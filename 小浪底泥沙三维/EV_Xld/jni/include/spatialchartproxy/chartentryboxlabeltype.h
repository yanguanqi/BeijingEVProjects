#ifndef	EARTHVIEW_WORLD_SPATIAL_SYSTEMUI_CHARTENTRYBOXLABELTYPE_H
#define EARTHVIEW_WORLD_SPATIAL_SYSTEMUI_CHARTENTRYBOXLABELTYPE_H
	...
	namespace World
	{
		namespace Spatial
		{
			namespace SystemUI
			{
				...
				/// 海图注记类型组合框
				/// </summary>
				class EVCHARTENTRYBOX_API CChartEntryBoxLabelType
				...
				ev_private:
					CChartEntryBoxLabelType(_in EarthView::World::Core::CNameValuePairList *pList );
				private:
					...
					C_DISABLE_COPY( CChartEntryBoxLabelType );
				};
			}
		}
	}
