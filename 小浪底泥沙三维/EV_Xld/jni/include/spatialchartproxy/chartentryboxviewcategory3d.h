#ifndef	EARTHVIEW_WORLD_SPATIAL_SYSTEMUI_CHARTENTRYBOXVIEWCATEGORY3D_H
#define EARTHVIEW_WORLD_SPATIAL_SYSTEMUI_CHARTENTRYBOXVIEWCATEGORY3D_H
	...
	namespace World
	{
		namespace Spatial
		{
			namespace SystemUI
			{
				...
				/// 三维海图显示类型组合框
				/// </summary>
				class EVCHARTENTRYBOX_API CChartEntryBoxViewCategory3D
				...
				ev_private:
					CChartEntryBoxViewCategory3D(_in EarthView::World::Core::CNameValuePairList *pList );
				private:
					...
					C_DISABLE_COPY( CChartEntryBoxViewCategory3D );
				};
			}
		}
	}
