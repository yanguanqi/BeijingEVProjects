#ifndef	EARTHVIEW_WORLD_SPATIAL_SYSTEMUI_CHARTENTRYBOXCOLORMODE3D_H
#define EARTHVIEW_WORLD_SPATIAL_SYSTEMUI_CHARTENTRYBOXCOLORMODE3D_H
	...
	namespace World
	{
		namespace Spatial
		{
			namespace SystemUI
			{
				...
				/// 三维海图颜色组合框
				/// </summary>
				class EVCHARTENTRYBOX_API CChartEntryBoxColorMode3D
				...
				ev_private:
					CChartEntryBoxColorMode3D( EarthView::World::Core::CNameValuePairList *pList );
				private:
					...
					C_DISABLE_COPY( CChartEntryBoxColorMode3D );
				};
			}
		}
	}
