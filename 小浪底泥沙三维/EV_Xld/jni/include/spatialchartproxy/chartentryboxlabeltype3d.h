#ifndef	EARTHVIEW_WORLD_SPATIAL_SYSTEMUI_CHARTENTRYBOXLABELTYPE3D_H
#define EARTHVIEW_WORLD_SPATIAL_SYSTEMUI_CHARTENTRYBOXLABELTYPE3D_H
	...
	namespace World
	{
		namespace Spatial
		{
			namespace SystemUI
			{
				...
				/// 三维海图注记类型组合框
				/// </summary>
				class EVCHARTENTRYBOX_API CChartEntryBoxLabelType3D
				...
				ev_private:
					CChartEntryBoxLabelType3D(_in EarthView::World::Core::CNameValuePairList *pList );
				private:
					...
					C_DISABLE_COPY( CChartEntryBoxLabelType3D );
				};
			}
		}
	}
