#ifndef	EARTHVIEW_WORLD_SPATIAL_SYSTEMUI_CHARTENTRYBOXSAFTYCONTOUR_H
#define EARTHVIEW_WORLD_SPATIAL_SYSTEMUI_CHARTENTRYBOXSAFTYCONTOUR_H
	...
	namespace World
	{
		namespace Spatial
		{
			namespace SystemUI
			{
				...
				/// 海图安全等深线深度组合框
				/// </summary>
				class EVCHARTENTRYBOX_API CChartEntryBoxSaftyContour
				...
				ev_private:
					CChartEntryBoxSaftyContour(_in EarthView::World::Core::CNameValuePairList *pList );
				private:
					...
					C_DISABLE_COPY( CChartEntryBoxSaftyContour );
				};
			}
		}
	}
