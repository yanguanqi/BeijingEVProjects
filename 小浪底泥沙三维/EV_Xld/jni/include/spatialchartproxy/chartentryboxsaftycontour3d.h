#ifndef	EARTHVIEW_WORLD_SPATIAL_SYSTEMUI_CHARTENTRYBOXSAFTYCONTOUR3D_H
#define EARTHVIEW_WORLD_SPATIAL_SYSTEMUI_CHARTENTRYBOXSAFTYCONTOUR3D_H
	...
	namespace World
	{
		namespace Spatial
		{
			namespace SystemUI
			{
				...
				/// 三维海图安全等深线深度组合框
				/// </summary>
				class EVCHARTENTRYBOX_API CChartEntryBoxSaftyContour3D
				...
				ev_private:
					CChartEntryBoxSaftyContour3D(_in EarthView::World::Core::CNameValuePairList *pList );
				private:
					...
					C_DISABLE_COPY( CChartEntryBoxSaftyContour3D );
				};
			}
		}
	}
