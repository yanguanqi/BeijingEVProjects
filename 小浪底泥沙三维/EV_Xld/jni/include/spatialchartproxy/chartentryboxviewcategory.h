#ifndef	EARTHVIEW_WORLD_SPATIAL_SYSTEMUI_CHARTENTRYBOXVIEWCATEGORY_H
#define EARTHVIEW_WORLD_SPATIAL_SYSTEMUI_CHARTENTRYBOXVIEWCATEGORY_H
	...
	namespace World
	{
		namespace Spatial
		{
			namespace SystemUI
			{
				...
				/// 海图显示类型组合框
				/// </summary>
				class EVCHARTENTRYBOX_API CChartEntryBoxViewCategory
				...
				ev_private:
					CChartEntryBoxViewCategory(_in EarthView::World::Core::CNameValuePairList *pList );
				private:
					...
					C_DISABLE_COPY( CChartEntryBoxViewCategory );
				};
			}
		}
	}
