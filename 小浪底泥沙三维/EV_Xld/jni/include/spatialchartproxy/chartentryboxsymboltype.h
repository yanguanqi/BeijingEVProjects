#ifndef	EARTHVIEW_WORLD_SPATIAL_SYSTEMUI_CHARTENTRYBOXSYMBOLTYPE_H
#define EARTHVIEW_WORLD_SPATIAL_SYSTEMUI_CHARTENTRYBOXSYMBOLTYPE_H
	...
	namespace World
	{
		namespace Spatial
		{
			namespace SystemUI
			{
				...
				/// 海图符号样式组合框
				/// </summary>
				class EVCHARTENTRYBOX_API CChartEntryBoxSymbolType
				...
				ev_private:
					CChartEntryBoxSymbolType(_in EarthView::World::Core::CNameValuePairList *pList );
				private:
					...
					C_DISABLE_COPY( CChartEntryBoxSymbolType );
				};
			}
		}
	}
