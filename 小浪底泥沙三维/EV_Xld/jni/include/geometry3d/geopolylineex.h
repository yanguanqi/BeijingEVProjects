#ifndef GeoPolylineEx_H
#define GeoPolylineEx_H
...
namespace EarthView
{
	namespace World
	{
		...
		{				
			...
			/// 管理三维中二维图层
			/// </summary>
			class EV_GEOMETRY3D_DLL CGeoPolylineEx : public EarthView::World::Core::CAllocatedObject
			{
ev_private:
				/// <summary>
				/// 构造函数
				...
				/// <returns></returns>
				CGeoPolylineEx(EarthView::World::Core::CNameValuePairList* pList);
			public:
				/// <summary>
				/// 构造函数
				/// </summary>
				/// <param name=""></param>
				/// <returns></returns>
				CGeoPolylineEx(EarthView::World::Graphic::CSceneManager* ref_scenemanager);
			...
			private:					
				...
				/// <returns></returns>
				C_DISABLE_COPY(CGeoPolylineEx);

			protected:
				EarthView::World::Graphic::CSceneManager* mpSceneManager;

				EarthView::World::Geometry3D::CMultiPolyline3DExtension* mpMultiGeoExtension;			
