#ifndef EARTHVIEW_WORLD_SPATIAL3D_GEOMETRY_KMLFRESNELSURFACE_H
#define EARTHVIEW_WORLD_SPATIAL3D_GEOMETRY_KMLFRESNELSURFACE_H
...
namespace EarthView
{
	namespace World
	{
		namespace Geometry3D
		{
			...
			/// 管理面线型的地理对象扩展到三维类方法
			/// </summary>
			class EV_GEOMETRY3D_DLL CKmlFresnelSurface: public EarthView::World::Geometry3D::CMultiPolygon3DExtension
			{
ev_private:
				/// <summary>
				/// 构造函数
				...
				/// <returns></returns>
				CKmlFresnelSurface(EarthView::World::Core::CNameValuePairList* pList);
			public:
				/// <summary>
				/// 构造函数
				/// </summary>
				...
				/// <returns></returns>
				CKmlFresnelSurface(EarthView::World::Spatial::Kml::CGeoObjectExtension* ref_geo,EarthView::World::Graphic::CSceneManager* ref_scenemanager,const EVString& groupName );
				/// <summary>
				/// 析构函数
				/// </summary>
				/// <param name=""></param>
				/// <returns></returns>
				virtual ~CKmlFresnelSurface();
			...
			ev_private:	
				...
				EarthView::World::Spatial::Display::CFresnelSurface3DSymbol* mpFill3DSymbol;

				EarthView::World::Spatial::Geometry::CPolygon* mpGeometry;
			};	

			//
			class EV_GEOMETRY3D_DLL CKmlFresnelSurfaceFactory : public EarthView::World::Spatial3D::Atlas::IGeometry3DFactory
			{
ev_private: 
				/// <summary>
				/// 构造函数
				...
				/// <param name="pList">构造函数参数键值对表</param>
				/// <returns></returns>
				CKmlFresnelSurfaceFactory(EarthView::World::Core::CNameValuePairList* pList);
			public:
				/// <summary>
				/// 构造函数
				/// </summary>
