#ifndef EARTHVIEW_WORLD_SPATIAL3D_OSGBDATASOURCE_H
#define EARTHVIEW_WORLD_SPATIAL3D_OSGBDATASOURCE_H
...
namespace EarthView{
	namespace World{
		namespace Spatial3D{
				...
				class CLocalOSGBDataSourceFactory;
				
				class EV_Spatial3D_OSGB_DLL CLocalOSGBDataSource : public EarthView::World::Spatial::GeoDataset::IFileDataSource
				{
ev_private:
					/// <summary>
					/// 构造函数
					...
					/// <returns></returns>
					CLocalOSGBDataSource(_in EarthView::World::Core::CNameValuePairList *pList);
				public:
					CLocalOSGBDataSource(const EVString& datasourcePath,const EVString& aliasname);
				...
				protected:
					friend class CLocalOSGBDataSourceFactory;
				private:					
