#ifndef EARTHVIEW_WORLD_SPATIAL_GEODATASET_IGEOMETRYINSERT_H
#define EARTHVIEW_WORLD_SPATIAL_GEODATASET_IGEOMETRYINSERT_H
	...
	namespace World
	{
		namespace Spatial
		{
			namespace Carto
			{
				...
				/// 插入绘图
				/// </summary>
				class EV_INTERFACE_DLL IGeometryInsert : public IMapSurround
				{
				public:
					/// <summary>
					/// 析构函数
...
ev_internal:
				...
				protected:
					IGeometryInsert();
ev_private:
					IGeometryInsert( EarthView::World::Core::CNameValuePairList *pList );
				private:
					IGeometryInsert(IGeometryInsert & obj);
				};
			}
		}
	}
