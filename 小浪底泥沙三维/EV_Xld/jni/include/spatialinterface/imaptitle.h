#ifndef EARTHVIEW_WORLD_SPATIAL_CARTO_IMAPTITLE_H
#define EARTHVIEW_WORLD_SPATIAL_CARTO_IMAPTITLE_H
...
namespace EarthView
{
	namespace World
	{
		namespace Spatial
		{
			namespace Carto
			{
				class EV_INTERFACE_DLL IMapTitle : public IMapSurround
				{
				public:
					/// <summary>
					/// 析构函数
...
ev_internal:
				...
				protected:
					IMapTitle();
ev_private:
					IMapTitle(EarthView::World::Core::CNameValuePairList *pList );
				private:
					IMapTitle(IMapTitle& obj);
				};
			}
		}
	}
