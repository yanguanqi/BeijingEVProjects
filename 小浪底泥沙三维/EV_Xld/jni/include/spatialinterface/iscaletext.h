#ifndef EARTHVIEW_WORLD_SPATIAL_GEODATASET_ISCALEIEXT_H
#define EARTHVIEW_WORLD_SPATIAL_GEODATASET_ISCALEIEXT_H
...
namespace EarthView
{
	namespace World
	{
		namespace Spatial
		{
			namespace Carto
			{
				class EV_INTERFACE_DLL IScaleText : public IMapSurround
				{
				public:
					/// <summary>
					/// 析构函数
				...
				protected:
					IScaleText();
				ev_private:
					IScaleText( EarthView::World::Core::CNameValuePairList *pList );
				private:
					IScaleText(IScaleText & obj);
				};
			}
		}
	}
