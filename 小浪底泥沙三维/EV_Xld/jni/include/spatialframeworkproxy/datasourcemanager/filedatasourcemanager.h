#ifndef FILE_DATASOURCE_MANAGER_H__
#define FILE_DATASOURCE_MANAGER_H__
#include "datasourcemanager.h"
namespace EarthView{
	namespace World{
		namespace FrameWorkProxy{
			namespace DataSourceManager{
				class  FileDataSourceManager : public CDataSourceManager
				{
				protected:
				...
				public:
					...
					/// 关闭所有数据集
					/// </summary>
					/// <param name="dataSourceEvent">数据源事件对象类</param>
					/// <returns></returns>					
				...
				protected:
					...
					/// <param name=""></param>
					/// <returns></returns>					
					FileDataSourceManager(ev_int32 t):CDataSourceManager(t)
					{
