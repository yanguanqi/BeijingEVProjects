#ifndef EARTHVIEW_WORLD_SPATIAL_CARTO_SCALETEXT_H
#define EARTHVIEW_WORLD_SPATIAL_CARTO_SCALETEXT_H
...
namespace EarthView
{
	namespace World
	{
		namespace Spatial
		{
			namespace Carto
			{
				class EV_SPATIAL2DCARTO_DLL CScaleText : public IScaleText
				{
				public:
				...
				ev_internal:
				 ...
				 private:
					...
					EVString calculateScale(EarthView::World::Spatial::Display::ISpatialDisplay *pPageDisplay);//如果比例发生改变
					ev_void correctEnvelope(EarthView::World::Spatial::Display::ISpatialTransformer *pTransformer);
				ev_private:
					CScaleText(EarthView::World::Core::CNameValuePairList *pList );
				private:
					CScaleText(CScaleText& obj);
				private:
