#ifndef EARTHVIEW_WORLD_SPATIAL_CARTO_TEXTINSERT_H
#define EARTHVIEW_WORLD_SPATIAL_CARTO_TEXTINSERT_H
...
namespace EarthView
{
	namespace World
	{
		namespace Spatial
		{
			namespace Carto
			{
				class EV_SPATIAL2DCARTO_DLL CTextInsert : public ITextInsert
				{
				public:
				...
				ev_private:
					CTextInsert(EarthView::World::Core::CNameValuePairList *pList );
				private:
					CTextInsert(CTextInsert& obj);
				private:
