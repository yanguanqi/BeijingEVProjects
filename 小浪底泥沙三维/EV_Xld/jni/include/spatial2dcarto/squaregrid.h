#ifndef EARTHVIEW_WORLD_SPATIAL_CARTO_SQUAREGRID_H
#define EARTHVIEW_WORLD_SPATIAL_CARTO_SQUAREGRID_H
	...
	namespace World
	{
		namespace Spatial
		{
			namespace Carto
			{
				...
				/// 方格网类
				/// </summary>
				class EV_SPATIAL2DCARTO_DLL CSquareGrid : public ISquareGrid
				{
				public:
				...
				ev_internal:
					...
					ev_void init();
					EarthView::World::Spatial::Atlas::EVMapUnits getMapUnit(EVString strUnit);
					ev_int32 toIntValue(ev_real64 dValue);
				ev_private:
					CSquareGrid(EarthView::World::Core::CNameValuePairList *pList );
				private:
					CSquareGrid(CSquareGrid& obj);
				protected:
					EVString m_strName;
					EarthView::World::Spatial::Display::CLineSymbol* m_pGridlineSymbol;
					EarthView::World::Spatial::Display::CTextSymbol* m_pLabelSymbol;
					...
					EarthView::World::Spatial::Carto::EVSquareGridType m_squareGridType;
					ev_bool m_bDrawGridline;
					ev_bool m_bActive;
				};
			}
		}
