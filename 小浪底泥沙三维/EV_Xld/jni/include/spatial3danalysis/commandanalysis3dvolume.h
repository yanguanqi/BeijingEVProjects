#ifndef  COMMANDANALYSIS3DVOLUME_H
#define  COMMANDANALYSIS3DVOLUME_H
	...
	namespace World
	{
		...
		namespace Spatial3D
		{
			...
			namespace  Analysis
			{
				...
				/// 工具栏土方分析类
				/// </summary>
				class EV_ANALYSIS3D_DLL CCommandAnalysis3DVolume:public EarthView::World::Spatial3D::Controls::CGlobeCommand
				{
				public:
					...
					/// <param name=""></param>
					/// <returns></returns>
					virtual ~ CCommandAnalysis3DVolume();
...
ev_private:
					...
					/// <returns></returns>
					CCommandAnalysis3DVolume( EarthView::World::Core::CNameValuePairList *pList );
				protected:
					C_DISABLE_COPY( CCommandAnalysis3DVolume )
				};
			}
		}
	}
