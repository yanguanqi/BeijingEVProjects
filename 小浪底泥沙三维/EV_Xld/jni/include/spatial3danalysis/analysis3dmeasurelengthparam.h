#ifndef _ANALYSIS3DMEASURELENGTHPARAM_H_
#define _ANALYSIS3DMEASURELENGTHPARAM_H_
...
namespace EarthView
{
	namespace World
	{
		namespace Spatial3D
		{
			namespace Analysis
			{
				class EV_ANALYSIS3D_DLL CAnalysis3DMeasureLengthParam : public EarthView::World::Core::CStringInterface
				{
ev_private:
					/// <summary>
					/// 构造函数
					...
					/// <returns></returns>
					CAnalysis3DMeasureLengthParam(_in EarthView::World::Core::CNameValuePairList *pList);
				public:
					/// <summary>
					///  构造函数
					/// </summary>
					/// <returns></returns>
					/// <memo></memo>
					CAnalysis3DMeasureLengthParam(void* parent);
					/// <summary>
					///  析构函数
					/// </summary>
					/// <param name=""></param>
					/// <returns></returns>
					/// <memo></memo>
					virtual ~CAnalysis3DMeasureLengthParam();	
					/// <summary>
					///  设置
					/// </summary>
