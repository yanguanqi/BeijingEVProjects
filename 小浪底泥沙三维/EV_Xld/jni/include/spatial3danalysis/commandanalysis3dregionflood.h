#ifndef  COMMANDANALYSIS3DDREGIONFLOOD_H
#define   COMMANDANALYSIS3DDREGIONFLOOD_H
	...
	namespace World
	{
		...
		namespace Spatial3D
		{
			...
			namespace Analysis
			{
				...
				/// 工具栏淹没分析类
				/// </summary>
				class EV_ANALYSIS3D_DLL CCommandAnalysis3DRegionFlood:public EarthView::World::Spatial3D::Controls::CGlobeCommand
				{
				public:
					...
					/// <param name=""></param>
					/// <returns></returns>
					virtual ~ CCommandAnalysis3DRegionFlood();
...
ev_private:
					...
					/// <returns></returns>
					CCommandAnalysis3DRegionFlood( EarthView::World::Core::CNameValuePairList *pList );
				protected:
					C_DISABLE_COPY(CCommandAnalysis3DRegionFlood )
