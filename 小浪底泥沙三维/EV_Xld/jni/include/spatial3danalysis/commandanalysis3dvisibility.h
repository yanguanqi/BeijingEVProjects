#ifndef  COMMANDANALYSIS3DVISIBILITY_H
#define  COMMANDANALYSIS3DVISIBILITY_H
	...
	namespace World
	{
		...
		namespace Spatial3D
		{
			...
			namespace Analysis
			{
				...
				/// 工具栏通视分析类
				/// </summary>
				class EV_ANALYSIS3D_DLL CCommandAnalysis3DVisibility:public EarthView::World::Spatial3D::Controls::CGlobeCommand
				{
				public:
					...
					/// <param name=""></param>
					/// <returns></returns>
					virtual ~ CCommandAnalysis3DVisibility();
...
ev_private:
					...
					/// <returns></returns>
					CCommandAnalysis3DVisibility( EarthView::World::Core::CNameValuePairList *pList );
				protected:
					C_DISABLE_COPY(CCommandAnalysis3DVisibility )
				};
			}
		}
	}
