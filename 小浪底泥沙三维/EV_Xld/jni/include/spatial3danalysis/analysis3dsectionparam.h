#ifndef _ANALYSIS3DSECTIONPARAM_H_
#define _ANALYSIS3DSECTIONPARAM_H_
...
namespace EarthView
{
	namespace World
	{
		namespace Spatial3D
		{
			namespace Analysis
			{
				class EV_ANALYSIS3D_DLL CAnalysis3DSectionParam : public EarthView::World::Core::CStringInterface
				{
ev_private:
					/// <summary>
					/// 构造函数
					...
					/// <returns></returns>
					CAnalysis3DSectionParam(_in EarthView::World::Core::CNameValuePairList *pList);
				public:
					/// <summary>
					///  构造函数
					/// </summary>
					/// <returns></returns>
					/// <memo></memo>
					CAnalysis3DSectionParam(void* parent);
					/// <summary>
					///  析构函数
					/// </summary>
					/// <param name=""></param>
					/// <returns></returns>
					/// <memo></memo>
					virtual ~CAnalysis3DSectionParam();	
					/// <summary>
					///  设置
					/// </summary>
...
ev_private:
					...
					class  CCmdSlopeVisible : public EarthView::World::Core::CParamCommand //坡度字体可见性
					{
					public:
						CCmdSlopeVisible();
						EVString doGet(const void *target) const;
					...
					class  CCmdAltitudeVisible : public EarthView::World::Core::CParamCommand //高程字体可见性
					{
					public:
						CCmdAltitudeVisible();
						EVString doGet(const void *target) const;
					...
					static CCmdSlopeVisible msSlopeVisibleCmd;
					static CCmdAltitudeVisible msAltitudeVisibleCmd;
