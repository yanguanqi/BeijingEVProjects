#ifndef  COMMANDANALYSIS3DSKYLINE_H
#define  COMMANDANALYSIS3DSKYLINE_H
	...
	namespace World
	{
		...
		namespace Spatial3D
		{
			...
			namespace Analysis
			{
				...
				/// 工具栏通视分析类
				/// </summary>
				class EV_ANALYSIS3D_DLL CCommandAnalysis3DSkyline:public EarthView::World::Spatial3D::Controls::CGlobeCommand
				{
				public:
					...
					/// <param name=""></param>
					/// <returns></returns>
					virtual ~ CCommandAnalysis3DSkyline();
...
ev_private:
					...
					/// <returns></returns>
					CCommandAnalysis3DSkyline( EarthView::World::Core::CNameValuePairList *pList );
				protected:
					C_DISABLE_COPY( CCommandAnalysis3DSkyline )
				};
			}
		}
	}
