#ifndef _ANALYSIS3DVOLUMEPARAM_H_
#define _ANALYSIS3DVOLUMEPARAM_H_
...
namespace EarthView
{
	namespace World
	{
		namespace Spatial3D
		{
			namespace Analysis
			{
				class EV_ANALYSIS3D_DLL CAnalysis3DVolumeParam : public EarthView::World::Core::CStringInterface
				{
ev_private:
					/// <summary>
					/// 构造函数
					...
					/// <returns></returns>
					CAnalysis3DVolumeParam(_in EarthView::World::Core::CNameValuePairList *pList);
				public:
					/// <summary>
					///  构造函数
					/// </summary>
					/// <returns></returns>
					/// <memo></memo>
					CAnalysis3DVolumeParam(void* parent);
...
ev_private:
					...
					class  CCmdDefaultDepth : public EarthView::World::Core::CParamCommand //根据地形确定基准面高程
					{
					public:
						CCmdDefaultDepth();
						EVString doGet(const void *target) const;
					...
					class  CCmdDepth : public EarthView::World::Core::CParamCommand //挖填深度
					{
					public:
						CCmdDepth();
						EVString doGet(const void *target) const;
					...
					static CCmdDefaultDepth msDefaultDepthCmd;
