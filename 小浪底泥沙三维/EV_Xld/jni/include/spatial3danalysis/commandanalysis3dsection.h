#ifndef  CCOMMANDSECTIONANALYSIS3D_H
#define  CCOMMANDSECTIONANALYSIS3D_H
	...
	namespace World
	{
		...
		namespace Spatial3D
		{
			...
			namespace Analysis
			{
				...
				/// 工具栏断面分析类
				/// </summary>
				class EV_ANALYSIS3D_DLL CCommandAnalysis3DSection:public EarthView::World::Spatial3D::Controls::CGlobeCommand
				{
				public:
					...
					/// <param name=""></param>
					/// <returns></returns>
					virtual ~ CCommandAnalysis3DSection();
...
ev_private:
					...
					/// <returns></returns>
					CCommandAnalysis3DSection( EarthView::World::Core::CNameValuePairList *pList );
				protected:
					C_DISABLE_COPY( CCommandAnalysis3DSection )
