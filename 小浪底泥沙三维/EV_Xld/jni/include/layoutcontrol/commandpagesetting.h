#ifndef EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_COMMANDPAGESETTING_H
#define EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_COMMANDPAGESETTING_H
...
namespace EarthView{
	namespace World{
		namespace Layout{
			namespace Controls{
				class EV_LAYOUTCONTROL_DLL CCommandPageSetting : public CLayoutCommand
				{
				public:
				...
				ev_private:
					CCommandPageSetting( EarthView::World::Core::CNameValuePairList *pList );
				protected:
					C_DISABLE_COPY( CCommandPageSetting )
				};
			}
		}
	}
