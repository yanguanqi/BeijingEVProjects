#ifndef EARTHVIEW_WORLD_LAYOUT_CONTROLS_TOOLELEMENTSELECTION_H
#define EARTHVIEW_WORLD_LAYOUT_CONTROLS_TOOLELEMENTSELECTION_H
...
namespace EarthView{
	namespace World{
		namespace Layout{
			namespace Controls{
				class  EV_LAYOUTCONTROL_DLL CToolElementSelection : public CToolLayout
				{
				public:
				...
				public:
					...
					virtual ev_void showMessage(EVString strMag);
				private:
					EarthView::World::Spatial::Geometry::IGeometry *toRectangleRing(EarthView::World::Spatial::Geometry::IEnvelope *pEnvelope);
					ev_void exchangeData(ev_real64 &dFirst, ev_real64 &dSecond);
				    ev_void init();
					ev_int32 getSnapPoint(EarthView::World::Spatial::Geometry::IEnvelope *pEnvelope, EarthView::World::Spatial::Geometry::CPoint cursorPoint, ev_bool bEightPoints);
					//ev_int32 updatePointIndex(EarthView::World::Spatial::Geometry::IEnvelope *pEnvelope, EarthView::World::Spatial::Geometry::CPoint cursorPoint, ev_bool bEightPoints);
					EarthView::World::Spatial::Display::CSimpleFillSymbol *m_pSymbol;
					EarthView::World::Spatial::Geometry::CPolygon* m_pRectangle;
					CLayoutSublineRender *m_pSublineRender;
					ev_bool m_bSnapPoint;
					ev_int32 m_nPointIndex;
				protected:
					ev_uint32 m_nOperationMode;
				ev_private:
					CToolElementSelection ( EarthView::World::Core::CNameValuePairList *pList );
				protected:
					C_DISABLE_COPY(CToolElementSelection)
				};
			}
		}
	}
