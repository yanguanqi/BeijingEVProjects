#ifndef EARTHVIEW_WORLD_LAYOUT_CONTROLS_COMMANDNEXTPAGEVIEW_H
#define EARTHVIEW_WORLD_LAYOUT_CONTROLS_COMMANDNEXTPAGEVIEW_H
	...
	namespace World{
		namespace Layout{
			namespace Controls{
				...
				/// 纸张1:1显示
				/// </summary>
				class EV_LAYOUTCONTROL_DLL CCommandNextPageView : public CLayoutCommand
				{
				public:
				...
				private:
					ev_void init();
				ev_private:
					CCommandNextPageView ( EarthView::World::Core::CNameValuePairList *pList );
				protected:
					C_DISABLE_COPY( CCommandNextPageView )
				};
			}
		}
	}
