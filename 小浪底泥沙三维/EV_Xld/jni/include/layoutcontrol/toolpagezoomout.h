#ifndef EARTHVIEW_WORLD_LAYOUT_CONTROLS_TOOLPAGEZOOMOUT_H
#define EARTHVIEW_WORLD_LAYOUT_CONTROLS_TOOLPAGEZOOMOUT_H
...
namespace EarthView
{
	namespace World
	{
		namespace Layout
		{
			namespace Controls
			{
				class EV_LAYOUTCONTROL_DLL CToolPageZoomOut : public CToolLayout
				{
				public:
				...
				private:
					...
					EarthView::World::Spatial::Geometry::CRectangle* m_pRectangle;
					CLayoutSublineRender *m_pSublineRender;
				ev_private:
					CToolPageZoomOut ( EarthView::World::Core::CNameValuePairList *pList );
				protected:
					C_DISABLE_COPY(CToolPageZoomOut)
				};
			}
		}
	}
