#ifndef EARTHVIEW_WORLD_LAYOUT_CONTROLS_COMMANDINSERTMAPFRAME_H
#define EARTHVIEW_WORLD_LAYOUT_CONTROLS_COMMANDINSERTMAPFRAME_H
	...
	namespace World{
		namespace Layout{
			namespace Controls{
				...
				/// 插入边框
				/// </summary>
				class EV_LAYOUTCONTROL_DLL CCommandInsertMapFrame : public CLayoutCommand
				{
				public:
				...
				private:
					ev_void init();
ev_private:
					CCommandInsertMapFrame ( EarthView::World::Core::CNameValuePairList *pList );
				protected:
					C_DISABLE_COPY( CCommandInsertMapFrame )
				};
			}
		}
	}
