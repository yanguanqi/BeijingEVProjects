#ifndef EARTHVIEW_WORLD_LAYOUT_CONTROLS_COMMANDINSERTMAPTITLE_H
#define EARTHVIEW_WORLD_LAYOUT_CONTROLS_COMMANDINSERTMAPTITLE_H
...
namespace EarthView{
	namespace World{
		namespace Layout{
			namespace Controls{
				class EV_LAYOUTCONTROL_DLL CCommandInsertMapTitle : public CLayoutCommand
				{
				public:
				...
				private:
					ev_void init();
				ev_private:
					CCommandInsertMapTitle ( EarthView::World::Core::CNameValuePairList *pList );
				protected:
					C_DISABLE_COPY( CCommandInsertMapTitle )
				};
			}
		}
	}
