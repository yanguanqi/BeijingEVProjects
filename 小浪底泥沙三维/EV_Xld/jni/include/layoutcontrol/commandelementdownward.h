#ifndef EARTHVIEW_WORLD_LAYOUT_CONTROLS_COMMANDELEMENTDOWNWARD_H
#define EARTHVIEW_WORLD_LAYOUT_CONTROLS_COMMANDELEMENTDOWNWARD_H
...
namespace EarthView{
	namespace World{
		namespace Layout{
			namespace Controls{
class  CLayoutOperationObserver;
class EV_LAYOUTCONTROL_DLL CCommandElementDownward : public CLayoutCommand
{
public:
...
ev_private:
	CCommandElementDownward( EarthView::World::Core::CNameValuePairList *pList );
protected:
	ev_void init();
	C_DISABLE_COPY( CCommandElementDownward )
private:
