#ifndef _TOOL_ZOOM_OUT_INPAGE_H_
#define _TOOL_ZOOM_OUT_INPAGE_H_
	...
	namespace World
	{
		namespace Layout
		{
			namespace Controls
			{
				...
				class EV_LAYOUTCONTROL_DLL CToolZoomOutInPage : public CToolLayout
				{
				public:
...
ev_private:
					CToolZoomOutInPage( EarthView::World::Core::CNameValuePairList *pList );
				protected:
					C_DISABLE_COPY( CToolZoomOutInPage )
				};
			}
		}
	}
