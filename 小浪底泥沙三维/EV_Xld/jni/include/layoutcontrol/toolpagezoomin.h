#ifndef EARTHVIEW_WORLD_LAYOUT_CONTROLS_TOOLPAGEZOOMIN_H
#define EARTHVIEW_WORLD_LAYOUT_CONTROLS_TOOLPAGEZOOMIN_H
...
namespace EarthView
{
	namespace World
	{
		namespace Layout
		{
			namespace Controls
			{
				class EV_LAYOUTCONTROL_DLL CToolPageZoomIn : public CToolLayout
				{
				public:
				...
				ev_private:
					CToolPageZoomIn ( EarthView::World::Core::CNameValuePairList *pList );
				protected:
					C_DISABLE_COPY(CToolPageZoomIn)
				};
			}
		}
	}
