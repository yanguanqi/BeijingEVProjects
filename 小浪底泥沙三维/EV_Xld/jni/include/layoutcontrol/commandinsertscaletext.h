#ifndef EARTHVIEW_WORLD_LAYOUT_CONTROLS_COMMANDINSERTSCALETEXT_H
#define EARTHVIEW_WORLD_LAYOUT_CONTROLS_COMMANDINSERTSCALETEXT_H
...
namespace EarthView{
	namespace World{
		namespace Layout{
			namespace Controls{
				class EV_LAYOUTCONTROL_DLL CCommandInsertScaleText : public CLayoutCommand
				{
				public:
				...
				private:
					ev_void init();
ev_private:
					CCommandInsertScaleText ( EarthView::World::Core::CNameValuePairList *pList );
				protected:
					C_DISABLE_COPY( CCommandInsertScaleText )
				};
			}
		}
	}
