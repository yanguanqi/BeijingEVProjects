#ifndef EARTHVIEW_WORLD_LAYOUT_CONTROLS_TOOLPAGEPAN_H
#define EARTHVIEW_WORLD_LAYOUT_CONTROLS_TOOLPAGEPAN_H
...
namespace EarthView{
	namespace World{
		namespace Layout{
			namespace Controls{
				class EV_LAYOUTCONTROL_DLL CToolPagePan : public CToolLayout
				{
				public:
...
ev_private:
					CToolPagePan ( EarthView::World::Core::CNameValuePairList *pList );
				protected:
					C_DISABLE_COPY(CToolPagePan)
				};
			}
		}
	}
