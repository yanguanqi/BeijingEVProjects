#ifndef EARTHVIEW_WORLD_LAYOUT_CONTROLS_COMMANDINSERTTEXT_H
#define EARTHVIEW_WORLD_LAYOUT_CONTROLS_COMMANDINSERTTEXT_H
...
namespace EarthView{
	namespace World{
		namespace Layout{
			namespace Controls{
				class EV_LAYOUTCONTROL_DLL CCommandInsertText : public CLayoutCommand
				{
				public:
				...
				private:
					ev_void init();
ev_private:
					CCommandInsertText ( EarthView::World::Core::CNameValuePairList *pList );
				protected:
					C_DISABLE_COPY( CCommandInsertText )
				};
			}
		}
	}
