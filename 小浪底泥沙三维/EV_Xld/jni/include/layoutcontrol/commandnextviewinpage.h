#ifndef EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_COMMANDNEXTVIEWINPAGE_H
#define EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_COMMANDNEXTVIEWINPAGE_H
...
namespace EarthView{
	namespace World{
		namespace Layout{
			namespace Controls{
				class EV_LAYOUTCONTROL_DLL CCommandNextViewInPage : public CLayoutCommand
				{
				public:
				...
				ev_private:
					CCommandNextViewInPage( EarthView::World::Core::CNameValuePairList *pList );
				protected:
					C_DISABLE_COPY( CCommandNextViewInPage )
				};
			}
		}
	}
