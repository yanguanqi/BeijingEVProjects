#ifndef EARTHVIEW_WORLD_LAYOUT_CONTROLS_COMMANDPREVIOUSPAGEVIEW_H
#define EARTHVIEW_WORLD_LAYOUT_CONTROLS_COMMANDPREVIOUSPAGEVIEW_H
	...
	namespace World{
		namespace Layout{
			namespace Controls{
				...
				/// 纸张1:1显示
				/// </summary>
				class EV_LAYOUTCONTROL_DLL CCommandPreviousPageView : public CLayoutCommand
				{
				public:
				...
				private:
					ev_void init();
				ev_private:
					CCommandPreviousPageView ( EarthView::World::Core::CNameValuePairList *pList );
				protected:
					C_DISABLE_COPY( CCommandPreviousPageView )
				};
			}
		}
	}
