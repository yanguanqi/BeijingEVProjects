#ifndef EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_COMMANDPREVIOUSVIEWINPAGE_H
#define EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_COMMANDPREVIOUSVIEWINPAGE_H
...
namespace EarthView{
	namespace World{
		namespace Layout{
			namespace Controls{
				class EV_LAYOUTCONTROL_DLL CCommandPreviousViewInPage : public CLayoutCommand
				{
				public:
				...
				ev_private:
					CCommandPreviousViewInPage( EarthView::World::Core::CNameValuePairList *pList );
				protected:
					C_DISABLE_COPY( CCommandPreviousViewInPage )
				};
			}
		}
	}
