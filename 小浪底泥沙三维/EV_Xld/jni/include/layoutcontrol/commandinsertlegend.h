#ifndef EARTHVIEW_WORLD_LAYOUT_CONTROLS_COMMANDINSERTLEGEND_H
#define EARTHVIEW_WORLD_LAYOUT_CONTROLS_COMMANDINSERTLEGNED_H
...
namespace EarthView{
	namespace World{
		namespace Layout{
			namespace Controls{
				class EV_LAYOUTCONTROL_DLL CCommandInsertLegend : public CLayoutCommand
				{
				public:
