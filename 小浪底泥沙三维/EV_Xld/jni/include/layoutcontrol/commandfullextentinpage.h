#ifndef EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_COMMANDFULLEXTENTINPAGE_H
#define EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_COMMANDFULLEXTENTINPAGE_H
...
namespace EarthView{
	namespace World{
		namespace Layout{
			namespace Controls{
				class EV_LAYOUTCONTROL_DLL CCommandFullExtentInPage : public CLayoutCommand
				{
				public:
				...
				ev_private:
					CCommandFullExtentInPage( EarthView::World::Core::CNameValuePairList *pList );
				protected:
					C_DISABLE_COPY( CCommandFullExtentInPage )
				};
			}
		}
	}
