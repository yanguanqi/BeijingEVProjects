#ifndef EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_TOOLPAN_INPAGER_H
#define EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_TOOLPAN_INPAGER_H
...
namespace EarthView{
	namespace World{
		namespace Layout{
			namespace Controls{
				class EV_LAYOUTCONTROL_DLL CToolPanInPage : public CToolLayout
				{
				public:
				...
				ev_private:
					CToolPanInPage( EarthView::World::Core::CNameValuePairList *pList );
				protected:
					C_DISABLE_COPY( CToolPanInPage )
					private:
						ev_void init();
						ev_bool m_bPan;
				};
