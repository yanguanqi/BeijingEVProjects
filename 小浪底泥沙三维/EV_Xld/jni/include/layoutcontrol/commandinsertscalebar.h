#ifndef EARTHVIEW_WORLD_LAYOUT_CONTROLS_COMMANDINSERTSCALEBAR_H
#define EARTHVIEW_WORLD_LAYOUT_CONTROLS_COMMANDINSERTSCALEBAR_H
	...
	namespace World{
		namespace Layout{
			namespace Controls{
				...
				/// 插入尺度条
				/// </summary>
				class EV_LAYOUTCONTROL_DLL CCommandInsertScaleBar : public CLayoutCommand
				{
				public:
...
ev_private:
					CCommandInsertScaleBar ( EarthView::World::Core::CNameValuePairList *pList );
				protected:
					C_DISABLE_COPY( CCommandInsertScaleBar )
				};
			}
		}
	}
