#ifndef EARTHVIEW_WORLD_LAYOUT_CONTROLS_COMMANDPAGENORMAL_H
#define EARTHVIEW_WORLD_LAYOUT_CONTROLS_COMMANDPAGENORMAL_H
	...
	namespace World{
		namespace Layout{
			namespace Controls{
				...
				/// 纸张1:1显示
				/// </summary>
				class EV_LAYOUTCONTROL_DLL CCommandPageNormal : public CLayoutCommand
				{
				public:
...
ev_private:
					CCommandPageNormal ( EarthView::World::Core::CNameValuePairList *pList );
				protected:
					C_DISABLE_COPY( CCommandPageNormal )
				};
			}
		}
	}
