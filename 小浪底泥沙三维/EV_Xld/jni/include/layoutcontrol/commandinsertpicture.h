#ifndef EARTHVIEW_WORLD_LAYOUT_CONTROLS_COMMANDINSERTPICTURE_H
#define EARTHVIEW_WORLD_LAYOUT_CONTROLS_COMMANDINSERTPICTURE_H
...
namespace EarthView{
	namespace World{
		namespace Layout{
			namespace Controls{
				class EV_LAYOUTCONTROL_DLL CCommandInsertPicture : public CLayoutCommand
				{
				public:
				...
				private:
					ev_void init();
ev_private:
					CCommandInsertPicture ( EarthView::World::Core::CNameValuePairList *pList );
				protected:
					C_DISABLE_COPY( CCommandInsertPicture )
				};
			}
		}
	}
