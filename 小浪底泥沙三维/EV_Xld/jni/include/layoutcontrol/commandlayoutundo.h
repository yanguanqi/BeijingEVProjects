#ifndef EARTHVIEW_WORLD_LAYOUT_CONTROLS_COMMANDLAYOUTUNDO_H
#define EARTHVIEW_WORLD_LAYOUT_CONTROLS_COMMANDLAYOUTUNDO_H
...
class EV_LAYOUTCONTROL_DLL CCommandLayoutUndo : public CLayoutCommand
{
public:
...
ev_private:
	CCommandLayoutUndo( EarthView::World::Core::CNameValuePairList *pList );
protected:
	ev_void init();
	CLayoutOperationObserver *m_pObserver;
	C_DISABLE_COPY( CCommandLayoutUndo )
};
			}
		}
	}
