#ifndef EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_COMMANDMAPEXPORT_H
#define EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_COMMANDMAPEXPORT_H
...
namespace EarthView{
	namespace World{
		namespace Layout{
			namespace Controls{
				class EV_LAYOUTCONTROL_DLL CCommandMapExport : public CLayoutCommand
				{
				public:
				...
				ev_private:
					CCommandMapExport( EarthView::World::Core::CNameValuePairList *pList );
				protected:
					C_DISABLE_COPY( CCommandMapExport )
				};
			}
		}
	}
