#ifndef EARTHVIEW_WORLD_LAYOUT_CONTROLS_COMMANDELEMENTBOTTOM_H
#define EARTHVIEW_WORLD_LAYOUT_CONTROLS_COMMANDELEMENTBOTTOM_H
...
class EV_LAYOUTCONTROL_DLL CCommandElementBottom : public CLayoutCommand
{
public:
...
ev_private:
	CCommandElementBottom( EarthView::World::Core::CNameValuePairList *pList );
protected:
	ev_void init();
	C_DISABLE_COPY( CCommandElementBottom )
};
			}
		}
	}
