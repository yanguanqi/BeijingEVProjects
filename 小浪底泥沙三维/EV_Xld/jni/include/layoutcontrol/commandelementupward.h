#ifndef EARTHVIEW_WORLD_LAYOUT_CONTROLS_COMMANDELEMENTUPWARD_H
#define EARTHVIEW_WORLD_LAYOUT_CONTROLS_COMMANDELEMENTUPWARD_H
...
namespace EarthView{
	namespace World{
		namespace Layout{
			namespace Controls{
class EV_LAYOUTCONTROL_DLL CCommandElementUpward : public CLayoutCommand
{
public:
...
ev_private:
	CCommandElementUpward( EarthView::World::Core::CNameValuePairList *pList );
protected:
	ev_void init();
	C_DISABLE_COPY( CCommandElementUpward )
};
			}
		}
	}
