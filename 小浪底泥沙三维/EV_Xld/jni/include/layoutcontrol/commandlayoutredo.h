...
class EV_LAYOUTCONTROL_DLL CCommandLayoutRedo : public CLayoutCommand
{
public:
...
ev_private:
	CCommandLayoutRedo( EarthView::World::Core::CNameValuePairList *pList );
protected:
	ev_void init();
	C_DISABLE_COPY( CCommandLayoutRedo )
