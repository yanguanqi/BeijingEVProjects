#ifndef TOOLGETINFORMATION_H
#define TOOLGETINFORMATION_H
...
namespace EarthView
{
	namespace World
	{
		namespace Desktop
		{
			namespace QT
			{
				class CFrmGetInformation;
				class VIEWTOOLBAR_EXPORT CToolGetInformation : public EarthView::World::Spatial2D::Controls::CTool2D
				{
				public:
				...
				protected:
					...
					//信息显示对话框对象
					CFrmGetInformation *m_infoDlg; 
					//图层对象
					EarthView::World::Spatial::Atlas::ILayer *m_pIlayer;
					//被选择几何要素
					EarthView::World::Spatial2D::Controls::CTrackingGeometryItem *m_pTrackingItem;
					//填充符号属性
				...
				ev_private:
					CToolGetInformation( EarthView::World::Core::CNameValuePairList *pList );
				protected:
					C_DISABLE_COPY( CToolGetInformation )
				};
			}
		}
	}
