#ifndef EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_TOOLCIRCLESELECT_H
#define EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_TOOLCIRCLESELECT_H
	...
	namespace World{
		namespace Spatial2D{
			namespace Controls{
				...
				class EV_MAPCONTROL_DLL CToolCircleSelect : public CTool2D
				{
				public:
				...
				protected:
					...
					CTrackingGeometryItem *m_pPointItem;
					CSimpleFillSymbol *m_pSymbol;
					IGeometry* m_pSelectGeometry;
				ev_private:
					CToolCircleSelect( EarthView::World::Core::CNameValuePairList *pList );
				protected:
					C_DISABLE_COPY( CToolCircleSelect )
				};
			}
		}
	}
