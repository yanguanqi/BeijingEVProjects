#ifndef EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_TOOLPARALLELRESTRAIN_H
#define EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_TOOLPARALLELRESTRAIN_H
...
namespace EarthView{
	namespace World{
		namespace Spatial2D{
			namespace Controls{
				class EV_MAPCONTROL_DLL CToolParallelRestrain : public CNewNonPointTypeTool
				{
				public:
				...
				private:
					EarthView::World::Spatial::Geometry::IGeometry *snapSketch(ev_real64 dTolerance,EarthView::World::Spatial::Geometry::CPoint *pSnapPoint);
					EarthView::World::Spatial::Geometry::IGeometry *snapEdge(CEditingObject *edit, const EarthView::World::Spatial::Geometry::CPoint *pSnapPoint, ev_real64 dTolerance);
					EarthView::World::Spatial::Geometry::CPoint *getParallelPoint();
					EarthView::World::Spatial::Geometry::CPoint *m_pFirstPoint;
					EarthView::World::Spatial::Geometry::CPoint *m_pSecondPoint;
					EarthView::World::Spatial::Atlas::ILayer *m_pSnapLayer;
					CTrackingGeometryItem *m_pLineItem;
				ev_private:
					CToolParallelRestrain( EarthView::World::Core::CNameValuePairList *pList );
					CTrackingLayer *m_pTrackingLayer;
				protected:
					ev_void init();
					C_DISABLE_COPY( CToolParallelRestrain )
				};
			}
		}
	}
