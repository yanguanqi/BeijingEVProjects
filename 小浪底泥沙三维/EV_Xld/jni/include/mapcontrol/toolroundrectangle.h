#ifndef EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_TOOLROUNDRECTANGLE_H
#define EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_TOOLROUNDRECTANGLE_H
...
namespace EarthView{
	namespace World{
		namespace Spatial2D{
			namespace Controls{
				class EV_MAPCONTROL_DLL CToolRoundRectangle : public CNewNonPointTypeTool
				{
				public:
				...
				protected:
					ev_void init();
					EarthView::World::Spatial::Display::ISymbol* mpSketchSymbol;
					EarthView::World::Spatial::Geometry::CRectangleRing* mpRectangle;
					ev_real64 mdValue1, mdValue2;
					CTrackingGeometryItem* mpRatioLineItem;
				ev_private:
					CToolRoundRectangle( EarthView::World::Core::CNameValuePairList *pList );
				protected:
					C_DISABLE_COPY( CToolRoundRectangle )
				};
			}
		}
	}
