#ifndef EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_COMMANDCLEARSELECTION_H
#define EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_COMMANDCLEARSELECTION_H
...
namespace EarthView{
	namespace World{
		namespace Spatial2D{
			namespace Controls{
				class EV_MAPCONTROL_DLL CCommandClearSelection : public CMapCommand
				{
				public:
				...
				ev_private:
					CCommandClearSelection( EarthView::World::Core::CNameValuePairList *pList );
				protected:
					C_DISABLE_COPY( CCommandClearSelection )
				};
			}
		}
	}
