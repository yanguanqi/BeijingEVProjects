#ifndef _EDITING_ELLIPTIC_SECTOR_H
#define _EDITING_ELLIPTIC_SECTOR_H
...
class EV_MAPCONTROL_DLL CEditingEllipticSector : public CEditingCurve
{
public:
	CEditingEllipticSector(){}
...
ev_private:
	CEditingEllipticSector( EarthView::World::Core::CNameValuePairList *pList ) : CEditingCurve( pList ){}
};
			}
		}
	}
