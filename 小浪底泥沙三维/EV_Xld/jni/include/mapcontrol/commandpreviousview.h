#ifndef EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_COMMANDPREVIOUSVIEW_H
#define EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_COMMANDPREVIOUSVIEW_H
...
namespace EarthView{
	namespace World{
		namespace Spatial2D{
			namespace Controls{
				class EV_MAPCONTROL_DLL CCommandPreviousView : public CMapCommand
				{
				public:
				...
				ev_private:
					CCommandPreviousView( EarthView::World::Core::CNameValuePairList *pList );
				protected:
					C_DISABLE_COPY( CCommandPreviousView )
				};
			}
		}
	}
