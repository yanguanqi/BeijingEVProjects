#ifndef EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_DELETEVERTEXCOMMAND_H
#define EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_DELETEVERTEXCOMMAND_H
...
namespace EarthView{
	namespace World{
		namespace Spatial2D{
			namespace Controls{
				class EV_MAPCONTROL_DLL CDeleteVertexCommand : public CMapCommand
				{
				public:
				...
				ev_private:
					CDeleteVertexCommand( EarthView::World::Core::CNameValuePairList *pList );
				protected:
					C_DISABLE_COPY( CDeleteVertexCommand )
				};
			}
		}
	}
