#ifndef EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_TOOLRECTANGLESELECT_H
#define EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_TOOLRECTANGLESELECT_H
	...
	namespace World{
		namespace Spatial2D{
			namespace Controls{
				...
				class EV_MAPCONTROL_DLL CToolRectangleSelect : public CTool2D
				{
				public:
				...
				ev_private:
					CToolRectangleSelect( EarthView::World::Core::CNameValuePairList *pList );
				protected:
					C_DISABLE_COPY( CToolRectangleSelect )
				};
			}
		}
	}
