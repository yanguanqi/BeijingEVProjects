#ifndef EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_TOOLCIRCULARANGLE_H
#define EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_TOOLCIRCULARANGLE_H
...
namespace EarthView{
	namespace World{
		namespace Spatial2D{
			namespace Controls{
				class EV_MAPCONTROL_DLL CToolCircularAngle : public CNewNonPointTypeTool
				{
				public:
				...
				public:
					...
					private:
					EarthView::World::Spatial::Geometry::CCircleArc *getCircleArc(EarthView::World::Spatial::Geometry::CPoint* pTempPoint); 
					ev_void snapGeometry(EarthView::World::Spatial::Geometry::IGeometry *pRect);
					ev_real64 getPlaneAngle(EarthView::World::Spatial::Geometry::CPoint *pPoint);
					ev_void resetData();
					ev_bool isValidPoint(EarthView::World::Spatial::Geometry::CPoint *pPoint);
					CTrackingGeomsItem *m_pLineItems;
					EarthView::World::Spatial::Geometry::CPolyline *m_pOperationLine;
					EarthView::World::Spatial::Geometry::IGeometry *m_pSnapPath;
					EarthView::World::Spatial::Geometry::CLine *m_pStartLine;
					EarthView::World::Spatial::Geometry::CLine *m_pEndLine;
					EarthView::World::Spatial::Geometry::CPoint *m_pCurrentPoint;
					EarthView::World::Spatial::Geometry::CPoint *m_pIntPoint;
					ev_int32 m_nOperationID;
				ev_private:
					CToolCircularAngle( EarthView::World::Core::CNameValuePairList *pList );
					CTrackingLayer *m_pTrackingLayer;
				protected:
					ev_void init();
					C_DISABLE_COPY( CToolCircularAngle )
				};
			}
		}
	}
