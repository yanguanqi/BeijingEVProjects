#ifndef EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_TOOLCIRCLESECTOR_H
#define EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_TOOLCIRCLESECTOR_H
...
namespace EarthView{
	namespace World{
		namespace Spatial2D{
			namespace Controls{
				class EV_MAPCONTROL_DLL CToolCircleSector : public CNewNonPointTypeTool
				{
				public:
				...
				protected:
					ev_void init();
				ev_private:
					CToolCircleSector( EarthView::World::Core::CNameValuePairList *pList );
				protected:
					C_DISABLE_COPY( CToolCircleSector )
				};
			}
		}
	}
