#ifndef EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_REDOCOMMAND_H
#define EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_REDOCOMMAND_H
...
namespace EarthView{
	namespace World{
		namespace Spatial2D{
			namespace Controls{
class COperationObserver;
class EV_MAPCONTROL_DLL CRedoCommand : public CEditCommand
{
public:
...
ev_private:
	CRedoCommand( EarthView::World::Core::CNameValuePairList *pList );
protected:
	ev_void init();
	COperationObserver *mpObserver;
	C_DISABLE_COPY( CRedoCommand )
};
			}
		}
	}
