#ifndef _TOOL_LONG_CIRCLE_H_
#define _TOOL_LONG_CIRCLE_H_
...
namespace EarthView{
	namespace World{
		namespace Spatial2D{
			namespace Controls{
class EV_MAPCONTROL_DLL CToolLongCircle : public CNewNonPointTypeTool
{
public:
...
ev_private:
	CToolLongCircle( EarthView::World::Core::CNameValuePairList *pList );
protected:
	C_DISABLE_COPY( CToolLongCircle )
};
}}}}
#endif