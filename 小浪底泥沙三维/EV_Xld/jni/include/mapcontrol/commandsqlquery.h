#ifndef EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_commandsqlquery_H
#define EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_commandsqlquery_H
...
namespace EarthView{
	namespace World{
		namespace Spatial2D{
			namespace Controls{
				class EV_MAPCONTROL_DLL CCommandSqlQuery : public CMapCommand
				{
				public:
				...
				ev_private:
					CCommandSqlQuery( EarthView::World::Core::CNameValuePairList *pList );
				protected:
					C_DISABLE_COPY( CCommandSqlQuery )
				};
			}
		}
	}
