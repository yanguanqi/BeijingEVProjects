#ifndef EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_COMMANDNEXTVIEW_H
#define EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_COMMANDNEXTVIEW_H
...
namespace EarthView{
	namespace World{
		namespace Spatial2D{
			namespace Controls{
				class EV_MAPCONTROL_DLL CCommandNextView : public CMapCommand
				{
				public:
				...
				ev_private:
					CCommandNextView( EarthView::World::Core::CNameValuePairList *pList );
				protected:
					C_DISABLE_COPY( CCommandNextView )
				};
			}
		}
	}
