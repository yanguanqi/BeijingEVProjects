#ifndef EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_TOOLRECONDITION_H
#define EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_TOOLRECONDITION_H
...
namespace EarthView{
	namespace World{
		namespace Spatial2D{
			namespace Controls{
				class EV_MAPCONTROL_DLL CToolRecondition : public CNewNonPointTypeTool
				{
				public:
					/// <summary>
					/// 默认构造函数
				...
				private:
					ev_void	recondition();
ev_private:
					CToolRecondition( EarthView::World::Core::CNameValuePairList *pList );
					EarthView::World::Spatial::Geometry::CLineString *m_pTempLine;
				protected:
					ev_void init();
					C_DISABLE_COPY( CToolRecondition )
				};
