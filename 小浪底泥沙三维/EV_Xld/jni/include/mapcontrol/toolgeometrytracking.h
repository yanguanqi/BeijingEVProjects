#ifndef EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_TOOLGEOMETRYTRAKING_H
#define EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_TOOLGEOMETRYTRAKING_H
...
namespace EarthView{
	namespace World{
		namespace Spatial2D{
			namespace Controls{
				class EV_MAPCONTROL_DLL CToolGeometryTracking : public CNewNonPointTypeTool
				{
				public:
				...
				public:
					...
					ev_void trackingPoint(ev_real64 x, ev_real64 y);
					
				private:
					enum TrackingDirection
					{
						TD_Unknow            = 0,
						TD_ForwardDirection  = 1,
						TD_OppositeDirection = 2,
					};
					CTrackingLayer *m_pTrackingLayer;
					EarthView::World::Spatial::Geometry::CLineString *m_pTrackingLine;
					EarthView::World::Spatial::Geometry::CLineString *m_pSnapLine;	
					EarthView::World::Spatial::Geometry::CPoint *m_pEndPoint;
					ev_int32 mdCurrentSegIndex;
					CTrackingGeometryItem *m_pTrackLineItem;
					CTrackingGeometryItem *m_pSnapLineItem;
					TrackingDirection mnTrackingDirection;
					ev_int32 m_nLastFlag;
				ev_private:
					CToolGeometryTracking( EarthView::World::Core::CNameValuePairList *pList );
				protected:
					ev_void init();
					C_DISABLE_COPY( CToolGeometryTracking )
				};
			}
		}
	}
