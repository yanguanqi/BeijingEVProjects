#ifndef EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_TOOLSPLITOBJECT_H
#define EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_TOOLSPLITOBJECT_H
...
namespace EarthView{
	namespace World{
		namespace Spatial2D{
			namespace Controls{
				class EV_MAPCONTROL_DLL CToolSplitObject : public CNewNonPointTypeTool
				{
				public:
					/// <summary>
					/// 默认构造函数
				...
				public:
					...
					private:
					ev_void	splitFeature(EarthView::World::Spatial::Geometry::IGeometry *pSplitGeom);
					ev_void updateTracking(EarthView::World::Spatial::Geometry::EVGeometryType geomType);
					EarthView::World::Spatial::Geometry::IGeometry *getSnapPoint(EarthView::World::Spatial::Geometry::CPoint *pTempPoint);
				ev_private:
					CToolSplitObject( EarthView::World::Core::CNameValuePairList *pList );
					CTrackingLayer *m_pTrackingLayer;
					EarthView::World::Spatial::Geometry::EVGeometryType m_splitGeomType;
					EarthView::World::Spatial::Geometry::CLineString *m_pTempLine;
					EarthView::World::Spatial2D::Controls::CTrackingGeomsItem *m_pPointItem;
				protected:
					ev_void init();
					C_DISABLE_COPY( CToolSplitObject )
				};
