#ifndef EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_COMMANDREFRESH_H
#define EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_COMMANDREFRESH_H
...
namespace EarthView{
	namespace World{
		namespace Spatial2D{
			namespace Controls{
				class EV_MAPCONTROL_DLL CCommandRefresh : public CMapCommand
				{
				public:
				...
				ev_private:
					CCommandRefresh( EarthView::World::Core::CNameValuePairList *pList );
				protected:
					C_DISABLE_COPY( CCommandRefresh )
				};
			}
		}
	}
