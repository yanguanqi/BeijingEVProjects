#ifndef EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_TOOLTANGENTCURVE_H
#define EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_TOOLTANGENTCURVE_H
...
namespace EarthView{
	namespace World{
		namespace Spatial2D{
			namespace Controls{
				class EV_MAPCONTROL_DLL CToolTangentCurve : public CNewCurveTypeTool
				{
				public:
				...
				public:
					...
					private:
					ev_void	cutApartFeature(EarthView::World::Spatial::GeoDataset::IFeature *pSrcFeature);
				ev_private:
					CToolTangentCurve( EarthView::World::Core::CNameValuePairList *pList );
					CTrackingLayer *m_pTrackingLayer;
				private:
					EarthView::World::Spatial::Geometry::CPoint *getControlPoint(EarthView::World::Spatial::Geometry::CPoint *firstPoint, EarthView::World::Spatial::Geometry::CPoint *secondPoint);
					ev_bool m_bDrawFinish;
					ev_bool m_bBezierCurve;
				protected:
					ev_void init();
					C_DISABLE_COPY( CToolTangentCurve )
				};
			}
		}
	}
