#ifndef EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_COMMANDBUFFERANALYSIS_H
#define EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_COMMANDBUFFERANALYSIS_H
...
namespace EarthView{
	namespace World{
		namespace Spatial2D{
			namespace Controls{
				class EV_MAPCONTROL_DLL CCommandBufferAnalysis : public CMapCommand
				{
				public:
				...
				ev_private:
					CCommandBufferAnalysis( EarthView::World::Core::CNameValuePairList *pList );
				protected:
					C_DISABLE_COPY( CCommandBufferAnalysis )
				private:
					ev_bool isExistVectorLayer( EarthView::World::Spatial::Atlas::IMap* map );
				};
			}
		}
	}
