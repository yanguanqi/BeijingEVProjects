#ifndef EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_UNDOCOMMAND_H
#define EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_UNDOCOMMAND_H
...
class EV_MAPCONTROL_DLL CUndoCommand : public CEditCommand
{
public:
...
ev_private:
	CUndoCommand( EarthView::World::Core::CNameValuePairList *pList );
protected:
	ev_void init();
	COperationObserver *mpObserver;
	C_DISABLE_COPY( CUndoCommand )
};
			}
		}
	}
