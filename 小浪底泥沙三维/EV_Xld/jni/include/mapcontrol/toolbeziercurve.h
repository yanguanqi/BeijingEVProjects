#ifndef EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_TOOL_BERZIRCURVE_H
#define EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_TOOL_BERZIRCURVE_H
...
namespace EarthView{
	namespace World{
		namespace Spatial2D{
			namespace Controls{
				class EV_MAPCONTROL_DLL CToolBezierCurve : public CNewCurveTypeTool
				{
				public:
				...
				public:
					...
					private:
						...
						//获取对称点
						CPoint getSymmetricalPoint(CPoint centerPoint, CPoint currentPoint);
						//是否完成绘图
						ev_bool m_bDrawFinish;
						//辅助线
						CTrackingGeometryItem* m_pAssistLineItem;
						//跟踪层
						CTrackingLayer *m_pTrackingLayer;
						//前个部分的顶点数
						ev_int32 m_nLastPointCount;
			    ...
			    ev_private:
					...
					/// <returns></returns>
					/// <memo></memo>
					CToolBezierCurve( EarthView::World::Core::CNameValuePairList *pList );
				protected:
					C_DISABLE_COPY( CToolBezierCurve )
				};
			}
		}
	}
