#ifndef EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_ADDVERTEXCOMMAND_H
#define EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_ADDVERTEXCOMMAND_H
...
namespace EarthView{
	namespace World{
		namespace Spatial2D{
			namespace Controls{
				class EV_MAPCONTROL_DLL CAddVertexCommand : public CMapCommand
				{
				public:
				...
				ev_private:
					CAddVertexCommand( EarthView::World::Core::CNameValuePairList *pList );
				protected:
					C_DISABLE_COPY( CAddVertexCommand )
				};
			}
		}
	}
