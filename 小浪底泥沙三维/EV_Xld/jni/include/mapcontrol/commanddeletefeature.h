#ifndef _COMMAND_DELETE_FEATRUE_H_
#define _COMMAND_DELETE_FEATRUE_H_
...
namespace EarthView{
	namespace World{
		namespace Spatial2D{
			namespace Controls{
				class EV_MAPCONTROL_DLL CCommandDeleteFeature : public CMapCommand
				{
				public:
				...
				ev_private:
					CCommandDeleteFeature( EarthView::World::Core::CNameValuePairList *pList );
				protected:
					C_DISABLE_COPY( CCommandDeleteFeature )
				};
			}
		}
	}
