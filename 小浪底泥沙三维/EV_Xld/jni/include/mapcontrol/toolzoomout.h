#ifndef _TOOL_ZOOM_OUT_H_
#define _TOOL_ZOOM_OUT_H_
	...
	namespace World{
		namespace Spatial2D{
			namespace Controls{
				...
				class EV_MAPCONTROL_DLL CToolZoomOut : public CTool2D
				{
				public:
...
ev_private:
					CToolZoomOut( EarthView::World::Core::CNameValuePairList *pList );
				protected:
					C_DISABLE_COPY( CToolZoomOut )
				};
			}
		}
	}
