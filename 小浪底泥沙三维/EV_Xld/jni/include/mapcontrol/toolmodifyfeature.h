#ifndef EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_TOOLMODIFYFEATURE_H
#define EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_TOOLMODIFYFEATURE_H
	...
	namespace World{
		namespace Spatial2D{
			namespace Controls{
				...
				class EV_MAPCONTROL_DLL CToolModifyFeature : public CEditTool
				{
				public:
				...
				protected:
					ev_void init();
					ModifyMode m_eMode;
					EarthView::World::Spatial::Geometry::CPoint mAssitant;
					CEditingObject *mpSnappedPart;
				ev_private:
					CToolModifyFeature( EarthView::World::Core::CNameValuePairList *pList );
				protected:
					C_DISABLE_COPY( CToolModifyFeature )
				};
			}
		}
	}
