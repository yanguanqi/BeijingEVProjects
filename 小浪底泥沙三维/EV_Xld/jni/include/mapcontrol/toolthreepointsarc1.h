#ifndef _TOOL_THREE_POINTS_ARC1_H_
#define _TOOL_THREE_POINTS_ARC1_H_
...
namespace EarthView{
	namespace World{
		namespace Spatial2D{
			namespace Controls{
class EV_MAPCONTROL_DLL CToolThreePointsArc1 : public CNewCurveTypeTool
{
public:
...
public:
	...
	private:
	ev_void updateDrawFinish( const IGeometry *geometry);
	ev_bool m_bDrawFinish;
	ev_bool m_bBezierCurve;
ev_private:
	CToolThreePointsArc1( EarthView::World::Core::CNameValuePairList *pList );
protected:
	ev_void init();
	C_DISABLE_COPY( CToolThreePointsArc1 )
};
			}
		}
	}
