#ifndef EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_TOOLSKETCH_H
#define EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_TOOLSKETCH_H
...
namespace EarthView{
	namespace World{
		namespace Spatial2D{
			namespace Controls{
				class EV_MAPCONTROL_DLL CToolSketch : public CNewGeometryTool
				{
				public:
				...
				protected:
					ev_void init();
				ev_private:
					CToolSketch( EarthView::World::Core::CNameValuePairList *pList );
				};
			}
		}
	}
