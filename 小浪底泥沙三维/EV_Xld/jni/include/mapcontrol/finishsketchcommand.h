#ifndef _FINISH_SKETCH_COMMAND_H_
#define _FINISH_SKETCH_COMMAND_H_
...
namespace EarthView{
	namespace World{
		namespace Spatial2D{
			namespace Controls{
				class EV_MAPCONTROL_DLL CFinishSketchCommand : public CMapCommand
				{
				public:
				...
				ev_private:
					CFinishSketchCommand( EarthView::World::Core::CNameValuePairList *pList );
				protected:
					C_DISABLE_COPY( CFinishSketchCommand )
				};
			}
		}
	}
