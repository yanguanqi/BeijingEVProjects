#ifndef EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_TOOL2D_H
#define EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_TOOL2D_H
...
namespace EarthView{
	namespace World{
		namespace Spatial2D{
			namespace Controls{
				class CMapControl;
				class EV_MAPCONTROL_DLL CTool2D : public EarthView::World::Spatial::SystemUI::ITool
				{
				public:
				...
				ev_private:
					CTool2D( EarthView::World::Core::CNameValuePairList *pList );
				ev_internal:
					CTool2D();
