#ifndef EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_TOOLPOLYGONSELECT_H
#define EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_TOOLPOLYGONSELECT_H
	...
	namespace World{
		namespace Spatial2D{
			namespace Controls{
				...
				class EV_MAPCONTROL_DLL CToolPolygonSelect : public CTool2D
				{
				public:
				...
				protected:
					...
					EarthView::World::Spatial::Geometry::CLineString *mpCoords;
				...
				ev_private:
					CToolPolygonSelect( EarthView::World::Core::CNameValuePairList *pList );
				protected:
					C_DISABLE_COPY( CToolPolygonSelect )
				};
			}
		}
	}
