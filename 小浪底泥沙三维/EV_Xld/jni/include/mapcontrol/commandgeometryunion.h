#ifndef EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_COMMANDGEOMETRYUNION_H
#define EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_COMMANDGEOMETRYUNION_H
...
namespace EarthView{
	namespace World{
		namespace Spatial2D{
			namespace Controls{
				class EV_MAPCONTROL_DLL CCommandGeometryUnion : public CEditCommand
				{
				public:
				...
				ev_private:
					CCommandGeometryUnion( EarthView::World::Core::CNameValuePairList *pList );
				protected:
					C_DISABLE_COPY( CCommandGeometryUnion )
				};
			}
		}
	}
