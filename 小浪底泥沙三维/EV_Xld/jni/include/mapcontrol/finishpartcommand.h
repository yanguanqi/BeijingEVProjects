#ifndef _FINISH_PART_COMMAND_H_
#define _FINISH_PART_COMMAND_H_
...
namespace EarthView{
	namespace World{
		namespace Spatial2D{
			namespace Controls{
				class EV_MAPCONTROL_DLL CFinishPartCommand : public CMapCommand
				{
				public:
				...
				ev_private:
					CFinishPartCommand( EarthView::World::Core::CNameValuePairList *pList );
				protected:
					C_DISABLE_COPY( CFinishPartCommand )
				};
			}
		}
	}
