#ifndef EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_TOOLTRIM_H
#define EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_TOOLTRIM_H
...
namespace EarthView{
	namespace World{
		namespace Spatial2D{
			namespace Controls{
				class EV_MAPCONTROL_DLL CToolTrim : public CNewNonPointTypeTool
				{
				public:
				...
				private:
					ev_void trimGeometry(EarthView::World::Spatial::Geometry::IGeometry *pRect);
				...
				ev_private:
					CToolTrim( EarthView::World::Core::CNameValuePairList *pList );
