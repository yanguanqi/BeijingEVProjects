#ifndef EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_TOOLCLIPFEATURE_H
#define EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_TOOLCLIPFEATURE_H
...
namespace EarthView{
	namespace World{
		namespace Spatial2D{
			namespace Controls{
				class EV_MAPCONTROL_DLL CToolClipFeature : public CNewNonPointTypeTool
				{
				public:
					/// <summary>
					/// 默认构造函数
				...
				public:
					...
					private:
					ev_void	clipFeature();
					EarthView::World::Spatial::Geometry::CRectangleRing *createRectangleRing();
					EarthView::World::Spatial::Geometry::CPoint* m_pFirstPoint;
				ev_private:
					CToolClipFeature( EarthView::World::Core::CNameValuePairList *pList );
				protected:
					ev_void init();
					C_DISABLE_COPY( CToolClipFeature )
				};
