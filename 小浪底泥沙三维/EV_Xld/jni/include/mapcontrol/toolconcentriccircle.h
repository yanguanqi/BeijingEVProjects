#ifndef EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_TOOLCONCENTRICCIRCLE_H
#define EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_TOOLCONCENTRICCIRCLE_H
...
namespace EarthView{
	namespace World{
		namespace Spatial2D{
			namespace Controls{
				class EV_MAPCONTROL_DLL CToolConcentricCircle : public CNewGeometryTool
				{
				public:
				...
				ev_private:
					CToolConcentricCircle( EarthView::World::Core::CNameValuePairList *pList );
				protected:
					C_DISABLE_COPY( CToolConcentricCircle )
				};
			}
		}
	}
