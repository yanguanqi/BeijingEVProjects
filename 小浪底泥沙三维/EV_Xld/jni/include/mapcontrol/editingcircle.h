#ifndef _EDITING_LINE_CIRCLE_H
#define _EDITING_LINE_CIRCLE_H
...
namespace EarthView{
	namespace World{
		namespace Spatial2D{
			namespace Controls{
class EV_MAPCONTROL_DLL CEditingCircle : public CEditingCurve
{
public:
	CEditingCircle(){}
...
ev_private:
	CEditingCircle( EarthView::World::Core::CNameValuePairList *pList ) : CEditingCurve( pList ){}
};
			}
		}
	}
