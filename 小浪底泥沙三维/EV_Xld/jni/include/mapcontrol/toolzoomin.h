#ifndef _TOOL_ZOOM_IN_H_
#define _TOOL_ZOOM_IN_H_
	...
	namespace World{
		namespace Spatial2D{
			namespace Controls{
				...
				class EV_MAPCONTROL_DLL CToolZoomIn : public CTool2D
				{
				public:
...
ev_private:
					CToolZoomIn( EarthView::World::Core::CNameValuePairList *pList );
				protected:
					C_DISABLE_COPY( CToolZoomIn )
				};
			}
		}
	}
