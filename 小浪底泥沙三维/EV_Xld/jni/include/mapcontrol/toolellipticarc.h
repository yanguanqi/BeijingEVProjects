#ifndef EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_TOOLELLIPTICARC_H
#define EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_TOOLELLIPTICARC_H
...
namespace EarthView{
	namespace World{
		namespace Spatial2D{
			namespace Controls{
				class EV_MAPCONTROL_DLL CToolEllipticArc : public CNewNonPointTypeTool
				{
				public:
				...
				ev_private:
					CToolEllipticArc( EarthView::World::Core::CNameValuePairList *pList );
				protected:
					ev_void init();
					C_DISABLE_COPY( CToolEllipticArc )
				};
			}
		}
	}
