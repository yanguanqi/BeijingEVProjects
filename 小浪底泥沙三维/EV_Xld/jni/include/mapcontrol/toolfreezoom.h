#ifndef _TOOL_FREE_ZOOM_H_
#define _TOOL_FREE_ZOOM_H_
...
namespace EarthView{
	namespace World{
		namespace Spatial2D{
			namespace Controls{
				class EV_MAPCONTROL_DLL CToolFreeZoom : public CTool2D
				{
				public:
				...
				ev_private:
					CToolFreeZoom( EarthView::World::Core::CNameValuePairList *pList );
				protected:
					C_DISABLE_COPY( CToolFreeZoom )
				};
			}
		}
	}
