#ifndef _TOOL_POINT_SELECT_H_
#define _TOOL_POINT_SELECT_H_
...
namespace EarthView{
	namespace World{
		namespace Spatial2D{
			namespace Controls{
				class EV_MAPCONTROL_DLL CToolPointSelect : public CTool2D
				{
				public:
				...
				protected:
					ev_void init();
ev_private:
					CToolPointSelect( EarthView::World::Core::CNameValuePairList *pList );
				protected:
					C_DISABLE_COPY( CToolPointSelect )
				};
			}
		}
	}
