#ifndef EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_TOOLELLIPSECHORD_H
#define EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_TOOLELLIPSECHORD_H
...
namespace EarthView{
	namespace World{
		namespace Spatial2D{
			namespace Controls{
				class EV_MAPCONTROL_DLL CToolEllipticArched : public CNewNonPointTypeTool
				{
				public:
				...
				ev_private:
					CToolEllipticArched( EarthView::World::Core::CNameValuePairList *pList );
				protected:
					ev_void init();
					C_DISABLE_COPY( CToolEllipticArched )
				};
			}
		}
	}
