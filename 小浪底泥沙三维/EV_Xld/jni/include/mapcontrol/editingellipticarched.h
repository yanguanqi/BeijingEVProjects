#ifndef _EDITING_ELLIPTIC_ARCHED_H
#define _EDITING_ELLIPTIC_ARCHED_H
...
namespace EarthView{
	namespace World{
		namespace Spatial2D{
			namespace Controls{
class EV_MAPCONTROL_DLL CEditingEllipticArched : public CEditingCurve
{
public:
	CEditingEllipticArched(){}
...
ev_private:
	CEditingEllipticArched( EarthView::World::Core::CNameValuePairList *pList ) : CEditingCurve( pList ){}
};
			}
		}
	}
