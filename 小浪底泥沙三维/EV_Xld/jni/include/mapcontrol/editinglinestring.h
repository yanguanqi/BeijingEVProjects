#ifndef _EDITING_LINE_STRING_H
#define _EDITING_LINE_STRING_H
...
namespace EarthView{
	namespace World{
		namespace Spatial2D{
			namespace Controls{
class EV_MAPCONTROL_DLL CEditingLineString : public CEditingCurve
{
public:
	CEditingLineString(){}
...
ev_private:
	CEditingLineString( EarthView::World::Core::CNameValuePairList *pList ) : CEditingCurve( pList ){}
};
			}
		}
	}
