#ifndef EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_COMMANDSIMPLIFY_H
#define EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_COMMANDSIMPLIFY_H
...
namespace EarthView{
	namespace World{
		namespace Spatial2D{
			namespace Controls{
				class EV_MAPCONTROL_DLL CCommandSimplify : public CEditCommand
				{
				public:
				...
				public:
					...
					/// <returns></returns>
					ev_bool simplifyFeature(ev_real64 dDeviation);
				...
				ev_private:
					CCommandSimplify( EarthView::World::Core::CNameValuePairList *pList );
					CTrackingLayer *m_pTrackingLayer;
				protected:
					ev_void init();
					C_DISABLE_COPY( CCommandSimplify )
				};
			}
		}
	}
