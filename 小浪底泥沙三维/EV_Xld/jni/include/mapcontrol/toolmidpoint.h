#ifndef EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_TOOLMIDPOINT_H
#define EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_TOOLMIDPOINT_H
...
namespace EarthView{
	namespace World{
		namespace Spatial2D{
			namespace Controls{
				class EV_MAPCONTROL_DLL CToolMidpoint : public CNewGeometryTool
				{
				public:
				...
				public:
					...
					private:
					EarthView::World::Spatial::Geometry::CPoint *getMidPoint();
					ev_void init();
					private:
					EarthView::World::Spatial::Geometry::CPoint *m_pFirstPoint;
				ev_private:
					CToolMidpoint( EarthView::World::Core::CNameValuePairList *pList );
					CTrackingLayer *m_pTrackingLayer;
					CTrackingGeometryItem *m_pLineItem;
					CTrackingGeometryItem *m_pPointItem;
					ev_bool m_bEditPoint;
				protected:
					C_DISABLE_COPY( CToolMidpoint )
				};
			}
		}
	}
