#ifndef EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_TOOLSTRETCH_H
#define EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_TOOLSTRETCH_H
...
namespace EarthView{
	namespace World{
		namespace Spatial2D{
			namespace Controls{
				class EV_MAPCONTROL_DLL CToolStretch : public CNewNonPointTypeTool
				{
				public:
				...
				public:
					...
					private:
					ev_void extendGeometry(EarthView::World::Spatial::Geometry::IGeometry *pRect);
					private:
						CTrackingGeometryItem *m_pLineItem;
						EarthView::World::Spatial::Geometry::IGeometry *m_pRefGeometry;
						EarthView::World::Spatial::Geometry::CPoint *m_pCurrentPoint;
				ev_private:
					CToolStretch( EarthView::World::Core::CNameValuePairList *pList );
					CTrackingLayer *m_pTrackingLayer;
				protected:
					ev_void init();
					C_DISABLE_COPY( CToolStretch )
				};
			}
		}
	}
