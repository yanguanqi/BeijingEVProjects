#ifndef EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_TOOLELLIPSE_H
#define EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_TOOLELLIPSE_H
...
namespace EarthView{
	namespace World{
		namespace Spatial2D{
			namespace Controls{
				class EV_MAPCONTROL_DLL CToolEllipse : public CNewNonPointTypeTool
				{
				public:
				...
				public:
					...
					private:
						void initData();
				ev_private:
					CToolEllipse( EarthView::World::Core::CNameValuePairList *pList );
				protected:
					C_DISABLE_COPY( CToolEllipse )
				};
			}
		}
	}
