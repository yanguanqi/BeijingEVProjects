#ifndef EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_TOOLRIGHTANGLERESTRAIN_H
#define EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_TOOLRIGHTANGLERESTRAIN_H
...
namespace EarthView{
	namespace World{
		namespace Spatial2D{
			namespace Controls{
				class EV_MAPCONTROL_DLL CToolRightangleRestrain : public CNewNonPointTypeTool
				{
				public:
				...
				ev_private:
					CToolRightangleRestrain( EarthView::World::Core::CNameValuePairList *pList );
					CTrackingLayer *m_pTrackingLayer;
				protected:
					ev_void init();
					C_DISABLE_COPY( CToolRightangleRestrain )
				};
			}
		}
	}
