#ifndef _EDITING_CIRCLE_ARCHED_H
#define _EDITING_CIRCLE_ARCHED_H
...
namespace EarthView{
	namespace World{
		namespace Spatial2D{
			namespace Controls{
class EV_MAPCONTROL_DLL CEditingCircleArched : public CEditingCurve
{
public:
	CEditingCircleArched(){}
...
ev_private:
	CEditingCircleArched( EarthView::World::Core::CNameValuePairList *pList ) : CEditingCurve( pList ){}
};
			}
		}
	}
