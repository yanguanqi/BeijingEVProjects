#ifndef EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_TOOLTWOPOINTCIRCLE_H
#define EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_TOOLTWOPOINTCIRCLE_H
...
namespace EarthView{
	namespace World{
		namespace Spatial2D{
			namespace Controls{
				class EV_MAPCONTROL_DLL CToolTwoPointsCircle : public CNewNonPointTypeTool
				{
				public:
				...
				ev_private:
					CToolTwoPointsCircle( EarthView::World::Core::CNameValuePairList *pList );
				protected:
					C_DISABLE_COPY( CToolTwoPointsCircle )
				};
			}
		}
	}
