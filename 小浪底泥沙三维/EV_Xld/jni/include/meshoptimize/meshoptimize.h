		...
		public:
			...
			~CMeshOptimizeParams();
			 ...
			 ev_void  operator=(CMeshOptimizeParams& params)
			 {
				 ...
				 mUseBoundboxSizeDiscardSubmesh = params.getUseBoundboxSizeDiscardSubmesh();
				 mDiscardBoundBoxSize = params.getDiscardBoundBoxSize();
				 mDiscardBoundBoxSizeForMesh = params.getDiscardBoundBoxSizeForMesh();
			 };
			...
			//获取或设置是否根据包围盒大小抛弃SubMesh
			ev_void setUseBoundboxSizeDiscardSubmesh(ev_bool useBoundboxSizeDiscard);
			ev_bool getUseBoundboxSizeDiscardSubmesh();

			//获取或设置包围盒丢弃大小
			ev_void setDiscardBoundBoxSize(ev_real32 discardBoundBoxSize);
			ev_real32 getDiscardBoundBoxSize();

			//获取或设置mesh的包围盒丢弃大小
			ev_void setDiscardBoundBoxSizeForMesh(ev_real32 discardBoundBoxSizeForSize);
			ev_real32 getDiscardBoundBoxSizeForMesh();
		private:
			//
			ev_void initVar();
