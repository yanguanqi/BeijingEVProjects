#ifndef EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_COMMANDSTARTEDITING_H
#define EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_COMMANDSTARTEDITING_H
	...
	namespace World{
		namespace Spatial2D{
			namespace Controls{
				...
				/// 是否可以选择、点击命令、操作更新
				/// </summary>
				class EV_2DPROXY_DLL CCommandStartEditing : public EarthView::World::Spatial2D::Controls::CEditCommand
				{
				public:
					/// <summary>
					/// 默认构造函数
				...
				ev_private:
					CCommandStartEditing( EarthView::World::Core::CNameValuePairList *pList );
				protected:
					C_DISABLE_COPY( CCommandStartEditing )
				};
			}
		}
	}
