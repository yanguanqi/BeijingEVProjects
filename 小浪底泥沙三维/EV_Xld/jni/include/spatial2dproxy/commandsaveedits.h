#ifndef EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_COMMANDSAVEEDITING_H
#define EARTHVIEW_WORLD_SPATIAL2D_CONTROLS_COMMANDSAVEEDITING_H
...
namespace EarthView{
	namespace World{
		namespace Spatial2D{
			namespace Controls{
				class EV_2DPROXY_DLL CCommandSaveEdits : public EarthView::World::Spatial2D::Controls::CMapCommand
				{
				public:
				...
				ev_private:
					CCommandSaveEdits( EarthView::World::Core::CNameValuePairList *pList );
				protected:
					C_DISABLE_COPY( CCommandSaveEdits )
				};
			}
		}
	}
