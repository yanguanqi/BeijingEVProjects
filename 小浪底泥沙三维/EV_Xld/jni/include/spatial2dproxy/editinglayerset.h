#ifndef _EDITINGLAYER_SET_H_
#define _EDITINGLAYER_SET_H_
...
/// </summary>
class EV_2DPROXY_DLL CEditingLayerSet : public EarthView::World::Spatial::SystemUI::IEntryBox
{
public:
	/// <summary>
	/// 默认构造函数
...
ev_private:
	CEditingLayerSet( EarthView::World::Core::CNameValuePairList* pList );
protected:
	ev_void addLayer( _in EarthView::World::Spatial::Atlas::ILayer* layer );
	ev_bool removeLayer( _in EarthView::World::Spatial::Atlas::ILayer* layer );
	ev_bool mbEnabled;
	EarthView::World::Spatial2D::Controls::CMapControl* mpMapControl;
	ev_vector<EarthView::World::Spatial::Atlas::ILayer*> mEditingLayers;
	ev_int32 mnCurrentIndex;

	C_DISABLE_COPY( CEditingLayerSet )
};
#endif
