#ifndef _NETWORK_ANALYST_TOOL_STOP_H_H_
#define _NETWORK_ANALYST_TOOL_STOP_H_H_
...
/// 网络分析停靠点
/// </summary>
class EV_2DPROXY_DLL CNAToolStop :  public EarthView::World::Spatial2D::Controls::CTool2D
{
public:
	/// <summary>
	/// 构造函数
	...
	/// <returns></returns>
	CNAToolStop(CNetworkAnalystToolBar *ref_bar);
	/// <summary>
	/// 析构函数
	/// </summary>
	/// <param name=""></param>
...
ev_private:
	CNAToolStop( EarthView::World::Core::CNameValuePairList *pList );
protected:
	C_DISABLE_COPY(	CNAToolStop)
