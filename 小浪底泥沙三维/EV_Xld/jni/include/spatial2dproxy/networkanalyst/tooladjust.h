#ifndef _NETWORK_ANALYST_TOOL_ADJUST_H_H_
#define _NETWORK_ANALYST_TOOL_ADJUST_H_H_
...
///网络分析位置调整命令
///</summary>
class EV_2DPROXY_DLL CNAToolAdjust : public EarthView::World::Spatial2D::Controls::CTool2D
{
public:
	/// <summary>
	/// 构造函数
	...
	/// <returns></returns>
	CNAToolAdjust(CNetworkAnalystToolBar *ref_bar);
	/// <summary>
	/// 析构函数
	/// </summary>
	/// <param name=""></param>
...
private:
	EarthView::World::Spatial::Display::ISymbol* getSelectedSymbol();

ev_private:
	CNAToolAdjust( EarthView::World::Core::CNameValuePairList *pList );
protected:
	C_DISABLE_COPY(	CNAToolAdjust)
private:
	EarthView::World::Spatial2D::Controls::CTrackingGeometryItem	*m_pItem;
	...
	EarthView::World::Spatial::Geometry::CPoint					*m_pMovePoint;
	EarthView::World::Spatial::Display::ISymbol					*m_pMoveSymbol;

	EarthView::World::Spatial::Geometry::CPoint					*m_pOrigin;
	EarthView::World::Spatial2D::Analyst::EVNAAttachType			m_attachType;
