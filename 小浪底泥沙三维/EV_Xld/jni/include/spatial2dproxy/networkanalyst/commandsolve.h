#ifndef _NETWORK_ANALYST_TOOL_SOLVE_H_H_
#define _NETWORK_ANALYST_TOOL_SOLVE_H_H_
...
/// 网络分析求解命令
/// </summary>
class EV_2DPROXY_DLL CNACmdSolve : public EarthView::World::Spatial::SystemUI::ICommand
{
public:
	/// <summary>
	/// 构造函数
	...
	/// <returns></returns>
	CNACmdSolve(CNetworkAnalystToolBar *ref_bar);
	/// <summary>
	/// 默认析构函数
	/// </summary>
	~CNACmdSolve();
...
ev_private:
	CNACmdSolve( EarthView::World::Core::CNameValuePairList *pList );
protected:
	C_DISABLE_COPY(	CNACmdSolve)
private:
	ev_bool					m_bEnable;
