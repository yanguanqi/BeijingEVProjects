#ifndef mstiledownload_metadata_h_H
#define mstiledownload_metadata_h_H
#include "mstiledownload/mstiledll.h"
#include "download/webmetadataserviceconnection.h"

namespace MSTile{

	class EV_MSTILE_DOWNLOAD_DLL MSTileMetadata : public EarthView::World::Spatial::Download::WebMetadataServiceConnectionImp
	{
	public:
		MSTileMetadata();
		~MSTileMetadata();
