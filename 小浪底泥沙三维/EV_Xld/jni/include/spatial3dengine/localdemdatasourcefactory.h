#ifndef EARTHVIEW_WORLD_SPATIAL3D_LOCALDEMDATASOURCEFACTORY_H
#define EARTHVIEW_WORLD_SPATIAL3D_LOCALDEMDATASOURCEFACTORY_H
...
namespace EarthView{
	namespace World{
		namespace Spatial3D{
				...
				class EV_Spatial3DEngine_DLL CLocalDemDataSourceFactory:public EarthView::World::Spatial::GeoDataset::IDataSourceFactory
				{
				private:
					static EarthView::World::Spatial3D::CLocalDemDataSourceFactory* mSingletonPtr;
				public:
					/// <summary>
					/// 构造函数
					/// </summary>
					/// <returns></returns>
					CLocalDemDataSourceFactory();
ev_private:
					/// <summary>
					/// 构造函数
					/// </summary>
					...
					/// <returns></returns>
					CLocalDemDataSourceFactory(EarthView::World::Core::CNameValuePairList* pList);
				public:
					/// <summary>
					/// 析构函数
					/// </summary>
					/// <returns></returns>
					virtual ~CLocalDemDataSourceFactory();
					/// <summary>
					/// 返回单例的数据源工厂句柄
					/// </summary>
					/// <returns>CModelDataSourceFactory，失败则返回NULL</returns>
					static EarthView::World::Spatial3D::CLocalDemDataSourceFactory* getSingletonPtr();
