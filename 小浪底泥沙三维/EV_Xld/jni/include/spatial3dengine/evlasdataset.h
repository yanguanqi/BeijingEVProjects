#ifndef EARTHVIEW_WORLD_SPATIAL3D_MODELMANAGER_EVLASDATASET_H
#define EARTHVIEW_WORLD_SPATIAL3D_MODELMANAGER_EVLASDATASET_H
	...
	namespace World{
		namespace Spatial3D{
			namespace ModelManager{
				...
				class EV_Spatial3DEngine_DLL CEVLasDataset : public IObqDataset
				{
ev_private:
					/// <summary>
					/// 构造函数
					...
					/// <returns></returns>
					CEVLasDataset(_in EarthView::World::Core::CNameValuePairList *pList);
				...
				public:
					...
					/// <returns></returns>
					CEVLasDataset(const EVString& name, EarthView::World::Spatial::GeoDataset::IDataSource* ref_DataSource);
