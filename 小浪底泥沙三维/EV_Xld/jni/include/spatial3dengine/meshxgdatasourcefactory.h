#ifndef EARTHVIEW_WORLD_SPATIAL3D_MODELMANAGER_MESHXGDATASOURCEFACTORY_H
#define EARTHVIEW_WORLD_SPATIAL3D_MODELMANAGER_MESHXGDATASOURCEFACTORY_H
	...
	namespace World{
		namespace Spatial3D{
			namespace ModelManager{
				class EV_Spatial3DEngine_DLL CMeshXGDataSourceFactory:public EarthView::World::Spatial::GeoDataset::IDataSourceFactory
				{
				private:
					static EarthView::World::Spatial3D::ModelManager::CMeshXGDataSourceFactory* mSingletonPtr;
				public:
					/// <summary>
					/// 构造函数
					/// </summary>
					/// <returns></returns>
					CMeshXGDataSourceFactory();
ev_private:
					/// <summary>
					/// 构造函数
					/// </summary>
					...
					/// <returns></returns>
					CMeshXGDataSourceFactory(EarthView::World::Core::CNameValuePairList* pList);
				public:
					/// <summary>
					/// 析构函数
					/// </summary>
					/// <returns></returns>
					virtual ~CMeshXGDataSourceFactory();
					/// <summary>
					/// 返回单例的数据源工厂句柄
					/// </summary>
					/// <returns>CModelDataSourceFactory，失败则返回NULL</returns>
					static EarthView::World::Spatial3D::ModelManager::CMeshXGDataSourceFactory* getSingletonPtr();
