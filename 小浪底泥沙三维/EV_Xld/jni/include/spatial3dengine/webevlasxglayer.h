#ifndef EARTHVIEW_WORLD_SPATIAL3D_MODELMANAGER_WEBLASXGLAYER_H
#define EARTHVIEW_WORLD_SPATIAL3D_MODELMANAGER_WEBLASXGLAYER_H
...
namespace EarthView{
	namespace World{
		namespace Spatial3D{
			namespace Atlas
			{
				class CWebEVLasXGLayerFactory;

				class EV_Spatial3DEngine_DLL CWebEVLasXGLayer : public CEVLasXGLayer
				{
					friend class CWebEVLasXGLayerFactory;
ev_private:
					/// <summary>
					/// 构造函数
					/// </summary>
					...
					/// <returns></returns>
					CWebEVLasXGLayer(_in EarthView::World::Core::CNameValuePairList *pList);
				protected:
					CWebEVLasXGLayer();
					CWebEVLasXGLayer(const EVString& name, EarthView::World::Spatial::GeoDataset::IDataset* ds);
				public:
					virtual ~CWebEVLasXGLayer();
...
// 					virtual ev_void fromXmlElement( _in EarthView::World::Core::CXmlElement& element);
				...
				/// 类工厂
				/// </summary>
				class EV_Spatial3DEngine_DLL CWebEVLasXGLayerFactory : public  EarthView::World::Spatial::Atlas::ILayerFactory
				{
ev_private:
					/// <summary>
					/// 构造函数
					...
					/// <param name="pList">构造函数参数键值对表</param>
					/// <returns></returns>
					CWebEVLasXGLayerFactory(EarthView::World::Core::CNameValuePairList* pList);
				public:
					/// <summary>
					/// 构造函数
					/// </summary>
					/// <returns></returns>
					CWebEVLasXGLayerFactory();
					/// <summary>
					/// 析构函数
					/// </summary>
					/// <returns></returns>
					virtual ~CWebEVLasXGLayerFactory();
				public:
					/// <summary>
					/// 返回单例的图层工厂
					/// </summary>
					static EarthView::World::Spatial3D::Atlas::CWebEVLasXGLayerFactory* getSingletonPtr();
					/// <summary>
					/// 释放单例的kml图层工厂
					/// </summary>
					/// <returns></returns>
				...
				public:
					static const EVString msWebLasXGLayerFactoryName;
				private:
					static EarthView::World::Spatial3D::Atlas::CWebEVLasXGLayerFactory* mSingletonPtr;
				};
