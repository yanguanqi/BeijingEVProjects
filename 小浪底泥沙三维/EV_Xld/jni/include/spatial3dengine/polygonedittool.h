#ifndef  EV_POLYGONEDITTOOL_H
#define  EV_POLYGONEDITTOOL_H
...
namespace EarthView
{
	namespace World
	{
		namespace Spatial3D
		{
			...
			{
				class EV_Spatial3DEngine_DLL CPolygonEditTool:public EarthView::World::Spatial::SystemUI::ITool
				{
ev_private: 
					/// <summary>
					/// 构造函数
					...
					/// <returns></returns>
					CPolygonEditTool(EarthView::World::Core::CNameValuePairList* pList);
				...
				public:
					...
					/// <returns></returns>
					CPolygonEditTool(EarthView::World::Graphic::CSceneManager* ref_sceneMgr,EarthView::World::Graphic::CCamera* ref_camera,EarthView::World::Graphic::CViewport* ref_viewPort,EarthView::World::Spatial::Kml::CGeoObjectExtension* geoObj,EarthView::World::Spatial::Kml::CKmlDocument* ref_parent);
					/// <summary>
					/// 析构函数
					/// </summary>
					/// <returns></returns>
					...
					ev_void setPolygonExtrude(ev_bool isExtrude);
					ev_bool getPolygonExtrude();
				...
				private:
					...
					list<EarthView::World::Spatial::Math::CVector3> mInnerVerts;
					//list<PositionColor*> mInnerEditVerts;
					...
					//ev_void updateGeoPolygonAlt(double altitude);
