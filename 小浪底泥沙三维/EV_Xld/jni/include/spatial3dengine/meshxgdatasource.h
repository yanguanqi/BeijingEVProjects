#ifndef EARTHVIEW_WORLD_SPATIAL3D_MODELMANAGER_MESHXGDATASOURCE_H
#define EARTHVIEW_WORLD_SPATIAL3D_MODELMANAGER_MESHXGDATASOURCE_H
	...
	namespace World{
		namespace Spatial3D{
			namespace ModelManager{
				...
				class EV_Spatial3DEngine_DLL CMeshXGDataSource : public EarthView::World::Spatial::GeoDataset::IFileDataSource
				{
ev_private:
					/// <summary>
					/// 构造函数
					...
					/// <returns></returns>
					CMeshXGDataSource(_in EarthView::World::Core::CNameValuePairList *pList);
				public:
					CMeshXGDataSource(const EVString& datasourcePath,const EVString& aliasname);
