#ifndef EARTHVIEW_WORLD_SPATIAL3D_LOACALDEMDATASOURCE_H
#define EARTHVIEW_WORLD_SPATIAL3D_LOACALDEMDATASOURCE_H
...
namespace EarthView{
	namespace World{
		namespace Spatial3D{
				...
				class CLocalDemDataSourceFactory;
				enum ImageType
				{
					LocalDem=201,
					CacheDem
				...
				class EV_Spatial3DEngine_DLL CLocalDemDataSource : public EarthView::World::Spatial::GeoDataset::IFileDataSource
				{
ev_private:
					/// <summary>
					/// 构造函数
					...
					/// <returns></returns>
					CLocalDemDataSource(_in EarthView::World::Core::CNameValuePairList *pList);
				public:
					CLocalDemDataSource(const EVString& datasourcePath,const EVString& aliasname);
				...
				protected:
					friend class CLocalDemDataSourceFactory;
					friend class CLocalDemDataset;
				private:					
