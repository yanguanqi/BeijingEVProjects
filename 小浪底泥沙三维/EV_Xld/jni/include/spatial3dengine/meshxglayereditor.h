#ifndef EARTHVIEW_WORLD_SPATIAL3D_MESHXGLAYEREDITOR_H
#define EARTHVIEW_WORLD_SPATIAL3D_MESHXGLAYEREDITOR_H
...
namespace EarthView{
	namespace World{
		namespace Spatial3D{
			class CCmdDataBase;
			class CMeshxgEventObject;

			class EV_Spatial3DEngine_DLL CMeshxgLayerEditor : public EarthView::World::Spatial3D::CLayer3DEditor 
			{
			public:
				/*
...
ev_private:
				CMeshxgLayerEditor(_in EarthView::World::Core::CNameValuePairList *pList);

				friend class CMeshxgEventObject;
			protected:
				ev_uint32 mNewID;
				CMeshxgEventObject* mpEventObject;
			};
