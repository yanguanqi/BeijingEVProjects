#ifndef EARTHVIEW_WORLD_SPATIAL3D_MODELMANAGER_MESHXGLAYER_H
#define EARTHVIEW_WORLD_SPATIAL3D_MODELMANAGER_MESHXGLAYER_H
...
namespace EarthView{
	namespace World{
		namespace Spatial3D{
			namespace Atlas
			{
				class CMeshXGLayerFactory;

				class EV_Spatial3DEngine_DLL CMeshXGLayer : public CObliqueModelLayer
				{
					friend class CMeshXGLayerFactory;
ev_private:
					/// <summary>
					/// 构造函数
					/// </summary>
					...
					/// <returns></returns>
					CMeshXGLayer(_in EarthView::World::Core::CNameValuePairList *pList);
				protected:
					CMeshXGLayer();
					CMeshXGLayer(const EVString& name, EarthView::World::Spatial::GeoDataset::IDataset* ds);
				public:
					virtual ~CMeshXGLayer();
				...
				/// 类工厂
				/// </summary>
				class EV_Spatial3DEngine_DLL CMeshXGLayerFactory : public  EarthView::World::Spatial::Atlas::ILayerFactory
				{
ev_private:
					/// <summary>
					/// 构造函数
					...
					/// <param name="pList">构造函数参数键值对表</param>
					/// <returns></returns>
					CMeshXGLayerFactory(EarthView::World::Core::CNameValuePairList* pList);
				public:
					/// <summary>
					/// 构造函数
					/// </summary>
					...
					/// </summary>
					/// <returns></returns>
					virtual ~CMeshXGLayerFactory();
				public:
					/// <summary>
					/// 返回单例的图层工厂
					/// </summary>
					static EarthView::World::Spatial3D::Atlas::CMeshXGLayerFactory* getSingletonPtr();
					/// <summary>
					/// 释放单例的kml图层工厂
					/// </summary>
					/// <returns></returns>
				...
				private:
					static EarthView::World::Spatial3D::Atlas::CMeshXGLayerFactory* mSingletonPtr;
				};
