#ifndef EARTHVIEW_WORLD_SPATIAL3D_MODELMANAGER_LASXGDATASOURCEFACTORY_H
#define EARTHVIEW_WORLD_SPATIAL3D_MODELMANAGER_LASXGDATASOURCEFACTORY_H
	...
	namespace World{
		namespace Spatial3D{
			namespace ModelManager{
				class EV_Spatial3DEngine_DLL CEVLasXGDataSourceFactory:public EarthView::World::Spatial::GeoDataset::IDataSourceFactory
				{
				private:
					static EarthView::World::Spatial3D::ModelManager::CEVLasXGDataSourceFactory* mSingletonPtr;
				public:
					/// <summary>
					/// 构造函数
					/// </summary>
					/// <returns></returns>
					CEVLasXGDataSourceFactory();
ev_private:
					/// <summary>
					/// 构造函数
					/// </summary>
					...
					/// <returns></returns>
					CEVLasXGDataSourceFactory(EarthView::World::Core::CNameValuePairList* pList);
				public:
					/// <summary>
					/// 析构函数
					/// </summary>
					/// <returns></returns>
					virtual ~CEVLasXGDataSourceFactory();
					/// <summary>
					/// 返回单例的数据源工厂句柄
					/// </summary>
					/// <returns>CModelDataSourceFactory，失败则返回NULL</returns>
					static EarthView::World::Spatial3D::ModelManager::CEVLasXGDataSourceFactory* getSingletonPtr();
