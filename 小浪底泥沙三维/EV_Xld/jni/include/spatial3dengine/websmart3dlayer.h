#ifndef EARTHVIEW_WORLD_SPATIAL3D_MODELMANAGER_WEBSMART3DLAYER_H
#define EARTHVIEW_WORLD_SPATIAL3D_MODELMANAGER_WEBSMART3DLAYER_H
...
namespace EarthView{
	namespace World{
		namespace Spatial3D{
			namespace Atlas
			{
				class CWebSmart3DLayerFactory;

				class EV_Spatial3DEngine_DLL CWebSmart3DLayer : public CObliqueModelLayer
				{
					friend class CWebSmart3DLayerFactory;
ev_private:
					/// <summary>
					/// 构造函数
					/// </summary>
					...
					/// <returns></returns>
					CWebSmart3DLayer(_in EarthView::World::Core::CNameValuePairList *pList);
				protected:
					CWebSmart3DLayer();
					CWebSmart3DLayer(const EVString& name, EarthView::World::Spatial::GeoDataset::IDataset* ds);
				public:
					virtual ~CWebSmart3DLayer();
				...
				/// 类工厂
				/// </summary>
				class EV_Spatial3DEngine_DLL CWebSmart3DLayerFactory : public  EarthView::World::Spatial::Atlas::ILayerFactory
				{
ev_private:
					/// <summary>
					/// 构造函数
					...
					/// <param name="pList">构造函数参数键值对表</param>
					/// <returns></returns>
					CWebSmart3DLayerFactory(EarthView::World::Core::CNameValuePairList* pList);
				public:
					/// <summary>
					/// 构造函数
					/// </summary>
					/// <returns></returns>
					CWebSmart3DLayerFactory();
					/// <summary>
					/// 析构函数
					/// </summary>
					/// <returns></returns>
					virtual ~CWebSmart3DLayerFactory();
				public:
					/// <summary>
					/// 返回单例的图层工厂
					/// </summary>
					static EarthView::World::Spatial3D::Atlas::CWebSmart3DLayerFactory* getSingletonPtr();
					/// <summary>
					/// 释放单例的kml图层工厂
					/// </summary>
					/// <returns></returns>
				...
				private:
					static EarthView::World::Spatial3D::Atlas::CWebSmart3DLayerFactory* mSingletonPtr;
				};
