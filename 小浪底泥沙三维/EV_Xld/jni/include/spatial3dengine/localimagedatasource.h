#ifndef EARTHVIEW_WORLD_SPATIAL3D_LOACALIMAGEDATASOURCE_H
#define EARTHVIEW_WORLD_SPATIAL3D_LOACALIMAGEDATASOURCE_H
...
namespace EarthView{
	namespace World{
		namespace Spatial3D{
				...
				class CLocalImageDataSourceFactory;
				enum DemType
				{
					LocalImage=101,
					CacheImage
				...
				class EV_Spatial3DEngine_DLL CLocalImageDataSource : public EarthView::World::Spatial::GeoDataset::IFileDataSource
				{
ev_private:
					/// <summary>
					/// 构造函数
					...
					/// <returns></returns>
					CLocalImageDataSource(_in EarthView::World::Core::CNameValuePairList *pList);
				public:
					CLocalImageDataSource(const EVString& datasourcePath,const EVString& aliasname);
				...
				protected:
					friend class CLocalImageDataSourceFactory;
					friend class CLocalImageDataset;
				private:					
					EarthView::World::Core::ev_stringArray mFilesArray;
					EVString mName;	

					vector<EarthView::World::Spatial::GeoDataset::IDataset*> mDatasets;
					vector<CacheFile> mCacheFiles;
					//vector<EarthView::World::Spatial::CEVWMTSLayerInfo *> mCacheMis;
