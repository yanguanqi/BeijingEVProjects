#ifndef EARTHVIEW_WORLD_SPATIAL3D_MODELMANAGER_SMART3DDATASOURCEFACTORY_H
#define EARTHVIEW_WORLD_SPATIAL3D_MODELMANAGER_SMART3DDATASOURCEFACTORY_H
	...
	namespace World{
		namespace Spatial3D{
			namespace ModelManager{
				class EV_Spatial3DEngine_DLL CSmart3DDataSourceFactory:public EarthView::World::Spatial::GeoDataset::IDataSourceFactory
				{
				private:
					static EarthView::World::Spatial3D::ModelManager::CSmart3DDataSourceFactory* mSingletonPtr;
				public:
					/// <summary>
					/// 构造函数
					/// </summary>
					/// <returns></returns>
					CSmart3DDataSourceFactory();
ev_private:
					/// <summary>
					/// 构造函数
					/// </summary>
					...
					/// <returns></returns>
					CSmart3DDataSourceFactory(EarthView::World::Core::CNameValuePairList* pList);
				public:
					/// <summary>
					/// 析构函数
					/// </summary>
					/// <returns></returns>
					virtual ~CSmart3DDataSourceFactory();
					/// <summary>
					/// 返回单例的数据源工厂句柄
					/// </summary>
					/// <returns>CModelDataSourceFactory，失败则返回NULL</returns>
					static EarthView::World::Spatial3D::ModelManager::CSmart3DDataSourceFactory* getSingletonPtr();
