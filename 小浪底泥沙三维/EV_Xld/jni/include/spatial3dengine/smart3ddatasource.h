#ifndef EARTHVIEW_WORLD_SPATIAL3D_MODELMANAGER_SMART3DDATASOURCE_H
#define EARTHVIEW_WORLD_SPATIAL3D_MODELMANAGER_SMART3DDATASOURCE_H
	...
	namespace World{
		namespace Spatial3D{
			namespace ModelManager{
				class CSmart3DDataSourceFactory;
				
				class EV_Spatial3DEngine_DLL CSmart3DDataSource : public EarthView::World::Spatial::GeoDataset::IFileDataSource
				{
ev_private:
					/// <summary>
					/// 构造函数
					...
					/// <returns></returns>
					CSmart3DDataSource(_in EarthView::World::Core::CNameValuePairList *pList);
				public:
					CSmart3DDataSource(const EVString& datasourcePath,const EVString& aliasname);
				...
				protected:
					friend class CSmart3DDataSourceFactory;
				private:					
