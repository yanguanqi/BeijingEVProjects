#ifndef EARTHVIEW_WORLD_SPATIAL3D_MODELMANAGER_EVLASDATASOURCE_H
#define EARTHVIEW_WORLD_SPATIAL3D_MODELMANAGER_EVLASDATASOURCE_H
	...
	namespace World{
		namespace Spatial3D{
			namespace ModelManager{
				class CEVLasDataSourceFactory;
				
				class EV_Spatial3DEngine_DLL CEVLasDataSource : public EarthView::World::Spatial::GeoDataset::IFileDataSource
				{
ev_private:
					/// <summary>
					/// 构造函数
					...
					/// <returns></returns>
					CEVLasDataSource(_in EarthView::World::Core::CNameValuePairList *pList);
				public:
					CEVLasDataSource(const EVString& datasourcePath,const EVString& aliasname);
				...
				protected:
					friend class CEVLasDataSourceFactory;
				private:					
