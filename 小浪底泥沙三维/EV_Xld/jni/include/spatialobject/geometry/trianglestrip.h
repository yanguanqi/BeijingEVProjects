#ifndef _GEOMETRY_TRIANGLESTRIP_H_
#define _GEOMETRY_TRIANGLESTRIP_H_
	...
	namespace World{
		namespace Spatial{
			namespace Geometry{
				...
				/// 
				/// </summary>
				class EV_GEOMETRY_DLL CTriangleStrip : public EarthView::World::Spatial::Geometry::CSurface
				{
				public:
					/// <summary>
					/// 构造函数
...
ev_private:
					...
					/// <returns></returns>
					CTriangleStrip(EarthView::World::Core::CNameValuePairList* pList);
				public:
					/// <summary>
					/// 获取点
					/// </summary>
                ...
                private:		
                    CTriangleStrip(const CTriangleStrip& obj);
				protected:
