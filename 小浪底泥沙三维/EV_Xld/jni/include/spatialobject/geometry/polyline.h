#ifndef EARTHVIEW_WORLD_SPATIAL_GEOMETRY_POLYLINE_H
#define EARTHVIEW_WORLD_SPATIAL_GEOMETRY_POLYLINE_H
	...
	namespace World{
		namespace Spatial{
			namespace Geometry{
				...
				/// 折线类
				/// </summary>
				class EV_GEOMETRY_DLL CPolyline
				...
				public:
					...
					/// <returns></returns>
					CPolyline();
					CPolyline(const EarthView::World::Spatial::Geometry::CCoordinateSequence& coords);		
					/// <summary>
					/// 默认析构函数
					/// </summary>
					/// <param name=""></param>
					...
					virtual ~CPolyline();
				ev_private:
					CPolyline(EarthView::World::Core::CNameValuePairList* pList);
					CPolyline(const CPoint* cpy_points[],ev_uint32 size);
					ev_int32 add(const EarthView::World::Spatial::Geometry::CCurvePath* cpy_paths[],ev_uint32 size,ev_int32 index);
				public:
					/// <summary>
					/// 获取曲线Path数目
					/// </summary>
					...
					/// <returns></returns>
					_extfree EarthView::World::Spatial::Geometry::CCurvePath* getCurvePath(ev_uint32 index) const;
					/// <summary>
					/// 获取曲线Path对象
					/// </summary>
					/// <param name="index">索引位置</param>
					/// <returns></returns>
					const EarthView::World::Spatial::Geometry::CCurvePath* getCurvePathRef(ev_uint32 index) const;
					...
					ev_int32 add(const EarthView::World::Spatial::Geometry::CCurvePath* cpy_paths,ev_int32 index);
					/// <summary>
					/// 删除指定索引处，指定数目的曲线Path
					/// </summary>
					/// <param name="index">指定索引</param>
					...
					ev_int32 clear();
					EarthView::World::Spatial::Geometry::CPolyline clone2() const;
					ev_uint32 replace(const EarthView::World::Spatial::Geometry::CCurvePath* cpy_path,ev_uint32 index);
					///*********************************************************/
				...
				protected:
					...
					ev_void clone2(EarthView::World::Spatial::Geometry::CPolyline* polyline)const;
				public:
					CPolyline(const CPolyline& obj);
					EarthView::World::Spatial::Geometry::CPolyline& operator=(const EarthView::World::Spatial::Geometry::CPolyline& obj);
ev_private:
					CPolyline(EV_GEOMETY_PRIVATE_PREFIX::CPolylinePrivate* obj);
				private:
					EV_DEFINE_CLASS_PRIVATE(CPolyline);
