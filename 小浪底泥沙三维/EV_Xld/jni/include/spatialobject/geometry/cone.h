#ifndef _GEOMETRY_CONE_H_
#define _GEOMETRY_CONE_H_
	...
	namespace World{
		namespace Spatial{
			namespace Geometry{
                ...
                /// 圆锥体
                /// </summary>
				class EV_GEOMETRY_DLL CCone : public EarthView::World::Spatial::Geometry::CRevolvingVolume
				{
				public:
					/// <summary>
					/// 构造函数
					...
					/// <returns></returns>
					CCone(const EarthView::World::Spatial::Geometry::CCircle& bottomCircle, ev_real64 height);
					/// <summary>
					/// 析构函数
					/// </summary>
					/// <param name=""></param>
...
ev_private:
					...
					/// <returns></returns>
					CCone(EarthView::World::Core::CNameValuePairList* pList);
				public:
					/// <summary>
					/// 获取底圆
					/// </summary>
