#ifndef EARTHVIEW_WORLD_SPATIAL3D_RESOURCEFEATURE_H
#define EARTHVIEW_WORLD_SPATIAL3D_RESOURCEFEATURE_H
...
namespace EarthView{
	namespace World{
		namespace Spatial3D{
				class CSpatialPosition;
			namespace Dataset{
				

				class EV_Spatial3DDataset_DLL CResourceFeature :  public EarthView::World::Spatial::GeoDataset::IFeature
				{
					friend class CResourceDataset;
					friend class CResourceIterator;
					friend class CResourceGeometry;
					friend class CResourceDatasetEditor;
				private:
					ev_int32 mID;
                ...
                ev_private:
					...
					/// <returns></returns>
					CResourceFeature(_in EarthView::World::Core::CNameValuePairList *pList);
				public:
					/// <summary>
					/// 析构函数
					/// </summary>
