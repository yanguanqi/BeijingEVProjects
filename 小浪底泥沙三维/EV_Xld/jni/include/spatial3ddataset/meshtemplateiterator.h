#ifndef EARTHVIEW_WORLD_SPATIAL3D_MESHTEMPLATEITERATOR_H
#define EARTHVIEW_WORLD_SPATIAL3D_MESHTEMPLATEITERATOR_H
	...
	namespace World{
		namespace Spatial3D{
			namespace Dataset{
				...
				class EV_Spatial3DDataset_DLL CMeshTemplateIterator : public EarthView::World::Spatial::GeoDataset::IFeatureIterator
				{
                ...
                ev_private:
					...
					/// <returns></returns>
					CMeshTemplateIterator(_in EarthView::World::Core::CNameValuePairList *pList);
				protected:
					/// <summary>
					/// 构造函数
					/// </summary>
