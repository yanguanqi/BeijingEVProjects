#ifndef EARTHVIEW_WORLD_SPATIAL3D_MESHTEMPLATEDATASET_H
#define EARTHVIEW_WORLD_SPATIAL3D_MESHTEMPLATEDATASET_H
...
ev_private:
					...
					/// <returns></returns>
					CMeshTemplateDataset(_in EarthView::World::Core::CNameValuePairList *pList);
				protected:
					/// <summary>
					/// 构造函数
					/// </summary>
					...
					CMeshTemplateDataset(EarthView::World::Spatial::GeoDataset::IDataSource* ref_datasource);
				public:
					/// <summary>
					/// 析构函数
					/// </summary>
					...
					/// <returns>EarthView::World::Spatial::GeoDataset::IFeature*，失败返回NULL</returns>
					virtual _extfree EarthView::World::Spatial::GeoDataset::IFeature* createFeatureBuffer(const EVString& typeName);
					...
					/// <returns>ev_bool，TURE成功，FALSE失败</returns>
					virtual ev_bool getAttrRef(ev_uint32 meshTmplID, _out EVString& attrType, _out ev_uint32& attrID);
					...
					/// <returns>ev_bool，TURE成功，FALSE失败</returns>
					virtual ev_bool getAttr(const EVString& attrType, ev_uint32 attrID, _inout EarthView::World::Spatial::GeoDataset::CPropertySet* ps);
				};
