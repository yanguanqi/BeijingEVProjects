#ifndef EARTHVIEW_WORLD_SPATIAL_DISPLAY_DRAWSIMPLETEXT_H
#define EARTHVIEW_WORLD_SPATIAL_DISPLAY_DRAWSIMPLETEXT_H
	...
	namespace World{
		namespace Spatial{
			namespace Display{
				...
				class CDrawSimpleText : public CDrawText
				{
				public:
					/// <summary>
					/// 默认构造函数
					...
					CDrawSimpleText();
				ev_private:
					CDrawSimpleText( EarthView::World::Core::CNameValuePairList* pList );
				public:
					/// <summary>
					/// 默认析构函数
					/// </summary>
