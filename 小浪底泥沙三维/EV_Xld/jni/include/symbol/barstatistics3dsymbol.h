#ifndef EARTHVIEW_WORLD_SPATIAL_DISPLAY_BARSTATISTICS3DSYMBOL_H
#define EARTHVIEW_WORLD_SPATIAL_DISPLAY_BARSTATISTICS3DSYMBOL_H
	...
	namespace World
	{
		namespace Spatial
		{
			namespace Display
			{
				...
				/// 三维柱状统计图符号
				/// </summary>
				class EV_SYMBOL_DLL CBarStatistics3DSymbol : public EarthView::World::Spatial::Display::CStatistics3DSymbol
				{
ev_private:
					/// <summary>
					/// 封装构造函数
					...
					/// <returns></returns>
					CBarStatistics3DSymbol(_in EarthView::World::Core::CNameValuePairList* pList);
				public:
