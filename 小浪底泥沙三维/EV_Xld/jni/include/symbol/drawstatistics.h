#ifndef EARTHVIEW_WORLD_SPATIAL_DISPLAY_DRAWSTATISTICS_H
#define EARTHVIEW_WORLD_SPATIAL_DISPLAY_DRAWSTATISTICS_H
		...
		namespace Spatial{
			namespace Display{
				...
				public:
					...
					CDrawStatistics();
				ev_private:
					CDrawStatistics( EarthView::World::Core::CNameValuePairList* pList );
				public:
					/// <summary>
					/// 默认析构函数
					/// </summary>
				...
				private:
					C_DISABLE_COPY( CDrawStatistics );
				};
			}
		}
	}
