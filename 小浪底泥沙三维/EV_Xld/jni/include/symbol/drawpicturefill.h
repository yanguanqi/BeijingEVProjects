#ifndef EARTHVIEW_WORLD_SPATIAL_DISPLAY_DRAWPICTUREFILL_H
#define EARTHVIEW_WORLD_SPATIAL_DISPLAY_DRAWPICTUREFILL_H
		...
		namespace Spatial{
			namespace Display{
				...
				public:
					...
					CDrawPictureFill();
				ev_private:
					CDrawPictureFill( EarthView::World::Core::CNameValuePairList* pList );
				public:
					/// <summary>
					/// 默认析构函数
					/// </summary>
