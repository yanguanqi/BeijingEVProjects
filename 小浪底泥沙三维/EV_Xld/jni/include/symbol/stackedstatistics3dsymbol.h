#ifndef EARTHVIEW_WORLD_SPATIAL_DISPLAY_STACKEDSTATISTICS3DSYMBOL_H
#define EARTHVIEW_WORLD_SPATIAL_DISPLAY_STACKEDSTATISTICS3DSYMBOL_H
	...
	namespace World
	{
		namespace Spatial
		{
			namespace Display
			{
				...
				/// 三维堆叠统计图符号
				/// </summary>
				class EV_SYMBOL_DLL CStackedStatistics3DSymbol : public EarthView::World::Spatial::Display::CStatistics3DSymbol
				{
ev_private:
					...
					/// <returns></returns>
					CStackedStatistics3DSymbol(_in EarthView::World::Core::CNameValuePairList* pList);
				public:
