#ifndef EARTHVIEW_WORLD_SPATIAL_DISPLAY_DRAWGRADIENTFILL_H
#define EARTHVIEW_WORLD_SPATIAL_DISPLAY_DRAWGRADIENTFILL_H
#include "symbol/drawfill.h"
namespace EarthView{
	namespace World{
		namespace Spatial{
			namespace Display{
				class CDrawGradientFill :
					public CDrawFill
				{
				public:
					/// <summary>
					...
					CDrawGradientFill();
				ev_private:
					CDrawGradientFill( EarthView::World::Core::CNameValuePairList* pList );
				public:
					/// <summary>
					/// 默认析构函数
					/// </summary>
