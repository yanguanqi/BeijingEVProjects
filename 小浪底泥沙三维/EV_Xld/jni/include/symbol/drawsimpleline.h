#ifndef EARTHVIEW_WORLD_SPATIAL_DISPLAY_DRAWSIMPLELINE_H
#define EARTHVIEW_WORLD_SPATIAL_DISPLAY_DRAWSIMPLELINE_H
#include "symbol/drawline.h"
namespace EarthView{
	namespace World{
		namespace Spatial{
			namespace Display{
				class CDrawSimpleLine : public CDrawLine
				{
				public:
					/// <summary>
					/// 默认构造函数
					...
					CDrawSimpleLine();
				ev_private:
					CDrawSimpleLine( EarthView::World::Core::CNameValuePairList* pList );
				public:
					/// <summary>
					/// 默认析构函数
					/// </summary>
