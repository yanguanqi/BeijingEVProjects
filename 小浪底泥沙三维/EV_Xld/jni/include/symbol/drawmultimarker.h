#ifndef EARTHVIEW_WORLD_SPATIAL_DISPLAY_DRAWMULTIMARKER_H
#define EARTHVIEW_WORLD_SPATIAL_DISPLAY_DRAWMULTIMARKER_H
#include "drawmultisymbol.h"
namespace EarthView{
	namespace World{
		namespace Spatial{
			namespace Display{
				class CDrawMultiMarker : public CDrawMultiSymbol
				{
				public:
					/// <summary>
					/// 默认构造函数
					...
					CDrawMultiMarker();
				ev_private:
					CDrawMultiMarker( EarthView::World::Core::CNameValuePairList* pList );
				public:
					/// <summary>
					/// 默认析构函数
					/// </summary>
