#ifndef _TEXTURE_LINE_3DSYMBOL_H_
#define _TEXTURE_LINE_3DSYMBOL_H_
    ...
    namespace World{
        namespace Spatial{
            namespace Display{
				...
				/// 纹理线扩展符号				
				/// </summary>
                class EV_SYMBOL_DLL CTextureLine3DSymbol : public EarthView::World::Spatial::Display::CSimpleLine3DSymbol
                {
ev_private:
					/// <summary>
					/// 构造函数
					...
					/// <returns></returns>
					CTextureLine3DSymbol(_in EarthView::World::Core::CNameValuePairList* pList);
                public:
					/// <summary>
					/// 构造函数
					/// </summary>
                ...
                public:
                    ...
                    EarthView::World::Spatial::Display::CTextureInfo& getTextureInfo();
					/// <summary>
					/// 设置纹理信息
					/// </summary>
					/// <param name="ti">纹理信息</param>
					/// <returns></returns>
                    ev_void setTextureInfo(const EarthView::World::Spatial::Display::CTextureInfo& ti);
...
ev_internal:
                ...
                protected:
                    EarthView::World::Spatial::Display::CTextureInfo mTextureInfo;
                };
            }
        }
    }
