#ifndef EARTHVIEW_WORLD_SPATIAL_DISPLAY_DRAWFONTMARKER_H
#define EARTHVIEW_WORLD_SPATIAL_DISPLAY_DRAWFONTMARKER_H
		...
		namespace Spatial{
			namespace Display{
				...
				public:
					...
					CDrawFontMarker();
				ev_private:
					CDrawFontMarker( EarthView::World::Core::CNameValuePairList* pList );
				public:
					/// <summary>
					/// 默认析构函数
					/// </summary>
				...
				private:
					C_DISABLE_COPY( CDrawFontMarker );
				};
			}
		}
	}
