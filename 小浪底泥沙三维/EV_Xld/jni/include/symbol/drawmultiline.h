#ifndef EARTHVIEW_WORLD_SPATIAL_DISPLAY_DRAWMULTILINE_H
#define EARTHVIEW_WORLD_SPATIAL_DISPLAY_DRAWMULTILINE_H
...
namespace EarthView{
	namespace World{
		namespace Spatial{
			namespace Display{
				class CDrawMultiLine : public CDrawMultiSymbol
				{
				public:
					/// <summary>
					/// 默认构造函数
					...
					CDrawMultiLine();
				ev_private:
					CDrawMultiLine( EarthView::World::Core::CNameValuePairList* pList );
				public:
					/// <summary>
					/// 默认析构函数
					/// </summary>
