#ifndef EARTHVIEW_WORLD_SPATIAL_DISPLAY_DRAWMARKER_H
#define EARTHVIEW_WORLD_SPATIAL_DISPLAY_DRAWMARKER_H
		...
		namespace Spatial{
			namespace Display{
				...
				protected:
					...
					CDrawMarker();
				ev_private:
					CDrawMarker( EarthView::World::Core::CNameValuePairList* pList );
				public:
					/// <summary>
					/// 默认析构函数
					/// </summary>
