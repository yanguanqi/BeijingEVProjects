#ifndef EARTHVIEW_WORLD_SPATIAL_DISPLAY_DRAWMULTISYMBOL_H
#define EARTHVIEW_WORLD_SPATIAL_DISPLAY_DRAWMULTISYMBOL_H
	...
	namespace World{
		namespace Spatial{
			namespace Display{
				...
				class CDrawMultiSymbol : public CDrawSymbol
				{
				public:
					/// <summary>
					/// 默认构造函数
					...
					CDrawMultiSymbol();
			ev_private:
					CDrawMultiSymbol( EarthView::World::Core::CNameValuePairList* pList );
				public:
					/// <summary>
					/// 默认析构函数
					/// </summary>
				...
				protected:
					ev_vector<CSymbolRenderer*> m_vecRenderers;
				private:
					C_DISABLE_COPY( CDrawMultiSymbol );
				};
			}
		}
	}
