#ifndef EARTHVIEW_WORLD_SPATIAL_DISPLAY_DRAWARROWMARKER_H
#define EARTHVIEW_WORLD_SPATIAL_DISPLAY_DRAWARROWMARKER_H
		...
		namespace Spatial{
			namespace Display{
				...
				public:
					...
					CDrawArrowMarker();
				ev_private:
					CDrawArrowMarker( EarthView::World::Core::CNameValuePairList* pList );
				public:
					/// <summary>
					/// 默认析构函数
					/// </summary>
				...
				private:
					C_DISABLE_COPY( CDrawArrowMarker );
				};
			}
		}
	}
