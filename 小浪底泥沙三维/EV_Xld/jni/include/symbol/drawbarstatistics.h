#ifndef EARTHVIEW_WORLD_SPATIAL_DISPLAY_DRAWBARSTATISTICS_H
#define EARTHVIEW_WORLD_SPATIAL_DISPLAY_DRAWBARSTATISTICS_H
		...
		namespace Spatial{
			namespace Display{
				...
				public:
					...
					CDrawBarStatistics();
			ev_private:
					CDrawBarStatistics( EarthView::World::Core::CNameValuePairList* pList );
				public:
					/// <summary>
					/// 默认析构函数
					/// </summary>
					...
					ev_void endDraw();
				private:
					C_DISABLE_COPY( CDrawBarStatistics );
