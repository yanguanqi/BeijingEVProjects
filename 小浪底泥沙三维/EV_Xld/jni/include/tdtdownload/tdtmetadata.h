#ifndef tdtdownload_tdtmetadata_h_H
#define tdtdownload_tdtmetadata_h_H
#include "tdtdownload/tdtdll.h"
#include "download/webmetadataserviceconnection.h"

namespace TDT{

	class EV_TDT_DOWNLOAD_DLL TDTMetadata : public EarthView::World::Spatial::Download::WebMetadataServiceConnectionImp
	{
	public:
		TDTMetadata();
		~TDTMetadata();
