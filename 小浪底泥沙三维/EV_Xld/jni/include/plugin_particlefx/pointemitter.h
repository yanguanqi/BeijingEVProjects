    ...
    namespace World
    {
        namespace Plugin
        {
            namespace ParticleFX
            {
                ...
                */
                class EV_ParticleFX_DLL CPointEmitter : public EarthView::World::Graphic::CParticleEmitter
                {
                public:
                    CPointEmitter(EarthView::World::Graphic::CParticleSystem *psys);
                ...
                ev_private:
                    CPointEmitter(_in EarthView::World::Core::CNameValuePairList *pList);
