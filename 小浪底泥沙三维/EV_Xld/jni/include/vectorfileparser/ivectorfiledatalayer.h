#ifndef IVECTORFILEDATALAYER_H
#define IVECTORFILEDATALAYER_H
...
class EV_VECTORFILEPARSER_LIB IVectorFileDataLayer
					: public EarthView::World::Spatial::Atlas::IVectorLayer
{
public:
	IVectorFileDataLayer();
	~IVectorFileDataLayer();
...
protected:
	C_DISABLE_COPY(IVectorFileDataLayer);
