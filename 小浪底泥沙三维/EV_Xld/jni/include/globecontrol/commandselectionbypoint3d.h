#ifndef CCOMMANDSELECTIONBYPOINT3D_H
#define CCOMMANDSELECTIONBYPOINT3D_H
	...
	namespace World
	{
		...
		namespace Spatial3D
		{
			...
			namespace Controls
			{
				...
				/// 工具栏点选择类
				/// </summary>
				class EV_GLOBECONTROL_DLL CCommandSelectionByPoint3D:public EarthView::World::Spatial3D::Controls::CGlobeCommand
				{
				public:
					/// <summary>
					/// 构造函数
					...
					/// <param name=""></param>
					/// <returns></returns>	
					virtual ~CCommandSelectionByPoint3D();
				...
				ev_private:
					...
					/// <returns></returns>	
					CCommandSelectionByPoint3D( EarthView::World::Core::CNameValuePairList *pList );
				protected:
					C_DISABLE_COPY( CCommandSelectionByPoint3D )
				};
			}
		}
	}
