#ifndef _RAY_QUERY_TOOL_H
#define _RAY_QUERY_TOOL_H
...
namespace EarthView
{
	namespace World
	{
		namespace Spatial3D
		{
			namespace SystemUI
			{
				class EV_GLOBECONTROL_DLL CRaySelectTool : public EarthView::World::Spatial::SystemUI::ITool
				{
				protected:
					class CObjectListener : public EarthView::World::Graphic::CMovableObject::CMovableObjectListener
					{
					public:
						CObjectListener(CRaySelectTool* parent)
							: mParent(parent)
						{
						}
					public:
				...
				public:
					...
					/// <returns></returns>
					CRaySelectTool(EarthView::World::Spatial3D::Controls::CGlobeControl* ref_ctrl);
					/// <summary>
					/// 析构函数
					/// </summary>
					virtual ~CRaySelectTool();
				ev_private:
					CRaySelectTool(EarthView::World::Core::CNameValuePairList* pList);
