#ifndef CCOMMANDSTARTEDIT3D_H
#define CCOMMANDSTARTEDIT3D_H
	...
	namespace World
	{
		...
		namespace Spatial3D
		{
			...
			namespace Controls
			{
				...
				/// 开始编辑命令
				/// </summary>
				class EV_GLOBECONTROL_DLL CCommandStartEdit3D:public EarthView::World::Spatial3D::Controls::CGlobeCommand
				{
				public:
					/// <summary>
					/// 默认构造函数
...
ev_private:
					...
					/// <returns></returns>
					CCommandStartEdit3D( EarthView::World::Core::CNameValuePairList *pList );
				protected:
					C_DISABLE_COPY( CCommandStartEdit3D )
