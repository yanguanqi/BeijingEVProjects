#ifndef CCOMMANDSELECTIONBYCIRCLE3D_H
#define CCOMMANDSELECTIONBYCIRCLE3D_H
	...
	namespace World
	{
		namespace Spatial3D
		{
			namespace Controls
			{
				...
				/// 工具栏圆形选择类
				/// </summary>
				class EV_GLOBECONTROL_DLL CCommandSelectionByCircle3D:public EarthView::World::Spatial3D::Controls::CGlobeCommand
				{
				public:
					/// <summary>
					/// 构造函数
					...
					/// <param name=""></param>
					/// <returns></returns>	
					virtual ~CCommandSelectionByCircle3D();
				...
				ev_private:
					...
					/// <returns></returns>	
					CCommandSelectionByCircle3D( EarthView::World::Core::CNameValuePairList *pList );
				protected:
					C_DISABLE_COPY( CCommandSelectionByCircle3D )
				};
			}
		}
	}
