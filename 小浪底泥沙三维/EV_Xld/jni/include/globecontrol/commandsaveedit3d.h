#ifndef CCOMMANDSAVEEDIT3D_H
#define CCOMMANDSAVEEDIT3D_H
	...
	namespace World
	{
		...
		namespace Spatial3D
		{
			...
			namespace Controls
			{
				...
				/// 保存编辑命令
				/// </summary>
				class EV_GLOBECONTROL_DLL CCommandSaveEdit3D:public EarthView::World::Spatial3D::Controls::CGlobeCommand
				{
				public:
					/// <summary>
					/// 默认构造函数
...
ev_private:
					...
					/// <returns></returns>
					CCommandSaveEdit3D( EarthView::World::Core::CNameValuePairList *pList );
				protected:
					C_DISABLE_COPY( CCommandSaveEdit3D )
