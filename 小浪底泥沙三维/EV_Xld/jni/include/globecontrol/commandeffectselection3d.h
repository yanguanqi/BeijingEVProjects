#ifndef CCOMMANDEFFECTSELECTION3D_H
#define CCOMMANDEFFECTSELECTION3D_H
	...
	namespace World
	{
		...
		namespace Spatial3D
		{
			...
			namespace Controls
			{
				...
				/// 显示特效库编辑素材命令
				/// </summary>
				class EV_GLOBECONTROL_DLL CCommandEffectSelection3D:public EarthView::World::Spatial3D::Controls::CGlobeCommand
				{
				public:
					/// <summary>
					/// 默认构造函数
					...
					/// <param name=""></param>
					/// <returns></returns>	
					virtual ~CCommandEffectSelection3D();
...
ev_private:
					...
					/// <returns></returns>
					CCommandEffectSelection3D( EarthView::World::Core::CNameValuePairList *pList );
				protected:
					C_DISABLE_COPY( CCommandEffectSelection3D )
						/// <summary>
						/// 设置正在编辑的数据集名称
						/// </summary>
