#ifndef CCOMMANDSTOPEDIT3D_H
#define CCOMMANDSTOPEDIT3D_H
	...
	namespace World
	{
		...
		namespace Spatial3D
		{
			...
			namespace Controls
			{
				...
				/// 结束编辑命令
				/// </summary>
				class EV_GLOBECONTROL_DLL CCommandStopEdit3D:public EarthView::World::Spatial3D::Controls::CGlobeCommand
				{
				public:
					/// <summary>
					/// 默认构造函数
...
ev_private:
					...
					/// <returns></returns>
					CCommandStopEdit3D( EarthView::World::Core::CNameValuePairList *pList );
				protected:
					C_DISABLE_COPY( CCommandStopEdit3D )
