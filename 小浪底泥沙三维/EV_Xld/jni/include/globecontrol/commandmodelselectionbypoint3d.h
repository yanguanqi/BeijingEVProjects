#ifndef CCommandModelSelectionByPoint3D_H
#define CCommandModelSelectionByPoint3D_H
	...
	namespace World
	{
		...
		namespace Spatial3D
		{
			...
			namespace Controls
			{
				...
				/// 工具栏点选择类
				/// </summary>
				class EV_GLOBECONTROL_DLL CCommandModelSelectionByPoint3D:public EarthView::World::Spatial3D::Controls::CGlobeCommand
				{
				public:
					/// <summary>
					/// 构造函数
					...
					/// <param name=""></param>
					/// <returns></returns>	
					CCommandModelSelectionByPoint3D();
					...
					/// <param name=""></param>
					/// <returns></returns>	
					virtual ~CCommandModelSelectionByPoint3D();
...
ev_private:
					...
					/// <returns></returns>	
					CCommandModelSelectionByPoint3D( EarthView::World::Core::CNameValuePairList *pList );
				protected:
					C_DISABLE_COPY( CCommandModelSelectionByPoint3D )
				};
			}
		}
	}
