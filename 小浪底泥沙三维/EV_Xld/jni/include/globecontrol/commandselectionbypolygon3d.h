#ifndef CCOMMANDSELECTIONBYPOLYGON3D_H
#define CCOMMANDSELECTIONBYPOLYGON3D_H
	...
	namespace World
	{
		...
		namespace Spatial3D
		{
			...
			namespace Controls
			{
				...
				/// 工具栏多边形选择类
				/// </summary>
				class EV_GLOBECONTROL_DLL CCommandSelectionByPolygon3D:public EarthView::World::Spatial3D::Controls::CGlobeCommand
				{
				public:
					/// <summary>
					/// 构造函数
					...
					/// <param name=""></param>
					/// <returns></returns>	
					virtual ~CCommandSelectionByPolygon3D();
				...
				ev_private:
					...
					/// <returns></returns>	
					CCommandSelectionByPolygon3D( EarthView::World::Core::CNameValuePairList *pList );
				protected:
					C_DISABLE_COPY( CCommandSelectionByPolygon3D )
				};
			}
		}
	}
