#ifndef CVECTORRELATIVEWEBSCENELAYER_H
#define CVECTORRELATIVEWEBSCENELAYER_H
	...
	namespace World{
		namespace Spatial3D{
			namespace Atlas{
				...
				class CVectorWebOctreeManager;
				class CRelativeWebLayerUpdator;
				...
				/// 管理非贴地层-二维矢量数据
				/// </summary>
				class EV_3DLAYER_DLL CVectorWebRelativeSceneLayer
...
ev_private:
					...
					/// <returns></returns>
					CVectorWebRelativeSceneLayer(EarthView::World::Core::CNameValuePairList* pList);
				public:
					/// <summary>
					/// 构造函数
					/// </summary>
					/// <param name=""></param>
					/// <returns></returns>
					CVectorWebRelativeSceneLayer();
					/// <summary>
					/// 构造函数
					/// </summary>
					/// <param name=""></param>
					/// <returns></returns>
					CVectorWebRelativeSceneLayer(const EVString& name,EarthView::World::Spatial::GeoDataset::IDataset* ref_Dataset);
					/// <summary>
					/// 析构函数
					/// </summary>
					/// <param name=""></param>
					/// <returns></returns>
					virtual ~CVectorWebRelativeSceneLayer();
				...
				public:
					...
					/// <param name=""></param>
					/// <returns>图层标签属性</returns>
					ev_uint32 getWebFieldCount() const;
					/// <summary>
					/// 获取网络字段
					/// </summary>
					/// <param name="labelproperty">注记属性</param>
					/// <returns></returns>
					const CVector3DCacheField& getWebField(ev_uint32 index) const;
				...
				protected:
					...
					/// <returns></returns>
					ev_void walkOctree( EarthView::World::Graphic::COctreeCamera* cam, EarthView::World::Spatial::Octree::CBaseOctree *octant,ev_bool* childValid, ev_bool foundvisible,_inout list<OctreeNode_Box>& listNodeCode,ev_int32 altiMode,Real height);
					/// <summary>
					/// 停止请求
					/// </summary>
					void stopLayerRequests();
					
					ev_void calcuEnvelope(const EarthView::World::Spatial::Geometry::IEnvelope* pEnv);
				...
				private:
					...
					/// <returns></returns>
					C_DISABLE_COPY(CVectorWebRelativeSceneLayer);

					void init(EarthView::World::Spatial::GeoDataset::IDataset* ref_Dataset);
					...
					EarthView::World::Geometry3D::CMultiGeometry3DExtension* processPointLocalCache(const EVString& nodeCode,EarthView::World::Core::MemoryDataStreamPtr& themeStream,EarthView::World::Spatial::Display::ISymbol* symbol);
					EarthView::World::Geometry3D::CMultiGeometry3DExtension* processPointVectorLayer(const EVString& nodeCode,EarthView::World::Spatial::Display::ISymbol* symbol,ev_bool exist);
					EarthView::World::Geometry3D::CMultiGeometry3DExtension* processLocalCache(const EVString& nodeCode,EarthView::World::Core::MemoryDataStreamPtr& meshMemory);
					EarthView::World::Geometry3D::CMultiGeometry3DExtension* processVectorLayer(const EVString& nodeCode,ev_bool exist);
					...
					ev_void setSymbolWithFeature(EarthView::World::Spatial::Display::ISymbol* sym,EarthView::World::Spatial3D::Atlas::CGeometryObject& obj);
					...
					ev_void updataLabelFromDB(const EVString& nodeCode,CGeometryObjectVector& objects,EarthView::World::Geometry3D::CMultiGeometry3DExtension* extension,ev_bool reCreate);
					...
					friend class CVectorRelativeWebSceneLayerFactory;
				...
				protected:
					...
					******************/
					...
					EarthView::World::Spatial3D::Atlas::CVectorWebOctreeManager* mpOctreeMnger;
				...
				private:
					EarthView::World::Spatial::CWebVector3DDataset* mpFeatureClass;
					...
					EarthView::World::Geometry3D::CGeoStatistics3DExtension* buildStatisticsExtension(EarthView::World::Spatial3D::Atlas::CGeometryObjectVector& obj,EarthView::World::Geometry3D::CMultiGeometry3DExtension* geoExtension,EarthView::World::Core::IntVector& vecIDs,EarthView::World::Core::MemoryDataStreamPtr& fieldValues);
					EarthView::World::Geometry3D::CGeoStatistics3DExtension* buildStatisticsExtension(vector<ev_uint32>& EVIDs,EarthView::World::Spatial::Geometry::CGeometryCollection* geometrys,EarthView::World::Geometry3D::CMultiGeometry3DExtension* geoExtension,EarthView::World::Core::MemoryDataStreamPtr& fieldValues,ev_uint32& preSize,EarthView::World::Core::MemoryDataStreamPtr& meshMemory);
					...
					friend class CRelativeWebLayerUpdator;
					CRelativeWebLayerUpdator* mUpdator;
				...
				/// 管理非贴地二维矢量数据
				/// </summary>
				class EV_3DLAYER_DLL CVectorRelativeWebSceneLayerFactory:public EarthView::World::Spatial::Atlas::ILayerFactory
				{
				...
				ev_private:
					...
					/// <param name="pList">构造函数参数键值对表</param>
					/// <returns></returns>
					CVectorRelativeWebSceneLayerFactory(EarthView::World::Core::CNameValuePairList*pList);
				public:
					/// <summary>
					/// 构造函数
					/// </summary>
					/// <param name=""></param>
					/// <returns></returns>
					CVectorRelativeWebSceneLayerFactory();
					/// <summary>
					/// 析构函数
					/// </summary>
					/// <param name=""></param>
					/// <returns></returns>
					virtual ~CVectorRelativeWebSceneLayerFactory();
				...
				public:
					...
					/// <returns></returns>
					EarthView::World::Spatial::Atlas::ILayer* createInstance(const EVString& name,EarthView::World::Spatial::GeoDataset::IDataset* ref_Dataset);
					/// <summary>
					/// 销毁一个图层
					/// </summary>
