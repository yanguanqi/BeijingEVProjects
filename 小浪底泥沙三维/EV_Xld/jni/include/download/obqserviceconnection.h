#ifndef EARTHVIEW_WORLD_SPATIAL_OBQSERVICECONNECTION_H
#define EARTHVIEW_WORLD_SPATIAL_OBQSERVICECONNECTION_H
	...
	namespace World{
		namespace Spatial{
			namespace Download{
				...
				class ObqServiceConnection;
				class ObqServiceConnectionImp;

		

			///////////////////////////////////////////////////////////////////////////
			class EV_DOWNLOAD_DLL ObqServiceConnection : public EarthView::World::Spatial::Download::CWebServiceConnection
			{
			...
			public:
				...
				/// <param name=""></param>
				/// <returns></returns>
				ObqServiceConnection(EVString& name, EVString& url, EVString& pluginFile);
			...
			private:
				C_DISABLE_COPY(ObqServiceConnection);
				ObqServiceConnectionImp* mpImp;
			};

			class EV_DOWNLOAD_DLL ObqServiceConnectionImp : public EarthView::World::Spatial::Download::ConnectionImp
			{
			public:
				ObqServiceConnectionImp();
				virtual ~ObqServiceConnectionImp();
