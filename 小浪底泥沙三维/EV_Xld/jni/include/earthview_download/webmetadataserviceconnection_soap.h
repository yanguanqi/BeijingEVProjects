#ifndef WEBMETADATASERVICECONNECTION_SOAP_H_
#define WEBMETADATASERVICECONNECTION_SOAP_H_
	...
	namespace World{
		namespace Spatial{
			namespace EarthViewDownload{
				class WebMetadataServiceServiceSoapBindingProxyPool;
				class EV_EARTHVIEW_DOWNLOAD_DLL WebMetadataServiceConnectionImp_soap : public EarthView::World::Spatial::Download::WebMetadataServiceConnectionImp
				{
				public:
					WebMetadataServiceConnectionImp_soap();
					~WebMetadataServiceConnectionImp_soap();
				...
				protected:
					WebMetadataServiceServiceSoapBindingProxyPool* mpPool;
				private:
				};
			}}}}
#endif