...
/// 二维矢量要素集类
/// </summary>
class EV_2DGEODATABSE_DLL CVectorFeatureClass : public EarthView::World::Spatial::GeoDataset::IFeatureClass2
{
...
public:
	...
	{return  EarthView::World::Spatial::GeoDataset::FCT_VECTORFEATURECLASS;}
	/// <summary>
	/// 获取要素集几何体类型
	/// </summary>
	/// <param name=""></param>
...
private:
	...
	EarthView::World::Spatial::GeoDataset::IFeature*					nextFeature2(const EarthView::World::Spatial2D::GeoDataset::CFeatureIterator *iterator);
...
protected:
	...
	///* 空间索引类型 */
	EarthView::World::Spatial::GeoDataset::EVSpatialIndexEnum			m_nSpatialIndexType;

	ev_list<EarthView::World::Spatial2D::GeoDataset::CFeatureIterator*>mQueryIterators;
