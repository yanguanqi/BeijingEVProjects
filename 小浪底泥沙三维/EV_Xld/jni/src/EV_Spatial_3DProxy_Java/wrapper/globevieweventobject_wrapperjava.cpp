...
namespace EarthView
{
	namespace World
	{
		...
		{
			class JCGlobeViewEventObjectProxy : public EarthView::World::Spatial3DProxy::CGlobeViewEventObject
			{
			 private:
			...
			public:
				JCGlobeViewEventObjectProxy(EarthView::World::Core::CNameValuePairList *pList) : CGlobeViewEventObject(pList)
				{
				}
			...
			REGISTER_FACTORY_CLASS(JCGlobeViewEventObjectProxy);
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3dproxy_GlobeViewEventObject_dragDrop_1ev_1uint32_1ILayer_1CGlobeControl_1ev_1uint32_1ev_1uint32(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong id_j, jlong layer_j, jlong globecontrol_j, jlong dropx_j, jlong dropy_j)
			{
				...
				ev_uint32 dropx = (ev_uint32) dropx_j;
				ev_uint32 dropy = (ev_uint32) dropy_j;
				EarthView::World::Spatial3DProxy::CGlobeViewEventObject *pObjectX = (EarthView::World::Spatial3DProxy::CGlobeViewEventObject*) pObjXXXX;
				pObjectX->dragDrop(id, layer, globecontrol, dropx, dropy);
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3dproxy_GlobeViewEventObject_register_1onEvent_1CEvent(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCGlobeViewEventObjectProxy *pObjectX = (JCGlobeViewEventObjectProxy*) pObjXXXX;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3dproxy_GlobeViewEventObject_register_1onTimerEvent_1CTimerEvent(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCGlobeViewEventObjectProxy *pObjectX = (JCGlobeViewEventObjectProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3dproxy_GlobeViewEventObject_register_1onCustomEvent_1CEvent(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCGlobeViewEventObjectProxy *pObjectX = (JCGlobeViewEventObjectProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
