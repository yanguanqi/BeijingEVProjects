...
namespace EarthView
{
	namespace World
	{
		...
		{
			class JCEffectInfoPanelParamProxy : public EarthView::World::Spatial3DProxy::CEffectInfoPanelParam
			{
			 private:
			...
			public:
				JCEffectInfoPanelParamProxy(EarthView::World::Core::CNameValuePairList *pList) : CEffectInfoPanelParam(pList)
				{
				}
			...
			REGISTER_FACTORY_CLASS(JCEffectInfoPanelParamProxy);
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3dproxy_EffectInfoPanelParam_setEffectObject_1CEffectObject(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong ref_obj_j)
			{
				...
				EarthView::World::Spatial3DProxy::CEffectInfoPanelParam *pObjectX = (EarthView::World::Spatial3DProxy::CEffectInfoPanelParam*) pObjXXXX;
				pObjectX->setEffectObject(ref_obj);
			}
			extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial3dproxy_EffectInfoPanelParam_get_1mName_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Spatial3DProxy::CEffectInfoPanelParam *pObjectX = (EarthView::World::Spatial3DProxy::CEffectInfoPanelParam*)pObjXXXX;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3dproxy_EffectInfoPanelParam_set_1mName_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __values1_j)
			{
				EarthView::World::Spatial3DProxy::CEffectInfoPanelParam *pObjectX = (EarthView::World::Spatial3DProxy::CEffectInfoPanelParam*)pObjXXXX;
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3dproxy_EffectInfoPanelParam_get_1mpEffectObject_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Spatial3DProxy::CEffectInfoPanelParam *pObjectX = (EarthView::World::Spatial3DProxy::CEffectInfoPanelParam*)pObjXXXX;
				jlong __values1_j = (jlong)(pObjectX->mpEffectObject);
				return __values1_j;
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3dproxy_EffectInfoPanelParam_set_1mpEffectObject_1CEffectObject(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jlong __values1_j)
			{
				EarthView::World::Spatial3DProxy::CEffectInfoPanelParam *pObjectX = (EarthView::World::Spatial3DProxy::CEffectInfoPanelParam*)pObjXXXX;
				pObjectX->mpEffectObject = (EarthView::World::Spatial3D::EffectManager::CEffectObject*) __values1_j;
			}
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3dproxy_EffectInfoPanelParam_get_1mpNode_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Spatial3DProxy::CEffectInfoPanelParam *pObjectX = (EarthView::World::Spatial3DProxy::CEffectInfoPanelParam*)pObjXXXX;
				jlong __values1_j = (jlong)(pObjectX->mpNode);
				return __values1_j;
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3dproxy_EffectInfoPanelParam_set_1mpNode_1CSceneNode(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jlong __values1_j)
			{
				EarthView::World::Spatial3DProxy::CEffectInfoPanelParam *pObjectX = (EarthView::World::Spatial3DProxy::CEffectInfoPanelParam*)pObjXXXX;
				pObjectX->mpNode = (EarthView::World::Graphic::CSceneNode*) __values1_j;
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3dproxy_EffectInfoPanelParam_register_1setParameter_1EVString_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCEffectInfoPanelParamProxy *pObjectX = (JCEffectInfoPanelParamProxy*) pObjXXXX;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3dproxy_EffectInfoPanelParam_register_1setParameter_1EVString_1ev_1bool_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCEffectInfoPanelParamProxy *pObjectX = (JCEffectInfoPanelParamProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3dproxy_EffectInfoPanelParam_register_1setParameterList_1CommonStringPairList(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCEffectInfoPanelParamProxy *pObjectX = (JCEffectInfoPanelParamProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3dproxy_EffectInfoPanelParam_register_1getParameter_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCEffectInfoPanelParamProxy *pObjectX = (JCEffectInfoPanelParamProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3dproxy_EffectInfoPanelParam_register_1copyParametersTo_1CStringInterface(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCEffectInfoPanelParamProxy *pObjectX = (JCEffectInfoPanelParamProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
