...
namespace EarthView
{
	namespace World
	{
		namespace Spatial2D
		{
			namespace Renderer
			{
				class JCDrawUniqueValueThemeProxy : public EarthView::World::Spatial2D::Renderer::CDrawUniqueValueTheme
				{
				 private:
				...
				public:
					JCDrawUniqueValueThemeProxy(EarthView::World::Core::CNameValuePairList *pList) : CDrawUniqueValueTheme(pList)
					{
					}
				...
				protected:
					C_DISABLE_COPY(JCDrawUniqueValueThemeProxy)
				public:
				...
				REGISTER_FACTORY_CLASS(JCDrawUniqueValueThemeProxy);
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_renderer_DrawUniqueValueTheme_startDraw_1ISpatialDisplay_1ITheme(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong ref_display_j, jlong ref_theme_j)
				{
					...
					EarthView::World::Spatial2D::Renderer::CDrawUniqueValueTheme *pObjectX = (EarthView::World::Spatial2D::Renderer::CDrawUniqueValueTheme*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCDrawUniqueValueThemeProxy))
					{
						pObjectX->EarthView::World::Spatial2D::Renderer::CDrawUniqueValueTheme::startDraw(ref_display, ref_theme);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_renderer_DrawUniqueValueTheme_register_1startDraw_1ISpatialDisplay_1ITheme(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCDrawUniqueValueThemeProxy *pObjectX = (JCDrawUniqueValueThemeProxy*) pObjXXXX;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_renderer_DrawUniqueValueTheme_startDraw_1ISpatialDisplay_1ITheme_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong ref_display_j, jlong ref_theme_j)
				{
					EarthView::World::Spatial::Display::ISpatialDisplay *ref_display = (EarthView::World::Spatial::Display::ISpatialDisplay*) ref_display_j;
					EarthView::World::Spatial::Theme::ITheme *ref_theme = (EarthView::World::Spatial::Theme::ITheme*) ref_theme_j;
					EarthView::World::Spatial2D::Renderer::CDrawUniqueValueTheme *pObjectX = (EarthView::World::Spatial2D::Renderer::CDrawUniqueValueTheme*) pObjXXXX;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial2d_renderer_DrawUniqueValueTheme_draw_1IFeatureClass_1IQueryFilter(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong featureClass_j, jlong filter_j)
				{
					...
					if (typeid(*pObjectX) == typeid(JCDrawUniqueValueThemeProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial2D::Renderer::CDrawUniqueValueTheme::draw(featureClass, filter);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_renderer_DrawUniqueValueTheme_register_1draw_1IFeatureClass_1IQueryFilter(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCDrawUniqueValueThemeProxy *pObjectX = (JCDrawUniqueValueThemeProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial2d_renderer_DrawUniqueValueTheme_draw_1IFeatureClass_1IQueryFilter_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong featureClass_j, jlong filter_j)
				{
					EarthView::World::Spatial::GeoDataset::IFeatureClass *featureClass = (EarthView::World::Spatial::GeoDataset::IFeatureClass*) featureClass_j;
					EarthView::World::Spatial::GeoDataset::IQueryFilter *filter = (EarthView::World::Spatial::GeoDataset::IQueryFilter*) filter_j;
					EarthView::World::Spatial2D::Renderer::CDrawUniqueValueTheme *pObjectX = (EarthView::World::Spatial2D::Renderer::CDrawUniqueValueTheme*) pObjXXXX;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_renderer_DrawUniqueValueTheme_endDraw_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial2D::Renderer::CDrawUniqueValueTheme *pObjectX = (EarthView::World::Spatial2D::Renderer::CDrawUniqueValueTheme*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCDrawUniqueValueThemeProxy))
					{
						pObjectX->EarthView::World::Spatial2D::Renderer::CDrawUniqueValueTheme::endDraw();
					}
					else
					{
						pObjectX->endDraw();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_renderer_DrawUniqueValueTheme_register_1endDraw_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCDrawUniqueValueThemeProxy *pObjectX = (JCDrawUniqueValueThemeProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_renderer_DrawUniqueValueTheme_endDraw_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial2D::Renderer::CDrawUniqueValueTheme *pObjectX = (EarthView::World::Spatial2D::Renderer::CDrawUniqueValueTheme*) pObjXXXX;
					pObjectX->EarthView::World::Spatial2D::Renderer::CDrawUniqueValueTheme::endDraw();
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_renderer_DrawUniqueValueTheme_register_1draw_1ISpatialDisplay_1ISymbol_1IFeature(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCDrawUniqueValueThemeProxy *pObjectX = (JCDrawUniqueValueThemeProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
