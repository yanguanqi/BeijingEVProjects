...
namespace EarthView
{
	namespace World
	{
		namespace Spatial2D
		{
			namespace Renderer
			{
				class JCDrawCADUniqueEntityValueThemeProxy : public EarthView::World::Spatial2D::Renderer::CDrawCADUniqueEntityValueTheme
				{
				 private:
				...
				public:
					JCDrawCADUniqueEntityValueThemeProxy(EarthView::World::Core::CNameValuePairList *pList) : CDrawCADUniqueEntityValueTheme(pList)
					{
					}
				...
				protected:
					C_DISABLE_COPY(JCDrawCADUniqueEntityValueThemeProxy)
				public:
				...
				REGISTER_FACTORY_CLASS(JCDrawCADUniqueEntityValueThemeProxy);
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_renderer_DrawCADUniqueEntityValueTheme_startDraw_1ISpatialDisplay_1ITheme(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong ref_display_j, jlong ref_theme_j)
				{
					...
					EarthView::World::Spatial2D::Renderer::CDrawCADUniqueEntityValueTheme *pObjectX = (EarthView::World::Spatial2D::Renderer::CDrawCADUniqueEntityValueTheme*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCDrawCADUniqueEntityValueThemeProxy))
					{
						pObjectX->EarthView::World::Spatial2D::Renderer::CDrawCADUniqueEntityValueTheme::startDraw(ref_display, ref_theme);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_renderer_DrawCADUniqueEntityValueTheme_register_1startDraw_1ISpatialDisplay_1ITheme(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCDrawCADUniqueEntityValueThemeProxy *pObjectX = (JCDrawCADUniqueEntityValueThemeProxy*) pObjXXXX;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_renderer_DrawCADUniqueEntityValueTheme_startDraw_1ISpatialDisplay_1ITheme_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong ref_display_j, jlong ref_theme_j)
				{
					EarthView::World::Spatial::Display::ISpatialDisplay *ref_display = (EarthView::World::Spatial::Display::ISpatialDisplay*) ref_display_j;
					EarthView::World::Spatial::Theme::ITheme *ref_theme = (EarthView::World::Spatial::Theme::ITheme*) ref_theme_j;
					EarthView::World::Spatial2D::Renderer::CDrawCADUniqueEntityValueTheme *pObjectX = (EarthView::World::Spatial2D::Renderer::CDrawCADUniqueEntityValueTheme*) pObjXXXX;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial2d_renderer_DrawCADUniqueEntityValueTheme_draw_1IFeatureClass_1IQueryFilter(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong featureClass_j, jlong filter_j)
				{
					...
					if (typeid(*pObjectX) == typeid(JCDrawCADUniqueEntityValueThemeProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial2D::Renderer::CDrawCADUniqueEntityValueTheme::draw(featureClass, filter);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_renderer_DrawCADUniqueEntityValueTheme_register_1draw_1IFeatureClass_1IQueryFilter(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCDrawCADUniqueEntityValueThemeProxy *pObjectX = (JCDrawCADUniqueEntityValueThemeProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial2d_renderer_DrawCADUniqueEntityValueTheme_draw_1IFeatureClass_1IQueryFilter_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong featureClass_j, jlong filter_j)
				{
					EarthView::World::Spatial::GeoDataset::IFeatureClass *featureClass = (EarthView::World::Spatial::GeoDataset::IFeatureClass*) featureClass_j;
					EarthView::World::Spatial::GeoDataset::IQueryFilter *filter = (EarthView::World::Spatial::GeoDataset::IQueryFilter*) filter_j;
					EarthView::World::Spatial2D::Renderer::CDrawCADUniqueEntityValueTheme *pObjectX = (EarthView::World::Spatial2D::Renderer::CDrawCADUniqueEntityValueTheme*) pObjXXXX;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_renderer_DrawCADUniqueEntityValueTheme_endDraw_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial2D::Renderer::CDrawCADUniqueEntityValueTheme *pObjectX = (EarthView::World::Spatial2D::Renderer::CDrawCADUniqueEntityValueTheme*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCDrawCADUniqueEntityValueThemeProxy))
					{
						pObjectX->EarthView::World::Spatial2D::Renderer::CDrawCADUniqueEntityValueTheme::endDraw();
					}
					else
					{
						pObjectX->endDraw();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_renderer_DrawCADUniqueEntityValueTheme_register_1endDraw_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCDrawCADUniqueEntityValueThemeProxy *pObjectX = (JCDrawCADUniqueEntityValueThemeProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_renderer_DrawCADUniqueEntityValueTheme_endDraw_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial2D::Renderer::CDrawCADUniqueEntityValueTheme *pObjectX = (EarthView::World::Spatial2D::Renderer::CDrawCADUniqueEntityValueTheme*) pObjXXXX;
					pObjectX->EarthView::World::Spatial2D::Renderer::CDrawCADUniqueEntityValueTheme::endDraw();
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_renderer_DrawCADUniqueEntityValueTheme_register_1draw_1ISpatialDisplay_1ISymbol_1IFeature(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCDrawCADUniqueEntityValueThemeProxy *pObjectX = (JCDrawCADUniqueEntityValueThemeProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
