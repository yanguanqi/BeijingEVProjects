...
namespace EarthView
{
	namespace World
	{
		namespace Spatial2D
		{
			namespace Renderer
			{
				class JCDrawSimpleThemeProxy : public EarthView::World::Spatial2D::Renderer::CDrawSimpleTheme
				{
				 private:
				...
				public:
					JCDrawSimpleThemeProxy(EarthView::World::Core::CNameValuePairList *pList) : CDrawSimpleTheme(pList)
					{
					}
				...
				protected:
					C_DISABLE_COPY(JCDrawSimpleThemeProxy)
				public:
				...
				REGISTER_FACTORY_CLASS(JCDrawSimpleThemeProxy);
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_renderer_DrawSimpleTheme_startDraw_1ISpatialDisplay_1ITheme(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong ref_display_j, jlong ref_theme_j)
				{
					...
					EarthView::World::Spatial2D::Renderer::CDrawSimpleTheme *pObjectX = (EarthView::World::Spatial2D::Renderer::CDrawSimpleTheme*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCDrawSimpleThemeProxy))
					{
						pObjectX->EarthView::World::Spatial2D::Renderer::CDrawSimpleTheme::startDraw(ref_display, ref_theme);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_renderer_DrawSimpleTheme_register_1startDraw_1ISpatialDisplay_1ITheme(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCDrawSimpleThemeProxy *pObjectX = (JCDrawSimpleThemeProxy*) pObjXXXX;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_renderer_DrawSimpleTheme_startDraw_1ISpatialDisplay_1ITheme_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong ref_display_j, jlong ref_theme_j)
				{
					EarthView::World::Spatial::Display::ISpatialDisplay *ref_display = (EarthView::World::Spatial::Display::ISpatialDisplay*) ref_display_j;
					EarthView::World::Spatial::Theme::ITheme *ref_theme = (EarthView::World::Spatial::Theme::ITheme*) ref_theme_j;
					EarthView::World::Spatial2D::Renderer::CDrawSimpleTheme *pObjectX = (EarthView::World::Spatial2D::Renderer::CDrawSimpleTheme*) pObjXXXX;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial2d_renderer_DrawSimpleTheme_draw_1IFeatureClass_1IQueryFilter(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong featureClass_j, jlong filter_j)
				{
					...
					if (typeid(*pObjectX) == typeid(JCDrawSimpleThemeProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial2D::Renderer::CDrawSimpleTheme::draw(featureClass, filter);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_renderer_DrawSimpleTheme_register_1draw_1IFeatureClass_1IQueryFilter(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCDrawSimpleThemeProxy *pObjectX = (JCDrawSimpleThemeProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial2d_renderer_DrawSimpleTheme_draw_1IFeatureClass_1IQueryFilter_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong featureClass_j, jlong filter_j)
				{
					EarthView::World::Spatial::GeoDataset::IFeatureClass *featureClass = (EarthView::World::Spatial::GeoDataset::IFeatureClass*) featureClass_j;
					EarthView::World::Spatial::GeoDataset::IQueryFilter *filter = (EarthView::World::Spatial::GeoDataset::IQueryFilter*) filter_j;
					EarthView::World::Spatial2D::Renderer::CDrawSimpleTheme *pObjectX = (EarthView::World::Spatial2D::Renderer::CDrawSimpleTheme*) pObjXXXX;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_renderer_DrawSimpleTheme_endDraw_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial2D::Renderer::CDrawSimpleTheme *pObjectX = (EarthView::World::Spatial2D::Renderer::CDrawSimpleTheme*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCDrawSimpleThemeProxy))
					{
						pObjectX->EarthView::World::Spatial2D::Renderer::CDrawSimpleTheme::endDraw();
					}
					else
					{
						pObjectX->endDraw();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_renderer_DrawSimpleTheme_register_1endDraw_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCDrawSimpleThemeProxy *pObjectX = (JCDrawSimpleThemeProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_renderer_DrawSimpleTheme_endDraw_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial2D::Renderer::CDrawSimpleTheme *pObjectX = (EarthView::World::Spatial2D::Renderer::CDrawSimpleTheme*) pObjXXXX;
					pObjectX->EarthView::World::Spatial2D::Renderer::CDrawSimpleTheme::endDraw();
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_renderer_DrawSimpleTheme_register_1draw_1ISpatialDisplay_1ISymbol_1IFeature(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCDrawSimpleThemeProxy *pObjectX = (JCDrawSimpleThemeProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
