...
namespace EarthView
{
	namespace World
	{
		namespace Plugin
		{
			...
			{
				class JCRingEmitterProxy : public EarthView::World::Plugin::ParticleFX::CRingEmitter
				{
				 private:
				...
				public:
					JCRingEmitterProxy(EarthView::World::Core::CNameValuePairList *pList) : CRingEmitter(pList)
					{
					}
				...
				REGISTER_FACTORY_CLASS(JCRingEmitterProxy);
				class JCRingEmitterCmdInnerXProxy : public EarthView::World::Plugin::ParticleFX::CRingEmitter::CRingEmitterCmdInnerX
				{
				 private:
				...
				public:
					JCRingEmitterCmdInnerXProxy(EarthView::World::Core::CNameValuePairList *pList) : CRingEmitterCmdInnerX(pList)
					{
					}
					ev_void unRegisterJavaReference()
					{
				...
				REGISTER_FACTORY_CLASS(JCRingEmitterCmdInnerXProxy);
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_00024RingEmitterCmdInnerX_doGet_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong target_j)
				{
					const void *target = (const void*) target_j;
					const 					EarthView::World::Plugin::ParticleFX::CRingEmitter::CRingEmitterCmdInnerX *pObjectX = (EarthView::World::Plugin::ParticleFX::CRingEmitter::CRingEmitterCmdInnerX*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCRingEmitterCmdInnerXProxy))
					{
						EVString __values1 = pObjectX->EarthView::World::Plugin::ParticleFX::CRingEmitter::CRingEmitterCmdInnerX::doGet(target);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_00024RingEmitterCmdInnerX_register_1doGet_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCRingEmitterCmdInnerXProxy *pObjectX = (JCRingEmitterCmdInnerXProxy*) pObjXXXX;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_00024RingEmitterCmdInnerX_doGet_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong target_j)
				{
					const void *target = (const void*) target_j;
					const 					EarthView::World::Plugin::ParticleFX::CRingEmitter::CRingEmitterCmdInnerX *pObjectX = (EarthView::World::Plugin::ParticleFX::CRingEmitter::CRingEmitterCmdInnerX*) pObjXXXX;
					EVString __values1 = pObjectX->EarthView::World::Plugin::ParticleFX::CRingEmitter::CRingEmitterCmdInnerX::doGet(target);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_00024RingEmitterCmdInnerX_doSet_1void_1EVString(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong target_j, jstring val_j)
				{
					...
					#endif
					EarthView::World::Plugin::ParticleFX::CRingEmitter::CRingEmitterCmdInnerX *pObjectX = (EarthView::World::Plugin::ParticleFX::CRingEmitter::CRingEmitterCmdInnerX*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCRingEmitterCmdInnerXProxy))
					{
						pObjectX->EarthView::World::Plugin::ParticleFX::CRingEmitter::CRingEmitterCmdInnerX::doSet(target, val);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_00024RingEmitterCmdInnerX_register_1doSet_1void_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCRingEmitterCmdInnerXProxy *pObjectX = (JCRingEmitterCmdInnerXProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_00024RingEmitterCmdInnerX_doSet_1void_1EVString_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong target_j, jstring val_j)
				{
					void *target = (void*) target_j;
					#if EV_PLATFORM == EV_PLATFORM_ANDROID
					const ev_char* val_ch = (const ev_char*)__env->GetStringUTFChars(val_j,JNI_FALSE);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_00024RingEmitterCmdInnerX_register_1trySet_1void_1EVString_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCRingEmitterCmdInnerXProxy *pObjectX = (JCRingEmitterCmdInnerXProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				class JCRingEmitterCmdInnerYProxy : public EarthView::World::Plugin::ParticleFX::CRingEmitter::CRingEmitterCmdInnerY
				{
				 private:
					EarthView::World::Core::ev_string m_doGet_void_callback;
					EarthView::World::Core::ev_string m_doSet_void_EVString_callback;
					EarthView::World::Core::ev_string m_trySet_void_EVString_EVString_callback;
				public:
					JCRingEmitterCmdInnerYProxy(EarthView::World::Core::CNameValuePairList *pList) : CRingEmitterCmdInnerY(pList)
					{
					}
					ev_void unRegisterJavaReference()
					{
				...
				REGISTER_FACTORY_CLASS(JCRingEmitterCmdInnerYProxy);
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_00024RingEmitterCmdInnerY_doGet_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong target_j)
				{
					const void *target = (const void*) target_j;
					const 					EarthView::World::Plugin::ParticleFX::CRingEmitter::CRingEmitterCmdInnerY *pObjectX = (EarthView::World::Plugin::ParticleFX::CRingEmitter::CRingEmitterCmdInnerY*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCRingEmitterCmdInnerYProxy))
					{
						EVString __values1 = pObjectX->EarthView::World::Plugin::ParticleFX::CRingEmitter::CRingEmitterCmdInnerY::doGet(target);
						EarthView::World::Core::ev_wstring valuesw1 = __values1;
						jstring __values1_j = __env->NewString((const jchar*)valuesw1.getString(), valuesw1.size());
						return __values1_j;
					}
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_00024RingEmitterCmdInnerY_register_1doGet_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCRingEmitterCmdInnerYProxy *pObjectX = (JCRingEmitterCmdInnerYProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
					__env->ReleaseStringUTFChars(__method, pMethod);
					pObjectX->register_doGet_void_callback(sMethod);
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_00024RingEmitterCmdInnerY_doGet_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong target_j)
				{
					const void *target = (const void*) target_j;
					const 					EarthView::World::Plugin::ParticleFX::CRingEmitter::CRingEmitterCmdInnerY *pObjectX = (EarthView::World::Plugin::ParticleFX::CRingEmitter::CRingEmitterCmdInnerY*) pObjXXXX;
					EVString __values1 = pObjectX->EarthView::World::Plugin::ParticleFX::CRingEmitter::CRingEmitterCmdInnerY::doGet(target);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_00024RingEmitterCmdInnerY_doSet_1void_1EVString(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong target_j, jstring val_j)
				{
					void *target = (void*) target_j;
					#if EV_PLATFORM == EV_PLATFORM_ANDROID
					const ev_char* val_ch = (const ev_char*)__env->GetStringUTFChars(val_j,JNI_FALSE);
					...
					__env->ReleaseStringChars(val_j, (const jchar *)val_ch);
					#endif
					EarthView::World::Plugin::ParticleFX::CRingEmitter::CRingEmitterCmdInnerY *pObjectX = (EarthView::World::Plugin::ParticleFX::CRingEmitter::CRingEmitterCmdInnerY*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCRingEmitterCmdInnerYProxy))
					{
						pObjectX->EarthView::World::Plugin::ParticleFX::CRingEmitter::CRingEmitterCmdInnerY::doSet(target, val);
					}
					else
					{
						pObjectX->doSet(target, val);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_00024RingEmitterCmdInnerY_register_1doSet_1void_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCRingEmitterCmdInnerYProxy *pObjectX = (JCRingEmitterCmdInnerYProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_00024RingEmitterCmdInnerY_doSet_1void_1EVString_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong target_j, jstring val_j)
				{
					void *target = (void*) target_j;
					#if EV_PLATFORM == EV_PLATFORM_ANDROID
					const ev_char* val_ch = (const ev_char*)__env->GetStringUTFChars(val_j,JNI_FALSE);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_00024RingEmitterCmdInnerY_register_1trySet_1void_1EVString_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCRingEmitterCmdInnerYProxy *pObjectX = (JCRingEmitterCmdInnerYProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter__1initParticle_1CParticle(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong pParticle_j)
				{
					EarthView::World::Graphic::CParticle *pParticle = (EarthView::World::Graphic::CParticle*) pParticle_j;
					EarthView::World::Plugin::ParticleFX::CRingEmitter *pObjectX = (EarthView::World::Plugin::ParticleFX::CRingEmitter*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCRingEmitterProxy))
					{
						pObjectX->EarthView::World::Plugin::ParticleFX::CRingEmitter::_initParticle(pParticle);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_register_1_1initParticle_1CParticle(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCRingEmitterProxy *pObjectX = (JCRingEmitterProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
					__env->ReleaseStringUTFChars(__method, pMethod);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter__1initParticle_1CParticle_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong pParticle_j)
				{
					EarthView::World::Graphic::CParticle *pParticle = (EarthView::World::Graphic::CParticle*) pParticle_j;
					EarthView::World::Plugin::ParticleFX::CRingEmitter *pObjectX = (EarthView::World::Plugin::ParticleFX::CRingEmitter*) pObjXXXX;
					pObjectX->EarthView::World::Plugin::ParticleFX::CRingEmitter::_initParticle(pParticle);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_setInnerSize_1Real_1Real(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble x_j, jdouble y_j)
				{
					Real x = (Real) x_j;
					Real y = (Real) y_j;
					EarthView::World::Plugin::ParticleFX::CRingEmitter *pObjectX = (EarthView::World::Plugin::ParticleFX::CRingEmitter*) pObjXXXX;
					pObjectX->setInnerSize(x, y);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_setInnerSizeX_1Real(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble x_j)
				{
					Real x = (Real) x_j;
					EarthView::World::Plugin::ParticleFX::CRingEmitter *pObjectX = (EarthView::World::Plugin::ParticleFX::CRingEmitter*) pObjXXXX;
					pObjectX->setInnerSizeX(x);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_setInnerSizeY_1Real(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble y_j)
				{
					Real y = (Real) y_j;
					EarthView::World::Plugin::ParticleFX::CRingEmitter *pObjectX = (EarthView::World::Plugin::ParticleFX::CRingEmitter*) pObjXXXX;
					pObjectX->setInnerSizeY(y);
				}
				extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_getInnerSizeX_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Plugin::ParticleFX::CRingEmitter *pObjectX = (EarthView::World::Plugin::ParticleFX::CRingEmitter*) pObjXXXX;
					Real __values1 = pObjectX->getInnerSizeX();
					jdouble __values1_j = (jdouble)__values1;
					return __values1_j;
				}
				extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_getInnerSizeY_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Plugin::ParticleFX::CRingEmitter *pObjectX = (EarthView::World::Plugin::ParticleFX::CRingEmitter*) pObjXXXX;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_register_1getStringInterfacePtr_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCRingEmitterProxy *pObjectX = (JCRingEmitterProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_register_1genEmissionDirectionNoRandom_1CVector3(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCRingEmitterProxy *pObjectX = (JCRingEmitterProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_register_1genEmissionDirection_1CVector3(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCRingEmitterProxy *pObjectX = (JCRingEmitterProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_register_1genEmissionVelocity_1CVector3(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCRingEmitterProxy *pObjectX = (JCRingEmitterProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_register_1genEmissionTTL_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCRingEmitterProxy *pObjectX = (JCRingEmitterProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_register_1genEmissionColour_1CColourValue(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCRingEmitterProxy *pObjectX = (JCRingEmitterProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_register_1genConstantEmissionCount_1Real(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCRingEmitterProxy *pObjectX = (JCRingEmitterProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_register_1setPosition_1CVector3(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCRingEmitterProxy *pObjectX = (JCRingEmitterProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_register_1getPosition_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCRingEmitterProxy *pObjectX = (JCRingEmitterProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_register_1setDirection_1CVector3(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCRingEmitterProxy *pObjectX = (JCRingEmitterProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_register_1getDirection_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCRingEmitterProxy *pObjectX = (JCRingEmitterProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_register_1setUp_1CVector3(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCRingEmitterProxy *pObjectX = (JCRingEmitterProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_register_1getUp_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCRingEmitterProxy *pObjectX = (JCRingEmitterProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_register_1setAngle_1CRadian(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCRingEmitterProxy *pObjectX = (JCRingEmitterProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_register_1getAngle_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCRingEmitterProxy *pObjectX = (JCRingEmitterProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_register_1setParticleVelocity_1Real(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCRingEmitterProxy *pObjectX = (JCRingEmitterProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_register_1setParticleVelocity_1Real_1Real(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCRingEmitterProxy *pObjectX = (JCRingEmitterProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_register_1setMinParticleVelocity_1Real(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCRingEmitterProxy *pObjectX = (JCRingEmitterProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_register_1setMaxParticleVelocity_1Real(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCRingEmitterProxy *pObjectX = (JCRingEmitterProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_register_1getParticleVelocity_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCRingEmitterProxy *pObjectX = (JCRingEmitterProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_register_1getMinParticleVelocity_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCRingEmitterProxy *pObjectX = (JCRingEmitterProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_register_1getMaxParticleVelocity_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCRingEmitterProxy *pObjectX = (JCRingEmitterProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_register_1setEmissionRate_1Real(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCRingEmitterProxy *pObjectX = (JCRingEmitterProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_register_1getEmissionRate_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCRingEmitterProxy *pObjectX = (JCRingEmitterProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_register_1setTimeToLive_1Real(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCRingEmitterProxy *pObjectX = (JCRingEmitterProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_register_1setTimeToLive_1Real_1Real(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCRingEmitterProxy *pObjectX = (JCRingEmitterProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_register_1setMinTimeToLive_1Real(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCRingEmitterProxy *pObjectX = (JCRingEmitterProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_register_1setMaxTimeToLive_1Real(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCRingEmitterProxy *pObjectX = (JCRingEmitterProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_register_1getTimeToLive_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCRingEmitterProxy *pObjectX = (JCRingEmitterProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_register_1getMinTimeToLive_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCRingEmitterProxy *pObjectX = (JCRingEmitterProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_register_1getMaxTimeToLive_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCRingEmitterProxy *pObjectX = (JCRingEmitterProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_register_1setColour_1CColourValue(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCRingEmitterProxy *pObjectX = (JCRingEmitterProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_register_1setColour_1CColourValue_1CColourValue(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCRingEmitterProxy *pObjectX = (JCRingEmitterProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_register_1setColourRangeStart_1CColourValue(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCRingEmitterProxy *pObjectX = (JCRingEmitterProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_register_1setColourRangeEnd_1CColourValue(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCRingEmitterProxy *pObjectX = (JCRingEmitterProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_register_1getColour_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCRingEmitterProxy *pObjectX = (JCRingEmitterProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_register_1getColourRangeStart_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCRingEmitterProxy *pObjectX = (JCRingEmitterProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_register_1getColourRangeEnd_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCRingEmitterProxy *pObjectX = (JCRingEmitterProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_register_1_1getEmissionCount_1Real(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCRingEmitterProxy *pObjectX = (JCRingEmitterProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_register_1setEnabled_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCRingEmitterProxy *pObjectX = (JCRingEmitterProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_register_1getEnabled_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCRingEmitterProxy *pObjectX = (JCRingEmitterProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_register_1setStartTime_1Real(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCRingEmitterProxy *pObjectX = (JCRingEmitterProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_register_1getStartTime_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCRingEmitterProxy *pObjectX = (JCRingEmitterProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_register_1setDuration_1Real(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCRingEmitterProxy *pObjectX = (JCRingEmitterProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_register_1getDuration_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCRingEmitterProxy *pObjectX = (JCRingEmitterProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_register_1setDuration_1Real_1Real(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCRingEmitterProxy *pObjectX = (JCRingEmitterProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_register_1setMinDuration_1Real(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCRingEmitterProxy *pObjectX = (JCRingEmitterProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_register_1setMaxDuration_1Real(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCRingEmitterProxy *pObjectX = (JCRingEmitterProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_register_1getMinDuration_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCRingEmitterProxy *pObjectX = (JCRingEmitterProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_register_1getMaxDuration_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCRingEmitterProxy *pObjectX = (JCRingEmitterProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_register_1setRepeatDelay_1Real(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCRingEmitterProxy *pObjectX = (JCRingEmitterProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_register_1getRepeatDelay_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCRingEmitterProxy *pObjectX = (JCRingEmitterProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_register_1setRepeatDelay_1Real_1Real(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCRingEmitterProxy *pObjectX = (JCRingEmitterProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_register_1setMinRepeatDelay_1Real(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCRingEmitterProxy *pObjectX = (JCRingEmitterProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_register_1setMaxRepeatDelay_1Real(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCRingEmitterProxy *pObjectX = (JCRingEmitterProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_register_1getMinRepeatDelay_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCRingEmitterProxy *pObjectX = (JCRingEmitterProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_register_1getMaxRepeatDelay_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCRingEmitterProxy *pObjectX = (JCRingEmitterProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_register_1setName_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCRingEmitterProxy *pObjectX = (JCRingEmitterProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_register_1setEmittedEmitter_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCRingEmitterProxy *pObjectX = (JCRingEmitterProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_register_1isEmitted_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCRingEmitterProxy *pObjectX = (JCRingEmitterProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_plugin_particlefx_RingEmitter_register_1setEmitted_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCRingEmitterProxy *pObjectX = (JCRingEmitterProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
