...
namespace EarthView
{
	namespace IndustryEngine
	{
		...
		{
			class JCGlobeNodeTrackAnimationStartEventProxy : public EarthView::IndustryEngine::DynamicModelLibrary::CGlobeNodeTrackAnimationStartEvent
			{
			 private:
			...
			public:
				JCGlobeNodeTrackAnimationStartEventProxy(EarthView::World::Core::CNameValuePairList *pList) : CGlobeNodeTrackAnimationStartEvent(pList)
				{
				}
			...
			REGISTER_FACTORY_CLASS(JCGlobeNodeTrackAnimationStartEventProxy);
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_industryengine_dynamicmodellibrary_GlobeNodeTrackAnimationStartEvent_beforeEvent_1CDynamicModelObjectManager_1Real_1ev_1bool(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong manager_j, jdouble curAnimationTime_j, jboolean islooping_j)
			{
				...
				EarthView::IndustryEngine::DynamicModelLibrary::CGlobeNodeTrackAnimationStartEvent *pObjectX = (EarthView::IndustryEngine::DynamicModelLibrary::CGlobeNodeTrackAnimationStartEvent*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCGlobeNodeTrackAnimationStartEventProxy))
				{
					pObjectX->EarthView::IndustryEngine::DynamicModelLibrary::CGlobeNodeTrackAnimationStartEvent::beforeEvent(manager, curAnimationTime, islooping);
				}
				else
				{
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_industryengine_dynamicmodellibrary_GlobeNodeTrackAnimationStartEvent_register_1beforeEvent_1CDynamicModelObjectManager_1Real_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCGlobeNodeTrackAnimationStartEventProxy *pObjectX = (JCGlobeNodeTrackAnimationStartEventProxy*) pObjXXXX;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_industryengine_dynamicmodellibrary_GlobeNodeTrackAnimationStartEvent_beforeEvent_1CDynamicModelObjectManager_1Real_1ev_1bool_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong manager_j, jdouble curAnimationTime_j, jboolean islooping_j)
			{
				EarthView::IndustryEngine::DynamicModelLibrary::CDynamicModelObjectManager *manager = (EarthView::IndustryEngine::DynamicModelLibrary::CDynamicModelObjectManager*) manager_j;
				Real curAnimationTime = (Real) curAnimationTime_j;
				ev_bool islooping = (ev_bool) islooping_j;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_industryengine_dynamicmodellibrary_GlobeNodeTrackAnimationStartEvent_afterEvent_1CDynamicModelObjectManager_1Real_1ev_1bool(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong manager_j, jdouble curAnimationTime_j, jboolean isEnd_j)
			{
				EarthView::IndustryEngine::DynamicModelLibrary::CDynamicModelObjectManager *manager = (EarthView::IndustryEngine::DynamicModelLibrary::CDynamicModelObjectManager*) manager_j;
				Real curAnimationTime = (Real) curAnimationTime_j;
				...
				if (typeid(*pObjectX) == typeid(JCGlobeNodeTrackAnimationStartEventProxy))
				{
					pObjectX->EarthView::IndustryEngine::DynamicModelLibrary::CGlobeNodeTrackAnimationStartEvent::afterEvent(manager, curAnimationTime, isEnd);
				}
				else
				{
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_industryengine_dynamicmodellibrary_GlobeNodeTrackAnimationStartEvent_register_1afterEvent_1CDynamicModelObjectManager_1Real_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCGlobeNodeTrackAnimationStartEventProxy *pObjectX = (JCGlobeNodeTrackAnimationStartEventProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_industryengine_dynamicmodellibrary_GlobeNodeTrackAnimationStartEvent_afterEvent_1CDynamicModelObjectManager_1Real_1ev_1bool_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong manager_j, jdouble curAnimationTime_j, jboolean isEnd_j)
			{
				EarthView::IndustryEngine::DynamicModelLibrary::CDynamicModelObjectManager *manager = (EarthView::IndustryEngine::DynamicModelLibrary::CDynamicModelObjectManager*) manager_j;
				Real curAnimationTime = (Real) curAnimationTime_j;
				ev_bool isEnd = (ev_bool) isEnd_j;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_industryengine_dynamicmodellibrary_GlobeNodeTrackAnimationStartEvent_resetEvent_1CDynamicModelObjectManager(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong manager_j)
			{
				EarthView::IndustryEngine::DynamicModelLibrary::CDynamicModelObjectManager *manager = (EarthView::IndustryEngine::DynamicModelLibrary::CDynamicModelObjectManager*) manager_j;
				EarthView::IndustryEngine::DynamicModelLibrary::CGlobeNodeTrackAnimationStartEvent *pObjectX = (EarthView::IndustryEngine::DynamicModelLibrary::CGlobeNodeTrackAnimationStartEvent*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCGlobeNodeTrackAnimationStartEventProxy))
				{
					pObjectX->EarthView::IndustryEngine::DynamicModelLibrary::CGlobeNodeTrackAnimationStartEvent::resetEvent(manager);
				}
				else
				{
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_industryengine_dynamicmodellibrary_GlobeNodeTrackAnimationStartEvent_register_1resetEvent_1CDynamicModelObjectManager(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCGlobeNodeTrackAnimationStartEventProxy *pObjectX = (JCGlobeNodeTrackAnimationStartEventProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_industryengine_dynamicmodellibrary_GlobeNodeTrackAnimationStartEvent_resetEvent_1CDynamicModelObjectManager_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong manager_j)
			{
				EarthView::IndustryEngine::DynamicModelLibrary::CDynamicModelObjectManager *manager = (EarthView::IndustryEngine::DynamicModelLibrary::CDynamicModelObjectManager*) manager_j;
				EarthView::IndustryEngine::DynamicModelLibrary::CGlobeNodeTrackAnimationStartEvent *pObjectX = (EarthView::IndustryEngine::DynamicModelLibrary::CGlobeNodeTrackAnimationStartEvent*) pObjXXXX;
				pObjectX->EarthView::IndustryEngine::DynamicModelLibrary::CGlobeNodeTrackAnimationStartEvent::resetEvent(manager);
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_industryengine_dynamicmodellibrary_GlobeNodeTrackAnimationStartEvent_register_1setTimePosition_1Real(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCGlobeNodeTrackAnimationStartEventProxy *pObjectX = (JCGlobeNodeTrackAnimationStartEventProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_industryengine_dynamicmodellibrary_GlobeNodeTrackAnimationStartEvent_register_1getTimePosition_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCGlobeNodeTrackAnimationStartEventProxy *pObjectX = (JCGlobeNodeTrackAnimationStartEventProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_industryengine_dynamicmodellibrary_GlobeNodeTrackAnimationStartEvent_register_1setIsFired_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCGlobeNodeTrackAnimationStartEventProxy *pObjectX = (JCGlobeNodeTrackAnimationStartEventProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_industryengine_dynamicmodellibrary_GlobeNodeTrackAnimationStartEvent_register_1getIsFired_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCGlobeNodeTrackAnimationStartEventProxy *pObjectX = (JCGlobeNodeTrackAnimationStartEventProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_industryengine_dynamicmodellibrary_GlobeNodeTrackAnimationStartEvent_register_1canFired_1Real(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCGlobeNodeTrackAnimationStartEventProxy *pObjectX = (JCGlobeNodeTrackAnimationStartEventProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_industryengine_dynamicmodellibrary_GlobeNodeTrackAnimationStartEvent_register_1getName_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCGlobeNodeTrackAnimationStartEventProxy *pObjectX = (JCGlobeNodeTrackAnimationStartEventProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_industryengine_dynamicmodellibrary_GlobeNodeTrackAnimationStartEvent_register_1setName_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCGlobeNodeTrackAnimationStartEventProxy *pObjectX = (JCGlobeNodeTrackAnimationStartEventProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
