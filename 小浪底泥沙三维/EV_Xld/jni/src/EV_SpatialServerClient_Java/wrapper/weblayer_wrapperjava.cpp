...
namespace EarthView
{
	namespace World
	{
		namespace Spatial
		{
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_Ogcresult_getDataPtr_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Spatial::COGCResult *pObjectX = (EarthView::World::Spatial::COGCResult*) pObjXXXX;
				EarthView::World::Core::MemoryDataStreamPtr& __values1 = pObjectX->getDataPtr();
				jlong __values1_j = (jlong) &__values1;
				return __values1_j;
			}
			class JCWebLayerProxy : public EarthView::World::Spatial::CWebLayer
			{
			 private:
			...
			public:
				JCWebLayerProxy(EarthView::World::Core::CNameValuePairList *pList) : CWebLayer(pList)
				{
				}
			...
			REGISTER_FACTORY_CLASS(JCWebLayerProxy);
			extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial_WebLayer_getType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Spatial::CWebLayer *pObjectX = (EarthView::World::Spatial::CWebLayer*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCWebLayerProxy))
				{
					EarthView::World::Spatial::Atlas::EVLayerType __values1 = pObjectX->EarthView::World::Spatial::CWebLayer::getType();
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_WebLayer_register_1getType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCWebLayerProxy *pObjectX = (JCWebLayerProxy*) pObjXXXX;
			...
			extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial_WebLayer_getType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Spatial::CWebLayer *pObjectX = (EarthView::World::Spatial::CWebLayer*) pObjXXXX;
				EarthView::World::Spatial::Atlas::EVLayerType __values1 = pObjectX->EarthView::World::Spatial::CWebLayer::getType();
				jint __values1_j = (jint) __values1;
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_WebLayer_getDataset_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Spatial::CWebLayer *pObjectX = (EarthView::World::Spatial::CWebLayer*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCWebLayerProxy))
				{
					EarthView::World::Spatial::GeoDataset::IDataset* __values1 = pObjectX->EarthView::World::Spatial::CWebLayer::getDataset();
					jlong __values1_j = (jlong) __values1;
					return __values1_j;
				}
				else
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_WebLayer_register_1getDataset_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCWebLayerProxy *pObjectX = (JCWebLayerProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_WebLayer_getDataset_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Spatial::CWebLayer *pObjectX = (EarthView::World::Spatial::CWebLayer*) pObjXXXX;
				EarthView::World::Spatial::GeoDataset::IDataset* __values1 = pObjectX->EarthView::World::Spatial::CWebLayer::getDataset();
				jlong __values1_j = (jlong) __values1;
			...
			extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial_WebLayer_getName_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Spatial::CWebLayer *pObjectX = (EarthView::World::Spatial::CWebLayer*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCWebLayerProxy))
				{
					EVString __values1 = pObjectX->EarthView::World::Spatial::CWebLayer::getName();
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_WebLayer_register_1getName_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCWebLayerProxy *pObjectX = (JCWebLayerProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial_WebLayer_getName_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Spatial::CWebLayer *pObjectX = (EarthView::World::Spatial::CWebLayer*) pObjXXXX;
				EVString __values1 = pObjectX->EarthView::World::Spatial::CWebLayer::getName();
				EarthView::World::Core::ev_wstring valuesw1 = __values1;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_WebLayer_setName_1EVString(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring name_j)
			{
				#if EV_PLATFORM == EV_PLATFORM_ANDROID
				...
				if (typeid(*pObjectX) == typeid(JCWebLayerProxy))
				{
					pObjectX->EarthView::World::Spatial::CWebLayer::setName(name);
				}
				else
				{
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_WebLayer_register_1setName_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCWebLayerProxy *pObjectX = (JCWebLayerProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_WebLayer_setName_1EVString_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring name_j)
			{
				#if EV_PLATFORM == EV_PLATFORM_ANDROID
				const ev_char* name_ch = (const ev_char*)__env->GetStringUTFChars(name_j,JNI_FALSE);
				const EVString name = name_ch;
			...
			extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial_WebLayer_getDescription_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Spatial::CWebLayer *pObjectX = (EarthView::World::Spatial::CWebLayer*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCWebLayerProxy))
				{
					EVString __values1 = pObjectX->EarthView::World::Spatial::CWebLayer::getDescription();
					EarthView::World::Core::ev_wstring valuesw1 = __values1;
					jstring __values1_j = __env->NewString((const jchar*)valuesw1.getString(), valuesw1.size());
					return __values1_j;
				}
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_WebLayer_register_1getDescription_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCWebLayerProxy *pObjectX = (JCWebLayerProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial_WebLayer_getDescription_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Spatial::CWebLayer *pObjectX = (EarthView::World::Spatial::CWebLayer*) pObjXXXX;
				EVString __values1 = pObjectX->EarthView::World::Spatial::CWebLayer::getDescription();
				EarthView::World::Core::ev_wstring valuesw1 = __values1;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_WebLayer_setDescription_1EVString(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring value_j)
			{
				#if EV_PLATFORM == EV_PLATFORM_ANDROID
				...
				if (typeid(*pObjectX) == typeid(JCWebLayerProxy))
				{
					pObjectX->EarthView::World::Spatial::CWebLayer::setDescription(value);
				}
				else
				{
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_WebLayer_register_1setDescription_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCWebLayerProxy *pObjectX = (JCWebLayerProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_WebLayer_setDescription_1EVString_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring value_j)
			{
				#if EV_PLATFORM == EV_PLATFORM_ANDROID
				const ev_char* value_ch = (const ev_char*)__env->GetStringUTFChars(value_j,JNI_FALSE);
				const EVString value = value_ch;
			...
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_WebLayer_canEdit_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Spatial::CWebLayer *pObjectX = (EarthView::World::Spatial::CWebLayer*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCWebLayerProxy))
				{
					ev_bool __values1 = pObjectX->EarthView::World::Spatial::CWebLayer::canEdit();
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_WebLayer_register_1canEdit_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCWebLayerProxy *pObjectX = (JCWebLayerProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_WebLayer_canEdit_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Spatial::CWebLayer *pObjectX = (EarthView::World::Spatial::CWebLayer*) pObjXXXX;
				ev_bool __values1 = pObjectX->EarthView::World::Spatial::CWebLayer::canEdit();
				jboolean __values1_j = (jboolean)__values1;
			...
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_WebLayer_isEditing_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Spatial::CWebLayer *pObjectX = (EarthView::World::Spatial::CWebLayer*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCWebLayerProxy))
				{
					ev_bool __values1 = pObjectX->EarthView::World::Spatial::CWebLayer::isEditing();
					jboolean __values1_j = (jboolean)__values1;
					return __values1_j;
				}
				else
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_WebLayer_register_1isEditing_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCWebLayerProxy *pObjectX = (JCWebLayerProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_WebLayer_isEditing_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Spatial::CWebLayer *pObjectX = (EarthView::World::Spatial::CWebLayer*) pObjXXXX;
				ev_bool __values1 = pObjectX->EarthView::World::Spatial::CWebLayer::isEditing();
				jboolean __values1_j = (jboolean)__values1;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_WebLayer_setEditing_1ev_1bool(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean editing_j)
			{
				ev_bool editing = (ev_bool) editing_j;
				EarthView::World::Spatial::CWebLayer *pObjectX = (EarthView::World::Spatial::CWebLayer*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCWebLayerProxy))
				{
					pObjectX->EarthView::World::Spatial::CWebLayer::setEditing(editing);
				}
				else
				{
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_WebLayer_register_1setEditing_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCWebLayerProxy *pObjectX = (JCWebLayerProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_WebLayer_setEditing_1ev_1bool_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean editing_j)
			{
				ev_bool editing = (ev_bool) editing_j;
				EarthView::World::Spatial::CWebLayer *pObjectX = (EarthView::World::Spatial::CWebLayer*) pObjXXXX;
				pObjectX->EarthView::World::Spatial::CWebLayer::setEditing(editing);
			}
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_WebLayer_isVisible_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Spatial::CWebLayer *pObjectX = (EarthView::World::Spatial::CWebLayer*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCWebLayerProxy))
				{
					ev_bool __values1 = pObjectX->EarthView::World::Spatial::CWebLayer::isVisible();
					jboolean __values1_j = (jboolean)__values1;
					return __values1_j;
				}
				else
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_WebLayer_register_1isVisible_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCWebLayerProxy *pObjectX = (JCWebLayerProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_WebLayer_isVisible_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Spatial::CWebLayer *pObjectX = (EarthView::World::Spatial::CWebLayer*) pObjXXXX;
				ev_bool __values1 = pObjectX->EarthView::World::Spatial::CWebLayer::isVisible();
				jboolean __values1_j = (jboolean)__values1;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_WebLayer_setVisible_1ev_1bool(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean visible_j)
			{
				ev_bool visible = (ev_bool) visible_j;
				EarthView::World::Spatial::CWebLayer *pObjectX = (EarthView::World::Spatial::CWebLayer*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCWebLayerProxy))
				{
					pObjectX->EarthView::World::Spatial::CWebLayer::setVisible(visible);
				}
				else
				{
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_WebLayer_register_1setVisible_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCWebLayerProxy *pObjectX = (JCWebLayerProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_WebLayer_setVisible_1ev_1bool_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean visible_j)
			{
				ev_bool visible = (ev_bool) visible_j;
				EarthView::World::Spatial::CWebLayer *pObjectX = (EarthView::World::Spatial::CWebLayer*) pObjXXXX;
				pObjectX->EarthView::World::Spatial::CWebLayer::setVisible(visible);
			}
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_WebLayer_isValid_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Spatial::CWebLayer *pObjectX = (EarthView::World::Spatial::CWebLayer*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCWebLayerProxy))
				{
					ev_bool __values1 = pObjectX->EarthView::World::Spatial::CWebLayer::isValid();
					jboolean __values1_j = (jboolean)__values1;
					return __values1_j;
				}
				else
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_WebLayer_register_1isValid_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCWebLayerProxy *pObjectX = (JCWebLayerProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_WebLayer_isValid_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Spatial::CWebLayer *pObjectX = (EarthView::World::Spatial::CWebLayer*) pObjXXXX;
				ev_bool __values1 = pObjectX->EarthView::World::Spatial::CWebLayer::isValid();
				jboolean __values1_j = (jboolean)__values1;
			...
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_WebLayer_isSelected_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Spatial::CWebLayer *pObjectX = (EarthView::World::Spatial::CWebLayer*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCWebLayerProxy))
				{
					ev_bool __values1 = pObjectX->EarthView::World::Spatial::CWebLayer::isSelected();
					jboolean __values1_j = (jboolean)__values1;
					return __values1_j;
				}
				else
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_WebLayer_register_1isSelected_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCWebLayerProxy *pObjectX = (JCWebLayerProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_WebLayer_isSelected_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Spatial::CWebLayer *pObjectX = (EarthView::World::Spatial::CWebLayer*) pObjXXXX;
				ev_bool __values1 = pObjectX->EarthView::World::Spatial::CWebLayer::isSelected();
				jboolean __values1_j = (jboolean)__values1;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_WebLayer_setSelected_1ev_1bool(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean selected_j)
			{
				ev_bool selected = (ev_bool) selected_j;
				EarthView::World::Spatial::CWebLayer *pObjectX = (EarthView::World::Spatial::CWebLayer*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCWebLayerProxy))
				{
					pObjectX->EarthView::World::Spatial::CWebLayer::setSelected(selected);
				}
				else
				{
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_WebLayer_register_1setSelected_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCWebLayerProxy *pObjectX = (JCWebLayerProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_WebLayer_setSelected_1ev_1bool_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean selected_j)
			{
				ev_bool selected = (ev_bool) selected_j;
				EarthView::World::Spatial::CWebLayer *pObjectX = (EarthView::World::Spatial::CWebLayer*) pObjXXXX;
				pObjectX->EarthView::World::Spatial::CWebLayer::setSelected(selected);
			}
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_WebLayer_ignoreScale_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Spatial::CWebLayer *pObjectX = (EarthView::World::Spatial::CWebLayer*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCWebLayerProxy))
				{
					ev_bool __values1 = pObjectX->EarthView::World::Spatial::CWebLayer::ignoreScale();
					jboolean __values1_j = (jboolean)__values1;
					return __values1_j;
				}
				else
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_WebLayer_register_1ignoreScale_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCWebLayerProxy *pObjectX = (JCWebLayerProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_WebLayer_ignoreScale_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Spatial::CWebLayer *pObjectX = (EarthView::World::Spatial::CWebLayer*) pObjXXXX;
				ev_bool __values1 = pObjectX->EarthView::World::Spatial::CWebLayer::ignoreScale();
				jboolean __values1_j = (jboolean)__values1;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_WebLayer_setIgnoreScale_1ev_1bool(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean bIgnore_j)
			{
				ev_bool bIgnore = (ev_bool) bIgnore_j;
				EarthView::World::Spatial::CWebLayer *pObjectX = (EarthView::World::Spatial::CWebLayer*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCWebLayerProxy))
				{
					pObjectX->EarthView::World::Spatial::CWebLayer::setIgnoreScale(bIgnore);
				}
				else
				{
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_WebLayer_register_1setIgnoreScale_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCWebLayerProxy *pObjectX = (JCWebLayerProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_WebLayer_setIgnoreScale_1ev_1bool_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean bIgnore_j)
			{
				ev_bool bIgnore = (ev_bool) bIgnore_j;
				EarthView::World::Spatial::CWebLayer *pObjectX = (EarthView::World::Spatial::CWebLayer*) pObjXXXX;
				pObjectX->EarthView::World::Spatial::CWebLayer::setIgnoreScale(bIgnore);
			}
			extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_spatial_WebLayer_getDisplayMaxScale_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Spatial::CWebLayer *pObjectX = (EarthView::World::Spatial::CWebLayer*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCWebLayerProxy))
				{
					ev_real64 __values1 = pObjectX->EarthView::World::Spatial::CWebLayer::getDisplayMaxScale();
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_WebLayer_register_1getDisplayMaxScale_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCWebLayerProxy *pObjectX = (JCWebLayerProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_spatial_WebLayer_getDisplayMaxScale_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Spatial::CWebLayer *pObjectX = (EarthView::World::Spatial::CWebLayer*) pObjXXXX;
				ev_real64 __values1 = pObjectX->EarthView::World::Spatial::CWebLayer::getDisplayMaxScale();
				jdouble __values1_j = (jdouble)__values1;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_WebLayer_setDisplayMaxScale_1ev_1real64(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble scale_j)
			{
				ev_real64 scale = (ev_real64) scale_j;
				EarthView::World::Spatial::CWebLayer *pObjectX = (EarthView::World::Spatial::CWebLayer*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCWebLayerProxy))
				{
					pObjectX->EarthView::World::Spatial::CWebLayer::setDisplayMaxScale(scale);
				}
				else
				{
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_WebLayer_register_1setDisplayMaxScale_1ev_1real64(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCWebLayerProxy *pObjectX = (JCWebLayerProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_WebLayer_setDisplayMaxScale_1ev_1real64_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble scale_j)
			{
				ev_real64 scale = (ev_real64) scale_j;
				EarthView::World::Spatial::CWebLayer *pObjectX = (EarthView::World::Spatial::CWebLayer*) pObjXXXX;
				pObjectX->EarthView::World::Spatial::CWebLayer::setDisplayMaxScale(scale);
			}
			extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_spatial_WebLayer_getDisplayMinScale_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Spatial::CWebLayer *pObjectX = (EarthView::World::Spatial::CWebLayer*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCWebLayerProxy))
				{
					ev_real64 __values1 = pObjectX->EarthView::World::Spatial::CWebLayer::getDisplayMinScale();
					jdouble __values1_j = (jdouble)__values1;
					return __values1_j;
				}
				else
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_WebLayer_register_1getDisplayMinScale_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCWebLayerProxy *pObjectX = (JCWebLayerProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_spatial_WebLayer_getDisplayMinScale_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Spatial::CWebLayer *pObjectX = (EarthView::World::Spatial::CWebLayer*) pObjXXXX;
				ev_real64 __values1 = pObjectX->EarthView::World::Spatial::CWebLayer::getDisplayMinScale();
				jdouble __values1_j = (jdouble)__values1;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_WebLayer_setDisplayMinScale_1ev_1real64(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble scale_j)
			{
				ev_real64 scale = (ev_real64) scale_j;
				EarthView::World::Spatial::CWebLayer *pObjectX = (EarthView::World::Spatial::CWebLayer*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCWebLayerProxy))
				{
					pObjectX->EarthView::World::Spatial::CWebLayer::setDisplayMinScale(scale);
				}
				else
				{
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_WebLayer_register_1setDisplayMinScale_1ev_1real64(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCWebLayerProxy *pObjectX = (JCWebLayerProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_WebLayer_setDisplayMinScale_1ev_1real64_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble scale_j)
			{
				ev_real64 scale = (ev_real64) scale_j;
				EarthView::World::Spatial::CWebLayer *pObjectX = (EarthView::World::Spatial::CWebLayer*) pObjXXXX;
				pObjectX->EarthView::World::Spatial::CWebLayer::setDisplayMinScale(scale);
			}
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_WebLayer_ev_1clone_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Spatial::CWebLayer *pObjectX = (EarthView::World::Spatial::CWebLayer*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCWebLayerProxy))
				{
					EarthView::World::Spatial::Atlas::ILayer* __values1 = pObjectX->EarthView::World::Spatial::CWebLayer::clone();
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_WebLayer_register_1ev_1clone_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCWebLayerProxy *pObjectX = (JCWebLayerProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_WebLayer_ev_1clone_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Spatial::CWebLayer *pObjectX = (EarthView::World::Spatial::CWebLayer*) pObjXXXX;
				EarthView::World::Spatial::Atlas::ILayer* __values1 = pObjectX->EarthView::World::Spatial::CWebLayer::clone();
				if(__values1 != NULL) {					((EarthView::World::Core::CBaseObject*)__values1)->setExternFree(true);
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_WebLayer_getSpatialReference_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Spatial::CWebLayer *pObjectX = (EarthView::World::Spatial::CWebLayer*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCWebLayerProxy))
				{
					EarthView::World::Spatial::Geometry::ISpatialReference* __values1 = pObjectX->EarthView::World::Spatial::CWebLayer::getSpatialReference();
					jlong __values1_j = (jlong) __values1;
					return __values1_j;
				}
				else
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_WebLayer_register_1getSpatialReference_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCWebLayerProxy *pObjectX = (JCWebLayerProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_WebLayer_getSpatialReference_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Spatial::CWebLayer *pObjectX = (EarthView::World::Spatial::CWebLayer*) pObjXXXX;
				EarthView::World::Spatial::Geometry::ISpatialReference* __values1 = pObjectX->EarthView::World::Spatial::CWebLayer::getSpatialReference();
				jlong __values1_j = (jlong) __values1;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_WebLayer_setSpatialReference_1ISpatialReference(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong ref_sr_j)
			{
				EarthView::World::Spatial::Geometry::ISpatialReference *ref_sr = (EarthView::World::Spatial::Geometry::ISpatialReference*) ref_sr_j;
				EarthView::World::Spatial::CWebLayer *pObjectX = (EarthView::World::Spatial::CWebLayer*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCWebLayerProxy))
				{
					pObjectX->EarthView::World::Spatial::CWebLayer::setSpatialReference(ref_sr);
				}
				else
				{
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_WebLayer_register_1setSpatialReference_1ISpatialReference(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCWebLayerProxy *pObjectX = (JCWebLayerProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_WebLayer_setSpatialReference_1ISpatialReference_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong ref_sr_j)
			{
				EarthView::World::Spatial::Geometry::ISpatialReference *ref_sr = (EarthView::World::Spatial::Geometry::ISpatialReference*) ref_sr_j;
				EarthView::World::Spatial::CWebLayer *pObjectX = (EarthView::World::Spatial::CWebLayer*) pObjXXXX;
				pObjectX->EarthView::World::Spatial::CWebLayer::setSpatialReference(ref_sr);
			}
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_WebLayer_getExtent_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Spatial::CWebLayer *pObjectX = (EarthView::World::Spatial::CWebLayer*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCWebLayerProxy))
				{
					const EarthView::World::Spatial::Geometry::IEnvelope* __values1 = pObjectX->EarthView::World::Spatial::CWebLayer::getExtent();
					jlong __values1_j = (jlong) __values1;
					return __values1_j;
				}
				else
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_WebLayer_register_1getExtent_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCWebLayerProxy *pObjectX = (JCWebLayerProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_WebLayer_getExtent_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Spatial::CWebLayer *pObjectX = (EarthView::World::Spatial::CWebLayer*) pObjXXXX;
				const EarthView::World::Spatial::Geometry::IEnvelope* __values1 = pObjectX->EarthView::World::Spatial::CWebLayer::getExtent();
				jlong __values1_j = (jlong) __values1;
			...
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_WebLayer_draw_1ISpatialDisplay_1EVVectorLayerRendererType(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong display_j, jint type_j)
			{
				...
				if (typeid(*pObjectX) == typeid(JCWebLayerProxy))
				{
					ev_bool __values1 = pObjectX->EarthView::World::Spatial::CWebLayer::draw(display, type);
					jboolean __values1_j = (jboolean)__values1;
					return __values1_j;
				}
				else
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_WebLayer_register_1draw_1ISpatialDisplay_1EVVectorLayerRendererType(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCWebLayerProxy *pObjectX = (JCWebLayerProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_WebLayer_draw_1ISpatialDisplay_1EVVectorLayerRendererType_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong display_j, jint type_j)
			{
				EarthView::World::Spatial::Display::ISpatialDisplay *display = (EarthView::World::Spatial::Display::ISpatialDisplay*) display_j;
				EarthView::World::Spatial::Atlas::EVVectorLayerRendererType type = (EarthView::World::Spatial::Atlas::EVVectorLayerRendererType) type_j;
				EarthView::World::Spatial::CWebLayer *pObjectX = (EarthView::World::Spatial::CWebLayer*) pObjXXXX;
			...
			extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial_WebLayer_toXML_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Spatial::CWebLayer *pObjectX = (EarthView::World::Spatial::CWebLayer*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCWebLayerProxy))
				{
					EVString __values1 = pObjectX->EarthView::World::Spatial::CWebLayer::toXML();
					EarthView::World::Core::ev_wstring valuesw1 = __values1;
					jstring __values1_j = __env->NewString((const jchar*)valuesw1.getString(), valuesw1.size());
					return __values1_j;
				}
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_WebLayer_register_1toXML_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCWebLayerProxy *pObjectX = (JCWebLayerProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial_WebLayer_toXML_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Spatial::CWebLayer *pObjectX = (EarthView::World::Spatial::CWebLayer*) pObjXXXX;
				EVString __values1 = pObjectX->EarthView::World::Spatial::CWebLayer::toXML();
				EarthView::World::Core::ev_wstring valuesw1 = __values1;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_WebLayer_fromXmlElement_1CXmlElement(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong element_j)
			{
				EarthView::World::Core::CXmlElement &element = *(EarthView::World::Core::CXmlElement*) element_j;
				EarthView::World::Spatial::CWebLayer *pObjectX = (EarthView::World::Spatial::CWebLayer*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCWebLayerProxy))
				{
					pObjectX->EarthView::World::Spatial::CWebLayer::fromXmlElement(element);
				}
				else
				{
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_WebLayer_register_1fromXmlElement_1CXmlElement(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCWebLayerProxy *pObjectX = (JCWebLayerProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_WebLayer_fromXmlElement_1CXmlElement_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong element_j)
			{
				EarthView::World::Core::CXmlElement &element = *(EarthView::World::Core::CXmlElement*) element_j;
				EarthView::World::Spatial::CWebLayer *pObjectX = (EarthView::World::Spatial::CWebLayer*) pObjXXXX;
				pObjectX->EarthView::World::Spatial::CWebLayer::fromXmlElement(element);
			}
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_WebLayer_toXmlElement_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Spatial::CWebLayer *pObjectX = (EarthView::World::Spatial::CWebLayer*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCWebLayerProxy))
				{
					EarthView::World::Core::CXmlElement __values1 = pObjectX->EarthView::World::Spatial::CWebLayer::toXmlElement();
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_WebLayer_register_1toXmlElement_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCWebLayerProxy *pObjectX = (JCWebLayerProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_WebLayer_toXmlElement_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Spatial::CWebLayer *pObjectX = (EarthView::World::Spatial::CWebLayer*) pObjXXXX;
				EarthView::World::Core::CXmlElement __values1 = pObjectX->EarthView::World::Spatial::CWebLayer::toXmlElement();
				EarthView::World::Core::CXmlElement *returnvalues = new EarthView::World::Core::CXmlElement(__values1);
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_WebLayer_register_1getDatasetName_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCWebLayerProxy *pObjectX = (JCWebLayerProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_WebLayer_register_1getDataSource_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCWebLayerProxy *pObjectX = (JCWebLayerProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_WebLayer_register_1select_1IQueryFilter_1EVSelectionResultType(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCWebLayerProxy *pObjectX = (JCWebLayerProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_WebLayer_register_1clearSelection_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCWebLayerProxy *pObjectX = (JCWebLayerProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_WebLayer_register_1setLayerSelection_1ILayerSelection(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCWebLayerProxy *pObjectX = (JCWebLayerProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_WebLayer_register_1getLayerSelection_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCWebLayerProxy *pObjectX = (JCWebLayerProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_WebLayer_register_1setCanEdit_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCWebLayerProxy *pObjectX = (JCWebLayerProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_WebLayer_register_1isSelectable_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCWebLayerProxy *pObjectX = (JCWebLayerProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_WebLayer_register_1setSelectable_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCWebLayerProxy *pObjectX = (JCWebLayerProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_WebLayer_register_1setTransparentValue_1ev_1uint8(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCWebLayerProxy *pObjectX = (JCWebLayerProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_WebLayer_register_1getTransparentValue_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCWebLayerProxy *pObjectX = (JCWebLayerProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_WebLayer_register_1toStream_1CDataStream(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCWebLayerProxy *pObjectX = (JCWebLayerProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_WebLayer_register_1fromStream_1CDataStream(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCWebLayerProxy *pObjectX = (JCWebLayerProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			class JCWebLayerFactoryProxy : public EarthView::World::Spatial::CWebLayerFactory
			{
			 private:
				EarthView::World::Core::ev_string m_getType_void_callback;
			...
			public:
				JCWebLayerFactoryProxy(EarthView::World::Core::CNameValuePairList *pList) : CWebLayerFactory(pList)
				{
				}
				ev_void unRegisterJavaReference()
				{
			...
			REGISTER_FACTORY_CLASS(JCWebLayerFactoryProxy);
			extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial_WebLayerFactory_getType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Spatial::CWebLayerFactory *pObjectX = (EarthView::World::Spatial::CWebLayerFactory*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCWebLayerFactoryProxy))
				{
					EarthView::World::Spatial::Atlas::EVLayerType __values1 = pObjectX->EarthView::World::Spatial::CWebLayerFactory::getType();
					jint __values1_j = (jint) __values1;
					return __values1_j;
				}
				else
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_WebLayerFactory_register_1getType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCWebLayerFactoryProxy *pObjectX = (JCWebLayerFactoryProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
				__env->ReleaseStringUTFChars(__method, pMethod);
				pObjectX->register_getType_void_callback(sMethod);
			...
			extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial_WebLayerFactory_getType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Spatial::CWebLayerFactory *pObjectX = (EarthView::World::Spatial::CWebLayerFactory*) pObjXXXX;
				EarthView::World::Spatial::Atlas::EVLayerType __values1 = pObjectX->EarthView::World::Spatial::CWebLayerFactory::getType();
				jint __values1_j = (jint) __values1;
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_WebLayerFactory_createInstance_1EVString(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring strXml_j)
			{
				#if EV_PLATFORM == EV_PLATFORM_ANDROID
				...
				#endif
				EarthView::World::Spatial::CWebLayerFactory *pObjectX = (EarthView::World::Spatial::CWebLayerFactory*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCWebLayerFactoryProxy))
				{
					EarthView::World::Spatial::Atlas::ILayer* __values1 = pObjectX->EarthView::World::Spatial::CWebLayerFactory::createInstance(strXml);
					if(__values1 != NULL) {						((EarthView::World::Core::CBaseObject*)__values1)->setExternFree(true);
					}					jlong __values1_j = (jlong) __values1;
					return __values1_j;
				}
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_WebLayerFactory_register_1createInstance_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCWebLayerFactoryProxy *pObjectX = (JCWebLayerFactoryProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_WebLayerFactory_createInstance_1EVString_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring strXml_j)
			{
				#if EV_PLATFORM == EV_PLATFORM_ANDROID
				const ev_char* strXml_ch = (const ev_char*)__env->GetStringUTFChars(strXml_j,JNI_FALSE);
				const EVString strXml = strXml_ch;
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_WebLayerFactory_createInstance_1CXmlElement(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong element_j)
			{
				EarthView::World::Core::CXmlElement &element = *(EarthView::World::Core::CXmlElement*) element_j;
				EarthView::World::Spatial::CWebLayerFactory *pObjectX = (EarthView::World::Spatial::CWebLayerFactory*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCWebLayerFactoryProxy))
				{
					EarthView::World::Spatial::Atlas::ILayer* __values1 = pObjectX->EarthView::World::Spatial::CWebLayerFactory::createInstance(element);
					if(__values1 != NULL) {						((EarthView::World::Core::CBaseObject*)__values1)->setExternFree(true);
					}					jlong __values1_j = (jlong) __values1;
					return __values1_j;
				}
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_WebLayerFactory_register_1createInstance_1CXmlElement(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCWebLayerFactoryProxy *pObjectX = (JCWebLayerFactoryProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_WebLayerFactory_createInstance_1CXmlElement_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong element_j)
			{
				EarthView::World::Core::CXmlElement &element = *(EarthView::World::Core::CXmlElement*) element_j;
				EarthView::World::Spatial::CWebLayerFactory *pObjectX = (EarthView::World::Spatial::CWebLayerFactory*) pObjXXXX;
				EarthView::World::Spatial::Atlas::ILayer* __values1 = pObjectX->EarthView::World::Spatial::CWebLayerFactory::createInstance(element);
			...
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_WebLayerFactory_destroyInstance_1ILayer(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong layer_j)
			{
				EarthView::World::Spatial::Atlas::ILayer *layer = (EarthView::World::Spatial::Atlas::ILayer*) layer_j;
				EarthView::World::Spatial::CWebLayerFactory *pObjectX = (EarthView::World::Spatial::CWebLayerFactory*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCWebLayerFactoryProxy))
				{
					ev_bool __values1 = pObjectX->EarthView::World::Spatial::CWebLayerFactory::destroyInstance(layer);
					jboolean __values1_j = (jboolean)__values1;
					return __values1_j;
				}
				else
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_WebLayerFactory_register_1destroyInstance_1ILayer(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCWebLayerFactoryProxy *pObjectX = (JCWebLayerFactoryProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_WebLayerFactory_destroyInstance_1ILayer_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong layer_j)
			{
				EarthView::World::Spatial::Atlas::ILayer *layer = (EarthView::World::Spatial::Atlas::ILayer*) layer_j;
				EarthView::World::Spatial::CWebLayerFactory *pObjectX = (EarthView::World::Spatial::CWebLayerFactory*) pObjXXXX;
				ev_bool __values1 = pObjectX->EarthView::World::Spatial::CWebLayerFactory::destroyInstance(layer);
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_WebLayerFactory_register_1createInstance_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCWebLayerFactoryProxy *pObjectX = (JCWebLayerFactoryProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
