...
namespace EarthView
{
	namespace World
	{
		namespace Spatial
		{
			class JCOGCSpatialServerProxy : public EarthView::World::Spatial::COGCSpatialServer
			{
			 private:
			...
			public:
				JCOGCSpatialServerProxy(EarthView::World::Core::CNameValuePairList *pList) : COGCSpatialServer(pList)
				{
				}
			...
			REGISTER_FACTORY_CLASS(JCOGCSpatialServerProxy);
			extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial_Ogcspatialserver_getServerName_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Spatial::COGCSpatialServer *pObjectX = (EarthView::World::Spatial::COGCSpatialServer*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCOGCSpatialServerProxy))
				{
					const EVString __values1 = pObjectX->EarthView::World::Spatial::COGCSpatialServer::getServerName();
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_Ogcspatialserver_register_1getServerName_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCOGCSpatialServerProxy *pObjectX = (JCOGCSpatialServerProxy*) pObjXXXX;
			...
			extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial_Ogcspatialserver_getServerName_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Spatial::COGCSpatialServer *pObjectX = (EarthView::World::Spatial::COGCSpatialServer*) pObjXXXX;
				const EVString __values1 = pObjectX->EarthView::World::Spatial::COGCSpatialServer::getServerName();
				EarthView::World::Core::ev_wstring valuesw1 = __values1;
			...
			extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial_Ogcspatialserver_getServerAbstract_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Spatial::COGCSpatialServer *pObjectX = (EarthView::World::Spatial::COGCSpatialServer*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCOGCSpatialServerProxy))
				{
					const EVString __values1 = pObjectX->EarthView::World::Spatial::COGCSpatialServer::getServerAbstract();
					EarthView::World::Core::ev_wstring valuesw1 = __values1;
					jstring __values1_j = __env->NewString((const jchar*)valuesw1.getString(), valuesw1.size());
					return __values1_j;
				}
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_Ogcspatialserver_register_1getServerAbstract_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCOGCSpatialServerProxy *pObjectX = (JCOGCSpatialServerProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial_Ogcspatialserver_getServerAbstract_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Spatial::COGCSpatialServer *pObjectX = (EarthView::World::Spatial::COGCSpatialServer*) pObjXXXX;
				const EVString __values1 = pObjectX->EarthView::World::Spatial::COGCSpatialServer::getServerAbstract();
				EarthView::World::Core::ev_wstring valuesw1 = __values1;
			...
			extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial_Ogcspatialserver_getServerTitle_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Spatial::COGCSpatialServer *pObjectX = (EarthView::World::Spatial::COGCSpatialServer*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCOGCSpatialServerProxy))
				{
					const EVString __values1 = pObjectX->EarthView::World::Spatial::COGCSpatialServer::getServerTitle();
					EarthView::World::Core::ev_wstring valuesw1 = __values1;
					jstring __values1_j = __env->NewString((const jchar*)valuesw1.getString(), valuesw1.size());
					return __values1_j;
				}
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_Ogcspatialserver_register_1getServerTitle_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCOGCSpatialServerProxy *pObjectX = (JCOGCSpatialServerProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial_Ogcspatialserver_getServerTitle_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Spatial::COGCSpatialServer *pObjectX = (EarthView::World::Spatial::COGCSpatialServer*) pObjXXXX;
				const EVString __values1 = pObjectX->EarthView::World::Spatial::COGCSpatialServer::getServerTitle();
				EarthView::World::Core::ev_wstring valuesw1 = __values1;
			...
			extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial_Ogcspatialserver_getServerUrl_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Spatial::COGCSpatialServer *pObjectX = (EarthView::World::Spatial::COGCSpatialServer*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCOGCSpatialServerProxy))
				{
					const EVString __values1 = pObjectX->EarthView::World::Spatial::COGCSpatialServer::getServerUrl();
					EarthView::World::Core::ev_wstring valuesw1 = __values1;
					jstring __values1_j = __env->NewString((const jchar*)valuesw1.getString(), valuesw1.size());
					return __values1_j;
				}
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_Ogcspatialserver_register_1getServerUrl_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCOGCSpatialServerProxy *pObjectX = (JCOGCSpatialServerProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial_Ogcspatialserver_getServerUrl_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Spatial::COGCSpatialServer *pObjectX = (EarthView::World::Spatial::COGCSpatialServer*) pObjXXXX;
				const EVString __values1 = pObjectX->EarthView::World::Spatial::COGCSpatialServer::getServerUrl();
				EarthView::World::Core::ev_wstring valuesw1 = __values1;
			...
			extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial_Ogcspatialserver_toXML_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Spatial::COGCSpatialServer *pObjectX = (EarthView::World::Spatial::COGCSpatialServer*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCOGCSpatialServerProxy))
				{
					EVString __values1 = pObjectX->EarthView::World::Spatial::COGCSpatialServer::toXML();
					EarthView::World::Core::ev_wstring valuesw1 = __values1;
					jstring __values1_j = __env->NewString((const jchar*)valuesw1.getString(), valuesw1.size());
					return __values1_j;
				}
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_Ogcspatialserver_register_1toXML_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCOGCSpatialServerProxy *pObjectX = (JCOGCSpatialServerProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial_Ogcspatialserver_toXML_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Spatial::COGCSpatialServer *pObjectX = (EarthView::World::Spatial::COGCSpatialServer*) pObjXXXX;
				EVString __values1 = pObjectX->EarthView::World::Spatial::COGCSpatialServer::toXML();
				EarthView::World::Core::ev_wstring valuesw1 = __values1;
			...
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_Ogcspatialserver_isConnected_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Spatial::COGCSpatialServer *pObjectX = (EarthView::World::Spatial::COGCSpatialServer*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCOGCSpatialServerProxy))
				{
					ev_bool __values1 = pObjectX->EarthView::World::Spatial::COGCSpatialServer::isConnected();
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_Ogcspatialserver_register_1isConnected_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCOGCSpatialServerProxy *pObjectX = (JCOGCSpatialServerProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_Ogcspatialserver_isConnected_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Spatial::COGCSpatialServer *pObjectX = (EarthView::World::Spatial::COGCSpatialServer*) pObjXXXX;
				ev_bool __values1 = pObjectX->EarthView::World::Spatial::COGCSpatialServer::isConnected();
				jboolean __values1_j = (jboolean)__values1;
			...
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_Ogcspatialserver_reconnect_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Spatial::COGCSpatialServer *pObjectX = (EarthView::World::Spatial::COGCSpatialServer*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCOGCSpatialServerProxy))
				{
					ev_bool __values1 = pObjectX->EarthView::World::Spatial::COGCSpatialServer::reconnect();
					jboolean __values1_j = (jboolean)__values1;
					return __values1_j;
				}
				else
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_Ogcspatialserver_register_1reconnect_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCOGCSpatialServerProxy *pObjectX = (JCOGCSpatialServerProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_Ogcspatialserver_reconnect_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Spatial::COGCSpatialServer *pObjectX = (EarthView::World::Spatial::COGCSpatialServer*) pObjXXXX;
				ev_bool __values1 = pObjectX->EarthView::World::Spatial::COGCSpatialServer::reconnect();
				jboolean __values1_j = (jboolean)__values1;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_Ogcspatialserver_disConnect_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Spatial::COGCSpatialServer *pObjectX = (EarthView::World::Spatial::COGCSpatialServer*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCOGCSpatialServerProxy))
				{
					pObjectX->EarthView::World::Spatial::COGCSpatialServer::disConnect();
				}
				else
				{
					pObjectX->disConnect();
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_Ogcspatialserver_register_1disConnect_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCOGCSpatialServerProxy *pObjectX = (JCOGCSpatialServerProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_Ogcspatialserver_disConnect_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Spatial::COGCSpatialServer *pObjectX = (EarthView::World::Spatial::COGCSpatialServer*) pObjXXXX;
				pObjectX->EarthView::World::Spatial::COGCSpatialServer::disConnect();
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_Ogcspatialserver_register_1getName_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCOGCSpatialServerProxy *pObjectX = (JCOGCSpatialServerProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_Ogcspatialserver_register_1getType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCOGCSpatialServerProxy *pObjectX = (JCOGCSpatialServerProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_Ogcspatialserver_register_1getPropertySet_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCOGCSpatialServerProxy *pObjectX = (JCOGCSpatialServerProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_Ogcspatialserver_register_1isValid_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCOGCSpatialServerProxy *pObjectX = (JCOGCSpatialServerProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_Ogcspatialserver_register_1getDatasetInfo_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCOGCSpatialServerProxy *pObjectX = (JCOGCSpatialServerProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_Ogcspatialserver_register_1getDatasetInfos_1EVDatasetType(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCOGCSpatialServerProxy *pObjectX = (JCOGCSpatialServerProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_Ogcspatialserver_register_1createFeatureClass_1EVString_1IGeometryField_1IFields(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCOGCSpatialServerProxy *pObjectX = (JCOGCSpatialServerProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_Ogcspatialserver_register_1openDataset_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCOGCSpatialServerProxy *pObjectX = (JCOGCSpatialServerProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_Ogcspatialserver_register_1deleteDataset_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCOGCSpatialServerProxy *pObjectX = (JCOGCSpatialServerProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_Ogcspatialserver_register_1closeDataset_1IDataset(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCOGCSpatialServerProxy *pObjectX = (JCOGCSpatialServerProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_Ogcspatialserver_register_1ev_1clone_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCOGCSpatialServerProxy *pObjectX = (JCOGCSpatialServerProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
