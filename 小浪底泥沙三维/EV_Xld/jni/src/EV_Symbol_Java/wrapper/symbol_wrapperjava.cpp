...
namespace EarthView
{
	namespace World
	{
		namespace Spatial
		{
			namespace Display
			{
				class JCSymbolProxy : public EarthView::World::Spatial::Display::CSymbol
				{
				 private:
				...
				public:
					JCSymbolProxy(EarthView::World::Core::CNameValuePairList *pList) : CSymbol(pList)
					{
					}
				...
				REGISTER_FACTORY_CLASS(JCSymbolProxy);
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_Symbol_fromXmlElement_1CXmlElement(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong element_j)
				{
					EarthView::World::Core::CXmlElement &element = *(EarthView::World::Core::CXmlElement*) element_j;
					EarthView::World::Spatial::Display::CSymbol *pObjectX = (EarthView::World::Spatial::Display::CSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCSymbolProxy))
					{
						pObjectX->EarthView::World::Spatial::Display::CSymbol::fromXmlElement(element);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_Symbol_register_1fromXmlElement_1CXmlElement(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCSymbolProxy *pObjectX = (JCSymbolProxy*) pObjXXXX;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_Symbol_fromXmlElement_1CXmlElement_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong element_j)
				{
					EarthView::World::Core::CXmlElement &element = *(EarthView::World::Core::CXmlElement*) element_j;
					EarthView::World::Spatial::Display::CSymbol *pObjectX = (EarthView::World::Spatial::Display::CSymbol*) pObjXXXX;
					pObjectX->EarthView::World::Spatial::Display::CSymbol::fromXmlElement(element);
				}
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_display_Symbol_toXmlElement_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Display::CSymbol *pObjectX = (EarthView::World::Spatial::Display::CSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCSymbolProxy))
					{
						EarthView::World::Core::CXmlElement __values1 = pObjectX->EarthView::World::Spatial::Display::CSymbol::toXmlElement();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_Symbol_register_1toXmlElement_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCSymbolProxy *pObjectX = (JCSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_display_Symbol_toXmlElement_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Display::CSymbol *pObjectX = (EarthView::World::Spatial::Display::CSymbol*) pObjXXXX;
					EarthView::World::Core::CXmlElement __values1 = pObjectX->EarthView::World::Spatial::Display::CSymbol::toXmlElement();
					EarthView::World::Core::CXmlElement *returnvalues = new EarthView::World::Core::CXmlElement(__values1);
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial_display_Symbol_getName_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Display::CSymbol *pObjectX = (EarthView::World::Spatial::Display::CSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCSymbolProxy))
					{
						EVString __values1 = pObjectX->EarthView::World::Spatial::Display::CSymbol::getName();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_Symbol_register_1getName_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCSymbolProxy *pObjectX = (JCSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial_display_Symbol_getName_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Display::CSymbol *pObjectX = (EarthView::World::Spatial::Display::CSymbol*) pObjXXXX;
					EVString __values1 = pObjectX->EarthView::World::Spatial::Display::CSymbol::getName();
					EarthView::World::Core::ev_wstring valuesw1 = __values1;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_Symbol_setName_1EVString(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring szName_j)
				{
					#if EV_PLATFORM == EV_PLATFORM_ANDROID
					...
					if (typeid(*pObjectX) == typeid(JCSymbolProxy))
					{
						pObjectX->EarthView::World::Spatial::Display::CSymbol::setName(szName);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_Symbol_register_1setName_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCSymbolProxy *pObjectX = (JCSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_Symbol_setName_1EVString_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring szName_j)
				{
					#if EV_PLATFORM == EV_PLATFORM_ANDROID
					const ev_char* szName_ch = (const ev_char*)__env->GetStringUTFChars(szName_j,JNI_FALSE);
					const EVString szName = szName_ch;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_display_Symbol_getColor_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Display::CSymbol *pObjectX = (EarthView::World::Spatial::Display::CSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCSymbolProxy))
					{
						EarthView::World::Spatial::Display::IColor* __values1 = pObjectX->EarthView::World::Spatial::Display::CSymbol::getColor();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_Symbol_register_1getColor_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCSymbolProxy *pObjectX = (JCSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_display_Symbol_getColor_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Display::CSymbol *pObjectX = (EarthView::World::Spatial::Display::CSymbol*) pObjXXXX;
					EarthView::World::Spatial::Display::IColor* __values1 = pObjectX->EarthView::World::Spatial::Display::CSymbol::getColor();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_Symbol_setColor_1IColor(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong color_j)
				{
					const EarthView::World::Spatial::Display::IColor *color = (const EarthView::World::Spatial::Display::IColor*) color_j;
					EarthView::World::Spatial::Display::CSymbol *pObjectX = (EarthView::World::Spatial::Display::CSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCSymbolProxy))
					{
						pObjectX->EarthView::World::Spatial::Display::CSymbol::setColor(color);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_Symbol_register_1setColor_1IColor(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCSymbolProxy *pObjectX = (JCSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_Symbol_setColor_1IColor_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong color_j)
				{
					const EarthView::World::Spatial::Display::IColor *color = (const EarthView::World::Spatial::Display::IColor*) color_j;
					EarthView::World::Spatial::Display::CSymbol *pObjectX = (EarthView::World::Spatial::Display::CSymbol*) pObjXXXX;
					pObjectX->EarthView::World::Spatial::Display::CSymbol::setColor(color);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_Symbol_toStream_1CDataStream(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong stream_j)
				{
					EarthView::World::Core::CDataStream &stream = *(EarthView::World::Core::CDataStream*) stream_j;
					const 					EarthView::World::Spatial::Display::CSymbol *pObjectX = (EarthView::World::Spatial::Display::CSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCSymbolProxy))
					{
						pObjectX->EarthView::World::Spatial::Display::CSymbol::toStream(stream);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_Symbol_register_1toStream_1CDataStream(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCSymbolProxy *pObjectX = (JCSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_Symbol_toStream_1CDataStream_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong stream_j)
				{
					EarthView::World::Core::CDataStream &stream = *(EarthView::World::Core::CDataStream*) stream_j;
					const 					EarthView::World::Spatial::Display::CSymbol *pObjectX = (EarthView::World::Spatial::Display::CSymbol*) pObjXXXX;
					pObjectX->EarthView::World::Spatial::Display::CSymbol::toStream(stream);
				}
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial_display_Symbol_toSLD_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Display::CSymbol *pObjectX = (EarthView::World::Spatial::Display::CSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCSymbolProxy))
					{
						EVString __values1 = pObjectX->EarthView::World::Spatial::Display::CSymbol::toSLD();
						EarthView::World::Core::ev_wstring valuesw1 = __values1;
						jstring __values1_j = __env->NewString((const jchar*)valuesw1.getString(), valuesw1.size());
						return __values1_j;
					}
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_Symbol_register_1toSLD_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCSymbolProxy *pObjectX = (JCSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial_display_Symbol_toSLD_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Display::CSymbol *pObjectX = (EarthView::World::Spatial::Display::CSymbol*) pObjXXXX;
					EVString __values1 = pObjectX->EarthView::World::Spatial::Display::CSymbol::toSLD();
					EarthView::World::Core::ev_wstring valuesw1 = __values1;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_display_Symbol_equal_1ISymbol(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong pSymbol_j)
				{
					const EarthView::World::Spatial::Display::ISymbol *pSymbol = (const EarthView::World::Spatial::Display::ISymbol*) pSymbol_j;
					EarthView::World::Spatial::Display::CSymbol *pObjectX = (EarthView::World::Spatial::Display::CSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCSymbolProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial::Display::CSymbol::equal(pSymbol);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_Symbol_register_1equal_1ISymbol(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCSymbolProxy *pObjectX = (JCSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_display_Symbol_equal_1ISymbol_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong pSymbol_j)
				{
					const EarthView::World::Spatial::Display::ISymbol *pSymbol = (const EarthView::World::Spatial::Display::ISymbol*) pSymbol_j;
					EarthView::World::Spatial::Display::CSymbol *pObjectX = (EarthView::World::Spatial::Display::CSymbol*) pObjXXXX;
					ev_bool __values1 = pObjectX->EarthView::World::Spatial::Display::CSymbol::equal(pSymbol);
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_display_Symbol_hasImage_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Display::CSymbol *pObjectX = (EarthView::World::Spatial::Display::CSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCSymbolProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial::Display::CSymbol::hasImage();
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_Symbol_register_1hasImage_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCSymbolProxy *pObjectX = (JCSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_display_Symbol_hasImage_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Display::CSymbol *pObjectX = (EarthView::World::Spatial::Display::CSymbol*) pObjXXXX;
					ev_bool __values1 = pObjectX->EarthView::World::Spatial::Display::CSymbol::hasImage();
					jboolean __values1_j = (jboolean)__values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_display_Symbol_getImageCount_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Display::CSymbol *pObjectX = (EarthView::World::Spatial::Display::CSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCSymbolProxy))
					{
						ev_uint32 __values1 = pObjectX->EarthView::World::Spatial::Display::CSymbol::getImageCount();
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_Symbol_register_1getImageCount_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCSymbolProxy *pObjectX = (JCSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_display_Symbol_getImageCount_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Display::CSymbol *pObjectX = (EarthView::World::Spatial::Display::CSymbol*) pObjXXXX;
					ev_uint32 __values1 = pObjectX->EarthView::World::Spatial::Display::CSymbol::getImageCount();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial_display_Symbol_getImageID_1ev_1uint32(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong index_j)
				{
					ev_uint32 index = (ev_uint32) index_j;
					const 					EarthView::World::Spatial::Display::CSymbol *pObjectX = (EarthView::World::Spatial::Display::CSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCSymbolProxy))
					{
						EVString __values1 = pObjectX->EarthView::World::Spatial::Display::CSymbol::getImageID(index);
						EarthView::World::Core::ev_wstring valuesw1 = __values1;
						jstring __values1_j = __env->NewString((const jchar*)valuesw1.getString(), valuesw1.size());
						return __values1_j;
					}
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_Symbol_register_1getImageID_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCSymbolProxy *pObjectX = (JCSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial_display_Symbol_getImageID_1ev_1uint32_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong index_j)
				{
					ev_uint32 index = (ev_uint32) index_j;
					const 					EarthView::World::Spatial::Display::CSymbol *pObjectX = (EarthView::World::Spatial::Display::CSymbol*) pObjXXXX;
					EVString __values1 = pObjectX->EarthView::World::Spatial::Display::CSymbol::getImageID(index);
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_display_Symbol_getImage_1ev_1uint32(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong index_j)
				{
					ev_uint32 index = (ev_uint32) index_j;
					const 					EarthView::World::Spatial::Display::CSymbol *pObjectX = (EarthView::World::Spatial::Display::CSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCSymbolProxy))
					{
						EarthView::World::Core::MemoryDataStreamPtr __values1 = pObjectX->EarthView::World::Spatial::Display::CSymbol::getImage(index);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_Symbol_register_1getImage_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCSymbolProxy *pObjectX = (JCSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_display_Symbol_getImage_1ev_1uint32_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong index_j)
				{
					ev_uint32 index = (ev_uint32) index_j;
					const 					EarthView::World::Spatial::Display::CSymbol *pObjectX = (EarthView::World::Spatial::Display::CSymbol*) pObjXXXX;
					EarthView::World::Core::MemoryDataStreamPtr __values1 = pObjectX->EarthView::World::Spatial::Display::CSymbol::getImage(index);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_Symbol_setImage_1ev_1uint32_1EVString_1MemoryDataStreamPtr(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong index_j, jstring imageID_j, jlong stream_j)
				{
					ev_uint32 index = (ev_uint32) index_j;
					#if EV_PLATFORM == EV_PLATFORM_ANDROID
					...
					if (typeid(*pObjectX) == typeid(JCSymbolProxy))
					{
						pObjectX->EarthView::World::Spatial::Display::CSymbol::setImage(index, imageID, stream);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_Symbol_register_1setImage_1ev_1uint32_1EVString_1MemoryDataStreamPtr(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCSymbolProxy *pObjectX = (JCSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_Symbol_setImage_1ev_1uint32_1EVString_1MemoryDataStreamPtr_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong index_j, jstring imageID_j, jlong stream_j)
				{
					ev_uint32 index = (ev_uint32) index_j;
					#if EV_PLATFORM == EV_PLATFORM_ANDROID
					const ev_char* imageID_ch = (const ev_char*)__env->GetStringUTFChars(imageID_j,JNI_FALSE);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_Symbol_fromSLD_1EVString(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong sld_j)
				{
					EVString &sld = *(EVString*) sld_j;
					EarthView::World::Spatial::Display::CSymbol *pObjectX = (EarthView::World::Spatial::Display::CSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCSymbolProxy))
					{
						pObjectX->EarthView::World::Spatial::Display::CSymbol::fromSLD(sld);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_Symbol_register_1fromSLD_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCSymbolProxy *pObjectX = (JCSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_Symbol_fromSLD_1EVString_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong sld_j)
				{
					EVString &sld = *(EVString*) sld_j;
					EarthView::World::Spatial::Display::CSymbol *pObjectX = (EarthView::World::Spatial::Display::CSymbol*) pObjXXXX;
					pObjectX->EarthView::World::Spatial::Display::CSymbol::fromSLD(sld);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_Symbol_fromStream_1CDataStream(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong stream_j)
				{
					EarthView::World::Core::CDataStream &stream = *(EarthView::World::Core::CDataStream*) stream_j;
					EarthView::World::Spatial::Display::CSymbol *pObjectX = (EarthView::World::Spatial::Display::CSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCSymbolProxy))
					{
						pObjectX->EarthView::World::Spatial::Display::CSymbol::fromStream(stream);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_Symbol_register_1fromStream_1CDataStream(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCSymbolProxy *pObjectX = (JCSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_Symbol_fromStream_1CDataStream_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong stream_j)
				{
					EarthView::World::Core::CDataStream &stream = *(EarthView::World::Core::CDataStream*) stream_j;
					EarthView::World::Spatial::Display::CSymbol *pObjectX = (EarthView::World::Spatial::Display::CSymbol*) pObjXXXX;
					pObjectX->EarthView::World::Spatial::Display::CSymbol::fromStream(stream);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_Symbol_register_1getSize_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCSymbolProxy *pObjectX = (JCSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_Symbol_register_1getColorRef_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCSymbolProxy *pObjectX = (JCSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_Symbol_register_1ev_1clone_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCSymbolProxy *pObjectX = (JCSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_Symbol_register_1getSymbolType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCSymbolProxy *pObjectX = (JCSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
