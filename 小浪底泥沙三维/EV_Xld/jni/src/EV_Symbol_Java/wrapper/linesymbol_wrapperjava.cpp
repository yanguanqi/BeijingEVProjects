...
namespace EarthView
{
	namespace World
	{
		namespace Spatial
		{
			namespace Display
			{
				extern "C" JNIEXPORT jintArray JNICALL Java_com_earthview_world_spatial_display_EVLineCapTypeHelper_getEnumValues (JNIEnv *__env, jclass __clazz)
				{
					jint enum_values[] = {
						LCT_LINECAPTYPE_FLAT,
						LCT_LINECAPTYPE_SQUARE,
						LCT_LINECAPTYPE_ROUND
					};
					jintArray array = __env->NewIntArray(3);
					__env->SetIntArrayRegion(array, 0, 3, enum_values);
					return array;
				}
				extern "C" JNIEXPORT jintArray JNICALL Java_com_earthview_world_spatial_display_EVLineJoinTypeHelper_getEnumValues (JNIEnv *__env, jclass __clazz)
				{
					jint enum_values[] = {
						LJT_LINEJOINTYPE_BEVEL,
						LJT_LINEJOINTYPE_MITER,
						LJT_LINEJOINTYPE_ROUND
					};
					jintArray array = __env->NewIntArray(3);
					__env->SetIntArrayRegion(array, 0, 3, enum_values);
					return array;
				}
				class JCLineSymbolProxy : public EarthView::World::Spatial::Display::CLineSymbol
				{
				 private:
				...
				public:
					JCLineSymbolProxy(EarthView::World::Core::CNameValuePairList *pList) : CLineSymbol(pList)
					{
					}
				...
				REGISTER_FACTORY_CLASS(JCLineSymbolProxy);
				extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_spatial_display_LineSymbol_getWidth_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Display::CLineSymbol *pObjectX = (EarthView::World::Spatial::Display::CLineSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCLineSymbolProxy))
					{
						ev_real64 __values1 = pObjectX->EarthView::World::Spatial::Display::CLineSymbol::getWidth();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_LineSymbol_register_1getWidth_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCLineSymbolProxy *pObjectX = (JCLineSymbolProxy*) pObjXXXX;
				...
				extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_spatial_display_LineSymbol_getWidth_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Display::CLineSymbol *pObjectX = (EarthView::World::Spatial::Display::CLineSymbol*) pObjXXXX;
					ev_real64 __values1 = pObjectX->EarthView::World::Spatial::Display::CLineSymbol::getWidth();
					jdouble __values1_j = (jdouble)__values1;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_LineSymbol_setWidth_1ev_1real64(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble dWidth_j)
				{
					ev_real64 dWidth = (ev_real64) dWidth_j;
					EarthView::World::Spatial::Display::CLineSymbol *pObjectX = (EarthView::World::Spatial::Display::CLineSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCLineSymbolProxy))
					{
						pObjectX->EarthView::World::Spatial::Display::CLineSymbol::setWidth(dWidth);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_LineSymbol_register_1setWidth_1ev_1real64(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCLineSymbolProxy *pObjectX = (JCLineSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_LineSymbol_setWidth_1ev_1real64_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble dWidth_j)
				{
					ev_real64 dWidth = (ev_real64) dWidth_j;
					EarthView::World::Spatial::Display::CLineSymbol *pObjectX = (EarthView::World::Spatial::Display::CLineSymbol*) pObjXXXX;
					pObjectX->EarthView::World::Spatial::Display::CLineSymbol::setWidth(dWidth);
				}
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial_display_LineSymbol_getJoinType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial::Display::CLineSymbol *pObjectX = (EarthView::World::Spatial::Display::CLineSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCLineSymbolProxy))
					{
						EarthView::World::Spatial::Display::EVLineJoinType __values1 = pObjectX->EarthView::World::Spatial::Display::CLineSymbol::getJoinType();
						jint __values1_j = (jint) __values1;
						return __values1_j;
					}
					else
					{
						EarthView::World::Spatial::Display::EVLineJoinType __values1 = pObjectX->getJoinType();
						jint __values1_j = (jint) __values1;
						return __values1_j;
					}
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_LineSymbol_register_1getJoinType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCLineSymbolProxy *pObjectX = (JCLineSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial_display_LineSymbol_getJoinType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial::Display::CLineSymbol *pObjectX = (EarthView::World::Spatial::Display::CLineSymbol*) pObjXXXX;
					EarthView::World::Spatial::Display::EVLineJoinType __values1 = pObjectX->EarthView::World::Spatial::Display::CLineSymbol::getJoinType();
					jint __values1_j = (jint) __values1;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial_display_LineSymbol_getCapType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial::Display::CLineSymbol *pObjectX = (EarthView::World::Spatial::Display::CLineSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCLineSymbolProxy))
					{
						EarthView::World::Spatial::Display::EVLineCapType __values1 = pObjectX->EarthView::World::Spatial::Display::CLineSymbol::getCapType();
						jint __values1_j = (jint) __values1;
						return __values1_j;
					}
					else
					{
						EarthView::World::Spatial::Display::EVLineCapType __values1 = pObjectX->getCapType();
						jint __values1_j = (jint) __values1;
						return __values1_j;
					}
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_LineSymbol_register_1getCapType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCLineSymbolProxy *pObjectX = (JCLineSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial_display_LineSymbol_getCapType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial::Display::CLineSymbol *pObjectX = (EarthView::World::Spatial::Display::CLineSymbol*) pObjXXXX;
					EarthView::World::Spatial::Display::EVLineCapType __values1 = pObjectX->EarthView::World::Spatial::Display::CLineSymbol::getCapType();
					jint __values1_j = (jint) __values1;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_LineSymbol_setJoinType_1EVLineJoinType(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint nType_j)
				{
					EarthView::World::Spatial::Display::EVLineJoinType nType = (EarthView::World::Spatial::Display::EVLineJoinType) nType_j;
					EarthView::World::Spatial::Display::CLineSymbol *pObjectX = (EarthView::World::Spatial::Display::CLineSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCLineSymbolProxy))
					{
						pObjectX->EarthView::World::Spatial::Display::CLineSymbol::setJoinType(nType);
					}
					else
					{
						pObjectX->setJoinType(nType);
					}
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_LineSymbol_register_1setJoinType_1EVLineJoinType(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCLineSymbolProxy *pObjectX = (JCLineSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_LineSymbol_setJoinType_1EVLineJoinType_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint nType_j)
				{
					EarthView::World::Spatial::Display::EVLineJoinType nType = (EarthView::World::Spatial::Display::EVLineJoinType) nType_j;
					EarthView::World::Spatial::Display::CLineSymbol *pObjectX = (EarthView::World::Spatial::Display::CLineSymbol*) pObjXXXX;
					pObjectX->EarthView::World::Spatial::Display::CLineSymbol::setJoinType(nType);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_LineSymbol_setCapType_1EVLineCapType(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint nType_j)
				{
					EarthView::World::Spatial::Display::EVLineCapType nType = (EarthView::World::Spatial::Display::EVLineCapType) nType_j;
					EarthView::World::Spatial::Display::CLineSymbol *pObjectX = (EarthView::World::Spatial::Display::CLineSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCLineSymbolProxy))
					{
						pObjectX->EarthView::World::Spatial::Display::CLineSymbol::setCapType(nType);
					}
					else
					{
						pObjectX->setCapType(nType);
					}
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_LineSymbol_register_1setCapType_1EVLineCapType(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCLineSymbolProxy *pObjectX = (JCLineSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_LineSymbol_setCapType_1EVLineCapType_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint nType_j)
				{
					EarthView::World::Spatial::Display::EVLineCapType nType = (EarthView::World::Spatial::Display::EVLineCapType) nType_j;
					EarthView::World::Spatial::Display::CLineSymbol *pObjectX = (EarthView::World::Spatial::Display::CLineSymbol*) pObjXXXX;
					pObjectX->EarthView::World::Spatial::Display::CLineSymbol::setCapType(nType);
				}
				extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_spatial_display_LineSymbol_getOffset_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Display::CLineSymbol *pObjectX = (EarthView::World::Spatial::Display::CLineSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCLineSymbolProxy))
					{
						ev_real64 __values1 = pObjectX->EarthView::World::Spatial::Display::CLineSymbol::getOffset();
						jdouble __values1_j = (jdouble)__values1;
						return __values1_j;
					}
					else
					{
						ev_real64 __values1 = pObjectX->getOffset();
						jdouble __values1_j = (jdouble)__values1;
						return __values1_j;
					}
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_LineSymbol_register_1getOffset_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCLineSymbolProxy *pObjectX = (JCLineSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_spatial_display_LineSymbol_getOffset_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Display::CLineSymbol *pObjectX = (EarthView::World::Spatial::Display::CLineSymbol*) pObjXXXX;
					ev_real64 __values1 = pObjectX->EarthView::World::Spatial::Display::CLineSymbol::getOffset();
					jdouble __values1_j = (jdouble)__values1;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_LineSymbol_setOffset_1ev_1real64(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble value_j)
				{
					ev_real64 value = (ev_real64) value_j;
					EarthView::World::Spatial::Display::CLineSymbol *pObjectX = (EarthView::World::Spatial::Display::CLineSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCLineSymbolProxy))
					{
						pObjectX->EarthView::World::Spatial::Display::CLineSymbol::setOffset(value);
					}
					else
					{
						pObjectX->setOffset(value);
					}
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_LineSymbol_register_1setOffset_1ev_1real64(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCLineSymbolProxy *pObjectX = (JCLineSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_LineSymbol_setOffset_1ev_1real64_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble value_j)
				{
					ev_real64 value = (ev_real64) value_j;
					EarthView::World::Spatial::Display::CLineSymbol *pObjectX = (EarthView::World::Spatial::Display::CLineSymbol*) pObjXXXX;
					pObjectX->EarthView::World::Spatial::Display::CLineSymbol::setOffset(value);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_LineSymbol_toStream_1CDataStream(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong stream_j)
				{
					EarthView::World::Core::CDataStream &stream = *(EarthView::World::Core::CDataStream*) stream_j;
					const 					EarthView::World::Spatial::Display::CLineSymbol *pObjectX = (EarthView::World::Spatial::Display::CLineSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCLineSymbolProxy))
					{
						pObjectX->EarthView::World::Spatial::Display::CLineSymbol::toStream(stream);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_LineSymbol_register_1toStream_1CDataStream(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCLineSymbolProxy *pObjectX = (JCLineSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_LineSymbol_toStream_1CDataStream_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong stream_j)
				{
					EarthView::World::Core::CDataStream &stream = *(EarthView::World::Core::CDataStream*) stream_j;
					const 					EarthView::World::Spatial::Display::CLineSymbol *pObjectX = (EarthView::World::Spatial::Display::CLineSymbol*) pObjXXXX;
					pObjectX->EarthView::World::Spatial::Display::CLineSymbol::toStream(stream);
				}
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial_display_LineSymbol_toSLD_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Display::CLineSymbol *pObjectX = (EarthView::World::Spatial::Display::CLineSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCLineSymbolProxy))
					{
						EVString __values1 = pObjectX->EarthView::World::Spatial::Display::CLineSymbol::toSLD();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_LineSymbol_register_1toSLD_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCLineSymbolProxy *pObjectX = (JCLineSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial_display_LineSymbol_toSLD_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Display::CLineSymbol *pObjectX = (EarthView::World::Spatial::Display::CLineSymbol*) pObjXXXX;
					EVString __values1 = pObjectX->EarthView::World::Spatial::Display::CLineSymbol::toSLD();
					EarthView::World::Core::ev_wstring valuesw1 = __values1;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_LineSymbol_fromXmlElement_1CXmlElement(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong element_j)
				{
					EarthView::World::Core::CXmlElement &element = *(EarthView::World::Core::CXmlElement*) element_j;
					EarthView::World::Spatial::Display::CLineSymbol *pObjectX = (EarthView::World::Spatial::Display::CLineSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCLineSymbolProxy))
					{
						pObjectX->EarthView::World::Spatial::Display::CLineSymbol::fromXmlElement(element);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_LineSymbol_register_1fromXmlElement_1CXmlElement(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCLineSymbolProxy *pObjectX = (JCLineSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_LineSymbol_fromXmlElement_1CXmlElement_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong element_j)
				{
					EarthView::World::Core::CXmlElement &element = *(EarthView::World::Core::CXmlElement*) element_j;
					EarthView::World::Spatial::Display::CLineSymbol *pObjectX = (EarthView::World::Spatial::Display::CLineSymbol*) pObjXXXX;
					pObjectX->EarthView::World::Spatial::Display::CLineSymbol::fromXmlElement(element);
				}
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_display_LineSymbol_toXmlElement_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Display::CLineSymbol *pObjectX = (EarthView::World::Spatial::Display::CLineSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCLineSymbolProxy))
					{
						EarthView::World::Core::CXmlElement __values1 = pObjectX->EarthView::World::Spatial::Display::CLineSymbol::toXmlElement();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_LineSymbol_register_1toXmlElement_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCLineSymbolProxy *pObjectX = (JCLineSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_display_LineSymbol_toXmlElement_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Display::CLineSymbol *pObjectX = (EarthView::World::Spatial::Display::CLineSymbol*) pObjXXXX;
					EarthView::World::Core::CXmlElement __values1 = pObjectX->EarthView::World::Spatial::Display::CLineSymbol::toXmlElement();
					EarthView::World::Core::CXmlElement *returnvalues = new EarthView::World::Core::CXmlElement(__values1);
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_display_LineSymbol_equal_1ISymbol(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong pSymbol_j)
				{
					const EarthView::World::Spatial::Display::ISymbol *pSymbol = (const EarthView::World::Spatial::Display::ISymbol*) pSymbol_j;
					EarthView::World::Spatial::Display::CLineSymbol *pObjectX = (EarthView::World::Spatial::Display::CLineSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCLineSymbolProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial::Display::CLineSymbol::equal(pSymbol);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_LineSymbol_register_1equal_1ISymbol(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCLineSymbolProxy *pObjectX = (JCLineSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_display_LineSymbol_equal_1ISymbol_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong pSymbol_j)
				{
					const EarthView::World::Spatial::Display::ISymbol *pSymbol = (const EarthView::World::Spatial::Display::ISymbol*) pSymbol_j;
					EarthView::World::Spatial::Display::CLineSymbol *pObjectX = (EarthView::World::Spatial::Display::CLineSymbol*) pObjXXXX;
					ev_bool __values1 = pObjectX->EarthView::World::Spatial::Display::CLineSymbol::equal(pSymbol);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_LineSymbol_fromSLD_1EVString(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong sld_j)
				{
					EVString &sld = *(EVString*) sld_j;
					EarthView::World::Spatial::Display::CLineSymbol *pObjectX = (EarthView::World::Spatial::Display::CLineSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCLineSymbolProxy))
					{
						pObjectX->EarthView::World::Spatial::Display::CLineSymbol::fromSLD(sld);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_LineSymbol_register_1fromSLD_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCLineSymbolProxy *pObjectX = (JCLineSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_LineSymbol_fromSLD_1EVString_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong sld_j)
				{
					EVString &sld = *(EVString*) sld_j;
					EarthView::World::Spatial::Display::CLineSymbol *pObjectX = (EarthView::World::Spatial::Display::CLineSymbol*) pObjXXXX;
					pObjectX->EarthView::World::Spatial::Display::CLineSymbol::fromSLD(sld);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_LineSymbol_fromStream_1CDataStream(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong stream_j)
				{
					EarthView::World::Core::CDataStream &stream = *(EarthView::World::Core::CDataStream*) stream_j;
					EarthView::World::Spatial::Display::CLineSymbol *pObjectX = (EarthView::World::Spatial::Display::CLineSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCLineSymbolProxy))
					{
						pObjectX->EarthView::World::Spatial::Display::CLineSymbol::fromStream(stream);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_LineSymbol_register_1fromStream_1CDataStream(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCLineSymbolProxy *pObjectX = (JCLineSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_LineSymbol_fromStream_1CDataStream_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong stream_j)
				{
					EarthView::World::Core::CDataStream &stream = *(EarthView::World::Core::CDataStream*) stream_j;
					EarthView::World::Spatial::Display::CLineSymbol *pObjectX = (EarthView::World::Spatial::Display::CLineSymbol*) pObjXXXX;
					pObjectX->EarthView::World::Spatial::Display::CLineSymbol::fromStream(stream);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_LineSymbol_register_1getSize_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCLineSymbolProxy *pObjectX = (JCLineSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_LineSymbol_register_1getColorRef_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCLineSymbolProxy *pObjectX = (JCLineSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_LineSymbol_register_1ev_1clone_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCLineSymbolProxy *pObjectX = (JCLineSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_LineSymbol_register_1getColor_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCLineSymbolProxy *pObjectX = (JCLineSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_LineSymbol_register_1setColor_1IColor(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCLineSymbolProxy *pObjectX = (JCLineSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_LineSymbol_register_1getSymbolType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCLineSymbolProxy *pObjectX = (JCLineSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_LineSymbol_register_1hasImage_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCLineSymbolProxy *pObjectX = (JCLineSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_LineSymbol_register_1getImageCount_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCLineSymbolProxy *pObjectX = (JCLineSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_LineSymbol_register_1getImageID_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCLineSymbolProxy *pObjectX = (JCLineSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_LineSymbol_register_1getImage_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCLineSymbolProxy *pObjectX = (JCLineSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_LineSymbol_register_1setImage_1ev_1uint32_1EVString_1MemoryDataStreamPtr(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCLineSymbolProxy *pObjectX = (JCLineSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_LineSymbol_register_1getName_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCLineSymbolProxy *pObjectX = (JCLineSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_LineSymbol_register_1setName_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCLineSymbolProxy *pObjectX = (JCLineSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
