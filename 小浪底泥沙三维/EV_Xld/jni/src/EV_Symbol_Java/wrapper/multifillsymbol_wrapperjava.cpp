...
namespace EarthView
{
	namespace World
	{
		namespace Spatial
		{
			namespace Display
			{
				class JCMultiFillSymbolProxy : public EarthView::World::Spatial::Display::CMultiFillSymbol
				{
				 private:
				...
				public:
					JCMultiFillSymbolProxy(EarthView::World::Core::CNameValuePairList *pList) : CMultiFillSymbol(pList)
					{
					}
				...
				REGISTER_FACTORY_CLASS(JCMultiFillSymbolProxy);
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial_display_MultiFillSymbol_getSymbolType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Display::CMultiFillSymbol *pObjectX = (EarthView::World::Spatial::Display::CMultiFillSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCMultiFillSymbolProxy))
					{
						ev_int32 __values1 = pObjectX->EarthView::World::Spatial::Display::CMultiFillSymbol::getSymbolType();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_MultiFillSymbol_register_1getSymbolType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMultiFillSymbolProxy *pObjectX = (JCMultiFillSymbolProxy*) pObjXXXX;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial_display_MultiFillSymbol_getSymbolType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Display::CMultiFillSymbol *pObjectX = (EarthView::World::Spatial::Display::CMultiFillSymbol*) pObjXXXX;
					ev_int32 __values1 = pObjectX->EarthView::World::Spatial::Display::CMultiFillSymbol::getSymbolType();
					jint __values1_j = (jint)__values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_display_MultiFillSymbol_ev_1clone_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Display::CMultiFillSymbol *pObjectX = (EarthView::World::Spatial::Display::CMultiFillSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCMultiFillSymbolProxy))
					{
						EarthView::World::Spatial::Display::ISymbol* __values1 = pObjectX->EarthView::World::Spatial::Display::CMultiFillSymbol::clone();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_MultiFillSymbol_register_1ev_1clone_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMultiFillSymbolProxy *pObjectX = (JCMultiFillSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_display_MultiFillSymbol_ev_1clone_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Display::CMultiFillSymbol *pObjectX = (EarthView::World::Spatial::Display::CMultiFillSymbol*) pObjXXXX;
					EarthView::World::Spatial::Display::ISymbol* __values1 = pObjectX->EarthView::World::Spatial::Display::CMultiFillSymbol::clone();
					if(__values1 != NULL) {						((EarthView::World::Core::CBaseObject*)__values1)->setExternFree(true);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_MultiFillSymbol_toStream_1CDataStream(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong stream_j)
				{
					EarthView::World::Core::CDataStream &stream = *(EarthView::World::Core::CDataStream*) stream_j;
					const 					EarthView::World::Spatial::Display::CMultiFillSymbol *pObjectX = (EarthView::World::Spatial::Display::CMultiFillSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCMultiFillSymbolProxy))
					{
						pObjectX->EarthView::World::Spatial::Display::CMultiFillSymbol::toStream(stream);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_MultiFillSymbol_register_1toStream_1CDataStream(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMultiFillSymbolProxy *pObjectX = (JCMultiFillSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_MultiFillSymbol_toStream_1CDataStream_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong stream_j)
				{
					EarthView::World::Core::CDataStream &stream = *(EarthView::World::Core::CDataStream*) stream_j;
					const 					EarthView::World::Spatial::Display::CMultiFillSymbol *pObjectX = (EarthView::World::Spatial::Display::CMultiFillSymbol*) pObjXXXX;
					pObjectX->EarthView::World::Spatial::Display::CMultiFillSymbol::toStream(stream);
				}
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial_display_MultiFillSymbol_toSLD_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Display::CMultiFillSymbol *pObjectX = (EarthView::World::Spatial::Display::CMultiFillSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCMultiFillSymbolProxy))
					{
						EVString __values1 = pObjectX->EarthView::World::Spatial::Display::CMultiFillSymbol::toSLD();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_MultiFillSymbol_register_1toSLD_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMultiFillSymbolProxy *pObjectX = (JCMultiFillSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial_display_MultiFillSymbol_toSLD_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Display::CMultiFillSymbol *pObjectX = (EarthView::World::Spatial::Display::CMultiFillSymbol*) pObjXXXX;
					EVString __values1 = pObjectX->EarthView::World::Spatial::Display::CMultiFillSymbol::toSLD();
					EarthView::World::Core::ev_wstring valuesw1 = __values1;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_MultiFillSymbol_fromXmlElement_1CXmlElement(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong element_j)
				{
					EarthView::World::Core::CXmlElement &element = *(EarthView::World::Core::CXmlElement*) element_j;
					EarthView::World::Spatial::Display::CMultiFillSymbol *pObjectX = (EarthView::World::Spatial::Display::CMultiFillSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCMultiFillSymbolProxy))
					{
						pObjectX->EarthView::World::Spatial::Display::CMultiFillSymbol::fromXmlElement(element);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_MultiFillSymbol_register_1fromXmlElement_1CXmlElement(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMultiFillSymbolProxy *pObjectX = (JCMultiFillSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_MultiFillSymbol_fromXmlElement_1CXmlElement_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong element_j)
				{
					EarthView::World::Core::CXmlElement &element = *(EarthView::World::Core::CXmlElement*) element_j;
					EarthView::World::Spatial::Display::CMultiFillSymbol *pObjectX = (EarthView::World::Spatial::Display::CMultiFillSymbol*) pObjXXXX;
					pObjectX->EarthView::World::Spatial::Display::CMultiFillSymbol::fromXmlElement(element);
				}
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_display_MultiFillSymbol_toXmlElement_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Display::CMultiFillSymbol *pObjectX = (EarthView::World::Spatial::Display::CMultiFillSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCMultiFillSymbolProxy))
					{
						EarthView::World::Core::CXmlElement __values1 = pObjectX->EarthView::World::Spatial::Display::CMultiFillSymbol::toXmlElement();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_MultiFillSymbol_register_1toXmlElement_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMultiFillSymbolProxy *pObjectX = (JCMultiFillSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_display_MultiFillSymbol_toXmlElement_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Display::CMultiFillSymbol *pObjectX = (EarthView::World::Spatial::Display::CMultiFillSymbol*) pObjXXXX;
					EarthView::World::Core::CXmlElement __values1 = pObjectX->EarthView::World::Spatial::Display::CMultiFillSymbol::toXmlElement();
					EarthView::World::Core::CXmlElement *returnvalues = new EarthView::World::Core::CXmlElement(__values1);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_MultiFillSymbol_fromSLD_1EVString(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong sld_j)
				{
					EVString &sld = *(EVString*) sld_j;
					EarthView::World::Spatial::Display::CMultiFillSymbol *pObjectX = (EarthView::World::Spatial::Display::CMultiFillSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCMultiFillSymbolProxy))
					{
						pObjectX->EarthView::World::Spatial::Display::CMultiFillSymbol::fromSLD(sld);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_MultiFillSymbol_register_1fromSLD_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMultiFillSymbolProxy *pObjectX = (JCMultiFillSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_MultiFillSymbol_fromSLD_1EVString_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong sld_j)
				{
					EVString &sld = *(EVString*) sld_j;
					EarthView::World::Spatial::Display::CMultiFillSymbol *pObjectX = (EarthView::World::Spatial::Display::CMultiFillSymbol*) pObjXXXX;
					pObjectX->EarthView::World::Spatial::Display::CMultiFillSymbol::fromSLD(sld);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_MultiFillSymbol_fromStream_1CDataStream(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong stream_j)
				{
					EarthView::World::Core::CDataStream &stream = *(EarthView::World::Core::CDataStream*) stream_j;
					EarthView::World::Spatial::Display::CMultiFillSymbol *pObjectX = (EarthView::World::Spatial::Display::CMultiFillSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCMultiFillSymbolProxy))
					{
						pObjectX->EarthView::World::Spatial::Display::CMultiFillSymbol::fromStream(stream);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_MultiFillSymbol_register_1fromStream_1CDataStream(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMultiFillSymbolProxy *pObjectX = (JCMultiFillSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_MultiFillSymbol_fromStream_1CDataStream_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong stream_j)
				{
					EarthView::World::Core::CDataStream &stream = *(EarthView::World::Core::CDataStream*) stream_j;
					EarthView::World::Spatial::Display::CMultiFillSymbol *pObjectX = (EarthView::World::Spatial::Display::CMultiFillSymbol*) pObjXXXX;
					pObjectX->EarthView::World::Spatial::Display::CMultiFillSymbol::fromStream(stream);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_MultiFillSymbol_register_1getSize_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMultiFillSymbolProxy *pObjectX = (JCMultiFillSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_MultiFillSymbol_register_1getColorRef_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMultiFillSymbolProxy *pObjectX = (JCMultiFillSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_MultiFillSymbol_register_1getColor_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMultiFillSymbolProxy *pObjectX = (JCMultiFillSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_MultiFillSymbol_register_1setColor_1IColor(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMultiFillSymbolProxy *pObjectX = (JCMultiFillSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_MultiFillSymbol_register_1hasImage_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMultiFillSymbolProxy *pObjectX = (JCMultiFillSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_MultiFillSymbol_register_1getImageCount_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMultiFillSymbolProxy *pObjectX = (JCMultiFillSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_MultiFillSymbol_register_1getImageID_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMultiFillSymbolProxy *pObjectX = (JCMultiFillSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_MultiFillSymbol_register_1getImage_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMultiFillSymbolProxy *pObjectX = (JCMultiFillSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_MultiFillSymbol_register_1setImage_1ev_1uint32_1EVString_1MemoryDataStreamPtr(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMultiFillSymbolProxy *pObjectX = (JCMultiFillSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_MultiFillSymbol_register_1equal_1ISymbol(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMultiFillSymbolProxy *pObjectX = (JCMultiFillSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_MultiFillSymbol_register_1getName_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMultiFillSymbolProxy *pObjectX = (JCMultiFillSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_MultiFillSymbol_register_1setName_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMultiFillSymbolProxy *pObjectX = (JCMultiFillSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
