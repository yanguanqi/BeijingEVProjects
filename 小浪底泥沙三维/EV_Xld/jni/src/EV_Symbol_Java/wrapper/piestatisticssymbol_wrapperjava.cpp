...
namespace EarthView
{
	namespace World
	{
		namespace Spatial
		{
			namespace Display
			{
				class JCPieStatisticsSymbolProxy : public EarthView::World::Spatial::Display::CPieStatisticsSymbol
				{
				 private:
				...
				public:
					JCPieStatisticsSymbolProxy(EarthView::World::Core::CNameValuePairList *pList) : CPieStatisticsSymbol(pList)
					{
					}
				...
				REGISTER_FACTORY_CLASS(JCPieStatisticsSymbolProxy);
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_display_PieStatisticsSymbol_isShowOutline_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Display::CPieStatisticsSymbol *pObjectX = (EarthView::World::Spatial::Display::CPieStatisticsSymbol*) pObjXXXX;
					ev_bool __values1 = pObjectX->isShowOutline();
					jboolean __values1_j = (jboolean)__values1;
					return __values1_j;
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_PieStatisticsSymbol_setShowOutline_1ev_1bool(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean bShow_j)
				{
					ev_bool bShow = (ev_bool) bShow_j;
					EarthView::World::Spatial::Display::CPieStatisticsSymbol *pObjectX = (EarthView::World::Spatial::Display::CPieStatisticsSymbol*) pObjXXXX;
					pObjectX->setShowOutline(bShow);
				}
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial_display_PieStatisticsSymbol_getSymbolType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Display::CPieStatisticsSymbol *pObjectX = (EarthView::World::Spatial::Display::CPieStatisticsSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCPieStatisticsSymbolProxy))
					{
						ev_int32 __values1 = pObjectX->EarthView::World::Spatial::Display::CPieStatisticsSymbol::getSymbolType();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_PieStatisticsSymbol_register_1getSymbolType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPieStatisticsSymbolProxy *pObjectX = (JCPieStatisticsSymbolProxy*) pObjXXXX;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial_display_PieStatisticsSymbol_getSymbolType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Display::CPieStatisticsSymbol *pObjectX = (EarthView::World::Spatial::Display::CPieStatisticsSymbol*) pObjXXXX;
					ev_int32 __values1 = pObjectX->EarthView::World::Spatial::Display::CPieStatisticsSymbol::getSymbolType();
					jint __values1_j = (jint)__values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_display_PieStatisticsSymbol_ev_1clone_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Display::CPieStatisticsSymbol *pObjectX = (EarthView::World::Spatial::Display::CPieStatisticsSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCPieStatisticsSymbolProxy))
					{
						EarthView::World::Spatial::Display::ISymbol* __values1 = pObjectX->EarthView::World::Spatial::Display::CPieStatisticsSymbol::clone();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_PieStatisticsSymbol_register_1ev_1clone_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPieStatisticsSymbolProxy *pObjectX = (JCPieStatisticsSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_display_PieStatisticsSymbol_ev_1clone_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Display::CPieStatisticsSymbol *pObjectX = (EarthView::World::Spatial::Display::CPieStatisticsSymbol*) pObjXXXX;
					EarthView::World::Spatial::Display::ISymbol* __values1 = pObjectX->EarthView::World::Spatial::Display::CPieStatisticsSymbol::clone();
					if(__values1 != NULL) {						((EarthView::World::Core::CBaseObject*)__values1)->setExternFree(true);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_PieStatisticsSymbol_toStream_1CDataStream(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong stream_j)
				{
					EarthView::World::Core::CDataStream &stream = *(EarthView::World::Core::CDataStream*) stream_j;
					const 					EarthView::World::Spatial::Display::CPieStatisticsSymbol *pObjectX = (EarthView::World::Spatial::Display::CPieStatisticsSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCPieStatisticsSymbolProxy))
					{
						pObjectX->EarthView::World::Spatial::Display::CPieStatisticsSymbol::toStream(stream);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_PieStatisticsSymbol_register_1toStream_1CDataStream(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPieStatisticsSymbolProxy *pObjectX = (JCPieStatisticsSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_PieStatisticsSymbol_toStream_1CDataStream_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong stream_j)
				{
					EarthView::World::Core::CDataStream &stream = *(EarthView::World::Core::CDataStream*) stream_j;
					const 					EarthView::World::Spatial::Display::CPieStatisticsSymbol *pObjectX = (EarthView::World::Spatial::Display::CPieStatisticsSymbol*) pObjXXXX;
					pObjectX->EarthView::World::Spatial::Display::CPieStatisticsSymbol::toStream(stream);
				}
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial_display_PieStatisticsSymbol_toSLD_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Display::CPieStatisticsSymbol *pObjectX = (EarthView::World::Spatial::Display::CPieStatisticsSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCPieStatisticsSymbolProxy))
					{
						EVString __values1 = pObjectX->EarthView::World::Spatial::Display::CPieStatisticsSymbol::toSLD();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_PieStatisticsSymbol_register_1toSLD_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPieStatisticsSymbolProxy *pObjectX = (JCPieStatisticsSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial_display_PieStatisticsSymbol_toSLD_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Display::CPieStatisticsSymbol *pObjectX = (EarthView::World::Spatial::Display::CPieStatisticsSymbol*) pObjXXXX;
					EVString __values1 = pObjectX->EarthView::World::Spatial::Display::CPieStatisticsSymbol::toSLD();
					EarthView::World::Core::ev_wstring valuesw1 = __values1;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_PieStatisticsSymbol_fromXmlElement_1CXmlElement(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong element_j)
				{
					EarthView::World::Core::CXmlElement &element = *(EarthView::World::Core::CXmlElement*) element_j;
					EarthView::World::Spatial::Display::CPieStatisticsSymbol *pObjectX = (EarthView::World::Spatial::Display::CPieStatisticsSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCPieStatisticsSymbolProxy))
					{
						pObjectX->EarthView::World::Spatial::Display::CPieStatisticsSymbol::fromXmlElement(element);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_PieStatisticsSymbol_register_1fromXmlElement_1CXmlElement(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPieStatisticsSymbolProxy *pObjectX = (JCPieStatisticsSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_PieStatisticsSymbol_fromXmlElement_1CXmlElement_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong element_j)
				{
					EarthView::World::Core::CXmlElement &element = *(EarthView::World::Core::CXmlElement*) element_j;
					EarthView::World::Spatial::Display::CPieStatisticsSymbol *pObjectX = (EarthView::World::Spatial::Display::CPieStatisticsSymbol*) pObjXXXX;
					pObjectX->EarthView::World::Spatial::Display::CPieStatisticsSymbol::fromXmlElement(element);
				}
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_display_PieStatisticsSymbol_toXmlElement_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Display::CPieStatisticsSymbol *pObjectX = (EarthView::World::Spatial::Display::CPieStatisticsSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCPieStatisticsSymbolProxy))
					{
						EarthView::World::Core::CXmlElement __values1 = pObjectX->EarthView::World::Spatial::Display::CPieStatisticsSymbol::toXmlElement();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_PieStatisticsSymbol_register_1toXmlElement_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPieStatisticsSymbolProxy *pObjectX = (JCPieStatisticsSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_display_PieStatisticsSymbol_toXmlElement_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Display::CPieStatisticsSymbol *pObjectX = (EarthView::World::Spatial::Display::CPieStatisticsSymbol*) pObjXXXX;
					EarthView::World::Core::CXmlElement __values1 = pObjectX->EarthView::World::Spatial::Display::CPieStatisticsSymbol::toXmlElement();
					EarthView::World::Core::CXmlElement *returnvalues = new EarthView::World::Core::CXmlElement(__values1);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_PieStatisticsSymbol_setSizeRatio_1ev_1real64(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble ratio_j)
				{
					const ev_real64 ratio = (ev_real64) ratio_j;
					EarthView::World::Spatial::Display::CPieStatisticsSymbol *pObjectX = (EarthView::World::Spatial::Display::CPieStatisticsSymbol*) pObjXXXX;
					pObjectX->setSizeRatio(ratio);
				}
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_display_PieStatisticsSymbol_equal_1ISymbol(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong pSymbol_j)
				{
					const EarthView::World::Spatial::Display::ISymbol *pSymbol = (const EarthView::World::Spatial::Display::ISymbol*) pSymbol_j;
					EarthView::World::Spatial::Display::CPieStatisticsSymbol *pObjectX = (EarthView::World::Spatial::Display::CPieStatisticsSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCPieStatisticsSymbolProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial::Display::CPieStatisticsSymbol::equal(pSymbol);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_PieStatisticsSymbol_register_1equal_1ISymbol(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPieStatisticsSymbolProxy *pObjectX = (JCPieStatisticsSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_display_PieStatisticsSymbol_equal_1ISymbol_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong pSymbol_j)
				{
					const EarthView::World::Spatial::Display::ISymbol *pSymbol = (const EarthView::World::Spatial::Display::ISymbol*) pSymbol_j;
					EarthView::World::Spatial::Display::CPieStatisticsSymbol *pObjectX = (EarthView::World::Spatial::Display::CPieStatisticsSymbol*) pObjXXXX;
					ev_bool __values1 = pObjectX->EarthView::World::Spatial::Display::CPieStatisticsSymbol::equal(pSymbol);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_PieStatisticsSymbol_fromSLD_1EVString(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong sld_j)
				{
					EVString &sld = *(EVString*) sld_j;
					EarthView::World::Spatial::Display::CPieStatisticsSymbol *pObjectX = (EarthView::World::Spatial::Display::CPieStatisticsSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCPieStatisticsSymbolProxy))
					{
						pObjectX->EarthView::World::Spatial::Display::CPieStatisticsSymbol::fromSLD(sld);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_PieStatisticsSymbol_register_1fromSLD_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPieStatisticsSymbolProxy *pObjectX = (JCPieStatisticsSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_PieStatisticsSymbol_fromSLD_1EVString_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong sld_j)
				{
					EVString &sld = *(EVString*) sld_j;
					EarthView::World::Spatial::Display::CPieStatisticsSymbol *pObjectX = (EarthView::World::Spatial::Display::CPieStatisticsSymbol*) pObjXXXX;
					pObjectX->EarthView::World::Spatial::Display::CPieStatisticsSymbol::fromSLD(sld);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_PieStatisticsSymbol_fromStream_1CDataStream(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong stream_j)
				{
					EarthView::World::Core::CDataStream &stream = *(EarthView::World::Core::CDataStream*) stream_j;
					EarthView::World::Spatial::Display::CPieStatisticsSymbol *pObjectX = (EarthView::World::Spatial::Display::CPieStatisticsSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCPieStatisticsSymbolProxy))
					{
						pObjectX->EarthView::World::Spatial::Display::CPieStatisticsSymbol::fromStream(stream);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_PieStatisticsSymbol_register_1fromStream_1CDataStream(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPieStatisticsSymbolProxy *pObjectX = (JCPieStatisticsSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_PieStatisticsSymbol_fromStream_1CDataStream_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong stream_j)
				{
					EarthView::World::Core::CDataStream &stream = *(EarthView::World::Core::CDataStream*) stream_j;
					EarthView::World::Spatial::Display::CPieStatisticsSymbol *pObjectX = (EarthView::World::Spatial::Display::CPieStatisticsSymbol*) pObjXXXX;
					pObjectX->EarthView::World::Spatial::Display::CPieStatisticsSymbol::fromStream(stream);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_PieStatisticsSymbol_register_1getSize_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPieStatisticsSymbolProxy *pObjectX = (JCPieStatisticsSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_PieStatisticsSymbol_register_1getColorRef_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPieStatisticsSymbolProxy *pObjectX = (JCPieStatisticsSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_PieStatisticsSymbol_register_1getColor_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPieStatisticsSymbolProxy *pObjectX = (JCPieStatisticsSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_PieStatisticsSymbol_register_1setColor_1IColor(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPieStatisticsSymbolProxy *pObjectX = (JCPieStatisticsSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_PieStatisticsSymbol_register_1hasImage_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPieStatisticsSymbolProxy *pObjectX = (JCPieStatisticsSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_PieStatisticsSymbol_register_1getImageCount_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPieStatisticsSymbolProxy *pObjectX = (JCPieStatisticsSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_PieStatisticsSymbol_register_1getImageID_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPieStatisticsSymbolProxy *pObjectX = (JCPieStatisticsSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_PieStatisticsSymbol_register_1getImage_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPieStatisticsSymbolProxy *pObjectX = (JCPieStatisticsSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_PieStatisticsSymbol_register_1setImage_1ev_1uint32_1EVString_1MemoryDataStreamPtr(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPieStatisticsSymbolProxy *pObjectX = (JCPieStatisticsSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_PieStatisticsSymbol_register_1getName_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPieStatisticsSymbolProxy *pObjectX = (JCPieStatisticsSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_PieStatisticsSymbol_register_1setName_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPieStatisticsSymbolProxy *pObjectX = (JCPieStatisticsSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
