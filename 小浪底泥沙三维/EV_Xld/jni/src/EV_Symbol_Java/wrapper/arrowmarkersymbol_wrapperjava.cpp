...
namespace EarthView
{
	namespace World
	{
		namespace Spatial
		{
			namespace Display
			{
				extern "C" JNIEXPORT jintArray JNICALL Java_com_earthview_world_spatial_display_EVArrowMarkerTypeHelper_getEnumValues (JNIEnv *__env, jclass __clazz)
				{
					jint enum_values[] = {
						AMT_ARROWMARKER_SOLID,
						AMT_ARROWMARKER_BOUND,
						AMT_ARROWMARKER_SPINE
					};
					jintArray array = __env->NewIntArray(3);
					__env->SetIntArrayRegion(array, 0, 3, enum_values);
					return array;
				}
				class JCArrowMarkerSymbolProxy : public EarthView::World::Spatial::Display::CArrowMarkerSymbol
				{
				 private:
				...
				public:
					JCArrowMarkerSymbolProxy(EarthView::World::Core::CNameValuePairList *pList) : CArrowMarkerSymbol(pList)
					{
					}
				...
				REGISTER_FACTORY_CLASS(JCArrowMarkerSymbolProxy);
				extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_spatial_display_ArrowMarkerSymbol_getLength_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Display::CArrowMarkerSymbol *pObjectX = (EarthView::World::Spatial::Display::CArrowMarkerSymbol*) pObjXXXX;
					ev_real64 __values1 = pObjectX->getLength();
					jdouble __values1_j = (jdouble)__values1;
					return __values1_j;
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_ArrowMarkerSymbol_setLength_1ev_1real64(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble value_j)
				{
					ev_real64 value = (ev_real64) value_j;
					EarthView::World::Spatial::Display::CArrowMarkerSymbol *pObjectX = (EarthView::World::Spatial::Display::CArrowMarkerSymbol*) pObjXXXX;
					pObjectX->setLength(value);
				}
				extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_spatial_display_ArrowMarkerSymbol_getWidth_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Display::CArrowMarkerSymbol *pObjectX = (EarthView::World::Spatial::Display::CArrowMarkerSymbol*) pObjXXXX;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_ArrowMarkerSymbol_setWidth_1ev_1real64(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble value_j)
				{
					ev_real64 value = (ev_real64) value_j;
					EarthView::World::Spatial::Display::CArrowMarkerSymbol *pObjectX = (EarthView::World::Spatial::Display::CArrowMarkerSymbol*) pObjXXXX;
					pObjectX->setWidth(value);
				}
				extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_spatial_display_ArrowMarkerSymbol_getSize_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Display::CArrowMarkerSymbol *pObjectX = (EarthView::World::Spatial::Display::CArrowMarkerSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCArrowMarkerSymbolProxy))
					{
						ev_real64 __values1 = pObjectX->EarthView::World::Spatial::Display::CArrowMarkerSymbol::getSize();
						jdouble __values1_j = (jdouble)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_ArrowMarkerSymbol_register_1getSize_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCArrowMarkerSymbolProxy *pObjectX = (JCArrowMarkerSymbolProxy*) pObjXXXX;
				...
				extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_spatial_display_ArrowMarkerSymbol_getSize_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Display::CArrowMarkerSymbol *pObjectX = (EarthView::World::Spatial::Display::CArrowMarkerSymbol*) pObjXXXX;
					ev_real64 __values1 = pObjectX->EarthView::World::Spatial::Display::CArrowMarkerSymbol::getSize();
					jdouble __values1_j = (jdouble)__values1;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_ArrowMarkerSymbol_setSize_1ev_1real64(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble size_j)
				{
					ev_real64 size = (ev_real64) size_j;
					EarthView::World::Spatial::Display::CArrowMarkerSymbol *pObjectX = (EarthView::World::Spatial::Display::CArrowMarkerSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCArrowMarkerSymbolProxy))
					{
						pObjectX->EarthView::World::Spatial::Display::CArrowMarkerSymbol::setSize(size);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_ArrowMarkerSymbol_register_1setSize_1ev_1real64(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCArrowMarkerSymbolProxy *pObjectX = (JCArrowMarkerSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_ArrowMarkerSymbol_setSize_1ev_1real64_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble size_j)
				{
					ev_real64 size = (ev_real64) size_j;
					EarthView::World::Spatial::Display::CArrowMarkerSymbol *pObjectX = (EarthView::World::Spatial::Display::CArrowMarkerSymbol*) pObjXXXX;
					pObjectX->EarthView::World::Spatial::Display::CArrowMarkerSymbol::setSize(size);
				}
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial_display_ArrowMarkerSymbol_getStyle_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Display::CArrowMarkerSymbol *pObjectX = (EarthView::World::Spatial::Display::CArrowMarkerSymbol*) pObjXXXX;
					EarthView::World::Spatial::Display::EVArrowMarkerType __values1 = pObjectX->getStyle();
					jint __values1_j = (jint) __values1;
					return __values1_j;
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_ArrowMarkerSymbol_setStyle_1EVArrowMarkerType(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint type_j)
				{
					EarthView::World::Spatial::Display::EVArrowMarkerType type = (EarthView::World::Spatial::Display::EVArrowMarkerType) type_j;
					EarthView::World::Spatial::Display::CArrowMarkerSymbol *pObjectX = (EarthView::World::Spatial::Display::CArrowMarkerSymbol*) pObjXXXX;
					pObjectX->setStyle(type);
				}
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial_display_ArrowMarkerSymbol_getSymbolType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Display::CArrowMarkerSymbol *pObjectX = (EarthView::World::Spatial::Display::CArrowMarkerSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCArrowMarkerSymbolProxy))
					{
						ev_int32 __values1 = pObjectX->EarthView::World::Spatial::Display::CArrowMarkerSymbol::getSymbolType();
						jint __values1_j = (jint)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_ArrowMarkerSymbol_register_1getSymbolType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCArrowMarkerSymbolProxy *pObjectX = (JCArrowMarkerSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial_display_ArrowMarkerSymbol_getSymbolType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Display::CArrowMarkerSymbol *pObjectX = (EarthView::World::Spatial::Display::CArrowMarkerSymbol*) pObjXXXX;
					ev_int32 __values1 = pObjectX->EarthView::World::Spatial::Display::CArrowMarkerSymbol::getSymbolType();
					jint __values1_j = (jint)__values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_display_ArrowMarkerSymbol_ev_1clone_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Display::CArrowMarkerSymbol *pObjectX = (EarthView::World::Spatial::Display::CArrowMarkerSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCArrowMarkerSymbolProxy))
					{
						EarthView::World::Spatial::Display::ISymbol* __values1 = pObjectX->EarthView::World::Spatial::Display::CArrowMarkerSymbol::clone();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_ArrowMarkerSymbol_register_1ev_1clone_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCArrowMarkerSymbolProxy *pObjectX = (JCArrowMarkerSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_display_ArrowMarkerSymbol_ev_1clone_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Display::CArrowMarkerSymbol *pObjectX = (EarthView::World::Spatial::Display::CArrowMarkerSymbol*) pObjXXXX;
					EarthView::World::Spatial::Display::ISymbol* __values1 = pObjectX->EarthView::World::Spatial::Display::CArrowMarkerSymbol::clone();
					if(__values1 != NULL) {						((EarthView::World::Core::CBaseObject*)__values1)->setExternFree(true);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_ArrowMarkerSymbol_toStream_1CDataStream(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong stream_j)
				{
					EarthView::World::Core::CDataStream &stream = *(EarthView::World::Core::CDataStream*) stream_j;
					const 					EarthView::World::Spatial::Display::CArrowMarkerSymbol *pObjectX = (EarthView::World::Spatial::Display::CArrowMarkerSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCArrowMarkerSymbolProxy))
					{
						pObjectX->EarthView::World::Spatial::Display::CArrowMarkerSymbol::toStream(stream);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_ArrowMarkerSymbol_register_1toStream_1CDataStream(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCArrowMarkerSymbolProxy *pObjectX = (JCArrowMarkerSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_ArrowMarkerSymbol_toStream_1CDataStream_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong stream_j)
				{
					EarthView::World::Core::CDataStream &stream = *(EarthView::World::Core::CDataStream*) stream_j;
					const 					EarthView::World::Spatial::Display::CArrowMarkerSymbol *pObjectX = (EarthView::World::Spatial::Display::CArrowMarkerSymbol*) pObjXXXX;
					pObjectX->EarthView::World::Spatial::Display::CArrowMarkerSymbol::toStream(stream);
				}
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial_display_ArrowMarkerSymbol_toSLD_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Display::CArrowMarkerSymbol *pObjectX = (EarthView::World::Spatial::Display::CArrowMarkerSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCArrowMarkerSymbolProxy))
					{
						EVString __values1 = pObjectX->EarthView::World::Spatial::Display::CArrowMarkerSymbol::toSLD();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_ArrowMarkerSymbol_register_1toSLD_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCArrowMarkerSymbolProxy *pObjectX = (JCArrowMarkerSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial_display_ArrowMarkerSymbol_toSLD_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Display::CArrowMarkerSymbol *pObjectX = (EarthView::World::Spatial::Display::CArrowMarkerSymbol*) pObjXXXX;
					EVString __values1 = pObjectX->EarthView::World::Spatial::Display::CArrowMarkerSymbol::toSLD();
					EarthView::World::Core::ev_wstring valuesw1 = __values1;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_ArrowMarkerSymbol_fromXmlElement_1CXmlElement(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong element_j)
				{
					EarthView::World::Core::CXmlElement &element = *(EarthView::World::Core::CXmlElement*) element_j;
					EarthView::World::Spatial::Display::CArrowMarkerSymbol *pObjectX = (EarthView::World::Spatial::Display::CArrowMarkerSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCArrowMarkerSymbolProxy))
					{
						pObjectX->EarthView::World::Spatial::Display::CArrowMarkerSymbol::fromXmlElement(element);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_ArrowMarkerSymbol_register_1fromXmlElement_1CXmlElement(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCArrowMarkerSymbolProxy *pObjectX = (JCArrowMarkerSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_ArrowMarkerSymbol_fromXmlElement_1CXmlElement_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong element_j)
				{
					EarthView::World::Core::CXmlElement &element = *(EarthView::World::Core::CXmlElement*) element_j;
					EarthView::World::Spatial::Display::CArrowMarkerSymbol *pObjectX = (EarthView::World::Spatial::Display::CArrowMarkerSymbol*) pObjXXXX;
					pObjectX->EarthView::World::Spatial::Display::CArrowMarkerSymbol::fromXmlElement(element);
				}
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_display_ArrowMarkerSymbol_toXmlElement_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Display::CArrowMarkerSymbol *pObjectX = (EarthView::World::Spatial::Display::CArrowMarkerSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCArrowMarkerSymbolProxy))
					{
						EarthView::World::Core::CXmlElement __values1 = pObjectX->EarthView::World::Spatial::Display::CArrowMarkerSymbol::toXmlElement();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_ArrowMarkerSymbol_register_1toXmlElement_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCArrowMarkerSymbolProxy *pObjectX = (JCArrowMarkerSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_display_ArrowMarkerSymbol_toXmlElement_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Display::CArrowMarkerSymbol *pObjectX = (EarthView::World::Spatial::Display::CArrowMarkerSymbol*) pObjXXXX;
					EarthView::World::Core::CXmlElement __values1 = pObjectX->EarthView::World::Spatial::Display::CArrowMarkerSymbol::toXmlElement();
					EarthView::World::Core::CXmlElement *returnvalues = new EarthView::World::Core::CXmlElement(__values1);
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_display_ArrowMarkerSymbol_equal_1ISymbol(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong pSymbol_j)
				{
					const EarthView::World::Spatial::Display::ISymbol *pSymbol = (const EarthView::World::Spatial::Display::ISymbol*) pSymbol_j;
					EarthView::World::Spatial::Display::CArrowMarkerSymbol *pObjectX = (EarthView::World::Spatial::Display::CArrowMarkerSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCArrowMarkerSymbolProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial::Display::CArrowMarkerSymbol::equal(pSymbol);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_ArrowMarkerSymbol_register_1equal_1ISymbol(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCArrowMarkerSymbolProxy *pObjectX = (JCArrowMarkerSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_display_ArrowMarkerSymbol_equal_1ISymbol_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong pSymbol_j)
				{
					const EarthView::World::Spatial::Display::ISymbol *pSymbol = (const EarthView::World::Spatial::Display::ISymbol*) pSymbol_j;
					EarthView::World::Spatial::Display::CArrowMarkerSymbol *pObjectX = (EarthView::World::Spatial::Display::CArrowMarkerSymbol*) pObjXXXX;
					ev_bool __values1 = pObjectX->EarthView::World::Spatial::Display::CArrowMarkerSymbol::equal(pSymbol);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_ArrowMarkerSymbol_fromSLD_1EVString(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong sld_j)
				{
					EVString &sld = *(EVString*) sld_j;
					EarthView::World::Spatial::Display::CArrowMarkerSymbol *pObjectX = (EarthView::World::Spatial::Display::CArrowMarkerSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCArrowMarkerSymbolProxy))
					{
						pObjectX->EarthView::World::Spatial::Display::CArrowMarkerSymbol::fromSLD(sld);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_ArrowMarkerSymbol_register_1fromSLD_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCArrowMarkerSymbolProxy *pObjectX = (JCArrowMarkerSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_ArrowMarkerSymbol_fromSLD_1EVString_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong sld_j)
				{
					EVString &sld = *(EVString*) sld_j;
					EarthView::World::Spatial::Display::CArrowMarkerSymbol *pObjectX = (EarthView::World::Spatial::Display::CArrowMarkerSymbol*) pObjXXXX;
					pObjectX->EarthView::World::Spatial::Display::CArrowMarkerSymbol::fromSLD(sld);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_ArrowMarkerSymbol_fromStream_1CDataStream(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong stream_j)
				{
					EarthView::World::Core::CDataStream &stream = *(EarthView::World::Core::CDataStream*) stream_j;
					EarthView::World::Spatial::Display::CArrowMarkerSymbol *pObjectX = (EarthView::World::Spatial::Display::CArrowMarkerSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCArrowMarkerSymbolProxy))
					{
						pObjectX->EarthView::World::Spatial::Display::CArrowMarkerSymbol::fromStream(stream);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_ArrowMarkerSymbol_register_1fromStream_1CDataStream(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCArrowMarkerSymbolProxy *pObjectX = (JCArrowMarkerSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_ArrowMarkerSymbol_fromStream_1CDataStream_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong stream_j)
				{
					EarthView::World::Core::CDataStream &stream = *(EarthView::World::Core::CDataStream*) stream_j;
					EarthView::World::Spatial::Display::CArrowMarkerSymbol *pObjectX = (EarthView::World::Spatial::Display::CArrowMarkerSymbol*) pObjXXXX;
					pObjectX->EarthView::World::Spatial::Display::CArrowMarkerSymbol::fromStream(stream);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_ArrowMarkerSymbol_register_1getAngle_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCArrowMarkerSymbolProxy *pObjectX = (JCArrowMarkerSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_ArrowMarkerSymbol_register_1setAngle_1ev_1real64(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCArrowMarkerSymbolProxy *pObjectX = (JCArrowMarkerSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_ArrowMarkerSymbol_register_1getOffsetX_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCArrowMarkerSymbolProxy *pObjectX = (JCArrowMarkerSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_ArrowMarkerSymbol_register_1setOffsetX_1ev_1real64(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCArrowMarkerSymbolProxy *pObjectX = (JCArrowMarkerSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_ArrowMarkerSymbol_register_1getOffsetY_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCArrowMarkerSymbolProxy *pObjectX = (JCArrowMarkerSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_ArrowMarkerSymbol_register_1setOffsetY_1ev_1real64(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCArrowMarkerSymbolProxy *pObjectX = (JCArrowMarkerSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_ArrowMarkerSymbol_register_1getColorRef_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCArrowMarkerSymbolProxy *pObjectX = (JCArrowMarkerSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_ArrowMarkerSymbol_register_1getColor_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCArrowMarkerSymbolProxy *pObjectX = (JCArrowMarkerSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_ArrowMarkerSymbol_register_1setColor_1IColor(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCArrowMarkerSymbolProxy *pObjectX = (JCArrowMarkerSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_ArrowMarkerSymbol_register_1hasImage_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCArrowMarkerSymbolProxy *pObjectX = (JCArrowMarkerSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_ArrowMarkerSymbol_register_1getImageCount_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCArrowMarkerSymbolProxy *pObjectX = (JCArrowMarkerSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_ArrowMarkerSymbol_register_1getImageID_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCArrowMarkerSymbolProxy *pObjectX = (JCArrowMarkerSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_ArrowMarkerSymbol_register_1getImage_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCArrowMarkerSymbolProxy *pObjectX = (JCArrowMarkerSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_ArrowMarkerSymbol_register_1setImage_1ev_1uint32_1EVString_1MemoryDataStreamPtr(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCArrowMarkerSymbolProxy *pObjectX = (JCArrowMarkerSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_ArrowMarkerSymbol_register_1getName_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCArrowMarkerSymbolProxy *pObjectX = (JCArrowMarkerSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_ArrowMarkerSymbol_register_1setName_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCArrowMarkerSymbolProxy *pObjectX = (JCArrowMarkerSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
