...
namespace EarthView
{
	namespace World
	{
		namespace Spatial
		{
			namespace Display
			{
				class JCMarkerSymbolProxy : public EarthView::World::Spatial::Display::CMarkerSymbol
				{
				 private:
				...
				public:
					JCMarkerSymbolProxy(EarthView::World::Core::CNameValuePairList *pList) : CMarkerSymbol(pList)
					{
					}
				...
				REGISTER_FACTORY_CLASS(JCMarkerSymbolProxy);
				extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_spatial_display_MarkerSymbol_getAngle_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Display::CMarkerSymbol *pObjectX = (EarthView::World::Spatial::Display::CMarkerSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCMarkerSymbolProxy))
					{
						ev_real64 __values1 = pObjectX->EarthView::World::Spatial::Display::CMarkerSymbol::getAngle();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_MarkerSymbol_register_1getAngle_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMarkerSymbolProxy *pObjectX = (JCMarkerSymbolProxy*) pObjXXXX;
				...
				extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_spatial_display_MarkerSymbol_getAngle_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Display::CMarkerSymbol *pObjectX = (EarthView::World::Spatial::Display::CMarkerSymbol*) pObjXXXX;
					ev_real64 __values1 = pObjectX->EarthView::World::Spatial::Display::CMarkerSymbol::getAngle();
					jdouble __values1_j = (jdouble)__values1;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_MarkerSymbol_setAngle_1ev_1real64(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble angle_j)
				{
					ev_real64 angle = (ev_real64) angle_j;
					EarthView::World::Spatial::Display::CMarkerSymbol *pObjectX = (EarthView::World::Spatial::Display::CMarkerSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCMarkerSymbolProxy))
					{
						pObjectX->EarthView::World::Spatial::Display::CMarkerSymbol::setAngle(angle);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_MarkerSymbol_register_1setAngle_1ev_1real64(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMarkerSymbolProxy *pObjectX = (JCMarkerSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_MarkerSymbol_setAngle_1ev_1real64_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble angle_j)
				{
					ev_real64 angle = (ev_real64) angle_j;
					EarthView::World::Spatial::Display::CMarkerSymbol *pObjectX = (EarthView::World::Spatial::Display::CMarkerSymbol*) pObjXXXX;
					pObjectX->EarthView::World::Spatial::Display::CMarkerSymbol::setAngle(angle);
				}
				extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_spatial_display_MarkerSymbol_getSize_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Display::CMarkerSymbol *pObjectX = (EarthView::World::Spatial::Display::CMarkerSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCMarkerSymbolProxy))
					{
						ev_real64 __values1 = pObjectX->EarthView::World::Spatial::Display::CMarkerSymbol::getSize();
						jdouble __values1_j = (jdouble)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_MarkerSymbol_register_1getSize_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMarkerSymbolProxy *pObjectX = (JCMarkerSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_spatial_display_MarkerSymbol_getSize_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Display::CMarkerSymbol *pObjectX = (EarthView::World::Spatial::Display::CMarkerSymbol*) pObjXXXX;
					ev_real64 __values1 = pObjectX->EarthView::World::Spatial::Display::CMarkerSymbol::getSize();
					jdouble __values1_j = (jdouble)__values1;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_MarkerSymbol_setSize_1ev_1real64(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble size_j)
				{
					ev_real64 size = (ev_real64) size_j;
					EarthView::World::Spatial::Display::CMarkerSymbol *pObjectX = (EarthView::World::Spatial::Display::CMarkerSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCMarkerSymbolProxy))
					{
						pObjectX->EarthView::World::Spatial::Display::CMarkerSymbol::setSize(size);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_MarkerSymbol_register_1setSize_1ev_1real64(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMarkerSymbolProxy *pObjectX = (JCMarkerSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_MarkerSymbol_setSize_1ev_1real64_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble size_j)
				{
					ev_real64 size = (ev_real64) size_j;
					EarthView::World::Spatial::Display::CMarkerSymbol *pObjectX = (EarthView::World::Spatial::Display::CMarkerSymbol*) pObjXXXX;
					pObjectX->EarthView::World::Spatial::Display::CMarkerSymbol::setSize(size);
				}
				extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_spatial_display_MarkerSymbol_getOffsetX_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Display::CMarkerSymbol *pObjectX = (EarthView::World::Spatial::Display::CMarkerSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCMarkerSymbolProxy))
					{
						ev_real64 __values1 = pObjectX->EarthView::World::Spatial::Display::CMarkerSymbol::getOffsetX();
						jdouble __values1_j = (jdouble)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_MarkerSymbol_register_1getOffsetX_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMarkerSymbolProxy *pObjectX = (JCMarkerSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_spatial_display_MarkerSymbol_getOffsetX_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Display::CMarkerSymbol *pObjectX = (EarthView::World::Spatial::Display::CMarkerSymbol*) pObjXXXX;
					ev_real64 __values1 = pObjectX->EarthView::World::Spatial::Display::CMarkerSymbol::getOffsetX();
					jdouble __values1_j = (jdouble)__values1;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_MarkerSymbol_setOffsetX_1ev_1real64(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble value_j)
				{
					ev_real64 value = (ev_real64) value_j;
					EarthView::World::Spatial::Display::CMarkerSymbol *pObjectX = (EarthView::World::Spatial::Display::CMarkerSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCMarkerSymbolProxy))
					{
						pObjectX->EarthView::World::Spatial::Display::CMarkerSymbol::setOffsetX(value);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_MarkerSymbol_register_1setOffsetX_1ev_1real64(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMarkerSymbolProxy *pObjectX = (JCMarkerSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_MarkerSymbol_setOffsetX_1ev_1real64_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble value_j)
				{
					ev_real64 value = (ev_real64) value_j;
					EarthView::World::Spatial::Display::CMarkerSymbol *pObjectX = (EarthView::World::Spatial::Display::CMarkerSymbol*) pObjXXXX;
					pObjectX->EarthView::World::Spatial::Display::CMarkerSymbol::setOffsetX(value);
				}
				extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_spatial_display_MarkerSymbol_getOffsetY_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Display::CMarkerSymbol *pObjectX = (EarthView::World::Spatial::Display::CMarkerSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCMarkerSymbolProxy))
					{
						ev_real64 __values1 = pObjectX->EarthView::World::Spatial::Display::CMarkerSymbol::getOffsetY();
						jdouble __values1_j = (jdouble)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_MarkerSymbol_register_1getOffsetY_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMarkerSymbolProxy *pObjectX = (JCMarkerSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_spatial_display_MarkerSymbol_getOffsetY_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Display::CMarkerSymbol *pObjectX = (EarthView::World::Spatial::Display::CMarkerSymbol*) pObjXXXX;
					ev_real64 __values1 = pObjectX->EarthView::World::Spatial::Display::CMarkerSymbol::getOffsetY();
					jdouble __values1_j = (jdouble)__values1;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_MarkerSymbol_setOffsetY_1ev_1real64(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble value_j)
				{
					ev_real64 value = (ev_real64) value_j;
					EarthView::World::Spatial::Display::CMarkerSymbol *pObjectX = (EarthView::World::Spatial::Display::CMarkerSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCMarkerSymbolProxy))
					{
						pObjectX->EarthView::World::Spatial::Display::CMarkerSymbol::setOffsetY(value);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_MarkerSymbol_register_1setOffsetY_1ev_1real64(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMarkerSymbolProxy *pObjectX = (JCMarkerSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_MarkerSymbol_setOffsetY_1ev_1real64_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble value_j)
				{
					ev_real64 value = (ev_real64) value_j;
					EarthView::World::Spatial::Display::CMarkerSymbol *pObjectX = (EarthView::World::Spatial::Display::CMarkerSymbol*) pObjXXXX;
					pObjectX->EarthView::World::Spatial::Display::CMarkerSymbol::setOffsetY(value);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_MarkerSymbol_toStream_1CDataStream(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong stream_j)
				{
					EarthView::World::Core::CDataStream &stream = *(EarthView::World::Core::CDataStream*) stream_j;
					const 					EarthView::World::Spatial::Display::CMarkerSymbol *pObjectX = (EarthView::World::Spatial::Display::CMarkerSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCMarkerSymbolProxy))
					{
						pObjectX->EarthView::World::Spatial::Display::CMarkerSymbol::toStream(stream);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_MarkerSymbol_register_1toStream_1CDataStream(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMarkerSymbolProxy *pObjectX = (JCMarkerSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_MarkerSymbol_toStream_1CDataStream_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong stream_j)
				{
					EarthView::World::Core::CDataStream &stream = *(EarthView::World::Core::CDataStream*) stream_j;
					const 					EarthView::World::Spatial::Display::CMarkerSymbol *pObjectX = (EarthView::World::Spatial::Display::CMarkerSymbol*) pObjXXXX;
					pObjectX->EarthView::World::Spatial::Display::CMarkerSymbol::toStream(stream);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_MarkerSymbol_fromXmlElement_1CXmlElement(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong element_j)
				{
					EarthView::World::Core::CXmlElement &element = *(EarthView::World::Core::CXmlElement*) element_j;
					EarthView::World::Spatial::Display::CMarkerSymbol *pObjectX = (EarthView::World::Spatial::Display::CMarkerSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCMarkerSymbolProxy))
					{
						pObjectX->EarthView::World::Spatial::Display::CMarkerSymbol::fromXmlElement(element);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_MarkerSymbol_register_1fromXmlElement_1CXmlElement(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMarkerSymbolProxy *pObjectX = (JCMarkerSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_MarkerSymbol_fromXmlElement_1CXmlElement_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong element_j)
				{
					EarthView::World::Core::CXmlElement &element = *(EarthView::World::Core::CXmlElement*) element_j;
					EarthView::World::Spatial::Display::CMarkerSymbol *pObjectX = (EarthView::World::Spatial::Display::CMarkerSymbol*) pObjXXXX;
					pObjectX->EarthView::World::Spatial::Display::CMarkerSymbol::fromXmlElement(element);
				}
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_display_MarkerSymbol_toXmlElement_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Display::CMarkerSymbol *pObjectX = (EarthView::World::Spatial::Display::CMarkerSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCMarkerSymbolProxy))
					{
						EarthView::World::Core::CXmlElement __values1 = pObjectX->EarthView::World::Spatial::Display::CMarkerSymbol::toXmlElement();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_MarkerSymbol_register_1toXmlElement_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMarkerSymbolProxy *pObjectX = (JCMarkerSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_display_MarkerSymbol_toXmlElement_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Display::CMarkerSymbol *pObjectX = (EarthView::World::Spatial::Display::CMarkerSymbol*) pObjXXXX;
					EarthView::World::Core::CXmlElement __values1 = pObjectX->EarthView::World::Spatial::Display::CMarkerSymbol::toXmlElement();
					EarthView::World::Core::CXmlElement *returnvalues = new EarthView::World::Core::CXmlElement(__values1);
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial_display_MarkerSymbol_toSLD_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Display::CMarkerSymbol *pObjectX = (EarthView::World::Spatial::Display::CMarkerSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCMarkerSymbolProxy))
					{
						EVString __values1 = pObjectX->EarthView::World::Spatial::Display::CMarkerSymbol::toSLD();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_MarkerSymbol_register_1toSLD_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMarkerSymbolProxy *pObjectX = (JCMarkerSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial_display_MarkerSymbol_toSLD_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Display::CMarkerSymbol *pObjectX = (EarthView::World::Spatial::Display::CMarkerSymbol*) pObjXXXX;
					EVString __values1 = pObjectX->EarthView::World::Spatial::Display::CMarkerSymbol::toSLD();
					EarthView::World::Core::ev_wstring valuesw1 = __values1;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_display_MarkerSymbol_equal_1ISymbol(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong pSymbol_j)
				{
					const EarthView::World::Spatial::Display::ISymbol *pSymbol = (const EarthView::World::Spatial::Display::ISymbol*) pSymbol_j;
					EarthView::World::Spatial::Display::CMarkerSymbol *pObjectX = (EarthView::World::Spatial::Display::CMarkerSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCMarkerSymbolProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial::Display::CMarkerSymbol::equal(pSymbol);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_MarkerSymbol_register_1equal_1ISymbol(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMarkerSymbolProxy *pObjectX = (JCMarkerSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_display_MarkerSymbol_equal_1ISymbol_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong pSymbol_j)
				{
					const EarthView::World::Spatial::Display::ISymbol *pSymbol = (const EarthView::World::Spatial::Display::ISymbol*) pSymbol_j;
					EarthView::World::Spatial::Display::CMarkerSymbol *pObjectX = (EarthView::World::Spatial::Display::CMarkerSymbol*) pObjXXXX;
					ev_bool __values1 = pObjectX->EarthView::World::Spatial::Display::CMarkerSymbol::equal(pSymbol);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_MarkerSymbol_fromSLD_1EVString(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong sld_j)
				{
					EVString &sld = *(EVString*) sld_j;
					EarthView::World::Spatial::Display::CMarkerSymbol *pObjectX = (EarthView::World::Spatial::Display::CMarkerSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCMarkerSymbolProxy))
					{
						pObjectX->EarthView::World::Spatial::Display::CMarkerSymbol::fromSLD(sld);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_MarkerSymbol_register_1fromSLD_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMarkerSymbolProxy *pObjectX = (JCMarkerSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_MarkerSymbol_fromSLD_1EVString_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong sld_j)
				{
					EVString &sld = *(EVString*) sld_j;
					EarthView::World::Spatial::Display::CMarkerSymbol *pObjectX = (EarthView::World::Spatial::Display::CMarkerSymbol*) pObjXXXX;
					pObjectX->EarthView::World::Spatial::Display::CMarkerSymbol::fromSLD(sld);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_MarkerSymbol_fromStream_1CDataStream(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong stream_j)
				{
					EarthView::World::Core::CDataStream &stream = *(EarthView::World::Core::CDataStream*) stream_j;
					EarthView::World::Spatial::Display::CMarkerSymbol *pObjectX = (EarthView::World::Spatial::Display::CMarkerSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCMarkerSymbolProxy))
					{
						pObjectX->EarthView::World::Spatial::Display::CMarkerSymbol::fromStream(stream);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_MarkerSymbol_register_1fromStream_1CDataStream(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMarkerSymbolProxy *pObjectX = (JCMarkerSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_MarkerSymbol_fromStream_1CDataStream_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong stream_j)
				{
					EarthView::World::Core::CDataStream &stream = *(EarthView::World::Core::CDataStream*) stream_j;
					EarthView::World::Spatial::Display::CMarkerSymbol *pObjectX = (EarthView::World::Spatial::Display::CMarkerSymbol*) pObjXXXX;
					pObjectX->EarthView::World::Spatial::Display::CMarkerSymbol::fromStream(stream);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_MarkerSymbol_register_1getColorRef_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMarkerSymbolProxy *pObjectX = (JCMarkerSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_MarkerSymbol_register_1ev_1clone_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMarkerSymbolProxy *pObjectX = (JCMarkerSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_MarkerSymbol_register_1getColor_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMarkerSymbolProxy *pObjectX = (JCMarkerSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_MarkerSymbol_register_1setColor_1IColor(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMarkerSymbolProxy *pObjectX = (JCMarkerSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_MarkerSymbol_register_1getSymbolType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMarkerSymbolProxy *pObjectX = (JCMarkerSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_MarkerSymbol_register_1hasImage_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMarkerSymbolProxy *pObjectX = (JCMarkerSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_MarkerSymbol_register_1getImageCount_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMarkerSymbolProxy *pObjectX = (JCMarkerSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_MarkerSymbol_register_1getImageID_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMarkerSymbolProxy *pObjectX = (JCMarkerSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_MarkerSymbol_register_1getImage_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMarkerSymbolProxy *pObjectX = (JCMarkerSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_MarkerSymbol_register_1setImage_1ev_1uint32_1EVString_1MemoryDataStreamPtr(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMarkerSymbolProxy *pObjectX = (JCMarkerSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_MarkerSymbol_register_1getName_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMarkerSymbolProxy *pObjectX = (JCMarkerSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_MarkerSymbol_register_1setName_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMarkerSymbolProxy *pObjectX = (JCMarkerSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
