...
namespace EarthView
{
	namespace World
	{
		namespace Spatial
		{
			namespace Display
			{
				class JCSimpleTextSymbolProxy : public EarthView::World::Spatial::Display::CSimpleTextSymbol
				{
				 private:
				...
				public:
					JCSimpleTextSymbolProxy(EarthView::World::Core::CNameValuePairList *pList) : CSimpleTextSymbol(pList)
					{
					}
				...
				REGISTER_FACTORY_CLASS(JCSimpleTextSymbolProxy);
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial_display_SimpleTextSymbol_getSymbolType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Display::CSimpleTextSymbol *pObjectX = (EarthView::World::Spatial::Display::CSimpleTextSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCSimpleTextSymbolProxy))
					{
						ev_int32 __values1 = pObjectX->EarthView::World::Spatial::Display::CSimpleTextSymbol::getSymbolType();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_SimpleTextSymbol_register_1getSymbolType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCSimpleTextSymbolProxy *pObjectX = (JCSimpleTextSymbolProxy*) pObjXXXX;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial_display_SimpleTextSymbol_getSymbolType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Display::CSimpleTextSymbol *pObjectX = (EarthView::World::Spatial::Display::CSimpleTextSymbol*) pObjXXXX;
					ev_int32 __values1 = pObjectX->EarthView::World::Spatial::Display::CSimpleTextSymbol::getSymbolType();
					jint __values1_j = (jint)__values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_display_SimpleTextSymbol_ev_1clone_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Display::CSimpleTextSymbol *pObjectX = (EarthView::World::Spatial::Display::CSimpleTextSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCSimpleTextSymbolProxy))
					{
						EarthView::World::Spatial::Display::ISymbol* __values1 = pObjectX->EarthView::World::Spatial::Display::CSimpleTextSymbol::clone();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_SimpleTextSymbol_register_1ev_1clone_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCSimpleTextSymbolProxy *pObjectX = (JCSimpleTextSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_display_SimpleTextSymbol_ev_1clone_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Display::CSimpleTextSymbol *pObjectX = (EarthView::World::Spatial::Display::CSimpleTextSymbol*) pObjXXXX;
					EarthView::World::Spatial::Display::ISymbol* __values1 = pObjectX->EarthView::World::Spatial::Display::CSimpleTextSymbol::clone();
					if(__values1 != NULL) {						((EarthView::World::Core::CBaseObject*)__values1)->setExternFree(true);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_SimpleTextSymbol_toStream_1CDataStream(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong stream_j)
				{
					EarthView::World::Core::CDataStream &stream = *(EarthView::World::Core::CDataStream*) stream_j;
					const 					EarthView::World::Spatial::Display::CSimpleTextSymbol *pObjectX = (EarthView::World::Spatial::Display::CSimpleTextSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCSimpleTextSymbolProxy))
					{
						pObjectX->EarthView::World::Spatial::Display::CSimpleTextSymbol::toStream(stream);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_SimpleTextSymbol_register_1toStream_1CDataStream(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCSimpleTextSymbolProxy *pObjectX = (JCSimpleTextSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_SimpleTextSymbol_toStream_1CDataStream_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong stream_j)
				{
					EarthView::World::Core::CDataStream &stream = *(EarthView::World::Core::CDataStream*) stream_j;
					const 					EarthView::World::Spatial::Display::CSimpleTextSymbol *pObjectX = (EarthView::World::Spatial::Display::CSimpleTextSymbol*) pObjXXXX;
					pObjectX->EarthView::World::Spatial::Display::CSimpleTextSymbol::toStream(stream);
				}
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial_display_SimpleTextSymbol_toSLD_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Display::CSimpleTextSymbol *pObjectX = (EarthView::World::Spatial::Display::CSimpleTextSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCSimpleTextSymbolProxy))
					{
						EVString __values1 = pObjectX->EarthView::World::Spatial::Display::CSimpleTextSymbol::toSLD();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_SimpleTextSymbol_register_1toSLD_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCSimpleTextSymbolProxy *pObjectX = (JCSimpleTextSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial_display_SimpleTextSymbol_toSLD_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Display::CSimpleTextSymbol *pObjectX = (EarthView::World::Spatial::Display::CSimpleTextSymbol*) pObjXXXX;
					EVString __values1 = pObjectX->EarthView::World::Spatial::Display::CSimpleTextSymbol::toSLD();
					EarthView::World::Core::ev_wstring valuesw1 = __values1;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_SimpleTextSymbol_fromXmlElement_1CXmlElement(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong element_j)
				{
					EarthView::World::Core::CXmlElement &element = *(EarthView::World::Core::CXmlElement*) element_j;
					EarthView::World::Spatial::Display::CSimpleTextSymbol *pObjectX = (EarthView::World::Spatial::Display::CSimpleTextSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCSimpleTextSymbolProxy))
					{
						pObjectX->EarthView::World::Spatial::Display::CSimpleTextSymbol::fromXmlElement(element);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_SimpleTextSymbol_register_1fromXmlElement_1CXmlElement(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCSimpleTextSymbolProxy *pObjectX = (JCSimpleTextSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_SimpleTextSymbol_fromXmlElement_1CXmlElement_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong element_j)
				{
					EarthView::World::Core::CXmlElement &element = *(EarthView::World::Core::CXmlElement*) element_j;
					EarthView::World::Spatial::Display::CSimpleTextSymbol *pObjectX = (EarthView::World::Spatial::Display::CSimpleTextSymbol*) pObjXXXX;
					pObjectX->EarthView::World::Spatial::Display::CSimpleTextSymbol::fromXmlElement(element);
				}
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_display_SimpleTextSymbol_toXmlElement_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Display::CSimpleTextSymbol *pObjectX = (EarthView::World::Spatial::Display::CSimpleTextSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCSimpleTextSymbolProxy))
					{
						EarthView::World::Core::CXmlElement __values1 = pObjectX->EarthView::World::Spatial::Display::CSimpleTextSymbol::toXmlElement();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_SimpleTextSymbol_register_1toXmlElement_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCSimpleTextSymbolProxy *pObjectX = (JCSimpleTextSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_display_SimpleTextSymbol_toXmlElement_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Display::CSimpleTextSymbol *pObjectX = (EarthView::World::Spatial::Display::CSimpleTextSymbol*) pObjXXXX;
					EarthView::World::Core::CXmlElement __values1 = pObjectX->EarthView::World::Spatial::Display::CSimpleTextSymbol::toXmlElement();
					EarthView::World::Core::CXmlElement *returnvalues = new EarthView::World::Core::CXmlElement(__values1);
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_display_SimpleTextSymbol_equal_1ISymbol(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong pSymbol_j)
				{
					const EarthView::World::Spatial::Display::ISymbol *pSymbol = (const EarthView::World::Spatial::Display::ISymbol*) pSymbol_j;
					EarthView::World::Spatial::Display::CSimpleTextSymbol *pObjectX = (EarthView::World::Spatial::Display::CSimpleTextSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCSimpleTextSymbolProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial::Display::CSimpleTextSymbol::equal(pSymbol);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_SimpleTextSymbol_register_1equal_1ISymbol(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCSimpleTextSymbolProxy *pObjectX = (JCSimpleTextSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_display_SimpleTextSymbol_equal_1ISymbol_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong pSymbol_j)
				{
					const EarthView::World::Spatial::Display::ISymbol *pSymbol = (const EarthView::World::Spatial::Display::ISymbol*) pSymbol_j;
					EarthView::World::Spatial::Display::CSimpleTextSymbol *pObjectX = (EarthView::World::Spatial::Display::CSimpleTextSymbol*) pObjXXXX;
					ev_bool __values1 = pObjectX->EarthView::World::Spatial::Display::CSimpleTextSymbol::equal(pSymbol);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_SimpleTextSymbol_getTextSize_1ev_1int64_1EVString_1ev_1real64_1ev_1real64(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong hdc_j, jstring text_j, jlong xSize_j, jlong ySize_j)
				{
					...
					if (typeid(*pObjectX) == typeid(JCSimpleTextSymbolProxy))
					{
						pObjectX->EarthView::World::Spatial::Display::CSimpleTextSymbol::getTextSize(hdc, text, xSize, ySize);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_SimpleTextSymbol_register_1getTextSize_1ev_1int64_1EVString_1ev_1real64_1ev_1real64(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCSimpleTextSymbolProxy *pObjectX = (JCSimpleTextSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_SimpleTextSymbol_getTextSize_1ev_1int64_1EVString_1ev_1real64_1ev_1real64_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong hdc_j, jstring text_j, jlong xSize_j, jlong ySize_j)
				{
					ev_int64 hdc = (ev_int64) hdc_j;
					#if EV_PLATFORM == EV_PLATFORM_ANDROID
					const ev_char* text_ch = (const ev_char*)__env->GetStringUTFChars(text_j,JNI_FALSE);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_SimpleTextSymbol_fromSLD_1EVString(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong sld_j)
				{
					EVString &sld = *(EVString*) sld_j;
					EarthView::World::Spatial::Display::CSimpleTextSymbol *pObjectX = (EarthView::World::Spatial::Display::CSimpleTextSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCSimpleTextSymbolProxy))
					{
						pObjectX->EarthView::World::Spatial::Display::CSimpleTextSymbol::fromSLD(sld);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_SimpleTextSymbol_register_1fromSLD_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCSimpleTextSymbolProxy *pObjectX = (JCSimpleTextSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_SimpleTextSymbol_fromSLD_1EVString_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong sld_j)
				{
					EVString &sld = *(EVString*) sld_j;
					EarthView::World::Spatial::Display::CSimpleTextSymbol *pObjectX = (EarthView::World::Spatial::Display::CSimpleTextSymbol*) pObjXXXX;
					pObjectX->EarthView::World::Spatial::Display::CSimpleTextSymbol::fromSLD(sld);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_SimpleTextSymbol_fromStream_1CDataStream(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong stream_j)
				{
					EarthView::World::Core::CDataStream &stream = *(EarthView::World::Core::CDataStream*) stream_j;
					EarthView::World::Spatial::Display::CSimpleTextSymbol *pObjectX = (EarthView::World::Spatial::Display::CSimpleTextSymbol*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCSimpleTextSymbolProxy))
					{
						pObjectX->EarthView::World::Spatial::Display::CSimpleTextSymbol::fromStream(stream);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_SimpleTextSymbol_register_1fromStream_1CDataStream(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCSimpleTextSymbolProxy *pObjectX = (JCSimpleTextSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_SimpleTextSymbol_fromStream_1CDataStream_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong stream_j)
				{
					EarthView::World::Core::CDataStream &stream = *(EarthView::World::Core::CDataStream*) stream_j;
					EarthView::World::Spatial::Display::CSimpleTextSymbol *pObjectX = (EarthView::World::Spatial::Display::CSimpleTextSymbol*) pObjXXXX;
					pObjectX->EarthView::World::Spatial::Display::CSimpleTextSymbol::fromStream(stream);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_SimpleTextSymbol_register_1getTextSize_1IPaintDevice_1EVString_1ev_1real64_1ev_1real64(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCSimpleTextSymbolProxy *pObjectX = (JCSimpleTextSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_SimpleTextSymbol_register_1getOutlineColor_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCSimpleTextSymbolProxy *pObjectX = (JCSimpleTextSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_SimpleTextSymbol_register_1setOutlineColor_1IColor(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCSimpleTextSymbolProxy *pObjectX = (JCSimpleTextSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_SimpleTextSymbol_register_1getSize_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCSimpleTextSymbolProxy *pObjectX = (JCSimpleTextSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_SimpleTextSymbol_register_1getColorRef_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCSimpleTextSymbolProxy *pObjectX = (JCSimpleTextSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_SimpleTextSymbol_register_1getColor_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCSimpleTextSymbolProxy *pObjectX = (JCSimpleTextSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_SimpleTextSymbol_register_1setColor_1IColor(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCSimpleTextSymbolProxy *pObjectX = (JCSimpleTextSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_SimpleTextSymbol_register_1hasImage_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCSimpleTextSymbolProxy *pObjectX = (JCSimpleTextSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_SimpleTextSymbol_register_1getImageCount_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCSimpleTextSymbolProxy *pObjectX = (JCSimpleTextSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_SimpleTextSymbol_register_1getImageID_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCSimpleTextSymbolProxy *pObjectX = (JCSimpleTextSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_SimpleTextSymbol_register_1getImage_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCSimpleTextSymbolProxy *pObjectX = (JCSimpleTextSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_SimpleTextSymbol_register_1setImage_1ev_1uint32_1EVString_1MemoryDataStreamPtr(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCSimpleTextSymbolProxy *pObjectX = (JCSimpleTextSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_SimpleTextSymbol_register_1getName_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCSimpleTextSymbolProxy *pObjectX = (JCSimpleTextSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_SimpleTextSymbol_register_1setName_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCSimpleTextSymbolProxy *pObjectX = (JCSimpleTextSymbolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
