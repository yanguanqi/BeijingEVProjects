...
namespace EarthView
{
	namespace World
	{
		namespace Graphic
		{
			...
			{
				class JCPerPixelLightingProxy : public EarthView::World::Graphic::RTShaderSystem::CPerPixelLighting
				{
				 private:
				...
				public:
					JCPerPixelLightingProxy(EarthView::World::Core::CNameValuePairList *pList) : CPerPixelLighting(pList)
					{
					}
				...
				REGISTER_FACTORY_CLASS(JCPerPixelLightingProxy);
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_graphic_rtshadersystem_PerPixelLighting_getType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Graphic::RTShaderSystem::CPerPixelLighting *pObjectX = (EarthView::World::Graphic::RTShaderSystem::CPerPixelLighting*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCPerPixelLightingProxy))
					{
						EVString __values1 = pObjectX->EarthView::World::Graphic::RTShaderSystem::CPerPixelLighting::getType();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_rtshadersystem_PerPixelLighting_register_1getType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPerPixelLightingProxy *pObjectX = (JCPerPixelLightingProxy*) pObjXXXX;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_graphic_rtshadersystem_PerPixelLighting_getType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Graphic::RTShaderSystem::CPerPixelLighting *pObjectX = (EarthView::World::Graphic::RTShaderSystem::CPerPixelLighting*) pObjXXXX;
					EVString __values1 = pObjectX->EarthView::World::Graphic::RTShaderSystem::CPerPixelLighting::getType();
					EarthView::World::Core::ev_wstring valuesw1 = __values1;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_graphic_rtshadersystem_PerPixelLighting_getExecutionOrder_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Graphic::RTShaderSystem::CPerPixelLighting *pObjectX = (EarthView::World::Graphic::RTShaderSystem::CPerPixelLighting*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCPerPixelLightingProxy))
					{
						int __values1 = pObjectX->EarthView::World::Graphic::RTShaderSystem::CPerPixelLighting::getExecutionOrder();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_rtshadersystem_PerPixelLighting_register_1getExecutionOrder_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPerPixelLightingProxy *pObjectX = (JCPerPixelLightingProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_graphic_rtshadersystem_PerPixelLighting_getExecutionOrder_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Graphic::RTShaderSystem::CPerPixelLighting *pObjectX = (EarthView::World::Graphic::RTShaderSystem::CPerPixelLighting*) pObjXXXX;
					int __values1 = pObjectX->EarthView::World::Graphic::RTShaderSystem::CPerPixelLighting::getExecutionOrder();
					jint __values1_j = (jint)__values1;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_rtshadersystem_PerPixelLighting_updateGpuProgramsParams_1CRenderable_1CPass_1CAutoParamDataSource_1LightList(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong rend_j, jlong pass_j, jlong source_j, jlong pLightList_j)
				{
					...
					EarthView::World::Graphic::RTShaderSystem::CPerPixelLighting *pObjectX = (EarthView::World::Graphic::RTShaderSystem::CPerPixelLighting*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCPerPixelLightingProxy))
					{
						pObjectX->EarthView::World::Graphic::RTShaderSystem::CPerPixelLighting::updateGpuProgramsParams(rend, pass, source, pLightList);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_rtshadersystem_PerPixelLighting_register_1updateGpuProgramsParams_1CRenderable_1CPass_1CAutoParamDataSource_1LightList(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPerPixelLightingProxy *pObjectX = (JCPerPixelLightingProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_rtshadersystem_PerPixelLighting_updateGpuProgramsParams_1CRenderable_1CPass_1CAutoParamDataSource_1LightList_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong rend_j, jlong pass_j, jlong source_j, jlong pLightList_j)
				{
					EarthView::World::Graphic::CRenderable *rend = (EarthView::World::Graphic::CRenderable*) rend_j;
					EarthView::World::Graphic::CPass *pass = (EarthView::World::Graphic::CPass*) pass_j;
					const EarthView::World::Graphic::CAutoParamDataSource *source = (const EarthView::World::Graphic::CAutoParamDataSource*) source_j;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_rtshadersystem_PerPixelLighting_copyFrom_1CSubRenderState(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong rhs_j)
				{
					...
					if (typeid(*pObjectX) == typeid(JCPerPixelLightingProxy))
					{
						pObjectX->EarthView::World::Graphic::RTShaderSystem::CPerPixelLighting::copyFrom(rhs);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_rtshadersystem_PerPixelLighting_register_1copyFrom_1CSubRenderState(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPerPixelLightingProxy *pObjectX = (JCPerPixelLightingProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_rtshadersystem_PerPixelLighting_copyFrom_1CSubRenderState_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong rhs_j)
				{
					const EarthView::World::Graphic::RTShaderSystem::CSubRenderState &rhs = *(EarthView::World::Graphic::RTShaderSystem::CSubRenderState*) rhs_j;
					EarthView::World::Graphic::RTShaderSystem::CPerPixelLighting *pObjectX = (EarthView::World::Graphic::RTShaderSystem::CPerPixelLighting*) pObjXXXX;
					pObjectX->EarthView::World::Graphic::RTShaderSystem::CPerPixelLighting::copyFrom(rhs);
				}
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_graphic_rtshadersystem_PerPixelLighting_preAddToRenderState_1CRenderState_1CPass_1CPass(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong renderState_j, jlong srcPass_j, jlong dstPass_j)
				{
					...
					if (typeid(*pObjectX) == typeid(JCPerPixelLightingProxy))
					{
						bool __values1 = pObjectX->EarthView::World::Graphic::RTShaderSystem::CPerPixelLighting::preAddToRenderState(renderState, srcPass, dstPass);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_rtshadersystem_PerPixelLighting_register_1preAddToRenderState_1CRenderState_1CPass_1CPass(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPerPixelLightingProxy *pObjectX = (JCPerPixelLightingProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_graphic_rtshadersystem_PerPixelLighting_preAddToRenderState_1CRenderState_1CPass_1CPass_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong renderState_j, jlong srcPass_j, jlong dstPass_j)
				{
					const EarthView::World::Graphic::RTShaderSystem::CRenderState *renderState = (const EarthView::World::Graphic::RTShaderSystem::CRenderState*) renderState_j;
					EarthView::World::Graphic::CPass *srcPass = (EarthView::World::Graphic::CPass*) srcPass_j;
					EarthView::World::Graphic::CPass *dstPass = (EarthView::World::Graphic::CPass*) dstPass_j;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_graphic_rtshadersystem_PerPixelLighting_get_1Type_1void(JNIEnv *__env, jclass __clazz)
				{
					EarthView::World::Core::ev_wstring __values1_ch = EarthView::World::Graphic::RTShaderSystem::CPerPixelLighting::Type;
					jstring __values1_j = __env->NewString((const jchar*)__values1_ch.getString(), __values1_ch.size());
					return __values1_j;
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_rtshadersystem_PerPixelLighting_set_1Type_1EVString(JNIEnv *__env, jclass __clazz, jstring __values1_j)
				{
					const ev_wchar* __values1_ch = (const ev_wchar*)__env->GetStringChars(__values1_j,JNI_FALSE);
					EarthView::World::Graphic::RTShaderSystem::CPerPixelLighting::Type = __values1_ch;
					__env->ReleaseStringChars(__values1_j,(const jchar*)__values1_ch);
				}
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_graphic_rtshadersystem_PerPixelLighting_resolveParameters_1CProgramSet(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong programSet_j)
				{
					...
					if (typeid(*pObjectX) == typeid(JCPerPixelLightingProxy))
					{
						bool __values1 = pObjectX->EarthView::World::Graphic::RTShaderSystem::CPerPixelLighting::resolveParameters(programSet);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_rtshadersystem_PerPixelLighting_register_1resolveParameters_1CProgramSet(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPerPixelLightingProxy *pObjectX = (JCPerPixelLightingProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_graphic_rtshadersystem_PerPixelLighting_resolveParameters_1CProgramSet_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong programSet_j)
				{
					EarthView::World::Graphic::RTShaderSystem::CProgramSet *programSet = (EarthView::World::Graphic::RTShaderSystem::CProgramSet*) programSet_j;
					EarthView::World::Graphic::RTShaderSystem::CPerPixelLighting *pObjectX = (EarthView::World::Graphic::RTShaderSystem::CPerPixelLighting*) pObjXXXX;
					bool __values1 = pObjectX->EarthView::World::Graphic::RTShaderSystem::CPerPixelLighting::resolveParameters(programSet);
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_graphic_rtshadersystem_PerPixelLighting_resolveDependencies_1CProgramSet(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong programSet_j)
				{
					EarthView::World::Graphic::RTShaderSystem::CProgramSet *programSet = (EarthView::World::Graphic::RTShaderSystem::CProgramSet*) programSet_j;
					EarthView::World::Graphic::RTShaderSystem::CPerPixelLighting *pObjectX = (EarthView::World::Graphic::RTShaderSystem::CPerPixelLighting*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCPerPixelLightingProxy))
					{
						bool __values1 = pObjectX->EarthView::World::Graphic::RTShaderSystem::CPerPixelLighting::resolveDependencies(programSet);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_rtshadersystem_PerPixelLighting_register_1resolveDependencies_1CProgramSet(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPerPixelLightingProxy *pObjectX = (JCPerPixelLightingProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_graphic_rtshadersystem_PerPixelLighting_resolveDependencies_1CProgramSet_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong programSet_j)
				{
					EarthView::World::Graphic::RTShaderSystem::CProgramSet *programSet = (EarthView::World::Graphic::RTShaderSystem::CProgramSet*) programSet_j;
					EarthView::World::Graphic::RTShaderSystem::CPerPixelLighting *pObjectX = (EarthView::World::Graphic::RTShaderSystem::CPerPixelLighting*) pObjXXXX;
					bool __values1 = pObjectX->EarthView::World::Graphic::RTShaderSystem::CPerPixelLighting::resolveDependencies(programSet);
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_graphic_rtshadersystem_PerPixelLighting_addFunctionInvocations_1CProgramSet(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong programSet_j)
				{
					EarthView::World::Graphic::RTShaderSystem::CProgramSet *programSet = (EarthView::World::Graphic::RTShaderSystem::CProgramSet*) programSet_j;
					EarthView::World::Graphic::RTShaderSystem::CPerPixelLighting *pObjectX = (EarthView::World::Graphic::RTShaderSystem::CPerPixelLighting*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCPerPixelLightingProxy))
					{
						bool __values1 = pObjectX->EarthView::World::Graphic::RTShaderSystem::CPerPixelLighting::addFunctionInvocations(programSet);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_rtshadersystem_PerPixelLighting_register_1addFunctionInvocations_1CProgramSet(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPerPixelLightingProxy *pObjectX = (JCPerPixelLightingProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_graphic_rtshadersystem_PerPixelLighting_addFunctionInvocations_1CProgramSet_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong programSet_j)
				{
					EarthView::World::Graphic::RTShaderSystem::CProgramSet *programSet = (EarthView::World::Graphic::RTShaderSystem::CProgramSet*) programSet_j;
					EarthView::World::Graphic::RTShaderSystem::CPerPixelLighting *pObjectX = (EarthView::World::Graphic::RTShaderSystem::CPerPixelLighting*) pObjXXXX;
					bool __values1 = pObjectX->EarthView::World::Graphic::RTShaderSystem::CPerPixelLighting::addFunctionInvocations(programSet);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_rtshadersystem_PerPixelLighting_register_1createCpuSubPrograms_1CProgramSet(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPerPixelLightingProxy *pObjectX = (JCPerPixelLightingProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				class JCPerPixelLightingFactoryProxy : public EarthView::World::Graphic::RTShaderSystem::CPerPixelLightingFactory
				{
				 private:
					EarthView::World::Core::ev_string m_getType_void_callback;
				...
				public:
					JCPerPixelLightingFactoryProxy(EarthView::World::Core::CNameValuePairList *pList) : CPerPixelLightingFactory(pList)
					{
					}
					ev_void unRegisterJavaReference()
					{
				...
				REGISTER_FACTORY_CLASS(JCPerPixelLightingFactoryProxy);
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_graphic_rtshadersystem_PerPixelLightingFactory_getType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Graphic::RTShaderSystem::CPerPixelLightingFactory *pObjectX = (EarthView::World::Graphic::RTShaderSystem::CPerPixelLightingFactory*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCPerPixelLightingFactoryProxy))
					{
						EVString __values1 = pObjectX->EarthView::World::Graphic::RTShaderSystem::CPerPixelLightingFactory::getType();
						EarthView::World::Core::ev_wstring valuesw1 = __values1;
						jstring __values1_j = __env->NewString((const jchar*)valuesw1.getString(), valuesw1.size());
						return __values1_j;
					}
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_rtshadersystem_PerPixelLightingFactory_register_1getType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPerPixelLightingFactoryProxy *pObjectX = (JCPerPixelLightingFactoryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
					__env->ReleaseStringUTFChars(__method, pMethod);
					pObjectX->register_getType_void_callback(sMethod);
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_graphic_rtshadersystem_PerPixelLightingFactory_getType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Graphic::RTShaderSystem::CPerPixelLightingFactory *pObjectX = (EarthView::World::Graphic::RTShaderSystem::CPerPixelLightingFactory*) pObjXXXX;
					EVString __values1 = pObjectX->EarthView::World::Graphic::RTShaderSystem::CPerPixelLightingFactory::getType();
					EarthView::World::Core::ev_wstring valuesw1 = __values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_graphic_rtshadersystem_PerPixelLightingFactory_createInstance_1CScriptCompiler_1CPropertyAbstractNode_1CPass_1CSGScriptTranslator(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong compiler_j, jlong prop_j, jlong pass_j, jlong translator_j)
				{
					...
					EarthView::World::Graphic::RTShaderSystem::CPerPixelLightingFactory *pObjectX = (EarthView::World::Graphic::RTShaderSystem::CPerPixelLightingFactory*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCPerPixelLightingFactoryProxy))
					{
						EarthView::World::Graphic::RTShaderSystem::CSubRenderState* __values1 = pObjectX->EarthView::World::Graphic::RTShaderSystem::CPerPixelLightingFactory::createInstance(compiler, prop, pass, translator);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_rtshadersystem_PerPixelLightingFactory_register_1createInstance_1CScriptCompiler_1CPropertyAbstractNode_1CPass_1CSGScriptTranslator(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPerPixelLightingFactoryProxy *pObjectX = (JCPerPixelLightingFactoryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_graphic_rtshadersystem_PerPixelLightingFactory_createInstance_1CScriptCompiler_1CPropertyAbstractNode_1CPass_1CSGScriptTranslator_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong compiler_j, jlong prop_j, jlong pass_j, jlong translator_j)
				{
					EarthView::World::Graphic::CScriptCompiler *compiler = (EarthView::World::Graphic::CScriptCompiler*) compiler_j;
					EarthView::World::Graphic::CPropertyAbstractNode *prop = (EarthView::World::Graphic::CPropertyAbstractNode*) prop_j;
					EarthView::World::Graphic::CPass *pass = (EarthView::World::Graphic::CPass*) pass_j;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_rtshadersystem_PerPixelLightingFactory_writeInstance_1CMaterialSerializer_1CSubRenderState_1CPass_1CPass(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong ser_j, jlong subRenderState_j, jlong srcPass_j, jlong dstPass_j)
				{
					...
					if (typeid(*pObjectX) == typeid(JCPerPixelLightingFactoryProxy))
					{
						pObjectX->EarthView::World::Graphic::RTShaderSystem::CPerPixelLightingFactory::writeInstance(ser, subRenderState, srcPass, dstPass);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_rtshadersystem_PerPixelLightingFactory_register_1writeInstance_1CMaterialSerializer_1CSubRenderState_1CPass_1CPass(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPerPixelLightingFactoryProxy *pObjectX = (JCPerPixelLightingFactoryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_rtshadersystem_PerPixelLightingFactory_writeInstance_1CMaterialSerializer_1CSubRenderState_1CPass_1CPass_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong ser_j, jlong subRenderState_j, jlong srcPass_j, jlong dstPass_j)
				{
					EarthView::World::Graphic::CMaterialSerializer *ser = (EarthView::World::Graphic::CMaterialSerializer*) ser_j;
					EarthView::World::Graphic::RTShaderSystem::CSubRenderState *subRenderState = (EarthView::World::Graphic::RTShaderSystem::CSubRenderState*) subRenderState_j;
					EarthView::World::Graphic::CPass *srcPass = (EarthView::World::Graphic::CPass*) srcPass_j;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_graphic_rtshadersystem_PerPixelLightingFactory_createInstanceImpl_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Graphic::RTShaderSystem::CPerPixelLightingFactory *pObjectX = (EarthView::World::Graphic::RTShaderSystem::CPerPixelLightingFactory*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCPerPixelLightingFactoryProxy))
					{
						EarthView::World::Graphic::RTShaderSystem::CSubRenderState* __values1 = pObjectX->EarthView::World::Graphic::RTShaderSystem::CPerPixelLightingFactory::createInstanceImpl();
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_rtshadersystem_PerPixelLightingFactory_register_1createInstanceImpl_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPerPixelLightingFactoryProxy *pObjectX = (JCPerPixelLightingFactoryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_graphic_rtshadersystem_PerPixelLightingFactory_createInstanceImpl_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Graphic::RTShaderSystem::CPerPixelLightingFactory *pObjectX = (EarthView::World::Graphic::RTShaderSystem::CPerPixelLightingFactory*) pObjXXXX;
					EarthView::World::Graphic::RTShaderSystem::CSubRenderState* __values1 = pObjectX->EarthView::World::Graphic::RTShaderSystem::CPerPixelLightingFactory::createInstanceImpl();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_rtshadersystem_PerPixelLightingFactory_register_1createInstance_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPerPixelLightingFactoryProxy *pObjectX = (JCPerPixelLightingFactoryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_rtshadersystem_PerPixelLightingFactory_register_1createInstance_1CScriptCompiler_1CPropertyAbstractNode_1CTextureUnitState_1CSGScriptTranslator(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPerPixelLightingFactoryProxy *pObjectX = (JCPerPixelLightingFactoryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_rtshadersystem_PerPixelLightingFactory_register_1createOrRetrieveInstance_1CSGScriptTranslator(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPerPixelLightingFactoryProxy *pObjectX = (JCPerPixelLightingFactoryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_rtshadersystem_PerPixelLightingFactory_register_1destroyInstance_1CSubRenderState(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPerPixelLightingFactoryProxy *pObjectX = (JCPerPixelLightingFactoryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_rtshadersystem_PerPixelLightingFactory_register_1destroyAllInstances_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPerPixelLightingFactoryProxy *pObjectX = (JCPerPixelLightingFactoryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_rtshadersystem_PerPixelLightingFactory_register_1writeInstance_1CMaterialSerializer_1CSubRenderState_1CTextureUnitState_1CTextureUnitState(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPerPixelLightingFactoryProxy *pObjectX = (JCPerPixelLightingFactoryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
