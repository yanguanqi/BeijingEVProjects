...
namespace EarthView
{
	namespace World
	{
		namespace Graphic
		{
			...
			{
				class JCDualQuaternionSkinningProxy : public EarthView::World::Graphic::RTShaderSystem::CDualQuaternionSkinning
				{
				 private:
				...
				public:
					JCDualQuaternionSkinningProxy(EarthView::World::Core::CNameValuePairList *pList) : CDualQuaternionSkinning(pList)
					{
					}
				...
				REGISTER_FACTORY_CLASS(JCDualQuaternionSkinningProxy);
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_graphic_rtshadersystem_DualQuaternionSkinning_resolveParameters_1CProgramSet(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong programSet_j)
				{
					...
					EarthView::World::Graphic::RTShaderSystem::CDualQuaternionSkinning *pObjectX = (EarthView::World::Graphic::RTShaderSystem::CDualQuaternionSkinning*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCDualQuaternionSkinningProxy))
					{
						bool __values1 = pObjectX->EarthView::World::Graphic::RTShaderSystem::CDualQuaternionSkinning::resolveParameters(programSet);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_rtshadersystem_DualQuaternionSkinning_register_1resolveParameters_1CProgramSet(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCDualQuaternionSkinningProxy *pObjectX = (JCDualQuaternionSkinningProxy*) pObjXXXX;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_graphic_rtshadersystem_DualQuaternionSkinning_resolveParameters_1CProgramSet_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong programSet_j)
				{
					EarthView::World::Graphic::RTShaderSystem::CProgramSet *programSet = (EarthView::World::Graphic::RTShaderSystem::CProgramSet*) programSet_j;
					EarthView::World::Graphic::RTShaderSystem::CDualQuaternionSkinning *pObjectX = (EarthView::World::Graphic::RTShaderSystem::CDualQuaternionSkinning*) pObjXXXX;
					bool __values1 = pObjectX->EarthView::World::Graphic::RTShaderSystem::CDualQuaternionSkinning::resolveParameters(programSet);
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_graphic_rtshadersystem_DualQuaternionSkinning_resolveDependencies_1CProgramSet(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong programSet_j)
				{
					EarthView::World::Graphic::RTShaderSystem::CProgramSet *programSet = (EarthView::World::Graphic::RTShaderSystem::CProgramSet*) programSet_j;
					EarthView::World::Graphic::RTShaderSystem::CDualQuaternionSkinning *pObjectX = (EarthView::World::Graphic::RTShaderSystem::CDualQuaternionSkinning*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCDualQuaternionSkinningProxy))
					{
						bool __values1 = pObjectX->EarthView::World::Graphic::RTShaderSystem::CDualQuaternionSkinning::resolveDependencies(programSet);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_rtshadersystem_DualQuaternionSkinning_register_1resolveDependencies_1CProgramSet(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCDualQuaternionSkinningProxy *pObjectX = (JCDualQuaternionSkinningProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_graphic_rtshadersystem_DualQuaternionSkinning_resolveDependencies_1CProgramSet_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong programSet_j)
				{
					EarthView::World::Graphic::RTShaderSystem::CProgramSet *programSet = (EarthView::World::Graphic::RTShaderSystem::CProgramSet*) programSet_j;
					EarthView::World::Graphic::RTShaderSystem::CDualQuaternionSkinning *pObjectX = (EarthView::World::Graphic::RTShaderSystem::CDualQuaternionSkinning*) pObjXXXX;
					bool __values1 = pObjectX->EarthView::World::Graphic::RTShaderSystem::CDualQuaternionSkinning::resolveDependencies(programSet);
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_graphic_rtshadersystem_DualQuaternionSkinning_addFunctionInvocations_1CProgramSet(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong programSet_j)
				{
					EarthView::World::Graphic::RTShaderSystem::CProgramSet *programSet = (EarthView::World::Graphic::RTShaderSystem::CProgramSet*) programSet_j;
					EarthView::World::Graphic::RTShaderSystem::CDualQuaternionSkinning *pObjectX = (EarthView::World::Graphic::RTShaderSystem::CDualQuaternionSkinning*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCDualQuaternionSkinningProxy))
					{
						bool __values1 = pObjectX->EarthView::World::Graphic::RTShaderSystem::CDualQuaternionSkinning::addFunctionInvocations(programSet);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_rtshadersystem_DualQuaternionSkinning_register_1addFunctionInvocations_1CProgramSet(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCDualQuaternionSkinningProxy *pObjectX = (JCDualQuaternionSkinningProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_graphic_rtshadersystem_DualQuaternionSkinning_addFunctionInvocations_1CProgramSet_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong programSet_j)
				{
					EarthView::World::Graphic::RTShaderSystem::CProgramSet *programSet = (EarthView::World::Graphic::RTShaderSystem::CProgramSet*) programSet_j;
					EarthView::World::Graphic::RTShaderSystem::CDualQuaternionSkinning *pObjectX = (EarthView::World::Graphic::RTShaderSystem::CDualQuaternionSkinning*) pObjXXXX;
					bool __values1 = pObjectX->EarthView::World::Graphic::RTShaderSystem::CDualQuaternionSkinning::addFunctionInvocations(programSet);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_rtshadersystem_DualQuaternionSkinning_register_1copyFrom_1CHardwareSkinningTechnique(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCDualQuaternionSkinningProxy *pObjectX = (JCDualQuaternionSkinningProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
