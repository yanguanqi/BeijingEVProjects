...
namespace EarthView
{
	namespace World
	{
		namespace Graphic
		{
			...
			{
				class JCGLSLProgramProcessorProxy : public EarthView::World::Graphic::RTShaderSystem::CGLSLProgramProcessor
				{
				 private:
				...
				public:
					JCGLSLProgramProcessorProxy(EarthView::World::Core::CNameValuePairList *pList) : CGLSLProgramProcessor(pList)
					{
					}
				...
				REGISTER_FACTORY_CLASS(JCGLSLProgramProcessorProxy);
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_graphic_rtshadersystem_Glslprogramprocessor_getTargetLanguage_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Graphic::RTShaderSystem::CGLSLProgramProcessor *pObjectX = (EarthView::World::Graphic::RTShaderSystem::CGLSLProgramProcessor*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCGLSLProgramProcessorProxy))
					{
						EVString __values1 = pObjectX->EarthView::World::Graphic::RTShaderSystem::CGLSLProgramProcessor::getTargetLanguage();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_rtshadersystem_Glslprogramprocessor_register_1getTargetLanguage_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCGLSLProgramProcessorProxy *pObjectX = (JCGLSLProgramProcessorProxy*) pObjXXXX;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_graphic_rtshadersystem_Glslprogramprocessor_getTargetLanguage_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Graphic::RTShaderSystem::CGLSLProgramProcessor *pObjectX = (EarthView::World::Graphic::RTShaderSystem::CGLSLProgramProcessor*) pObjXXXX;
					EVString __values1 = pObjectX->EarthView::World::Graphic::RTShaderSystem::CGLSLProgramProcessor::getTargetLanguage();
					EarthView::World::Core::ev_wstring valuesw1 = __values1;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_graphic_rtshadersystem_Glslprogramprocessor_preCreateGpuPrograms_1CProgramSet(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong programSet_j)
				{
					...
					EarthView::World::Graphic::RTShaderSystem::CGLSLProgramProcessor *pObjectX = (EarthView::World::Graphic::RTShaderSystem::CGLSLProgramProcessor*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCGLSLProgramProcessorProxy))
					{
						bool __values1 = pObjectX->EarthView::World::Graphic::RTShaderSystem::CGLSLProgramProcessor::preCreateGpuPrograms(programSet);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_rtshadersystem_Glslprogramprocessor_register_1preCreateGpuPrograms_1CProgramSet(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCGLSLProgramProcessorProxy *pObjectX = (JCGLSLProgramProcessorProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_graphic_rtshadersystem_Glslprogramprocessor_preCreateGpuPrograms_1CProgramSet_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong programSet_j)
				{
					EarthView::World::Graphic::RTShaderSystem::CProgramSet *programSet = (EarthView::World::Graphic::RTShaderSystem::CProgramSet*) programSet_j;
					EarthView::World::Graphic::RTShaderSystem::CGLSLProgramProcessor *pObjectX = (EarthView::World::Graphic::RTShaderSystem::CGLSLProgramProcessor*) pObjXXXX;
					bool __values1 = pObjectX->EarthView::World::Graphic::RTShaderSystem::CGLSLProgramProcessor::preCreateGpuPrograms(programSet);
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_graphic_rtshadersystem_Glslprogramprocessor_postCreateGpuPrograms_1CProgramSet(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong programSet_j)
				{
					EarthView::World::Graphic::RTShaderSystem::CProgramSet *programSet = (EarthView::World::Graphic::RTShaderSystem::CProgramSet*) programSet_j;
					EarthView::World::Graphic::RTShaderSystem::CGLSLProgramProcessor *pObjectX = (EarthView::World::Graphic::RTShaderSystem::CGLSLProgramProcessor*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCGLSLProgramProcessorProxy))
					{
						bool __values1 = pObjectX->EarthView::World::Graphic::RTShaderSystem::CGLSLProgramProcessor::postCreateGpuPrograms(programSet);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_rtshadersystem_Glslprogramprocessor_register_1postCreateGpuPrograms_1CProgramSet(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCGLSLProgramProcessorProxy *pObjectX = (JCGLSLProgramProcessorProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_graphic_rtshadersystem_Glslprogramprocessor_postCreateGpuPrograms_1CProgramSet_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong programSet_j)
				{
					EarthView::World::Graphic::RTShaderSystem::CProgramSet *programSet = (EarthView::World::Graphic::RTShaderSystem::CProgramSet*) programSet_j;
					EarthView::World::Graphic::RTShaderSystem::CGLSLProgramProcessor *pObjectX = (EarthView::World::Graphic::RTShaderSystem::CGLSLProgramProcessor*) pObjXXXX;
					bool __values1 = pObjectX->EarthView::World::Graphic::RTShaderSystem::CGLSLProgramProcessor::postCreateGpuPrograms(programSet);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_rtshadersystem_Glslprogramprocessor_register_1compactVsOutputs_1CFunction_1CFunction(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCGLSLProgramProcessorProxy *pObjectX = (JCGLSLProgramProcessorProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
