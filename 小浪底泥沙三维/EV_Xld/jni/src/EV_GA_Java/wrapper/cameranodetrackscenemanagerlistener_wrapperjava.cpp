...
namespace EarthView
{
	namespace World
	{
		namespace Spatial3D
		{
			namespace Controls
			{
				class JCCameraNodeTrackSceneManagerListenerProxy : public EarthView::World::Spatial3D::Controls::CCameraNodeTrackSceneManagerListener
				{
				 private:
				...
				public:
					JCCameraNodeTrackSceneManagerListenerProxy(EarthView::World::Core::CNameValuePairList *pList) : CCameraNodeTrackSceneManagerListener(pList)
					{
					}
				...
				REGISTER_FACTORY_CLASS(JCCameraNodeTrackSceneManagerListenerProxy);
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_controls_CameraNodeTrackSceneManagerListener_preUpdateSceneGraph_1CSceneManager_1CCamera(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong source_j, jlong camera_j)
				{
					...
					EarthView::World::Spatial3D::Controls::CCameraNodeTrackSceneManagerListener *pObjectX = (EarthView::World::Spatial3D::Controls::CCameraNodeTrackSceneManagerListener*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCCameraNodeTrackSceneManagerListenerProxy))
					{
						pObjectX->EarthView::World::Spatial3D::Controls::CCameraNodeTrackSceneManagerListener::preUpdateSceneGraph(source, camera);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_controls_CameraNodeTrackSceneManagerListener_register_1preUpdateSceneGraph_1CSceneManager_1CCamera(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCameraNodeTrackSceneManagerListenerProxy *pObjectX = (JCCameraNodeTrackSceneManagerListenerProxy*) pObjXXXX;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_controls_CameraNodeTrackSceneManagerListener_preUpdateSceneGraph_1CSceneManager_1CCamera_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong source_j, jlong camera_j)
				{
					EarthView::World::Graphic::CSceneManager *source = (EarthView::World::Graphic::CSceneManager*) source_j;
					EarthView::World::Graphic::CCamera *camera = (EarthView::World::Graphic::CCamera*) camera_j;
					EarthView::World::Spatial3D::Controls::CCameraNodeTrackSceneManagerListener *pObjectX = (EarthView::World::Spatial3D::Controls::CCameraNodeTrackSceneManagerListener*) pObjXXXX;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_controls_CameraNodeTrackSceneManagerListener_setCamera_1CCamera(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong camera_j)
				{
					EarthView::World::Graphic::CCamera *camera = (EarthView::World::Graphic::CCamera*) camera_j;
					EarthView::World::Spatial3D::Controls::CCameraNodeTrackSceneManagerListener *pObjectX = (EarthView::World::Spatial3D::Controls::CCameraNodeTrackSceneManagerListener*) pObjXXXX;
					pObjectX->setCamera(camera);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_controls_CameraNodeTrackSceneManagerListener_register_1postUpdateSceneGraph_1CSceneManager_1CCamera(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCameraNodeTrackSceneManagerListenerProxy *pObjectX = (JCCameraNodeTrackSceneManagerListenerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_controls_CameraNodeTrackSceneManagerListener_register_1preFindVisibleObjects_1CSceneManager_1IlluminationRenderStage_1CViewport(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCameraNodeTrackSceneManagerListenerProxy *pObjectX = (JCCameraNodeTrackSceneManagerListenerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_controls_CameraNodeTrackSceneManagerListener_register_1postFindVisibleObjects_1CSceneManager_1IlluminationRenderStage_1CViewport(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCameraNodeTrackSceneManagerListenerProxy *pObjectX = (JCCameraNodeTrackSceneManagerListenerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_controls_CameraNodeTrackSceneManagerListener_register_1shadowTexturesUpdated_1ev_1size_1t(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCameraNodeTrackSceneManagerListenerProxy *pObjectX = (JCCameraNodeTrackSceneManagerListenerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_controls_CameraNodeTrackSceneManagerListener_register_1shadowTextureCasterPreViewProj_1CLight_1CCamera_1ev_1size_1t(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCameraNodeTrackSceneManagerListenerProxy *pObjectX = (JCCameraNodeTrackSceneManagerListenerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_controls_CameraNodeTrackSceneManagerListener_register_1shadowTextureReceiverPreViewProj_1CLight_1CFrustum(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCameraNodeTrackSceneManagerListenerProxy *pObjectX = (JCCameraNodeTrackSceneManagerListenerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_controls_CameraNodeTrackSceneManagerListener_register_1sortLightsAffectingFrustum_1LightList(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCameraNodeTrackSceneManagerListenerProxy *pObjectX = (JCCameraNodeTrackSceneManagerListenerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_controls_CameraNodeTrackSceneManagerListener_register_1sceneManagerDestroyed_1CSceneManager(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCameraNodeTrackSceneManagerListenerProxy *pObjectX = (JCCameraNodeTrackSceneManagerListenerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
