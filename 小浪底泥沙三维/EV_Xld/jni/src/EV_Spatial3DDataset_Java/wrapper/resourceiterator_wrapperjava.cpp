...
namespace EarthView
{
	namespace World
	{
		namespace Spatial3D
		{
			namespace Dataset
			{
				class JCResourceIteratorProxy : public EarthView::World::Spatial3D::Dataset::CResourceIterator
				{
				 private:
				...
				public:
					JCResourceIteratorProxy(EarthView::World::Core::CNameValuePairList *pList) : CResourceIterator(pList)
					{
					}
				...
				REGISTER_FACTORY_CLASS(JCResourceIteratorProxy);
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceIterator_next_1ev_1bool(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean bCreateNewOne_j)
				{
					ev_bool bCreateNewOne = (ev_bool) bCreateNewOne_j;
					EarthView::World::Spatial3D::Dataset::CResourceIterator *pObjectX = (EarthView::World::Spatial3D::Dataset::CResourceIterator*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCResourceIteratorProxy))
					{
						EarthView::World::Spatial::GeoDataset::IFeature* __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CResourceIterator::next(bCreateNewOne);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceIterator_register_1next_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCResourceIteratorProxy *pObjectX = (JCResourceIteratorProxy*) pObjXXXX;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceIterator_next_1ev_1bool_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean bCreateNewOne_j)
				{
					ev_bool bCreateNewOne = (ev_bool) bCreateNewOne_j;
					EarthView::World::Spatial3D::Dataset::CResourceIterator *pObjectX = (EarthView::World::Spatial3D::Dataset::CResourceIterator*) pObjXXXX;
					EarthView::World::Spatial::GeoDataset::IFeature* __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CResourceIterator::next(bCreateNewOne);
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceIterator_next_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::Dataset::CResourceIterator *pObjectX = (EarthView::World::Spatial3D::Dataset::CResourceIterator*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCResourceIteratorProxy))
					{
						EarthView::World::Spatial::GeoDataset::IFeature* __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CResourceIterator::next();
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceIterator_register_1next_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCResourceIteratorProxy *pObjectX = (JCResourceIteratorProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceIterator_next_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::Dataset::CResourceIterator *pObjectX = (EarthView::World::Spatial3D::Dataset::CResourceIterator*) pObjXXXX;
					EarthView::World::Spatial::GeoDataset::IFeature* __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CResourceIterator::next();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceIterator_getFields_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Dataset::CResourceIterator *pObjectX = (EarthView::World::Spatial3D::Dataset::CResourceIterator*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCResourceIteratorProxy))
					{
						const EarthView::World::Spatial::GeoDataset::IFields* __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CResourceIterator::getFields();
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceIterator_register_1getFields_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCResourceIteratorProxy *pObjectX = (JCResourceIteratorProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceIterator_getFields_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Dataset::CResourceIterator *pObjectX = (EarthView::World::Spatial3D::Dataset::CResourceIterator*) pObjXXXX;
					const EarthView::World::Spatial::GeoDataset::IFields* __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CResourceIterator::getFields();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceIterator_getField_1ev_1uint32(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong index_j)
				{
					ev_uint32 index = (ev_uint32) index_j;
					const 					EarthView::World::Spatial3D::Dataset::CResourceIterator *pObjectX = (EarthView::World::Spatial3D::Dataset::CResourceIterator*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCResourceIteratorProxy))
					{
						const EarthView::World::Spatial::GeoDataset::IField* __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CResourceIterator::getField(index);
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceIterator_register_1getField_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCResourceIteratorProxy *pObjectX = (JCResourceIteratorProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceIterator_getField_1ev_1uint32_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong index_j)
				{
					ev_uint32 index = (ev_uint32) index_j;
					const 					EarthView::World::Spatial3D::Dataset::CResourceIterator *pObjectX = (EarthView::World::Spatial3D::Dataset::CResourceIterator*) pObjXXXX;
					const EarthView::World::Spatial::GeoDataset::IField* __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CResourceIterator::getField(index);
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceIterator_findField_1EVString(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring fieldName_j)
				{
					#if EV_PLATFORM == EV_PLATFORM_ANDROID
					...
					if (typeid(*pObjectX) == typeid(JCResourceIteratorProxy))
					{
						ev_int32 __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CResourceIterator::findField(fieldName);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceIterator_register_1findField_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCResourceIteratorProxy *pObjectX = (JCResourceIteratorProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceIterator_findField_1EVString_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring fieldName_j)
				{
					#if EV_PLATFORM == EV_PLATFORM_ANDROID
					const ev_char* fieldName_ch = (const ev_char*)__env->GetStringUTFChars(fieldName_j,JNI_FALSE);
					const EVString fieldName = fieldName_ch;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceIterator_clear_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::Dataset::CResourceIterator *pObjectX = (EarthView::World::Spatial3D::Dataset::CResourceIterator*) pObjXXXX;
					pObjectX->clear();
				}
