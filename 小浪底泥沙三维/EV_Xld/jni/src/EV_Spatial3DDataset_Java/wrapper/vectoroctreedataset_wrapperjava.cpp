...
namespace EarthView
{
	namespace World
	{
		namespace Spatial3D
		{
			namespace Dataset
			{
				class JCVectorOctreeDatasetProxy : public EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset
				{
				 private:
					EarthView::World::Core::ev_string m_getID_void_callback;
					EarthView::World::Core::ev_string m_getSRID_void_callback;
					EarthView::World::Core::ev_string m_getOctreeNodes_EVString_MemoryDataStreamPtr_callback;
					EarthView::World::Core::ev_string m_getOctreeObjects_EVString_MemoryDataStreamPtr_callback;
					EarthView::World::Core::ev_string m_writeOctree_EVString_MemoryDataStreamPtr_MemoryDataStreamPtr_callback;
				...
				public:
					JCVectorOctreeDatasetProxy(EarthView::World::Core::CNameValuePairList *pList) : CVectorOctreeDataset(pList)
					{
					}
				...
				public:
					...
					void register_getOctreeNodes_EVString_MemoryDataStreamPtr_callback(EarthView::World::Core::ev_string __method)
					{
						this->m_getOctreeNodes_EVString_MemoryDataStreamPtr_callback = __method;
					}
					void register_getOctreeObjects_EVString_MemoryDataStreamPtr_callback(EarthView::World::Core::ev_string __method)
					{
						this->m_getOctreeObjects_EVString_MemoryDataStreamPtr_callback = __method;
					}
					void register_writeOctree_EVString_MemoryDataStreamPtr_MemoryDataStreamPtr_callback(EarthView::World::Core::ev_string __method)
					{
						this->m_writeOctree_EVString_MemoryDataStreamPtr_MemoryDataStreamPtr_callback = __method;
					}
					...
					virtual ev_bool getOctreeNodes(const EVString& octreeCode, EarthView::World::Core::MemoryDataStreamPtr& octreeNodes)
					{
						if (this->_gRef != NULL && this->m_getOctreeNodes_EVString_MemoryDataStreamPtr_callback != "" && this->isCustomExtend())
						{
							EarthView::World::Core::GlobalReference *__gr = (EarthView::World::Core::GlobalReference *)this->getJavaReference();
							JNIEnv * __env;
							#if EV_PLATFORM == EV_PLATFORM_ANDROID
							...
							jobject __obj = __gr->getJObject();
							jclass __clazz = __gr->getClass();
							EarthView::World::Core::ev_wstring octreeCode_wch = octreeCode;
							jstring octreeCode_j = __env->NewString((const jchar*)octreeCode_wch.getString(), octreeCode_wch.size());
							jlong octreeNodes_j = (jlong) &octreeNodes;
							jmethodID __method = __gr->getMethod("getOctreeNodes_EVString_MemoryDataStreamPtr_callback");
							jboolean __values1_j = (jboolean)__env->CallBooleanMethod(__obj, __method , octreeCode_j, octreeNodes_j);
							#if EV_PLATFORM == EV_PLATFORM_ANDROID
							if(__jniAttachable)
							{
								EarthView::World::Core::JNILoad::getCachedJVM()->DetachCurrentThread();
					...
					virtual ev_bool getOctreeObjects(const EVString& octreeCode, EarthView::World::Core::MemoryDataStreamPtr& objectsStream)
					{
						if (this->_gRef != NULL && this->m_getOctreeObjects_EVString_MemoryDataStreamPtr_callback != "" && this->isCustomExtend())
						{
							EarthView::World::Core::GlobalReference *__gr = (EarthView::World::Core::GlobalReference *)this->getJavaReference();
							JNIEnv * __env;
							#if EV_PLATFORM == EV_PLATFORM_ANDROID
							...
							EarthView::World::Core::ev_wstring octreeCode_wch = octreeCode;
							jstring octreeCode_j = __env->NewString((const jchar*)octreeCode_wch.getString(), octreeCode_wch.size());
							jlong objectsStream_j = (jlong) &objectsStream;
							jmethodID __method = __gr->getMethod("getOctreeObjects_EVString_MemoryDataStreamPtr_callback");
							jboolean __values1_j = (jboolean)__env->CallBooleanMethod(__obj, __method , octreeCode_j, objectsStream_j);
							#if EV_PLATFORM == EV_PLATFORM_ANDROID
							if(__jniAttachable)
							{
								EarthView::World::Core::JNILoad::getCachedJVM()->DetachCurrentThread();
					...
					{
						if (this->_gRef != NULL && this->m_writeOctree_EVString_MemoryDataStreamPtr_MemoryDataStreamPtr_callback != "" && this->isCustomExtend())
						{
							EarthView::World::Core::GlobalReference *__gr = (EarthView::World::Core::GlobalReference *)this->getJavaReference();
							JNIEnv * __env;
							#if EV_PLATFORM == EV_PLATFORM_ANDROID
							...
							jlong octreeNodes_j = (jlong) &octreeNodes;
							jlong objectsStream_j = (jlong) &objectsStream;
							jmethodID __method = __gr->getMethod("writeOctree_EVString_MemoryDataStreamPtr_MemoryDataStreamPtr_callback");
							jboolean __values1_j = (jboolean)__env->CallBooleanMethod(__obj, __method , octreeCode_j, octreeNodes_j, objectsStream_j);
							#if EV_PLATFORM == EV_PLATFORM_ANDROID
							if(__jniAttachable)
							{
								EarthView::World::Core::JNILoad::getCachedJVM()->DetachCurrentThread();
				...
				REGISTER_FACTORY_CLASS(JCVectorOctreeDatasetProxy);
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_getDataVersion_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorOctreeDatasetProxy))
					{
						ev_uint64 __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset::getDataVersion();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_register_1getDataVersion_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorOctreeDatasetProxy *pObjectX = (JCVectorOctreeDatasetProxy*) pObjXXXX;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_getDataVersion_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset*) pObjXXXX;
					ev_uint64 __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset::getDataVersion();
					EarthView::World::Core::ev_string __values1_ch;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_getEnvelopeRef_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorOctreeDatasetProxy))
					{
						EarthView::World::Spatial::Geometry::IEnvelope* __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset::getEnvelopeRef();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_register_1getEnvelopeRef_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorOctreeDatasetProxy *pObjectX = (JCVectorOctreeDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_getEnvelopeRef_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset*) pObjXXXX;
					EarthView::World::Spatial::Geometry::IEnvelope* __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset::getEnvelopeRef();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_getSpatialReferenceRef_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorOctreeDatasetProxy))
					{
						EarthView::World::Spatial::Geometry::ISpatialReference* __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset::getSpatialReferenceRef();
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_register_1getSpatialReferenceRef_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorOctreeDatasetProxy *pObjectX = (JCVectorOctreeDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_getSpatialReferenceRef_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset*) pObjXXXX;
					EarthView::World::Spatial::Geometry::ISpatialReference* __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset::getSpatialReferenceRef();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_getName_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorOctreeDatasetProxy))
					{
						EVString __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset::getName();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_register_1getName_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorOctreeDatasetProxy *pObjectX = (JCVectorOctreeDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_getName_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset*) pObjXXXX;
					EVString __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset::getName();
					EarthView::World::Core::ev_wstring valuesw1 = __values1;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_getAliasName_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset*) pObjXXXX;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_getDataSourceRef_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorOctreeDatasetProxy))
					{
						EarthView::World::Spatial::GeoDataset::IDataSource* __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset::getDataSourceRef();
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_register_1getDataSourceRef_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorOctreeDatasetProxy *pObjectX = (JCVectorOctreeDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_getDataSourceRef_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset*) pObjXXXX;
					EarthView::World::Spatial::GeoDataset::IDataSource* __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset::getDataSourceRef();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_getID_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorOctreeDatasetProxy))
					{
						ev_uint32 __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset::getID();
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_register_1getID_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorOctreeDatasetProxy *pObjectX = (JCVectorOctreeDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_getID_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset*) pObjXXXX;
					ev_uint32 __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset::getID();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_getSRID_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorOctreeDatasetProxy))
					{
						ev_int32 __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset::getSRID();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_register_1getSRID_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorOctreeDatasetProxy *pObjectX = (JCVectorOctreeDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_getSRID_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset*) pObjXXXX;
					ev_int32 __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset::getSRID();
					jint __values1_j = (jint)__values1;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_getGeometryType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorOctreeDatasetProxy))
					{
						EarthView::World::Spatial::Geometry::EVGeometryType __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset::getGeometryType();
						jint __values1_j = (jint) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_register_1getGeometryType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorOctreeDatasetProxy *pObjectX = (JCVectorOctreeDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_getGeometryType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset*) pObjXXXX;
					EarthView::World::Spatial::Geometry::EVGeometryType __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset::getGeometryType();
					jint __values1_j = (jint) __values1;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_getLayerType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset*) pObjXXXX;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_getOctreeNodes_1EVString_1MemoryDataStreamPtr(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring octreeCode_j, jlong octreeNodes_j)
				{
					#if EV_PLATFORM == EV_PLATFORM_ANDROID
					const ev_char* octreeCode_ch = (const ev_char*)__env->GetStringUTFChars(octreeCode_j,JNI_FALSE);
					const EVString octreeCode = octreeCode_ch;
					__env->ReleaseStringUTFChars(octreeCode_j, (const char *)octreeCode_ch);
					#else
					const ev_wchar* octreeCode_ch = (const ev_wchar*)__env->GetStringChars(octreeCode_j,JNI_FALSE);
					const EVString octreeCode = octreeCode_ch;
					__env->ReleaseStringChars(octreeCode_j, (const jchar *)octreeCode_ch);
					#endif
					EarthView::World::Core::MemoryDataStreamPtr &octreeNodes = *(EarthView::World::Core::MemoryDataStreamPtr*) octreeNodes_j;
					EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorOctreeDatasetProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset::getOctreeNodes(octreeCode, octreeNodes);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
					{
						ev_bool __values1 = pObjectX->getOctreeNodes(octreeCode, octreeNodes);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_register_1getOctreeNodes_1EVString_1MemoryDataStreamPtr(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorOctreeDatasetProxy *pObjectX = (JCVectorOctreeDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
					__env->ReleaseStringUTFChars(__method, pMethod);
					pObjectX->register_getOctreeNodes_EVString_MemoryDataStreamPtr_callback(sMethod);
					if (pObjectX->getJavaReference() != NULL && sMethod != "")
					{
						EarthView::World::Core::GlobalReference *__gr = (EarthView::World::Core::GlobalReference *)pObjectX->getJavaReference();
						jobject __obj1 = __gr->getJObject();
						jclass __clazz1 = __env->GetObjectClass(__obj1);
						jmethodID __method = __env->GetMethodID(__clazz1,"getOctreeNodes_EVString_MemoryDataStreamPtr_callback", "(Ljava/lang/String;J)Z");
						__gr->setMethod(sMethod, __method);
					}
				}
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_getOctreeNodes_1EVString_1MemoryDataStreamPtr_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring octreeCode_j, jlong octreeNodes_j)
				{
					#if EV_PLATFORM == EV_PLATFORM_ANDROID
					const ev_char* octreeCode_ch = (const ev_char*)__env->GetStringUTFChars(octreeCode_j,JNI_FALSE);
					const EVString octreeCode = octreeCode_ch;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_getOctreeObjects_1EVString_1MemoryDataStreamPtr(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring octreeCode_j, jlong objectsStream_j)
				{
					#if EV_PLATFORM == EV_PLATFORM_ANDROID
					const ev_char* octreeCode_ch = (const ev_char*)__env->GetStringUTFChars(octreeCode_j,JNI_FALSE);
					const EVString octreeCode = octreeCode_ch;
					...
					__env->ReleaseStringChars(octreeCode_j, (const jchar *)octreeCode_ch);
					#endif
					EarthView::World::Core::MemoryDataStreamPtr &objectsStream = *(EarthView::World::Core::MemoryDataStreamPtr*) objectsStream_j;
					EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorOctreeDatasetProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset::getOctreeObjects(octreeCode, objectsStream);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
					{
						ev_bool __values1 = pObjectX->getOctreeObjects(octreeCode, objectsStream);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_register_1getOctreeObjects_1EVString_1MemoryDataStreamPtr(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorOctreeDatasetProxy *pObjectX = (JCVectorOctreeDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
					__env->ReleaseStringUTFChars(__method, pMethod);
					pObjectX->register_getOctreeObjects_EVString_MemoryDataStreamPtr_callback(sMethod);
					if (pObjectX->getJavaReference() != NULL && sMethod != "")
					{
						EarthView::World::Core::GlobalReference *__gr = (EarthView::World::Core::GlobalReference *)pObjectX->getJavaReference();
						jobject __obj1 = __gr->getJObject();
						jclass __clazz1 = __env->GetObjectClass(__obj1);
						jmethodID __method = __env->GetMethodID(__clazz1,"getOctreeObjects_EVString_MemoryDataStreamPtr_callback", "(Ljava/lang/String;J)Z");
						__gr->setMethod(sMethod, __method);
					}
				}
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_getOctreeObjects_1EVString_1MemoryDataStreamPtr_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring octreeCode_j, jlong objectsStream_j)
				{
					#if EV_PLATFORM == EV_PLATFORM_ANDROID
					const ev_char* octreeCode_ch = (const ev_char*)__env->GetStringUTFChars(octreeCode_j,JNI_FALSE);
					const EVString octreeCode = octreeCode_ch;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_writeOctree_1EVString_1MemoryDataStreamPtr_1MemoryDataStreamPtr(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring octreeCode_j, jlong octreeNodes_j, jlong objectsStream_j)
				{
					#if EV_PLATFORM == EV_PLATFORM_ANDROID
					const ev_char* octreeCode_ch = (const ev_char*)__env->GetStringUTFChars(octreeCode_j,JNI_FALSE);
					const EVString octreeCode = octreeCode_ch;
					...
					__env->ReleaseStringChars(octreeCode_j, (const jchar *)octreeCode_ch);
					#endif
					const EarthView::World::Core::MemoryDataStreamPtr &octreeNodes = *(EarthView::World::Core::MemoryDataStreamPtr*) octreeNodes_j;
					const EarthView::World::Core::MemoryDataStreamPtr &objectsStream = *(EarthView::World::Core::MemoryDataStreamPtr*) objectsStream_j;
					EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorOctreeDatasetProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset::writeOctree(octreeCode, octreeNodes, objectsStream);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
					{
						ev_bool __values1 = pObjectX->writeOctree(octreeCode, octreeNodes, objectsStream);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_register_1writeOctree_1EVString_1MemoryDataStreamPtr_1MemoryDataStreamPtr(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorOctreeDatasetProxy *pObjectX = (JCVectorOctreeDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
					__env->ReleaseStringUTFChars(__method, pMethod);
					pObjectX->register_writeOctree_EVString_MemoryDataStreamPtr_MemoryDataStreamPtr_callback(sMethod);
					if (pObjectX->getJavaReference() != NULL && sMethod != "")
					{
						EarthView::World::Core::GlobalReference *__gr = (EarthView::World::Core::GlobalReference *)pObjectX->getJavaReference();
						jobject __obj1 = __gr->getJObject();
						jclass __clazz1 = __env->GetObjectClass(__obj1);
						jmethodID __method = __env->GetMethodID(__clazz1,"writeOctree_EVString_MemoryDataStreamPtr_MemoryDataStreamPtr_callback", "(Ljava/lang/String;JJ)Z");
						__gr->setMethod(sMethod, __method);
					}
				}
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_writeOctree_1EVString_1MemoryDataStreamPtr_1MemoryDataStreamPtr_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring octreeCode_j, jlong octreeNodes_j, jlong objectsStream_j)
				{
					#if EV_PLATFORM == EV_PLATFORM_ANDROID
					const ev_char* octreeCode_ch = (const ev_char*)__env->GetStringUTFChars(octreeCode_j,JNI_FALSE);
					const EVString octreeCode = octreeCode_ch;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_getLayerInfoStream_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset*) pObjXXXX;
					EarthView::World::Core::MemoryDataStreamPtr __values1 = pObjectX->getLayerInfoStream();
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_getType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorOctreeDatasetProxy))
					{
						EarthView::World::Spatial::GeoDataset::EVDatasetType __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset::getType();
						jint __values1_j = (jint) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_register_1getType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorOctreeDatasetProxy *pObjectX = (JCVectorOctreeDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_getType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset*) pObjXXXX;
					EarthView::World::Spatial::GeoDataset::EVDatasetType __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset::getType();
					jint __values1_j = (jint) __values1;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_clearDataset_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CVectorOctreeDataset*) pObjXXXX;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_register_1getFeatureClassType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorOctreeDatasetProxy *pObjectX = (JCVectorOctreeDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_register_1getFieldsRef_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorOctreeDatasetProxy *pObjectX = (JCVectorOctreeDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_register_1getFieldCount_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorOctreeDatasetProxy *pObjectX = (JCVectorOctreeDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_register_1getFieldRef_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorOctreeDatasetProxy *pObjectX = (JCVectorOctreeDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_register_1findField_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorOctreeDatasetProxy *pObjectX = (JCVectorOctreeDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_register_1getGeometryField_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorOctreeDatasetProxy *pObjectX = (JCVectorOctreeDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_register_1getIDField_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorOctreeDatasetProxy *pObjectX = (JCVectorOctreeDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_register_1getSpatialIndexEnum_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorOctreeDatasetProxy *pObjectX = (JCVectorOctreeDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_register_1getFeature_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorOctreeDatasetProxy *pObjectX = (JCVectorOctreeDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_register_1query_1IQueryFilter(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorOctreeDatasetProxy *pObjectX = (JCVectorOctreeDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_register_1select_1IQueryFilter(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorOctreeDatasetProxy *pObjectX = (JCVectorOctreeDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_register_1getFeatureCount_1IQueryFilter(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorOctreeDatasetProxy *pObjectX = (JCVectorOctreeDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_register_1createSpatialIndex_1EVSpatialIndexEnum(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorOctreeDatasetProxy *pObjectX = (JCVectorOctreeDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_register_1rebulidSpatialIndex_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorOctreeDatasetProxy *pObjectX = (JCVectorOctreeDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_register_1deleteSpatialIndex_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorOctreeDatasetProxy *pObjectX = (JCVectorOctreeDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_register_1addField_1IField(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorOctreeDatasetProxy *pObjectX = (JCVectorOctreeDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_register_1deleteField_1IField(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorOctreeDatasetProxy *pObjectX = (JCVectorOctreeDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_register_1createFeatureBuffer_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorOctreeDatasetProxy *pObjectX = (JCVectorOctreeDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_register_1insert_1IFeature(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorOctreeDatasetProxy *pObjectX = (JCVectorOctreeDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_register_1insertFeatureBuffer_1IFeature(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorOctreeDatasetProxy *pObjectX = (JCVectorOctreeDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_register_1update_1IFeature(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorOctreeDatasetProxy *pObjectX = (JCVectorOctreeDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_register_1deleteFeature_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorOctreeDatasetProxy *pObjectX = (JCVectorOctreeDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_register_1createTableProxy_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorOctreeDatasetProxy *pObjectX = (JCVectorOctreeDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_register_1getDescription_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorOctreeDatasetProxy *pObjectX = (JCVectorOctreeDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_register_1getUpdateTime_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorOctreeDatasetProxy *pObjectX = (JCVectorOctreeDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_register_1hasSubDataset_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorOctreeDatasetProxy *pObjectX = (JCVectorOctreeDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_register_1canEdit_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorOctreeDatasetProxy *pObjectX = (JCVectorOctreeDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_register_1isEditing_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorOctreeDatasetProxy *pObjectX = (JCVectorOctreeDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_register_1startEditing_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorOctreeDatasetProxy *pObjectX = (JCVectorOctreeDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_register_1stopEditing_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorOctreeDatasetProxy *pObjectX = (JCVectorOctreeDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_register_1isBeginEditingOperation_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorOctreeDatasetProxy *pObjectX = (JCVectorOctreeDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_register_1beginEditingOperation_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorOctreeDatasetProxy *pObjectX = (JCVectorOctreeDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_VectorOctreeDataset_register_1endEditingOperation_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorOctreeDatasetProxy *pObjectX = (JCVectorOctreeDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
