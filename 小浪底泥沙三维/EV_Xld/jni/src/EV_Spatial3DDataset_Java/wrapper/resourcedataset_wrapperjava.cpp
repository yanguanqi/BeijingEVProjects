...
namespace EarthView
{
	namespace World
	{
		namespace Spatial3D
		{
			namespace Dataset
			{
				class JCResourceDatasetProxy : public EarthView::World::Spatial3D::Dataset::CResourceDataset
				{
				 private:
					EarthView::World::Core::ev_string m_getAliasName_void_callback;
					EarthView::World::Core::ev_string m_saveEditing_void_callback;
					EarthView::World::Core::ev_string m_getFeature_ev_uint32_ev_uint32_callback;
					EarthView::World::Core::ev_string m_getFeatureVector_ev_uint32_FeatureVector_callback;
					EarthView::World::Core::ev_string m_insert_void_callback;
					EarthView::World::Core::ev_string m_insertFeatureBuffer_IFeature_ev_bool_callback;
					EarthView::World::Core::ev_string m_deleteFeature_ev_uint32_ev_uint32_callback;
				...
				public:
					JCResourceDatasetProxy(EarthView::World::Core::CNameValuePairList *pList) : CResourceDataset(pList)
					{
					}
				...
				public:
					...
					void register_getFeature_ev_uint32_ev_uint32_callback(EarthView::World::Core::ev_string __method)
					{
						this->m_getFeature_ev_uint32_ev_uint32_callback = __method;
					}
					void register_getFeatureVector_ev_uint32_FeatureVector_callback(EarthView::World::Core::ev_string __method)
					{
						this->m_getFeatureVector_ev_uint32_FeatureVector_callback = __method;
					}
					void register_insert_void_callback(EarthView::World::Core::ev_string __method)
					{
						this->m_insert_void_callback = __method;
					}
					void register_insertFeatureBuffer_IFeature_ev_bool_callback(EarthView::World::Core::ev_string __method)
					{
						this->m_insertFeatureBuffer_IFeature_ev_bool_callback = __method;
					}
					void register_deleteFeature_ev_uint32_ev_uint32_callback(EarthView::World::Core::ev_string __method)
					{
						this->m_deleteFeature_ev_uint32_ev_uint32_callback = __method;
					}
					...
					virtual EarthView::World::Spatial::GeoDataset::IFeature* getFeature(ev_uint32 meshID, ev_uint32 resID)
					{
						if (this->_gRef != NULL && this->m_getFeature_ev_uint32_ev_uint32_callback != "" && this->isCustomExtend())
						{
							EarthView::World::Core::GlobalReference *__gr = (EarthView::World::Core::GlobalReference *)this->getJavaReference();
							JNIEnv * __env;
							#if EV_PLATFORM == EV_PLATFORM_ANDROID
							...
							jobject __obj = __gr->getJObject();
							jclass __clazz = __gr->getClass();
							jlong meshID_j = (jlong) meshID;
							jlong resID_j = (jlong) resID;
							jmethodID __method = __gr->getMethod("getFeature_ev_uint32_ev_uint32_callback");
							jlong __values1_j = (jlong)__env->CallLongMethod(__obj, __method , meshID_j, resID_j);
							#if EV_PLATFORM == EV_PLATFORM_ANDROID
							if(__jniAttachable)
							{
								EarthView::World::Core::JNILoad::getCachedJVM()->DetachCurrentThread();
					...
					virtual ev_bool getFeatureVector(ev_uint32 meshID, EarthView::World::Spatial3D::Dataset::FeatureVector& fs)
					{
						if (this->_gRef != NULL && this->m_getFeatureVector_ev_uint32_FeatureVector_callback != "" && this->isCustomExtend())
						{
							EarthView::World::Core::GlobalReference *__gr = (EarthView::World::Core::GlobalReference *)this->getJavaReference();
							JNIEnv * __env;
							#if EV_PLATFORM == EV_PLATFORM_ANDROID
							...
							jlong meshID_j = (jlong) meshID;
							jlong fs_j = (jlong) &fs;
							jmethodID __method = __gr->getMethod("getFeatureVector_ev_uint32_FeatureVector_callback");
							jboolean __values1_j = (jboolean)__env->CallBooleanMethod(__obj, __method , meshID_j, fs_j);
							#if EV_PLATFORM == EV_PLATFORM_ANDROID
							if(__jniAttachable)
							{
								EarthView::World::Core::JNILoad::getCachedJVM()->DetachCurrentThread();
					...
					{
						if (this->_gRef != NULL && this->m_insertFeatureBuffer_IFeature_ev_bool_callback != "" && this->isCustomExtend())
						{
							EarthView::World::Core::GlobalReference *__gr = (EarthView::World::Core::GlobalReference *)this->getJavaReference();
							JNIEnv * __env;
							#if EV_PLATFORM == EV_PLATFORM_ANDROID
							...
							jclass __clazz = __gr->getClass();
							jlong buffer_j = (jlong) buffer;
							jboolean bRefCount_j = (jboolean) bRefCount;
							jmethodID __method = __gr->getMethod("insertFeatureBuffer_IFeature_ev_bool_callback");
							jlong __values1_j = (jlong)__env->CallLongMethod(__obj, __method , buffer_j, bRefCount_j);
							#if EV_PLATFORM == EV_PLATFORM_ANDROID
							if(__jniAttachable)
							{
								EarthView::World::Core::JNILoad::getCachedJVM()->DetachCurrentThread();
					...
					{
						if (this->_gRef != NULL && this->m_deleteFeature_ev_uint32_ev_uint32_callback != "" && this->isCustomExtend())
						{
							EarthView::World::Core::GlobalReference *__gr = (EarthView::World::Core::GlobalReference *)this->getJavaReference();
							JNIEnv * __env;
							#if EV_PLATFORM == EV_PLATFORM_ANDROID
							...
							jlong meshID_j = (jlong) meshID;
							jlong resID_j = (jlong) resID;
							jmethodID __method = __gr->getMethod("deleteFeature_ev_uint32_ev_uint32_callback");
							jboolean __values1_j = (jboolean)__env->CallBooleanMethod(__obj, __method , meshID_j, resID_j);
							#if EV_PLATFORM == EV_PLATFORM_ANDROID
							if(__jniAttachable)
							{
								EarthView::World::Core::JNILoad::getCachedJVM()->DetachCurrentThread();
					...
					virtual ev_bool deleteFeature(ev_uint32 meshID)
					{
						if (this->_gRef != NULL && this->m_deleteFeature_ev_uint32_callback != "" && this->isCustomExtend())
						{
							...
							jboolean __values1_j = (jboolean)__env->CallBooleanMethod(__obj, __method , meshID_j);
							#if EV_PLATFORM == EV_PLATFORM_ANDROID
							if(__jniAttachable)
							{
								EarthView::World::Core::JNILoad::getCachedJVM()->DetachCurrentThread();
				...
				REGISTER_FACTORY_CLASS(JCResourceDatasetProxy);
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_get_1mIsTempl_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::Dataset::CResourceDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CResourceDataset*)pObjXXXX;
					jboolean __values1_j = (jboolean)(pObjectX->mIsTempl);
					return __values1_j;
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_set_1mIsTempl_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jboolean __values1_j)
				{
					EarthView::World::Spatial3D::Dataset::CResourceDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CResourceDataset*)pObjXXXX;
					pObjectX->mIsTempl = (ev_bool)__values1_j;
				}
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_getName_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Dataset::CResourceDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CResourceDataset*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCResourceDatasetProxy))
					{
						EVString __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CResourceDataset::getName();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_register_1getName_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCResourceDatasetProxy *pObjectX = (JCResourceDatasetProxy*) pObjXXXX;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_getName_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Dataset::CResourceDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CResourceDataset*) pObjXXXX;
					EVString __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CResourceDataset::getName();
					EarthView::World::Core::ev_wstring valuesw1 = __values1;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_getAliasName_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Dataset::CResourceDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CResourceDataset*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCResourceDatasetProxy))
					{
						EVString __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CResourceDataset::getAliasName();
						EarthView::World::Core::ev_wstring valuesw1 = __values1;
						jstring __values1_j = __env->NewString((const jchar*)valuesw1.getString(), valuesw1.size());
						return __values1_j;
					}
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_register_1getAliasName_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCResourceDatasetProxy *pObjectX = (JCResourceDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_getAliasName_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Dataset::CResourceDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CResourceDataset*) pObjXXXX;
					EVString __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CResourceDataset::getAliasName();
					EarthView::World::Core::ev_wstring valuesw1 = __values1;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_canEdit_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Dataset::CResourceDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CResourceDataset*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCResourceDatasetProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CResourceDataset::canEdit();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_register_1canEdit_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCResourceDatasetProxy *pObjectX = (JCResourceDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_canEdit_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Dataset::CResourceDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CResourceDataset*) pObjXXXX;
					ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CResourceDataset::canEdit();
					jboolean __values1_j = (jboolean)__values1;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_isEditing_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Dataset::CResourceDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CResourceDataset*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCResourceDatasetProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CResourceDataset::isEditing();
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_register_1isEditing_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCResourceDatasetProxy *pObjectX = (JCResourceDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_isEditing_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Dataset::CResourceDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CResourceDataset*) pObjXXXX;
					ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CResourceDataset::isEditing();
					jboolean __values1_j = (jboolean)__values1;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_startEditing_1ev_1bool(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean withUndo_j)
				{
					ev_bool withUndo = (ev_bool) withUndo_j;
					EarthView::World::Spatial3D::Dataset::CResourceDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CResourceDataset*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCResourceDatasetProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CResourceDataset::startEditing(withUndo);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_register_1startEditing_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCResourceDatasetProxy *pObjectX = (JCResourceDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_startEditing_1ev_1bool_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean withUndo_j)
				{
					ev_bool withUndo = (ev_bool) withUndo_j;
					EarthView::World::Spatial3D::Dataset::CResourceDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CResourceDataset*) pObjXXXX;
					ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CResourceDataset::startEditing(withUndo);
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_saveEditing_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::Dataset::CResourceDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CResourceDataset*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCResourceDatasetProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CResourceDataset::saveEditing();
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_register_1saveEditing_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCResourceDatasetProxy *pObjectX = (JCResourceDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_saveEditing_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::Dataset::CResourceDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CResourceDataset*) pObjXXXX;
					ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CResourceDataset::saveEditing();
					jboolean __values1_j = (jboolean)__values1;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_stopEditing_1ev_1bool(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean isSave_j)
				{
					ev_bool isSave = (ev_bool) isSave_j;
					EarthView::World::Spatial3D::Dataset::CResourceDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CResourceDataset*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCResourceDatasetProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CResourceDataset::stopEditing(isSave);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_register_1stopEditing_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCResourceDatasetProxy *pObjectX = (JCResourceDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_stopEditing_1ev_1bool_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean isSave_j)
				{
					ev_bool isSave = (ev_bool) isSave_j;
					EarthView::World::Spatial3D::Dataset::CResourceDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CResourceDataset*) pObjXXXX;
					ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CResourceDataset::stopEditing(isSave);
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_getGeometryField_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Dataset::CResourceDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CResourceDataset*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCResourceDatasetProxy))
					{
						const EarthView::World::Spatial::GeoDataset::IField* __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CResourceDataset::getGeometryField();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_register_1getGeometryField_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCResourceDatasetProxy *pObjectX = (JCResourceDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_getGeometryField_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Dataset::CResourceDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CResourceDataset*) pObjXXXX;
					const EarthView::World::Spatial::GeoDataset::IField* __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CResourceDataset::getGeometryField();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_getIDField_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Dataset::CResourceDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CResourceDataset*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCResourceDatasetProxy))
					{
						const EarthView::World::Spatial::GeoDataset::IField* __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CResourceDataset::getIDField();
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_register_1getIDField_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCResourceDatasetProxy *pObjectX = (JCResourceDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_getIDField_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Dataset::CResourceDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CResourceDataset*) pObjXXXX;
					const EarthView::World::Spatial::GeoDataset::IField* __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CResourceDataset::getIDField();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_getFieldsRef_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Dataset::CResourceDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CResourceDataset*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCResourceDatasetProxy))
					{
						const EarthView::World::Spatial::GeoDataset::IFields* __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CResourceDataset::getFieldsRef();
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_register_1getFieldsRef_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCResourceDatasetProxy *pObjectX = (JCResourceDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_getFieldsRef_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Dataset::CResourceDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CResourceDataset*) pObjXXXX;
					const EarthView::World::Spatial::GeoDataset::IFields* __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CResourceDataset::getFieldsRef();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_getFieldCount_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Dataset::CResourceDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CResourceDataset*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCResourceDatasetProxy))
					{
						ev_uint32 __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CResourceDataset::getFieldCount();
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_register_1getFieldCount_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCResourceDatasetProxy *pObjectX = (JCResourceDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_getFieldCount_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Dataset::CResourceDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CResourceDataset*) pObjXXXX;
					ev_uint32 __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CResourceDataset::getFieldCount();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_getFieldRef_1ev_1uint32(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong index_j)
				{
					ev_uint32 index = (ev_uint32) index_j;
					const 					EarthView::World::Spatial3D::Dataset::CResourceDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CResourceDataset*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCResourceDatasetProxy))
					{
						const EarthView::World::Spatial::GeoDataset::IField* __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CResourceDataset::getFieldRef(index);
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_register_1getFieldRef_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCResourceDatasetProxy *pObjectX = (JCResourceDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_getFieldRef_1ev_1uint32_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong index_j)
				{
					ev_uint32 index = (ev_uint32) index_j;
					const 					EarthView::World::Spatial3D::Dataset::CResourceDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CResourceDataset*) pObjXXXX;
					const EarthView::World::Spatial::GeoDataset::IField* __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CResourceDataset::getFieldRef(index);
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_findField_1EVString(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring fieldName_j)
				{
					#if EV_PLATFORM == EV_PLATFORM_ANDROID
					...
					if (typeid(*pObjectX) == typeid(JCResourceDatasetProxy))
					{
						ev_int32 __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CResourceDataset::findField(fieldName);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_register_1findField_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCResourceDatasetProxy *pObjectX = (JCResourceDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_findField_1EVString_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring fieldName_j)
				{
					#if EV_PLATFORM == EV_PLATFORM_ANDROID
					const ev_char* fieldName_ch = (const ev_char*)__env->GetStringUTFChars(fieldName_j,JNI_FALSE);
					const EVString fieldName = fieldName_ch;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_getFeature_1ev_1uint32_1ev_1uint32(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong meshID_j, jlong resID_j)
				{
					...
					if (typeid(*pObjectX) == typeid(JCResourceDatasetProxy))
					{
						EarthView::World::Spatial::GeoDataset::IFeature* __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CResourceDataset::getFeature(meshID, resID);
					...
					{
						EarthView::World::Spatial::GeoDataset::IFeature* __values1 = pObjectX->getFeature(meshID, resID);
						if(__values1 != NULL) {							((EarthView::World::Core::CBaseObject*)__values1)->setExternFree(true);
						}						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_register_1getFeature_1ev_1uint32_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCResourceDatasetProxy *pObjectX = (JCResourceDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
					__env->ReleaseStringUTFChars(__method, pMethod);
					pObjectX->register_getFeature_ev_uint32_ev_uint32_callback(sMethod);
					if (pObjectX->getJavaReference() != NULL && sMethod != "")
					{
						EarthView::World::Core::GlobalReference *__gr = (EarthView::World::Core::GlobalReference *)pObjectX->getJavaReference();
						jobject __obj1 = __gr->getJObject();
						jclass __clazz1 = __env->GetObjectClass(__obj1);
						jmethodID __method = __env->GetMethodID(__clazz1,"getFeature_ev_uint32_ev_uint32_callback", "(JJ)J");
						__gr->setMethod(sMethod, __method);
					}
				}
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_getFeature_1ev_1uint32_1ev_1uint32_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong meshID_j, jlong resID_j)
				{
					ev_uint32 meshID = (ev_uint32) meshID_j;
					ev_uint32 resID = (ev_uint32) resID_j;
					EarthView::World::Spatial3D::Dataset::CResourceDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CResourceDataset*) pObjXXXX;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_getFeatureVector_1ev_1uint32_1FeatureVector(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong meshID_j, jlong fs_j)
				{
					ev_uint32 meshID = (ev_uint32) meshID_j;
					EarthView::World::Spatial3D::Dataset::FeatureVector &fs = *(EarthView::World::Spatial3D::Dataset::FeatureVector*) fs_j;
					EarthView::World::Spatial3D::Dataset::CResourceDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CResourceDataset*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCResourceDatasetProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CResourceDataset::getFeatureVector(meshID, fs);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
					{
						ev_bool __values1 = pObjectX->getFeatureVector(meshID, fs);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_register_1getFeatureVector_1ev_1uint32_1FeatureVector(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCResourceDatasetProxy *pObjectX = (JCResourceDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
					__env->ReleaseStringUTFChars(__method, pMethod);
					pObjectX->register_getFeatureVector_ev_uint32_FeatureVector_callback(sMethod);
					if (pObjectX->getJavaReference() != NULL && sMethod != "")
					{
						EarthView::World::Core::GlobalReference *__gr = (EarthView::World::Core::GlobalReference *)pObjectX->getJavaReference();
						jobject __obj1 = __gr->getJObject();
						jclass __clazz1 = __env->GetObjectClass(__obj1);
						jmethodID __method = __env->GetMethodID(__clazz1,"getFeatureVector_ev_uint32_FeatureVector_callback", "(JJ)Z");
						__gr->setMethod(sMethod, __method);
					}
				}
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_getFeatureVector_1ev_1uint32_1FeatureVector_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong meshID_j, jlong fs_j)
				{
					ev_uint32 meshID = (ev_uint32) meshID_j;
					EarthView::World::Spatial3D::Dataset::FeatureVector &fs = *(EarthView::World::Spatial3D::Dataset::FeatureVector*) fs_j;
					EarthView::World::Spatial3D::Dataset::CResourceDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CResourceDataset*) pObjXXXX;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_query_1IQueryFilter(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong filter_j)
				{
					EarthView::World::Spatial::GeoDataset::IQueryFilter *filter = (EarthView::World::Spatial::GeoDataset::IQueryFilter*) filter_j;
					EarthView::World::Spatial3D::Dataset::CResourceDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CResourceDataset*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCResourceDatasetProxy))
					{
						EarthView::World::Spatial::GeoDataset::IFeatureIterator* __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CResourceDataset::query(filter);
						if(__values1 != NULL) {							((EarthView::World::Core::CBaseObject*)__values1)->setExternFree(true);
						}						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_register_1query_1IQueryFilter(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCResourceDatasetProxy *pObjectX = (JCResourceDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_query_1IQueryFilter_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong filter_j)
				{
					EarthView::World::Spatial::GeoDataset::IQueryFilter *filter = (EarthView::World::Spatial::GeoDataset::IQueryFilter*) filter_j;
					EarthView::World::Spatial3D::Dataset::CResourceDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CResourceDataset*) pObjXXXX;
					EarthView::World::Spatial::GeoDataset::IFeatureIterator* __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CResourceDataset::query(filter);
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_select_1IQueryFilter(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong filter_j)
				{
					EarthView::World::Spatial::GeoDataset::IQueryFilter *filter = (EarthView::World::Spatial::GeoDataset::IQueryFilter*) filter_j;
					EarthView::World::Spatial3D::Dataset::CResourceDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CResourceDataset*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCResourceDatasetProxy))
					{
						EarthView::World::Spatial::GeoDataset::IFeatureSelection* __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CResourceDataset::select(filter);
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_register_1select_1IQueryFilter(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCResourceDatasetProxy *pObjectX = (JCResourceDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_select_1IQueryFilter_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong filter_j)
				{
					EarthView::World::Spatial::GeoDataset::IQueryFilter *filter = (EarthView::World::Spatial::GeoDataset::IQueryFilter*) filter_j;
					EarthView::World::Spatial3D::Dataset::CResourceDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CResourceDataset*) pObjXXXX;
					EarthView::World::Spatial::GeoDataset::IFeatureSelection* __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CResourceDataset::select(filter);
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_getFeatureCount_1IQueryFilter(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong filter_j)
				{
					EarthView::World::Spatial::GeoDataset::IQueryFilter *filter = (EarthView::World::Spatial::GeoDataset::IQueryFilter*) filter_j;
					EarthView::World::Spatial3D::Dataset::CResourceDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CResourceDataset*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCResourceDatasetProxy))
					{
						ev_uint32 __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CResourceDataset::getFeatureCount(filter);
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_register_1getFeatureCount_1IQueryFilter(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCResourceDatasetProxy *pObjectX = (JCResourceDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_getFeatureCount_1IQueryFilter_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong filter_j)
				{
					EarthView::World::Spatial::GeoDataset::IQueryFilter *filter = (EarthView::World::Spatial::GeoDataset::IQueryFilter*) filter_j;
					EarthView::World::Spatial3D::Dataset::CResourceDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CResourceDataset*) pObjXXXX;
					ev_uint32 __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CResourceDataset::getFeatureCount(filter);
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_createFeatureBuffer_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::Dataset::CResourceDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CResourceDataset*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCResourceDatasetProxy))
					{
						EarthView::World::Spatial::GeoDataset::IFeature* __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CResourceDataset::createFeatureBuffer();
						if(__values1 != NULL) {							((EarthView::World::Core::CBaseObject*)__values1)->setExternFree(true);
						}						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_register_1createFeatureBuffer_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCResourceDatasetProxy *pObjectX = (JCResourceDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_createFeatureBuffer_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::Dataset::CResourceDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CResourceDataset*) pObjXXXX;
					EarthView::World::Spatial::GeoDataset::IFeature* __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CResourceDataset::createFeatureBuffer();
					if(__values1 != NULL) {						((EarthView::World::Core::CBaseObject*)__values1)->setExternFree(true);
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_insert_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::Dataset::CResourceDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CResourceDataset*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCResourceDatasetProxy))
					{
						EarthView::World::Spatial::GeoDataset::IFeature* __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CResourceDataset::insert();
						if(__values1 != NULL) {							((EarthView::World::Core::CBaseObject*)__values1)->setExternFree(true);
						}						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_register_1insert_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCResourceDatasetProxy *pObjectX = (JCResourceDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_insert_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::Dataset::CResourceDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CResourceDataset*) pObjXXXX;
					EarthView::World::Spatial::GeoDataset::IFeature* __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CResourceDataset::insert();
					if(__values1 != NULL) {						((EarthView::World::Core::CBaseObject*)__values1)->setExternFree(true);
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_insertFeatureBuffer_1IFeature(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong buffer_j)
				{
					const EarthView::World::Spatial::GeoDataset::IFeature *buffer = (const EarthView::World::Spatial::GeoDataset::IFeature*) buffer_j;
					EarthView::World::Spatial3D::Dataset::CResourceDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CResourceDataset*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCResourceDatasetProxy))
					{
						ev_uint32 __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CResourceDataset::insertFeatureBuffer(buffer);
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_register_1insertFeatureBuffer_1IFeature(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCResourceDatasetProxy *pObjectX = (JCResourceDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_insertFeatureBuffer_1IFeature_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong buffer_j)
				{
					const EarthView::World::Spatial::GeoDataset::IFeature *buffer = (const EarthView::World::Spatial::GeoDataset::IFeature*) buffer_j;
					EarthView::World::Spatial3D::Dataset::CResourceDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CResourceDataset*) pObjXXXX;
					ev_uint32 __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CResourceDataset::insertFeatureBuffer(buffer);
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_insertFeatureBuffer_1IFeature_1ev_1bool(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong buffer_j, jboolean bRefCount_j)
				{
					const EarthView::World::Spatial::GeoDataset::IFeature *buffer = (const EarthView::World::Spatial::GeoDataset::IFeature*) buffer_j;
					ev_bool bRefCount = (ev_bool) bRefCount_j;
					EarthView::World::Spatial3D::Dataset::CResourceDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CResourceDataset*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCResourceDatasetProxy))
					{
						ev_uint32 __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CResourceDataset::insertFeatureBuffer(buffer, bRefCount);
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
					{
						ev_uint32 __values1 = pObjectX->insertFeatureBuffer(buffer, bRefCount);
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_register_1insertFeatureBuffer_1IFeature_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCResourceDatasetProxy *pObjectX = (JCResourceDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
					__env->ReleaseStringUTFChars(__method, pMethod);
					pObjectX->register_insertFeatureBuffer_IFeature_ev_bool_callback(sMethod);
					if (pObjectX->getJavaReference() != NULL && sMethod != "")
					{
						EarthView::World::Core::GlobalReference *__gr = (EarthView::World::Core::GlobalReference *)pObjectX->getJavaReference();
						jobject __obj1 = __gr->getJObject();
						jclass __clazz1 = __env->GetObjectClass(__obj1);
						jmethodID __method = __env->GetMethodID(__clazz1,"insertFeatureBuffer_IFeature_ev_bool_callback", "(JZ)J");
						__gr->setMethod(sMethod, __method);
					}
				}
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_insertFeatureBuffer_1IFeature_1ev_1bool_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong buffer_j, jboolean bRefCount_j)
				{
					const EarthView::World::Spatial::GeoDataset::IFeature *buffer = (const EarthView::World::Spatial::GeoDataset::IFeature*) buffer_j;
					ev_bool bRefCount = (ev_bool) bRefCount_j;
					EarthView::World::Spatial3D::Dataset::CResourceDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CResourceDataset*) pObjXXXX;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_update_1IFeature(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong buffer_j)
				{
					const EarthView::World::Spatial::GeoDataset::IFeature *buffer = (const EarthView::World::Spatial::GeoDataset::IFeature*) buffer_j;
					EarthView::World::Spatial3D::Dataset::CResourceDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CResourceDataset*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCResourceDatasetProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CResourceDataset::update(buffer);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_register_1update_1IFeature(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCResourceDatasetProxy *pObjectX = (JCResourceDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_update_1IFeature_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong buffer_j)
				{
					const EarthView::World::Spatial::GeoDataset::IFeature *buffer = (const EarthView::World::Spatial::GeoDataset::IFeature*) buffer_j;
					EarthView::World::Spatial3D::Dataset::CResourceDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CResourceDataset*) pObjXXXX;
					ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CResourceDataset::update(buffer);
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_deleteFeature_1ev_1uint32_1ev_1uint32(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong meshID_j, jlong resID_j)
				{
					ev_uint32 meshID = (ev_uint32) meshID_j;
					ev_uint32 resID = (ev_uint32) resID_j;
					EarthView::World::Spatial3D::Dataset::CResourceDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CResourceDataset*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCResourceDatasetProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CResourceDataset::deleteFeature(meshID, resID);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
					{
						ev_bool __values1 = pObjectX->deleteFeature(meshID, resID);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_register_1deleteFeature_1ev_1uint32_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCResourceDatasetProxy *pObjectX = (JCResourceDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
					__env->ReleaseStringUTFChars(__method, pMethod);
					pObjectX->register_deleteFeature_ev_uint32_ev_uint32_callback(sMethod);
					if (pObjectX->getJavaReference() != NULL && sMethod != "")
					{
						EarthView::World::Core::GlobalReference *__gr = (EarthView::World::Core::GlobalReference *)pObjectX->getJavaReference();
						jobject __obj1 = __gr->getJObject();
						jclass __clazz1 = __env->GetObjectClass(__obj1);
						jmethodID __method = __env->GetMethodID(__clazz1,"deleteFeature_ev_uint32_ev_uint32_callback", "(JJ)Z");
						__gr->setMethod(sMethod, __method);
					}
				}
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_deleteFeature_1ev_1uint32_1ev_1uint32_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong meshID_j, jlong resID_j)
				{
					ev_uint32 meshID = (ev_uint32) meshID_j;
					ev_uint32 resID = (ev_uint32) resID_j;
					EarthView::World::Spatial3D::Dataset::CResourceDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CResourceDataset*) pObjXXXX;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_deleteFeature_1ev_1uint32(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong meshID_j)
				{
					ev_uint32 meshID = (ev_uint32) meshID_j;
					EarthView::World::Spatial3D::Dataset::CResourceDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CResourceDataset*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCResourceDatasetProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CResourceDataset::deleteFeature(meshID);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
					{
						ev_bool __values1 = pObjectX->deleteFeature(meshID);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_register_1deleteFeature_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCResourceDatasetProxy *pObjectX = (JCResourceDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_deleteFeature_1ev_1uint32_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong meshID_j)
				{
					ev_uint32 meshID = (ev_uint32) meshID_j;
					EarthView::World::Spatial3D::Dataset::CResourceDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CResourceDataset*) pObjXXXX;
					ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CResourceDataset::deleteFeature(meshID);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_releaseFeature_1IFeature(JNIEnv *__env , jclass __clazz, jlong feature_j)
				{
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_getDataSourceRef_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Dataset::CResourceDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CResourceDataset*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCResourceDatasetProxy))
					{
						EarthView::World::Spatial::GeoDataset::IDataSource* __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CResourceDataset::getDataSourceRef();
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_register_1getDataSourceRef_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCResourceDatasetProxy *pObjectX = (JCResourceDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_getDataSourceRef_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Dataset::CResourceDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CResourceDataset*) pObjXXXX;
					EarthView::World::Spatial::GeoDataset::IDataSource* __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CResourceDataset::getDataSourceRef();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_register_1getFeatureClassType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCResourceDatasetProxy *pObjectX = (JCResourceDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_register_1getGeometryType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCResourceDatasetProxy *pObjectX = (JCResourceDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_register_1getSpatialIndexEnum_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCResourceDatasetProxy *pObjectX = (JCResourceDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_register_1getFeature_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCResourceDatasetProxy *pObjectX = (JCResourceDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_register_1createSpatialIndex_1EVSpatialIndexEnum(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCResourceDatasetProxy *pObjectX = (JCResourceDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_register_1rebulidSpatialIndex_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCResourceDatasetProxy *pObjectX = (JCResourceDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_register_1deleteSpatialIndex_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCResourceDatasetProxy *pObjectX = (JCResourceDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_register_1addField_1IField(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCResourceDatasetProxy *pObjectX = (JCResourceDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_register_1deleteField_1IField(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCResourceDatasetProxy *pObjectX = (JCResourceDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_register_1insert_1IFeature(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCResourceDatasetProxy *pObjectX = (JCResourceDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_register_1getEnvelopeRef_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCResourceDatasetProxy *pObjectX = (JCResourceDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_register_1getSpatialReferenceRef_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCResourceDatasetProxy *pObjectX = (JCResourceDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_register_1createTableProxy_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCResourceDatasetProxy *pObjectX = (JCResourceDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_register_1getType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCResourceDatasetProxy *pObjectX = (JCResourceDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_register_1getDataVersion_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCResourceDatasetProxy *pObjectX = (JCResourceDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_register_1getDescription_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCResourceDatasetProxy *pObjectX = (JCResourceDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_register_1getUpdateTime_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCResourceDatasetProxy *pObjectX = (JCResourceDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_register_1hasSubDataset_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCResourceDatasetProxy *pObjectX = (JCResourceDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_register_1isBeginEditingOperation_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCResourceDatasetProxy *pObjectX = (JCResourceDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_register_1beginEditingOperation_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCResourceDatasetProxy *pObjectX = (JCResourceDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_ResourceDataset_register_1endEditingOperation_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCResourceDatasetProxy *pObjectX = (JCResourceDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
