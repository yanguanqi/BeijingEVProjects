...
namespace EarthView
{
	namespace World
	{
		namespace Spatial3D
		{
			namespace Dataset
			{
				class JCMeshTemplateDatasetProxy : public EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset
				{
				 private:
					EarthView::World::Core::ev_string m_createFeatureBuffer_EVString_callback;
					...
					EarthView::World::Core::ev_string m_getAttrRef_ev_uint32_EVString_ev_uint32_callback;
					EarthView::World::Core::ev_string m_getAttr_EVString_ev_uint32_CPropertySet_callback;
				...
				public:
					JCMeshTemplateDatasetProxy(EarthView::World::Core::CNameValuePairList *pList) : CMeshTemplateDataset(pList)
					{
					}
				...
				public:
					void register_createFeatureBuffer_EVString_callback(EarthView::World::Core::ev_string __method)
					{
						this->m_createFeatureBuffer_EVString_callback = __method;
					}
					...
					void register_getAttrRef_ev_uint32_EVString_ev_uint32_callback(EarthView::World::Core::ev_string __method)
					{
						this->m_getAttrRef_ev_uint32_EVString_ev_uint32_callback = __method;
					}
					void register_getAttr_EVString_ev_uint32_CPropertySet_callback(EarthView::World::Core::ev_string __method)
					{
						this->m_getAttr_EVString_ev_uint32_CPropertySet_callback = __method;
					}
					...
					virtual EarthView::World::Spatial::GeoDataset::IFeature* createFeatureBuffer(const EVString& typeName)
					{
						if (this->_gRef != NULL && this->m_createFeatureBuffer_EVString_callback != "" && this->isCustomExtend())
						{
							EarthView::World::Core::GlobalReference *__gr = (EarthView::World::Core::GlobalReference *)this->getJavaReference();
							JNIEnv * __env;
							#if EV_PLATFORM == EV_PLATFORM_ANDROID
							...
							jmethodID __method = __gr->getMethod("createFeatureBuffer_EVString_callback");
					...
					virtual ev_bool getAttrRef(ev_uint32 meshTmplID, EVString& attrType, ev_uint32& attrID)
					{
						if (this->_gRef != NULL && this->m_getAttrRef_ev_uint32_EVString_ev_uint32_callback != "" && this->isCustomExtend())
						{
							EarthView::World::Core::GlobalReference *__gr = (EarthView::World::Core::GlobalReference *)this->getJavaReference();
							JNIEnv * __env;
							#if EV_PLATFORM == EV_PLATFORM_ANDROID
							...
							jobject __obj = __gr->getJObject();
							jclass __clazz = __gr->getClass();
							jlong meshTmplID_j = (jlong) meshTmplID;
							jlong attrType_j = (jlong) &attrType;
							jlong attrID_j = (jlong) &attrID;
							jmethodID __method = __gr->getMethod("getAttrRef_ev_uint32_EVString_ev_uint32_callback");
							jboolean __values1_j = (jboolean)__env->CallBooleanMethod(__obj, __method , meshTmplID_j, attrType_j, attrID_j);
							#if EV_PLATFORM == EV_PLATFORM_ANDROID
							if(__jniAttachable)
							{
								EarthView::World::Core::JNILoad::getCachedJVM()->DetachCurrentThread();
					...
					virtual ev_bool getAttr(const EVString& attrType, ev_uint32 attrID, EarthView::World::Spatial::GeoDataset::CPropertySet* ps)
					{
						if (this->_gRef != NULL && this->m_getAttr_EVString_ev_uint32_CPropertySet_callback != "" && this->isCustomExtend())
						{
							EarthView::World::Core::GlobalReference *__gr = (EarthView::World::Core::GlobalReference *)this->getJavaReference();
							JNIEnv * __env;
							#if EV_PLATFORM == EV_PLATFORM_ANDROID
							...
							jobject __obj = __gr->getJObject();
							jclass __clazz = __gr->getClass();
							EarthView::World::Core::ev_wstring attrType_wch = attrType;
							jstring attrType_j = __env->NewString((const jchar*)attrType_wch.getString(), attrType_wch.size());
							jlong attrID_j = (jlong) attrID;
							jlong ps_j = (jlong) ps;
							jmethodID __method = __gr->getMethod("getAttr_EVString_ev_uint32_CPropertySet_callback");
							jboolean __values1_j = (jboolean)__env->CallBooleanMethod(__obj, __method , attrType_j, attrID_j, ps_j);
							#if EV_PLATFORM == EV_PLATFORM_ANDROID
							if(__jniAttachable)
							{
								EarthView::World::Core::JNILoad::getCachedJVM()->DetachCurrentThread();
				...
				REGISTER_FACTORY_CLASS(JCMeshTemplateDatasetProxy);
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_getType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCMeshTemplateDatasetProxy))
					{
						EarthView::World::Spatial::GeoDataset::EVDatasetType __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset::getType();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_register_1getType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMeshTemplateDatasetProxy *pObjectX = (JCMeshTemplateDatasetProxy*) pObjXXXX;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_getType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset*) pObjXXXX;
					EarthView::World::Spatial::GeoDataset::EVDatasetType __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset::getType();
					jint __values1_j = (jint) __values1;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_getName_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCMeshTemplateDatasetProxy))
					{
						EVString __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset::getName();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_register_1getName_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMeshTemplateDatasetProxy *pObjectX = (JCMeshTemplateDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_getName_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset*) pObjXXXX;
					EVString __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset::getName();
					EarthView::World::Core::ev_wstring valuesw1 = __values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_getGeometryField_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCMeshTemplateDatasetProxy))
					{
						const EarthView::World::Spatial::GeoDataset::IField* __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset::getGeometryField();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_register_1getGeometryField_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMeshTemplateDatasetProxy *pObjectX = (JCMeshTemplateDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_getGeometryField_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset*) pObjXXXX;
					const EarthView::World::Spatial::GeoDataset::IField* __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset::getGeometryField();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_getIDField_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCMeshTemplateDatasetProxy))
					{
						const EarthView::World::Spatial::GeoDataset::IField* __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset::getIDField();
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_register_1getIDField_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMeshTemplateDatasetProxy *pObjectX = (JCMeshTemplateDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_getIDField_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset*) pObjXXXX;
					const EarthView::World::Spatial::GeoDataset::IField* __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset::getIDField();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_getFieldsRef_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCMeshTemplateDatasetProxy))
					{
						const EarthView::World::Spatial::GeoDataset::IFields* __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset::getFieldsRef();
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_register_1getFieldsRef_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMeshTemplateDatasetProxy *pObjectX = (JCMeshTemplateDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_getFieldsRef_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset*) pObjXXXX;
					const EarthView::World::Spatial::GeoDataset::IFields* __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset::getFieldsRef();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_getFieldCount_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCMeshTemplateDatasetProxy))
					{
						ev_uint32 __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset::getFieldCount();
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_register_1getFieldCount_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMeshTemplateDatasetProxy *pObjectX = (JCMeshTemplateDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_getFieldCount_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset*) pObjXXXX;
					ev_uint32 __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset::getFieldCount();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_getFieldRef_1ev_1uint32(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong index_j)
				{
					ev_uint32 index = (ev_uint32) index_j;
					const 					EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCMeshTemplateDatasetProxy))
					{
						const EarthView::World::Spatial::GeoDataset::IField* __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset::getFieldRef(index);
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_register_1getFieldRef_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMeshTemplateDatasetProxy *pObjectX = (JCMeshTemplateDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_getFieldRef_1ev_1uint32_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong index_j)
				{
					ev_uint32 index = (ev_uint32) index_j;
					const 					EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset*) pObjXXXX;
					const EarthView::World::Spatial::GeoDataset::IField* __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset::getFieldRef(index);
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_findField_1EVString(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring fieldName_j)
				{
					#if EV_PLATFORM == EV_PLATFORM_ANDROID
					...
					if (typeid(*pObjectX) == typeid(JCMeshTemplateDatasetProxy))
					{
						ev_int32 __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset::findField(fieldName);
						jint __values1_j = (jint)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_register_1findField_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMeshTemplateDatasetProxy *pObjectX = (JCMeshTemplateDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_findField_1EVString_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring fieldName_j)
				{
					#if EV_PLATFORM == EV_PLATFORM_ANDROID
					const ev_char* fieldName_ch = (const ev_char*)__env->GetStringUTFChars(fieldName_j,JNI_FALSE);
					const EVString fieldName = fieldName_ch;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_getFeature_1ev_1uint32(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong id_j)
				{
					ev_uint32 id = (ev_uint32) id_j;
					EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCMeshTemplateDatasetProxy))
					{
						EarthView::World::Spatial::GeoDataset::IFeature* __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset::getFeature(id);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_register_1getFeature_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMeshTemplateDatasetProxy *pObjectX = (JCMeshTemplateDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_getFeature_1ev_1uint32_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong id_j)
				{
					ev_uint32 id = (ev_uint32) id_j;
					EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset*) pObjXXXX;
					EarthView::World::Spatial::GeoDataset::IFeature* __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset::getFeature(id);
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_query_1IQueryFilter(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong filter_j)
				{
					EarthView::World::Spatial::GeoDataset::IQueryFilter *filter = (EarthView::World::Spatial::GeoDataset::IQueryFilter*) filter_j;
					EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCMeshTemplateDatasetProxy))
					{
						EarthView::World::Spatial::GeoDataset::IFeatureIterator* __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset::query(filter);
						if(__values1 != NULL) {							((EarthView::World::Core::CBaseObject*)__values1)->setExternFree(true);
						}						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_register_1query_1IQueryFilter(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMeshTemplateDatasetProxy *pObjectX = (JCMeshTemplateDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_query_1IQueryFilter_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong filter_j)
				{
					EarthView::World::Spatial::GeoDataset::IQueryFilter *filter = (EarthView::World::Spatial::GeoDataset::IQueryFilter*) filter_j;
					EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset*) pObjXXXX;
					EarthView::World::Spatial::GeoDataset::IFeatureIterator* __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset::query(filter);
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_select_1IQueryFilter(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong filter_j)
				{
					EarthView::World::Spatial::GeoDataset::IQueryFilter *filter = (EarthView::World::Spatial::GeoDataset::IQueryFilter*) filter_j;
					EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCMeshTemplateDatasetProxy))
					{
						EarthView::World::Spatial::GeoDataset::IFeatureSelection* __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset::select(filter);
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_register_1select_1IQueryFilter(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMeshTemplateDatasetProxy *pObjectX = (JCMeshTemplateDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_select_1IQueryFilter_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong filter_j)
				{
					EarthView::World::Spatial::GeoDataset::IQueryFilter *filter = (EarthView::World::Spatial::GeoDataset::IQueryFilter*) filter_j;
					EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset*) pObjXXXX;
					EarthView::World::Spatial::GeoDataset::IFeatureSelection* __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset::select(filter);
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_getFeatureCount_1IQueryFilter(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong filter_j)
				{
					EarthView::World::Spatial::GeoDataset::IQueryFilter *filter = (EarthView::World::Spatial::GeoDataset::IQueryFilter*) filter_j;
					EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCMeshTemplateDatasetProxy))
					{
						ev_uint32 __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset::getFeatureCount(filter);
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_register_1getFeatureCount_1IQueryFilter(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMeshTemplateDatasetProxy *pObjectX = (JCMeshTemplateDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_getFeatureCount_1IQueryFilter_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong filter_j)
				{
					EarthView::World::Spatial::GeoDataset::IQueryFilter *filter = (EarthView::World::Spatial::GeoDataset::IQueryFilter*) filter_j;
					EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset*) pObjXXXX;
					ev_uint32 __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset::getFeatureCount(filter);
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_createFeatureBuffer_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCMeshTemplateDatasetProxy))
					{
						EarthView::World::Spatial::GeoDataset::IFeature* __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset::createFeatureBuffer();
						if(__values1 != NULL) {							((EarthView::World::Core::CBaseObject*)__values1)->setExternFree(true);
						}						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_register_1createFeatureBuffer_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMeshTemplateDatasetProxy *pObjectX = (JCMeshTemplateDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_createFeatureBuffer_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset*) pObjXXXX;
					EarthView::World::Spatial::GeoDataset::IFeature* __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset::createFeatureBuffer();
					if(__values1 != NULL) {						((EarthView::World::Core::CBaseObject*)__values1)->setExternFree(true);
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_createFeatureBuffer_1EVString(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring typeName_j)
				{
					#if EV_PLATFORM == EV_PLATFORM_ANDROID
					...
					if (typeid(*pObjectX) == typeid(JCMeshTemplateDatasetProxy))
					{
						EarthView::World::Spatial::GeoDataset::IFeature* __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset::createFeatureBuffer(typeName);
						if(__values1 != NULL) {							((EarthView::World::Core::CBaseObject*)__values1)->setExternFree(true);
						}						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					...
					{
						EarthView::World::Spatial::GeoDataset::IFeature* __values1 = pObjectX->createFeatureBuffer(typeName);
						if(__values1 != NULL) {							((EarthView::World::Core::CBaseObject*)__values1)->setExternFree(true);
						}						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_register_1createFeatureBuffer_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMeshTemplateDatasetProxy *pObjectX = (JCMeshTemplateDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
					__env->ReleaseStringUTFChars(__method, pMethod);
					pObjectX->register_createFeatureBuffer_EVString_callback(sMethod);
					if (pObjectX->getJavaReference() != NULL && sMethod != "")
					{
						EarthView::World::Core::GlobalReference *__gr = (EarthView::World::Core::GlobalReference *)pObjectX->getJavaReference();
						jobject __obj1 = __gr->getJObject();
						jclass __clazz1 = __env->GetObjectClass(__obj1);
						jmethodID __method = __env->GetMethodID(__clazz1,"createFeatureBuffer_EVString_callback", "(Ljava/lang/String;)J");
						__gr->setMethod(sMethod, __method);
					}
				}
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_createFeatureBuffer_1EVString_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring typeName_j)
				{
					#if EV_PLATFORM == EV_PLATFORM_ANDROID
					const ev_char* typeName_ch = (const ev_char*)__env->GetStringUTFChars(typeName_j,JNI_FALSE);
					const EVString typeName = typeName_ch;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_insert_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCMeshTemplateDatasetProxy))
					{
						EarthView::World::Spatial::GeoDataset::IFeature* __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset::insert();
						if(__values1 != NULL) {							((EarthView::World::Core::CBaseObject*)__values1)->setExternFree(true);
						}						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_register_1insert_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMeshTemplateDatasetProxy *pObjectX = (JCMeshTemplateDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_insert_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset*) pObjXXXX;
					EarthView::World::Spatial::GeoDataset::IFeature* __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset::insert();
					if(__values1 != NULL) {						((EarthView::World::Core::CBaseObject*)__values1)->setExternFree(true);
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_insertFeatureBuffer_1IFeature(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong buffer_j)
				{
					const EarthView::World::Spatial::GeoDataset::IFeature *buffer = (const EarthView::World::Spatial::GeoDataset::IFeature*) buffer_j;
					EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCMeshTemplateDatasetProxy))
					{
						ev_uint32 __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset::insertFeatureBuffer(buffer);
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_register_1insertFeatureBuffer_1IFeature(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMeshTemplateDatasetProxy *pObjectX = (JCMeshTemplateDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_insertFeatureBuffer_1IFeature_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong buffer_j)
				{
					const EarthView::World::Spatial::GeoDataset::IFeature *buffer = (const EarthView::World::Spatial::GeoDataset::IFeature*) buffer_j;
					EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset*) pObjXXXX;
					ev_uint32 __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset::insertFeatureBuffer(buffer);
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_update_1IFeature(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong buffer_j)
				{
					const EarthView::World::Spatial::GeoDataset::IFeature *buffer = (const EarthView::World::Spatial::GeoDataset::IFeature*) buffer_j;
					EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCMeshTemplateDatasetProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset::update(buffer);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_register_1update_1IFeature(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMeshTemplateDatasetProxy *pObjectX = (JCMeshTemplateDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_update_1IFeature_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong buffer_j)
				{
					const EarthView::World::Spatial::GeoDataset::IFeature *buffer = (const EarthView::World::Spatial::GeoDataset::IFeature*) buffer_j;
					EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset*) pObjXXXX;
					ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset::update(buffer);
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_deleteFeature_1ev_1uint32(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong id_j)
				{
					ev_uint32 id = (ev_uint32) id_j;
					EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCMeshTemplateDatasetProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset::deleteFeature(id);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_register_1deleteFeature_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMeshTemplateDatasetProxy *pObjectX = (JCMeshTemplateDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_deleteFeature_1ev_1uint32_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong id_j)
				{
					ev_uint32 id = (ev_uint32) id_j;
					EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset*) pObjXXXX;
					ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset::deleteFeature(id);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_releaseFeature_1IFeature(JNIEnv *__env , jclass __clazz, jlong feature_j)
				{
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_getDataSourceRef_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCMeshTemplateDatasetProxy))
					{
						EarthView::World::Spatial::GeoDataset::IDataSource* __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset::getDataSourceRef();
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_register_1getDataSourceRef_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMeshTemplateDatasetProxy *pObjectX = (JCMeshTemplateDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_getDataSourceRef_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset*) pObjXXXX;
					EarthView::World::Spatial::GeoDataset::IDataSource* __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset::getDataSourceRef();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_getResourceDatasetRef_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCMeshTemplateDatasetProxy))
					{
						EarthView::World::Spatial::GeoDataset::IFeatureClass* __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset::getResourceDatasetRef();
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_register_1getResourceDatasetRef_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMeshTemplateDatasetProxy *pObjectX = (JCMeshTemplateDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_getResourceDatasetRef_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset*) pObjXXXX;
					EarthView::World::Spatial::GeoDataset::IFeatureClass* __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset::getResourceDatasetRef();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_clearDataset_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset*) pObjXXXX;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_getMaxMeshInstID_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset*) pObjXXXX;
					ev_int32 __values1 = pObjectX->getMaxMeshInstID();
					jint __values1_j = (jint)__values1;
					return __values1_j;
				}
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_getAttrRef_1ev_1uint32_1EVString_1ev_1uint32(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong meshTmplID_j, jlong attrType_j, jlong attrID_j)
				{
					ev_uint32 meshTmplID = (ev_uint32) meshTmplID_j;
					EVString &attrType = *(EVString*) attrType_j;
					ev_uint32 &attrID = *(ev_uint32*) attrID_j;
					EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCMeshTemplateDatasetProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset::getAttrRef(meshTmplID, attrType, attrID);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
					{
						ev_bool __values1 = pObjectX->getAttrRef(meshTmplID, attrType, attrID);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_register_1getAttrRef_1ev_1uint32_1EVString_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMeshTemplateDatasetProxy *pObjectX = (JCMeshTemplateDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
					__env->ReleaseStringUTFChars(__method, pMethod);
					pObjectX->register_getAttrRef_ev_uint32_EVString_ev_uint32_callback(sMethod);
					if (pObjectX->getJavaReference() != NULL && sMethod != "")
					{
						EarthView::World::Core::GlobalReference *__gr = (EarthView::World::Core::GlobalReference *)pObjectX->getJavaReference();
						jobject __obj1 = __gr->getJObject();
						jclass __clazz1 = __env->GetObjectClass(__obj1);
						jmethodID __method = __env->GetMethodID(__clazz1,"getAttrRef_ev_uint32_EVString_ev_uint32_callback", "(JJJ)Z");
						__gr->setMethod(sMethod, __method);
					}
				}
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_getAttrRef_1ev_1uint32_1EVString_1ev_1uint32_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong meshTmplID_j, jlong attrType_j, jlong attrID_j)
				{
					ev_uint32 meshTmplID = (ev_uint32) meshTmplID_j;
					EVString &attrType = *(EVString*) attrType_j;
					ev_uint32 &attrID = *(ev_uint32*) attrID_j;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_getAttr_1EVString_1ev_1uint32_1CPropertySet(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring attrType_j, jlong attrID_j, jlong ps_j)
				{
					#if EV_PLATFORM == EV_PLATFORM_ANDROID
					const ev_char* attrType_ch = (const ev_char*)__env->GetStringUTFChars(attrType_j,JNI_FALSE);
					const EVString attrType = attrType_ch;
					__env->ReleaseStringUTFChars(attrType_j, (const char *)attrType_ch);
					#else
					const ev_wchar* attrType_ch = (const ev_wchar*)__env->GetStringChars(attrType_j,JNI_FALSE);
					const EVString attrType = attrType_ch;
					__env->ReleaseStringChars(attrType_j, (const jchar *)attrType_ch);
					#endif
					ev_uint32 attrID = (ev_uint32) attrID_j;
					EarthView::World::Spatial::GeoDataset::CPropertySet *ps = (EarthView::World::Spatial::GeoDataset::CPropertySet*) ps_j;
					EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset *pObjectX = (EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCMeshTemplateDatasetProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::Dataset::CMeshTemplateDataset::getAttr(attrType, attrID, ps);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
					{
						ev_bool __values1 = pObjectX->getAttr(attrType, attrID, ps);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_register_1getAttr_1EVString_1ev_1uint32_1CPropertySet(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMeshTemplateDatasetProxy *pObjectX = (JCMeshTemplateDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
					__env->ReleaseStringUTFChars(__method, pMethod);
					pObjectX->register_getAttr_EVString_ev_uint32_CPropertySet_callback(sMethod);
					if (pObjectX->getJavaReference() != NULL && sMethod != "")
					{
						EarthView::World::Core::GlobalReference *__gr = (EarthView::World::Core::GlobalReference *)pObjectX->getJavaReference();
						jobject __obj1 = __gr->getJObject();
						jclass __clazz1 = __env->GetObjectClass(__obj1);
						jmethodID __method = __env->GetMethodID(__clazz1,"getAttr_EVString_ev_uint32_CPropertySet_callback", "(Ljava/lang/String;JJ)Z");
						__gr->setMethod(sMethod, __method);
					}
				}
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_getAttr_1EVString_1ev_1uint32_1CPropertySet_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring attrType_j, jlong attrID_j, jlong ps_j)
				{
					#if EV_PLATFORM == EV_PLATFORM_ANDROID
					const ev_char* attrType_ch = (const ev_char*)__env->GetStringUTFChars(attrType_j,JNI_FALSE);
					const EVString attrType = attrType_ch;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_register_1getFeatureClassType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMeshTemplateDatasetProxy *pObjectX = (JCMeshTemplateDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_register_1getGeometryType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMeshTemplateDatasetProxy *pObjectX = (JCMeshTemplateDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_register_1getSpatialIndexEnum_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMeshTemplateDatasetProxy *pObjectX = (JCMeshTemplateDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_register_1createSpatialIndex_1EVSpatialIndexEnum(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMeshTemplateDatasetProxy *pObjectX = (JCMeshTemplateDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_register_1rebulidSpatialIndex_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMeshTemplateDatasetProxy *pObjectX = (JCMeshTemplateDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_register_1deleteSpatialIndex_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMeshTemplateDatasetProxy *pObjectX = (JCMeshTemplateDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_register_1addField_1IField(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMeshTemplateDatasetProxy *pObjectX = (JCMeshTemplateDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_register_1deleteField_1IField(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMeshTemplateDatasetProxy *pObjectX = (JCMeshTemplateDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_register_1insert_1IFeature(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMeshTemplateDatasetProxy *pObjectX = (JCMeshTemplateDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_register_1getEnvelopeRef_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMeshTemplateDatasetProxy *pObjectX = (JCMeshTemplateDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_register_1getSpatialReferenceRef_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMeshTemplateDatasetProxy *pObjectX = (JCMeshTemplateDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_register_1createTableProxy_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMeshTemplateDatasetProxy *pObjectX = (JCMeshTemplateDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_register_1getDataVersion_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMeshTemplateDatasetProxy *pObjectX = (JCMeshTemplateDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_register_1getDescription_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMeshTemplateDatasetProxy *pObjectX = (JCMeshTemplateDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_register_1getUpdateTime_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMeshTemplateDatasetProxy *pObjectX = (JCMeshTemplateDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_register_1hasSubDataset_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMeshTemplateDatasetProxy *pObjectX = (JCMeshTemplateDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_register_1canEdit_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMeshTemplateDatasetProxy *pObjectX = (JCMeshTemplateDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_register_1isEditing_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMeshTemplateDatasetProxy *pObjectX = (JCMeshTemplateDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_register_1startEditing_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMeshTemplateDatasetProxy *pObjectX = (JCMeshTemplateDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_register_1stopEditing_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMeshTemplateDatasetProxy *pObjectX = (JCMeshTemplateDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_register_1isBeginEditingOperation_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMeshTemplateDatasetProxy *pObjectX = (JCMeshTemplateDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_register_1beginEditingOperation_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMeshTemplateDatasetProxy *pObjectX = (JCMeshTemplateDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_dataset_MeshTemplateDataset_register_1endEditingOperation_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMeshTemplateDatasetProxy *pObjectX = (JCMeshTemplateDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
