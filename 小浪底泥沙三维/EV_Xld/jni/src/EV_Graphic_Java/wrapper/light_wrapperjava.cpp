...
namespace EarthView
{
	namespace World
	{
		namespace Graphic
		{
			class JCLightProxy : public EarthView::World::Graphic::CLight
			{
			 private:
				EarthView::World::Core::ev_string m_createAnimableValue_EVString_callback;
				EarthView::World::Core::ev_string m__getNearClipVolume_CCamera_callback;
				EarthView::World::Core::ev_string m__getFrustumClipVolumes_CCamera_callback;
				EarthView::World::Core::ev_string m__updateCustomGpuParameter_ev_uint16_CAutoConstantEntry_CGpuProgramParameters_callback;
			...
			public:
				JCLightProxy(EarthView::World::Core::CNameValuePairList *pList) : CLight(pList)
				{
				}
			...
			public:
				...
				void register__getNearClipVolume_CCamera_callback(EarthView::World::Core::ev_string __method)
				{
					this->m__getNearClipVolume_CCamera_callback = __method;
				}
				void register__getFrustumClipVolumes_CCamera_callback(EarthView::World::Core::ev_string __method)
				{
					this->m__getFrustumClipVolumes_CCamera_callback = __method;
				}
				void register__updateCustomGpuParameter_ev_uint16_CAutoConstantEntry_CGpuProgramParameters_callback(EarthView::World::Core::ev_string __method)
				{
					this->m__updateCustomGpuParameter_ev_uint16_CAutoConstantEntry_CGpuProgramParameters_callback = __method;
				}
				...
				virtual const EarthView::World::Spatial::Math::CPlaneBoundedVolume& _getNearClipVolume(const EarthView::World::Graphic::CCamera* cam) const
				{
					if (this->_gRef != NULL && this->m__getNearClipVolume_CCamera_callback != "" && this->isCustomExtend())
					{
						EarthView::World::Core::GlobalReference *__gr = (EarthView::World::Core::GlobalReference *)this->getJavaReference();
						JNIEnv * __env;
						#if EV_PLATFORM == EV_PLATFORM_ANDROID
						...
						jmethodID __method = __gr->getMethod("_getNearClipVolume_CCamera_callback");
						jlong __values1_j = (jlong)__env->CallLongMethod(__obj, __method , cam_j);
						#if EV_PLATFORM == EV_PLATFORM_ANDROID
						if(__jniAttachable)
						{
							EarthView::World::Core::JNILoad::getCachedJVM()->DetachCurrentThread();
						...
						EarthView::World::Core::JNILoad::getCachedJVM()->DetachCurrentThread();
						#endif
						const EarthView::World::Spatial::Math::CPlaneBoundedVolume &__values1 = *(const EarthView::World::Spatial::Math::CPlaneBoundedVolume*) __values1_j;
						return __values1;
					}
					else
					{
				...
				virtual const EarthView::World::Spatial::Math::PlaneBoundedVolumeList& _getFrustumClipVolumes(const EarthView::World::Graphic::CCamera* cam) const
				{
					if (this->_gRef != NULL && this->m__getFrustumClipVolumes_CCamera_callback != "" && this->isCustomExtend())
					{
						EarthView::World::Core::GlobalReference *__gr = (EarthView::World::Core::GlobalReference *)this->getJavaReference();
						JNIEnv * __env;
						#if EV_PLATFORM == EV_PLATFORM_ANDROID
						...
						jclass __clazz = __gr->getClass();
						jlong cam_j = (jlong) cam;
						jmethodID __method = __gr->getMethod("_getFrustumClipVolumes_CCamera_callback");
						jlong __values1_j = (jlong)__env->CallLongMethod(__obj, __method , cam_j);
						#if EV_PLATFORM == EV_PLATFORM_ANDROID
						if(__jniAttachable)
						{
						...
						EarthView::World::Core::JNILoad::getCachedJVM()->DetachCurrentThread();
						#endif
						const EarthView::World::Spatial::Math::PlaneBoundedVolumeList &__values1 = *(const EarthView::World::Spatial::Math::PlaneBoundedVolumeList*) __values1_j;
						return __values1;
					}
					else
					{
				...
				virtual void _updateCustomGpuParameter(ev_uint16 paramIndex, const EarthView::World::Graphic::CGpuProgramParameters::CAutoConstantEntry& constantEntry, EarthView::World::Graphic::CGpuProgramParameters* params) const
				{
					if (this->_gRef != NULL && this->m__updateCustomGpuParameter_ev_uint16_CAutoConstantEntry_CGpuProgramParameters_callback != "" && this->isCustomExtend())
					{
						EarthView::World::Core::GlobalReference *__gr = (EarthView::World::Core::GlobalReference *)this->getJavaReference();
						JNIEnv * __env;
						#if EV_PLATFORM == EV_PLATFORM_ANDROID
						...
						jobject __obj = __gr->getJObject();
						jclass __clazz = __gr->getClass();
						jint paramIndex_j = (jint) paramIndex;
						jlong constantEntry_j = (jlong) &constantEntry;
						jlong params_j = (jlong) params;
						jmethodID __method = __gr->getMethod("_updateCustomGpuParameter_ev_uint16_CAutoConstantEntry_CGpuProgramParameters_callback");
						__env->CallVoidMethod(__obj, __method , paramIndex_j, constantEntry_j, params_j);
						#if EV_PLATFORM == EV_PLATFORM_ANDROID
						if(__jniAttachable)
						{
							EarthView::World::Core::JNILoad::getCachedJVM()->DetachCurrentThread();
			...
			REGISTER_FACTORY_CLASS(JCLightProxy);
			class JCLightInternalAnimableObjectProxy : public EarthView::World::Graphic::CLight::CLightInternalAnimableObject
			{
			 private:
				...
				EarthView::World::Core::ev_string m_createAnimableValue_EVString_callback;
			public:
				JCLightInternalAnimableObjectProxy(EarthView::World::Core::CNameValuePairList *pList) : CLightInternalAnimableObject(pList)
				{
				}
				ev_void unRegisterJavaReference()
				{
			...
			REGISTER_FACTORY_CLASS(JCLightInternalAnimableObjectProxy);
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_graphic_Light_00024LightInternalAnimableObject_createAnimableValue_1EVString(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring valueName_j)
			{
				#if EV_PLATFORM == EV_PLATFORM_ANDROID
				...
				#endif
				EarthView::World::Graphic::CLight::CLightInternalAnimableObject *pObjectX = (EarthView::World::Graphic::CLight::CLightInternalAnimableObject*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCLightInternalAnimableObjectProxy))
				{
					EarthView::World::Graphic::AnimableValuePtr __values1 = pObjectX->EarthView::World::Graphic::CLight::CLightInternalAnimableObject::createAnimableValue(valueName);
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_00024LightInternalAnimableObject_register_1createAnimableValue_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightInternalAnimableObjectProxy *pObjectX = (JCLightInternalAnimableObjectProxy*) pObjXXXX;
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_graphic_Light_00024LightInternalAnimableObject_createAnimableValue_1EVString_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring valueName_j)
			{
				#if EV_PLATFORM == EV_PLATFORM_ANDROID
				const ev_char* valueName_ch = (const ev_char*)__env->GetStringUTFChars(valueName_j,JNI_FALSE);
				const EVString valueName = valueName_ch;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_00024LightInternalAnimableObject_register_1initialiseAnimableDictionary_1StringVector(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightInternalAnimableObjectProxy *pObjectX = (JCLightInternalAnimableObjectProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_00024LightInternalAnimableObject_register_1getAnimableDictionaryName_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightInternalAnimableObjectProxy *pObjectX = (JCLightInternalAnimableObjectProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_graphic_Light_createAnimableValue_1EVString(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring valueName_j)
			{
				#if EV_PLATFORM == EV_PLATFORM_ANDROID
				const ev_char* valueName_ch = (const ev_char*)__env->GetStringUTFChars(valueName_j,JNI_FALSE);
				const EVString valueName = valueName_ch;
				...
				__env->ReleaseStringChars(valueName_j, (const jchar *)valueName_ch);
				#endif
				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCLightProxy))
				{
					EarthView::World::Graphic::AnimableValuePtr __values1 = pObjectX->EarthView::World::Graphic::CLight::createAnimableValue(valueName);
					EarthView::World::Graphic::AnimableValuePtr *returnvalues = new EarthView::World::Graphic::AnimableValuePtr(__values1);
					((EarthView::World::Core::CBaseObject*)returnvalues)->setExternFree(true);
					jlong __values1_j = (jlong) returnvalues;
					return __values1_j;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1createAnimableValue_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
				__env->ReleaseStringUTFChars(__method, pMethod);
				pObjectX->register_createAnimableValue_EVString_callback(sMethod);
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_graphic_Light_createAnimableValue_1EVString_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring valueName_j)
			{
				#if EV_PLATFORM == EV_PLATFORM_ANDROID
				const ev_char* valueName_ch = (const ev_char*)__env->GetStringUTFChars(valueName_j,JNI_FALSE);
				const EVString valueName = valueName_ch;
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_graphic_Light_getAnimableObjectPtr_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCLightProxy))
				{
					const EarthView::World::Graphic::CMovableObject::CMovableObjectInternalAnimableObject* __values1 = pObjectX->EarthView::World::Graphic::CLight::getAnimableObjectPtr();
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1getAnimableObjectPtr_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_graphic_Light_getAnimableObjectPtr_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				const EarthView::World::Graphic::CMovableObject::CMovableObjectInternalAnimableObject* __values1 = pObjectX->EarthView::World::Graphic::CLight::getAnimableObjectPtr();
				jlong __values1_j = (jlong) __values1;
			...
			extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_graphic_Light_get_1tempSquareDist_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*)pObjXXXX;
				jdouble __values1_j = (jdouble)(pObjectX->tempSquareDist);
				return __values1_j;
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_set_1tempSquareDist_1Real(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jdouble __values1_j)
			{
				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*)pObjXXXX;
				pObjectX->tempSquareDist = (Real)__values1_j;
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light__1calcTempSquareDist_1CVector3(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong worldPos_j)
			{
				const EarthView::World::Spatial::Math::CVector3 &worldPos = *(EarthView::World::Spatial::Math::CVector3*) worldPos_j;
				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				pObjectX->_calcTempSquareDist(worldPos);
			}
			extern "C" JNIEXPORT jintArray JNICALL Java_com_earthview_world_graphic_Light_00024LightTypesHelper_getEnumValues (JNIEnv *__env, jclass __clazz)
			{
				jint enum_values[] = {
					CLight::LT_POINT,
					CLight::LT_DIRECTIONAL,
					CLight::LT_SPOTLIGHT
				};
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_setType_1LightTypes(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint type_j)
			{
				EarthView::World::Graphic::CLight::LightTypes type = (EarthView::World::Graphic::CLight::LightTypes) type_j;
				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				pObjectX->setType(type);
			}
			extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_graphic_Light_getType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				EarthView::World::Graphic::CLight::LightTypes __values1 = pObjectX->getType();
				jint __values1_j = (jint) __values1;
				return __values1_j;
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_setDiffuseColour_1Real_1Real_1Real(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble red_j, jdouble green_j, jdouble blue_j)
			{
				Real red = (Real) red_j;
				Real green = (Real) green_j;
				Real blue = (Real) blue_j;
				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				pObjectX->setDiffuseColour(red, green, blue);
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_setDiffuseColour_1CColourValue(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong colour_j)
			{
				const EarthView::World::Graphic::CColourValue &colour = *(EarthView::World::Graphic::CColourValue*) colour_j;
				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				pObjectX->setDiffuseColour(colour);
			}
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_graphic_Light_getDiffuseColour_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				const EarthView::World::Graphic::CColourValue& __values1 = pObjectX->getDiffuseColour();
				jlong __values1_j = (jlong) &__values1;
				return __values1_j;
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_setSpecularColour_1Real_1Real_1Real(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble red_j, jdouble green_j, jdouble blue_j)
			{
				Real red = (Real) red_j;
				Real green = (Real) green_j;
				Real blue = (Real) blue_j;
				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				pObjectX->setSpecularColour(red, green, blue);
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_setSpecularColour_1CColourValue(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong colour_j)
			{
				const EarthView::World::Graphic::CColourValue &colour = *(EarthView::World::Graphic::CColourValue*) colour_j;
				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				pObjectX->setSpecularColour(colour);
			}
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_graphic_Light_getSpecularColour_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				const EarthView::World::Graphic::CColourValue& __values1 = pObjectX->getSpecularColour();
				jlong __values1_j = (jlong) &__values1;
				return __values1_j;
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_setAttenuation_1Real_1Real_1Real_1Real(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble range_j, jdouble constant_j, jdouble linear_j, jdouble quadratic_j)
			{
				Real range = (Real) range_j;
				Real constant = (Real) constant_j;
				Real linear = (Real) linear_j;
				Real quadratic = (Real) quadratic_j;
				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				pObjectX->setAttenuation(range, constant, linear, quadratic);
			}
			extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_graphic_Light_getAttenuationRange_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				Real __values1 = pObjectX->getAttenuationRange();
				jdouble __values1_j = (jdouble)__values1;
				return __values1_j;
			}
			extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_graphic_Light_getAttenuationConstant_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				Real __values1 = pObjectX->getAttenuationConstant();
				jdouble __values1_j = (jdouble)__values1;
				return __values1_j;
			}
			extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_graphic_Light_getAttenuationLinear_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				Real __values1 = pObjectX->getAttenuationLinear();
				jdouble __values1_j = (jdouble)__values1;
				return __values1_j;
			}
			extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_graphic_Light_getAttenuationQuadric_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				Real __values1 = pObjectX->getAttenuationQuadric();
				jdouble __values1_j = (jdouble)__values1;
				return __values1_j;
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_setPosition_1Real_1Real_1Real(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble x_j, jdouble y_j, jdouble z_j)
			{
				Real x = (Real) x_j;
				Real y = (Real) y_j;
				Real z = (Real) z_j;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_setPosition_1CVector3(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong vec_j)
			{
				const EarthView::World::Spatial::Math::CVector3 &vec = *(EarthView::World::Spatial::Math::CVector3*) vec_j;
				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				pObjectX->setPosition(vec);
			}
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_graphic_Light_getPosition_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_setDirection_1Real_1Real_1Real(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble x_j, jdouble y_j, jdouble z_j)
			{
				Real x = (Real) x_j;
				Real y = (Real) y_j;
				Real z = (Real) z_j;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_setDirection_1CVector3(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong vec_j)
			{
				const EarthView::World::Spatial::Math::CVector3 &vec = *(EarthView::World::Spatial::Math::CVector3*) vec_j;
				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				pObjectX->setDirection(vec);
			}
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_graphic_Light_getDirection_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_setSpotlightRange_1CRadian_1CRadian_1Real(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong innerAngle_j, jlong outerAngle_j, jdouble falloff_j)
			{
				const EarthView::World::Spatial::Math::CRadian &innerAngle = *(EarthView::World::Spatial::Math::CRadian*) innerAngle_j;
				const EarthView::World::Spatial::Math::CRadian &outerAngle = *(EarthView::World::Spatial::Math::CRadian*) outerAngle_j;
				Real falloff = (Real) falloff_j;
				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				pObjectX->setSpotlightRange(innerAngle, outerAngle, falloff);
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_setSpotlightRange_1CRadian_1CRadian(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong innerAngle_j, jlong outerAngle_j)
			{
				const EarthView::World::Spatial::Math::CRadian &innerAngle = *(EarthView::World::Spatial::Math::CRadian*) innerAngle_j;
				const EarthView::World::Spatial::Math::CRadian &outerAngle = *(EarthView::World::Spatial::Math::CRadian*) outerAngle_j;
				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				pObjectX->setSpotlightRange(innerAngle, outerAngle);
			}
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_graphic_Light_getSpotlightInnerAngle_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				const EarthView::World::Spatial::Math::CRadian& __values1 = pObjectX->getSpotlightInnerAngle();
				jlong __values1_j = (jlong) &__values1;
				return __values1_j;
			}
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_graphic_Light_getSpotlightOuterAngle_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				const EarthView::World::Spatial::Math::CRadian& __values1 = pObjectX->getSpotlightOuterAngle();
				jlong __values1_j = (jlong) &__values1;
				return __values1_j;
			}
			extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_graphic_Light_getSpotlightFalloff_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				Real __values1 = pObjectX->getSpotlightFalloff();
				jdouble __values1_j = (jdouble)__values1;
				return __values1_j;
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_setSpotlightInnerAngle_1CRadian(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong val_j)
			{
				const EarthView::World::Spatial::Math::CRadian &val = *(EarthView::World::Spatial::Math::CRadian*) val_j;
				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				pObjectX->setSpotlightInnerAngle(val);
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_setSpotlightOuterAngle_1CRadian(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong val_j)
			{
				const EarthView::World::Spatial::Math::CRadian &val = *(EarthView::World::Spatial::Math::CRadian*) val_j;
				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				pObjectX->setSpotlightOuterAngle(val);
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_setSpotlightFalloff_1Real(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble val_j)
			{
				Real val = (Real) val_j;
				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				pObjectX->setSpotlightFalloff(val);
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_setSpotlightNearClipDistance_1Real(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble nearClip_j)
			{
				Real nearClip = (Real) nearClip_j;
				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				pObjectX->setSpotlightNearClipDistance(nearClip);
			}
			extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_graphic_Light_getSpotlightNearClipDistance_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				Real __values1 = pObjectX->getSpotlightNearClipDistance();
				jdouble __values1_j = (jdouble)__values1;
				return __values1_j;
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_setPowerScale_1Real(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble power_j)
			{
				Real power = (Real) power_j;
				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				pObjectX->setPowerScale(power);
			}
			extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_graphic_Light_getPowerScale_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				Real __values1 = pObjectX->getPowerScale();
				jdouble __values1_j = (jdouble)__values1;
				return __values1_j;
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light__1notifyAttached_1CNode_1ev_1bool(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong ref_parent_j, jboolean isTagPoint_j)
			{
				...
				if (typeid(*pObjectX) == typeid(JCLightProxy))
				{
					pObjectX->EarthView::World::Graphic::CLight::_notifyAttached(ref_parent, isTagPoint);
				}
				else
				{
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1_1notifyAttached_1CNode_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light__1notifyAttached_1CNode_1ev_1bool_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong ref_parent_j, jboolean isTagPoint_j)
			{
				EarthView::World::Graphic::CNode *ref_parent = (EarthView::World::Graphic::CNode*) ref_parent_j;
				ev_bool isTagPoint = (ev_bool) isTagPoint_j;
				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light__1notifyAttached_1CNode(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong ref_parent_j)
			{
				EarthView::World::Graphic::CNode *ref_parent = (EarthView::World::Graphic::CNode*) ref_parent_j;
				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCLightProxy))
				{
					pObjectX->EarthView::World::Graphic::CLight::_notifyAttached(ref_parent);
				}
				else
				{
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1_1notifyAttached_1CNode(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light__1notifyAttached_1CNode_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong ref_parent_j)
			{
				EarthView::World::Graphic::CNode *ref_parent = (EarthView::World::Graphic::CNode*) ref_parent_j;
				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				pObjectX->EarthView::World::Graphic::CLight::_notifyAttached(ref_parent);
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light__1notifyMoved_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCLightProxy))
				{
					pObjectX->EarthView::World::Graphic::CLight::_notifyMoved();
				}
				else
				{
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1_1notifyMoved_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light__1notifyMoved_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				pObjectX->EarthView::World::Graphic::CLight::_notifyMoved();
			}
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_graphic_Light_getBoundingBox_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCLightProxy))
				{
					const EarthView::World::Spatial::Math::CAxisAlignedBox& __values1 = pObjectX->EarthView::World::Graphic::CLight::getBoundingBox();
					jlong __values1_j = (jlong) &__values1;
					return __values1_j;
				}
				else
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1getBoundingBox_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_graphic_Light_getBoundingBox_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				const EarthView::World::Spatial::Math::CAxisAlignedBox& __values1 = pObjectX->EarthView::World::Graphic::CLight::getBoundingBox();
				jlong __values1_j = (jlong) &__values1;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light__1updateRenderQueue_1CRenderQueue(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong queue_j)
			{
				EarthView::World::Graphic::CRenderQueue *queue = (EarthView::World::Graphic::CRenderQueue*) queue_j;
				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCLightProxy))
				{
					pObjectX->EarthView::World::Graphic::CLight::_updateRenderQueue(queue);
				}
				else
				{
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1_1updateRenderQueue_1CRenderQueue(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light__1updateRenderQueue_1CRenderQueue_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong queue_j)
			{
				EarthView::World::Graphic::CRenderQueue *queue = (EarthView::World::Graphic::CRenderQueue*) queue_j;
				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				pObjectX->EarthView::World::Graphic::CLight::_updateRenderQueue(queue);
			}
			extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_graphic_Light_getMovableType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCLightProxy))
				{
					EVString __values1 = pObjectX->EarthView::World::Graphic::CLight::getMovableType();
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1getMovableType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_graphic_Light_getMovableType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				EVString __values1 = pObjectX->EarthView::World::Graphic::CLight::getMovableType();
				EarthView::World::Core::ev_wstring valuesw1 = __values1;
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_graphic_Light_getDerivedPosition_1ev_1bool(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean cameraRelativeIfSet_j)
			{
				ev_bool cameraRelativeIfSet = (ev_bool) cameraRelativeIfSet_j;
				const 				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				const EarthView::World::Spatial::Math::CVector3& __values1 = pObjectX->getDerivedPosition(cameraRelativeIfSet);
				jlong __values1_j = (jlong) &__values1;
				return __values1_j;
			}
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_graphic_Light_getDerivedPosition_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_graphic_Light_getDerivedDirection_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				const EarthView::World::Spatial::Math::CVector3& __values1 = pObjectX->getDerivedDirection();
				jlong __values1_j = (jlong) &__values1;
				return __values1_j;
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_setVisible_1ev_1bool(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean visible_j)
			{
				ev_bool visible = (ev_bool) visible_j;
				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCLightProxy))
				{
					pObjectX->EarthView::World::Graphic::CLight::setVisible(visible);
				}
				else
				{
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1setVisible_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_setVisible_1ev_1bool_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean visible_j)
			{
				ev_bool visible = (ev_bool) visible_j;
				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				pObjectX->EarthView::World::Graphic::CLight::setVisible(visible);
			}
			extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_graphic_Light_getBoundingRadius_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCLightProxy))
				{
					Real __values1 = pObjectX->EarthView::World::Graphic::CLight::getBoundingRadius();
					jdouble __values1_j = (jdouble)__values1;
					return __values1_j;
				}
				else
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1getBoundingRadius_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_graphic_Light_getBoundingRadius_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				Real __values1 = pObjectX->EarthView::World::Graphic::CLight::getBoundingRadius();
				jdouble __values1_j = (jdouble)__values1;
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_graphic_Light_getAs4DVector_1ev_1bool(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean cameraRelativeIfSet_j)
			{
				ev_bool cameraRelativeIfSet = (ev_bool) cameraRelativeIfSet_j;
				const 				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				EarthView::World::Spatial::Math::CVector4 __values1 = pObjectX->getAs4DVector(cameraRelativeIfSet);
				EarthView::World::Spatial::Math::CVector4 *returnvalues = new EarthView::World::Spatial::Math::CVector4(__values1);
				((EarthView::World::Core::CBaseObject*)returnvalues)->setExternFree(true);
				jlong __values1_j = (jlong) returnvalues;
				return __values1_j;
			}
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_graphic_Light_getAs4DVector_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				EarthView::World::Spatial::Math::CVector4 __values1 = pObjectX->getAs4DVector();
				EarthView::World::Spatial::Math::CVector4 *returnvalues = new EarthView::World::Spatial::Math::CVector4(__values1);
				((EarthView::World::Core::CBaseObject*)returnvalues)->setExternFree(true);
				jlong __values1_j = (jlong) returnvalues;
				return __values1_j;
			}
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_graphic_Light__1getNearClipVolume_1CCamera(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong cam_j)
			{
				const EarthView::World::Graphic::CCamera *cam = (const EarthView::World::Graphic::CCamera*) cam_j;
				const 				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCLightProxy))
				{
					const EarthView::World::Spatial::Math::CPlaneBoundedVolume& __values1 = pObjectX->EarthView::World::Graphic::CLight::_getNearClipVolume(cam);
					jlong __values1_j = (jlong) &__values1;
					return __values1_j;
				}
				else
				{
					const EarthView::World::Spatial::Math::CPlaneBoundedVolume& __values1 = pObjectX->_getNearClipVolume(cam);
					jlong __values1_j = (jlong) &__values1;
					return __values1_j;
				}
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1_1getNearClipVolume_1CCamera(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
				__env->ReleaseStringUTFChars(__method, pMethod);
				pObjectX->register__getNearClipVolume_CCamera_callback(sMethod);
				if (pObjectX->getJavaReference() != NULL && sMethod != "")
				{
					EarthView::World::Core::GlobalReference *__gr = (EarthView::World::Core::GlobalReference *)pObjectX->getJavaReference();
					jobject __obj1 = __gr->getJObject();
					jclass __clazz1 = __env->GetObjectClass(__obj1);
					jmethodID __method = __env->GetMethodID(__clazz1,"_getNearClipVolume_CCamera_callback", "(J)J");
					__gr->setMethod(sMethod, __method);
				}
			}
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_graphic_Light__1getNearClipVolume_1CCamera_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong cam_j)
			{
				const EarthView::World::Graphic::CCamera *cam = (const EarthView::World::Graphic::CCamera*) cam_j;
				const 				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				const EarthView::World::Spatial::Math::CPlaneBoundedVolume& __values1 = pObjectX->EarthView::World::Graphic::CLight::_getNearClipVolume(cam);
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_graphic_Light__1getFrustumClipVolumes_1CCamera(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong cam_j)
			{
				const EarthView::World::Graphic::CCamera *cam = (const EarthView::World::Graphic::CCamera*) cam_j;
				const 				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCLightProxy))
				{
					const EarthView::World::Spatial::Math::PlaneBoundedVolumeList& __values1 = pObjectX->EarthView::World::Graphic::CLight::_getFrustumClipVolumes(cam);
					jlong __values1_j = (jlong) &__values1;
					return __values1_j;
				}
				else
				{
					const EarthView::World::Spatial::Math::PlaneBoundedVolumeList& __values1 = pObjectX->_getFrustumClipVolumes(cam);
					jlong __values1_j = (jlong) &__values1;
					return __values1_j;
				}
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1_1getFrustumClipVolumes_1CCamera(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
				__env->ReleaseStringUTFChars(__method, pMethod);
				pObjectX->register__getFrustumClipVolumes_CCamera_callback(sMethod);
				if (pObjectX->getJavaReference() != NULL && sMethod != "")
				{
					EarthView::World::Core::GlobalReference *__gr = (EarthView::World::Core::GlobalReference *)pObjectX->getJavaReference();
					jobject __obj1 = __gr->getJObject();
					jclass __clazz1 = __env->GetObjectClass(__obj1);
					jmethodID __method = __env->GetMethodID(__clazz1,"_getFrustumClipVolumes_CCamera_callback", "(J)J");
					__gr->setMethod(sMethod, __method);
				}
			}
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_graphic_Light__1getFrustumClipVolumes_1CCamera_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong cam_j)
			{
				const EarthView::World::Graphic::CCamera *cam = (const EarthView::World::Graphic::CCamera*) cam_j;
				const 				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				const EarthView::World::Spatial::Math::PlaneBoundedVolumeList& __values1 = pObjectX->EarthView::World::Graphic::CLight::_getFrustumClipVolumes(cam);
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_graphic_Light_getTypeFlags_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCLightProxy))
				{
					ev_uint32 __values1 = pObjectX->EarthView::World::Graphic::CLight::getTypeFlags();
					jlong __values1_j = (jlong) __values1;
					return __values1_j;
				}
				else
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1getTypeFlags_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_graphic_Light_getTypeFlags_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				ev_uint32 __values1 = pObjectX->EarthView::World::Graphic::CLight::getTypeFlags();
				jlong __values1_j = (jlong) __values1;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_setCustomShadowCameraSetup_1ShadowCameraSetupPtr(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong customShadowSetup_j)
			{
				const EarthView::World::Graphic::ShadowCameraSetupPtr &customShadowSetup = *(EarthView::World::Graphic::ShadowCameraSetupPtr*) customShadowSetup_j;
				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				pObjectX->setCustomShadowCameraSetup(customShadowSetup);
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_resetCustomShadowCameraSetup_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				pObjectX->resetCustomShadowCameraSetup();
			}
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_graphic_Light_getCustomShadowCameraSetup_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				const EarthView::World::Graphic::ShadowCameraSetupPtr& __values1 = pObjectX->getCustomShadowCameraSetup();
				jlong __values1_j = (jlong) &__values1;
				return __values1_j;
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_visitRenderables_1CVisitor_1ev_1bool(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong visitor_j, jboolean debugRenderables_j)
			{
				...
				if (typeid(*pObjectX) == typeid(JCLightProxy))
				{
					pObjectX->EarthView::World::Graphic::CLight::visitRenderables(visitor, debugRenderables);
				}
				else
				{
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1visitRenderables_1CVisitor_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_visitRenderables_1CVisitor_1ev_1bool_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong visitor_j, jboolean debugRenderables_j)
			{
				EarthView::World::Graphic::CRenderable::CVisitor *visitor = (EarthView::World::Graphic::CRenderable::CVisitor*) visitor_j;
				ev_bool debugRenderables = (ev_bool) debugRenderables_j;
				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_visitRenderables_1CVisitor(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong visitor_j)
			{
				EarthView::World::Graphic::CRenderable::CVisitor *visitor = (EarthView::World::Graphic::CRenderable::CVisitor*) visitor_j;
				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCLightProxy))
				{
					pObjectX->EarthView::World::Graphic::CLight::visitRenderables(visitor);
				}
				else
				{
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1visitRenderables_1CVisitor(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_visitRenderables_1CVisitor_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong visitor_j)
			{
				EarthView::World::Graphic::CRenderable::CVisitor *visitor = (EarthView::World::Graphic::CRenderable::CVisitor*) visitor_j;
				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				pObjectX->EarthView::World::Graphic::CLight::visitRenderables(visitor);
			}
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_graphic_Light__1getIndexInFrame_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				ev_size_t __values1 = pObjectX->_getIndexInFrame();
				jlong __values1_j = (jlong) __values1;
				return __values1_j;
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light__1notifyIndexInFrame_1ev_1size_1t(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong i_j)
			{
				ev_size_t i = (ev_size_t) i_j;
				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				pObjectX->_notifyIndexInFrame(i);
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_setShadowFarDistance_1Real(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble distance_j)
			{
				Real distance = (Real) distance_j;
				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				pObjectX->setShadowFarDistance(distance);
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_resetShadowFarDistance_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				pObjectX->resetShadowFarDistance();
			}
			extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_graphic_Light_getShadowFarDistance_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
			...
			extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_graphic_Light_getShadowFarDistanceSquared_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_setShadowNearClipDistance_1Real(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble nearClip_j)
			{
				Real nearClip = (Real) nearClip_j;
				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				pObjectX->setShadowNearClipDistance(nearClip);
			}
			extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_graphic_Light_getShadowNearClipDistance_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				Real __values1 = pObjectX->getShadowNearClipDistance();
				jdouble __values1_j = (jdouble)__values1;
				return __values1_j;
			}
			extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_graphic_Light__1deriveShadowNearClipDistance_1CCamera(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong maincam_j)
			{
				const EarthView::World::Graphic::CCamera *maincam = (const EarthView::World::Graphic::CCamera*) maincam_j;
				const 				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				Real __values1 = pObjectX->_deriveShadowNearClipDistance(maincam);
				jdouble __values1_j = (jdouble)__values1;
				return __values1_j;
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_setShadowFarClipDistance_1Real(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble farClip_j)
			{
				Real farClip = (Real) farClip_j;
				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				pObjectX->setShadowFarClipDistance(farClip);
			}
			extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_graphic_Light_getShadowFarClipDistance_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				Real __values1 = pObjectX->getShadowFarClipDistance();
				jdouble __values1_j = (jdouble)__values1;
				return __values1_j;
			}
			extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_graphic_Light__1deriveShadowFarClipDistance_1CCamera(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong maincam_j)
			{
				const EarthView::World::Graphic::CCamera *maincam = (const EarthView::World::Graphic::CCamera*) maincam_j;
				const 				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				Real __values1 = pObjectX->_deriveShadowFarClipDistance(maincam);
				jdouble __values1_j = (jdouble)__values1;
				return __values1_j;
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light__1setCameraRelative_1CCamera(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong cam_j)
			{
				EarthView::World::Graphic::CCamera *cam = (EarthView::World::Graphic::CCamera*) cam_j;
				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				pObjectX->_setCameraRelative(cam);
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_setCustomParameter_1ev_1uint16_1CVector4(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint index_j, jlong value_j)
			{
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_graphic_Light_getCustomParameter_1ev_1uint16(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint index_j)
			{
				ev_uint16 index = (ev_uint16) index_j;
				const 				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light__1updateCustomGpuParameter_1ev_1uint16_1CAutoConstantEntry_1CGpuProgramParameters(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint paramIndex_j, jlong constantEntry_j, jlong params_j)
			{
				ev_uint16 paramIndex = (ev_uint16) paramIndex_j;
				...
				if (typeid(*pObjectX) == typeid(JCLightProxy))
				{
					pObjectX->EarthView::World::Graphic::CLight::_updateCustomGpuParameter(paramIndex, constantEntry, params);
				}
				else
				{
					pObjectX->_updateCustomGpuParameter(paramIndex, constantEntry, params);
				}
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1_1updateCustomGpuParameter_1ev_1uint16_1CAutoConstantEntry_1CGpuProgramParameters(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
				__env->ReleaseStringUTFChars(__method, pMethod);
				pObjectX->register__updateCustomGpuParameter_ev_uint16_CAutoConstantEntry_CGpuProgramParameters_callback(sMethod);
				if (pObjectX->getJavaReference() != NULL && sMethod != "")
				{
					EarthView::World::Core::GlobalReference *__gr = (EarthView::World::Core::GlobalReference *)pObjectX->getJavaReference();
					jobject __obj1 = __gr->getJObject();
					jclass __clazz1 = __env->GetObjectClass(__obj1);
					jmethodID __method = __env->GetMethodID(__clazz1,"_updateCustomGpuParameter_ev_uint16_CAutoConstantEntry_CGpuProgramParameters_callback", "(IJJ)V");
					__gr->setMethod(sMethod, __method);
				}
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light__1updateCustomGpuParameter_1ev_1uint16_1CAutoConstantEntry_1CGpuProgramParameters_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint paramIndex_j, jlong constantEntry_j, jlong params_j)
			{
				ev_uint16 paramIndex = (ev_uint16) paramIndex_j;
				const EarthView::World::Graphic::CGpuProgramParameters::CAutoConstantEntry &constantEntry = *(EarthView::World::Graphic::CGpuProgramParameters::CAutoConstantEntry*) constantEntry_j;
				EarthView::World::Graphic::CGpuProgramParameters *params = (EarthView::World::Graphic::CGpuProgramParameters*) params_j;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_update_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCLightProxy))
				{
					pObjectX->EarthView::World::Graphic::CLight::update();
				}
				else
				{
					pObjectX->update();
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1update_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_update_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Graphic::CLight *pObjectX = (EarthView::World::Graphic::CLight*) pObjXXXX;
				pObjectX->EarthView::World::Graphic::CLight::update();
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1getRenderQueueId_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1_1notifyCreator_1CMovableObjectFactory(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1_1getCreator_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1_1notifyManager_1CSceneManager(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1_1getManager_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1getName_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1getParentNode_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1getParentSceneNode_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1isParentTagPoint_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1isAttached_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1detachFromParent_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1isInScene_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1_1notifyLightsQueried_1LightList(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1setLightQueriedListener_1CLightQueriedListener(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1getLightQueriedListener_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1getLightListUpdated_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1setLightListUpdated_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1_1notifyCurrentCamera_1CCamera(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1getWorldBoundingSphere_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1getWorldBoundingSphere_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1getVisible_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1isVisible_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1setRenderingMaxDistance_1Real(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1getRenderingMaxDistance_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1setRenderingMinDistance_1Real(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1getRenderingMinDistance_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1setRenderingMinPixelSize_1Real(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1getRenderingMinPixelSize_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1setSelectionColour_1CColourValue(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1setSelected_1IntVector(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1getSelected_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1selectBy_1CRay_1CViewport_1ev_1bool_1ev_1int32_1CVector3(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1selectBy_1CAxisAlignedBox_1ev_1bool_1IntVector(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1selectBy_1CSphere_1ev_1bool_1IntVector(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1selectComponentBy_1CRay_1CViewport_1ev_1bool_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32_1CVector3(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1renderSelection_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1clearSelection_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1startEditing_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1endEditing_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1getEditBoundingBox_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1getSelectedObjectWorldMatrix_1ev_1uint32_1CMatrix4(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1setSelectedObjectWorldMatrix_1ev_1uint32_1CMatrix4(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1setRenderQueueGroup_1ev_1uint8(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1setRenderQueueGroupAndPriority_1ev_1uint8_1ev_1uint16(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1getRenderQueueGroup_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1_1getParentNodeFullTransform_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1setQueryFlags_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1addQueryFlags_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1removeQueryFlags_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1getQueryFlags_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1setVisibilityFlags_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1addVisibilityFlags_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1removeVisibilityFlags_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1getVisibilityFlags_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1addListener_1CMovableObjectListener(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1removeListener_1CMovableObjectListener(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1existListener_1CMovableObjectListener(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1getListenerCount_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1getListener_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1queryLights_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1getLightMask_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1setLightMask_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1_1getLightList_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1setCastShadows_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1getReceivesShadows_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1setDebugDisplayEnabled_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1isDebugDisplayEnabled_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1getCastShadows_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1getEdgeList_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1hasEdgeList_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1getWorldBoundingBox_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1getWorldBoundingBox_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1getLightCapBounds_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1getDarkCapBounds_1CLight_1Real(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1getShadowVolumeRenderableIterator_1ShadowTechnique_1CLight_1CHardwareIndexBufferSharedPtr_1ev_1bool_1Real_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1getShadowVolumeRenderableIterator_1ShadowTechnique_1CLight_1CHardwareIndexBufferSharedPtr_1ev_1bool_1Real(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1getPointExtrusionDistance_1CLight(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1updateEdgeListLightFacing_1CEdgeData_1CVector4(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1generateShadowVolume_1CEdgeData_1CHardwareIndexBufferSharedPtr_1CLight_1ShadowRenderableList_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Light_register_1extrudeBounds_1CAxisAlignedBox_1CVector4_1Real(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightProxy *pObjectX = (JCLightProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			class JCLightFactoryProxy : public EarthView::World::Graphic::CLightFactory
			{
			 private:
			...
			public:
				JCLightFactoryProxy(EarthView::World::Core::CNameValuePairList *pList) : CLightFactory(pList)
				{
				}
				ev_void unRegisterJavaReference()
				{
			...
			REGISTER_FACTORY_CLASS(JCLightFactoryProxy);
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_graphic_LightFactory_createInstanceImpl_1EVString_1CommonStringPairList(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring name_j, jlong params_j)
			{
				#if EV_PLATFORM == EV_PLATFORM_ANDROID
				...
				EarthView::World::Graphic::CLightFactory *pObjectX = (EarthView::World::Graphic::CLightFactory*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCLightFactoryProxy))
				{
					EarthView::World::Graphic::CMovableObject* __values1 = pObjectX->EarthView::World::Graphic::CLightFactory::createInstanceImpl(name, params);
					jlong __values1_j = (jlong) __values1;
					return __values1_j;
				}
				else
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_LightFactory_register_1createInstanceImpl_1EVString_1CommonStringPairList(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightFactoryProxy *pObjectX = (JCLightFactoryProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
				__env->ReleaseStringUTFChars(__method, pMethod);
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_graphic_LightFactory_createInstanceImpl_1EVString_1CommonStringPairList_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring name_j, jlong params_j)
			{
				#if EV_PLATFORM == EV_PLATFORM_ANDROID
				const ev_char* name_ch = (const ev_char*)__env->GetStringUTFChars(name_j,JNI_FALSE);
				const EVString name = name_ch;
			...
			extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_graphic_LightFactory_get_1FACTORY_1TYPE_1NAME_1void(JNIEnv *__env, jclass __clazz)
			{
				EarthView::World::Core::ev_wstring __values1_ch = EarthView::World::Graphic::CLightFactory::FACTORY_TYPE_NAME;
				jstring __values1_j = __env->NewString((const jchar*)__values1_ch.getString(), __values1_ch.size());
				return __values1_j;
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_LightFactory_set_1FACTORY_1TYPE_1NAME_1EVString(JNIEnv *__env, jclass __clazz, jstring __values1_j)
			{
				const ev_wchar* __values1_ch = (const ev_wchar*)__env->GetStringChars(__values1_j,JNI_FALSE);
				EarthView::World::Graphic::CLightFactory::FACTORY_TYPE_NAME = __values1_ch;
				__env->ReleaseStringChars(__values1_j,(const jchar*)__values1_ch);
			}
			extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_graphic_LightFactory_getType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Graphic::CLightFactory *pObjectX = (EarthView::World::Graphic::CLightFactory*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCLightFactoryProxy))
				{
					EVString __values1 = pObjectX->EarthView::World::Graphic::CLightFactory::getType();
					EarthView::World::Core::ev_wstring valuesw1 = __values1;
					jstring __values1_j = __env->NewString((const jchar*)valuesw1.getString(), valuesw1.size());
					return __values1_j;
				}
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_LightFactory_register_1getType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightFactoryProxy *pObjectX = (JCLightFactoryProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_graphic_LightFactory_getType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Graphic::CLightFactory *pObjectX = (EarthView::World::Graphic::CLightFactory*) pObjXXXX;
				EVString __values1 = pObjectX->EarthView::World::Graphic::CLightFactory::getType();
				EarthView::World::Core::ev_wstring valuesw1 = __values1;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_LightFactory_destroyInstance_1CMovableObject(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong obj_j)
			{
				EarthView::World::Graphic::CMovableObject *obj = (EarthView::World::Graphic::CMovableObject*) obj_j;
				EarthView::World::Graphic::CLightFactory *pObjectX = (EarthView::World::Graphic::CLightFactory*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCLightFactoryProxy))
				{
					pObjectX->EarthView::World::Graphic::CLightFactory::destroyInstance(obj);
				}
				else
				{
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_LightFactory_register_1destroyInstance_1CMovableObject(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightFactoryProxy *pObjectX = (JCLightFactoryProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_LightFactory_destroyInstance_1CMovableObject_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong obj_j)
			{
				EarthView::World::Graphic::CMovableObject *obj = (EarthView::World::Graphic::CMovableObject*) obj_j;
				EarthView::World::Graphic::CLightFactory *pObjectX = (EarthView::World::Graphic::CLightFactory*) pObjXXXX;
				pObjectX->EarthView::World::Graphic::CLightFactory::destroyInstance(obj);
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_LightFactory_register_1createInstanceImpl_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightFactoryProxy *pObjectX = (JCLightFactoryProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_LightFactory_register_1createInstance_1EVString_1CSceneManager_1CommonStringPairList(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightFactoryProxy *pObjectX = (JCLightFactoryProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_LightFactory_register_1createInstance_1EVString_1CSceneManager(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightFactoryProxy *pObjectX = (JCLightFactoryProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_LightFactory_register_1requestTypeFlags_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLightFactoryProxy *pObjectX = (JCLightFactoryProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
