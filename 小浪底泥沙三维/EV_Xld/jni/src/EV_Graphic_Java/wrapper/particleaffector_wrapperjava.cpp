...
namespace EarthView
{
	namespace World
	{
		namespace Graphic
		{
			class JCParticleAffectorProxy : public EarthView::World::Graphic::CParticleAffector
			{
			 private:
			...
			public:
				JCParticleAffectorProxy(EarthView::World::Core::CNameValuePairList *pList) : CParticleAffector(pList)
				{
				}
			...
			REGISTER_FACTORY_CLASS(JCParticleAffectorProxy);
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_ParticleAffector_addBaseParameters_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Graphic::CParticleAffector *pObjectX = (EarthView::World::Graphic::CParticleAffector*) pObjXXXX;
				pObjectX->addBaseParameters();
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_ParticleAffector__1initParticle_1CParticle(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong pParticle_j)
			{
				EarthView::World::Graphic::CParticle *pParticle = (EarthView::World::Graphic::CParticle*) pParticle_j;
				EarthView::World::Graphic::CParticleAffector *pObjectX = (EarthView::World::Graphic::CParticleAffector*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCParticleAffectorProxy))
				{
					pObjectX->EarthView::World::Graphic::CParticleAffector::_initParticle(pParticle);
				}
				else
				{
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_ParticleAffector_register_1_1initParticle_1CParticle(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCParticleAffectorProxy *pObjectX = (JCParticleAffectorProxy*) pObjXXXX;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_ParticleAffector__1initParticle_1CParticle_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong pParticle_j)
			{
				EarthView::World::Graphic::CParticle *pParticle = (EarthView::World::Graphic::CParticle*) pParticle_j;
				EarthView::World::Graphic::CParticleAffector *pObjectX = (EarthView::World::Graphic::CParticleAffector*) pObjXXXX;
				pObjectX->EarthView::World::Graphic::CParticleAffector::_initParticle(pParticle);
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_ParticleAffector__1affectParticles_1CParticleSystem_1Real(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong pSystem_j, jdouble timeElapsed_j)
			{
				...
				if (typeid(*pObjectX) == typeid(JCParticleAffectorProxy))
				{
					pObjectX->EarthView::World::Graphic::CParticleAffector::_affectParticles(pSystem, timeElapsed);
				}
				else
				{
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_ParticleAffector_register_1_1affectParticles_1CParticleSystem_1Real(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCParticleAffectorProxy *pObjectX = (JCParticleAffectorProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_ParticleAffector__1affectParticles_1CParticleSystem_1Real_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong pSystem_j, jdouble timeElapsed_j)
			{
				EarthView::World::Graphic::CParticleSystem *pSystem = (EarthView::World::Graphic::CParticleSystem*) pSystem_j;
				Real timeElapsed = (Real) timeElapsed_j;
				EarthView::World::Graphic::CParticleAffector *pObjectX = (EarthView::World::Graphic::CParticleAffector*) pObjXXXX;
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_graphic_ParticleAffector_getType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Graphic::CParticleAffector *pObjectX = (EarthView::World::Graphic::CParticleAffector*) pObjXXXX;
				const EVString& __values1 = pObjectX->getType();
				jlong __values1_j = (jlong) &__values1;
				return __values1_j;
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_ParticleAffector_register_1setParameter_1EVString_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCParticleAffectorProxy *pObjectX = (JCParticleAffectorProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_ParticleAffector_register_1setParameter_1EVString_1ev_1bool_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCParticleAffectorProxy *pObjectX = (JCParticleAffectorProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_ParticleAffector_register_1setParameterList_1CommonStringPairList(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCParticleAffectorProxy *pObjectX = (JCParticleAffectorProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_ParticleAffector_register_1getParameter_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCParticleAffectorProxy *pObjectX = (JCParticleAffectorProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_ParticleAffector_register_1copyParametersTo_1CStringInterface(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCParticleAffectorProxy *pObjectX = (JCParticleAffectorProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
