...
namespace EarthView
{
	namespace World
	{
		namespace Graphic
		{
			class JCPVRTCCodecProxy : public EarthView::World::Graphic::CPVRTCCodec
			{
			 private:
			...
			public:
				JCPVRTCCodecProxy(EarthView::World::Core::CNameValuePairList *pList) : CPVRTCCodec(pList)
				{
				}
			...
			REGISTER_FACTORY_CLASS(JCPVRTCCodecProxy);
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_graphic_Pvrtccodec_code_1MemoryDataStreamPtr_1CodecDataPtr(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong input_j, jlong pData_j)
			{
				...
				const 				EarthView::World::Graphic::CPVRTCCodec *pObjectX = (EarthView::World::Graphic::CPVRTCCodec*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCPVRTCCodecProxy))
				{
					EarthView::World::Core::DataStreamPtr __values1 = pObjectX->EarthView::World::Graphic::CPVRTCCodec::code(input, pData);
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Pvrtccodec_register_1code_1MemoryDataStreamPtr_1CodecDataPtr(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCPVRTCCodecProxy *pObjectX = (JCPVRTCCodecProxy*) pObjXXXX;
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_graphic_Pvrtccodec_code_1MemoryDataStreamPtr_1CodecDataPtr_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong input_j, jlong pData_j)
			{
				EarthView::World::Core::MemoryDataStreamPtr &input = *(EarthView::World::Core::MemoryDataStreamPtr*) input_j;
				EarthView::World::Graphic::CCodec::CodecDataPtr &pData = *(EarthView::World::Graphic::CCodec::CodecDataPtr*) pData_j;
				const 				EarthView::World::Graphic::CPVRTCCodec *pObjectX = (EarthView::World::Graphic::CPVRTCCodec*) pObjXXXX;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Pvrtccodec_codeToFile_1MemoryDataStreamPtr_1EVString_1CodecDataPtr(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong input_j, jstring outFileName_j, jlong pData_j)
			{
				EarthView::World::Core::MemoryDataStreamPtr &input = *(EarthView::World::Core::MemoryDataStreamPtr*) input_j;
				#if EV_PLATFORM == EV_PLATFORM_ANDROID
				...
				if (typeid(*pObjectX) == typeid(JCPVRTCCodecProxy))
				{
					pObjectX->EarthView::World::Graphic::CPVRTCCodec::codeToFile(input, outFileName, pData);
				}
				else
				{
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Pvrtccodec_register_1codeToFile_1MemoryDataStreamPtr_1EVString_1CodecDataPtr(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCPVRTCCodecProxy *pObjectX = (JCPVRTCCodecProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Pvrtccodec_codeToFile_1MemoryDataStreamPtr_1EVString_1CodecDataPtr_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong input_j, jstring outFileName_j, jlong pData_j)
			{
				EarthView::World::Core::MemoryDataStreamPtr &input = *(EarthView::World::Core::MemoryDataStreamPtr*) input_j;
				#if EV_PLATFORM == EV_PLATFORM_ANDROID
				const ev_char* outFileName_ch = (const ev_char*)__env->GetStringUTFChars(outFileName_j,JNI_FALSE);
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_graphic_Pvrtccodec_decode_1DataStreamPtr(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong input_j)
			{
				EarthView::World::Core::DataStreamPtr &input = *(EarthView::World::Core::DataStreamPtr*) input_j;
				const 				EarthView::World::Graphic::CPVRTCCodec *pObjectX = (EarthView::World::Graphic::CPVRTCCodec*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCPVRTCCodecProxy))
				{
					EarthView::World::Graphic::CCodec::DecodeResult __values1 = pObjectX->EarthView::World::Graphic::CPVRTCCodec::decode(input);
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Pvrtccodec_register_1decode_1DataStreamPtr(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCPVRTCCodecProxy *pObjectX = (JCPVRTCCodecProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_graphic_Pvrtccodec_decode_1DataStreamPtr_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong input_j)
			{
				EarthView::World::Core::DataStreamPtr &input = *(EarthView::World::Core::DataStreamPtr*) input_j;
				const 				EarthView::World::Graphic::CPVRTCCodec *pObjectX = (EarthView::World::Graphic::CPVRTCCodec*) pObjXXXX;
				EarthView::World::Graphic::CCodec::DecodeResult __values1 = pObjectX->EarthView::World::Graphic::CPVRTCCodec::decode(input);
			...
			extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_graphic_Pvrtccodec_magicNumberToFileExt_1ev_1char_1ev_1size_1t(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong magicNumberPtr_j, jlong maxbytes_j)
			{
				...
				if (typeid(*pObjectX) == typeid(JCPVRTCCodecProxy))
				{
					EVString __values1 = pObjectX->EarthView::World::Graphic::CPVRTCCodec::magicNumberToFileExt(magicNumberPtr, maxbytes);
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Pvrtccodec_register_1magicNumberToFileExt_1ev_1char_1ev_1size_1t(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCPVRTCCodecProxy *pObjectX = (JCPVRTCCodecProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_graphic_Pvrtccodec_magicNumberToFileExt_1ev_1char_1ev_1size_1t_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong magicNumberPtr_j, jlong maxbytes_j)
			{
				const ev_char *magicNumberPtr = (const ev_char*) magicNumberPtr_j;
				ev_size_t maxbytes = (ev_size_t) maxbytes_j;
				const 				EarthView::World::Graphic::CPVRTCCodec *pObjectX = (EarthView::World::Graphic::CPVRTCCodec*) pObjXXXX;
			...
			extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_graphic_Pvrtccodec_getType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Graphic::CPVRTCCodec *pObjectX = (EarthView::World::Graphic::CPVRTCCodec*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCPVRTCCodecProxy))
				{
					EVString __values1 = pObjectX->EarthView::World::Graphic::CPVRTCCodec::getType();
					EarthView::World::Core::ev_wstring valuesw1 = __values1;
					jstring __values1_j = __env->NewString((const jchar*)valuesw1.getString(), valuesw1.size());
					return __values1_j;
				}
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Pvrtccodec_register_1getType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCPVRTCCodecProxy *pObjectX = (JCPVRTCCodecProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_graphic_Pvrtccodec_getType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Graphic::CPVRTCCodec *pObjectX = (EarthView::World::Graphic::CPVRTCCodec*) pObjXXXX;
				EVString __values1 = pObjectX->EarthView::World::Graphic::CPVRTCCodec::getType();
				EarthView::World::Core::ev_wstring valuesw1 = __values1;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Pvrtccodec_startup_1void(JNIEnv *__env , jclass __clazz)
			{
				EarthView::World::Graphic::CPVRTCCodec::startup();
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Pvrtccodec_shutdown_1void(JNIEnv *__env , jclass __clazz)
			{
				EarthView::World::Graphic::CPVRTCCodec::shutdown();
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Pvrtccodec_register_1getDataType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCPVRTCCodecProxy *pObjectX = (JCPVRTCCodecProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Pvrtccodec_register_1magicNumberMatch_1ev_1char_1ev_1size_1t(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCPVRTCCodecProxy *pObjectX = (JCPVRTCCodecProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
