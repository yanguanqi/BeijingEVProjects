...
namespace EarthView
{
	namespace World
	{
		namespace Graphic
		{
			class JCDistanceLodStrategyProxy : public EarthView::World::Graphic::CDistanceLodStrategy
			{
			 private:
			...
			public:
				JCDistanceLodStrategyProxy(EarthView::World::Core::CNameValuePairList *pList) : CDistanceLodStrategy(pList)
				{
				}
			...
			REGISTER_FACTORY_CLASS(JCDistanceLodStrategyProxy);
			extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_graphic_DistanceLodStrategy_getValueImpl_1CMovableObject_1CCamera(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong movableObject_j, jlong camera_j)
			{
				...
				const 				EarthView::World::Graphic::CDistanceLodStrategy *pObjectX = (EarthView::World::Graphic::CDistanceLodStrategy*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCDistanceLodStrategyProxy))
				{
					Real __values1 = pObjectX->EarthView::World::Graphic::CDistanceLodStrategy::getValueImpl(movableObject, camera);
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_DistanceLodStrategy_register_1getValueImpl_1CMovableObject_1CCamera(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCDistanceLodStrategyProxy *pObjectX = (JCDistanceLodStrategyProxy*) pObjXXXX;
			...
			extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_graphic_DistanceLodStrategy_getValueImpl_1CMovableObject_1CCamera_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong movableObject_j, jlong camera_j)
			{
				const EarthView::World::Graphic::CMovableObject *movableObject = (const EarthView::World::Graphic::CMovableObject*) movableObject_j;
				const EarthView::World::Graphic::CCamera *camera = (const EarthView::World::Graphic::CCamera*) camera_j;
				const 				EarthView::World::Graphic::CDistanceLodStrategy *pObjectX = (EarthView::World::Graphic::CDistanceLodStrategy*) pObjXXXX;
			...
			extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_graphic_DistanceLodStrategy_getBaseValue_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Graphic::CDistanceLodStrategy *pObjectX = (EarthView::World::Graphic::CDistanceLodStrategy*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCDistanceLodStrategyProxy))
				{
					Real __values1 = pObjectX->EarthView::World::Graphic::CDistanceLodStrategy::getBaseValue();
					jdouble __values1_j = (jdouble)__values1;
					return __values1_j;
				}
				else
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_DistanceLodStrategy_register_1getBaseValue_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCDistanceLodStrategyProxy *pObjectX = (JCDistanceLodStrategyProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_graphic_DistanceLodStrategy_getBaseValue_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Graphic::CDistanceLodStrategy *pObjectX = (EarthView::World::Graphic::CDistanceLodStrategy*) pObjXXXX;
				Real __values1 = pObjectX->EarthView::World::Graphic::CDistanceLodStrategy::getBaseValue();
				jdouble __values1_j = (jdouble)__values1;
			...
			extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_graphic_DistanceLodStrategy_transformBias_1Real(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble factor_j)
			{
				Real factor = (Real) factor_j;
				const 				EarthView::World::Graphic::CDistanceLodStrategy *pObjectX = (EarthView::World::Graphic::CDistanceLodStrategy*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCDistanceLodStrategyProxy))
				{
					Real __values1 = pObjectX->EarthView::World::Graphic::CDistanceLodStrategy::transformBias(factor);
					jdouble __values1_j = (jdouble)__values1;
					return __values1_j;
				}
				else
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_DistanceLodStrategy_register_1transformBias_1Real(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCDistanceLodStrategyProxy *pObjectX = (JCDistanceLodStrategyProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_graphic_DistanceLodStrategy_transformBias_1Real_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble factor_j)
			{
				Real factor = (Real) factor_j;
				const 				EarthView::World::Graphic::CDistanceLodStrategy *pObjectX = (EarthView::World::Graphic::CDistanceLodStrategy*) pObjXXXX;
				Real __values1 = pObjectX->EarthView::World::Graphic::CDistanceLodStrategy::transformBias(factor);
			...
			extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_graphic_DistanceLodStrategy_transformUserValue_1Real(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble userValue_j)
			{
				Real userValue = (Real) userValue_j;
				const 				EarthView::World::Graphic::CDistanceLodStrategy *pObjectX = (EarthView::World::Graphic::CDistanceLodStrategy*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCDistanceLodStrategyProxy))
				{
					Real __values1 = pObjectX->EarthView::World::Graphic::CDistanceLodStrategy::transformUserValue(userValue);
					jdouble __values1_j = (jdouble)__values1;
					return __values1_j;
				}
				else
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_DistanceLodStrategy_register_1transformUserValue_1Real(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCDistanceLodStrategyProxy *pObjectX = (JCDistanceLodStrategyProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_graphic_DistanceLodStrategy_transformUserValue_1Real_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble userValue_j)
			{
				Real userValue = (Real) userValue_j;
				const 				EarthView::World::Graphic::CDistanceLodStrategy *pObjectX = (EarthView::World::Graphic::CDistanceLodStrategy*) pObjXXXX;
				Real __values1 = pObjectX->EarthView::World::Graphic::CDistanceLodStrategy::transformUserValue(userValue);
			...
			extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_graphic_DistanceLodStrategy_getIndex_1Real_1MeshLodUsageList(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble value_j, jlong meshLodUsageList_j)
			{
				...
				if (typeid(*pObjectX) == typeid(JCDistanceLodStrategyProxy))
				{
					ev_uint16 __values1 = pObjectX->EarthView::World::Graphic::CDistanceLodStrategy::getIndex(value, meshLodUsageList);
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_DistanceLodStrategy_register_1getIndex_1Real_1MeshLodUsageList(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCDistanceLodStrategyProxy *pObjectX = (JCDistanceLodStrategyProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_graphic_DistanceLodStrategy_getIndex_1Real_1MeshLodUsageList_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble value_j, jlong meshLodUsageList_j)
			{
				Real value = (Real) value_j;
				const EarthView::World::Graphic::CMesh::MeshLodUsageList &meshLodUsageList = *(EarthView::World::Graphic::CMesh::MeshLodUsageList*) meshLodUsageList_j;
				const 				EarthView::World::Graphic::CDistanceLodStrategy *pObjectX = (EarthView::World::Graphic::CDistanceLodStrategy*) pObjXXXX;
			...
			extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_graphic_DistanceLodStrategy_getIndex_1Real_1LodValueList(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble value_j, jlong materialLodValueList_j)
			{
				Real value = (Real) value_j;
				...
				if (typeid(*pObjectX) == typeid(JCDistanceLodStrategyProxy))
				{
					ev_uint16 __values1 = pObjectX->EarthView::World::Graphic::CDistanceLodStrategy::getIndex(value, materialLodValueList);
					jint __values1_j = (jint) __values1;
					return __values1_j;
				}
				else
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_DistanceLodStrategy_register_1getIndex_1Real_1LodValueList(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCDistanceLodStrategyProxy *pObjectX = (JCDistanceLodStrategyProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_graphic_DistanceLodStrategy_getIndex_1Real_1LodValueList_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble value_j, jlong materialLodValueList_j)
			{
				Real value = (Real) value_j;
				const EarthView::World::Graphic::LodValueList &materialLodValueList = *(EarthView::World::Graphic::LodValueList*) materialLodValueList_j;
				const 				EarthView::World::Graphic::CDistanceLodStrategy *pObjectX = (EarthView::World::Graphic::CDistanceLodStrategy*) pObjXXXX;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_DistanceLodStrategy_sort_1MeshLodUsageList(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong meshLodUsageList_j)
			{
				...
				if (typeid(*pObjectX) == typeid(JCDistanceLodStrategyProxy))
				{
					pObjectX->EarthView::World::Graphic::CDistanceLodStrategy::sort(meshLodUsageList);
				}
				else
				{
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_DistanceLodStrategy_register_1sort_1MeshLodUsageList(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCDistanceLodStrategyProxy *pObjectX = (JCDistanceLodStrategyProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_DistanceLodStrategy_sort_1MeshLodUsageList_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong meshLodUsageList_j)
			{
				EarthView::World::Graphic::CMesh::MeshLodUsageList &meshLodUsageList = *(EarthView::World::Graphic::CMesh::MeshLodUsageList*) meshLodUsageList_j;
				const 				EarthView::World::Graphic::CDistanceLodStrategy *pObjectX = (EarthView::World::Graphic::CDistanceLodStrategy*) pObjXXXX;
				pObjectX->EarthView::World::Graphic::CDistanceLodStrategy::sort(meshLodUsageList);
			}
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_graphic_DistanceLodStrategy_isSorted_1LodValueList(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong values_j)
			{
				const EarthView::World::Graphic::LodValueList &values = *(EarthView::World::Graphic::LodValueList*) values_j;
				const 				EarthView::World::Graphic::CDistanceLodStrategy *pObjectX = (EarthView::World::Graphic::CDistanceLodStrategy*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCDistanceLodStrategyProxy))
				{
					ev_bool __values1 = pObjectX->EarthView::World::Graphic::CDistanceLodStrategy::isSorted(values);
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_DistanceLodStrategy_register_1isSorted_1LodValueList(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCDistanceLodStrategyProxy *pObjectX = (JCDistanceLodStrategyProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_graphic_DistanceLodStrategy_isSorted_1LodValueList_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong values_j)
			{
				const EarthView::World::Graphic::LodValueList &values = *(EarthView::World::Graphic::LodValueList*) values_j;
				const 				EarthView::World::Graphic::CDistanceLodStrategy *pObjectX = (EarthView::World::Graphic::CDistanceLodStrategy*) pObjXXXX;
				ev_bool __values1 = pObjectX->EarthView::World::Graphic::CDistanceLodStrategy::isSorted(values);
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_DistanceLodStrategy_setReferenceView_1Real_1Real_1CRadian(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble viewportWidth_j, jdouble viewportHeight_j, jlong fovY_j)
			{
				Real viewportWidth = (Real) viewportWidth_j;
				Real viewportHeight = (Real) viewportHeight_j;
				EarthView::World::Spatial::Math::CRadian fovY = *(EarthView::World::Spatial::Math::CRadian*) fovY_j;
				EarthView::World::Graphic::CDistanceLodStrategy *pObjectX = (EarthView::World::Graphic::CDistanceLodStrategy*) pObjXXXX;
				pObjectX->setReferenceView(viewportWidth, viewportHeight, fovY);
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_DistanceLodStrategy_setReferenceViewEnabled_1ev_1bool(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean value_j)
			{
				ev_bool value = (ev_bool) value_j;
				EarthView::World::Graphic::CDistanceLodStrategy *pObjectX = (EarthView::World::Graphic::CDistanceLodStrategy*) pObjXXXX;
				pObjectX->setReferenceViewEnabled(value);
			}
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_graphic_DistanceLodStrategy_getReferenceViewEnabled_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Graphic::CDistanceLodStrategy *pObjectX = (EarthView::World::Graphic::CDistanceLodStrategy*) pObjXXXX;
				ev_bool __values1 = pObjectX->getReferenceViewEnabled();
				jboolean __values1_j = (jboolean)__values1;
				return __values1_j;
			}
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_graphic_DistanceLodStrategy_getSingleton_1void(JNIEnv *__env , jclass __clazz)
			{
				EarthView::World::Graphic::CDistanceLodStrategy& __values1 = EarthView::World::Graphic::CDistanceLodStrategy::getSingleton();
				jlong __values1_j = (jlong) &__values1;
				return __values1_j;
			}
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_graphic_DistanceLodStrategy_getSingletonPtr_1void(JNIEnv *__env , jclass __clazz)
			{
				EarthView::World::Graphic::CDistanceLodStrategy* __values1 = EarthView::World::Graphic::CDistanceLodStrategy::getSingletonPtr();
				jlong __values1_j = (jlong) __values1;
				return __values1_j;
			}
		}
