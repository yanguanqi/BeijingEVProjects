...
namespace EarthView
{
	namespace World
	{
		namespace Graphic
		{
			class JCDDSCodecProxy : public EarthView::World::Graphic::CDDSCodec
			{
			 private:
			...
			public:
				JCDDSCodecProxy(EarthView::World::Core::CNameValuePairList *pList) : CDDSCodec(pList)
				{
				}
			...
			REGISTER_FACTORY_CLASS(JCDDSCodecProxy);
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_graphic_Ddscodec_code_1MemoryDataStreamPtr_1CodecDataPtr(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong input_j, jlong pData_j)
			{
				...
				const 				EarthView::World::Graphic::CDDSCodec *pObjectX = (EarthView::World::Graphic::CDDSCodec*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCDDSCodecProxy))
				{
					EarthView::World::Core::DataStreamPtr __values1 = pObjectX->EarthView::World::Graphic::CDDSCodec::code(input, pData);
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Ddscodec_register_1code_1MemoryDataStreamPtr_1CodecDataPtr(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCDDSCodecProxy *pObjectX = (JCDDSCodecProxy*) pObjXXXX;
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_graphic_Ddscodec_code_1MemoryDataStreamPtr_1CodecDataPtr_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong input_j, jlong pData_j)
			{
				EarthView::World::Core::MemoryDataStreamPtr &input = *(EarthView::World::Core::MemoryDataStreamPtr*) input_j;
				EarthView::World::Graphic::CCodec::CodecDataPtr &pData = *(EarthView::World::Graphic::CCodec::CodecDataPtr*) pData_j;
				const 				EarthView::World::Graphic::CDDSCodec *pObjectX = (EarthView::World::Graphic::CDDSCodec*) pObjXXXX;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Ddscodec_codeToFile_1MemoryDataStreamPtr_1EVString_1CodecDataPtr(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong input_j, jstring outFileName_j, jlong pData_j)
			{
				EarthView::World::Core::MemoryDataStreamPtr &input = *(EarthView::World::Core::MemoryDataStreamPtr*) input_j;
				#if EV_PLATFORM == EV_PLATFORM_ANDROID
				...
				if (typeid(*pObjectX) == typeid(JCDDSCodecProxy))
				{
					pObjectX->EarthView::World::Graphic::CDDSCodec::codeToFile(input, outFileName, pData);
				}
				else
				{
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Ddscodec_register_1codeToFile_1MemoryDataStreamPtr_1EVString_1CodecDataPtr(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCDDSCodecProxy *pObjectX = (JCDDSCodecProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Ddscodec_codeToFile_1MemoryDataStreamPtr_1EVString_1CodecDataPtr_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong input_j, jstring outFileName_j, jlong pData_j)
			{
				EarthView::World::Core::MemoryDataStreamPtr &input = *(EarthView::World::Core::MemoryDataStreamPtr*) input_j;
				#if EV_PLATFORM == EV_PLATFORM_ANDROID
				const ev_char* outFileName_ch = (const ev_char*)__env->GetStringUTFChars(outFileName_j,JNI_FALSE);
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_graphic_Ddscodec_decode_1DataStreamPtr(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong input_j)
			{
				EarthView::World::Core::DataStreamPtr &input = *(EarthView::World::Core::DataStreamPtr*) input_j;
				const 				EarthView::World::Graphic::CDDSCodec *pObjectX = (EarthView::World::Graphic::CDDSCodec*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCDDSCodecProxy))
				{
					EarthView::World::Graphic::CCodec::DecodeResult __values1 = pObjectX->EarthView::World::Graphic::CDDSCodec::decode(input);
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Ddscodec_register_1decode_1DataStreamPtr(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCDDSCodecProxy *pObjectX = (JCDDSCodecProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_graphic_Ddscodec_decode_1DataStreamPtr_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong input_j)
			{
				EarthView::World::Core::DataStreamPtr &input = *(EarthView::World::Core::DataStreamPtr*) input_j;
				const 				EarthView::World::Graphic::CDDSCodec *pObjectX = (EarthView::World::Graphic::CDDSCodec*) pObjXXXX;
				EarthView::World::Graphic::CCodec::DecodeResult __values1 = pObjectX->EarthView::World::Graphic::CDDSCodec::decode(input);
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_graphic_Ddscodec_decode_1DataStreamPtr_1ev_1bool(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong input_j, jboolean ignoreMipmap_j)
			{
				EarthView::World::Core::DataStreamPtr &input = *(EarthView::World::Core::DataStreamPtr*) input_j;
				ev_bool ignoreMipmap = (ev_bool) ignoreMipmap_j;
				const 				EarthView::World::Graphic::CDDSCodec *pObjectX = (EarthView::World::Graphic::CDDSCodec*) pObjXXXX;
				EarthView::World::Graphic::CCodec::DecodeResult __values1 = pObjectX->decode(input, ignoreMipmap);
				EarthView::World::Graphic::CCodec::DecodeResult *returnvalues = new EarthView::World::Graphic::CCodec::DecodeResult(__values1);
				((EarthView::World::Core::CBaseObject*)returnvalues)->setExternFree(true);
				jlong __values1_j = (jlong) returnvalues;
				return __values1_j;
			}
			extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_graphic_Ddscodec_magicNumberToFileExt_1ev_1char_1ev_1size_1t(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong magicNumberPtr_j, jlong maxbytes_j)
			{
				...
				if (typeid(*pObjectX) == typeid(JCDDSCodecProxy))
				{
					EVString __values1 = pObjectX->EarthView::World::Graphic::CDDSCodec::magicNumberToFileExt(magicNumberPtr, maxbytes);
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Ddscodec_register_1magicNumberToFileExt_1ev_1char_1ev_1size_1t(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCDDSCodecProxy *pObjectX = (JCDDSCodecProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_graphic_Ddscodec_magicNumberToFileExt_1ev_1char_1ev_1size_1t_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong magicNumberPtr_j, jlong maxbytes_j)
			{
				const ev_char *magicNumberPtr = (const ev_char*) magicNumberPtr_j;
				ev_size_t maxbytes = (ev_size_t) maxbytes_j;
				const 				EarthView::World::Graphic::CDDSCodec *pObjectX = (EarthView::World::Graphic::CDDSCodec*) pObjXXXX;
			...
			extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_graphic_Ddscodec_getType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Graphic::CDDSCodec *pObjectX = (EarthView::World::Graphic::CDDSCodec*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCDDSCodecProxy))
				{
					EVString __values1 = pObjectX->EarthView::World::Graphic::CDDSCodec::getType();
					EarthView::World::Core::ev_wstring valuesw1 = __values1;
					jstring __values1_j = __env->NewString((const jchar*)valuesw1.getString(), valuesw1.size());
					return __values1_j;
				}
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Ddscodec_register_1getType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCDDSCodecProxy *pObjectX = (JCDDSCodecProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_graphic_Ddscodec_getType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Graphic::CDDSCodec *pObjectX = (EarthView::World::Graphic::CDDSCodec*) pObjXXXX;
				EVString __values1 = pObjectX->EarthView::World::Graphic::CDDSCodec::getType();
				EarthView::World::Core::ev_wstring valuesw1 = __values1;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Ddscodec_startup_1void(JNIEnv *__env , jclass __clazz)
			{
				EarthView::World::Graphic::CDDSCodec::startup();
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Ddscodec_shutdown_1void(JNIEnv *__env , jclass __clazz)
			{
				EarthView::World::Graphic::CDDSCodec::shutdown();
			}
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_graphic_Ddscodec_encodeImage_1MemoryDataStreamPtr_1ev_1int32_1CImageData(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong input_j, jint dxtFormat_j, jlong imgData_j)
			{
				EarthView::World::Core::MemoryDataStreamPtr &input = *(EarthView::World::Core::MemoryDataStreamPtr*) input_j;
				ev_int32 dxtFormat = (ev_int32) dxtFormat_j;
				EarthView::World::Graphic::CImageCodec::CImageData &imgData = *(EarthView::World::Graphic::CImageCodec::CImageData*) imgData_j;
				EarthView::World::Graphic::CDDSCodec *pObjectX = (EarthView::World::Graphic::CDDSCodec*) pObjXXXX;
				EarthView::World::Core::DataStreamPtr __values1 = pObjectX->encodeImage(input, dxtFormat, imgData);
				EarthView::World::Core::DataStreamPtr *returnvalues = new EarthView::World::Core::DataStreamPtr(__values1);
				((EarthView::World::Core::CBaseObject*)returnvalues)->setExternFree(true);
				jlong __values1_j = (jlong) returnvalues;
				return __values1_j;
			}
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_graphic_Ddscodec_resizeDDS_1DataStreamPtr_1ev_1uint32_1ev_1uint32(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong stream_j, jlong newW_j, jlong newH_j)
			{
				EarthView::World::Core::DataStreamPtr &stream = *(EarthView::World::Core::DataStreamPtr*) stream_j;
				ev_uint32 newW = (ev_uint32) newW_j;
				ev_uint32 newH = (ev_uint32) newH_j;
				const 				EarthView::World::Graphic::CDDSCodec *pObjectX = (EarthView::World::Graphic::CDDSCodec*) pObjXXXX;
				EarthView::World::Core::DataStreamPtr __values1 = pObjectX->resizeDDS(stream, newW, newH);
				EarthView::World::Core::DataStreamPtr *returnvalues = new EarthView::World::Core::DataStreamPtr(__values1);
				((EarthView::World::Core::CBaseObject*)returnvalues)->setExternFree(true);
				jlong __values1_j = (jlong) returnvalues;
				return __values1_j;
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Ddscodec_register_1getDataType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCDDSCodecProxy *pObjectX = (JCDDSCodecProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_Ddscodec_register_1magicNumberMatch_1ev_1char_1ev_1size_1t(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCDDSCodecProxy *pObjectX = (JCDDSCodecProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
