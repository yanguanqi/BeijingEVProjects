...
#include "graphic/instancebatchhw_vtf.h"
#include <jni.h>
...
namespace EarthView
{
	namespace World
	{
		namespace Graphic
		{
			class JCInstanceBatchHW_VTFProxy : public EarthView::World::Graphic::CInstanceBatchHW_VTF
			{
			 private:
			...
			public:
				JCInstanceBatchHW_VTFProxy(EarthView::World::Core::CNameValuePairList *pList) : CInstanceBatchHW_VTF(pList)
				{
				}
			...
			public:
				...
				virtual ev_size_t calculateMaxNumInstances(const EarthView::World::Graphic::CSubMesh* baseSubMesh, ev_uint16 flags) const
				{
					...
					{
						return this->CInstanceBatchHW_VTF::calculateMaxNumInstances(baseSubMesh, flags);
					}
				}
				virtual void _boundsDirty()
				{
					...
					{
						return this->CInstanceBatchHW_VTF::_boundsDirty();
					}
				}
				virtual void setStaticAndUpdate(ev_bool bStatic)
				{
					...
					{
						return this->CInstanceBatchHW_VTF::setStaticAndUpdate(bStatic);
					}
				}
				virtual ev_bool isStatic() const
				{
					...
					{
						return this->CInstanceBatchHW_VTF::isStatic();
					}
				}
				virtual void _updateRenderQueue(EarthView::World::Graphic::CRenderQueue* queue)
				{
					...
					{
						return this->CInstanceBatchHW_VTF::_updateRenderQueue(queue);
					}
				}
				virtual void buildFrom(const EarthView::World::Graphic::CSubMesh* baseSubMesh, const EarthView::World::Graphic::CRenderOperation& renderOperation)
				{
					...
					{
						return this->CInstanceBatchHW_VTF::buildFrom(baseSubMesh, renderOperation);
					}
				}
				virtual void getWorldTransforms(EarthView::World::Spatial::Math::CMatrix4* xform) const
				{
					...
					{
						return this->CInstanceBatchHW_VTF::getWorldTransforms(xform);
					}
				}
				virtual ev_uint16 getNumWorldTransforms() const
				{
					...
					{
						return this->CInstanceBatchHW_VTF::getNumWorldTransforms();
					}
				}
				virtual ev_bool useBoneWorldMatrices() const
				{
					...
					{
						return this->CInstanceBatchHW_VTF::useBoneWorldMatrices();
					}
				}
				virtual ev_size_t getMaxLookupTableInstances() const
				{
					...
					{
						return this->CInstanceBatchHW_VTF::getMaxLookupTableInstances();
					}
				}
				virtual EVString getMovableType() const
				{
					...
					{
						return this->CInstanceBatchHW_VTF::getMovableType();
					}
				}
				virtual void _notifyCurrentCamera(EarthView::World::Graphic::CCamera* ref_cam)
				{
					...
					{
						return this->CInstanceBatchHW_VTF::_notifyCurrentCamera(ref_cam);
					}
				}
				virtual const EarthView::World::Spatial::Math::CAxisAlignedBox& getBoundingBox() const
				{
					...
					{
						return this->CInstanceBatchHW_VTF::getBoundingBox();
					}
				}
				virtual Real getBoundingRadius() const
				{
					...
					{
						return this->CInstanceBatchHW_VTF::getBoundingRadius();
					}
				}
				virtual void visitRenderables(EarthView::World::Graphic::CRenderable::CVisitor* visitor)
				{
					...
					{
						return this->CInstanceBatchHW_VTF::visitRenderables(visitor);
					}
				}
				virtual void visitRenderables(EarthView::World::Graphic::CRenderable::CVisitor* visitor, ev_bool debugRenderables)
				{
					...
					{
						return this->CInstanceBatchHW_VTF::visitRenderables(visitor, debugRenderables);
					}
				}
				virtual void _notifyAttached(EarthView::World::Graphic::CNode* ref_parent, ev_bool isTagPoint)
				{
					...
					{
						return this->CInstanceBatchHW_VTF::_notifyAttached(ref_parent, isTagPoint);
					}
				}
				virtual ev_bool preRender(EarthView::World::Graphic::CSceneManager* sm, EarthView::World::Graphic::CRenderSystem* rsys)
				{
					...
					{
						return this->CInstanceBatchHW_VTF::preRender(sm, rsys);
					}
				}
				virtual void postRender(EarthView::World::Graphic::CSceneManager* sm, EarthView::World::Graphic::CRenderSystem* rsys)
				{
					...
					{
						return this->CInstanceBatchHW_VTF::postRender(sm, rsys);
					}
				}
				virtual ev_bool getReceivesShadows()
				{
					...
					{
						return this->CInstanceBatchHW_VTF::getReceivesShadows();
					}
				}
				virtual ev_bool selectBy(const EarthView::World::Spatial::Math::CRay& ray, const EarthView::World::Graphic::CViewport* viewport, ev_bool prepareToRenderSelection, ev_int32& objIndex, EarthView::World::Spatial::Math::CVector3& point)
				{
					...
					{
						return this->CInstanceBatchHW_VTF::selectBy(ray, viewport, prepareToRenderSelection, objIndex, point);
					}
				}
				virtual ev_bool selectBy(const EarthView::World::Spatial::Math::CAxisAlignedBox& aabb, ev_bool prepareToRenderSelection, EarthView::World::Core::IntVector& indexVec)
				{
					...
					{
						return this->CInstanceBatchHW_VTF::selectBy(aabb, prepareToRenderSelection, indexVec);
					}
				}
				virtual ev_bool selectBy(const EarthView::World::Spatial::Math::CSphere& sphere, ev_bool prepareToRenderSelection, EarthView::World::Core::IntVector& indexVec)
				{
					...
					{
						return this->CInstanceBatchHW_VTF::selectBy(sphere, prepareToRenderSelection, indexVec);
					}
				}
				virtual ev_bool selectComponentBy(const EarthView::World::Spatial::Math::CRay& ray, const EarthView::World::Graphic::CViewport* viewport, ev_bool prepareToRenderSelection, ev_int32& objIndex, ev_int32& submeshIndex, ev_int32& instanceIndex, ev_int32& segmentIndex, EarthView::World::Spatial::Math::CVector3& point)
				{
					...
					{
						return this->CInstanceBatchHW_VTF::selectComponentBy(ray, viewport, prepareToRenderSelection, objIndex, submeshIndex, instanceIndex, segmentIndex, point);
					}
				}
				virtual void renderSelection()
				{
					...
					{
						return this->CInstanceBatchHW_VTF::renderSelection();
					}
				}
				virtual void clearSelection()
				{
					...
					{
						return this->CInstanceBatchHW_VTF::clearSelection();
					}
				}
				virtual ev_bool startEditing(ev_uint32 objectIndex)
				{
					...
					{
						return this->CInstanceBatchHW_VTF::startEditing(objectIndex);
					}
				}
				virtual void endEditing()
				{
					...
					{
						return this->CInstanceBatchHW_VTF::endEditing();
					}
				}
				virtual EarthView::World::Graphic::CEditBoundingBox* getEditBoundingBox()
				{
					...
					{
						return this->CInstanceBatchHW_VTF::getEditBoundingBox();
					}
				}
				virtual ev_bool getSelectedObjectWorldMatrix(ev_uint32 objectIndex, EarthView::World::Spatial::Math::CMatrix4& matrix)
				{
					...
					{
						return this->CInstanceBatchHW_VTF::getSelectedObjectWorldMatrix(objectIndex, matrix);
					}
				}
				virtual ev_bool setSelectedObjectWorldMatrix(ev_uint32 objectIndex, const EarthView::World::Spatial::Math::CMatrix4& matrix)
				{
					...
					{
						return this->CInstanceBatchHW_VTF::setSelectedObjectWorldMatrix(objectIndex, matrix);
					}
				}
				virtual EarthView::World::Graphic::CInstancedEntity* getInstanceEntity(ev_uint32 objectIndex)
				{
					...
					{
						return this->CInstanceBatchHW_VTF::getInstanceEntity(objectIndex);
					}
				}
				virtual EarthView::World::Graphic::CMovableObject* getMovableObject() const
				{
					...
					{
						return this->CInstanceBatchHW_VTF::getMovableObject();
					}
				}
				virtual ev_bool trackParentNode(EarthView::World::Graphic::CNode* pNode)
				{
					...
					{
						return this->CInstanceBatchHW_VTF::trackParentNode(pNode);
					}
				}
				virtual EarthView::World::Graphic::CNode* getTrackingNode() const
				{
					...
					{
						return this->CInstanceBatchHW_VTF::getTrackingNode();
					}
				}
				virtual void onInstancedEntityStateChanged(EarthView::World::Graphic::CInstancedEntity* instancedEntity)
				{
					...
					{
						return this->CInstanceBatchHW_VTF::onInstancedEntityStateChanged(instancedEntity);
					}
				}
				virtual EarthView::World::Graphic::CRenderOperation build(const EarthView::World::Graphic::CSubMesh* baseSubMesh)
				{
					...
					{
						return this->CInstanceBatchHW_VTF::build(baseSubMesh);
					}
				}
				virtual const EarthView::World::Graphic::CMaterialPtr& getMaterial() const
				{
					...
					{
						return this->CInstanceBatchHW_VTF::getMaterial();
					}
				}
				virtual void getRenderOperation(EarthView::World::Graphic::CRenderOperation& op)
				{
					...
					{
						return this->CInstanceBatchHW_VTF::getRenderOperation(op);
					}
				}
				virtual Real getSquaredViewDepth(const EarthView::World::Graphic::CCamera* cam) const
				{
					...
					{
						return this->CInstanceBatchHW_VTF::getSquaredViewDepth(cam);
					}
				}
				virtual const EarthView::World::Graphic::LightList& getLights() const
				{
					...
					{
						return this->CInstanceBatchHW_VTF::getLights();
					}
				}
				virtual EarthView::World::Graphic::CTechnique* getTechnique() const
				{
					...
					{
						return this->CInstanceBatchHW_VTF::getTechnique();
					}
				}
				virtual ev_bool getCastsShadows() const
				{
					...
					{
						return this->CInstanceBatchHW_VTF::getCastsShadows();
					}
				}
				virtual void _updateCustomGpuParameter(const EarthView::World::Graphic::CGpuProgramParameters::CAutoConstantEntry& constantEntry, EarthView::World::Graphic::CGpuProgramParameters* params) const
				{
					...
					{
						return this->CInstanceBatchHW_VTF::_updateCustomGpuParameter(constantEntry, params);
					}
				}
				virtual void setPolygonModeOverrideable(ev_bool override)
				{
					...
					{
						return this->CInstanceBatchHW_VTF::setPolygonModeOverrideable(override);
					}
				}
				virtual ev_bool getPolygonModeOverrideable() const
				{
					...
					{
						return this->CInstanceBatchHW_VTF::getPolygonModeOverrideable();
					}
				}
				virtual void setCustomAmbient(const EarthView::World::Graphic::CColourValue& ambient)
				{
					...
					{
						return this->CInstanceBatchHW_VTF::setCustomAmbient(ambient);
					}
				}
				virtual const EarthView::World::Graphic::CColourValue& getCustomAmbient() const
				{
					...
					{
						return this->CInstanceBatchHW_VTF::getCustomAmbient();
					}
				}
				virtual bool getCustomAmbientEnabled() const
				{
					...
					{
						return this->CInstanceBatchHW_VTF::getCustomAmbientEnabled();
					}
				}
				virtual void setCustomAmbientEnabled(ev_bool enabled)
				{
					...
					{
						return this->CInstanceBatchHW_VTF::setCustomAmbientEnabled(enabled);
					}
				}
				virtual void addListener(EarthView::World::Graphic::CRenderable::CRenderableListener* ref_listener)
				{
					...
					{
						return this->CInstanceBatchHW_VTF::addListener(ref_listener);
					}
				}
				virtual void removeListener(EarthView::World::Graphic::CRenderable::CRenderableListener* listener)
				{
					...
					{
						return this->CInstanceBatchHW_VTF::removeListener(listener);
					}
				}
				virtual ev_bool existListener(EarthView::World::Graphic::CRenderable::CRenderableListener* listener) const
				{
					...
					{
						return this->CInstanceBatchHW_VTF::existListener(listener);
					}
				}
				virtual ev_uint32 getListenerCount() const
				{
					...
					{
						return this->CInstanceBatchHW_VTF::getListenerCount();
					}
				}
				virtual EarthView::World::Graphic::CRenderable::CRenderableListener* getListener(ev_uint32 index) const
				{
					...
					{
						return this->CInstanceBatchHW_VTF::getListener(index);
					}
				}
				virtual EarthView::World::Graphic::CRenderable::CRenderSystemData* getRenderSystemData() const
				{
					...
					{
						return this->CInstanceBatchHW_VTF::getRenderSystemData();
					}
				}
				virtual void setRenderSystemData(EarthView::World::Graphic::CRenderable::CRenderSystemData* ref_val) const
				{
					...
					{
						return this->CInstanceBatchHW_VTF::setRenderSystemData(ref_val);
					}
				}
			};
			REGISTER_FACTORY_CLASS(JCInstanceBatchHW_VTFProxy);
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_graphic_InstanceBatchHWVtf_calculateMaxNumInstances_1CSubMesh_1ev_1uint16(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong baseSubMesh_j, jint flags_j)
			{
				...
				const 				EarthView::World::Graphic::CInstanceBatchHW_VTF *pObjectX = (EarthView::World::Graphic::CInstanceBatchHW_VTF*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCInstanceBatchHW_VTFProxy))
				{
					ev_size_t __values1 = pObjectX->EarthView::World::Graphic::CInstanceBatchHW_VTF::calculateMaxNumInstances(baseSubMesh, flags);
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHWVtf_register_1calculateMaxNumInstances_1CSubMesh_1ev_1uint16(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHW_VTFProxy *pObjectX = (JCInstanceBatchHW_VTFProxy*) pObjXXXX;
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_graphic_InstanceBatchHWVtf_calculateMaxNumInstances_1CSubMesh_1ev_1uint16_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong baseSubMesh_j, jint flags_j)
			{
				const EarthView::World::Graphic::CSubMesh *baseSubMesh = (const EarthView::World::Graphic::CSubMesh*) baseSubMesh_j;
				ev_uint16 flags = (ev_uint16) flags_j;
				const 				EarthView::World::Graphic::CInstanceBatchHW_VTF *pObjectX = (EarthView::World::Graphic::CInstanceBatchHW_VTF*) pObjXXXX;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHWVtf__1boundsDirty_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Graphic::CInstanceBatchHW_VTF *pObjectX = (EarthView::World::Graphic::CInstanceBatchHW_VTF*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCInstanceBatchHW_VTFProxy))
				{
					pObjectX->EarthView::World::Graphic::CInstanceBatchHW_VTF::_boundsDirty();
				}
				else
				{
					pObjectX->_boundsDirty();
				}
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHWVtf_register_1_1boundsDirty_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHW_VTFProxy *pObjectX = (JCInstanceBatchHW_VTFProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHWVtf__1boundsDirty_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Graphic::CInstanceBatchHW_VTF *pObjectX = (EarthView::World::Graphic::CInstanceBatchHW_VTF*) pObjXXXX;
				pObjectX->EarthView::World::Graphic::CInstanceBatchHW_VTF::_boundsDirty();
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHWVtf_setStaticAndUpdate_1ev_1bool(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean bStatic_j)
			{
				ev_bool bStatic = (ev_bool) bStatic_j;
				EarthView::World::Graphic::CInstanceBatchHW_VTF *pObjectX = (EarthView::World::Graphic::CInstanceBatchHW_VTF*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCInstanceBatchHW_VTFProxy))
				{
					pObjectX->EarthView::World::Graphic::CInstanceBatchHW_VTF::setStaticAndUpdate(bStatic);
				}
				else
				{
					pObjectX->setStaticAndUpdate(bStatic);
				}
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHWVtf_register_1setStaticAndUpdate_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHW_VTFProxy *pObjectX = (JCInstanceBatchHW_VTFProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHWVtf_setStaticAndUpdate_1ev_1bool_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean bStatic_j)
			{
				ev_bool bStatic = (ev_bool) bStatic_j;
				EarthView::World::Graphic::CInstanceBatchHW_VTF *pObjectX = (EarthView::World::Graphic::CInstanceBatchHW_VTF*) pObjXXXX;
				pObjectX->EarthView::World::Graphic::CInstanceBatchHW_VTF::setStaticAndUpdate(bStatic);
			}
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_graphic_InstanceBatchHWVtf_isStatic_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Graphic::CInstanceBatchHW_VTF *pObjectX = (EarthView::World::Graphic::CInstanceBatchHW_VTF*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCInstanceBatchHW_VTFProxy))
				{
					ev_bool __values1 = pObjectX->EarthView::World::Graphic::CInstanceBatchHW_VTF::isStatic();
					jboolean __values1_j = (jboolean)__values1;
					return __values1_j;
				}
				else
				{
					ev_bool __values1 = pObjectX->isStatic();
					jboolean __values1_j = (jboolean)__values1;
					return __values1_j;
				}
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHWVtf_register_1isStatic_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHW_VTFProxy *pObjectX = (JCInstanceBatchHW_VTFProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_graphic_InstanceBatchHWVtf_isStatic_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Graphic::CInstanceBatchHW_VTF *pObjectX = (EarthView::World::Graphic::CInstanceBatchHW_VTF*) pObjXXXX;
				ev_bool __values1 = pObjectX->EarthView::World::Graphic::CInstanceBatchHW_VTF::isStatic();
				jboolean __values1_j = (jboolean)__values1;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHWVtf__1updateRenderQueue_1CRenderQueue(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong queue_j)
			{
				EarthView::World::Graphic::CRenderQueue *queue = (EarthView::World::Graphic::CRenderQueue*) queue_j;
				EarthView::World::Graphic::CInstanceBatchHW_VTF *pObjectX = (EarthView::World::Graphic::CInstanceBatchHW_VTF*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCInstanceBatchHW_VTFProxy))
				{
					pObjectX->EarthView::World::Graphic::CInstanceBatchHW_VTF::_updateRenderQueue(queue);
				}
				else
				{
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHWVtf_register_1_1updateRenderQueue_1CRenderQueue(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHW_VTFProxy *pObjectX = (JCInstanceBatchHW_VTFProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHWVtf__1updateRenderQueue_1CRenderQueue_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong queue_j)
			{
				EarthView::World::Graphic::CRenderQueue *queue = (EarthView::World::Graphic::CRenderQueue*) queue_j;
				EarthView::World::Graphic::CInstanceBatchHW_VTF *pObjectX = (EarthView::World::Graphic::CInstanceBatchHW_VTF*) pObjXXXX;
				pObjectX->EarthView::World::Graphic::CInstanceBatchHW_VTF::_updateRenderQueue(queue);
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHWVtf_register_1getMaxLookupTableInstances_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHW_VTFProxy *pObjectX = (JCInstanceBatchHW_VTFProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHWVtf_register_1getMovableType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHW_VTFProxy *pObjectX = (JCInstanceBatchHW_VTFProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHWVtf_register_1_1notifyCurrentCamera_1CCamera(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHW_VTFProxy *pObjectX = (JCInstanceBatchHW_VTFProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHWVtf_register_1getBoundingBox_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHW_VTFProxy *pObjectX = (JCInstanceBatchHW_VTFProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHWVtf_register_1getBoundingRadius_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHW_VTFProxy *pObjectX = (JCInstanceBatchHW_VTFProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHWVtf_register_1visitRenderables_1CVisitor(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHW_VTFProxy *pObjectX = (JCInstanceBatchHW_VTFProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHWVtf_register_1visitRenderables_1CVisitor_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHW_VTFProxy *pObjectX = (JCInstanceBatchHW_VTFProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHWVtf_register_1_1notifyAttached_1CNode_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHW_VTFProxy *pObjectX = (JCInstanceBatchHW_VTFProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHWVtf_register_1getReceivesShadows_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHW_VTFProxy *pObjectX = (JCInstanceBatchHW_VTFProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHWVtf_register_1selectBy_1CRay_1CViewport_1ev_1bool_1ev_1int32_1CVector3(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHW_VTFProxy *pObjectX = (JCInstanceBatchHW_VTFProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHWVtf_register_1selectBy_1CAxisAlignedBox_1ev_1bool_1IntVector(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHW_VTFProxy *pObjectX = (JCInstanceBatchHW_VTFProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHWVtf_register_1selectBy_1CSphere_1ev_1bool_1IntVector(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHW_VTFProxy *pObjectX = (JCInstanceBatchHW_VTFProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHWVtf_register_1selectComponentBy_1CRay_1CViewport_1ev_1bool_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32_1CVector3(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHW_VTFProxy *pObjectX = (JCInstanceBatchHW_VTFProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHWVtf_register_1renderSelection_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHW_VTFProxy *pObjectX = (JCInstanceBatchHW_VTFProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHWVtf_register_1clearSelection_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHW_VTFProxy *pObjectX = (JCInstanceBatchHW_VTFProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHWVtf_register_1startEditing_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHW_VTFProxy *pObjectX = (JCInstanceBatchHW_VTFProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHWVtf_register_1endEditing_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHW_VTFProxy *pObjectX = (JCInstanceBatchHW_VTFProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHWVtf_register_1getEditBoundingBox_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHW_VTFProxy *pObjectX = (JCInstanceBatchHW_VTFProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHWVtf_register_1getSelectedObjectWorldMatrix_1ev_1uint32_1CMatrix4(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHW_VTFProxy *pObjectX = (JCInstanceBatchHW_VTFProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHWVtf_register_1setSelectedObjectWorldMatrix_1ev_1uint32_1CMatrix4(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHW_VTFProxy *pObjectX = (JCInstanceBatchHW_VTFProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHWVtf_register_1getInstanceEntity_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHW_VTFProxy *pObjectX = (JCInstanceBatchHW_VTFProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHWVtf_register_1trackParentNode_1CNode(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHW_VTFProxy *pObjectX = (JCInstanceBatchHW_VTFProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHWVtf_register_1getTrackingNode_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHW_VTFProxy *pObjectX = (JCInstanceBatchHW_VTFProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHWVtf_register_1onInstancedEntityStateChanged_1CInstancedEntity(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHW_VTFProxy *pObjectX = (JCInstanceBatchHW_VTFProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHWVtf_register_1build_1CSubMesh(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHW_VTFProxy *pObjectX = (JCInstanceBatchHW_VTFProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHWVtf_register_1buildFrom_1CSubMesh_1CRenderOperation(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHW_VTFProxy *pObjectX = (JCInstanceBatchHW_VTFProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHWVtf_register_1useBoneWorldMatrices_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHW_VTFProxy *pObjectX = (JCInstanceBatchHW_VTFProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHWVtf_register_1getMaterial_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHW_VTFProxy *pObjectX = (JCInstanceBatchHW_VTFProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHWVtf_register_1getTechnique_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHW_VTFProxy *pObjectX = (JCInstanceBatchHW_VTFProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHWVtf_register_1getRenderOperation_1CRenderOperation(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHW_VTFProxy *pObjectX = (JCInstanceBatchHW_VTFProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHWVtf_register_1preRender_1CSceneManager_1CRenderSystem(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHW_VTFProxy *pObjectX = (JCInstanceBatchHW_VTFProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHWVtf_register_1postRender_1CSceneManager_1CRenderSystem(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHW_VTFProxy *pObjectX = (JCInstanceBatchHW_VTFProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHWVtf_register_1getWorldTransforms_1CMatrix4(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHW_VTFProxy *pObjectX = (JCInstanceBatchHW_VTFProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHWVtf_register_1getNumWorldTransforms_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHW_VTFProxy *pObjectX = (JCInstanceBatchHW_VTFProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHWVtf_register_1getSquaredViewDepth_1CCamera(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHW_VTFProxy *pObjectX = (JCInstanceBatchHW_VTFProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHWVtf_register_1getLights_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHW_VTFProxy *pObjectX = (JCInstanceBatchHW_VTFProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHWVtf_register_1getCastsShadows_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHW_VTFProxy *pObjectX = (JCInstanceBatchHW_VTFProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHWVtf_register_1_1updateCustomGpuParameter_1CAutoConstantEntry_1CGpuProgramParameters(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHW_VTFProxy *pObjectX = (JCInstanceBatchHW_VTFProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHWVtf_register_1setPolygonModeOverrideable_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHW_VTFProxy *pObjectX = (JCInstanceBatchHW_VTFProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHWVtf_register_1getPolygonModeOverrideable_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHW_VTFProxy *pObjectX = (JCInstanceBatchHW_VTFProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHWVtf_register_1setCustomAmbient_1CColourValue(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHW_VTFProxy *pObjectX = (JCInstanceBatchHW_VTFProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHWVtf_register_1getCustomAmbient_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHW_VTFProxy *pObjectX = (JCInstanceBatchHW_VTFProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHWVtf_register_1getCustomAmbientEnabled_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHW_VTFProxy *pObjectX = (JCInstanceBatchHW_VTFProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHWVtf_register_1setCustomAmbientEnabled_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHW_VTFProxy *pObjectX = (JCInstanceBatchHW_VTFProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHWVtf_register_1getMovableObject_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHW_VTFProxy *pObjectX = (JCInstanceBatchHW_VTFProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHWVtf_register_1addListener_1CRenderableListener(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHW_VTFProxy *pObjectX = (JCInstanceBatchHW_VTFProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHWVtf_register_1removeListener_1CRenderableListener(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHW_VTFProxy *pObjectX = (JCInstanceBatchHW_VTFProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHWVtf_register_1existListener_1CRenderableListener(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHW_VTFProxy *pObjectX = (JCInstanceBatchHW_VTFProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHWVtf_register_1getListenerCount_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHW_VTFProxy *pObjectX = (JCInstanceBatchHW_VTFProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHWVtf_register_1getListener_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHW_VTFProxy *pObjectX = (JCInstanceBatchHW_VTFProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHWVtf_register_1getRenderSystemData_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHW_VTFProxy *pObjectX = (JCInstanceBatchHW_VTFProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHWVtf_register_1setRenderSystemData_1CRenderSystemData(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHW_VTFProxy *pObjectX = (JCInstanceBatchHW_VTFProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
