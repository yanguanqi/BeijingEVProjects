...
#include "graphic/instancebatchhw.h"
#include <jni.h>
...
namespace EarthView
{
	namespace World
	{
		namespace Graphic
		{
			class JCInstanceBatchHWProxy : public EarthView::World::Graphic::CInstanceBatchHW
			{
			 private:
			...
			public:
				JCInstanceBatchHWProxy(EarthView::World::Core::CNameValuePairList *pList) : CInstanceBatchHW(pList)
				{
				}
			...
			public:
				...
				virtual ev_size_t calculateMaxNumInstances(const EarthView::World::Graphic::CSubMesh* baseSubMesh, ev_uint16 flags) const
				{
					...
					{
						return this->CInstanceBatchHW::calculateMaxNumInstances(baseSubMesh, flags);
					}
				}
				virtual void buildFrom(const EarthView::World::Graphic::CSubMesh* baseSubMesh, const EarthView::World::Graphic::CRenderOperation& renderOperation)
				{
					...
					{
						return this->CInstanceBatchHW::buildFrom(baseSubMesh, renderOperation);
					}
				}
				virtual void _boundsDirty()
				{
					...
					{
						return this->CInstanceBatchHW::_boundsDirty();
					}
				}
				virtual void setStaticAndUpdate(ev_bool bStatic)
				{
					...
					{
						return this->CInstanceBatchHW::setStaticAndUpdate(bStatic);
					}
				}
				virtual ev_bool isStatic() const
				{
					...
					{
						return this->CInstanceBatchHW::isStatic();
					}
				}
				virtual void getWorldTransforms(EarthView::World::Spatial::Math::CMatrix4* xform) const
				{
					...
					{
						return this->CInstanceBatchHW::getWorldTransforms(xform);
					}
				}
				virtual ev_uint16 getNumWorldTransforms() const
				{
					...
					{
						return this->CInstanceBatchHW::getNumWorldTransforms();
					}
				}
				virtual void _updateRenderQueue(EarthView::World::Graphic::CRenderQueue* queue)
				{
					...
					{
						return this->CInstanceBatchHW::_updateRenderQueue(queue);
					}
				}
				virtual void getRenderOperation(EarthView::World::Graphic::CRenderOperation& op)
				{
					...
					{
						return this->CInstanceBatchHW::getRenderOperation(op);
					}
				}
				virtual const EarthView::World::Spatial::Math::CAxisAlignedBox& getBoundingBox() const
				{
					...
					{
						return this->CInstanceBatchHW::getBoundingBox();
					}
				}
				virtual ev_bool trackParentNode(EarthView::World::Graphic::CNode* pNode)
				{
					...
					{
						return this->CInstanceBatchHW::trackParentNode(pNode);
					}
				}
				virtual EarthView::World::Graphic::CNode* getTrackingNode() const
				{
					...
					{
						return this->CInstanceBatchHW::getTrackingNode();
					}
				}
				virtual void onInstancedEntityStateChanged(EarthView::World::Graphic::CInstancedEntity* instancedEntity)
				{
					...
					{
						return this->CInstanceBatchHW::onInstancedEntityStateChanged(instancedEntity);
					}
				}
				virtual EVString getMovableType() const
				{
					...
					{
						return this->CInstanceBatchHW::getMovableType();
					}
				}
				virtual void _notifyCurrentCamera(EarthView::World::Graphic::CCamera* ref_cam)
				{
					...
					{
						return this->CInstanceBatchHW::_notifyCurrentCamera(ref_cam);
					}
				}
				virtual Real getBoundingRadius() const
				{
					...
					{
						return this->CInstanceBatchHW::getBoundingRadius();
					}
				}
				virtual void visitRenderables(EarthView::World::Graphic::CRenderable::CVisitor* visitor)
				{
					...
					{
						return this->CInstanceBatchHW::visitRenderables(visitor);
					}
				}
				virtual void visitRenderables(EarthView::World::Graphic::CRenderable::CVisitor* visitor, ev_bool debugRenderables)
				{
					...
					{
						return this->CInstanceBatchHW::visitRenderables(visitor, debugRenderables);
					}
				}
				virtual void _notifyAttached(EarthView::World::Graphic::CNode* ref_parent, ev_bool isTagPoint)
				{
					...
					{
						return this->CInstanceBatchHW::_notifyAttached(ref_parent, isTagPoint);
					}
				}
				virtual ev_bool preRender(EarthView::World::Graphic::CSceneManager* sm, EarthView::World::Graphic::CRenderSystem* rsys)
				{
					...
					{
						return this->CInstanceBatchHW::preRender(sm, rsys);
					}
				}
				virtual void postRender(EarthView::World::Graphic::CSceneManager* sm, EarthView::World::Graphic::CRenderSystem* rsys)
				{
					...
					{
						return this->CInstanceBatchHW::postRender(sm, rsys);
					}
				}
				virtual ev_bool getReceivesShadows()
				{
					...
					{
						return this->CInstanceBatchHW::getReceivesShadows();
					}
				}
				virtual ev_bool selectBy(const EarthView::World::Spatial::Math::CRay& ray, const EarthView::World::Graphic::CViewport* viewport, ev_bool prepareToRenderSelection, ev_int32& objIndex, EarthView::World::Spatial::Math::CVector3& point)
				{
					...
					{
						return this->CInstanceBatchHW::selectBy(ray, viewport, prepareToRenderSelection, objIndex, point);
					}
				}
				virtual ev_bool selectBy(const EarthView::World::Spatial::Math::CAxisAlignedBox& aabb, ev_bool prepareToRenderSelection, EarthView::World::Core::IntVector& indexVec)
				{
					...
					{
						return this->CInstanceBatchHW::selectBy(aabb, prepareToRenderSelection, indexVec);
					}
				}
				virtual ev_bool selectBy(const EarthView::World::Spatial::Math::CSphere& sphere, ev_bool prepareToRenderSelection, EarthView::World::Core::IntVector& indexVec)
				{
					...
					{
						return this->CInstanceBatchHW::selectBy(sphere, prepareToRenderSelection, indexVec);
					}
				}
				virtual ev_bool selectComponentBy(const EarthView::World::Spatial::Math::CRay& ray, const EarthView::World::Graphic::CViewport* viewport, ev_bool prepareToRenderSelection, ev_int32& objIndex, ev_int32& submeshIndex, ev_int32& instanceIndex, ev_int32& segmentIndex, EarthView::World::Spatial::Math::CVector3& point)
				{
					...
					{
						return this->CInstanceBatchHW::selectComponentBy(ray, viewport, prepareToRenderSelection, objIndex, submeshIndex, instanceIndex, segmentIndex, point);
					}
				}
				virtual void renderSelection()
				{
					...
					{
						return this->CInstanceBatchHW::renderSelection();
					}
				}
				virtual void clearSelection()
				{
					...
					{
						return this->CInstanceBatchHW::clearSelection();
					}
				}
				virtual ev_bool startEditing(ev_uint32 objectIndex)
				{
					...
					{
						return this->CInstanceBatchHW::startEditing(objectIndex);
					}
				}
				virtual void endEditing()
				{
					...
					{
						return this->CInstanceBatchHW::endEditing();
					}
				}
				virtual EarthView::World::Graphic::CEditBoundingBox* getEditBoundingBox()
				{
					...
					{
						return this->CInstanceBatchHW::getEditBoundingBox();
					}
				}
				virtual ev_bool getSelectedObjectWorldMatrix(ev_uint32 objectIndex, EarthView::World::Spatial::Math::CMatrix4& matrix)
				{
					...
					{
						return this->CInstanceBatchHW::getSelectedObjectWorldMatrix(objectIndex, matrix);
					}
				}
				virtual ev_bool setSelectedObjectWorldMatrix(ev_uint32 objectIndex, const EarthView::World::Spatial::Math::CMatrix4& matrix)
				{
					...
					{
						return this->CInstanceBatchHW::setSelectedObjectWorldMatrix(objectIndex, matrix);
					}
				}
				virtual EarthView::World::Graphic::CInstancedEntity* getInstanceEntity(ev_uint32 objectIndex)
				{
					...
					{
						return this->CInstanceBatchHW::getInstanceEntity(objectIndex);
					}
				}
				virtual EarthView::World::Graphic::CMovableObject* getMovableObject() const
				{
					...
					{
						return this->CInstanceBatchHW::getMovableObject();
					}
				}
				virtual EarthView::World::Graphic::CRenderOperation build(const EarthView::World::Graphic::CSubMesh* baseSubMesh)
				{
					...
					{
						return this->CInstanceBatchHW::build(baseSubMesh);
					}
				}
				virtual ev_bool useBoneWorldMatrices() const
				{
					...
					{
						return this->CInstanceBatchHW::useBoneWorldMatrices();
					}
				}
				virtual const EarthView::World::Graphic::CMaterialPtr& getMaterial() const
				{
					...
					{
						return this->CInstanceBatchHW::getMaterial();
					}
				}
				virtual Real getSquaredViewDepth(const EarthView::World::Graphic::CCamera* cam) const
				{
					...
					{
						return this->CInstanceBatchHW::getSquaredViewDepth(cam);
					}
				}
				virtual const EarthView::World::Graphic::LightList& getLights() const
				{
					...
					{
						return this->CInstanceBatchHW::getLights();
					}
				}
				virtual EarthView::World::Graphic::CTechnique* getTechnique() const
				{
					...
					{
						return this->CInstanceBatchHW::getTechnique();
					}
				}
				virtual ev_bool getCastsShadows() const
				{
					...
					{
						return this->CInstanceBatchHW::getCastsShadows();
					}
				}
				virtual void _updateCustomGpuParameter(const EarthView::World::Graphic::CGpuProgramParameters::CAutoConstantEntry& constantEntry, EarthView::World::Graphic::CGpuProgramParameters* params) const
				{
					...
					{
						return this->CInstanceBatchHW::_updateCustomGpuParameter(constantEntry, params);
					}
				}
				virtual void setPolygonModeOverrideable(ev_bool override)
				{
					...
					{
						return this->CInstanceBatchHW::setPolygonModeOverrideable(override);
					}
				}
				virtual ev_bool getPolygonModeOverrideable() const
				{
					...
					{
						return this->CInstanceBatchHW::getPolygonModeOverrideable();
					}
				}
				virtual void setCustomAmbient(const EarthView::World::Graphic::CColourValue& ambient)
				{
					...
					{
						return this->CInstanceBatchHW::setCustomAmbient(ambient);
					}
				}
				virtual const EarthView::World::Graphic::CColourValue& getCustomAmbient() const
				{
					...
					{
						return this->CInstanceBatchHW::getCustomAmbient();
					}
				}
				virtual bool getCustomAmbientEnabled() const
				{
					...
					{
						return this->CInstanceBatchHW::getCustomAmbientEnabled();
					}
				}
				virtual void setCustomAmbientEnabled(ev_bool enabled)
				{
					...
					{
						return this->CInstanceBatchHW::setCustomAmbientEnabled(enabled);
					}
				}
				virtual void addListener(EarthView::World::Graphic::CRenderable::CRenderableListener* ref_listener)
				{
					...
					{
						return this->CInstanceBatchHW::addListener(ref_listener);
					}
				}
				virtual void removeListener(EarthView::World::Graphic::CRenderable::CRenderableListener* listener)
				{
					...
					{
						return this->CInstanceBatchHW::removeListener(listener);
					}
				}
				virtual ev_bool existListener(EarthView::World::Graphic::CRenderable::CRenderableListener* listener) const
				{
					...
					{
						return this->CInstanceBatchHW::existListener(listener);
					}
				}
				virtual ev_uint32 getListenerCount() const
				{
					...
					{
						return this->CInstanceBatchHW::getListenerCount();
					}
				}
				virtual EarthView::World::Graphic::CRenderable::CRenderableListener* getListener(ev_uint32 index) const
				{
					...
					{
						return this->CInstanceBatchHW::getListener(index);
					}
				}
				virtual EarthView::World::Graphic::CRenderable::CRenderSystemData* getRenderSystemData() const
				{
					...
					{
						return this->CInstanceBatchHW::getRenderSystemData();
					}
				}
				virtual void setRenderSystemData(EarthView::World::Graphic::CRenderable::CRenderSystemData* ref_val) const
				{
					...
					{
						return this->CInstanceBatchHW::setRenderSystemData(ref_val);
					}
				}
			};
			REGISTER_FACTORY_CLASS(JCInstanceBatchHWProxy);
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_calculateMaxNumInstances_1CSubMesh_1ev_1uint16(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong baseSubMesh_j, jint flags_j)
			{
				...
				const 				EarthView::World::Graphic::CInstanceBatchHW *pObjectX = (EarthView::World::Graphic::CInstanceBatchHW*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCInstanceBatchHWProxy))
				{
					ev_size_t __values1 = pObjectX->EarthView::World::Graphic::CInstanceBatchHW::calculateMaxNumInstances(baseSubMesh, flags);
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_register_1calculateMaxNumInstances_1CSubMesh_1ev_1uint16(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHWProxy *pObjectX = (JCInstanceBatchHWProxy*) pObjXXXX;
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_calculateMaxNumInstances_1CSubMesh_1ev_1uint16_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong baseSubMesh_j, jint flags_j)
			{
				const EarthView::World::Graphic::CSubMesh *baseSubMesh = (const EarthView::World::Graphic::CSubMesh*) baseSubMesh_j;
				ev_uint16 flags = (ev_uint16) flags_j;
				const 				EarthView::World::Graphic::CInstanceBatchHW *pObjectX = (EarthView::World::Graphic::CInstanceBatchHW*) pObjXXXX;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_buildFrom_1CSubMesh_1CRenderOperation(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong baseSubMesh_j, jlong renderOperation_j)
			{
				const EarthView::World::Graphic::CSubMesh *baseSubMesh = (const EarthView::World::Graphic::CSubMesh*) baseSubMesh_j;
				...
				EarthView::World::Graphic::CInstanceBatchHW *pObjectX = (EarthView::World::Graphic::CInstanceBatchHW*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCInstanceBatchHWProxy))
				{
					pObjectX->EarthView::World::Graphic::CInstanceBatchHW::buildFrom(baseSubMesh, renderOperation);
				}
				else
				{
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_register_1buildFrom_1CSubMesh_1CRenderOperation(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHWProxy *pObjectX = (JCInstanceBatchHWProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_buildFrom_1CSubMesh_1CRenderOperation_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong baseSubMesh_j, jlong renderOperation_j)
			{
				const EarthView::World::Graphic::CSubMesh *baseSubMesh = (const EarthView::World::Graphic::CSubMesh*) baseSubMesh_j;
				const EarthView::World::Graphic::CRenderOperation &renderOperation = *(EarthView::World::Graphic::CRenderOperation*) renderOperation_j;
				EarthView::World::Graphic::CInstanceBatchHW *pObjectX = (EarthView::World::Graphic::CInstanceBatchHW*) pObjXXXX;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW__1boundsDirty_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Graphic::CInstanceBatchHW *pObjectX = (EarthView::World::Graphic::CInstanceBatchHW*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCInstanceBatchHWProxy))
				{
					pObjectX->EarthView::World::Graphic::CInstanceBatchHW::_boundsDirty();
				}
				else
				{
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_register_1_1boundsDirty_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHWProxy *pObjectX = (JCInstanceBatchHWProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW__1boundsDirty_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Graphic::CInstanceBatchHW *pObjectX = (EarthView::World::Graphic::CInstanceBatchHW*) pObjXXXX;
				pObjectX->EarthView::World::Graphic::CInstanceBatchHW::_boundsDirty();
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_setStaticAndUpdate_1ev_1bool(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean bStatic_j)
			{
				ev_bool bStatic = (ev_bool) bStatic_j;
				EarthView::World::Graphic::CInstanceBatchHW *pObjectX = (EarthView::World::Graphic::CInstanceBatchHW*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCInstanceBatchHWProxy))
				{
					pObjectX->EarthView::World::Graphic::CInstanceBatchHW::setStaticAndUpdate(bStatic);
				}
				else
				{
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_register_1setStaticAndUpdate_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHWProxy *pObjectX = (JCInstanceBatchHWProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_setStaticAndUpdate_1ev_1bool_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean bStatic_j)
			{
				ev_bool bStatic = (ev_bool) bStatic_j;
				EarthView::World::Graphic::CInstanceBatchHW *pObjectX = (EarthView::World::Graphic::CInstanceBatchHW*) pObjXXXX;
				pObjectX->EarthView::World::Graphic::CInstanceBatchHW::setStaticAndUpdate(bStatic);
			}
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_isStatic_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Graphic::CInstanceBatchHW *pObjectX = (EarthView::World::Graphic::CInstanceBatchHW*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCInstanceBatchHWProxy))
				{
					ev_bool __values1 = pObjectX->EarthView::World::Graphic::CInstanceBatchHW::isStatic();
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_register_1isStatic_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHWProxy *pObjectX = (JCInstanceBatchHWProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_isStatic_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Graphic::CInstanceBatchHW *pObjectX = (EarthView::World::Graphic::CInstanceBatchHW*) pObjXXXX;
				ev_bool __values1 = pObjectX->EarthView::World::Graphic::CInstanceBatchHW::isStatic();
				jboolean __values1_j = (jboolean)__values1;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_getWorldTransforms_1CMatrix4(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong xform_j)
			{
				EarthView::World::Spatial::Math::CMatrix4 *xform = (EarthView::World::Spatial::Math::CMatrix4*) xform_j;
				const 				EarthView::World::Graphic::CInstanceBatchHW *pObjectX = (EarthView::World::Graphic::CInstanceBatchHW*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCInstanceBatchHWProxy))
				{
					pObjectX->EarthView::World::Graphic::CInstanceBatchHW::getWorldTransforms(xform);
				}
				else
				{
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_register_1getWorldTransforms_1CMatrix4(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHWProxy *pObjectX = (JCInstanceBatchHWProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_getWorldTransforms_1CMatrix4_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong xform_j)
			{
				EarthView::World::Spatial::Math::CMatrix4 *xform = (EarthView::World::Spatial::Math::CMatrix4*) xform_j;
				const 				EarthView::World::Graphic::CInstanceBatchHW *pObjectX = (EarthView::World::Graphic::CInstanceBatchHW*) pObjXXXX;
				pObjectX->EarthView::World::Graphic::CInstanceBatchHW::getWorldTransforms(xform);
			}
			extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_getNumWorldTransforms_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Graphic::CInstanceBatchHW *pObjectX = (EarthView::World::Graphic::CInstanceBatchHW*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCInstanceBatchHWProxy))
				{
					ev_uint16 __values1 = pObjectX->EarthView::World::Graphic::CInstanceBatchHW::getNumWorldTransforms();
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_register_1getNumWorldTransforms_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHWProxy *pObjectX = (JCInstanceBatchHWProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_getNumWorldTransforms_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Graphic::CInstanceBatchHW *pObjectX = (EarthView::World::Graphic::CInstanceBatchHW*) pObjXXXX;
				ev_uint16 __values1 = pObjectX->EarthView::World::Graphic::CInstanceBatchHW::getNumWorldTransforms();
				jint __values1_j = (jint) __values1;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW__1updateRenderQueue_1CRenderQueue(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong queue_j)
			{
				EarthView::World::Graphic::CRenderQueue *queue = (EarthView::World::Graphic::CRenderQueue*) queue_j;
				EarthView::World::Graphic::CInstanceBatchHW *pObjectX = (EarthView::World::Graphic::CInstanceBatchHW*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCInstanceBatchHWProxy))
				{
					pObjectX->EarthView::World::Graphic::CInstanceBatchHW::_updateRenderQueue(queue);
				}
				else
				{
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_register_1_1updateRenderQueue_1CRenderQueue(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHWProxy *pObjectX = (JCInstanceBatchHWProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW__1updateRenderQueue_1CRenderQueue_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong queue_j)
			{
				EarthView::World::Graphic::CRenderQueue *queue = (EarthView::World::Graphic::CRenderQueue*) queue_j;
				EarthView::World::Graphic::CInstanceBatchHW *pObjectX = (EarthView::World::Graphic::CInstanceBatchHW*) pObjXXXX;
				pObjectX->EarthView::World::Graphic::CInstanceBatchHW::_updateRenderQueue(queue);
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_getRenderOperation_1CRenderOperation(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong op_j)
			{
				EarthView::World::Graphic::CRenderOperation &op = *(EarthView::World::Graphic::CRenderOperation*) op_j;
				EarthView::World::Graphic::CInstanceBatchHW *pObjectX = (EarthView::World::Graphic::CInstanceBatchHW*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCInstanceBatchHWProxy))
				{
					pObjectX->EarthView::World::Graphic::CInstanceBatchHW::getRenderOperation(op);
				}
				else
				{
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_register_1getRenderOperation_1CRenderOperation(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHWProxy *pObjectX = (JCInstanceBatchHWProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_getRenderOperation_1CRenderOperation_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong op_j)
			{
				EarthView::World::Graphic::CRenderOperation &op = *(EarthView::World::Graphic::CRenderOperation*) op_j;
				EarthView::World::Graphic::CInstanceBatchHW *pObjectX = (EarthView::World::Graphic::CInstanceBatchHW*) pObjXXXX;
				pObjectX->EarthView::World::Graphic::CInstanceBatchHW::getRenderOperation(op);
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_prepareMatrixBuffer_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Graphic::CInstanceBatchHW *pObjectX = (EarthView::World::Graphic::CInstanceBatchHW*) pObjXXXX;
				pObjectX->prepareMatrixBuffer();
			}
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_getBoundingBox_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Graphic::CInstanceBatchHW *pObjectX = (EarthView::World::Graphic::CInstanceBatchHW*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCInstanceBatchHWProxy))
				{
					const EarthView::World::Spatial::Math::CAxisAlignedBox& __values1 = pObjectX->EarthView::World::Graphic::CInstanceBatchHW::getBoundingBox();
					jlong __values1_j = (jlong) &__values1;
					return __values1_j;
				}
				else
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_register_1getBoundingBox_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHWProxy *pObjectX = (JCInstanceBatchHWProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_getBoundingBox_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Graphic::CInstanceBatchHW *pObjectX = (EarthView::World::Graphic::CInstanceBatchHW*) pObjXXXX;
				const EarthView::World::Spatial::Math::CAxisAlignedBox& __values1 = pObjectX->EarthView::World::Graphic::CInstanceBatchHW::getBoundingBox();
				jlong __values1_j = (jlong) &__values1;
			...
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_trackParentNode_1CNode(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong pNode_j)
			{
				EarthView::World::Graphic::CNode *pNode = (EarthView::World::Graphic::CNode*) pNode_j;
				EarthView::World::Graphic::CInstanceBatchHW *pObjectX = (EarthView::World::Graphic::CInstanceBatchHW*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCInstanceBatchHWProxy))
				{
					ev_bool __values1 = pObjectX->EarthView::World::Graphic::CInstanceBatchHW::trackParentNode(pNode);
					jboolean __values1_j = (jboolean)__values1;
					return __values1_j;
				}
				else
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_register_1trackParentNode_1CNode(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHWProxy *pObjectX = (JCInstanceBatchHWProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_trackParentNode_1CNode_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong pNode_j)
			{
				EarthView::World::Graphic::CNode *pNode = (EarthView::World::Graphic::CNode*) pNode_j;
				EarthView::World::Graphic::CInstanceBatchHW *pObjectX = (EarthView::World::Graphic::CInstanceBatchHW*) pObjXXXX;
				ev_bool __values1 = pObjectX->EarthView::World::Graphic::CInstanceBatchHW::trackParentNode(pNode);
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_getTrackingNode_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Graphic::CInstanceBatchHW *pObjectX = (EarthView::World::Graphic::CInstanceBatchHW*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCInstanceBatchHWProxy))
				{
					EarthView::World::Graphic::CNode* __values1 = pObjectX->EarthView::World::Graphic::CInstanceBatchHW::getTrackingNode();
					jlong __values1_j = (jlong) __values1;
					return __values1_j;
				}
				else
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_register_1getTrackingNode_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHWProxy *pObjectX = (JCInstanceBatchHWProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_getTrackingNode_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Graphic::CInstanceBatchHW *pObjectX = (EarthView::World::Graphic::CInstanceBatchHW*) pObjXXXX;
				EarthView::World::Graphic::CNode* __values1 = pObjectX->EarthView::World::Graphic::CInstanceBatchHW::getTrackingNode();
				jlong __values1_j = (jlong) __values1;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_onInstancedEntityStateChanged_1CInstancedEntity(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong instancedEntity_j)
			{
				EarthView::World::Graphic::CInstancedEntity *instancedEntity = (EarthView::World::Graphic::CInstancedEntity*) instancedEntity_j;
				EarthView::World::Graphic::CInstanceBatchHW *pObjectX = (EarthView::World::Graphic::CInstanceBatchHW*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCInstanceBatchHWProxy))
				{
					pObjectX->EarthView::World::Graphic::CInstanceBatchHW::onInstancedEntityStateChanged(instancedEntity);
				}
				else
				{
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_register_1onInstancedEntityStateChanged_1CInstancedEntity(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHWProxy *pObjectX = (JCInstanceBatchHWProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_onInstancedEntityStateChanged_1CInstancedEntity_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong instancedEntity_j)
			{
				EarthView::World::Graphic::CInstancedEntity *instancedEntity = (EarthView::World::Graphic::CInstancedEntity*) instancedEntity_j;
				EarthView::World::Graphic::CInstanceBatchHW *pObjectX = (EarthView::World::Graphic::CInstanceBatchHW*) pObjXXXX;
				pObjectX->EarthView::World::Graphic::CInstanceBatchHW::onInstancedEntityStateChanged(instancedEntity);
			}
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_linkEntity_1CEntity(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong pEntity_j)
			{
				EarthView::World::Graphic::CEntity *pEntity = (EarthView::World::Graphic::CEntity*) pEntity_j;
				EarthView::World::Graphic::CInstanceBatchHW *pObjectX = (EarthView::World::Graphic::CInstanceBatchHW*) pObjXXXX;
				ev_bool __values1 = pObjectX->linkEntity(pEntity);
				jboolean __values1_j = (jboolean)__values1;
				return __values1_j;
			}
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_isAsyncUpdatingBuffer_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Graphic::CInstanceBatchHW *pObjectX = (EarthView::World::Graphic::CInstanceBatchHW*) pObjXXXX;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_setAsyncUpdateBuffer_1ev_1bool(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean async_j)
			{
				ev_bool async = (ev_bool) async_j;
				EarthView::World::Graphic::CInstanceBatchHW *pObjectX = (EarthView::World::Graphic::CInstanceBatchHW*) pObjXXXX;
				pObjectX->setAsyncUpdateBuffer(async);
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_register_1getMovableType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHWProxy *pObjectX = (JCInstanceBatchHWProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_register_1_1notifyCurrentCamera_1CCamera(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHWProxy *pObjectX = (JCInstanceBatchHWProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_register_1getBoundingRadius_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHWProxy *pObjectX = (JCInstanceBatchHWProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_register_1visitRenderables_1CVisitor(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHWProxy *pObjectX = (JCInstanceBatchHWProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_register_1visitRenderables_1CVisitor_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHWProxy *pObjectX = (JCInstanceBatchHWProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_register_1_1notifyAttached_1CNode_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHWProxy *pObjectX = (JCInstanceBatchHWProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_register_1getReceivesShadows_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHWProxy *pObjectX = (JCInstanceBatchHWProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_register_1selectBy_1CRay_1CViewport_1ev_1bool_1ev_1int32_1CVector3(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHWProxy *pObjectX = (JCInstanceBatchHWProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_register_1selectBy_1CAxisAlignedBox_1ev_1bool_1IntVector(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHWProxy *pObjectX = (JCInstanceBatchHWProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_register_1selectBy_1CSphere_1ev_1bool_1IntVector(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHWProxy *pObjectX = (JCInstanceBatchHWProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_register_1selectComponentBy_1CRay_1CViewport_1ev_1bool_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32_1CVector3(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHWProxy *pObjectX = (JCInstanceBatchHWProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_register_1renderSelection_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHWProxy *pObjectX = (JCInstanceBatchHWProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_register_1clearSelection_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHWProxy *pObjectX = (JCInstanceBatchHWProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_register_1startEditing_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHWProxy *pObjectX = (JCInstanceBatchHWProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_register_1endEditing_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHWProxy *pObjectX = (JCInstanceBatchHWProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_register_1getEditBoundingBox_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHWProxy *pObjectX = (JCInstanceBatchHWProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_register_1getSelectedObjectWorldMatrix_1ev_1uint32_1CMatrix4(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHWProxy *pObjectX = (JCInstanceBatchHWProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_register_1setSelectedObjectWorldMatrix_1ev_1uint32_1CMatrix4(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHWProxy *pObjectX = (JCInstanceBatchHWProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_register_1getInstanceEntity_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHWProxy *pObjectX = (JCInstanceBatchHWProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_register_1build_1CSubMesh(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHWProxy *pObjectX = (JCInstanceBatchHWProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_register_1useBoneWorldMatrices_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHWProxy *pObjectX = (JCInstanceBatchHWProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_register_1getMaterial_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHWProxy *pObjectX = (JCInstanceBatchHWProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_register_1getTechnique_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHWProxy *pObjectX = (JCInstanceBatchHWProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_register_1preRender_1CSceneManager_1CRenderSystem(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHWProxy *pObjectX = (JCInstanceBatchHWProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_register_1postRender_1CSceneManager_1CRenderSystem(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHWProxy *pObjectX = (JCInstanceBatchHWProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_register_1getSquaredViewDepth_1CCamera(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHWProxy *pObjectX = (JCInstanceBatchHWProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_register_1getLights_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHWProxy *pObjectX = (JCInstanceBatchHWProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_register_1getCastsShadows_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHWProxy *pObjectX = (JCInstanceBatchHWProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_register_1_1updateCustomGpuParameter_1CAutoConstantEntry_1CGpuProgramParameters(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHWProxy *pObjectX = (JCInstanceBatchHWProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_register_1setPolygonModeOverrideable_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHWProxy *pObjectX = (JCInstanceBatchHWProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_register_1getPolygonModeOverrideable_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHWProxy *pObjectX = (JCInstanceBatchHWProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_register_1setCustomAmbient_1CColourValue(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHWProxy *pObjectX = (JCInstanceBatchHWProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_register_1getCustomAmbient_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHWProxy *pObjectX = (JCInstanceBatchHWProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_register_1getCustomAmbientEnabled_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHWProxy *pObjectX = (JCInstanceBatchHWProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_register_1setCustomAmbientEnabled_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHWProxy *pObjectX = (JCInstanceBatchHWProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_register_1getMovableObject_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHWProxy *pObjectX = (JCInstanceBatchHWProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_register_1addListener_1CRenderableListener(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHWProxy *pObjectX = (JCInstanceBatchHWProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_register_1removeListener_1CRenderableListener(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHWProxy *pObjectX = (JCInstanceBatchHWProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_register_1existListener_1CRenderableListener(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHWProxy *pObjectX = (JCInstanceBatchHWProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_register_1getListenerCount_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHWProxy *pObjectX = (JCInstanceBatchHWProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_register_1getListener_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHWProxy *pObjectX = (JCInstanceBatchHWProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_register_1getRenderSystemData_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHWProxy *pObjectX = (JCInstanceBatchHWProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_InstanceBatchHW_register_1setRenderSystemData_1CRenderSystemData(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCInstanceBatchHWProxy *pObjectX = (JCInstanceBatchHWProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
