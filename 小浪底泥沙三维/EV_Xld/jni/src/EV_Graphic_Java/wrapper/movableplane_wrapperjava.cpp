...
namespace EarthView
{
	namespace World
	{
		namespace Graphic
		{
			class JCMovablePlaneProxy : public EarthView::World::Graphic::CMovablePlane
			{
			 private:
				...
				EarthView::World::Core::ev_string m_getMovableObjectPtr_void_callback;
			public:
				JCMovablePlaneProxy(EarthView::World::Core::CNameValuePairList *pList) : CMovablePlane(pList)
				{
				}
			...
			public:
				...
				void register_getMovableObjectPtr_void_callback(EarthView::World::Core::ev_string __method)
				{
					this->m_getMovableObjectPtr_void_callback = __method;
				}
				...
				virtual void _updateRenderQueue(EarthView::World::Graphic::CRenderQueue* pQueue)
				{
					if (this->_gRef != NULL && this->m__updateRenderQueue_CRenderQueue_callback != "" && this->isCustomExtend())
					{
						...
						__env->CallVoidMethod(__obj, __method , pQueue_j);
						#if EV_PLATFORM == EV_PLATFORM_ANDROID
						if(__jniAttachable)
						{
							EarthView::World::Core::JNILoad::getCachedJVM()->DetachCurrentThread();
				...
				{
					if (this->_gRef != NULL && this->m_getMovableObjectPtr_void_callback != "" && this->isCustomExtend())
					{
						EarthView::World::Core::GlobalReference *__gr = (EarthView::World::Core::GlobalReference *)this->getJavaReference();
						JNIEnv * __env;
						#if EV_PLATFORM == EV_PLATFORM_ANDROID
						...
						jobject __obj = __gr->getJObject();
						jclass __clazz = __gr->getClass();
						jmethodID __method = __gr->getMethod("getMovableObjectPtr_void_callback");
						jlong __values1_j = (jlong)__env->CallLongMethod(__obj, __method );
						#if EV_PLATFORM == EV_PLATFORM_ANDROID
						if(__jniAttachable)
						{
						...
						EarthView::World::Core::JNILoad::getCachedJVM()->DetachCurrentThread();
						#endif
						const EarthView::World::Graphic::CMovablePlane::CMovablePlaneInternalMovable *__values1 = (const EarthView::World::Graphic::CMovablePlane::CMovablePlaneInternalMovable*) __values1_j;
						return __values1;
					}
					else
					{
			...
			REGISTER_FACTORY_CLASS(JCMovablePlaneProxy);
			class JCMovablePlaneInternalMovableProxy : public EarthView::World::Graphic::CMovablePlane::CMovablePlaneInternalMovable
			{
			 private:
			...
			public:
				JCMovablePlaneInternalMovableProxy(EarthView::World::Core::CNameValuePairList *pList) : CMovablePlaneInternalMovable(pList)
				{
				}
				ev_void unRegisterJavaReference()
				{
			...
			REGISTER_FACTORY_CLASS(JCMovablePlaneInternalMovableProxy);
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable__1notifyCurrentCamera_1CCamera(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong cam_j)
			{
				EarthView::World::Graphic::CCamera *cam = (EarthView::World::Graphic::CCamera*) cam_j;
				EarthView::World::Graphic::CMovablePlane::CMovablePlaneInternalMovable *pObjectX = (EarthView::World::Graphic::CMovablePlane::CMovablePlaneInternalMovable*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCMovablePlaneInternalMovableProxy))
				{
					pObjectX->EarthView::World::Graphic::CMovablePlane::CMovablePlaneInternalMovable::_notifyCurrentCamera(cam);
				}
				else
				{
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1_1notifyCurrentCamera_1CCamera(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable__1notifyCurrentCamera_1CCamera_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong cam_j)
			{
				EarthView::World::Graphic::CCamera *cam = (EarthView::World::Graphic::CCamera*) cam_j;
				EarthView::World::Graphic::CMovablePlane::CMovablePlaneInternalMovable *pObjectX = (EarthView::World::Graphic::CMovablePlane::CMovablePlaneInternalMovable*) pObjXXXX;
				pObjectX->EarthView::World::Graphic::CMovablePlane::CMovablePlaneInternalMovable::_notifyCurrentCamera(cam);
			}
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_getBoundingBox_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Graphic::CMovablePlane::CMovablePlaneInternalMovable *pObjectX = (EarthView::World::Graphic::CMovablePlane::CMovablePlaneInternalMovable*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCMovablePlaneInternalMovableProxy))
				{
					const EarthView::World::Spatial::Math::CAxisAlignedBox& __values1 = pObjectX->EarthView::World::Graphic::CMovablePlane::CMovablePlaneInternalMovable::getBoundingBox();
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1getBoundingBox_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_getBoundingBox_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Graphic::CMovablePlane::CMovablePlaneInternalMovable *pObjectX = (EarthView::World::Graphic::CMovablePlane::CMovablePlaneInternalMovable*) pObjXXXX;
				const EarthView::World::Spatial::Math::CAxisAlignedBox& __values1 = pObjectX->EarthView::World::Graphic::CMovablePlane::CMovablePlaneInternalMovable::getBoundingBox();
				jlong __values1_j = (jlong) &__values1;
			...
			extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_getBoundingRadius_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Graphic::CMovablePlane::CMovablePlaneInternalMovable *pObjectX = (EarthView::World::Graphic::CMovablePlane::CMovablePlaneInternalMovable*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCMovablePlaneInternalMovableProxy))
				{
					Real __values1 = pObjectX->EarthView::World::Graphic::CMovablePlane::CMovablePlaneInternalMovable::getBoundingRadius();
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1getBoundingRadius_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_getBoundingRadius_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Graphic::CMovablePlane::CMovablePlaneInternalMovable *pObjectX = (EarthView::World::Graphic::CMovablePlane::CMovablePlaneInternalMovable*) pObjXXXX;
				Real __values1 = pObjectX->EarthView::World::Graphic::CMovablePlane::CMovablePlaneInternalMovable::getBoundingRadius();
				jdouble __values1_j = (jdouble)__values1;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable__1updateRenderQueue_1CRenderQueue(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong pQueue_j)
			{
				EarthView::World::Graphic::CRenderQueue *pQueue = (EarthView::World::Graphic::CRenderQueue*) pQueue_j;
				EarthView::World::Graphic::CMovablePlane::CMovablePlaneInternalMovable *pObjectX = (EarthView::World::Graphic::CMovablePlane::CMovablePlaneInternalMovable*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCMovablePlaneInternalMovableProxy))
				{
					pObjectX->EarthView::World::Graphic::CMovablePlane::CMovablePlaneInternalMovable::_updateRenderQueue(pQueue);
				}
				else
				{
					pObjectX->_updateRenderQueue(pQueue);
				}
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1_1updateRenderQueue_1CRenderQueue(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable__1updateRenderQueue_1CRenderQueue_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong pQueue_j)
			{
				EarthView::World::Graphic::CRenderQueue *pQueue = (EarthView::World::Graphic::CRenderQueue*) pQueue_j;
				EarthView::World::Graphic::CMovablePlane::CMovablePlaneInternalMovable *pObjectX = (EarthView::World::Graphic::CMovablePlane::CMovablePlaneInternalMovable*) pObjXXXX;
				pObjectX->EarthView::World::Graphic::CMovablePlane::CMovablePlaneInternalMovable::_updateRenderQueue(pQueue);
			}
			extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_getMovableType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Graphic::CMovablePlane::CMovablePlaneInternalMovable *pObjectX = (EarthView::World::Graphic::CMovablePlane::CMovablePlaneInternalMovable*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCMovablePlaneInternalMovableProxy))
				{
					EVString __values1 = pObjectX->EarthView::World::Graphic::CMovablePlane::CMovablePlaneInternalMovable::getMovableType();
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1getMovableType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_getMovableType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Graphic::CMovablePlane::CMovablePlaneInternalMovable *pObjectX = (EarthView::World::Graphic::CMovablePlane::CMovablePlaneInternalMovable*) pObjXXXX;
				EVString __values1 = pObjectX->EarthView::World::Graphic::CMovablePlane::CMovablePlaneInternalMovable::getMovableType();
				EarthView::World::Core::ev_wstring valuesw1 = __values1;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_visitRenderables_1CVisitor_1ev_1bool(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong visitor_j, jboolean debugRenderables_j)
			{
				...
				if (typeid(*pObjectX) == typeid(JCMovablePlaneInternalMovableProxy))
				{
					pObjectX->EarthView::World::Graphic::CMovablePlane::CMovablePlaneInternalMovable::visitRenderables(visitor, debugRenderables);
				}
				else
				{
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1visitRenderables_1CVisitor_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_visitRenderables_1CVisitor_1ev_1bool_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong visitor_j, jboolean debugRenderables_j)
			{
				EarthView::World::Graphic::CRenderable::CVisitor *visitor = (EarthView::World::Graphic::CRenderable::CVisitor*) visitor_j;
				ev_bool debugRenderables = (ev_bool) debugRenderables_j;
				EarthView::World::Graphic::CMovablePlane::CMovablePlaneInternalMovable *pObjectX = (EarthView::World::Graphic::CMovablePlane::CMovablePlaneInternalMovable*) pObjXXXX;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_visitRenderables_1CVisitor(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong visitor_j)
			{
				EarthView::World::Graphic::CRenderable::CVisitor *visitor = (EarthView::World::Graphic::CRenderable::CVisitor*) visitor_j;
				EarthView::World::Graphic::CMovablePlane::CMovablePlaneInternalMovable *pObjectX = (EarthView::World::Graphic::CMovablePlane::CMovablePlaneInternalMovable*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCMovablePlaneInternalMovableProxy))
				{
					pObjectX->EarthView::World::Graphic::CMovablePlane::CMovablePlaneInternalMovable::visitRenderables(visitor);
				}
				else
				{
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1visitRenderables_1CVisitor(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_visitRenderables_1CVisitor_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong visitor_j)
			{
				EarthView::World::Graphic::CRenderable::CVisitor *visitor = (EarthView::World::Graphic::CRenderable::CVisitor*) visitor_j;
				EarthView::World::Graphic::CMovablePlane::CMovablePlaneInternalMovable *pObjectX = (EarthView::World::Graphic::CMovablePlane::CMovablePlaneInternalMovable*) pObjXXXX;
				pObjectX->EarthView::World::Graphic::CMovablePlane::CMovablePlaneInternalMovable::visitRenderables(visitor);
			}
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable__1getDerivedPlane_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Graphic::CMovablePlane::CMovablePlaneInternalMovable *pObjectX = (EarthView::World::Graphic::CMovablePlane::CMovablePlaneInternalMovable*) pObjXXXX;
				const EarthView::World::Spatial::Math::CPlane& __values1 = pObjectX->_getDerivedPlane();
				jlong __values1_j = (jlong) &__values1;
				return __values1_j;
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1getAnimableObjectPtr_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1getRenderQueueId_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1_1notifyCreator_1CMovableObjectFactory(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1_1getCreator_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1_1notifyManager_1CSceneManager(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1_1getManager_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1getName_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1getParentNode_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1getParentSceneNode_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1isParentTagPoint_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1_1notifyAttached_1CNode_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1_1notifyAttached_1CNode(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1isAttached_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1detachFromParent_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1isInScene_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1_1notifyMoved_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1_1notifyLightsQueried_1LightList(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1setLightQueriedListener_1CLightQueriedListener(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1getLightQueriedListener_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1getLightListUpdated_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1setLightListUpdated_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1getWorldBoundingSphere_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1getWorldBoundingSphere_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1setVisible_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1getVisible_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1isVisible_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1setRenderingMaxDistance_1Real(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1getRenderingMaxDistance_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1setRenderingMinDistance_1Real(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1getRenderingMinDistance_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1setRenderingMinPixelSize_1Real(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1getRenderingMinPixelSize_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1setSelectionColour_1CColourValue(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1setSelected_1IntVector(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1getSelected_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1selectBy_1CRay_1CViewport_1ev_1bool_1ev_1int32_1CVector3(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1selectBy_1CAxisAlignedBox_1ev_1bool_1IntVector(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1selectBy_1CSphere_1ev_1bool_1IntVector(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1selectComponentBy_1CRay_1CViewport_1ev_1bool_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32_1CVector3(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1renderSelection_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1clearSelection_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1startEditing_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1endEditing_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1getEditBoundingBox_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1getSelectedObjectWorldMatrix_1ev_1uint32_1CMatrix4(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1setSelectedObjectWorldMatrix_1ev_1uint32_1CMatrix4(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1setRenderQueueGroup_1ev_1uint8(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1setRenderQueueGroupAndPriority_1ev_1uint8_1ev_1uint16(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1getRenderQueueGroup_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1_1getParentNodeFullTransform_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1setQueryFlags_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1addQueryFlags_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1removeQueryFlags_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1getQueryFlags_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1setVisibilityFlags_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1addVisibilityFlags_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1removeVisibilityFlags_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1getVisibilityFlags_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1addListener_1CMovableObjectListener(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1removeListener_1CMovableObjectListener(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1existListener_1CMovableObjectListener(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1getListenerCount_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1getListener_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1queryLights_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1getLightMask_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1setLightMask_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1_1getLightList_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1setCastShadows_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1getReceivesShadows_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1getTypeFlags_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1setDebugDisplayEnabled_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1isDebugDisplayEnabled_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1getCastShadows_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1getEdgeList_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1hasEdgeList_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1getWorldBoundingBox_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1getWorldBoundingBox_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1getLightCapBounds_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1getDarkCapBounds_1CLight_1Real(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1getShadowVolumeRenderableIterator_1ShadowTechnique_1CLight_1CHardwareIndexBufferSharedPtr_1ev_1bool_1Real_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1getShadowVolumeRenderableIterator_1ShadowTechnique_1CLight_1CHardwareIndexBufferSharedPtr_1ev_1bool_1Real(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1getPointExtrusionDistance_1CLight(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1updateEdgeListLightFacing_1CEdgeData_1CVector4(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1generateShadowVolume_1CEdgeData_1CHardwareIndexBufferSharedPtr_1CLight_1ShadowRenderableList_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_00024MovablePlaneInternalMovable_register_1extrudeBounds_1CAxisAlignedBox_1CVector4_1Real(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneInternalMovableProxy *pObjectX = (JCMovablePlaneInternalMovableProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane__1notifyCurrentCamera_1CCamera(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong cam_j)
			{
				EarthView::World::Graphic::CCamera *cam = (EarthView::World::Graphic::CCamera*) cam_j;
				EarthView::World::Graphic::CMovablePlane *pObjectX = (EarthView::World::Graphic::CMovablePlane*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCMovablePlaneProxy))
				{
					pObjectX->EarthView::World::Graphic::CMovablePlane::_notifyCurrentCamera(cam);
				}
				else
				{
					pObjectX->_notifyCurrentCamera(cam);
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_register_1_1notifyCurrentCamera_1CCamera(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneProxy *pObjectX = (JCMovablePlaneProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
				__env->ReleaseStringUTFChars(__method, pMethod);
				pObjectX->register__notifyCurrentCamera_CCamera_callback(sMethod);
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane__1notifyCurrentCamera_1CCamera_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong cam_j)
			{
				EarthView::World::Graphic::CCamera *cam = (EarthView::World::Graphic::CCamera*) cam_j;
				EarthView::World::Graphic::CMovablePlane *pObjectX = (EarthView::World::Graphic::CMovablePlane*) pObjXXXX;
				pObjectX->EarthView::World::Graphic::CMovablePlane::_notifyCurrentCamera(cam);
			}
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_graphic_MovablePlane_getBoundingBox_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Graphic::CMovablePlane *pObjectX = (EarthView::World::Graphic::CMovablePlane*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCMovablePlaneProxy))
				{
					const EarthView::World::Spatial::Math::CAxisAlignedBox& __values1 = pObjectX->EarthView::World::Graphic::CMovablePlane::getBoundingBox();
					jlong __values1_j = (jlong) &__values1;
					return __values1_j;
				}
				else
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_register_1getBoundingBox_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneProxy *pObjectX = (JCMovablePlaneProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_graphic_MovablePlane_getBoundingBox_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Graphic::CMovablePlane *pObjectX = (EarthView::World::Graphic::CMovablePlane*) pObjXXXX;
				const EarthView::World::Spatial::Math::CAxisAlignedBox& __values1 = pObjectX->EarthView::World::Graphic::CMovablePlane::getBoundingBox();
				jlong __values1_j = (jlong) &__values1;
			...
			extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_graphic_MovablePlane_getBoundingRadius_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Graphic::CMovablePlane *pObjectX = (EarthView::World::Graphic::CMovablePlane*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCMovablePlaneProxy))
				{
					Real __values1 = pObjectX->EarthView::World::Graphic::CMovablePlane::getBoundingRadius();
					jdouble __values1_j = (jdouble)__values1;
					return __values1_j;
				}
				else
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_register_1getBoundingRadius_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneProxy *pObjectX = (JCMovablePlaneProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_graphic_MovablePlane_getBoundingRadius_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Graphic::CMovablePlane *pObjectX = (EarthView::World::Graphic::CMovablePlane*) pObjXXXX;
				Real __values1 = pObjectX->EarthView::World::Graphic::CMovablePlane::getBoundingRadius();
				jdouble __values1_j = (jdouble)__values1;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane__1updateRenderQueue_1CRenderQueue(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong pQueue_j)
			{
				EarthView::World::Graphic::CRenderQueue *pQueue = (EarthView::World::Graphic::CRenderQueue*) pQueue_j;
				EarthView::World::Graphic::CMovablePlane *pObjectX = (EarthView::World::Graphic::CMovablePlane*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCMovablePlaneProxy))
				{
					pObjectX->EarthView::World::Graphic::CMovablePlane::_updateRenderQueue(pQueue);
				}
				else
				{
					pObjectX->_updateRenderQueue(pQueue);
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_register_1_1updateRenderQueue_1CRenderQueue(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneProxy *pObjectX = (JCMovablePlaneProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane__1updateRenderQueue_1CRenderQueue_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong pQueue_j)
			{
				EarthView::World::Graphic::CRenderQueue *pQueue = (EarthView::World::Graphic::CRenderQueue*) pQueue_j;
				EarthView::World::Graphic::CMovablePlane *pObjectX = (EarthView::World::Graphic::CMovablePlane*) pObjXXXX;
				pObjectX->EarthView::World::Graphic::CMovablePlane::_updateRenderQueue(pQueue);
			}
			extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_graphic_MovablePlane_getMovableType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Graphic::CMovablePlane *pObjectX = (EarthView::World::Graphic::CMovablePlane*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCMovablePlaneProxy))
				{
					EVString __values1 = pObjectX->EarthView::World::Graphic::CMovablePlane::getMovableType();
					EarthView::World::Core::ev_wstring valuesw1 = __values1;
					jstring __values1_j = __env->NewString((const jchar*)valuesw1.getString(), valuesw1.size());
					return __values1_j;
				}
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_register_1getMovableType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneProxy *pObjectX = (JCMovablePlaneProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_graphic_MovablePlane_getMovableType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Graphic::CMovablePlane *pObjectX = (EarthView::World::Graphic::CMovablePlane*) pObjXXXX;
				EVString __values1 = pObjectX->EarthView::World::Graphic::CMovablePlane::getMovableType();
				EarthView::World::Core::ev_wstring valuesw1 = __values1;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_visitRenderables_1CVisitor_1ev_1bool(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong visitor_j, jboolean debugRenderables_j)
			{
				EarthView::World::Graphic::CRenderable::CVisitor *visitor = (EarthView::World::Graphic::CRenderable::CVisitor*) visitor_j;
				ev_bool debugRenderables = (ev_bool) debugRenderables_j;
				EarthView::World::Graphic::CMovablePlane *pObjectX = (EarthView::World::Graphic::CMovablePlane*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCMovablePlaneProxy))
				{
					pObjectX->EarthView::World::Graphic::CMovablePlane::visitRenderables(visitor, debugRenderables);
				}
				else
				{
					pObjectX->visitRenderables(visitor, debugRenderables);
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_register_1visitRenderables_1CVisitor_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneProxy *pObjectX = (JCMovablePlaneProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_visitRenderables_1CVisitor_1ev_1bool_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong visitor_j, jboolean debugRenderables_j)
			{
				EarthView::World::Graphic::CRenderable::CVisitor *visitor = (EarthView::World::Graphic::CRenderable::CVisitor*) visitor_j;
				ev_bool debugRenderables = (ev_bool) debugRenderables_j;
				EarthView::World::Graphic::CMovablePlane *pObjectX = (EarthView::World::Graphic::CMovablePlane*) pObjXXXX;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_visitRenderables_1CVisitor(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong visitor_j)
			{
				EarthView::World::Graphic::CRenderable::CVisitor *visitor = (EarthView::World::Graphic::CRenderable::CVisitor*) visitor_j;
				EarthView::World::Graphic::CMovablePlane *pObjectX = (EarthView::World::Graphic::CMovablePlane*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCMovablePlaneProxy))
				{
					pObjectX->EarthView::World::Graphic::CMovablePlane::visitRenderables(visitor);
				}
				else
				{
					pObjectX->visitRenderables(visitor);
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_register_1visitRenderables_1CVisitor(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneProxy *pObjectX = (JCMovablePlaneProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_visitRenderables_1CVisitor_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong visitor_j)
			{
				EarthView::World::Graphic::CRenderable::CVisitor *visitor = (EarthView::World::Graphic::CRenderable::CVisitor*) visitor_j;
				EarthView::World::Graphic::CMovablePlane *pObjectX = (EarthView::World::Graphic::CMovablePlane*) pObjXXXX;
				pObjectX->EarthView::World::Graphic::CMovablePlane::visitRenderables(visitor);
			}
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_graphic_MovablePlane_getMovableObjectPtr_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Graphic::CMovablePlane *pObjectX = (EarthView::World::Graphic::CMovablePlane*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCMovablePlaneProxy))
				{
					const EarthView::World::Graphic::CMovablePlane::CMovablePlaneInternalMovable* __values1 = pObjectX->EarthView::World::Graphic::CMovablePlane::getMovableObjectPtr();
					jlong __values1_j = (jlong) __values1;
					return __values1_j;
				}
				else
				{
					const EarthView::World::Graphic::CMovablePlane::CMovablePlaneInternalMovable* __values1 = pObjectX->getMovableObjectPtr();
					jlong __values1_j = (jlong) __values1;
					return __values1_j;
				}
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_graphic_MovablePlane_register_1getMovableObjectPtr_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMovablePlaneProxy *pObjectX = (JCMovablePlaneProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
				__env->ReleaseStringUTFChars(__method, pMethod);
				pObjectX->register_getMovableObjectPtr_void_callback(sMethod);
				if (pObjectX->getJavaReference() != NULL && sMethod != "")
				{
					EarthView::World::Core::GlobalReference *__gr = (EarthView::World::Core::GlobalReference *)pObjectX->getJavaReference();
					jobject __obj1 = __gr->getJObject();
					jclass __clazz1 = __env->GetObjectClass(__obj1);
					jmethodID __method = __env->GetMethodID(__clazz1,"getMovableObjectPtr_void_callback", "()J");
					__gr->setMethod(sMethod, __method);
				}
			}
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_graphic_MovablePlane_getMovableObjectPtr_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Graphic::CMovablePlane *pObjectX = (EarthView::World::Graphic::CMovablePlane*) pObjXXXX;
				const EarthView::World::Graphic::CMovablePlane::CMovablePlaneInternalMovable* __values1 = pObjectX->EarthView::World::Graphic::CMovablePlane::getMovableObjectPtr();
				jlong __values1_j = (jlong) __values1;
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_graphic_MovablePlane__1getDerivedPlane_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Graphic::CMovablePlane *pObjectX = (EarthView::World::Graphic::CMovablePlane*) pObjXXXX;
				const EarthView::World::Spatial::Math::CPlane& __values1 = pObjectX->_getDerivedPlane();
				jlong __values1_j = (jlong) &__values1;
