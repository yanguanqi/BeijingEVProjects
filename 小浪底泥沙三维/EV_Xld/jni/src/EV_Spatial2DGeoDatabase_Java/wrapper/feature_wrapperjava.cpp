...
namespace EarthView
{
	namespace World
	{
		namespace Spatial2D
		{
			...
			{
				class JCVectorFeatureProxy : public EarthView::World::Spatial2D::GeoDataset::CVectorFeature
				{
				 private:
				...
				public:
					JCVectorFeatureProxy(EarthView::World::Core::CNameValuePairList *pList) : CVectorFeature(pList)
					{
					}
				...
				REGISTER_FACTORY_CLASS(JCVectorFeatureProxy);
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_geodataset_VectorFeature_getID_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::GeoDataset::CVectorFeature *pObjectX = (EarthView::World::Spatial2D::GeoDataset::CVectorFeature*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorFeatureProxy))
					{
						ev_uint32 __values1 = pObjectX->EarthView::World::Spatial2D::GeoDataset::CVectorFeature::getID();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_geodataset_VectorFeature_register_1getID_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorFeatureProxy *pObjectX = (JCVectorFeatureProxy*) pObjXXXX;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_geodataset_VectorFeature_getID_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::GeoDataset::CVectorFeature *pObjectX = (EarthView::World::Spatial2D::GeoDataset::CVectorFeature*) pObjXXXX;
					ev_uint32 __values1 = pObjectX->EarthView::World::Spatial2D::GeoDataset::CVectorFeature::getID();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial2d_geodataset_VectorFeature_getGeometryType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::GeoDataset::CVectorFeature *pObjectX = (EarthView::World::Spatial2D::GeoDataset::CVectorFeature*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorFeatureProxy))
					{
						EarthView::World::Spatial::Geometry::EVGeometryType __values1 = pObjectX->EarthView::World::Spatial2D::GeoDataset::CVectorFeature::getGeometryType();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_geodataset_VectorFeature_register_1getGeometryType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorFeatureProxy *pObjectX = (JCVectorFeatureProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial2d_geodataset_VectorFeature_getGeometryType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::GeoDataset::CVectorFeature *pObjectX = (EarthView::World::Spatial2D::GeoDataset::CVectorFeature*) pObjXXXX;
					EarthView::World::Spatial::Geometry::EVGeometryType __values1 = pObjectX->EarthView::World::Spatial2D::GeoDataset::CVectorFeature::getGeometryType();
					jint __values1_j = (jint) __values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_geodataset_VectorFeature_getFieldsRef_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::GeoDataset::CVectorFeature *pObjectX = (EarthView::World::Spatial2D::GeoDataset::CVectorFeature*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorFeatureProxy))
					{
						const EarthView::World::Spatial::GeoDataset::IFields* __values1 = pObjectX->EarthView::World::Spatial2D::GeoDataset::CVectorFeature::getFieldsRef();
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_geodataset_VectorFeature_register_1getFieldsRef_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorFeatureProxy *pObjectX = (JCVectorFeatureProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_geodataset_VectorFeature_getFieldsRef_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::GeoDataset::CVectorFeature *pObjectX = (EarthView::World::Spatial2D::GeoDataset::CVectorFeature*) pObjXXXX;
					const EarthView::World::Spatial::GeoDataset::IFields* __values1 = pObjectX->EarthView::World::Spatial2D::GeoDataset::CVectorFeature::getFieldsRef();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_geodataset_VectorFeature_getFieldCount_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::GeoDataset::CVectorFeature *pObjectX = (EarthView::World::Spatial2D::GeoDataset::CVectorFeature*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorFeatureProxy))
					{
						ev_uint32 __values1 = pObjectX->EarthView::World::Spatial2D::GeoDataset::CVectorFeature::getFieldCount();
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_geodataset_VectorFeature_register_1getFieldCount_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorFeatureProxy *pObjectX = (JCVectorFeatureProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_geodataset_VectorFeature_getFieldCount_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::GeoDataset::CVectorFeature *pObjectX = (EarthView::World::Spatial2D::GeoDataset::CVectorFeature*) pObjXXXX;
					ev_uint32 __values1 = pObjectX->EarthView::World::Spatial2D::GeoDataset::CVectorFeature::getFieldCount();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_geodataset_VectorFeature_getFieldRef_1ev_1uint32(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong index_j)
				{
					ev_uint32 index = (ev_uint32) index_j;
					const 					EarthView::World::Spatial2D::GeoDataset::CVectorFeature *pObjectX = (EarthView::World::Spatial2D::GeoDataset::CVectorFeature*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorFeatureProxy))
					{
						const EarthView::World::Spatial::GeoDataset::IField* __values1 = pObjectX->EarthView::World::Spatial2D::GeoDataset::CVectorFeature::getFieldRef(index);
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_geodataset_VectorFeature_register_1getFieldRef_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorFeatureProxy *pObjectX = (JCVectorFeatureProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_geodataset_VectorFeature_getFieldRef_1ev_1uint32_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong index_j)
				{
					ev_uint32 index = (ev_uint32) index_j;
					const 					EarthView::World::Spatial2D::GeoDataset::CVectorFeature *pObjectX = (EarthView::World::Spatial2D::GeoDataset::CVectorFeature*) pObjXXXX;
					const EarthView::World::Spatial::GeoDataset::IField* __values1 = pObjectX->EarthView::World::Spatial2D::GeoDataset::CVectorFeature::getFieldRef(index);
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial2d_geodataset_VectorFeature_findField_1EVString(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring fieldName_j)
				{
					#if EV_PLATFORM == EV_PLATFORM_ANDROID
					...
					if (typeid(*pObjectX) == typeid(JCVectorFeatureProxy))
					{
						ev_int32 __values1 = pObjectX->EarthView::World::Spatial2D::GeoDataset::CVectorFeature::findField(fieldName);
						jint __values1_j = (jint)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_geodataset_VectorFeature_register_1findField_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorFeatureProxy *pObjectX = (JCVectorFeatureProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial2d_geodataset_VectorFeature_findField_1EVString_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring fieldName_j)
				{
					#if EV_PLATFORM == EV_PLATFORM_ANDROID
					const ev_char* fieldName_ch = (const ev_char*)__env->GetStringUTFChars(fieldName_j,JNI_FALSE);
					const EVString fieldName = fieldName_ch;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_geodataset_VectorFeature_getValue_1CVariant_1ev_1uint32(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong value_j, jlong index_j)
				{
					...
					if (typeid(*pObjectX) == typeid(JCVectorFeatureProxy))
					{
						pObjectX->EarthView::World::Spatial2D::GeoDataset::CVectorFeature::getValue(value, index);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_geodataset_VectorFeature_register_1getValue_1CVariant_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorFeatureProxy *pObjectX = (JCVectorFeatureProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_geodataset_VectorFeature_getValue_1CVariant_1ev_1uint32_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong value_j, jlong index_j)
				{
					EarthView::World::Core::CVariant &value = *(EarthView::World::Core::CVariant*) value_j;
					ev_uint32 index = (ev_uint32) index_j;
					const 					EarthView::World::Spatial2D::GeoDataset::CVectorFeature *pObjectX = (EarthView::World::Spatial2D::GeoDataset::CVectorFeature*) pObjXXXX;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_geodataset_VectorFeature_getGeometryRef_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::GeoDataset::CVectorFeature *pObjectX = (EarthView::World::Spatial2D::GeoDataset::CVectorFeature*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorFeatureProxy))
					{
						const EarthView::World::Spatial::Geometry::IGeometry* __values1 = pObjectX->EarthView::World::Spatial2D::GeoDataset::CVectorFeature::getGeometryRef();
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_geodataset_VectorFeature_register_1getGeometryRef_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorFeatureProxy *pObjectX = (JCVectorFeatureProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_geodataset_VectorFeature_getGeometryRef_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::GeoDataset::CVectorFeature *pObjectX = (EarthView::World::Spatial2D::GeoDataset::CVectorFeature*) pObjXXXX;
					const EarthView::World::Spatial::Geometry::IGeometry* __values1 = pObjectX->EarthView::World::Spatial2D::GeoDataset::CVectorFeature::getGeometryRef();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_geodataset_VectorFeature_getEnvelopeRef_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::GeoDataset::CVectorFeature *pObjectX = (EarthView::World::Spatial2D::GeoDataset::CVectorFeature*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorFeatureProxy))
					{
						const EarthView::World::Spatial::Geometry::IEnvelope* __values1 = pObjectX->EarthView::World::Spatial2D::GeoDataset::CVectorFeature::getEnvelopeRef();
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_geodataset_VectorFeature_register_1getEnvelopeRef_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorFeatureProxy *pObjectX = (JCVectorFeatureProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_geodataset_VectorFeature_getEnvelopeRef_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::GeoDataset::CVectorFeature *pObjectX = (EarthView::World::Spatial2D::GeoDataset::CVectorFeature*) pObjXXXX;
					const EarthView::World::Spatial::Geometry::IEnvelope* __values1 = pObjectX->EarthView::World::Spatial2D::GeoDataset::CVectorFeature::getEnvelopeRef();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_geodataset_VectorFeature_setGeometry_1IGeometry(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong geom_j)
				{
					const EarthView::World::Spatial::Geometry::IGeometry *geom = (const EarthView::World::Spatial::Geometry::IGeometry*) geom_j;
					EarthView::World::Spatial2D::GeoDataset::CVectorFeature *pObjectX = (EarthView::World::Spatial2D::GeoDataset::CVectorFeature*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorFeatureProxy))
					{
						pObjectX->EarthView::World::Spatial2D::GeoDataset::CVectorFeature::setGeometry(geom);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_geodataset_VectorFeature_register_1setGeometry_1IGeometry(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorFeatureProxy *pObjectX = (JCVectorFeatureProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_geodataset_VectorFeature_setGeometry_1IGeometry_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong geom_j)
				{
					const EarthView::World::Spatial::Geometry::IGeometry *geom = (const EarthView::World::Spatial::Geometry::IGeometry*) geom_j;
					EarthView::World::Spatial2D::GeoDataset::CVectorFeature *pObjectX = (EarthView::World::Spatial2D::GeoDataset::CVectorFeature*) pObjXXXX;
					pObjectX->EarthView::World::Spatial2D::GeoDataset::CVectorFeature::setGeometry(geom);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_geodataset_VectorFeature_setValue_1CVariant_1ev_1uint32(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong value_j, jlong index_j)
				{
					...
					if (typeid(*pObjectX) == typeid(JCVectorFeatureProxy))
					{
						pObjectX->EarthView::World::Spatial2D::GeoDataset::CVectorFeature::setValue(value, index);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_geodataset_VectorFeature_register_1setValue_1CVariant_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorFeatureProxy *pObjectX = (JCVectorFeatureProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_geodataset_VectorFeature_setValue_1CVariant_1ev_1uint32_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong value_j, jlong index_j)
				{
					const EarthView::World::Core::CVariant &value = *(EarthView::World::Core::CVariant*) value_j;
					ev_uint32 index = (ev_uint32) index_j;
					EarthView::World::Spatial2D::GeoDataset::CVectorFeature *pObjectX = (EarthView::World::Spatial2D::GeoDataset::CVectorFeature*) pObjXXXX;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial2d_geodataset_VectorFeature_deleteFeature_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial2D::GeoDataset::CVectorFeature *pObjectX = (EarthView::World::Spatial2D::GeoDataset::CVectorFeature*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorFeatureProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial2D::GeoDataset::CVectorFeature::deleteFeature();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_geodataset_VectorFeature_register_1deleteFeature_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorFeatureProxy *pObjectX = (JCVectorFeatureProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial2d_geodataset_VectorFeature_deleteFeature_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial2D::GeoDataset::CVectorFeature *pObjectX = (EarthView::World::Spatial2D::GeoDataset::CVectorFeature*) pObjXXXX;
					ev_bool __values1 = pObjectX->EarthView::World::Spatial2D::GeoDataset::CVectorFeature::deleteFeature();
					jboolean __values1_j = (jboolean)__values1;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial2d_geodataset_VectorFeature_saveFeature_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial2D::GeoDataset::CVectorFeature *pObjectX = (EarthView::World::Spatial2D::GeoDataset::CVectorFeature*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorFeatureProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial2D::GeoDataset::CVectorFeature::saveFeature();
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_geodataset_VectorFeature_register_1saveFeature_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorFeatureProxy *pObjectX = (JCVectorFeatureProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial2d_geodataset_VectorFeature_saveFeature_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial2D::GeoDataset::CVectorFeature *pObjectX = (EarthView::World::Spatial2D::GeoDataset::CVectorFeature*) pObjXXXX;
					ev_bool __values1 = pObjectX->EarthView::World::Spatial2D::GeoDataset::CVectorFeature::saveFeature();
					jboolean __values1_j = (jboolean)__values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_geodataset_VectorFeature_ev_1clone_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::GeoDataset::CVectorFeature *pObjectX = (EarthView::World::Spatial2D::GeoDataset::CVectorFeature*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorFeatureProxy))
					{
						EarthView::World::Spatial::GeoDataset::IFeature* __values1 = pObjectX->EarthView::World::Spatial2D::GeoDataset::CVectorFeature::clone();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_geodataset_VectorFeature_register_1ev_1clone_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorFeatureProxy *pObjectX = (JCVectorFeatureProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_geodataset_VectorFeature_ev_1clone_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::GeoDataset::CVectorFeature *pObjectX = (EarthView::World::Spatial2D::GeoDataset::CVectorFeature*) pObjXXXX;
					EarthView::World::Spatial::GeoDataset::IFeature* __values1 = pObjectX->EarthView::World::Spatial2D::GeoDataset::CVectorFeature::clone();
					if(__values1 != NULL) {						((EarthView::World::Core::CBaseObject*)__values1)->setExternFree(true);
