...
public class ModelLODGenerateListener extends com.earthview.world.core.BaseObject {
	
	static {
		GlobalClassFactoryMap.put("EarthView::MeshOptimize::CModelLODGenerateListener", new ModelLODGenerateListenerClassFactory());
		GlobalClassFactoryMap.put("EarthView::MeshOptimize::JCModelLODGenerateListenerProxy", new ModelLODGenerateListenerClassFactory());
	}

	public ModelLODGenerateListener() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCModelLODGenerateListenerProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.meshoptimize.ModelLODGenerateListener".equals(this.getClass().getName()))
		{
	...
	public ModelLODGenerateListener(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ModelLODGenerateListener(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ModelLODGenerateListener fromBaseObject(BaseObject baseObj)
	{
		...
		ModelLODGenerateListener obj = null;
 		if(baseObj instanceof ModelLODGenerateListener)
		{
			obj = (ModelLODGenerateListener)baseObj;
		} else {
