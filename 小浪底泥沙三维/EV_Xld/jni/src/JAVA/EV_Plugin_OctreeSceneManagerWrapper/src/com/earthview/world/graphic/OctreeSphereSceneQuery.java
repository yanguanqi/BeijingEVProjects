...
public class OctreeSphereSceneQuery extends com.earthview.world.graphic.DefaultSphereSceneQuery {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::COctreeSphereSceneQuery", new OctreeSphereSceneQueryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::JCOctreeSphereSceneQueryProxy", new OctreeSphereSceneQueryClassFactory());
	}

	public OctreeSphereSceneQuery(com.earthview.world.graphic.SceneManager ref_creator) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer ref_creatorPtr = new BasePointer(ref_creator);
		list.add("ref_creator", ref_creatorPtr.get());
		Create("JCOctreeSphereSceneQueryProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.OctreeSphereSceneQuery".equals(this.getClass().getName()))
		{
	...
	public OctreeSphereSceneQuery(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public OctreeSphereSceneQuery(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static OctreeSphereSceneQuery fromBaseObject(BaseObject baseObj)
	{
		...
		OctreeSphereSceneQuery obj = null;
 		if(baseObj instanceof OctreeSphereSceneQuery)
		{
			obj = (OctreeSphereSceneQuery)baseObj;
		} else {
