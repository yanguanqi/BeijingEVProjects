...
public class OctreeSceneManager extends com.earthview.world.graphic.SceneManager {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::COctreeSceneManager", new OctreeSceneManagerClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::JCOctreeSceneManagerProxy", new OctreeSceneManagerClassFactory());
	}

	native private static int get_intersect_call_void();
	public static int get_intersect_call()
	{
		int jniValue = get_intersect_call_void();
		
		return jniValue;
	}
	
	native private static void set_intersect_call_int (int value);
	public static void set_intersect_call(int intersect_call)
	{
		int intersect_callParamValue = intersect_call;
		
		set_intersect_call_int(intersect_callParamValue);
	}
	...
	public OctreeSceneManager(String name) {
		...
		Create("JCOctreeSceneManagerProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.OctreeSceneManager".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
		}
	}

	public OctreeSceneManager(String name, com.earthview.world.spatial.math.AxisAlignedBox box, int max_depth) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer namePtr = new BasePointer(name);
		list.add("name", namePtr.get());
	...
	native private void init_CAxisAlignedBox_int(long pNativeObject, long box, int d);
	public void init(com.earthview.world.spatial.math.AxisAlignedBox box, int d)
	{
		long boxParamValue = box.nativeObject.pointer;
		int dParamValue = d;
		init_CAxisAlignedBox_int(this.nativeObject.pointer, boxParamValue, dParamValue);
	}
	...
	protected  void _alertVisibleObjects_void_callback()
	{
		_alertVisibleObjects();
	}

	native private void _alertVisibleObjects_void(long pNativeObject);
	public void _alertVisibleObjects()
	{
		_alertVisibleObjects_void(this.nativeObject.pointer);
	}
	native private void _alertVisibleObjects_void_NoVirtual(long pNativeObject);
	protected void _alertVisibleObjects_NoVirtual()
	{
		_alertVisibleObjects_void_NoVirtual(this.nativeObject.pointer);
	}

	native private void walkOctree_COctreeCamera_CRenderQueue_COctree_VisibleObjectsBoundsInfo_ev_bool_ev_bool_ev_bool(long pNativeObject, long camera, long queue, long octant, long visibleBounds, boolean foundvisible, boolean onlyShadowCasters, boolean oceanDepthRendering);
	public void walkOctree(com.earthview.world.graphic.OctreeCamera camera, com.earthview.world.graphic.RenderQueue queue, com.earthview.world.graphic.Octree octant, com.earthview.world.graphic.VisibleObjectsBoundsInfo visibleBounds, boolean foundvisible, boolean onlyShadowCasters, boolean oceanDepthRendering)
	{
		...
		long octantParamValue = (octant == null ? 0L : octant.nativeObject.pointer);
		long visibleBoundsParamValue = (visibleBounds == null ? 0L : visibleBounds.nativeObject.pointer);
		boolean foundvisibleParamValue = foundvisible;
		boolean onlyShadowCastersParamValue = onlyShadowCasters;
		boolean oceanDepthRenderingParamValue = oceanDepthRendering;
		walkOctree_COctreeCamera_CRenderQueue_COctree_VisibleObjectsBoundsInfo_ev_bool_ev_bool_ev_bool(this.nativeObject.pointer, cameraParamValue, queueParamValue, octantParamValue, visibleBoundsParamValue, foundvisibleParamValue, onlyShadowCastersParamValue, oceanDepthRenderingParamValue);
	}
	native private void walkOctree_COctreeCamera_COctree_ev_bool(long pNativeObject, long camera, long octant, boolean foundvisible);
	public void walkOctree(com.earthview.world.graphic.OctreeCamera camera, com.earthview.world.graphic.Octree octant, boolean foundvisible)
	{
		long cameraParamValue = (camera == null ? 0L : camera.nativeObject.pointer);
		long octantParamValue = (octant == null ? 0L : octant.nativeObject.pointer);
		boolean foundvisibleParamValue = foundvisible;
		walkOctree_COctreeCamera_COctree_ev_bool(this.nativeObject.pointer, cameraParamValue, octantParamValue, foundvisibleParamValue);
	}
	native private void _updateOctreeNode_COctreeNode(long pNativeObject, long onode);
	public void _updateOctreeNode(com.earthview.world.graphic.OctreeNode onode)
	{
		long onodeParamValue = (onode == null ? 0L : onode.nativeObject.pointer);
		_updateOctreeNode_COctreeNode(this.nativeObject.pointer, onodeParamValue);
	}
	native private void _removeOctreeNode_COctreeNode(long pNativeObject, long onode);
	public void _removeOctreeNode(com.earthview.world.graphic.OctreeNode onode)
	{
		long onodeParamValue = (onode == null ? 0L : onode.nativeObject.pointer);
		_removeOctreeNode_COctreeNode(this.nativeObject.pointer, onodeParamValue);
	}
	native private void _addOctreeNode_COctreeNode_COctree_int(long pNativeObject, long ref_n, long ref_octree, int depth);
	public void _addOctreeNode(com.earthview.world.graphic.OctreeNode ref_n, com.earthview.world.graphic.Octree ref_octree, int depth)
	{
		long ref_nParamValue = (ref_n == null ? 0L : ref_n.nativeObject.pointer);
		long ref_octreeParamValue = (ref_octree == null ? 0L : ref_octree.nativeObject.pointer);
		int depthParamValue = depth;
		_addOctreeNode_COctreeNode_COctree_int(this.nativeObject.pointer, ref_nParamValue, ref_octreeParamValue, depthParamValue);
	}
	native private void _addOctreeNode_COctreeNode_COctree(long pNativeObject, long ref_n, long ref_octree);
	public void _addOctreeNode(com.earthview.world.graphic.OctreeNode ref_n, com.earthview.world.graphic.Octree ref_octree)
	{
		long ref_nParamValue = (ref_n == null ? 0L : ref_n.nativeObject.pointer);
		long ref_octreeParamValue = (ref_octree == null ? 0L : ref_octree.nativeObject.pointer);
		_addOctreeNode_COctreeNode_COctree(this.nativeObject.pointer, ref_nParamValue, ref_octreeParamValue);
	}
	native private void findNodesIn_CAxisAlignedBox_SceneNodes_CSceneNode(long pNativeObject, long box, long list, long exclude);
	public void findNodesIn(com.earthview.world.spatial.math.AxisAlignedBox box, com.earthview.world.graphic.SceneNodes list, com.earthview.world.graphic.SceneNode exclude)
	{
		long boxParamValue = box.nativeObject.pointer;
		long listParamValue = list.nativeObject.pointer;
		long excludeParamValue = (exclude == null ? 0L : exclude.nativeObject.pointer);
		findNodesIn_CAxisAlignedBox_SceneNodes_CSceneNode(this.nativeObject.pointer, boxParamValue, listParamValue, excludeParamValue);
	}
	native private void findNodesIn_CAxisAlignedBox_SceneNodes(long pNativeObject, long box, long list);
	public void findNodesIn(com.earthview.world.spatial.math.AxisAlignedBox box, com.earthview.world.graphic.SceneNodes list)
	{
		long boxParamValue = box.nativeObject.pointer;
		long listParamValue = list.nativeObject.pointer;
		findNodesIn_CAxisAlignedBox_SceneNodes(this.nativeObject.pointer, boxParamValue, listParamValue);
	}
	native private void findNodesIn_CSphere_SceneNodes_CSceneNode(long pNativeObject, long sphere, long list, long exclude);
	public void findNodesIn(com.earthview.world.spatial.math.Sphere sphere, com.earthview.world.graphic.SceneNodes list, com.earthview.world.graphic.SceneNode exclude)
	{
		long sphereParamValue = sphere.nativeObject.pointer;
		long listParamValue = list.nativeObject.pointer;
		long excludeParamValue = (exclude == null ? 0L : exclude.nativeObject.pointer);
		findNodesIn_CSphere_SceneNodes_CSceneNode(this.nativeObject.pointer, sphereParamValue, listParamValue, excludeParamValue);
	}
	native private void findNodesIn_CSphere_SceneNodes(long pNativeObject, long sphere, long list);
	public void findNodesIn(com.earthview.world.spatial.math.Sphere sphere, com.earthview.world.graphic.SceneNodes list)
	{
		long sphereParamValue = sphere.nativeObject.pointer;
		long listParamValue = list.nativeObject.pointer;
		findNodesIn_CSphere_SceneNodes(this.nativeObject.pointer, sphereParamValue, listParamValue);
	}
	native private void findNodesIn_CPlaneBoundedVolume_SceneNodes_CSceneNode(long pNativeObject, long volume, long list, long exclude);
	public void findNodesIn(com.earthview.world.spatial.math.PlaneBoundedVolume volume, com.earthview.world.graphic.SceneNodes list, com.earthview.world.graphic.SceneNode exclude)
	{
		long volumeParamValue = volume.nativeObject.pointer;
		long listParamValue = list.nativeObject.pointer;
		long excludeParamValue = (exclude == null ? 0L : exclude.nativeObject.pointer);
		findNodesIn_CPlaneBoundedVolume_SceneNodes_CSceneNode(this.nativeObject.pointer, volumeParamValue, listParamValue, excludeParamValue);
	}
	native private void findNodesIn_CPlaneBoundedVolume_SceneNodes(long pNativeObject, long volume, long list);
	public void findNodesIn(com.earthview.world.spatial.math.PlaneBoundedVolume volume, com.earthview.world.graphic.SceneNodes list)
	{
		long volumeParamValue = volume.nativeObject.pointer;
		long listParamValue = list.nativeObject.pointer;
		findNodesIn_CPlaneBoundedVolume_SceneNodes(this.nativeObject.pointer, volumeParamValue, listParamValue);
	}
	native private void findNodesIn_CRay_SceneNodes_CSceneNode(long pNativeObject, long ray, long list, long exclude);
	public void findNodesIn(com.earthview.world.spatial.math.Ray ray, com.earthview.world.graphic.SceneNodes list, com.earthview.world.graphic.SceneNode exclude)
	{
		long rayParamValue = ray.nativeObject.pointer;
		long listParamValue = list.nativeObject.pointer;
		long excludeParamValue = (exclude == null ? 0L : exclude.nativeObject.pointer);
		findNodesIn_CRay_SceneNodes_CSceneNode(this.nativeObject.pointer, rayParamValue, listParamValue, excludeParamValue);
	}
	native private void findNodesIn_CRay_SceneNodes(long pNativeObject, long ray, long list);
	public void findNodesIn(com.earthview.world.spatial.math.Ray ray, com.earthview.world.graphic.SceneNodes list)
	{
		long rayParamValue = ray.nativeObject.pointer;
		long listParamValue = list.nativeObject.pointer;
		findNodesIn_CRay_SceneNodes(this.nativeObject.pointer, rayParamValue, listParamValue);
	}
	native private void setShowBoxes_ev_bool(long pNativeObject, boolean b);
	public void setShowBoxes(boolean b)
	{
		boolean bParamValue = b;
		setShowBoxes_ev_bool(this.nativeObject.pointer, bParamValue);
	}
	native private void setLooseOctree_ev_bool(long pNativeObject, boolean b);
	public void setLooseOctree(boolean b)
	{
		boolean bParamValue = b;
		setLooseOctree_ev_bool(this.nativeObject.pointer, bParamValue);
	}
	native private void resize_CAxisAlignedBox(long pNativeObject, long box);
	public void resize(com.earthview.world.spatial.math.AxisAlignedBox box)
	{
		long boxParamValue = box.nativeObject.pointer;
		resize_CAxisAlignedBox(this.nativeObject.pointer, boxParamValue);
	}
	native private boolean setOption_EVString_void(long pNativeObject, String key, long val);
	public boolean setOption(String key, VoidPointer val)
	{
		String keyParamValue = key;
		long valParamValue = (val == null ? 0L : val.nativeObject.pointer);
		boolean returnValue = setOption_EVString_void(this.nativeObject.pointer, keyParamValue, valParamValue);
		return returnValue;
	}
	native private boolean setOption_EVString_void_NoVirtual(long pNativeObject, String key, long val);
	protected boolean setOption_NoVirtual(String key, VoidPointer val)
	{
		String keyParamValue = key;
		long valParamValue = (val == null ? 0L : val.nativeObject.pointer);
		boolean returnValue = setOption_EVString_void_NoVirtual(this.nativeObject.pointer, keyParamValue, valParamValue);
		return returnValue;
	}

	native private boolean getOption_EVString_void(long pNativeObject, String key, long val);
	public boolean getOption(String key, VoidPointer val)
	{
		String keyParamValue = key;
		long valParamValue = (val == null ? 0L : val.nativeObject.pointer);
		boolean returnValue = getOption_EVString_void(this.nativeObject.pointer, keyParamValue, valParamValue);
		return returnValue;
	}
	native private boolean getOption_EVString_void_NoVirtual(long pNativeObject, String key, long val);
	protected boolean getOption_NoVirtual(String key, VoidPointer val)
	{
		String keyParamValue = key;
		long valParamValue = (val == null ? 0L : val.nativeObject.pointer);
		boolean returnValue = getOption_EVString_void_NoVirtual(this.nativeObject.pointer, keyParamValue, valParamValue);
		return returnValue;
	}

	native private boolean getOptionValues_EVString_StringVector(long pNativeObject, String key, long refValueList);
	public boolean getOptionValues(String key, com.earthview.world.core.StringVector refValueList)
	{
		String keyParamValue = key;
		long refValueListParamValue = refValueList.nativeObject.pointer;
		boolean returnValue = getOptionValues_EVString_StringVector(this.nativeObject.pointer, keyParamValue, refValueListParamValue);
		return returnValue;
	}
	native private boolean getOptionValues_EVString_StringVector_NoVirtual(long pNativeObject, String key, long refValueList);
	protected boolean getOptionValues_NoVirtual(String key, com.earthview.world.core.StringVector refValueList)
	{
		String keyParamValue = key;
		long refValueListParamValue = refValueList.nativeObject.pointer;
		boolean returnValue = getOptionValues_EVString_StringVector_NoVirtual(this.nativeObject.pointer, keyParamValue, refValueListParamValue);
		return returnValue;
	}
	...
	public OctreeSceneManager(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public OctreeSceneManager(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static OctreeSceneManager fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		OctreeSceneManager obj = null;
 		if(baseObj instanceof OctreeSceneManager)
		{
			obj = (OctreeSceneManager)baseObj;
		} else {
			obj = new OctreeSceneManager(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "COctreeSceneManager");
			obj.increaseCast();
		}
