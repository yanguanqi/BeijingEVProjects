...
public class OctreeNode extends com.earthview.world.graphic.SceneNode {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::COctreeNode", new OctreeNodeClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::JCOctreeNodeProxy", new OctreeNodeClassFactory());
	}

	public OctreeNode(com.earthview.world.graphic.SceneManager ref_creator) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer ref_creatorPtr = new BasePointer(ref_creator);
		list.add("ref_creator", ref_creatorPtr.get());
		Create("JCOctreeNodeProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.OctreeNode".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
		}
	}

	public OctreeNode(com.earthview.world.graphic.SceneManager ref_creator, String name) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer ref_creatorPtr = new BasePointer(ref_creator);
		list.add("ref_creator", ref_creatorPtr.get());
	...
	native private long getOctant_void(long pNativeObject);
	public com.earthview.world.graphic.Octree getOctant()
	{
		long returnValue = getOctant_void(this.nativeObject.pointer);
		if(returnValue == 0L) {
			return null;
		}
		com.earthview.world.graphic.Octree __returnValue = new com.earthview.world.graphic.Octree(CreatedWhenConstruct.CWC_NotToCreate, "COctree");
		__returnValue.setDelegate(true);
		InstancePointer __instancePointer = new InstancePointer(returnValue);
		__returnValue.setInstancePointer(__instancePointer);
		IClassFactory __returnValueClassFactory = GlobalClassFactoryMap.get(__returnValue.getCppInstanceTypeName());
		...
		{
			__returnValue.setDelegate(true);
			__returnValue = (com.earthview.world.graphic.Octree)__returnValueClassFactory.create();
			__returnValue.setDelegate(true);
			__returnValue.bindNativeObject(__instancePointer, "COctree");
		}
		return __returnValue;
	}
	native private void setOctant_COctree(long pNativeObject, long ref_o);
	public void setOctant(com.earthview.world.graphic.Octree ref_o)
	{
		long ref_oParamValue = (ref_o == null ? 0L : ref_o.nativeObject.pointer);
		setOctant_COctree(this.nativeObject.pointer, ref_oParamValue);
	}
	native private boolean _isIn_CAxisAlignedBox(long pNativeObject, long box);
	public boolean _isIn(com.earthview.world.spatial.math.AxisAlignedBox box)
	{
		long boxParamValue = box.nativeObject.pointer;
		boolean returnValue = _isIn_CAxisAlignedBox(this.nativeObject.pointer, boxParamValue);
		return returnValue;
	}
	protected  void _addToRenderQueue_CCamera_CRenderQueue_ev_bool_VisibleObjectsBoundsInfo_callback(long cam, long q, boolean onlyShadowCasters, long visibleBounds)
	{
		...
		com.earthview.world.graphic.RenderQueue qParamValue = (q == 0L ? null : new com.earthview.world.graphic.RenderQueue(CreatedWhenConstruct.CWC_NotToCreate));
		if(qParamValue != null)
		{
		...
		{
			qParamValue.setDelegate(true);
			qParamValue = (com.earthview.world.graphic.RenderQueue)qParamValueClassFactory.create();
			qParamValue.setDelegate(true);
			qParamValue.setInstancePointer(new InstancePointer(q));
		}
		}
		...
		_addToRenderQueue(camParamValue, qParamValue, onlyShadowCastersParamValue, visibleBoundsParamValue);
	}
	...
	native private long _getLocalAABB_void(long pNativeObject);
	public com.earthview.world.spatial.math.AxisAlignedBox _getLocalAABB()
	{
		long returnValue = _getLocalAABB_void(this.nativeObject.pointer);
	...
	public OctreeNode(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public OctreeNode(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static OctreeNode fromBaseObject(BaseObject baseObj)
	{
		...
		OctreeNode obj = null;
 		if(baseObj instanceof OctreeNode)
		{
			obj = (OctreeNode)baseObj;
		} else {
