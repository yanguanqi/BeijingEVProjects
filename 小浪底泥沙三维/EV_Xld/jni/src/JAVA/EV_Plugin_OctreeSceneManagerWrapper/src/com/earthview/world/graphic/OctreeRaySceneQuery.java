...
public class OctreeRaySceneQuery extends com.earthview.world.graphic.DefaultRaySceneQuery {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::COctreeRaySceneQuery", new OctreeRaySceneQueryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::JCOctreeRaySceneQueryProxy", new OctreeRaySceneQueryClassFactory());
	}

	public OctreeRaySceneQuery(com.earthview.world.graphic.SceneManager ref_creator) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer ref_creatorPtr = new BasePointer(ref_creator);
		list.add("ref_creator", ref_creatorPtr.get());
		Create("JCOctreeRaySceneQueryProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.OctreeRaySceneQuery".equals(this.getClass().getName()))
		{
	...
	public OctreeRaySceneQuery(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public OctreeRaySceneQuery(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static OctreeRaySceneQuery fromBaseObject(BaseObject baseObj)
	{
		...
		OctreeRaySceneQuery obj = null;
 		if(baseObj instanceof OctreeRaySceneQuery)
		{
			obj = (OctreeRaySceneQuery)baseObj;
		} else {
