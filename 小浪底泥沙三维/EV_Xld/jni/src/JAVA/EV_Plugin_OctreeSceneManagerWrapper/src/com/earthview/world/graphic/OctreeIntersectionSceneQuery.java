...
public class OctreeIntersectionSceneQuery extends com.earthview.world.graphic.DefaultIntersectionSceneQuery {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::COctreeIntersectionSceneQuery", new OctreeIntersectionSceneQueryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::JCOctreeIntersectionSceneQueryProxy", new OctreeIntersectionSceneQueryClassFactory());
	}

	public OctreeIntersectionSceneQuery(com.earthview.world.graphic.SceneManager ref_creator) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer ref_creatorPtr = new BasePointer(ref_creator);
		list.add("ref_creator", ref_creatorPtr.get());
		Create("JCOctreeIntersectionSceneQueryProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.OctreeIntersectionSceneQuery".equals(this.getClass().getName()))
		{
	...
	public OctreeIntersectionSceneQuery(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public OctreeIntersectionSceneQuery(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static OctreeIntersectionSceneQuery fromBaseObject(BaseObject baseObj)
	{
		...
		OctreeIntersectionSceneQuery obj = null;
 		if(baseObj instanceof OctreeIntersectionSceneQuery)
		{
			obj = (OctreeIntersectionSceneQuery)baseObj;
		} else {
