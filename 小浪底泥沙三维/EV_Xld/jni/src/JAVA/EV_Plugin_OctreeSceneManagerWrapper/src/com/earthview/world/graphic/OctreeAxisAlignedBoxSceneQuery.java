...
public class OctreeAxisAlignedBoxSceneQuery extends com.earthview.world.graphic.DefaultAxisAlignedBoxSceneQuery {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::COctreeAxisAlignedBoxSceneQuery", new OctreeAxisAlignedBoxSceneQueryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::JCOctreeAxisAlignedBoxSceneQueryProxy", new OctreeAxisAlignedBoxSceneQueryClassFactory());
	}

	public OctreeAxisAlignedBoxSceneQuery(com.earthview.world.graphic.SceneManager ref_creator) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer ref_creatorPtr = new BasePointer(ref_creator);
		list.add("ref_creator", ref_creatorPtr.get());
		Create("JCOctreeAxisAlignedBoxSceneQueryProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.OctreeAxisAlignedBoxSceneQuery".equals(this.getClass().getName()))
		{
	...
	public OctreeAxisAlignedBoxSceneQuery(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public OctreeAxisAlignedBoxSceneQuery(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static OctreeAxisAlignedBoxSceneQuery fromBaseObject(BaseObject baseObj)
	{
		...
		OctreeAxisAlignedBoxSceneQuery obj = null;
 		if(baseObj instanceof OctreeAxisAlignedBoxSceneQuery)
		{
			obj = (OctreeAxisAlignedBoxSceneQuery)baseObj;
		} else {
