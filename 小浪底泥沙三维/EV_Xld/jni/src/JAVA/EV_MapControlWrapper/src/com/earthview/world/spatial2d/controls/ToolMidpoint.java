...
public class ToolMidpoint extends com.earthview.world.spatial2d.controls.NewGeometryTool {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CToolMidpoint", new ToolMidpointClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCToolMidpointProxy", new ToolMidpointClassFactory());
	}
	...
	public ToolMidpoint() {
		...
		Create("JCToolMidpointProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.ToolMidpoint".equals(this.getClass().getName()))
		{
	...
	public ToolMidpoint(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ToolMidpoint(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ToolMidpoint fromBaseObject(BaseObject baseObj)
	{
		...
		ToolMidpoint obj = null;
 		if(baseObj instanceof ToolMidpoint)
		{
			obj = (ToolMidpoint)baseObj;
		} else {
