...
public class EditingCircle extends com.earthview.world.spatial2d.controls.EditingCurve {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CEditingCircle", new EditingCircleClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCEditingCircleProxy", new EditingCircleClassFactory());
	}

	public EditingCircle() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCEditingCircleProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.EditingCircle".equals(this.getClass().getName()))
		{
	...
	public EditingCircle(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public EditingCircle(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static EditingCircle fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		EditingCircle obj = null;
 		if(baseObj instanceof EditingCircle)
		{
			obj = (EditingCircle)baseObj;
		} else {
			obj = new EditingCircle(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CEditingCircle");
			obj.increaseCast();
		}
