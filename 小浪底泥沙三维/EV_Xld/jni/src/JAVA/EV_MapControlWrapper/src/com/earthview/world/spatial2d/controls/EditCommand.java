...
public class EditCommand extends com.earthview.world.spatial2d.controls.MapCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CEditCommand", new EditCommandClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCEditCommandProxy", new EditCommandClassFactory());
	}
	...
	public EditCommand() {
		...
		Create("JCEditCommandProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.EditCommand".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
		}
	}

	public EditCommand(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public EditCommand(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static EditCommand fromBaseObject(BaseObject baseObj)
	{
		...
		EditCommand obj = null;
 		if(baseObj instanceof EditCommand)
		{
			obj = (EditCommand)baseObj;
		} else {
