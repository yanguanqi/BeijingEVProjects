...
public class MapCommand extends com.earthview.world.spatial.systemui.Icommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CMapCommand", new MapCommandClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCMapCommandProxy", new MapCommandClassFactory());
	}
	...
	public MapCommand() {
		...
		Create("JCMapCommandProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.MapCommand".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
		}
	}

	public MapCommand(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public MapCommand(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static MapCommand fromBaseObject(BaseObject baseObj)
	{
		...
		MapCommand obj = null;
 		if(baseObj instanceof MapCommand)
		{
			obj = (MapCommand)baseObj;
		} else {
