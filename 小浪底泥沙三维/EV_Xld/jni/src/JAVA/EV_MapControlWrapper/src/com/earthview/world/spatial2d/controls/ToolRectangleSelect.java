...
public class ToolRectangleSelect extends com.earthview.world.spatial2d.controls.Tool2D {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CToolRectangleSelect", new ToolRectangleSelectClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCToolRectangleSelectProxy", new ToolRectangleSelectClassFactory());
	}
	 ...
	 * @param  
	 */
	public ToolRectangleSelect() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCToolRectangleSelectProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.ToolRectangleSelect".equals(this.getClass().getName()))
		{
	...
	public ToolRectangleSelect(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ToolRectangleSelect(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ToolRectangleSelect fromBaseObject(BaseObject baseObj)
	{
		...
		ToolRectangleSelect obj = null;
 		if(baseObj instanceof ToolRectangleSelect)
		{
			obj = (ToolRectangleSelect)baseObj;
		} else {
