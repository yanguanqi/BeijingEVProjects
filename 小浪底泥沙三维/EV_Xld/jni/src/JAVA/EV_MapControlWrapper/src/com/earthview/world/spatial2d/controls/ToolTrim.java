...
public class ToolTrim extends com.earthview.world.spatial2d.controls.NewNonPointTypeTool {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CToolTrim", new ToolTrimClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCToolTrimProxy", new ToolTrimClassFactory());
	}
	...
	public ToolTrim() {
		...
		Create("JCToolTrimProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.ToolTrim".equals(this.getClass().getName()))
		{
	...
	public ToolTrim(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ToolTrim(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ToolTrim fromBaseObject(BaseObject baseObj)
	{
		...
		ToolTrim obj = null;
 		if(baseObj instanceof ToolTrim)
		{
			obj = (ToolTrim)baseObj;
		} else {
