...
public class ToolEllipticSector extends com.earthview.world.spatial2d.controls.NewNonPointTypeTool {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CToolEllipticSector", new ToolEllipticSectorClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCToolEllipticSectorProxy", new ToolEllipticSectorClassFactory());
	}
	 ...
	 * @param  
	 */
	public ToolEllipticSector() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCToolEllipticSectorProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.ToolEllipticSector".equals(this.getClass().getName()))
		{
	...
	public ToolEllipticSector(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ToolEllipticSector(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ToolEllipticSector fromBaseObject(BaseObject baseObj)
	{
		...
		ToolEllipticSector obj = null;
 		if(baseObj instanceof ToolEllipticSector)
		{
			obj = (ToolEllipticSector)baseObj;
		} else {
