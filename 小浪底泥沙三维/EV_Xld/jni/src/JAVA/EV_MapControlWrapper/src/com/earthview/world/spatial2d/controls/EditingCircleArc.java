...
public class EditingCircleArc extends com.earthview.world.spatial2d.controls.EditingLineString {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CEditingCircleArc", new EditingCircleArcClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCEditingCircleArcProxy", new EditingCircleArcClassFactory());
	}

	public EditingCircleArc() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCEditingCircleArcProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.EditingCircleArc".equals(this.getClass().getName()))
		{
	...
	public EditingCircleArc(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public EditingCircleArc(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static EditingCircleArc fromBaseObject(BaseObject baseObj)
	{
		...
		EditingCircleArc obj = null;
 		if(baseObj instanceof EditingCircleArc)
		{
			obj = (EditingCircleArc)baseObj;
		} else {
