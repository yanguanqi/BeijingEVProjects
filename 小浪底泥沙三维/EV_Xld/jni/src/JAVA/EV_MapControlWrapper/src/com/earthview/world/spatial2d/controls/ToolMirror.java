...
public class ToolMirror extends com.earthview.world.spatial2d.controls.NewNonPointTypeTool {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CToolMirror", new ToolMirrorClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCToolMirrorProxy", new ToolMirrorClassFactory());
	}
	...
	public ToolMirror() {
		...
		Create("JCToolMirrorProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.ToolMirror".equals(this.getClass().getName()))
		{
	...
	public ToolMirror(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ToolMirror(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ToolMirror fromBaseObject(BaseObject baseObj)
	{
		...
		ToolMirror obj = null;
 		if(baseObj instanceof ToolMirror)
		{
			obj = (ToolMirror)baseObj;
		} else {
