...
public class CommandSimplify extends com.earthview.world.spatial2d.controls.EditCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CCommandSimplify", new CommandSimplifyClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCCommandSimplifyProxy", new CommandSimplifyClassFactory());
	}
	...
	public CommandSimplify() {
		...
		Create("JCCommandSimplifyProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.CommandSimplify".equals(this.getClass().getName()))
		{
	...
	native private boolean simplifyFeature_ev_real64(long pNativeObject, double dDeviation);
	/**
	 * 概化要素
	 * @param dDeviation 最大偏移
	 */
	public boolean simplifyFeature(double dDeviation)
	{
		double dDeviationParamValue = dDeviation;
		boolean returnValue = simplifyFeature_ev_real64(this.nativeObject.pointer, dDeviationParamValue);
		return returnValue;
	}
	...
	public CommandSimplify(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandSimplify(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandSimplify fromBaseObject(BaseObject baseObj)
	{
		...
		CommandSimplify obj = null;
 		if(baseObj instanceof CommandSimplify)
		{
			obj = (CommandSimplify)baseObj;
		} else {
