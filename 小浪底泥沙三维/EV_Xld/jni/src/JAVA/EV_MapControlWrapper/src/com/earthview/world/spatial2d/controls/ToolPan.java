...
public class ToolPan extends com.earthview.world.spatial2d.controls.Tool2D {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CToolPan", new ToolPanClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCToolPanProxy", new ToolPanClassFactory());
	}
	...
	public ToolPan() {
		...
		Create("JCToolPanProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.ToolPan".equals(this.getClass().getName()))
		{
	...
	public ToolPan(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ToolPan(CreatedWhenConstruct cwc, String classNameStr) {
