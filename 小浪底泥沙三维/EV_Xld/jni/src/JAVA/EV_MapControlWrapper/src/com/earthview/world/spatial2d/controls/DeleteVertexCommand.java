...
public class DeleteVertexCommand extends com.earthview.world.spatial2d.controls.MapCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CDeleteVertexCommand", new DeleteVertexCommandClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCDeleteVertexCommandProxy", new DeleteVertexCommandClassFactory());
	}
	...
	public DeleteVertexCommand() {
		...
		Create("JCDeleteVertexCommandProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.DeleteVertexCommand".equals(this.getClass().getName()))
		{
	...
	public DeleteVertexCommand(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public DeleteVertexCommand(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static DeleteVertexCommand fromBaseObject(BaseObject baseObj)
	{
		...
		DeleteVertexCommand obj = null;
 		if(baseObj instanceof DeleteVertexCommand)
		{
			obj = (DeleteVertexCommand)baseObj;
		} else {
