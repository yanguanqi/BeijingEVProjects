...
public class ToolRoundRectangle extends com.earthview.world.spatial2d.controls.NewNonPointTypeTool {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CToolRoundRectangle", new ToolRoundRectangleClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCToolRoundRectangleProxy", new ToolRoundRectangleClassFactory());
	}
	 ...
	 * @param  
	 */
	public ToolRoundRectangle() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCToolRoundRectangleProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.ToolRoundRectangle".equals(this.getClass().getName()))
		{
	...
	public ToolRoundRectangle(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ToolRoundRectangle(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ToolRoundRectangle fromBaseObject(BaseObject baseObj)
	{
		...
		ToolRoundRectangle obj = null;
 		if(baseObj instanceof ToolRoundRectangle)
		{
			obj = (ToolRoundRectangle)baseObj;
		} else {
