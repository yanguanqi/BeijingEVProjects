...
public class CommandClearSelection extends com.earthview.world.spatial2d.controls.MapCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CCommandClearSelection", new CommandClearSelectionClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCCommandClearSelectionProxy", new CommandClearSelectionClassFactory());
	}
	 ...
	 * @param  
	 */
	public CommandClearSelection() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandClearSelectionProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.CommandClearSelection".equals(this.getClass().getName()))
		{
	...
	public CommandClearSelection(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandClearSelection(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandClearSelection fromBaseObject(BaseObject baseObj)
	{
		...
		CommandClearSelection obj = null;
 		if(baseObj instanceof CommandClearSelection)
		{
			obj = (CommandClearSelection)baseObj;
		} else {
