...
public class EditingCircleArched extends com.earthview.world.spatial2d.controls.EditingCurve {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CEditingCircleArched", new EditingCircleArchedClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCEditingCircleArchedProxy", new EditingCircleArchedClassFactory());
	}

	public EditingCircleArched() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCEditingCircleArchedProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.EditingCircleArched".equals(this.getClass().getName()))
		{
	...
	public EditingCircleArched(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public EditingCircleArched(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static EditingCircleArched fromBaseObject(BaseObject baseObj)
	{
		...
		EditingCircleArched obj = null;
 		if(baseObj instanceof EditingCircleArched)
		{
			obj = (EditingCircleArched)baseObj;
		} else {
