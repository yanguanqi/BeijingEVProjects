...
public class CommandRefresh extends com.earthview.world.spatial2d.controls.MapCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CCommandRefresh", new CommandRefreshClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCCommandRefreshProxy", new CommandRefreshClassFactory());
	}
	...
	public CommandRefresh() {
		...
		Create("JCCommandRefreshProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.CommandRefresh".equals(this.getClass().getName()))
		{
	...
	public CommandRefresh(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandRefresh(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandRefresh fromBaseObject(BaseObject baseObj)
	{
		...
		CommandRefresh obj = null;
 		if(baseObj instanceof CommandRefresh)
		{
			obj = (CommandRefresh)baseObj;
		} else {
