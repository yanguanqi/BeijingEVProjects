...
public class CommandBufferAnalysis extends com.earthview.world.spatial2d.controls.MapCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CCommandBufferAnalysis", new CommandBufferAnalysisClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCCommandBufferAnalysisProxy", new CommandBufferAnalysisClassFactory());
	}
	 ...
	 * @param  
	 */
	public CommandBufferAnalysis() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandBufferAnalysisProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.CommandBufferAnalysis".equals(this.getClass().getName()))
		{
	...
	public CommandBufferAnalysis(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandBufferAnalysis(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandBufferAnalysis fromBaseObject(BaseObject baseObj)
	{
		...
		CommandBufferAnalysis obj = null;
 		if(baseObj instanceof CommandBufferAnalysis)
		{
			obj = (CommandBufferAnalysis)baseObj;
		} else {
