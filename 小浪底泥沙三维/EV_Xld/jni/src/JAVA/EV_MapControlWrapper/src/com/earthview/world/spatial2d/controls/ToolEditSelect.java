...
public class ToolEditSelect extends com.earthview.world.spatial2d.controls.Tool2D {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CToolEditSelect", new ToolEditSelectClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCToolEditSelectProxy", new ToolEditSelectClassFactory());
	}
	 ...
	 * @param  
	 */
	public ToolEditSelect() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCToolEditSelectProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.ToolEditSelect".equals(this.getClass().getName()))
		{
	...
	public ToolEditSelect(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ToolEditSelect(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ToolEditSelect fromBaseObject(BaseObject baseObj)
	{
		...
		ToolEditSelect obj = null;
 		if(baseObj instanceof ToolEditSelect)
		{
			obj = (ToolEditSelect)baseObj;
		} else {
