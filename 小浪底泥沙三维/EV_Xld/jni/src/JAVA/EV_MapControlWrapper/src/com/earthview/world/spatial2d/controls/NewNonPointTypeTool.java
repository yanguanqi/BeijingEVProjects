...
public class NewNonPointTypeTool extends com.earthview.world.spatial2d.controls.NewGeometryTool {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CNewNonPointTypeTool", new NewNonPointTypeToolClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCNewNonPointTypeToolProxy", new NewNonPointTypeToolClassFactory());
	}
	...
	public NewNonPointTypeTool(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public NewNonPointTypeTool(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static NewNonPointTypeTool fromBaseObject(BaseObject baseObj)
	{
		...
		NewNonPointTypeTool obj = null;
 		if(baseObj instanceof NewNonPointTypeTool)
		{
			obj = (NewNonPointTypeTool)baseObj;
		} else {
