...
public class CommandDeleteFeature extends com.earthview.world.spatial2d.controls.MapCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CCommandDeleteFeature", new CommandDeleteFeatureClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCCommandDeleteFeatureProxy", new CommandDeleteFeatureClassFactory());
	}
	 ...
	 * @param  
	 */
	public CommandDeleteFeature() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandDeleteFeatureProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.CommandDeleteFeature".equals(this.getClass().getName()))
		{
	...
	public CommandDeleteFeature(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandDeleteFeature(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandDeleteFeature fromBaseObject(BaseObject baseObj)
	{
		...
		CommandDeleteFeature obj = null;
 		if(baseObj instanceof CommandDeleteFeature)
		{
			obj = (CommandDeleteFeature)baseObj;
		} else {
