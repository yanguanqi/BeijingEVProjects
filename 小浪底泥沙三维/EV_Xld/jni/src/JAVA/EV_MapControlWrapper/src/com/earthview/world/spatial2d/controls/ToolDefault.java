...
public class ToolDefault extends com.earthview.world.spatial2d.controls.Tool2D {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CToolDefault", new ToolDefaultClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCToolDefaultProxy", new ToolDefaultClassFactory());
	}

	public ToolDefault() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCToolDefaultProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.ToolDefault".equals(this.getClass().getName()))
		{
	...
	public ToolDefault(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ToolDefault(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ToolDefault fromBaseObject(BaseObject baseObj)
	{
		...
		ToolDefault obj = null;
 		if(baseObj instanceof ToolDefault)
		{
			obj = (ToolDefault)baseObj;
		} else {
