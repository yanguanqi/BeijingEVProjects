...
public class EditTool extends com.earthview.world.spatial2d.controls.Tool2D {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CEditTool", new EditToolClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCEditToolProxy", new EditToolClassFactory());
	}
	...
	native private void clearTrace_void(long pNativeObject);
	/**
	 * 清空临时几何对象的痕迹
	 * @param  
	 */
	...
	{
		clearTrace_void(this.nativeObject.pointer);
	}
	...
	public EditTool(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public EditTool(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static EditTool fromBaseObject(BaseObject baseObj)
	{
		...
		EditTool obj = null;
 		if(baseObj instanceof EditTool)
		{
			obj = (EditTool)baseObj;
		} else {
