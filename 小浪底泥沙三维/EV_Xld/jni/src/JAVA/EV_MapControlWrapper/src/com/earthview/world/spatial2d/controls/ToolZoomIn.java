...
public class ToolZoomIn extends com.earthview.world.spatial2d.controls.Tool2D {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CToolZoomIn", new ToolZoomInClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCToolZoomInProxy", new ToolZoomInClassFactory());
	}
	...
	public ToolZoomIn() {
		...
		Create("JCToolZoomInProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.ToolZoomIn".equals(this.getClass().getName()))
		{
	...
	public ToolZoomIn(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ToolZoomIn(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ToolZoomIn fromBaseObject(BaseObject baseObj)
	{
		...
		ToolZoomIn obj = null;
 		if(baseObj instanceof ToolZoomIn)
		{
			obj = (ToolZoomIn)baseObj;
		} else {
