...
public class ToolSplitObject extends com.earthview.world.spatial2d.controls.NewNonPointTypeTool {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CToolSplitObject", new ToolSplitObjectClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCToolSplitObjectProxy", new ToolSplitObjectClassFactory());
	}
	 ...
	 * @param  
	 */
	public ToolSplitObject() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCToolSplitObjectProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.ToolSplitObject".equals(this.getClass().getName()))
		{
	...
	public ToolSplitObject(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ToolSplitObject(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ToolSplitObject fromBaseObject(BaseObject baseObj)
	{
		...
		ToolSplitObject obj = null;
 		if(baseObj instanceof ToolSplitObject)
		{
			obj = (ToolSplitObject)baseObj;
		} else {
