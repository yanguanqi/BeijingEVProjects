...
public class ToolEllipticArched extends com.earthview.world.spatial2d.controls.NewNonPointTypeTool {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CToolEllipticArched", new ToolEllipticArchedClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCToolEllipticArchedProxy", new ToolEllipticArchedClassFactory());
	}
	 ...
	 * @param  
	 */
	public ToolEllipticArched() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCToolEllipticArchedProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.ToolEllipticArched".equals(this.getClass().getName()))
		{
	...
	public ToolEllipticArched(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ToolEllipticArched(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ToolEllipticArched fromBaseObject(BaseObject baseObj)
	{
		...
		ToolEllipticArched obj = null;
 		if(baseObj instanceof ToolEllipticArched)
		{
			obj = (ToolEllipticArched)baseObj;
		} else {
