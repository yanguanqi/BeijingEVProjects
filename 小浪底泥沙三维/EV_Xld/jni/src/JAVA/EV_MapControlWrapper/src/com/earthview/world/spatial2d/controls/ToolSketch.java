...
public class ToolSketch extends com.earthview.world.spatial2d.controls.NewGeometryTool {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CToolSketch", new ToolSketchClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCToolSketchProxy", new ToolSketchClassFactory());
	}
	...
	public ToolSketch() {
		...
		Create("JCToolSketchProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.ToolSketch".equals(this.getClass().getName()))
		{
	...
	public ToolSketch(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ToolSketch(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ToolSketch fromBaseObject(BaseObject baseObj)
	{
		...
		ToolSketch obj = null;
 		if(baseObj instanceof ToolSketch)
		{
			obj = (ToolSketch)baseObj;
		} else {
