...
public class ToolTangentCurve extends com.earthview.world.spatial2d.controls.NewCurveTypeTool {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CToolTangentCurve", new ToolTangentCurveClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCToolTangentCurveProxy", new ToolTangentCurveClassFactory());
	}
	 ...
	 * @param  
	 */
	public ToolTangentCurve() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCToolTangentCurveProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.ToolTangentCurve".equals(this.getClass().getName()))
		{
	...
	public ToolTangentCurve(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ToolTangentCurve(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ToolTangentCurve fromBaseObject(BaseObject baseObj)
	{
		...
		ToolTangentCurve obj = null;
 		if(baseObj instanceof ToolTangentCurve)
		{
			obj = (ToolTangentCurve)baseObj;
		} else {
