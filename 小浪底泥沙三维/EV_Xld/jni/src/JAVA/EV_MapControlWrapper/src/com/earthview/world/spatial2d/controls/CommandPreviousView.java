...
public class CommandPreviousView extends com.earthview.world.spatial2d.controls.MapCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CCommandPreviousView", new CommandPreviousViewClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCCommandPreviousViewProxy", new CommandPreviousViewClassFactory());
	}
	 ...
	 * @param  
	 */
	public CommandPreviousView() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandPreviousViewProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.CommandPreviousView".equals(this.getClass().getName()))
		{
	...
	public CommandPreviousView(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandPreviousView(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandPreviousView fromBaseObject(BaseObject baseObj)
	{
		...
		CommandPreviousView obj = null;
 		if(baseObj instanceof CommandPreviousView)
		{
			obj = (CommandPreviousView)baseObj;
		} else {
