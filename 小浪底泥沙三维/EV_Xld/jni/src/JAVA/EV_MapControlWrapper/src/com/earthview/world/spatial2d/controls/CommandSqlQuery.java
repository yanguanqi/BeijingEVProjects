...
public class CommandSqlQuery extends com.earthview.world.spatial2d.controls.MapCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CCommandSqlQuery", new CommandSqlQueryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCCommandSqlQueryProxy", new CommandSqlQueryClassFactory());
	}
	 ...
	 * @param  
	 */
	public CommandSqlQuery() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandSqlQueryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.CommandSqlQuery".equals(this.getClass().getName()))
		{
	...
	public CommandSqlQuery(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandSqlQuery(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandSqlQuery fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		CommandSqlQuery obj = null;
 		if(baseObj instanceof CommandSqlQuery)
		{
			obj = (CommandSqlQuery)baseObj;
		} else {
			obj = new CommandSqlQuery(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CCommandSqlQuery");
			obj.increaseCast();
		}
