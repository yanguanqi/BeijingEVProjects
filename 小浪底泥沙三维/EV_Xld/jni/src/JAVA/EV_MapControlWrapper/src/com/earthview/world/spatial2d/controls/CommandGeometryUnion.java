...
public class CommandGeometryUnion extends com.earthview.world.spatial2d.controls.EditCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CCommandGeometryUnion", new CommandGeometryUnionClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCCommandGeometryUnionProxy", new CommandGeometryUnionClassFactory());
	}
	 ...
	 * @param  
	 */
	public CommandGeometryUnion() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandGeometryUnionProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.CommandGeometryUnion".equals(this.getClass().getName()))
		{
	...
	public CommandGeometryUnion(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandGeometryUnion(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandGeometryUnion fromBaseObject(BaseObject baseObj)
	{
		...
		CommandGeometryUnion obj = null;
 		if(baseObj instanceof CommandGeometryUnion)
		{
			obj = (CommandGeometryUnion)baseObj;
		} else {
