...
public class ToolThreePointsArc1 extends com.earthview.world.spatial2d.controls.NewCurveTypeTool {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CToolThreePointsArc1", new ToolThreePointsArc1ClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCToolThreePointsArc1Proxy", new ToolThreePointsArc1ClassFactory());
	}
	 ...
	 * @param  
	 */
	public ToolThreePointsArc1() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCToolThreePointsArc1Proxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.ToolThreePointsArc1".equals(this.getClass().getName()))
		{
	...
	public ToolThreePointsArc1(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ToolThreePointsArc1(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ToolThreePointsArc1 fromBaseObject(BaseObject baseObj)
	{
		...
		ToolThreePointsArc1 obj = null;
 		if(baseObj instanceof ToolThreePointsArc1)
		{
			obj = (ToolThreePointsArc1)baseObj;
		} else {
