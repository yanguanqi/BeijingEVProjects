...
public class CommandCombinePart extends com.earthview.world.spatial2d.controls.EditCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CCommandCombinePart", new CommandCombinePartClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCCommandCombinePartProxy", new CommandCombinePartClassFactory());
	}
	 ...
	 * @param  
	 */
	public CommandCombinePart() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandCombinePartProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.CommandCombinePart".equals(this.getClass().getName()))
		{
	...
	protected  void showErrorMessage_void_callback()
	{
		showErrorMessage();
	}

	native private void showErrorMessage_void(long pNativeObject);
	/**
	 * 显示错误信息
	 * @param  
	 */
	...
	{
		showErrorMessage_void(this.nativeObject.pointer);
	}
	native private void showErrorMessage_void_NoVirtual(long pNativeObject);
	protected void showErrorMessage_NoVirtual()
	{
		showErrorMessage_void_NoVirtual(this.nativeObject.pointer);
	}

	native private void combineFeature_IFeature(long pNativeObject, long pDestFeature);
	/**
	 * 合并要素
	 * @param e 合并到的目标要素
	 */
	public void combineFeature(com.earthview.world.spatial.geodataset.Ifeature pDestFeature)
	{
		long pDestFeatureParamValue = (pDestFeature == null ? 0L : pDestFeature.nativeObject.pointer);
		combineFeature_IFeature(this.nativeObject.pointer, pDestFeatureParamValue);
	}
	...
	public CommandCombinePart(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandCombinePart(CreatedWhenConstruct cwc, String classNameStr) {
	...
	native protected void register_showErrorMessage_void(long pNativeObject, String method);
	...
	public void registerCallback(){
		if (!this.nativeObject.equals(InstancePointer.ZERO)){
			this.register_showErrorMessage_void(this.nativeObject.pointer, "showErrorMessage_void_callback");
	...
	public static CommandCombinePart fromBaseObject(BaseObject baseObj)
	{
		...
		CommandCombinePart obj = null;
 		if(baseObj instanceof CommandCombinePart)
		{
			obj = (CommandCombinePart)baseObj;
		} else {
