...
public class ToolRotate extends com.earthview.world.spatial2d.controls.NewNonPointTypeTool {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CToolRotate", new ToolRotateClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCToolRotateProxy", new ToolRotateClassFactory());
	}
	...
	public ToolRotate() {
		...
		Create("JCToolRotateProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.ToolRotate".equals(this.getClass().getName()))
		{
	...
	public ToolRotate(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ToolRotate(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ToolRotate fromBaseObject(BaseObject baseObj)
	{
		...
		ToolRotate obj = null;
 		if(baseObj instanceof ToolRotate)
		{
			obj = (ToolRotate)baseObj;
		} else {
