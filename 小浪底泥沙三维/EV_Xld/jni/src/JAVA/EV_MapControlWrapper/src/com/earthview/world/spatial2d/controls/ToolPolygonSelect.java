...
public class ToolPolygonSelect extends com.earthview.world.spatial2d.controls.Tool2D {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CToolPolygonSelect", new ToolPolygonSelectClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCToolPolygonSelectProxy", new ToolPolygonSelectClassFactory());
	}
	...
	public ToolPolygonSelect() {
		...
		Create("JCToolPolygonSelectProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.ToolPolygonSelect".equals(this.getClass().getName()))
		{
	...
	public ToolPolygonSelect(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ToolPolygonSelect(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ToolPolygonSelect fromBaseObject(BaseObject baseObj)
	{
		...
		ToolPolygonSelect obj = null;
 		if(baseObj instanceof ToolPolygonSelect)
		{
			obj = (ToolPolygonSelect)baseObj;
		} else {
