...
public class EditingMultiPoint extends com.earthview.world.spatial2d.controls.EditingSketch {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CEditingMultiPoint", new EditingMultiPointClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCEditingMultiPointProxy", new EditingMultiPointClassFactory());
	}

	public EditingMultiPoint(com.earthview.world.spatial2d.controls.GeometryEditor ref_editor) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer ref_editorPtr = new BasePointer(ref_editor);
		list.add("ref_editor", ref_editorPtr.get());
		Create("JCEditingMultiPointProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.EditingMultiPoint".equals(this.getClass().getName()))
		{
	...
	public EditingMultiPoint(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public EditingMultiPoint(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static EditingMultiPoint fromBaseObject(BaseObject baseObj)
	{
		...
		EditingMultiPoint obj = null;
 		if(baseObj instanceof EditingMultiPoint)
		{
			obj = (EditingMultiPoint)baseObj;
		} else {
