...
public class CommandNextView extends com.earthview.world.spatial2d.controls.MapCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CCommandNextView", new CommandNextViewClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCCommandNextViewProxy", new CommandNextViewClassFactory());
	}
	 ...
	 * @param  
	 */
	public CommandNextView() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandNextViewProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.CommandNextView".equals(this.getClass().getName()))
		{
	...
	public CommandNextView(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandNextView(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandNextView fromBaseObject(BaseObject baseObj)
	{
		...
		CommandNextView obj = null;
 		if(baseObj instanceof CommandNextView)
		{
			obj = (CommandNextView)baseObj;
		} else {
