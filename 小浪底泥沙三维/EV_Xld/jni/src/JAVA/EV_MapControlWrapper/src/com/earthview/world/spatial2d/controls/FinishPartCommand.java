...
public class FinishPartCommand extends com.earthview.world.spatial2d.controls.MapCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CFinishPartCommand", new FinishPartCommandClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCFinishPartCommandProxy", new FinishPartCommandClassFactory());
	}
	 ...
	 * @param  
	 */
	public FinishPartCommand() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCFinishPartCommandProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.FinishPartCommand".equals(this.getClass().getName()))
		{
	...
	public FinishPartCommand(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public FinishPartCommand(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static FinishPartCommand fromBaseObject(BaseObject baseObj)
	{
		...
		FinishPartCommand obj = null;
 		if(baseObj instanceof FinishPartCommand)
		{
			obj = (FinishPartCommand)baseObj;
		} else {
