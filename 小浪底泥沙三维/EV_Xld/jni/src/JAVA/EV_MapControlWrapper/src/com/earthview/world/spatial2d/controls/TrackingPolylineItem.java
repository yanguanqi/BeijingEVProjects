 ...
 * 简单折线
 */
public class TrackingPolylineItem extends com.earthview.world.spatial2d.controls.TrackingShapeItem {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CTrackingPolylineItem", new TrackingPolylineItemClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCTrackingPolylineItemProxy", new TrackingPolylineItemClassFactory());
	}

	/**
	 * 默认构造函数
	 */
	public TrackingPolylineItem() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCTrackingPolylineItemProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.TrackingPolylineItem".equals(this.getClass().getName()))
		{
	 ...
	 * @param unitType 单位
	 */
	public TrackingPolylineItem(com.earthview.world.spatial2d.controls.EVTrackingItemUnit unitType) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer unitTypePtr = new BasePointer(unitType);
		list.add("unitType", unitTypePtr.get());
		Create("JCTrackingPolylineItemProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.TrackingPolylineItem".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
	...
	native private void setPolyline_CLineString(long pNativeObject, long lstr);
	/**
	 * 设置折线
	 * @param lstr 线对象
	 */
	public void setPolyline(com.earthview.world.spatial.geometry.LineString lstr)
	{
		long lstrParamValue = (lstr == null ? 0L : lstr.nativeObject.pointer);
		setPolyline_CLineString(this.nativeObject.pointer, lstrParamValue);
	}
	 ...
	 * @return 折线
	 */
	public com.earthview.world.spatial.geometry.LineString getPolyline()
	{
	...
	public TrackingPolylineItem(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public TrackingPolylineItem(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static TrackingPolylineItem fromBaseObject(BaseObject baseObj)
	{
		...
		TrackingPolylineItem obj = null;
 		if(baseObj instanceof TrackingPolylineItem)
		{
			obj = (TrackingPolylineItem)baseObj;
		} else {
