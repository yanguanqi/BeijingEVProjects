...
public class ToolCircleSelect extends com.earthview.world.spatial2d.controls.Tool2D {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CToolCircleSelect", new ToolCircleSelectClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCToolCircleSelectProxy", new ToolCircleSelectClassFactory());
	}
	 ...
	 * @param  
	 */
	public ToolCircleSelect() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCToolCircleSelectProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.ToolCircleSelect".equals(this.getClass().getName()))
		{
	...
	public ToolCircleSelect(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ToolCircleSelect(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ToolCircleSelect fromBaseObject(BaseObject baseObj)
	{
		...
		ToolCircleSelect obj = null;
 		if(baseObj instanceof ToolCircleSelect)
		{
			obj = (ToolCircleSelect)baseObj;
		} else {
