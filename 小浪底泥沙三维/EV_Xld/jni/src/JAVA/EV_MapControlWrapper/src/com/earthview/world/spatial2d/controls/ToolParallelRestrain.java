...
public class ToolParallelRestrain extends com.earthview.world.spatial2d.controls.NewNonPointTypeTool {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CToolParallelRestrain", new ToolParallelRestrainClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCToolParallelRestrainProxy", new ToolParallelRestrainClassFactory());
	}
	 ...
	 * @param  
	 */
	public ToolParallelRestrain() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCToolParallelRestrainProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.ToolParallelRestrain".equals(this.getClass().getName()))
		{
	...
	public ToolParallelRestrain(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ToolParallelRestrain(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ToolParallelRestrain fromBaseObject(BaseObject baseObj)
	{
		...
		ToolParallelRestrain obj = null;
 		if(baseObj instanceof ToolParallelRestrain)
		{
			obj = (ToolParallelRestrain)baseObj;
		} else {
