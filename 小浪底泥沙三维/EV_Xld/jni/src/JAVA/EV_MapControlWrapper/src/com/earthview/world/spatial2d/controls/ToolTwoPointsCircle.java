...
public class ToolTwoPointsCircle extends com.earthview.world.spatial2d.controls.NewNonPointTypeTool {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CToolTwoPointsCircle", new ToolTwoPointsCircleClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCToolTwoPointsCircleProxy", new ToolTwoPointsCircleClassFactory());
	}
	 ...
	 * @param  
	 */
	public ToolTwoPointsCircle() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCToolTwoPointsCircleProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.ToolTwoPointsCircle".equals(this.getClass().getName()))
		{
	...
	public ToolTwoPointsCircle(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ToolTwoPointsCircle(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ToolTwoPointsCircle fromBaseObject(BaseObject baseObj)
	{
		...
		ToolTwoPointsCircle obj = null;
 		if(baseObj instanceof ToolTwoPointsCircle)
		{
			obj = (ToolTwoPointsCircle)baseObj;
		} else {
