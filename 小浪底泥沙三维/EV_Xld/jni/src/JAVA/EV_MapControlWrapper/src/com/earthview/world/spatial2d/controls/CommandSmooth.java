...
public class CommandSmooth extends com.earthview.world.spatial2d.controls.EditCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CCommandSmooth", new CommandSmoothClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCCommandSmoothProxy", new CommandSmoothClassFactory());
	}
	 ...
	 * @param  
	 */
	public CommandSmooth() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandSmoothProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.CommandSmooth".equals(this.getClass().getName()))
		{
	...
	native private boolean smoothFeature_ev_real64(long pNativeObject, double dDeviation);
	/**
	 * 概化要素
	 * @param dDeviation 最大偏移
	 */
	public boolean smoothFeature(double dDeviation)
	{
		double dDeviationParamValue = dDeviation;
		boolean returnValue = smoothFeature_ev_real64(this.nativeObject.pointer, dDeviationParamValue);
		return returnValue;
	}
	...
	public CommandSmooth(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandSmooth(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandSmooth fromBaseObject(BaseObject baseObj)
	{
		...
		CommandSmooth obj = null;
 		if(baseObj instanceof CommandSmooth)
		{
			obj = (CommandSmooth)baseObj;
		} else {
