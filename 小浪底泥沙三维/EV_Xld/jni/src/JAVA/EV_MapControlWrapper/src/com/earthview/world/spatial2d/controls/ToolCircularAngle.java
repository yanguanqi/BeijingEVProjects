...
public class ToolCircularAngle extends com.earthview.world.spatial2d.controls.NewNonPointTypeTool {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CToolCircularAngle", new ToolCircularAngleClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCToolCircularAngleProxy", new ToolCircularAngleClassFactory());
	}
	 ...
	 * @param  
	 */
	public ToolCircularAngle() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCToolCircularAngleProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.ToolCircularAngle".equals(this.getClass().getName()))
		{
	...
	public ToolCircularAngle(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ToolCircularAngle(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ToolCircularAngle fromBaseObject(BaseObject baseObj)
	{
		...
		ToolCircularAngle obj = null;
 		if(baseObj instanceof ToolCircularAngle)
		{
			obj = (ToolCircularAngle)baseObj;
		} else {
