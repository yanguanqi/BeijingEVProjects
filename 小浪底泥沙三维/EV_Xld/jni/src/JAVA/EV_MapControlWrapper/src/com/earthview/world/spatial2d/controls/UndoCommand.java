...
public class UndoCommand extends com.earthview.world.spatial2d.controls.EditCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CUndoCommand", new UndoCommandClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCUndoCommandProxy", new UndoCommandClassFactory());
	}
	...
	public UndoCommand() {
		...
		Create("JCUndoCommandProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.UndoCommand".equals(this.getClass().getName()))
		{
	...
	public UndoCommand(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public UndoCommand(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static UndoCommand fromBaseObject(BaseObject baseObj)
	{
		...
		UndoCommand obj = null;
 		if(baseObj instanceof UndoCommand)
		{
			obj = (UndoCommand)baseObj;
		} else {
