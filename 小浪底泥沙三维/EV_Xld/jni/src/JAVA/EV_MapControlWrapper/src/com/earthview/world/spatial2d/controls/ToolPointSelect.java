...
public class ToolPointSelect extends com.earthview.world.spatial2d.controls.Tool2D {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CToolPointSelect", new ToolPointSelectClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCToolPointSelectProxy", new ToolPointSelectClassFactory());
	}
	 ...
	 * @param  
	 */
	public ToolPointSelect() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCToolPointSelectProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.ToolPointSelect".equals(this.getClass().getName()))
		{
	...
	public ToolPointSelect(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ToolPointSelect(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ToolPointSelect fromBaseObject(BaseObject baseObj)
	{
		...
		ToolPointSelect obj = null;
 		if(baseObj instanceof ToolPointSelect)
		{
			obj = (ToolPointSelect)baseObj;
		} else {
