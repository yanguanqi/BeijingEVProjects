...
public class EditingPolyline extends com.earthview.world.spatial2d.controls.EditingSketch {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CEditingPolyline", new EditingPolylineClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCEditingPolylineProxy", new EditingPolylineClassFactory());
	}

	public EditingPolyline(com.earthview.world.spatial2d.controls.GeometryEditor ref_editor) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer ref_editorPtr = new BasePointer(ref_editor);
		list.add("ref_editor", ref_editorPtr.get());
		Create("JCEditingPolylineProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.EditingPolyline".equals(this.getClass().getName()))
		{
	...
	public EditingPolyline(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public EditingPolyline(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static EditingPolyline fromBaseObject(BaseObject baseObj)
	{
		...
		EditingPolyline obj = null;
 		if(baseObj instanceof EditingPolyline)
		{
			obj = (EditingPolyline)baseObj;
		} else {
