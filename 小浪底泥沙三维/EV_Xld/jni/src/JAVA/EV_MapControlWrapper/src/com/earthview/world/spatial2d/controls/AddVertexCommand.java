...
public class AddVertexCommand extends com.earthview.world.spatial2d.controls.MapCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CAddVertexCommand", new AddVertexCommandClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCAddVertexCommandProxy", new AddVertexCommandClassFactory());
	}
	...
	public AddVertexCommand() {
		...
		Create("JCAddVertexCommandProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.AddVertexCommand".equals(this.getClass().getName()))
		{
	...
	public AddVertexCommand(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public AddVertexCommand(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static AddVertexCommand fromBaseObject(BaseObject baseObj)
	{
		...
		AddVertexCommand obj = null;
 		if(baseObj instanceof AddVertexCommand)
		{
			obj = (AddVertexCommand)baseObj;
		} else {
