...
public class ToolConcentricCircle extends com.earthview.world.spatial2d.controls.NewGeometryTool {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CToolConcentricCircle", new ToolConcentricCircleClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCToolConcentricCircleProxy", new ToolConcentricCircleClassFactory());
	}
	 ...
	 * @param  
	 */
	public ToolConcentricCircle() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCToolConcentricCircleProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.ToolConcentricCircle".equals(this.getClass().getName()))
		{
	 ...
	 * @param x 鼠标右键的x坐标
	 * @param y 鼠标右键的y坐标
	 * @return 如果鼠标右键按下，返回true,如果没有按下，返回false
	 */
	...
	public ToolConcentricCircle(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ToolConcentricCircle(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ToolConcentricCircle fromBaseObject(BaseObject baseObj)
	{
		...
		ToolConcentricCircle obj = null;
 		if(baseObj instanceof ToolConcentricCircle)
		{
			obj = (ToolConcentricCircle)baseObj;
		} else {
