...
public class EditingPoint extends com.earthview.world.spatial2d.controls.EditingObject {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CEditingPoint", new EditingPointClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCEditingPointProxy", new EditingPointClassFactory());
	}

	public EditingPoint() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCEditingPointProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.EditingPoint".equals(this.getClass().getName()))
		{
	...
	public EditingPoint(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public EditingPoint(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static EditingPoint fromBaseObject(BaseObject baseObj)
	{
		...
		EditingPoint obj = null;
 		if(baseObj instanceof EditingPoint)
		{
			obj = (EditingPoint)baseObj;
		} else {
