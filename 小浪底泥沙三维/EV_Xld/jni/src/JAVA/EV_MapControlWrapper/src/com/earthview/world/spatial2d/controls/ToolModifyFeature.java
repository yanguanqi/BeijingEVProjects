...
public class ToolModifyFeature extends com.earthview.world.spatial2d.controls.EditTool {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CToolModifyFeature", new ToolModifyFeatureClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCToolModifyFeatureProxy", new ToolModifyFeatureClassFactory());
	}
	 ...
	 * @param  
	 */
	public ToolModifyFeature() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCToolModifyFeatureProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.ToolModifyFeature".equals(this.getClass().getName()))
		{
	...
	public ToolModifyFeature(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ToolModifyFeature(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ToolModifyFeature fromBaseObject(BaseObject baseObj)
	{
		...
		ToolModifyFeature obj = null;
 		if(baseObj instanceof ToolModifyFeature)
		{
			obj = (ToolModifyFeature)baseObj;
		} else {
