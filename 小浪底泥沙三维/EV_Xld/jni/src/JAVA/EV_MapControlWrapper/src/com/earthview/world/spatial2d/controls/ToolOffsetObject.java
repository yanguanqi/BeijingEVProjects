...
public class ToolOffsetObject extends com.earthview.world.spatial2d.controls.NewNonPointTypeTool {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CToolOffsetObject", new ToolOffsetObjectClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCToolOffsetObjectProxy", new ToolOffsetObjectClassFactory());
	}
	 ...
	 * @param  
	 */
	public ToolOffsetObject() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCToolOffsetObjectProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.ToolOffsetObject".equals(this.getClass().getName()))
		{
	...
	public ToolOffsetObject(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ToolOffsetObject(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ToolOffsetObject fromBaseObject(BaseObject baseObj)
	{
		...
		ToolOffsetObject obj = null;
 		if(baseObj instanceof ToolOffsetObject)
		{
			obj = (ToolOffsetObject)baseObj;
		} else {
