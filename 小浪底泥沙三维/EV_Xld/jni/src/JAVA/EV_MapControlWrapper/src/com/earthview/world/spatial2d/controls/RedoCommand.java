...
public class RedoCommand extends com.earthview.world.spatial2d.controls.EditCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CRedoCommand", new RedoCommandClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCRedoCommandProxy", new RedoCommandClassFactory());
	}
	...
	public RedoCommand() {
		...
		Create("JCRedoCommandProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.RedoCommand".equals(this.getClass().getName()))
		{
	...
	public RedoCommand(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public RedoCommand(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static RedoCommand fromBaseObject(BaseObject baseObj)
	{
		...
		RedoCommand obj = null;
 		if(baseObj instanceof RedoCommand)
		{
			obj = (RedoCommand)baseObj;
		} else {
