...
public class FinishSketchCommand extends com.earthview.world.spatial2d.controls.MapCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CFinishSketchCommand", new FinishSketchCommandClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCFinishSketchCommandProxy", new FinishSketchCommandClassFactory());
	}
	 ...
	 * @param  
	 */
	public FinishSketchCommand() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCFinishSketchCommandProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.FinishSketchCommand".equals(this.getClass().getName()))
		{
	...
	public FinishSketchCommand(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public FinishSketchCommand(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static FinishSketchCommand fromBaseObject(BaseObject baseObj)
	{
		...
		FinishSketchCommand obj = null;
 		if(baseObj instanceof FinishSketchCommand)
		{
			obj = (FinishSketchCommand)baseObj;
		} else {
