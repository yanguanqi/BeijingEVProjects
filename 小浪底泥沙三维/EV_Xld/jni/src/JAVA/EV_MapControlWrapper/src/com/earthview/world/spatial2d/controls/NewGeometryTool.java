...
public class NewGeometryTool extends com.earthview.world.spatial2d.controls.EditTool {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CNewGeometryTool", new NewGeometryToolClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCNewGeometryToolProxy", new NewGeometryToolClassFactory());
	}
	...
	public NewGeometryTool(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public NewGeometryTool(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static NewGeometryTool fromBaseObject(BaseObject baseObj)
	{
		...
		NewGeometryTool obj = null;
 		if(baseObj instanceof NewGeometryTool)
		{
			obj = (NewGeometryTool)baseObj;
		} else {
