...
public class CommandFullExtent extends com.earthview.world.spatial2d.controls.MapCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CCommandFullExtent", new CommandFullExtentClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCCommandFullExtentProxy", new CommandFullExtentClassFactory());
	}
	...
	public CommandFullExtent() {
		...
		Create("JCCommandFullExtentProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.CommandFullExtent".equals(this.getClass().getName()))
		{
	...
	public CommandFullExtent(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandFullExtent(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandFullExtent fromBaseObject(BaseObject baseObj)
	{
		...
		CommandFullExtent obj = null;
 		if(baseObj instanceof CommandFullExtent)
		{
			obj = (CommandFullExtent)baseObj;
		} else {
