...
public class ToolRightangle extends com.earthview.world.spatial2d.controls.NewNonPointTypeTool {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CToolRightangle", new ToolRightangleClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCToolRightangleProxy", new ToolRightangleClassFactory());
	}
	 ...
	 * @param  
	 */
	public ToolRightangle() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCToolRightangleProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.ToolRightangle".equals(this.getClass().getName()))
		{
	...
	public ToolRightangle(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ToolRightangle(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ToolRightangle fromBaseObject(BaseObject baseObj)
	{
		...
		ToolRightangle obj = null;
 		if(baseObj instanceof ToolRightangle)
		{
			obj = (ToolRightangle)baseObj;
		} else {
