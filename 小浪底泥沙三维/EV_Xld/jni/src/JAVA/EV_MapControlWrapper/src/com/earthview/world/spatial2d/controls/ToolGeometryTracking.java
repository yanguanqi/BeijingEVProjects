...
public class ToolGeometryTracking extends com.earthview.world.spatial2d.controls.NewNonPointTypeTool {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CToolGeometryTracking", new ToolGeometryTrackingClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCToolGeometryTrackingProxy", new ToolGeometryTrackingClassFactory());
	}
	 ...
	 * @param  
	 */
	public ToolGeometryTracking() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCToolGeometryTrackingProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.ToolGeometryTracking".equals(this.getClass().getName()))
		{
	...
	native private void trackingPoint_ev_real64_ev_real64(long pNativeObject, double x, double y);
	public void trackingPoint(double x, double y)
	{
		double xParamValue = x;
		double yParamValue = y;
		trackingPoint_ev_real64_ev_real64(this.nativeObject.pointer, xParamValue, yParamValue);
	}
	public ToolGeometryTracking(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ToolGeometryTracking(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ToolGeometryTracking fromBaseObject(BaseObject baseObj)
	{
		...
		ToolGeometryTracking obj = null;
 		if(baseObj instanceof ToolGeometryTracking)
		{
			obj = (ToolGeometryTracking)baseObj;
		} else {
