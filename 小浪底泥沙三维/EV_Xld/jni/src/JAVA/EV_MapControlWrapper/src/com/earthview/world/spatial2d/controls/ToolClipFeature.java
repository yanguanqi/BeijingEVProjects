...
public class ToolClipFeature extends com.earthview.world.spatial2d.controls.NewNonPointTypeTool {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CToolClipFeature", new ToolClipFeatureClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCToolClipFeatureProxy", new ToolClipFeatureClassFactory());
	}
	 ...
	 * @param  
	 */
	public ToolClipFeature() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCToolClipFeatureProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.ToolClipFeature".equals(this.getClass().getName()))
		{
	...
	public ToolClipFeature(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ToolClipFeature(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ToolClipFeature fromBaseObject(BaseObject baseObj)
	{
		...
		ToolClipFeature obj = null;
 		if(baseObj instanceof ToolClipFeature)
		{
			obj = (ToolClipFeature)baseObj;
		} else {
