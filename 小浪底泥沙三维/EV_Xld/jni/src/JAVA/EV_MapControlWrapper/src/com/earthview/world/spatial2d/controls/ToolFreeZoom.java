...
public class ToolFreeZoom extends com.earthview.world.spatial2d.controls.Tool2D {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CToolFreeZoom", new ToolFreeZoomClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCToolFreeZoomProxy", new ToolFreeZoomClassFactory());
	}
	...
	public ToolFreeZoom() {
		...
		Create("JCToolFreeZoomProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.ToolFreeZoom".equals(this.getClass().getName()))
		{
	...
	public ToolFreeZoom(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ToolFreeZoom(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ToolFreeZoom fromBaseObject(BaseObject baseObj)
	{
		...
		ToolFreeZoom obj = null;
 		if(baseObj instanceof ToolFreeZoom)
		{
			obj = (ToolFreeZoom)baseObj;
		} else {
