...
public class ToolEllipticArc extends com.earthview.world.spatial2d.controls.NewNonPointTypeTool {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CToolEllipticArc", new ToolEllipticArcClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCToolEllipticArcProxy", new ToolEllipticArcClassFactory());
	}
	 ...
	 * @param  
	 */
	public ToolEllipticArc() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCToolEllipticArcProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.ToolEllipticArc".equals(this.getClass().getName()))
		{
	...
	public ToolEllipticArc(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ToolEllipticArc(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ToolEllipticArc fromBaseObject(BaseObject baseObj)
	{
		...
		ToolEllipticArc obj = null;
 		if(baseObj instanceof ToolEllipticArc)
		{
			obj = (ToolEllipticArc)baseObj;
		} else {
