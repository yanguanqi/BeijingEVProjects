...
public class EditingEllipticSector extends com.earthview.world.spatial2d.controls.EditingCurve {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CEditingEllipticSector", new EditingEllipticSectorClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCEditingEllipticSectorProxy", new EditingEllipticSectorClassFactory());
	}

	public EditingEllipticSector() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCEditingEllipticSectorProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.EditingEllipticSector".equals(this.getClass().getName()))
		{
	...
	public EditingEllipticSector(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public EditingEllipticSector(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static EditingEllipticSector fromBaseObject(BaseObject baseObj)
	{
		...
		EditingEllipticSector obj = null;
 		if(baseObj instanceof EditingEllipticSector)
		{
			obj = (EditingEllipticSector)baseObj;
		} else {
