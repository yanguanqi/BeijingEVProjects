...
public class DeletePartCommand extends com.earthview.world.spatial2d.controls.MapCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CDeletePartCommand", new DeletePartCommandClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCDeletePartCommandProxy", new DeletePartCommandClassFactory());
	}
	...
	public DeletePartCommand() {
		...
		Create("JCDeletePartCommandProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.DeletePartCommand".equals(this.getClass().getName()))
		{
	...
	public DeletePartCommand(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public DeletePartCommand(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static DeletePartCommand fromBaseObject(BaseObject baseObj)
	{
		...
		DeletePartCommand obj = null;
 		if(baseObj instanceof DeletePartCommand)
		{
			obj = (DeletePartCommand)baseObj;
		} else {
