...
public class CommandIntersection extends com.earthview.world.spatial2d.controls.EditCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CCommandIntersection", new CommandIntersectionClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCCommandIntersectionProxy", new CommandIntersectionClassFactory());
	}
	 ...
	 * @param  
	 */
	public CommandIntersection() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandIntersectionProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.CommandIntersection".equals(this.getClass().getName()))
		{
	...
	public CommandIntersection(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandIntersection(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandIntersection fromBaseObject(BaseObject baseObj)
	{
		...
		CommandIntersection obj = null;
 		if(baseObj instanceof CommandIntersection)
		{
			obj = (CommandIntersection)baseObj;
		} else {
