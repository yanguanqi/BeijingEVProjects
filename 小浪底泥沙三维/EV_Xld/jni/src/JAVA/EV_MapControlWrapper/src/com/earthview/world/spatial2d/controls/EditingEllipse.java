...
public class EditingEllipse extends com.earthview.world.spatial2d.controls.EditingCurve {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CEditingEllipse", new EditingEllipseClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCEditingEllipseProxy", new EditingEllipseClassFactory());
	}

	public EditingEllipse() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCEditingEllipseProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.EditingEllipse".equals(this.getClass().getName()))
		{
	...
	public EditingEllipse(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public EditingEllipse(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static EditingEllipse fromBaseObject(BaseObject baseObj)
	{
		...
		EditingEllipse obj = null;
 		if(baseObj instanceof EditingEllipse)
		{
			obj = (EditingEllipse)baseObj;
		} else {
