...
public class CommandSplitPart extends com.earthview.world.spatial2d.controls.EditCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CCommandSplitPart", new CommandSplitPartClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCCommandSplitPartProxy", new CommandSplitPartClassFactory());
	}
	 ...
	 * @param  
	 */
	public CommandSplitPart() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandSplitPartProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.CommandSplitPart".equals(this.getClass().getName()))
		{
	...
	public CommandSplitPart(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandSplitPart(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandSplitPart fromBaseObject(BaseObject baseObj)
	{
		...
		CommandSplitPart obj = null;
 		if(baseObj instanceof CommandSplitPart)
		{
			obj = (CommandSplitPart)baseObj;
		} else {
