...
public class ToolStretch extends com.earthview.world.spatial2d.controls.NewNonPointTypeTool {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CToolStretch", new ToolStretchClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCToolStretchProxy", new ToolStretchClassFactory());
	}
	...
	public ToolStretch() {
		...
		Create("JCToolStretchProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.ToolStretch".equals(this.getClass().getName()))
		{
	...
	public ToolStretch(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ToolStretch(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ToolStretch fromBaseObject(BaseObject baseObj)
	{
		...
		ToolStretch obj = null;
 		if(baseObj instanceof ToolStretch)
		{
			obj = (ToolStretch)baseObj;
		} else {
