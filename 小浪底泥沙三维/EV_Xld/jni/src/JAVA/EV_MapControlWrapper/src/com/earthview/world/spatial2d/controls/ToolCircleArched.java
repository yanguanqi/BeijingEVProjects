...
public class ToolCircleArched extends com.earthview.world.spatial2d.controls.NewNonPointTypeTool {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CToolCircleArched", new ToolCircleArchedClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCToolCircleArchedProxy", new ToolCircleArchedClassFactory());
	}
	 ...
	 * @param  
	 */
	public ToolCircleArched() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCToolCircleArchedProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.ToolCircleArched".equals(this.getClass().getName()))
		{
	...
	public ToolCircleArched(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ToolCircleArched(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ToolCircleArched fromBaseObject(BaseObject baseObj)
	{
		...
		ToolCircleArched obj = null;
 		if(baseObj instanceof ToolCircleArched)
		{
			obj = (ToolCircleArched)baseObj;
		} else {
