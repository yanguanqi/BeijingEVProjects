...
public class ToolEllipse extends com.earthview.world.spatial2d.controls.NewNonPointTypeTool {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CToolEllipse", new ToolEllipseClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCToolEllipseProxy", new ToolEllipseClassFactory());
	}
	...
	public ToolEllipse() {
		...
		Create("JCToolEllipseProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.ToolEllipse".equals(this.getClass().getName()))
		{
	...
	public ToolEllipse(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ToolEllipse(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ToolEllipse fromBaseObject(BaseObject baseObj)
	{
		...
		ToolEllipse obj = null;
 		if(baseObj instanceof ToolEllipse)
		{
			obj = (ToolEllipse)baseObj;
		} else {
