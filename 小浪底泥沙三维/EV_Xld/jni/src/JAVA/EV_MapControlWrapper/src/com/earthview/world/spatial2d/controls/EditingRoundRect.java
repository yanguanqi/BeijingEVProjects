...
public class EditingRoundRect extends com.earthview.world.spatial2d.controls.EditingCurve {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CEditingRoundRect", new EditingRoundRectClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCEditingRoundRectProxy", new EditingRoundRectClassFactory());
	}

	public EditingRoundRect() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCEditingRoundRectProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.EditingRoundRect".equals(this.getClass().getName()))
		{
	...
	public EditingRoundRect(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public EditingRoundRect(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static EditingRoundRect fromBaseObject(BaseObject baseObj)
	{
		...
		EditingRoundRect obj = null;
 		if(baseObj instanceof EditingRoundRect)
		{
			obj = (EditingRoundRect)baseObj;
		} else {
