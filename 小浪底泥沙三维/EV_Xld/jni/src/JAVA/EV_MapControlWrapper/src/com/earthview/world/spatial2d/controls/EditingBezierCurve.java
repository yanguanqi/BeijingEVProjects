...
public class EditingBezierCurve extends com.earthview.world.spatial2d.controls.EditingCurve {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CEditingBezierCurve", new EditingBezierCurveClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCEditingBezierCurveProxy", new EditingBezierCurveClassFactory());
	}

	public EditingBezierCurve() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCEditingBezierCurveProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.EditingBezierCurve".equals(this.getClass().getName()))
		{
	...
	public EditingBezierCurve(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public EditingBezierCurve(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static EditingBezierCurve fromBaseObject(BaseObject baseObj)
	{
		...
		EditingBezierCurve obj = null;
 		if(baseObj instanceof EditingBezierCurve)
		{
			obj = (EditingBezierCurve)baseObj;
		} else {
