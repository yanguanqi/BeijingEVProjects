...
public class ToolCopyFeature extends com.earthview.world.spatial2d.controls.NewNonPointTypeTool {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CToolCopyFeature", new ToolCopyFeatureClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCToolCopyFeatureProxy", new ToolCopyFeatureClassFactory());
	}
	 ...
	 * @param  
	 */
	public ToolCopyFeature() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCToolCopyFeatureProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.ToolCopyFeature".equals(this.getClass().getName()))
		{
	...
	native private boolean onContextMenu_ev_int32_ev_int32_NoVirtual(long pNativeObject, int x, int y);
	protected boolean onContextMenu_NoVirtual(int x, int y)
	{
		int xParamValue = x;
		int yParamValue = y;
		boolean returnValue = onContextMenu_ev_int32_ev_int32_NoVirtual(this.nativeObject.pointer, xParamValue, yParamValue);
		return returnValue;
	}
	...
	native private void copy_ILayer_ev_real64_ev_real64(long pNativeObject, long pScrLayer, double dCenterPX, double dCenterPY);
	/**
	 * 复制
	 * @param pScrLayer 被复制对象所在的图层
	 * @param dTransX 复制到新的中心点的X坐标
	 * @param dTransY 复制到新的中心点的Y坐标
	 */
	public void copy(com.earthview.world.spatial.atlas.Ilayer pScrLayer, double dCenterPX, double dCenterPY)
	{
		long pScrLayerParamValue = (pScrLayer == null ? 0L : pScrLayer.nativeObject.pointer);
		double dCenterPXParamValue = dCenterPX;
		double dCenterPYParamValue = dCenterPY;
		copy_ILayer_ev_real64_ev_real64(this.nativeObject.pointer, pScrLayerParamValue, dCenterPXParamValue, dCenterPYParamValue);
	}
	...
	native private long get_m_pScrLayer_void(long pNativeObject);
	public com.earthview.world.spatial.atlas.Ilayer get_m_pScrLayer()
	{
		long jniValue = get_m_pScrLayer_void(this.nativeObject.pointer);
	...
	native private void set_m_pScrLayer_ILayer (long pNativeObject, long value);
	public void set_m_pScrLayer(com.earthview.world.spatial.atlas.Ilayer m_pScrLayer)
	{
		long m_pScrLayerParamValue = (m_pScrLayer == null ? 0L : m_pScrLayer.nativeObject.pointer);
		
		set_m_pScrLayer_ILayer(this.nativeObject.pointer, m_pScrLayerParamValue);
	}
	
	native private int get_m_settingType_void(long pNativeObject);
	public PositionSetting get_m_settingType()
	{
		int jniValue = get_m_settingType_void(this.nativeObject.pointer);
		
		return PositionSetting.toEnum(jniValue);
	}
	
	native private void set_m_settingType_PositionSetting (long pNativeObject, int value);
	public void set_m_settingType(PositionSetting m_settingType)
	{
		int m_settingTypeParamValue = m_settingType.getValue();
		
		set_m_settingType_PositionSetting(this.nativeObject.pointer, m_settingTypeParamValue);
	}
	
	public ToolCopyFeature(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ToolCopyFeature(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ToolCopyFeature fromBaseObject(BaseObject baseObj)
	{
		...
		ToolCopyFeature obj = null;
 		if(baseObj instanceof ToolCopyFeature)
		{
			obj = (ToolCopyFeature)baseObj;
		} else {
