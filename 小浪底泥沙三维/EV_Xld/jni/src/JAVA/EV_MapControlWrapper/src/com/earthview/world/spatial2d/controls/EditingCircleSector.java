...
public class EditingCircleSector extends com.earthview.world.spatial2d.controls.EditingCurve {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CEditingCircleSector", new EditingCircleSectorClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCEditingCircleSectorProxy", new EditingCircleSectorClassFactory());
	}

	public EditingCircleSector() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCEditingCircleSectorProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.EditingCircleSector".equals(this.getClass().getName()))
		{
	...
	public EditingCircleSector(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public EditingCircleSector(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static EditingCircleSector fromBaseObject(BaseObject baseObj)
	{
		...
		EditingCircleSector obj = null;
 		if(baseObj instanceof EditingCircleSector)
		{
			obj = (EditingCircleSector)baseObj;
		} else {
