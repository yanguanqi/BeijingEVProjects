...
public class ToolLongCircle extends com.earthview.world.spatial2d.controls.NewNonPointTypeTool {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CToolLongCircle", new ToolLongCircleClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCToolLongCircleProxy", new ToolLongCircleClassFactory());
	}
	 ...
	 * @param  
	 */
	public ToolLongCircle() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCToolLongCircleProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.ToolLongCircle".equals(this.getClass().getName()))
		{
	...
	public ToolLongCircle(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ToolLongCircle(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ToolLongCircle fromBaseObject(BaseObject baseObj)
	{
		...
		ToolLongCircle obj = null;
 		if(baseObj instanceof ToolLongCircle)
		{
			obj = (ToolLongCircle)baseObj;
		} else {
