...
public class ToolRecondition extends com.earthview.world.spatial2d.controls.NewNonPointTypeTool {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CToolRecondition", new ToolReconditionClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCToolReconditionProxy", new ToolReconditionClassFactory());
	}
	 ...
	 * @param  
	 */
	public ToolRecondition() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCToolReconditionProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.ToolRecondition".equals(this.getClass().getName()))
		{
	...
	public ToolRecondition(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ToolRecondition(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ToolRecondition fromBaseObject(BaseObject baseObj)
	{
		...
		ToolRecondition obj = null;
 		if(baseObj instanceof ToolRecondition)
		{
			obj = (ToolRecondition)baseObj;
		} else {
