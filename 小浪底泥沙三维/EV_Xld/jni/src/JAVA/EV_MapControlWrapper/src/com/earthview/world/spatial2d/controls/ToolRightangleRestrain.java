...
public class ToolRightangleRestrain extends com.earthview.world.spatial2d.controls.NewNonPointTypeTool {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CToolRightangleRestrain", new ToolRightangleRestrainClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCToolRightangleRestrainProxy", new ToolRightangleRestrainClassFactory());
	}
	 ...
	 * @param  
	 */
	public ToolRightangleRestrain() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCToolRightangleRestrainProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.ToolRightangleRestrain".equals(this.getClass().getName()))
		{
	...
	public ToolRightangleRestrain(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ToolRightangleRestrain(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ToolRightangleRestrain fromBaseObject(BaseObject baseObj)
	{
		...
		ToolRightangleRestrain obj = null;
 		if(baseObj instanceof ToolRightangleRestrain)
		{
			obj = (ToolRightangleRestrain)baseObj;
		} else {
