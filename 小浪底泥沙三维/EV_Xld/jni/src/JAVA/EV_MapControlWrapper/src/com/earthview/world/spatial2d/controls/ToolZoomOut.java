...
public class ToolZoomOut extends com.earthview.world.spatial2d.controls.Tool2D {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CToolZoomOut", new ToolZoomOutClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCToolZoomOutProxy", new ToolZoomOutClassFactory());
	}
	...
	public ToolZoomOut() {
		...
		Create("JCToolZoomOutProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.ToolZoomOut".equals(this.getClass().getName()))
		{
	...
	public ToolZoomOut(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ToolZoomOut(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ToolZoomOut fromBaseObject(BaseObject baseObj)
	{
		...
		ToolZoomOut obj = null;
 		if(baseObj instanceof ToolZoomOut)
		{
			obj = (ToolZoomOut)baseObj;
		} else {
