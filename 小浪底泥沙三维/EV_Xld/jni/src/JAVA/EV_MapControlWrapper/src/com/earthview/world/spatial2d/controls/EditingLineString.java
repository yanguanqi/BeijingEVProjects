...
public class EditingLineString extends com.earthview.world.spatial2d.controls.EditingCurve {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CEditingLineString", new EditingLineStringClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCEditingLineStringProxy", new EditingLineStringClassFactory());
	}

	public EditingLineString() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCEditingLineStringProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.EditingLineString".equals(this.getClass().getName()))
		{
	...
	public EditingLineString(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public EditingLineString(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static EditingLineString fromBaseObject(BaseObject baseObj)
	{
		...
		EditingLineString obj = null;
 		if(baseObj instanceof EditingLineString)
		{
			obj = (EditingLineString)baseObj;
		} else {
