...
public class EditingEllipticArched extends com.earthview.world.spatial2d.controls.EditingCurve {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CEditingEllipticArched", new EditingEllipticArchedClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCEditingEllipticArchedProxy", new EditingEllipticArchedClassFactory());
	}

	public EditingEllipticArched() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCEditingEllipticArchedProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.EditingEllipticArched".equals(this.getClass().getName()))
		{
	...
	public EditingEllipticArched(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public EditingEllipticArched(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static EditingEllipticArched fromBaseObject(BaseObject baseObj)
	{
		...
		EditingEllipticArched obj = null;
 		if(baseObj instanceof EditingEllipticArched)
		{
			obj = (EditingEllipticArched)baseObj;
		} else {
