 ...
 * 矢量数据源工厂类
 */
public class DatabaseVectorSourceFactory extends com.earthview.world.spatial.geodataset.Idatasourcefactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::GeoDataset::CDatabaseVectorSourceFactory", new DatabaseVectorSourceFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::GeoDataset::JCDatabaseVectorSourceFactoryProxy", new DatabaseVectorSourceFactoryClassFactory());
	}
	...
	public DatabaseVectorSourceFactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCDatabaseVectorSourceFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.geodataset.DatabaseVectorSourceFactory".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
		}
	}

	public DatabaseVectorSourceFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public DatabaseVectorSourceFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static DatabaseVectorSourceFactory fromBaseObject(BaseObject baseObj)
	{
		...
		DatabaseVectorSourceFactory obj = null;
 		if(baseObj instanceof DatabaseVectorSourceFactory)
		{
			obj = (DatabaseVectorSourceFactory)baseObj;
		} else {
