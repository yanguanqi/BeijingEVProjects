 ...
 * 二维矢量要素类
 */
public class VectorFeature extends com.earthview.world.spatial.geodataset.Ifeature {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::GeoDataset::CVectorFeature", new VectorFeatureClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::GeoDataset::JCVectorFeatureProxy", new VectorFeatureClassFactory());
	}
	...
	public VectorFeature(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public VectorFeature(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static VectorFeature fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		VectorFeature obj = null;
 		if(baseObj instanceof VectorFeature)
		{
			obj = (VectorFeature)baseObj;
		} else {
			obj = new VectorFeature(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CVectorFeature");
			obj.increaseCast();
		}
