 ...
 * 二维矢量要素迭代器
 */
public class FeatureIterator extends com.earthview.world.spatial.geodataset.Ifeatureiterator {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::GeoDataset::CFeatureIterator", new FeatureIteratorClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::GeoDataset::JCFeatureIteratorProxy", new FeatureIteratorClassFactory());
	}
	...
	public FeatureIterator(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public FeatureIterator(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static FeatureIterator fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		FeatureIterator obj = null;
 		if(baseObj instanceof FeatureIterator)
		{
			obj = (FeatureIterator)baseObj;
		} else {
			obj = new FeatureIterator(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CFeatureIterator");
			obj.increaseCast();
		}
