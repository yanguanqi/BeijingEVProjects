...
public class ColourImageAffectorFactory extends com.earthview.world.graphic.ParticleAffectorFactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Plugin::ParticleFX::CColourImageAffectorFactory", new ColourImageAffectorFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Plugin::ParticleFX::JCColourImageAffectorFactoryProxy", new ColourImageAffectorFactoryClassFactory());
	}
	...
	public ColourImageAffectorFactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCColourImageAffectorFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.plugin.particlefx.ColourImageAffectorFactory".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
		}
	}

	public ColourImageAffectorFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ColourImageAffectorFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ColourImageAffectorFactory fromBaseObject(BaseObject baseObj)
	{
		...
		ColourImageAffectorFactory obj = null;
 		if(baseObj instanceof ColourImageAffectorFactory)
		{
			obj = (ColourImageAffectorFactory)baseObj;
		} else {
