...
public class EllipsoidEmitterFactory extends com.earthview.world.graphic.ParticleEmitterFactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Plugin::ParticleFX::CEllipsoidEmitterFactory", new EllipsoidEmitterFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Plugin::ParticleFX::JCEllipsoidEmitterFactoryProxy", new EllipsoidEmitterFactoryClassFactory());
	}

	public EllipsoidEmitterFactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCEllipsoidEmitterFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.plugin.particlefx.EllipsoidEmitterFactory".equals(this.getClass().getName()))
		{
	...
	public EllipsoidEmitterFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public EllipsoidEmitterFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static EllipsoidEmitterFactory fromBaseObject(BaseObject baseObj)
	{
		...
		EllipsoidEmitterFactory obj = null;
 		if(baseObj instanceof EllipsoidEmitterFactory)
		{
			obj = (EllipsoidEmitterFactory)baseObj;
		} else {
