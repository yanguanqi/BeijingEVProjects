...
public class ColourInterpolatorAffectorFactory extends com.earthview.world.graphic.ParticleAffectorFactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Plugin::ParticleFX::CColourInterpolatorAffectorFactory", new ColourInterpolatorAffectorFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Plugin::ParticleFX::JCColourInterpolatorAffectorFactoryProxy", new ColourInterpolatorAffectorFactoryClassFactory());
	}
	...
	public ColourInterpolatorAffectorFactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCColourInterpolatorAffectorFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.plugin.particlefx.ColourInterpolatorAffectorFactory".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
		}
	}

	public ColourInterpolatorAffectorFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ColourInterpolatorAffectorFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ColourInterpolatorAffectorFactory fromBaseObject(BaseObject baseObj)
	{
		...
		ColourInterpolatorAffectorFactory obj = null;
 		if(baseObj instanceof ColourInterpolatorAffectorFactory)
		{
			obj = (ColourInterpolatorAffectorFactory)baseObj;
		} else {
