...
public class BoxEmitter extends com.earthview.world.plugin.particlefx.AreaEmitter {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Plugin::ParticleFX::CBoxEmitter", new BoxEmitterClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Plugin::ParticleFX::JCBoxEmitterProxy", new BoxEmitterClassFactory());
	}

	public BoxEmitter(com.earthview.world.graphic.ParticleSystem psys) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer psysPtr = new BasePointer(psys);
		list.add("psys", psysPtr.get());
		Create("JCBoxEmitterProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.plugin.particlefx.BoxEmitter".equals(this.getClass().getName()))
		{
	...
	public BoxEmitter(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public BoxEmitter(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static BoxEmitter fromBaseObject(BaseObject baseObj)
	{
		...
		BoxEmitter obj = null;
 		if(baseObj instanceof BoxEmitter)
		{
			obj = (BoxEmitter)baseObj;
		} else {
