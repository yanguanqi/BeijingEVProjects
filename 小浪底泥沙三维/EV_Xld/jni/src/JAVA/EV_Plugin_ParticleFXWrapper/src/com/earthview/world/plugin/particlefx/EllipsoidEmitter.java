...
public class EllipsoidEmitter extends com.earthview.world.plugin.particlefx.AreaEmitter {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Plugin::ParticleFX::CEllipsoidEmitter", new EllipsoidEmitterClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Plugin::ParticleFX::JCEllipsoidEmitterProxy", new EllipsoidEmitterClassFactory());
	}

	/// See EarthView::World::Plugin::ParticleFX::CAreaEmitter
	public EllipsoidEmitter(com.earthview.world.graphic.ParticleSystem psys) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer psysPtr = new BasePointer(psys);
		list.add("psys", psysPtr.get());
		Create("JCEllipsoidEmitterProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.plugin.particlefx.EllipsoidEmitter".equals(this.getClass().getName()))
		{
	...
	public EllipsoidEmitter(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public EllipsoidEmitter(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static EllipsoidEmitter fromBaseObject(BaseObject baseObj)
	{
		...
		EllipsoidEmitter obj = null;
 		if(baseObj instanceof EllipsoidEmitter)
		{
			obj = (EllipsoidEmitter)baseObj;
		} else {
