...
public class RingEmitterFactory extends com.earthview.world.graphic.ParticleEmitterFactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Plugin::ParticleFX::CRingEmitterFactory", new RingEmitterFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Plugin::ParticleFX::JCRingEmitterFactoryProxy", new RingEmitterFactoryClassFactory());
	}

	public RingEmitterFactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCRingEmitterFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.plugin.particlefx.RingEmitterFactory".equals(this.getClass().getName()))
		{
	...
	public RingEmitterFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public RingEmitterFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static RingEmitterFactory fromBaseObject(BaseObject baseObj)
	{
		...
		RingEmitterFactory obj = null;
 		if(baseObj instanceof RingEmitterFactory)
		{
			obj = (RingEmitterFactory)baseObj;
		} else {
