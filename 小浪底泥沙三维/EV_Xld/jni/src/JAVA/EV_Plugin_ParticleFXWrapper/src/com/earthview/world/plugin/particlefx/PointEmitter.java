...
public class PointEmitter extends com.earthview.world.graphic.ParticleEmitter {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Plugin::ParticleFX::CPointEmitter", new PointEmitterClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Plugin::ParticleFX::JCPointEmitterProxy", new PointEmitterClassFactory());
	}

	public PointEmitter(com.earthview.world.graphic.ParticleSystem psys) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer psysPtr = new BasePointer(psys);
		list.add("psys", psysPtr.get());
		Create("JCPointEmitterProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.plugin.particlefx.PointEmitter".equals(this.getClass().getName()))
		{
	...
	public PointEmitter(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public PointEmitter(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static PointEmitter fromBaseObject(BaseObject baseObj)
	{
		...
		PointEmitter obj = null;
 		if(baseObj instanceof PointEmitter)
		{
			obj = (PointEmitter)baseObj;
		} else {
