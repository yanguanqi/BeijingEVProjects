...
public class DirectionRandomiserAffectorFactory extends com.earthview.world.graphic.ParticleAffectorFactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Plugin::ParticleFX::CDirectionRandomiserAffectorFactory", new DirectionRandomiserAffectorFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Plugin::ParticleFX::JCDirectionRandomiserAffectorFactoryProxy", new DirectionRandomiserAffectorFactoryClassFactory());
	}
	...
	public DirectionRandomiserAffectorFactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCDirectionRandomiserAffectorFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.plugin.particlefx.DirectionRandomiserAffectorFactory".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
		}
	}

	public DirectionRandomiserAffectorFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public DirectionRandomiserAffectorFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static DirectionRandomiserAffectorFactory fromBaseObject(BaseObject baseObj)
	{
		...
		DirectionRandomiserAffectorFactory obj = null;
 		if(baseObj instanceof DirectionRandomiserAffectorFactory)
		{
			obj = (DirectionRandomiserAffectorFactory)baseObj;
		} else {
