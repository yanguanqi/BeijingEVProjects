...
public class PointExtendEmitterFactory extends com.earthview.world.graphic.ParticleEmitterFactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Plugin::ParticleFX::CPointExtendEmitterFactory", new PointExtendEmitterFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Plugin::ParticleFX::JCPointExtendEmitterFactoryProxy", new PointExtendEmitterFactoryClassFactory());
	}

	public PointExtendEmitterFactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCPointExtendEmitterFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.plugin.particlefx.PointExtendEmitterFactory".equals(this.getClass().getName()))
		{
	...
	public PointExtendEmitterFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public PointExtendEmitterFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static PointExtendEmitterFactory fromBaseObject(BaseObject baseObj)
	{
		...
		PointExtendEmitterFactory obj = null;
 		if(baseObj instanceof PointExtendEmitterFactory)
		{
			obj = (PointExtendEmitterFactory)baseObj;
		} else {
