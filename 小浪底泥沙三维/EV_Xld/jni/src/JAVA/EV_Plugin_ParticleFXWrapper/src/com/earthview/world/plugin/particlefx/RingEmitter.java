...
public class RingEmitter extends com.earthview.world.plugin.particlefx.AreaEmitter {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Plugin::ParticleFX::CRingEmitter", new RingEmitterClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Plugin::ParticleFX::JCRingEmitterProxy", new RingEmitterClassFactory());
	}

	/// See EarthView::World::Plugin::ParticleFX::CAreaEmitter
	public static class RingEmitterCmdInnerX extends com.earthview.world.core.ParamCommand {
		
		static {
			GlobalClassFactoryMap.put("EarthView::World::Plugin::ParticleFX::CRingEmitter::CRingEmitterCmdInnerX", new RingEmitterCmdInnerXClassFactory());
			GlobalClassFactoryMap.put("EarthView::World::Plugin::ParticleFX::CRingEmitter::JCRingEmitterCmdInnerXProxy", new RingEmitterCmdInnerXClassFactory());
		}

		public RingEmitterCmdInnerX() {
			super(CreatedWhenConstruct.CWC_NotToCreate);
			Create("JCRingEmitterCmdInnerXProxy", null, true);
			this.registerCallback();
			if (!"com.earthview.world.plugin.particlefx.RingEmitter$RingEmitterCmdInnerX".equals(this.getClass().getName()))
			{
		...
		public RingEmitterCmdInnerX(CreatedWhenConstruct cwc) {
			super(CreatedWhenConstruct.CWC_NotToCreate);
		}
		public RingEmitterCmdInnerX(CreatedWhenConstruct cwc, String classNameStr) {
		...
		public static RingEmitterCmdInnerX fromBaseObject(BaseObject baseObj)
		{
			...
			RingEmitterCmdInnerX obj = null;
 			if(baseObj instanceof RingEmitterCmdInnerX)
			{
				obj = (RingEmitterCmdInnerX)baseObj;
			} else {
	...
	public static class RingEmitterCmdInnerXClassFactory implements IClassFactory {
	...
	public static class RingEmitterCmdInnerY extends com.earthview.world.core.ParamCommand {
		
		static {
			GlobalClassFactoryMap.put("EarthView::World::Plugin::ParticleFX::CRingEmitter::CRingEmitterCmdInnerY", new RingEmitterCmdInnerYClassFactory());
			GlobalClassFactoryMap.put("EarthView::World::Plugin::ParticleFX::CRingEmitter::JCRingEmitterCmdInnerYProxy", new RingEmitterCmdInnerYClassFactory());
		}

		public RingEmitterCmdInnerY() {
			super(CreatedWhenConstruct.CWC_NotToCreate);
			Create("JCRingEmitterCmdInnerYProxy", null, true);
			this.registerCallback();
			if (!"com.earthview.world.plugin.particlefx.RingEmitter$RingEmitterCmdInnerY".equals(this.getClass().getName()))
			{
				this.setCustomExtend(true);
			}
		}
		...
		public RingEmitterCmdInnerY(CreatedWhenConstruct cwc) {
			super(CreatedWhenConstruct.CWC_NotToCreate);
		}
		public RingEmitterCmdInnerY(CreatedWhenConstruct cwc, String classNameStr) {
			super(CreatedWhenConstruct.CWC_NotToCreate, classNameStr);
		}
		...
		public static RingEmitterCmdInnerY fromBaseObject(BaseObject baseObj)
		{
			...
			RingEmitterCmdInnerY obj = null;
 			if(baseObj instanceof RingEmitterCmdInnerY)
			{
				obj = (RingEmitterCmdInnerY)baseObj;
			} else {
	...
	public static class RingEmitterCmdInnerYClassFactory implements IClassFactory {
		public BaseObject create()
		{
	...
	public RingEmitter(com.earthview.world.graphic.ParticleSystem psys) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer psysPtr = new BasePointer(psys);
		list.add("psys", psysPtr.get());
		Create("JCRingEmitterProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.plugin.particlefx.RingEmitter".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
		}
	}
	...
	native private void setInnerSize_Real_Real(long pNativeObject, double x, double y);
	public void setInnerSize(double x, double y)
	{
		double xParamValue = x;
		double yParamValue = y;
		setInnerSize_Real_Real(this.nativeObject.pointer, xParamValue, yParamValue);
	}
	...
	public RingEmitter(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public RingEmitter(CreatedWhenConstruct cwc, String classNameStr) {
		super(CreatedWhenConstruct.CWC_NotToCreate, classNameStr);
	}
	...
	public static RingEmitter fromBaseObject(BaseObject baseObj)
	{
		...
		RingEmitter obj = null;
 		if(baseObj instanceof RingEmitter)
		{
			obj = (RingEmitter)baseObj;
		} else {
