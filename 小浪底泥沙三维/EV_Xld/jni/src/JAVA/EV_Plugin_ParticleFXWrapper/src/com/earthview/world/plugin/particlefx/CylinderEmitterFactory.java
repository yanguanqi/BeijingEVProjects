...
public class CylinderEmitterFactory extends com.earthview.world.graphic.ParticleEmitterFactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Plugin::ParticleFX::CCylinderEmitterFactory", new CylinderEmitterFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Plugin::ParticleFX::JCCylinderEmitterFactoryProxy", new CylinderEmitterFactoryClassFactory());
	}

	public CylinderEmitterFactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCylinderEmitterFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.plugin.particlefx.CylinderEmitterFactory".equals(this.getClass().getName()))
		{
	...
	public CylinderEmitterFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CylinderEmitterFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CylinderEmitterFactory fromBaseObject(BaseObject baseObj)
	{
		...
		CylinderEmitterFactory obj = null;
 		if(baseObj instanceof CylinderEmitterFactory)
		{
			obj = (CylinderEmitterFactory)baseObj;
		} else {
