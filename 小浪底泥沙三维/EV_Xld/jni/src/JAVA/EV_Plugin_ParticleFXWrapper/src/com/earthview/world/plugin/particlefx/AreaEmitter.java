...
public class AreaEmitter extends com.earthview.world.graphic.ParticleEmitter {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Plugin::ParticleFX::CAreaEmitter", new AreaEmitterClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Plugin::ParticleFX::JCAreaEmitterProxy", new AreaEmitterClassFactory());
	}

	public static class AreaEmitterCmdWidth extends com.earthview.world.core.ParamCommand {
		
		static {
			GlobalClassFactoryMap.put("EarthView::World::Plugin::ParticleFX::CAreaEmitter::CAreaEmitterCmdWidth", new AreaEmitterCmdWidthClassFactory());
			GlobalClassFactoryMap.put("EarthView::World::Plugin::ParticleFX::CAreaEmitter::JCAreaEmitterCmdWidthProxy", new AreaEmitterCmdWidthClassFactory());
		}

		public AreaEmitterCmdWidth() {
			super(CreatedWhenConstruct.CWC_NotToCreate);
			Create("JCAreaEmitterCmdWidthProxy", null, true);
			this.registerCallback();
			if (!"com.earthview.world.plugin.particlefx.AreaEmitter$AreaEmitterCmdWidth".equals(this.getClass().getName()))
			{
		...
		public AreaEmitterCmdWidth(CreatedWhenConstruct cwc) {
			super(CreatedWhenConstruct.CWC_NotToCreate);
		}
		public AreaEmitterCmdWidth(CreatedWhenConstruct cwc, String classNameStr) {
		...
		public static AreaEmitterCmdWidth fromBaseObject(BaseObject baseObj)
		{
			...
			AreaEmitterCmdWidth obj = null;
 			if(baseObj instanceof AreaEmitterCmdWidth)
			{
				obj = (AreaEmitterCmdWidth)baseObj;
			} else {
	...
	public static class AreaEmitterCmdWidthClassFactory implements IClassFactory {
	...
	public static class AreaEmitterCmdHeight extends com.earthview.world.core.ParamCommand {
		
		static {
			GlobalClassFactoryMap.put("EarthView::World::Plugin::ParticleFX::CAreaEmitter::CAreaEmitterCmdHeight", new AreaEmitterCmdHeightClassFactory());
			GlobalClassFactoryMap.put("EarthView::World::Plugin::ParticleFX::CAreaEmitter::JCAreaEmitterCmdHeightProxy", new AreaEmitterCmdHeightClassFactory());
		}

		public AreaEmitterCmdHeight() {
			super(CreatedWhenConstruct.CWC_NotToCreate);
			Create("JCAreaEmitterCmdHeightProxy", null, true);
			this.registerCallback();
			if (!"com.earthview.world.plugin.particlefx.AreaEmitter$AreaEmitterCmdHeight".equals(this.getClass().getName()))
			{
				this.setCustomExtend(true);
			}
		}
		...
		public AreaEmitterCmdHeight(CreatedWhenConstruct cwc) {
			super(CreatedWhenConstruct.CWC_NotToCreate);
		}
		public AreaEmitterCmdHeight(CreatedWhenConstruct cwc, String classNameStr) {
			super(CreatedWhenConstruct.CWC_NotToCreate, classNameStr);
		}
		...
		public static AreaEmitterCmdHeight fromBaseObject(BaseObject baseObj)
		{
			...
			AreaEmitterCmdHeight obj = null;
 			if(baseObj instanceof AreaEmitterCmdHeight)
			{
				obj = (AreaEmitterCmdHeight)baseObj;
			} else {
	...
	public static class AreaEmitterCmdHeightClassFactory implements IClassFactory {
		public BaseObject create()
		{
	...
	public static class CmdDepth extends com.earthview.world.core.ParamCommand {
		
		static {
			GlobalClassFactoryMap.put("EarthView::World::Plugin::ParticleFX::CAreaEmitter::CCmdDepth", new CmdDepthClassFactory());
			GlobalClassFactoryMap.put("EarthView::World::Plugin::ParticleFX::CAreaEmitter::JCCmdDepthProxy", new CmdDepthClassFactory());
		}

		public CmdDepth() {
			super(CreatedWhenConstruct.CWC_NotToCreate);
			Create("JCCmdDepthProxy", null, true);
			this.registerCallback();
			if (!"com.earthview.world.plugin.particlefx.AreaEmitter$CmdDepth".equals(this.getClass().getName()))
			{
				this.setCustomExtend(true);
			}
		}
		...
		public CmdDepth(CreatedWhenConstruct cwc) {
			super(CreatedWhenConstruct.CWC_NotToCreate);
		}
		public CmdDepth(CreatedWhenConstruct cwc, String classNameStr) {
			super(CreatedWhenConstruct.CWC_NotToCreate, classNameStr);
		}
		...
		public static CmdDepth fromBaseObject(BaseObject baseObj)
		{
			...
			CmdDepth obj = null;
 			if(baseObj instanceof CmdDepth)
			{
				obj = (CmdDepth)baseObj;
			} else {
	...
	public static class CmdDepthClassFactory implements IClassFactory {
		public BaseObject create()
		{
	...
	public AreaEmitter(com.earthview.world.graphic.ParticleSystem psys) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer psysPtr = new BasePointer(psys);
		list.add("psys", psysPtr.get());
		Create("JCAreaEmitterProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.plugin.particlefx.AreaEmitter".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
		}
	}
	...
	native private void setSize_CVector3(long pNativeObject, long size);
	public void setSize(com.earthview.world.spatial.math.Vector3 size)
	{
		long sizeParamValue = size.nativeObject.pointer;
		setSize_CVector3(this.nativeObject.pointer, sizeParamValue);
	}
	native private void setSize_Real_Real_Real(long pNativeObject, double x, double y, double z);
	public void setSize(double x, double y, double z)
	{
		double xParamValue = x;
		double yParamValue = y;
		double zParamValue = z;
		setSize_Real_Real_Real(this.nativeObject.pointer, xParamValue, yParamValue, zParamValue);
	}
	...
	native private void setDepth_Real(long pNativeObject, double Depth);
	public void setDepth(double Depth)
	{
		double DepthParamValue = Depth;
		setDepth_Real(this.nativeObject.pointer, DepthParamValue);
	}
	...
	public AreaEmitter(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public AreaEmitter(CreatedWhenConstruct cwc, String classNameStr) {
		super(CreatedWhenConstruct.CWC_NotToCreate, classNameStr);
	}
	...
	public static AreaEmitter fromBaseObject(BaseObject baseObj)
	{
		...
		AreaEmitter obj = null;
 		if(baseObj instanceof AreaEmitter)
		{
			obj = (AreaEmitter)baseObj;
		} else {
