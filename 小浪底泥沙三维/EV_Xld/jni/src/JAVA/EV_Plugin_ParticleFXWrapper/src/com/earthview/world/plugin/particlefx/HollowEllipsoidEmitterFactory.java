...
public class HollowEllipsoidEmitterFactory extends com.earthview.world.graphic.ParticleEmitterFactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Plugin::ParticleFX::CHollowEllipsoidEmitterFactory", new HollowEllipsoidEmitterFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Plugin::ParticleFX::JCHollowEllipsoidEmitterFactoryProxy", new HollowEllipsoidEmitterFactoryClassFactory());
	}

	public HollowEllipsoidEmitterFactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCHollowEllipsoidEmitterFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.plugin.particlefx.HollowEllipsoidEmitterFactory".equals(this.getClass().getName()))
		{
	...
	public HollowEllipsoidEmitterFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public HollowEllipsoidEmitterFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static HollowEllipsoidEmitterFactory fromBaseObject(BaseObject baseObj)
	{
		...
		HollowEllipsoidEmitterFactory obj = null;
 		if(baseObj instanceof HollowEllipsoidEmitterFactory)
		{
			obj = (HollowEllipsoidEmitterFactory)baseObj;
		} else {
