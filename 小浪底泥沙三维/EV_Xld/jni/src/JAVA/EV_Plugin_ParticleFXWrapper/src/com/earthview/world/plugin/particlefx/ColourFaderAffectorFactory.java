...
public class ColourFaderAffectorFactory extends com.earthview.world.graphic.ParticleAffectorFactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Plugin::ParticleFX::CColourFaderAffectorFactory", new ColourFaderAffectorFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Plugin::ParticleFX::JCColourFaderAffectorFactoryProxy", new ColourFaderAffectorFactoryClassFactory());
	}
	...
	public ColourFaderAffectorFactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCColourFaderAffectorFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.plugin.particlefx.ColourFaderAffectorFactory".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
		}
	}

	public ColourFaderAffectorFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ColourFaderAffectorFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ColourFaderAffectorFactory fromBaseObject(BaseObject baseObj)
	{
		...
		ColourFaderAffectorFactory obj = null;
 		if(baseObj instanceof ColourFaderAffectorFactory)
		{
			obj = (ColourFaderAffectorFactory)baseObj;
		} else {
