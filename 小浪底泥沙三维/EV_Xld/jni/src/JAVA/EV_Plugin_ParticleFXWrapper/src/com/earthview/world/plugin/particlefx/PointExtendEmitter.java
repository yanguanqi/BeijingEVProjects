...
public class PointExtendEmitter extends com.earthview.world.graphic.ParticleEmitter {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Plugin::ParticleFX::CPointExtendEmitter", new PointExtendEmitterClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Plugin::ParticleFX::JCPointExtendEmitterProxy", new PointExtendEmitterClassFactory());
	}

	public PointExtendEmitter(com.earthview.world.graphic.ParticleSystem psys) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer psysPtr = new BasePointer(psys);
		list.add("psys", psysPtr.get());
		Create("JCPointExtendEmitterProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.plugin.particlefx.PointExtendEmitter".equals(this.getClass().getName()))
		{
	...
	public PointExtendEmitter(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public PointExtendEmitter(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static PointExtendEmitter fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		PointExtendEmitter obj = null;
 		if(baseObj instanceof PointExtendEmitter)
		{
			obj = (PointExtendEmitter)baseObj;
		} else {
			obj = new PointExtendEmitter(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CPointExtendEmitter");
			obj.increaseCast();
		}
