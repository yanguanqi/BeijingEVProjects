...
public class LinearForceAffectorFactory extends com.earthview.world.graphic.ParticleAffectorFactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Plugin::ParticleFX::CLinearForceAffectorFactory", new LinearForceAffectorFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Plugin::ParticleFX::JCLinearForceAffectorFactoryProxy", new LinearForceAffectorFactoryClassFactory());
	}
	...
	public LinearForceAffectorFactory() {
		...
		Create("JCLinearForceAffectorFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.plugin.particlefx.LinearForceAffectorFactory".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
		}
	}

	public LinearForceAffectorFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public LinearForceAffectorFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static LinearForceAffectorFactory fromBaseObject(BaseObject baseObj)
	{
		...
		LinearForceAffectorFactory obj = null;
 		if(baseObj instanceof LinearForceAffectorFactory)
		{
			obj = (LinearForceAffectorFactory)baseObj;
		} else {
