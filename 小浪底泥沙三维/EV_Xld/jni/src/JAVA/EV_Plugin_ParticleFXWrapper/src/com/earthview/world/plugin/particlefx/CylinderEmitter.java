...
public class CylinderEmitter extends com.earthview.world.plugin.particlefx.AreaEmitter {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Plugin::ParticleFX::CCylinderEmitter", new CylinderEmitterClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Plugin::ParticleFX::JCCylinderEmitterProxy", new CylinderEmitterClassFactory());
	}

	/// See EarthView::World::Plugin::ParticleFX::CAreaEmitter
	public CylinderEmitter(com.earthview.world.graphic.ParticleSystem psys) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer psysPtr = new BasePointer(psys);
		list.add("psys", psysPtr.get());
		Create("JCCylinderEmitterProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.plugin.particlefx.CylinderEmitter".equals(this.getClass().getName()))
		{
	...
	public CylinderEmitter(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CylinderEmitter(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CylinderEmitter fromBaseObject(BaseObject baseObj)
	{
		...
		CylinderEmitter obj = null;
 		if(baseObj instanceof CylinderEmitter)
		{
			obj = (CylinderEmitter)baseObj;
		} else {
