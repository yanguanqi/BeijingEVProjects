...
/// <summary>
/// 椭圆弦环类，由椭圆弧和它的弦构成的环
public class EllipticChordRing extends com.earthview.world.spatial.geometry.EllipticArcRing {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Geometry::CEllipticChordRing", new EllipticChordRingClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Geometry::JCEllipticChordRingProxy", new EllipticChordRingClassFactory());
	}
	 ...
	 * @param  
	 */
	public EllipticChordRing() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCEllipticChordRingProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.geometry.EllipticChordRing".equals(this.getClass().getName()))
		{
	...
	public com.earthview.world.spatial.geometry.EllipticChordRing clone2()
	{
	...
	public EllipticChordRing(com.earthview.world.spatial.geometry.EllipticChordRing obj) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer objPtr = new BasePointer(obj);
		list.add("obj", objPtr.get());
		Create("JCEllipticChordRingProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.geometry.EllipticChordRing".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
	...
	native private long OperatorAssign_CEllipticChordRing(long pNativeObject, long obj);
	public com.earthview.world.spatial.geometry.EllipticChordRing OperatorAssign(com.earthview.world.spatial.geometry.EllipticChordRing obj)
	{
		long objParamValue = obj.nativeObject.pointer;
		long returnValue = OperatorAssign_CEllipticChordRing(this.nativeObject.pointer, objParamValue);
	...
	public EllipticChordRing(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public EllipticChordRing(CreatedWhenConstruct cwc, String classNameStr) {
	...
	{
		return super.getSemiMajorAxe_NoVirtual();
	}
	/**
	 * 获取短轴半径
	 * @param  
	...
	{
		return super.getSemiMinorAxe_NoVirtual();
	}
	/**
	 * 获取旋转角度
	 * @param  
	...
	{
		return super.getRotation_NoVirtual();
	}
	/**
	 * 获取椭圆弧起始角度
	 * @param  
	...
	{
		super.setEllipticArcRingByThreePoint_NoVirtual(centerPoint, assistantPoint1, assistantPoint2, fromAngle, sweepAngle);
	}
	/**
	 * 设置椭圆弧
	 * @param centerPoint 椭圆中心点
	...
	{
		super.setEllipticArcRingByRadius_NoVirtual(centerPoint, semiMajorAxe, semiMinorAxe, angle, fromAngle, sweepAngle);
	}
	/**
	 * 设置中心点
	 * @param point 中心点位置
	...
	{
		super.setSemiMajorAxe_NoVirtual(value);
	}
	/**
	 * 设置短半轴值
	 * @param value 短半轴长度
	...
	{
		super.setSemiMinorAxe_NoVirtual(value);
	}
	/**
	 * 设置旋转角度[-360,360]
	 * @param value 旋转角度
	...
	{
		super.setRotation_NoVirtual(value);
	}
	/**
	 * 设置起始角度
	 * @param value 起始角度
	...
	{
		super.setFromAngle_NoVirtual(value);
	}
	/**
	 * 设置椭圆弧张角
	 * @param value 张角
	...
	{
		super.setSweepAngle_NoVirtual(value);
	}
	/**
	 * 获取起点坐标
	 * @param  
	...
	{
		return super.getArcFromCoordinate_NoVirtual();
	}
	/**
	 * 获取终点坐标
	 * @param  
	...
	{
		return super.getArcToCoordinate_NoVirtual();
	}
	/**
	 * 获取中心点坐标
	 * @param  
	...
	{
		return super.getCenterCoordinate_NoVirtual();
	}
	/**
	 * 获取子曲线的数目
	 * @param  
	...
	public static EllipticChordRing fromBaseObject(BaseObject baseObj)
	{
		...
		EllipticChordRing obj = null;
 		if(baseObj instanceof EllipticChordRing)
		{
			obj = (EllipticChordRing)baseObj;
		} else {
