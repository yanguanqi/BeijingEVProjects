 ...
 * 椭球体
 */
public class Ellipsoid extends com.earthview.world.spatial.geometry.RevolvingVolume {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Geometry::CEllipsoid", new EllipsoidClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Geometry::JCEllipsoidProxy", new EllipsoidClassFactory());
	}
	...
	public Ellipsoid() {
		...
		Create("JCEllipsoidProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.geometry.Ellipsoid".equals(this.getClass().getName()))
		{
	...
	/**
	 * 构造函数
	 * @param centerPoint 球心
	 * @param width 宽度
	 * @param height 高度
	 */
	public Ellipsoid(com.earthview.world.spatial.geometry.Coordinate centerPoint, double width, double height) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		...
		Create("JCEllipsoidProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.geometry.Ellipsoid".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
	 ...
	 * @return 球心
	 */
	public com.earthview.world.spatial.geometry.Coordinate getCenterPoint()
	{
	...
	native private void setCenterPoint_CCoordinate(long pNativeObject, long centerPoint);
	/**
	 * 设置球心
	 * @param centerPoint 球心
	 */
	public void setCenterPoint(com.earthview.world.spatial.geometry.Coordinate centerPoint)
	{
		long centerPointParamValue = centerPoint.nativeObject.pointer;
		setCenterPoint_CCoordinate(this.nativeObject.pointer, centerPointParamValue);
	}
	...
	public Ellipsoid(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Ellipsoid(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Ellipsoid fromBaseObject(BaseObject baseObj)
	{
		...
		Ellipsoid obj = null;
 		if(baseObj instanceof Ellipsoid)
		{
			obj = (Ellipsoid)baseObj;
		} else {
