 ...
 * 表面类
 */
public class Surface extends com.earthview.world.spatial.geometry.Geometry {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Geometry::CSurface", new SurfaceClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Geometry::JCSurfaceProxy", new SurfaceClassFactory());
	}
	...
	public Surface(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Surface(CreatedWhenConstruct cwc, String classNameStr) {
