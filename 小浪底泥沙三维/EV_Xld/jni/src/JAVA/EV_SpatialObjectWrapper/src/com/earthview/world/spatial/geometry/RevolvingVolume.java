 ...
 */
public class RevolvingVolume extends com.earthview.world.spatial.geometry.Volume {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Geometry::CRevolvingVolume", new RevolvingVolumeClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Geometry::JCRevolvingVolumeProxy", new RevolvingVolumeClassFactory());
	}
	 ...
	 * @param  
	 */
	public RevolvingVolume() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCRevolvingVolumeProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.geometry.RevolvingVolume".equals(this.getClass().getName()))
		{
	 ...
	 * @param geometry 母线
	 */
	public RevolvingVolume(com.earthview.world.spatial.math.Ray axis, com.earthview.world.spatial.geometry.LineString geometry) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer axisPtr = new BasePointer(axis);
		list.add("axis", axisPtr.get());
		BasePointer geometryPtr = new BasePointer(geometry);
		list.add("geometry", geometryPtr.get());
		Create("JCRevolvingVolumeProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.geometry.RevolvingVolume".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
	...
	native private long getAxis_void(long pNativeObject);
	/**
	 * 获取旋转轴
	 * @param axis 旋转轴
	 * @return 旋转轴
	 */
	public com.earthview.world.spatial.math.Ray getAxis()
	{
		long returnValue = getAxis_void(this.nativeObject.pointer);
	...
	protected  boolean setAxis_CRay_callback(long axis)
	{
		com.earthview.world.spatial.math.Ray axisParamValue = new com.earthview.world.spatial.math.Ray(CreatedWhenConstruct.CWC_NotToCreate);
		...
		{
			axisParamValue.setDelegate(true);
			axisParamValue = (com.earthview.world.spatial.math.Ray)axisParamValueClassFactory.create();
			axisParamValue.setDelegate(true);
			axisParamValue.setInstancePointer(new InstancePointer(axis));
		}
		boolean returnValue = setAxis(axisParamValue);
		boolean __returnValue = returnValue;
		return __returnValue;
	}

	native private boolean setAxis_CRay(long pNativeObject, long axis);
	/**
	 * 设置旋转轴
	 * @param axis 旋转轴的方向
	 * @return 是否设置成功
	 */
	public boolean setAxis(com.earthview.world.spatial.math.Ray axis)
	{
		long axisParamValue = axis.nativeObject.pointer;
		boolean returnValue = setAxis_CRay(this.nativeObject.pointer, axisParamValue);
		return returnValue;
	}
	native private boolean setAxis_CRay_NoVirtual(long pNativeObject, long axis);
	protected boolean setAxis_NoVirtual(com.earthview.world.spatial.math.Ray axis)
	{
		long axisParamValue = axis.nativeObject.pointer;
		boolean returnValue = setAxis_CRay_NoVirtual(this.nativeObject.pointer, axisParamValue);
		return returnValue;
	}

	protected  boolean setGeneratrix_CLineString_callback(long geometry)
	{
		com.earthview.world.spatial.geometry.LineString geometryParamValue = new com.earthview.world.spatial.geometry.LineString(CreatedWhenConstruct.CWC_NotToCreate);
		...
		{
			geometryParamValue.setDelegate(true);
			geometryParamValue = (com.earthview.world.spatial.geometry.LineString)geometryParamValueClassFactory.create();
			geometryParamValue.setDelegate(true);
			geometryParamValue.setInstancePointer(new InstancePointer(geometry));
		}
		boolean returnValue = setGeneratrix(geometryParamValue);
		boolean __returnValue = returnValue;
		return __returnValue;
	}

	native private boolean setGeneratrix_CLineString(long pNativeObject, long geometry);
	/**
	 * 设置母线
	 * @param geometry 母线
	 * @return 是否设置成功
	 */
	public boolean setGeneratrix(com.earthview.world.spatial.geometry.LineString geometry)
	{
		long geometryParamValue = geometry.nativeObject.pointer;
		boolean returnValue = setGeneratrix_CLineString(this.nativeObject.pointer, geometryParamValue);
		return returnValue;
	}
	native private boolean setGeneratrix_CLineString_NoVirtual(long pNativeObject, long geometry);
	protected boolean setGeneratrix_NoVirtual(com.earthview.world.spatial.geometry.LineString geometry)
	{
		long geometryParamValue = geometry.nativeObject.pointer;
		boolean returnValue = setGeneratrix_CLineString_NoVirtual(this.nativeObject.pointer, geometryParamValue);
		return returnValue;
	}

	native private long getGeneratrix_void(long pNativeObject);
	/**
	 * 获得母线
	 * @param  
	 * @return 母线
	 */
	public com.earthview.world.spatial.geometry.LineString getGeneratrix()
	{
		long returnValue = getGeneratrix_void(this.nativeObject.pointer);
	 ...
	 * @return 旋转角度
	 */
	public com.earthview.world.spatial.math.Degree getAngle()
	{
	...
	protected  boolean setAngle_CDegree_callback(long degree)
	{
		com.earthview.world.spatial.math.Degree degreeParamValue = new com.earthview.world.spatial.math.Degree(CreatedWhenConstruct.CWC_NotToCreate);
		degreeParamValue.setDelegate(true);
		degreeParamValue.setInstancePointer(new InstancePointer(degree));
		IClassFactory degreeParamValueClassFactory = GlobalClassFactoryMap.get(degreeParamValue.getCppInstanceTypeName());
		if (degreeParamValueClassFactory != null)
		{
			degreeParamValue.setDelegate(true);
			degreeParamValue = (com.earthview.world.spatial.math.Degree)degreeParamValueClassFactory.create();
			degreeParamValue.setDelegate(true);
			degreeParamValue.setInstancePointer(new InstancePointer(degree));
		}
		boolean returnValue = setAngle(degreeParamValue);
		boolean __returnValue = returnValue;
		return __returnValue;
	}

	native private boolean setAngle_CDegree(long pNativeObject, long degree);
	/**
	 * 设置旋转角度
	 * @param degree 旋转角度
	 * @return 是否设置成功
	 */
	public boolean setAngle(com.earthview.world.spatial.math.Degree degree)
	{
		long degreeParamValue = degree.nativeObject.pointer;
		boolean returnValue = setAngle_CDegree(this.nativeObject.pointer, degreeParamValue);
		return returnValue;
	}
	native private boolean setAngle_CDegree_NoVirtual(long pNativeObject, long degree);
	protected boolean setAngle_NoVirtual(com.earthview.world.spatial.math.Degree degree)
	{
		long degreeParamValue = degree.nativeObject.pointer;
		boolean returnValue = setAngle_CDegree_NoVirtual(this.nativeObject.pointer, degreeParamValue);
		return returnValue;
	}
	...
	public RevolvingVolume(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public RevolvingVolume(CreatedWhenConstruct cwc, String classNameStr) {
	...
	{
		return super.getRotate_NoVirtual();
	}
	/**
	 * 获取缩放参数
	 * @param  
	...
	{
		return super.getTranslateX_NoVirtual();
	}
	/**
	 * 获取变换矩阵
	 * @param  
	...
	{
		super.setTranslate_NoVirtual(offset);
	}
	/**
	 * 设置缩放参数
	 * @param scale 缩放参数
	...
	{
		super.setRotation_NoVirtual(orientation);
	}
	/**
	 * 设置变换矩阵
	 * @param matrix 变换矩阵
	...
	{
		super.setMatrix_NoVirtual(matrix);
	}
	/**
	 * 判断对象的参数是否发生变化
	 * @param  
	...
	native protected void register_setAxis_CRay(long pNativeObject, String method);
	native protected void register_setGeneratrix_CLineString(long pNativeObject, String method);
	native protected void register_setAngle_CDegree(long pNativeObject, String method);
	...
	public void registerCallback(){
		if (!this.nativeObject.equals(InstancePointer.ZERO)){
			this.register_setAxis_CRay(this.nativeObject.pointer, "setAxis_CRay_callback");
			this.register_setGeneratrix_CLineString(this.nativeObject.pointer, "setGeneratrix_CLineString_callback");
			this.register_setAngle_CDegree(this.nativeObject.pointer, "setAngle_CDegree_callback");
	...
	public static RevolvingVolume fromBaseObject(BaseObject baseObj)
	{
		...
		RevolvingVolume obj = null;
 		if(baseObj instanceof RevolvingVolume)
		{
			obj = (RevolvingVolume)baseObj;
		} else {
