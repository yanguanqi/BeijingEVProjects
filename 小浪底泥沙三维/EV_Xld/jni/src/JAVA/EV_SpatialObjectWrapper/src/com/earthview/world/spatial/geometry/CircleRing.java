 ...
 */
public class CircleRing extends com.earthview.world.spatial.geometry.CircleArcRing {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Geometry::CCircleRing", new CircleRingClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Geometry::JCCircleRingProxy", new CircleRingClassFactory());
	}
	...
	public CircleRing() {
		...
		Create("JCCircleRingProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.geometry.CircleRing".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
		}
	}

	native private void setCircleArcRingByThreePoint_CPoint_CPoint_CPoint(long pNativeObject, long centerPoint, long assistantPoint1, long assistantPoint2);
	/**
	 * 通过三个点设置圆环
	 * @param  
	 */
	public void setCircleArcRingByThreePoint(com.earthview.world.spatial.geometry.Point centerPoint, com.earthview.world.spatial.geometry.Point assistantPoint1, com.earthview.world.spatial.geometry.Point assistantPoint2)
	{
		...
		setCircleArcRingByThreePoint_CPoint_CPoint_CPoint(this.nativeObject.pointer, centerPointParamValue, assistantPoint1ParamValue, assistantPoint2ParamValue);
	}
	native private void setCircleArcRingByThreePoint_CPoint_CPoint_CPoint_NoVirtual(long pNativeObject, long centerPoint, long assistantPoint1, long assistantPoint2);
	protected void setCircleArcRingByThreePoint_NoVirtual(com.earthview.world.spatial.geometry.Point centerPoint, com.earthview.world.spatial.geometry.Point assistantPoint1, com.earthview.world.spatial.geometry.Point assistantPoint2)
	{
		long centerPointParamValue = centerPoint.nativeObject.pointer;
		long assistantPoint1ParamValue = assistantPoint1.nativeObject.pointer;
		long assistantPoint2ParamValue = assistantPoint2.nativeObject.pointer;
		setCircleArcRingByThreePoint_CPoint_CPoint_CPoint_NoVirtual(this.nativeObject.pointer, centerPointParamValue, assistantPoint1ParamValue, assistantPoint2ParamValue);
	}
	...
	public com.earthview.world.spatial.geometry.CircleRing clone2()
	{
		long returnValue = clone2_void(this.nativeObject.pointer);
		com.earthview.world.spatial.geometry.CircleRing __returnValue = new com.earthview.world.spatial.geometry.CircleRing(CreatedWhenConstruct.CWC_NotToCreate);
		InstancePointer __instancePointer = new InstancePointer(returnValue);
		__returnValue.bindNativeObject(__instancePointer, "CCircleRing");
		__returnValue.createNativeObjectPointer(__instancePointer);
		IClassFactory __returnValueClassFactory = GlobalClassFactoryMap.get(__returnValue.getCppInstanceTypeName());
		if (__returnValueClassFactory != null)
		{
			__returnValue.setDelegate(true);
			__returnValue = (com.earthview.world.spatial.geometry.CircleRing)__returnValueClassFactory.create();
			__returnValue.bindNativeObject(__instancePointer, "CCircleRing");
		}
		return __returnValue;
	}
	public CircleRing(com.earthview.world.spatial.geometry.CircleRing obj) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer objPtr = new BasePointer(obj);
		list.add("obj", objPtr.get());
		Create("JCCircleRingProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.geometry.CircleRing".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
	...
	native private long OperatorAssign_CCircleRing(long pNativeObject, long obj);
	public com.earthview.world.spatial.geometry.CircleRing OperatorAssign(com.earthview.world.spatial.geometry.CircleRing obj)
	{
		long objParamValue = obj.nativeObject.pointer;
		long returnValue = OperatorAssign_CCircleRing(this.nativeObject.pointer, objParamValue);
		com.earthview.world.spatial.geometry.CircleRing __returnValue = new com.earthview.world.spatial.geometry.CircleRing(CreatedWhenConstruct.CWC_NotToCreate, "CCircleRing");
		__returnValue.setDelegate(true);
		InstancePointer __instancePointer = new InstancePointer(returnValue);
		__returnValue.setInstancePointer(__instancePointer);
		IClassFactory __returnValueClassFactory = GlobalClassFactoryMap.get(__returnValue.getCppInstanceTypeName());
	...
	public CircleRing(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CircleRing(CreatedWhenConstruct cwc, String classNameStr) {
	...
	{
		return super.getCenterPoint_NoVirtual();
	}
	public com.earthview.world.spatial.geometry.Point getCenterPoint2()
	{
		return super.getCenterPoint2_NoVirtual();
	}
	/**
	 * 获取圆弧起点
	 * @param  
	...
	{
		return super.getArcFromPoint_NoVirtual();
	}
	public com.earthview.world.spatial.geometry.Point getArcFromPoint2()
	{
		return super.getArcFromPoint2_NoVirtual();
	}
	/**
	 * 获取圆弧终点
	 * @param  
	...
	{
		return super.getArcToPoint_NoVirtual();
	}
	public com.earthview.world.spatial.geometry.Point getArcToPoint2()
	{
		return super.getArcToPoint2_NoVirtual();
	}
	/**
	 * 获取半径
	 * @param  
	...
	{
		return super.getRadius_NoVirtual();
	}
	/**
	 * 获取起始角度
	 * @param  
	...
	{
		return super.getFromAngle_NoVirtual();
	}
	/**
	 * 获取终止角度
	 * @param  
	...
	{
		return super.getToAngle_NoVirtual();
	}
	/**
	 * 获取圆心角
	 * @param  
	...
	{
		return super.getSweepAngle_NoVirtual();
	}
	/**
	 * 获取圆弧长度
	 * @param  
	...
	{
		return super.getArcLength_NoVirtual();
	}
	/**
	 * 获取弦长
	 * @param  
	...
	{
		return super.getChordLength_NoVirtual();
	}
	/**
	 * 获取弦高
	 * @param  
	...
	{
		return super.getChordHeight_NoVirtual();
	}
	/**
	 * 设置中心点
	 * @param point 中心点
	...
	{
		super.setRadius_NoVirtual(value);
	}
	/**
	 * 获取起始点坐标
	 * @param  
	...
	{
		return super.getArcFromCoordinateRef_NoVirtual();
	}
	/**
	 * 获取终止点坐标
	 * @param  
	...
	{
		return super.getArcToCoordinateRef_NoVirtual();
	}
	/**
	 * 获取中心点坐标
	 * @param  
	...
	{
		return super.getCenterCoordinateRef_NoVirtual();
	}
	/**
	 * 获取子曲线的数目
	 * @param  
	...
	{
		return super.remove_NoVirtual(index, size);
	}
	/**
	 * 清楚所有Path
	 * @param  
	...
	public static CircleRing fromBaseObject(BaseObject baseObj)
	{
		...
		CircleRing obj = null;
 		if(baseObj instanceof CircleRing)
		{
			obj = (CircleRing)baseObj;
		} else {
