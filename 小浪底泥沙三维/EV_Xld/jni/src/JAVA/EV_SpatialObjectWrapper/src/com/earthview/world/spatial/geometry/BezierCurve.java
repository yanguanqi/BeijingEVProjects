 ...
 * 贝赛尔曲线类
 */
public class BezierCurve extends com.earthview.world.spatial.geometry.Curve {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Geometry::CBezierCurve", new BezierCurveClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Geometry::JCBezierCurveProxy", new BezierCurveClassFactory());
	}
	...
	public BezierCurve() {
		...
		Create("JCBezierCurveProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.geometry.BezierCurve".equals(this.getClass().getName()))
		{
	 ...
	 * @param fromPoint 起始点
	 * @param toPoint 结束点
	 * @param fromControlPoint 起始控制点
	 * @param toControlPoint 起始控制点点
	 */
	public BezierCurve(com.earthview.world.spatial.geometry.Point fromPoint, com.earthview.world.spatial.geometry.Point toPoint, com.earthview.world.spatial.geometry.Point fromControlPoint, com.earthview.world.spatial.geometry.Point toControlPoint) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer fromPointPtr = new BasePointer(fromPoint);
		list.add("fromPoint", fromPointPtr.get());
		BasePointer toPointPtr = new BasePointer(toPoint);
		list.add("toPoint", toPointPtr.get());
		BasePointer fromControlPointPtr = new BasePointer(fromControlPoint);
		list.add("fromControlPoint", fromControlPointPtr.get());
		BasePointer toControlPointPtr = new BasePointer(toControlPoint);
		list.add("toControlPoint", toControlPointPtr.get());
		Create("JCBezierCurveProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.geometry.BezierCurve".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
	...
	native private long getFromControlPoint_void(long pNativeObject);
	/**
	 * 获取起始点的控制点
	 * @param  
	 */
	public com.earthview.world.spatial.geometry.Point getFromControlPoint()
	{
		long returnValue = getFromControlPoint_void(this.nativeObject.pointer);
		if(returnValue == 0L) {
			return null;
		}
		com.earthview.world.spatial.geometry.Point __returnValue = new com.earthview.world.spatial.geometry.Point(CreatedWhenConstruct.CWC_NotToCreate, "CPoint");
	...
	native private long getFromControlPoint2_void(long pNativeObject);
	public com.earthview.world.spatial.geometry.Point getFromControlPoint2()
	{
		long returnValue = getFromControlPoint2_void(this.nativeObject.pointer);
		com.earthview.world.spatial.geometry.Point __returnValue = new com.earthview.world.spatial.geometry.Point(CreatedWhenConstruct.CWC_NotToCreate);
		InstancePointer __instancePointer = new InstancePointer(returnValue);
		__returnValue.bindNativeObject(__instancePointer, "CPoint");
		__returnValue.createNativeObjectPointer(__instancePointer);
	...
	native private long getToControlPoint_void(long pNativeObject);
	/**
	 * 获取结束点控制点
	 * @param  
	 */
	public com.earthview.world.spatial.geometry.Point getToControlPoint()
	{
		long returnValue = getToControlPoint_void(this.nativeObject.pointer);
		if(returnValue == 0L) {
			return null;
		}
		com.earthview.world.spatial.geometry.Point __returnValue = new com.earthview.world.spatial.geometry.Point(CreatedWhenConstruct.CWC_NotToCreate, "CPoint");
	...
	native private long getToControlPoint2_void(long pNativeObject);
	public com.earthview.world.spatial.geometry.Point getToControlPoint2()
	{
		long returnValue = getToControlPoint2_void(this.nativeObject.pointer);
		com.earthview.world.spatial.geometry.Point __returnValue = new com.earthview.world.spatial.geometry.Point(CreatedWhenConstruct.CWC_NotToCreate);
		InstancePointer __instancePointer = new InstancePointer(returnValue);
		__returnValue.bindNativeObject(__instancePointer, "CPoint");
		__returnValue.createNativeObjectPointer(__instancePointer);
	...
	native private void setFromPoint_CPoint(long pNativeObject, long point);
	/**
	 * 设置起始点
	 * @param point 起始点
	 */
	public void setFromPoint(com.earthview.world.spatial.geometry.Point point)
	{
		long pointParamValue = point.nativeObject.pointer;
		setFromPoint_CPoint(this.nativeObject.pointer, pointParamValue);
	}
	native private void setToPoint_CPoint(long pNativeObject, long point);
	/**
	 * 设置结束点
	 * @param point 结束点
	 */
	public void setToPoint(com.earthview.world.spatial.geometry.Point point)
	{
		long pointParamValue = point.nativeObject.pointer;
		setToPoint_CPoint(this.nativeObject.pointer, pointParamValue);
	}
	native private void setFromControlPoint_CPoint(long pNativeObject, long point);
	/**
	 * 设置起始点控制点
	 * @param point 起始点的控制点
	 */
	public void setFromControlPoint(com.earthview.world.spatial.geometry.Point point)
	{
		long pointParamValue = point.nativeObject.pointer;
		setFromControlPoint_CPoint(this.nativeObject.pointer, pointParamValue);
	}
	native private void setToControlPoint_CPoint(long pNativeObject, long point);
	/**
	 * 设置结束点的控制点
	 * @param point 结束点的控制点
	 */
	public void setToControlPoint(com.earthview.world.spatial.geometry.Point point)
	{
		long pointParamValue = point.nativeObject.pointer;
		setToControlPoint_CPoint(this.nativeObject.pointer, pointParamValue);
	}
	...
	/**
	 * 转换成线串
	 * @param smooth 平滑度[0,1,2,3,4,5].参数越大，平滑度越高
	 * @return 线串对象
	 */
	...
	public com.earthview.world.spatial.geometry.BezierCurve clone2()
	{
		long returnValue = clone2_void(this.nativeObject.pointer);
		com.earthview.world.spatial.geometry.BezierCurve __returnValue = new com.earthview.world.spatial.geometry.BezierCurve(CreatedWhenConstruct.CWC_NotToCreate);
		InstancePointer __instancePointer = new InstancePointer(returnValue);
		__returnValue.bindNativeObject(__instancePointer, "CBezierCurve");
		__returnValue.createNativeObjectPointer(__instancePointer);
		IClassFactory __returnValueClassFactory = GlobalClassFactoryMap.get(__returnValue.getCppInstanceTypeName());
		if (__returnValueClassFactory != null)
		{
			__returnValue.setDelegate(true);
			__returnValue = (com.earthview.world.spatial.geometry.BezierCurve)__returnValueClassFactory.create();
			__returnValue.bindNativeObject(__instancePointer, "CBezierCurve");
		}
		return __returnValue;
	}
	...
	/**
	 * 更新内部参数，用于setXX方法后，调用。一般用于多处修改后，统一更新处理。
	 */
	public void update()
	{
	...
	/**
	 * 移动几何体上顶点到指定位置
	 * @param frmPoint 需要移动的点，该点必须上几何体上的顶点
	 * @param toPoint 移动的位置
	 * @return 移动成功，返回true；否则，返回false
	 */
	...
	/**
	 * 添加点到几何体
	 * @param point 添加点，该点必须和几何体上的某一边相交
	...
	/**
	 * 删除几何体上的点
	 * @param point 需要删除的点，该点必须上几何体上的顶点
	 ...
	 * @param  
	 */
	public BezierCurve(com.earthview.world.spatial.geometry.BezierCurve obj) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
	...
	native private long OperatorAssign_CBezierCurve(long pNativeObject, long obj);
	public com.earthview.world.spatial.geometry.BezierCurve OperatorAssign(com.earthview.world.spatial.geometry.BezierCurve obj)
	{
		long objParamValue = obj.nativeObject.pointer;
		long returnValue = OperatorAssign_CBezierCurve(this.nativeObject.pointer, objParamValue);
		com.earthview.world.spatial.geometry.BezierCurve __returnValue = new com.earthview.world.spatial.geometry.BezierCurve(CreatedWhenConstruct.CWC_NotToCreate, "CBezierCurve");
		__returnValue.setDelegate(true);
		InstancePointer __instancePointer = new InstancePointer(returnValue);
		__returnValue.setInstancePointer(__instancePointer);
		IClassFactory __returnValueClassFactory = GlobalClassFactoryMap.get(__returnValue.getCppInstanceTypeName());
	...
	public BezierCurve(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public BezierCurve(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static BezierCurve fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		BezierCurve obj = null;
 		if(baseObj instanceof BezierCurve)
		{
			obj = (BezierCurve)baseObj;
		} else {
			obj = new BezierCurve(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CBezierCurve");
			obj.increaseCast();
		}
