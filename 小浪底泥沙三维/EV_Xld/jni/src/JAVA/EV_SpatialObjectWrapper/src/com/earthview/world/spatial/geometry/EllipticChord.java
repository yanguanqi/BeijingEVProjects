 ...
 * 椭圆弦面，由椭圆弧和它的弦构成的面
 */
public class EllipticChord extends com.earthview.world.spatial.geometry.Polygon {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Geometry::CEllipticChord", new EllipticChordClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Geometry::JCEllipticChordProxy", new EllipticChordClassFactory());
	}
	 ...
	 * @param  
	 */
	public EllipticChord() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCEllipticChordProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.geometry.EllipticChord".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
		}
	}

	native private void setEllipticChordRing_CEllipticChordRing(long pNativeObject, long ring);
	/**
	 * 设置椭圆弦环
	 * @param ring 椭圆弦环
	 */
	public void setEllipticChordRing(com.earthview.world.spatial.geometry.EllipticChordRing ring)
	{
		long ringParamValue = ring.nativeObject.pointer;
		setEllipticChordRing_CEllipticChordRing(this.nativeObject.pointer, ringParamValue);
	}
	native private long getChordRingRef_void(long pNativeObject);
	/**
	 * 获取椭圆弦环
	 * @param  
	 * @return 椭圆弦环
	 */
	public com.earthview.world.spatial.geometry.EllipticChordRing getChordRingRef()
	{
		long returnValue = getChordRingRef_void(this.nativeObject.pointer);
		if(returnValue == 0L) {
			return null;
		}
		com.earthview.world.spatial.geometry.EllipticChordRing __returnValue = new com.earthview.world.spatial.geometry.EllipticChordRing(CreatedWhenConstruct.CWC_NotToCreate, "CEllipticChordRing");
		...
		{
			__returnValue.setDelegate(true);
			__returnValue = (com.earthview.world.spatial.geometry.EllipticChordRing)__returnValueClassFactory.create();
			__returnValue.setDelegate(true);
			__returnValue.bindNativeObject(__instancePointer, "CEllipticChordRing");
		}
		return __returnValue;
	}
	native private long getChordRing_void(long pNativeObject);
	public com.earthview.world.spatial.geometry.EllipticChordRing getChordRing()
	{
		long returnValue = getChordRing_void(this.nativeObject.pointer);
		com.earthview.world.spatial.geometry.EllipticChordRing __returnValue = new com.earthview.world.spatial.geometry.EllipticChordRing(CreatedWhenConstruct.CWC_NotToCreate);
		InstancePointer __instancePointer = new InstancePointer(returnValue);
		__returnValue.bindNativeObject(__instancePointer, "CEllipticChordRing");
	...
	public com.earthview.world.spatial.geometry.EllipticChord clone2()
	{
		long returnValue = clone2_void(this.nativeObject.pointer);
		com.earthview.world.spatial.geometry.EllipticChord __returnValue = new com.earthview.world.spatial.geometry.EllipticChord(CreatedWhenConstruct.CWC_NotToCreate);
		InstancePointer __instancePointer = new InstancePointer(returnValue);
		__returnValue.bindNativeObject(__instancePointer, "CEllipticChord");
		__returnValue.createNativeObjectPointer(__instancePointer);
		IClassFactory __returnValueClassFactory = GlobalClassFactoryMap.get(__returnValue.getCppInstanceTypeName());
		if (__returnValueClassFactory != null)
		{
			__returnValue.setDelegate(true);
			__returnValue = (com.earthview.world.spatial.geometry.EllipticChord)__returnValueClassFactory.create();
			__returnValue.bindNativeObject(__instancePointer, "CEllipticChord");
		}
		return __returnValue;
	}
	public EllipticChord(com.earthview.world.spatial.geometry.EllipticChord obj) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer objPtr = new BasePointer(obj);
		list.add("obj", objPtr.get());
		Create("JCEllipticChordProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.geometry.EllipticChord".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
	...
	native private long OperatorAssign_CEllipticChord(long pNativeObject, long obj);
	public com.earthview.world.spatial.geometry.EllipticChord OperatorAssign(com.earthview.world.spatial.geometry.EllipticChord obj)
	{
		long objParamValue = obj.nativeObject.pointer;
		long returnValue = OperatorAssign_CEllipticChord(this.nativeObject.pointer, objParamValue);
		com.earthview.world.spatial.geometry.EllipticChord __returnValue = new com.earthview.world.spatial.geometry.EllipticChord(CreatedWhenConstruct.CWC_NotToCreate, "CEllipticChord");
		__returnValue.setDelegate(true);
		InstancePointer __instancePointer = new InstancePointer(returnValue);
		__returnValue.setInstancePointer(__instancePointer);
		IClassFactory __returnValueClassFactory = GlobalClassFactoryMap.get(__returnValue.getCppInstanceTypeName());
	...
	public EllipticChord(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public EllipticChord(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static EllipticChord fromBaseObject(BaseObject baseObj)
	{
		...
		EllipticChord obj = null;
 		if(baseObj instanceof EllipticChord)
		{
			obj = (EllipticChord)baseObj;
		} else {
