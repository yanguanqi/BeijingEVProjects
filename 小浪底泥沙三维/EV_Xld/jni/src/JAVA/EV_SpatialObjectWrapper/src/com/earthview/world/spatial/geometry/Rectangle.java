 ...
 * 长方形类，角点可以设置为圆角。
 */
public class Rectangle extends com.earthview.world.spatial.geometry.Polygon {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Geometry::CRectangle", new RectangleClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Geometry::JCRectangleProxy", new RectangleClassFactory());
	}
	...
	public Rectangle() {
		...
		Create("JCRectangleProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.geometry.Rectangle".equals(this.getClass().getName()))
		{
	...
	native private void setRectangleRing_CRectangleRing(long pNativeObject, long ring);
	/**
	 * 设置矩形环
	 * @param ring 矩形环
	 */
	public void setRectangleRing(com.earthview.world.spatial.geometry.RectangleRing ring)
	{
		long ringParamValue = ring.nativeObject.pointer;
		setRectangleRing_CRectangleRing(this.nativeObject.pointer, ringParamValue);
	}
	native private long getRectangleRingRef_void(long pNativeObject);
	/**
	 * 获取矩形环
	 * @param  
	 * @return 矩形环
	 */
	public com.earthview.world.spatial.geometry.RectangleRing getRectangleRingRef()
	{
		long returnValue = getRectangleRingRef_void(this.nativeObject.pointer);
		if(returnValue == 0L) {
			return null;
		}
	...
	native private long getRectangleRing_void(long pNativeObject);
	public com.earthview.world.spatial.geometry.RectangleRing getRectangleRing()
	{
		long returnValue = getRectangleRing_void(this.nativeObject.pointer);
	...
	native private void getCornerRadius_ev_real64_ev_real64_ev_bool(long pNativeObject, long value12, long value23, boolean isRadio);
	/**
	 * 获取指定索引的圆弧半径。该索引有效值为0，1。index=0，返回第一个弧度半径
	 * @param  
	 */
	public void getCornerRadius(DoublePointer value12, DoublePointer value23, boolean isRadio)
	{
		...
		getCornerRadius_ev_real64_ev_real64_ev_bool(this.nativeObject.pointer, value12ParamValue, value23ParamValue, isRadioParamValue);
	}
	...
	native private void setRoundCorner_ev_real64_ev_real64_ev_bool(long pNativeObject, double value12, double value23, boolean isRadio);
	/**
	 * 设置圆角参数，通过设置长度比例，计算圆角控制点。该长度比例为长方形两个边长的比例，范围【0，0.5】
	 * @param isRoundCorner 是否开启圆角设置
	 * @param dfRadio1 长度比例
	 * @param dfRadio2 长度比例
	 */
	public void setRoundCorner(double value12, double value23, boolean isRadio)
	{
		double value12ParamValue = value12;
		double value23ParamValue = value23;
		boolean isRadioParamValue = isRadio;
		setRoundCorner_ev_real64_ev_real64_ev_bool(this.nativeObject.pointer, value12ParamValue, value23ParamValue, isRadioParamValue);
	}
	...
	public com.earthview.world.spatial.geometry.Rectangle clone2()
	{
		long returnValue = clone2_void(this.nativeObject.pointer);
		com.earthview.world.spatial.geometry.Rectangle __returnValue = new com.earthview.world.spatial.geometry.Rectangle(CreatedWhenConstruct.CWC_NotToCreate);
		InstancePointer __instancePointer = new InstancePointer(returnValue);
		__returnValue.bindNativeObject(__instancePointer, "CRectangle");
		__returnValue.createNativeObjectPointer(__instancePointer);
		IClassFactory __returnValueClassFactory = GlobalClassFactoryMap.get(__returnValue.getCppInstanceTypeName());
		if (__returnValueClassFactory != null)
		{
			__returnValue.setDelegate(true);
			__returnValue = (com.earthview.world.spatial.geometry.Rectangle)__returnValueClassFactory.create();
			__returnValue.bindNativeObject(__instancePointer, "CRectangle");
		}
		return __returnValue;
	}
	public Rectangle(com.earthview.world.spatial.geometry.Rectangle obj) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer objPtr = new BasePointer(obj);
		list.add("obj", objPtr.get());
		Create("JCRectangleProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.geometry.Rectangle".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
	...
	native private long OperatorAssign_CRectangle(long pNativeObject, long obj);
	public com.earthview.world.spatial.geometry.Rectangle OperatorAssign(com.earthview.world.spatial.geometry.Rectangle obj)
	{
		long objParamValue = obj.nativeObject.pointer;
		long returnValue = OperatorAssign_CRectangle(this.nativeObject.pointer, objParamValue);
		com.earthview.world.spatial.geometry.Rectangle __returnValue = new com.earthview.world.spatial.geometry.Rectangle(CreatedWhenConstruct.CWC_NotToCreate, "CRectangle");
		__returnValue.setDelegate(true);
		InstancePointer __instancePointer = new InstancePointer(returnValue);
		__returnValue.setInstancePointer(__instancePointer);
		IClassFactory __returnValueClassFactory = GlobalClassFactoryMap.get(__returnValue.getCppInstanceTypeName());
