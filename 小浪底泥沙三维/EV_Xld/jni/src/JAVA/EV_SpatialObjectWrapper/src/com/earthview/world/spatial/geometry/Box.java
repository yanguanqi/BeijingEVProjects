 ...
 * 长方体类管理长方体
 */
public class Box extends com.earthview.world.spatial.geometry.Volume {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Geometry::CBox", new BoxClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Geometry::JCBoxProxy", new BoxClassFactory());
	}
	...
	public Box() {
		...
		Create("JCBoxProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.geometry.Box".equals(this.getClass().getName()))
		{
	 ...
	 * @param maxpoint 最大点
	 */
	public Box(com.earthview.world.spatial.geometry.Coordinate minpoint, com.earthview.world.spatial.geometry.Coordinate maxpoint) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer minpointPtr = new BasePointer(minpoint);
		list.add("minpoint", minpointPtr.get());
		BasePointer maxpointPtr = new BasePointer(maxpoint);
		list.add("maxpoint", maxpointPtr.get());
		Create("JCBoxProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.geometry.Box".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
	...
	native private long getMinmum_void(long pNativeObject);
	/**
	 * 获取最小点
	 * @param  
	 * @return 最小点
	 */
	public com.earthview.world.spatial.geometry.Coordinate getMinmum()
	{
		long returnValue = getMinmum_void(this.nativeObject.pointer);
	...
	native private void setMinmum_CCoordinate(long pNativeObject, long minpoint);
	/**
	 * 设置最小点
	 * @param minpoint 最小点
	 */
	public void setMinmum(com.earthview.world.spatial.geometry.Coordinate minpoint)
	{
		long minpointParamValue = minpoint.nativeObject.pointer;
		setMinmum_CCoordinate(this.nativeObject.pointer, minpointParamValue);
	}
	native private long getMaxmum_void(long pNativeObject);
	/**
	 * 获取最大点
	 * @param  
	 * @return 最大点
	 */
	public com.earthview.world.spatial.geometry.Coordinate getMaxmum()
	{
		long returnValue = getMaxmum_void(this.nativeObject.pointer);
		com.earthview.world.spatial.geometry.Coordinate __returnValue = new com.earthview.world.spatial.geometry.Coordinate(CreatedWhenConstruct.CWC_NotToCreate, "CCoordinate");
		__returnValue.setDelegate(true);
		InstancePointer __instancePointer = new InstancePointer(returnValue);
		__returnValue.setInstancePointer(__instancePointer);
	...
	native private void setMaxmum_CCoordinate(long pNativeObject, long maxpoint);
	/**
	 * 设置最大点
	 * @param maxpoint 最大点
	 */
	public void setMaxmum(com.earthview.world.spatial.geometry.Coordinate maxpoint)
	{
		long maxpointParamValue = maxpoint.nativeObject.pointer;
		setMaxmum_CCoordinate(this.nativeObject.pointer, maxpointParamValue);
	}
