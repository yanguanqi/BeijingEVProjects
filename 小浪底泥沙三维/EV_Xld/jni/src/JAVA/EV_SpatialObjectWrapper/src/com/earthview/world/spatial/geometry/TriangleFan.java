...
/**
 * 三角扇类有第一个点和后面的按顺序每两个点构成三角扇
 */
public class TriangleFan extends com.earthview.world.spatial.geometry.Surface {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Geometry::CTriangleFan", new TriangleFanClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Geometry::JCTriangleFanProxy", new TriangleFanClassFactory());
	}
	...
	public TriangleFan() {
		...
		Create("JCTriangleFanProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.geometry.TriangleFan".equals(this.getClass().getName()))
		{
	 ...
	 * @return 点坐标
	 */
	public com.earthview.world.spatial.geometry.Coordinate getPoint(long index)
	{
	...
	native private void insertPoint_ev_uint32_CCoordinate(long pNativeObject, long index, long point);
	/**
	 * 插入点
	 * @param index 索引
	 * @param point 点
	 */
	public void insertPoint(long index, com.earthview.world.spatial.geometry.Coordinate point)
	{
		long indexParamValue = index;
		long pointParamValue = (point == null ? 0L : point.nativeObject.pointer);
		insertPoint_ev_uint32_CCoordinate(this.nativeObject.pointer, indexParamValue, pointParamValue);
	}
	...
	public TriangleFan(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public TriangleFan(CreatedWhenConstruct cwc, String classNameStr) {
	...
	{
		return super.getArea_NoVirtual();
	}
	/**
	 * 判断对象的参数是否发生变化
	 * @param  
	...
	public static TriangleFan fromBaseObject(BaseObject baseObj)
	{
		...
		TriangleFan obj = null;
 		if(baseObj instanceof TriangleFan)
		{
			obj = (TriangleFan)baseObj;
		} else {
