 ...
 * 椭圆面类。
 */
public class Ellipse extends com.earthview.world.spatial.geometry.Polygon {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Geometry::CEllipse", new EllipseClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Geometry::JCEllipseProxy", new EllipseClassFactory());
	}
	...
	public Ellipse() {
		...
		Create("JCEllipseProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.geometry.Ellipse".equals(this.getClass().getName()))
		{
	...
	native private long getEllipticRingRef_void(long pNativeObject);
	/**
	 * 获取椭圆环
	 * @param  
	 * @return 椭圆环
	 */
	public com.earthview.world.spatial.geometry.EllipticRing getEllipticRingRef()
	{
		long returnValue = getEllipticRingRef_void(this.nativeObject.pointer);
		if(returnValue == 0L) {
			return null;
		}
	...
	native private long getEllipticRing_void(long pNativeObject);
	public com.earthview.world.spatial.geometry.EllipticRing getEllipticRing()
	{
		long returnValue = getEllipticRing_void(this.nativeObject.pointer);
	...
	public com.earthview.world.spatial.geometry.Ellipse clone2()
	{
		long returnValue = clone2_void(this.nativeObject.pointer);
		com.earthview.world.spatial.geometry.Ellipse __returnValue = new com.earthview.world.spatial.geometry.Ellipse(CreatedWhenConstruct.CWC_NotToCreate);
		InstancePointer __instancePointer = new InstancePointer(returnValue);
		__returnValue.bindNativeObject(__instancePointer, "CEllipse");
		__returnValue.createNativeObjectPointer(__instancePointer);
		IClassFactory __returnValueClassFactory = GlobalClassFactoryMap.get(__returnValue.getCppInstanceTypeName());
		if (__returnValueClassFactory != null)
		{
			__returnValue.setDelegate(true);
			__returnValue = (com.earthview.world.spatial.geometry.Ellipse)__returnValueClassFactory.create();
			__returnValue.bindNativeObject(__instancePointer, "CEllipse");
		}
		return __returnValue;
	}
	public Ellipse(com.earthview.world.spatial.geometry.Ellipse obj) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer objPtr = new BasePointer(obj);
		list.add("obj", objPtr.get());
		Create("JCEllipseProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.geometry.Ellipse".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
	...
	native private long OperatorAssign_CEllipse(long pNativeObject, long obj);
	public com.earthview.world.spatial.geometry.Ellipse OperatorAssign(com.earthview.world.spatial.geometry.Ellipse obj)
	{
		long objParamValue = obj.nativeObject.pointer;
		long returnValue = OperatorAssign_CEllipse(this.nativeObject.pointer, objParamValue);
		com.earthview.world.spatial.geometry.Ellipse __returnValue = new com.earthview.world.spatial.geometry.Ellipse(CreatedWhenConstruct.CWC_NotToCreate, "CEllipse");
		__returnValue.setDelegate(true);
		InstancePointer __instancePointer = new InstancePointer(returnValue);
		__returnValue.setInstancePointer(__instancePointer);
		IClassFactory __returnValueClassFactory = GlobalClassFactoryMap.get(__returnValue.getCppInstanceTypeName());
	...
	public Ellipse(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Ellipse(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Ellipse fromBaseObject(BaseObject baseObj)
	{
		...
		Ellipse obj = null;
 		if(baseObj instanceof Ellipse)
		{
			obj = (Ellipse)baseObj;
		} else {
			obj = new Ellipse(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CEllipse");
			obj.increaseCast();
		}
