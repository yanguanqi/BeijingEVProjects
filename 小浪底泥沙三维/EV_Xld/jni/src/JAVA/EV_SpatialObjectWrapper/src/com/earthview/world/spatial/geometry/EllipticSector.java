 ...
 * 椭圆扇形面
 */
public class EllipticSector extends com.earthview.world.spatial.geometry.Polygon {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Geometry::CEllipticSector", new EllipticSectorClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Geometry::JCEllipticSectorProxy", new EllipticSectorClassFactory());
	}
	 ...
	 * @param  
	 */
	public EllipticSector() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCEllipticSectorProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.geometry.EllipticSector".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
		}
	}

	native private void setEllipticSectorRing_CEllipticSectorRing(long pNativeObject, long ring);
	/**
	 * 设置椭圆扇形环
	 * @param ring 椭圆扇形环
	 */
	public void setEllipticSectorRing(com.earthview.world.spatial.geometry.EllipticSectorRing ring)
	{
		long ringParamValue = ring.nativeObject.pointer;
		setEllipticSectorRing_CEllipticSectorRing(this.nativeObject.pointer, ringParamValue);
	}
	native private long getSectorRingRef_void(long pNativeObject);
	/**
	 * 获取椭圆扇形环
	 * @param  
	 * @return 椭圆扇形环
	 */
	public com.earthview.world.spatial.geometry.EllipticSectorRing getSectorRingRef()
	{
		long returnValue = getSectorRingRef_void(this.nativeObject.pointer);
		if(returnValue == 0L) {
			return null;
		}
		com.earthview.world.spatial.geometry.EllipticSectorRing __returnValue = new com.earthview.world.spatial.geometry.EllipticSectorRing(CreatedWhenConstruct.CWC_NotToCreate, "CEllipticSectorRing");
		...
		{
			__returnValue.setDelegate(true);
			__returnValue = (com.earthview.world.spatial.geometry.EllipticSectorRing)__returnValueClassFactory.create();
			__returnValue.setDelegate(true);
			__returnValue.bindNativeObject(__instancePointer, "CEllipticSectorRing");
		}
		return __returnValue;
	}
	native private long getSectorRing_void(long pNativeObject);
	public com.earthview.world.spatial.geometry.EllipticSectorRing getSectorRing()
	{
		long returnValue = getSectorRing_void(this.nativeObject.pointer);
		com.earthview.world.spatial.geometry.EllipticSectorRing __returnValue = new com.earthview.world.spatial.geometry.EllipticSectorRing(CreatedWhenConstruct.CWC_NotToCreate);
		InstancePointer __instancePointer = new InstancePointer(returnValue);
		__returnValue.bindNativeObject(__instancePointer, "CEllipticSectorRing");
	...
	public com.earthview.world.spatial.geometry.EllipticSector clone2()
	{
		long returnValue = clone2_void(this.nativeObject.pointer);
		com.earthview.world.spatial.geometry.EllipticSector __returnValue = new com.earthview.world.spatial.geometry.EllipticSector(CreatedWhenConstruct.CWC_NotToCreate);
		InstancePointer __instancePointer = new InstancePointer(returnValue);
		__returnValue.bindNativeObject(__instancePointer, "CEllipticSector");
		__returnValue.createNativeObjectPointer(__instancePointer);
		IClassFactory __returnValueClassFactory = GlobalClassFactoryMap.get(__returnValue.getCppInstanceTypeName());
		if (__returnValueClassFactory != null)
		{
			__returnValue.setDelegate(true);
			__returnValue = (com.earthview.world.spatial.geometry.EllipticSector)__returnValueClassFactory.create();
			__returnValue.bindNativeObject(__instancePointer, "CEllipticSector");
		}
		return __returnValue;
	}
	public EllipticSector(com.earthview.world.spatial.geometry.EllipticSector obj) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer objPtr = new BasePointer(obj);
		list.add("obj", objPtr.get());
		Create("JCEllipticSectorProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.geometry.EllipticSector".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
	...
	native private long OperatorAssign_CEllipticSector(long pNativeObject, long obj);
	public com.earthview.world.spatial.geometry.EllipticSector OperatorAssign(com.earthview.world.spatial.geometry.EllipticSector obj)
	{
		long objParamValue = obj.nativeObject.pointer;
		long returnValue = OperatorAssign_CEllipticSector(this.nativeObject.pointer, objParamValue);
		com.earthview.world.spatial.geometry.EllipticSector __returnValue = new com.earthview.world.spatial.geometry.EllipticSector(CreatedWhenConstruct.CWC_NotToCreate, "CEllipticSector");
		__returnValue.setDelegate(true);
		InstancePointer __instancePointer = new InstancePointer(returnValue);
		__returnValue.setInstancePointer(__instancePointer);
		IClassFactory __returnValueClassFactory = GlobalClassFactoryMap.get(__returnValue.getCppInstanceTypeName());
	...
	public EllipticSector(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public EllipticSector(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static EllipticSector fromBaseObject(BaseObject baseObj)
	{
		...
		EllipticSector obj = null;
 		if(baseObj instanceof EllipticSector)
		{
			obj = (EllipticSector)baseObj;
		} else {
