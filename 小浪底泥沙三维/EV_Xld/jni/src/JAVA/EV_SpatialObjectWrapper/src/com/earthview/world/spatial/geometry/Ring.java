...
/**
 * 圆环类有一个圆周组成，圆周上每个点的截面都是一个小圆
 */
public class Ring extends com.earthview.world.spatial.geometry.RevolvingVolume {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Geometry::CRing", new RingClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Geometry::JCRingProxy", new RingClassFactory());
	}
	...
	public Ring() {
		...
		Create("JCRingProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.geometry.Ring".equals(this.getClass().getName()))
		{
	...
	/**
	 * 构造函数
	 * @param centerPoint 环心
	 * @param thickness 圆环粗细
	 * @param radius 半径
	 */
	public Ring(com.earthview.world.spatial.geometry.Coordinate centerPoint, double thickness, double radius) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer centerPointPtr = new BasePointer(centerPoint);
		list.add("centerPoint", centerPointPtr.get());
		BasePointer thicknessPtr = new BasePointer(thickness);
		list.add("thickness", thicknessPtr.get());
		BasePointer radiusPtr = new BasePointer(radius);
		list.add("radius", radiusPtr.get());
		Create("JCRingProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.geometry.Ring".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
	...
	native private void setThickness_ev_real64(long pNativeObject, double thick);
	/**
	 * 设置圆环的粗细
	 * @param thick 圆环的粗细
	 */
	...
	{
		double thickParamValue = thick;
		setThickness_ev_real64(this.nativeObject.pointer, thickParamValue);
	}
	...
	public Ring(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Ring(CreatedWhenConstruct cwc, String classNameStr) {
