 ...
 * 两个顶点的线段类
 */
public class Line extends com.earthview.world.spatial.geometry.LineString {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Geometry::CLine", new LineClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Geometry::JCLineProxy", new LineClassFactory());
	}
	...
	public Line() {
		...
		Create("JCLineProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.geometry.Line".equals(this.getClass().getName()))
		{
	 ...
	 * @param second 尾坐标点
	 */
	public Line(com.earthview.world.spatial.geometry.Coordinate firstCoord, com.earthview.world.spatial.geometry.Coordinate secondCoord) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer firstCoordPtr = new BasePointer(firstCoord);
		list.add("firstCoord", firstCoordPtr.get());
		BasePointer secondCoordPtr = new BasePointer(secondCoord);
		list.add("secondCoord", secondCoordPtr.get());
		Create("JCLineProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.geometry.Line".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
	 ...
	 * @param second 尾几何点
	 */
	public Line(com.earthview.world.spatial.geometry.Point firstPoint, com.earthview.world.spatial.geometry.Point secondPoint) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer firstPointPtr = new BasePointer(firstPoint);
		list.add("firstPoint", firstPointPtr.get());
		BasePointer secondPointPtr = new BasePointer(secondPoint);
		list.add("secondPoint", secondPointPtr.get());
		Create("JCLineProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.geometry.Line".equals(this.getClass().getName()))
		{
	...
	public com.earthview.world.spatial.geometry.Line clone2()
	{
		long returnValue = clone2_void(this.nativeObject.pointer);
		com.earthview.world.spatial.geometry.Line __returnValue = new com.earthview.world.spatial.geometry.Line(CreatedWhenConstruct.CWC_NotToCreate);
		InstancePointer __instancePointer = new InstancePointer(returnValue);
		__returnValue.bindNativeObject(__instancePointer, "CLine");
		__returnValue.createNativeObjectPointer(__instancePointer);
		IClassFactory __returnValueClassFactory = GlobalClassFactoryMap.get(__returnValue.getCppInstanceTypeName());
		if (__returnValueClassFactory != null)
		{
			__returnValue.setDelegate(true);
			__returnValue = (com.earthview.world.spatial.geometry.Line)__returnValueClassFactory.create();
			__returnValue.bindNativeObject(__instancePointer, "CLine");
		}
		return __returnValue;
	}
	...
	native private long add_CCoordinate_ev_uint32_ev_int32(long pNativeObject, long cpy_coords, long count, int index);
	/**
	 * 添加坐标点列表到指定索引处
	 * @param coords 指定坐标点列表
	 * @param count 坐标点数目
	 * @param index 插入索引位置
	 */
	public long add(com.earthview.world.spatial.geometry.Coordinate cpy_coords, long count, int index)
	{
		long cpy_coordsParamValue = (cpy_coords == null ? 0L : cpy_coords.nativeObject.pointer);
		long countParamValue = count;
		int indexParamValue = index;
		long returnValue = add_CCoordinate_ev_uint32_ev_int32(this.nativeObject.pointer, cpy_coordsParamValue, countParamValue, indexParamValue);
		return returnValue;
	}
	native private long add_CCoordinate_ev_uint32_ev_int32_NoVirtual(long pNativeObject, long cpy_coords, long count, int index);
	protected long add_NoVirtual(com.earthview.world.spatial.geometry.Coordinate cpy_coords, long count, int index)
	{
		long cpy_coordsParamValue = (cpy_coords == null ? 0L : cpy_coords.nativeObject.pointer);
		long countParamValue = count;
		int indexParamValue = index;
		long returnValue = add_CCoordinate_ev_uint32_ev_int32_NoVirtual(this.nativeObject.pointer, cpy_coordsParamValue, countParamValue, indexParamValue);
		return returnValue;
	}

	native private long add_CPoint_ev_uint32_ev_int32(long pNativeObject, long cpy_points, long count, int index);
	/**
	 * 添加几何点列表到指定索引处
	 * @param coords 指定几何点列表
	 * @param count 几何点数目
	 * @param index 插入索引位置
	 */
	public long add(com.earthview.world.spatial.geometry.Point cpy_points, long count, int index)
	{
		long cpy_pointsParamValue = (cpy_points == null ? 0L : cpy_points.nativeObject.pointer);
		long countParamValue = count;
		int indexParamValue = index;
		long returnValue = add_CPoint_ev_uint32_ev_int32(this.nativeObject.pointer, cpy_pointsParamValue, countParamValue, indexParamValue);
		return returnValue;
	}
	native private long add_CPoint_ev_uint32_ev_int32_NoVirtual(long pNativeObject, long cpy_points, long count, int index);
	protected long add_NoVirtual(com.earthview.world.spatial.geometry.Point cpy_points, long count, int index)
	{
		long cpy_pointsParamValue = (cpy_points == null ? 0L : cpy_points.nativeObject.pointer);
		long countParamValue = count;
		int indexParamValue = index;
		long returnValue = add_CPoint_ev_uint32_ev_int32_NoVirtual(this.nativeObject.pointer, cpy_pointsParamValue, countParamValue, indexParamValue);
		return returnValue;
	}

	protected  long add_CCoordinateSequence_ev_uint32_ev_int32_ev_int32_callback(long coords, long index, int count, int insertIndex)
	{
		...
		int insertIndexParamValue = insertIndex;
		long returnValue = add(coordsParamValue, indexParamValue, countParamValue, insertIndexParamValue);
		long __returnValue = returnValue;
		return __returnValue;
	}

	native private long add_CCoordinateSequence_ev_uint32_ev_int32_ev_int32(long pNativeObject, long coords, long index, int count, int insertIndex);
	/**
	 * 添加坐标序列到指定索引处
	 * @param coords 指定坐标序列
	 * @param index 插入索引位置
	 */
	public long add(com.earthview.world.spatial.geometry.CoordinateSequence coords, long index, int count, int insertIndex)
	{
		long coordsParamValue = coords.nativeObject.pointer;
		long indexParamValue = index;
		int countParamValue = count;
		int insertIndexParamValue = insertIndex;
		long returnValue = add_CCoordinateSequence_ev_uint32_ev_int32_ev_int32(this.nativeObject.pointer, coordsParamValue, indexParamValue, countParamValue, insertIndexParamValue);
		return returnValue;
	}
	native private long add_CCoordinateSequence_ev_uint32_ev_int32_ev_int32_NoVirtual(long pNativeObject, long coords, long index, int count, int insertIndex);
	protected long add_NoVirtual(com.earthview.world.spatial.geometry.CoordinateSequence coords, long index, int count, int insertIndex)
	{
		long coordsParamValue = coords.nativeObject.pointer;
		long indexParamValue = index;
		int countParamValue = count;
		int insertIndexParamValue = insertIndex;
		long returnValue = add_CCoordinateSequence_ev_uint32_ev_int32_ev_int32_NoVirtual(this.nativeObject.pointer, coordsParamValue, indexParamValue, countParamValue, insertIndexParamValue);
		return returnValue;
	}
	...
	protected  void setStartPoint_CPoint_callback(long point)
	{
		...
		setStartPoint(pointParamValue);
	}

	native private void setStartPoint_CPoint(long pNativeObject, long point);
	/**
	 * 设置起点
	 * @param point 起点
	 */
	public void setStartPoint(com.earthview.world.spatial.geometry.Point point)
	{
		long pointParamValue = point.nativeObject.pointer;
		setStartPoint_CPoint(this.nativeObject.pointer, pointParamValue);
	}
	native private void setStartPoint_CPoint_NoVirtual(long pNativeObject, long point);
	protected void setStartPoint_NoVirtual(com.earthview.world.spatial.geometry.Point point)
	{
		long pointParamValue = point.nativeObject.pointer;
		setStartPoint_CPoint_NoVirtual(this.nativeObject.pointer, pointParamValue);
	}

	protected  void setStartPoint_CCoordinate_callback(long coord)
	{
		...
		setStartPoint(coordParamValue);
	}

	native private void setStartPoint_CCoordinate(long pNativeObject, long coord);
	/**
	 * 设置起点坐标
	 * @param coord 起点坐标
	 */
	public void setStartPoint(com.earthview.world.spatial.geometry.Coordinate coord)
	{
		long coordParamValue = coord.nativeObject.pointer;
		setStartPoint_CCoordinate(this.nativeObject.pointer, coordParamValue);
	}
	native private void setStartPoint_CCoordinate_NoVirtual(long pNativeObject, long coord);
	protected void setStartPoint_NoVirtual(com.earthview.world.spatial.geometry.Coordinate coord)
	{
		long coordParamValue = coord.nativeObject.pointer;
		setStartPoint_CCoordinate_NoVirtual(this.nativeObject.pointer, coordParamValue);
	}

	protected  void setEndPoint_CPoint_callback(long point)
	{
		com.earthview.world.spatial.geometry.Point pointParamValue = new com.earthview.world.spatial.geometry.Point(CreatedWhenConstruct.CWC_NotToCreate);
		pointParamValue.setDelegate(true);
		pointParamValue.setInstancePointer(new InstancePointer(point));
		...
		setEndPoint(pointParamValue);
	}

	native private void setEndPoint_CPoint(long pNativeObject, long point);
	/**
	 * 设置终点
	 * @param point 终点
	 */
	public void setEndPoint(com.earthview.world.spatial.geometry.Point point)
	{
		long pointParamValue = point.nativeObject.pointer;
		setEndPoint_CPoint(this.nativeObject.pointer, pointParamValue);
	}
	native private void setEndPoint_CPoint_NoVirtual(long pNativeObject, long point);
	protected void setEndPoint_NoVirtual(com.earthview.world.spatial.geometry.Point point)
	{
		long pointParamValue = point.nativeObject.pointer;
		setEndPoint_CPoint_NoVirtual(this.nativeObject.pointer, pointParamValue);
	}

	protected  void setEndPoint_CCoordinate_callback(long coord)
	{
		com.earthview.world.spatial.geometry.Coordinate coordParamValue = new com.earthview.world.spatial.geometry.Coordinate(CreatedWhenConstruct.CWC_NotToCreate);
		coordParamValue.setDelegate(true);
		coordParamValue.setInstancePointer(new InstancePointer(coord));
		...
		setEndPoint(coordParamValue);
	}

	native private void setEndPoint_CCoordinate(long pNativeObject, long coord);
	/**
	 * 设置终点坐标
	 * @param coord 终点坐标
	 */
	public void setEndPoint(com.earthview.world.spatial.geometry.Coordinate coord)
	{
		long coordParamValue = coord.nativeObject.pointer;
		setEndPoint_CCoordinate(this.nativeObject.pointer, coordParamValue);
	}
	native private void setEndPoint_CCoordinate_NoVirtual(long pNativeObject, long coord);
	protected void setEndPoint_NoVirtual(com.earthview.world.spatial.geometry.Coordinate coord)
	{
		long coordParamValue = coord.nativeObject.pointer;
		setEndPoint_CCoordinate_NoVirtual(this.nativeObject.pointer, coordParamValue);
	}

	public Line(com.earthview.world.spatial.geometry.Line obj) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
	...
	native private long OperatorAssign_CLine(long pNativeObject, long obj);
	public com.earthview.world.spatial.geometry.Line OperatorAssign(com.earthview.world.spatial.geometry.Line obj)
	{
		long objParamValue = obj.nativeObject.pointer;
		long returnValue = OperatorAssign_CLine(this.nativeObject.pointer, objParamValue);
		com.earthview.world.spatial.geometry.Line __returnValue = new com.earthview.world.spatial.geometry.Line(CreatedWhenConstruct.CWC_NotToCreate, "CLine");
		__returnValue.setDelegate(true);
		InstancePointer __instancePointer = new InstancePointer(returnValue);
		__returnValue.setInstancePointer(__instancePointer);
		IClassFactory __returnValueClassFactory = GlobalClassFactoryMap.get(__returnValue.getCppInstanceTypeName());
	...
	public Line(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Line(CreatedWhenConstruct cwc, String classNameStr) {
	...
	{
		return super.queryPoint_NoVirtual(point, tolerance);
	}
	public int queryPoint(com.earthview.world.spatial.geometry.Coordinate coord, double tolerance)
	{
		return super.queryPoint_NoVirtual(coord, tolerance);
	}
	...
	native protected void register_add_CCoordinateSequence_ev_uint32_ev_int32_ev_int32(long pNativeObject, String method);
	native protected void register_setStartPoint_CPoint(long pNativeObject, String method);
	native protected void register_setStartPoint_CCoordinate(long pNativeObject, String method);
	native protected void register_setEndPoint_CPoint(long pNativeObject, String method);
	native protected void register_setEndPoint_CCoordinate(long pNativeObject, String method);
	...
	public void registerCallback(){
		if (!this.nativeObject.equals(InstancePointer.ZERO)){
			this.register_add_CCoordinateSequence_ev_uint32_ev_int32_ev_int32(this.nativeObject.pointer, "add_CCoordinateSequence_ev_uint32_ev_int32_ev_int32_callback");
			this.register_setStartPoint_CPoint(this.nativeObject.pointer, "setStartPoint_CPoint_callback");
			this.register_setStartPoint_CCoordinate(this.nativeObject.pointer, "setStartPoint_CCoordinate_callback");
			this.register_setEndPoint_CPoint(this.nativeObject.pointer, "setEndPoint_CPoint_callback");
			this.register_setEndPoint_CCoordinate(this.nativeObject.pointer, "setEndPoint_CCoordinate_callback");
