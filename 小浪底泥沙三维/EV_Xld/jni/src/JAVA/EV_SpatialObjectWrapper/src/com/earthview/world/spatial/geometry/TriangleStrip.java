 ...
 * 三角带类
 */
public class TriangleStrip extends com.earthview.world.spatial.geometry.Surface {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Geometry::CTriangleStrip", new TriangleStripClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Geometry::JCTriangleStripProxy", new TriangleStripClassFactory());
	}
	...
	public TriangleStrip() {
		...
		Create("JCTriangleStripProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.geometry.TriangleStrip".equals(this.getClass().getName()))
		{
	...
	public TriangleStrip(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public TriangleStrip(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static TriangleStrip fromBaseObject(BaseObject baseObj)
	{
		...
		TriangleStrip obj = null;
 		if(baseObj instanceof TriangleStrip)
		{
			obj = (TriangleStrip)baseObj;
		} else {
