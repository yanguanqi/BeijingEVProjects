 ...
 */
public class CircleChord extends com.earthview.world.spatial.geometry.Polygon {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Geometry::CCircleChord", new CircleChordClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Geometry::JCCircleChordProxy", new CircleChordClassFactory());
	}
	...
	public CircleChord() {
		...
		Create("JCCircleChordProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.geometry.CircleChord".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
		}
	}

	native private void setCircleChordRing_CCircleChordRing(long pNativeObject, long ring);
	/**
	 * 设置圆弦面的圆弦环
	 * @param ring 圆弦环
	 */
	public void setCircleChordRing(com.earthview.world.spatial.geometry.CircleChordRing ring)
	{
		long ringParamValue = ring.nativeObject.pointer;
		setCircleChordRing_CCircleChordRing(this.nativeObject.pointer, ringParamValue);
	}
	native private long getCircleChordRingRef_void(long pNativeObject);
	/**
	 * 获取圆弦环
	 * @param  
	 * @return 圆弦环
	 */
	public com.earthview.world.spatial.geometry.CircleChordRing getCircleChordRingRef()
	{
		long returnValue = getCircleChordRingRef_void(this.nativeObject.pointer);
		if(returnValue == 0L) {
			return null;
		}
		com.earthview.world.spatial.geometry.CircleChordRing __returnValue = new com.earthview.world.spatial.geometry.CircleChordRing(CreatedWhenConstruct.CWC_NotToCreate, "CCircleChordRing");
		...
		{
			__returnValue.setDelegate(true);
			__returnValue = (com.earthview.world.spatial.geometry.CircleChordRing)__returnValueClassFactory.create();
			__returnValue.setDelegate(true);
			__returnValue.bindNativeObject(__instancePointer, "CCircleChordRing");
		}
		return __returnValue;
	}
	native private long getCircleChordRing_void(long pNativeObject);
	/**
	 * 获取圆弦环
	 * @param  
	 * @return 圆弦环
	 */
	public com.earthview.world.spatial.geometry.CircleChordRing getCircleChordRing()
	{
		long returnValue = getCircleChordRing_void(this.nativeObject.pointer);
		com.earthview.world.spatial.geometry.CircleChordRing __returnValue = new com.earthview.world.spatial.geometry.CircleChordRing(CreatedWhenConstruct.CWC_NotToCreate);
		InstancePointer __instancePointer = new InstancePointer(returnValue);
		__returnValue.bindNativeObject(__instancePointer, "CCircleChordRing");
	...
	native private void setCircleChord_CPoint_CPoint_CPoint(long pNativeObject, long firstPoint, long secondPoint, long thirdPoint);
	/**
	 * 设置圆弧
	 * @param fromPoint 起始点
	 * @param secondPoint 结束点
	 * @param thirdPoint 控制点
	 */
	public void setCircleChord(com.earthview.world.spatial.geometry.Point firstPoint, com.earthview.world.spatial.geometry.Point secondPoint, com.earthview.world.spatial.geometry.Point thirdPoint)
	{
		...
		setCircleChord_CPoint_CPoint_CPoint(this.nativeObject.pointer, firstPointParamValue, secondPointParamValue, thirdPointParamValue);
	}
	native private void setCircleChord_CPoint_ev_real64_ev_real64_ev_real64(long pNativeObject, long centerPoint, double radius, double fromAngle, double sweepAngle);
	/**
	 * 设置圆弧
	 ...
	 */
	public void setCircleChord(com.earthview.world.spatial.geometry.Point centerPoint, double radius, double fromAngle, double sweepAngle)
	{
		...
		setCircleChord_CPoint_ev_real64_ev_real64_ev_real64(this.nativeObject.pointer, centerPointParamValue, radiusParamValue, fromAngleParamValue, sweepAngleParamValue);
	}
	native private void setCircleChord_CPoint_CPoint_ev_real64(long pNativeObject, long centerPoint, long fromPoint, double sweepAngle);
	/**
	 * 设置圆弧
	 * @param centerPoint 中心点
	 * @param fromPoint 起始点
	 * @param sweepAngle 圆心角
	 */
	public void setCircleChord(com.earthview.world.spatial.geometry.Point centerPoint, com.earthview.world.spatial.geometry.Point fromPoint, double sweepAngle)
	{
		long centerPointParamValue = centerPoint.nativeObject.pointer;
		long fromPointParamValue = fromPoint.nativeObject.pointer;
		double sweepAngleParamValue = sweepAngle;
		setCircleChord_CPoint_CPoint_ev_real64(this.nativeObject.pointer, centerPointParamValue, fromPointParamValue, sweepAngleParamValue);
	}
	...
	public com.earthview.world.spatial.geometry.CircleChord clone2()
	{
		long returnValue = clone2_void(this.nativeObject.pointer);
		com.earthview.world.spatial.geometry.CircleChord __returnValue = new com.earthview.world.spatial.geometry.CircleChord(CreatedWhenConstruct.CWC_NotToCreate);
		InstancePointer __instancePointer = new InstancePointer(returnValue);
		__returnValue.bindNativeObject(__instancePointer, "CCircleChord");
		__returnValue.createNativeObjectPointer(__instancePointer);
		IClassFactory __returnValueClassFactory = GlobalClassFactoryMap.get(__returnValue.getCppInstanceTypeName());
		if (__returnValueClassFactory != null)
		{
			__returnValue.setDelegate(true);
			__returnValue = (com.earthview.world.spatial.geometry.CircleChord)__returnValueClassFactory.create();
			__returnValue.bindNativeObject(__instancePointer, "CCircleChord");
		}
		return __returnValue;
	}
	public CircleChord(com.earthview.world.spatial.geometry.CircleChord obj) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer objPtr = new BasePointer(obj);
		list.add("obj", objPtr.get());
		Create("JCCircleChordProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.geometry.CircleChord".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
	...
	native private long OperatorAssign_CCircleChord(long pNativeObject, long obj);
	public com.earthview.world.spatial.geometry.CircleChord OperatorAssign(com.earthview.world.spatial.geometry.CircleChord obj)
	{
		long objParamValue = obj.nativeObject.pointer;
		long returnValue = OperatorAssign_CCircleChord(this.nativeObject.pointer, objParamValue);
		com.earthview.world.spatial.geometry.CircleChord __returnValue = new com.earthview.world.spatial.geometry.CircleChord(CreatedWhenConstruct.CWC_NotToCreate, "CCircleChord");
		__returnValue.setDelegate(true);
		InstancePointer __instancePointer = new InstancePointer(returnValue);
		__returnValue.setInstancePointer(__instancePointer);
		IClassFactory __returnValueClassFactory = GlobalClassFactoryMap.get(__returnValue.getCppInstanceTypeName());
	...
	public CircleChord(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CircleChord(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CircleChord fromBaseObject(BaseObject baseObj)
	{
		...
		CircleChord obj = null;
 		if(baseObj instanceof CircleChord)
		{
			obj = (CircleChord)baseObj;
		} else {
