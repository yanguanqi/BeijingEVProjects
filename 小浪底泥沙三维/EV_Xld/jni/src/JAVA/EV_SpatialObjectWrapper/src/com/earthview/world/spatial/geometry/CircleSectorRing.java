 ...
 */
public class CircleSectorRing extends com.earthview.world.spatial.geometry.CircleArcRing {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Geometry::CCircleSectorRing", new CircleSectorRingClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Geometry::JCCircleSectorRingProxy", new CircleSectorRingClassFactory());
	}
	 ...
	 * @param  
	 */
	public CircleSectorRing() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCircleSectorRingProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.geometry.CircleSectorRing".equals(this.getClass().getName()))
		{
	...
	public com.earthview.world.spatial.geometry.CircleSectorRing clone2()
	{
	...
	public CircleSectorRing(com.earthview.world.spatial.geometry.CircleSectorRing obj) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer objPtr = new BasePointer(obj);
		list.add("obj", objPtr.get());
		Create("JCCircleSectorRingProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.geometry.CircleSectorRing".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
	...
	native private long OperatorAssign_CCircleSectorRing(long pNativeObject, long obj);
	public com.earthview.world.spatial.geometry.CircleSectorRing OperatorAssign(com.earthview.world.spatial.geometry.CircleSectorRing obj)
	{
		long objParamValue = obj.nativeObject.pointer;
		long returnValue = OperatorAssign_CCircleSectorRing(this.nativeObject.pointer, objParamValue);
	...
	public CircleSectorRing(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CircleSectorRing(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CircleSectorRing fromBaseObject(BaseObject baseObj)
	{
		...
		CircleSectorRing obj = null;
 		if(baseObj instanceof CircleSectorRing)
		{
			obj = (CircleSectorRing)baseObj;
		} else {
