 ...
 */
public class CurveRing extends com.earthview.world.spatial.geometry.CurvePath {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Geometry::CCurveRing", new CurveRingClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Geometry::JCCurveRingProxy", new CurveRingClassFactory());
	}
	...
	public CurveRing() {
		...
		Create("JCCurveRingProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.geometry.CurveRing".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
		}
	}

	public CurveRing(com.earthview.world.spatial.geometry.CoordinateSequence coords) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer coordsPtr = new BasePointer(coords);
		list.add("coords", coordsPtr.get());
		Create("JCCurveRingProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.geometry.CurveRing".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
	...
	protected  double getArea_void_callback()
	{
		double returnValue = getArea();
	...
	public com.earthview.world.spatial.geometry.CurveRing clone2()
	{
		long returnValue = clone2_void(this.nativeObject.pointer);
		com.earthview.world.spatial.geometry.CurveRing __returnValue = new com.earthview.world.spatial.geometry.CurveRing(CreatedWhenConstruct.CWC_NotToCreate);
	...
	native private long clip_IGeometry(long pNativeObject, long pClipLine);
	/**
	 * 裁剪
	 * @param pClipLine 裁剪线
	 * @return 裁剪后得到的对象
	 */
	public com.earthview.world.spatial.geometry.Igeometry clip(com.earthview.world.spatial.geometry.Igeometry pClipLine)
	{
		long pClipLineParamValue = (pClipLine == null ? 0L : pClipLine.nativeObject.pointer);
		long returnValue = clip_IGeometry(this.nativeObject.pointer, pClipLineParamValue);
		if(returnValue == 0L) {
			return null;
		}
		com.earthview.world.spatial.geometry.Igeometry __returnValue = new com.earthview.world.spatial.geometry.Igeometry(CreatedWhenConstruct.CWC_NotToCreate, "IGeometry");
	...
	native private long clip_IGeometry_NoVirtual(long pNativeObject, long pClipLine);
	protected com.earthview.world.spatial.geometry.Igeometry clip_NoVirtual(com.earthview.world.spatial.geometry.Igeometry pClipLine)
	{
		long pClipLineParamValue = (pClipLine == null ? 0L : pClipLine.nativeObject.pointer);
		long returnValue = clip_IGeometry_NoVirtual(this.nativeObject.pointer, pClipLineParamValue);
		if(returnValue == 0L) {
			return null;
		}
		com.earthview.world.spatial.geometry.Igeometry __returnValue = new com.earthview.world.spatial.geometry.Igeometry(CreatedWhenConstruct.CWC_NotToCreate, "IGeometry");
	...
	public CurveRing(com.earthview.world.spatial.geometry.CurveRing obj) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
	...
	native private long OperatorAssign_CCurveRing(long pNativeObject, long obj);
	public com.earthview.world.spatial.geometry.CurveRing OperatorAssign(com.earthview.world.spatial.geometry.CurveRing obj)
	{
		long objParamValue = obj.nativeObject.pointer;
		long returnValue = OperatorAssign_CCurveRing(this.nativeObject.pointer, objParamValue);
	...
	public CurveRing(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CurveRing(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CurveRing fromBaseObject(BaseObject baseObj)
	{
		...
		CurveRing obj = null;
 		if(baseObj instanceof CurveRing)
		{
			obj = (CurveRing)baseObj;
		} else {
