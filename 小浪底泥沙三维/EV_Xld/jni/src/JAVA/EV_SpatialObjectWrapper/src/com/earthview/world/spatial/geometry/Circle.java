...
/**
 * 圆类，描述一个圆面。圆面由一个中心点以及半径组成。
 */
public class Circle extends com.earthview.world.spatial.geometry.Polygon {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Geometry::CCircle", new CircleClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Geometry::JCCircleProxy", new CircleClassFactory());
	}
	...
	public Circle() {
		...
		Create("JCCircleProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.geometry.Circle".equals(this.getClass().getName()))
		{
	 ...
	 * @param radius 半径
	 */
	public Circle(com.earthview.world.spatial.geometry.Point centerPoint, double radius) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		...
		Create("JCCircleProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.geometry.Circle".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
	...
	native private void setCircleRing_CCircleRing(long pNativeObject, long ring);
	/**
	 * 设置圆面的圆环
	 * @param ring 圆环
	 */
	public void setCircleRing(com.earthview.world.spatial.geometry.CircleRing ring)
	{
		long ringParamValue = ring.nativeObject.pointer;
		setCircleRing_CCircleRing(this.nativeObject.pointer, ringParamValue);
	}
	native private long getCircleRingRef_void(long pNativeObject);
	/**
	 * 获取圆环
	 * @return 圆环
	 */
	public com.earthview.world.spatial.geometry.CircleRing getCircleRingRef()
	{
		long returnValue = getCircleRingRef_void(this.nativeObject.pointer);
		if(returnValue == 0L) {
			return null;
		}
	...
	native private long getCircleRing_void(long pNativeObject);
	public com.earthview.world.spatial.geometry.CircleRing getCircleRing()
	{
		long returnValue = getCircleRing_void(this.nativeObject.pointer);
	...
	native private void setCircle_CPoint_ev_real64(long pNativeObject, long cPoint, double radius);
	/**
	 * 设置圆面
	 * @param cPoint 圆心点
	 * @param radius 半径
	 */
	public void setCircle(com.earthview.world.spatial.geometry.Point cPoint, double radius)
	{
		long cPointParamValue = cPoint.nativeObject.pointer;
		double radiusParamValue = radius;
		setCircle_CPoint_ev_real64(this.nativeObject.pointer, cPointParamValue, radiusParamValue);
	}
	native private void setCircle_CCoordinate_ev_real64(long pNativeObject, long ccoord, double radius);
	/**
	 * 设置圆面
	 * @param centerCoordinate 圆心坐标
	 * @param assistantCoordinate 半径
	 */
	public void setCircle(com.earthview.world.spatial.geometry.Coordinate ccoord, double radius)
	{
		long ccoordParamValue = ccoord.nativeObject.pointer;
		double radiusParamValue = radius;
		setCircle_CCoordinate_ev_real64(this.nativeObject.pointer, ccoordParamValue, radiusParamValue);
	}
	...
	public com.earthview.world.spatial.geometry.Circle clone2()
	{
		long returnValue = clone2_void(this.nativeObject.pointer);
		com.earthview.world.spatial.geometry.Circle __returnValue = new com.earthview.world.spatial.geometry.Circle(CreatedWhenConstruct.CWC_NotToCreate);
		InstancePointer __instancePointer = new InstancePointer(returnValue);
	...
	public Circle(com.earthview.world.spatial.geometry.Circle obj) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
	...
	native private long OperatorAssign_CCircle(long pNativeObject, long obj);
	public com.earthview.world.spatial.geometry.Circle OperatorAssign(com.earthview.world.spatial.geometry.Circle obj)
	{
		long objParamValue = obj.nativeObject.pointer;
		long returnValue = OperatorAssign_CCircle(this.nativeObject.pointer, objParamValue);
	...
	public Circle(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Circle(CreatedWhenConstruct cwc, String classNameStr) {
