 ...
 */
public class CircleChordRing extends com.earthview.world.spatial.geometry.CircleArcRing {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Geometry::CCircleChordRing", new CircleChordRingClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Geometry::JCCircleChordRingProxy", new CircleChordRingClassFactory());
	}
	 ...
	 * @param  
	 */
	public CircleChordRing() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCircleChordRingProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.geometry.CircleChordRing".equals(this.getClass().getName()))
		{
	...
	public com.earthview.world.spatial.geometry.CircleChordRing clone2()
	{
	...
	public CircleChordRing(com.earthview.world.spatial.geometry.CircleChordRing obj) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer objPtr = new BasePointer(obj);
		list.add("obj", objPtr.get());
		Create("JCCircleChordRingProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.geometry.CircleChordRing".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
	...
	native private long OperatorAssign_CCircleChordRing(long pNativeObject, long obj);
	public com.earthview.world.spatial.geometry.CircleChordRing OperatorAssign(com.earthview.world.spatial.geometry.CircleChordRing obj)
	{
		long objParamValue = obj.nativeObject.pointer;
		long returnValue = OperatorAssign_CCircleChordRing(this.nativeObject.pointer, objParamValue);
	...
	public CircleChordRing(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CircleChordRing(CreatedWhenConstruct cwc, String classNameStr) {
	...
	{
		super.setCircleArcRingByThreePoint_NoVirtual(fromPoint, toPoint, controlPoint);
	}
	/**
	 * 设置圆弧环
	...
	{
		super.setCircleArcRingByRadius_NoVirtual(centerPoint, radius, fromAngle, sweepAngle);
	}
	/**
	 * 设置圆弧环
	 * @param centerPoint 中心点
	...
	{
		super.setCircleArcRingByTwoPoint_NoVirtual(centerPoint, edgePoint, sweepAngle);
	}
	/**
	 * 设置中心点
	 * @param point 中心点
	...
	public static CircleChordRing fromBaseObject(BaseObject baseObj)
	{
		...
		CircleChordRing obj = null;
 		if(baseObj instanceof CircleChordRing)
		{
			obj = (CircleChordRing)baseObj;
		} else {
