 ...
 * 椭圆环类，构成一个完整的椭圆
 */
public class EllipticRing extends com.earthview.world.spatial.geometry.EllipticArcRing {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Geometry::CEllipticRing", new EllipticRingClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Geometry::JCEllipticRingProxy", new EllipticRingClassFactory());
	}
	...
	public EllipticRing() {
		...
		Create("JCEllipticRingProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.geometry.EllipticRing".equals(this.getClass().getName()))
		{
	 ...
	 * @param fromAngle 椭圆环起始角度(无用参数，可以设为0）
	 * @param sweepAngle 椭圆环对椭圆中心张角（无用参数，默认为360，可以设为0）
	 */
	...
	public com.earthview.world.spatial.geometry.EllipticRing clone2()
	{
		long returnValue = clone2_void(this.nativeObject.pointer);
		com.earthview.world.spatial.geometry.EllipticRing __returnValue = new com.earthview.world.spatial.geometry.EllipticRing(CreatedWhenConstruct.CWC_NotToCreate);
		InstancePointer __instancePointer = new InstancePointer(returnValue);
	...
	public EllipticRing(com.earthview.world.spatial.geometry.EllipticRing obj) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer objPtr = new BasePointer(obj);
		list.add("obj", objPtr.get());
		Create("JCEllipticRingProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.geometry.EllipticRing".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
	...
	native private long OperatorAssign_CEllipticRing(long pNativeObject, long obj);
	public com.earthview.world.spatial.geometry.EllipticRing OperatorAssign(com.earthview.world.spatial.geometry.EllipticRing obj)
	{
		long objParamValue = obj.nativeObject.pointer;
		long returnValue = OperatorAssign_CEllipticRing(this.nativeObject.pointer, objParamValue);
	...
	public EllipticRing(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public EllipticRing(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static EllipticRing fromBaseObject(BaseObject baseObj)
	{
		...
		EllipticRing obj = null;
 		if(baseObj instanceof EllipticRing)
		{
			obj = (EllipticRing)baseObj;
		} else {
