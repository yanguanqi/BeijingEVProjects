 ...
 */
public class Curve extends com.earthview.world.spatial.geometry.Geometry {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Geometry::CCurve", new CurveClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Geometry::JCCurveProxy", new CurveClassFactory());
	}

	protected  long getStartPoint_void_callback()
	{
		com.earthview.world.spatial.geometry.Point returnValue = getStartPoint();
		if(returnValue == null) {
			return 0L;
		}
	...
	protected  long getStartPoint2_void_callback()
	{
		com.earthview.world.spatial.geometry.Point returnValue = getStartPoint2();
		long __returnValue = returnValue.nativeObject.pointer;
		return __returnValue;
	}
	...
	protected  long getEndPoint_void_callback()
	{
		com.earthview.world.spatial.geometry.Point returnValue = getEndPoint();
		if(returnValue == null) {
			return 0L;
		}
		returnValue.setDelegate(true);
	...
	protected  long getEndPoint2_void_callback()
	{
		com.earthview.world.spatial.geometry.Point returnValue = getEndPoint2();
		long __returnValue = returnValue.nativeObject.pointer;
		return __returnValue;
	}
	...
	protected  double getLength_void_callback()
	{
		double returnValue = getLength();
	...
	protected  boolean isRing_void_callback()
	{
		boolean returnValue = isRing();
		boolean __returnValue = returnValue;
		return __returnValue;
	}
	...
	protected  boolean reverse_void_callback()
	{
		boolean returnValue = reverse();
		boolean __returnValue = returnValue;
		return __returnValue;
	}
	...
	protected  long toLineString_ev_uint32_callback(long smooth)
	{
		long smoothParamValue = smooth;
		com.earthview.world.spatial.geometry.LineString returnValue = toLineString(smoothParamValue);
		if(returnValue == null) {
			return 0L;
		}
		returnValue.setDelegate(true);
	...
	public Curve(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Curve(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Curve fromBaseObject(BaseObject baseObj)
	{
		...
		Curve obj = null;
 		if(baseObj instanceof Curve)
		{
			obj = (Curve)baseObj;
		} else {
			obj = new Curve(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CCurve");
			obj.increaseCast();
		}
