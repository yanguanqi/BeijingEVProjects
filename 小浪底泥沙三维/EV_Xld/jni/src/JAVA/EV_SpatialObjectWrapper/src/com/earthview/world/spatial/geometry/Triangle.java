 ...
 * 三角面类
 */
public class Triangle extends com.earthview.world.spatial.geometry.Polygon {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Geometry::CTriangle", new TriangleClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Geometry::JCTriangleProxy", new TriangleClassFactory());
	}
	...
	public Triangle() {
		...
		Create("JCTriangleProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.geometry.Triangle".equals(this.getClass().getName()))
		{
	...
	native private void setTriangleRing_CTriangleRing(long pNativeObject, long ring);
	/**
	 * 设置三角环
	 * @param ring 三角环
	 */
	public void setTriangleRing(com.earthview.world.spatial.geometry.TriangleRing ring)
	{
		long ringParamValue = ring.nativeObject.pointer;
		setTriangleRing_CTriangleRing(this.nativeObject.pointer, ringParamValue);
	}
	native private long getTriangleRingRef_void(long pNativeObject);
	/**
	 * 获取三角环
	 * @param  
	 * @return 三角环
	 */
	public com.earthview.world.spatial.geometry.TriangleRing getTriangleRingRef()
	{
		long returnValue = getTriangleRingRef_void(this.nativeObject.pointer);
		if(returnValue == 0L) {
			return null;
		}
	...
	native private long getTriangleRing_void(long pNativeObject);
	/**
	 * 获取三角环
	 * @param  
	 * @return 三角环
	 */
	public com.earthview.world.spatial.geometry.TriangleRing getTriangleRing()
	{
		long returnValue = getTriangleRing_void(this.nativeObject.pointer);
	...
	public com.earthview.world.spatial.geometry.Triangle clone2()
	{
		long returnValue = clone2_void(this.nativeObject.pointer);
		com.earthview.world.spatial.geometry.Triangle __returnValue = new com.earthview.world.spatial.geometry.Triangle(CreatedWhenConstruct.CWC_NotToCreate);
		InstancePointer __instancePointer = new InstancePointer(returnValue);
		...
		{
			__returnValue.setDelegate(true);
			__returnValue = (com.earthview.world.spatial.geometry.Triangle)__returnValueClassFactory.create();
			__returnValue.bindNativeObject(__instancePointer, "CTriangle");
		}
		return __returnValue;
	}
	public Triangle(com.earthview.world.spatial.geometry.Triangle obj) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer objPtr = new BasePointer(obj);
		list.add("obj", objPtr.get());
		Create("JCTriangleProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.geometry.Triangle".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
	...
	native private long OperatorAssign_CTriangle(long pNativeObject, long obj);
	public com.earthview.world.spatial.geometry.Triangle OperatorAssign(com.earthview.world.spatial.geometry.Triangle obj)
	{
		long objParamValue = obj.nativeObject.pointer;
		long returnValue = OperatorAssign_CTriangle(this.nativeObject.pointer, objParamValue);
		com.earthview.world.spatial.geometry.Triangle __returnValue = new com.earthview.world.spatial.geometry.Triangle(CreatedWhenConstruct.CWC_NotToCreate, "CTriangle");
		__returnValue.setDelegate(true);
		InstancePointer __instancePointer = new InstancePointer(returnValue);
		__returnValue.setInstancePointer(__instancePointer);
		IClassFactory __returnValueClassFactory = GlobalClassFactoryMap.get(__returnValue.getCppInstanceTypeName());
