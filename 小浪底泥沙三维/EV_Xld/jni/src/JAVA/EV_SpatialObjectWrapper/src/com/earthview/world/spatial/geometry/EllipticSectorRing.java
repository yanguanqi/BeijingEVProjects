 ...
 * 椭圆扇形环类
 */
public class EllipticSectorRing extends com.earthview.world.spatial.geometry.EllipticArcRing {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Geometry::CEllipticSectorRing", new EllipticSectorRingClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Geometry::JCEllipticSectorRingProxy", new EllipticSectorRingClassFactory());
	}
	 ...
	 * @param  
	 */
	public EllipticSectorRing() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCEllipticSectorRingProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.geometry.EllipticSectorRing".equals(this.getClass().getName()))
		{
	 ...
	 * @param assistantPoint1 第一个辅助点，是位于椭圆长轴上的任意一点（但不能与中心点重合）
	...
	public com.earthview.world.spatial.geometry.EllipticSectorRing clone2()
	{
	...
	public EllipticSectorRing(com.earthview.world.spatial.geometry.EllipticSectorRing obj) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer objPtr = new BasePointer(obj);
		list.add("obj", objPtr.get());
		Create("JCEllipticSectorRingProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.geometry.EllipticSectorRing".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
	...
	native private long OperatorAssign_CEllipticSectorRing(long pNativeObject, long obj);
	public com.earthview.world.spatial.geometry.EllipticSectorRing OperatorAssign(com.earthview.world.spatial.geometry.EllipticSectorRing obj)
	{
		long objParamValue = obj.nativeObject.pointer;
		long returnValue = OperatorAssign_CEllipticSectorRing(this.nativeObject.pointer, objParamValue);
	...
	public EllipticSectorRing(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public EllipticSectorRing(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static EllipticSectorRing fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		EllipticSectorRing obj = null;
 		if(baseObj instanceof EllipticSectorRing)
		{
			obj = (EllipticSectorRing)baseObj;
		} else {
			obj = new EllipticSectorRing(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CEllipticSectorRing");
			obj.increaseCast();
		}
