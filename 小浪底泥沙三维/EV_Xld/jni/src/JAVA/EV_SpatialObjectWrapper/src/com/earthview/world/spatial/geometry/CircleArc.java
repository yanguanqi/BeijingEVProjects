 ...
 */
public class CircleArc extends com.earthview.world.spatial.geometry.Curve {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Geometry::CCircleArc", new CircleArcClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Geometry::JCCircleArcProxy", new CircleArcClassFactory());
	}
	...
	public CircleArc() {
		...
		Create("JCCircleArcProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.geometry.CircleArc".equals(this.getClass().getName()))
		{
	 ...
	 * @param thirdPoint 控制弦高的点
	 */
	public CircleArc(com.earthview.world.spatial.geometry.Point firstPoint, com.earthview.world.spatial.geometry.Point secondPoint, com.earthview.world.spatial.geometry.Point thirdPoint) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		...
		BasePointer thirdPointPtr = new BasePointer(thirdPoint);
		list.add("thirdPoint", thirdPointPtr.get());
		Create("JCCircleArcProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.geometry.CircleArc".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
	 ...
	 */
	public CircleArc(com.earthview.world.spatial.geometry.Point centerPoint, double radius, double fromAngle, double sweepAngle) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
	 ...
	 * @param sweepAngle 圆心角
	 */
	public CircleArc(com.earthview.world.spatial.geometry.Point centerPoint, com.earthview.world.spatial.geometry.Point fromPoint, double sweepAngle) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer centerPointPtr = new BasePointer(centerPoint);
		list.add("centerPoint", centerPointPtr.get());
		BasePointer fromPointPtr = new BasePointer(fromPoint);
		list.add("fromPoint", fromPointPtr.get());
		BasePointer sweepAnglePtr = new BasePointer(sweepAngle);
		list.add("sweepAngle", sweepAnglePtr.get());
		Create("JCCircleArcProxy", list, true);
		this.registerCallback();
	...
	native private void setCircleArcByControlPoint_CPoint_CPoint_CPoint(long pNativeObject, long firstPoint, long secondPoint, long thirdPoint);
	/**
	 * 设置圆弧
	 * @param firstPoint 第一个点
	 * @param secondPoint 第二个点
	 * @param thirdPoint 第三个点（控制弦高）
	 */
	public void setCircleArcByControlPoint(com.earthview.world.spatial.geometry.Point firstPoint, com.earthview.world.spatial.geometry.Point secondPoint, com.earthview.world.spatial.geometry.Point thirdPoint)
	{
		...
		setCircleArcByControlPoint_CPoint_CPoint_CPoint(this.nativeObject.pointer, firstPointParamValue, secondPointParamValue, thirdPointParamValue);
	}
	native private void setCircleArcByControlPoint_CCoordinate_CCoordinate_CCoordinate(long pNativeObject, long firstCoord, long secondCoord, long thirdCoord);
	/**
	 * 设置圆弧
	 * @param firstCoord 第一个点坐标
	 * @param secondCoord 第二个点坐标
	 * @param thirdCoord 第三个点坐标
	 */
	public void setCircleArcByControlPoint(com.earthview.world.spatial.geometry.Coordinate firstCoord, com.earthview.world.spatial.geometry.Coordinate secondCoord, com.earthview.world.spatial.geometry.Coordinate thirdCoord)
	{
		long firstCoordParamValue = firstCoord.nativeObject.pointer;
		long secondCoordParamValue = secondCoord.nativeObject.pointer;
		long thirdCoordParamValue = thirdCoord.nativeObject.pointer;
		setCircleArcByControlPoint_CCoordinate_CCoordinate_CCoordinate(this.nativeObject.pointer, firstCoordParamValue, secondCoordParamValue, thirdCoordParamValue);
	}
	native private void setCircleArc_CPoint_ev_real64_ev_real64_ev_real64(long pNativeObject, long centerPoint, double radius, double fromAngle, double sweepAngle);
	/**
	 * 设置圆弧
	 * @param centerPoint 中心点
	 * @param radius 半径
	 ...
	 * @param sweepAngle 圆心角
	 */
	public void setCircleArc(com.earthview.world.spatial.geometry.Point centerPoint, double radius, double fromAngle, double sweepAngle)
	{
		...
		setCircleArc_CPoint_ev_real64_ev_real64_ev_real64(this.nativeObject.pointer, centerPointParamValue, radiusParamValue, fromAngleParamValue, sweepAngleParamValue);
	}
	native private void setCircleArc_CCoordinate_ev_real64_ev_real64_ev_real64(long pNativeObject, long centerCoord, double radius, double fromAngle, double sweepAngle);
	/**
	 * 设置圆弧
	 ...
	 * @param sweepAngle 圆心角
	 */
	public void setCircleArc(com.earthview.world.spatial.geometry.Coordinate centerCoord, double radius, double fromAngle, double sweepAngle)
	{
		long centerCoordParamValue = centerCoord.nativeObject.pointer;
		double radiusParamValue = radius;
		double fromAngleParamValue = fromAngle;
		double sweepAngleParamValue = sweepAngle;
		setCircleArc_CCoordinate_ev_real64_ev_real64_ev_real64(this.nativeObject.pointer, centerCoordParamValue, radiusParamValue, fromAngleParamValue, sweepAngleParamValue);
	}
	native private void setCircleArc_CPoint_CPoint_ev_real64(long pNativeObject, long centerPoint, long fromPoint, double sweepAngle);
	/**
	 * 设置圆弧
	 * @param centerPoint 中心点
	 * @param fromPoint 起始点
	 * @param sweepAngle 圆心角
	 */
	public void setCircleArc(com.earthview.world.spatial.geometry.Point centerPoint, com.earthview.world.spatial.geometry.Point fromPoint, double sweepAngle)
	{
		long centerPointParamValue = centerPoint.nativeObject.pointer;
		long fromPointParamValue = fromPoint.nativeObject.pointer;
		double sweepAngleParamValue = sweepAngle;
		setCircleArc_CPoint_CPoint_ev_real64(this.nativeObject.pointer, centerPointParamValue, fromPointParamValue, sweepAngleParamValue);
	}
	native private void setCircleArc_CCoordinate_CCoordinate_ev_real64(long pNativeObject, long centerCoord, long fromCoord, double sweepAngle);
	/**
	 * 设置圆弧
	 * @param centerPoint 中心点坐标
	 * @param fromCoord 圆弧起点坐标
	 * @param sweepAngle 圆心角
	 */
	public void setCircleArc(com.earthview.world.spatial.geometry.Coordinate centerCoord, com.earthview.world.spatial.geometry.Coordinate fromCoord, double sweepAngle)
	{
		long centerCoordParamValue = centerCoord.nativeObject.pointer;
		long fromCoordParamValue = fromCoord.nativeObject.pointer;
		double sweepAngleParamValue = sweepAngle;
		setCircleArc_CCoordinate_CCoordinate_ev_real64(this.nativeObject.pointer, centerCoordParamValue, fromCoordParamValue, sweepAngleParamValue);
	}
	...
	native private void setCenterCoordinate_CCoordinate(long pNativeObject, long coord);
	/**
	 * 设置中心点坐标
	 * @param coord 中心点坐标
	 */
	public void setCenterCoordinate(com.earthview.world.spatial.geometry.Coordinate coord)
	{
		long coordParamValue = coord.nativeObject.pointer;
		setCenterCoordinate_CCoordinate(this.nativeObject.pointer, coordParamValue);
	}
	...
	native private void setFromAngle_ev_real64(long pNativeObject, double angle);
	/**
	 * 设置圆弧起始角度
	 * @param angle 起始角度
	 */
	public void setFromAngle(double angle)
	{
		...
		setFromAngle_ev_real64(this.nativeObject.pointer, angleParamValue);
	}
	native private void setSweepAngle_ev_real64(long pNativeObject, double sweep);
	/**
	 * 设置圆心角
	 * @param sweep 圆心角
	 */
	...
	{
		double sweepParamValue = sweep;
		setSweepAngle_ev_real64(this.nativeObject.pointer, sweepParamValue);
	}
	...
	native private boolean movePointTo_IGeometry_IGeometry(long pNativeObject, long frmPoint, long toPoint);
	/**
	 * 移动一个点
	 * @param frmPoint 待移动的点
	 * @param toPoint 目标点
	 */
	public boolean movePointTo(com.earthview.world.spatial.geometry.Igeometry frmPoint, com.earthview.world.spatial.geometry.Igeometry toPoint)
	{
		long frmPointParamValue = (frmPoint == null ? 0L : frmPoint.nativeObject.pointer);
		long toPointParamValue = (toPoint == null ? 0L : toPoint.nativeObject.pointer);
		boolean returnValue = movePointTo_IGeometry_IGeometry(this.nativeObject.pointer, frmPointParamValue, toPointParamValue);
		return returnValue;
	}
	native private boolean movePointTo_IGeometry_IGeometry_NoVirtual(long pNativeObject, long frmPoint, long toPoint);
	protected boolean movePointTo_NoVirtual(com.earthview.world.spatial.geometry.Igeometry frmPoint, com.earthview.world.spatial.geometry.Igeometry toPoint)
	{
		long frmPointParamValue = (frmPoint == null ? 0L : frmPoint.nativeObject.pointer);
		long toPointParamValue = (toPoint == null ? 0L : toPoint.nativeObject.pointer);
		boolean returnValue = movePointTo_IGeometry_IGeometry_NoVirtual(this.nativeObject.pointer, frmPointParamValue, toPointParamValue);
		return returnValue;
	}

	native private boolean addPointTo_IGeometry(long pNativeObject, long point);
	/**
	 * 增加一个点
	 * @param point 待增加的点
	 */
	public boolean addPointTo(com.earthview.world.spatial.geometry.Igeometry point)
	{
		long pointParamValue = (point == null ? 0L : point.nativeObject.pointer);
		boolean returnValue = addPointTo_IGeometry(this.nativeObject.pointer, pointParamValue);
		return returnValue;
	}
	native private boolean addPointTo_IGeometry_NoVirtual(long pNativeObject, long point);
	protected boolean addPointTo_NoVirtual(com.earthview.world.spatial.geometry.Igeometry point)
	{
		long pointParamValue = (point == null ? 0L : point.nativeObject.pointer);
		boolean returnValue = addPointTo_IGeometry_NoVirtual(this.nativeObject.pointer, pointParamValue);
		return returnValue;
	}
	...
	public CircleArc(com.earthview.world.spatial.geometry.CircleArc obj) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
	...
	native private long OperatorAssign_CCircleArc(long pNativeObject, long obj);
	public com.earthview.world.spatial.geometry.CircleArc OperatorAssign(com.earthview.world.spatial.geometry.CircleArc obj)
	{
		long objParamValue = obj.nativeObject.pointer;
		long returnValue = OperatorAssign_CCircleArc(this.nativeObject.pointer, objParamValue);
		com.earthview.world.spatial.geometry.CircleArc __returnValue = new com.earthview.world.spatial.geometry.CircleArc(CreatedWhenConstruct.CWC_NotToCreate, "CCircleArc");
		__returnValue.setDelegate(true);
		InstancePointer __instancePointer = new InstancePointer(returnValue);
		__returnValue.setInstancePointer(__instancePointer);
		IClassFactory __returnValueClassFactory = GlobalClassFactoryMap.get(__returnValue.getCppInstanceTypeName());
		...
		{
			__returnValue.setDelegate(true);
			__returnValue = (com.earthview.world.spatial.geometry.CircleArc)__returnValueClassFactory.create();
			__returnValue.setDelegate(true);
			__returnValue.bindNativeObject(__instancePointer, "CCircleArc");
		}
		return __returnValue;
	}
	native private long clone2_void(long pNativeObject);
	public com.earthview.world.spatial.geometry.CircleArc clone2()
	{
		long returnValue = clone2_void(this.nativeObject.pointer);
		com.earthview.world.spatial.geometry.CircleArc __returnValue = new com.earthview.world.spatial.geometry.CircleArc(CreatedWhenConstruct.CWC_NotToCreate);
		InstancePointer __instancePointer = new InstancePointer(returnValue);
		__returnValue.bindNativeObject(__instancePointer, "CCircleArc");
		__returnValue.createNativeObjectPointer(__instancePointer);
		IClassFactory __returnValueClassFactory = GlobalClassFactoryMap.get(__returnValue.getCppInstanceTypeName());
	...
	public CircleArc(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CircleArc(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CircleArc fromBaseObject(BaseObject baseObj)
	{
		...
		CircleArc obj = null;
 		if(baseObj instanceof CircleArc)
		{
			obj = (CircleArc)baseObj;
		} else {
