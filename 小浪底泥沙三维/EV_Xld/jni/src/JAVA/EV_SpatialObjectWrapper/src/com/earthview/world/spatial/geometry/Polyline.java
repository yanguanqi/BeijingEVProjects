 ...
 * 折线类
 */
public class Polyline extends com.earthview.world.spatial.geometry.Curve {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Geometry::CPolyline", new PolylineClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Geometry::JCPolylineProxy", new PolylineClassFactory());
	}
	...
	public Polyline() {
		...
		Create("JCPolylineProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.geometry.Polyline".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
		}
	}

	public Polyline(com.earthview.world.spatial.geometry.CoordinateSequence coords) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer coordsPtr = new BasePointer(coords);
		list.add("coords", coordsPtr.get());
		Create("JCPolylineProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.geometry.Polyline".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
	...
	native private long getCurvePath_ev_uint32(long pNativeObject, long index);
	/**
	 * 获取曲线Path对象
	 * @param index 索引位置
	 */
	public com.earthview.world.spatial.geometry.CurvePath getCurvePath(long index)
	{
		long indexParamValue = index;
		long returnValue = getCurvePath_ev_uint32(this.nativeObject.pointer, indexParamValue);
		if(returnValue == 0L) {
			return null;
		}
	...
	native private long getCurvePathRef_ev_uint32(long pNativeObject, long index);
	/**
	 * 获取曲线Path对象
	 * @param index 索引位置
	 */
	public com.earthview.world.spatial.geometry.CurvePath getCurvePathRef(long index)
	{
		long indexParamValue = index;
		long returnValue = getCurvePathRef_ev_uint32(this.nativeObject.pointer, indexParamValue);
		if(returnValue == 0L) {
			return null;
		}
		com.earthview.world.spatial.geometry.CurvePath __returnValue = new com.earthview.world.spatial.geometry.CurvePath(CreatedWhenConstruct.CWC_NotToCreate, "CCurvePath");
	...
	native private int add_CCurvePath_ev_int32(long pNativeObject, long cpy_paths, int index);
	/**
	 * 添加指定数目的Path到指定索引处
	 * @param paths 曲线Path列表
	 * @param size 曲线Path数目
	 * @param index 指定索引
	 * @return 成功加载数目
	 */
	public int add(com.earthview.world.spatial.geometry.CurvePath cpy_paths, int index)
	{
		long cpy_pathsParamValue = (cpy_paths == null ? 0L : cpy_paths.nativeObject.pointer);
		int indexParamValue = index;
		int returnValue = add_CCurvePath_ev_int32(this.nativeObject.pointer, cpy_pathsParamValue, indexParamValue);
		return returnValue;
	}
	...
	public com.earthview.world.spatial.geometry.Polyline clone2()
	{
		long returnValue = clone2_void(this.nativeObject.pointer);
		com.earthview.world.spatial.geometry.Polyline __returnValue = new com.earthview.world.spatial.geometry.Polyline(CreatedWhenConstruct.CWC_NotToCreate);
		InstancePointer __instancePointer = new InstancePointer(returnValue);
	...
	native private long replace_CCurvePath_ev_uint32(long pNativeObject, long cpy_path, long index);
	public long replace(com.earthview.world.spatial.geometry.CurvePath cpy_path, long index)
	{
		long cpy_pathParamValue = (cpy_path == null ? 0L : cpy_path.nativeObject.pointer);
		long indexParamValue = index;
		long returnValue = replace_CCurvePath_ev_uint32(this.nativeObject.pointer, cpy_pathParamValue, indexParamValue);
		return returnValue;
	}
	...
	public Polyline(com.earthview.world.spatial.geometry.Polyline obj) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
	...
	native private long OperatorAssign_CPolyline(long pNativeObject, long obj);
	public com.earthview.world.spatial.geometry.Polyline OperatorAssign(com.earthview.world.spatial.geometry.Polyline obj)
	{
		long objParamValue = obj.nativeObject.pointer;
		long returnValue = OperatorAssign_CPolyline(this.nativeObject.pointer, objParamValue);
	...
	public Polyline(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Polyline(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Polyline fromBaseObject(BaseObject baseObj)
	{
		...
		Polyline obj = null;
 		if(baseObj instanceof Polyline)
		{
			obj = (Polyline)baseObj;
		} else {
