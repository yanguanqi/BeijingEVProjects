 ...
 * 圆柱体类管理圆柱体
 */
public class Column extends com.earthview.world.spatial.geometry.RevolvingVolume {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Geometry::CColumn", new ColumnClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Geometry::JCColumnProxy", new ColumnClassFactory());
	}
	...
	public Column() {
		...
		Create("JCColumnProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.geometry.Column".equals(this.getClass().getName()))
		{
	...
	/**
	 * 构造函数
	 * @param bottomCircle 底圆
	 * @param height 高度
	 */
	public Column(com.earthview.world.spatial.geometry.Circle bottomCircle, double height) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer bottomCirclePtr = new BasePointer(bottomCircle);
		list.add("bottomCircle", bottomCirclePtr.get());
		BasePointer heightPtr = new BasePointer(height);
		list.add("height", heightPtr.get());
		Create("JCColumnProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.geometry.Column".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
	...
	native private long getCircle_void(long pNativeObject);
	/**
	 * 获取底圆
	 * @param  
	 * @return 底圆
	 */
	public com.earthview.world.spatial.geometry.Circle getCircle()
	{
		long returnValue = getCircle_void(this.nativeObject.pointer);
		com.earthview.world.spatial.geometry.Circle __returnValue = new com.earthview.world.spatial.geometry.Circle(CreatedWhenConstruct.CWC_NotToCreate, "CCircle");
		...
		{
			__returnValue.setDelegate(true);
			__returnValue = (com.earthview.world.spatial.geometry.Circle)__returnValueClassFactory.create();
			__returnValue.setDelegate(true);
			__returnValue.bindNativeObject(__instancePointer, "CCircle");
		}
		return __returnValue;
	}
	native private void setCircle_CCircle(long pNativeObject, long centerPoint);
	/**
	 * 设置底圆
	 * @param centerPoint 底圆
	 */
	public void setCircle(com.earthview.world.spatial.geometry.Circle centerPoint)
	{
		long centerPointParamValue = centerPoint.nativeObject.pointer;
		setCircle_CCircle(this.nativeObject.pointer, centerPointParamValue);
	}
	...
	native private void setHeight_ev_real64(long pNativeObject, double height);
	/**
	 * 设置高度
	 * @param height 高度
	 */
	public void setHeight(double height)
	{
		...
		setHeight_ev_real64(this.nativeObject.pointer, heightParamValue);
	}
	...
	public Column(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Column(CreatedWhenConstruct cwc, String classNameStr) {
	...
	{
		return super.setAngle_NoVirtual(degree);
	}
	/**
	 * 获取旋转四元数
	 * @param  
