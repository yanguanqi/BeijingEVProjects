 ...
 * 圆锥体
 */
public class Cone extends com.earthview.world.spatial.geometry.RevolvingVolume {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Geometry::CCone", new ConeClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Geometry::JCConeProxy", new ConeClassFactory());
	}
	...
	public Cone() {
		...
		Create("JCConeProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.geometry.Cone".equals(this.getClass().getName()))
		{
	 ...
	 * @param height 高度
	 */
	public Cone(com.earthview.world.spatial.geometry.Circle bottomCircle, double height) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	...
	public Cone(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Cone(CreatedWhenConstruct cwc, String classNameStr) {
