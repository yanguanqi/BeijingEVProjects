 ...
 * //获取显示模式。//
 */
public class TextLineMovable extends com.earthview.world.graphic.MovableObject {
	
	static {
		GlobalClassFactoryMap.put("EarthView::IndustryEngine::IndustryGraphic::CTextLineMovable", new TextLineMovableClassFactory());
		GlobalClassFactoryMap.put("EarthView::IndustryEngine::IndustryGraphic::JCTextLineMovableProxy", new TextLineMovableClassFactory());
	}

	/**
	 * 连接线渲染对象
	 */
	public static class TextLineRenderable extends com.earthview.world.graphic.Renderable {
		
		static {
			GlobalClassFactoryMap.put("EarthView::IndustryEngine::IndustryGraphic::CTextLineMovable::CTextLineRenderable", new TextLineRenderableClassFactory());
			GlobalClassFactoryMap.put("EarthView::IndustryEngine::IndustryGraphic::CTextLineMovable::JCTextLineRenderableProxy", new TextLineRenderableClassFactory());
		}
		 ...
		 */
		public TextLineRenderable(String name, com.earthview.industryengine.industrygraphic.TextLineMovable ref_parent) {
			...
			Create("JCTextLineRenderableProxy", list, true);
			this.registerCallback();
			if (!"com.earthview.industryengine.industrygraphic.TextLineMovable$TextLineRenderable".equals(this.getClass().getName()))
			{
		...
		public TextLineRenderable(CreatedWhenConstruct cwc) {
			super(CreatedWhenConstruct.CWC_NotToCreate);
		}
		public TextLineRenderable(CreatedWhenConstruct cwc, String classNameStr) {
		...
		public static TextLineRenderable fromBaseObject(BaseObject baseObj)
		{
			...
			TextLineRenderable obj = null;
 			if(baseObj instanceof TextLineRenderable)
			{
				obj = (TextLineRenderable)baseObj;
			} else {
	...
	public static class TextLineRenderableClassFactory implements IClassFactory {
	 ...
	 */
	public TextLineMovable(String name, com.earthview.industryengine.industrygraphic.ScutcheonText ref_scutcheonText, com.earthview.world.graphic.ColourValue lineColor) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer namePtr = new BasePointer(name);
		list.add("name", namePtr.get());
		...
		BasePointer lineColorPtr = new BasePointer(lineColor);
		list.add("lineColor", lineColorPtr.get());
		Create("JCTextLineMovableProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.industryengine.industrygraphic.TextLineMovable".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
		}
	}
	...
	native private void setLineMaterial_EVString(long pNativeObject, String matName);
	/**
	 * 设置连接线材质名称
	 * @param matName 材质名称
	 */
	...
	{
		String matNameParamValue = matName;
		setLineMaterial_EVString(this.nativeObject.pointer, matNameParamValue);
	}
	protected  void updateTextLineColor_CColourValue_callback(long color)
	{
		...
		updateTextLineColor(colorParamValue);
	}

	native private void updateTextLineColor_CColourValue(long pNativeObject, long color);
	/**
	 * 更新连接线颜色
	 */
	public void updateTextLineColor(com.earthview.world.graphic.ColourValue color)
	{
		long colorParamValue = color.nativeObject.pointer;
		updateTextLineColor_CColourValue(this.nativeObject.pointer, colorParamValue);
	}
	native private void updateTextLineColor_CColourValue_NoVirtual(long pNativeObject, long color);
	protected void updateTextLineColor_NoVirtual(com.earthview.world.graphic.ColourValue color)
	{
		long colorParamValue = color.nativeObject.pointer;
		updateTextLineColor_CColourValue_NoVirtual(this.nativeObject.pointer, colorParamValue);
	}
	...
	native private void setCalculateWorldMatrix_ev_bool(long pNativeObject, boolean enable);
	public void setCalculateWorldMatrix(boolean enable)
	{
		boolean enableParamValue = enable;
		setCalculateWorldMatrix_ev_bool(this.nativeObject.pointer, enableParamValue);
	}
	native private boolean getCalculateWorldMatrix_void(long pNativeObject);
	public boolean getCalculateWorldMatrix()
	{
		boolean returnValue = getCalculateWorldMatrix_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private long get_mAttachNode_void(long pNativeObject);
	public com.earthview.world.graphic.Node get_mAttachNode()
	{
		long jniValue = get_mAttachNode_void(this.nativeObject.pointer);
	...
	native private void set_mAttachNode_CNode (long pNativeObject, long value);
	public void set_mAttachNode(com.earthview.world.graphic.Node mAttachNode)
	{
		long mAttachNodeParamValue = (mAttachNode == null ? 0L : mAttachNode.nativeObject.pointer);
		
		set_mAttachNode_CNode(this.nativeObject.pointer, mAttachNodeParamValue);
	}
	
	public TextLineMovable(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public TextLineMovable(CreatedWhenConstruct cwc, String classNameStr) {
		super(CreatedWhenConstruct.CWC_NotToCreate, classNameStr);
	}
	...
	native protected void register_updateTextLineColor_CColourValue(long pNativeObject, String method);
	native protected void register_getMaterial_void(long pNativeObject, String method);
	...
	public void registerCallback(){
		if (!this.nativeObject.equals(InstancePointer.ZERO)){
			this.register_updateTextLineColor_CColourValue(this.nativeObject.pointer, "updateTextLineColor_CColourValue_callback");
			this.register_getMaterial_void(this.nativeObject.pointer, "getMaterial_void_callback");
	...
	public static TextLineMovable fromBaseObject(BaseObject baseObj)
	{
		...
		TextLineMovable obj = null;
 		if(baseObj instanceof TextLineMovable)
		{
			obj = (TextLineMovable)baseObj;
		} else {
