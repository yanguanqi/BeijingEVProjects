...
public class TextOverlayMovable extends com.earthview.world.graphic.MovableObject {
	
	static {
		GlobalClassFactoryMap.put("EarthView::IndustryEngine::IndustryGraphic::CTextOverlayMovable", new TextOverlayMovableClassFactory());
		GlobalClassFactoryMap.put("EarthView::IndustryEngine::IndustryGraphic::JCTextOverlayMovableProxy", new TextOverlayMovableClassFactory());
	}

	public static class TextOverlayRenderable extends com.earthview.world.graphic.Renderable {
		
		static {
			GlobalClassFactoryMap.put("EarthView::IndustryEngine::IndustryGraphic::CTextOverlayMovable::CTextOverlayRenderable", new TextOverlayRenderableClassFactory());
			GlobalClassFactoryMap.put("EarthView::IndustryEngine::IndustryGraphic::CTextOverlayMovable::JCTextOverlayRenderableProxy", new TextOverlayRenderableClassFactory());
		}
		 ...
		 */
		public TextOverlayRenderable(String name, com.earthview.industryengine.industrygraphic.TextOverlayMovable ref_parent) {
			...
			Create("JCTextOverlayRenderableProxy", list, true);
			this.registerCallback();
			if (!"com.earthview.industryengine.industrygraphic.TextOverlayMovable$TextOverlayRenderable".equals(this.getClass().getName()))
			{
		...
		public TextOverlayRenderable(CreatedWhenConstruct cwc) {
			super(CreatedWhenConstruct.CWC_NotToCreate);
		}
		public TextOverlayRenderable(CreatedWhenConstruct cwc, String classNameStr) {
		...
		public static TextOverlayRenderable fromBaseObject(BaseObject baseObj)
		{
			...
			TextOverlayRenderable obj = null;
 			if(baseObj instanceof TextOverlayRenderable)
			{
				obj = (TextOverlayRenderable)baseObj;
			} else {
	...
	public static class TextOverlayRenderableClassFactory implements IClassFactory {
	 ...
	 */
	public TextOverlayMovable(String name, com.earthview.industryengine.industrygraphic.ScutcheonText ref_scutcheonText) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer namePtr = new BasePointer(name);
		list.add("name", namePtr.get());
		...
		Create("JCTextOverlayMovableProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.industryengine.industrygraphic.TextOverlayMovable".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
		}
	}
	...
	native private void setOverlayMaterial_EVString(long pNativeObject, String matName);
	/**
	 * 设置底面材质名称
	 * @param  
	 * @return 材质名称
	...
	{
		String matNameParamValue = matName;
		setOverlayMaterial_EVString(this.nativeObject.pointer, matNameParamValue);
	}
	...
	public TextOverlayMovable(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public TextOverlayMovable(CreatedWhenConstruct cwc, String classNameStr) {
		super(CreatedWhenConstruct.CWC_NotToCreate, classNameStr);
	}
	...
	public static TextOverlayMovable fromBaseObject(BaseObject baseObj)
	{
		...
		TextOverlayMovable obj = null;
 		if(baseObj instanceof TextOverlayMovable)
		{
			obj = (TextOverlayMovable)baseObj;
		} else {
