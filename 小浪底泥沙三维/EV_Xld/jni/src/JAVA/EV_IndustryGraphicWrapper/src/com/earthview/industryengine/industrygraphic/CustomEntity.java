...
public class CustomEntity extends com.earthview.world.graphic.Entity {
	
	static {
		GlobalClassFactoryMap.put("EarthView::IndustryEngine::IndustryGraphic::CCustomEntity", new CustomEntityClassFactory());
		GlobalClassFactoryMap.put("EarthView::IndustryEngine::IndustryGraphic::JCCustomEntityProxy", new CustomEntityClassFactory());
	}

	native private long getSelctedSubEntity_void(long pNativeObject);
	public com.earthview.world.graphic.SubEntity getSelctedSubEntity()
	{
		long returnValue = getSelctedSubEntity_void(this.nativeObject.pointer);
		if(returnValue == 0L) {
			return null;
		}
	...
	native private long getSelctedIndex1_void(long pNativeObject);
	public long getSelctedIndex1()
	{
		long returnValue = getSelctedIndex1_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private long getSelctedIndex2_void(long pNativeObject);
	public long getSelctedIndex2()
	{
		long returnValue = getSelctedIndex2_void(this.nativeObject.pointer);
		return returnValue;
	}
	...
	public CustomEntity(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CustomEntity(CreatedWhenConstruct cwc, String classNameStr) {
	...
	{
		super.setprepareSelect_NoVirtual(selectedSubMeshIndex, selectedInstanceIndex, selectedSegmentIndex, bSelected);
	}
	...
	public static CustomEntity fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		CustomEntity obj = null;
 		if(baseObj instanceof CustomEntity)
		{
			obj = (CustomEntity)baseObj;
		} else {
			obj = new CustomEntity(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CCustomEntity");
			obj.increaseCast();
		}
