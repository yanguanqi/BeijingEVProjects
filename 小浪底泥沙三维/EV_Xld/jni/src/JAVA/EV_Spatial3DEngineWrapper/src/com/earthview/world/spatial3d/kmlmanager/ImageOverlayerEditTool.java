...
public class ImageOverlayerEditTool extends com.earthview.world.spatial.systemui.Itool {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::KmlManager::CImageOverlayerEditTool", new ImageOverlayerEditToolClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::KmlManager::JCImageOverlayerEditToolProxy", new ImageOverlayerEditToolClassFactory());
	}
	 ...
	 * @param parent kml文档
	 */
	public ImageOverlayerEditTool(com.earthview.world.graphic.SceneManager ref_sceneMgr, com.earthview.world.graphic.Camera ref_camera, com.earthview.world.graphic.Viewport ref_viewPort, com.earthview.world.spatial.kml.GeoObjectExtension geoObj, com.earthview.world.spatial.kml.KmlDocument ref_parent) {
		...
		Create("JCImageOverlayerEditToolProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.kmlmanager.ImageOverlayerEditTool".equals(this.getClass().getName()))
		{
	...
	native private boolean get_mHasImage_void(long pNativeObject);
	public boolean get_mHasImage()
	{
		boolean jniValue = get_mHasImage_void(this.nativeObject.pointer);
		
		return jniValue;
	}
	
	native private void set_mHasImage_ev_bool (long pNativeObject, boolean value);
	public void set_mHasImage(boolean mHasImage)
	{
		boolean mHasImageParamValue = mHasImage;
		
		set_mHasImage_ev_bool(this.nativeObject.pointer, mHasImageParamValue);
	}
	...
	public ImageOverlayerEditTool(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ImageOverlayerEditTool(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ImageOverlayerEditTool fromBaseObject(BaseObject baseObj)
	{
		...
		ImageOverlayerEditTool obj = null;
 		if(baseObj instanceof ImageOverlayerEditTool)
		{
			obj = (ImageOverlayerEditTool)baseObj;
		} else {
