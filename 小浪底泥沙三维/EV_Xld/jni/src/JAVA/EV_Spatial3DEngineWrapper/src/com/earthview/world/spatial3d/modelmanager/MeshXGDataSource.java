...
public class MeshXGDataSource extends com.earthview.world.spatial.geodataset.Ifiledatasource {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::ModelManager::CMeshXGDataSource", new MeshXGDataSourceClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::ModelManager::JCMeshXGDataSourceProxy", new MeshXGDataSourceClassFactory());
	}

	public MeshXGDataSource(String datasourcePath, String aliasname) {
		...
		Create("JCMeshXGDataSourceProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.modelmanager.MeshXGDataSource".equals(this.getClass().getName()))
		{
	...
	public MeshXGDataSource(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public MeshXGDataSource(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static MeshXGDataSource fromBaseObject(BaseObject baseObj)
	{
		...
		MeshXGDataSource obj = null;
 		if(baseObj instanceof MeshXGDataSource)
		{
			obj = (MeshXGDataSource)baseObj;
		} else {
