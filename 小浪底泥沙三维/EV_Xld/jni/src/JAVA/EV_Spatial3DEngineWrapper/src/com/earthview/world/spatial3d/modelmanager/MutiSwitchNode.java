 ...
 * 更新节点内部方法
 */
public class MutiSwitchNode extends com.earthview.world.spatial3d.modelmanager.FltBaseNode {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::ModelManager::CMutiSwitchNode", new MutiSwitchNodeClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::ModelManager::JCMutiSwitchNodeProxy", new MutiSwitchNodeClassFactory());
	}
	 ...
	 * @param name 分配的节点名称
	 */
	public MutiSwitchNode(String name, com.earthview.world.graphic.SceneManager ref_creator) {
		...
		Create("JCMutiSwitchNodeProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.modelmanager.MutiSwitchNode".equals(this.getClass().getName()))
		{
	...
	native private void setValue_ev_uint32_ev_uint32_ev_bool(long pNativeObject, long switchSet, long pos, boolean value);
	public void setValue(long switchSet, long pos, boolean value)
	{
		long switchSetParamValue = switchSet;
		long posParamValue = pos;
		boolean valueParamValue = value;
		setValue_ev_uint32_ev_uint32_ev_bool(this.nativeObject.pointer, switchSetParamValue, posParamValue, valueParamValue);
	}
	native private boolean getValue_ev_uint32_ev_uint32(long pNativeObject, long switchSet, long pos);
	public boolean getValue(long switchSet, long pos)
	{
		long switchSetParamValue = switchSet;
		long posParamValue = pos;
		boolean returnValue = getValue_ev_uint32_ev_uint32(this.nativeObject.pointer, switchSetParamValue, posParamValue);
		return returnValue;
	}
	native private void setChildValue_CSceneNode_ev_uint32_ev_bool(long pNativeObject, long child, long switchSet, boolean value);
	public void setChildValue(com.earthview.world.graphic.SceneNode child, long switchSet, boolean value)
	{
		long childParamValue = (child == null ? 0L : child.nativeObject.pointer);
		long switchSetParamValue = switchSet;
		boolean valueParamValue = value;
		setChildValue_CSceneNode_ev_uint32_ev_bool(this.nativeObject.pointer, childParamValue, switchSetParamValue, valueParamValue);
	}
	native private boolean getChildValue_CSceneNode_ev_uint32(long pNativeObject, long child, long switchSet);
	public boolean getChildValue(com.earthview.world.graphic.SceneNode child, long switchSet)
	{
		long childParamValue = (child == null ? 0L : child.nativeObject.pointer);
		long switchSetParamValue = switchSet;
		boolean returnValue = getChildValue_CSceneNode_ev_uint32(this.nativeObject.pointer, childParamValue, switchSetParamValue);
		return returnValue;
	}
	native private boolean setAllChildrenOff_ev_uint32(long pNativeObject, long switchSet);
	public boolean setAllChildrenOff(long switchSet)
	{
		long switchSetParamValue = switchSet;
		boolean returnValue = setAllChildrenOff_ev_uint32(this.nativeObject.pointer, switchSetParamValue);
		return returnValue;
	}
	native private boolean setAllChildrenOn_ev_uint32(long pNativeObject, long switchSet);
	public boolean setAllChildrenOn(long switchSet)
	{
		long switchSetParamValue = switchSet;
		boolean returnValue = setAllChildrenOn_ev_uint32(this.nativeObject.pointer, switchSetParamValue);
		return returnValue;
	}
	native private boolean setSingleChildOn_ev_uint32_ev_uint32(long pNativeObject, long switchSet, long pos);
	public boolean setSingleChildOn(long switchSet, long pos)
	{
		long switchSetParamValue = switchSet;
		long posParamValue = pos;
		boolean returnValue = setSingleChildOn_ev_uint32_ev_uint32(this.nativeObject.pointer, switchSetParamValue, posParamValue);
		return returnValue;
	}
	native private void setActiveSwitchSet_ev_uint32(long pNativeObject, long switchSet);
	public void setActiveSwitchSet(long switchSet)
	{
		long switchSetParamValue = switchSet;
		setActiveSwitchSet_ev_uint32(this.nativeObject.pointer, switchSetParamValue);
	}
	native private long getActiveSwitchSet_void(long pNativeObject);
	public long getActiveSwitchSet()
	{
		long returnValue = getActiveSwitchSet_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private void setValueName_ev_uint32_EVString(long pNativeObject, long switchSet, String name);
	...
	public void setValueName(long switchSet, String name)
	{
		long switchSetParamValue = switchSet;
		String nameParamValue = name;
		setValueName_ev_uint32_EVString(this.nativeObject.pointer, switchSetParamValue, nameParamValue);
	}
	native private long getValueName_ev_uint32(long pNativeObject, long switchSet);
	public StringPointer getValueName(long switchSet)
	{
		long switchSetParamValue = switchSet;
		long returnValue = getValueName_ev_uint32(this.nativeObject.pointer, switchSetParamValue);
	...
	native private void setNumChild_ev_uint32(long pNativeObject, long numChild);
	/**
	 * 更新节点内部方法
	 * @param updateChildren 为真，逐级更新所有子节点
	 * @param parentHasChanged 为true，表明父节点位置改变，子节点继承父节点变化
	 */
	public void setNumChild(long numChild)
	{
		long numChildParamValue = numChild;
		setNumChild_ev_uint32(this.nativeObject.pointer, numChildParamValue);
	}
	public MutiSwitchNode(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public MutiSwitchNode(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static MutiSwitchNode fromBaseObject(BaseObject baseObj)
	{
		...
		MutiSwitchNode obj = null;
 		if(baseObj instanceof MutiSwitchNode)
		{
			obj = (MutiSwitchNode)baseObj;
		} else {
