...
public class LocalImageDataSourceFactory extends com.earthview.world.spatial.geodataset.Idatasourcefactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::CLocalImageDataSourceFactory", new LocalImageDataSourceFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::JCLocalImageDataSourceFactoryProxy", new LocalImageDataSourceFactoryClassFactory());
	}

	/**
	 * 构造函数
	 */
	public LocalImageDataSourceFactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCLocalImageDataSourceFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.LocalImageDataSourceFactory".equals(this.getClass().getName()))
		{
	 ...
	 */
	public static com.earthview.world.spatial3d.LocalImageDataSourceFactory getSingletonPtr()
	{
		long returnValue = getSingletonPtr_void();
		if(returnValue == 0L) {
			return null;
		}
		com.earthview.world.spatial3d.LocalImageDataSourceFactory __returnValue = new com.earthview.world.spatial3d.LocalImageDataSourceFactory(CreatedWhenConstruct.CWC_NotToCreate, "CLocalImageDataSourceFactory");
		...
		{
			__returnValue.setDelegate(true);
			__returnValue = (com.earthview.world.spatial3d.LocalImageDataSourceFactory)__returnValueClassFactory.create();
			__returnValue.setDelegate(true);
			__returnValue.bindNativeObject(__instancePointer, "CLocalImageDataSourceFactory");
		}
	...
	public LocalImageDataSourceFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public LocalImageDataSourceFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static LocalImageDataSourceFactory fromBaseObject(BaseObject baseObj)
	{
		...
		LocalImageDataSourceFactory obj = null;
 		if(baseObj instanceof LocalImageDataSourceFactory)
		{
			obj = (LocalImageDataSourceFactory)baseObj;
		} else {
