...
public class MeshXGLayer extends com.earthview.world.spatial3d.atlas.ObliqueModelLayer {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::CMeshXGLayer", new MeshXGLayerClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::JCMeshXGLayerProxy", new MeshXGLayerClassFactory());
	}
	...
	public MeshXGLayer(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public MeshXGLayer(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static MeshXGLayer fromBaseObject(BaseObject baseObj)
	{
		...
		MeshXGLayer obj = null;
 		if(baseObj instanceof MeshXGLayer)
		{
			obj = (MeshXGLayer)baseObj;
		} else {
