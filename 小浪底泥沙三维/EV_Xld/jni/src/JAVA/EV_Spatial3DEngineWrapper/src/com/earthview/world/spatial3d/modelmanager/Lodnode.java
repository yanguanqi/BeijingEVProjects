...
public class Lodnode extends com.earthview.world.spatial3d.modelmanager.FltBaseNode {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::ModelManager::CLODNode", new LodnodeClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::ModelManager::JCLODNodeProxy", new LodnodeClassFactory());
	}
	 ...
	 * @param name 分配的节点名称
	 */
	public Lodnode(String name, com.earthview.world.graphic.SceneManager ref_creator) {
		...
		Create("JCLODNodeProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.modelmanager.Lodnode".equals(this.getClass().getName()))
		{
	...
	native private void setSwitchInDistance_ev_real64(long pNativeObject, double switchInDistance);
	/**
	 * 更新节点内部方法
	...
	{
		double switchInDistanceParamValue = switchInDistance;
		setSwitchInDistance_ev_real64(this.nativeObject.pointer, switchInDistanceParamValue);
	}
	native private double getSwitchInDistance_void(long pNativeObject);
	public double getSwitchInDistance()
	{
		double returnValue = getSwitchInDistance_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private void setSwitchOutDistance_ev_real64(long pNativeObject, double switchOutDistance);
	public void setSwitchOutDistance(double switchOutDistance)
	{
		double switchOutDistanceParamValue = switchOutDistance;
		setSwitchOutDistance_ev_real64(this.nativeObject.pointer, switchOutDistanceParamValue);
	}
	native private double getSwitchOutDistance_void(long pNativeObject);
	public double getSwitchOutDistance()
	{
		double returnValue = getSwitchOutDistance_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private void setLODCenter_CVector3(long pNativeObject, long lodCenter);
	public void setLODCenter(com.earthview.world.spatial.math.Vector3 lodCenter)
	{
		long lodCenterParamValue = lodCenter.nativeObject.pointer;
		setLODCenter_CVector3(this.nativeObject.pointer, lodCenterParamValue);
	}
	native private long getLODCenter_void(long pNativeObject);
	public com.earthview.world.spatial.math.Vector3 getLODCenter()
	{
		long returnValue = getLODCenter_void(this.nativeObject.pointer);
	...
	public Lodnode(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Lodnode(CreatedWhenConstruct cwc, String classNameStr) {
