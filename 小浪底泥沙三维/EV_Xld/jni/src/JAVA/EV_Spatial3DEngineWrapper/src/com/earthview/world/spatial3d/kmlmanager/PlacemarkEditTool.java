...
public class PlacemarkEditTool extends com.earthview.world.spatial.systemui.Itool {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::KmlManager::CPlacemarkEditTool", new PlacemarkEditToolClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::KmlManager::JCPlacemarkEditToolProxy", new PlacemarkEditToolClassFactory());
	}
	 ...
	 * @param parent kml文档
	 */
	public PlacemarkEditTool(com.earthview.world.graphic.SceneManager ref_sceneMgr, com.earthview.world.graphic.Camera ref_camera, com.earthview.world.graphic.Viewport ref_viewPort, com.earthview.world.spatial.kml.GeoObjectExtension geoObj, com.earthview.world.spatial.kml.KmlDocument ref_parent) {
		...
		Create("JCPlacemarkEditToolProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.kmlmanager.PlacemarkEditTool".equals(this.getClass().getName()))
		{
	...
	native private boolean get_mIsExtrude_void(long pNativeObject);
	public boolean get_mIsExtrude()
	{
		boolean jniValue = get_mIsExtrude_void(this.nativeObject.pointer);
		
		return jniValue;
	}
	
	native private void set_mIsExtrude_ev_bool (long pNativeObject, boolean value);
	public void set_mIsExtrude(boolean mIsExtrude)
	{
		boolean mIsExtrudeParamValue = mIsExtrude;
		
		set_mIsExtrude_ev_bool(this.nativeObject.pointer, mIsExtrudeParamValue);
	}
	...
	native private long getPoint_void(long pNativeObject);
	/**
	 * 获取地标的坐标
	 * @return 返回坐标
	 */
	public com.earthview.world.spatial.math.Vector3 getPoint()
	{
		long returnValue = getPoint_void(this.nativeObject.pointer);
	...
	native private void setPoint_CVector3(long pNativeObject, long vec);
	/**
	 * 设置坐标
	 * @param vec 坐标值
	 */
	public void setPoint(com.earthview.world.spatial.math.Vector3 vec)
	{
		long vecParamValue = vec.nativeObject.pointer;
		setPoint_CVector3(this.nativeObject.pointer, vecParamValue);
	}
	...
	public PlacemarkEditTool(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public PlacemarkEditTool(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static PlacemarkEditTool fromBaseObject(BaseObject baseObj)
	{
		...
		PlacemarkEditTool obj = null;
 		if(baseObj instanceof PlacemarkEditTool)
		{
			obj = (PlacemarkEditTool)baseObj;
		} else {
