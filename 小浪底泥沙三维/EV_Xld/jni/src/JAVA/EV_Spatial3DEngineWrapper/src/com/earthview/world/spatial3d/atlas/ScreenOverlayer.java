...
public class ScreenOverlayer extends com.earthview.world.geometry3d.VisibleObject {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::CScreenOverlayer", new ScreenOverlayerClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::JCScreenOverlayerProxy", new ScreenOverlayerClassFactory());
	}
	 ...
	 * @param  
	 */
	public ScreenOverlayer(com.earthview.world.spatial.kml.GeoObjectExtension geoObj, com.earthview.world.graphic.SceneManager scenemanager) {
		...
		Create("JCScreenOverlayerProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.atlas.ScreenOverlayer".equals(this.getClass().getName()))
		{
	...
	public ScreenOverlayer(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ScreenOverlayer(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ScreenOverlayer fromBaseObject(BaseObject baseObj)
	{
		...
		ScreenOverlayer obj = null;
 		if(baseObj instanceof ScreenOverlayer)
		{
			obj = (ScreenOverlayer)baseObj;
		} else {
