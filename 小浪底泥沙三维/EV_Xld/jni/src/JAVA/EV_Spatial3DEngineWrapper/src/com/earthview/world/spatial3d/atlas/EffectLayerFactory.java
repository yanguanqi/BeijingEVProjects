 ...
 * 特效图层工厂类
 */
public class EffectLayerFactory extends com.earthview.world.spatial.atlas.Ilayerfactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::CEffectLayerFactory", new EffectLayerFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::JCEffectLayerFactoryProxy", new EffectLayerFactoryClassFactory());
	}
	 ...
	 */
	public static com.earthview.world.spatial3d.atlas.EffectLayerFactory getSingletonPtr()
	{
		long returnValue = getSingletonPtr_void();
		if(returnValue == 0L) {
			return null;
		}
		com.earthview.world.spatial3d.atlas.EffectLayerFactory __returnValue = new com.earthview.world.spatial3d.atlas.EffectLayerFactory(CreatedWhenConstruct.CWC_NotToCreate, "CEffectLayerFactory");
		...
		{
			__returnValue.setDelegate(true);
			__returnValue = (com.earthview.world.spatial3d.atlas.EffectLayerFactory)__returnValueClassFactory.create();
			__returnValue.setDelegate(true);
			__returnValue.bindNativeObject(__instancePointer, "CEffectLayerFactory");
		}
	...
	public EffectLayerFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public EffectLayerFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static EffectLayerFactory fromBaseObject(BaseObject baseObj)
	{
		...
		EffectLayerFactory obj = null;
 		if(baseObj instanceof EffectLayerFactory)
		{
			obj = (EffectLayerFactory)baseObj;
		} else {
