...
public class Smart3DDataSource extends com.earthview.world.spatial.geodataset.Ifiledatasource {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::ModelManager::CSmart3DDataSource", new Smart3DDataSourceClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::ModelManager::JCSmart3DDataSourceProxy", new Smart3DDataSourceClassFactory());
	}

	public Smart3DDataSource(String datasourcePath, String aliasname) {
		...
		Create("JCSmart3DDataSourceProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.modelmanager.Smart3DDataSource".equals(this.getClass().getName()))
		{
	...
	public Smart3DDataSource(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Smart3DDataSource(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Smart3DDataSource fromBaseObject(BaseObject baseObj)
	{
		...
		Smart3DDataSource obj = null;
 		if(baseObj instanceof Smart3DDataSource)
		{
			obj = (Smart3DDataSource)baseObj;
		} else {
