 ...
 * 　编辑中
 */
public class ArrowEditorTool extends com.earthview.world.spatial.systemui.Itool {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::KmlManager::CArrowEditorTool", new ArrowEditorToolClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::KmlManager::JCArrowEditorToolProxy", new ArrowEditorToolClassFactory());
	}
	 ...
	 * @param parent kml文档
	 */
	public ArrowEditorTool(com.earthview.world.graphic.SceneManager ref_sceneMgr, com.earthview.world.graphic.Camera ref_camera, com.earthview.world.graphic.Viewport ref_viewPort, com.earthview.world.spatial.kml.GeoObjectExtension geoObj, com.earthview.world.spatial.kml.KmlDocument ref_parent) {
		...
		Create("JCArrowEditorToolProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.kmlmanager.ArrowEditorTool".equals(this.getClass().getName()))
		{
	...
	native private void setEditorArrowObj_CKmlArrowObjectEx(long pNativeObject, long pKmlArrowObj);
	/**
	 * 设置编辑的对象
	 */
	public void setEditorArrowObj(com.earthview.world.geometry3d.KmlArrowObjectEx pKmlArrowObj)
	{
		long pKmlArrowObjParamValue = (pKmlArrowObj == null ? 0L : pKmlArrowObj.nativeObject.pointer);
		setEditorArrowObj_CKmlArrowObjectEx(this.nativeObject.pointer, pKmlArrowObjParamValue);
	}
	...
	native private void setKmlArrowState_KmlArrowState(long pNativeObject, int ArrowState);
	/**
	 * 设置编辑的类型
	 * @param isRefreshLine 是否刷新线
	 */
	public void setKmlArrowState(com.earthview.world.spatial3d.kmlmanager.KmlArrowState ArrowState)
	{
		int ArrowStateParamValue = ArrowState.getValue();
		setKmlArrowState_KmlArrowState(this.nativeObject.pointer, ArrowStateParamValue);
	}
	native private int getKmlArrowState_void(long pNativeObject);
	/**
	 * 获取标绘的状态
	 * @param isRefreshLine 是否刷新线
	 */
	public com.earthview.world.spatial3d.kmlmanager.KmlArrowState getKmlArrowState()
	{
		int returnValue = getKmlArrowState_void(this.nativeObject.pointer);
		return com.earthview.world.spatial3d.kmlmanager.KmlArrowState.toEnum(returnValue);
	}
	...
	native private void updateGeoExProperty_EVString_CVariant(long pNativeObject, String key, long val);
	/**
	 * 更新扩展对象的属性
	 * @param key 键
	 * @param val 值
	 */
	public void updateGeoExProperty(String key, com.earthview.world.core.Variant val)
	{
		String keyParamValue = key;
		long valParamValue = val.nativeObject.pointer;
		updateGeoExProperty_EVString_CVariant(this.nativeObject.pointer, keyParamValue, valParamValue);
	}
	native private void setEditorPointAndIndex_ev_int32_CVector3(long pNativeObject, int index, long point);
	/**
	 * 设置正在编辑的点坐标和索引
	 * @param index 索引
	 * @param point 点坐标
	 */
	public void setEditorPointAndIndex(int index, com.earthview.world.spatial.math.Vector3 point)
	{
		int indexParamValue = index;
		long pointParamValue = point.nativeObject.pointer;
		setEditorPointAndIndex_ev_int32_CVector3(this.nativeObject.pointer, indexParamValue, pointParamValue);
	}
	native private int getEditorPointIndex_CVector3(long pNativeObject, long point);
	/**
	 * 获取正在编辑的点坐标和索引
	 * @param point 点坐标
	 * @return 索引
	 */
	public int getEditorPointIndex(com.earthview.world.spatial.math.Vector3 point)
	{
		long pointParamValue = point.nativeObject.pointer;
		int returnValue = getEditorPointIndex_CVector3(this.nativeObject.pointer, pointParamValue);
		return returnValue;
	}
	native private boolean reLoad_void(long pNativeObject);
	public boolean reLoad()
	{
		boolean returnValue = reLoad_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private void updataEditKeyPoints_void(long pNativeObject);
	public void updataEditKeyPoints()
	{
		updataEditKeyPoints_void(this.nativeObject.pointer);
	}
	public ArrowEditorTool(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ArrowEditorTool(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ArrowEditorTool fromBaseObject(BaseObject baseObj)
	{
		...
		ArrowEditorTool obj = null;
 		if(baseObj instanceof ArrowEditorTool)
		{
			obj = (ArrowEditorTool)baseObj;
		} else {
