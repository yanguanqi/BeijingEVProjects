...
public class Evlasdatasourcefactory extends com.earthview.world.spatial.geodataset.Idatasourcefactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::ModelManager::CEVLasDataSourceFactory", new EvlasdatasourcefactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::ModelManager::JCEVLasDataSourceFactoryProxy", new EvlasdatasourcefactoryClassFactory());
	}

	/**
	 * 构造函数
	 */
	public Evlasdatasourcefactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCEVLasDataSourceFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.modelmanager.Evlasdatasourcefactory".equals(this.getClass().getName()))
		{
	 ...
	 */
	public static com.earthview.world.spatial3d.modelmanager.Evlasdatasourcefactory getSingletonPtr()
	{
		long returnValue = getSingletonPtr_void();
		if(returnValue == 0L) {
			return null;
		}
		com.earthview.world.spatial3d.modelmanager.Evlasdatasourcefactory __returnValue = new com.earthview.world.spatial3d.modelmanager.Evlasdatasourcefactory(CreatedWhenConstruct.CWC_NotToCreate, "CEVLasDataSourceFactory");
		...
		{
			__returnValue.setDelegate(true);
			__returnValue = (com.earthview.world.spatial3d.modelmanager.Evlasdatasourcefactory)__returnValueClassFactory.create();
			__returnValue.setDelegate(true);
			__returnValue.bindNativeObject(__instancePointer, "CEVLasDataSourceFactory");
		}
	...
	public Evlasdatasourcefactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Evlasdatasourcefactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Evlasdatasourcefactory fromBaseObject(BaseObject baseObj)
	{
		...
		Evlasdatasourcefactory obj = null;
 		if(baseObj instanceof Evlasdatasourcefactory)
		{
			obj = (Evlasdatasourcefactory)baseObj;
		} else {
