...
public class KmlModelFactory extends com.earthview.world.spatial3d.atlas.Igeometry3dfactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::KmlManager::CKmlModelFactory", new KmlModelFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::KmlManager::JCKmlModelFactoryProxy", new KmlModelFactoryClassFactory());
	}
	 ...
	 * @param  
	 */
	public KmlModelFactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCKmlModelFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.kmlmanager.KmlModelFactory".equals(this.getClass().getName()))
		{
	...
	public KmlModelFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public KmlModelFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static KmlModelFactory fromBaseObject(BaseObject baseObj)
	{
		...
		KmlModelFactory obj = null;
 		if(baseObj instanceof KmlModelFactory)
		{
			obj = (KmlModelFactory)baseObj;
		} else {
