 ...
 * 大气圈
 */
public class Aerosphere extends com.earthview.world.graphic.ManualObject {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::CAerosphere", new AerosphereClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::JCAerosphereProxy", new AerosphereClassFactory());
	}
	 ...
	 * @param sm 场景管理器
	 */
	public Aerosphere(String name, com.earthview.world.spatial3d.GeoSceneManager sm) {
		...
		Create("JCAerosphereProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.Aerosphere".equals(this.getClass().getName()))
		{
	...
	public Aerosphere(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Aerosphere(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Aerosphere fromBaseObject(BaseObject baseObj)
	{
		...
		Aerosphere obj = null;
 		if(baseObj instanceof Aerosphere)
		{
			obj = (Aerosphere)baseObj;
		} else {
			obj = new Aerosphere(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CAerosphere");
			obj.increaseCast();
		}
