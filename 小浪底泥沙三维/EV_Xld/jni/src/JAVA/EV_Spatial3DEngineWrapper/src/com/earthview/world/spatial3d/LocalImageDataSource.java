...
public class LocalImageDataSource extends com.earthview.world.spatial.geodataset.Ifiledatasource {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::CLocalImageDataSource", new LocalImageDataSourceClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::JCLocalImageDataSourceProxy", new LocalImageDataSourceClassFactory());
	}

	public LocalImageDataSource(String datasourcePath, String aliasname) {
		...
		Create("JCLocalImageDataSourceProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.LocalImageDataSource".equals(this.getClass().getName()))
		{
	...
	native private static boolean createDataset_EVString_EVString_IFields(String name, String dstFolder, long attrFields);
	/**
	 * 创建数据集
	 * @param name 数据集名称
	 * @param dstFolder 目标目录
	 * @param attrFields 属性，NULL则无自定义属性
	 * @return 是，返回true;否则，返回false
	 */
	public static boolean createDataset(String name, String dstFolder, com.earthview.world.spatial.geodataset.Ifields attrFields)
	{
		String nameParamValue = name;
		String dstFolderParamValue = dstFolder;
		long attrFieldsParamValue = (attrFields == null ? 0L : attrFields.nativeObject.pointer);
		boolean returnValue = createDataset_EVString_EVString_IFields(nameParamValue, dstFolderParamValue, attrFieldsParamValue);
		return returnValue;
	}
	...
	public LocalImageDataSource(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public LocalImageDataSource(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static LocalImageDataSource fromBaseObject(BaseObject baseObj)
	{
		...
		LocalImageDataSource obj = null;
 		if(baseObj instanceof LocalImageDataSource)
		{
			obj = (LocalImageDataSource)baseObj;
		} else {
