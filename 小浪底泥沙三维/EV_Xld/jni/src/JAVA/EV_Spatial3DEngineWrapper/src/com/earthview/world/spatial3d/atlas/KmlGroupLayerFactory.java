 ...
 * CKmlGroupLayer工厂				
 */
public class KmlGroupLayerFactory extends com.earthview.world.spatial.atlas.Ilayerfactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::CKmlGroupLayerFactory", new KmlGroupLayerFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::JCKmlGroupLayerFactoryProxy", new KmlGroupLayerFactoryClassFactory());
	}

	/**
	 * 构造函数
	 */
	public KmlGroupLayerFactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCKmlGroupLayerFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.atlas.KmlGroupLayerFactory".equals(this.getClass().getName()))
		{
	...
	native private static String get_mKmlGroupLayerFactoryName_void();
	public static String get_mKmlGroupLayerFactoryName()
	{
		String jniValue = get_mKmlGroupLayerFactoryName_void();
		
		return jniValue;
	}
	
	public KmlGroupLayerFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public KmlGroupLayerFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static KmlGroupLayerFactory fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		KmlGroupLayerFactory obj = null;
 		if(baseObj instanceof KmlGroupLayerFactory)
		{
			obj = (KmlGroupLayerFactory)baseObj;
		} else {
			obj = new KmlGroupLayerFactory(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CKmlGroupLayerFactory");
			obj.increaseCast();
		}
