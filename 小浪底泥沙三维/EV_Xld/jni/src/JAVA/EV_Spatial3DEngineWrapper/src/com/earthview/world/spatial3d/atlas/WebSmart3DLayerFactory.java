 ...
 * 类工厂
 */
public class WebSmart3DLayerFactory extends com.earthview.world.spatial.atlas.Ilayerfactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::CWebSmart3DLayerFactory", new WebSmart3DLayerFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::JCWebSmart3DLayerFactoryProxy", new WebSmart3DLayerFactoryClassFactory());
	}

	/**
	 * 构造函数
	 */
	public WebSmart3DLayerFactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCWebSmart3DLayerFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.atlas.WebSmart3DLayerFactory".equals(this.getClass().getName()))
		{
	 ...
	 * 返回单例的图层工厂
	 */
	public static com.earthview.world.spatial3d.atlas.WebSmart3DLayerFactory getSingletonPtr()
	{
		long returnValue = getSingletonPtr_void();
		if(returnValue == 0L) {
			return null;
		}
		com.earthview.world.spatial3d.atlas.WebSmart3DLayerFactory __returnValue = new com.earthview.world.spatial3d.atlas.WebSmart3DLayerFactory(CreatedWhenConstruct.CWC_NotToCreate, "CWebSmart3DLayerFactory");
		...
		{
			__returnValue.setDelegate(true);
			__returnValue = (com.earthview.world.spatial3d.atlas.WebSmart3DLayerFactory)__returnValueClassFactory.create();
			__returnValue.setDelegate(true);
			__returnValue.bindNativeObject(__instancePointer, "CWebSmart3DLayerFactory");
		}
	...
	native private static String get_msObqLayerFactoryName_void();
	public static String get_msObqLayerFactoryName()
	{
		String jniValue = get_msObqLayerFactoryName_void();
		
		return jniValue;
	}
	
	public WebSmart3DLayerFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public WebSmart3DLayerFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static WebSmart3DLayerFactory fromBaseObject(BaseObject baseObj)
	{
		...
		WebSmart3DLayerFactory obj = null;
 		if(baseObj instanceof WebSmart3DLayerFactory)
		{
			obj = (WebSmart3DLayerFactory)baseObj;
		} else {
