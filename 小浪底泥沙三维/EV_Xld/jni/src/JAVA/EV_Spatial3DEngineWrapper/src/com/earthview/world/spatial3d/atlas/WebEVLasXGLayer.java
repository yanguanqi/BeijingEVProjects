...
public class WebEVLasXGLayer extends com.earthview.world.spatial3d.atlas.Evlasxglayer {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::CWebEVLasXGLayer", new WebEVLasXGLayerClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::JCWebEVLasXGLayerProxy", new WebEVLasXGLayerClassFactory());
	}
	...
	public WebEVLasXGLayer(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public WebEVLasXGLayer(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static WebEVLasXGLayer fromBaseObject(BaseObject baseObj)
	{
		...
		WebEVLasXGLayer obj = null;
 		if(baseObj instanceof WebEVLasXGLayer)
		{
			obj = (WebEVLasXGLayer)baseObj;
		} else {
