...
public class PanoramaTile extends com.earthview.world.graphic.SimpleRenderable {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::CPanoramaTile", new PanoramaTileClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::JCPanoramaTileProxy", new PanoramaTileClassFactory());
	}
	 ...
	 * @param latitude 纬度
	 * @param longitude 经度
	 * @param altitude 相对地面高度
	 * @param radius 半径
	 */
	public PanoramaTile(String name, com.earthview.world.graphic.SceneManager sceneMgr, com.earthview.world.spatial3d.GlobeCamera camera, String imageFilePath, String uri, double latitude, double longitude, double altitude, float radius) {
		...
		BasePointer uriPtr = new BasePointer(uri);
		list.add("uri", uriPtr.get());
		...
		Create("JCPanoramaTileProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.atlas.PanoramaTile".equals(this.getClass().getName()))
		{
	...
	native private void resetResource_EVString_EVString(long pNativeObject, String imageFilePath, String uri);
	public void resetResource(String imageFilePath, String uri)
	{
		...
		resetResource_EVString_EVString(this.nativeObject.pointer, imageFilePathParamValue, uriParamValue);
	}
	...
	native private boolean doubleClickEvent_CViewport_ev_int32_ev_int32_ev_int32_ev_int32(long pNativeObject, long viewPort, int button, int shift, int x, int y);
	public boolean doubleClickEvent(com.earthview.world.graphic.Viewport viewPort, int button, int shift, int x, int y)
	{
		...
		int xParamValue = x;
		int yParamValue = y;
		boolean returnValue = doubleClickEvent_CViewport_ev_int32_ev_int32_ev_int32_ev_int32(this.nativeObject.pointer, viewPortParamValue, buttonParamValue, shiftParamValue, xParamValue, yParamValue);
		return returnValue;
	}
	native private boolean mouseDownEvent_ev_int32_ev_int32_ev_int32_ev_int32(long pNativeObject, int button, int shift, int x, int y);
	public boolean mouseDownEvent(int button, int shift, int x, int y)
	{
		int buttonParamValue = button;
		int shiftParamValue = shift;
		int xParamValue = x;
		int yParamValue = y;
		boolean returnValue = mouseDownEvent_ev_int32_ev_int32_ev_int32_ev_int32(this.nativeObject.pointer, buttonParamValue, shiftParamValue, xParamValue, yParamValue);
		return returnValue;
	}
	native private boolean mouseUpEvent_ev_int32_ev_int32_ev_int32_ev_int32(long pNativeObject, int button, int shift, int x, int y);
	public boolean mouseUpEvent(int button, int shift, int x, int y)
	{
		int buttonParamValue = button;
		int shiftParamValue = shift;
		int xParamValue = x;
		int yParamValue = y;
		boolean returnValue = mouseUpEvent_ev_int32_ev_int32_ev_int32_ev_int32(this.nativeObject.pointer, buttonParamValue, shiftParamValue, xParamValue, yParamValue);
		return returnValue;
	}
	native private boolean mouseMoveEvent_CViewport_ev_int32_ev_int32_ev_int32_ev_int32(long pNativeObject, long viewPort, int button, int shift, int x, int y);
	public boolean mouseMoveEvent(com.earthview.world.graphic.Viewport viewPort, int button, int shift, int x, int y)
	{
		long viewPortParamValue = (viewPort == null ? 0L : viewPort.nativeObject.pointer);
		int buttonParamValue = button;
		int shiftParamValue = shift;
		int xParamValue = x;
		int yParamValue = y;
		boolean returnValue = mouseMoveEvent_CViewport_ev_int32_ev_int32_ev_int32_ev_int32(this.nativeObject.pointer, viewPortParamValue, buttonParamValue, shiftParamValue, xParamValue, yParamValue);
		return returnValue;
	}
	native private boolean mouseWheelEvent_ev_int32_ev_int32_ev_int32_ev_int32(long pNativeObject, int delta, int x, int y, int flag);
	public boolean mouseWheelEvent(int delta, int x, int y, int flag)
	{
		int deltaParamValue = delta;
		int xParamValue = x;
		int yParamValue = y;
		int flagParamValue = flag;
		boolean returnValue = mouseWheelEvent_ev_int32_ev_int32_ev_int32_ev_int32(this.nativeObject.pointer, deltaParamValue, xParamValue, yParamValue, flagParamValue);
		return returnValue;
	}
	native private boolean isCameraIn_void(long pNativeObject);
	public boolean isCameraIn()
	{
		boolean returnValue = isCameraIn_void(this.nativeObject.pointer);
		return returnValue;
	}
	...
	native private double getAbsoluteAltitude_void(long pNativeObject);
	public double getAbsoluteAltitude()
	{
		double returnValue = getAbsoluteAltitude_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private long getCenterPosition_void(long pNativeObject);
	public com.earthview.world.spatial.math.Vector3 getCenterPosition()
	{
	...
	public PanoramaTile(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public PanoramaTile(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static PanoramaTile fromBaseObject(BaseObject baseObj)
	{
		...
		PanoramaTile obj = null;
 		if(baseObj instanceof PanoramaTile)
		{
			obj = (PanoramaTile)baseObj;
		} else {
