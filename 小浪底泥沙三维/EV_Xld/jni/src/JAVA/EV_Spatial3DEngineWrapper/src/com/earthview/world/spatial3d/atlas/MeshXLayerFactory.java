 ...
 * 类工厂
 */
public class MeshXLayerFactory extends com.earthview.world.spatial.atlas.Ilayerfactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::CMeshXLayerFactory", new MeshXLayerFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::JCMeshXLayerFactoryProxy", new MeshXLayerFactoryClassFactory());
	}

	/**
	 * 构造函数
	 */
	public MeshXLayerFactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCMeshXLayerFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.atlas.MeshXLayerFactory".equals(this.getClass().getName()))
		{
	 ...
	 * 返回单例的图层工厂
	 */
	public static com.earthview.world.spatial3d.atlas.MeshXLayerFactory getSingletonPtr()
	{
		long returnValue = getSingletonPtr_void();
		if(returnValue == 0L) {
			return null;
		}
		com.earthview.world.spatial3d.atlas.MeshXLayerFactory __returnValue = new com.earthview.world.spatial3d.atlas.MeshXLayerFactory(CreatedWhenConstruct.CWC_NotToCreate, "CMeshXLayerFactory");
		...
		{
			__returnValue.setDelegate(true);
			__returnValue = (com.earthview.world.spatial3d.atlas.MeshXLayerFactory)__returnValueClassFactory.create();
			__returnValue.setDelegate(true);
			__returnValue.bindNativeObject(__instancePointer, "CMeshXLayerFactory");
		}
	...
	public MeshXLayerFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public MeshXLayerFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static MeshXLayerFactory fromBaseObject(BaseObject baseObj)
	{
		...
		MeshXLayerFactory obj = null;
 		if(baseObj instanceof MeshXLayerFactory)
		{
			obj = (MeshXLayerFactory)baseObj;
		} else {
