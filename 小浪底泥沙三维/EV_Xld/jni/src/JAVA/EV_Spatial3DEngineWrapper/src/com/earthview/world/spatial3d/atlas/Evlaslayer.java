...
public class Evlaslayer extends com.earthview.world.spatial3d.atlas.ObliqueModelLayer {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::CEVLasLayer", new EvlaslayerClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::JCEVLasLayerProxy", new EvlaslayerClassFactory());
	}
	...
	native private long queryResult_ev_real32_ev_real32_ev_real32_ev_real32(long pNativeObject, float minLon, float maxLon, float minLat, float maxLat);
	/**
	 * 查询给定经纬度范围内的点云数据
	 */
	public com.earthview.world.spatial3d.atlas.LasQueryResult queryResult(float minLon, float maxLon, float minLat, float maxLat)
	{
		float minLonParamValue = minLon;
		float maxLonParamValue = maxLon;
		float minLatParamValue = minLat;
		float maxLatParamValue = maxLat;
		long returnValue = queryResult_ev_real32_ev_real32_ev_real32_ev_real32(this.nativeObject.pointer, minLonParamValue, maxLonParamValue, minLatParamValue, maxLatParamValue);
		com.earthview.world.spatial3d.atlas.LasQueryResult __returnValue = new com.earthview.world.spatial3d.atlas.LasQueryResult(CreatedWhenConstruct.CWC_NotToCreate);
		InstancePointer __instancePointer = new InstancePointer(returnValue);
		__returnValue.bindNativeObject(__instancePointer, "CLasQueryResult");
		__returnValue.createNativeObjectPointer(__instancePointer);
		IClassFactory __returnValueClassFactory = GlobalClassFactoryMap.get(__returnValue.getCppInstanceTypeName());
		if (__returnValueClassFactory != null)
		{
			__returnValue.setDelegate(true);
			__returnValue = (com.earthview.world.spatial3d.atlas.LasQueryResult)__returnValueClassFactory.create();
			__returnValue.bindNativeObject(__instancePointer, "CLasQueryResult");
		}
		return __returnValue;
	}
	public Evlaslayer(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Evlaslayer(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Evlaslayer fromBaseObject(BaseObject baseObj)
	{
		...
		Evlaslayer obj = null;
 		if(baseObj instanceof Evlaslayer)
		{
			obj = (Evlaslayer)baseObj;
		} else {
