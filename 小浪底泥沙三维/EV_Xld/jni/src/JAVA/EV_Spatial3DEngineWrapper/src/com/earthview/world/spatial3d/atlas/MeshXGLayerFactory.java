 ...
 * 类工厂
 */
public class MeshXGLayerFactory extends com.earthview.world.spatial.atlas.Ilayerfactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::CMeshXGLayerFactory", new MeshXGLayerFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::JCMeshXGLayerFactoryProxy", new MeshXGLayerFactoryClassFactory());
	}

	/**
	 * 构造函数
	 */
	public MeshXGLayerFactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCMeshXGLayerFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.atlas.MeshXGLayerFactory".equals(this.getClass().getName()))
		{
	 ...
	 * 返回单例的图层工厂
	 */
	public static com.earthview.world.spatial3d.atlas.MeshXGLayerFactory getSingletonPtr()
	{
		long returnValue = getSingletonPtr_void();
		if(returnValue == 0L) {
			return null;
		}
		com.earthview.world.spatial3d.atlas.MeshXGLayerFactory __returnValue = new com.earthview.world.spatial3d.atlas.MeshXGLayerFactory(CreatedWhenConstruct.CWC_NotToCreate, "CMeshXGLayerFactory");
		...
		{
			__returnValue.setDelegate(true);
			__returnValue = (com.earthview.world.spatial3d.atlas.MeshXGLayerFactory)__returnValueClassFactory.create();
			__returnValue.setDelegate(true);
			__returnValue.bindNativeObject(__instancePointer, "CMeshXGLayerFactory");
		}
	...
	public MeshXGLayerFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public MeshXGLayerFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static MeshXGLayerFactory fromBaseObject(BaseObject baseObj)
	{
		...
		MeshXGLayerFactory obj = null;
 		if(baseObj instanceof MeshXGLayerFactory)
		{
			obj = (MeshXGLayerFactory)baseObj;
		} else {
