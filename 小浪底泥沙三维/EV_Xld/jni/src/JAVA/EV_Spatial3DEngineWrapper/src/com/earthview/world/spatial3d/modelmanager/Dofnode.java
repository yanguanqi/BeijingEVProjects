...
public class Dofnode extends com.earthview.world.spatial3d.modelmanager.FltBaseNode {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::ModelManager::CDOFNode", new DofnodeClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::ModelManager::JCDOFNodeProxy", new DofnodeClassFactory());
	}
	 ...
	 * @param name 分配的节点名称
	 */
	public Dofnode(String name, com.earthview.world.graphic.SceneManager ref_creator) {
		...
		Create("JCDOFNodeProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.modelmanager.Dofnode".equals(this.getClass().getName()))
		{
	...
	native private void setMinHPR_CVector3(long pNativeObject, long hpr);
	/**
	 * 更新节点内部方法
	 * @param updateChildren 为真，逐级更新所有子节点
	 * @param parentHasChanged 为true，表明父节点位置改变，子节点继承父节点变化
	 */
	public void setMinHPR(com.earthview.world.spatial.math.Vector3 hpr)
	{
		long hprParamValue = hpr.nativeObject.pointer;
		setMinHPR_CVector3(this.nativeObject.pointer, hprParamValue);
	}
	native private long getMinHPR_void(long pNativeObject);
	public com.earthview.world.spatial.math.Vector3 getMinHPR()
	{
		long returnValue = getMinHPR_void(this.nativeObject.pointer);
	...
	native private void setMaxHPR_CVector3(long pNativeObject, long hpr);
	public void setMaxHPR(com.earthview.world.spatial.math.Vector3 hpr)
	{
		long hprParamValue = hpr.nativeObject.pointer;
		setMaxHPR_CVector3(this.nativeObject.pointer, hprParamValue);
	}
	native private long getMaxHPR_void(long pNativeObject);
	public com.earthview.world.spatial.math.Vector3 getMaxHPR()
	{
		long returnValue = getMaxHPR_void(this.nativeObject.pointer);
		com.earthview.world.spatial.math.Vector3 __returnValue = new com.earthview.world.spatial.math.Vector3(CreatedWhenConstruct.CWC_NotToCreate, "CVector3");
		__returnValue.setDelegate(true);
		InstancePointer __instancePointer = new InstancePointer(returnValue);
		__returnValue.setInstancePointer(__instancePointer);
	...
	native private void setIncrementHPR_CVector3(long pNativeObject, long hpr);
	public void setIncrementHPR(com.earthview.world.spatial.math.Vector3 hpr)
	{
		long hprParamValue = hpr.nativeObject.pointer;
		setIncrementHPR_CVector3(this.nativeObject.pointer, hprParamValue);
	}
	native private long getIncrementHPR_void(long pNativeObject);
	public com.earthview.world.spatial.math.Vector3 getIncrementHPR()
	{
		long returnValue = getIncrementHPR_void(this.nativeObject.pointer);
		com.earthview.world.spatial.math.Vector3 __returnValue = new com.earthview.world.spatial.math.Vector3(CreatedWhenConstruct.CWC_NotToCreate, "CVector3");
		__returnValue.setDelegate(true);
		InstancePointer __instancePointer = new InstancePointer(returnValue);
		__returnValue.setInstancePointer(__instancePointer);
	...
	native private void setCurrentHPR_CVector3(long pNativeObject, long hpr);
	public void setCurrentHPR(com.earthview.world.spatial.math.Vector3 hpr)
	{
		long hprParamValue = hpr.nativeObject.pointer;
		setCurrentHPR_CVector3(this.nativeObject.pointer, hprParamValue);
	}
	native private long getCurrentHPR_void(long pNativeObject);
	public com.earthview.world.spatial.math.Vector3 getCurrentHPR()
	{
		long returnValue = getCurrentHPR_void(this.nativeObject.pointer);
		com.earthview.world.spatial.math.Vector3 __returnValue = new com.earthview.world.spatial.math.Vector3(CreatedWhenConstruct.CWC_NotToCreate, "CVector3");
		__returnValue.setDelegate(true);
		InstancePointer __instancePointer = new InstancePointer(returnValue);
		__returnValue.setInstancePointer(__instancePointer);
	...
	native private void setMinTranslate_CVector3(long pNativeObject, long translate);
	public void setMinTranslate(com.earthview.world.spatial.math.Vector3 translate)
	{
		long translateParamValue = translate.nativeObject.pointer;
		setMinTranslate_CVector3(this.nativeObject.pointer, translateParamValue);
	}
	native private long getMinTranslate_void(long pNativeObject);
	public com.earthview.world.spatial.math.Vector3 getMinTranslate()
	{
		long returnValue = getMinTranslate_void(this.nativeObject.pointer);
		com.earthview.world.spatial.math.Vector3 __returnValue = new com.earthview.world.spatial.math.Vector3(CreatedWhenConstruct.CWC_NotToCreate, "CVector3");
		__returnValue.setDelegate(true);
		InstancePointer __instancePointer = new InstancePointer(returnValue);
		__returnValue.setInstancePointer(__instancePointer);
	...
	native private void setMaxTranslate_CVector3(long pNativeObject, long translate);
	public void setMaxTranslate(com.earthview.world.spatial.math.Vector3 translate)
	{
		long translateParamValue = translate.nativeObject.pointer;
		setMaxTranslate_CVector3(this.nativeObject.pointer, translateParamValue);
	}
	native private long getMaxTranslate_void(long pNativeObject);
	public com.earthview.world.spatial.math.Vector3 getMaxTranslate()
	{
		long returnValue = getMaxTranslate_void(this.nativeObject.pointer);
		com.earthview.world.spatial.math.Vector3 __returnValue = new com.earthview.world.spatial.math.Vector3(CreatedWhenConstruct.CWC_NotToCreate, "CVector3");
		__returnValue.setDelegate(true);
		InstancePointer __instancePointer = new InstancePointer(returnValue);
		__returnValue.setInstancePointer(__instancePointer);
	...
	native private void setIncrementTranslate_CVector3(long pNativeObject, long translate);
	public void setIncrementTranslate(com.earthview.world.spatial.math.Vector3 translate)
	{
		long translateParamValue = translate.nativeObject.pointer;
		setIncrementTranslate_CVector3(this.nativeObject.pointer, translateParamValue);
	}
	native private long getIncrementTranslate_void(long pNativeObject);
	public com.earthview.world.spatial.math.Vector3 getIncrementTranslate()
	{
		long returnValue = getIncrementTranslate_void(this.nativeObject.pointer);
		com.earthview.world.spatial.math.Vector3 __returnValue = new com.earthview.world.spatial.math.Vector3(CreatedWhenConstruct.CWC_NotToCreate, "CVector3");
		__returnValue.setDelegate(true);
		InstancePointer __instancePointer = new InstancePointer(returnValue);
		__returnValue.setInstancePointer(__instancePointer);
	...
	native private void setCurrentTranslate_CVector3(long pNativeObject, long translate);
	public void setCurrentTranslate(com.earthview.world.spatial.math.Vector3 translate)
	{
		long translateParamValue = translate.nativeObject.pointer;
		setCurrentTranslate_CVector3(this.nativeObject.pointer, translateParamValue);
	}
	native private long getCurrentTranslate_void(long pNativeObject);
	public com.earthview.world.spatial.math.Vector3 getCurrentTranslate()
	{
		long returnValue = getCurrentTranslate_void(this.nativeObject.pointer);
		com.earthview.world.spatial.math.Vector3 __returnValue = new com.earthview.world.spatial.math.Vector3(CreatedWhenConstruct.CWC_NotToCreate, "CVector3");
		__returnValue.setDelegate(true);
		InstancePointer __instancePointer = new InstancePointer(returnValue);
		__returnValue.setInstancePointer(__instancePointer);
	...
	native private void setMinScale_CVector3(long pNativeObject, long scale);
	public void setMinScale(com.earthview.world.spatial.math.Vector3 scale)
	{
		long scaleParamValue = scale.nativeObject.pointer;
		setMinScale_CVector3(this.nativeObject.pointer, scaleParamValue);
	}
	native private long getMinScale_void(long pNativeObject);
	public com.earthview.world.spatial.math.Vector3 getMinScale()
	{
	...
	native private void setMaxScale_CVector3(long pNativeObject, long scale);
	public void setMaxScale(com.earthview.world.spatial.math.Vector3 scale)
	{
		long scaleParamValue = scale.nativeObject.pointer;
		setMaxScale_CVector3(this.nativeObject.pointer, scaleParamValue);
	}
	native private long getMaxScale_void(long pNativeObject);
	public com.earthview.world.spatial.math.Vector3 getMaxScale()
	{
	...
	native private void setIncrementScale_CVector3(long pNativeObject, long scale);
	public void setIncrementScale(com.earthview.world.spatial.math.Vector3 scale)
	{
		long scaleParamValue = scale.nativeObject.pointer;
		setIncrementScale_CVector3(this.nativeObject.pointer, scaleParamValue);
	}
	native private long getIncrementScale_void(long pNativeObject);
	public com.earthview.world.spatial.math.Vector3 getIncrementScale()
	{
		long returnValue = getIncrementScale_void(this.nativeObject.pointer);
		com.earthview.world.spatial.math.Vector3 __returnValue = new com.earthview.world.spatial.math.Vector3(CreatedWhenConstruct.CWC_NotToCreate, "CVector3");
		__returnValue.setDelegate(true);
		InstancePointer __instancePointer = new InstancePointer(returnValue);
		__returnValue.setInstancePointer(__instancePointer);
	...
	native private void setCurrentScale_CVector3(long pNativeObject, long scale);
	public void setCurrentScale(com.earthview.world.spatial.math.Vector3 scale)
	{
		long scaleParamValue = scale.nativeObject.pointer;
		setCurrentScale_CVector3(this.nativeObject.pointer, scaleParamValue);
	}
	native private long getCurrentScale_void(long pNativeObject);
	public com.earthview.world.spatial.math.Vector3 getCurrentScale()
	{
		long returnValue = getCurrentScale_void(this.nativeObject.pointer);
		com.earthview.world.spatial.math.Vector3 __returnValue = new com.earthview.world.spatial.math.Vector3(CreatedWhenConstruct.CWC_NotToCreate, "CVector3");
		__returnValue.setDelegate(true);
		InstancePointer __instancePointer = new InstancePointer(returnValue);
		__returnValue.setInstancePointer(__instancePointer);
	...
	native private void setPutMatrix_CMatrix4(long pNativeObject, long put);
	public void setPutMatrix(com.earthview.world.spatial.math.Matrix4 put)
	{
		long putParamValue = put.nativeObject.pointer;
		setPutMatrix_CMatrix4(this.nativeObject.pointer, putParamValue);
	}
	native private long getPutMatrix_void(long pNativeObject);
	public com.earthview.world.spatial.math.Matrix4 getPutMatrix()
	{
		long returnValue = getPutMatrix_void(this.nativeObject.pointer);
	...
	native private void setInversePutMatrix_CMatrix4(long pNativeObject, long inversePut);
	public void setInversePutMatrix(com.earthview.world.spatial.math.Matrix4 inversePut)
	{
		long inversePutParamValue = inversePut.nativeObject.pointer;
		setInversePutMatrix_CMatrix4(this.nativeObject.pointer, inversePutParamValue);
	}
	native private long getInversePutMatrix_void(long pNativeObject);
	public com.earthview.world.spatial.math.Matrix4 getInversePutMatrix()
	{
		long returnValue = getInversePutMatrix_void(this.nativeObject.pointer);
		com.earthview.world.spatial.math.Matrix4 __returnValue = new com.earthview.world.spatial.math.Matrix4(CreatedWhenConstruct.CWC_NotToCreate, "CMatrix4");
		__returnValue.setDelegate(true);
		InstancePointer __instancePointer = new InstancePointer(returnValue);
		__returnValue.setInstancePointer(__instancePointer);
	...
	public enum EVLimitationFlag implements INativeEnum<EVLimitationFlag> {
		LF_SCALE_X(EVLimitationFlagHelper.ENUM_VALUES[0]),
		LF_SCALE_Y(EVLimitationFlagHelper.ENUM_VALUES[1]),
		LF_SCALE_Z(EVLimitationFlagHelper.ENUM_VALUES[2]),
		LF_ROTATION_X(EVLimitationFlagHelper.ENUM_VALUES[3]),
		LF_ROTATION_Y(EVLimitationFlagHelper.ENUM_VALUES[4]),
		LF_ROTATION_Z(EVLimitationFlagHelper.ENUM_VALUES[5]),
		LF_TRANSLATE_X(EVLimitationFlagHelper.ENUM_VALUES[6]),
		LF_TRANSLATE_Y(EVLimitationFlagHelper.ENUM_VALUES[7]),
		LF_TRANSLATE_Z(EVLimitationFlagHelper.ENUM_VALUES[8]);
		private int value;
		EVLimitationFlag(int i) {
			this.value = i;
		}
		public EVLimitationFlag getEnum(int val) {
			return toEnum(val);
		}
		public int getValue() {
			return this.value;
		}
		public static final EVLimitationFlag toEnum(int retval) {
			if(retval == LF_SCALE_X.value){
				return LF_SCALE_X;
			}
			else if(retval == LF_SCALE_Y.value){
				return LF_SCALE_Y;
			}
			else if(retval == LF_SCALE_Z.value){
				return LF_SCALE_Z;
			}
			else if(retval == LF_ROTATION_X.value){
				return LF_ROTATION_X;
			}
			else if(retval == LF_ROTATION_Y.value){
				return LF_ROTATION_Y;
			}
			else if(retval == LF_ROTATION_Z.value){
				return LF_ROTATION_Z;
			}
			else if(retval == LF_TRANSLATE_X.value){
				return LF_TRANSLATE_X;
			}
			else if(retval == LF_TRANSLATE_Y.value){
				return LF_TRANSLATE_Y;
			}
			else if(retval == LF_TRANSLATE_Z.value){
				return LF_TRANSLATE_Z;
			}
			throw new RuntimeException("wrong number in jni call for an enum!");
		}
	}
	static class EVLimitationFlagHelper {
		public static final int[] ENUM_VALUES = getEnumValues();
		private static native int[] getEnumValues();
	}
	
	native private void setLimitationFlags_ev_uint64(long pNativeObject, long flags);
	public void setLimitationFlags(ULongPointer flags)
	{
		long flagsParamValue = flags.nativeObject.pointer;
		setLimitationFlags_ev_uint64(this.nativeObject.pointer, flagsParamValue);
	}
	native private String getLimitationFlags_void(long pNativeObject);
	public ULongPointer getLimitationFlags()
	{
		String returnValue = getLimitationFlags_void(this.nativeObject.pointer);
		ULongPointer __returnValue = new ULongPointer(returnValue);
		return __returnValue;
	}
	native private void setLimitationFlags_EVLimitationFlag_ev_bool(long pNativeObject, int limitFlag, boolean flag);
	public void setLimitationFlags(com.earthview.world.spatial3d.modelmanager.Dofnode.EVLimitationFlag limitFlag, boolean flag)
	{
		int limitFlagParamValue = limitFlag.getValue();
		boolean flagParamValue = flag;
		setLimitationFlags_EVLimitationFlag_ev_bool(this.nativeObject.pointer, limitFlagParamValue, flagParamValue);
	}
	native private boolean getLimitationFlags_EVLimitationFlag(long pNativeObject, int limitFlag);
	public boolean getLimitationFlags(com.earthview.world.spatial3d.modelmanager.Dofnode.EVLimitationFlag limitFlag)
	{
		int limitFlagParamValue = limitFlag.getValue();
		boolean returnValue = getLimitationFlags_EVLimitationFlag(this.nativeObject.pointer, limitFlagParamValue);
		return returnValue;
	}
	///
	public enum EVMultOrder implements INativeEnum<EVMultOrder> {
		MO_PRH(EVMultOrderHelper.ENUM_VALUES[0]),
		MO_PHR(EVMultOrderHelper.ENUM_VALUES[1]),
		MO_HPR(EVMultOrderHelper.ENUM_VALUES[2]),
		MO_HRP(EVMultOrderHelper.ENUM_VALUES[3]),
		MO_RPH(EVMultOrderHelper.ENUM_VALUES[4]),
		MO_RHP(EVMultOrderHelper.ENUM_VALUES[5]);
		private int value;
		EVMultOrder(int i) {
			this.value = i;
		}
		public EVMultOrder getEnum(int val) {
			return toEnum(val);
		}
		public int getValue() {
			return this.value;
		}
		public static final EVMultOrder toEnum(int retval) {
			if(retval == MO_PRH.value){
				return MO_PRH;
			}
			else if(retval == MO_PHR.value){
				return MO_PHR;
			}
			else if(retval == MO_HPR.value){
				return MO_HPR;
			}
			else if(retval == MO_HRP.value){
				return MO_HRP;
			}
			else if(retval == MO_RPH.value){
				return MO_RPH;
			}
			else if(retval == MO_RHP.value){
				return MO_RHP;
			}
			throw new RuntimeException("wrong number in jni call for an enum!");
		}
	}
	static class EVMultOrderHelper {
		public static final int[] ENUM_VALUES = getEnumValues();
		private static native int[] getEnumValues();
	}
	
	native private void setHPRMultOrder_EVMultOrder(long pNativeObject, int order);
	public void setHPRMultOrder(com.earthview.world.spatial3d.modelmanager.Dofnode.EVMultOrder order)
	{
		int orderParamValue = order.getValue();
		setHPRMultOrder_EVMultOrder(this.nativeObject.pointer, orderParamValue);
	}
	native private int getHPRMultOrder_void(long pNativeObject);
	public com.earthview.world.spatial3d.modelmanager.Dofnode.EVMultOrder getHPRMultOrder()
	{
		int returnValue = getHPRMultOrder_void(this.nativeObject.pointer);
		return com.earthview.world.spatial3d.modelmanager.Dofnode.EVMultOrder.toEnum(returnValue);
	}
	native private void setAnimationOn_ev_bool(long pNativeObject, boolean do_animate);
	public void setAnimationOn(boolean do_animate)
	{
		boolean do_animateParamValue = do_animate;
		setAnimationOn_ev_bool(this.nativeObject.pointer, do_animateParamValue);
	}
	native private boolean getAnimationOn_void(long pNativeObject);
	public boolean getAnimationOn()
	{
		boolean returnValue = getAnimationOn_void(this.nativeObject.pointer);
		return returnValue;
	}
	...
	native private void setAnimationPause_ev_bool(long pNativeObject, boolean pause_animate);
	public void setAnimationPause(boolean pause_animate)
	{
		boolean pause_animateParamValue = pause_animate;
		setAnimationPause_ev_bool(this.nativeObject.pointer, pause_animateParamValue);
	}
	native private boolean getAnimationPause_void(long pNativeObject);
	public boolean getAnimationPause()
	{
		boolean returnValue = getAnimationPause_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private void setAnimationLoop_ev_bool(long pNativeObject, boolean loop_animate);
	public void setAnimationLoop(boolean loop_animate)
	{
		boolean loop_animateParamValue = loop_animate;
		setAnimationLoop_ev_bool(this.nativeObject.pointer, loop_animateParamValue);
	}
	native private boolean getAnimationLoop_void(long pNativeObject);
	public boolean getAnimationLoop()
	{
		boolean returnValue = getAnimationLoop_void(this.nativeObject.pointer);
		return returnValue;
	}
	public Dofnode(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Dofnode(CreatedWhenConstruct cwc, String classNameStr) {
