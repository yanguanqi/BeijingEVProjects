 ...
 * 类工厂
 */
public class WebLasLayerFactory extends com.earthview.world.spatial.atlas.Ilayerfactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::CWebLasLayerFactory", new WebLasLayerFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::JCWebLasLayerFactoryProxy", new WebLasLayerFactoryClassFactory());
	}

	/**
	 * 构造函数
	 */
	public WebLasLayerFactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCWebLasLayerFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.atlas.WebLasLayerFactory".equals(this.getClass().getName()))
		{
	 ...
	 * 返回单例的图层工厂
	 */
	public static com.earthview.world.spatial3d.atlas.WebLasLayerFactory getSingletonPtr()
	{
		long returnValue = getSingletonPtr_void();
		if(returnValue == 0L) {
			return null;
		}
		com.earthview.world.spatial3d.atlas.WebLasLayerFactory __returnValue = new com.earthview.world.spatial3d.atlas.WebLasLayerFactory(CreatedWhenConstruct.CWC_NotToCreate, "CWebLasLayerFactory");
		...
		{
			__returnValue.setDelegate(true);
			__returnValue = (com.earthview.world.spatial3d.atlas.WebLasLayerFactory)__returnValueClassFactory.create();
			__returnValue.setDelegate(true);
			__returnValue.bindNativeObject(__instancePointer, "CWebLasLayerFactory");
		}
	...
	native private static String get_msWebLasLayerFactoryName_void();
	public static String get_msWebLasLayerFactoryName()
	{
		String jniValue = get_msWebLasLayerFactoryName_void();
		
		return jniValue;
	}
	
	public WebLasLayerFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public WebLasLayerFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static WebLasLayerFactory fromBaseObject(BaseObject baseObj)
	{
		...
		WebLasLayerFactory obj = null;
 		if(baseObj instanceof WebLasLayerFactory)
		{
			obj = (WebLasLayerFactory)baseObj;
		} else {
