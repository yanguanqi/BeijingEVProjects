...
public class MeshxgEditEvent extends com.earthview.world.spatial.systemui.DatasetEditEvent {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::ModelManager::CMeshxgEditEvent", new MeshxgEditEventClassFactory());
	}

	public MeshxgEditEvent(com.earthview.world.spatial.geodataset.Idataset dataset, int eventtype) {
	...
	public MeshxgEditEvent(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public MeshxgEditEvent(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static MeshxgEditEvent fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		MeshxgEditEvent obj = null;
 		if(baseObj instanceof MeshxgEditEvent)
		{
			obj = (MeshxgEditEvent)baseObj;
		} else {
			obj = new MeshxgEditEvent(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CMeshxgEditEvent");
			obj.increaseCast();
		}
