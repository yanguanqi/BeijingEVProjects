...
public class MeshXGDataSourceFactory extends com.earthview.world.spatial.geodataset.Idatasourcefactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::ModelManager::CMeshXGDataSourceFactory", new MeshXGDataSourceFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::ModelManager::JCMeshXGDataSourceFactoryProxy", new MeshXGDataSourceFactoryClassFactory());
	}

	/**
	 * 构造函数
	 */
	public MeshXGDataSourceFactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCMeshXGDataSourceFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.modelmanager.MeshXGDataSourceFactory".equals(this.getClass().getName()))
		{
	 ...
	 */
	public static com.earthview.world.spatial3d.modelmanager.MeshXGDataSourceFactory getSingletonPtr()
	{
		long returnValue = getSingletonPtr_void();
		if(returnValue == 0L) {
			return null;
		}
		com.earthview.world.spatial3d.modelmanager.MeshXGDataSourceFactory __returnValue = new com.earthview.world.spatial3d.modelmanager.MeshXGDataSourceFactory(CreatedWhenConstruct.CWC_NotToCreate, "CMeshXGDataSourceFactory");
		...
		{
			__returnValue.setDelegate(true);
			__returnValue = (com.earthview.world.spatial3d.modelmanager.MeshXGDataSourceFactory)__returnValueClassFactory.create();
			__returnValue.setDelegate(true);
			__returnValue.bindNativeObject(__instancePointer, "CMeshXGDataSourceFactory");
		}
	...
	public MeshXGDataSourceFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public MeshXGDataSourceFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static MeshXGDataSourceFactory fromBaseObject(BaseObject baseObj)
	{
		...
		MeshXGDataSourceFactory obj = null;
 		if(baseObj instanceof MeshXGDataSourceFactory)
		{
			obj = (MeshXGDataSourceFactory)baseObj;
		} else {
