 ...
 * 类工厂
 */
public class WebEVLasXGLayerFactory extends com.earthview.world.spatial.atlas.Ilayerfactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::CWebEVLasXGLayerFactory", new WebEVLasXGLayerFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::JCWebEVLasXGLayerFactoryProxy", new WebEVLasXGLayerFactoryClassFactory());
	}

	/**
	 * 构造函数
	 */
	public WebEVLasXGLayerFactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCWebEVLasXGLayerFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.atlas.WebEVLasXGLayerFactory".equals(this.getClass().getName()))
		{
	 ...
	 * 返回单例的图层工厂
	 */
	public static com.earthview.world.spatial3d.atlas.WebEVLasXGLayerFactory getSingletonPtr()
	{
		long returnValue = getSingletonPtr_void();
		if(returnValue == 0L) {
			return null;
		}
		com.earthview.world.spatial3d.atlas.WebEVLasXGLayerFactory __returnValue = new com.earthview.world.spatial3d.atlas.WebEVLasXGLayerFactory(CreatedWhenConstruct.CWC_NotToCreate, "CWebEVLasXGLayerFactory");
		...
		{
			__returnValue.setDelegate(true);
			__returnValue = (com.earthview.world.spatial3d.atlas.WebEVLasXGLayerFactory)__returnValueClassFactory.create();
			__returnValue.setDelegate(true);
			__returnValue.bindNativeObject(__instancePointer, "CWebEVLasXGLayerFactory");
		}
	...
	native private static String get_msWebLasXGLayerFactoryName_void();
	public static String get_msWebLasXGLayerFactoryName()
	{
		String jniValue = get_msWebLasXGLayerFactoryName_void();
		
		return jniValue;
	}
	
	public WebEVLasXGLayerFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public WebEVLasXGLayerFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static WebEVLasXGLayerFactory fromBaseObject(BaseObject baseObj)
	{
		...
		WebEVLasXGLayerFactory obj = null;
 		if(baseObj instanceof WebEVLasXGLayerFactory)
		{
			obj = (WebEVLasXGLayerFactory)baseObj;
		} else {
