...
public class Evlasxgdataset extends com.earthview.world.spatial3d.modelmanager.Iobqdataset {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::ModelManager::CEVLasXGDataset", new EvlasxgdatasetClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::ModelManager::JCEVLasXGDatasetProxy", new EvlasxgdatasetClassFactory());
	}

	/**
	 * 默认构造函数
	 */
	public Evlasxgdataset() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCEVLasXGDatasetProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.modelmanager.Evlasxgdataset".equals(this.getClass().getName()))
		{
	 ...
	 * @param  数据集的名字
	 */
	public Evlasxgdataset(String name, com.earthview.world.spatial.geodataset.Idatasource ref_DataSource) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		...
		Create("JCEVLasXGDatasetProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.modelmanager.Evlasxgdataset".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
	...
	native private boolean addObject_CEVLasxgEditingState(long pNativeObject, long st);
	public boolean addObject(com.earthview.world.spatial3d.modelmanager.Evlasxgeditingstate st)
	{
		long stParamValue = st.nativeObject.pointer;
		boolean returnValue = addObject_CEVLasxgEditingState(this.nativeObject.pointer, stParamValue);
		return returnValue;
	}
	native private boolean updateObject_CEVLasxgEditingState(long pNativeObject, long st);
	public boolean updateObject(com.earthview.world.spatial3d.modelmanager.Evlasxgeditingstate st)
	{
		long stParamValue = st.nativeObject.pointer;
		boolean returnValue = updateObject_CEVLasxgEditingState(this.nativeObject.pointer, stParamValue);
		return returnValue;
	}
	native private boolean getObject_ev_uint32_CEVLasxgEditingState(long pNativeObject, long id, long st);
	public boolean getObject(long id, com.earthview.world.spatial3d.modelmanager.Evlasxgeditingstate st)
	{
		long idParamValue = id;
		long stParamValue = st.nativeObject.pointer;
		boolean returnValue = getObject_ev_uint32_CEVLasxgEditingState(this.nativeObject.pointer, idParamValue, stParamValue);
		return returnValue;
	}
	native private boolean deleteObject_ev_uint32_CEVLasxgEditingState(long pNativeObject, long id, long st);
	public boolean deleteObject(long id, com.earthview.world.spatial3d.modelmanager.Evlasxgeditingstate st)
	{
		long idParamValue = id;
		long stParamValue = st.nativeObject.pointer;
		boolean returnValue = deleteObject_ev_uint32_CEVLasxgEditingState(this.nativeObject.pointer, idParamValue, stParamValue);
		return returnValue;
	}
	native private void getAddEditingStateMap_CEVLasxgEditingStateMap(long pNativeObject, long estm);
	public void getAddEditingStateMap(com.earthview.world.spatial3d.modelmanager.Evlasxgeditingstatemap estm)
	{
		long estmParamValue = estm.nativeObject.pointer;
		getAddEditingStateMap_CEVLasxgEditingStateMap(this.nativeObject.pointer, estmParamValue);
	}
	native private boolean findUpdateObject_ev_uint32_CEVLasxgEditingState(long pNativeObject, long id, long st);
	public boolean findUpdateObject(long id, com.earthview.world.spatial3d.modelmanager.Evlasxgeditingstate st)
	{
		long idParamValue = id;
		long stParamValue = st.nativeObject.pointer;
		boolean returnValue = findUpdateObject_ev_uint32_CEVLasxgEditingState(this.nativeObject.pointer, idParamValue, stParamValue);
		return returnValue;
	}
	...
	public Evlasxgdataset(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Evlasxgdataset(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Evlasxgdataset fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		Evlasxgdataset obj = null;
 		if(baseObj instanceof Evlasxgdataset)
		{
			obj = (Evlasxgdataset)baseObj;
		} else {
			obj = new Evlasxgdataset(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CEVLasXGDataset");
			obj.increaseCast();
		}
