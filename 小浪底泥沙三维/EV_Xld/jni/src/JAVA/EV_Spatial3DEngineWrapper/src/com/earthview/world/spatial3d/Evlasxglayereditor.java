...
public class Evlasxglayereditor extends com.earthview.world.spatial3d.Layer3DEditor {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::CEVLasxgLayerEditor", new EvlasxglayereditorClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::JCEVLasxgLayerEditorProxy", new EvlasxglayereditorClassFactory());
	}

	/**
	 * 构造函数
	 */
	public Evlasxglayereditor() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCEVLasxgLayerEditorProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.Evlasxglayereditor".equals(this.getClass().getName()))
		{
	...
	public Evlasxglayereditor(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Evlasxglayereditor(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Evlasxglayereditor fromBaseObject(BaseObject baseObj)
	{
		...
		Evlasxglayereditor obj = null;
 		if(baseObj instanceof Evlasxglayereditor)
		{
			obj = (Evlasxglayereditor)baseObj;
		} else {
