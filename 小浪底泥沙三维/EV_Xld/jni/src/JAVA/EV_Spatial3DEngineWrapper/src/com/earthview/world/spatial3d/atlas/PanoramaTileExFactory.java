...
public class PanoramaTileExFactory extends com.earthview.world.spatial3d.atlas.Igeometry3dfactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::CPanoramaTileExFactory", new PanoramaTileExFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::JCPanoramaTileExFactoryProxy", new PanoramaTileExFactoryClassFactory());
	}
	 ...
	 * @param  
	 */
	public PanoramaTileExFactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCPanoramaTileExFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.atlas.PanoramaTileExFactory".equals(this.getClass().getName()))
		{
	...
	public PanoramaTileExFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public PanoramaTileExFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static PanoramaTileExFactory fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		PanoramaTileExFactory obj = null;
 		if(baseObj instanceof PanoramaTileExFactory)
		{
			obj = (PanoramaTileExFactory)baseObj;
		} else {
			obj = new PanoramaTileExFactory(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CPanoramaTileExFactory");
			obj.increaseCast();
		}
