...
public class Evlasdataset extends com.earthview.world.spatial3d.modelmanager.Iobqdataset {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::ModelManager::CEVLasDataset", new EvlasdatasetClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::ModelManager::JCEVLasDatasetProxy", new EvlasdatasetClassFactory());
	}
	...
	public Evlasdataset() {
		...
		Create("JCEVLasDatasetProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.modelmanager.Evlasdataset".equals(this.getClass().getName()))
		{
	 ...
	 * @param  数据集的名字
	 */
	public Evlasdataset(String name, com.earthview.world.spatial.geodataset.Idatasource ref_DataSource) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		...
		Create("JCEVLasDatasetProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.modelmanager.Evlasdataset".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
	...
	public Evlasdataset(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Evlasdataset(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Evlasdataset fromBaseObject(BaseObject baseObj)
	{
		...
		Evlasdataset obj = null;
 		if(baseObj instanceof Evlasdataset)
		{
			obj = (Evlasdataset)baseObj;
		} else {
