...
public class LocalDemDataSource extends com.earthview.world.spatial.geodataset.Ifiledatasource {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::CLocalDemDataSource", new LocalDemDataSourceClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::JCLocalDemDataSourceProxy", new LocalDemDataSourceClassFactory());
	}

	public LocalDemDataSource(String datasourcePath, String aliasname) {
		...
		Create("JCLocalDemDataSourceProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.LocalDemDataSource".equals(this.getClass().getName()))
		{
	...
	public LocalDemDataSource(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public LocalDemDataSource(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static LocalDemDataSource fromBaseObject(BaseObject baseObj)
	{
		...
		LocalDemDataSource obj = null;
 		if(baseObj instanceof LocalDemDataSource)
		{
			obj = (LocalDemDataSource)baseObj;
		} else {
