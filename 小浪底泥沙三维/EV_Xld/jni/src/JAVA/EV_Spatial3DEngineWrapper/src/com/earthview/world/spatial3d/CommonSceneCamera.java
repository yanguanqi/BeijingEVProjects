...
/**
 * 通用场景相机类此类定义了通用场景中相机的主要操作
 */
public class CommonSceneCamera extends com.earthview.world.graphic.OctreeCamera {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::CCommonSceneCamera", new CommonSceneCameraClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::JCCommonSceneCameraProxy", new CommonSceneCameraClassFactory());
	}
	 ...
	 * @param ref_sm 场景管理器
	 */
	public CommonSceneCamera(String name, com.earthview.world.graphic.SceneManager ref_sm) {
		...
		Create("JCCommonSceneCameraProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.CommonSceneCamera".equals(this.getClass().getName()))
		{
	...
	native private void computeAngles_void(long pNativeObject);
	/**
	 * 初始角度
	 * @param  
	 */
	...
	{
		computeAngles_void(this.nativeObject.pointer);
	}
	native private void setRotationParam_CVector3_CRadian(long pNativeObject, long axisofRotation, long degreePerFrame);
	/**
	 * 设置旋转参数
	 * @param axisofRotation 旋转轴
	 * @param degreePerFrame 每帧旋转角度
	 */
	public void setRotationParam(com.earthview.world.spatial.math.Vector3 axisofRotation, com.earthview.world.spatial.math.Radian degreePerFrame)
	{
		long axisofRotationParamValue = axisofRotation.nativeObject.pointer;
		long degreePerFrameParamValue = degreePerFrame.nativeObject.pointer;
		setRotationParam_CVector3_CRadian(this.nativeObject.pointer, axisofRotationParamValue, degreePerFrameParamValue);
	}
	native private boolean OperatorEquals_CCommonSceneCamera(long pNativeObject, long rhs);
	/**
	 * 判断是否为同一个相机
	 * @param rhs 目标相机
	 * @return 判断结果
	 */
	public boolean OperatorEquals(com.earthview.world.spatial3d.CommonSceneCamera rhs)
	{
		long rhsParamValue = rhs.nativeObject.pointer;
		boolean returnValue = OperatorEquals_CCommonSceneCamera(this.nativeObject.pointer, rhsParamValue);
		return returnValue;
	}
	native private boolean OperatorNotEquals_CCommonSceneCamera(long pNativeObject, long rhs);
	/**
	 * 判断是否为同一个相机
	 * @param rhs 目标相机
	 * @return 判断结果
	 */
	public boolean OperatorNotEquals(com.earthview.world.spatial3d.CommonSceneCamera rhs)
	{
		long rhsParamValue = rhs.nativeObject.pointer;
		boolean returnValue = OperatorNotEquals_CCommonSceneCamera(this.nativeObject.pointer, rhsParamValue);
		return returnValue;
	}
	native private void OperatorAssign_CCommonSceneCamera(long pNativeObject, long rhs);
	/**
	 * 赋值运算符重载
	 * @param rhs 目标相机
	 */
	public void OperatorAssign(com.earthview.world.spatial3d.CommonSceneCamera rhs)
	{
		long rhsParamValue = rhs.nativeObject.pointer;
		OperatorAssign_CCommonSceneCamera(this.nativeObject.pointer, rhsParamValue);
	}
	...
	native private void setRightVector_CVector3(long pNativeObject, long rightVector);
	/**
	 * 设置相机的右方向
	 * @param rightVector 右方向
	 */
	public void setRightVector(com.earthview.world.spatial.math.Vector3 rightVector)
	{
		long rightVectorParamValue = rightVector.nativeObject.pointer;
		setRightVector_CVector3(this.nativeObject.pointer, rightVectorParamValue);
	}
	...
	native private double getAlititude_void(long pNativeObject);
	/**
	 * 获取相机的高度
	 * @param  
	 * @return 高度
	...
	{
		double returnValue = getAlititude_void(this.nativeObject.pointer);
		return returnValue;
	}
	...
	native private long getMinTilt_void(long pNativeObject);
	/**
	 * 获取最小俯仰角
	 * @param  
	 * @return 最小俯仰角
	 */
	public com.earthview.world.spatial.math.Degree getMinTilt()
	{
		long returnValue = getMinTilt_void(this.nativeObject.pointer);
		com.earthview.world.spatial.math.Degree __returnValue = new com.earthview.world.spatial.math.Degree(CreatedWhenConstruct.CWC_NotToCreate, "CDegree");
		__returnValue.setDelegate(true);
		InstancePointer __instancePointer = new InstancePointer(returnValue);
		__returnValue.setInstancePointer(__instancePointer);
	...
	native private void setMouseEvent_ev_bool(long pNativeObject, boolean mouseEvent);
	/**
	 * 设置鼠标事件
	...
	{
		boolean mouseEventParamValue = mouseEvent;
		setMouseEvent_ev_bool(this.nativeObject.pointer, mouseEventParamValue);
	}
	native private boolean getMouseEvent_void(long pNativeObject);
	/**
	 * 获取鼠标事件
	 * @param  
	 */
	...
	{
		boolean returnValue = getMouseEvent_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private void setWheelEvent_ev_bool(long pNativeObject, boolean wheelEvent);
	/**
	 * 设置滚轮事件
	 * @param wheelEvent 滚轮事件
	 */
	public void setWheelEvent(boolean wheelEvent)
	{
		boolean wheelEventParamValue = wheelEvent;
		setWheelEvent_ev_bool(this.nativeObject.pointer, wheelEventParamValue);
	}
	native private boolean getWheelEvent_void(long pNativeObject);
	/**
	 * 获取滚轮事件
	 * @param  
	 */
	public boolean getWheelEvent()
	{
		boolean returnValue = getWheelEvent_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private void computeAlitude_CVector3_CPlane(long pNativeObject, long position, long plane);
	/**
	 * 计算相机的高度
	 * @param position 相机的高度
	 * @param plane 参考平面
	 */
	public void computeAlitude(com.earthview.world.spatial.math.Vector3 position, com.earthview.world.spatial.math.Plane plane)
	{
		long positionParamValue = position.nativeObject.pointer;
		long planeParamValue = plane.nativeObject.pointer;
		computeAlitude_CVector3_CPlane(this.nativeObject.pointer, positionParamValue, planeParamValue);
	}
	native private void computeDistance_CVector3_CVector3(long pNativeObject, long point1, long point2);
	/**
	 * 计算相机和目标间的距离
	 * @param point1 相机的位置
	 * @param point2 目标的位置
	 */
	public void computeDistance(com.earthview.world.spatial.math.Vector3 point1, com.earthview.world.spatial.math.Vector3 point2)
	{
		long point1ParamValue = point1.nativeObject.pointer;
		long point2ParamValue = point2.nativeObject.pointer;
		computeDistance_CVector3_CVector3(this.nativeObject.pointer, point1ParamValue, point2ParamValue);
	}
	native private void setCameraState_CVector3_CDegree_CDegree(long pNativeObject, long position, long heading, long tilt);
	/**
	 * 设置相机的状态
	 * @param position 相机的位置
	 * @param heading 相机的偏航角
	 * @param tilt 相机的俯仰角
	 */
	public void setCameraState(com.earthview.world.spatial.math.Vector3 position, com.earthview.world.spatial.math.Degree heading, com.earthview.world.spatial.math.Degree tilt)
	{
		long positionParamValue = position.nativeObject.pointer;
		long headingParamValue = heading.nativeObject.pointer;
		long tiltParamValue = tilt.nativeObject.pointer;
		setCameraState_CVector3_CDegree_CDegree(this.nativeObject.pointer, positionParamValue, headingParamValue, tiltParamValue);
	}
	...
	native private long computeAxisMatrix_CVector3(long pNativeObject, long position);
	/**
	 * 计算相机的世界变换矩阵
	 * @param position 相机的位置
	 * @return 结果矩阵
	 */
	public com.earthview.world.spatial.math.Matrix3 computeAxisMatrix(com.earthview.world.spatial.math.Vector3 position)
	{
		long positionParamValue = position.nativeObject.pointer;
		long returnValue = computeAxisMatrix_CVector3(this.nativeObject.pointer, positionParamValue);
	...
	native private void setViewMatrix_CMatrix4(long pNativeObject, long viewMatrix);
	/**
	 * 设置相机的观察矩阵
	 * @param viewMatrix 观察矩阵
	 */
	public void setViewMatrix(com.earthview.world.spatial.math.Matrix4 viewMatrix)
	{
		long viewMatrixParamValue = viewMatrix.nativeObject.pointer;
		setViewMatrix_CMatrix4(this.nativeObject.pointer, viewMatrixParamValue);
	}
	native private void setViewMatrix_CVector3_CVector3_CVector3(long pNativeObject, long observer, long target, long upVector);
	/**
	 * 设置相机的观察矩阵
	 * @param observer 观察位置
	 * @param target 观察目标
	 * @param upVector 相机的上方向
	 */
	public void setViewMatrix(com.earthview.world.spatial.math.Vector3 observer, com.earthview.world.spatial.math.Vector3 target, com.earthview.world.spatial.math.Vector3 upVector)
	{
		long observerParamValue = observer.nativeObject.pointer;
		long targetParamValue = target.nativeObject.pointer;
		long upVectorParamValue = upVector.nativeObject.pointer;
		setViewMatrix_CVector3_CVector3_CVector3(this.nativeObject.pointer, observerParamValue, targetParamValue, upVectorParamValue);
	}
	native private void setInitViewMatrix_CVector3_CVector3_CVector3(long pNativeObject, long Position, long target, long upVector);
	/**
	 * 设置相机的初始观察矩阵
	 * @param Position 相机位置
	 * @param target 观察目标
	 * @param upVector 相机的上方向
	 */
	public void setInitViewMatrix(com.earthview.world.spatial.math.Vector3 Position, com.earthview.world.spatial.math.Vector3 target, com.earthview.world.spatial.math.Vector3 upVector)
	{
		long PositionParamValue = Position.nativeObject.pointer;
		long targetParamValue = target.nativeObject.pointer;
		long upVectorParamValue = upVector.nativeObject.pointer;
		setInitViewMatrix_CVector3_CVector3_CVector3(this.nativeObject.pointer, PositionParamValue, targetParamValue, upVectorParamValue);
	}
	...
	native private boolean get_misCameraInitialized_void(long pNativeObject);
	public boolean get_misCameraInitialized()
	{
		boolean jniValue = get_misCameraInitialized_void(this.nativeObject.pointer);
		
		return jniValue;
	}
	
	native private void set_misCameraInitialized_ev_bool (long pNativeObject, boolean value);
	public void set_misCameraInitialized(boolean misCameraInitialized)
	{
		boolean misCameraInitializedParamValue = misCameraInitialized;
		
		set_misCameraInitialized_ev_bool(this.nativeObject.pointer, misCameraInitializedParamValue);
	}
	
	native private long get_minitUpVector_void(long pNativeObject);
	public com.earthview.world.spatial.math.Vector3 get_minitUpVector()
	{
		long jniValue = get_minitUpVector_void(this.nativeObject.pointer);
	...
	native private void set_minitUpVector_CVector3 (long pNativeObject, long value);
	public void set_minitUpVector(com.earthview.world.spatial.math.Vector3 minitUpVector)
	{
		long minitUpVectorParamValue = minitUpVector.nativeObject.pointer;
		
		set_minitUpVector_CVector3(this.nativeObject.pointer, minitUpVectorParamValue);
	}
	
	native private long get_mInitialLookVector_void(long pNativeObject);
	public com.earthview.world.spatial.math.Vector3 get_mInitialLookVector()
	{
		long jniValue = get_mInitialLookVector_void(this.nativeObject.pointer);
	...
	native private void set_mInitialLookVector_CVector3 (long pNativeObject, long value);
	public void set_mInitialLookVector(com.earthview.world.spatial.math.Vector3 mInitialLookVector)
	{
		long mInitialLookVectorParamValue = mInitialLookVector.nativeObject.pointer;
		
		set_mInitialLookVector_CVector3(this.nativeObject.pointer, mInitialLookVectorParamValue);
	}
	
	native private long get_mCameraInitialPosition_void(long pNativeObject);
	public com.earthview.world.spatial.math.Vector3 get_mCameraInitialPosition()
	{
		long jniValue = get_mCameraInitialPosition_void(this.nativeObject.pointer);
	...
	native private void set_mCameraInitialPosition_CVector3 (long pNativeObject, long value);
	public void set_mCameraInitialPosition(com.earthview.world.spatial.math.Vector3 mCameraInitialPosition)
	{
		long mCameraInitialPositionParamValue = mCameraInitialPosition.nativeObject.pointer;
		
		set_mCameraInitialPosition_CVector3(this.nativeObject.pointer, mCameraInitialPositionParamValue);
	}
	
	native private long get_mCommonSceneManager_void(long pNativeObject);
	public com.earthview.world.spatial3d.CommonSceneManager get_mCommonSceneManager()
	{
		long jniValue = get_mCommonSceneManager_void(this.nativeObject.pointer);
		
		if(jniValue == 0L) {
			return null;
		}
		com.earthview.world.spatial3d.CommonSceneManager __returnValue = new com.earthview.world.spatial3d.CommonSceneManager(CreatedWhenConstruct.CWC_NotToCreate, "CCommonSceneManager");
		__returnValue.setDelegate(true);
		InstancePointer __instancePointer = new InstancePointer(jniValue);
		__returnValue.setInstancePointer(__instancePointer);
		IClassFactory __returnValueClassFactory = GlobalClassFactoryMap.get(__returnValue.getCppInstanceTypeName());
		...
		{
			__returnValue.setDelegate(true);
			__returnValue = (com.earthview.world.spatial3d.CommonSceneManager)__returnValueClassFactory.create();
			__returnValue.setDelegate(true);
			__returnValue.bindNativeObject(__instancePointer, "CCommonSceneManager");
		}
		return __returnValue;
	}
	
	native private void set_mCommonSceneManager_CCommonSceneManager (long pNativeObject, long value);
	public void set_mCommonSceneManager(com.earthview.world.spatial3d.CommonSceneManager mCommonSceneManager)
	{
		long mCommonSceneManagerParamValue = (mCommonSceneManager == null ? 0L : mCommonSceneManager.nativeObject.pointer);
		
		set_mCommonSceneManager_CCommonSceneManager(this.nativeObject.pointer, mCommonSceneManagerParamValue);
	}
	
	native private long get_mlastRightVector_void(long pNativeObject);
	public com.earthview.world.spatial.math.Vector3 get_mlastRightVector()
	{
		long jniValue = get_mlastRightVector_void(this.nativeObject.pointer);
	...
	native private void set_mlastRightVector_CVector3 (long pNativeObject, long value);
	public void set_mlastRightVector(com.earthview.world.spatial.math.Vector3 mlastRightVector)
	{
		long mlastRightVectorParamValue = mlastRightVector.nativeObject.pointer;
		
		set_mlastRightVector_CVector3(this.nativeObject.pointer, mlastRightVectorParamValue);
	}
	
	native private long get_mAngleX_void(long pNativeObject);
	public com.earthview.world.spatial.math.Radian get_mAngleX()
	{
		long jniValue = get_mAngleX_void(this.nativeObject.pointer);
	...
	native private void set_mAngleX_CRadian (long pNativeObject, long value);
	public void set_mAngleX(com.earthview.world.spatial.math.Radian mAngleX)
	{
		long mAngleXParamValue = mAngleX.nativeObject.pointer;
		
		set_mAngleX_CRadian(this.nativeObject.pointer, mAngleXParamValue);
	}
	
	native private long get_mAngleY_void(long pNativeObject);
	public com.earthview.world.spatial.math.Radian get_mAngleY()
	{
		long jniValue = get_mAngleY_void(this.nativeObject.pointer);
	...
	native private void set_mAngleY_CRadian (long pNativeObject, long value);
	public void set_mAngleY(com.earthview.world.spatial.math.Radian mAngleY)
	{
		long mAngleYParamValue = mAngleY.nativeObject.pointer;
		
		set_mAngleY_CRadian(this.nativeObject.pointer, mAngleYParamValue);
	}
	
	native private long get_mAxisofRotation_void(long pNativeObject);
	public com.earthview.world.spatial.math.Vector3 get_mAxisofRotation()
	{
		long jniValue = get_mAxisofRotation_void(this.nativeObject.pointer);
	...
	native private void set_mAxisofRotation_CVector3 (long pNativeObject, long value);
	public void set_mAxisofRotation(com.earthview.world.spatial.math.Vector3 mAxisofRotation)
	{
		long mAxisofRotationParamValue = mAxisofRotation.nativeObject.pointer;
		
		set_mAxisofRotation_CVector3(this.nativeObject.pointer, mAxisofRotationParamValue);
	}
	
	native private long get_mDegreePerFrame_void(long pNativeObject);
	public com.earthview.world.spatial.math.Radian get_mDegreePerFrame()
	{
		long jniValue = get_mDegreePerFrame_void(this.nativeObject.pointer);
	...
	native private void set_mDegreePerFrame_CRadian (long pNativeObject, long value);
	public void set_mDegreePerFrame(com.earthview.world.spatial.math.Radian mDegreePerFrame)
	{
		long mDegreePerFrameParamValue = mDegreePerFrame.nativeObject.pointer;
		
		set_mDegreePerFrame_CRadian(this.nativeObject.pointer, mDegreePerFrameParamValue);
	}
	
	native private boolean get_mMouseEvent_void(long pNativeObject);
	public boolean get_mMouseEvent()
	{
		boolean jniValue = get_mMouseEvent_void(this.nativeObject.pointer);
		
		return jniValue;
	}
	
	native private void set_mMouseEvent_ev_bool (long pNativeObject, boolean value);
	public void set_mMouseEvent(boolean mMouseEvent)
	{
		boolean mMouseEventParamValue = mMouseEvent;
		
		set_mMouseEvent_ev_bool(this.nativeObject.pointer, mMouseEventParamValue);
	}
	
	native private boolean get_mWheelEvent_void(long pNativeObject);
	public boolean get_mWheelEvent()
	{
		boolean jniValue = get_mWheelEvent_void(this.nativeObject.pointer);
		
		return jniValue;
	}
	
	native private void set_mWheelEvent_ev_bool (long pNativeObject, boolean value);
	public void set_mWheelEvent(boolean mWheelEvent)
	{
		boolean mWheelEventParamValue = mWheelEvent;
		
		set_mWheelEvent_ev_bool(this.nativeObject.pointer, mWheelEventParamValue);
	}
	
	public CommonSceneCamera(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommonSceneCamera(CreatedWhenConstruct cwc, String classNameStr) {
	...
	{
		return super.ev_clone_NoVirtual(newName);
	}
	...
	public static CommonSceneCamera fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		CommonSceneCamera obj = null;
 		if(baseObj instanceof CommonSceneCamera)
		{
			obj = (CommonSceneCamera)baseObj;
		} else {
			obj = new CommonSceneCamera(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CCommonSceneCamera");
			obj.increaseCast();
		}
