...
public class Smart3DDataset extends com.earthview.world.spatial3d.modelmanager.Iobqdataset {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::ModelManager::CSmart3DDataset", new Smart3DDatasetClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::ModelManager::JCSmart3DDatasetProxy", new Smart3DDatasetClassFactory());
	}

	/**
	 * 默认构造函数
	 */
	public Smart3DDataset() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCSmart3DDatasetProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.modelmanager.Smart3DDataset".equals(this.getClass().getName()))
		{
	 ...
	 * @param  数据集的名字
	 */
	public Smart3DDataset(String name, com.earthview.world.spatial.geodataset.Idatasource ref_DataSource) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		...
		Create("JCSmart3DDatasetProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.modelmanager.Smart3DDataset".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
	...
	protected  int readDem_ev_uint32_ev_uint32_ev_uint32_MemoryDataStreamPtr_callback(long level, long row, long col, long bilStream)
	{
		long levelParamValue = level;
		long rowParamValue = row;
		long colParamValue = col;
		com.earthview.world.core.MemoryDataStreamPtr bilStreamParamValue = new com.earthview.world.core.MemoryDataStreamPtr(CreatedWhenConstruct.CWC_NotToCreate);
		bilStreamParamValue.setDelegate(true);
		bilStreamParamValue.setInstancePointer(new InstancePointer(bilStream));
		IClassFactory bilStreamParamValueClassFactory = GlobalClassFactoryMap.get(bilStreamParamValue.getCppInstanceTypeName());
		if (bilStreamParamValueClassFactory != null)
		{
			bilStreamParamValue.setDelegate(true);
			bilStreamParamValue = (com.earthview.world.core.MemoryDataStreamPtr)bilStreamParamValueClassFactory.create();
			bilStreamParamValue.setDelegate(true);
			bilStreamParamValue.setInstancePointer(new InstancePointer(bilStream));
		}
		int returnValue = readDem(levelParamValue, rowParamValue, colParamValue, bilStreamParamValue);
	...
	native private int readDem_ev_uint32_ev_uint32_ev_uint32_MemoryDataStreamPtr_NoVirtual(long pNativeObject, long level, long row, long col, long bilStream);
	protected int readDem_NoVirtual(long level, long row, long col, com.earthview.world.core.MemoryDataStreamPtr bilStream)
	{
		long levelParamValue = level;
		long rowParamValue = row;
		long colParamValue = col;
		long bilStreamParamValue = bilStream.nativeObject.pointer;
		int returnValue = readDem_ev_uint32_ev_uint32_ev_uint32_MemoryDataStreamPtr_NoVirtual(this.nativeObject.pointer, levelParamValue, rowParamValue, colParamValue, bilStreamParamValue);
		return returnValue;
	}

	protected  boolean readDemMetaDataInfo_OBQDemMetaInfo_callback(long info)
	{
		com.earthview.world.spatial3d.modelmanager.Obqdemmetainfo infoParamValue = new com.earthview.world.spatial3d.modelmanager.Obqdemmetainfo(CreatedWhenConstruct.CWC_NotToCreate);
		...
		{
			infoParamValue.setDelegate(true);
			infoParamValue = (com.earthview.world.spatial3d.modelmanager.Obqdemmetainfo)infoParamValueClassFactory.create();
			infoParamValue.setDelegate(true);
			infoParamValue.setInstancePointer(new InstancePointer(info));
		}
		boolean returnValue = readDemMetaDataInfo(infoParamValue);
	...
	native private boolean readDemMetaDataInfo_OBQDemMetaInfo_NoVirtual(long pNativeObject, long info);
	protected boolean readDemMetaDataInfo_NoVirtual(com.earthview.world.spatial3d.modelmanager.Obqdemmetainfo info)
	{
		long infoParamValue = info.nativeObject.pointer;
		boolean returnValue = readDemMetaDataInfo_OBQDemMetaInfo_NoVirtual(this.nativeObject.pointer, infoParamValue);
		return returnValue;
	}

	public Smart3DDataset(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Smart3DDataset(CreatedWhenConstruct cwc, String classNameStr) {
	...
	native protected void register_readDem_ev_uint32_ev_uint32_ev_uint32_MemoryDataStreamPtr(long pNativeObject, String method);
	native protected void register_readDemMetaDataInfo_OBQDemMetaInfo(long pNativeObject, String method);
	...
	public void registerCallback(){
		if (!this.nativeObject.equals(InstancePointer.ZERO)){
			this.register_readDem_ev_uint32_ev_uint32_ev_uint32_MemoryDataStreamPtr(this.nativeObject.pointer, "readDem_ev_uint32_ev_uint32_ev_uint32_MemoryDataStreamPtr_callback");
			this.register_readDemMetaDataInfo_OBQDemMetaInfo(this.nativeObject.pointer, "readDemMetaDataInfo_OBQDemMetaInfo_callback");
	...
	public static Smart3DDataset fromBaseObject(BaseObject baseObj)
	{
		...
		Smart3DDataset obj = null;
 		if(baseObj instanceof Smart3DDataset)
		{
			obj = (Smart3DDataset)baseObj;
		} else {
