 ...
 * 类工厂
 */
public class WebMeshXGLayerFactory extends com.earthview.world.spatial.atlas.Ilayerfactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::CWebMeshXGLayerFactory", new WebMeshXGLayerFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::JCWebMeshXGLayerFactoryProxy", new WebMeshXGLayerFactoryClassFactory());
	}

	/**
	 * 构造函数
	 */
	public WebMeshXGLayerFactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCWebMeshXGLayerFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.atlas.WebMeshXGLayerFactory".equals(this.getClass().getName()))
		{
	 ...
	 * 返回单例的图层工厂
	 */
	public static com.earthview.world.spatial3d.atlas.WebMeshXGLayerFactory getSingletonPtr()
	{
		long returnValue = getSingletonPtr_void();
		if(returnValue == 0L) {
			return null;
		}
		com.earthview.world.spatial3d.atlas.WebMeshXGLayerFactory __returnValue = new com.earthview.world.spatial3d.atlas.WebMeshXGLayerFactory(CreatedWhenConstruct.CWC_NotToCreate, "CWebMeshXGLayerFactory");
		...
		{
			__returnValue.setDelegate(true);
			__returnValue = (com.earthview.world.spatial3d.atlas.WebMeshXGLayerFactory)__returnValueClassFactory.create();
			__returnValue.setDelegate(true);
			__returnValue.bindNativeObject(__instancePointer, "CWebMeshXGLayerFactory");
		}
	...
	public WebMeshXGLayerFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public WebMeshXGLayerFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static WebMeshXGLayerFactory fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		WebMeshXGLayerFactory obj = null;
 		if(baseObj instanceof WebMeshXGLayerFactory)
		{
			obj = (WebMeshXGLayerFactory)baseObj;
		} else {
			obj = new WebMeshXGLayerFactory(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CWebMeshXGLayerFactory");
			obj.increaseCast();
		}
