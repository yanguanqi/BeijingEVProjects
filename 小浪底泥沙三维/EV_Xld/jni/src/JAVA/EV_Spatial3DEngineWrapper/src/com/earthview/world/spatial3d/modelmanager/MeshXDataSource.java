...
public class MeshXDataSource extends com.earthview.world.spatial.geodataset.Ifiledatasource {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::ModelManager::CMeshXDataSource", new MeshXDataSourceClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::ModelManager::JCMeshXDataSourceProxy", new MeshXDataSourceClassFactory());
	}

	public MeshXDataSource(String datasourcePath, String aliasname) {
		...
		Create("JCMeshXDataSourceProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.modelmanager.MeshXDataSource".equals(this.getClass().getName()))
		{
	...
	public MeshXDataSource(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public MeshXDataSource(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static MeshXDataSource fromBaseObject(BaseObject baseObj)
	{
		...
		MeshXDataSource obj = null;
 		if(baseObj instanceof MeshXDataSource)
		{
			obj = (MeshXDataSource)baseObj;
		} else {
