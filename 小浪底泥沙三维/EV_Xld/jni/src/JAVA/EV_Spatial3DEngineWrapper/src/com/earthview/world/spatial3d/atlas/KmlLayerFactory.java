...
/**
 * KmlLayer的类工厂管理KmlLayer类
 */
public class KmlLayerFactory extends com.earthview.world.spatial.atlas.Ilayerfactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::CKmlLayerFactory", new KmlLayerFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::JCKmlLayerFactoryProxy", new KmlLayerFactoryClassFactory());
	}

	/**
	 * 构造函数
	 */
	public KmlLayerFactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCKmlLayerFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.atlas.KmlLayerFactory".equals(this.getClass().getName()))
		{
	...
	/**
	 * 返回单例的kml图层工厂
	 * @return EarthView::World::Spatial3D::Atlas::CKmlLayerFactory，失败则返回NULL
	 */
	public static com.earthview.world.spatial3d.atlas.KmlLayerFactory getSingletonPtr()
	{
		long returnValue = getSingletonPtr_void();
		if(returnValue == 0L) {
			return null;
		}
		com.earthview.world.spatial3d.atlas.KmlLayerFactory __returnValue = new com.earthview.world.spatial3d.atlas.KmlLayerFactory(CreatedWhenConstruct.CWC_NotToCreate, "CKmlLayerFactory");
		...
		{
			__returnValue.setDelegate(true);
			__returnValue = (com.earthview.world.spatial3d.atlas.KmlLayerFactory)__returnValueClassFactory.create();
			__returnValue.setDelegate(true);
			__returnValue.bindNativeObject(__instancePointer, "CKmlLayerFactory");
		}
	...
	native private static String get_msKmlLayerFactoryName_void();
	public static String get_msKmlLayerFactoryName()
	{
		String jniValue = get_msKmlLayerFactoryName_void();
		
		return jniValue;
	}
	
	public KmlLayerFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public KmlLayerFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static KmlLayerFactory fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		KmlLayerFactory obj = null;
 		if(baseObj instanceof KmlLayerFactory)
		{
			obj = (KmlLayerFactory)baseObj;
		} else {
			obj = new KmlLayerFactory(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CKmlLayerFactory");
			obj.increaseCast();
		}
