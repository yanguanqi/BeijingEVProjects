...
public class KmlDatasetIterator extends com.earthview.world.spatial.geodataset.Idatasetiterator {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::KmlManager::CKmlDatasetIterator", new KmlDatasetIteratorClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::KmlManager::JCKmlDatasetIteratorProxy", new KmlDatasetIteratorClassFactory());
	}
	...
	public KmlDatasetIterator(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public KmlDatasetIterator(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static KmlDatasetIterator fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		KmlDatasetIterator obj = null;
 		if(baseObj instanceof KmlDatasetIterator)
		{
			obj = (KmlDatasetIterator)baseObj;
		} else {
			obj = new KmlDatasetIterator(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CKmlDatasetIterator");
			obj.increaseCast();
		}
