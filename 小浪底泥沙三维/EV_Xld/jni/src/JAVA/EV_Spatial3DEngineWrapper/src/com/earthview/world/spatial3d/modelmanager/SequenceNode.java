...
public class SequenceNode extends com.earthview.world.spatial3d.modelmanager.FltBaseNode {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::ModelManager::CSequenceNode", new SequenceNodeClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::ModelManager::JCSequenceNodeProxy", new SequenceNodeClassFactory());
	}
	 ...
	 * @param name 分配的节点名称
	 */
	public SequenceNode(String name, com.earthview.world.graphic.SceneManager ref_creator) {
		...
		Create("JCSequenceNodeProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.modelmanager.SequenceNode".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
		}
	}

	native private void setValue_ev_int32(long pNativeObject, int value);
	public void setValue(int value)
	{
		int valueParamValue = value;
		setValue_ev_int32(this.nativeObject.pointer, valueParamValue);
	}
	...
	native private void setTime_ev_uint32_ev_real64(long pNativeObject, long frame, double t);
	public void setTime(long frame, double t)
	{
		long frameParamValue = frame;
		double tParamValue = t;
		setTime_ev_uint32_ev_real64(this.nativeObject.pointer, frameParamValue, tParamValue);
	}
	native private double getTime_ev_uint32(long pNativeObject, long frame);
	public double getTime(long frame)
	{
		long frameParamValue = frame;
		double returnValue = getTime_ev_uint32(this.nativeObject.pointer, frameParamValue);
		return returnValue;
	}
	native private void setDefaultTime_ev_real64(long pNativeObject, double t);
	...
	{
		double tParamValue = t;
		setDefaultTime_ev_real64(this.nativeObject.pointer, tParamValue);
	}
	native private double getDefaultTime_void(long pNativeObject);
	public double getDefaultTime()
	{
		double returnValue = getDefaultTime_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private void setLastFrameTime_ev_real64(long pNativeObject, double t);
	public void setLastFrameTime(double t)
	{
		double tParamValue = t;
		setLastFrameTime_ev_real64(this.nativeObject.pointer, tParamValue);
	}
	native private double getLastFrameTime_void(long pNativeObject);
	public double getLastFrameTime()
	{
		double returnValue = getLastFrameTime_void(this.nativeObject.pointer);
		return returnValue;
	}
	...
	public enum EVLoopMode implements INativeEnum<EVLoopMode> {
		LM_LOOP(EVLoopModeHelper.ENUM_VALUES[0]),
		LM_SWING(EVLoopModeHelper.ENUM_VALUES[1]),
		LM_NOTLOOP(EVLoopModeHelper.ENUM_VALUES[2]);
		private int value;
		EVLoopMode(int i) {
			this.value = i;
		}
		public EVLoopMode getEnum(int val) {
			return toEnum(val);
		}
		public int getValue() {
			return this.value;
		}
		public static final EVLoopMode toEnum(int retval) {
			if(retval == LM_LOOP.value){
				return LM_LOOP;
			}
			else if(retval == LM_SWING.value){
				return LM_SWING;
			}
			else if(retval == LM_NOTLOOP.value){
				return LM_NOTLOOP;
			}
			throw new RuntimeException("wrong number in jni call for an enum!");
		}
	}
	static class EVLoopModeHelper {
		public static final int[] ENUM_VALUES = getEnumValues();
		private static native int[] getEnumValues();
	}
	
	native private void setLoopMode_EVLoopMode(long pNativeObject, int mode);
	public void setLoopMode(com.earthview.world.spatial3d.modelmanager.SequenceNode.EVLoopMode mode)
	{
		int modeParamValue = mode.getValue();
		setLoopMode_EVLoopMode(this.nativeObject.pointer, modeParamValue);
	}
	native private int getLoopMode_void(long pNativeObject);
	public com.earthview.world.spatial3d.modelmanager.SequenceNode.EVLoopMode getLoopMode()
	{
		int returnValue = getLoopMode_void(this.nativeObject.pointer);
		return com.earthview.world.spatial3d.modelmanager.SequenceNode.EVLoopMode.toEnum(returnValue);
	}
	native private void setBegin_ev_int32(long pNativeObject, int begin);
	public void setBegin(int begin)
	{
		int beginParamValue = begin;
		setBegin_ev_int32(this.nativeObject.pointer, beginParamValue);
	}
	native private int getBegin_void(long pNativeObject);
	public int getBegin()
	{
		int returnValue = getBegin_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private void setEnd_ev_int32(long pNativeObject, int end);
	public void setEnd(int end)
	{
		int endParamValue = end;
		setEnd_ev_int32(this.nativeObject.pointer, endParamValue);
	}
	native private int getEnd_void(long pNativeObject);
	public int getEnd()
	{
		int returnValue = getEnd_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private void setInterval_EVLoopMode_ev_int32_ev_int32(long pNativeObject, int mode, int begin, int end);
	public void setInterval(com.earthview.world.spatial3d.modelmanager.SequenceNode.EVLoopMode mode, int begin, int end)
	{
		int modeParamValue = mode.getValue();
		int beginParamValue = begin;
		int endParamValue = end;
		setInterval_EVLoopMode_ev_int32_ev_int32(this.nativeObject.pointer, modeParamValue, beginParamValue, endParamValue);
	}
	native private void getInterval_EVLoopMode_ev_int32_ev_int32(long pNativeObject, long mode, long begin, long end);
	public void getInterval(EnumPointer mode, IntegerPointer begin, IntegerPointer end)
	{
		long modeParamValue = mode.nativeObject.pointer;
		long beginParamValue = begin.nativeObject.pointer;
		long endParamValue = end.nativeObject.pointer;
		getInterval_EVLoopMode_ev_int32_ev_int32(this.nativeObject.pointer, modeParamValue, beginParamValue, endParamValue);
	}
	native private void setSpeed_ev_real32(long pNativeObject, float speed);
	public void setSpeed(float speed)
	{
		float speedParamValue = speed;
		setSpeed_ev_real32(this.nativeObject.pointer, speedParamValue);
	}
	native private float getSpeed_void(long pNativeObject);
	public float getSpeed()
	{
		float returnValue = getSpeed_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private void setNumRepeats_ev_int32(long pNativeObject, int nreps);
	public void setNumRepeats(int nreps)
	{
		int nrepsParamValue = nreps;
		setNumRepeats_ev_int32(this.nativeObject.pointer, nrepsParamValue);
	}
	native private int getNumRepeats_void(long pNativeObject);
	public int getNumRepeats()
	{
		int returnValue = getNumRepeats_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private void setDuration_ev_real32_ev_int32(long pNativeObject, float speed, int nreps);
	public void setDuration(float speed, int nreps)
	{
		float speedParamValue = speed;
		int nrepsParamValue = nreps;
		setDuration_ev_real32_ev_int32(this.nativeObject.pointer, speedParamValue, nrepsParamValue);
	}
	native private void getDuration_ev_real32_ev_int32(long pNativeObject, long speed, long nreps);
	public void getDuration(FloatPointer speed, IntegerPointer nreps)
	{
		long speedParamValue = speed.nativeObject.pointer;
		long nrepsParamValue = nreps.nativeObject.pointer;
		getDuration_ev_real32_ev_int32(this.nativeObject.pointer, speedParamValue, nrepsParamValue);
	}
	public enum EVSequenceMode implements INativeEnum<EVSequenceMode> {
		SM_START(EVSequenceModeHelper.ENUM_VALUES[0]),
		SM_STOP(EVSequenceModeHelper.ENUM_VALUES[1]),
		SM_PAUSE(EVSequenceModeHelper.ENUM_VALUES[2]),
		SM_RESUME(EVSequenceModeHelper.ENUM_VALUES[3]);
		private int value;
		EVSequenceMode(int i) {
			this.value = i;
		}
		public EVSequenceMode getEnum(int val) {
			return toEnum(val);
		}
		public int getValue() {
			return this.value;
		}
		public static final EVSequenceMode toEnum(int retval) {
			if(retval == SM_START.value){
				return SM_START;
			}
			else if(retval == SM_STOP.value){
				return SM_STOP;
			}
			else if(retval == SM_PAUSE.value){
				return SM_PAUSE;
			}
			else if(retval == SM_RESUME.value){
				return SM_RESUME;
			}
			throw new RuntimeException("wrong number in jni call for an enum!");
		}
	}
	static class EVSequenceModeHelper {
		public static final int[] ENUM_VALUES = getEnumValues();
		private static native int[] getEnumValues();
	}
	
	native private void setMode_EVSequenceMode(long pNativeObject, int mode);
	public void setMode(com.earthview.world.spatial3d.modelmanager.SequenceNode.EVSequenceMode mode)
	{
		int modeParamValue = mode.getValue();
		setMode_EVSequenceMode(this.nativeObject.pointer, modeParamValue);
	}
	native private int getMode_void(long pNativeObject);
	public com.earthview.world.spatial3d.modelmanager.SequenceNode.EVSequenceMode getMode()
	{
		int returnValue = getMode_void(this.nativeObject.pointer);
		return com.earthview.world.spatial3d.modelmanager.SequenceNode.EVSequenceMode.toEnum(returnValue);
	}
	native private void setSync_ev_bool(long pNativeObject, boolean sync);
	public void setSync(boolean sync)
	{
		boolean syncParamValue = sync;
		setSync_ev_bool(this.nativeObject.pointer, syncParamValue);
	}
	native private boolean getSync_void(long pNativeObject);
	public boolean getSync()
	{
		boolean returnValue = getSync_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private void setClearOnStop_ev_bool(long pNativeObject, boolean clearOnStop);
	public void setClearOnStop(boolean clearOnStop)
	{
		boolean clearOnStopParamValue = clearOnStop;
		setClearOnStop_ev_bool(this.nativeObject.pointer, clearOnStopParamValue);
	}
	native private boolean getClearOnStop_void(long pNativeObject);
	public boolean getClearOnStop()
	{
		boolean returnValue = getClearOnStop_void(this.nativeObject.pointer);
		return returnValue;
	}
	...
	public SequenceNode(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public SequenceNode(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static SequenceNode fromBaseObject(BaseObject baseObj)
	{
		...
		SequenceNode obj = null;
 		if(baseObj instanceof SequenceNode)
		{
			obj = (SequenceNode)baseObj;
		} else {
