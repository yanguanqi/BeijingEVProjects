 ...
 * 更新节点内部方法
 */
public class LightPointNode extends com.earthview.world.spatial3d.modelmanager.FltBaseNode {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::ModelManager::CLightPointNode", new LightPointNodeClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::ModelManager::JCLightPointNodeProxy", new LightPointNodeClassFactory());
	}
	 ...
	 * @param name 分配的节点名称
	 */
	public LightPointNode(String name, com.earthview.world.graphic.SceneManager ref_creator) {
		...
		Create("JCLightPointNodeProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.modelmanager.LightPointNode".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
		}
	}

	native private long getNumLightPoints_void(long pNativeObject);
	public long getNumLightPoints()
	{
		long returnValue = getNumLightPoints_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private long addLightPoint_CLightPoint(long pNativeObject, long lp);
	public long addLightPoint(com.earthview.world.spatial3d.modelmanager.LightPoint lp)
	{
		long lpParamValue = lp.nativeObject.pointer;
		long returnValue = addLightPoint_CLightPoint(this.nativeObject.pointer, lpParamValue);
		return returnValue;
	}
	native private void removeLightPoint_ev_uint32(long pNativeObject, long pos);
	public void removeLightPoint(long pos)
	{
		long posParamValue = pos;
		removeLightPoint_ev_uint32(this.nativeObject.pointer, posParamValue);
	}
	native private long getLightPoint_ev_uint32(long pNativeObject, long pos);
	public com.earthview.world.spatial3d.modelmanager.LightPoint getLightPoint(long pos)
	{
		long posParamValue = pos;
		long returnValue = getLightPoint_ev_uint32(this.nativeObject.pointer, posParamValue);
		com.earthview.world.spatial3d.modelmanager.LightPoint __returnValue = new com.earthview.world.spatial3d.modelmanager.LightPoint(CreatedWhenConstruct.CWC_NotToCreate, "CLightPoint");
		...
		{
			__returnValue.setDelegate(true);
			__returnValue = (com.earthview.world.spatial3d.modelmanager.LightPoint)__returnValueClassFactory.create();
			__returnValue.setDelegate(true);
			__returnValue.bindNativeObject(__instancePointer, "CLightPoint");
		}
		return __returnValue;
	}
	native private void setMinPixelSize_ev_real32(long pNativeObject, float minPixelSize);
	public void setMinPixelSize(float minPixelSize)
	{
		float minPixelSizeParamValue = minPixelSize;
		setMinPixelSize_ev_real32(this.nativeObject.pointer, minPixelSizeParamValue);
	}
	native private float getMinPixelSize_void(long pNativeObject);
	public float getMinPixelSize()
	{
		float returnValue = getMinPixelSize_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private void setMaxPixelSize_ev_real32(long pNativeObject, float maxPixelSize);
	public void setMaxPixelSize(float maxPixelSize)
	{
		float maxPixelSizeParamValue = maxPixelSize;
		setMaxPixelSize_ev_real32(this.nativeObject.pointer, maxPixelSizeParamValue);
	}
	native private float getMaxPixelSize_void(long pNativeObject);
	public float getMaxPixelSize()
	{
		float returnValue = getMaxPixelSize_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private void setMaxVisibleDistance2_ev_real32(long pNativeObject, float maxVisibleDistance2);
	public void setMaxVisibleDistance2(float maxVisibleDistance2)
	{
		float maxVisibleDistance2ParamValue = maxVisibleDistance2;
		setMaxVisibleDistance2_ev_real32(this.nativeObject.pointer, maxVisibleDistance2ParamValue);
	}
	native private float getMaxVisibleDistance2_void(long pNativeObject);
	public float getMaxVisibleDistance2()
	{
		float returnValue = getMaxVisibleDistance2_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private void setLightPointSystem_CLightPointSystem(long pNativeObject, long lps);
	public void setLightPointSystem(com.earthview.world.spatial3d.modelmanager.LightPointSystem lps)
	{
		long lpsParamValue = (lps == null ? 0L : lps.nativeObject.pointer);
		setLightPointSystem_CLightPointSystem(this.nativeObject.pointer, lpsParamValue);
	}
	native private long getLightPointSystem_void(long pNativeObject);
	public com.earthview.world.spatial3d.modelmanager.LightPointSystem getLightPointSystem()
	{
		long returnValue = getLightPointSystem_void(this.nativeObject.pointer);
		if(returnValue == 0L) {
			return null;
		}
		com.earthview.world.spatial3d.modelmanager.LightPointSystem __returnValue = new com.earthview.world.spatial3d.modelmanager.LightPointSystem(CreatedWhenConstruct.CWC_NotToCreate, "CLightPointSystem");
		__returnValue.setDelegate(true);
		InstancePointer __instancePointer = new InstancePointer(returnValue);
		__returnValue.setInstancePointer(__instancePointer);
		IClassFactory __returnValueClassFactory = GlobalClassFactoryMap.get(__returnValue.getCppInstanceTypeName());
		...
		{
			__returnValue.setDelegate(true);
			__returnValue = (com.earthview.world.spatial3d.modelmanager.LightPointSystem)__returnValueClassFactory.create();
			__returnValue.setDelegate(true);
			__returnValue.bindNativeObject(__instancePointer, "CLightPointSystem");
		}
		return __returnValue;
	}
	native private void setPointSprite_ev_bool(long pNativeObject, boolean enable);
	public void setPointSprite(boolean enable)
	{
		boolean enableParamValue = enable;
		setPointSprite_ev_bool(this.nativeObject.pointer, enableParamValue);
	}
	native private boolean getPointSprite_void(long pNativeObject);
	public boolean getPointSprite()
	{
		boolean returnValue = getPointSprite_void(this.nativeObject.pointer);
		return returnValue;
	}
	...
	native private void setCameraParam_ev_real32_ev_real32_CMatrix4_CMatrix4(long pNativeObject, float viewPortWidth, float viewPortHeight, long viewMatrix, long projMatrix);
	/**
	 * 更新节点内部方法
	 * @param updateChildren 为真，逐级更新所有子节点
	 * @param parentHasChanged 为true，表明父节点位置改变，子节点继承父节点变化
	 */
	public void setCameraParam(float viewPortWidth, float viewPortHeight, com.earthview.world.spatial.math.Matrix4 viewMatrix, com.earthview.world.spatial.math.Matrix4 projMatrix)
	{
		float viewPortWidthParamValue = viewPortWidth;
		float viewPortHeightParamValue = viewPortHeight;
		long viewMatrixParamValue = viewMatrix.nativeObject.pointer;
		long projMatrixParamValue = projMatrix.nativeObject.pointer;
		setCameraParam_ev_real32_ev_real32_CMatrix4_CMatrix4(this.nativeObject.pointer, viewPortWidthParamValue, viewPortHeightParamValue, viewMatrixParamValue, projMatrixParamValue);
	}
	public LightPointNode(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public LightPointNode(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static LightPointNode fromBaseObject(BaseObject baseObj)
	{
		...
		LightPointNode obj = null;
 		if(baseObj instanceof LightPointNode)
		{
			obj = (LightPointNode)baseObj;
		} else {
