...
public class WebLasLayer extends com.earthview.world.spatial3d.atlas.Evlaslayer {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::CWebLasLayer", new WebLasLayerClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::JCWebLasLayerProxy", new WebLasLayerClassFactory());
	}
	...
	public WebLasLayer(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public WebLasLayer(CreatedWhenConstruct cwc, String classNameStr) {
	...
	{
		super.setAltitudeValue_NoVirtual(altitudeValue);
	}
	/**
	 * 设置位置
	 * @param lat 纬度
	...
	{
		super.setPosition_NoVirtual(lat, lon, alt);
	}
	/**
	 * 设置空间信息
	 * @param lat 纬度
	...
	{
		super.setSpatialInfo_NoVirtual(lat, lon, alt, localScale, localRotate);
	}
	/// <summary>
	/// 图层定位
	...
	public static WebLasLayer fromBaseObject(BaseObject baseObj)
	{
		...
		WebLasLayer obj = null;
 		if(baseObj instanceof WebLasLayer)
		{
			obj = (WebLasLayer)baseObj;
		} else {
