...
public class WebSmart3DLayer extends com.earthview.world.spatial3d.atlas.ObliqueModelLayer {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::CWebSmart3DLayer", new WebSmart3DLayerClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::JCWebSmart3DLayerProxy", new WebSmart3DLayerClassFactory());
	}
	...
	public WebSmart3DLayer(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public WebSmart3DLayer(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static WebSmart3DLayer fromBaseObject(BaseObject baseObj)
	{
		...
		WebSmart3DLayer obj = null;
 		if(baseObj instanceof WebSmart3DLayer)
		{
			obj = (WebSmart3DLayer)baseObj;
		} else {
