...
public class EntityInstanceLayerFactory extends com.earthview.world.spatial.atlas.Ilayerfactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::CEntityInstanceLayerFactory", new EntityInstanceLayerFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::JCEntityInstanceLayerFactoryProxy", new EntityInstanceLayerFactoryClassFactory());
	}
	 ...
	 */
	public static com.earthview.world.spatial3d.atlas.EntityInstanceLayerFactory getSingletonPtr()
	{
		long returnValue = getSingletonPtr_void();
		if(returnValue == 0L) {
			return null;
		}
		com.earthview.world.spatial3d.atlas.EntityInstanceLayerFactory __returnValue = new com.earthview.world.spatial3d.atlas.EntityInstanceLayerFactory(CreatedWhenConstruct.CWC_NotToCreate, "CEntityInstanceLayerFactory");
		...
		{
			__returnValue.setDelegate(true);
			__returnValue = (com.earthview.world.spatial3d.atlas.EntityInstanceLayerFactory)__returnValueClassFactory.create();
			__returnValue.setDelegate(true);
			__returnValue.bindNativeObject(__instancePointer, "CEntityInstanceLayerFactory");
		}
	...
	public EntityInstanceLayerFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public EntityInstanceLayerFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static EntityInstanceLayerFactory fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		EntityInstanceLayerFactory obj = null;
 		if(baseObj instanceof EntityInstanceLayerFactory)
		{
			obj = (EntityInstanceLayerFactory)baseObj;
		} else {
			obj = new EntityInstanceLayerFactory(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CEntityInstanceLayerFactory");
			obj.increaseCast();
		}
