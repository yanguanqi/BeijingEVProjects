...
public class I3DLayer extends com.earthview.world.spatial3d.atlas.Iglobelayer {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::I3DLayer", new I3DLayerClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::JI3DLayerProxy", new I3DLayerClassFactory());
	}
	...
	public I3DLayer() {
		...
		Create("JI3DLayerProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.atlas.I3DLayer".equals(this.getClass().getName()))
		{
	 ...
	 * @param  
	 */
	public I3DLayer(String name) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer namePtr = new BasePointer(name);
		list.add("name", namePtr.get());
		Create("JI3DLayerProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.atlas.I3DLayer".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
	...
	protected  long getVisibleObjectPtr_ev_uint32_callback(long id)
	{
		long idParamValue = id;
		com.earthview.world.geometry3d.VisibleObjectPtr returnValue = getVisibleObjectPtr(idParamValue);
	...
	protected  long getVisibleObjectPtr_CMovableObject_callback(long pMovableObj)
	{
		com.earthview.world.graphic.MovableObject pMovableObjParamValue = (pMovableObj == 0L ? null : new com.earthview.world.graphic.MovableObject(CreatedWhenConstruct.CWC_NotToCreate));
		if(pMovableObjParamValue != null)
		{
		pMovableObjParamValue.setDelegate(true);
		pMovableObjParamValue.setInstancePointer(new InstancePointer(pMovableObj));
		IClassFactory pMovableObjParamValueClassFactory = GlobalClassFactoryMap.get(pMovableObjParamValue.getCppInstanceTypeName());
		if (pMovableObjParamValueClassFactory != null)
		{
			pMovableObjParamValue.setDelegate(true);
			pMovableObjParamValue = (com.earthview.world.graphic.MovableObject)pMovableObjParamValueClassFactory.create();
			pMovableObjParamValue.setDelegate(true);
			pMovableObjParamValue.setInstancePointer(new InstancePointer(pMovableObj));
		}
		}
		com.earthview.world.geometry3d.VisibleObjectPtr returnValue = getVisibleObjectPtr(pMovableObjParamValue);
		long __returnValue = returnValue.nativeObject.pointer;
		return __returnValue;
	}
	...
	protected  long getVisibleObjectPtr_IFeature_callback(long f)
	{
		com.earthview.world.spatial.geodataset.Ifeature fParamValue = (f == 0L ? null : new com.earthview.world.spatial.geodataset.Ifeature(CreatedWhenConstruct.CWC_NotToCreate));
		if(fParamValue != null)
		{
		...
		{
			fParamValue.setDelegate(true);
			fParamValue = (com.earthview.world.spatial.geodataset.Ifeature)fParamValueClassFactory.create();
			fParamValue.setDelegate(true);
			fParamValue.setInstancePointer(new InstancePointer(f));
		}
		}
		com.earthview.world.geometry3d.VisibleObjectPtr returnValue = getVisibleObjectPtr(fParamValue);
		long __returnValue = returnValue.nativeObject.pointer;
		return __returnValue;
	}
	...
	protected  long createVisibleObjectPtr_IFeature_callback(long ref_f)
	{
		com.earthview.world.spatial.geodataset.Ifeature ref_fParamValue = (ref_f == 0L ? null : new com.earthview.world.spatial.geodataset.Ifeature(CreatedWhenConstruct.CWC_NotToCreate));
		if(ref_fParamValue != null)
		{
		ref_fParamValue.setDelegate(true);
		ref_fParamValue.setInstancePointer(new InstancePointer(ref_f));
		IClassFactory ref_fParamValueClassFactory = GlobalClassFactoryMap.get(ref_fParamValue.getCppInstanceTypeName());
		if (ref_fParamValueClassFactory != null)
		{
			ref_fParamValue.setDelegate(true);
			ref_fParamValue = (com.earthview.world.spatial.geodataset.Ifeature)ref_fParamValueClassFactory.create();
			ref_fParamValue.setDelegate(true);
			ref_fParamValue.setInstancePointer(new InstancePointer(ref_f));
		}
		}
		com.earthview.world.geometry3d.VisibleObjectPtr returnValue = createVisibleObjectPtr(ref_fParamValue);
		long __returnValue = returnValue.nativeObject.pointer;
		return __returnValue;
	}

	native private long createVisibleObjectPtr_IFeature(long pNativeObject, long ref_f);
	/**
	 * 创建要素获取对象，插入到图层中
	 * @param  
	 */
	public com.earthview.world.geometry3d.VisibleObjectPtr createVisibleObjectPtr(com.earthview.world.spatial.geodataset.Ifeature ref_f)
	{
		...
		long returnValue = createVisibleObjectPtr_IFeature(this.nativeObject.pointer, ref_fParamValue);
		com.earthview.world.geometry3d.VisibleObjectPtr __returnValue = new com.earthview.world.geometry3d.VisibleObjectPtr(CreatedWhenConstruct.CWC_NotToCreate);
		InstancePointer __instancePointer = new InstancePointer(returnValue);
		__returnValue.bindNativeObject(__instancePointer, "CVisibleObjectPtr");
		__returnValue.createNativeObjectPointer(__instancePointer);
	...
	native private long createVisibleObjectPtr_IFeature_NoVirtual(long pNativeObject, long ref_f);
	protected com.earthview.world.geometry3d.VisibleObjectPtr createVisibleObjectPtr_NoVirtual(com.earthview.world.spatial.geodataset.Ifeature ref_f)
	{
		long ref_fParamValue = (ref_f == null ? 0L : ref_f.nativeObject.pointer);
		long returnValue = createVisibleObjectPtr_IFeature_NoVirtual(this.nativeObject.pointer, ref_fParamValue);
		com.earthview.world.geometry3d.VisibleObjectPtr __returnValue = new com.earthview.world.geometry3d.VisibleObjectPtr(CreatedWhenConstruct.CWC_NotToCreate);
		InstancePointer __instancePointer = new InstancePointer(returnValue);
		__returnValue.bindNativeObject(__instancePointer, "CVisibleObjectPtr");
		__returnValue.createNativeObjectPointer(__instancePointer);
	...
	public I3DLayer(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public I3DLayer(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static I3DLayer fromBaseObject(BaseObject baseObj)
	{
		...
		I3DLayer obj = null;
 		if(baseObj instanceof I3DLayer)
		{
			obj = (I3DLayer)baseObj;
		} else {
