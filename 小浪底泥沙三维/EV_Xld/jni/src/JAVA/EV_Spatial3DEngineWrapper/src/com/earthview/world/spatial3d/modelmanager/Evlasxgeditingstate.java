...
public class Evlasxgeditingstate extends com.earthview.world.core.AllocatedObject {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::ModelManager::CEVLasxgEditingState", new EvlasxgeditingstateClassFactory());
	}

	public Evlasxgeditingstate() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("CEVLasxgEditingState", null);
	}
	...
	public Evlasxgeditingstate(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Evlasxgeditingstate(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Evlasxgeditingstate fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		Evlasxgeditingstate obj = null;
 		if(baseObj instanceof Evlasxgeditingstate)
		{
			obj = (Evlasxgeditingstate)baseObj;
		} else {
			obj = new Evlasxgeditingstate(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CEVLasxgEditingState");
			obj.increaseCast();
		}
