...
public class ScreenOverlayerFactory extends com.earthview.world.spatial3d.atlas.Igeometry3dfactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::CScreenOverlayerFactory", new ScreenOverlayerFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::JCScreenOverlayerFactoryProxy", new ScreenOverlayerFactoryClassFactory());
	}
	 ...
	 * @param  
	 */
	public ScreenOverlayerFactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCScreenOverlayerFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.atlas.ScreenOverlayerFactory".equals(this.getClass().getName()))
		{
	...
	public ScreenOverlayerFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ScreenOverlayerFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ScreenOverlayerFactory fromBaseObject(BaseObject baseObj)
	{
		...
		ScreenOverlayerFactory obj = null;
 		if(baseObj instanceof ScreenOverlayerFactory)
		{
			obj = (ScreenOverlayerFactory)baseObj;
		} else {
