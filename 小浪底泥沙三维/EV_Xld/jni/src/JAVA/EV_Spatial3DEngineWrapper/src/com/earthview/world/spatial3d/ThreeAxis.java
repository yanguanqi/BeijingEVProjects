...
public class ThreeAxis extends com.earthview.world.graphic.MovableObject {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::CThreeAxis", new ThreeAxisClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::JCThreeAxisProxy", new ThreeAxisClassFactory());
	}

	public static class ThreeAxisInternalRenderable extends com.earthview.world.graphic.Renderable {
		
		static {
			GlobalClassFactoryMap.put("EarthView::World::Spatial3D::CThreeAxis::CThreeAxisInternalRenderable", new ThreeAxisInternalRenderableClassFactory());
			GlobalClassFactoryMap.put("EarthView::World::Spatial3D::CThreeAxis::JCThreeAxisInternalRenderableProxy", new ThreeAxisInternalRenderableClassFactory());
		}

		public ThreeAxisInternalRenderable(com.earthview.world.spatial3d.ThreeAxis parent) {
			super(CreatedWhenConstruct.CWC_NotToCreate);
			NameValuePairList list = new NameValuePairList();
			BasePointer parentPtr = new BasePointer(parent);
			list.add("parent", parentPtr.get());
			Create("JCThreeAxisInternalRenderableProxy", list, true);
			this.registerCallback();
			if (!"com.earthview.world.spatial3d.ThreeAxis$ThreeAxisInternalRenderable".equals(this.getClass().getName()))
			{
		...
		public ThreeAxisInternalRenderable(CreatedWhenConstruct cwc) {
			super(CreatedWhenConstruct.CWC_NotToCreate);
		}
		public ThreeAxisInternalRenderable(CreatedWhenConstruct cwc, String classNameStr) {
		...
		public static ThreeAxisInternalRenderable fromBaseObject(BaseObject baseObj)
		{
			...
			ThreeAxisInternalRenderable obj = null;
 			if(baseObj instanceof ThreeAxisInternalRenderable)
			{
				obj = (ThreeAxisInternalRenderable)baseObj;
			} else {
	...
	public static class ThreeAxisInternalRenderableClassFactory implements IClassFactory {
	...
	public ThreeAxis() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCThreeAxisProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.ThreeAxis".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
		}
	}
	...
	native private long get_mRenderable_void(long pNativeObject);
	public com.earthview.world.spatial3d.ThreeAxis.ThreeAxisInternalRenderable get_mRenderable()
	{
		long jniValue = get_mRenderable_void(this.nativeObject.pointer);
		
		if(jniValue == 0L) {
			return null;
		}
		com.earthview.world.spatial3d.ThreeAxis.ThreeAxisInternalRenderable __returnValue = new com.earthview.world.spatial3d.ThreeAxis.ThreeAxisInternalRenderable(CreatedWhenConstruct.CWC_NotToCreate, "CThreeAxisInternalRenderable");
		__returnValue.setDelegate(true);
		...
		{
			__returnValue.setDelegate(true);
			__returnValue = (com.earthview.world.spatial3d.ThreeAxis.ThreeAxisInternalRenderable)__returnValueClassFactory.create();
			__returnValue.setDelegate(true);
			__returnValue.bindNativeObject(__instancePointer, "CThreeAxisInternalRenderable");
		}
		return __returnValue;
	}
	
	native private void set_mRenderable_CThreeAxisInternalRenderable (long pNativeObject, long value);
	public void set_mRenderable(com.earthview.world.spatial3d.ThreeAxis.ThreeAxisInternalRenderable mRenderable)
	{
		long mRenderableParamValue = (mRenderable == null ? 0L : mRenderable.nativeObject.pointer);
		
		set_mRenderable_CThreeAxisInternalRenderable(this.nativeObject.pointer, mRenderableParamValue);
	}
	
	native private long get_mMaterialPtr_void(long pNativeObject);
	public com.earthview.world.graphic.MaterialPtr get_mMaterialPtr()
	{
		long jniValue = get_mMaterialPtr_void(this.nativeObject.pointer);
	...
	native private void set_mMaterialPtr_CMaterialPtr (long pNativeObject, long value);
	public void set_mMaterialPtr(com.earthview.world.graphic.MaterialPtr mMaterialPtr)
	{
		long mMaterialPtrParamValue = mMaterialPtr.nativeObject.pointer;
		
		set_mMaterialPtr_CMaterialPtr(this.nativeObject.pointer, mMaterialPtrParamValue);
	}
	
	native private long get_mCam_void(long pNativeObject);
	public com.earthview.world.graphic.Camera get_mCam()
	{
		long jniValue = get_mCam_void(this.nativeObject.pointer);
	...
	native private void set_mCam_CCamera (long pNativeObject, long value);
	public void set_mCam(com.earthview.world.graphic.Camera mCam)
	{
		long mCamParamValue = (mCam == null ? 0L : mCam.nativeObject.pointer);
		
		set_mCam_CCamera(this.nativeObject.pointer, mCamParamValue);
	}
	
	native private boolean get_mautoScale_void(long pNativeObject);
	public boolean get_mautoScale()
	{
		boolean jniValue = get_mautoScale_void(this.nativeObject.pointer);
		
		return jniValue;
	}
	
	native private void set_mautoScale_bool (long pNativeObject, boolean value);
	public void set_mautoScale(boolean mautoScale)
	{
		boolean mautoScaleParamValue = mautoScale;
		
		set_mautoScale_bool(this.nativeObject.pointer, mautoScaleParamValue);
	}
	
	public ThreeAxis(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ThreeAxis(CreatedWhenConstruct cwc, String classNameStr) {
		super(CreatedWhenConstruct.CWC_NotToCreate, classNameStr);
	}
	...
	public static ThreeAxis fromBaseObject(BaseObject baseObj)
	{
		...
		ThreeAxis obj = null;
 		if(baseObj instanceof ThreeAxis)
		{
			obj = (ThreeAxis)baseObj;
		} else {
