...
public class ManualInstanceObject extends com.earthview.world.spatial3d.modelmanager.ModelBaseObject {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::ModelManager::CManualInstanceObject", new ManualInstanceObjectClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::ModelManager::JCManualInstanceObjectProxy", new ManualInstanceObjectClassFactory());
	}
	...
	protected  long getInstanceEntityVector_void_callback()
	{
		com.earthview.world.spatial3d.InstancedEntityVector returnValue = getInstanceEntityVector();
		long __returnValue = returnValue.nativeObject.pointer;
		return __returnValue;
	}

	native private long getInstanceEntityVector_void(long pNativeObject);
	/**
	 * 获取模型列表
	 * @return 模型列表
	 */
	public com.earthview.world.spatial3d.InstancedEntityVector getInstanceEntityVector()
	{
		long returnValue = getInstanceEntityVector_void(this.nativeObject.pointer);
		com.earthview.world.spatial3d.InstancedEntityVector __returnValue = new com.earthview.world.spatial3d.InstancedEntityVector(CreatedWhenConstruct.CWC_NotToCreate, "InstancedEntityVector");
		__returnValue.setDelegate(true);
		InstancePointer __instancePointer = new InstancePointer(returnValue);
		__returnValue.setInstancePointer(__instancePointer);
		IClassFactory __returnValueClassFactory = GlobalClassFactoryMap.get(__returnValue.getCppInstanceTypeName());
	...
	native private long getInstanceEntityVector_void_NoVirtual(long pNativeObject);
	protected com.earthview.world.spatial3d.InstancedEntityVector getInstanceEntityVector_NoVirtual()
	{
		long returnValue = getInstanceEntityVector_void_NoVirtual(this.nativeObject.pointer);
		com.earthview.world.spatial3d.InstancedEntityVector __returnValue = new com.earthview.world.spatial3d.InstancedEntityVector(CreatedWhenConstruct.CWC_NotToCreate, "InstancedEntityVector");
		__returnValue.setDelegate(true);
		InstancePointer __instancePointer = new InstancePointer(returnValue);
		__returnValue.setInstancePointer(__instancePointer);
	...
	protected  long getNumInstancePerBatch_void_callback()
	{
		long returnValue = getNumInstancePerBatch();
		long __returnValue = returnValue;
		return __returnValue;
	}

	native private long getNumInstancePerBatch_void(long pNativeObject);
	/**
	 * 获取instanceBatch容量
	 * @return 容量
	 */
	public long getNumInstancePerBatch()
	{
		long returnValue = getNumInstancePerBatch_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private long getNumInstancePerBatch_void_NoVirtual(long pNativeObject);
	protected long getNumInstancePerBatch_NoVirtual()
	{
		long returnValue = getNumInstancePerBatch_void_NoVirtual(this.nativeObject.pointer);
		return returnValue;
	}

	protected  void setNumInstancePerBatch_ev_uint32_callback(long numPerBatch)
	{
		long numPerBatchParamValue = numPerBatch;
		setNumInstancePerBatch(numPerBatchParamValue);
	}

	native private void setNumInstancePerBatch_ev_uint32(long pNativeObject, long numPerBatch);
	/**
	 * 设置instanceBatch容量
	 * @param numPerBatch instanceBatch容量
	 */
	public void setNumInstancePerBatch(long numPerBatch)
	{
		long numPerBatchParamValue = numPerBatch;
		setNumInstancePerBatch_ev_uint32(this.nativeObject.pointer, numPerBatchParamValue);
	}
	native private void setNumInstancePerBatch_ev_uint32_NoVirtual(long pNativeObject, long numPerBatch);
	protected void setNumInstancePerBatch_NoVirtual(long numPerBatch)
	{
		long numPerBatchParamValue = numPerBatch;
		setNumInstancePerBatch_ev_uint32_NoVirtual(this.nativeObject.pointer, numPerBatchParamValue);
	}
	...
	/**
	 * 创建控制局部变换的节点，节点控制的坐标轴是基于建模时子部件的局部坐标轴限制：1.当前的的CModelBaseObject必须是由createSubEntityObject创建的对象且只有一个子部件2.当前的的CModelBaseObject必须是已经attachToNode（pWorldNode）后状态【attachToScene不支持】，调用此接口会调整pWorldNode下的挂接层次关系
	...
	/**
	 * 是否可选择
	 * @return ev_bool，TRUE可选择/FALSE不可选择
	 */
	...
	/**
	 * 是否被选择
	 * @return ev_bool，TRUE被选择/FALSE没有被选择
	 */
	...
	native private void linkEntity_CEntity(long pNativeObject, long pEntity);
	public void linkEntity(com.earthview.world.graphic.Entity pEntity)
	{
		long pEntityParamValue = (pEntity == null ? 0L : pEntity.nativeObject.pointer);
		linkEntity_CEntity(this.nativeObject.pointer, pEntityParamValue);
	}
	...
	/**
	 * 设置阴影
	 * @param flag TRUE可投射阴影/FALSE不可投射阴影
	 */
	...
	native private void destoryAnimationSceneNodes_void(long pNativeObject);
	/**
	 * 销毁创建的节点
	 */
	public void destoryAnimationSceneNodes()
	{
		destoryAnimationSceneNodes_void(this.nativeObject.pointer);
	}
	...
	native private long getComponentByInstancedEntity_CInstancedEntity(long pNativeObject, long instancedEntity);
	/**
	 * 根据CInstancedEntity取所属组件
	 * @param CInstancedEntity CInstancedEntity指针
	 * @return 组件对象
	 */
	public com.earthview.world.spatial3d.Component getComponentByInstancedEntity(com.earthview.world.graphic.InstancedEntity instancedEntity)
	{
		long instancedEntityParamValue = (instancedEntity == null ? 0L : instancedEntity.nativeObject.pointer);
		long returnValue = getComponentByInstancedEntity_CInstancedEntity(this.nativeObject.pointer, instancedEntityParamValue);
	...
	native private void setInstanceInUse_ev_bool(long pNativeObject, boolean bInUse);
	/**
	 * 设置内部复用的instance可用
	 */
	public void setInstanceInUse(boolean bInUse)
	{
		boolean bInUseParamValue = bInUse;
		setInstanceInUse_ev_bool(this.nativeObject.pointer, bInUseParamValue);
	}
	...
	public ManualInstanceObject(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ManualInstanceObject(CreatedWhenConstruct cwc, String classNameStr) {
	...
	{
		super.setSubEntitySelected_NoVirtual(subEntityIndex, segmentIndex, flag);
	}
	/**
	 * 获取模型状态
	 */
	...
	{
		return super.getBoneNode_NoVirtual(boneName);
	}
	/**
	...
	{
		super.updateSkeletonAnimationVertex_NoVirtual();
	}
	/**
	 * 获取节点
	 * @return true成功，false失败
	...
	native protected void register_getInstanceEntityVector_void(long pNativeObject, String method);
	native protected void register_getNumInstancePerBatch_void(long pNativeObject, String method);
	native protected void register_setNumInstancePerBatch_ev_uint32(long pNativeObject, String method);
	...
	public void registerCallback(){
		if (!this.nativeObject.equals(InstancePointer.ZERO)){
			this.register_getInstanceEntityVector_void(this.nativeObject.pointer, "getInstanceEntityVector_void_callback");
			this.register_getNumInstancePerBatch_void(this.nativeObject.pointer, "getNumInstancePerBatch_void_callback");
			this.register_setNumInstancePerBatch_ev_uint32(this.nativeObject.pointer, "setNumInstancePerBatch_ev_uint32_callback");
	...
	public static ManualInstanceObject fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		ManualInstanceObject obj = null;
 		if(baseObj instanceof ManualInstanceObject)
		{
			obj = (ManualInstanceObject)baseObj;
		} else {
			obj = new ManualInstanceObject(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CManualInstanceObject");
			obj.increaseCast();
		}
