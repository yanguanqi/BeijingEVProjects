...
public class ModelEditTool extends com.earthview.world.spatial.systemui.Itool {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::KmlManager::CModelEditTool", new ModelEditToolClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::KmlManager::JCModelEditToolProxy", new ModelEditToolClassFactory());
	}
	 ...
	 * @param parent kml文档
	 */
	public ModelEditTool(com.earthview.world.graphic.SceneManager ref_sceneMgr, com.earthview.world.graphic.Camera ref_camera, com.earthview.world.graphic.Viewport ref_viewPort, com.earthview.world.spatial.kml.GeoObjectExtension geoObj, com.earthview.world.spatial.kml.KmlDocument ref_parent) {
		...
		Create("JCModelEditToolProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.kmlmanager.ModelEditTool".equals(this.getClass().getName()))
		{
	...
	native private long getGeoObjectAttribute_void(long pNativeObject);
	public com.earthview.world.spatial.kml.GeoObjectExtensionAttribute getGeoObjectAttribute()
	{
		long returnValue = getGeoObjectAttribute_void(this.nativeObject.pointer);
	...
	native private void updateModel_void(long pNativeObject);
	/**
	 * 刷新
	 * @param  
	 */
	...
	{
		updateModel_void(this.nativeObject.pointer);
	}
	...
	native private void setEditingObj_CKmlModel(long pNativeObject, long pKmlModel);
	public void setEditingObj(com.earthview.world.spatial3d.kmlmanager.KmlModel pKmlModel)
	{
		long pKmlModelParamValue = (pKmlModel == null ? 0L : pKmlModel.nativeObject.pointer);
		setEditingObj_CKmlModel(this.nativeObject.pointer, pKmlModelParamValue);
	}
	native private void addEditingObjListener_CMovableObjectListener(long pNativeObject, long pListener);
	public void addEditingObjListener(com.earthview.world.graphic.MovableObject.MovableObjectListener pListener)
	{
		long pListenerParamValue = (pListener == null ? 0L : pListener.nativeObject.pointer);
		addEditingObjListener_CMovableObjectListener(this.nativeObject.pointer, pListenerParamValue);
	}
	native private void removeEditingObjListener_CMovableObjectListener(long pNativeObject, long pListener);
	public void removeEditingObjListener(com.earthview.world.graphic.MovableObject.MovableObjectListener pListener)
	{
		long pListenerParamValue = (pListener == null ? 0L : pListener.nativeObject.pointer);
		removeEditingObjListener_CMovableObjectListener(this.nativeObject.pointer, pListenerParamValue);
	}
	...
	native private long get_mVert_void(long pNativeObject);
	public com.earthview.world.spatial.math.Vector3 get_mVert()
	{
		long jniValue = get_mVert_void(this.nativeObject.pointer);
	...
	native private void set_mVert_CVector3 (long pNativeObject, long value);
	public void set_mVert(com.earthview.world.spatial.math.Vector3 mVert)
	{
		long mVertParamValue = mVert.nativeObject.pointer;
		
		set_mVert_CVector3(this.nativeObject.pointer, mVertParamValue);
	}
	
	public ModelEditTool(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ModelEditTool(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ModelEditTool fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		ModelEditTool obj = null;
 		if(baseObj instanceof ModelEditTool)
		{
			obj = (ModelEditTool)baseObj;
		} else {
			obj = new ModelEditTool(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CModelEditTool");
			obj.increaseCast();
		}
