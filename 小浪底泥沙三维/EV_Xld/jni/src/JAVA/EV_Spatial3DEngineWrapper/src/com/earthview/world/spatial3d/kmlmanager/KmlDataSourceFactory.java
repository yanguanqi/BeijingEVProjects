...
public class KmlDataSourceFactory extends com.earthview.world.spatial.geodataset.Idatasourcefactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::KmlManager::CKmlDataSourceFactory", new KmlDataSourceFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::KmlManager::JCKmlDataSourceFactoryProxy", new KmlDataSourceFactoryClassFactory());
	}

	/**
	 * 构造函数
	 */
	public KmlDataSourceFactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCKmlDataSourceFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.kmlmanager.KmlDataSourceFactory".equals(this.getClass().getName()))
		{
	 ...
	 */
	public static com.earthview.world.spatial3d.kmlmanager.KmlDataSourceFactory getSingletonPtr()
	{
		long returnValue = getSingletonPtr_void();
		if(returnValue == 0L) {
			return null;
		}
		com.earthview.world.spatial3d.kmlmanager.KmlDataSourceFactory __returnValue = new com.earthview.world.spatial3d.kmlmanager.KmlDataSourceFactory(CreatedWhenConstruct.CWC_NotToCreate, "CKmlDataSourceFactory");
		...
		{
			__returnValue.setDelegate(true);
			__returnValue = (com.earthview.world.spatial3d.kmlmanager.KmlDataSourceFactory)__returnValueClassFactory.create();
			__returnValue.setDelegate(true);
			__returnValue.bindNativeObject(__instancePointer, "CKmlDataSourceFactory");
		}
	...
	public KmlDataSourceFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public KmlDataSourceFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static KmlDataSourceFactory fromBaseObject(BaseObject baseObj)
	{
		...
		KmlDataSourceFactory obj = null;
 		if(baseObj instanceof KmlDataSourceFactory)
		{
			obj = (KmlDataSourceFactory)baseObj;
		} else {
