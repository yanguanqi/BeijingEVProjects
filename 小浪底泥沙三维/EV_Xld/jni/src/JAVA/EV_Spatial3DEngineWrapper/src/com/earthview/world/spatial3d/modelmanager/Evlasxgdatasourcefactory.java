...
public class Evlasxgdatasourcefactory extends com.earthview.world.spatial.geodataset.Idatasourcefactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::ModelManager::CEVLasXGDataSourceFactory", new EvlasxgdatasourcefactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::ModelManager::JCEVLasXGDataSourceFactoryProxy", new EvlasxgdatasourcefactoryClassFactory());
	}

	/**
	 * 构造函数
	 */
	public Evlasxgdatasourcefactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCEVLasXGDataSourceFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.modelmanager.Evlasxgdatasourcefactory".equals(this.getClass().getName()))
		{
	 ...
	 */
	public static com.earthview.world.spatial3d.modelmanager.Evlasxgdatasourcefactory getSingletonPtr()
	{
		long returnValue = getSingletonPtr_void();
		if(returnValue == 0L) {
			return null;
		}
		com.earthview.world.spatial3d.modelmanager.Evlasxgdatasourcefactory __returnValue = new com.earthview.world.spatial3d.modelmanager.Evlasxgdatasourcefactory(CreatedWhenConstruct.CWC_NotToCreate, "CEVLasXGDataSourceFactory");
		...
		{
			__returnValue.setDelegate(true);
			__returnValue = (com.earthview.world.spatial3d.modelmanager.Evlasxgdatasourcefactory)__returnValueClassFactory.create();
			__returnValue.setDelegate(true);
			__returnValue.bindNativeObject(__instancePointer, "CEVLasXGDataSourceFactory");
		}
	...
	public Evlasxgdatasourcefactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Evlasxgdatasourcefactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Evlasxgdatasourcefactory fromBaseObject(BaseObject baseObj)
	{
		...
		Evlasxgdatasourcefactory obj = null;
 		if(baseObj instanceof Evlasxgdatasourcefactory)
		{
			obj = (Evlasxgdatasourcefactory)baseObj;
		} else {
