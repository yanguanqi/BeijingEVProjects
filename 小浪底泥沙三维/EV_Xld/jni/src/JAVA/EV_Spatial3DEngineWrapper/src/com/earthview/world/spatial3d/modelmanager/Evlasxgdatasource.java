...
public class Evlasxgdatasource extends com.earthview.world.spatial.geodataset.Ifiledatasource {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::ModelManager::CEVLasXGDataSource", new EvlasxgdatasourceClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::ModelManager::JCEVLasXGDataSourceProxy", new EvlasxgdatasourceClassFactory());
	}

	public Evlasxgdatasource(String datasourcePath, String aliasname) {
		...
		Create("JCEVLasXGDataSourceProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.modelmanager.Evlasxgdatasource".equals(this.getClass().getName()))
		{
	...
	public Evlasxgdatasource(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Evlasxgdatasource(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Evlasxgdatasource fromBaseObject(BaseObject baseObj)
	{
		...
		Evlasxgdatasource obj = null;
 		if(baseObj instanceof Evlasxgdatasource)
		{
			obj = (Evlasxgdatasource)baseObj;
		} else {
