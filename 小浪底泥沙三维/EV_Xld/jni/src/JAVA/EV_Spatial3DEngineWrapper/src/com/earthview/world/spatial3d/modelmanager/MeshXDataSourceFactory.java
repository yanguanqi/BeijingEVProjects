...
public class MeshXDataSourceFactory extends com.earthview.world.spatial.geodataset.Idatasourcefactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::ModelManager::CMeshXDataSourceFactory", new MeshXDataSourceFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::ModelManager::JCMeshXDataSourceFactoryProxy", new MeshXDataSourceFactoryClassFactory());
	}

	/**
	 * 构造函数
	 */
	public MeshXDataSourceFactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCMeshXDataSourceFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.modelmanager.MeshXDataSourceFactory".equals(this.getClass().getName()))
		{
	 ...
	 */
	public static com.earthview.world.spatial3d.modelmanager.MeshXDataSourceFactory getSingletonPtr()
	{
		long returnValue = getSingletonPtr_void();
		if(returnValue == 0L) {
			return null;
		}
		com.earthview.world.spatial3d.modelmanager.MeshXDataSourceFactory __returnValue = new com.earthview.world.spatial3d.modelmanager.MeshXDataSourceFactory(CreatedWhenConstruct.CWC_NotToCreate, "CMeshXDataSourceFactory");
		...
		{
			__returnValue.setDelegate(true);
			__returnValue = (com.earthview.world.spatial3d.modelmanager.MeshXDataSourceFactory)__returnValueClassFactory.create();
			__returnValue.setDelegate(true);
			__returnValue.bindNativeObject(__instancePointer, "CMeshXDataSourceFactory");
		}
	...
	public MeshXDataSourceFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public MeshXDataSourceFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static MeshXDataSourceFactory fromBaseObject(BaseObject baseObj)
	{
		...
		MeshXDataSourceFactory obj = null;
 		if(baseObj instanceof MeshXDataSourceFactory)
		{
			obj = (MeshXDataSourceFactory)baseObj;
		} else {
