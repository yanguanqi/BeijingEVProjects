 ...
 * 类工厂
 */
public class Smart3DLayerFactory extends com.earthview.world.spatial.atlas.Ilayerfactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::CSmart3DLayerFactory", new Smart3DLayerFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::JCSmart3DLayerFactoryProxy", new Smart3DLayerFactoryClassFactory());
	}

	/**
	 * 构造函数
	 */
	public Smart3DLayerFactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCSmart3DLayerFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.atlas.Smart3DLayerFactory".equals(this.getClass().getName()))
		{
	 ...
	 * 返回单例的图层工厂
	 */
	public static com.earthview.world.spatial3d.atlas.Smart3DLayerFactory getSingletonPtr()
	{
		long returnValue = getSingletonPtr_void();
		if(returnValue == 0L) {
			return null;
		}
		com.earthview.world.spatial3d.atlas.Smart3DLayerFactory __returnValue = new com.earthview.world.spatial3d.atlas.Smart3DLayerFactory(CreatedWhenConstruct.CWC_NotToCreate, "CSmart3DLayerFactory");
		...
		{
			__returnValue.setDelegate(true);
			__returnValue = (com.earthview.world.spatial3d.atlas.Smart3DLayerFactory)__returnValueClassFactory.create();
			__returnValue.setDelegate(true);
			__returnValue.bindNativeObject(__instancePointer, "CSmart3DLayerFactory");
		}
	...
	public Smart3DLayerFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Smart3DLayerFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Smart3DLayerFactory fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		Smart3DLayerFactory obj = null;
 		if(baseObj instanceof Smart3DLayerFactory)
		{
			obj = (Smart3DLayerFactory)baseObj;
		} else {
			obj = new Smart3DLayerFactory(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CSmart3DLayerFactory");
			obj.increaseCast();
		}
