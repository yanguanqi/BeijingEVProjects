...
public class LocalDemDataset extends com.earthview.world.spatial.Evdemdataset {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::CLocalDemDataset", new LocalDemDatasetClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::JCLocalDemDatasetProxy", new LocalDemDatasetClassFactory());
	}

	protected  int getDEMFile_ev_int32_ev_int32_ev_int32_CMemoryStreamResult_callback(int level, int row, int col, long serverresult)
	{
		...
		int returnValue = getDEMFile(levelParamValue, rowParamValue, colParamValue, serverresultParamValue);
	...
	native private int getDEMFile_ev_int32_ev_int32_ev_int32_CMemoryStreamResult_NoVirtual(long pNativeObject, int level, int row, int col, long serverresult);
	protected int getDEMFile_NoVirtual(int level, int row, int col, com.earthview.world.spatial.MemoryStreamResult serverresult)
	{
		int levelParamValue = level;
		int rowParamValue = row;
		int colParamValue = col;
		long serverresultParamValue = serverresult.nativeObject.pointer;
		int returnValue = getDEMFile_ev_int32_ev_int32_ev_int32_CMemoryStreamResult_NoVirtual(this.nativeObject.pointer, levelParamValue, rowParamValue, colParamValue, serverresultParamValue);
		return returnValue;
	}

	protected  long getLayerInfoRef_void_callback()
	{
		com.earthview.world.spatial.Evdemlayerinfo returnValue = getLayerInfoRef();
		if(returnValue == null) {
			return 0L;
		}
	...
	protected com.earthview.world.spatial.Evdemlayerinfo getLayerInfoRef_NoVirtual()
	{
	...
	public LocalDemDataset(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public LocalDemDataset(CreatedWhenConstruct cwc, String classNameStr) {
	...
	native protected void register_getDEMFile_ev_int32_ev_int32_ev_int32_CMemoryStreamResult(long pNativeObject, String method);
	...
	public void registerCallback(){
		if (!this.nativeObject.equals(InstancePointer.ZERO)){
			this.register_getDEMFile_ev_int32_ev_int32_ev_int32_CMemoryStreamResult(this.nativeObject.pointer, "getDEMFile_ev_int32_ev_int32_ev_int32_CMemoryStreamResult_callback");
	...
	public static LocalDemDataset fromBaseObject(BaseObject baseObj)
	{
		...
		LocalDemDataset obj = null;
 		if(baseObj instanceof LocalDemDataset)
		{
			obj = (LocalDemDataset)baseObj;
		} else {
