 ...
 * 类工厂
 */
public class Evlasxglayerfactory extends com.earthview.world.spatial.atlas.Ilayerfactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::CEVLasXGLayerFactory", new EvlasxglayerfactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::JCEVLasXGLayerFactoryProxy", new EvlasxglayerfactoryClassFactory());
	}

	/**
	 * 构造函数
	 */
	public Evlasxglayerfactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCEVLasXGLayerFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.atlas.Evlasxglayerfactory".equals(this.getClass().getName()))
		{
	 ...
	 * 返回单例的图层工厂
	 */
	public static com.earthview.world.spatial3d.atlas.Evlasxglayerfactory getSingletonPtr()
	{
		long returnValue = getSingletonPtr_void();
		if(returnValue == 0L) {
			return null;
		}
		com.earthview.world.spatial3d.atlas.Evlasxglayerfactory __returnValue = new com.earthview.world.spatial3d.atlas.Evlasxglayerfactory(CreatedWhenConstruct.CWC_NotToCreate, "CEVLasXGLayerFactory");
		...
		{
			__returnValue.setDelegate(true);
			__returnValue = (com.earthview.world.spatial3d.atlas.Evlasxglayerfactory)__returnValueClassFactory.create();
			__returnValue.setDelegate(true);
			__returnValue.bindNativeObject(__instancePointer, "CEVLasXGLayerFactory");
		}
	...
	native private static String get_msLasXGLayerFactoryName_void();
	public static String get_msLasXGLayerFactoryName()
	{
		String jniValue = get_msLasXGLayerFactoryName_void();
		
		return jniValue;
	}
	
	public Evlasxglayerfactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Evlasxglayerfactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Evlasxglayerfactory fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		Evlasxglayerfactory obj = null;
 		if(baseObj instanceof Evlasxglayerfactory)
		{
			obj = (Evlasxglayerfactory)baseObj;
		} else {
			obj = new Evlasxglayerfactory(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CEVLasXGLayerFactory");
			obj.increaseCast();
		}
