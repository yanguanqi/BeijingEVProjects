...
public class PolygonEditTool extends com.earthview.world.spatial.systemui.Itool {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::KmlManager::CPolygonEditTool", new PolygonEditToolClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::KmlManager::JCPolygonEditToolProxy", new PolygonEditToolClassFactory());
	}
	 ...
	 * @param parent kml文档
	 */
	public PolygonEditTool(com.earthview.world.graphic.SceneManager ref_sceneMgr, com.earthview.world.graphic.Camera ref_camera, com.earthview.world.graphic.Viewport ref_viewPort, com.earthview.world.spatial.kml.GeoObjectExtension geoObj, com.earthview.world.spatial.kml.KmlDocument ref_parent) {
		...
		Create("JCPolygonEditToolProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.kmlmanager.PolygonEditTool".equals(this.getClass().getName()))
		{
	...
	native private void setPolygonExtrude_ev_bool(long pNativeObject, boolean isExtrude);
	public void setPolygonExtrude(boolean isExtrude)
	{
		boolean isExtrudeParamValue = isExtrude;
		setPolygonExtrude_ev_bool(this.nativeObject.pointer, isExtrudeParamValue);
	}
	native private boolean getPolygonExtrude_void(long pNativeObject);
	public boolean getPolygonExtrude()
	{
		boolean returnValue = getPolygonExtrude_void(this.nativeObject.pointer);
		return returnValue;
	}
	...
	public PolygonEditTool(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public PolygonEditTool(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static PolygonEditTool fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		PolygonEditTool obj = null;
 		if(baseObj instanceof PolygonEditTool)
		{
			obj = (PolygonEditTool)baseObj;
		} else {
			obj = new PolygonEditTool(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CPolygonEditTool");
			obj.increaseCast();
		}
