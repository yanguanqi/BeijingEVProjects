...
public class CommandSaveEdits extends com.earthview.world.spatial2d.controls.MapCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CCommandSaveEdits", new CommandSaveEditsClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCCommandSaveEditsProxy", new CommandSaveEditsClassFactory());
	}
	 ...
	 * @param  
	 */
	public CommandSaveEdits() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandSaveEditsProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.CommandSaveEdits".equals(this.getClass().getName()))
		{
	...
	public CommandSaveEdits(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandSaveEdits(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandSaveEdits fromBaseObject(BaseObject baseObj)
	{
		...
		CommandSaveEdits obj = null;
 		if(baseObj instanceof CommandSaveEdits)
		{
			obj = (CommandSaveEdits)baseObj;
		} else {
