...
/**
 * 停止编辑命令类提供方法如下：获取工具条类型、类型、名称、类别、工具、图标是否可以选择、点击命令、操作更新
 */
public class CommandStopEditing extends com.earthview.world.spatial2d.controls.EditCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CCommandStopEditing", new CommandStopEditingClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCCommandStopEditingProxy", new CommandStopEditingClassFactory());
	}
	 ...
	 * @param  
	 */
	public CommandStopEditing() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandStopEditingProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.CommandStopEditing".equals(this.getClass().getName()))
		{
	...
	public CommandStopEditing(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandStopEditing(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandStopEditing fromBaseObject(BaseObject baseObj)
	{
		...
		CommandStopEditing obj = null;
 		if(baseObj instanceof CommandStopEditing)
		{
			obj = (CommandStopEditing)baseObj;
		} else {
