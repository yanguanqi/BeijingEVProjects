...
/**
 * 开始编辑命令类提供方法如下：获取工具条类型、类型、名称、类别、工具、图标是否可以选择、点击命令、操作更新
 */
public class CommandStartEditing extends com.earthview.world.spatial2d.controls.EditCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CCommandStartEditing", new CommandStartEditingClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCCommandStartEditingProxy", new CommandStartEditingClassFactory());
	}
	 ...
	 * @param  
	 */
	public CommandStartEditing() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandStartEditingProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.CommandStartEditing".equals(this.getClass().getName()))
		{
	...
	public CommandStartEditing(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandStartEditing(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandStartEditing fromBaseObject(BaseObject baseObj)
	{
		...
		CommandStartEditing obj = null;
 		if(baseObj instanceof CommandStartEditing)
		{
			obj = (CommandStartEditing)baseObj;
		} else {
