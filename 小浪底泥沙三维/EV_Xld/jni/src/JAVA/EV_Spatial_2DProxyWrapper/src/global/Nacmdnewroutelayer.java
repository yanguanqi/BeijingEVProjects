 ...
 * 新建路径分析图层命令
 */
public class Nacmdnewroutelayer extends com.earthview.world.spatial.systemui.Icommand {
	 ...
	 * @param bar 网络分析工具条
	 */
	public Nacmdnewroutelayer(NetworkAnalystToolBar ref_bar) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer ref_barPtr = new BasePointer(ref_bar);
		list.add("ref_bar", ref_barPtr.get());
		Create("JCNACmdNewRouteLayerProxy", list, true);
		this.registerCallback();
		if (!"global.Nacmdnewroutelayer".equals(this.getClass().getName()))
		{
	...
	public Nacmdnewroutelayer(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Nacmdnewroutelayer(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Nacmdnewroutelayer fromBaseObject(BaseObject baseObj)
	{
		...
		Nacmdnewroutelayer obj = null;
 		if(baseObj instanceof Nacmdnewroutelayer)
		{
			obj = (Nacmdnewroutelayer)baseObj;
		} else {
