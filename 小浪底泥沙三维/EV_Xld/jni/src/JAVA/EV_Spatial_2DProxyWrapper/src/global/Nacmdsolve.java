 ...
 * 网络分析求解命令
 */
public class Nacmdsolve extends com.earthview.world.spatial.systemui.Icommand {
	 ...
	 * @param bar 网络分析工具条
	 */
	public Nacmdsolve(NetworkAnalystToolBar ref_bar) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer ref_barPtr = new BasePointer(ref_bar);
		list.add("ref_bar", ref_barPtr.get());
		Create("JCNACmdSolveProxy", list, true);
		this.registerCallback();
		if (!"global.Nacmdsolve".equals(this.getClass().getName()))
		{
	...
	public Nacmdsolve(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Nacmdsolve(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Nacmdsolve fromBaseObject(BaseObject baseObj)
	{
		...
		Nacmdsolve obj = null;
 		if(baseObj instanceof Nacmdsolve)
		{
			obj = (Nacmdsolve)baseObj;
		} else {
