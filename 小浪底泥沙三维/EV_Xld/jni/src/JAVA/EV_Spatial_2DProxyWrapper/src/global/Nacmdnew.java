 ...
 * 新建网络分析命令
 */
public class Nacmdnew extends com.earthview.world.spatial.systemui.Itoolbutton {
	 ...
	 * @param bar 网络分析工具条
	 */
	public Nacmdnew(NetworkAnalystToolBar ref_bar) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer ref_barPtr = new BasePointer(ref_bar);
		list.add("ref_bar", ref_barPtr.get());
		Create("JCNACmdNewProxy", list, true);
		this.registerCallback();
		if (!"global.Nacmdnew".equals(this.getClass().getName()))
		{
	...
	public Nacmdnew(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Nacmdnew(CreatedWhenConstruct cwc, String classNameStr) {
	...
	{
		super.addCommand_NoVirtual(ref_cmd);
	}
	...
	public static Nacmdnew fromBaseObject(BaseObject baseObj)
	{
		...
		Nacmdnew obj = null;
 		if(baseObj instanceof Nacmdnew)
		{
			obj = (Nacmdnew)baseObj;
		} else {
