 ...
 * 网络分析图层下拉框
 */
public class Nacmdlayer extends com.earthview.world.spatial.systemui.Ientrybox {
	 ...
	 * @param bar 网络分析工具条
	 */
	public Nacmdlayer(NetworkAnalystToolBar ref_bar) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer ref_barPtr = new BasePointer(ref_bar);
		list.add("ref_bar", ref_barPtr.get());
		Create("JCNACmdLayerProxy", list, true);
		this.registerCallback();
		if (!"global.Nacmdlayer".equals(this.getClass().getName()))
		{
	...
	public Nacmdlayer(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Nacmdlayer(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Nacmdlayer fromBaseObject(BaseObject baseObj)
	{
		...
		Nacmdlayer obj = null;
 		if(baseObj instanceof Nacmdlayer)
		{
			obj = (Nacmdlayer)baseObj;
		} else {
