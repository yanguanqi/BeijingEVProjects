 ...
 * 网络分析停靠点
 */
public class Natoolstop extends com.earthview.world.spatial2d.controls.Tool2D {
	 ...
	 * @param bar 网络分析工具条
	 */
	public Natoolstop(NetworkAnalystToolBar ref_bar) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer ref_barPtr = new BasePointer(ref_bar);
		list.add("ref_bar", ref_barPtr.get());
		Create("JCNAToolStopProxy", list, true);
		this.registerCallback();
		if (!"global.Natoolstop".equals(this.getClass().getName()))
		{
	...
	public Natoolstop(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Natoolstop(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Natoolstop fromBaseObject(BaseObject baseObj)
	{
		...
		Natoolstop obj = null;
 		if(baseObj instanceof Natoolstop)
		{
			obj = (Natoolstop)baseObj;
		} else {
