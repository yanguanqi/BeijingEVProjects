 ...
 * 网络分析位置调整命令
 */
public class Natooladjust extends com.earthview.world.spatial2d.controls.Tool2D {
	 ...
	 * @param bar 网络分析工具条
	 */
	public Natooladjust(NetworkAnalystToolBar ref_bar) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer ref_barPtr = new BasePointer(ref_bar);
		list.add("ref_bar", ref_barPtr.get());
		Create("JCNAToolAdjustProxy", list, true);
		this.registerCallback();
		if (!"global.Natooladjust".equals(this.getClass().getName()))
		{
	...
	public Natooladjust(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Natooladjust(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Natooladjust fromBaseObject(BaseObject baseObj)
	{
		...
		Natooladjust obj = null;
 		if(baseObj instanceof Natooladjust)
		{
			obj = (Natooladjust)baseObj;
		} else {
