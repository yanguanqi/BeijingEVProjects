 ...
 */
public class StringArray extends com.earthview.world.core.AllocatedObject {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Core::CStringArray", new StringArrayClassFactory());
	}

	public StringArray() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("CStringArray", null);
	}
	...
	native private long append_ev_string(long pNativeObject, String strNewItem);
	/**
	 * 函数说明：在数组尾部添加字符串
	...
	public long append(String strNewItem)
	{
		...
		long returnValue = append_ev_string(this.nativeObject.pointer, strNewItemParamValue);
		return returnValue;
	}
	native private void insertAt_ev_uint32_ev_string(long pNativeObject, long index, String strNewItem);
	/**
	 * 函数说明：在设定的位置插入字符串
	 * @param index 新字符位置
	 * @param strNewItem 新字符串项
	...
	public void insertAt(long index, String strNewItem)
	{
		...
		String strNewItemParamValue = strNewItem;
		insertAt_ev_uint32_ev_string(this.nativeObject.pointer, indexParamValue, strNewItemParamValue);
	}
	 ...
	 * @return 返回的字符串(不拷贝)
	 */
	public StringPointer at(long index)
	{
		long indexParamValue = index;
	...
	public StringArray(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public StringArray(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static StringArray fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		StringArray obj = null;
 		if(baseObj instanceof StringArray)
		{
			obj = (StringArray)baseObj;
		} else {
			obj = new StringArray(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CStringArray");
			obj.increaseCast();
		}
