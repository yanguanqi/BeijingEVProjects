...
/**
 * 项目一致性的异常类跳出项目一致性异常信息
 */
public class ItemIdentityException extends com.earthview.world.core.EVException {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Core::CItemIdentityException", new ItemIdentityExceptionClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Core::JCItemIdentityExceptionProxy", new ItemIdentityExceptionClassFactory());
	}
	 ...
	 */
	public ItemIdentityException(int inNumber, String inDescription, String inSource, BytePointer inFile, int inLine) {
		...
		Create("JCItemIdentityExceptionProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.core.ItemIdentityException".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
		}
	}

	public ItemIdentityException(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ItemIdentityException(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ItemIdentityException fromBaseObject(BaseObject baseObj)
	{
		...
		ItemIdentityException obj = null;
 		if(baseObj instanceof ItemIdentityException)
		{
			obj = (ItemIdentityException)baseObj;
		} else {
