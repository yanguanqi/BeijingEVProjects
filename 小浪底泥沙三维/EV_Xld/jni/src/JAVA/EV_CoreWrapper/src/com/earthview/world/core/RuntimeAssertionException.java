...
/**
 * 运行时断言的异常类跳出运行时断言异常信息
 */
public class RuntimeAssertionException extends com.earthview.world.core.EVException {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Core::CRuntimeAssertionException", new RuntimeAssertionExceptionClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Core::JCRuntimeAssertionExceptionProxy", new RuntimeAssertionExceptionClassFactory());
	}
	 ...
	 */
	public RuntimeAssertionException(int inNumber, String inDescription, String inSource, BytePointer inFile, int inLine) {
		...
		Create("JCRuntimeAssertionExceptionProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.core.RuntimeAssertionException".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
		}
	}

	public RuntimeAssertionException(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public RuntimeAssertionException(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static RuntimeAssertionException fromBaseObject(BaseObject baseObj)
	{
		...
		RuntimeAssertionException obj = null;
 		if(baseObj instanceof RuntimeAssertionException)
		{
			obj = (RuntimeAssertionException)baseObj;
		} else {
