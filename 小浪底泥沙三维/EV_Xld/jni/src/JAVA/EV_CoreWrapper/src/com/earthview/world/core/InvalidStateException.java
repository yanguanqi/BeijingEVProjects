 ...
 * 无效声明的异常类跳出无效声明异常信息
 */
public class InvalidStateException extends com.earthview.world.core.EVException {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Core::CInvalidStateException", new InvalidStateExceptionClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Core::JCInvalidStateExceptionProxy", new InvalidStateExceptionClassFactory());
	}
	 ...
	 */
	public InvalidStateException(int inNumber, String inDescription, String inSource, BytePointer inFile, int inLine) {
		...
		Create("JCInvalidStateExceptionProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.core.InvalidStateException".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
		}
	}

	public InvalidStateException(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public InvalidStateException(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static InvalidStateException fromBaseObject(BaseObject baseObj)
	{
		...
		InvalidStateException obj = null;
 		if(baseObj instanceof InvalidStateException)
		{
			obj = (InvalidStateException)baseObj;
		} else {
