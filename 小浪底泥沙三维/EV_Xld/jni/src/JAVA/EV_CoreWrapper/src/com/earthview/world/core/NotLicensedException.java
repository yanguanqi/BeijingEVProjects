 ...
 * 未许可的异常类跳出未实现异常信息
 */
public class NotLicensedException extends com.earthview.world.core.EVException {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Core::CNotLicensedException", new NotLicensedExceptionClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Core::JCNotLicensedExceptionProxy", new NotLicensedExceptionClassFactory());
	}
	 ...
	 */
	public NotLicensedException(int inNumber, String inDescription, String inSource, BytePointer inFile, int inLine) {
		...
		Create("JCNotLicensedExceptionProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.core.NotLicensedException".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
		}
	}

	public NotLicensedException(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public NotLicensedException(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static NotLicensedException fromBaseObject(BaseObject baseObj)
	{
		...
		NotLicensedException obj = null;
 		if(baseObj instanceof NotLicensedException)
		{
			obj = (NotLicensedException)baseObj;
		} else {
