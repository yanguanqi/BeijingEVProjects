 ...
 * 未实现的异常类跳出未实现异常信息
 */
public class UnimplementedException extends com.earthview.world.core.EVException {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Core::CUnimplementedException", new UnimplementedExceptionClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Core::JCUnimplementedExceptionProxy", new UnimplementedExceptionClassFactory());
	}
	 ...
	 */
	public UnimplementedException(int inNumber, String inDescription, String inSource, BytePointer inFile, int inLine) {
		...
		Create("JCUnimplementedExceptionProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.core.UnimplementedException".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
		}
	}

	public UnimplementedException(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public UnimplementedException(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static UnimplementedException fromBaseObject(BaseObject baseObj)
	{
		...
		UnimplementedException obj = null;
 		if(baseObj instanceof UnimplementedException)
		{
			obj = (UnimplementedException)baseObj;
		} else {
