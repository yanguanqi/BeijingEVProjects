 ...
 * 渲染接口的异常类跳出渲染接口异常信息
 */
public class RenderingAPIException extends com.earthview.world.core.EVException {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Core::CRenderingAPIException", new RenderingAPIExceptionClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Core::JCRenderingAPIExceptionProxy", new RenderingAPIExceptionClassFactory());
	}
	 ...
	 */
	public RenderingAPIException(int inNumber, String inDescription, String inSource, BytePointer inFile, int inLine) {
		...
		Create("JCRenderingAPIExceptionProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.core.RenderingAPIException".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
		}
	}

	public RenderingAPIException(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public RenderingAPIException(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static RenderingAPIException fromBaseObject(BaseObject baseObj)
	{
		...
		RenderingAPIException obj = null;
 		if(baseObj instanceof RenderingAPIException)
		{
			obj = (RenderingAPIException)baseObj;
		} else {
