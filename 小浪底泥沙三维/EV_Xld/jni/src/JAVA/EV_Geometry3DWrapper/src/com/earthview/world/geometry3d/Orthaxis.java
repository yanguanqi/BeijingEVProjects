 ...
 * 坐标轴类
 */
public class Orthaxis extends com.earthview.world.graphic.MovableObject {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::COrthaxis", new OrthaxisClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::JCOrthaxisProxy", new OrthaxisClassFactory());
	}

	/**
	 * 坐标轴内部渲染类
	 */
	public static class OrthaxisInternalRenderable extends com.earthview.world.graphic.Renderable {
		
		static {
			GlobalClassFactoryMap.put("EarthView::World::Geometry3D::COrthaxis::COrthaxisInternalRenderable", new OrthaxisInternalRenderableClassFactory());
			GlobalClassFactoryMap.put("EarthView::World::Geometry3D::COrthaxis::JCOrthaxisInternalRenderableProxy", new OrthaxisInternalRenderableClassFactory());
		}
		 ...
		 * @param parent 坐标轴
		 */
		public OrthaxisInternalRenderable(com.earthview.world.geometry3d.Orthaxis ref_parent) {
			super(CreatedWhenConstruct.CWC_NotToCreate);
			NameValuePairList list = new NameValuePairList();
			BasePointer ref_parentPtr = new BasePointer(ref_parent);
			list.add("ref_parent", ref_parentPtr.get());
			Create("JCOrthaxisInternalRenderableProxy", list, true);
			this.registerCallback();
			if (!"com.earthview.world.geometry3d.Orthaxis$OrthaxisInternalRenderable".equals(this.getClass().getName()))
			{
		 ...
		 * @param length 坐标轴长度
		 */
		public OrthaxisInternalRenderable(com.earthview.world.geometry3d.Orthaxis ref_parent, ULongPointer length) {
			super(CreatedWhenConstruct.CWC_NotToCreate);
			NameValuePairList list = new NameValuePairList();
			BasePointer ref_parentPtr = new BasePointer(ref_parent);
			list.add("ref_parent", ref_parentPtr.get());
		...
		native private void setOrthaxisLength_ev_uint64(long pNativeObject, long length);
		/**
		 * 设置坐标轴长度
		 * @param length 坐标轴长度
		 */
		public void setOrthaxisLength(ULongPointer length)
		{
			long lengthParamValue = length.nativeObject.pointer;
			setOrthaxisLength_ev_uint64(this.nativeObject.pointer, lengthParamValue);
		}
		native private long getOrthaxisLength_void(long pNativeObject);
		/**
		 * 获取坐标轴长度
		 * @param  
		 * @return 坐标轴长度
		 */
		public long getOrthaxisLength()
		{
			long returnValue = getOrthaxisLength_void(this.nativeObject.pointer);
			return returnValue;
		}
		...
		public OrthaxisInternalRenderable(CreatedWhenConstruct cwc) {
			super(CreatedWhenConstruct.CWC_NotToCreate);
		}
		public OrthaxisInternalRenderable(CreatedWhenConstruct cwc, String classNameStr) {
		...
		public static OrthaxisInternalRenderable fromBaseObject(BaseObject baseObj)
		{
			...
			OrthaxisInternalRenderable obj = null;
 			if(baseObj instanceof OrthaxisInternalRenderable)
			{
				obj = (OrthaxisInternalRenderable)baseObj;
			} else {
	...
	public static class OrthaxisInternalRenderableClassFactory implements IClassFactory {
	...
	public Orthaxis() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCOrthaxisProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.geometry3d.Orthaxis".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
		}
	}
	 ...
	 * @param  
	 */
	public Orthaxis(ULongPointer length) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer lengthPtr = new BasePointer(length);
		list.add("length", lengthPtr.get());
		Create("JCOrthaxisProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.geometry3d.Orthaxis".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
	...
	native private void setOrthaxisLength_ev_uint32(long pNativeObject, long length);
	/**
	 * 设置坐标轴长度
	 * @param length 坐标轴长度
	 */
	public void setOrthaxisLength(long length)
	{
		long lengthParamValue = length;
		setOrthaxisLength_ev_uint32(this.nativeObject.pointer, lengthParamValue);
	}
	native private long getOrthaxisLength_void(long pNativeObject);
	/**
	 * 获得坐标轴长度
	...
	public Orthaxis(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Orthaxis(CreatedWhenConstruct cwc, String classNameStr) {
		super(CreatedWhenConstruct.CWC_NotToCreate, classNameStr);
	}
	...
	public static Orthaxis fromBaseObject(BaseObject baseObj)
	{
		...
		Orthaxis obj = null;
 		if(baseObj instanceof Orthaxis)
		{
			obj = (Orthaxis)baseObj;
		} else {
