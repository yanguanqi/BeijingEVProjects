...
///  提供设置线的宽度和填充符号(未实现)
/// <summary>
public class MovableLine2 extends com.earthview.world.geometry3d.MovableLine {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::CMovableLine2", new MovableLine2ClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::JCMovableLine2Proxy", new MovableLine2ClassFactory());
	}

	public MovableLine2() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCMovableLine2Proxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.geometry3d.MovableLine2".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
		}
	}

	public MovableLine2(com.earthview.world.geometry3d.MovableLine2 other) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer otherPtr = new BasePointer(other);
		list.add("other", otherPtr.get());
		Create("JCMovableLine2Proxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.geometry3d.MovableLine2".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
	...
	native private long OperatorAssign_CMovableLine2(long pNativeObject, long other);
	public com.earthview.world.geometry3d.MovableLine2 OperatorAssign(com.earthview.world.geometry3d.MovableLine2 other)
	{
		long otherParamValue = other.nativeObject.pointer;
		long returnValue = OperatorAssign_CMovableLine2(this.nativeObject.pointer, otherParamValue);
	...
	native private void setLineWidth_Real(long pNativeObject, double width);
	/// <summary>
	///  设置线宽
	/// <summary>
	public void setLineWidth(double width)
	{
		...
		setLineWidth_Real(this.nativeObject.pointer, widthParamValue);
	}
	native private double getLineWidth_void(long pNativeObject);
	/// <summary>
	///  获取线宽
	/// <summary>
	public double getLineWidth()
	{
		double returnValue = getLineWidth_void(this.nativeObject.pointer);
		return returnValue;
	}
	...
	public MovableLine2(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public MovableLine2(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static MovableLine2 fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		MovableLine2 obj = null;
 		if(baseObj instanceof MovableLine2)
		{
			obj = (MovableLine2)baseObj;
		} else {
			obj = new MovableLine2(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CMovableLine2");
			obj.increaseCast();
		}
