...
/// 2. 提供了绘制方法
/// <summary>
public class MovableEllipsoid extends com.earthview.world.geometry3d.Geometry3D {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::CMovableEllipsoid", new MovableEllipsoidClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::JCMovableEllipsoidProxy", new MovableEllipsoidClassFactory());
	}

	public MovableEllipsoid() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCMovableEllipsoidProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.geometry3d.MovableEllipsoid".equals(this.getClass().getName()))
		{
	...
	public MovableEllipsoid(com.earthview.world.spatial.math.Vector3 centerPoint, double xRadius, double yRadius, double zRadius, com.earthview.world.graphic.ColourValue fillClr, com.earthview.world.graphic.ColourValue frameClr, com.earthview.world.geometry3d.DrawingMode drawingMode, boolean includeTextureCoordinates) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer centerPointPtr = new BasePointer(centerPoint);
		list.add("centerPoint", centerPointPtr.get());
		BasePointer xRadiusPtr = new BasePointer(xRadius);
		list.add("xRadius", xRadiusPtr.get());
		BasePointer yRadiusPtr = new BasePointer(yRadius);
		list.add("yRadius", yRadiusPtr.get());
		BasePointer zRadiusPtr = new BasePointer(zRadius);
		list.add("zRadius", zRadiusPtr.get());
		...
		Create("JCMovableEllipsoidProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.geometry3d.MovableEllipsoid".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
	...
	public MovableEllipsoid(com.earthview.world.geometry3d.MovableEllipsoid other) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
	...
	native private long OperatorAssign_CMovableEllipsoid(long pNativeObject, long other);
	public com.earthview.world.geometry3d.MovableEllipsoid OperatorAssign(com.earthview.world.geometry3d.MovableEllipsoid other)
	{
		long otherParamValue = other.nativeObject.pointer;
		long returnValue = OperatorAssign_CMovableEllipsoid(this.nativeObject.pointer, otherParamValue);
		com.earthview.world.geometry3d.MovableEllipsoid __returnValue = new com.earthview.world.geometry3d.MovableEllipsoid(CreatedWhenConstruct.CWC_NotToCreate, "CMovableEllipsoid");
		...
		{
			__returnValue.setDelegate(true);
			__returnValue = (com.earthview.world.geometry3d.MovableEllipsoid)__returnValueClassFactory.create();
			__returnValue.setDelegate(true);
			__returnValue.bindNativeObject(__instancePointer, "CMovableEllipsoid");
		}
		return __returnValue;
	}
	native private double getXRadius_void(long pNativeObject);
	/// <summary>
	///  获取X方向轴长
	/// <summary>
	public double getXRadius()
	{
		double returnValue = getXRadius_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private double getYRadius_void(long pNativeObject);
	/// <summary>
	///  获取Y方向轴长
	/// <summary>
	public double getYRadius()
	{
		double returnValue = getYRadius_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private double getZRadius_void(long pNativeObject);
	/// <summary>
	///  获取Z方向轴长
	/// <summary>
	public double getZRadius()
	{
		double returnValue = getZRadius_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private void setXRadius_Real(long pNativeObject, double radius);
	/// <summary>
	///  设置X方向轴长
	/// <summary>
	public void setXRadius(double radius)
	{
		...
		setXRadius_Real(this.nativeObject.pointer, radiusParamValue);
	}
	native private void setYRadius_Real(long pNativeObject, double radius);
	/// <summary>
	///  设置Y方向轴长
	/// <summary>
	...
	{
		double radiusParamValue = radius;
		setYRadius_Real(this.nativeObject.pointer, radiusParamValue);
	}
	native private void setZRadius_Real(long pNativeObject, double radius);
	/// <summary>
	///  设置Z方向轴长
	/// <summary>
	public void setZRadius(double radius)
	{
		double radiusParamValue = radius;
		setZRadius_Real(this.nativeObject.pointer, radiusParamValue);
	}
	native private void setRadius_Real_Real_Real(long pNativeObject, double x, double y, double z);
	/// <summary>
	///  设置X,Y,Z三个方向轴长
	/// <summary>
	public void setRadius(double x, double y, double z)
	{
		double xParamValue = x;
		double yParamValue = y;
		double zParamValue = z;
		setRadius_Real_Real_Real(this.nativeObject.pointer, xParamValue, yParamValue, zParamValue);
	}
	...
	public MovableEllipsoid(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public MovableEllipsoid(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static MovableEllipsoid fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		MovableEllipsoid obj = null;
 		if(baseObj instanceof MovableEllipsoid)
		{
			obj = (MovableEllipsoid)baseObj;
		} else {
			obj = new MovableEllipsoid(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CMovableEllipsoid");
			obj.increaseCast();
		}
