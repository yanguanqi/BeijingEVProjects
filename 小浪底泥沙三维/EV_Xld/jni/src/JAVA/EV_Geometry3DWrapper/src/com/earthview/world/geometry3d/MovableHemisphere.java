...
/// 2. 提供了绘制方法
/// <summary>
public class MovableHemisphere extends com.earthview.world.geometry3d.Geometry3D {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::CMovableHemisphere", new MovableHemisphereClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::JCMovableHemisphereProxy", new MovableHemisphereClassFactory());
	}

	public MovableHemisphere() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCMovableHemisphereProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.geometry3d.MovableHemisphere".equals(this.getClass().getName()))
		{
	...
	public MovableHemisphere(com.earthview.world.spatial.math.Vector3 centerPoint, double radius, com.earthview.world.graphic.ColourValue fillClr, com.earthview.world.graphic.ColourValue frameClr, com.earthview.world.geometry3d.DrawingMode drawingMode, boolean closed, boolean includeTextureCoordinates) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		...
		BasePointer fillClrPtr = new BasePointer(fillClr);
		list.add("fillClr", fillClrPtr.get());
		BasePointer frameClrPtr = new BasePointer(frameClr);
		list.add("frameClr", frameClrPtr.get());
		BasePointer drawingModePtr = new BasePointer(drawingMode);
		list.add("drawingMode", drawingModePtr.get());
		BasePointer closedPtr = new BasePointer(closed);
		list.add("closed", closedPtr.get());
		BasePointer includeTextureCoordinatesPtr = new BasePointer(includeTextureCoordinates);
		list.add("includeTextureCoordinates", includeTextureCoordinatesPtr.get());
		Create("JCMovableHemisphereProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.geometry3d.MovableHemisphere".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
	...
	public MovableHemisphere(com.earthview.world.geometry3d.MovableHemisphere other) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
	...
	native private long OperatorAssign_CMovableHemisphere(long pNativeObject, long other);
	public com.earthview.world.geometry3d.MovableHemisphere OperatorAssign(com.earthview.world.geometry3d.MovableHemisphere other)
	{
		long otherParamValue = other.nativeObject.pointer;
		long returnValue = OperatorAssign_CMovableHemisphere(this.nativeObject.pointer, otherParamValue);
		com.earthview.world.geometry3d.MovableHemisphere __returnValue = new com.earthview.world.geometry3d.MovableHemisphere(CreatedWhenConstruct.CWC_NotToCreate, "CMovableHemisphere");
		...
		{
			__returnValue.setDelegate(true);
			__returnValue = (com.earthview.world.geometry3d.MovableHemisphere)__returnValueClassFactory.create();
			__returnValue.setDelegate(true);
			__returnValue.bindNativeObject(__instancePointer, "CMovableHemisphere");
		}
	...
	native private boolean getBottomClosed_void(long pNativeObject);
	/// <summary>
	///  获取球心
	/// <summary>
	public boolean getBottomClosed()
	{
		boolean returnValue = getBottomClosed_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private void setBottomClosed_ev_bool(long pNativeObject, boolean closed);
	/// <summary>
	///  设置球心
	/// <summary>
	public void setBottomClosed(boolean closed)
	{
		boolean closedParamValue = closed;
		setBottomClosed_ev_bool(this.nativeObject.pointer, closedParamValue);
	}
	...
	///  获取圆柱体颜色
	/// <summary>
	public com.earthview.world.graphic.ColourValue getFillColor()
	{
	...
	native private void setFillColor_CColourValue(long pNativeObject, long clr);
	/// <summary>
	///  设置圆柱体颜色
	/// <summary>
	public void setFillColor(com.earthview.world.graphic.ColourValue clr)
	{
		long clrParamValue = clr.nativeObject.pointer;
		setFillColor_CColourValue(this.nativeObject.pointer, clrParamValue);
	}
	native private long getClosedColor_void(long pNativeObject);
	/// <summary>
	///  获取圆柱体颜色
	/// <summary>
	public com.earthview.world.graphic.ColourValue getClosedColor()
	{
		long returnValue = getClosedColor_void(this.nativeObject.pointer);
		com.earthview.world.graphic.ColourValue __returnValue = new com.earthview.world.graphic.ColourValue(CreatedWhenConstruct.CWC_NotToCreate);
		InstancePointer __instancePointer = new InstancePointer(returnValue);
		__returnValue.bindNativeObject(__instancePointer, "CColourValue");
		__returnValue.createNativeObjectPointer(__instancePointer);
	...
	native private void setClosedColor_CColourValue(long pNativeObject, long clr);
	/// <summary>
	///  设置圆柱体颜色
	/// <summary>
	public void setClosedColor(com.earthview.world.graphic.ColourValue clr)
	{
		long clrParamValue = clr.nativeObject.pointer;
		setClosedColor_CColourValue(this.nativeObject.pointer, clrParamValue);
	}
	native private long getFrameColor_void(long pNativeObject);
	/// <summary>
	///  获取圆柱体边框颜色
	/// <summary>
	public com.earthview.world.graphic.ColourValue getFrameColor()
	{
		long returnValue = getFrameColor_void(this.nativeObject.pointer);
		com.earthview.world.graphic.ColourValue __returnValue = new com.earthview.world.graphic.ColourValue(CreatedWhenConstruct.CWC_NotToCreate);
		InstancePointer __instancePointer = new InstancePointer(returnValue);
		__returnValue.bindNativeObject(__instancePointer, "CColourValue");
		__returnValue.createNativeObjectPointer(__instancePointer);
	...
	native private void setFrameColor_CColourValue(long pNativeObject, long clr);
	/// <summary>
	///  设置圆柱体边框颜色
	/// <summary>
	public void setFrameColor(com.earthview.world.graphic.ColourValue clr)
	{
		long clrParamValue = clr.nativeObject.pointer;
		setFrameColor_CColourValue(this.nativeObject.pointer, clrParamValue);
	}
	native private int getDrawingMode_void(long pNativeObject);
	/// <summary>
	///  获取是绘制模式
	/// <summary>
	public com.earthview.world.geometry3d.DrawingMode getDrawingMode()
	{
		int returnValue = getDrawingMode_void(this.nativeObject.pointer);
		return com.earthview.world.geometry3d.DrawingMode.toEnum(returnValue);
	}
	...
	native private long getLongitudeGranularity_void(long pNativeObject);
	/// <summary>
	///  获取经度方向网格密度
	/// <summary>
	public long getLongitudeGranularity()
	{
		long returnValue = getLongitudeGranularity_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private void setLatitudeGranularity_ev_uint32(long pNativeObject, long latitudeGranularity);
	/// <summary>
	///  设置经度方向网格密度
	/// <summary>
	public void setLatitudeGranularity(long latitudeGranularity)
	{
		long latitudeGranularityParamValue = latitudeGranularity;
		setLatitudeGranularity_ev_uint32(this.nativeObject.pointer, latitudeGranularityParamValue);
	}
	native private long getLatitudeGranularity_void(long pNativeObject);
	/// <summary>
	///  获取纬度方向网格密度
	/// <summary>
	public long getLatitudeGranularity()
	{
		long returnValue = getLatitudeGranularity_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private void setLongitudeGranularity_ev_uint32(long pNativeObject, long longitudeGranularity);
	/// <summary>
	///  设置纬度方向网格密度
	/// <summary>
	public void setLongitudeGranularity(long longitudeGranularity)
	{
		long longitudeGranularityParamValue = longitudeGranularity;
		setLongitudeGranularity_ev_uint32(this.nativeObject.pointer, longitudeGranularityParamValue);
	}
	...
	native private void setBottomMaterial_EVString(long pNativeObject, String matName);
	/**
	 * 设置底部填充材质
	 * @param matName 材质名称
	 */
	public void setBottomMaterial(String matName)
	{
		String matNameParamValue = matName;
		setBottomMaterial_EVString(this.nativeObject.pointer, matNameParamValue);
	}
	protected  long getBottomMaterial_void_callback()
	{
		com.earthview.world.graphic.MaterialPtr returnValue = getBottomMaterial();
		long __returnValue = returnValue.nativeObject.pointer;
		return __returnValue;
	}

	native private long getBottomMaterial_void(long pNativeObject);
	/**
	 * 获取底部填充材质
	 * @param  
	 * @return 边框材质
	 */
	public com.earthview.world.graphic.MaterialPtr getBottomMaterial()
	{
		long returnValue = getBottomMaterial_void(this.nativeObject.pointer);
		com.earthview.world.graphic.MaterialPtr __returnValue = new com.earthview.world.graphic.MaterialPtr(CreatedWhenConstruct.CWC_NotToCreate, "CMaterialPtr");
		__returnValue.setDelegate(true);
		InstancePointer __instancePointer = new InstancePointer(returnValue);
		__returnValue.setInstancePointer(__instancePointer);
	...
	native private long getBottomMaterial_void_NoVirtual(long pNativeObject);
	protected com.earthview.world.graphic.MaterialPtr getBottomMaterial_NoVirtual()
	{
		long returnValue = getBottomMaterial_void_NoVirtual(this.nativeObject.pointer);
		com.earthview.world.graphic.MaterialPtr __returnValue = new com.earthview.world.graphic.MaterialPtr(CreatedWhenConstruct.CWC_NotToCreate, "CMaterialPtr");
		__returnValue.setDelegate(true);
		InstancePointer __instancePointer = new InstancePointer(returnValue);
		__returnValue.setInstancePointer(__instancePointer);
	...
	protected  void setBottomRenderOperation_CRenderOperation_callback(long rend)
	{
		...
		setBottomRenderOperation(rendParamValue);
	}

	native private void setBottomRenderOperation_CRenderOperation(long pNativeObject, long rend);
	public void setBottomRenderOperation(com.earthview.world.graphic.RenderOperation rend)
	{
		long rendParamValue = rend.nativeObject.pointer;
		setBottomRenderOperation_CRenderOperation(this.nativeObject.pointer, rendParamValue);
	}
	native private void setBottomRenderOperation_CRenderOperation_NoVirtual(long pNativeObject, long rend);
	protected void setBottomRenderOperation_NoVirtual(com.earthview.world.graphic.RenderOperation rend)
	{
		long rendParamValue = rend.nativeObject.pointer;
		setBottomRenderOperation_CRenderOperation_NoVirtual(this.nativeObject.pointer, rendParamValue);
	}

	protected  void getBottomRenderOperation_CRenderOperation_callback(long op)
	{
		...
		getBottomRenderOperation(opParamValue);
	}

	native private void getBottomRenderOperation_CRenderOperation(long pNativeObject, long op);
	public void getBottomRenderOperation(com.earthview.world.graphic.RenderOperation op)
	{
		long opParamValue = op.nativeObject.pointer;
		getBottomRenderOperation_CRenderOperation(this.nativeObject.pointer, opParamValue);
	}
	native private void getBottomRenderOperation_CRenderOperation_NoVirtual(long pNativeObject, long op);
	protected void getBottomRenderOperation_NoVirtual(com.earthview.world.graphic.RenderOperation op)
	{
		long opParamValue = op.nativeObject.pointer;
		getBottomRenderOperation_CRenderOperation_NoVirtual(this.nativeObject.pointer, opParamValue);
	}
	...
	public MovableHemisphere(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public MovableHemisphere(CreatedWhenConstruct cwc, String classNameStr) {
	...
	native protected void register_getBottomMaterial_void(long pNativeObject, String method);
	native protected void register_setBottomRenderOperation_CRenderOperation(long pNativeObject, String method);
	native protected void register_getBottomRenderOperation_CRenderOperation(long pNativeObject, String method);
	...
	public void registerCallback(){
		if (!this.nativeObject.equals(InstancePointer.ZERO)){
			...
			this.register_getBottomMaterial_void(this.nativeObject.pointer, "getBottomMaterial_void_callback");
			this.register_setBottomRenderOperation_CRenderOperation(this.nativeObject.pointer, "setBottomRenderOperation_CRenderOperation_callback");
			this.register_getBottomRenderOperation_CRenderOperation(this.nativeObject.pointer, "getBottomRenderOperation_CRenderOperation_callback");
	...
	public static MovableHemisphere fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		MovableHemisphere obj = null;
 		if(baseObj instanceof MovableHemisphere)
		{
			obj = (MovableHemisphere)baseObj;
		} else {
			obj = new MovableHemisphere(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CMovableHemisphere");
			obj.increaseCast();
		}
