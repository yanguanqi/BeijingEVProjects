...
/// 2. 提供了绘制方法
/// <summary>
public class MovableCone extends com.earthview.world.geometry3d.Geometry3D {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::CMovableCone", new MovableConeClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::JCMovableConeProxy", new MovableConeClassFactory());
	}

	public MovableCone() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCMovableConeProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.geometry3d.MovableCone".equals(this.getClass().getName()))
		{
	...
	public MovableCone(com.earthview.world.spatial.math.Vector3 centerPoint, double radius, double height, com.earthview.world.graphic.ColourValue fillClr, com.earthview.world.graphic.ColourValue frameClr, com.earthview.world.geometry3d.DrawingMode drawingMode, boolean includeTextureCoordinates) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		...
		Create("JCMovableConeProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.geometry3d.MovableCone".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
	...
	public MovableCone(com.earthview.world.geometry3d.MovableCone other) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
	...
	native private long OperatorAssign_CMovableCone(long pNativeObject, long other);
	public com.earthview.world.geometry3d.MovableCone OperatorAssign(com.earthview.world.geometry3d.MovableCone other)
	{
		long otherParamValue = other.nativeObject.pointer;
		long returnValue = OperatorAssign_CMovableCone(this.nativeObject.pointer, otherParamValue);
		com.earthview.world.geometry3d.MovableCone __returnValue = new com.earthview.world.geometry3d.MovableCone(CreatedWhenConstruct.CWC_NotToCreate, "CMovableCone");
		...
		{
			__returnValue.setDelegate(true);
			__returnValue = (com.earthview.world.geometry3d.MovableCone)__returnValueClassFactory.create();
			__returnValue.setDelegate(true);
			__returnValue.bindNativeObject(__instancePointer, "CMovableCone");
		}
	...
	native private double getTopCircleRadius_void(long pNativeObject);
	/// <summary>
	///  获取圆柱体的底部圆半径
	/// <summary>
	public double getTopCircleRadius()
	{
		double returnValue = getTopCircleRadius_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private void setTopCircleRadius_Real(long pNativeObject, double radius);
	/// <summary>
	///  设置圆柱体的底部圆半径
	/// <summary>
	public void setTopCircleRadius(double radius)
	{
		double radiusParamValue = radius;
		setTopCircleRadius_Real(this.nativeObject.pointer, radiusParamValue);
	}
	native private double getBottomCircleRadius_void(long pNativeObject);
	/// <summary>
	///  获取圆柱体的底部圆半径
	/// <summary>
	public double getBottomCircleRadius()
	{
		double returnValue = getBottomCircleRadius_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private void setBottomCircleRadius_Real(long pNativeObject, double radius);
	/// <summary>
	///  设置圆柱体的底部圆半径
	/// <summary>
	public void setBottomCircleRadius(double radius)
	{
		double radiusParamValue = radius;
		setBottomCircleRadius_Real(this.nativeObject.pointer, radiusParamValue);
	}
	native private long getCircleCenter_void(long pNativeObject);
	/// <summary>
	///  获取圆柱体底部圆中心点
	/// <summary>
	public com.earthview.world.spatial.math.Vector3 getCircleCenter()
	{
		long returnValue = getCircleCenter_void(this.nativeObject.pointer);
	...
	native private void setCircleCenter_CVector3(long pNativeObject, long center);
	/// <summary>
	///  设置圆柱体底部圆中心点
	/// <summary>
	public void setCircleCenter(com.earthview.world.spatial.math.Vector3 center)
	{
		long centerParamValue = center.nativeObject.pointer;
		setCircleCenter_CVector3(this.nativeObject.pointer, centerParamValue);
	}
	...
	native private boolean getClosed_void(long pNativeObject);
	/// <summary>
	///  获取圆柱体颜色
	/// <summary>
	public boolean getClosed()
	{
		boolean returnValue = getClosed_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private void setClosed_ev_bool(long pNativeObject, boolean closed);
	/// <summary>
	///  设置圆柱体颜色
	/// <summary>
	public void setClosed(boolean closed)
	{
		...
		setClosed_ev_bool(this.nativeObject.pointer, closedParamValue);
	}
	...
	public MovableCone(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public MovableCone(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static MovableCone fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		MovableCone obj = null;
 		if(baseObj instanceof MovableCone)
		{
			obj = (MovableCone)baseObj;
		} else {
			obj = new MovableCone(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CMovableCone");
			obj.increaseCast();
		}
