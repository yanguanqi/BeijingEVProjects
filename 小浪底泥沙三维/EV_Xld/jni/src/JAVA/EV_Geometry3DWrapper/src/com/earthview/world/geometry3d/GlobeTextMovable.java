...
public class GlobeTextMovable extends com.earthview.world.graphic.TextureMovableText {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::CGlobeTextMovable", new GlobeTextMovableClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::JCGlobeTextMovableProxy", new GlobeTextMovableClassFactory());
	}

	native private void setDirection_CVector3(long pNativeObject, long direction);
	/**
	 * 设置文本在球面上的走向APPLE====>
	 * @param direction 要想文本走向始终和相机左方向平行,可传入VEC_FACETO_CAMERA
	 */
	...
	native private void holdDirectionForCamera_ev_bool(long pNativeObject, boolean bHold);
	/// <summary>
	/// 使文本走向随相机而变
	/// <summary>
	public void holdDirectionForCamera(boolean bHold)
	{
		boolean bHoldParamValue = bHold;
		holdDirectionForCamera_ev_bool(this.nativeObject.pointer, bHoldParamValue);
	}
	/// <summary>
	/// 构造函数
	/// </summary>
	...
	public GlobeTextMovable(String str, com.earthview.world.graphic.TextureTextStyle ref_style) {
		...
		Create("JCGlobeTextMovableProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.geometry3d.GlobeTextMovable".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
		}
	}

	public GlobeTextMovable(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public GlobeTextMovable(CreatedWhenConstruct cwc, String classNameStr) {
	...
	{
		super.setDepthCheckEnabled_NoVirtual(enable);
	}
	...
	public static GlobeTextMovable fromBaseObject(BaseObject baseObj)
	{
		...
		GlobeTextMovable obj = null;
 		if(baseObj instanceof GlobeTextMovable)
		{
			obj = (GlobeTextMovable)baseObj;
		} else {
