...
///polyline容器类
public class PolylineList extends com.earthview.world.geometry3d.VisibleObject {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::CPolylineList", new PolylineListClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::JCPolylineListProxy", new PolylineListClassFactory());
	}

	public PolylineList(com.earthview.world.graphic.SceneManager ref_scenemanager) {
		...
		Create("JCPolylineListProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.geometry3d.PolylineList".equals(this.getClass().getName()))
		{
	...
	public PolylineList(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public PolylineList(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static PolylineList fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		PolylineList obj = null;
 		if(baseObj instanceof PolylineList)
		{
			obj = (PolylineList)baseObj;
		} else {
			obj = new PolylineList(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CPolylineList");
			obj.increaseCast();
		}
