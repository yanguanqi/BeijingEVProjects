...
public class MovablePolygon extends com.earthview.world.geometry3d.Geometry3D {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::CMovablePolygon", new MovablePolygonClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::JCMovablePolygonProxy", new MovablePolygonClassFactory());
	}

	public MovablePolygon() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCMovablePolygonProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.geometry3d.MovablePolygon".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
		}
	}

	public MovablePolygon(com.earthview.world.geometry3d.MovablePolygon other) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer otherPtr = new BasePointer(other);
		list.add("other", otherPtr.get());
		Create("JCMovablePolygonProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.geometry3d.MovablePolygon".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
	...
	public MovablePolygon(com.earthview.world.geometry3d.MovablePointCollection ring) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer ringPtr = new BasePointer(ring);
		list.add("ring", ringPtr.get());
		Create("JCMovablePolygonProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.geometry3d.MovablePolygon".equals(this.getClass().getName()))
		{
	...
	native private long OperatorAssign_CMovablePolygon(long pNativeObject, long other);
	public com.earthview.world.geometry3d.MovablePolygon OperatorAssign(com.earthview.world.geometry3d.MovablePolygon other)
	{
		long otherParamValue = other.nativeObject.pointer;
		long returnValue = OperatorAssign_CMovablePolygon(this.nativeObject.pointer, otherParamValue);
		com.earthview.world.geometry3d.MovablePolygon __returnValue = new com.earthview.world.geometry3d.MovablePolygon(CreatedWhenConstruct.CWC_NotToCreate, "CMovablePolygon");
		...
		{
			__returnValue.setDelegate(true);
			__returnValue = (com.earthview.world.geometry3d.MovablePolygon)__returnValueClassFactory.create();
			__returnValue.setDelegate(true);
			__returnValue.bindNativeObject(__instancePointer, "CMovablePolygon");
		}
		return __returnValue;
	}
	native private void addRing_CMovablePointCollection(long pNativeObject, long ring);
	/**
	 * 增加一个环
	 */
	public void addRing(com.earthview.world.geometry3d.MovablePointCollection ring)
	{
		long ringParamValue = ring.nativeObject.pointer;
		addRing_CMovablePointCollection(this.nativeObject.pointer, ringParamValue);
	}
	native private long getRingCount_void(long pNativeObject);
	/**
	 * 环的个数
	 */
	public long getRingCount()
	{
		long returnValue = getRingCount_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private long getExteriorRing_void(long pNativeObject);
	/**
	 * 获取外环
	 */
	public com.earthview.world.geometry3d.MovablePointCollection getExteriorRing()
	{
		long returnValue = getExteriorRing_void(this.nativeObject.pointer);
	...
	native private long getInteriorRing_ev_size_t(long pNativeObject, long index);
	/**
	 * 获取内环
	 */
	public com.earthview.world.geometry3d.MovablePointCollection getInteriorRing(long index)
	{
		long indexParamValue = index;
		long returnValue = getInteriorRing_ev_size_t(this.nativeObject.pointer, indexParamValue);
		com.earthview.world.geometry3d.MovablePointCollection __returnValue = new com.earthview.world.geometry3d.MovablePointCollection(CreatedWhenConstruct.CWC_NotToCreate, "CMovablePointCollection");
		__returnValue.setDelegate(true);
		InstancePointer __instancePointer = new InstancePointer(returnValue);
		__returnValue.setInstancePointer(__instancePointer);
	...
	native private void setDrawMode_DrawingMode(long pNativeObject, int drawingMode);
	/// <summary>
	///  设置是否为绘制为填充的多边形,true为绘制成填充多边形
	/// <summary>
	public void setDrawMode(com.earthview.world.geometry3d.DrawingMode drawingMode)
	{
		int drawingModeParamValue = drawingMode.getValue();
		setDrawMode_DrawingMode(this.nativeObject.pointer, drawingModeParamValue);
	}
	...
	public MovablePolygon(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public MovablePolygon(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static MovablePolygon fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		MovablePolygon obj = null;
 		if(baseObj instanceof MovablePolygon)
		{
			obj = (MovablePolygon)baseObj;
		} else {
			obj = new MovablePolygon(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CMovablePolygon");
			obj.increaseCast();
		}
