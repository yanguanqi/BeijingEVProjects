...
/// 2. 提供了绘制单个点
/// <summary>
public class MovablePoint extends com.earthview.world.geometry3d.Geometry3D {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::CMovablePoint", new MovablePointClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::JCMovablePointProxy", new MovablePointClassFactory());
	}

	public MovablePoint() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCMovablePointProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.geometry3d.MovablePoint".equals(this.getClass().getName()))
		{
	...
	public MovablePoint(double x, double y, double z, com.earthview.world.graphic.ColourValue clr, com.earthview.world.spatial.math.Vector3 normal) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		...
		list.add("z", zPtr.get());
		BasePointer clrPtr = new BasePointer(clr);
		list.add("clr", clrPtr.get());
		BasePointer normalPtr = new BasePointer(normal);
		list.add("normal", normalPtr.get());
		Create("JCMovablePointProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.geometry3d.MovablePoint".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
	...
	/// <param name="clr">点的颜色</param>
	/// <param name="normal">点的法向量</param>
	public MovablePoint(com.earthview.world.spatial.math.Vector3 point, com.earthview.world.graphic.ColourValue clr, com.earthview.world.spatial.math.Vector3 normal) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
	...
	public MovablePoint(com.earthview.world.geometry3d.MovablePoint point) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer pointPtr = new BasePointer(point);
		list.add("point", pointPtr.get());
	...
	native private long getXYZ_void(long pNativeObject);
	/// <summary>
	///  获取点坐标
	/// <summary>
	public com.earthview.world.spatial.math.Vector3 getXYZ()
	{
		long returnValue = getXYZ_void(this.nativeObject.pointer);
	...
	native private void setX_Real(long pNativeObject, double x);
	/// <summary>
	///  设置点坐标X
	/// <summary>
	...
	public void setX(double x)
	{
		...
		setX_Real(this.nativeObject.pointer, xParamValue);
	}
	...
	native private void setY_Real(long pNativeObject, double y);
	/// <summary>
	///  设置点坐标Y
	/// <summary>
	...
	public void setY(double y)
	{
		...
		setY_Real(this.nativeObject.pointer, yParamValue);
	}
	...
	native private void setZ_Real(long pNativeObject, double z);
	/// <summary>
	///  设置点坐标Z
	/// <summary>
	...
	public void setZ(double z)
	{
		...
		setZ_Real(this.nativeObject.pointer, zParamValue);
	}
	...
	native private void setColor_CColourValue(long pNativeObject, long clr);
	/// <summary>
	///  设置点坐颜色信息
	/// <summary>
	/// <param name="clr">点的颜色类</param>
	public void setColor(com.earthview.world.graphic.ColourValue clr)
	{
		long clrParamValue = clr.nativeObject.pointer;
		setColor_CColourValue(this.nativeObject.pointer, clrParamValue);
	}
	native private float getTextureCoordU_void(long pNativeObject);
	/// <summary>
	///  获取点水平纹理坐标
	/// <summary>
	public float getTextureCoordU()
	{
		float returnValue = getTextureCoordU_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private float getTextureCoordV_void(long pNativeObject);
	/// <summary>
	///  获取点垂直纹理坐标
	/// <summary>
	public float getTextureCoordV()
	{
		float returnValue = getTextureCoordV_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private void setTextureCoord_ev_real32_ev_real32(long pNativeObject, float u, float v);
	/// <summary>
	///  获取设置点纹理坐标
	/// <summary>
	...
	public void setTextureCoord(float u, float v)
	{
		float uParamValue = u;
		float vParamValue = v;
		setTextureCoord_ev_real32_ev_real32(this.nativeObject.pointer, uParamValue, vParamValue);
	}
	...
	native private void setNormal_Real_Real_Real(long pNativeObject, double x, double y, double z);
	/// <summary>
	///  设置点法向量
	/// <summary>
	...
	public void setNormal(double x, double y, double z)
	{
		...
		double yParamValue = y;
		double zParamValue = z;
		setNormal_Real_Real_Real(this.nativeObject.pointer, xParamValue, yParamValue, zParamValue);
	}
	native private long OperatorPlus_CMovablePoint(long pNativeObject, long other);
	/// <summary>
	///  操作符重载+，只与位置有关
	/// <summary>
	public com.earthview.world.geometry3d.MovablePoint OperatorPlus(com.earthview.world.geometry3d.MovablePoint other)
	{
		long otherParamValue = other.nativeObject.pointer;
		long returnValue = OperatorPlus_CMovablePoint(this.nativeObject.pointer, otherParamValue);
		com.earthview.world.geometry3d.MovablePoint __returnValue = new com.earthview.world.geometry3d.MovablePoint(CreatedWhenConstruct.CWC_NotToCreate, "CMovablePoint");
		__returnValue.setDelegate(true);
		InstancePointer __instancePointer = new InstancePointer(returnValue);
		__returnValue.setInstancePointer(__instancePointer);
		IClassFactory __returnValueClassFactory = GlobalClassFactoryMap.get(__returnValue.getCppInstanceTypeName());
		...
		{
			__returnValue.setDelegate(true);
			__returnValue = (com.earthview.world.geometry3d.MovablePoint)__returnValueClassFactory.create();
			__returnValue.setDelegate(true);
			__returnValue.bindNativeObject(__instancePointer, "CMovablePoint");
		}
		return __returnValue;
	}
	native private long OperatorMinus_CMovablePoint(long pNativeObject, long other);
	/// <summary>
	///  操作符重载-，只与位置有关
	/// <summary>
	public com.earthview.world.geometry3d.MovablePoint OperatorMinus(com.earthview.world.geometry3d.MovablePoint other)
	{
		long otherParamValue = other.nativeObject.pointer;
		long returnValue = OperatorMinus_CMovablePoint(this.nativeObject.pointer, otherParamValue);
		com.earthview.world.geometry3d.MovablePoint __returnValue = new com.earthview.world.geometry3d.MovablePoint(CreatedWhenConstruct.CWC_NotToCreate, "CMovablePoint");
		__returnValue.setDelegate(true);
		InstancePointer __instancePointer = new InstancePointer(returnValue);
		__returnValue.setInstancePointer(__instancePointer);
	...
	native private long OperatorMultiply_CMovablePoint(long pNativeObject, long other);
	/// <summary>
	///  操作符重载*，只与位置有关
	/// <summary>
	public com.earthview.world.geometry3d.MovablePoint OperatorMultiply(com.earthview.world.geometry3d.MovablePoint other)
	{
		long otherParamValue = other.nativeObject.pointer;
		long returnValue = OperatorMultiply_CMovablePoint(this.nativeObject.pointer, otherParamValue);
		com.earthview.world.geometry3d.MovablePoint __returnValue = new com.earthview.world.geometry3d.MovablePoint(CreatedWhenConstruct.CWC_NotToCreate, "CMovablePoint");
		__returnValue.setDelegate(true);
		InstancePointer __instancePointer = new InstancePointer(returnValue);
		__returnValue.setInstancePointer(__instancePointer);
	...
	native private long OperatorDivide_CMovablePoint(long pNativeObject, long other);
	/// <summary>
	///  操作符重载/，只与位置有关
	/// <summary>
	public com.earthview.world.geometry3d.MovablePoint OperatorDivide(com.earthview.world.geometry3d.MovablePoint other)
	{
		long otherParamValue = other.nativeObject.pointer;
		long returnValue = OperatorDivide_CMovablePoint(this.nativeObject.pointer, otherParamValue);
		com.earthview.world.geometry3d.MovablePoint __returnValue = new com.earthview.world.geometry3d.MovablePoint(CreatedWhenConstruct.CWC_NotToCreate, "CMovablePoint");
		__returnValue.setDelegate(true);
		InstancePointer __instancePointer = new InstancePointer(returnValue);
		__returnValue.setInstancePointer(__instancePointer);
	...
	native private long OperatorAssign_CMovablePoint(long pNativeObject, long other);
	/// <summary>
	///  复制操作，复制所有信息，含颜色，法向量
	/// <summary>
	public com.earthview.world.geometry3d.MovablePoint OperatorAssign(com.earthview.world.geometry3d.MovablePoint other)
	{
		long otherParamValue = other.nativeObject.pointer;
		long returnValue = OperatorAssign_CMovablePoint(this.nativeObject.pointer, otherParamValue);
		com.earthview.world.geometry3d.MovablePoint __returnValue = new com.earthview.world.geometry3d.MovablePoint(CreatedWhenConstruct.CWC_NotToCreate, "CMovablePoint");
		__returnValue.setDelegate(true);
		InstancePointer __instancePointer = new InstancePointer(returnValue);
		__returnValue.setInstancePointer(__instancePointer);
	...
	native private boolean OperatorEquals_CMovablePoint(long pNativeObject, long other);
	/// <summary>
	///  判断是否相等，判断所有信息，含颜色，法向量
	/// <summary>
	public boolean OperatorEquals(com.earthview.world.geometry3d.MovablePoint other)
	{
		long otherParamValue = other.nativeObject.pointer;
		boolean returnValue = OperatorEquals_CMovablePoint(this.nativeObject.pointer, otherParamValue);
		return returnValue;
	}
	native private boolean OperatorNotEquals_CMovablePoint(long pNativeObject, long other);
	/// <summary>
	///  判断是否不相等，判断所有信息，含颜色，法向量
	/// <summary>
	public boolean OperatorNotEquals(com.earthview.world.geometry3d.MovablePoint other)
	{
		long otherParamValue = other.nativeObject.pointer;
		boolean returnValue = OperatorNotEquals_CMovablePoint(this.nativeObject.pointer, otherParamValue);
		return returnValue;
	}
	...
	native private void setPointSize_Real(long pNativeObject, double size);
	/// <summary>
	///  设置点的大小
	/// <summary>
	...
	public void setPointSize(double size)
	{
		...
		setPointSize_Real(this.nativeObject.pointer, sizeParamValue);
	}
	...
	public MovablePoint(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public MovablePoint(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static MovablePoint fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		MovablePoint obj = null;
 		if(baseObj instanceof MovablePoint)
		{
			obj = (MovablePoint)baseObj;
		} else {
			obj = new MovablePoint(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CMovablePoint");
			obj.increaseCast();
		}
