...
/// 多义线是简单线的集合，可以一次性绘制
/// </summary>
public class MovablePolyline extends com.earthview.world.geometry3d.Geometry3D {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::CMovablePolyline", new MovablePolylineClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::JCMovablePolylineProxy", new MovablePolylineClassFactory());
	}

	public MovablePolyline() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCMovablePolylineProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.geometry3d.MovablePolyline".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
		}
	}

	public MovablePolyline(com.earthview.world.geometry3d.MovableLine line) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer linePtr = new BasePointer(line);
		list.add("line", linePtr.get());
		Create("JCMovablePolylineProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.geometry3d.MovablePolyline".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
	...
	public MovablePolyline(com.earthview.world.geometry3d.MovablePolyline other) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
	...
	native private long OperatorAssign_CMovablePolyline(long pNativeObject, long other);
	public com.earthview.world.geometry3d.MovablePolyline OperatorAssign(com.earthview.world.geometry3d.MovablePolyline other)
	{
		long otherParamValue = other.nativeObject.pointer;
		long returnValue = OperatorAssign_CMovablePolyline(this.nativeObject.pointer, otherParamValue);
		com.earthview.world.geometry3d.MovablePolyline __returnValue = new com.earthview.world.geometry3d.MovablePolyline(CreatedWhenConstruct.CWC_NotToCreate, "CMovablePolyline");
		...
		{
			__returnValue.setDelegate(true);
			__returnValue = (com.earthview.world.geometry3d.MovablePolyline)__returnValueClassFactory.create();
			__returnValue.setDelegate(true);
			__returnValue.bindNativeObject(__instancePointer, "CMovablePolyline");
		}
		return __returnValue;
	}
	native private void addLine_CMovableLine(long pNativeObject, long line);
	/// <summary>
	///  增加一条线
	/// <summary>
	/// <param name="line">增加的简单线</param>
	public void addLine(com.earthview.world.geometry3d.MovableLine line)
	{
		long lineParamValue = line.nativeObject.pointer;
		addLine_CMovableLine(this.nativeObject.pointer, lineParamValue);
	}
	native private long getLineCount_void(long pNativeObject);
	/// <summary>
	///  获取包含简单线的个数
	/// <summary>
	...
	{
		long returnValue = getLineCount_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private long getLine_ev_size_t(long pNativeObject, long index);
	/// <summary>
	///  获取简单线
	/// <summary>
	/// <returns>获取的简单线</returns>
	public com.earthview.world.geometry3d.MovableLine getLine(long index)
	{
		long indexParamValue = index;
		long returnValue = getLine_ev_size_t(this.nativeObject.pointer, indexParamValue);
		com.earthview.world.geometry3d.MovableLine __returnValue = new com.earthview.world.geometry3d.MovableLine(CreatedWhenConstruct.CWC_NotToCreate, "CMovableLine");
		__returnValue.setDelegate(true);
		InstancePointer __instancePointer = new InstancePointer(returnValue);
		__returnValue.setInstancePointer(__instancePointer);
		IClassFactory __returnValueClassFactory = GlobalClassFactoryMap.get(__returnValue.getCppInstanceTypeName());
		...
		{
			__returnValue.setDelegate(true);
			__returnValue = (com.earthview.world.geometry3d.MovableLine)__returnValueClassFactory.create();
			__returnValue.setDelegate(true);
			__returnValue.bindNativeObject(__instancePointer, "CMovableLine");
		}
		return __returnValue;
	}
	...
	public MovablePolyline(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public MovablePolyline(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static MovablePolyline fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		MovablePolyline obj = null;
 		if(baseObj instanceof MovablePolyline)
		{
			obj = (MovablePolyline)baseObj;
		} else {
			obj = new MovablePolyline(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CMovablePolyline");
			obj.increaseCast();
		}
