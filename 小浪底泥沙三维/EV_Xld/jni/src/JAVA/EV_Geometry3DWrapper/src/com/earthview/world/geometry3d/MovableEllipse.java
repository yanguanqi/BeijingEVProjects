...
/// 2. 提供了绘制方法
/// <summary>
public class MovableEllipse extends com.earthview.world.geometry3d.Geometry3D {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::CMovableEllipse", new MovableEllipseClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::JCMovableEllipseProxy", new MovableEllipseClassFactory());
	}

	public MovableEllipse() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCMovableEllipseProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.geometry3d.MovableEllipse".equals(this.getClass().getName()))
		{
	...
	public MovableEllipse(com.earthview.world.spatial.math.Vector3 centerPoint, double lRadius, double sRadius, com.earthview.world.graphic.ColourValue fillClr, com.earthview.world.graphic.ColourValue frameClr, com.earthview.world.geometry3d.DrawingMode drawingMode, boolean includeTextureCoordinates) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer centerPointPtr = new BasePointer(centerPoint);
		list.add("centerPoint", centerPointPtr.get());
		BasePointer lRadiusPtr = new BasePointer(lRadius);
		list.add("lRadius", lRadiusPtr.get());
		BasePointer sRadiusPtr = new BasePointer(sRadius);
		list.add("sRadius", sRadiusPtr.get());
		...
		Create("JCMovableEllipseProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.geometry3d.MovableEllipse".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
	...
	public MovableEllipse(com.earthview.world.geometry3d.MovableEllipse other) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
	...
	native private long OperatorAssign_CMovableEllipse(long pNativeObject, long other);
	public com.earthview.world.geometry3d.MovableEllipse OperatorAssign(com.earthview.world.geometry3d.MovableEllipse other)
	{
		long otherParamValue = other.nativeObject.pointer;
		long returnValue = OperatorAssign_CMovableEllipse(this.nativeObject.pointer, otherParamValue);
		com.earthview.world.geometry3d.MovableEllipse __returnValue = new com.earthview.world.geometry3d.MovableEllipse(CreatedWhenConstruct.CWC_NotToCreate, "CMovableEllipse");
		...
		{
			__returnValue.setDelegate(true);
			__returnValue = (com.earthview.world.geometry3d.MovableEllipse)__returnValueClassFactory.create();
			__returnValue.setDelegate(true);
			__returnValue.bindNativeObject(__instancePointer, "CMovableEllipse");
		}
	...
	///  获取椭圆中心点
	/// <summary>
	public com.earthview.world.spatial.math.Vector3 getCenterPoint()
	{
	...
	native private void setCenterPoint_CVector3(long pNativeObject, long centerPoint);
	/// <summary>
	///  设置椭圆中心点
	/// <summary>
	public void setCenterPoint(com.earthview.world.spatial.math.Vector3 centerPoint)
	{
		long centerPointParamValue = centerPoint.nativeObject.pointer;
		setCenterPoint_CVector3(this.nativeObject.pointer, centerPointParamValue);
	}
	...
	native private void setXRadius_Real(long pNativeObject, double lRadius);
	/// <summary>
	///  设置椭圆X方向轴长
	/// <summary>
	public void setXRadius(double lRadius)
	{
		double lRadiusParamValue = lRadius;
		setXRadius_Real(this.nativeObject.pointer, lRadiusParamValue);
	}
	...
	native private void setYRadius_Real(long pNativeObject, double sRadius);
	/// <summary>
	///  设置椭圆Y方向轴长
	/// <summary>
	public void setYRadius(double sRadius)
	{
		double sRadiusParamValue = sRadius;
		setYRadius_Real(this.nativeObject.pointer, sRadiusParamValue);
	}
	...
	native private long getAxisBox_void(long pNativeObject);
	/// <summary>
	///  得到外包盒
	/// <summary>
	public com.earthview.world.spatial.math.AxisAlignedBox getAxisBox()
	{
		long returnValue = getAxisBox_void(this.nativeObject.pointer);
	...
	public MovableEllipse(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public MovableEllipse(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static MovableEllipse fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		MovableEllipse obj = null;
 		if(baseObj instanceof MovableEllipse)
		{
			obj = (MovableEllipse)baseObj;
		} else {
			obj = new MovableEllipse(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CMovableEllipse");
			obj.increaseCast();
		}
