...
public class MultiPolygon3DExtensionFactory extends com.earthview.world.spatial3d.atlas.Igeometry3dfactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::CMultiPolygon3DExtensionFactory", new MultiPolygon3DExtensionFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::JCMultiPolygon3DExtensionFactoryProxy", new MultiPolygon3DExtensionFactoryClassFactory());
	}
	 ...
	 * @param  
	 */
	public MultiPolygon3DExtensionFactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCMultiPolygon3DExtensionFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.geometry3d.MultiPolygon3DExtensionFactory".equals(this.getClass().getName()))
		{
	...
	public MultiPolygon3DExtensionFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public MultiPolygon3DExtensionFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static MultiPolygon3DExtensionFactory fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		MultiPolygon3DExtensionFactory obj = null;
 		if(baseObj instanceof MultiPolygon3DExtensionFactory)
		{
			obj = (MultiPolygon3DExtensionFactory)baseObj;
		} else {
			obj = new MultiPolygon3DExtensionFactory(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CMultiPolygon3DExtensionFactory");
			obj.increaseCast();
		}
