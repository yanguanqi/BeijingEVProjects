...
public class WideLine extends com.earthview.world.graphic.MovableObject {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::CWideLine", new WideLineClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::JCWideLineProxy", new WideLineClassFactory());
	}

	public static class WideLineRenderable extends com.earthview.world.graphic.Renderable {
		
		static {
			GlobalClassFactoryMap.put("EarthView::World::Geometry3D::CWideLine::CWideLineRenderable", new WideLineRenderableClassFactory());
			GlobalClassFactoryMap.put("EarthView::World::Geometry3D::CWideLine::JCWideLineRenderableProxy", new WideLineRenderableClassFactory());
		}

		public WideLineRenderable(com.earthview.world.geometry3d.WideLine ref_parent) {
			super(CreatedWhenConstruct.CWC_NotToCreate);
			NameValuePairList list = new NameValuePairList();
			BasePointer ref_parentPtr = new BasePointer(ref_parent);
			list.add("ref_parent", ref_parentPtr.get());
			Create("JCWideLineRenderableProxy", list, true);
			this.registerCallback();
			if (!"com.earthview.world.geometry3d.WideLine$WideLineRenderable".equals(this.getClass().getName()))
			{
		...
		public WideLineRenderable(CreatedWhenConstruct cwc) {
			super(CreatedWhenConstruct.CWC_NotToCreate);
		}
		public WideLineRenderable(CreatedWhenConstruct cwc, String classNameStr) {
		...
		public static WideLineRenderable fromBaseObject(BaseObject baseObj)
		{
			...
			WideLineRenderable obj = null;
 			if(baseObj instanceof WideLineRenderable)
			{
				obj = (WideLineRenderable)baseObj;
			} else {
	...
	public static class WideLineRenderableClassFactory implements IClassFactory {
	 ...
	 * @param pixelWidth 宽线的像素宽度
	 */
	public WideLine(long estimatedVertexCount, long pixelWidth) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer estimatedVertexCountPtr = new BasePointer(estimatedVertexCount);
		list.add("estimatedVertexCount", estimatedVertexCountPtr.get());
		BasePointer pixelWidthPtr = new BasePointer(pixelWidth);
		list.add("pixelWidth", pixelWidthPtr.get());
		Create("JCWideLineProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.geometry3d.WideLine".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
		}
	}
	 ...
	 * @param joint 接头处是否封闭
	 */
	public WideLine(long estimatedVertexCount, long pixelWidth, com.earthview.world.graphic.TexturePtr texture, boolean joint) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer estimatedVertexCountPtr = new BasePointer(estimatedVertexCount);
		list.add("estimatedVertexCount", estimatedVertexCountPtr.get());
		...
		BasePointer jointPtr = new BasePointer(joint);
		list.add("joint", jointPtr.get());
		Create("JCWideLineProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.geometry3d.WideLine".equals(this.getClass().getName()))
		{
	...
	native private boolean beginSegment_CColourValue(long pNativeObject, long colour);
	/**
	 * 开始一条分段线在渲染时也可以调用此函数
	 * @param colour 线的颜色(没有纹理时起作用)
	 */
	public boolean beginSegment(com.earthview.world.graphic.ColourValue colour)
	{
		long colourParamValue = colour.nativeObject.pointer;
		boolean returnValue = beginSegment_CColourValue(this.nativeObject.pointer, colourParamValue);
		return returnValue;
	}
	native private boolean beginSegment_void(long pNativeObject);
	public boolean beginSegment()
	{
		boolean returnValue = beginSegment_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private void appendPoint_CVector3(long pNativeObject, long position);
	/**
	 * 往当前分段线中追加点在渲染时也可以调用此函数(即可在渲染时追加点)
	 * @param position 点坐标
	 * @param colour 颜色
	 */
	public void appendPoint(com.earthview.world.spatial.math.Vector3 position)
	{
		long positionParamValue = position.nativeObject.pointer;
		appendPoint_CVector3(this.nativeObject.pointer, positionParamValue);
	}
	native private void appendPoint_CVector3_CColourValue(long pNativeObject, long position, long colour);
	public void appendPoint(com.earthview.world.spatial.math.Vector3 position, com.earthview.world.graphic.ColourValue colour)
	{
		long positionParamValue = position.nativeObject.pointer;
		long colourParamValue = colour.nativeObject.pointer;
		appendPoint_CVector3_CColourValue(this.nativeObject.pointer, positionParamValue, colourParamValue);
	}
	native private void appendPoints_VertexList(long pNativeObject, long points);
	/**
	 * 往当前分段线中批量追加点在渲染时也可以调用此函数(即可在渲染时追加点)
	 * @param points 点集
	 * @param colour 颜色
	 */
	public void appendPoints(com.earthview.world.spatial.math.VertexList points)
	{
		long pointsParamValue = points.nativeObject.pointer;
		appendPoints_VertexList(this.nativeObject.pointer, pointsParamValue);
	}
	native private void appendPoints_VertexList_CColourValue(long pNativeObject, long points, long colour);
	public void appendPoints(com.earthview.world.spatial.math.VertexList points, com.earthview.world.graphic.ColourValue colour)
	{
		long pointsParamValue = points.nativeObject.pointer;
		long colourParamValue = colour.nativeObject.pointer;
		appendPoints_VertexList_CColourValue(this.nativeObject.pointer, pointsParamValue, colourParamValue);
	}
	native private void appendPoints_CVertexVector(long pNativeObject, long points);
	/**
	 * 往当前分段线中批量追加点在渲染时也可以调用此函数(即可在渲染时追加点)
	 * @param points 点集,其中只有位置和颜色会被写入顶点buffer
	 */
	public void appendPoints(com.earthview.world.geometry3d.VertexVector points)
	{
		long pointsParamValue = points.nativeObject.pointer;
		appendPoints_CVertexVector(this.nativeObject.pointer, pointsParamValue);
	}
	native private boolean endSegment_void(long pNativeObject);
	/**
	...
	{
		boolean returnValue = endSegment_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private boolean endSegment_ev_bool(long pNativeObject, boolean closed);
	/**
	 * 结束一条分段线(下次调用beginSegment则会另起一段线)在渲染时也可以调用此函数
	 * @param closed 是否连接起点与终点
	 */
	public boolean endSegment(boolean closed)
	{
		boolean closedParamValue = closed;
		boolean returnValue = endSegment_ev_bool(this.nativeObject.pointer, closedParamValue);
		return returnValue;
	}
	...
	native private void setPixelWidth_ev_uint32(long pNativeObject, long pixelWidth);
	/**
	 * 设置线宽(立即生效)
	 * @param pixelWidth 线宽
	 */
	public void setPixelWidth(long pixelWidth)
	{
		...
		setPixelWidth_ev_uint32(this.nativeObject.pointer, pixelWidthParamValue);
	}
	native private long getPixelWidth_void(long pNativeObject);
	/**
	 * 获取线宽
	 * @param  
	 */
	...
	{
		long returnValue = getPixelWidth_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private void setTextureWrapper_ev_bool(long pNativeObject, boolean wrapper);
	/**
	 * 设置纹理是否平铺(立刻生效)
	 * @param wrapper true:纹理沿线平铺;false:纹理沿线拉伸
	 */
	public void setTextureWrapper(boolean wrapper)
	{
		boolean wrapperParamValue = wrapper;
		setTextureWrapper_ev_bool(this.nativeObject.pointer, wrapperParamValue);
	}
	native private boolean getTextureWrapper_void(long pNativeObject);
	/**
	 * 获取纹理是否平铺
	 * @param  
	 */
	public boolean getTextureWrapper()
	{
		boolean returnValue = getTextureWrapper_void(this.nativeObject.pointer);
		return returnValue;
	}
	...
	public com.earthview.world.geometry3d.WideLine.WideLineRenderable getRenderable()
	{
		long returnValue = getRenderable_void(this.nativeObject.pointer);
		if(returnValue == 0L) {
			return null;
		}
		com.earthview.world.geometry3d.WideLine.WideLineRenderable __returnValue = new com.earthview.world.geometry3d.WideLine.WideLineRenderable(CreatedWhenConstruct.CWC_NotToCreate, "CWideLineRenderable");
		__returnValue.setDelegate(true);
		InstancePointer __instancePointer = new InstancePointer(returnValue);
		__returnValue.setInstancePointer(__instancePointer);
		IClassFactory __returnValueClassFactory = GlobalClassFactoryMap.get(__returnValue.getCppInstanceTypeName());
		...
		{
			__returnValue.setDelegate(true);
			__returnValue = (com.earthview.world.geometry3d.WideLine.WideLineRenderable)__returnValueClassFactory.create();
			__returnValue.setDelegate(true);
			__returnValue.bindNativeObject(__instancePointer, "CWideLineRenderable");
		}
		return __returnValue;
	}
	...
	public WideLine(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public WideLine(CreatedWhenConstruct cwc, String classNameStr) {
		super(CreatedWhenConstruct.CWC_NotToCreate, classNameStr);
	}
	...
	public static WideLine fromBaseObject(BaseObject baseObj)
	{
		...
		WideLine obj = null;
 		if(baseObj instanceof WideLine)
		{
			obj = (WideLine)baseObj;
		} else {
