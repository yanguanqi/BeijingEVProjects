...
///
public class KmlPolylineFactory extends com.earthview.world.spatial3d.atlas.Igeometry3dfactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::CKmlPolylineFactory", new KmlPolylineFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::JCKmlPolylineFactoryProxy", new KmlPolylineFactoryClassFactory());
	}
	 ...
	 * @param  
	 */
	public KmlPolylineFactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCKmlPolylineFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.geometry3d.KmlPolylineFactory".equals(this.getClass().getName()))
		{
	...
	public KmlPolylineFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public KmlPolylineFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static KmlPolylineFactory fromBaseObject(BaseObject baseObj)
	{
		...
		KmlPolylineFactory obj = null;
 		if(baseObj instanceof KmlPolylineFactory)
		{
			obj = (KmlPolylineFactory)baseObj;
		} else {
