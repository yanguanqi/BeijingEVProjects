...
/// 2. 提供了绘制方法
/// <summary>
public class MovableLine extends com.earthview.world.geometry3d.MovablePointCollection {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::CMovableLine", new MovableLineClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::JCMovableLineProxy", new MovableLineClassFactory());
	}

	public MovableLine() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCMovableLineProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.geometry3d.MovableLine".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
		}
	}

	public MovableLine(com.earthview.world.geometry3d.MovableLine other) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer otherPtr = new BasePointer(other);
		list.add("other", otherPtr.get());
		Create("JCMovableLineProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.geometry3d.MovableLine".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
	...
	native private long OperatorAssign_CMovableLine(long pNativeObject, long other);
	public com.earthview.world.geometry3d.MovableLine OperatorAssign(com.earthview.world.geometry3d.MovableLine other)
	{
		long otherParamValue = other.nativeObject.pointer;
		long returnValue = OperatorAssign_CMovableLine(this.nativeObject.pointer, otherParamValue);
	...
	public MovableLine(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public MovableLine(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static MovableLine fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		MovableLine obj = null;
 		if(baseObj instanceof MovableLine)
		{
			obj = (MovableLine)baseObj;
		} else {
			obj = new MovableLine(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CMovableLine");
			obj.increaseCast();
		}
