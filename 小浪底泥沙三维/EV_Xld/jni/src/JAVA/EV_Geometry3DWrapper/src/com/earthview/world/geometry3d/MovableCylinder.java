...
/// 2. 提供了绘制方法
/// <summary>
public class MovableCylinder extends com.earthview.world.geometry3d.MovableEllipticalCylinder {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::CMovableCylinder", new MovableCylinderClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::JCMovableCylinderProxy", new MovableCylinderClassFactory());
	}

	public MovableCylinder() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCMovableCylinderProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.geometry3d.MovableCylinder".equals(this.getClass().getName()))
		{
	...
	public MovableCylinder(com.earthview.world.spatial.math.Vector3 centerPoint, double radius, double height, com.earthview.world.graphic.ColourValue fillClr, com.earthview.world.graphic.ColourValue frameClr, com.earthview.world.geometry3d.DrawingMode drawingMode, boolean includeTextureCoordinates) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		...
		Create("JCMovableCylinderProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.geometry3d.MovableCylinder".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
	...
	native private double getCircleRadius_void(long pNativeObject);
	/// <summary>
	///  获取圆柱体的底部圆半径
	/// <summary>
	public double getCircleRadius()
	{
		double returnValue = getCircleRadius_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private void setCircleRadius_Real(long pNativeObject, double radius);
	/// <summary>
	///  设置圆柱体的底部圆半径
	/// <summary>
	public void setCircleRadius(double radius)
	{
		...
		setCircleRadius_Real(this.nativeObject.pointer, radiusParamValue);
	}
	public MovableCylinder(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public MovableCylinder(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static MovableCylinder fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		MovableCylinder obj = null;
 		if(baseObj instanceof MovableCylinder)
		{
			obj = (MovableCylinder)baseObj;
		} else {
			obj = new MovableCylinder(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CMovableCylinder");
			obj.increaseCast();
		}
