 ...
 */
public class Iscenelayer extends com.earthview.world.spatial3d.atlas.Iglobelayer {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::ISceneLayer", new IscenelayerClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::JISceneLayerProxy", new IscenelayerClassFactory());
	}
	...
	public Iscenelayer() {
		...
		Create("JISceneLayerProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.atlas.Iscenelayer".equals(this.getClass().getName()))
		{
	 ...
	 * @param  
	 */
	public Iscenelayer(String name) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer namePtr = new BasePointer(name);
		list.add("name", namePtr.get());
		Create("JISceneLayerProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.atlas.Iscenelayer".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
	...
	native private static String makeCacheName_EVString(String srcName);
	/**
	 * 格式化缓存名称，将不规范字符转为"_"
	 * @param srcName 缓存名称
	 * @return 缓存名称
	...
	public static String makeCacheName(String srcName)
	{
		...
		String returnValue = makeCacheName_EVString(srcNameParamValue);
		return returnValue;
	}
	...
	public Iscenelayer(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Iscenelayer(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Iscenelayer fromBaseObject(BaseObject baseObj)
	{
		...
		Iscenelayer obj = null;
 		if(baseObj instanceof Iscenelayer)
		{
			obj = (Iscenelayer)baseObj;
		} else {
