 ...
 */
public class KmlMultigeometry extends com.earthview.world.geometry3d.VisibleObject {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::CKmlMultigeometry", new KmlMultigeometryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::JCKmlMultigeometryProxy", new KmlMultigeometryClassFactory());
	}
	 ...
	 */
	public KmlMultigeometry(com.earthview.world.spatial.kml.GeoObjectExtension ref_geo, com.earthview.world.graphic.SceneManager ref_scenemanager, String groupName) {
		...
		Create("JCKmlMultigeometryProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.geometry3d.KmlMultigeometry".equals(this.getClass().getName()))
		{
	...
	public KmlMultigeometry(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public KmlMultigeometry(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static KmlMultigeometry fromBaseObject(BaseObject baseObj)
	{
		...
		KmlMultigeometry obj = null;
 		if(baseObj instanceof KmlMultigeometry)
		{
			obj = (KmlMultigeometry)baseObj;
		} else {
