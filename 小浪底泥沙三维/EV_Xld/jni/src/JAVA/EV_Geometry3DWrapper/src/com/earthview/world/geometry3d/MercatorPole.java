...
public class MercatorPole extends com.earthview.world.geometry3d.MercatorSphere {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::CMercatorPole", new MercatorPoleClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::JCMercatorPoleProxy", new MercatorPoleClassFactory());
	}

	public MercatorPole(com.earthview.world.spatial.math.Vector3 centerPoint, double radius) {
		...
		Create("JCMercatorPoleProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.geometry3d.MercatorPole".equals(this.getClass().getName()))
		{
	...
	public MercatorPole(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public MercatorPole(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static MercatorPole fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		MercatorPole obj = null;
 		if(baseObj instanceof MercatorPole)
		{
			obj = (MercatorPole)baseObj;
		} else {
			obj = new MercatorPole(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CMercatorPole");
			obj.increaseCast();
		}
