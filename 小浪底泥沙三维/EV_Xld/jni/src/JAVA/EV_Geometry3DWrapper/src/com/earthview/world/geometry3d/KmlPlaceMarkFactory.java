...
///
public class KmlPlaceMarkFactory extends com.earthview.world.spatial3d.atlas.Igeometry3dfactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::CKmlPlaceMarkFactory", new KmlPlaceMarkFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::JCKmlPlaceMarkFactoryProxy", new KmlPlaceMarkFactoryClassFactory());
	}
	 ...
	 * @param  
	 */
	public KmlPlaceMarkFactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCKmlPlaceMarkFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.geometry3d.KmlPlaceMarkFactory".equals(this.getClass().getName()))
		{
	...
	public KmlPlaceMarkFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public KmlPlaceMarkFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static KmlPlaceMarkFactory fromBaseObject(BaseObject baseObj)
	{
		...
		KmlPlaceMarkFactory obj = null;
 		if(baseObj instanceof KmlPlaceMarkFactory)
		{
			obj = (KmlPlaceMarkFactory)baseObj;
		} else {
