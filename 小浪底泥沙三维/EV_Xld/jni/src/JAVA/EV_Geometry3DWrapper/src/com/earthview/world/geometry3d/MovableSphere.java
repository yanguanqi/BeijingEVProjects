...
/// 2. 提供了绘制方法
/// <summary>
public class MovableSphere extends com.earthview.world.geometry3d.MovableEllipsoid {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::CMovableSphere", new MovableSphereClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::JCMovableSphereProxy", new MovableSphereClassFactory());
	}

	public MovableSphere() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCMovableSphereProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.geometry3d.MovableSphere".equals(this.getClass().getName()))
		{
	...
	public MovableSphere(com.earthview.world.spatial.math.Vector3 centerPoint, double radius, com.earthview.world.graphic.ColourValue fillClr, com.earthview.world.graphic.ColourValue frameClr, com.earthview.world.geometry3d.DrawingMode drawingMode, boolean includeTextureCoordinates) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		...
		Create("JCMovableSphereProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.geometry3d.MovableSphere".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
	...
	public MovableSphere(com.earthview.world.geometry3d.MovableSphere other) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
	...
	native private long OperatorAssign_CMovableSphere(long pNativeObject, long other);
	public com.earthview.world.geometry3d.MovableSphere OperatorAssign(com.earthview.world.geometry3d.MovableSphere other)
	{
		long otherParamValue = other.nativeObject.pointer;
		long returnValue = OperatorAssign_CMovableSphere(this.nativeObject.pointer, otherParamValue);
		com.earthview.world.geometry3d.MovableSphere __returnValue = new com.earthview.world.geometry3d.MovableSphere(CreatedWhenConstruct.CWC_NotToCreate, "CMovableSphere");
		...
		{
			__returnValue.setDelegate(true);
			__returnValue = (com.earthview.world.geometry3d.MovableSphere)__returnValueClassFactory.create();
			__returnValue.setDelegate(true);
			__returnValue.bindNativeObject(__instancePointer, "CMovableSphere");
		}
	...
	public MovableSphere(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public MovableSphere(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static MovableSphere fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		MovableSphere obj = null;
 		if(baseObj instanceof MovableSphere)
		{
			obj = (MovableSphere)baseObj;
		} else {
			obj = new MovableSphere(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CMovableSphere");
			obj.increaseCast();
		}
