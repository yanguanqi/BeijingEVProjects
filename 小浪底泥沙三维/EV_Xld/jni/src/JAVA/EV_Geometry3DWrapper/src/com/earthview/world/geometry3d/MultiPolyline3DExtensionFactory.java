...
public class MultiPolyline3DExtensionFactory extends com.earthview.world.spatial3d.atlas.Igeometry3dfactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::CMultiPolyline3DExtensionFactory", new MultiPolyline3DExtensionFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::JCMultiPolyline3DExtensionFactoryProxy", new MultiPolyline3DExtensionFactoryClassFactory());
	}
	 ...
	 * @param  
	 */
	public MultiPolyline3DExtensionFactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCMultiPolyline3DExtensionFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.geometry3d.MultiPolyline3DExtensionFactory".equals(this.getClass().getName()))
		{
	...
	public MultiPolyline3DExtensionFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public MultiPolyline3DExtensionFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static MultiPolyline3DExtensionFactory fromBaseObject(BaseObject baseObj)
	{
		...
		MultiPolyline3DExtensionFactory obj = null;
 		if(baseObj instanceof MultiPolyline3DExtensionFactory)
		{
			obj = (MultiPolyline3DExtensionFactory)baseObj;
		} else {
