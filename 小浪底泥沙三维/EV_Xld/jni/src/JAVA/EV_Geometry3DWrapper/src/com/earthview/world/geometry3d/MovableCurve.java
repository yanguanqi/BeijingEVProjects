...
/// </summary>
public class MovableCurve extends com.earthview.world.geometry3d.MovableLine {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::CMovableCurve", new MovableCurveClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::JCMovableCurveProxy", new MovableCurveClassFactory());
	}

	public MovableCurve() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCMovableCurveProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.geometry3d.MovableCurve".equals(this.getClass().getName()))
		{
	...
	public MovableCurve(com.earthview.world.geometry3d.MovableCurve other) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
	...
	native private long OperatorAssign_CMovableCurve(long pNativeObject, long other);
	public com.earthview.world.geometry3d.MovableCurve OperatorAssign(com.earthview.world.geometry3d.MovableCurve other)
	{
		long otherParamValue = other.nativeObject.pointer;
		long returnValue = OperatorAssign_CMovableCurve(this.nativeObject.pointer, otherParamValue);
		com.earthview.world.geometry3d.MovableCurve __returnValue = new com.earthview.world.geometry3d.MovableCurve(CreatedWhenConstruct.CWC_NotToCreate, "CMovableCurve");
		...
		{
			__returnValue.setDelegate(true);
			__returnValue = (com.earthview.world.geometry3d.MovableCurve)__returnValueClassFactory.create();
			__returnValue.setDelegate(true);
			__returnValue.bindNativeObject(__instancePointer, "CMovableCurve");
		}
	...
	public MovableCurve(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public MovableCurve(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static MovableCurve fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		MovableCurve obj = null;
 		if(baseObj instanceof MovableCurve)
		{
			obj = (MovableCurve)baseObj;
		} else {
			obj = new MovableCurve(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CMovableCurve");
			obj.increaseCast();
		}
