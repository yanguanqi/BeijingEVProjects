...
/// 2. 提供了绘制方法
/// <summary>
public class MovablePointCollection extends com.earthview.world.geometry3d.Geometry3D {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::CMovablePointCollection", new MovablePointCollectionClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::JCMovablePointCollectionProxy", new MovablePointCollectionClassFactory());
	}

	public MovablePointCollection() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCMovablePointCollectionProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.geometry3d.MovablePointCollection".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
		}
	}

	public MovablePointCollection(com.earthview.world.geometry3d.MovablePointCollection other) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer otherPtr = new BasePointer(other);
		list.add("other", otherPtr.get());
		Create("JCMovablePointCollectionProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.geometry3d.MovablePointCollection".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
	...
	native private long OperatorAssign_CMovablePointCollection(long pNativeObject, long other);
	public com.earthview.world.geometry3d.MovablePointCollection OperatorAssign(com.earthview.world.geometry3d.MovablePointCollection other)
	{
		long otherParamValue = other.nativeObject.pointer;
		long returnValue = OperatorAssign_CMovablePointCollection(this.nativeObject.pointer, otherParamValue);
		com.earthview.world.geometry3d.MovablePointCollection __returnValue = new com.earthview.world.geometry3d.MovablePointCollection(CreatedWhenConstruct.CWC_NotToCreate, "CMovablePointCollection");
		...
		{
			__returnValue.setDelegate(true);
			__returnValue = (com.earthview.world.geometry3d.MovablePointCollection)__returnValueClassFactory.create();
			__returnValue.setDelegate(true);
			__returnValue.bindNativeObject(__instancePointer, "CMovablePointCollection");
		}
		return __returnValue;
	}
	protected  void addPoint_CMovablePoint_callback(long point)
	{
		com.earthview.world.geometry3d.MovablePoint pointParamValue = new com.earthview.world.geometry3d.MovablePoint(CreatedWhenConstruct.CWC_NotToCreate);
		...
		{
			pointParamValue.setDelegate(true);
			pointParamValue = (com.earthview.world.geometry3d.MovablePoint)pointParamValueClassFactory.create();
			pointParamValue.setDelegate(true);
			pointParamValue.setInstancePointer(new InstancePointer(point));
		}
	...
	native private void addPoint_CMovablePoint(long pNativeObject, long point);
	/**
	 * 向点集合增加一个点，设计成虚函数主要让子类对数据可以检查
	 * @param point 点信息
	 */
	public void addPoint(com.earthview.world.geometry3d.MovablePoint point)
	{
		long pointParamValue = point.nativeObject.pointer;
		addPoint_CMovablePoint(this.nativeObject.pointer, pointParamValue);
	}
	native private void addPoint_CMovablePoint_NoVirtual(long pNativeObject, long point);
	protected void addPoint_NoVirtual(com.earthview.world.geometry3d.MovablePoint point)
	{
		long pointParamValue = point.nativeObject.pointer;
		addPoint_CMovablePoint_NoVirtual(this.nativeObject.pointer, pointParamValue);
	}

	protected  void insertPoint_ev_size_t_CMovablePoint_callback(long pos, long point)
	{
		...
		insertPoint(posParamValue, pointParamValue);
	}

	native private void insertPoint_ev_size_t_CMovablePoint(long pNativeObject, long pos, long point);
	/**
	 * 向点集合插入一个点，设计成虚函数主要让子类对数据可以检查
	 * @param pos 插入的位置索引，在集合大小范围内，否则出错
	 * @param point 点信息
	 */
	public void insertPoint(long pos, com.earthview.world.geometry3d.MovablePoint point)
	{
		long posParamValue = pos;
		long pointParamValue = point.nativeObject.pointer;
		insertPoint_ev_size_t_CMovablePoint(this.nativeObject.pointer, posParamValue, pointParamValue);
	}
	native private void insertPoint_ev_size_t_CMovablePoint_NoVirtual(long pNativeObject, long pos, long point);
	protected void insertPoint_NoVirtual(long pos, com.earthview.world.geometry3d.MovablePoint point)
	{
		long posParamValue = pos;
		long pointParamValue = point.nativeObject.pointer;
		insertPoint_ev_size_t_CMovablePoint_NoVirtual(this.nativeObject.pointer, posParamValue, pointParamValue);
	}

	native private void removePoint_ev_size_t(long pNativeObject, long pos);
	/**
	 * 删除集合中的一个点
	 * @param pos 删除的位置索引，在集合大小范围内，否则出错
	 */
	public void removePoint(long pos)
	{
		long posParamValue = pos;
		removePoint_ev_size_t(this.nativeObject.pointer, posParamValue);
	}
	...
	native private long getPoint_ev_size_t(long pNativeObject, long pos);
	/**
	 * 获取一个点
	 * @param pos 获取点的位置索引，在集合大小范围内，否则出错
	 */
	public com.earthview.world.geometry3d.MovablePoint getPoint(long pos)
	{
		long posParamValue = pos;
		long returnValue = getPoint_ev_size_t(this.nativeObject.pointer, posParamValue);
	...
	native private long OperatorIndex_ev_size_t(long pNativeObject, long pos);
	/**
	 * 获取一个点
	 * @param pos 获取点的位置索引，在集合大小范围内，否则出错
	 */
	public com.earthview.world.geometry3d.MovablePoint OperatorIndex(long pos)
	{
		long posParamValue = pos;
		long returnValue = OperatorIndex_ev_size_t(this.nativeObject.pointer, posParamValue);
		com.earthview.world.geometry3d.MovablePoint __returnValue = new com.earthview.world.geometry3d.MovablePoint(CreatedWhenConstruct.CWC_NotToCreate, "CMovablePoint");
		__returnValue.setDelegate(true);
		InstancePointer __instancePointer = new InstancePointer(returnValue);
		__returnValue.setInstancePointer(__instancePointer);
	...
	native private void setCapacity_ev_size_t(long pNativeObject, long size);
	/**
	 * 设置现在集合的实际内存大小
	 * @param size 一次性使集合的大小变为size,这是一种有效提高效率的方法
	 */
	public void setCapacity(long size)
	{
		long sizeParamValue = size;
		setCapacity_ev_size_t(this.nativeObject.pointer, sizeParamValue);
	}
	...
	public MovablePointCollection(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public MovablePointCollection(CreatedWhenConstruct cwc, String classNameStr) {
	...
	native protected void register_addPoint_CMovablePoint(long pNativeObject, String method);
	native protected void register_insertPoint_ev_size_t_CMovablePoint(long pNativeObject, String method);
	...
	public void registerCallback(){
		if (!this.nativeObject.equals(InstancePointer.ZERO)){
			this.register_addPoint_CMovablePoint(this.nativeObject.pointer, "addPoint_CMovablePoint_callback");
			this.register_insertPoint_ev_size_t_CMovablePoint(this.nativeObject.pointer, "insertPoint_ev_size_t_CMovablePoint_callback");
	...
	public static MovablePointCollection fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		MovablePointCollection obj = null;
 		if(baseObj instanceof MovablePointCollection)
		{
			obj = (MovablePointCollection)baseObj;
		} else {
			obj = new MovablePointCollection(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CMovablePointCollection");
			obj.increaseCast();
		}
