 ...
 */
public class KmlPlacemark extends com.earthview.world.geometry3d.MultiPoint3DExtension {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::CKmlPlacemark", new KmlPlacemarkClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::JCKmlPlacemarkProxy", new KmlPlacemarkClassFactory());
	}
	 ...
	 */
	public KmlPlacemark(com.earthview.world.spatial.kml.GeoObjectExtension ref_geo, com.earthview.world.graphic.SceneManager ref_scenemanager, String groupName) {
		...
		Create("JCKmlPlacemarkProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.geometry3d.KmlPlacemark".equals(this.getClass().getName()))
		{
	...
	public KmlPlacemark(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public KmlPlacemark(CreatedWhenConstruct cwc, String classNameStr) {
	...
	{
		return super.getReduceDistance_NoVirtual();
	}
	public void setReduceDistance(double reduceDis)
	{
		super.setReduceDistance_NoVirtual(reduceDis);
	}
	/**
	 * 增加地理对象
	...
	public static KmlPlacemark fromBaseObject(BaseObject baseObj)
	{
		...
		KmlPlacemark obj = null;
 		if(baseObj instanceof KmlPlacemark)
		{
			obj = (KmlPlacemark)baseObj;
		} else {
