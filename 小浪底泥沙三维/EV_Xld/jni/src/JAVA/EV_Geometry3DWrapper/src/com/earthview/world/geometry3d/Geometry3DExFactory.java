...
public class Geometry3DExFactory extends com.earthview.world.spatial3d.atlas.Igeometry3dfactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::CGeometry3DExFactory", new Geometry3DExFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::JCGeometry3DExFactoryProxy", new Geometry3DExFactoryClassFactory());
	}
	 ...
	 * @param  
	 */
	public Geometry3DExFactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCGeometry3DExFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.geometry3d.Geometry3DExFactory".equals(this.getClass().getName()))
		{
	...
	public Geometry3DExFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Geometry3DExFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Geometry3DExFactory fromBaseObject(BaseObject baseObj)
	{
		...
		Geometry3DExFactory obj = null;
 		if(baseObj instanceof Geometry3DExFactory)
		{
			obj = (Geometry3DExFactory)baseObj;
		} else {
