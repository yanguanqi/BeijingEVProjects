...
/// <summary>
public class MovableSurface extends com.earthview.world.geometry3d.MovablePointCollection {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::CMovableSurface", new MovableSurfaceClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::JCMovableSurfaceProxy", new MovableSurfaceClassFactory());
	}

	public MovableSurface() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCMovableSurfaceProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.geometry3d.MovableSurface".equals(this.getClass().getName()))
		{
	...
	public MovableSurface(int width, int height, int uMax, int vMax) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		...
		BasePointer uMaxPtr = new BasePointer(uMax);
		list.add("uMax", uMaxPtr.get());
		BasePointer vMaxPtr = new BasePointer(vMax);
		list.add("vMax", vMaxPtr.get());
		Create("JCMovableSurfaceProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.geometry3d.MovableSurface".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
	...
	public MovableSurface(com.earthview.world.geometry3d.MovableSurface other) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
	...
	native private long OperatorAssign_CMovableSurface(long pNativeObject, long other);
	public com.earthview.world.geometry3d.MovableSurface OperatorAssign(com.earthview.world.geometry3d.MovableSurface other)
	{
		long otherParamValue = other.nativeObject.pointer;
		long returnValue = OperatorAssign_CMovableSurface(this.nativeObject.pointer, otherParamValue);
		com.earthview.world.geometry3d.MovableSurface __returnValue = new com.earthview.world.geometry3d.MovableSurface(CreatedWhenConstruct.CWC_NotToCreate, "CMovableSurface");
		...
		{
			__returnValue.setDelegate(true);
			__returnValue = (com.earthview.world.geometry3d.MovableSurface)__returnValueClassFactory.create();
			__returnValue.setDelegate(true);
			__returnValue.bindNativeObject(__instancePointer, "CMovableSurface");
		}
	...
	native private int getUmaxSubdivisionLevel_void(long pNativeObject);
	/// <summary>
	///  设置水平方向最大的插值级别
	/// <summary>
	public int getUmaxSubdivisionLevel()
	{
		int returnValue = getUmaxSubdivisionLevel_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private void setUmaxSubdivisionLevel_ev_int32(long pNativeObject, int uMax);
	/// <summary>
	///  设置水平方向最大的插值级别，默认为-1，自动选择级别
	/// <summary>
	public void setUmaxSubdivisionLevel(int uMax)
	{
		int uMaxParamValue = uMax;
		setUmaxSubdivisionLevel_ev_int32(this.nativeObject.pointer, uMaxParamValue);
	}
	native private int getVmaxSubdivisionLevel_void(long pNativeObject);
	/// <summary>
	///  获取垂直方向最大插值级别
	/// <summary>
	public int getVmaxSubdivisionLevel()
	{
		int returnValue = getVmaxSubdivisionLevel_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private void setVmaxSubdivisionLevel_ev_int32(long pNativeObject, int vMax);
	/// <summary>
	///  设置垂直方向最大插值级别，默认为-1，自动选择级别
	/// <summary>
	public void setVmaxSubdivisionLevel(int vMax)
	{
		int vMaxParamValue = vMax;
		setVmaxSubdivisionLevel_ev_int32(this.nativeObject.pointer, vMaxParamValue);
	}
	native private int getSurfaceWidth_void(long pNativeObject);
	/// <summary>
	///  获取水平方向控制点的数量
	/// <summary>
	public int getSurfaceWidth()
	{
		int returnValue = getSurfaceWidth_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private void setSurfaceWidth_ev_int32(long pNativeObject, int width);
	/// <summary>
	///  设置水平方向控制点的数量，至少>3
	/// <summary>
	public void setSurfaceWidth(int width)
	{
		...
		setSurfaceWidth_ev_int32(this.nativeObject.pointer, widthParamValue);
	}
	native private int getSurfaceHeight_void(long pNativeObject);
	/// <summary>
	///  获取垂直方向控制点的数量
	/// <summary>
	public int getSurfaceHeight()
	{
		int returnValue = getSurfaceHeight_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private void setSurfaceHeight_int(long pNativeObject, int height);
	/// <summary>
	///  设置垂直方向控制点的数量，至少>3
	/// <summary>
	public void setSurfaceHeight(int height)
	{
		...
		setSurfaceHeight_int(this.nativeObject.pointer, heightParamValue);
	}
	...
	public MovableSurface(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public MovableSurface(CreatedWhenConstruct cwc, String classNameStr) {
	...
	{
		super.addPoint_NoVirtual(point);
	}
	/**
	...
	{
		super.insertPoint_NoVirtual(pos, point);
	}
	/**
	 * 矢量图元转为为网格
	...
	public static MovableSurface fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		MovableSurface obj = null;
 		if(baseObj instanceof MovableSurface)
		{
			obj = (MovableSurface)baseObj;
		} else {
			obj = new MovableSurface(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CMovableSurface");
			obj.increaseCast();
		}
