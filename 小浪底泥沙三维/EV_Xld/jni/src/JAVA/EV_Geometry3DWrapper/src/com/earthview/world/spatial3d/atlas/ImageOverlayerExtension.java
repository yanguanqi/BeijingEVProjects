 ...
 * 图像覆盖层渲染类管理图像覆盖层的渲染
 */
public class ImageOverlayerExtension extends com.earthview.world.geometry3d.VisibleObject {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::CImageOverlayerExtension", new ImageOverlayerExtensionClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::JCImageOverlayerExtensionProxy", new ImageOverlayerExtensionClassFactory());
	}

	/**
	 * 构造函数
	 */
	public ImageOverlayerExtension(com.earthview.world.spatial.kml.GeoObjectExtension geoObj, com.earthview.world.graphic.SceneManager scenemanager) {
		...
		Create("JCImageOverlayerExtensionProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.atlas.ImageOverlayerExtension".equals(this.getClass().getName()))
		{
	...
	native private long getImageOverlayer_void(long pNativeObject);
	public com.earthview.world.geometry3d.ImageOverlayer getImageOverlayer()
	{
		long returnValue = getImageOverlayer_void(this.nativeObject.pointer);
		if(returnValue == 0L) {
			return null;
		}
		com.earthview.world.geometry3d.ImageOverlayer __returnValue = new com.earthview.world.geometry3d.ImageOverlayer(CreatedWhenConstruct.CWC_NotToCreate, "CImageOverlayer");
		__returnValue.setDelegate(true);
		InstancePointer __instancePointer = new InstancePointer(returnValue);
		__returnValue.setInstancePointer(__instancePointer);
		IClassFactory __returnValueClassFactory = GlobalClassFactoryMap.get(__returnValue.getCppInstanceTypeName());
		...
		{
			__returnValue.setDelegate(true);
			__returnValue = (com.earthview.world.geometry3d.ImageOverlayer)__returnValueClassFactory.create();
			__returnValue.setDelegate(true);
			__returnValue.bindNativeObject(__instancePointer, "CImageOverlayer");
		}
		return __returnValue;
	}
	...
	public ImageOverlayerExtension(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ImageOverlayerExtension(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ImageOverlayerExtension fromBaseObject(BaseObject baseObj)
	{
		...
		ImageOverlayerExtension obj = null;
 		if(baseObj instanceof ImageOverlayerExtension)
		{
			obj = (ImageOverlayerExtension)baseObj;
		} else {
