...
public class MercatorSphere extends com.earthview.world.geometry3d.MovableSphere {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::CMercatorSphere", new MercatorSphereClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::JCMercatorSphereProxy", new MercatorSphereClassFactory());
	}

	public MercatorSphere(com.earthview.world.spatial.math.Vector3 centerPoint, double radius) {
		...
		Create("JCMercatorSphereProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.geometry3d.MercatorSphere".equals(this.getClass().getName()))
		{
	...
	public MercatorSphere(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public MercatorSphere(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static MercatorSphere fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		MercatorSphere obj = null;
 		if(baseObj instanceof MercatorSphere)
		{
			obj = (MercatorSphere)baseObj;
		} else {
			obj = new MercatorSphere(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CMercatorSphere");
			obj.increaseCast();
		}
