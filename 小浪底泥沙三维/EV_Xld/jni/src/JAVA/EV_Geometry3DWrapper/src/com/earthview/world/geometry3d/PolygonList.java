...
///polygon容器类
/// </summary>
public class PolygonList extends com.earthview.world.geometry3d.VisibleObject {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::CPolygonList", new PolygonListClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::JCPolygonListProxy", new PolygonListClassFactory());
	}

	public PolygonList(com.earthview.world.graphic.SceneManager ref_scenemanager) {
		...
		Create("JCPolygonListProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.geometry3d.PolygonList".equals(this.getClass().getName()))
		{
	...
	public static PolygonList fromBaseObject(BaseObject baseObj)
	{
 		...
 		if(baseObj instanceof PolygonList)
		{
			...
			obj.bindNativeObject(baseObj.nativeObject, "CPolygonList");
			obj.increaseCast();
		}
