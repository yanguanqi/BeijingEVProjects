...
/// 提供设置点的大小和填充符号
/// <summary>
public class MovablePoint2 extends com.earthview.world.geometry3d.MovablePoint {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::CMovablePoint2", new MovablePoint2ClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::JCMovablePoint2Proxy", new MovablePoint2ClassFactory());
	}

	public MovablePoint2() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCMovablePoint2Proxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.geometry3d.MovablePoint2".equals(this.getClass().getName()))
		{
	...
	public MovablePoint2(double x, double y, double z, com.earthview.world.graphic.ColourValue clr, com.earthview.world.spatial.math.Vector3 normal) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		...
		Create("JCMovablePoint2Proxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.geometry3d.MovablePoint2".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
	...
	/// <param name="clr">点的颜色</param>
	/// <param name="normal">点的法向量</param>
	public MovablePoint2(com.earthview.world.spatial.math.Vector3 point, com.earthview.world.graphic.ColourValue clr, com.earthview.world.spatial.math.Vector3 normal) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
	...
	public MovablePoint2(com.earthview.world.geometry3d.MovablePoint2 other) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
	...
	native private long OperatorAssign_CMovablePoint2(long pNativeObject, long other);
	public com.earthview.world.geometry3d.MovablePoint2 OperatorAssign(com.earthview.world.geometry3d.MovablePoint2 other)
	{
		long otherParamValue = other.nativeObject.pointer;
		long returnValue = OperatorAssign_CMovablePoint2(this.nativeObject.pointer, otherParamValue);
		com.earthview.world.geometry3d.MovablePoint2 __returnValue = new com.earthview.world.geometry3d.MovablePoint2(CreatedWhenConstruct.CWC_NotToCreate, "CMovablePoint2");
		...
		{
			__returnValue.setDelegate(true);
			__returnValue = (com.earthview.world.geometry3d.MovablePoint2)__returnValueClassFactory.create();
			__returnValue.setDelegate(true);
			__returnValue.bindNativeObject(__instancePointer, "CMovablePoint2");
		}
	...
	public com.earthview.world.geometry3d.Point2DBufferType getBufferType()
	{
		int returnValue = getBufferType_void(this.nativeObject.pointer);
		return com.earthview.world.geometry3d.Point2DBufferType.toEnum(returnValue);
	}
	native private void setBufferType_Point2DBufferType(long pNativeObject, int type);
	/// <summary>
	/// 设置缓冲的类型
	/// <summary>
	/// <param name="type">设置当前的缓冲类型，是球还是立方体</param>
	public void setBufferType(com.earthview.world.geometry3d.Point2DBufferType type)
	{
		int typeParamValue = type.getValue();
		setBufferType_Point2DBufferType(this.nativeObject.pointer, typeParamValue);
	}
	...
	public MovablePoint2(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public MovablePoint2(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static MovablePoint2 fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		MovablePoint2 obj = null;
 		if(baseObj instanceof MovablePoint2)
		{
			obj = (MovablePoint2)baseObj;
		} else {
			obj = new MovablePoint2(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CMovablePoint2");
			obj.increaseCast();
		}
