...
/// <summary>
public class Geometry3D extends com.earthview.world.geometry3d.SimpleRenderableEx {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::CGeometry3D", new Geometry3DClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::JCGeometry3DProxy", new Geometry3DClassFactory());
	}
	...
	public Geometry3D() {
		...
		Create("JCGeometry3DProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.geometry3d.Geometry3D".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
		}
	}

	public Geometry3D(com.earthview.world.geometry3d.Geometry3D other) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer otherPtr = new BasePointer(other);
		list.add("other", otherPtr.get());
		Create("JCGeometry3DProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.geometry3d.Geometry3D".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
	...
	{
		com.earthview.world.geometry3d.Geometry3D returnValue = ev_clone();
		if(returnValue == null) {
			return 0L;
		}
	...
	protected  void create_void_callback()
	{
		create();
	}
	...
	protected  int getDrawingType_void_callback()
	{
		com.earthview.world.geometry3d.DrawingType returnValue = getDrawingType();
	...
	native private void setAutoDepthAlias_ev_bool(long pNativeObject, boolean value);
	/**
	 * 是否进行矩阵偏移
	 * @param value 是否进行矩阵偏移
	 */
	public void setAutoDepthAlias(boolean value)
	{
		boolean valueParamValue = value;
		setAutoDepthAlias_ev_bool(this.nativeObject.pointer, valueParamValue);
	}
	public Geometry3D(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Geometry3D(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Geometry3D fromBaseObject(BaseObject baseObj)
	{
		...
		Geometry3D obj = null;
 		if(baseObj instanceof Geometry3D)
		{
			obj = (Geometry3D)baseObj;
		} else {
			obj = new Geometry3D(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CGeometry3D");
			obj.increaseCast();
		}
