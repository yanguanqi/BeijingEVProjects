 ...
 */
public class GeometryClampSceneLayer extends com.earthview.world.spatial3d.atlas.Iclampscenelayer {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::CGeometryClampSceneLayer", new GeometryClampSceneLayerClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::JCGeometryClampSceneLayerProxy", new GeometryClampSceneLayerClassFactory());
	}
	 ...
	 */
	public GeometryClampSceneLayer(com.earthview.world.graphic.SceneManager ref_pSceneMgr) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer ref_pSceneMgrPtr = new BasePointer(ref_pSceneMgr);
		list.add("ref_pSceneMgr", ref_pSceneMgrPtr.get());
		Create("JCGeometryClampSceneLayerProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.geometry3d.GeometryClampSceneLayer".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
		}
	}

	native private boolean appendGeoObject_CGeoObject(long pNativeObject, long ref_obj);
	/**
	 * 添加CGeoObject对象
	 * @param obj 对象指针
	 * @return 是否添加成功
	 */
	public boolean appendGeoObject(com.earthview.world.spatial.GeoObject ref_obj)
	{
		long ref_objParamValue = (ref_obj == null ? 0L : ref_obj.nativeObject.pointer);
		boolean returnValue = appendGeoObject_CGeoObject(this.nativeObject.pointer, ref_objParamValue);
		return returnValue;
	}
	native private boolean removeGeoObject_CGeoObject(long pNativeObject, long obj);
	public boolean removeGeoObject(com.earthview.world.spatial.GeoObject obj)
	{
		long objParamValue = (obj == null ? 0L : obj.nativeObject.pointer);
		boolean returnValue = removeGeoObject_CGeoObject(this.nativeObject.pointer, objParamValue);
		return returnValue;
	}
	...
	native private void clearGeoObjects_void(long pNativeObject);
	public void clearGeoObjects()
	{
		clearGeoObjects_void(this.nativeObject.pointer);
	}
	...
	public GeometryClampSceneLayer(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public GeometryClampSceneLayer(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static GeometryClampSceneLayer fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		GeometryClampSceneLayer obj = null;
 		if(baseObj instanceof GeometryClampSceneLayer)
		{
			obj = (GeometryClampSceneLayer)baseObj;
		} else {
			obj = new GeometryClampSceneLayer(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CGeometryClampSceneLayer");
			obj.increaseCast();
		}
