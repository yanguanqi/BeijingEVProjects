...
///
public class KmlPolygonFactory extends com.earthview.world.spatial3d.atlas.Igeometry3dfactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::CKmlPolygonFactory", new KmlPolygonFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::JCKmlPolygonFactoryProxy", new KmlPolygonFactoryClassFactory());
	}
	 ...
	 * @param  
	 */
	public KmlPolygonFactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCKmlPolygonFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.geometry3d.KmlPolygonFactory".equals(this.getClass().getName()))
		{
	...
	public KmlPolygonFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public KmlPolygonFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static KmlPolygonFactory fromBaseObject(BaseObject baseObj)
	{
		...
		KmlPolygonFactory obj = null;
 		if(baseObj instanceof KmlPolygonFactory)
		{
			obj = (KmlPolygonFactory)baseObj;
		} else {
