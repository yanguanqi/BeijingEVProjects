...
/**
 * 创建广告板设置实例类定义实例的创建及相关操作
 */
public class GeoEntityFactory extends com.earthview.world.graphic.MovableObjectFactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::CGeoEntityFactory", new GeoEntityFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::JCGeoEntityFactoryProxy", new GeoEntityFactoryClassFactory());
	}
	...
	public GeoEntityFactory() {
		...
		Create("JCGeoEntityFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.geometry3d.GeoEntityFactory".equals(this.getClass().getName()))
		{
	...
	{
		com.earthview.world.graphic.MovableObject returnValue = createInstance();
		if(returnValue == null) {
			return 0L;
		}
	 ...
	 * @param  
	 */
	public com.earthview.world.graphic.MovableObject createInstance()
	{
	...
	protected com.earthview.world.graphic.MovableObject createInstance_NoVirtual()
	{
	...
	public GeoEntityFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public GeoEntityFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	{
		return super.createInstanceImpl_NoVirtual(name, params);
	}
	...
	public static GeoEntityFactory fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		GeoEntityFactory obj = null;
 		if(baseObj instanceof GeoEntityFactory)
		{
			obj = (GeoEntityFactory)baseObj;
		} else {
			obj = new GeoEntityFactory(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CGeoEntityFactory");
			obj.increaseCast();
		}
