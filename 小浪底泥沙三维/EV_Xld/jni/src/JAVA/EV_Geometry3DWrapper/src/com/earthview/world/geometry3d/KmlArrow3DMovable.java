...
/// 3D标绘的渲染对象
public class KmlArrow3DMovable extends com.earthview.world.geometry3d.SimpleRenderableEx {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::CKmlArrow3DMovable", new KmlArrow3DMovableClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::JCKmlArrow3DMovableProxy", new KmlArrow3DMovableClassFactory());
	}

	/**
	 * 构造函数
	 * @param pSceMger 场景管理器
	 * @param ArrowInfo 绘制的基本信息对象
	 */
	public KmlArrow3DMovable(com.earthview.world.graphic.SceneManager pSceMger, com.earthview.world.geometry3d.ArrowBaseInfo ArrowInfo) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer pSceMgerPtr = new BasePointer(pSceMger);
		list.add("pSceMger", pSceMgerPtr.get());
		BasePointer ArrowInfoPtr = new BasePointer(ArrowInfo);
		list.add("ArrowInfo", ArrowInfoPtr.get());
		Create("JCKmlArrow3DMovableProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.geometry3d.KmlArrow3DMovable".equals(this.getClass().getName()))
		{
	...
	public KmlArrow3DMovable(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public KmlArrow3DMovable(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static KmlArrow3DMovable fromBaseObject(BaseObject baseObj)
	{
		...
		KmlArrow3DMovable obj = null;
 		if(baseObj instanceof KmlArrow3DMovable)
		{
			obj = (KmlArrow3DMovable)baseObj;
		} else {
