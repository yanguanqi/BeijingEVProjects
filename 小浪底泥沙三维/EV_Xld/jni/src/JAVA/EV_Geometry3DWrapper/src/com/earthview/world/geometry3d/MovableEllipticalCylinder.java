...
/// 2. 提供了绘制方法
/// <summary>
public class MovableEllipticalCylinder extends com.earthview.world.geometry3d.Geometry3D {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::CMovableEllipticalCylinder", new MovableEllipticalCylinderClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::JCMovableEllipticalCylinderProxy", new MovableEllipticalCylinderClassFactory());
	}

	public MovableEllipticalCylinder() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCMovableEllipticalCylinderProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.geometry3d.MovableEllipticalCylinder".equals(this.getClass().getName()))
		{
	...
	public MovableEllipticalCylinder(com.earthview.world.spatial.math.Vector3 centerPoint, double xRadius, double yRadius, double height, com.earthview.world.graphic.ColourValue fillClr, com.earthview.world.graphic.ColourValue frameClr, com.earthview.world.geometry3d.DrawingMode drawingMode, boolean includeTextureCoordinates) {
		...
		Create("JCMovableEllipticalCylinderProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.geometry3d.MovableEllipticalCylinder".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
	...
	public MovableEllipticalCylinder(com.earthview.world.geometry3d.MovableEllipticalCylinder other) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
	...
	native private long OperatorAssign_CMovableEllipticalCylinder(long pNativeObject, long other);
	public com.earthview.world.geometry3d.MovableEllipticalCylinder OperatorAssign(com.earthview.world.geometry3d.MovableEllipticalCylinder other)
	{
		long otherParamValue = other.nativeObject.pointer;
		long returnValue = OperatorAssign_CMovableEllipticalCylinder(this.nativeObject.pointer, otherParamValue);
		com.earthview.world.geometry3d.MovableEllipticalCylinder __returnValue = new com.earthview.world.geometry3d.MovableEllipticalCylinder(CreatedWhenConstruct.CWC_NotToCreate, "CMovableEllipticalCylinder");
		...
		{
			__returnValue.setDelegate(true);
			__returnValue = (com.earthview.world.geometry3d.MovableEllipticalCylinder)__returnValueClassFactory.create();
			__returnValue.setDelegate(true);
			__returnValue.bindNativeObject(__instancePointer, "CMovableEllipticalCylinder");
		}
	...
	public MovableEllipticalCylinder(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public MovableEllipticalCylinder(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static MovableEllipticalCylinder fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		MovableEllipticalCylinder obj = null;
 		if(baseObj instanceof MovableEllipticalCylinder)
		{
			obj = (MovableEllipticalCylinder)baseObj;
		} else {
			obj = new MovableEllipticalCylinder(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CMovableEllipticalCylinder");
			obj.increaseCast();
		}
