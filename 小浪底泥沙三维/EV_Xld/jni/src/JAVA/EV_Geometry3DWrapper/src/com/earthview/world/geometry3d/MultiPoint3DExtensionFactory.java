...
///
public class MultiPoint3DExtensionFactory extends com.earthview.world.spatial3d.atlas.Igeometry3dfactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::CMultiPoint3DExtensionFactory", new MultiPoint3DExtensionFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::JCMultiPoint3DExtensionFactoryProxy", new MultiPoint3DExtensionFactoryClassFactory());
	}
	 ...
	 * @param  
	 */
	public MultiPoint3DExtensionFactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCMultiPoint3DExtensionFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.geometry3d.MultiPoint3DExtensionFactory".equals(this.getClass().getName()))
		{
	...
	public MultiPoint3DExtensionFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public MultiPoint3DExtensionFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static MultiPoint3DExtensionFactory fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		MultiPoint3DExtensionFactory obj = null;
 		if(baseObj instanceof MultiPoint3DExtensionFactory)
		{
			obj = (MultiPoint3DExtensionFactory)baseObj;
		} else {
			obj = new MultiPoint3DExtensionFactory(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CMultiPoint3DExtensionFactory");
			obj.increaseCast();
		}
