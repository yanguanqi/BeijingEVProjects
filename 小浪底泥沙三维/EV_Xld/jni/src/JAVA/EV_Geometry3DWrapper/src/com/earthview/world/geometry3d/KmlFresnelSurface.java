 ...
 */
public class KmlFresnelSurface extends com.earthview.world.geometry3d.MultiPolygon3DExtension {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::CKmlFresnelSurface", new KmlFresnelSurfaceClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::JCKmlFresnelSurfaceProxy", new KmlFresnelSurfaceClassFactory());
	}
	 ...
	 */
	public KmlFresnelSurface(com.earthview.world.spatial.kml.GeoObjectExtension ref_geo, com.earthview.world.graphic.SceneManager ref_scenemanager, String groupName) {
		...
		Create("JCKmlFresnelSurfaceProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.geometry3d.KmlFresnelSurface".equals(this.getClass().getName()))
		{
	...
	public KmlFresnelSurface(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public KmlFresnelSurface(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static KmlFresnelSurface fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		KmlFresnelSurface obj = null;
 		if(baseObj instanceof KmlFresnelSurface)
		{
			obj = (KmlFresnelSurface)baseObj;
		} else {
			obj = new KmlFresnelSurface(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CKmlFresnelSurface");
			obj.increaseCast();
		}
