...
///   提供设置点的大小和填充符号
/// <summary>
public class MovablePoint3 extends com.earthview.world.geometry3d.MovablePoint {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::CMovablePoint3", new MovablePoint3ClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::JCMovablePoint3Proxy", new MovablePoint3ClassFactory());
	}

	public MovablePoint3() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCMovablePoint3Proxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.geometry3d.MovablePoint3".equals(this.getClass().getName()))
		{
	...
	public MovablePoint3(double x, double y, double z, com.earthview.world.graphic.ColourValue clr, com.earthview.world.spatial.math.Vector3 normal) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		...
		Create("JCMovablePoint3Proxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.geometry3d.MovablePoint3".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
	...
	/// <param name="clr">点的颜色</param>
	/// <param name="normal">点的法向量</param>
	public MovablePoint3(com.earthview.world.spatial.math.Vector3 point, com.earthview.world.graphic.ColourValue clr, com.earthview.world.spatial.math.Vector3 normal) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
	...
	public MovablePoint3(com.earthview.world.geometry3d.MovablePoint3 other) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
	...
	native private long OperatorAssign_CMovablePoint3(long pNativeObject, long other);
	public com.earthview.world.geometry3d.MovablePoint3 OperatorAssign(com.earthview.world.geometry3d.MovablePoint3 other)
	{
		long otherParamValue = other.nativeObject.pointer;
		long returnValue = OperatorAssign_CMovablePoint3(this.nativeObject.pointer, otherParamValue);
		com.earthview.world.geometry3d.MovablePoint3 __returnValue = new com.earthview.world.geometry3d.MovablePoint3(CreatedWhenConstruct.CWC_NotToCreate, "CMovablePoint3");
		...
		{
			__returnValue.setDelegate(true);
			__returnValue = (com.earthview.world.geometry3d.MovablePoint3)__returnValueClassFactory.create();
			__returnValue.setDelegate(true);
			__returnValue.bindNativeObject(__instancePointer, "CMovablePoint3");
		}
	...
	native private int getBufferType_void(long pNativeObject);
	/// <summary>
	/// 获取缓冲的类型
	/// <summary>
	/// <returns>当前的缓冲类型，是球还是立方体</returns>
	public com.earthview.world.geometry3d.Point3DBufferType getBufferType()
	{
		int returnValue = getBufferType_void(this.nativeObject.pointer);
		return com.earthview.world.geometry3d.Point3DBufferType.toEnum(returnValue);
	}
	native private void setBufferType_Point3DBufferType(long pNativeObject, int type);
	/// <summary>
	/// 设置缓冲的类型
	/// <summary>
	/// <param name="type">设置当前的缓冲类型，是球还是立方体</param>
	public void setBufferType(com.earthview.world.geometry3d.Point3DBufferType type)
	{
		int typeParamValue = type.getValue();
		setBufferType_Point3DBufferType(this.nativeObject.pointer, typeParamValue);
	}
	...
	public MovablePoint3(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public MovablePoint3(CreatedWhenConstruct cwc, String classNameStr) {
	...
	{
		return super.getDrawingType_NoVirtual();
	}
	/**
	 * 渲染开始时向外通知的事件
	 * @param sm 渲染场景
	...
	public static MovablePoint3 fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		MovablePoint3 obj = null;
 		if(baseObj instanceof MovablePoint3)
		{
			obj = (MovablePoint3)baseObj;
		} else {
			obj = new MovablePoint3(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CMovablePoint3");
			obj.increaseCast();
		}
