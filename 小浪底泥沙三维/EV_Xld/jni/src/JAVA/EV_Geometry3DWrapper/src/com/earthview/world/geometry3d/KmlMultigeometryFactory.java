...
///
public class KmlMultigeometryFactory extends com.earthview.world.spatial3d.atlas.Igeometry3dfactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::CKmlMultigeometryFactory", new KmlMultigeometryFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::JCKmlMultigeometryFactoryProxy", new KmlMultigeometryFactoryClassFactory());
	}
	 ...
	 * @param  
	 */
	public KmlMultigeometryFactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCKmlMultigeometryFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.geometry3d.KmlMultigeometryFactory".equals(this.getClass().getName()))
		{
	...
	public KmlMultigeometryFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public KmlMultigeometryFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static KmlMultigeometryFactory fromBaseObject(BaseObject baseObj)
	{
		...
		KmlMultigeometryFactory obj = null;
 		if(baseObj instanceof KmlMultigeometryFactory)
		{
			obj = (KmlMultigeometryFactory)baseObj;
		} else {
