...
///
public class KmlFresnelSurfaceFactory extends com.earthview.world.spatial3d.atlas.Igeometry3dfactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::CKmlFresnelSurfaceFactory", new KmlFresnelSurfaceFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::JCKmlFresnelSurfaceFactoryProxy", new KmlFresnelSurfaceFactoryClassFactory());
	}
	 ...
	 * @param  
	 */
	public KmlFresnelSurfaceFactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCKmlFresnelSurfaceFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.geometry3d.KmlFresnelSurfaceFactory".equals(this.getClass().getName()))
		{
	...
	public KmlFresnelSurfaceFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public KmlFresnelSurfaceFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static KmlFresnelSurfaceFactory fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		KmlFresnelSurfaceFactory obj = null;
 		if(baseObj instanceof KmlFresnelSurfaceFactory)
		{
			obj = (KmlFresnelSurfaceFactory)baseObj;
		} else {
			obj = new KmlFresnelSurfaceFactory(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CKmlFresnelSurfaceFactory");
			obj.increaseCast();
		}
