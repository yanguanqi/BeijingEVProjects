...
public class KmlArrowObjectExFactory extends com.earthview.world.spatial3d.atlas.Igeometry3dfactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::CKmlArrowObjectExFactory", new KmlArrowObjectExFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::JCKmlArrowObjectExFactoryProxy", new KmlArrowObjectExFactoryClassFactory());
	}
	 ...
	 * @param  
	 */
	public KmlArrowObjectExFactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCKmlArrowObjectExFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.geometry3d.KmlArrowObjectExFactory".equals(this.getClass().getName()))
		{
	...
	public KmlArrowObjectExFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public KmlArrowObjectExFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static KmlArrowObjectExFactory fromBaseObject(BaseObject baseObj)
	{
		...
		KmlArrowObjectExFactory obj = null;
 		if(baseObj instanceof KmlArrowObjectExFactory)
		{
			obj = (KmlArrowObjectExFactory)baseObj;
		} else {
