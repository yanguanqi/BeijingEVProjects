 ...
 */
public class GeoPointEx extends com.earthview.world.core.AllocatedObject {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::CGeoPointEx", new GeoPointExClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::JCGeoPointExProxy", new GeoPointExClassFactory());
	}
	 ...
	 */
	public GeoPointEx(com.earthview.world.graphic.SceneManager ref_scenemanager) {
		...
		Create("JCGeoPointExProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.geometry3d.GeoPointEx".equals(this.getClass().getName()))
		{
	...
	public GeoPointEx(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public GeoPointEx(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static GeoPointEx fromBaseObject(BaseObject baseObj)
	{
		...
		GeoPointEx obj = null;
 		if(baseObj instanceof GeoPointEx)
		{
			obj = (GeoPointEx)baseObj;
		} else {
