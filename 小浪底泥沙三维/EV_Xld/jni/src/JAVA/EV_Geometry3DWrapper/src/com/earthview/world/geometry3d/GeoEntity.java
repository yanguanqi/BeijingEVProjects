 ...
 * 				管理地理实体类
 */
public class GeoEntity extends com.earthview.world.graphic.MovableObject {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::CGeoEntity", new GeoEntityClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Geometry3D::JCGeoEntityProxy", new GeoEntityClassFactory());
	}
	...
	public GeoEntity() {
		...
		Create("JCGeoEntityProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.geometry3d.GeoEntity".equals(this.getClass().getName()))
		{
	 ...
	 * @param  
	 */
	public GeoEntity(com.earthview.world.graphic.SceneManager ref_sceneManager) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		...
		Create("JCGeoEntityProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.geometry3d.GeoEntity".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
	...
	native private boolean addGeoObject_CGeoObject(long pNativeObject, long ref_geo);
	/// <summary>
	/// 追加地理对象				
	/// <param name="geo">地理对象</param>				
	/// <returns>是否成功</returns>
	public boolean addGeoObject(com.earthview.world.spatial.GeoObject ref_geo)
	{
		long ref_geoParamValue = (ref_geo == null ? 0L : ref_geo.nativeObject.pointer);
		boolean returnValue = addGeoObject_CGeoObject(this.nativeObject.pointer, ref_geoParamValue);
		return returnValue;
	}
	native private boolean removeGeoObject_ev_uint32(long pNativeObject, long pos);
	/// <summary>
	/// 移除地理对象				
	/// <param name="pos">索引</param>				
	/// <returns>是否成功</returns>
	public boolean removeGeoObject(long pos)
	{
		long posParamValue = pos;
		boolean returnValue = removeGeoObject_ev_uint32(this.nativeObject.pointer, posParamValue);
		return returnValue;
	}
	native private boolean removeGeoObject_CGeoObject(long pNativeObject, long geo);
	/// <summary>
	/// 移除地理对象				
	/// <param name="geo">地理对象</param>				
	/// <returns>是否成功</returns>
	public boolean removeGeoObject(com.earthview.world.spatial.GeoObject geo)
	{
		long geoParamValue = (geo == null ? 0L : geo.nativeObject.pointer);
		boolean returnValue = removeGeoObject_CGeoObject(this.nativeObject.pointer, geoParamValue);
		return returnValue;
	}
	native private long getGeoObjectCount_void(long pNativeObject);
	/// <summary>
	/// 返回地理对象数量				
	/// <param name=""></param>				
	/// <returns>地理对象数量</returns>
	public long getGeoObjectCount()
	{
		long returnValue = getGeoObjectCount_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private boolean existGeoObject_CGeoObject(long pNativeObject, long geo);
	/// <summary>
	/// 是否存在地理对象				
	/// <param name="geo">地理对象</param>				
	/// <returns>是否存在</returns>
	public boolean existGeoObject(com.earthview.world.spatial.GeoObject geo)
	{
		long geoParamValue = (geo == null ? 0L : geo.nativeObject.pointer);
		boolean returnValue = existGeoObject_CGeoObject(this.nativeObject.pointer, geoParamValue);
		return returnValue;
	}
	native private long getGeoObject_ev_uint32(long pNativeObject, long pos);
	/// <summary>
	/// 获取地理对象				
	/// <param name="pos">索引</param>				
	/// <returns>地理对象</returns>
	public com.earthview.world.spatial.GeoObject getGeoObject(long pos)
	{
		long posParamValue = pos;
		long returnValue = getGeoObject_ev_uint32(this.nativeObject.pointer, posParamValue);
		if(returnValue == 0L) {
			return null;
		}
	...
	native private boolean insertGeoObject_CGeoObject_ev_uint32(long pNativeObject, long ref_geo, long pos);
	/// <summary>
	/// 插入地理对象				
	/// <param name="geo">地理对象</param>
	/// <param name="pos">索引位置</param>	
	/// <returns>是否成功</returns>
	public boolean insertGeoObject(com.earthview.world.spatial.GeoObject ref_geo, long pos)
	{
		long ref_geoParamValue = (ref_geo == null ? 0L : ref_geo.nativeObject.pointer);
		long posParamValue = pos;
		boolean returnValue = insertGeoObject_CGeoObject_ev_uint32(this.nativeObject.pointer, ref_geoParamValue, posParamValue);
		return returnValue;
	}
	native private boolean setGeoObject_CGeoObject_ev_uint32(long pNativeObject, long ref_geo, long pos);
	/// <summary>
	/// 替换地理对象				
	/// <param name="geo">地理对象</param>
	/// <param name="pos">索引位置</param>	
	/// <returns>是否成功</returns>
	public boolean setGeoObject(com.earthview.world.spatial.GeoObject ref_geo, long pos)
	{
		long ref_geoParamValue = (ref_geo == null ? 0L : ref_geo.nativeObject.pointer);
		long posParamValue = pos;
		boolean returnValue = setGeoObject_CGeoObject_ev_uint32(this.nativeObject.pointer, ref_geoParamValue, posParamValue);
		return returnValue;
	}
	native private boolean clearGeoObjects_void(long pNativeObject);
	/// <summary>
	/// 清除地理对象				
	/// <param name=""></param>
	/// <returns>是否成功</returns>
	public boolean clearGeoObjects()
	{
		boolean returnValue = clearGeoObjects_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private long getMovableObjectsCount_void(long pNativeObject);
	/// <summary>
	/// 获取movableobject数量				
	/// <param name=""></param>
	/// <returns>movableobject数量</returns>
	public long getMovableObjectsCount()
	{
		long returnValue = getMovableObjectsCount_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private boolean existMovableObject_CMovableObject(long pNativeObject, long mo);
	/// <summary>
	/// 是否存在movableobject				
	/// <param name="mo">movableobject</param>
	/// <returns>是否存在</returns>
	public boolean existMovableObject(com.earthview.world.graphic.MovableObject mo)
	{
		long moParamValue = (mo == null ? 0L : mo.nativeObject.pointer);
		boolean returnValue = existMovableObject_CMovableObject(this.nativeObject.pointer, moParamValue);
		return returnValue;
	}
	native private long getMovableObject_ev_uint32(long pNativeObject, long pos);
	/// <summary>
	/// 获取movableobject				
	/// <param name="pos">索引位置</param>
	/// <returns>movableobject</returns>
	public com.earthview.world.graphic.MovableObject getMovableObject(long pos)
	{
		long posParamValue = pos;
		long returnValue = getMovableObject_ev_uint32(this.nativeObject.pointer, posParamValue);
		if(returnValue == 0L) {
			return null;
		}
	...
	native private void setRenderableListener_CRenderableGeometryExtensionListener(long pNativeObject, long listener);
	/**
	 * 获取renderablelistener
	 * @param  
	 * @return renderablelistener
	 */
	public void setRenderableListener(com.earthview.world.geometry3d.RenderableGeometryExtensionListener listener)
	{
		long listenerParamValue = (listener == null ? 0L : listener.nativeObject.pointer);
		setRenderableListener_CRenderableGeometryExtensionListener(this.nativeObject.pointer, listenerParamValue);
	}
	protected  void flash_IntVector_CColourValue_ev_uint32_ev_uint32_ev_uint32_callback(long objIndics, long color, long hightLight_ms, long normally_ms, long flashCount)
	{
		...
		flash(objIndicsParamValue, colorParamValue, hightLight_msParamValue, normally_msParamValue, flashCountParamValue);
	}

	native private void flash_IntVector_CColourValue_ev_uint32_ev_uint32_ev_uint32(long pNativeObject, long objIndics, long color, long hightLight_ms, long normally_ms, long flashCount);
	/**
	 * 闪烁
	 */
	public void flash(com.earthview.world.core.IntVector objIndics, com.earthview.world.graphic.ColourValue color, long hightLight_ms, long normally_ms, long flashCount)
	{
		long objIndicsParamValue = objIndics.nativeObject.pointer;
		...
		long normally_msParamValue = normally_ms;
		long flashCountParamValue = flashCount;
		flash_IntVector_CColourValue_ev_uint32_ev_uint32_ev_uint32(this.nativeObject.pointer, objIndicsParamValue, colorParamValue, hightLight_msParamValue, normally_msParamValue, flashCountParamValue);
	}
	native private void flash_IntVector_CColourValue_ev_uint32_ev_uint32_ev_uint32_NoVirtual(long pNativeObject, long objIndics, long color, long hightLight_ms, long normally_ms, long flashCount);
	protected void flash_NoVirtual(com.earthview.world.core.IntVector objIndics, com.earthview.world.graphic.ColourValue color, long hightLight_ms, long normally_ms, long flashCount)
	{
		long objIndicsParamValue = objIndics.nativeObject.pointer;
		long colorParamValue = color.nativeObject.pointer;
		long hightLight_msParamValue = hightLight_ms;
		long normally_msParamValue = normally_ms;
		long flashCountParamValue = flashCount;
		flash_IntVector_CColourValue_ev_uint32_ev_uint32_ev_uint32_NoVirtual(this.nativeObject.pointer, objIndicsParamValue, colorParamValue, hightLight_msParamValue, normally_msParamValue, flashCountParamValue);
	}
	...
	public GeoEntity(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public GeoEntity(CreatedWhenConstruct cwc, String classNameStr) {
	...
	native protected void register_flash_IntVector_CColourValue_ev_uint32_ev_uint32_ev_uint32(long pNativeObject, String method);
	...
	public void registerCallback(){
		if (!this.nativeObject.equals(InstancePointer.ZERO)){
			...
			this.register_flash_IntVector_CColourValue_ev_uint32_ev_uint32_ev_uint32(this.nativeObject.pointer, "flash_IntVector_CColourValue_ev_uint32_ev_uint32_ev_uint32_callback");
	...
	public static GeoEntity fromBaseObject(BaseObject baseObj)
	{
		...
		GeoEntity obj = null;
 		if(baseObj instanceof GeoEntity)
		{
			obj = (GeoEntity)baseObj;
		} else {
			obj = new GeoEntity(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CGeoEntity");
			obj.increaseCast();
		}
