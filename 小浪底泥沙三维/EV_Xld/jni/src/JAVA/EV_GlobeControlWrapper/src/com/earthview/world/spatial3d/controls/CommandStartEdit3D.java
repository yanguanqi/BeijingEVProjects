 ...
 * 开始编辑命令
 */
public class CommandStartEdit3D extends com.earthview.world.spatial3d.controls.GlobeCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Controls::CCommandStartEdit3D", new CommandStartEdit3DClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Controls::JCCommandStartEdit3DProxy", new CommandStartEdit3DClassFactory());
	}
	 ...
	 * @param  
	 */
	public CommandStartEdit3D() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandStartEdit3DProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.controls.CommandStartEdit3D".equals(this.getClass().getName()))
		{
	...
	public CommandStartEdit3D(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandStartEdit3D(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandStartEdit3D fromBaseObject(BaseObject baseObj)
	{
		...
		CommandStartEdit3D obj = null;
 		if(baseObj instanceof CommandStartEdit3D)
		{
			obj = (CommandStartEdit3D)baseObj;
		} else {
