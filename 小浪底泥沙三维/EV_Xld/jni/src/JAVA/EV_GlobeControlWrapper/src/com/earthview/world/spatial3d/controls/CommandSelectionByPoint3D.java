 ...
 * 工具栏点选择类
 */
public class CommandSelectionByPoint3D extends com.earthview.world.spatial3d.controls.GlobeCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Controls::CCommandSelectionByPoint3D", new CommandSelectionByPoint3DClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Controls::JCCommandSelectionByPoint3DProxy", new CommandSelectionByPoint3DClassFactory());
	}
	 ...
	 * @param  
	 */
	public CommandSelectionByPoint3D() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandSelectionByPoint3DProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.controls.CommandSelectionByPoint3D".equals(this.getClass().getName()))
		{
	...
	public CommandSelectionByPoint3D(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandSelectionByPoint3D(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandSelectionByPoint3D fromBaseObject(BaseObject baseObj)
	{
		...
		CommandSelectionByPoint3D obj = null;
 		if(baseObj instanceof CommandSelectionByPoint3D)
		{
			obj = (CommandSelectionByPoint3D)baseObj;
		} else {
