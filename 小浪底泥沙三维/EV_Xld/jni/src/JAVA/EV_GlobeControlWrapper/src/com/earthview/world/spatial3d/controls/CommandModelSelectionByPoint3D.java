 ...
 * π§æﬂ¿∏µ„—°‘Ò¿‡
 */
public class CommandModelSelectionByPoint3D extends com.earthview.world.spatial3d.controls.GlobeCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Controls::CCommandModelSelectionByPoint3D", new CommandModelSelectionByPoint3DClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Controls::JCCommandModelSelectionByPoint3DProxy", new CommandModelSelectionByPoint3DClassFactory());
	}
	 ...
	 * @param  
	 */
	public CommandModelSelectionByPoint3D() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandModelSelectionByPoint3DProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.controls.CommandModelSelectionByPoint3D".equals(this.getClass().getName()))
		{
	...
	public CommandModelSelectionByPoint3D(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandModelSelectionByPoint3D(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandModelSelectionByPoint3D fromBaseObject(BaseObject baseObj)
	{
		...
		CommandModelSelectionByPoint3D obj = null;
 		if(baseObj instanceof CommandModelSelectionByPoint3D)
		{
			obj = (CommandModelSelectionByPoint3D)baseObj;
		} else {
