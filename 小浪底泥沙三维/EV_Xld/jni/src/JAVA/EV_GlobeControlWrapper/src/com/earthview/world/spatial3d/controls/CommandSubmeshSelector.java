...
public class CommandSubmeshSelector extends com.earthview.world.spatial3d.controls.GlobeCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Controls::CommandSubmeshSelector", new CommandSubmeshSelectorClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Controls::JCommandSubmeshSelectorProxy", new CommandSubmeshSelectorClassFactory());
	}

	public CommandSubmeshSelector() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCommandSubmeshSelectorProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.controls.CommandSubmeshSelector".equals(this.getClass().getName()))
		{
	...
	public CommandSubmeshSelector(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandSubmeshSelector(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandSubmeshSelector fromBaseObject(BaseObject baseObj)
	{
		...
		CommandSubmeshSelector obj = null;
 		if(baseObj instanceof CommandSubmeshSelector)
		{
			obj = (CommandSubmeshSelector)baseObj;
		} else {
