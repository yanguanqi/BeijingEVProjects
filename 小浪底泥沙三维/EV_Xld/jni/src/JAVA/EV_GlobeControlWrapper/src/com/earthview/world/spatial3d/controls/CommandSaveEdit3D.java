 ...
 * 保存编辑命令
 */
public class CommandSaveEdit3D extends com.earthview.world.spatial3d.controls.GlobeCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Controls::CCommandSaveEdit3D", new CommandSaveEdit3DClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Controls::JCCommandSaveEdit3DProxy", new CommandSaveEdit3DClassFactory());
	}
	 ...
	 * @param  
	 */
	public CommandSaveEdit3D() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandSaveEdit3DProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.controls.CommandSaveEdit3D".equals(this.getClass().getName()))
		{
	...
	public CommandSaveEdit3D(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandSaveEdit3D(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandSaveEdit3D fromBaseObject(BaseObject baseObj)
	{
		...
		CommandSaveEdit3D obj = null;
 		if(baseObj instanceof CommandSaveEdit3D)
		{
			obj = (CommandSaveEdit3D)baseObj;
		} else {
