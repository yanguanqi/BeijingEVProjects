 ...
 * 显示模型库编辑素材命令
 */
public class CommandModelSelection3D extends com.earthview.world.spatial3d.controls.GlobeCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Controls::CCommandModelSelection3D", new CommandModelSelection3DClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Controls::JCCommandModelSelection3DProxy", new CommandModelSelection3DClassFactory());
	}
	 ...
	 * @param  
	 */
	public CommandModelSelection3D() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandModelSelection3DProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.controls.CommandModelSelection3D".equals(this.getClass().getName()))
		{
	...
	public CommandModelSelection3D(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandModelSelection3D(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandModelSelection3D fromBaseObject(BaseObject baseObj)
	{
		...
		CommandModelSelection3D obj = null;
 		if(baseObj instanceof CommandModelSelection3D)
		{
			obj = (CommandModelSelection3D)baseObj;
		} else {
