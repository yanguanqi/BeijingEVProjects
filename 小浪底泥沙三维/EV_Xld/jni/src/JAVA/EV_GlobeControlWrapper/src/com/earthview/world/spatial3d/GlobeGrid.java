...
public class GlobeGrid extends com.earthview.world.graphic.ManualObject {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::CGlobeGrid", new GlobeGridClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::JCGlobeGridProxy", new GlobeGridClassFactory());
	}

	public GlobeGrid(String name, com.earthview.world.spatial3d.controls.GlobeControl control) {
		...
		Create("JCGlobeGridProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.GlobeGrid".equals(this.getClass().getName()))
		{
	...
	native private void show_CCamera_ev_bool(long pNativeObject, long cam, boolean visible);
	public void show(com.earthview.world.graphic.Camera cam, boolean visible)
	{
		long camParamValue = (cam == null ? 0L : cam.nativeObject.pointer);
		boolean visibleParamValue = visible;
		show_CCamera_ev_bool(this.nativeObject.pointer, camParamValue, visibleParamValue);
	}
	native private void setTextStyle_CTextureTextStyle_CTextureTextStyle(long pNativeObject, long genericStyle, long tropicStyle);
	public void setTextStyle(com.earthview.world.graphic.TextureTextStyle genericStyle, com.earthview.world.graphic.TextureTextStyle tropicStyle)
	{
		long genericStyleParamValue = genericStyle.nativeObject.pointer;
		long tropicStyleParamValue = tropicStyle.nativeObject.pointer;
		setTextStyle_CTextureTextStyle_CTextureTextStyle(this.nativeObject.pointer, genericStyleParamValue, tropicStyleParamValue);
	}
	native private void getTextStyle_CTextureTextStyle_CTextureTextStyle(long pNativeObject, long genericStyle, long tropicStyle);
	public void getTextStyle(com.earthview.world.graphic.TextureTextStyle genericStyle, com.earthview.world.graphic.TextureTextStyle tropicStyle)
	{
		long genericStyleParamValue = genericStyle.nativeObject.pointer;
		long tropicStyleParamValue = tropicStyle.nativeObject.pointer;
		getTextStyle_CTextureTextStyle_CTextureTextStyle(this.nativeObject.pointer, genericStyleParamValue, tropicStyleParamValue);
	}
	native private void setGridColor_CColourValue_CColourValue(long pNativeObject, long genericColor, long tropicColor);
	public void setGridColor(com.earthview.world.graphic.ColourValue genericColor, com.earthview.world.graphic.ColourValue tropicColor)
	{
		long genericColorParamValue = genericColor.nativeObject.pointer;
		long tropicColorParamValue = tropicColor.nativeObject.pointer;
		setGridColor_CColourValue_CColourValue(this.nativeObject.pointer, genericColorParamValue, tropicColorParamValue);
	}
	native private void getGridColor_CColourValue_CColourValue(long pNativeObject, long genericColor, long tropicColor);
	public void getGridColor(com.earthview.world.graphic.ColourValue genericColor, com.earthview.world.graphic.ColourValue tropicColor)
	{
		long genericColorParamValue = genericColor.nativeObject.pointer;
		long tropicColorParamValue = tropicColor.nativeObject.pointer;
		getGridColor_CColourValue_CColourValue(this.nativeObject.pointer, genericColorParamValue, tropicColorParamValue);
	}
	...
	public GlobeGrid(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public GlobeGrid(CreatedWhenConstruct cwc, String classNameStr) {
	...
	{
		super.estimateVertexCount_NoVirtual(vcount);
	}
	/**
	...
	{
		super.estimateIndexCount_NoVirtual(icount);
	}
	/**
	...
	{
		super.beginUpdate_NoVirtual(sectionIndex);
	}
	/**
	 * 添加顶点位置信息，同时创建一个新的顶点
	 * @param pos 三维矢量
	...
	{
		super.position_NoVirtual(x, y, z);
	}
	/**
	 * 为当前顶点定义法线
	 * @param norm 三维矢量
	...
	{
		super.textureCoord_NoVirtual(u);
	}
	/**
	 * 为当前顶点添加纹理坐标根据需求，可以是一维到三维的
	 * @param u 
	...
	{
		super.textureCoord_NoVirtual(u, v);
	}
	/**
	 * 为当前顶点添加纹理坐标根据需求，可以是一维到三维的
	 * @param u 
	...
	{
		super.textureCoord_NoVirtual(u, v, w);
	}
	/**
	 * 为当前顶点添加纹理坐标根据需求，可以是一维到三维的
	 * @param x 
	...
	{
		super.textureCoord_NoVirtual(x, y, z, w);
	}
	/**
	 * 为当前顶点添加纹理坐标根据需求，可以是一维到三维的
	 * @param uv 二维矢量
	...
	{
		super.textureCoord_NoVirtual(uv);
	}
	/**
	 * 为当前顶点添加纹理坐标根据需求，可以是一维到三维的
	 * @param uvw 三维矢量
	...
	{
		super.textureCoord_NoVirtual(uvw);
	}
	/**
	 * 为当前顶点添加纹理坐标根据需求，可以是一维到三维的
	 * @param xyzw 四维矢量
	...
	{
		super.textureCoord_NoVirtual(xyzw);
	}
	/**
	 * 为顶点添加颜色
	 * @param col 颜色
	...
	{
		return super.getCurrentVertexCount_NoVirtual();
	}
	...
	public static GlobeGrid fromBaseObject(BaseObject baseObj)
	{
		...
		GlobeGrid obj = null;
 		if(baseObj instanceof GlobeGrid)
		{
			obj = (GlobeGrid)baseObj;
		} else {
