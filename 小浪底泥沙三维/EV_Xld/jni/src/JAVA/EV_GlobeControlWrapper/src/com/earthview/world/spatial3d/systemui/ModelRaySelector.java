 ...
 * 射线选择类三角面精确选择
 */
public class ModelRaySelector extends com.earthview.world.graphic.RaySceneQuery {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::SystemUI::CModelRaySelector", new ModelRaySelectorClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::SystemUI::JCModelRaySelectorProxy", new ModelRaySelectorClassFactory());
	}

	public ModelRaySelector(com.earthview.world.graphic.SceneManager ref_creator) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer ref_creatorPtr = new BasePointer(ref_creator);
		list.add("ref_creator", ref_creatorPtr.get());
		Create("JCModelRaySelectorProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.systemui.ModelRaySelector".equals(this.getClass().getName()))
		{
	...
	public ModelRaySelector(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ModelRaySelector(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ModelRaySelector fromBaseObject(BaseObject baseObj)
	{
		...
		ModelRaySelector obj = null;
 		if(baseObj instanceof ModelRaySelector)
		{
			obj = (ModelRaySelector)baseObj;
		} else {
