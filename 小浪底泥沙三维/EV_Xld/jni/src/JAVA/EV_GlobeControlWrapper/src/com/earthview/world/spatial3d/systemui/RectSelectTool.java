...
public class RectSelectTool extends com.earthview.world.spatial.systemui.Itool {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::SystemUI::CRectSelectTool", new RectSelectToolClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::SystemUI::JCRectSelectToolProxy", new RectSelectToolClassFactory());
	}
	 ...
	 */
	public RectSelectTool(com.earthview.world.spatial3d.controls.GlobeControl ref_ctrl) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer ref_ctrlPtr = new BasePointer(ref_ctrl);
		list.add("ref_ctrl", ref_ctrlPtr.get());
		Create("JCRectSelectToolProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.systemui.RectSelectTool".equals(this.getClass().getName()))
		{
	...
	native private void setLineColor_CColourValue(long pNativeObject, long color);
	/**
	 * 设置拉框的线颜色
	 * @param color 线颜色
	 */
	public void setLineColor(com.earthview.world.graphic.ColourValue color)
	{
		long colorParamValue = color.nativeObject.pointer;
		setLineColor_CColourValue(this.nativeObject.pointer, colorParamValue);
	}
	public RectSelectTool(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public RectSelectTool(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static RectSelectTool fromBaseObject(BaseObject baseObj)
	{
		...
		RectSelectTool obj = null;
 		if(baseObj instanceof RectSelectTool)
		{
			obj = (RectSelectTool)baseObj;
		} else {
