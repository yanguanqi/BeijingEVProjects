 ...
 * 区域范围渲染对象
 */
public class RegionAreaManualObject extends com.earthview.world.graphic.MovableObject {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::SystemUI::CRegionAreaManualObject", new RegionAreaManualObjectClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::SystemUI::JCRegionAreaManualObjectProxy", new RegionAreaManualObjectClassFactory());
	}

	public static class SubRenderable extends com.earthview.world.graphic.Renderable {
		
		static {
			GlobalClassFactoryMap.put("EarthView::World::Spatial3D::SystemUI::CRegionAreaManualObject::CSubRenderable", new SubRenderableClassFactory());
			GlobalClassFactoryMap.put("EarthView::World::Spatial3D::SystemUI::CRegionAreaManualObject::JCSubRenderableProxy", new SubRenderableClassFactory());
		}

		public SubRenderable(com.earthview.world.spatial3d.systemui.RegionAreaManualObject ref_pParent) {
			super(CreatedWhenConstruct.CWC_NotToCreate);
			NameValuePairList list = new NameValuePairList();
			BasePointer ref_pParentPtr = new BasePointer(ref_pParent);
			list.add("ref_pParent", ref_pParentPtr.get());
			Create("JCSubRenderableProxy", list, true);
			this.registerCallback();
			if (!"com.earthview.world.spatial3d.systemui.RegionAreaManualObject$SubRenderable".equals(this.getClass().getName()))
			{
		...
		public SubRenderable(CreatedWhenConstruct cwc) {
			super(CreatedWhenConstruct.CWC_NotToCreate);
		}
		public SubRenderable(CreatedWhenConstruct cwc, String classNameStr) {
		...
		public static SubRenderable fromBaseObject(BaseObject baseObj)
		{
			...
			SubRenderable obj = null;
 			if(baseObj instanceof SubRenderable)
			{
				obj = (SubRenderable)baseObj;
			} else {
	...
	public static class SubRenderableClassFactory implements IClassFactory {
	 ...
	 * @param name 对象名
	 */
	public RegionAreaManualObject(String name) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer namePtr = new BasePointer(name);
		list.add("name", namePtr.get());
		Create("JCRegionAreaManualObjectProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.systemui.RegionAreaManualObject".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
		}
	}

	native private void begin_EVString_OperationType(long pNativeObject, String materialName, int ro);
	/**
	 * 初始化
	 * @param materialName 材质名
	 * @param ro 渲染操作类型
	 */
	public void begin(String materialName, com.earthview.world.graphic.RenderOperation.OperationType ro)
	{
		String materialNameParamValue = materialName;
		int roParamValue = ro.getValue();
		begin_EVString_OperationType(this.nativeObject.pointer, materialNameParamValue, roParamValue);
	}
	...
	native private void addPoint_CVector3_CColourValue(long pNativeObject, long pos, long color);
	/**
	 * 添加点
	 * @param pos 点的世界坐标
	 * @param color 点的颜色
	 */
	public void addPoint(com.earthview.world.spatial.math.Vector3 pos, com.earthview.world.graphic.ColourValue color)
	{
		long posParamValue = pos.nativeObject.pointer;
		long colorParamValue = color.nativeObject.pointer;
		addPoint_CVector3_CColourValue(this.nativeObject.pointer, posParamValue, colorParamValue);
	}
	native private void addIndex_ev_uint32(long pNativeObject, long idx);
	/**
	 * 添加索引
	 * @param idx 点的索引
	 */
	public void addIndex(long idx)
	{
		...
		addIndex_ev_uint32(this.nativeObject.pointer, idxParamValue);
	}
	native private void setMaterial_EVString(long pNativeObject, String matName);
	/**
	 * 设置材质
	 ...
	 * 访问可渲染对象
	 * @param visitor 访问者
	 * @param debugRenderables 是否包含调试用可渲染对象
	 */
	...
	public RegionAreaManualObject(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public RegionAreaManualObject(CreatedWhenConstruct cwc, String classNameStr) {
		super(CreatedWhenConstruct.CWC_NotToCreate, classNameStr);
	}
	...
	public static RegionAreaManualObject fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		RegionAreaManualObject obj = null;
 		if(baseObj instanceof RegionAreaManualObject)
		{
			obj = (RegionAreaManualObject)baseObj;
		} else {
			obj = new RegionAreaManualObject(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CRegionAreaManualObject");
			obj.increaseCast();
		}
