 ...
 * 工具栏圆形选择类
 */
public class CommandSelectionByCircle3D extends com.earthview.world.spatial3d.controls.GlobeCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Controls::CCommandSelectionByCircle3D", new CommandSelectionByCircle3DClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Controls::JCCommandSelectionByCircle3DProxy", new CommandSelectionByCircle3DClassFactory());
	}
	 ...
	 * @param  
	 */
	public CommandSelectionByCircle3D() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandSelectionByCircle3DProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.controls.CommandSelectionByCircle3D".equals(this.getClass().getName()))
		{
	...
	public CommandSelectionByCircle3D(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandSelectionByCircle3D(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandSelectionByCircle3D fromBaseObject(BaseObject baseObj)
	{
		...
		CommandSelectionByCircle3D obj = null;
 		if(baseObj instanceof CommandSelectionByCircle3D)
		{
			obj = (CommandSelectionByCircle3D)baseObj;
		} else {
