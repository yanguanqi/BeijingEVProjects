 ...
 * 工具栏三角形选择类
 */
public class CommandSelectionByTrangle3D extends com.earthview.world.spatial3d.controls.GlobeCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Controls::CCommandSelectionByTrangle3D", new CommandSelectionByTrangle3DClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Controls::JCCommandSelectionByTrangle3DProxy", new CommandSelectionByTrangle3DClassFactory());
	}
	 ...
	 * @param  
	 */
	public CommandSelectionByTrangle3D() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandSelectionByTrangle3DProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.controls.CommandSelectionByTrangle3D".equals(this.getClass().getName()))
		{
	...
	public CommandSelectionByTrangle3D(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandSelectionByTrangle3D(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandSelectionByTrangle3D fromBaseObject(BaseObject baseObj)
	{
		...
		CommandSelectionByTrangle3D obj = null;
 		if(baseObj instanceof CommandSelectionByTrangle3D)
		{
			obj = (CommandSelectionByTrangle3D)baseObj;
		} else {
