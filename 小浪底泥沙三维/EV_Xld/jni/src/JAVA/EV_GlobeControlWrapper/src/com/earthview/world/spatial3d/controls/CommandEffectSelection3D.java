 ...
 * 显示特效库编辑素材命令
 */
public class CommandEffectSelection3D extends com.earthview.world.spatial3d.controls.GlobeCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Controls::CCommandEffectSelection3D", new CommandEffectSelection3DClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Controls::JCCommandEffectSelection3DProxy", new CommandEffectSelection3DClassFactory());
	}

	/**
	 * 默认构造函数
	 */
	public CommandEffectSelection3D() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandEffectSelection3DProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.controls.CommandEffectSelection3D".equals(this.getClass().getName()))
		{
	...
	public CommandEffectSelection3D(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandEffectSelection3D(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandEffectSelection3D fromBaseObject(BaseObject baseObj)
	{
		...
		CommandEffectSelection3D obj = null;
 		if(baseObj instanceof CommandEffectSelection3D)
		{
			obj = (CommandEffectSelection3D)baseObj;
		} else {
