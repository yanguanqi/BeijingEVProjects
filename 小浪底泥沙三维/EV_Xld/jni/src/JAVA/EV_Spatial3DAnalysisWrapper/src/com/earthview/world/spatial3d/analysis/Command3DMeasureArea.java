 ...
 * 面积测量
 */
public class Command3DMeasureArea extends com.earthview.world.spatial3d.controls.GlobeCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Analysis::CCommand3DMeasureArea", new Command3DMeasureAreaClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Analysis::JCCommand3DMeasureAreaProxy", new Command3DMeasureAreaClassFactory());
	}
	 ...
	 * @param  
	 */
	public Command3DMeasureArea() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommand3DMeasureAreaProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.analysis.Command3DMeasureArea".equals(this.getClass().getName()))
		{
	...
	public Command3DMeasureArea(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Command3DMeasureArea(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Command3DMeasureArea fromBaseObject(BaseObject baseObj)
	{
		...
		Command3DMeasureArea obj = null;
 		if(baseObj instanceof Command3DMeasureArea)
		{
			obj = (Command3DMeasureArea)baseObj;
		} else {
