 ...
 * 点位坐标
 */
public class Command3DMeasurePoint extends com.earthview.world.spatial3d.controls.GlobeCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Analysis::CCommand3DMeasurePoint", new Command3DMeasurePointClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Analysis::JCCommand3DMeasurePointProxy", new Command3DMeasurePointClassFactory());
	}
	 ...
	 * @param  
	 */
	public Command3DMeasurePoint() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommand3DMeasurePointProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.analysis.Command3DMeasurePoint".equals(this.getClass().getName()))
		{
	...
	public Command3DMeasurePoint(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Command3DMeasurePoint(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Command3DMeasurePoint fromBaseObject(BaseObject baseObj)
	{
		...
		Command3DMeasurePoint obj = null;
 		if(baseObj instanceof Command3DMeasurePoint)
		{
			obj = (Command3DMeasurePoint)baseObj;
		} else {
