...
public class Analysis3DMeasurePointParam extends com.earthview.world.core.StringInterface {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Analysis::CAnalysis3DMeasurePointParam", new Analysis3DMeasurePointParamClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Analysis::JCAnalysis3DMeasurePointParamProxy", new Analysis3DMeasurePointParamClassFactory());
	}

	/**
	 * 构造函数
	 */
	public Analysis3DMeasurePointParam(VoidPointer parent) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer parentPtr = new BasePointer(parent);
		list.add("parent", parentPtr.get());
		Create("JCAnalysis3DMeasurePointParamProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.analysis.Analysis3DMeasurePointParam".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
		}
	}

	native private void setLocationPoint_CVector3(long pNativeObject, long cen);
	/**
	 * 设置
	 * @param altitude 
	 */
	public void setLocationPoint(com.earthview.world.spatial.math.Vector3 cen)
	{
		long cenParamValue = cen.nativeObject.pointer;
		setLocationPoint_CVector3(this.nativeObject.pointer, cenParamValue);
	}
	...
	public Analysis3DMeasurePointParam(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Analysis3DMeasurePointParam(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Analysis3DMeasurePointParam fromBaseObject(BaseObject baseObj)
	{
		...
		Analysis3DMeasurePointParam obj = null;
 		if(baseObj instanceof Analysis3DMeasurePointParam)
		{
			obj = (Analysis3DMeasurePointParam)baseObj;
		} else {
