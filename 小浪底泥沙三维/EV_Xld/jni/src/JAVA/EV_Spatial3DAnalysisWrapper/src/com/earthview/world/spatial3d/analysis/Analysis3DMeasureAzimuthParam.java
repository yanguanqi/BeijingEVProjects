...
public class Analysis3DMeasureAzimuthParam extends com.earthview.world.core.StringInterface {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Analysis::CAnalysis3DMeasureAzimuthParam", new Analysis3DMeasureAzimuthParamClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Analysis::JCAnalysis3DMeasureAzimuthParamProxy", new Analysis3DMeasureAzimuthParamClassFactory());
	}

	/**
	 * 构造函数
	 */
	public Analysis3DMeasureAzimuthParam(VoidPointer parent) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer parentPtr = new BasePointer(parent);
		list.add("parent", parentPtr.get());
		Create("JCAnalysis3DMeasureAzimuthParamProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.analysis.Analysis3DMeasureAzimuthParam".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
		}
	}

	native private void setCurrentPoint_CVector3(long pNativeObject, long cen);
	/**
	 * 设置
	 * @param altitude 
	 */
	public void setCurrentPoint(com.earthview.world.spatial.math.Vector3 cen)
	{
		long cenParamValue = cen.nativeObject.pointer;
		setCurrentPoint_CVector3(this.nativeObject.pointer, cenParamValue);
	}
	native private long getCurrentPoint_void(long pNativeObject);
	/**
	 * 获取
	 * @param  
	 * @return 返回
	 */
	public com.earthview.world.spatial.math.Vector3 getCurrentPoint()
	{
		long returnValue = getCurrentPoint_void(this.nativeObject.pointer);
	...
	public Analysis3DMeasureAzimuthParam(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Analysis3DMeasureAzimuthParam(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Analysis3DMeasureAzimuthParam fromBaseObject(BaseObject baseObj)
	{
		...
		Analysis3DMeasureAzimuthParam obj = null;
 		if(baseObj instanceof Analysis3DMeasureAzimuthParam)
		{
			obj = (Analysis3DMeasureAzimuthParam)baseObj;
		} else {
