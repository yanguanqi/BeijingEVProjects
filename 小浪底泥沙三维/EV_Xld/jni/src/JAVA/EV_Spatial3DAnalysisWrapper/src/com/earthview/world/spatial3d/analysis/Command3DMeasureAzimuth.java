 ...
 * 方位角测量
 */
public class Command3DMeasureAzimuth extends com.earthview.world.spatial3d.controls.GlobeCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Analysis::CCommand3DMeasureAzimuth", new Command3DMeasureAzimuthClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Analysis::JCCommand3DMeasureAzimuthProxy", new Command3DMeasureAzimuthClassFactory());
	}
	 ...
	 * @param  
	 */
	public Command3DMeasureAzimuth() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommand3DMeasureAzimuthProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.analysis.Command3DMeasureAzimuth".equals(this.getClass().getName()))
		{
	...
	public Command3DMeasureAzimuth(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Command3DMeasureAzimuth(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Command3DMeasureAzimuth fromBaseObject(BaseObject baseObj)
	{
		...
		Command3DMeasureAzimuth obj = null;
 		if(baseObj instanceof Command3DMeasureAzimuth)
		{
			obj = (Command3DMeasureAzimuth)baseObj;
		} else {
