 ...
 * 土方分析类
 */
public class Analysis3DVolume extends com.earthview.world.spatial3d.analysis.Ianalysis3dtool {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Analysis::CAnalysis3DVolume", new Analysis3DVolumeClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Analysis::JCAnalysis3DVolumeProxy", new Analysis3DVolumeClassFactory());
	}
	 ...
	 */
	public Analysis3DVolume(com.earthview.world.spatial3d.controls.GlobeControl ref_pGlobeControl) {
		...
		Create("JCAnalysis3DVolumeProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.analysis.Analysis3DVolume".equals(this.getClass().getName()))
		{
	 ...
	 */
	public Analysis3DVolume(com.earthview.world.graphic.SceneManager ref_pSceneMgr) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
	 ...
	 */
	public Analysis3DVolume(com.earthview.world.spatial3d.atlas.Iterrainlayer ref_pTerrainLayer) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
	...
	native private void setVolumeUnit_VolumeUnit(long pNativeObject, int volumeUnit);
	/**
	 * 设置最后结果显示的单位
	 */
	public void setVolumeUnit(com.earthview.world.spatial3d.analysis.VolumeUnit volumeUnit)
	{
		int volumeUnitParamValue = volumeUnit.getValue();
		setVolumeUnit_VolumeUnit(this.nativeObject.pointer, volumeUnitParamValue);
	}
	...
	native private double getGroundArea_void(long pNativeObject);
	/**
	 * 获取贴地面积
	 * @return 贴地面积
	 */
	...
	{
		double returnValue = getGroundArea_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private double getDigVolume_void(long pNativeObject);
	/**
	 * 获取挖方体积
	 * @return 挖方体积
	 */
	...
	{
		double returnValue = getDigVolume_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private double getFillVolume_void(long pNativeObject);
	/**
	 * 获取填方体积
	 * @return 填方体积
	 */
	...
	{
		double returnValue = getFillVolume_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private double getDifference_void(long pNativeObject);
	/**
	 * 获取填方体积与挖方体积差值的绝对值
	 * @return 填方体积与挖方体积差值的绝对值
	 */
	public double getDifference()
	{
		double returnValue = getDifference_void(this.nativeObject.pointer);
		return returnValue;
	}
	...
	public Analysis3DVolume(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Analysis3DVolume(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Analysis3DVolume fromBaseObject(BaseObject baseObj)
	{
		...
		Analysis3DVolume obj = null;
 		if(baseObj instanceof Analysis3DVolume)
		{
			obj = (Analysis3DVolume)baseObj;
		} else {
