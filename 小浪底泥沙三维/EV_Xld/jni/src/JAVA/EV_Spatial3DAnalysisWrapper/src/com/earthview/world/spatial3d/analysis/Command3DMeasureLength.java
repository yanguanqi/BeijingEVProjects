 ...
 * 距离测量
 */
public class Command3DMeasureLength extends com.earthview.world.spatial3d.controls.GlobeCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Analysis::CCommand3DMeasureLength", new Command3DMeasureLengthClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Analysis::JCCommand3DMeasureLengthProxy", new Command3DMeasureLengthClassFactory());
	}
	 ...
	 * @param  
	 */
	public Command3DMeasureLength() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommand3DMeasureLengthProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.analysis.Command3DMeasureLength".equals(this.getClass().getName()))
		{
	...
	public Command3DMeasureLength(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Command3DMeasureLength(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Command3DMeasureLength fromBaseObject(BaseObject baseObj)
	{
		...
		Command3DMeasureLength obj = null;
 		if(baseObj instanceof Command3DMeasureLength)
		{
			obj = (Command3DMeasureLength)baseObj;
		} else {
