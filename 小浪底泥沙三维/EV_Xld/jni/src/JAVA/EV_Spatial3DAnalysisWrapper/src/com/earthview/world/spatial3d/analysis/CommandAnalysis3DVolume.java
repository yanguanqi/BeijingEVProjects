 ...
 * 工具栏土方分析类
 */
public class CommandAnalysis3DVolume extends com.earthview.world.spatial3d.controls.GlobeCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Analysis::CCommandAnalysis3DVolume", new CommandAnalysis3DVolumeClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Analysis::JCCommandAnalysis3DVolumeProxy", new CommandAnalysis3DVolumeClassFactory());
	}
	 ...
	 * @param  
	 */
	public CommandAnalysis3DVolume() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandAnalysis3DVolumeProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.analysis.CommandAnalysis3DVolume".equals(this.getClass().getName()))
		{
	...
	public CommandAnalysis3DVolume(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandAnalysis3DVolume(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandAnalysis3DVolume fromBaseObject(BaseObject baseObj)
	{
		...
		CommandAnalysis3DVolume obj = null;
 		if(baseObj instanceof CommandAnalysis3DVolume)
		{
			obj = (CommandAnalysis3DVolume)baseObj;
		} else {
