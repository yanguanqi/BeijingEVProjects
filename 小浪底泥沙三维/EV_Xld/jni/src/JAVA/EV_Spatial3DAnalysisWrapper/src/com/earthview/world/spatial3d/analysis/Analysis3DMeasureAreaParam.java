...
public class Analysis3DMeasureAreaParam extends com.earthview.world.core.StringInterface {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Analysis::CAnalysis3DMeasureAreaParam", new Analysis3DMeasureAreaParamClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Analysis::JCAnalysis3DMeasureAreaParamProxy", new Analysis3DMeasureAreaParamClassFactory());
	}

	/**
	 * 构造函数
	 */
	public Analysis3DMeasureAreaParam(VoidPointer parent) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer parentPtr = new BasePointer(parent);
		list.add("parent", parentPtr.get());
		Create("JCAnalysis3DMeasureAreaParamProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.analysis.Analysis3DMeasureAreaParam".equals(this.getClass().getName()))
		{
	...
	public Analysis3DMeasureAreaParam(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Analysis3DMeasureAreaParam(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Analysis3DMeasureAreaParam fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		Analysis3DMeasureAreaParam obj = null;
 		if(baseObj instanceof Analysis3DMeasureAreaParam)
		{
			obj = (Analysis3DMeasureAreaParam)baseObj;
		} else {
			obj = new Analysis3DMeasureAreaParam(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CAnalysis3DMeasureAreaParam");
			obj.increaseCast();
		}
