 ...
 * 坡度分析类
 */
public class Analysis3DSlope extends com.earthview.world.spatial3d.analysis.Ianalysis3dtool {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Analysis::CAnalysis3DSlope", new Analysis3DSlopeClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Analysis::JCAnalysis3DSlopeProxy", new Analysis3DSlopeClassFactory());
	}
	 ...
	 */
	public Analysis3DSlope(com.earthview.world.spatial3d.controls.GlobeControl ref_pGlobeControl) {
		...
		Create("JCAnalysis3DSlopeProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.analysis.Analysis3DSlope".equals(this.getClass().getName()))
		{
	 ...
	 */
	public Analysis3DSlope(com.earthview.world.graphic.SceneManager ref_pSceneMgr) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
	 ...
	 */
	public Analysis3DSlope(com.earthview.world.spatial3d.atlas.Iterrainlayer ref_pTerrainLayer) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
	...
	native private long getDivisions_void(long pNativeObject);
	/**
	 * 获取坡度级别
	 * @param  
	 * @return 级别数组
	 */
	public com.earthview.world.core.RealVector getDivisions()
	{
		long returnValue = getDivisions_void(this.nativeObject.pointer);
	...
	native private void setDivisions_RealVector(long pNativeObject, long divisions);
	/**
	 * 设置坡度级别
	 * @param divisions 级别数组
	 */
	public void setDivisions(com.earthview.world.core.RealVector divisions)
	{
		long divisionsParamValue = divisions.nativeObject.pointer;
		setDivisions_RealVector(this.nativeObject.pointer, divisionsParamValue);
	}
	native private long getSlopeColor_ev_uint32(long pNativeObject, long grade);
	/**
	 * 获取指定级别坡度颜色
	 * @param grade 坡度级别
	 * @return 指定级别坡度的颜色
	 */
	public com.earthview.world.graphic.ColourValue getSlopeColor(long grade)
	{
		long gradeParamValue = grade;
		long returnValue = getSlopeColor_ev_uint32(this.nativeObject.pointer, gradeParamValue);
	...
	native private void setSlopeColor_ev_uint32_CColourValue(long pNativeObject, long grade, long color);
	/**
	 * 设置指定级别坡度的颜色
	 * @param grade 坡度级别
	 * @param color 指定级别坡度的颜色
	 */
	public void setSlopeColor(long grade, com.earthview.world.graphic.ColourValue color)
	{
		long gradeParamValue = grade;
		long colorParamValue = color.nativeObject.pointer;
		setSlopeColor_ev_uint32_CColourValue(this.nativeObject.pointer, gradeParamValue, colorParamValue);
	}
	native private boolean isSlopeLayerShow_void(long pNativeObject);
	/**
	 * 获取坡度图层是否显示
	 * @return 是否显示坡度图层
	 */
	public boolean isSlopeLayerShow()
	{
		boolean returnValue = isSlopeLayerShow_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private void showSlopeLayer_ev_bool(long pNativeObject, boolean value);
	/**
	 * 设置坡度图层是否显示
	 * @param value 是否显示坡度图层
	 */
	public void showSlopeLayer(boolean value)
	{
		boolean valueParamValue = value;
		showSlopeLayer_ev_bool(this.nativeObject.pointer, valueParamValue);
	}
	native private boolean isAspectLayerShow_void(long pNativeObject);
	/**
	 * 获取坡向图层是否显示
	 * @return 是否显示坡向图层
	 */
	public boolean isAspectLayerShow()
	{
		boolean returnValue = isAspectLayerShow_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private void showAspectLayer_ev_bool(long pNativeObject, boolean value);
	/**
	 * 设置坡向图层是否显示
	 * @param value 是否显示坡向图层
	 */
	public void showAspectLayer(boolean value)
	{
		boolean valueParamValue = value;
		showAspectLayer_ev_bool(this.nativeObject.pointer, valueParamValue);
	}
	...
	public Analysis3DSlope(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Analysis3DSlope(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Analysis3DSlope fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		Analysis3DSlope obj = null;
 		if(baseObj instanceof Analysis3DSlope)
		{
			obj = (Analysis3DSlope)baseObj;
		} else {
			obj = new Analysis3DSlope(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CAnalysis3DSlope");
			obj.increaseCast();
		}
