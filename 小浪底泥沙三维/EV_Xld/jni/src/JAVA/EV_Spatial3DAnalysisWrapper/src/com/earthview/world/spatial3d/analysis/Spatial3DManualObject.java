 ...
 * 三维分析渲染对象
 */
public class Spatial3DManualObject extends com.earthview.world.graphic.MovableObject {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Analysis::CSpatial3DManualObject", new Spatial3DManualObjectClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Analysis::JCSpatial3DManualObjectProxy", new Spatial3DManualObjectClassFactory());
	}

	public static class SubRenderable extends com.earthview.world.graphic.Renderable {
		
		static {
			GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Analysis::CSpatial3DManualObject::CSubRenderable", new SubRenderableClassFactory());
			GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Analysis::CSpatial3DManualObject::JCSubRenderableProxy", new SubRenderableClassFactory());
		}

		/**
		 * 构造函数
		 * @param ref_pParent 父对象
		 */
		public SubRenderable(com.earthview.world.spatial3d.analysis.Spatial3DManualObject ref_pParent) {
			...
			if (!"com.earthview.world.spatial3d.analysis.Spatial3DManualObject$SubRenderable".equals(this.getClass().getName()))
			{
	 ...
	 * @param name 名称
	 */
	public Spatial3DManualObject(String name) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer namePtr = new BasePointer(name);
		list.add("name", namePtr.get());
		Create("JCSpatial3DManualObjectProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.analysis.Spatial3DManualObject".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
		}
	}
	...
	public Spatial3DManualObject(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Spatial3DManualObject(CreatedWhenConstruct cwc, String classNameStr) {
		super(CreatedWhenConstruct.CWC_NotToCreate, classNameStr);
	}
	...
	public static Spatial3DManualObject fromBaseObject(BaseObject baseObj)
	{
		...
		Spatial3DManualObject obj = null;
 		if(baseObj instanceof Spatial3DManualObject)
		{
			obj = (Spatial3DManualObject)baseObj;
		} else {
