 ...
 * 高度测量类定义了高度测量的所有操作
 */
public class Analysis3DMeasureHeight extends com.earthview.world.spatial3d.analysis.Ianalysis3dtool {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Analysis::CAnalysis3DMeasureHeight", new Analysis3DMeasureHeightClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Analysis::JCAnalysis3DMeasureHeightProxy", new Analysis3DMeasureHeightClassFactory());
	}
	 ...
	 */
	public Analysis3DMeasureHeight(com.earthview.world.spatial3d.controls.GlobeControl ref_pGlobeControl) {
		...
		Create("JCAnalysis3DMeasureHeightProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.analysis.Analysis3DMeasureHeight".equals(this.getClass().getName()))
		{
	 ...
	 */
	public Analysis3DMeasureHeight(com.earthview.world.graphic.SceneManager ref_pSceneMgr) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
	 ...
	 */
	public Analysis3DMeasureHeight(com.earthview.world.spatial3d.atlas.Iterrainlayer ref_pTerrainLayer) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
	 ...
	 * @return 高度测量方式
	 */
	public com.earthview.world.spatial3d.analysis.HeightCalcuStyle getCalcuStyle()
	{
		int returnValue = getCalcuStyle_void(this.nativeObject.pointer);
		return com.earthview.world.spatial3d.analysis.HeightCalcuStyle.toEnum(returnValue);
	}
	native private void setCalcuStyle_HeightCalcuStyle(long pNativeObject, int value);
	/**
	 * 设置高度测量方式
	 * @param value 高度测量方式
	 */
	public void setCalcuStyle(com.earthview.world.spatial3d.analysis.HeightCalcuStyle value)
	{
		int valueParamValue = value.getValue();
		setCalcuStyle_HeightCalcuStyle(this.nativeObject.pointer, valueParamValue);
	}
	 ...
	 * 获取终止点位置
	 * @param  
	 * @return 终止点（HCS_Vertical方式为屏幕像素坐标，HCS_Difference方式为地理极坐标）
	 */
	...
	native private double getVerticalDistance_void(long pNativeObject);
	/**
	 * 获取高度值
	 * @param  
	 * @return 高度值
	...
	{
		double returnValue = getVerticalDistance_void(this.nativeObject.pointer);
		return returnValue;
	}
	...
	public Analysis3DMeasureHeight(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Analysis3DMeasureHeight(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Analysis3DMeasureHeight fromBaseObject(BaseObject baseObj)
	{
		...
		Analysis3DMeasureHeight obj = null;
 		if(baseObj instanceof Analysis3DMeasureHeight)
		{
			obj = (Analysis3DMeasureHeight)baseObj;
		} else {
