 ...
 * 工具栏淹没分析类
 */
public class CommandAnalysis3DRegionFlood extends com.earthview.world.spatial3d.controls.GlobeCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Analysis::CCommandAnalysis3DRegionFlood", new CommandAnalysis3DRegionFloodClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Analysis::JCCommandAnalysis3DRegionFloodProxy", new CommandAnalysis3DRegionFloodClassFactory());
	}
	 ...
	 * @param  
	 */
	public CommandAnalysis3DRegionFlood() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandAnalysis3DRegionFloodProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.analysis.CommandAnalysis3DRegionFlood".equals(this.getClass().getName()))
		{
	...
	public CommandAnalysis3DRegionFlood(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandAnalysis3DRegionFlood(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandAnalysis3DRegionFlood fromBaseObject(BaseObject baseObj)
	{
		...
		CommandAnalysis3DRegionFlood obj = null;
 		if(baseObj instanceof CommandAnalysis3DRegionFlood)
		{
			obj = (CommandAnalysis3DRegionFlood)baseObj;
		} else {
