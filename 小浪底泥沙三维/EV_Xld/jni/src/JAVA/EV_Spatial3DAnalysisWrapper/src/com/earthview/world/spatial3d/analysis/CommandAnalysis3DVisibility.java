 ...
 * 工具栏通视分析类
 */
public class CommandAnalysis3DVisibility extends com.earthview.world.spatial3d.controls.GlobeCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Analysis::CCommandAnalysis3DVisibility", new CommandAnalysis3DVisibilityClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Analysis::JCCommandAnalysis3DVisibilityProxy", new CommandAnalysis3DVisibilityClassFactory());
	}
	 ...
	 * @param  
	 */
	public CommandAnalysis3DVisibility() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandAnalysis3DVisibilityProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.analysis.CommandAnalysis3DVisibility".equals(this.getClass().getName()))
		{
	...
	public CommandAnalysis3DVisibility(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandAnalysis3DVisibility(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandAnalysis3DVisibility fromBaseObject(BaseObject baseObj)
	{
		...
		CommandAnalysis3DVisibility obj = null;
 		if(baseObj instanceof CommandAnalysis3DVisibility)
		{
			obj = (CommandAnalysis3DVisibility)baseObj;
		} else {
