...
public class Analysis3DMeasureLengthParam extends com.earthview.world.core.StringInterface {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Analysis::CAnalysis3DMeasureLengthParam", new Analysis3DMeasureLengthParamClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Analysis::JCAnalysis3DMeasureLengthParamProxy", new Analysis3DMeasureLengthParamClassFactory());
	}

	/**
	 * 构造函数
	 */
	public Analysis3DMeasureLengthParam(VoidPointer parent) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer parentPtr = new BasePointer(parent);
		list.add("parent", parentPtr.get());
		Create("JCAnalysis3DMeasureLengthParamProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.analysis.Analysis3DMeasureLengthParam".equals(this.getClass().getName()))
		{
	...
	public Analysis3DMeasureLengthParam(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Analysis3DMeasureLengthParam(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Analysis3DMeasureLengthParam fromBaseObject(BaseObject baseObj)
	{
		...
		Analysis3DMeasureLengthParam obj = null;
 		if(baseObj instanceof Analysis3DMeasureLengthParam)
		{
			obj = (Analysis3DMeasureLengthParam)baseObj;
		} else {
