 ...
 * 面积测量类定义了面积测量的所有操作
 */
public class Analysis3DMeasureArea extends com.earthview.world.spatial3d.analysis.Ianalysis3dtool {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Analysis::CAnalysis3DMeasureArea", new Analysis3DMeasureAreaClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Analysis::JCAnalysis3DMeasureAreaProxy", new Analysis3DMeasureAreaClassFactory());
	}
	 ...
	 */
	public Analysis3DMeasureArea(com.earthview.world.spatial3d.controls.GlobeControl ref_pGlobeControl) {
		...
		Create("JCAnalysis3DMeasureAreaProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.analysis.Analysis3DMeasureArea".equals(this.getClass().getName()))
		{
	 ...
	 */
	public Analysis3DMeasureArea(com.earthview.world.graphic.SceneManager ref_pSceneMgr) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
	 ...
	 */
	public Analysis3DMeasureArea(com.earthview.world.spatial3d.atlas.Iterrainlayer ref_pTerrainLayer) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
	 ...
	 * 获取面积测量方式
	 */
	public com.earthview.world.spatial3d.analysis.AreaMeasureStyle getCalcuStyle()
	{
		int returnValue = getCalcuStyle_void(this.nativeObject.pointer);
		return com.earthview.world.spatial3d.analysis.AreaMeasureStyle.toEnum(returnValue);
	}
	native private void setCalcuStyle_AreaMeasureStyle(long pNativeObject, int value);
	/**
	 * 设置面积测量方式
	 */
	public void setCalcuStyle(com.earthview.world.spatial3d.analysis.AreaMeasureStyle value)
	{
		int valueParamValue = value.getValue();
		setCalcuStyle_AreaMeasureStyle(this.nativeObject.pointer, valueParamValue);
	}
	native private void setAreaUnit_AreaUnit(long pNativeObject, int areaUnit);
	/**
	 * 设置最后结果显示的单位
	 */
	public void setAreaUnit(com.earthview.world.spatial3d.analysis.AreaUnit areaUnit)
	{
		int areaUnitParamValue = areaUnit.getValue();
		setAreaUnit_AreaUnit(this.nativeObject.pointer, areaUnitParamValue);
	}
	native private double getClampedArea_void(long pNativeObject);
	/**
	 * 获取贴地面积
	 * @param  
	 * @return 贴地面积
	...
	{
		double returnValue = getClampedArea_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private double getProjectArea_void(long pNativeObject);
	/**
	 * 获取投影面积
	 * @param  
	 * @return 投影面积
	...
	{
		double returnValue = getProjectArea_void(this.nativeObject.pointer);
		return returnValue;
	}
	...
	public Analysis3DMeasureArea(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Analysis3DMeasureArea(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Analysis3DMeasureArea fromBaseObject(BaseObject baseObj)
	{
		...
		Analysis3DMeasureArea obj = null;
 		if(baseObj instanceof Analysis3DMeasureArea)
		{
			obj = (Analysis3DMeasureArea)baseObj;
		} else {
