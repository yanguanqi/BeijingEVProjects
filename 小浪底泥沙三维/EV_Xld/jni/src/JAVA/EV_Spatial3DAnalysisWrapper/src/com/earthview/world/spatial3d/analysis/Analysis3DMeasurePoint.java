 ...
 * 点测量类定义了点测量的所有操作
 */
public class Analysis3DMeasurePoint extends com.earthview.world.spatial3d.analysis.Ianalysis3dtool {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Analysis::CAnalysis3DMeasurePoint", new Analysis3DMeasurePointClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Analysis::JCAnalysis3DMeasurePointProxy", new Analysis3DMeasurePointClassFactory());
	}
	 ...
	 */
	public Analysis3DMeasurePoint(com.earthview.world.spatial3d.controls.GlobeControl ref_pGlobeControl) {
		...
		Create("JCAnalysis3DMeasurePointProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.analysis.Analysis3DMeasurePoint".equals(this.getClass().getName()))
		{
	 ...
	 */
	public Analysis3DMeasurePoint(com.earthview.world.graphic.SceneManager ref_pSceneMgr) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
	 ...
	 */
	public Analysis3DMeasurePoint(com.earthview.world.spatial3d.atlas.Iterrainlayer ref_pTerrainLayer) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
	...
	native private long getLocationPoint_void(long pNativeObject);
	/**
	 * 获取测量点坐标
	 * @param  
	 * @return 测量点坐标（经度、纬度、高程）
	 */
	public com.earthview.world.spatial.math.Vector3 getLocationPoint()
	{
		long returnValue = getLocationPoint_void(this.nativeObject.pointer);
	...
	native private void setLocationPoint_CVector3(long pNativeObject, long pt);
	/**
	 * 设置测量点坐标
	 * @param pt 测量点坐标（经度、纬度、高程）
	 */
	public void setLocationPoint(com.earthview.world.spatial.math.Vector3 pt)
	{
		long ptParamValue = pt.nativeObject.pointer;
		setLocationPoint_CVector3(this.nativeObject.pointer, ptParamValue);
	}
	...
	public Analysis3DMeasurePoint(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Analysis3DMeasurePoint(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Analysis3DMeasurePoint fromBaseObject(BaseObject baseObj)
	{
		...
		Analysis3DMeasurePoint obj = null;
 		if(baseObj instanceof Analysis3DMeasurePoint)
		{
			obj = (Analysis3DMeasurePoint)baseObj;
		} else {
