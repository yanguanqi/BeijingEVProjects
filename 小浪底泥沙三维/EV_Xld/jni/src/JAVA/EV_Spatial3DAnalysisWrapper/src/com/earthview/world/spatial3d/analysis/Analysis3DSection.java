 ...
 * 断面分析类定义了断面分析的所有操作
 */
public class Analysis3DSection extends com.earthview.world.spatial3d.analysis.Ianalysis3dtool {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Analysis::CAnalysis3DSection", new Analysis3DSectionClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Analysis::JCAnalysis3DSectionProxy", new Analysis3DSectionClassFactory());
	}
	 ...
	 */
	public Analysis3DSection(com.earthview.world.spatial3d.controls.GlobeControl ref_pGlobeControl) {
		...
		Create("JCAnalysis3DSectionProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.analysis.Analysis3DSection".equals(this.getClass().getName()))
		{
	 ...
	 */
	public Analysis3DSection(com.earthview.world.graphic.SceneManager ref_pSceneMgr) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
	 ...
	 */
	public Analysis3DSection(com.earthview.world.spatial3d.atlas.Iterrainlayer ref_pTerrainLayer) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
	...
	native private boolean getAltitudeVisible_void(long pNativeObject);
	/**
	 * 获取高程节点及字体是否可见
	 * @param visible 是否可见
	 */
	public boolean getAltitudeVisible()
	{
		boolean returnValue = getAltitudeVisible_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private void setAltitudeVisible_ev_bool(long pNativeObject, boolean visible);
	/**
	 * 设置高程节点及字体是否可见
	 * @param visible 是否可见
	 */
	public void setAltitudeVisible(boolean visible)
	{
		boolean visibleParamValue = visible;
		setAltitudeVisible_ev_bool(this.nativeObject.pointer, visibleParamValue);
	}
	native private boolean getSlopeVisible_void(long pNativeObject);
	/**
	 * 获取坡度节点及字体是否可见
	 * @param visible 是否可见
	 */
	public boolean getSlopeVisible()
	{
		boolean returnValue = getSlopeVisible_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private void setSlopeVisible_ev_bool(long pNativeObject, boolean visible);
	/**
	 * 设置坡度节点及字体是否可见
	 * @param visible 是否可见
	 */
	public void setSlopeVisible(boolean visible)
	{
		boolean visibleParamValue = visible;
		setSlopeVisible_ev_bool(this.nativeObject.pointer, visibleParamValue);
	}
	native private void setHighOrLowDetail_ev_bool(long pNativeObject, boolean detail);
	/**
	 * 控制断面分析结果信息精确程度true:根据用户设置的采样间隔距离，保存全部的采样点地理坐标及坡度值，有可能占用较大内存false:保存较为适合数量的采样点地理坐标及坡度值，不会影响断面分析结果信息中的其它信息
	 * @param detail 控制断面分析结果信息精确程度，默认值为false
	 */
	public void setHighOrLowDetail(boolean detail)
	{
		boolean detailParamValue = detail;
		setHighOrLowDetail_ev_bool(this.nativeObject.pointer, detailParamValue);
	}
	...
	native private double getMaxAltitude_void(long pNativeObject);
	/**
	 * 获取最大高程
	 * @return 最大高程
	 */
	...
	{
		double returnValue = getMaxAltitude_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private double getMinAltitude_void(long pNativeObject);
	/**
	 * 获取最小高程
	 * @return 最小高程
	 */
	...
	{
		double returnValue = getMinAltitude_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private double getMaxSlope_void(long pNativeObject);
	/**
	 * 获取最大坡度
	 * @return 最大坡度
	 */
	...
	{
		double returnValue = getMaxSlope_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private double getMinSlope_void(long pNativeObject);
	/**
	 * 获取最小坡度
	 * @return 最小坡度
	 */
	...
	{
		double returnValue = getMinSlope_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private long getSectionInfo_void(long pNativeObject);
	/**
	 * 获取断面分析结果信息
	 * @return 断面分析结果信息指针
	 */
	public com.earthview.world.spatial3d.analysis.SectionLineInfo getSectionInfo()
	{
		long returnValue = getSectionInfo_void(this.nativeObject.pointer);
		if(returnValue == 0L) {
			return null;
		}
		com.earthview.world.spatial3d.analysis.SectionLineInfo __returnValue = new com.earthview.world.spatial3d.analysis.SectionLineInfo(CreatedWhenConstruct.CWC_NotToCreate, "CSectionLineInfo");
		__returnValue.setDelegate(true);
		InstancePointer __instancePointer = new InstancePointer(returnValue);
		...
		{
			__returnValue.setDelegate(true);
			__returnValue = (com.earthview.world.spatial3d.analysis.SectionLineInfo)__returnValueClassFactory.create();
			__returnValue.setDelegate(true);
			__returnValue.bindNativeObject(__instancePointer, "CSectionLineInfo");
		}
		return __returnValue;
	}
	native private long ToBitmapStreamPtr_ev_int32_ev_int32_ev_bool(long pNativeObject, int width, int height, boolean onlyCoordinate);
	/**
	 * 根据断面分析结果生成位图
	 * @param width 位图宽度
	 * @param height 位图高度
	 * @param onlyCoordinate 是否只有坐标
	 * @return 数据流指针
	 */
	public com.earthview.world.core.MemoryDataStreamPtr ToBitmapStreamPtr(int width, int height, boolean onlyCoordinate)
	{
		int widthParamValue = width;
		int heightParamValue = height;
		boolean onlyCoordinateParamValue = onlyCoordinate;
		long returnValue = ToBitmapStreamPtr_ev_int32_ev_int32_ev_bool(this.nativeObject.pointer, widthParamValue, heightParamValue, onlyCoordinateParamValue);
	...
	public Analysis3DSection(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Analysis3DSection(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Analysis3DSection fromBaseObject(BaseObject baseObj)
	{
		...
		Analysis3DSection obj = null;
 		if(baseObj instanceof Analysis3DSection)
		{
			obj = (Analysis3DSection)baseObj;
		} else {
