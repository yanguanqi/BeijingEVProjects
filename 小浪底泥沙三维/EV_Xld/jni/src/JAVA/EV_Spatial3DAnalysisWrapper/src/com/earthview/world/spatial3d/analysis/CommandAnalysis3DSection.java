 ...
 * 工具栏断面分析类
 */
public class CommandAnalysis3DSection extends com.earthview.world.spatial3d.controls.GlobeCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Analysis::CCommandAnalysis3DSection", new CommandAnalysis3DSectionClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Analysis::JCCommandAnalysis3DSectionProxy", new CommandAnalysis3DSectionClassFactory());
	}
	 ...
	 * @param  
	 */
	public CommandAnalysis3DSection() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandAnalysis3DSectionProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.analysis.CommandAnalysis3DSection".equals(this.getClass().getName()))
		{
	...
	public CommandAnalysis3DSection(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandAnalysis3DSection(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandAnalysis3DSection fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		CommandAnalysis3DSection obj = null;
 		if(baseObj instanceof CommandAnalysis3DSection)
		{
			obj = (CommandAnalysis3DSection)baseObj;
		} else {
			obj = new CommandAnalysis3DSection(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CCommandAnalysis3DSection");
			obj.increaseCast();
		}
