 ...
 * 工具栏通视分析类
 */
public class CommandAnalysis3DSkyline extends com.earthview.world.spatial3d.controls.GlobeCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Analysis::CCommandAnalysis3DSkyline", new CommandAnalysis3DSkylineClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Analysis::JCCommandAnalysis3DSkylineProxy", new CommandAnalysis3DSkylineClassFactory());
	}
	 ...
	 * @param  
	 */
	public CommandAnalysis3DSkyline() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandAnalysis3DSkylineProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.analysis.CommandAnalysis3DSkyline".equals(this.getClass().getName()))
		{
	...
	public CommandAnalysis3DSkyline(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandAnalysis3DSkyline(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandAnalysis3DSkyline fromBaseObject(BaseObject baseObj)
	{
		...
		CommandAnalysis3DSkyline obj = null;
 		if(baseObj instanceof CommandAnalysis3DSkyline)
		{
			obj = (CommandAnalysis3DSkyline)baseObj;
		} else {
