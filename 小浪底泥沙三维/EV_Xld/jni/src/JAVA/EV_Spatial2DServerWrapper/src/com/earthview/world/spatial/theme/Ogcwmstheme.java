 ...
 * WMSÕº≤„ƒ¨»œ◊®Ã‚Õº◊®Ã‚Õº¿‡
 */
public class Ogcwmstheme extends com.earthview.world.spatial.theme.Itheme {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Theme::COGCWMSTheme", new OgcwmsthemeClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Theme::JCOGCWMSThemeProxy", new OgcwmsthemeClassFactory());
	}

	public enum EVOGCWMSRequestType implements INativeEnum<EVOGCWMSRequestType> {
		RT_RequestByMap(EVOGCWMSRequestTypeHelper.ENUM_VALUES[0]),
		RT_RequestByTile(EVOGCWMSRequestTypeHelper.ENUM_VALUES[1]);
		private int value;
		EVOGCWMSRequestType(int i) {
			this.value = i;
		}
		public EVOGCWMSRequestType getEnum(int val) {
			return toEnum(val);
		}
		public int getValue() {
			return this.value;
		}
		public static final EVOGCWMSRequestType toEnum(int retval) {
			if(retval == RT_RequestByMap.value){
				return RT_RequestByMap;
			}
			else if(retval == RT_RequestByTile.value){
				return RT_RequestByTile;
			}
			throw new RuntimeException("wrong number in jni call for an enum!");
		}
	}
	static class EVOGCWMSRequestTypeHelper {
	...
	public Ogcwmstheme() {
		...
		Create("JCOGCWMSThemeProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.theme.Ogcwmstheme".equals(this.getClass().getName()))
		{
	...
	protected  void setRequestType_EVOGCWMSRequestType_callback(int requestType)
	{
		com.earthview.world.spatial.theme.Ogcwmstheme.EVOGCWMSRequestType requestTypeParamValue = com.earthview.world.spatial.theme.Ogcwmstheme.EVOGCWMSRequestType.toEnum(requestType);
		setRequestType(requestTypeParamValue);
	}

	native private void setRequestType_EVOGCWMSRequestType(long pNativeObject, int requestType);
	public void setRequestType(com.earthview.world.spatial.theme.Ogcwmstheme.EVOGCWMSRequestType requestType)
	{
		int requestTypeParamValue = requestType.getValue();
		setRequestType_EVOGCWMSRequestType(this.nativeObject.pointer, requestTypeParamValue);
	}
	native private void setRequestType_EVOGCWMSRequestType_NoVirtual(long pNativeObject, int requestType);
	protected void setRequestType_NoVirtual(com.earthview.world.spatial.theme.Ogcwmstheme.EVOGCWMSRequestType requestType)
	{
		int requestTypeParamValue = requestType.getValue();
		setRequestType_EVOGCWMSRequestType_NoVirtual(this.nativeObject.pointer, requestTypeParamValue);
	}

	protected  int getRequestType_void_callback()
	{
		com.earthview.world.spatial.theme.Ogcwmstheme.EVOGCWMSRequestType returnValue = getRequestType();
		int __returnValue = returnValue.getValue();
		return __returnValue;
	}

	native private int getRequestType_void(long pNativeObject);
	public com.earthview.world.spatial.theme.Ogcwmstheme.EVOGCWMSRequestType getRequestType()
	{
		int returnValue = getRequestType_void(this.nativeObject.pointer);
		return com.earthview.world.spatial.theme.Ogcwmstheme.EVOGCWMSRequestType.toEnum(returnValue);
	}
	native private int getRequestType_void_NoVirtual(long pNativeObject);
	protected com.earthview.world.spatial.theme.Ogcwmstheme.EVOGCWMSRequestType getRequestType_NoVirtual()
	{
		int returnValue = getRequestType_void_NoVirtual(this.nativeObject.pointer);
		return com.earthview.world.spatial.theme.Ogcwmstheme.EVOGCWMSRequestType.toEnum(returnValue);
	}

	public Ogcwmstheme(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Ogcwmstheme(CreatedWhenConstruct cwc, String classNameStr) {
	...
	native protected void register_setRequestType_EVOGCWMSRequestType(long pNativeObject, String method);
	...
	public void registerCallback(){
		if (!this.nativeObject.equals(InstancePointer.ZERO)){
			this.register_setRequestType_EVOGCWMSRequestType(this.nativeObject.pointer, "setRequestType_EVOGCWMSRequestType_callback");
	...
	public static Ogcwmstheme fromBaseObject(BaseObject baseObj)
	{
		...
		Ogcwmstheme obj = null;
 		if(baseObj instanceof Ogcwmstheme)
		{
			obj = (Ogcwmstheme)baseObj;
		} else {
