 ...
 * wmts影像渲染器基类
 */
public class DrawChartTheme extends com.earthview.world.spatial.display.DrawServerLayerTheme {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Display::CDrawChartTheme", new DrawChartThemeClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Display::JCDrawChartThemeProxy", new DrawChartThemeClassFactory());
	}
	 ...
	 * @param  
	 */
	public DrawChartTheme() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCDrawChartThemeProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.display.DrawChartTheme".equals(this.getClass().getName()))
		{
	...
	public DrawChartTheme(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public DrawChartTheme(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static DrawChartTheme fromBaseObject(BaseObject baseObj)
	{
		...
		DrawChartTheme obj = null;
 		if(baseObj instanceof DrawChartTheme)
		{
			obj = (DrawChartTheme)baseObj;
		} else {
