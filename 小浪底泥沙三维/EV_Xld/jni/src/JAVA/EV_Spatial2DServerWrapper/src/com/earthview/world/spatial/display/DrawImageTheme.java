 ...
 * wmts影像渲染器基类
 */
public class DrawImageTheme extends com.earthview.world.spatial.display.DrawServerLayerTheme {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Display::CDrawImageTheme", new DrawImageThemeClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Display::JCDrawImageThemeProxy", new DrawImageThemeClassFactory());
	}
	 ...
	 * @param  
	 */
	public DrawImageTheme() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCDrawImageThemeProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.display.DrawImageTheme".equals(this.getClass().getName()))
		{
	...
	public DrawImageTheme(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public DrawImageTheme(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static DrawImageTheme fromBaseObject(BaseObject baseObj)
	{
		...
		DrawImageTheme obj = null;
 		if(baseObj instanceof DrawImageTheme)
		{
			obj = (DrawImageTheme)baseObj;
		} else {
