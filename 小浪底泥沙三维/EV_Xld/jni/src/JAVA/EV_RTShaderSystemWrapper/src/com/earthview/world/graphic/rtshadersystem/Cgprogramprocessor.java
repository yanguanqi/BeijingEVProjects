...
public class Cgprogramprocessor extends com.earthview.world.graphic.rtshadersystem.ProgramProcessor {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::RTShaderSystem::CCGProgramProcessor", new CgprogramprocessorClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::RTShaderSystem::JCCGProgramProcessorProxy", new CgprogramprocessorClassFactory());
	}

	public Cgprogramprocessor() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCGProgramProcessorProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.rtshadersystem.Cgprogramprocessor".equals(this.getClass().getName()))
		{
	...
	public Cgprogramprocessor(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Cgprogramprocessor(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Cgprogramprocessor fromBaseObject(BaseObject baseObj)
	{
		...
		Cgprogramprocessor obj = null;
 		if(baseObj instanceof Cgprogramprocessor)
		{
			obj = (Cgprogramprocessor)baseObj;
		} else {
