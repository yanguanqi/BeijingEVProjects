...
/// Attributes.
public class Ffpfogfactory extends com.earthview.world.graphic.rtshadersystem.SubRenderStateFactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::RTShaderSystem::CFFPFogFactory", new FfpfogfactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::RTShaderSystem::JCFFPFogFactoryProxy", new FfpfogfactoryClassFactory());
	}

	public Ffpfogfactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCFFPFogFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.rtshadersystem.Ffpfogfactory".equals(this.getClass().getName()))
		{
	...
	public Ffpfogfactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Ffpfogfactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Ffpfogfactory fromBaseObject(BaseObject baseObj)
	{
		...
		Ffpfogfactory obj = null;
 		if(baseObj instanceof Ffpfogfactory)
		{
			obj = (Ffpfogfactory)baseObj;
		} else {
