...
public class PerPixelLighting extends com.earthview.world.graphic.rtshadersystem.SubRenderState {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::RTShaderSystem::CPerPixelLighting", new PerPixelLightingClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::RTShaderSystem::JCPerPixelLightingProxy", new PerPixelLightingClassFactory());
	}

	public PerPixelLighting() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCPerPixelLightingProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.rtshadersystem.PerPixelLighting".equals(this.getClass().getName()))
		{
	...
	public PerPixelLighting(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public PerPixelLighting(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static PerPixelLighting fromBaseObject(BaseObject baseObj)
	{
		...
		PerPixelLighting obj = null;
 		if(baseObj instanceof PerPixelLighting)
		{
			obj = (PerPixelLighting)baseObj;
		} else {
