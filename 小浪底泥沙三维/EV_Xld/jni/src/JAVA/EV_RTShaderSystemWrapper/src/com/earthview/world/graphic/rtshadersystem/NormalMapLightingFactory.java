...
public class NormalMapLightingFactory extends com.earthview.world.graphic.rtshadersystem.SubRenderStateFactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::RTShaderSystem::CNormalMapLightingFactory", new NormalMapLightingFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::RTShaderSystem::JCNormalMapLightingFactoryProxy", new NormalMapLightingFactoryClassFactory());
	}

	public NormalMapLightingFactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCNormalMapLightingFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.rtshadersystem.NormalMapLightingFactory".equals(this.getClass().getName()))
		{
	...
	public NormalMapLightingFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public NormalMapLightingFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static NormalMapLightingFactory fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		NormalMapLightingFactory obj = null;
 		if(baseObj instanceof NormalMapLightingFactory)
		{
			obj = (NormalMapLightingFactory)baseObj;
		} else {
			obj = new NormalMapLightingFactory(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CNormalMapLightingFactory");
			obj.increaseCast();
		}
