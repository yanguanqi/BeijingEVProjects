...
public class Ffplighting extends com.earthview.world.graphic.rtshadersystem.SubRenderState {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::RTShaderSystem::CFFPLighting", new FfplightingClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::RTShaderSystem::JCFFPLightingProxy", new FfplightingClassFactory());
	}

	public Ffplighting() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCFFPLightingProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.rtshadersystem.Ffplighting".equals(this.getClass().getName()))
		{
	...
	public Ffplighting(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Ffplighting(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Ffplighting fromBaseObject(BaseObject baseObj)
	{
		...
		Ffplighting obj = null;
 		if(baseObj instanceof Ffplighting)
		{
			obj = (Ffplighting)baseObj;
		} else {
