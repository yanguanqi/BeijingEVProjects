...
public class Ffptransformfactory extends com.earthview.world.graphic.rtshadersystem.SubRenderStateFactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::RTShaderSystem::CFFPTransformFactory", new FfptransformfactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::RTShaderSystem::JCFFPTransformFactoryProxy", new FfptransformfactoryClassFactory());
	}

	public Ffptransformfactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCFFPTransformFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.rtshadersystem.Ffptransformfactory".equals(this.getClass().getName()))
		{
	...
	public Ffptransformfactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Ffptransformfactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Ffptransformfactory fromBaseObject(BaseObject baseObj)
	{
		...
		Ffptransformfactory obj = null;
 		if(baseObj instanceof Ffptransformfactory)
		{
			obj = (Ffptransformfactory)baseObj;
		} else {
