...
public class PerPixelLightingFactory extends com.earthview.world.graphic.rtshadersystem.SubRenderStateFactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::RTShaderSystem::CPerPixelLightingFactory", new PerPixelLightingFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::RTShaderSystem::JCPerPixelLightingFactoryProxy", new PerPixelLightingFactoryClassFactory());
	}

	public PerPixelLightingFactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCPerPixelLightingFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.rtshadersystem.PerPixelLightingFactory".equals(this.getClass().getName()))
		{
	...
	public PerPixelLightingFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public PerPixelLightingFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static PerPixelLightingFactory fromBaseObject(BaseObject baseObj)
	{
		...
		PerPixelLightingFactory obj = null;
 		if(baseObj instanceof PerPixelLightingFactory)
		{
			obj = (PerPixelLightingFactory)baseObj;
		} else {
