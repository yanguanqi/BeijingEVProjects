...
/// Attributes.
public class Ffpcolourfactory extends com.earthview.world.graphic.rtshadersystem.SubRenderStateFactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::RTShaderSystem::CFFPColourFactory", new FfpcolourfactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::RTShaderSystem::JCFFPColourFactoryProxy", new FfpcolourfactoryClassFactory());
	}

	public Ffpcolourfactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCFFPColourFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.rtshadersystem.Ffpcolourfactory".equals(this.getClass().getName()))
		{
	...
	public Ffpcolourfactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Ffpcolourfactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Ffpcolourfactory fromBaseObject(BaseObject baseObj)
	{
		...
		Ffpcolourfactory obj = null;
 		if(baseObj instanceof Ffpcolourfactory)
		{
			obj = (Ffpcolourfactory)baseObj;
		} else {
