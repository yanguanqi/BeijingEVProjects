...
public class Ffplightingfactory extends com.earthview.world.graphic.rtshadersystem.SubRenderStateFactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::RTShaderSystem::CFFPLightingFactory", new FfplightingfactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::RTShaderSystem::JCFFPLightingFactoryProxy", new FfplightingfactoryClassFactory());
	}

	public Ffplightingfactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCFFPLightingFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.rtshadersystem.Ffplightingfactory".equals(this.getClass().getName()))
		{
	...
	public Ffplightingfactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Ffplightingfactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Ffplightingfactory fromBaseObject(BaseObject baseObj)
	{
		...
		Ffplightingfactory obj = null;
 		if(baseObj instanceof Ffplightingfactory)
		{
			obj = (Ffplightingfactory)baseObj;
		} else {
