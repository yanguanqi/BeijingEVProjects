...
public class CommandLayoutRedo extends com.earthview.world.layout.controls.LayoutCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Layout::Controls::CCommandLayoutRedo", new CommandLayoutRedoClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Layout::Controls::JCCommandLayoutRedoProxy", new CommandLayoutRedoClassFactory());
	}
	 ...
	 * @param  
	 */
	public CommandLayoutRedo() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandLayoutRedoProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.layout.controls.CommandLayoutRedo".equals(this.getClass().getName()))
		{
	...
	public CommandLayoutRedo(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandLayoutRedo(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandLayoutRedo fromBaseObject(BaseObject baseObj)
	{
		...
		CommandLayoutRedo obj = null;
 		if(baseObj instanceof CommandLayoutRedo)
		{
			obj = (CommandLayoutRedo)baseObj;
		} else {
