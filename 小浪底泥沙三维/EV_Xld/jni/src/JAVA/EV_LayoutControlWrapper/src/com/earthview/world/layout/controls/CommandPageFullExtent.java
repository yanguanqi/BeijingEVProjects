 ...
 * 纸张1:1显示
 */
public class CommandPageFullExtent extends com.earthview.world.layout.controls.LayoutCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Layout::Controls::CCommandPageFullExtent", new CommandPageFullExtentClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Layout::Controls::JCCommandPageFullExtentProxy", new CommandPageFullExtentClassFactory());
	}
	 ...
	 * @param  
	 */
	public CommandPageFullExtent() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandPageFullExtentProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.layout.controls.CommandPageFullExtent".equals(this.getClass().getName()))
		{
	...
	public CommandPageFullExtent(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandPageFullExtent(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandPageFullExtent fromBaseObject(BaseObject baseObj)
	{
		...
		CommandPageFullExtent obj = null;
 		if(baseObj instanceof CommandPageFullExtent)
		{
			obj = (CommandPageFullExtent)baseObj;
		} else {
