...
public class ToolPagePan extends com.earthview.world.layout.controls.ToolLayout {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Layout::Controls::CToolPagePan", new ToolPagePanClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Layout::Controls::JCToolPagePanProxy", new ToolPagePanClassFactory());
	}
	...
	public ToolPagePan() {
		...
		Create("JCToolPagePanProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.layout.controls.ToolPagePan".equals(this.getClass().getName()))
		{
	...
	public ToolPagePan(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ToolPagePan(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ToolPagePan fromBaseObject(BaseObject baseObj)
	{
		...
		ToolPagePan obj = null;
 		if(baseObj instanceof ToolPagePan)
		{
			obj = (ToolPagePan)baseObj;
		} else {
