 ...
 * 纸张1:1显示
 */
public class CommandDeleteElement extends com.earthview.world.layout.controls.LayoutCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Layout::Controls::CCommandDeleteElement", new CommandDeleteElementClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Layout::Controls::JCCommandDeleteElementProxy", new CommandDeleteElementClassFactory());
	}
	 ...
	 * @param  
	 */
	public CommandDeleteElement() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandDeleteElementProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.layout.controls.CommandDeleteElement".equals(this.getClass().getName()))
		{
	...
	public CommandDeleteElement(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandDeleteElement(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandDeleteElement fromBaseObject(BaseObject baseObj)
	{
		...
		CommandDeleteElement obj = null;
 		if(baseObj instanceof CommandDeleteElement)
		{
			obj = (CommandDeleteElement)baseObj;
		} else {
