...
public class ToolPageZoomOut extends com.earthview.world.layout.controls.ToolLayout {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Layout::Controls::CToolPageZoomOut", new ToolPageZoomOutClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Layout::Controls::JCToolPageZoomOutProxy", new ToolPageZoomOutClassFactory());
	}
	 ...
	 * @param  
	 */
	public ToolPageZoomOut() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCToolPageZoomOutProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.layout.controls.ToolPageZoomOut".equals(this.getClass().getName()))
		{
	...
	public ToolPageZoomOut(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ToolPageZoomOut(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ToolPageZoomOut fromBaseObject(BaseObject baseObj)
	{
		...
		ToolPageZoomOut obj = null;
 		if(baseObj instanceof ToolPageZoomOut)
		{
			obj = (ToolPageZoomOut)baseObj;
		} else {
