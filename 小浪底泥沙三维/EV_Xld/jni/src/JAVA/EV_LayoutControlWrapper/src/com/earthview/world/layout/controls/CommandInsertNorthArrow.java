...
public class CommandInsertNorthArrow extends com.earthview.world.layout.controls.LayoutCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Layout::Controls::CCommandInsertNorthArrow", new CommandInsertNorthArrowClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Layout::Controls::JCCommandInsertNorthArrowProxy", new CommandInsertNorthArrowClassFactory());
	}
	 ...
	 * @param  
	 */
	public CommandInsertNorthArrow() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandInsertNorthArrowProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.layout.controls.CommandInsertNorthArrow".equals(this.getClass().getName()))
		{
	...
	public CommandInsertNorthArrow(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandInsertNorthArrow(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandInsertNorthArrow fromBaseObject(BaseObject baseObj)
	{
		...
		CommandInsertNorthArrow obj = null;
 		if(baseObj instanceof CommandInsertNorthArrow)
		{
			obj = (CommandInsertNorthArrow)baseObj;
		} else {
