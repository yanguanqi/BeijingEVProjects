...
public class CommandLayoutUndo extends com.earthview.world.layout.controls.LayoutCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Layout::Controls::CCommandLayoutUndo", new CommandLayoutUndoClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Layout::Controls::JCCommandLayoutUndoProxy", new CommandLayoutUndoClassFactory());
	}
	 ...
	 * @param  
	 */
	public CommandLayoutUndo() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandLayoutUndoProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.layout.controls.CommandLayoutUndo".equals(this.getClass().getName()))
		{
	...
	public CommandLayoutUndo(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandLayoutUndo(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandLayoutUndo fromBaseObject(BaseObject baseObj)
	{
		...
		CommandLayoutUndo obj = null;
 		if(baseObj instanceof CommandLayoutUndo)
		{
			obj = (CommandLayoutUndo)baseObj;
		} else {
