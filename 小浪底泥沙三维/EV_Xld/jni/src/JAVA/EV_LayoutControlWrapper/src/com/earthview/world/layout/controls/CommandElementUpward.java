...
public class CommandElementUpward extends com.earthview.world.layout.controls.LayoutCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Layout::Controls::CCommandElementUpward", new CommandElementUpwardClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Layout::Controls::JCCommandElementUpwardProxy", new CommandElementUpwardClassFactory());
	}
	 ...
	 * @param  
	 */
	public CommandElementUpward() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandElementUpwardProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.layout.controls.CommandElementUpward".equals(this.getClass().getName()))
		{
	...
	public CommandElementUpward(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandElementUpward(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandElementUpward fromBaseObject(BaseObject baseObj)
	{
		...
		CommandElementUpward obj = null;
 		if(baseObj instanceof CommandElementUpward)
		{
			obj = (CommandElementUpward)baseObj;
		} else {
