...
public class ToolZoomInInPage extends com.earthview.world.layout.controls.ToolLayout {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Layout::Controls::CToolZoomInInPage", new ToolZoomInInPageClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Layout::Controls::JCToolZoomInInPageProxy", new ToolZoomInInPageClassFactory());
	}
	 ...
	 * @param  
	 */
	public ToolZoomInInPage() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCToolZoomInInPageProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.layout.controls.ToolZoomInInPage".equals(this.getClass().getName()))
		{
	...
	public ToolZoomInInPage(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ToolZoomInInPage(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ToolZoomInInPage fromBaseObject(BaseObject baseObj)
	{
		...
		ToolZoomInInPage obj = null;
 		if(baseObj instanceof ToolZoomInInPage)
		{
			obj = (ToolZoomInInPage)baseObj;
		} else {
