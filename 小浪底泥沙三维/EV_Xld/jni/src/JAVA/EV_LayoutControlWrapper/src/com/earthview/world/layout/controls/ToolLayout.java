...
///class CMapControl;
public class ToolLayout extends com.earthview.world.spatial.systemui.Itool {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Layout::Controls::CToolLayout", new ToolLayoutClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Layout::Controls::JCToolLayoutProxy", new ToolLayoutClassFactory());
	}
	...
	native private void setMapControl_CMapControl(long pNativeObject, long pMapControl);
	public void setMapControl(com.earthview.world.spatial2d.controls.MapControl pMapControl)
	{
		long pMapControlParamValue = (pMapControl == null ? 0L : pMapControl.nativeObject.pointer);
		setMapControl_CMapControl(this.nativeObject.pointer, pMapControlParamValue);
	}
	...
	public ToolLayout() {
		...
		Create("JCToolLayoutProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.layout.controls.ToolLayout".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
		}
	}

	public ToolLayout(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ToolLayout(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ToolLayout fromBaseObject(BaseObject baseObj)
	{
		...
		ToolLayout obj = null;
 		if(baseObj instanceof ToolLayout)
		{
			obj = (ToolLayout)baseObj;
		} else {
