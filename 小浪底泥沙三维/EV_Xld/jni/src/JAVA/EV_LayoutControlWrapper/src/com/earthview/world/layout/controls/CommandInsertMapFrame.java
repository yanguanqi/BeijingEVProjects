 ...
 * 插入边框
 */
public class CommandInsertMapFrame extends com.earthview.world.layout.controls.LayoutCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Layout::Controls::CCommandInsertMapFrame", new CommandInsertMapFrameClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Layout::Controls::JCCommandInsertMapFrameProxy", new CommandInsertMapFrameClassFactory());
	}
	 ...
	 * @param  
	 */
	public CommandInsertMapFrame() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandInsertMapFrameProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.layout.controls.CommandInsertMapFrame".equals(this.getClass().getName()))
		{
	...
	public CommandInsertMapFrame(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandInsertMapFrame(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandInsertMapFrame fromBaseObject(BaseObject baseObj)
	{
		...
		CommandInsertMapFrame obj = null;
 		if(baseObj instanceof CommandInsertMapFrame)
		{
			obj = (CommandInsertMapFrame)baseObj;
		} else {
