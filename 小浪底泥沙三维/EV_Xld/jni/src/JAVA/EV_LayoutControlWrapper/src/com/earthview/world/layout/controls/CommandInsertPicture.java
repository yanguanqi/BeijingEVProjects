...
public class CommandInsertPicture extends com.earthview.world.layout.controls.LayoutCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Layout::Controls::CCommandInsertPicture", new CommandInsertPictureClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Layout::Controls::JCCommandInsertPictureProxy", new CommandInsertPictureClassFactory());
	}
	...
	public CommandInsertPicture() {
		...
		Create("JCCommandInsertPictureProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.layout.controls.CommandInsertPicture".equals(this.getClass().getName()))
		{
	...
	public CommandInsertPicture(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandInsertPicture(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandInsertPicture fromBaseObject(BaseObject baseObj)
	{
		...
		CommandInsertPicture obj = null;
 		if(baseObj instanceof CommandInsertPicture)
		{
			obj = (CommandInsertPicture)baseObj;
		} else {
