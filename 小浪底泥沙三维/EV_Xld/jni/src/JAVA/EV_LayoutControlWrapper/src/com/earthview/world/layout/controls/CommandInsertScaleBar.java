 ...
 * 插入尺度条
 */
public class CommandInsertScaleBar extends com.earthview.world.layout.controls.LayoutCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Layout::Controls::CCommandInsertScaleBar", new CommandInsertScaleBarClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Layout::Controls::JCCommandInsertScaleBarProxy", new CommandInsertScaleBarClassFactory());
	}
	 ...
	 * @param  
	 */
	public CommandInsertScaleBar() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandInsertScaleBarProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.layout.controls.CommandInsertScaleBar".equals(this.getClass().getName()))
		{
	...
	public CommandInsertScaleBar(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandInsertScaleBar(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandInsertScaleBar fromBaseObject(BaseObject baseObj)
	{
		...
		CommandInsertScaleBar obj = null;
 		if(baseObj instanceof CommandInsertScaleBar)
		{
			obj = (CommandInsertScaleBar)baseObj;
		} else {
