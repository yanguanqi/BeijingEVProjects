...
public class ToolZoomOutInPage extends com.earthview.world.layout.controls.ToolLayout {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Layout::Controls::CToolZoomOutInPage", new ToolZoomOutInPageClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Layout::Controls::JCToolZoomOutInPageProxy", new ToolZoomOutInPageClassFactory());
	}
	 ...
	 * @param  
	 */
	public ToolZoomOutInPage() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCToolZoomOutInPageProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.layout.controls.ToolZoomOutInPage".equals(this.getClass().getName()))
		{
	...
	public ToolZoomOutInPage(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ToolZoomOutInPage(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ToolZoomOutInPage fromBaseObject(BaseObject baseObj)
	{
		...
		ToolZoomOutInPage obj = null;
 		if(baseObj instanceof ToolZoomOutInPage)
		{
			obj = (ToolZoomOutInPage)baseObj;
		} else {
