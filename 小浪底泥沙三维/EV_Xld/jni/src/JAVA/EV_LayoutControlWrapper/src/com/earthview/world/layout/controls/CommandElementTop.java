...
public class CommandElementTop extends com.earthview.world.layout.controls.LayoutCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Layout::Controls::CCommandElementTop", new CommandElementTopClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Layout::Controls::JCCommandElementTopProxy", new CommandElementTopClassFactory());
	}
	 ...
	 * @param  
	 */
	public CommandElementTop() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandElementTopProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.layout.controls.CommandElementTop".equals(this.getClass().getName()))
		{
	...
	public CommandElementTop(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandElementTop(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandElementTop fromBaseObject(BaseObject baseObj)
	{
		...
		CommandElementTop obj = null;
 		if(baseObj instanceof CommandElementTop)
		{
			obj = (CommandElementTop)baseObj;
		} else {
