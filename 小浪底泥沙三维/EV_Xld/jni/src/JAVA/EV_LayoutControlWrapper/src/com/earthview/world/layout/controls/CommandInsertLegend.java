...
public class CommandInsertLegend extends com.earthview.world.layout.controls.LayoutCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Layout::Controls::CCommandInsertLegend", new CommandInsertLegendClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Layout::Controls::JCCommandInsertLegendProxy", new CommandInsertLegendClassFactory());
	}
	 ...
	 * @param  
	 */
	public CommandInsertLegend() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandInsertLegendProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.layout.controls.CommandInsertLegend".equals(this.getClass().getName()))
		{
	...
	public CommandInsertLegend(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandInsertLegend(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandInsertLegend fromBaseObject(BaseObject baseObj)
	{
		...
		CommandInsertLegend obj = null;
 		if(baseObj instanceof CommandInsertLegend)
		{
			obj = (CommandInsertLegend)baseObj;
		} else {
