...
public class CommandElementBottom extends com.earthview.world.layout.controls.LayoutCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Layout::Controls::CCommandElementBottom", new CommandElementBottomClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Layout::Controls::JCCommandElementBottomProxy", new CommandElementBottomClassFactory());
	}
	 ...
	 * @param  
	 */
	public CommandElementBottom() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandElementBottomProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.layout.controls.CommandElementBottom".equals(this.getClass().getName()))
		{
	...
	public CommandElementBottom(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandElementBottom(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandElementBottom fromBaseObject(BaseObject baseObj)
	{
		...
		CommandElementBottom obj = null;
 		if(baseObj instanceof CommandElementBottom)
		{
			obj = (CommandElementBottom)baseObj;
		} else {
