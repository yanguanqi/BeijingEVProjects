 ...
 * 纸张1:1显示
 */
public class CommandPreviousPageView extends com.earthview.world.layout.controls.LayoutCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Layout::Controls::CCommandPreviousPageView", new CommandPreviousPageViewClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Layout::Controls::JCCommandPreviousPageViewProxy", new CommandPreviousPageViewClassFactory());
	}
	 ...
	 * @param  
	 */
	public CommandPreviousPageView() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandPreviousPageViewProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.layout.controls.CommandPreviousPageView".equals(this.getClass().getName()))
		{
	...
	public CommandPreviousPageView(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandPreviousPageView(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandPreviousPageView fromBaseObject(BaseObject baseObj)
	{
		...
		CommandPreviousPageView obj = null;
 		if(baseObj instanceof CommandPreviousPageView)
		{
			obj = (CommandPreviousPageView)baseObj;
		} else {
