...
public class CommandPageSetting extends com.earthview.world.layout.controls.LayoutCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Layout::Controls::CCommandPageSetting", new CommandPageSettingClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Layout::Controls::JCCommandPageSettingProxy", new CommandPageSettingClassFactory());
	}
	 ...
	 * @param  
	 */
	public CommandPageSetting() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandPageSettingProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.layout.controls.CommandPageSetting".equals(this.getClass().getName()))
		{
	...
	public CommandPageSetting(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandPageSetting(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandPageSetting fromBaseObject(BaseObject baseObj)
	{
		...
		CommandPageSetting obj = null;
 		if(baseObj instanceof CommandPageSetting)
		{
			obj = (CommandPageSetting)baseObj;
		} else {
