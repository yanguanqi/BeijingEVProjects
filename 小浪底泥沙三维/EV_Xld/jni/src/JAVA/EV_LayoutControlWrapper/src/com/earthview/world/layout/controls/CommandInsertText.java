...
public class CommandInsertText extends com.earthview.world.layout.controls.LayoutCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Layout::Controls::CCommandInsertText", new CommandInsertTextClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Layout::Controls::JCCommandInsertTextProxy", new CommandInsertTextClassFactory());
	}
	 ...
	 * @param  
	 */
	public CommandInsertText() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandInsertTextProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.layout.controls.CommandInsertText".equals(this.getClass().getName()))
		{
	...
	public CommandInsertText(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandInsertText(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandInsertText fromBaseObject(BaseObject baseObj)
	{
		...
		CommandInsertText obj = null;
 		if(baseObj instanceof CommandInsertText)
		{
			obj = (CommandInsertText)baseObj;
		} else {
