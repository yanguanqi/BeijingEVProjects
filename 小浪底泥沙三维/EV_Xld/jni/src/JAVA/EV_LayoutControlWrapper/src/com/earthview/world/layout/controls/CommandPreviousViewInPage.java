...
public class CommandPreviousViewInPage extends com.earthview.world.layout.controls.LayoutCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Layout::Controls::CCommandPreviousViewInPage", new CommandPreviousViewInPageClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Layout::Controls::JCCommandPreviousViewInPageProxy", new CommandPreviousViewInPageClassFactory());
	}
	 ...
	 * @param  
	 */
	public CommandPreviousViewInPage() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandPreviousViewInPageProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.layout.controls.CommandPreviousViewInPage".equals(this.getClass().getName()))
		{
	...
	public CommandPreviousViewInPage(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandPreviousViewInPage(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandPreviousViewInPage fromBaseObject(BaseObject baseObj)
	{
		...
		CommandPreviousViewInPage obj = null;
 		if(baseObj instanceof CommandPreviousViewInPage)
		{
			obj = (CommandPreviousViewInPage)baseObj;
		} else {
