 ...
 * 纸张1:1显示
 */
public class CommandNextPageView extends com.earthview.world.layout.controls.LayoutCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Layout::Controls::CCommandNextPageView", new CommandNextPageViewClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Layout::Controls::JCCommandNextPageViewProxy", new CommandNextPageViewClassFactory());
	}
	 ...
	 * @param  
	 */
	public CommandNextPageView() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandNextPageViewProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.layout.controls.CommandNextPageView".equals(this.getClass().getName()))
		{
	...
	public CommandNextPageView(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandNextPageView(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandNextPageView fromBaseObject(BaseObject baseObj)
	{
		...
		CommandNextPageView obj = null;
 		if(baseObj instanceof CommandNextPageView)
		{
			obj = (CommandNextPageView)baseObj;
		} else {
