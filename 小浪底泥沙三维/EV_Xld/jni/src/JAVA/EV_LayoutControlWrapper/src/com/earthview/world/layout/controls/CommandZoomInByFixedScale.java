 ...
 * 纸张1:1显示
 */
public class CommandZoomInByFixedScale extends com.earthview.world.layout.controls.LayoutCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Layout::Controls::CCommandZoomInByFixedScale", new CommandZoomInByFixedScaleClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Layout::Controls::JCCommandZoomInByFixedScaleProxy", new CommandZoomInByFixedScaleClassFactory());
	}
	 ...
	 * @param  
	 */
	public CommandZoomInByFixedScale() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandZoomInByFixedScaleProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.layout.controls.CommandZoomInByFixedScale".equals(this.getClass().getName()))
		{
	...
	public CommandZoomInByFixedScale(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandZoomInByFixedScale(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandZoomInByFixedScale fromBaseObject(BaseObject baseObj)
	{
		...
		CommandZoomInByFixedScale obj = null;
 		if(baseObj instanceof CommandZoomInByFixedScale)
		{
			obj = (CommandZoomInByFixedScale)baseObj;
		} else {
