...
public class CommandElementDownward extends com.earthview.world.layout.controls.LayoutCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Layout::Controls::CCommandElementDownward", new CommandElementDownwardClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Layout::Controls::JCCommandElementDownwardProxy", new CommandElementDownwardClassFactory());
	}
	 ...
	 * @param  
	 */
	public CommandElementDownward() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandElementDownwardProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.layout.controls.CommandElementDownward".equals(this.getClass().getName()))
		{
	...
	public CommandElementDownward(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandElementDownward(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandElementDownward fromBaseObject(BaseObject baseObj)
	{
		...
		CommandElementDownward obj = null;
 		if(baseObj instanceof CommandElementDownward)
		{
			obj = (CommandElementDownward)baseObj;
		} else {
