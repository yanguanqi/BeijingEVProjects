...
public class CommandInsertScaleText extends com.earthview.world.layout.controls.LayoutCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Layout::Controls::CCommandInsertScaleText", new CommandInsertScaleTextClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Layout::Controls::JCCommandInsertScaleTextProxy", new CommandInsertScaleTextClassFactory());
	}
	 ...
	 * @param  
	 */
	public CommandInsertScaleText() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandInsertScaleTextProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.layout.controls.CommandInsertScaleText".equals(this.getClass().getName()))
		{
	...
	public CommandInsertScaleText(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandInsertScaleText(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandInsertScaleText fromBaseObject(BaseObject baseObj)
	{
		...
		CommandInsertScaleText obj = null;
 		if(baseObj instanceof CommandInsertScaleText)
		{
			obj = (CommandInsertScaleText)baseObj;
		} else {
