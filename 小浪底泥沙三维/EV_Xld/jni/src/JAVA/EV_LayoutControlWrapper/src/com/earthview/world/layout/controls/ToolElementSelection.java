...
public class ToolElementSelection extends com.earthview.world.layout.controls.ToolLayout {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Layout::Controls::CToolElementSelection", new ToolElementSelectionClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Layout::Controls::JCToolElementSelectionProxy", new ToolElementSelectionClassFactory());
	}
	 ...
	 * @param  
	 */
	public ToolElementSelection() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCToolElementSelectionProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.layout.controls.ToolElementSelection".equals(this.getClass().getName()))
		{
	...
	protected  void showMessage_EVString_callback(String strMag)
	{
		String strMagParamValue = strMag;
		showMessage(strMagParamValue);
	}

	native private void showMessage_EVString(long pNativeObject, String strMag);
	public void showMessage(String strMag)
	{
		String strMagParamValue = strMag;
		showMessage_EVString(this.nativeObject.pointer, strMagParamValue);
	}
	native private void showMessage_EVString_NoVirtual(long pNativeObject, String strMag);
	protected void showMessage_NoVirtual(String strMag)
	{
		String strMagParamValue = strMag;
		showMessage_EVString_NoVirtual(this.nativeObject.pointer, strMagParamValue);
	}

	public ToolElementSelection(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ToolElementSelection(CreatedWhenConstruct cwc, String classNameStr) {
	...
	native protected void register_showMessage_EVString(long pNativeObject, String method);
	...
	public void registerCallback(){
		if (!this.nativeObject.equals(InstancePointer.ZERO)){
			this.register_showMessage_EVString(this.nativeObject.pointer, "showMessage_EVString_callback");
	...
	public static ToolElementSelection fromBaseObject(BaseObject baseObj)
	{
		...
		ToolElementSelection obj = null;
 		if(baseObj instanceof ToolElementSelection)
		{
			obj = (ToolElementSelection)baseObj;
		} else {
