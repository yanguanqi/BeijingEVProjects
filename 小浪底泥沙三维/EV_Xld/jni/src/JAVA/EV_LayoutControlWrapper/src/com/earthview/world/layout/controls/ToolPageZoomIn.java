...
public class ToolPageZoomIn extends com.earthview.world.layout.controls.ToolLayout {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Layout::Controls::CToolPageZoomIn", new ToolPageZoomInClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Layout::Controls::JCToolPageZoomInProxy", new ToolPageZoomInClassFactory());
	}
	 ...
	 * @param  
	 */
	public ToolPageZoomIn() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCToolPageZoomInProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.layout.controls.ToolPageZoomIn".equals(this.getClass().getName()))
		{
	...
	public ToolPageZoomIn(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ToolPageZoomIn(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ToolPageZoomIn fromBaseObject(BaseObject baseObj)
	{
		...
		ToolPageZoomIn obj = null;
 		if(baseObj instanceof ToolPageZoomIn)
		{
			obj = (ToolPageZoomIn)baseObj;
		} else {
