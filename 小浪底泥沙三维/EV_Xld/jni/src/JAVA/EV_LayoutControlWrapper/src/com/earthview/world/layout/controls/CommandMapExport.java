...
public class CommandMapExport extends com.earthview.world.layout.controls.LayoutCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Layout::Controls::CCommandMapExport", new CommandMapExportClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Layout::Controls::JCCommandMapExportProxy", new CommandMapExportClassFactory());
	}
	...
	public CommandMapExport() {
		...
		Create("JCCommandMapExportProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.layout.controls.CommandMapExport".equals(this.getClass().getName()))
		{
	...
	public CommandMapExport(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandMapExport(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandMapExport fromBaseObject(BaseObject baseObj)
	{
		...
		CommandMapExport obj = null;
 		if(baseObj instanceof CommandMapExport)
		{
			obj = (CommandMapExport)baseObj;
		} else {
