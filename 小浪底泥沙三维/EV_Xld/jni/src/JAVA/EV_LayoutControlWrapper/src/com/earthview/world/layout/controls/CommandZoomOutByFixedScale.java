 ...
 * 纸张1:1显示
 */
public class CommandZoomOutByFixedScale extends com.earthview.world.layout.controls.LayoutCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Layout::Controls::CCommandZoomOutByFixedScale", new CommandZoomOutByFixedScaleClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Layout::Controls::JCCommandZoomOutByFixedScaleProxy", new CommandZoomOutByFixedScaleClassFactory());
	}
	 ...
	 * @param  
	 */
	public CommandZoomOutByFixedScale() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandZoomOutByFixedScaleProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.layout.controls.CommandZoomOutByFixedScale".equals(this.getClass().getName()))
		{
	...
	public CommandZoomOutByFixedScale(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandZoomOutByFixedScale(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandZoomOutByFixedScale fromBaseObject(BaseObject baseObj)
	{
		...
		CommandZoomOutByFixedScale obj = null;
 		if(baseObj instanceof CommandZoomOutByFixedScale)
		{
			obj = (CommandZoomOutByFixedScale)baseObj;
		} else {
