...
public class CommandFullExtentInPage extends com.earthview.world.layout.controls.LayoutCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Layout::Controls::CCommandFullExtentInPage", new CommandFullExtentInPageClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Layout::Controls::JCCommandFullExtentInPageProxy", new CommandFullExtentInPageClassFactory());
	}
	 ...
	 * @param  
	 */
	public CommandFullExtentInPage() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandFullExtentInPageProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.layout.controls.CommandFullExtentInPage".equals(this.getClass().getName()))
		{
	...
	public CommandFullExtentInPage(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandFullExtentInPage(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandFullExtentInPage fromBaseObject(BaseObject baseObj)
	{
		...
		CommandFullExtentInPage obj = null;
 		if(baseObj instanceof CommandFullExtentInPage)
		{
			obj = (CommandFullExtentInPage)baseObj;
		} else {
