 ...
 * 纸张1:1显示
 */
public class CommandPageNormal extends com.earthview.world.layout.controls.LayoutCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Layout::Controls::CCommandPageNormal", new CommandPageNormalClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Layout::Controls::JCCommandPageNormalProxy", new CommandPageNormalClassFactory());
	}
	 ...
	 * @param  
	 */
	public CommandPageNormal() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandPageNormalProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.layout.controls.CommandPageNormal".equals(this.getClass().getName()))
		{
	...
	public CommandPageNormal(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandPageNormal(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandPageNormal fromBaseObject(BaseObject baseObj)
	{
		...
		CommandPageNormal obj = null;
 		if(baseObj instanceof CommandPageNormal)
		{
			obj = (CommandPageNormal)baseObj;
		} else {
