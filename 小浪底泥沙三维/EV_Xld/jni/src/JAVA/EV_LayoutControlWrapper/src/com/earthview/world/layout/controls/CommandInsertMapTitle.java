...
public class CommandInsertMapTitle extends com.earthview.world.layout.controls.LayoutCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Layout::Controls::CCommandInsertMapTitle", new CommandInsertMapTitleClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Layout::Controls::JCCommandInsertMapTitleProxy", new CommandInsertMapTitleClassFactory());
	}
	 ...
	 * @param  
	 */
	public CommandInsertMapTitle() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandInsertMapTitleProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.layout.controls.CommandInsertMapTitle".equals(this.getClass().getName()))
		{
	...
	public CommandInsertMapTitle(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandInsertMapTitle(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandInsertMapTitle fromBaseObject(BaseObject baseObj)
	{
		...
		CommandInsertMapTitle obj = null;
 		if(baseObj instanceof CommandInsertMapTitle)
		{
			obj = (CommandInsertMapTitle)baseObj;
		} else {
