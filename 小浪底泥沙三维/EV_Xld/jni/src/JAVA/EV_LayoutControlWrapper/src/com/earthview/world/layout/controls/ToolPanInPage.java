...
public class ToolPanInPage extends com.earthview.world.layout.controls.ToolLayout {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Layout::Controls::CToolPanInPage", new ToolPanInPageClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Layout::Controls::JCToolPanInPageProxy", new ToolPanInPageClassFactory());
	}
	 ...
	 * @param  
	 */
	public ToolPanInPage() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCToolPanInPageProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.layout.controls.ToolPanInPage".equals(this.getClass().getName()))
		{
	...
	public ToolPanInPage(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ToolPanInPage(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ToolPanInPage fromBaseObject(BaseObject baseObj)
	{
		...
		ToolPanInPage obj = null;
 		if(baseObj instanceof ToolPanInPage)
		{
			obj = (ToolPanInPage)baseObj;
		} else {
