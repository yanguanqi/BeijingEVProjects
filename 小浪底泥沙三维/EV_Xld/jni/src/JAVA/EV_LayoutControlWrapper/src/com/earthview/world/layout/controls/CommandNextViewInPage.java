...
public class CommandNextViewInPage extends com.earthview.world.layout.controls.LayoutCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Layout::Controls::CCommandNextViewInPage", new CommandNextViewInPageClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Layout::Controls::JCCommandNextViewInPageProxy", new CommandNextViewInPageClassFactory());
	}
	 ...
	 * @param  
	 */
	public CommandNextViewInPage() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandNextViewInPageProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.layout.controls.CommandNextViewInPage".equals(this.getClass().getName()))
		{
	...
	public CommandNextViewInPage(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandNextViewInPage(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandNextViewInPage fromBaseObject(BaseObject baseObj)
	{
		...
		CommandNextViewInPage obj = null;
 		if(baseObj instanceof CommandNextViewInPage)
		{
			obj = (CommandNextViewInPage)baseObj;
		} else {
