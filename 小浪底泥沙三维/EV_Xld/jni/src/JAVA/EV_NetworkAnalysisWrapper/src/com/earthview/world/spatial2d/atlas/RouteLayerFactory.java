...
public class RouteLayerFactory extends com.earthview.world.spatial.atlas.Ilayerfactory {
	...
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Atlas::CRouteLayerFactory", new RouteLayerFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Atlas::JCRouteLayerFactoryProxy", new RouteLayerFactoryClassFactory());
	}
	...
	public RouteLayerFactory() {
		...
		if (!"com.earthview.world.spatial2d.atlas.RouteLayerFactory".equals(this.getClass().getName()))
		{
