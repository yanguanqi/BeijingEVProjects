 ...
 * 网络要素集图层工厂
 */
public class NetworkLayerFactory extends com.earthview.world.spatial.atlas.Ilayerfactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Atlas::CNetworkLayerFactory", new NetworkLayerFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Atlas::JCNetworkLayerFactoryProxy", new NetworkLayerFactoryClassFactory());
	}
	 ...
	 * @param  
	 */
	public NetworkLayerFactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCNetworkLayerFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.atlas.NetworkLayerFactory".equals(this.getClass().getName()))
		{
	...
	public NetworkLayerFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public NetworkLayerFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static NetworkLayerFactory fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		NetworkLayerFactory obj = null;
 		if(baseObj instanceof NetworkLayerFactory)
		{
			obj = (NetworkLayerFactory)baseObj;
		} else {
			obj = new NetworkLayerFactory(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CNetworkLayerFactory");
			obj.increaseCast();
		}
