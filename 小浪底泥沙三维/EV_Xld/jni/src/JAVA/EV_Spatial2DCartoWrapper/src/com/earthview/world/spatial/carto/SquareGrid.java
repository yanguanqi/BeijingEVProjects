 ...
 * 方格网类
 */
public class SquareGrid extends Isquaregrid {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Carto::CSquareGrid", new SquareGridClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Carto::JCSquareGridProxy", new SquareGridClassFactory());
	}
	...
	public SquareGrid() {
		...
		Create("JCSquareGridProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.carto.SquareGrid".equals(this.getClass().getName()))
		{
	...
	public SquareGrid(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public SquareGrid(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static SquareGrid fromBaseObject(BaseObject baseObj)
	{
		...
		SquareGrid obj = null;
 		if(baseObj instanceof SquareGrid)
		{
			obj = (SquareGrid)baseObj;
		} else {
