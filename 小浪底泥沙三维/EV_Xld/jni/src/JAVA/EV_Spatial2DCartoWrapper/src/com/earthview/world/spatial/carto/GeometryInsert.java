...
public class GeometryInsert extends Igeometryinsert {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Carto::CGeometryInsert", new GeometryInsertClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Carto::JCGeometryInsertProxy", new GeometryInsertClassFactory());
	}
	 ...
	 * @param  
	 */
	public GeometryInsert() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCGeometryInsertProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.carto.GeometryInsert".equals(this.getClass().getName()))
		{
	...
	protected  void setGeometry_IGeometry_callback(long pGeometry)
	{
		...
		setGeometry(pGeometryParamValue);
	}
	...
	native private void setGeometry_IGeometry_NoVirtual(long pNativeObject, long pGeometry);
	protected void setGeometry_NoVirtual(com.earthview.world.spatial.geometry.Igeometry pGeometry)
	{
		long pGeometryParamValue = (pGeometry == null ? 0L : pGeometry.nativeObject.pointer);
		setGeometry_IGeometry_NoVirtual(this.nativeObject.pointer, pGeometryParamValue);
	}
	...
	public GeometryInsert(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public GeometryInsert(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static GeometryInsert fromBaseObject(BaseObject baseObj)
	{
		...
		GeometryInsert obj = null;
 		if(baseObj instanceof GeometryInsert)
		{
			obj = (GeometryInsert)baseObj;
		} else {
