...
public class Page extends Ipage {
	...
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Carto::CPage", new PageClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Carto::JCPageProxy", new PageClassFactory());
	}
	...
	public Page() {
		...
		Create("JCPageProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.carto.Page".equals(this.getClass().getName()))
		{
	...
	protected Ipage ev_clone_NoVirtual()
	{
	...
	public Page(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Page(CreatedWhenConstruct cwc, String classNameStr) {
