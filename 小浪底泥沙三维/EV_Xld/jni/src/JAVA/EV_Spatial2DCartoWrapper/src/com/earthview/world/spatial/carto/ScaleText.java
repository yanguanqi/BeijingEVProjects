...
public class ScaleText extends Iscaletext {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Carto::CScaleText", new ScaleTextClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Carto::JCScaleTextProxy", new ScaleTextClassFactory());
	}
	...
	public ScaleText() {
		...
		Create("JCScaleTextProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.carto.ScaleText".equals(this.getClass().getName()))
		{
	...
	protected  void setSelected_ev_bool_callback(boolean bSelected)
	{
		boolean bSelectedParamValue = bSelected;
		setSelected(bSelectedParamValue);
	}
	...
	protected  String to_1_N_Format_EVString_callback(String strText)
	{
		String strTextParamValue = strText;
		String returnValue = to_1_N_Format(strTextParamValue);
		String __returnValue = returnValue;
		return __returnValue;
	}

	native private String to_1_N_Format_EVString(long pNativeObject, String strText);
	/**
	 * 将比例尺字符串变为1:n格式
	 * @param strText 比例尺字符
	 * @return 变为1:n格式后的比例尺字符串
	 */
	public String to_1_N_Format(String strText)
	{
		String strTextParamValue = strText;
		String returnValue = to_1_N_Format_EVString(this.nativeObject.pointer, strTextParamValue);
		return returnValue;
	}
	native private String to_1_N_Format_EVString_NoVirtual(long pNativeObject, String strText);
	protected String to_1_N_Format_NoVirtual(String strText)
	{
		String strTextParamValue = strText;
		String returnValue = to_1_N_Format_EVString_NoVirtual(this.nativeObject.pointer, strTextParamValue);
		return returnValue;
	}

	protected  String toKilobitSeparatedFormat_EVString_callback(String strText)
	{
		String strTextParamValue = strText;
		String returnValue = toKilobitSeparatedFormat(strTextParamValue);
		String __returnValue = returnValue;
		return __returnValue;
	}

	native private String toKilobitSeparatedFormat_EVString(long pNativeObject, String strText);
	/**
	 * 将比例尺字符串变为千位分隔的格式
	 * @param strText 比例尺字符串
	 * @return 比例尺变为千位分隔格式后的字符串
	 */
	public String toKilobitSeparatedFormat(String strText)
	{
		String strTextParamValue = strText;
		String returnValue = toKilobitSeparatedFormat_EVString(this.nativeObject.pointer, strTextParamValue);
		return returnValue;
	}
	native private String toKilobitSeparatedFormat_EVString_NoVirtual(long pNativeObject, String strText);
	protected String toKilobitSeparatedFormat_NoVirtual(String strText)
	{
		String strTextParamValue = strText;
		String returnValue = toKilobitSeparatedFormat_EVString_NoVirtual(this.nativeObject.pointer, strTextParamValue);
		return returnValue;
	}
	...
	protected  String getPreviewScale_ISpatialDisplay_callback(long pPageDisplay)
	{
		...
		String returnValue = getPreviewScale(pPageDisplayParamValue);
		String __returnValue = returnValue;
		return __returnValue;
	}

	native private String getPreviewScale_ISpatialDisplay(long pNativeObject, long pPageDisplay);
	/**
	 * 获取预览比例尺
	 * @param  纸张显示设备
	 * @return 字符型的比例尺
	 */
	public String getPreviewScale(com.earthview.world.spatial.display.Ispatialdisplay pPageDisplay)
	{
		long pPageDisplayParamValue = (pPageDisplay == null ? 0L : pPageDisplay.nativeObject.pointer);
		String returnValue = getPreviewScale_ISpatialDisplay(this.nativeObject.pointer, pPageDisplayParamValue);
		return returnValue;
	}
	native private String getPreviewScale_ISpatialDisplay_NoVirtual(long pNativeObject, long pPageDisplay);
	protected String getPreviewScale_NoVirtual(com.earthview.world.spatial.display.Ispatialdisplay pPageDisplay)
	{
		long pPageDisplayParamValue = (pPageDisplay == null ? 0L : pPageDisplay.nativeObject.pointer);
		String returnValue = getPreviewScale_ISpatialDisplay_NoVirtual(this.nativeObject.pointer, pPageDisplayParamValue);
		return returnValue;
	}
	...
	public ScaleText(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ScaleText(CreatedWhenConstruct cwc, String classNameStr) {
	...
	native protected void register_to_1_N_Format_EVString(long pNativeObject, String method);
	native protected void register_toKilobitSeparatedFormat_EVString(long pNativeObject, String method);
	native protected void register_setMapFrame_IMapFrame(long pNativeObject, String method);
	native protected void register_getPreviewScale_ISpatialDisplay(long pNativeObject, String method);
	...
	public void registerCallback(){
		if (!this.nativeObject.equals(InstancePointer.ZERO)){
			...
			this.register_to_1_N_Format_EVString(this.nativeObject.pointer, "to_1_N_Format_EVString_callback");
			this.register_toKilobitSeparatedFormat_EVString(this.nativeObject.pointer, "toKilobitSeparatedFormat_EVString_callback");
			this.register_setMapFrame_IMapFrame(this.nativeObject.pointer, "setMapFrame_IMapFrame_callback");
			this.register_getPreviewScale_ISpatialDisplay(this.nativeObject.pointer, "getPreviewScale_ISpatialDisplay_callback");
	...
	public static ScaleText fromBaseObject(BaseObject baseObj)
	{
		...
		ScaleText obj = null;
 		if(baseObj instanceof ScaleText)
		{
			obj = (ScaleText)baseObj;
		} else {
