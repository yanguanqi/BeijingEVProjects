...
public class MarkNorthArrow extends Imarknortharrow {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Carto::CMarkNorthArrow", new MarkNorthArrowClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Carto::JCMarkNorthArrowProxy", new MarkNorthArrowClassFactory());
	}
	 ...
	 * @param type 
	 */
	public MarkNorthArrow() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCMarkNorthArrowProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.carto.MarkNorthArrow".equals(this.getClass().getName()))
		{
	...
	public MarkNorthArrow(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public MarkNorthArrow(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static MarkNorthArrow fromBaseObject(BaseObject baseObj)
	{
		...
		MarkNorthArrow obj = null;
 		if(baseObj instanceof MarkNorthArrow)
		{
			obj = (MarkNorthArrow)baseObj;
		} else {
