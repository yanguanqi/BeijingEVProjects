...
public class MapFrame extends Imapframe {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Carto::CMapFrame", new MapFrameClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Carto::JCMapFrameProxy", new MapFrameClassFactory());
	}
	...
	public MapFrame() {
		...
		Create("JCMapFrameProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.carto.MapFrame".equals(this.getClass().getName()))
		{
	...
	public MapFrame(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public MapFrame(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static MapFrame fromBaseObject(BaseObject baseObj)
	{
		...
		MapFrame obj = null;
 		if(baseObj instanceof MapFrame)
		{
			obj = (MapFrame)baseObj;
		} else {
