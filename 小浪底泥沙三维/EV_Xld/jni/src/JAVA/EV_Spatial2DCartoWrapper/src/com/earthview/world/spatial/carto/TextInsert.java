...
public class TextInsert extends Itextinsert {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Carto::CTextInsert", new TextInsertClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Carto::JCTextInsertProxy", new TextInsertClassFactory());
	}
	...
	public TextInsert() {
		...
		Create("JCTextInsertProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.carto.TextInsert".equals(this.getClass().getName()))
		{
	...
	public TextInsert(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public TextInsert(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static TextInsert fromBaseObject(BaseObject baseObj)
	{
		...
		TextInsert obj = null;
 		if(baseObj instanceof TextInsert)
		{
			obj = (TextInsert)baseObj;
		} else {
