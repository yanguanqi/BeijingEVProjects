 ...
 * 方格网类
 */
public class KilometerGrid extends com.earthview.world.spatial.carto.SquareGrid {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Carto::CKilometerGrid", new KilometerGridClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Carto::JCKilometerGridProxy", new KilometerGridClassFactory());
	}
	 ...
	 * @param  
	 */
	public KilometerGrid() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCKilometerGridProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.carto.KilometerGrid".equals(this.getClass().getName()))
		{
	...
	public KilometerGrid(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public KilometerGrid(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static KilometerGrid fromBaseObject(BaseObject baseObj)
	{
		...
		KilometerGrid obj = null;
 		if(baseObj instanceof KilometerGrid)
		{
			obj = (KilometerGrid)baseObj;
		} else {
