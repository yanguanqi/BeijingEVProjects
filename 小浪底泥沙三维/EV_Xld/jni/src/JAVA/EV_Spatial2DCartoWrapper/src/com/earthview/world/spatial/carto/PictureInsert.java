...
public class PictureInsert extends Ipictureinsert {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Carto::CPictureInsert", new PictureInsertClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Carto::JCPictureInsertProxy", new PictureInsertClassFactory());
	}
	...
	public PictureInsert() {
		...
		Create("JCPictureInsertProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.carto.PictureInsert".equals(this.getClass().getName()))
		{
	...
	public PictureInsert(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public PictureInsert(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static PictureInsert fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		PictureInsert obj = null;
 		if(baseObj instanceof PictureInsert)
		{
			obj = (PictureInsert)baseObj;
		} else {
			obj = new PictureInsert(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CPictureInsert");
			obj.increaseCast();
		}
