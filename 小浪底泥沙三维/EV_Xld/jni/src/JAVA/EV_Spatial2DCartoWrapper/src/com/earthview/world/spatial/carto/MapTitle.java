...
public class MapTitle extends Imaptitle {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Carto::CMapTitle", new MapTitleClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Carto::JCMapTitleProxy", new MapTitleClassFactory());
	}
	...
	public MapTitle() {
		...
		Create("JCMapTitleProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.carto.MapTitle".equals(this.getClass().getName()))
		{
	...
	public MapTitle(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public MapTitle(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static MapTitle fromBaseObject(BaseObject baseObj)
	{
		...
		MapTitle obj = null;
 		if(baseObj instanceof MapTitle)
		{
			obj = (MapTitle)baseObj;
		} else {
