...
public class Itool extends com.earthview.world.spatial.systemui.Icommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::SystemUI::ITool", new ItoolClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::SystemUI::JIToolProxy", new ItoolClassFactory());
	}
	...
	protected  int getCursor_void_callback()
	{
		int returnValue = getCursor();
	...
	protected  boolean onContextMenu_ev_int32_ev_int32_callback(int x, int y)
	{
		int xParamValue = x;
		int yParamValue = y;
		boolean returnValue = onContextMenu(xParamValue, yParamValue);
	...
	protected  boolean onDoubleClick_void_callback()
	{
		boolean returnValue = onDoubleClick();
		boolean __returnValue = returnValue;
		return __returnValue;
	}
	...
	protected  boolean onDoubleClick_ev_int32_ev_int32_ev_int32_ev_int32_callback(int button, int shift, int x, int y)
	{
		int buttonParamValue = button;
		int shiftParamValue = shift;
		int xParamValue = x;
		int yParamValue = y;
		boolean returnValue = onDoubleClick(buttonParamValue, shiftParamValue, xParamValue, yParamValue);
		boolean __returnValue = returnValue;
		return __returnValue;
	}
	...
	protected  boolean onMouseWheel_ev_int32_ev_int32_ev_int32_ev_int32_callback(int delta, int x, int y, int flag)
	{
		int deltaParamValue = delta;
		int xParamValue = x;
		int yParamValue = y;
		int flagParamValue = flag;
		boolean returnValue = onMouseWheel(deltaParamValue, xParamValue, yParamValue, flagParamValue);
		boolean __returnValue = returnValue;
		return __returnValue;
	}
	...
	protected  boolean onTouchDown_MotionEvent_callback(long touchEvent)
	{
		com.earthview.world.spatial.systemui.MotionEvent touchEventParamValue = new com.earthview.world.spatial.systemui.MotionEvent(CreatedWhenConstruct.CWC_NotToCreate);
		touchEventParamValue.setDelegate(true);
		touchEventParamValue.setInstancePointer(new InstancePointer(touchEvent));
		IClassFactory touchEventParamValueClassFactory = GlobalClassFactoryMap.get(touchEventParamValue.getCppInstanceTypeName());
		if (touchEventParamValueClassFactory != null)
		{
			touchEventParamValue.setDelegate(true);
			touchEventParamValue = (com.earthview.world.spatial.systemui.MotionEvent)touchEventParamValueClassFactory.create();
			touchEventParamValue.setDelegate(true);
			touchEventParamValue.setInstancePointer(new InstancePointer(touchEvent));
		}
		boolean returnValue = onTouchDown(touchEventParamValue);
		boolean __returnValue = returnValue;
		return __returnValue;
	}
	...
	protected  boolean onTouchUp_MotionEvent_callback(long touchEvent)
	{
		com.earthview.world.spatial.systemui.MotionEvent touchEventParamValue = new com.earthview.world.spatial.systemui.MotionEvent(CreatedWhenConstruct.CWC_NotToCreate);
		touchEventParamValue.setDelegate(true);
		touchEventParamValue.setInstancePointer(new InstancePointer(touchEvent));
		...
		boolean returnValue = onTouchUp(touchEventParamValue);
		boolean __returnValue = returnValue;
		return __returnValue;
	}
	...
	protected  boolean onTouchMove_MotionEvent_callback(long touchEvent)
	{
		com.earthview.world.spatial.systemui.MotionEvent touchEventParamValue = new com.earthview.world.spatial.systemui.MotionEvent(CreatedWhenConstruct.CWC_NotToCreate);
		touchEventParamValue.setDelegate(true);
		touchEventParamValue.setInstancePointer(new InstancePointer(touchEvent));
		...
		boolean returnValue = onTouchMove(touchEventParamValue);
		boolean __returnValue = returnValue;
		return __returnValue;
	}
	...
	public Itool() {
		...
		Create("JIToolProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.systemui.Itool".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
		}
	}

	public Itool(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Itool(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Itool fromBaseObject(BaseObject baseObj)
	{
		...
		Itool obj = null;
 		if(baseObj instanceof Itool)
		{
			obj = (Itool)baseObj;
		} else {
			obj = new Itool(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "ITool");
			obj.increaseCast();
		}
