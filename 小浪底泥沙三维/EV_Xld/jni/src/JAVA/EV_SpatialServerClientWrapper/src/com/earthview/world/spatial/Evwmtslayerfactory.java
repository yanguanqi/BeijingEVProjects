 ...
 * EarthViewWMTS图层类工厂
 */
public class Evwmtslayerfactory extends com.earthview.world.spatial.WebLayerFactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::CEVWMTSLayerFactory", new EvwmtslayerfactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::JCEVWMTSLayerFactoryProxy", new EvwmtslayerfactoryClassFactory());
	}

	/**
	 * 默认构造函数
	 */
	public Evwmtslayerfactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCEVWMTSLayerFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.Evwmtslayerfactory".equals(this.getClass().getName()))
		{
	...
	public Evwmtslayerfactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Evwmtslayerfactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Evwmtslayerfactory fromBaseObject(BaseObject baseObj)
	{
		...
		Evwmtslayerfactory obj = null;
 		if(baseObj instanceof Evwmtslayerfactory)
		{
			obj = (Evwmtslayerfactory)baseObj;
		} else {
