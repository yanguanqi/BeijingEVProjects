 ...
 * EarthViewWMS图层类工厂
 */
public class Evwmslayerfactory extends com.earthview.world.spatial.WebLayerFactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::CEVWMSLayerFactory", new EvwmslayerfactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::JCEVWMSLayerFactoryProxy", new EvwmslayerfactoryClassFactory());
	}

	/**
	 * 默认构造函数
	 */
	public Evwmslayerfactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCEVWMSLayerFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.Evwmslayerfactory".equals(this.getClass().getName()))
		{
	...
	public Evwmslayerfactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Evwmslayerfactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Evwmslayerfactory fromBaseObject(BaseObject baseObj)
	{
		...
		Evwmslayerfactory obj = null;
 		if(baseObj instanceof Evwmslayerfactory)
		{
			obj = (Evwmslayerfactory)baseObj;
		} else {
