 ...
 * EarthViewKML图层类工厂
 */
public class Evkmllayerfactory extends com.earthview.world.spatial.WebLayerFactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::CEVKMLLayerFactory", new EvkmllayerfactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::JCEVKMLLayerFactoryProxy", new EvkmllayerfactoryClassFactory());
	}

	/**
	 * 默认构造函数
	 */
	public Evkmllayerfactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCEVKMLLayerFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.Evkmllayerfactory".equals(this.getClass().getName()))
		{
	...
	public Evkmllayerfactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Evkmllayerfactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Evkmllayerfactory fromBaseObject(BaseObject baseObj)
	{
		...
		Evkmllayerfactory obj = null;
 		if(baseObj instanceof Evkmllayerfactory)
		{
			obj = (Evkmllayerfactory)baseObj;
		} else {
