 ...
 * EarthViewDEM图层类
 */
public class Evdemlayer extends com.earthview.world.spatial.WebLayer {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::CEVDEMLayer", new EvdemlayerClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::JCEVDEMLayerProxy", new EvdemlayerClassFactory());
	}
	...
	public Evdemlayer() {
		...
		Create("JCEVDEMLayerProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.Evdemlayer".equals(this.getClass().getName()))
		{
	...
	public Evdemlayer(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Evdemlayer(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Evdemlayer fromBaseObject(BaseObject baseObj)
	{
		...
		Evdemlayer obj = null;
 		if(baseObj instanceof Evdemlayer)
		{
			obj = (Evdemlayer)baseObj;
		} else {
