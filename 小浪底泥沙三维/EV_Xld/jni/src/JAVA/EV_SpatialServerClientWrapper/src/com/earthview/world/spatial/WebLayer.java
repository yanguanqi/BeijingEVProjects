 ...
 * 网络图层类
 */
public class WebLayer extends com.earthview.world.spatial.atlas.Ilayer {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::CWebLayer", new WebLayerClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::JCWebLayerProxy", new WebLayerClassFactory());
	}
	...
	/**
	 * 获取当前图层的xml结点描述
	 * @return 当前图层描述的EarthView::World::Core::CXmlElement对象
	 */
	...
	public WebLayer(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public WebLayer(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static WebLayer fromBaseObject(BaseObject baseObj)
	{
		...
		WebLayer obj = null;
 		if(baseObj instanceof WebLayer)
		{
			obj = (WebLayer)baseObj;
		} else {
