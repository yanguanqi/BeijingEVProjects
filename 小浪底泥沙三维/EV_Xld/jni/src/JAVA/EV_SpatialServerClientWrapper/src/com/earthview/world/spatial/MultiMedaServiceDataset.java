 ...
 * EarthView几何数据集类
 */
public class MultiMedaServiceDataset extends com.earthview.world.spatial.WebDataset {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::CMultiMedaServiceDataset", new MultiMedaServiceDatasetClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::JCMultiMedaServiceDatasetProxy", new MultiMedaServiceDatasetClassFactory());
	}
	...
	public MultiMedaServiceDataset(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public MultiMedaServiceDataset(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static MultiMedaServiceDataset fromBaseObject(BaseObject baseObj)
	{
		...
		MultiMedaServiceDataset obj = null;
 		if(baseObj instanceof MultiMedaServiceDataset)
		{
			obj = (MultiMedaServiceDataset)baseObj;
		} else {
