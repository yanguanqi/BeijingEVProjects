 ...
 * EarthViewDEM图层类工厂
 */
public class Evdemlayerfactory extends com.earthview.world.spatial.WebLayerFactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::CEVDEMLayerFactory", new EvdemlayerfactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::JCEVDEMLayerFactoryProxy", new EvdemlayerfactoryClassFactory());
	}

	/**
	 * 默认构造函数
	 */
	public Evdemlayerfactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCEVDEMLayerFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.Evdemlayerfactory".equals(this.getClass().getName()))
		{
	...
	public Evdemlayerfactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Evdemlayerfactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Evdemlayerfactory fromBaseObject(BaseObject baseObj)
	{
		...
		Evdemlayerfactory obj = null;
 		if(baseObj instanceof Evdemlayerfactory)
		{
			obj = (Evdemlayerfactory)baseObj;
		} else {
