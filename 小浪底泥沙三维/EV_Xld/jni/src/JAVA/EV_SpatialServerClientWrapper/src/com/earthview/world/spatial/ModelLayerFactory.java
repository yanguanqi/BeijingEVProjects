 ...
 * EarthView模型图层类工厂
 */
public class ModelLayerFactory extends com.earthview.world.spatial.WebLayerFactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::CModelLayerFactory", new ModelLayerFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::JCModelLayerFactoryProxy", new ModelLayerFactoryClassFactory());
	}
	...
	public ModelLayerFactory() {
		...
		Create("JCModelLayerFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.ModelLayerFactory".equals(this.getClass().getName()))
		{
	...
	public ModelLayerFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ModelLayerFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ModelLayerFactory fromBaseObject(BaseObject baseObj)
	{
		...
		ModelLayerFactory obj = null;
 		if(baseObj instanceof ModelLayerFactory)
		{
			obj = (ModelLayerFactory)baseObj;
		} else {
