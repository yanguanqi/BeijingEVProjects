 ...
 * OGCWMS服务类
 */
public class Wmsserver extends com.earthview.world.spatial.Ogcspatialserver {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::CWMSServer", new WmsserverClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::JCWMSServerProxy", new WmsserverClassFactory());
	}
	 ...
	 * @return 服务器信息对象指针
	 */
	public com.earthview.world.spatial.Wmsserverinfo getServerInfo()
	{
	 ...
	 * @return 指定图层信息
	 */
	public com.earthview.world.spatial.Wmslayerinfo getLayerInfo(long index)
	{
	...
	public Wmsserver(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Wmsserver(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Wmsserver fromBaseObject(BaseObject baseObj)
	{
		...
		Wmsserver obj = null;
 		if(baseObj instanceof Wmsserver)
		{
			obj = (Wmsserver)baseObj;
		} else {
			obj = new Wmsserver(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CWMSServer");
			obj.increaseCast();
		}
