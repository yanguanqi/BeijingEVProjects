 ...
 * EarthViewWFS图层类工厂
 */
public class Evwfslayerfactory extends com.earthview.world.spatial.WebLayerFactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::CEVWFSLayerFactory", new EvwfslayerfactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::JCEVWFSLayerFactoryProxy", new EvwfslayerfactoryClassFactory());
	}

	/**
	 * 默认构造函数
	 */
	public Evwfslayerfactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCEVWFSLayerFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.Evwfslayerfactory".equals(this.getClass().getName()))
		{
	...
	public Evwfslayerfactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Evwfslayerfactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Evwfslayerfactory fromBaseObject(BaseObject baseObj)
	{
		...
		Evwfslayerfactory obj = null;
 		if(baseObj instanceof Evwfslayerfactory)
		{
			obj = (Evwfslayerfactory)baseObj;
		} else {
