...
public class Evmodeltemplatelayer extends com.earthview.world.spatial.WebLayer {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::CEVModelTemplateLayer", new EvmodeltemplatelayerClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::JCEVModelTemplateLayerProxy", new EvmodeltemplatelayerClassFactory());
	}
	...
	native private int getResource_ev_int32_ev_bool_CServerResourceObject(long pNativeObject, int entityid, boolean needorigtexture, long resObject);
	/**
	 * 获取资源
	 * @param entityid id
	 ...
	 * @return ok返回0，其他值均为错误
	 */
	public int getResource(int entityid, boolean needorigtexture, com.earthview.world.spatial.ServerResourceObject resObject)
	{
		int entityidParamValue = entityid;
		boolean needorigtextureParamValue = needorigtexture;
		long resObjectParamValue = resObject.nativeObject.pointer;
		int returnValue = getResource_ev_int32_ev_bool_CServerResourceObject(this.nativeObject.pointer, entityidParamValue, needorigtextureParamValue, resObjectParamValue);
		return returnValue;
	}
	 ...
	 * 析构函数
	 */
	public Evmodeltemplatelayer() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCEVModelTemplateLayerProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.Evmodeltemplatelayer".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
		}
	}

	public Evmodeltemplatelayer(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Evmodeltemplatelayer(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Evmodeltemplatelayer fromBaseObject(BaseObject baseObj)
	{
		...
		Evmodeltemplatelayer obj = null;
 		if(baseObj instanceof Evmodeltemplatelayer)
		{
			obj = (Evmodeltemplatelayer)baseObj;
		} else {
