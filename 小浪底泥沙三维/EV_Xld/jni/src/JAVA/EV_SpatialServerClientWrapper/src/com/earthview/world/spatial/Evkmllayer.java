 ...
 * EarthViewKML图层类
 */
public class Evkmllayer extends com.earthview.world.spatial.WebLayer {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::CEVKMLLayer", new EvkmllayerClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::JCEVKMLLayerProxy", new EvkmllayerClassFactory());
	}
	...
	public Evkmllayer() {
		...
		Create("JCEVKMLLayerProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.Evkmllayer".equals(this.getClass().getName()))
		{
	...
	native private int getKMLFile_EVString_CMemoryStreamResult(long pNativeObject, String dataName, long serverresult);
	/**
	 * 获取KML文件
	 * @param dataName 数据名
	 ...
	 */
	public int getKMLFile(String dataName, com.earthview.world.spatial.MemoryStreamResult serverresult)
	{
		String dataNameParamValue = dataName;
		long serverresultParamValue = serverresult.nativeObject.pointer;
		int returnValue = getKMLFile_EVString_CMemoryStreamResult(this.nativeObject.pointer, dataNameParamValue, serverresultParamValue);
		return returnValue;
	}
	 ...
	 * @return 元数据对象指针
	 */
	public com.earthview.world.spatial.Evkmllayerinfo getLayerInfoRef()
	{
		long returnValue = getLayerInfoRef_void(this.nativeObject.pointer);
		if(returnValue == 0L) {
			return null;
		}
		com.earthview.world.spatial.Evkmllayerinfo __returnValue = new com.earthview.world.spatial.Evkmllayerinfo(CreatedWhenConstruct.CWC_NotToCreate, "CEVKMLLayerInfo");
		...
		{
			__returnValue.setDelegate(true);
			__returnValue = (com.earthview.world.spatial.Evkmllayerinfo)__returnValueClassFactory.create();
			__returnValue.setDelegate(true);
			__returnValue.bindNativeObject(__instancePointer, "CEVKMLLayerInfo");
		}
		return __returnValue;
	}
	public Evkmllayer(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Evkmllayer(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Evkmllayer fromBaseObject(BaseObject baseObj)
	{
		...
		Evkmllayer obj = null;
 		if(baseObj instanceof Evkmllayer)
		{
			obj = (Evkmllayer)baseObj;
		} else {
