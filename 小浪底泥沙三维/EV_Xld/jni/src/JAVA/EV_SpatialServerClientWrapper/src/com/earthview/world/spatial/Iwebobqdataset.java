 ...
 * EarthViewOBQ数据集类
 */
public class Iwebobqdataset extends com.earthview.world.spatial.WebDataset {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::IWebOBQDataset", new IwebobqdatasetClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::JIWebOBQDatasetProxy", new IwebobqdatasetClassFactory());
	}

	protected  String getGUID_void_callback()
	{
		String returnValue = getGUID();
	...
	native private String getGUID_void_NoVirtual(long pNativeObject);
	protected String getGUID_NoVirtual()
	{
		String returnValue = getGUID_void_NoVirtual(this.nativeObject.pointer);
		return returnValue;
	}
	...
	protected  int readInitData_MemoryDataStreamPtr_callback(long streamPackage)
	{
		...
		int returnValue = readInitData(streamPackageParamValue);
	...
	protected  int readTileData_EVString_MemoryDataStreamPtr_callback(String url, long streamPackage)
	{
		...
		int returnValue = readTileData(urlParamValue, streamPackageParamValue);
		int __returnValue = returnValue;
		return __returnValue;
	}
	...
	protected  int readDem_EVString_MemoryDataStreamPtr_callback(String url, long streamPackage)
	{
		String urlParamValue = url;
		com.earthview.world.core.MemoryDataStreamPtr streamPackageParamValue = new com.earthview.world.core.MemoryDataStreamPtr(CreatedWhenConstruct.CWC_NotToCreate);
		streamPackageParamValue.setDelegate(true);
		...
		int returnValue = readDem(urlParamValue, streamPackageParamValue);
		int __returnValue = returnValue;
		return __returnValue;
	}
	...
	protected  int readTileMeshData_EVString_MemoryDataStreamPtr_callback(String url, long streamPackage)
	{
		String urlParamValue = url;
		com.earthview.world.core.MemoryDataStreamPtr streamPackageParamValue = new com.earthview.world.core.MemoryDataStreamPtr(CreatedWhenConstruct.CWC_NotToCreate);
		streamPackageParamValue.setDelegate(true);
		...
		int returnValue = readTileMeshData(urlParamValue, streamPackageParamValue);
		int __returnValue = returnValue;
		return __returnValue;
	}
	...
	public Iwebobqdataset(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Iwebobqdataset(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Iwebobqdataset fromBaseObject(BaseObject baseObj)
	{
		...
		Iwebobqdataset obj = null;
 		if(baseObj instanceof Iwebobqdataset)
		{
			obj = (Iwebobqdataset)baseObj;
		} else {
