 ...
 * EarthViewKML数据集类
 */
public class Evkmldataset extends com.earthview.world.spatial.WebDataset {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::CEVKMLDataset", new EvkmldatasetClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::JCEVKMLDatasetProxy", new EvkmldatasetClassFactory());
	}
	...
	public Evkmldataset(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Evkmldataset(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Evkmldataset fromBaseObject(BaseObject baseObj)
	{
		...
		Evkmldataset obj = null;
 		if(baseObj instanceof Evkmldataset)
		{
			obj = (Evkmldataset)baseObj;
		} else {
