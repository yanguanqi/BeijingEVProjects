 ...
 * EarthViewMESHXG数据集类
 */
public class WebMeshXGDataset extends com.earthview.world.spatial.Iwebobqdataset {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::CWebMeshXGDataset", new WebMeshXGDatasetClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::JCWebMeshXGDatasetProxy", new WebMeshXGDatasetClassFactory());
	}
	...
	protected  int getWFSMetaData_EVString_CDataMetaInfo_callback(String servicename, long metadata)
	{
		...
		com.earthview.world.spatial.geodataset.DataMetaInfo metadataParamValue = new com.earthview.world.spatial.geodataset.DataMetaInfo(CreatedWhenConstruct.CWC_NotToCreate);
		...
		{
			metadataParamValue.setDelegate(true);
			metadataParamValue = (com.earthview.world.spatial.geodataset.DataMetaInfo)metadataParamValueClassFactory.create();
			metadataParamValue.setDelegate(true);
			metadataParamValue.setInstancePointer(new InstancePointer(metadata));
		}
	 ...
	 * @return 失败返回-1
	 */
	public int getWFSMetaData(String servicename, com.earthview.world.spatial.geodataset.DataMetaInfo metadata)
	{
		String servicenameParamValue = servicename;
	...
	protected int getWFSMetaData_NoVirtual(String servicename, com.earthview.world.spatial.geodataset.DataMetaInfo metadata)
	{
		String servicenameParamValue = servicename;
		long metadataParamValue = metadata.nativeObject.pointer;
	...
	{
		String servicenameParamValue = servicename;
		com.earthview.world.spatial.geodataset.Fields fieldsParamValue = new com.earthview.world.spatial.geodataset.Fields(CreatedWhenConstruct.CWC_NotToCreate);
		...
		{
			fieldsParamValue.setDelegate(true);
			fieldsParamValue = (com.earthview.world.spatial.geodataset.Fields)fieldsParamValueClassFactory.create();
			fieldsParamValue.setDelegate(true);
			fieldsParamValue.setInstancePointer(new InstancePointer(fields));
		}
	 ...
	 * @return 失败返回-1
	 */
	public int getFields(String servicename, com.earthview.world.spatial.geodataset.Fields fields)
	{
		String servicenameParamValue = servicename;
	...
	protected int getFields_NoVirtual(String servicename, com.earthview.world.spatial.geodataset.Fields fields)
	{
		String servicenameParamValue = servicename;
		long fieldsParamValue = fields.nativeObject.pointer;
	...
	protected  int getFeatures_EVString_CQueryFilter_ModelFeatureVector_callback(String servicename, long filter, long featurevector)
	{
		String servicenameParamValue = servicename;
		com.earthview.world.spatial.geodataset.QueryFilter filterParamValue = new com.earthview.world.spatial.geodataset.QueryFilter(CreatedWhenConstruct.CWC_NotToCreate);
		...
		{
			filterParamValue.setDelegate(true);
			filterParamValue = (com.earthview.world.spatial.geodataset.QueryFilter)filterParamValueClassFactory.create();
			filterParamValue.setDelegate(true);
			filterParamValue.setInstancePointer(new InstancePointer(filter));
		}
		com.earthview.world.spatial.download.ModelFeatureVector featurevectorParamValue = new com.earthview.world.spatial.download.ModelFeatureVector(CreatedWhenConstruct.CWC_NotToCreate);
		...
		{
			featurevectorParamValue.setDelegate(true);
			featurevectorParamValue = (com.earthview.world.spatial.download.ModelFeatureVector)featurevectorParamValueClassFactory.create();
			featurevectorParamValue.setDelegate(true);
			featurevectorParamValue.setInstancePointer(new InstancePointer(featurevector));
		}
		int returnValue = getFeatures(servicenameParamValue, filterParamValue, featurevectorParamValue);
		int __returnValue = returnValue;
		return __returnValue;
	}

	native private int getFeatures_EVString_CQueryFilter_ModelFeatureVector(long pNativeObject, String servicename, long filter, long featurevector);
	/**
	 * 读取要素数据
	 * @param  
	 * @return 失败返回-1
	 */
	public int getFeatures(String servicename, com.earthview.world.spatial.geodataset.QueryFilter filter, com.earthview.world.spatial.download.ModelFeatureVector featurevector)
	{
		String servicenameParamValue = servicename;
		long filterParamValue = filter.nativeObject.pointer;
		long featurevectorParamValue = featurevector.nativeObject.pointer;
		int returnValue = getFeatures_EVString_CQueryFilter_ModelFeatureVector(this.nativeObject.pointer, servicenameParamValue, filterParamValue, featurevectorParamValue);
		return returnValue;
	}
	native private int getFeatures_EVString_CQueryFilter_ModelFeatureVector_NoVirtual(long pNativeObject, String servicename, long filter, long featurevector);
	protected int getFeatures_NoVirtual(String servicename, com.earthview.world.spatial.geodataset.QueryFilter filter, com.earthview.world.spatial.download.ModelFeatureVector featurevector)
	{
		String servicenameParamValue = servicename;
		long filterParamValue = filter.nativeObject.pointer;
		long featurevectorParamValue = featurevector.nativeObject.pointer;
		int returnValue = getFeatures_EVString_CQueryFilter_ModelFeatureVector_NoVirtual(this.nativeObject.pointer, servicenameParamValue, filterParamValue, featurevectorParamValue);
		return returnValue;
	}

	public WebMeshXGDataset(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public WebMeshXGDataset(CreatedWhenConstruct cwc, String classNameStr) {
	...
	{
		return super.readTileMeshData_NoVirtual(url, streamPackage);
	}
	/**
	 * 获取数据集类型
	 * @param  
	...
	native protected void register_getFeatures_EVString_CQueryFilter_ModelFeatureVector(long pNativeObject, String method);
	...
	public void registerCallback(){
		if (!this.nativeObject.equals(InstancePointer.ZERO)){
			...
			this.register_getFeatures_EVString_CQueryFilter_ModelFeatureVector(this.nativeObject.pointer, "getFeatures_EVString_CQueryFilter_ModelFeatureVector_callback");
	...
	public static WebMeshXGDataset fromBaseObject(BaseObject baseObj)
	{
		...
		WebMeshXGDataset obj = null;
 		if(baseObj instanceof WebMeshXGDataset)
		{
			obj = (WebMeshXGDataset)baseObj;
		} else {
