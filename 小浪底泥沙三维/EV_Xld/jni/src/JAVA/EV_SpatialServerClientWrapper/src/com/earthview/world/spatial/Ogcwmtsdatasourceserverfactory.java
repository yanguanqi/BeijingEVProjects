...
public class Ogcwmtsdatasourceserverfactory extends com.earthview.world.spatial.geodataset.Idatasourcefactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::COGCWMTSDataSourceServerFactory", new OgcwmtsdatasourceserverfactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::JCOGCWMTSDataSourceServerFactoryProxy", new OgcwmtsdatasourceserverfactoryClassFactory());
	}
	 ...
	 * @return 对象指针
	 */
	public static com.earthview.world.spatial.Ogcwmtsdatasourceserverfactory getInstance()
	{
		long returnValue = getInstance_void();
		if(returnValue == 0L) {
			return null;
		}
		com.earthview.world.spatial.Ogcwmtsdatasourceserverfactory __returnValue = new com.earthview.world.spatial.Ogcwmtsdatasourceserverfactory(CreatedWhenConstruct.CWC_NotToCreate, "COGCWMTSDataSourceServerFactory");
		__returnValue.setDelegate(true);
		InstancePointer __instancePointer = new InstancePointer(returnValue);
		__returnValue.setInstancePointer(__instancePointer);
		IClassFactory __returnValueClassFactory = GlobalClassFactoryMap.get(__returnValue.getCppInstanceTypeName());
		...
		{
			__returnValue.setDelegate(true);
			__returnValue = (com.earthview.world.spatial.Ogcwmtsdatasourceserverfactory)__returnValueClassFactory.create();
			__returnValue.setDelegate(true);
			__returnValue.bindNativeObject(__instancePointer, "COGCWMTSDataSourceServerFactory");
		}
		return __returnValue;
	}
	public Ogcwmtsdatasourceserverfactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Ogcwmtsdatasourceserverfactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Ogcwmtsdatasourceserverfactory fromBaseObject(BaseObject baseObj)
	{
		...
		Ogcwmtsdatasourceserverfactory obj = null;
 		if(baseObj instanceof Ogcwmtsdatasourceserverfactory)
		{
			obj = (Ogcwmtsdatasourceserverfactory)baseObj;
		} else {
