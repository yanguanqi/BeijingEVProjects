 ...
 * EarthView几何图层类工厂
 */
public class GeometryLayerFactory extends com.earthview.world.spatial.WebLayerFactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::CGeometryLayerFactory", new GeometryLayerFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::JCGeometryLayerFactoryProxy", new GeometryLayerFactoryClassFactory());
	}

	/**
	 * 默认构造函数
	 */
	public GeometryLayerFactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCGeometryLayerFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.GeometryLayerFactory".equals(this.getClass().getName()))
		{
	...
	public GeometryLayerFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public GeometryLayerFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static GeometryLayerFactory fromBaseObject(BaseObject baseObj)
	{
		...
		GeometryLayerFactory obj = null;
 		if(baseObj instanceof GeometryLayerFactory)
		{
			obj = (GeometryLayerFactory)baseObj;
		} else {
