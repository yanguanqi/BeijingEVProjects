...
public class Evwmsimagedataset extends com.earthview.world.spatial.WebDataset {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::CEVWMSImageDataset", new EvwmsimagedatasetClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::JCEVWMSImageDatasetProxy", new EvwmsimagedatasetClassFactory());
	}
	...
	public com.earthview.world.spatial.Evwmsimageinfo getLayerInfoRef()
	{
		long returnValue = getLayerInfoRef_void(this.nativeObject.pointer);
		if(returnValue == 0L) {
			return null;
		}
		com.earthview.world.spatial.Evwmsimageinfo __returnValue = new com.earthview.world.spatial.Evwmsimageinfo(CreatedWhenConstruct.CWC_NotToCreate, "CEVWMSImageInfo");
		...
		{
			__returnValue.setDelegate(true);
			__returnValue = (com.earthview.world.spatial.Evwmsimageinfo)__returnValueClassFactory.create();
			__returnValue.setDelegate(true);
			__returnValue.bindNativeObject(__instancePointer, "CEVWMSImageInfo");
		}
		return __returnValue;
	}
	public Evwmsimagedataset(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Evwmsimagedataset(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Evwmsimagedataset fromBaseObject(BaseObject baseObj)
	{
		...
		Evwmsimagedataset obj = null;
 		if(baseObj instanceof Evwmsimagedataset)
		{
			obj = (Evwmsimagedataset)baseObj;
		} else {
