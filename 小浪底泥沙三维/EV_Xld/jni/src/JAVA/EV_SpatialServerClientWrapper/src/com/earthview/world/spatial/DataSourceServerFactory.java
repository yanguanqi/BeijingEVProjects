 ...
 * 服务连接类工厂
 */
public class DataSourceServerFactory extends com.earthview.world.spatial.geodataset.Idatasourcefactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::CDataSourceServerFactory", new DataSourceServerFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::JCDataSourceServerFactoryProxy", new DataSourceServerFactoryClassFactory());
	}
	 ...
	 * @return 对象指针
	 */
	public static com.earthview.world.spatial.DataSourceServerFactory getInstance()
	{
		long returnValue = getInstance_void();
		if(returnValue == 0L) {
			return null;
		}
		com.earthview.world.spatial.DataSourceServerFactory __returnValue = new com.earthview.world.spatial.DataSourceServerFactory(CreatedWhenConstruct.CWC_NotToCreate, "CDataSourceServerFactory");
		__returnValue.setDelegate(true);
		InstancePointer __instancePointer = new InstancePointer(returnValue);
		__returnValue.setInstancePointer(__instancePointer);
		IClassFactory __returnValueClassFactory = GlobalClassFactoryMap.get(__returnValue.getCppInstanceTypeName());
		...
		{
			__returnValue.setDelegate(true);
			__returnValue = (com.earthview.world.spatial.DataSourceServerFactory)__returnValueClassFactory.create();
			__returnValue.setDelegate(true);
			__returnValue.bindNativeObject(__instancePointer, "CDataSourceServerFactory");
		}
		return __returnValue;
	}
	public DataSourceServerFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public DataSourceServerFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static DataSourceServerFactory fromBaseObject(BaseObject baseObj)
	{
		...
		DataSourceServerFactory obj = null;
 		if(baseObj instanceof DataSourceServerFactory)
		{
			obj = (DataSourceServerFactory)baseObj;
		} else {
