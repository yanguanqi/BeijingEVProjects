...
public class Ogcwfsdatasourceserverfactory extends com.earthview.world.spatial.geodataset.Idatasourcefactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::COGCWFSDataSourceServerFactory", new OgcwfsdatasourceserverfactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::JCOGCWFSDataSourceServerFactoryProxy", new OgcwfsdatasourceserverfactoryClassFactory());
	}
	 ...
	 * @return 对象指针
	 */
	public static com.earthview.world.spatial.Ogcwfsdatasourceserverfactory getInstance()
	{
		long returnValue = getInstance_void();
		if(returnValue == 0L) {
			return null;
		}
		com.earthview.world.spatial.Ogcwfsdatasourceserverfactory __returnValue = new com.earthview.world.spatial.Ogcwfsdatasourceserverfactory(CreatedWhenConstruct.CWC_NotToCreate, "COGCWFSDataSourceServerFactory");
		__returnValue.setDelegate(true);
		InstancePointer __instancePointer = new InstancePointer(returnValue);
		__returnValue.setInstancePointer(__instancePointer);
		IClassFactory __returnValueClassFactory = GlobalClassFactoryMap.get(__returnValue.getCppInstanceTypeName());
		...
		{
			__returnValue.setDelegate(true);
			__returnValue = (com.earthview.world.spatial.Ogcwfsdatasourceserverfactory)__returnValueClassFactory.create();
			__returnValue.setDelegate(true);
			__returnValue.bindNativeObject(__instancePointer, "COGCWFSDataSourceServerFactory");
		}
		return __returnValue;
	}
	public Ogcwfsdatasourceserverfactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Ogcwfsdatasourceserverfactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Ogcwfsdatasourceserverfactory fromBaseObject(BaseObject baseObj)
	{
		...
		Ogcwfsdatasourceserverfactory obj = null;
 		if(baseObj instanceof Ogcwfsdatasourceserverfactory)
		{
			obj = (Ogcwfsdatasourceserverfactory)baseObj;
		} else {
