 ...
 * OGCWMS服务信息类
 */
public class Wmsserverinfo extends com.earthview.world.spatial.ServerInfo {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::CWMSServerInfo", new WmsserverinfoClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::JCWMSServerInfoProxy", new WmsserverinfoClassFactory());
	}
	...
	native private long getUserDefinedSymbolizationRef_void(long pNativeObject);
	/**
	 * 获取用户自定义符号
	 * @return 用户自定义符号
	 */
	public com.earthview.world.spatial.Ogcwmsuserdefinedsymbolization getUserDefinedSymbolizationRef()
	{
		long returnValue = getUserDefinedSymbolizationRef_void(this.nativeObject.pointer);
		if(returnValue == 0L) {
			return null;
		}
		com.earthview.world.spatial.Ogcwmsuserdefinedsymbolization __returnValue = new com.earthview.world.spatial.Ogcwmsuserdefinedsymbolization(new InstancePointer(returnValue));
		return __returnValue;
	}
	...
	native private long getImageMaxWidth_void(long pNativeObject);
	/**
	 * 获取图片的宽的最大值
	 * @return 图片宽的最大值
	 */
	...
	{
		long returnValue = getImageMaxWidth_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private long getImageMaxHeight_void(long pNativeObject);
	/**
	 * 获取图片的高的最大值
	 * @return 图片高的最大值
	 */
	...
	{
		long returnValue = getImageMaxHeight_void(this.nativeObject.pointer);
		return returnValue;
	}
	...
	public Wmsserverinfo(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Wmsserverinfo(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Wmsserverinfo fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		Wmsserverinfo obj = null;
 		if(baseObj instanceof Wmsserverinfo)
		{
			obj = (Wmsserverinfo)baseObj;
		} else {
			obj = new Wmsserverinfo(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CWMSServerInfo");
			obj.increaseCast();
		}
