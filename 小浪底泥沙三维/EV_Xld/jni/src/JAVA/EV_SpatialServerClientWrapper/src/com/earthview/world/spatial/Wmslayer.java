 ...
 * OGCWMS图层类
 */
public class Wmslayer extends com.earthview.world.spatial.WebLayer {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::CWMSLayer", new WmslayerClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::JCWMSLayerProxy", new WmslayerClassFactory());
	}
	...
	public Wmslayer() {
		...
		Create("JCWMSLayerProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.Wmslayer".equals(this.getClass().getName()))
		{
	...
	native private void setDiaplaySRS_EVString(long pNativeObject, String srs);
	/**
	...
	public void setDiaplaySRS(String srs)
	{
		...
		setDiaplaySRS_EVString(this.nativeObject.pointer, srsParamValue);
	}
	native private long getDisplaySRS_void(long pNativeObject);
	/**
	 * 获取显示投影
	 * @return 显示投影
	 */
	public StringPointer getDisplaySRS()
	{
		long returnValue = getDisplaySRS_void(this.nativeObject.pointer);
	...
	native private void setDisplayStyle_EVString(long pNativeObject, String styles);
	/**
	 * 设置显示风格
	 * @param style 风格列表
	 */
	public void setDisplayStyle(String styles)
	{
		...
		setDisplayStyle_EVString(this.nativeObject.pointer, stylesParamValue);
	}
	...
	native private String getElevation_void(long pNativeObject);
	/**
	 * 获取高程信息
	 * @return 高程信息
	 */
	...
	{
		String returnValue = getElevation_void(this.nativeObject.pointer);
		return returnValue;
	}
	...
	native private String getTime_void(long pNativeObject);
	/**
	 * 获取时间信息
	 * @return 时间信息
	 */
	...
	{
		String returnValue = getTime_void(this.nativeObject.pointer);
		return returnValue;
	}
	public Wmslayer(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Wmslayer(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Wmslayer fromBaseObject(BaseObject baseObj)
	{
		...
		Wmslayer obj = null;
 		if(baseObj instanceof Wmslayer)
		{
			obj = (Wmslayer)baseObj;
		} else {
