 ...
 * 网络图层类工厂
 */
public class WebLayerFactory extends com.earthview.world.spatial.atlas.Ilayerfactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::CWebLayerFactory", new WebLayerFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::JCWebLayerFactoryProxy", new WebLayerFactoryClassFactory());
	}
	...
	public WebLayerFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public WebLayerFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static WebLayerFactory fromBaseObject(BaseObject baseObj)
	{
		...
		WebLayerFactory obj = null;
 		if(baseObj instanceof WebLayerFactory)
		{
			obj = (WebLayerFactory)baseObj;
		} else {
