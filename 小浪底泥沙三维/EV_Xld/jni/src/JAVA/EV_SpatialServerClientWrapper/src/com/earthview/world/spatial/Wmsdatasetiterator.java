 ...
 * OGCWMS网络数据集迭代器类
 */
public class Wmsdatasetiterator extends com.earthview.world.spatial.WebDatasetIterator {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::CWMSDatasetIterator", new WmsdatasetiteratorClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::JCWMSDatasetIteratorProxy", new WmsdatasetiteratorClassFactory());
	}
	...
	public Wmsdatasetiterator(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Wmsdatasetiterator(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Wmsdatasetiterator fromBaseObject(BaseObject baseObj)
	{
		...
		Wmsdatasetiterator obj = null;
 		if(baseObj instanceof Wmsdatasetiterator)
		{
			obj = (Wmsdatasetiterator)baseObj;
		} else {
