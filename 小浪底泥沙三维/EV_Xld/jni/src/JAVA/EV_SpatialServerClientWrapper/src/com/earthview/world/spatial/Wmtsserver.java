 ...
 * OGCWMTS服务类
 */
public class Wmtsserver extends com.earthview.world.spatial.Ogcspatialserver {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::CWMTSServer", new WmtsserverClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::JCWMTSServerProxy", new WmtsserverClassFactory());
	}
	...
	native private long getLayerInfoRef_EVString(long pNativeObject, String tilematrix);
	/**
	 * 获取指定图层信息
	 * @param tilematrix tilematrix名称
	 * @return 指定图层信息
	 */
	public com.earthview.world.spatial.Wmtslayerinfo getLayerInfoRef(String tilematrix)
	{
		String tilematrixParamValue = tilematrix;
		long returnValue = getLayerInfoRef_EVString(this.nativeObject.pointer, tilematrixParamValue);
		if(returnValue == 0L) {
			return null;
		}
		com.earthview.world.spatial.Wmtslayerinfo __returnValue = new com.earthview.world.spatial.Wmtslayerinfo(CreatedWhenConstruct.CWC_NotToCreate, "CWMTSLayerInfo");
	...
	public Wmtsserver(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Wmtsserver(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Wmtsserver fromBaseObject(BaseObject baseObj)
	{
		...
		Wmtsserver obj = null;
 		if(baseObj instanceof Wmtsserver)
		{
			obj = (Wmtsserver)baseObj;
		} else {
			obj = new Wmtsserver(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CWMTSServer");
			obj.increaseCast();
		}
