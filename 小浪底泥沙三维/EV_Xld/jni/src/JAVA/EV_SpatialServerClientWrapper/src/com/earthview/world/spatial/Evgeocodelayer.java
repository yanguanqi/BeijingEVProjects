 ...
 * EarthView地理编码图层类
 */
public class Evgeocodelayer extends com.earthview.world.spatial.WebLayer {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::CEVGeoCodeLayer", new EvgeocodelayerClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::JCEVGeoCodeLayerProxy", new EvgeocodelayerClassFactory());
	}

	/**
	 * 构造函数
	 */
	public Evgeocodelayer() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCEVGeoCodeLayerProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.Evgeocodelayer".equals(this.getClass().getName()))
		{
	...
	public Evgeocodelayer(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Evgeocodelayer(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Evgeocodelayer fromBaseObject(BaseObject baseObj)
	{
		...
		Evgeocodelayer obj = null;
 		if(baseObj instanceof Evgeocodelayer)
		{
			obj = (Evgeocodelayer)baseObj;
		} else {
