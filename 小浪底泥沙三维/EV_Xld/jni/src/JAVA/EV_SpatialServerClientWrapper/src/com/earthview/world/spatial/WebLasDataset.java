...
public class WebLasDataset extends com.earthview.world.spatial.Iwebobqdataset {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::CWebLasDataset", new WebLasDatasetClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::JCWebLasDatasetProxy", new WebLasDatasetClassFactory());
	}
	...
	protected  int getFeatures_ev_int32_EVLasFeatureVector_callback(int type, long featurevector)
	{
		...
		int returnValue = getFeatures(typeParamValue, featurevectorParamValue);
		int __returnValue = returnValue;
		return __returnValue;
	}

	native private int getFeatures_ev_int32_EVLasFeatureVector(long pNativeObject, int type, long featurevector);
	/**
	 * 读取要素数据
	 * @param  
	 * @return 失败返回-1
	 */
	public int getFeatures(int type, com.earthview.world.spatial.download.Evlasfeaturevector featurevector)
	{
		int typeParamValue = type;
		long featurevectorParamValue = featurevector.nativeObject.pointer;
		int returnValue = getFeatures_ev_int32_EVLasFeatureVector(this.nativeObject.pointer, typeParamValue, featurevectorParamValue);
		return returnValue;
	}
	native private int getFeatures_ev_int32_EVLasFeatureVector_NoVirtual(long pNativeObject, int type, long featurevector);
	protected int getFeatures_NoVirtual(int type, com.earthview.world.spatial.download.Evlasfeaturevector featurevector)
	{
		int typeParamValue = type;
		long featurevectorParamValue = featurevector.nativeObject.pointer;
		int returnValue = getFeatures_ev_int32_EVLasFeatureVector_NoVirtual(this.nativeObject.pointer, typeParamValue, featurevectorParamValue);
		return returnValue;
	}

	public WebLasDataset(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public WebLasDataset(CreatedWhenConstruct cwc, String classNameStr) {
	...
	native protected void register_getFeatures_ev_int32_EVLasFeatureVector(long pNativeObject, String method);
	...
	public void registerCallback(){
		if (!this.nativeObject.equals(InstancePointer.ZERO)){
			this.register_getFeatures_ev_int32_EVLasFeatureVector(this.nativeObject.pointer, "getFeatures_ev_int32_EVLasFeatureVector_callback");
	...
	public static WebLasDataset fromBaseObject(BaseObject baseObj)
	{
		...
		WebLasDataset obj = null;
 		if(baseObj instanceof WebLasDataset)
		{
			obj = (WebLasDataset)baseObj;
		} else {
