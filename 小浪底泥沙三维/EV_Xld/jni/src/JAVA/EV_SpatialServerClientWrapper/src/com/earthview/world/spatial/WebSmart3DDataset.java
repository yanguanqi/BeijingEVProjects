 ...
 * EarthViewOBQ数据集类
 */
public class WebSmart3DDataset extends com.earthview.world.spatial.Iwebobqdataset {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::CWebSmart3DDataset", new WebSmart3DDatasetClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::JCWebSmart3DDatasetProxy", new WebSmart3DDatasetClassFactory());
	}
	...
	public WebSmart3DDataset(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public WebSmart3DDataset(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static WebSmart3DDataset fromBaseObject(BaseObject baseObj)
	{
		...
		WebSmart3DDataset obj = null;
 		if(baseObj instanceof WebSmart3DDataset)
		{
			obj = (WebSmart3DDataset)baseObj;
		} else {
