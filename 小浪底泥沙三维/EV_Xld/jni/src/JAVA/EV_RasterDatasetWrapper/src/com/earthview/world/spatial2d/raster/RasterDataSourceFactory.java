...
public class RasterDataSourceFactory extends com.earthview.world.spatial.geodataset.Idatasourcefactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Raster::CRasterDataSourceFactory", new RasterDataSourceFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Raster::JCRasterDataSourceFactoryProxy", new RasterDataSourceFactoryClassFactory());
	}
	 ...
	 * @return 栅格数据源工厂
	 */
	public static com.earthview.world.spatial2d.raster.RasterDataSourceFactory getSingletonPtr()
	{
		long returnValue = getSingletonPtr_void();
		if(returnValue == 0L) {
			return null;
		}
		com.earthview.world.spatial2d.raster.RasterDataSourceFactory __returnValue = new com.earthview.world.spatial2d.raster.RasterDataSourceFactory(CreatedWhenConstruct.CWC_NotToCreate, "CRasterDataSourceFactory");
		__returnValue.setDelegate(true);
		InstancePointer __instancePointer = new InstancePointer(returnValue);
		__returnValue.setInstancePointer(__instancePointer);
		IClassFactory __returnValueClassFactory = GlobalClassFactoryMap.get(__returnValue.getCppInstanceTypeName());
		...
		{
			__returnValue.setDelegate(true);
			__returnValue = (com.earthview.world.spatial2d.raster.RasterDataSourceFactory)__returnValueClassFactory.create();
			__returnValue.setDelegate(true);
			__returnValue.bindNativeObject(__instancePointer, "CRasterDataSourceFactory");
		}
		return __returnValue;
	}
	public RasterDataSourceFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public RasterDataSourceFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static RasterDataSourceFactory fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		RasterDataSourceFactory obj = null;
 		if(baseObj instanceof RasterDataSourceFactory)
		{
			obj = (RasterDataSourceFactory)baseObj;
		} else {
			obj = new RasterDataSourceFactory(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CRasterDataSourceFactory");
			obj.increaseCast();
		}
