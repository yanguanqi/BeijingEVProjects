...
////rasterlayerPlayer
public class RasterLayerFactory extends com.earthview.world.spatial.atlas.Ilayerfactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Raster::RasterLayerFactory", new RasterLayerFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Raster::JRasterLayerFactoryProxy", new RasterLayerFactoryClassFactory());
	}

	public RasterLayerFactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JRasterLayerFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.raster.RasterLayerFactory".equals(this.getClass().getName()))
		{
	...
	public RasterLayerFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public RasterLayerFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static RasterLayerFactory fromBaseObject(BaseObject baseObj)
	{
		...
		RasterLayerFactory obj = null;
 		if(baseObj instanceof RasterLayerFactory)
		{
			obj = (RasterLayerFactory)baseObj;
		} else {
