...
///插入几何图形 
public class Ielement extends com.earthview.world.core.AllocatedObject {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Carto::IElement", new IelementClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Carto::JIElementProxy", new IelementClassFactory());
	}
	...
	public Ielement(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Ielement(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Ielement fromBaseObject(BaseObject baseObj)
	{
		...
		Ielement obj = null;
 		if(baseObj instanceof Ielement)
		{
			obj = (Ielement)baseObj;
		} else {
