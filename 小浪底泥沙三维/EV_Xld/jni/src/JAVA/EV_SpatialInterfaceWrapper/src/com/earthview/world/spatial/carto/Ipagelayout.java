...
public class Ipagelayout extends com.earthview.world.core.AllocatedObject {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Carto::IPageLayout", new IpagelayoutClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Carto::JIPageLayoutProxy", new IpagelayoutClassFactory());
	}
	...
	{
		com.earthview.world.spatial.carto.Ipage returnValue = getPage();
		if(returnValue == null) {
			return 0L;
		}
	...
	protected com.earthview.world.spatial.carto.Ipage getPage_NoVirtual()
	{
	...
	{
		com.earthview.world.spatial.carto.Ipage pPageParamValue = (pPage == 0L ? null : new com.earthview.world.spatial.carto.Ipage(CreatedWhenConstruct.CWC_NotToCreate));
		...
		{
			pPageParamValue.setDelegate(true);
			pPageParamValue = (com.earthview.world.spatial.carto.Ipage)pPageParamValueClassFactory.create();
			pPageParamValue.setDelegate(true);
			pPageParamValue.setInstancePointer(new InstancePointer(pPage));
		}
		}
	 ...
	 * @return 页面纸张
	 */
	public void setPage(com.earthview.world.spatial.carto.Ipage pPage)
	{
	...
	protected void setPage_NoVirtual(com.earthview.world.spatial.carto.Ipage pPage)
	{
		long pPageParamValue = (pPage == null ? 0L : pPage.nativeObject.pointer);
		setPage_IPage_NoVirtual(this.nativeObject.pointer, pPageParamValue);
	}

	protected  long createElement_EVElementType_callback(int elementType)
	{
		com.earthview.world.spatial.carto.EVElementType elementTypeParamValue = com.earthview.world.spatial.carto.EVElementType.toEnum(elementType);
		com.earthview.world.spatial.carto.Ielement returnValue = createElement(elementTypeParamValue);
		if(returnValue == null) {
			return 0L;
		}
		returnValue.setDelegate(true);
	...
	native private long createElement_EVElementType(long pNativeObject, int elementType);
	/**
	 * 创建地图周边元素
	 * @param scale 元素类型
	 */
	public com.earthview.world.spatial.carto.Ielement createElement(com.earthview.world.spatial.carto.EVElementType elementType)
	{
		int elementTypeParamValue = elementType.getValue();
		long returnValue = createElement_EVElementType(this.nativeObject.pointer, elementTypeParamValue);
		if(returnValue == 0L) {
			return null;
		}
	...
	native private long createElement_EVElementType_NoVirtual(long pNativeObject, int elementType);
	protected com.earthview.world.spatial.carto.Ielement createElement_NoVirtual(com.earthview.world.spatial.carto.EVElementType elementType)
	{
		int elementTypeParamValue = elementType.getValue();
		long returnValue = createElement_EVElementType_NoVirtual(this.nativeObject.pointer, elementTypeParamValue);
		if(returnValue == 0L) {
			return null;
		}
		com.earthview.world.spatial.carto.Ielement __returnValue = new com.earthview.world.spatial.carto.Ielement(CreatedWhenConstruct.CWC_NotToCreate, "IElement");
	...
	protected  void addElement_IElement_callback(long pElement)
	{
		com.earthview.world.spatial.carto.Ielement pElementParamValue = (pElement == 0L ? null : new com.earthview.world.spatial.carto.Ielement(CreatedWhenConstruct.CWC_NotToCreate));
		...
		{
			pElementParamValue.setDelegate(true);
			pElementParamValue = (com.earthview.world.spatial.carto.Ielement)pElementParamValueClassFactory.create();
			pElementParamValue.setDelegate(true);
			pElementParamValue.setInstancePointer(new InstancePointer(pElement));
		}
		}
		addElement(pElementParamValue);
	}

	native private void addElement_IElement(long pNativeObject, long pElement);
	/**
	 * 添加元素
	 * @param element 元素
	 */
	public void addElement(com.earthview.world.spatial.carto.Ielement pElement)
	{
		long pElementParamValue = (pElement == null ? 0L : pElement.nativeObject.pointer);
		addElement_IElement(this.nativeObject.pointer, pElementParamValue);
	}
	native private void addElement_IElement_NoVirtual(long pNativeObject, long pElement);
	protected void addElement_NoVirtual(com.earthview.world.spatial.carto.Ielement pElement)
	{
		long pElementParamValue = (pElement == null ? 0L : pElement.nativeObject.pointer);
		addElement_IElement_NoVirtual(this.nativeObject.pointer, pElementParamValue);
	}

	protected  void insertElement_ev_int32_IElement_callback(int nIndex, long pElement)
	{
		...
		insertElement(nIndexParamValue, pElementParamValue);
	}

	native private void insertElement_ev_int32_IElement(long pNativeObject, int nIndex, long pElement);
	/**
	 * 插入元素
	 * @param element 插入的位置
	 * @param element 元素
	 */
	public void insertElement(int nIndex, com.earthview.world.spatial.carto.Ielement pElement)
	{
		int nIndexParamValue = nIndex;
		long pElementParamValue = (pElement == null ? 0L : pElement.nativeObject.pointer);
		insertElement_ev_int32_IElement(this.nativeObject.pointer, nIndexParamValue, pElementParamValue);
	}
	native private void insertElement_ev_int32_IElement_NoVirtual(long pNativeObject, int nIndex, long pElement);
	protected void insertElement_NoVirtual(int nIndex, com.earthview.world.spatial.carto.Ielement pElement)
	{
		int nIndexParamValue = nIndex;
		long pElementParamValue = (pElement == null ? 0L : pElement.nativeObject.pointer);
		insertElement_ev_int32_IElement_NoVirtual(this.nativeObject.pointer, nIndexParamValue, pElementParamValue);
	}
	...
	{
		int nIndexParamValue = nIndex;
		com.earthview.world.spatial.carto.Ielement returnValue = getElement(nIndexParamValue);
		if(returnValue == null) {
			return 0L;
		}
		returnValue.setDelegate(true);
	 ...
	 * @return 元素对象
	 */
	public com.earthview.world.spatial.carto.Ielement getElement(int nIndex)
	{
		int nIndexParamValue = nIndex;
	...
	protected com.earthview.world.spatial.carto.Ielement getElement_NoVirtual(int nIndex)
	{
		int nIndexParamValue = nIndex;
	 ...
	 * @return 如果存在返回true,否则返回false
	 */
	public boolean isExist(com.earthview.world.spatial.carto.Ielement pElement)
	{
		long pElementParamValue = (pElement == null ? 0L : pElement.nativeObject.pointer);
	...
	protected boolean isExist_NoVirtual(com.earthview.world.spatial.carto.Ielement pElement)
	{
		long pElementParamValue = (pElement == null ? 0L : pElement.nativeObject.pointer);
	...
	{
		com.earthview.world.spatial.carto.Ielement returnValue = next();
		if(returnValue == null) {
			return 0L;
		}
		returnValue.setDelegate(true);
	 ...
	 * @param  
	 */
	public com.earthview.world.spatial.carto.Ielement next()
	{
	...
	protected com.earthview.world.spatial.carto.Ielement next_NoVirtual()
	{
	...
	{
		com.earthview.world.spatial.carto.Ipagelayout returnValue = ev_clone();
		if(returnValue == null) {
			return 0L;
		}
		returnValue.setDelegate(true);
	 ...
	 * @return 地图元素
	 */
	public com.earthview.world.spatial.carto.Ipagelayout ev_clone()
	{
	...
	protected com.earthview.world.spatial.carto.Ipagelayout ev_clone_NoVirtual()
	{
	...
	public Ipagelayout(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Ipagelayout(CreatedWhenConstruct cwc, String classNameStr) {
	...
	native protected void register_createElement_EVElementType(long pNativeObject, String method);
	...
	public void registerCallback(){
		if (!this.nativeObject.equals(InstancePointer.ZERO)){
			...
			this.register_createElement_EVElementType(this.nativeObject.pointer, "createElement_EVElementType_callback");
	...
	public static Ipagelayout fromBaseObject(BaseObject baseObj)
	{
		...
		Ipagelayout obj = null;
 		if(baseObj instanceof Ipagelayout)
		{
			obj = (Ipagelayout)baseObj;
		} else {
