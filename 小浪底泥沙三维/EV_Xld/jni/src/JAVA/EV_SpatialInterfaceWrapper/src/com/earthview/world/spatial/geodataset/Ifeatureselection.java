 ...
 */
public class Ifeatureselection extends com.earthview.world.core.AllocatedObject {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::GeoDataset::IFeatureSelection", new IfeatureselectionClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::GeoDataset::JIFeatureSelectionProxy", new IfeatureselectionClassFactory());
	}
	...
	protected  long getID_ev_uint32_callback(long index)
	{
		long indexParamValue = index;
		long returnValue = getID(indexParamValue);
		long __returnValue = returnValue;
		return __returnValue;
	}
	...
	protected  long getIDs_ev_uint32_callback(long ids)
	{
		UIntegerPointer idsParamValue = (ids == 0L ? null : new UIntegerPointer(new InstancePointer(ids)));
		long returnValue = getIDs(idsParamValue);
		long __returnValue = returnValue;
		return __returnValue;
	}
	...
	protected  int findID_ev_uint32_callback(long id)
	{
		long idParamValue = id;
		int returnValue = findID(idParamValue);
	...
	protected  boolean addID_ev_uint32_callback(long id)
	{
		long idParamValue = id;
		boolean returnValue = addID(idParamValue);
	...
	protected  long addIDs_ev_uint32_ev_uint32_callback(long id, long size)
	{
		UIntegerPointer idParamValue = (id == 0L ? null : new UIntegerPointer(new InstancePointer(id)));
		long sizeParamValue = size;
		long returnValue = addIDs(idParamValue, sizeParamValue);
		long __returnValue = returnValue;
		return __returnValue;
	}
	...
	protected  long remove_ev_uint32_ev_uint32_callback(long index, long size)
	{
		long indexParamValue = index;
		long sizeParamValue = size;
		long returnValue = remove(indexParamValue, sizeParamValue);
		long __returnValue = returnValue;
		return __returnValue;
	}
	...
	protected  void intersect_IFeatureSelection_callback(long set)
	{
		com.earthview.world.spatial.geodataset.Ifeatureselection setParamValue = (set == 0L ? null : new com.earthview.world.spatial.geodataset.Ifeatureselection(CreatedWhenConstruct.CWC_NotToCreate));
		...
		{
			setParamValue.setDelegate(true);
			setParamValue = (com.earthview.world.spatial.geodataset.Ifeatureselection)setParamValueClassFactory.create();
			setParamValue.setDelegate(true);
			setParamValue.setInstancePointer(new InstancePointer(set));
		}
		}
		intersect(setParamValue);
	}
	...
	protected  void difference_IFeatureSelection_callback(long set)
	{
		com.earthview.world.spatial.geodataset.Ifeatureselection setParamValue = (set == 0L ? null : new com.earthview.world.spatial.geodataset.Ifeatureselection(CreatedWhenConstruct.CWC_NotToCreate));
		if(setParamValue != null)
		{
	...
	protected  void append_IFeatureSelection_callback(long set)
	{
		com.earthview.world.spatial.geodataset.Ifeatureselection setParamValue = (set == 0L ? null : new com.earthview.world.spatial.geodataset.Ifeatureselection(CreatedWhenConstruct.CWC_NotToCreate));
		if(setParamValue != null)
		{
	...
	public Ifeatureselection(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Ifeatureselection(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Ifeatureselection fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		Ifeatureselection obj = null;
 		if(baseObj instanceof Ifeatureselection)
		{
			obj = (Ifeatureselection)baseObj;
		} else {
			obj = new Ifeatureselection(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "IFeatureSelection");
			obj.increaseCast();
		}
