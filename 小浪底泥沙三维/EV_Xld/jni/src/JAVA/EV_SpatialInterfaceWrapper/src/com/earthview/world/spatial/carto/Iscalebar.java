...
/// 上方
public class Iscalebar extends com.earthview.world.spatial.carto.Imapsurround {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Carto::IScaleBar", new IscalebarClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Carto::JIScaleBarProxy", new IscalebarClassFactory());
	}
	...
	protected  void setScaleType_EVScaleType_callback(int type)
	{
		com.earthview.world.spatial.carto.EVScaleType typeParamValue = com.earthview.world.spatial.carto.EVScaleType.toEnum(type);
		setScaleType(typeParamValue);
	}
	...
	protected  int getScaleType_void_callback()
	{
		com.earthview.world.spatial.carto.EVScaleType returnValue = getScaleType();
	...
	protected  void setDataLabelPositon_DataLabelPosition_callback(int pos)
	{
		com.earthview.world.spatial.carto.DataLabelPosition posParamValue = com.earthview.world.spatial.carto.DataLabelPosition.toEnum(pos);
		setDataLabelPositon(posParamValue);
	}
	...
	protected  int getDataLabelPositon_void_callback()
	{
		com.earthview.world.spatial.carto.DataLabelPosition returnValue = getDataLabelPositon();
		int __returnValue = returnValue.getValue();
		return __returnValue;
	}
	...
	protected  boolean getIsDrawFrame_void_callback()
	{
		boolean returnValue = getIsDrawFrame();
		boolean __returnValue = returnValue;
		return __returnValue;
	}
	...
	protected  void setScaleUnit_EVMapUnits_callback(int scaleUnit)
	{
		com.earthview.world.spatial.atlas.EVMapUnits scaleUnitParamValue = com.earthview.world.spatial.atlas.EVMapUnits.toEnum(scaleUnit);
		setScaleUnit(scaleUnitParamValue);
	}
	...
	protected  int getScaleUnit_void_callback()
	{
		com.earthview.world.spatial.atlas.EVMapUnits returnValue = getScaleUnit();
		int __returnValue = returnValue.getValue();
		return __returnValue;
	}
	...
	protected  void setScaleColor_IColor_callback(long color)
	{
	...
	protected  long getScaleColor_void_callback()
	{
		com.earthview.world.spatial.display.Icolor returnValue = getScaleColor();
		if(returnValue == null) {
			return 0L;
		}
		returnValue.setDelegate(true);
	...
	protected  void setDivisions_ev_int32_callback(int divisons)
	{
		int divisonsParamValue = divisons;
		setDivisions(divisonsParamValue);
	}
	...
	protected  int getDivisions_void_callback()
	{
		int returnValue = getDivisions();
	...
	protected  void setDivisionLength_ev_real64_callback(double dDivLength)
	{
		double dDivLengthParamValue = dDivLength;
		setDivisionLength(dDivLengthParamValue);
	}
	...
	protected  double getDivisionLength_void_callback()
	{
		double returnValue = getDivisionLength();
	...
	protected  void setSubDivisions_ev_int32_callback(int subdivisons)
	{
		int subdivisonsParamValue = subdivisons;
		setSubDivisions(subdivisonsParamValue);
	}
	...
	protected  int getSubDivisions_void_callback()
	{
		int returnValue = getSubDivisions();
		int __returnValue = returnValue;
		return __returnValue;
	}
	...
	protected  void setDivisionMarkHeight_ev_real64_callback(double divisionMarkHeight)
	{
		double divisionMarkHeightParamValue = divisionMarkHeight;
		setDivisionMarkHeight(divisionMarkHeightParamValue);
	}
	...
	protected  double getDivisionMarkHeight_void_callback()
	{
		double returnValue = getDivisionMarkHeight();
		double __returnValue = returnValue;
		return __returnValue;
	}
	...
	protected  void setSubdivisionMarkHeight_ev_real64_callback(double subdivisionMarkHeight)
	{
		double subdivisionMarkHeightParamValue = subdivisionMarkHeight;
		setSubdivisionMarkHeight(subdivisionMarkHeightParamValue);
	}
	...
	protected  double getSubdivisionMarkHeight_void_callback()
	{
		double returnValue = getSubdivisionMarkHeight();
		double __returnValue = returnValue;
		return __returnValue;
	}
	...
	protected  void setDivisionMarkSymbol_ISymbol_callback(long symbol)
	{
		...
		setDivisionMarkSymbol(symbolParamValue);
	}
	...
	protected  long getDivisionMarkSymbol_void_callback()
	{
		com.earthview.world.spatial.display.Isymbol returnValue = getDivisionMarkSymbol();
		if(returnValue == null) {
			return 0L;
		}
		returnValue.setDelegate(true);
	...
	protected  void setSubDivisionMarkSymbol_ISymbol_callback(long symbol)
	{
		com.earthview.world.spatial.display.Isymbol symbolParamValue = (symbol == 0L ? null : new com.earthview.world.spatial.display.Isymbol(CreatedWhenConstruct.CWC_NotToCreate));
		if(symbolParamValue != null)
		{
		...
		setSubDivisionMarkSymbol(symbolParamValue);
	}
	...
	protected  long getSubDivisionMarkSymbol_void_callback()
	{
		com.earthview.world.spatial.display.Isymbol returnValue = getSubDivisionMarkSymbol();
		if(returnValue == null) {
			return 0L;
		}
		returnValue.setDelegate(true);
	...
	protected  void setDataLabelSymbol_ISymbol_callback(long symbol)
	{
		com.earthview.world.spatial.display.Isymbol symbolParamValue = (symbol == 0L ? null : new com.earthview.world.spatial.display.Isymbol(CreatedWhenConstruct.CWC_NotToCreate));
		if(symbolParamValue != null)
		{
		...
		setDataLabelSymbol(symbolParamValue);
	}
	...
	protected  long getDataLabelSymbol_void_callback()
	{
		com.earthview.world.spatial.display.Isymbol returnValue = getDataLabelSymbol();
		if(returnValue == null) {
			return 0L;
		}
		returnValue.setDelegate(true);
	...
	protected  void setUnitLabelSymbol_ISymbol_callback(long symbol)
	{
		com.earthview.world.spatial.display.Isymbol symbolParamValue = (symbol == 0L ? null : new com.earthview.world.spatial.display.Isymbol(CreatedWhenConstruct.CWC_NotToCreate));
		if(symbolParamValue != null)
		{
		...
		setUnitLabelSymbol(symbolParamValue);
	}
	...
	protected  long getUnitLabelSymbol_void_callback()
	{
		com.earthview.world.spatial.display.Isymbol returnValue = getUnitLabelSymbol();
		if(returnValue == null) {
			return 0L;
		}
		returnValue.setDelegate(true);
	...
	public Iscalebar(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Iscalebar(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Iscalebar fromBaseObject(BaseObject baseObj)
	{
		...
		Iscalebar obj = null;
 		if(baseObj instanceof Iscalebar)
		{
			obj = (Iscalebar)baseObj;
		} else {
