...
public class Imaptitle extends com.earthview.world.spatial.carto.Imapsurround {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Carto::IMapTitle", new ImaptitleClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Carto::JIMapTitleProxy", new ImaptitleClassFactory());
	}
	...
	protected  void setTitleSymbol_ISymbol_callback(long symbol)
	{
		...
		setTitleSymbol(symbolParamValue);
	}

	native private void setTitleSymbol_ISymbol(long pNativeObject, long symbol);
	/**
	 * 设置地图标题的风格
	 * @param symbol 地图标题的风格
	 */
	public void setTitleSymbol(com.earthview.world.spatial.display.Isymbol symbol)
	{
		long symbolParamValue = (symbol == null ? 0L : symbol.nativeObject.pointer);
		setTitleSymbol_ISymbol(this.nativeObject.pointer, symbolParamValue);
	}
	native private void setTitleSymbol_ISymbol_NoVirtual(long pNativeObject, long symbol);
	protected void setTitleSymbol_NoVirtual(com.earthview.world.spatial.display.Isymbol symbol)
	{
		long symbolParamValue = (symbol == null ? 0L : symbol.nativeObject.pointer);
		setTitleSymbol_ISymbol_NoVirtual(this.nativeObject.pointer, symbolParamValue);
	}
	...
	public Imaptitle(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Imaptitle(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Imaptitle fromBaseObject(BaseObject baseObj)
	{
		...
		Imaptitle obj = null;
 		if(baseObj instanceof Imaptitle)
		{
			obj = (Imaptitle)baseObj;
		} else {
			obj = new Imaptitle(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "IMapTitle");
			obj.increaseCast();
		}
