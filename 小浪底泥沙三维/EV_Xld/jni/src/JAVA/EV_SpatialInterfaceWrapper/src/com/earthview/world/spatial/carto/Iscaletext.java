...
public class Iscaletext extends com.earthview.world.spatial.carto.Imapsurround {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Carto::IScaleText", new IscaletextClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Carto::JIScaleTextProxy", new IscaletextClassFactory());
	}
	...
	public Iscaletext(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Iscaletext(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Iscaletext fromBaseObject(BaseObject baseObj)
	{
		...
		Iscaletext obj = null;
 		if(baseObj instanceof Iscaletext)
		{
			obj = (Iscaletext)baseObj;
		} else {
			obj = new Iscaletext(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "IScaleText");
			obj.increaseCast();
		}
