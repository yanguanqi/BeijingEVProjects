 ...
 * 地图周边元素类
 */
public class Imapsurround extends com.earthview.world.spatial.carto.Ielement {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Carto::IMapSurround", new ImapsurroundClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Carto::JIMapSurroundProxy", new ImapsurroundClassFactory());
	}
	...
	public Imapsurround(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Imapsurround(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Imapsurround fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		Imapsurround obj = null;
 		if(baseObj instanceof Imapsurround)
		{
			obj = (Imapsurround)baseObj;
		} else {
			obj = new Imapsurround(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "IMapSurround");
			obj.increaseCast();
		}
