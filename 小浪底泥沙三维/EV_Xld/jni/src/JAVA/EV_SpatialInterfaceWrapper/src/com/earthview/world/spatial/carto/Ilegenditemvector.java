...
public class Ilegenditemvector extends com.earthview.world.core.AllocatedObject {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Carto::ILegendItemVector", new IlegenditemvectorClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Carto::JILegendItemVectorProxy", new IlegenditemvectorClassFactory());
	}
	...
	{
		com.earthview.world.spatial.carto.Ilegenditem pItemParamValue = (pItem == 0L ? null : new com.earthview.world.spatial.carto.Ilegenditem(CreatedWhenConstruct.CWC_NotToCreate));
		...
		{
			pItemParamValue.setDelegate(true);
			pItemParamValue = (com.earthview.world.spatial.carto.Ilegenditem)pItemParamValueClassFactory.create();
			pItemParamValue.setDelegate(true);
			pItemParamValue.setInstancePointer(new InstancePointer(pItem));
		}
		}
	 ...
	 * @param pItem 图列项
	 */
	public void addLegendItem(com.earthview.world.spatial.carto.Ilegenditem pItem)
	{
	...
	protected void addLegendItem_NoVirtual(com.earthview.world.spatial.carto.Ilegenditem pItem)
	{
		long pItemParamValue = (pItem == null ? 0L : pItem.nativeObject.pointer);
	...
	{
		int nIndexParamValue = nIndex;
		com.earthview.world.spatial.carto.Ilegenditem returnValue = getLegendItem(nIndexParamValue);
		if(returnValue == null) {
			return 0L;
		}
	 ...
	 * @param pItem 图列项
	 */
	public com.earthview.world.spatial.carto.Ilegenditem getLegendItem(int nIndex)
	{
		int nIndexParamValue = nIndex;
	...
	protected com.earthview.world.spatial.carto.Ilegenditem getLegendItem_NoVirtual(int nIndex)
	{
		int nIndexParamValue = nIndex;
	...
	public Ilegenditemvector(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Ilegenditemvector(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Ilegenditemvector fromBaseObject(BaseObject baseObj)
	{
		...
		Ilegenditemvector obj = null;
 		if(baseObj instanceof Ilegenditemvector)
		{
			obj = (Ilegenditemvector)baseObj;
		} else {
