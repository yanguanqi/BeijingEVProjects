 ...
 * 图例接口
 */
public class Ilegend extends com.earthview.world.spatial.carto.Imapsurround {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Carto::ILegend", new IlegendClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Carto::JILegendProxy", new IlegendClassFactory());
	}
	...
	public Ilegend(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Ilegend(CreatedWhenConstruct cwc, String classNameStr) {
