 ...
 * 要素类接口
 */
public class Ifeatureclass2 extends com.earthview.world.spatial.geodataset.Ifeatureclass {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::GeoDataset::IFeatureClass2", new Ifeatureclass2ClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::GeoDataset::JIFeatureClass2Proxy", new Ifeatureclass2ClassFactory());
	}
	...
	public Ifeatureclass2(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Ifeatureclass2(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Ifeatureclass2 fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		Ifeatureclass2 obj = null;
 		if(baseObj instanceof Ifeatureclass2)
		{
			obj = (Ifeatureclass2)baseObj;
		} else {
			obj = new Ifeatureclass2(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "IFeatureClass2");
			obj.increaseCast();
		}
