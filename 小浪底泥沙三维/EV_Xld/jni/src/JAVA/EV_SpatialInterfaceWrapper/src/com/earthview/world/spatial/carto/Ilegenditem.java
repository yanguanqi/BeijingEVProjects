...
public class Ilegenditem extends com.earthview.world.core.AllocatedObject {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Carto::ILegendItem", new IlegenditemClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Carto::JILegendItemProxy", new IlegenditemClassFactory());
	}
	...
	protected  void setTransparentValue_ev_uint8_callback(short nValue)
	{
		short nValueParamValue = nValue;
		setTransparentValue(nValueParamValue);
	}
	...
	native private void setTransparentValue_ev_uint8_NoVirtual(long pNativeObject, short nValue);
	protected void setTransparentValue_NoVirtual(short nValue)
	{
		short nValueParamValue = nValue;
		setTransparentValue_ev_uint8_NoVirtual(this.nativeObject.pointer, nValueParamValue);
	}
	...
	public Ilegenditem(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Ilegenditem(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Ilegenditem fromBaseObject(BaseObject baseObj)
	{
		...
		Ilegenditem obj = null;
 		if(baseObj instanceof Ilegenditem)
		{
			obj = (Ilegenditem)baseObj;
		} else {
