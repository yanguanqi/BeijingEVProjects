 ...
 * 数据集类，是数据集合的基类。
 */
public class Idataset extends com.earthview.world.core.AllocatedObject {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::GeoDataset::IDataset", new IdatasetClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::GeoDataset::JIDatasetProxy", new IdatasetClassFactory());
	}
	...
	protected  boolean hasSubDataset_void_callback()
	{
		boolean returnValue = hasSubDataset();
	...
	protected  boolean stopEditing_ev_bool_callback(boolean isSave)
	{
		boolean isSaveParamValue = isSave;
		boolean returnValue = stopEditing(isSaveParamValue);
		boolean __returnValue = returnValue;
		return __returnValue;
	}
	...
	protected  boolean isBeginEditingOperation_void_callback()
	{
		boolean returnValue = isBeginEditingOperation();
		boolean __returnValue = returnValue;
		return __returnValue;
	}
	...
	protected  boolean beginEditingOperation_void_callback()
	{
		boolean returnValue = beginEditingOperation();
		boolean __returnValue = returnValue;
		return __returnValue;
	}
	...
	protected  boolean endEditingOperation_ev_bool_callback(boolean isConfirm)
	{
		boolean isConfirmParamValue = isConfirm;
		boolean returnValue = endEditingOperation(isConfirmParamValue);
		boolean __returnValue = returnValue;
		return __returnValue;
	}
	...
	public Idataset(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Idataset(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Idataset fromBaseObject(BaseObject baseObj)
	{
		...
		Idataset obj = null;
 		if(baseObj instanceof Idataset)
		{
			obj = (Idataset)baseObj;
		} else {
