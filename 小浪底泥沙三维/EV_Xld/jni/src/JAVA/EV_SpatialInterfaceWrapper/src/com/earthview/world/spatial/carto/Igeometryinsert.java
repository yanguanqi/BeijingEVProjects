 ...
 * 插入绘图
 */
public class Igeometryinsert extends com.earthview.world.spatial.carto.Imapsurround {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Carto::IGeometryInsert", new IgeometryinsertClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Carto::JIGeometryInsertProxy", new IgeometryinsertClassFactory());
	}
	...
	public Igeometryinsert(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Igeometryinsert(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Igeometryinsert fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		Igeometryinsert obj = null;
 		if(baseObj instanceof Igeometryinsert)
		{
			obj = (Igeometryinsert)baseObj;
		} else {
			obj = new Igeometryinsert(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "IGeometryInsert");
			obj.increaseCast();
		}
