...
public class TranslationSerializer extends com.earthview.world.graphic.AnimationBaseSerializer {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::CTranslationSerializer", new TranslationSerializerClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::JCTranslationSerializerProxy", new TranslationSerializerClassFactory());
	}

	public TranslationSerializer() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCTranslationSerializerProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.TranslationSerializer".equals(this.getClass().getName()))
		{
	...
	native private long get_mpostion_void(long pNativeObject);
	public com.earthview.world.spatial.math.Vector3 get_mpostion()
	{
		long jniValue = get_mpostion_void(this.nativeObject.pointer);
	...
	native private void set_mpostion_CVector3 (long pNativeObject, long value);
	public void set_mpostion(com.earthview.world.spatial.math.Vector3 mpostion)
	{
		long mpostionParamValue = mpostion.nativeObject.pointer;
		
		set_mpostion_CVector3(this.nativeObject.pointer, mpostionParamValue);
	}
	
	public TranslationSerializer(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public TranslationSerializer(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static TranslationSerializer fromBaseObject(BaseObject baseObj)
	{
		...
		TranslationSerializer obj = null;
 		if(baseObj instanceof TranslationSerializer)
		{
			obj = (TranslationSerializer)baseObj;
		} else {
