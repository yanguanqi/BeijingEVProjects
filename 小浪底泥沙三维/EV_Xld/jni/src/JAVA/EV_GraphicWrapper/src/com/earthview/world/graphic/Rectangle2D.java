...
public class Rectangle2D extends com.earthview.world.graphic.SimpleRenderable {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::CRectangle2D", new Rectangle2DClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::JCRectangle2DProxy", new Rectangle2DClassFactory());
	}
	...
	native private void _initRectangle2D_bool_Usage(long pNativeObject, boolean includeTextureCoords, int vBufUsage);
	///zxt updatefor v1.8
	public void _initRectangle2D(boolean includeTextureCoords, com.earthview.world.graphic.HardwareBuffer.Usage vBufUsage)
	{
		boolean includeTextureCoordsParamValue = includeTextureCoords;
		int vBufUsageParamValue = vBufUsage.getValue();
		_initRectangle2D_bool_Usage(this.nativeObject.pointer, includeTextureCoordsParamValue, vBufUsageParamValue);
	}
	public Rectangle2D() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCRectangle2DProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.Rectangle2D".equals(this.getClass().getName()))
		{
	...
	public Rectangle2D(boolean includeTextureCoordinates) {
		...
		Create("JCRectangle2DProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.Rectangle2D".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
	...
	public Rectangle2D(boolean includeTextureCoordinates, com.earthview.world.graphic.HardwareBuffer.Usage vBufUsage) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer includeTextureCoordinatesPtr = new BasePointer(includeTextureCoordinates);
		list.add("includeTextureCoordinates", includeTextureCoordinatesPtr.get());
		BasePointer vBufUsagePtr = new BasePointer(vBufUsage);
		list.add("vBufUsage", vBufUsagePtr.get());
		Create("JCRectangle2DProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.Rectangle2D".equals(this.getClass().getName()))
		{
	...
	public Rectangle2D(String name, boolean includeTextureCoordinates, com.earthview.world.graphic.HardwareBuffer.Usage vBufUsage) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer namePtr = new BasePointer(name);
		list.add("name", namePtr.get());
	...
	native private void setCorners_Real_Real_Real_Real_ev_bool(long pNativeObject, double left, double top, double right, double bottom, boolean updateAABB);
	public void setCorners(double left, double top, double right, double bottom, boolean updateAABB)
	{
		double leftParamValue = left;
		double topParamValue = top;
		double rightParamValue = right;
		double bottomParamValue = bottom;
		boolean updateAABBParamValue = updateAABB;
		setCorners_Real_Real_Real_Real_ev_bool(this.nativeObject.pointer, leftParamValue, topParamValue, rightParamValue, bottomParamValue, updateAABBParamValue);
	}
	native private void setCorners_Real_Real_Real_Real(long pNativeObject, double left, double top, double right, double bottom);
	public void setCorners(double left, double top, double right, double bottom)
	{
		...
		double rightParamValue = right;
		double bottomParamValue = bottom;
		setCorners_Real_Real_Real_Real(this.nativeObject.pointer, leftParamValue, topParamValue, rightParamValue, bottomParamValue);
	}
	native private void setNormals_CVector3_CVector3_CVector3_CVector3(long pNativeObject, long topLeft, long bottomLeft, long topRight, long bottomRight);
	public void setNormals(com.earthview.world.spatial.math.Vector3 topLeft, com.earthview.world.spatial.math.Vector3 bottomLeft, com.earthview.world.spatial.math.Vector3 topRight, com.earthview.world.spatial.math.Vector3 bottomRight)
	{
		long topLeftParamValue = topLeft.nativeObject.pointer;
		long bottomLeftParamValue = bottomLeft.nativeObject.pointer;
		long topRightParamValue = topRight.nativeObject.pointer;
		long bottomRightParamValue = bottomRight.nativeObject.pointer;
		setNormals_CVector3_CVector3_CVector3_CVector3(this.nativeObject.pointer, topLeftParamValue, bottomLeftParamValue, topRightParamValue, bottomRightParamValue);
	}
	native private void setUVs_CVector2_CVector2_CVector2_CVector2(long pNativeObject, long topLeft, long bottomLeft, long topRight, long bottomRight);
	////zxt updatefor v1.8
	public void setUVs(com.earthview.world.spatial.math.Vector2 topLeft, com.earthview.world.spatial.math.Vector2 bottomLeft, com.earthview.world.spatial.math.Vector2 topRight, com.earthview.world.spatial.math.Vector2 bottomRight)
	{
		long topLeftParamValue = topLeft.nativeObject.pointer;
		long bottomLeftParamValue = bottomLeft.nativeObject.pointer;
		long topRightParamValue = topRight.nativeObject.pointer;
		long bottomRightParamValue = bottomRight.nativeObject.pointer;
		setUVs_CVector2_CVector2_CVector2_CVector2(this.nativeObject.pointer, topLeftParamValue, bottomLeftParamValue, topRightParamValue, bottomRightParamValue);
	}
	native private void setDefaultUVs_void(long pNativeObject);
	public void setDefaultUVs()
	{
		setDefaultUVs_void(this.nativeObject.pointer);
	}
	...
	public Rectangle2D(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Rectangle2D(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Rectangle2D fromBaseObject(BaseObject baseObj)
	{
		...
		Rectangle2D obj = null;
 		if(baseObj instanceof Rectangle2D)
		{
			obj = (Rectangle2D)baseObj;
		} else {
