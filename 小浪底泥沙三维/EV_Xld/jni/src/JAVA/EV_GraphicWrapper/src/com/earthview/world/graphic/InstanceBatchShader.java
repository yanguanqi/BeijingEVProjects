...
public class InstanceBatchShader extends com.earthview.world.graphic.InstanceBatch {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::CInstanceBatchShader", new InstanceBatchShaderClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::JCInstanceBatchShaderProxy", new InstanceBatchShaderClassFactory());
	}

	public InstanceBatchShader(com.earthview.world.graphic.InstanceManager ref_creator, com.earthview.world.graphic.MeshPtr meshReference, com.earthview.world.graphic.MaterialPtr material, long instancesPerBatch, com.earthview.world.graphic.IndexMap ref_indexToBoneMap, String batchName) {
		...
		Create("JCInstanceBatchShaderProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.InstanceBatchShader".equals(this.getClass().getName()))
		{
	...
	public InstanceBatchShader(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public InstanceBatchShader(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static InstanceBatchShader fromBaseObject(BaseObject baseObj)
	{
		...
		InstanceBatchShader obj = null;
 		if(baseObj instanceof InstanceBatchShader)
		{
			obj = (InstanceBatchShader)baseObj;
		} else {
