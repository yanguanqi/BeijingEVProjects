...
public class CmdMetricsMode extends com.earthview.world.core.ParamCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::OverlayElementCommands::CCmdMetricsMode", new CmdMetricsModeClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::OverlayElementCommands::JCCmdMetricsModeProxy", new CmdMetricsModeClassFactory());
	}

	public CmdMetricsMode() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCmdMetricsModeProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.overlayelementcommands.CmdMetricsMode".equals(this.getClass().getName()))
		{
	...
	public CmdMetricsMode(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CmdMetricsMode(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CmdMetricsMode fromBaseObject(BaseObject baseObj)
	{
		...
		CmdMetricsMode obj = null;
 		if(baseObj instanceof CmdMetricsMode)
		{
			obj = (CmdMetricsMode)baseObj;
		} else {
