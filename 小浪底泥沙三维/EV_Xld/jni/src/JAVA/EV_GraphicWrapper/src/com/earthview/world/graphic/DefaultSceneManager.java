 ...
 * 默认场景管理者
 */
public class DefaultSceneManager extends com.earthview.world.graphic.SceneManager {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::CDefaultSceneManager", new DefaultSceneManagerClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::JCDefaultSceneManagerProxy", new DefaultSceneManagerClassFactory());
	}
	...
	public DefaultSceneManager(String name) {
		...
		Create("JCDefaultSceneManagerProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.DefaultSceneManager".equals(this.getClass().getName()))
		{
	...
	public DefaultSceneManager(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public DefaultSceneManager(CreatedWhenConstruct cwc, String classNameStr) {
	...
	{
		return super.createCamera_NoVirtual(name);
	}
	/**
	 * 通过摄像机名称获得摄像机
	 * @param name 名称
	...
	public static DefaultSceneManager fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		DefaultSceneManager obj = null;
 		if(baseObj instanceof DefaultSceneManager)
		{
			obj = (DefaultSceneManager)baseObj;
		} else {
			obj = new DefaultSceneManager(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CDefaultSceneManager");
			obj.increaseCast();
		}
