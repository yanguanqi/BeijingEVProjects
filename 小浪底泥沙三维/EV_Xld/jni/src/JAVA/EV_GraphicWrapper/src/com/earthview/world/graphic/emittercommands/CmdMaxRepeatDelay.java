...
/**
 * 粒子发射器的命令对象获得/设置发射器重复发射最大间隔时间参数
 */
public class CmdMaxRepeatDelay extends com.earthview.world.core.ParamCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::EmitterCommands::CCmdMaxRepeatDelay", new CmdMaxRepeatDelayClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::EmitterCommands::JCCmdMaxRepeatDelayProxy", new CmdMaxRepeatDelayClassFactory());
	}
	 ...
	 * @param  
	 */
	public CmdMaxRepeatDelay() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCmdMaxRepeatDelayProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.emittercommands.CmdMaxRepeatDelay".equals(this.getClass().getName()))
		{
	 ...
	 * @param target 
	 * @return 返回EVString类型的发射器重复发射最大间隔时间的值
	 */
	...
	public CmdMaxRepeatDelay(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CmdMaxRepeatDelay(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CmdMaxRepeatDelay fromBaseObject(BaseObject baseObj)
	{
		...
		CmdMaxRepeatDelay obj = null;
 		if(baseObj instanceof CmdMaxRepeatDelay)
		{
			obj = (CmdMaxRepeatDelay)baseObj;
		} else {
