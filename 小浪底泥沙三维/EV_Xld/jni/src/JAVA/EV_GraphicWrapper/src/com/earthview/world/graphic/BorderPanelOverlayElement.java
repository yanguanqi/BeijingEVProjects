...
/**
 * AspecialisationoftheEarthView::World::Graphic::CPanelOverlayElementtoprovideapanelwithaborder.remarksWhilstthestandardpanelcanuseasingletiledmaterial,thisclassallowspanelswithatileablebackdropplusabordertexture.Thisishandyforlargepanelsthataretoobigtouseasinglelargetexturewithaborder,orformultipledifferentsizepanelswhereyouwanttheborderaconstantwidthbutthecentertorepeat.parInadditiontotheusualCPanelOverlayElementproperties,thisclasshasa'bordermaterial',whichspecifiesthematerialusedfortheedgesofthepanel,aborderwidth(whichcaneitherbeconstantallthewayaround,orspecifiedperedge),andthetexturecoordinatesforeachofthebordersections.
 */
public class BorderPanelOverlayElement extends com.earthview.world.graphic.PanelOverlayElement {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::CBorderPanelOverlayElement", new BorderPanelOverlayElementClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::JCBorderPanelOverlayElementProxy", new BorderPanelOverlayElementClassFactory());
	}
	...
	public BorderPanelOverlayElement(String name) {
		...
		Create("JCBorderPanelOverlayElementProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.BorderPanelOverlayElement".equals(this.getClass().getName()))
		{
	...
	native private void setBorderSize_Real(long pNativeObject, double size);
	/**
	 * Setsthesizeoftheborder.remarksThismethodsetsaconstantsizeforallborders.Therearealsoalternativemethodswhichallowyoutosetborderwidthsforindividualedgesseparately.Rememberthatthedimensionsspecifiedhereareinrelationtothesizeofthescreen,so0.1is1/10thofthescreenwidthorheight.Alsonotethatbecausebordersizewilllookslightlybiggeracrossthanup.
	 * @param  name="size"Thesizeoftheborderasafactorofthescreendimensionsie0.2isone-fifthofthescreensize.
	 */
	public void setBorderSize(double size)
	{
		double sizeParamValue = size;
		setBorderSize_Real(this.nativeObject.pointer, sizeParamValue);
	}
	native private void setBorderSize_Real_Real(long pNativeObject, double sides, double topAndBottom);
	/**
	 * Setsthesizeoftheborder,withdifferentsizesforverticalandhorizontalborders.remarksThismethodsetsasizeforthesideandtop/bottombordersseparately.Rememberthatthedimensionsspecifiedhereareinrelationtothesizeofthescreen,so0.1is1/10thofthescreenwidthorheight.Alsonotethatbecausebordersizewilllookslightlybiggeracrossthanup.
	 * @param  name="sides"Thesizeofthesidebordersasafactorofthescreendimensionsie0.2isone-fifthofthescreensize.
	 * @param  name="topAndBottom"Thesizeofthetopandbottombordersasafactorofthescreendimensions.
	 * @return 
	 */
	public void setBorderSize(double sides, double topAndBottom)
	{
		double sidesParamValue = sides;
		double topAndBottomParamValue = topAndBottom;
		setBorderSize_Real_Real(this.nativeObject.pointer, sidesParamValue, topAndBottomParamValue);
	}
	native private void setBorderSize_Real_Real_Real_Real(long pNativeObject, double left, double right, double top, double bottom);
	/**
	 * Setsthesizeoftheborderseparatelyforallborders.remarksThismethodsetsasizeallbordersseparately.Rememberthatthedimensionsspecifiedhereareinrelationtothesizeofthescreen,so0.1is1/10thofthescreenwidthorheight.Alsonotethatbecausebordersizewilllookslightlybiggeracrossthanup.
	 * @param  name="left"Thesizeoftheleftborderasafactorofthescreendimensionsie0.2isone-fifthofthescreensize.
	 * @param  name="right"Thesizeoftheleftborderasafactorofthescreendimensions.
	 * @param  name="top"Thesizeofthetopborderasafactorofthescreendimensions.
	 * @param  name="bottom"Thesizeofthebottomborderasafactorofthescreendimensions.
	 */
	public void setBorderSize(double left, double right, double top, double bottom)
	{
		...
		setBorderSize_Real_Real_Real_Real(this.nativeObject.pointer, leftParamValue, rightParamValue, topParamValue, bottomParamValue);
	}
	native private double getLeftBorderSize_void(long pNativeObject);
	/**
	 * Getsthesizeoftheleftborder.
	 * @param  
	 */
	public double getLeftBorderSize()
	{
		double returnValue = getLeftBorderSize_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private double getRightBorderSize_void(long pNativeObject);
	/**
	 * Getsthesizeoftherightborder.
	 * @param  
	 */
	public double getRightBorderSize()
	{
		double returnValue = getRightBorderSize_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private double getTopBorderSize_void(long pNativeObject);
	/**
	 * Getsthesizeofthetopborder.
	 * @param  
	 */
	public double getTopBorderSize()
	{
		double returnValue = getTopBorderSize_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private double getBottomBorderSize_void(long pNativeObject);
	/**
	 * Getsthesizeofthebottomborder.
	 * @param  
	 */
	public double getBottomBorderSize()
	{
		double returnValue = getBottomBorderSize_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private void setLeftBorderUV_Real_Real_Real_Real(long pNativeObject, double u1, double v1, double u2, double v2);
	/**
	 * Setsthetexturecoordinatesfortheleftedgeoftheborder.remarksTheborderpaneluses8panelsfortheborder(9includingthecenter).Imagineatablewith3rowsand3columns.Thecornersarealwaysthesamesize,buttheedgesstretchdependingonhowbigthepanelis.ThosewhohavedoneresizableHTMLtableswillbefamiliarwiththisapproach.parWeonlyrequire2setsofuvcoordinates,oneforthetop-leftandoneforthebottom-rightofthepanel,sinceitisassumedthesectionsarealignedonthetexture.
	 * @param  name="u1"ucoordinateoftop-leftpoint
	 * @param  name="v1"vcoordinateoftop-leftpoint
	 * @param  name="u2"ucoordinateofbottom-rightpoint
	 * @param  name="v2"vcoordinateofbottom-rightpoint
	 */
	public void setLeftBorderUV(double u1, double v1, double u2, double v2)
	{
		double u1ParamValue = u1;
		double v1ParamValue = v1;
		double u2ParamValue = u2;
		double v2ParamValue = v2;
		setLeftBorderUV_Real_Real_Real_Real(this.nativeObject.pointer, u1ParamValue, v1ParamValue, u2ParamValue, v2ParamValue);
	}
	native private void setRightBorderUV_Real_Real_Real_Real(long pNativeObject, double u1, double v1, double u2, double v2);
	/**
	 * Setsthetexturecoordinatesfortherightedgeoftheborder.
	 * @param  name="u1"ucoordinateoftop-leftpoint
	 * @param  name="v1"vcoordinateoftop-leftpoint
	 * @param  name="u2"ucoordinateofbottom-rightpoint
	 * @param  name="v2"vcoordinateofbottom-rightpoint
	 */
	public void setRightBorderUV(double u1, double v1, double u2, double v2)
	{
		double u1ParamValue = u1;
		double v1ParamValue = v1;
		double u2ParamValue = u2;
		double v2ParamValue = v2;
		setRightBorderUV_Real_Real_Real_Real(this.nativeObject.pointer, u1ParamValue, v1ParamValue, u2ParamValue, v2ParamValue);
	}
	native private void setTopBorderUV_Real_Real_Real_Real(long pNativeObject, double u1, double v1, double u2, double v2);
	/**
	 * Setsthetexturecoordinatesforthetopedgeoftheborder.
	 * @param  name="u1"ucoordinateoftop-leftpoint
	 * @param  name="v1"vcoordinateoftop-leftpoint
	 * @param  name="u2"ucoordinateofbottom-rightpoint
	 * @param  name="v2"vcoordinateofbottom-rightpoint
	 */
	public void setTopBorderUV(double u1, double v1, double u2, double v2)
	{
		double u1ParamValue = u1;
		double v1ParamValue = v1;
		double u2ParamValue = u2;
		double v2ParamValue = v2;
		setTopBorderUV_Real_Real_Real_Real(this.nativeObject.pointer, u1ParamValue, v1ParamValue, u2ParamValue, v2ParamValue);
	}
	native private void setBottomBorderUV_Real_Real_Real_Real(long pNativeObject, double u1, double v1, double u2, double v2);
	/**
	 * Setsthetexturecoordinatesforthebottomedgeoftheborder.
	 * @param  name="u1"ucoordinateoftop-leftpoint
	 * @param  name="v1"vcoordinateoftop-leftpoint
	 * @param  name="u2"ucoordinateofbottom-rightpoint
	 * @param  name="v2"vcoordinateofbottom-rightpoint
	 */
	public void setBottomBorderUV(double u1, double v1, double u2, double v2)
	{
		double u1ParamValue = u1;
		double v1ParamValue = v1;
		double u2ParamValue = u2;
		double v2ParamValue = v2;
		setBottomBorderUV_Real_Real_Real_Real(this.nativeObject.pointer, u1ParamValue, v1ParamValue, u2ParamValue, v2ParamValue);
	}
	native private void setTopLeftBorderUV_Real_Real_Real_Real(long pNativeObject, double u1, double v1, double u2, double v2);
	/**
	 * Setsthetexturecoordinatesforthetop-leftcorneroftheborder.
	 * @param  name="u1"ucoordinateoftop-leftpoint
	 * @param  name="v1"vcoordinateoftop-leftpoint
	 * @param  name="u2"ucoordinateofbottom-rightpoint
	 * @param  name="v2"vcoordinateofbottom-rightpoint
	 */
	public void setTopLeftBorderUV(double u1, double v1, double u2, double v2)
	{
		double u1ParamValue = u1;
		double v1ParamValue = v1;
		double u2ParamValue = u2;
		double v2ParamValue = v2;
		setTopLeftBorderUV_Real_Real_Real_Real(this.nativeObject.pointer, u1ParamValue, v1ParamValue, u2ParamValue, v2ParamValue);
	}
	native private void setTopRightBorderUV_Real_Real_Real_Real(long pNativeObject, double u1, double v1, double u2, double v2);
	public void setTopRightBorderUV(double u1, double v1, double u2, double v2)
	{
		double u1ParamValue = u1;
		double v1ParamValue = v1;
		double u2ParamValue = u2;
		double v2ParamValue = v2;
		setTopRightBorderUV_Real_Real_Real_Real(this.nativeObject.pointer, u1ParamValue, v1ParamValue, u2ParamValue, v2ParamValue);
	}
	native private void setBottomLeftBorderUV_Real_Real_Real_Real(long pNativeObject, double u1, double v1, double u2, double v2);
	...
	///<returns></returns>
	public void setBottomLeftBorderUV(double u1, double v1, double u2, double v2)
	{
		double u1ParamValue = u1;
		double v1ParamValue = v1;
		double u2ParamValue = u2;
		double v2ParamValue = v2;
		setBottomLeftBorderUV_Real_Real_Real_Real(this.nativeObject.pointer, u1ParamValue, v1ParamValue, u2ParamValue, v2ParamValue);
	}
	native private void setBottomRightBorderUV_Real_Real_Real_Real(long pNativeObject, double u1, double v1, double u2, double v2);
	/**
	 * Setsthetexturecoordinatesforthebottom-rightcorneroftheborder.
	 * @param  name="u1"ucoordinateoftop-leftpoint
	 * @param  name="v1"vcoordinateoftop-leftpoint
	 * @param  name="u2"ucoordinateofbottom-rightpoint
	 * @param  name="v2"vcoordinateofbottom-rightpoint
	 */
	public void setBottomRightBorderUV(double u1, double v1, double u2, double v2)
	{
		double u1ParamValue = u1;
		double v1ParamValue = v1;
		double u2ParamValue = u2;
		double v2ParamValue = v2;
		setBottomRightBorderUV_Real_Real_Real_Real(this.nativeObject.pointer, u1ParamValue, v1ParamValue, u2ParamValue, v2ParamValue);
	}
	native private String getLeftBorderUVString_void(long pNativeObject);
	public String getLeftBorderUVString()
	{
		String returnValue = getLeftBorderUVString_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private String getRightBorderUVString_void(long pNativeObject);
	public String getRightBorderUVString()
	{
		String returnValue = getRightBorderUVString_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private String getTopBorderUVString_void(long pNativeObject);
	public String getTopBorderUVString()
	{
		String returnValue = getTopBorderUVString_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private String getBottomBorderUVString_void(long pNativeObject);
	public String getBottomBorderUVString()
	{
		String returnValue = getBottomBorderUVString_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private String getTopLeftBorderUVString_void(long pNativeObject);
	public String getTopLeftBorderUVString()
	{
		String returnValue = getTopLeftBorderUVString_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private String getTopRightBorderUVString_void(long pNativeObject);
	public String getTopRightBorderUVString()
	{
		String returnValue = getTopRightBorderUVString_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private String getBottomLeftBorderUVString_void(long pNativeObject);
	public String getBottomLeftBorderUVString()
	{
		String returnValue = getBottomLeftBorderUVString_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private String getBottomRightBorderUVString_void(long pNativeObject);
	public String getBottomRightBorderUVString()
	{
		String returnValue = getBottomRightBorderUVString_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private void setBorderMaterialName_EVString(long pNativeObject, String name);
	/**
	 * Setsthenameofthematerialtousefortheborders.
	 * @param  name="name"
	 */
	public void setBorderMaterialName(String name)
	{
		String nameParamValue = name;
		setBorderMaterialName_EVString(this.nativeObject.pointer, nameParamValue);
	}
	native private long getBorderMaterialName_void(long pNativeObject);
	/**
	 * Getsthenameofthematerialtousefortheborders.
	 * @param  
	 */
	public StringPointer getBorderMaterialName()
	{
		long returnValue = getBorderMaterialName_void(this.nativeObject.pointer);
	...
	/**
	 * @copydocOvelayElement::visitRenderables
	 * @param  name="visitor"
	 * @param  name="debugRenderables"
	 */
	...
	public BorderPanelOverlayElement(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public BorderPanelOverlayElement(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static BorderPanelOverlayElement fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		BorderPanelOverlayElement obj = null;
 		if(baseObj instanceof BorderPanelOverlayElement)
		{
			obj = (BorderPanelOverlayElement)baseObj;
		} else {
			obj = new BorderPanelOverlayElement(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CBorderPanelOverlayElement");
			obj.increaseCast();
		}
