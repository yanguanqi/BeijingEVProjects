...
public class CompositionTechniqueTranslator extends com.earthview.world.graphic.ScriptTranslator {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::CCompositionTechniqueTranslator", new CompositionTechniqueTranslatorClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::JCCompositionTechniqueTranslatorProxy", new CompositionTechniqueTranslatorClassFactory());
	}

	public CompositionTechniqueTranslator() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCompositionTechniqueTranslatorProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.CompositionTechniqueTranslator".equals(this.getClass().getName()))
		{
	...
	public CompositionTechniqueTranslator(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CompositionTechniqueTranslator(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CompositionTechniqueTranslator fromBaseObject(BaseObject baseObj)
	{
		...
		CompositionTechniqueTranslator obj = null;
 		if(baseObj instanceof CompositionTechniqueTranslator)
		{
			obj = (CompositionTechniqueTranslator)baseObj;
		} else {
