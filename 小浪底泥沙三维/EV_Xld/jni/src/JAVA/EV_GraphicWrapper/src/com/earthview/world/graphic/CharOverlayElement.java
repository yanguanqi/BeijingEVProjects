...
public class CharOverlayElement extends com.earthview.world.graphic.OverlayElement {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::CCharOverlayElement", new CharOverlayElementClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::JCCharOverlayElementProxy", new CharOverlayElementClassFactory());
	}
	...
	native private static String get_msTypeName_void();
	public static String get_msTypeName()
	{
		String jniValue = get_msTypeName_void();
		
		return jniValue;
	}
	
	native private static void set_msTypeName_EVString (String value);
	public static void set_msTypeName(String msTypeName)
	{
		String msTypeNameParamValue = msTypeName;
		
		set_msTypeName_EVString(msTypeNameParamValue);
	}
	
	public CharOverlayElement(String name) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer namePtr = new BasePointer(name);
		list.add("name", namePtr.get());
		Create("JCCharOverlayElementProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.CharOverlayElement".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
		}
	}

	protected  void updateColors_void_callback()
	{
		updateColors();
	}

	native private void updateColors_void(long pNativeObject);
	public void updateColors()
	{
		updateColors_void(this.nativeObject.pointer);
	}
	native private void updateColors_void_NoVirtual(long pNativeObject);
	protected void updateColors_NoVirtual()
	{
		updateColors_void_NoVirtual(this.nativeObject.pointer);
	}
	...
	native private void setChar_ev_wchar(long pNativeObject, char unicode);
	public void setChar(char unicode)
	{
		char unicodeParamValue = unicode;
		setChar_ev_wchar(this.nativeObject.pointer, unicodeParamValue);
	}
	native private void setContainer_CTextAreaOverlayElement(long pNativeObject, long container);
	public void setContainer(com.earthview.world.graphic.TextAreaOverlayElement container)
	{
		long containerParamValue = (container == null ? 0L : container.nativeObject.pointer);
		setContainer_CTextAreaOverlayElement(this.nativeObject.pointer, containerParamValue);
	}
	native private void setPen_ev_real32_ev_real32(long pNativeObject, float x, float y);
	public void setPen(float x, float y)
	{
		float xParamValue = x;
		float yParamValue = y;
		setPen_ev_real32_ev_real32(this.nativeObject.pointer, xParamValue, yParamValue);
	}
	native private void getPen_ev_real32_ev_real32(long pNativeObject, long x, long y);
	public void getPen(FloatPointer x, FloatPointer y)
	{
		long xParamValue = x.nativeObject.pointer;
		long yParamValue = y.nativeObject.pointer;
		getPen_ev_real32_ev_real32(this.nativeObject.pointer, xParamValue, yParamValue);
	}
	...
	public CharOverlayElement(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CharOverlayElement(CreatedWhenConstruct cwc, String classNameStr) {
	...
	native protected void register_updateColors_void(long pNativeObject, String method);
	...
	public void registerCallback(){
		if (!this.nativeObject.equals(InstancePointer.ZERO)){
			this.register_updateColors_void(this.nativeObject.pointer, "updateColors_void_callback");
	...
	public static CharOverlayElement fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		CharOverlayElement obj = null;
 		if(baseObj instanceof CharOverlayElement)
		{
			obj = (CharOverlayElement)baseObj;
		} else {
			obj = new CharOverlayElement(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CCharOverlayElement");
			obj.increaseCast();
		}
