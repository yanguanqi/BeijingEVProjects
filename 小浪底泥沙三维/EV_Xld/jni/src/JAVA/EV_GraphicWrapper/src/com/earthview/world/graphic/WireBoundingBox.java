 ...
 * 线框盒类
 */
public class WireBoundingBox extends com.earthview.world.graphic.SimpleRenderable {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::CWireBoundingBox", new WireBoundingBoxClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::JCWireBoundingBoxProxy", new WireBoundingBoxClassFactory());
	}
	...
	public WireBoundingBox() {
		...
		Create("JCWireBoundingBoxProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.WireBoundingBox".equals(this.getClass().getName()))
		{
	...
	public WireBoundingBox(String name) {
		...
		Create("JCWireBoundingBoxProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.WireBoundingBox".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
	...
	public WireBoundingBox(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public WireBoundingBox(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static WireBoundingBox fromBaseObject(BaseObject baseObj)
	{
		...
		WireBoundingBox obj = null;
 		if(baseObj instanceof WireBoundingBox)
		{
			obj = (WireBoundingBox)baseObj;
		} else {
