...
public class Pkmcodec extends com.earthview.world.graphic.ImageCodec {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::CPKMCodec", new PkmcodecClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::JCPKMCodecProxy", new PkmcodecClassFactory());
	}

	public Pkmcodec() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCPKMCodecProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.Pkmcodec".equals(this.getClass().getName()))
		{
	...
	public Pkmcodec(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Pkmcodec(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Pkmcodec fromBaseObject(BaseObject baseObj)
	{
		...
		Pkmcodec obj = null;
 		if(baseObj instanceof Pkmcodec)
		{
			obj = (Pkmcodec)baseObj;
		} else {
