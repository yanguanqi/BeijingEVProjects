...
/**
 * 粒子发射器的命令对象获得/设置发射器重复发射最小间隔时间参数
 */
public class CmdMinRepeatDelay extends com.earthview.world.core.ParamCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::EmitterCommands::CCmdMinRepeatDelay", new CmdMinRepeatDelayClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::EmitterCommands::JCCmdMinRepeatDelayProxy", new CmdMinRepeatDelayClassFactory());
	}
	 ...
	 * @param  
	 */
	public CmdMinRepeatDelay() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCmdMinRepeatDelayProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.emittercommands.CmdMinRepeatDelay".equals(this.getClass().getName()))
		{
	 ...
	 * @param target 
	 * @return 返回EVString类型的发射器重复发射最小间隔时间的值
	 */
	...
	public CmdMinRepeatDelay(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CmdMinRepeatDelay(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CmdMinRepeatDelay fromBaseObject(BaseObject baseObj)
	{
		...
		CmdMinRepeatDelay obj = null;
 		if(baseObj instanceof CmdMinRepeatDelay)
		{
			obj = (CmdMinRepeatDelay)baseObj;
		} else {
