...
public class DefaultPlaneBoundedVolumeListSceneQuery extends com.earthview.world.graphic.PlaneBoundedVolumeListSceneQuery {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::CDefaultPlaneBoundedVolumeListSceneQuery", new DefaultPlaneBoundedVolumeListSceneQueryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::JCDefaultPlaneBoundedVolumeListSceneQueryProxy", new DefaultPlaneBoundedVolumeListSceneQueryClassFactory());
	}

	public DefaultPlaneBoundedVolumeListSceneQuery(com.earthview.world.graphic.SceneManager ref_creator) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer ref_creatorPtr = new BasePointer(ref_creator);
		list.add("ref_creator", ref_creatorPtr.get());
		Create("JCDefaultPlaneBoundedVolumeListSceneQueryProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.DefaultPlaneBoundedVolumeListSceneQuery".equals(this.getClass().getName()))
		{
	...
	public DefaultPlaneBoundedVolumeListSceneQuery(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public DefaultPlaneBoundedVolumeListSceneQuery(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static DefaultPlaneBoundedVolumeListSceneQuery fromBaseObject(BaseObject baseObj)
	{
		...
		DefaultPlaneBoundedVolumeListSceneQuery obj = null;
 		if(baseObj instanceof DefaultPlaneBoundedVolumeListSceneQuery)
		{
			obj = (DefaultPlaneBoundedVolumeListSceneQuery)baseObj;
		} else {
