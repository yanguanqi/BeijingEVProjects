 ...
 * 光线工厂类创建光线实例
 */
public class LightFactory extends com.earthview.world.graphic.MovableObjectFactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::CLightFactory", new LightFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::JCLightFactoryProxy", new LightFactoryClassFactory());
	}
	...
	public LightFactory() {
		...
		Create("JCLightFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.LightFactory".equals(this.getClass().getName()))
		{
	...
	public LightFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public LightFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static LightFactory fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		LightFactory obj = null;
 		if(baseObj instanceof LightFactory)
		{
			obj = (LightFactory)baseObj;
		} else {
			obj = new LightFactory(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CLightFactory");
			obj.increaseCast();
		}
