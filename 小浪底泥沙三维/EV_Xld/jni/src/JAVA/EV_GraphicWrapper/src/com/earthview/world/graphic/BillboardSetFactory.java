 ...
 */
public class BillboardSetFactory extends com.earthview.world.graphic.MovableObjectFactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::CBillboardSetFactory", new BillboardSetFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::JCBillboardSetFactoryProxy", new BillboardSetFactoryClassFactory());
	}
	...
	public BillboardSetFactory() {
		...
		Create("JCBillboardSetFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.BillboardSetFactory".equals(this.getClass().getName()))
		{
	...
	public BillboardSetFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public BillboardSetFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static BillboardSetFactory fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		BillboardSetFactory obj = null;
 		if(baseObj instanceof BillboardSetFactory)
		{
			obj = (BillboardSetFactory)baseObj;
		} else {
			obj = new BillboardSetFactory(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CBillboardSetFactory");
			obj.increaseCast();
		}
