 ...
 * 盒选择类盒与目标轴向包围盒求交
 */
public class BoxSelector extends com.earthview.world.graphic.AxisAlignedBoxSceneQuery {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::CBoxSelector", new BoxSelectorClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::JCBoxSelectorProxy", new BoxSelectorClassFactory());
	}

	public BoxSelector(com.earthview.world.graphic.SceneManager ref_creator) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer ref_creatorPtr = new BasePointer(ref_creator);
		list.add("ref_creator", ref_creatorPtr.get());
		Create("JCBoxSelectorProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.BoxSelector".equals(this.getClass().getName()))
		{
	...
	public BoxSelector(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public BoxSelector(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static BoxSelector fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		BoxSelector obj = null;
 		if(baseObj instanceof BoxSelector)
		{
			obj = (BoxSelector)baseObj;
		} else {
			obj = new BoxSelector(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CBoxSelector");
			obj.increaseCast();
		}
