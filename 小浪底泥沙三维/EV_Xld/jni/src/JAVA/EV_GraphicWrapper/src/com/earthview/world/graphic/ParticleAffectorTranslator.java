...
public class ParticleAffectorTranslator extends com.earthview.world.graphic.ScriptTranslator {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::CParticleAffectorTranslator", new ParticleAffectorTranslatorClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::JCParticleAffectorTranslatorProxy", new ParticleAffectorTranslatorClassFactory());
	}

	public ParticleAffectorTranslator() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCParticleAffectorTranslatorProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.ParticleAffectorTranslator".equals(this.getClass().getName()))
		{
	...
	public ParticleAffectorTranslator(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ParticleAffectorTranslator(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ParticleAffectorTranslator fromBaseObject(BaseObject baseObj)
	{
		...
		ParticleAffectorTranslator obj = null;
 		if(baseObj instanceof ParticleAffectorTranslator)
		{
			obj = (ParticleAffectorTranslator)baseObj;
		} else {
