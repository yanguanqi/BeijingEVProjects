...
public class CompositionTargetPassTranslator extends com.earthview.world.graphic.ScriptTranslator {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::CCompositionTargetPassTranslator", new CompositionTargetPassTranslatorClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::JCCompositionTargetPassTranslatorProxy", new CompositionTargetPassTranslatorClassFactory());
	}

	public CompositionTargetPassTranslator() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCompositionTargetPassTranslatorProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.CompositionTargetPassTranslator".equals(this.getClass().getName()))
		{
	...
	public CompositionTargetPassTranslator(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CompositionTargetPassTranslator(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CompositionTargetPassTranslator fromBaseObject(BaseObject baseObj)
	{
		...
		CompositionTargetPassTranslator obj = null;
 		if(baseObj instanceof CompositionTargetPassTranslator)
		{
			obj = (CompositionTargetPassTranslator)baseObj;
		} else {
