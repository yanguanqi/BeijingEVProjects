...
public class TextureUnitTranslator extends com.earthview.world.graphic.ScriptTranslator {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::CTextureUnitTranslator", new TextureUnitTranslatorClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::JCTextureUnitTranslatorProxy", new TextureUnitTranslatorClassFactory());
	}

	public TextureUnitTranslator() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCTextureUnitTranslatorProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.TextureUnitTranslator".equals(this.getClass().getName()))
		{
	...
	public TextureUnitTranslator(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public TextureUnitTranslator(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static TextureUnitTranslator fromBaseObject(BaseObject baseObj)
	{
		...
		TextureUnitTranslator obj = null;
 		if(baseObj instanceof TextureUnitTranslator)
		{
			obj = (TextureUnitTranslator)baseObj;
		} else {
