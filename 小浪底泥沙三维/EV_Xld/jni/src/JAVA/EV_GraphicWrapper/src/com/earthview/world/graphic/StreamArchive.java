...
public class StreamArchive extends com.earthview.world.core.Archive {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::CStreamArchive", new StreamArchiveClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::JCStreamArchiveProxy", new StreamArchiveClassFactory());
	}

	public StreamArchive(String name, String archType) {
		...
		Create("JCStreamArchiveProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.StreamArchive".equals(this.getClass().getName()))
		{
	...
	native private void addItem_EVString_DataStreamPtr(long pNativeObject, String filename, long item);
	///zxt add
	public void addItem(String filename, com.earthview.world.core.DataStreamPtr item)
	{
		String filenameParamValue = filename;
		long itemParamValue = item.nativeObject.pointer;
		addItem_EVString_DataStreamPtr(this.nativeObject.pointer, filenameParamValue, itemParamValue);
	}
	...
	public StreamArchive(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public StreamArchive(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static StreamArchive fromBaseObject(BaseObject baseObj)
	{
		...
		StreamArchive obj = null;
 		if(baseObj instanceof StreamArchive)
		{
			obj = (StreamArchive)baseObj;
		} else {
