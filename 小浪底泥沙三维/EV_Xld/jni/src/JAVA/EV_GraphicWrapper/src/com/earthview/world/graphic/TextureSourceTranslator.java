...
public class TextureSourceTranslator extends com.earthview.world.graphic.ScriptTranslator {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::CTextureSourceTranslator", new TextureSourceTranslatorClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::JCTextureSourceTranslatorProxy", new TextureSourceTranslatorClassFactory());
	}

	public TextureSourceTranslator() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCTextureSourceTranslatorProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.TextureSourceTranslator".equals(this.getClass().getName()))
		{
	...
	public TextureSourceTranslator(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public TextureSourceTranslator(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static TextureSourceTranslator fromBaseObject(BaseObject baseObj)
	{
		...
		TextureSourceTranslator obj = null;
 		if(baseObj instanceof TextureSourceTranslator)
		{
			obj = (TextureSourceTranslator)baseObj;
		} else {
