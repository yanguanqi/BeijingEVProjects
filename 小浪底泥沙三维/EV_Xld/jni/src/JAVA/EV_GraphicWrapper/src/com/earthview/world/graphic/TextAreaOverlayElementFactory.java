...
public class TextAreaOverlayElementFactory extends com.earthview.world.graphic.OverlayElementFactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::CTextAreaOverlayElementFactory", new TextAreaOverlayElementFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::JCTextAreaOverlayElementFactoryProxy", new TextAreaOverlayElementFactoryClassFactory());
	}

	public TextAreaOverlayElementFactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCTextAreaOverlayElementFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.TextAreaOverlayElementFactory".equals(this.getClass().getName()))
		{
	...
	public TextAreaOverlayElementFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public TextAreaOverlayElementFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static TextAreaOverlayElementFactory fromBaseObject(BaseObject baseObj)
	{
		...
		TextAreaOverlayElementFactory obj = null;
 		if(baseObj instanceof TextAreaOverlayElementFactory)
		{
			obj = (TextAreaOverlayElementFactory)baseObj;
		} else {
