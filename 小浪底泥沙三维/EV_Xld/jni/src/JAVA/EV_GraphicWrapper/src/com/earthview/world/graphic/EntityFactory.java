 ...
 * 实体类工厂为实体创建实例
 */
public class EntityFactory extends com.earthview.world.graphic.MovableObjectFactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::CEntityFactory", new EntityFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::JCEntityFactoryProxy", new EntityFactoryClassFactory());
	}
	...
	public EntityFactory() {
		...
		Create("JCEntityFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.EntityFactory".equals(this.getClass().getName()))
		{
	...
	public EntityFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public EntityFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static EntityFactory fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		EntityFactory obj = null;
 		if(baseObj instanceof EntityFactory)
		{
			obj = (EntityFactory)baseObj;
		} else {
			obj = new EntityFactory(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CEntityFactory");
			obj.increaseCast();
		}
