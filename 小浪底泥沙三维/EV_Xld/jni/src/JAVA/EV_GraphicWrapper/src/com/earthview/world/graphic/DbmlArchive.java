...
public class DbmlArchive extends com.earthview.world.core.Archive {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::CDbmlArchive", new DbmlArchiveClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::JCDbmlArchiveProxy", new DbmlArchiveClassFactory());
	}

	public DbmlArchive(String name, String archType) {
		...
		Create("JCDbmlArchiveProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.DbmlArchive".equals(this.getClass().getName()))
		{
	...
	public DbmlArchive(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public DbmlArchive(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static DbmlArchive fromBaseObject(BaseObject baseObj)
	{
		...
		DbmlArchive obj = null;
 		if(baseObj instanceof DbmlArchive)
		{
			obj = (DbmlArchive)baseObj;
		} else {
