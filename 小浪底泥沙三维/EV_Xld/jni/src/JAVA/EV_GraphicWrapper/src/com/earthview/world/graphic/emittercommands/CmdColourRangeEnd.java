...
/**
 * 粒子发射器的命令对象获得/设置发射粒子的最大颜色值参数
 */
public class CmdColourRangeEnd extends com.earthview.world.core.ParamCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::EmitterCommands::CCmdColourRangeEnd", new CmdColourRangeEndClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::EmitterCommands::JCCmdColourRangeEndProxy", new CmdColourRangeEndClassFactory());
	}
	 ...
	 * @param  
	 */
	public CmdColourRangeEnd() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCmdColourRangeEndProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.emittercommands.CmdColourRangeEnd".equals(this.getClass().getName()))
		{
	...
	public CmdColourRangeEnd(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CmdColourRangeEnd(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CmdColourRangeEnd fromBaseObject(BaseObject baseObj)
	{
		...
		CmdColourRangeEnd obj = null;
 		if(baseObj instanceof CmdColourRangeEnd)
		{
			obj = (CmdColourRangeEnd)baseObj;
		} else {
