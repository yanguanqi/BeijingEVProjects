 ...
 * 射线选择类三角面精确选择
 */
public class RaySelector extends com.earthview.world.graphic.RaySceneQuery {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::CRaySelector", new RaySelectorClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::JCRaySelectorProxy", new RaySelectorClassFactory());
	}

	public RaySelector(com.earthview.world.graphic.SceneManager ref_creator) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer ref_creatorPtr = new BasePointer(ref_creator);
		list.add("ref_creator", ref_creatorPtr.get());
		Create("JCRaySelectorProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.RaySelector".equals(this.getClass().getName()))
		{
	...
	public RaySelector(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public RaySelector(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static RaySelector fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		RaySelector obj = null;
 		if(baseObj instanceof RaySelector)
		{
			obj = (RaySelector)baseObj;
		} else {
			obj = new RaySelector(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CRaySelector");
			obj.increaseCast();
		}
