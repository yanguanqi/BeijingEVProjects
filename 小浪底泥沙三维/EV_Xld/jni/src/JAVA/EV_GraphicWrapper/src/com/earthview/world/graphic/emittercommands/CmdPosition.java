...
/**
 * 粒子发射器的命令对象获得/设置粒子发射相对于粒子系统中心的位置参数
 */
public class CmdPosition extends com.earthview.world.core.ParamCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::EmitterCommands::CCmdPosition", new CmdPositionClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::EmitterCommands::JCCmdPositionProxy", new CmdPositionClassFactory());
	}
	...
	public CmdPosition() {
		...
		Create("JCCmdPositionProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.emittercommands.CmdPosition".equals(this.getClass().getName()))
		{
	 ...
	 * @param target 
	 * @return 返回EVString类型的粒子发射相对于粒子系统中心的位置值
	 */
	...
	public CmdPosition(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CmdPosition(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CmdPosition fromBaseObject(BaseObject baseObj)
	{
		...
		CmdPosition obj = null;
 		if(baseObj instanceof CmdPosition)
		{
			obj = (CmdPosition)baseObj;
		} else {
