...
public class CmdVisible extends com.earthview.world.core.ParamCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::OverlayElementCommands::CCmdVisible", new CmdVisibleClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::OverlayElementCommands::JCCmdVisibleProxy", new CmdVisibleClassFactory());
	}

	public CmdVisible() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCmdVisibleProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.overlayelementcommands.CmdVisible".equals(this.getClass().getName()))
		{
	...
	public CmdVisible(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CmdVisible(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CmdVisible fromBaseObject(BaseObject baseObj)
	{
		...
		CmdVisible obj = null;
 		if(baseObj instanceof CmdVisible)
		{
			obj = (CmdVisible)baseObj;
		} else {
