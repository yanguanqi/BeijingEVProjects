 ...
 */
public class SimpleRenderable extends com.earthview.world.graphic.MovableObject {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::CSimpleRenderable", new SimpleRenderableClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::JCSimpleRenderableProxy", new SimpleRenderableClassFactory());
	}

	public static class SimpleRenderableInternal extends com.earthview.world.graphic.Renderable {
		
		static {
			GlobalClassFactoryMap.put("EarthView::World::Graphic::CSimpleRenderable::CSimpleRenderableInternal", new SimpleRenderableInternalClassFactory());
			GlobalClassFactoryMap.put("EarthView::World::Graphic::CSimpleRenderable::JCSimpleRenderableInternalProxy", new SimpleRenderableInternalClassFactory());
		}
		 ...
		 */
		public SimpleRenderableInternal(com.earthview.world.graphic.SimpleRenderable ref_parent) {
			super(CreatedWhenConstruct.CWC_NotToCreate);
			NameValuePairList list = new NameValuePairList();
			BasePointer ref_parentPtr = new BasePointer(ref_parent);
			list.add("ref_parent", ref_parentPtr.get());
			Create("JCSimpleRenderableInternalProxy", list, true);
			this.registerCallback();
			if (!"com.earthview.world.graphic.SimpleRenderable$SimpleRenderableInternal".equals(this.getClass().getName()))
			{
		...
		public com.earthview.world.graphic.SimpleRenderable getParent()
		{
		...
		protected  void setRenderOperation_CRenderOperation_callback(long rend)
		{
			...
			setRenderOperation(rendParamValue);
		}

		native private void setRenderOperation_CRenderOperation(long pNativeObject, long rend);
		public void setRenderOperation(com.earthview.world.graphic.RenderOperation rend)
		{
			...
			setRenderOperation_CRenderOperation(this.nativeObject.pointer, rendParamValue);
		}
		native private void setRenderOperation_CRenderOperation_NoVirtual(long pNativeObject, long rend);
		protected void setRenderOperation_NoVirtual(com.earthview.world.graphic.RenderOperation rend)
		{
			long rendParamValue = rend.nativeObject.pointer;
			setRenderOperation_CRenderOperation_NoVirtual(this.nativeObject.pointer, rendParamValue);
		}
		...
		public SimpleRenderableInternal(CreatedWhenConstruct cwc) {
			super(CreatedWhenConstruct.CWC_NotToCreate);
		}
		public SimpleRenderableInternal(CreatedWhenConstruct cwc, String classNameStr) {
		...
		public static SimpleRenderableInternal fromBaseObject(BaseObject baseObj)
		{
			...
			SimpleRenderableInternal obj = null;
 			if(baseObj instanceof SimpleRenderableInternal)
			{
				obj = (SimpleRenderableInternal)baseObj;
			} else {
	...
	public static class SimpleRenderableInternalClassFactory implements IClassFactory {
	...
	protected  long getRenderable_void_callback()
	{
		com.earthview.world.graphic.SimpleRenderable.SimpleRenderableInternal returnValue = getRenderable();
		if(returnValue == null) {
			return 0L;
		}
	...
	public com.earthview.world.graphic.SimpleRenderable.SimpleRenderableInternal getRenderable()
	{
		...
		com.earthview.world.graphic.SimpleRenderable.SimpleRenderableInternal __returnValue = new com.earthview.world.graphic.SimpleRenderable.SimpleRenderableInternal(CreatedWhenConstruct.CWC_NotToCreate, "CSimpleRenderableInternal");
		__returnValue.setDelegate(true);
		InstancePointer __instancePointer = new InstancePointer(returnValue);
		__returnValue.setInstancePointer(__instancePointer);
		IClassFactory __returnValueClassFactory = GlobalClassFactoryMap.get(__returnValue.getCppInstanceTypeName());
		...
		{
			__returnValue.setDelegate(true);
			__returnValue = (com.earthview.world.graphic.SimpleRenderable.SimpleRenderableInternal)__returnValueClassFactory.create();
			__returnValue.setDelegate(true);
			__returnValue.bindNativeObject(__instancePointer, "CSimpleRenderableInternal");
		}
		return __returnValue;
	}
	native private long getRenderable_void_NoVirtual(long pNativeObject);
	protected com.earthview.world.graphic.SimpleRenderable.SimpleRenderableInternal getRenderable_NoVirtual()
	{
		long returnValue = getRenderable_void_NoVirtual(this.nativeObject.pointer);
		if(returnValue == 0L) {
			return null;
		}
		com.earthview.world.graphic.SimpleRenderable.SimpleRenderableInternal __returnValue = new com.earthview.world.graphic.SimpleRenderable.SimpleRenderableInternal(CreatedWhenConstruct.CWC_NotToCreate, "CSimpleRenderableInternal");
	...
	public SimpleRenderable() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCSimpleRenderableProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.SimpleRenderable".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
		}
	}
	...
	public SimpleRenderable(String name) {
		...
		Create("JCSimpleRenderableProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.SimpleRenderable".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
	...
	native private void setTransform_CMatrix4(long pNativeObject, long xform);
	public void setTransform(com.earthview.world.spatial.math.Matrix4 xform)
	{
		long xformParamValue = xform.nativeObject.pointer;
		setTransform_CMatrix4(this.nativeObject.pointer, xformParamValue);
	}
	public SimpleRenderable(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public SimpleRenderable(CreatedWhenConstruct cwc, String classNameStr) {
		super(CreatedWhenConstruct.CWC_NotToCreate, classNameStr);
	}
	...
	public static SimpleRenderable fromBaseObject(BaseObject baseObj)
	{
		...
		SimpleRenderable obj = null;
 		if(baseObj instanceof SimpleRenderable)
		{
			obj = (SimpleRenderable)baseObj;
		} else {
