...
public class CompositionPassTranslator extends com.earthview.world.graphic.ScriptTranslator {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::CCompositionPassTranslator", new CompositionPassTranslatorClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::JCCompositionPassTranslatorProxy", new CompositionPassTranslatorClassFactory());
	}

	public CompositionPassTranslator() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCompositionPassTranslatorProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.CompositionPassTranslator".equals(this.getClass().getName()))
		{
	...
	public CompositionPassTranslator(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CompositionPassTranslator(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CompositionPassTranslator fromBaseObject(BaseObject baseObj)
	{
		...
		CompositionPassTranslator obj = null;
 		if(baseObj instanceof CompositionPassTranslator)
		{
			obj = (CompositionPassTranslator)baseObj;
		} else {
