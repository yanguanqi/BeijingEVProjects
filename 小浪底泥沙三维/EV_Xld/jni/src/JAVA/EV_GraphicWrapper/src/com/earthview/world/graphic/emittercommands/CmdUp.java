...
public class CmdUp extends com.earthview.world.core.ParamCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::EmitterCommands::CCmdUp", new CmdUpClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::EmitterCommands::JCCmdUpProxy", new CmdUpClassFactory());
	}
	...
	public CmdUp() {
		...
		Create("JCCmdUpProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.emittercommands.CmdUp".equals(this.getClass().getName()))
		{
	...
	public CmdUp(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CmdUp(CreatedWhenConstruct cwc, String classNameStr) {
