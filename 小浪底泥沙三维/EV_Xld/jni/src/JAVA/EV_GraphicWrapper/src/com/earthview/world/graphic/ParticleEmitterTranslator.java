...
public class ParticleEmitterTranslator extends com.earthview.world.graphic.ScriptTranslator {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::CParticleEmitterTranslator", new ParticleEmitterTranslatorClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::JCParticleEmitterTranslatorProxy", new ParticleEmitterTranslatorClassFactory());
	}

	public ParticleEmitterTranslator() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCParticleEmitterTranslatorProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.ParticleEmitterTranslator".equals(this.getClass().getName()))
		{
	...
	public ParticleEmitterTranslator(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ParticleEmitterTranslator(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ParticleEmitterTranslator fromBaseObject(BaseObject baseObj)
	{
		...
		ParticleEmitterTranslator obj = null;
 		if(baseObj instanceof ParticleEmitterTranslator)
		{
			obj = (ParticleEmitterTranslator)baseObj;
		} else {
