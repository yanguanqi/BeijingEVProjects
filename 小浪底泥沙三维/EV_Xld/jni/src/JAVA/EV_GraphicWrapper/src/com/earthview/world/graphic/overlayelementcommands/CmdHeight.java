...
public class CmdHeight extends com.earthview.world.core.ParamCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::OverlayElementCommands::CCmdHeight", new CmdHeightClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::OverlayElementCommands::JCCmdHeightProxy", new CmdHeightClassFactory());
	}

	public CmdHeight() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCmdHeightProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.overlayelementcommands.CmdHeight".equals(this.getClass().getName()))
		{
	...
	public CmdHeight(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CmdHeight(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CmdHeight fromBaseObject(BaseObject baseObj)
	{
		...
		CmdHeight obj = null;
 		if(baseObj instanceof CmdHeight)
		{
			obj = (CmdHeight)baseObj;
		} else {
