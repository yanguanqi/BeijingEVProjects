...
public class InstanceBatchHW extends com.earthview.world.graphic.InstanceBatch {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::CInstanceBatchHW", new InstanceBatchHWClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::JCInstanceBatchHWProxy", new InstanceBatchHWClassFactory());
	}

	public InstanceBatchHW(com.earthview.world.graphic.InstanceManager ref_creator, com.earthview.world.graphic.MeshPtr meshReference, com.earthview.world.graphic.MaterialPtr material, long instancesPerBatch, com.earthview.world.graphic.IndexMap ref_indexToBoneMap, String batchName) {
		...
		Create("JCInstanceBatchHWProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.InstanceBatchHW".equals(this.getClass().getName()))
		{
	...
	native private void prepareMatrixBuffer_void(long pNativeObject);
	public void prepareMatrixBuffer()
	{
		prepareMatrixBuffer_void(this.nativeObject.pointer);
	}
	...
	/**
	 * 跟踪父节点内部instance专用(instancedentity之间相对静止)
	 * @param pNode 
	 */
	...
	native private boolean linkEntity_CEntity(long pNativeObject, long pEntity);
	public boolean linkEntity(com.earthview.world.graphic.Entity pEntity)
	{
		long pEntityParamValue = (pEntity == null ? 0L : pEntity.nativeObject.pointer);
		boolean returnValue = linkEntity_CEntity(this.nativeObject.pointer, pEntityParamValue);
		return returnValue;
	}
	...
	public InstanceBatchHW(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public InstanceBatchHW(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static InstanceBatchHW fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		InstanceBatchHW obj = null;
 		if(baseObj instanceof InstanceBatchHW)
		{
			obj = (InstanceBatchHW)baseObj;
		} else {
			obj = new InstanceBatchHW(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CInstanceBatchHW");
			obj.increaseCast();
		}
