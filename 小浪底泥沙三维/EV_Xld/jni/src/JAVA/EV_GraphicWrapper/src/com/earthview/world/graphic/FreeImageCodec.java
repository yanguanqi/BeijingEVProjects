...
public class FreeImageCodec extends com.earthview.world.graphic.ImageCodec {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::CFreeImageCodec", new FreeImageCodecClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::JCFreeImageCodecProxy", new FreeImageCodecClassFactory());
	}

	public FreeImageCodec(String type, long fiType) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer typePtr = new BasePointer(type);
		list.add("type", typePtr.get());
		BasePointer fiTypePtr = new BasePointer(fiType);
		list.add("fiType", fiTypePtr.get());
		Create("JCFreeImageCodecProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.FreeImageCodec".equals(this.getClass().getName()))
		{
	...
	public FreeImageCodec(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public FreeImageCodec(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static FreeImageCodec fromBaseObject(BaseObject baseObj)
	{
		...
		FreeImageCodec obj = null;
 		if(baseObj instanceof FreeImageCodec)
		{
			obj = (FreeImageCodec)baseObj;
		} else {
