 ...
 * 字符串可渲染对象
 */
public class RenderableString extends com.earthview.world.graphic.RenderableFont {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::CRenderableString", new RenderableStringClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::JCRenderableStringProxy", new RenderableStringClassFactory());
	}

	public RenderableString(String wstr) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer wstrPtr = new BasePointer(wstr);
		list.add("wstr", wstrPtr.get());
		Create("JCRenderableStringProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.RenderableString".equals(this.getClass().getName()))
		{
	...
	native private long getMaterials_void(long pNativeObject);
	public com.earthview.world.graphic.MaterialPtrList getMaterials()
	{
		long returnValue = getMaterials_void(this.nativeObject.pointer);
	...
	public RenderableString(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public RenderableString(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static RenderableString fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		RenderableString obj = null;
 		if(baseObj instanceof RenderableString)
		{
			obj = (RenderableString)baseObj;
		} else {
			obj = new RenderableString(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CRenderableString");
			obj.increaseCast();
		}
