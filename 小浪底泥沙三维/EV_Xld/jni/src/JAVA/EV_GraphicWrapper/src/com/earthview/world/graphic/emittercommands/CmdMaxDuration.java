...
/**
 * 粒子发射器的命令对象获得/设置发射器最大持续时间参数
 */
public class CmdMaxDuration extends com.earthview.world.core.ParamCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::EmitterCommands::CCmdMaxDuration", new CmdMaxDurationClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::EmitterCommands::JCCmdMaxDurationProxy", new CmdMaxDurationClassFactory());
	}
	 ...
	 * @param  
	 */
	public CmdMaxDuration() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCmdMaxDurationProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.emittercommands.CmdMaxDuration".equals(this.getClass().getName()))
		{
	...
	public CmdMaxDuration(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CmdMaxDuration(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CmdMaxDuration fromBaseObject(BaseObject baseObj)
	{
		...
		CmdMaxDuration obj = null;
 		if(baseObj instanceof CmdMaxDuration)
		{
			obj = (CmdMaxDuration)baseObj;
		} else {
