...
///	};
public class CompositionPassStencilTranslator extends com.earthview.world.graphic.ScriptTranslator {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::CCompositionPassStencilTranslator", new CompositionPassStencilTranslatorClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::JCCompositionPassStencilTranslatorProxy", new CompositionPassStencilTranslatorClassFactory());
	}

	public CompositionPassStencilTranslator() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCompositionPassStencilTranslatorProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.CompositionPassStencilTranslator".equals(this.getClass().getName()))
		{
	...
	public CompositionPassStencilTranslator(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CompositionPassStencilTranslator(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CompositionPassStencilTranslator fromBaseObject(BaseObject baseObj)
	{
		...
		CompositionPassStencilTranslator obj = null;
 		if(baseObj instanceof CompositionPassStencilTranslator)
		{
			obj = (CompositionPassStencilTranslator)baseObj;
		} else {
