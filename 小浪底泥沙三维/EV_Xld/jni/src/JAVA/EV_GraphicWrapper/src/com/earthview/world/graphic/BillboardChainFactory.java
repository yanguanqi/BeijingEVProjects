 ...
 * 广告板链类工厂定义相关操作
 */
public class BillboardChainFactory extends com.earthview.world.graphic.MovableObjectFactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::CBillboardChainFactory", new BillboardChainFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::JCBillboardChainFactoryProxy", new BillboardChainFactoryClassFactory());
	}
	...
	public BillboardChainFactory() {
		...
		Create("JCBillboardChainFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.BillboardChainFactory".equals(this.getClass().getName()))
		{
	...
	public BillboardChainFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public BillboardChainFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static BillboardChainFactory fromBaseObject(BaseObject baseObj)
	{
		...
		BillboardChainFactory obj = null;
 		if(baseObj instanceof BillboardChainFactory)
		{
			obj = (BillboardChainFactory)baseObj;
		} else {
