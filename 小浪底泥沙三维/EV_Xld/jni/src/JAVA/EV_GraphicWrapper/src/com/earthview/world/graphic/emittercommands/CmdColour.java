...
/**
 * 粒子发射器的命令对象获得/设置发射粒子颜色参数
 */
public class CmdColour extends com.earthview.world.core.ParamCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::EmitterCommands::CCmdColour", new CmdColourClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::EmitterCommands::JCCmdColourProxy", new CmdColourClassFactory());
	}
	...
	public CmdColour() {
		...
		Create("JCCmdColourProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.emittercommands.CmdColour".equals(this.getClass().getName()))
		{
	...
	public CmdColour(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CmdColour(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CmdColour fromBaseObject(BaseObject baseObj)
	{
		...
		CmdColour obj = null;
 		if(baseObj instanceof CmdColour)
		{
			obj = (CmdColour)baseObj;
		} else {
