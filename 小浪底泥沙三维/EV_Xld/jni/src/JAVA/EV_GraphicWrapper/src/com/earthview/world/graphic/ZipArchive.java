...
public class ZipArchive extends com.earthview.world.core.Archive {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::CZipArchive", new ZipArchiveClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::JCZipArchiveProxy", new ZipArchiveClassFactory());
	}
	...
	public ZipArchive(String name, String archType) {
		...
		Create("JCZipArchiveProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.ZipArchive".equals(this.getClass().getName()))
		{
	...
	public ZipArchive(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ZipArchive(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ZipArchive fromBaseObject(BaseObject baseObj)
	{
		...
		ZipArchive obj = null;
 		if(baseObj instanceof ZipArchive)
		{
			obj = (ZipArchive)baseObj;
		} else {
			obj = new ZipArchive(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CZipArchive");
			obj.increaseCast();
		}
