...
/**
 * CRibbonTrail类工厂定义类工厂及相关操作
 */
public class RibbonTrailFactory extends com.earthview.world.graphic.MovableObjectFactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::CRibbonTrailFactory", new RibbonTrailFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::JCRibbonTrailFactoryProxy", new RibbonTrailFactoryClassFactory());
	}
	...
	public RibbonTrailFactory() {
		...
		Create("JCRibbonTrailFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.RibbonTrailFactory".equals(this.getClass().getName()))
		{
	...
	public RibbonTrailFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public RibbonTrailFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static RibbonTrailFactory fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		RibbonTrailFactory obj = null;
 		if(baseObj instanceof RibbonTrailFactory)
		{
			obj = (RibbonTrailFactory)baseObj;
		} else {
			obj = new RibbonTrailFactory(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CRibbonTrailFactory");
			obj.increaseCast();
		}
