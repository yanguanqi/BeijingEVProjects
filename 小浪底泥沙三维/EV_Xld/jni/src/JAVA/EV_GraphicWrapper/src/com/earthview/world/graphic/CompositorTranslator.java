...
public class CompositorTranslator extends com.earthview.world.graphic.ScriptTranslator {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::CCompositorTranslator", new CompositorTranslatorClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::JCCompositorTranslatorProxy", new CompositorTranslatorClassFactory());
	}

	public CompositorTranslator() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCompositorTranslatorProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.CompositorTranslator".equals(this.getClass().getName()))
		{
	...
	public CompositorTranslator(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CompositorTranslator(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CompositorTranslator fromBaseObject(BaseObject baseObj)
	{
		...
		CompositorTranslator obj = null;
 		if(baseObj instanceof CompositorTranslator)
		{
			obj = (CompositorTranslator)baseObj;
		} else {
