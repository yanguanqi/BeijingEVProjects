...
public class InstanceBatchHWVtf extends com.earthview.world.graphic.BaseInstanceBatchVTF {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::CInstanceBatchHW_VTF", new InstanceBatchHWVtfClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::JCInstanceBatchHW_VTFProxy", new InstanceBatchHWVtfClassFactory());
	}

	public InstanceBatchHWVtf(com.earthview.world.graphic.InstanceManager ref_creator, com.earthview.world.graphic.MeshPtr meshReference, com.earthview.world.graphic.MaterialPtr material, long instancesPerBatch, com.earthview.world.graphic.IndexMap ref_indexToBoneMap, String batchName) {
		...
		Create("JCInstanceBatchHW_VTFProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.InstanceBatchHWVtf".equals(this.getClass().getName()))
		{
	...
	public InstanceBatchHWVtf(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public InstanceBatchHWVtf(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static InstanceBatchHWVtf fromBaseObject(BaseObject baseObj)
	{
		...
		InstanceBatchHWVtf obj = null;
 		if(baseObj instanceof InstanceBatchHWVtf)
		{
			obj = (InstanceBatchHWVtf)baseObj;
		} else {
