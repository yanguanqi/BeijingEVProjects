...
/**
 * 粒子发射器的命令对象获得/设置发射器持续时间参数
 */
public class CmdDuration extends com.earthview.world.core.ParamCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::EmitterCommands::CCmdDuration", new CmdDurationClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::EmitterCommands::JCCmdDurationProxy", new CmdDurationClassFactory());
	}
	...
	public CmdDuration() {
		...
		Create("JCCmdDurationProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.emittercommands.CmdDuration".equals(this.getClass().getName()))
		{
	...
	public CmdDuration(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CmdDuration(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CmdDuration fromBaseObject(BaseObject baseObj)
	{
		...
		CmdDuration obj = null;
 		if(baseObj instanceof CmdDuration)
		{
			obj = (CmdDuration)baseObj;
		} else {
