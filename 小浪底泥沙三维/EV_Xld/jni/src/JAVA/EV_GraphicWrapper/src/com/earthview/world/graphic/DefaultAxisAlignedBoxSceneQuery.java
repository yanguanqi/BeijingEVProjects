...
public class DefaultAxisAlignedBoxSceneQuery extends com.earthview.world.graphic.AxisAlignedBoxSceneQuery {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::CDefaultAxisAlignedBoxSceneQuery", new DefaultAxisAlignedBoxSceneQueryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::JCDefaultAxisAlignedBoxSceneQueryProxy", new DefaultAxisAlignedBoxSceneQueryClassFactory());
	}

	public DefaultAxisAlignedBoxSceneQuery(com.earthview.world.graphic.SceneManager ref_creator) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer ref_creatorPtr = new BasePointer(ref_creator);
		list.add("ref_creator", ref_creatorPtr.get());
		Create("JCDefaultAxisAlignedBoxSceneQueryProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.DefaultAxisAlignedBoxSceneQuery".equals(this.getClass().getName()))
		{
	...
	public DefaultAxisAlignedBoxSceneQuery(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public DefaultAxisAlignedBoxSceneQuery(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static DefaultAxisAlignedBoxSceneQuery fromBaseObject(BaseObject baseObj)
	{
		...
		DefaultAxisAlignedBoxSceneQuery obj = null;
 		if(baseObj instanceof DefaultAxisAlignedBoxSceneQuery)
		{
			obj = (DefaultAxisAlignedBoxSceneQuery)baseObj;
		} else {
