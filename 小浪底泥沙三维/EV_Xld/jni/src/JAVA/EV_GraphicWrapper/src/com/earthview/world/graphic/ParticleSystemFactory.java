 ...
 */
public class ParticleSystemFactory extends com.earthview.world.graphic.MovableObjectFactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::CParticleSystemFactory", new ParticleSystemFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::JCParticleSystemFactoryProxy", new ParticleSystemFactoryClassFactory());
	}
	...
	public ParticleSystemFactory() {
		...
		Create("JCParticleSystemFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.ParticleSystemFactory".equals(this.getClass().getName()))
		{
	...
	public ParticleSystemFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ParticleSystemFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ParticleSystemFactory fromBaseObject(BaseObject baseObj)
	{
		...
		ParticleSystemFactory obj = null;
 		if(baseObj instanceof ParticleSystemFactory)
		{
			obj = (ParticleSystemFactory)baseObj;
		} else {
