...
public class ColorSerializer extends com.earthview.world.graphic.AnimationBaseSerializer {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::CColorSerializer", new ColorSerializerClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::JCColorSerializerProxy", new ColorSerializerClassFactory());
	}

	public ColorSerializer() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCColorSerializerProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.ColorSerializer".equals(this.getClass().getName()))
		{
	...
	public ColorSerializer(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ColorSerializer(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ColorSerializer fromBaseObject(BaseObject baseObj)
	{
		...
		ColorSerializer obj = null;
 		if(baseObj instanceof ColorSerializer)
		{
			obj = (ColorSerializer)baseObj;
		} else {
