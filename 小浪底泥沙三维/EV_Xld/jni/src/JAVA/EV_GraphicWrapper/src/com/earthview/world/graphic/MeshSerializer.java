...
public class MeshSerializer extends com.earthview.world.graphic.ModelSerializer {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::CMeshSerializer", new MeshSerializerClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::JCMeshSerializerProxy", new MeshSerializerClassFactory());
	}

	public MeshSerializer() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCMeshSerializerProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.MeshSerializer".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
		}
	}

	native private void exportMesh_CMesh_EVString_Endian(long pNativeObject, long pMesh, String filename, int endianMode);
	public void exportMesh(com.earthview.world.graphic.Mesh pMesh, String filename, com.earthview.world.graphic.Serializer.Endian endianMode)
	{
		...
		exportMesh_CMesh_EVString_Endian(this.nativeObject.pointer, pMeshParamValue, filenameParamValue, endianModeParamValue);
	}
	native private void exportMesh_CMesh_EVString(long pNativeObject, long pMesh, String filename);
	public void exportMesh(com.earthview.world.graphic.Mesh pMesh, String filename)
	{
		long pMeshParamValue = (pMesh == null ? 0L : pMesh.nativeObject.pointer);
		String filenameParamValue = filename;
		exportMesh_CMesh_EVString(this.nativeObject.pointer, pMeshParamValue, filenameParamValue);
	}
	native private void exportMesh_CMesh_EVString_MeshVersion_Endian(long pNativeObject, long pMesh, String filename, int version, int endianMode);
	public void exportMesh(com.earthview.world.graphic.Mesh pMesh, String filename, com.earthview.world.graphic.MeshVersion version, com.earthview.world.graphic.Serializer.Endian endianMode)
	{
		long pMeshParamValue = (pMesh == null ? 0L : pMesh.nativeObject.pointer);
		String filenameParamValue = filename;
		int versionParamValue = version.getValue();
		int endianModeParamValue = endianMode.getValue();
		exportMesh_CMesh_EVString_MeshVersion_Endian(this.nativeObject.pointer, pMeshParamValue, filenameParamValue, versionParamValue, endianModeParamValue);
	}
	native private void exportMesh_CMesh_EVString_MeshVersion(long pNativeObject, long pMesh, String filename, int version);
	public void exportMesh(com.earthview.world.graphic.Mesh pMesh, String filename, com.earthview.world.graphic.MeshVersion version)
	{
		long pMeshParamValue = (pMesh == null ? 0L : pMesh.nativeObject.pointer);
		String filenameParamValue = filename;
		int versionParamValue = version.getValue();
		exportMesh_CMesh_EVString_MeshVersion(this.nativeObject.pointer, pMeshParamValue, filenameParamValue, versionParamValue);
	}
	native private void exportMesh_CMesh_DataStreamPtr_Endian(long pNativeObject, long pMesh, long stream, int endianMode);
	public void exportMesh(com.earthview.world.graphic.Mesh pMesh, com.earthview.world.core.DataStreamPtr stream, com.earthview.world.graphic.Serializer.Endian endianMode)
	{
		long pMeshParamValue = (pMesh == null ? 0L : pMesh.nativeObject.pointer);
		long streamParamValue = stream.nativeObject.pointer;
		int endianModeParamValue = endianMode.getValue();
		exportMesh_CMesh_DataStreamPtr_Endian(this.nativeObject.pointer, pMeshParamValue, streamParamValue, endianModeParamValue);
	}
	native private void exportMesh_CMesh_DataStreamPtr(long pNativeObject, long pMesh, long stream);
	public void exportMesh(com.earthview.world.graphic.Mesh pMesh, com.earthview.world.core.DataStreamPtr stream)
	{
		long pMeshParamValue = (pMesh == null ? 0L : pMesh.nativeObject.pointer);
		long streamParamValue = stream.nativeObject.pointer;
		exportMesh_CMesh_DataStreamPtr(this.nativeObject.pointer, pMeshParamValue, streamParamValue);
	}
	native private void exportMesh_CMesh_DataStreamPtr_MeshVersion_Endian(long pNativeObject, long pMesh, long stream, int version, int endianMode);
	public void exportMesh(com.earthview.world.graphic.Mesh pMesh, com.earthview.world.core.DataStreamPtr stream, com.earthview.world.graphic.MeshVersion version, com.earthview.world.graphic.Serializer.Endian endianMode)
	{
		long pMeshParamValue = (pMesh == null ? 0L : pMesh.nativeObject.pointer);
		long streamParamValue = stream.nativeObject.pointer;
		int versionParamValue = version.getValue();
		int endianModeParamValue = endianMode.getValue();
		exportMesh_CMesh_DataStreamPtr_MeshVersion_Endian(this.nativeObject.pointer, pMeshParamValue, streamParamValue, versionParamValue, endianModeParamValue);
	}
	native private void exportMesh_CMesh_DataStreamPtr_MeshVersion(long pNativeObject, long pMesh, long stream, int version);
	public void exportMesh(com.earthview.world.graphic.Mesh pMesh, com.earthview.world.core.DataStreamPtr stream, com.earthview.world.graphic.MeshVersion version)
	{
		long pMeshParamValue = (pMesh == null ? 0L : pMesh.nativeObject.pointer);
		long streamParamValue = stream.nativeObject.pointer;
		int versionParamValue = version.getValue();
		exportMesh_CMesh_DataStreamPtr_MeshVersion(this.nativeObject.pointer, pMeshParamValue, streamParamValue, versionParamValue);
	}
	...
	public MeshSerializer(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public MeshSerializer(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static MeshSerializer fromBaseObject(BaseObject baseObj)
	{
		...
		MeshSerializer obj = null;
 		if(baseObj instanceof MeshSerializer)
		{
			obj = (MeshSerializer)baseObj;
		} else {
