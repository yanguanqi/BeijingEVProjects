...
/**
 * 粒子发射器的命令对象获得/设置粒子发射的最大初始速度参数
 */
public class CmdMaxVelocity extends com.earthview.world.core.ParamCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::EmitterCommands::CCmdMaxVelocity", new CmdMaxVelocityClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::EmitterCommands::JCCmdMaxVelocityProxy", new CmdMaxVelocityClassFactory());
	}
	 ...
	 * @param  
	 */
	public CmdMaxVelocity() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCmdMaxVelocityProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.emittercommands.CmdMaxVelocity".equals(this.getClass().getName()))
		{
	...
	public CmdMaxVelocity(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CmdMaxVelocity(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CmdMaxVelocity fromBaseObject(BaseObject baseObj)
	{
		...
		CmdMaxVelocity obj = null;
 		if(baseObj instanceof CmdMaxVelocity)
		{
			obj = (CmdMaxVelocity)baseObj;
		} else {
