...
public class TechniqueTranslator extends com.earthview.world.graphic.ScriptTranslator {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::CTechniqueTranslator", new TechniqueTranslatorClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::JCTechniqueTranslatorProxy", new TechniqueTranslatorClassFactory());
	}

	public TechniqueTranslator() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCTechniqueTranslatorProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.TechniqueTranslator".equals(this.getClass().getName()))
		{
	...
	public TechniqueTranslator(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public TechniqueTranslator(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static TechniqueTranslator fromBaseObject(BaseObject baseObj)
	{
		...
		TechniqueTranslator obj = null;
 		if(baseObj instanceof TechniqueTranslator)
		{
			obj = (TechniqueTranslator)baseObj;
		} else {
