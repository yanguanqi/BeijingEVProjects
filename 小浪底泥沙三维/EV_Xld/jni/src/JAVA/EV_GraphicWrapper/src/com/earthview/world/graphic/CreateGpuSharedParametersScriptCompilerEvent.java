...
public class CreateGpuSharedParametersScriptCompilerEvent extends com.earthview.world.graphic.ScriptCompilerEvent {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::CCreateGpuSharedParametersScriptCompilerEvent", new CreateGpuSharedParametersScriptCompilerEventClassFactory());
	}
	...
	public CreateGpuSharedParametersScriptCompilerEvent(String file, String name, String resourceGroup) {
		...
		Create("CCreateGpuSharedParametersScriptCompilerEvent", list);
	}

	public CreateGpuSharedParametersScriptCompilerEvent(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CreateGpuSharedParametersScriptCompilerEvent(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CreateGpuSharedParametersScriptCompilerEvent fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		CreateGpuSharedParametersScriptCompilerEvent obj = null;
 		if(baseObj instanceof CreateGpuSharedParametersScriptCompilerEvent)
		{
			obj = (CreateGpuSharedParametersScriptCompilerEvent)baseObj;
		} else {
			obj = new CreateGpuSharedParametersScriptCompilerEvent(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CCreateGpuSharedParametersScriptCompilerEvent");
			obj.increaseCast();
		}
