...
public class CharOverlayElementFactory extends com.earthview.world.graphic.OverlayElementFactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::CCharOverlayElementFactory", new CharOverlayElementFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::JCCharOverlayElementFactoryProxy", new CharOverlayElementFactoryClassFactory());
	}

	public CharOverlayElementFactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCharOverlayElementFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.CharOverlayElementFactory".equals(this.getClass().getName()))
		{
	...
	public CharOverlayElementFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CharOverlayElementFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CharOverlayElementFactory fromBaseObject(BaseObject baseObj)
	{
		...
		CharOverlayElementFactory obj = null;
 		if(baseObj instanceof CharOverlayElementFactory)
		{
			obj = (CharOverlayElementFactory)baseObj;
		} else {
