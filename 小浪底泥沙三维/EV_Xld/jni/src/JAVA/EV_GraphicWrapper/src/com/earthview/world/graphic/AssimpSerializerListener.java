...
public class AssimpSerializerListener extends com.earthview.world.graphic.ModelSerializerListener {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::CAssimpSerializerListener", new AssimpSerializerListenerClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::JCAssimpSerializerListenerProxy", new AssimpSerializerListenerClassFactory());
	}

	public AssimpSerializerListener() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCAssimpSerializerListenerProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.AssimpSerializerListener".equals(this.getClass().getName()))
		{
	...
	public AssimpSerializerListener(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public AssimpSerializerListener(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static AssimpSerializerListener fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		AssimpSerializerListener obj = null;
 		if(baseObj instanceof AssimpSerializerListener)
		{
			obj = (AssimpSerializerListener)baseObj;
		} else {
			obj = new AssimpSerializerListener(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CAssimpSerializerListener");
			obj.increaseCast();
		}
