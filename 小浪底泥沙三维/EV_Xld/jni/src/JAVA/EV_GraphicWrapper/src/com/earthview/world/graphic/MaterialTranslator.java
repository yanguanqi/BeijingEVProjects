...
public class MaterialTranslator extends com.earthview.world.graphic.ScriptTranslator {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::CMaterialTranslator", new MaterialTranslatorClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::JCMaterialTranslatorProxy", new MaterialTranslatorClassFactory());
	}

	public MaterialTranslator() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCMaterialTranslatorProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.MaterialTranslator".equals(this.getClass().getName()))
		{
	...
	public MaterialTranslator(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public MaterialTranslator(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static MaterialTranslator fromBaseObject(BaseObject baseObj)
	{
		...
		MaterialTranslator obj = null;
 		if(baseObj instanceof MaterialTranslator)
		{
			obj = (MaterialTranslator)baseObj;
		} else {
