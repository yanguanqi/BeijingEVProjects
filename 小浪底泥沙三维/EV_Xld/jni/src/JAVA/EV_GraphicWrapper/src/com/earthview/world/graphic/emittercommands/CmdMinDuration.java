...
/**
 * 粒子发射器的命令对象获得/设置发射器最小持续时间参数
 */
public class CmdMinDuration extends com.earthview.world.core.ParamCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::EmitterCommands::CCmdMinDuration", new CmdMinDurationClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::EmitterCommands::JCCmdMinDurationProxy", new CmdMinDurationClassFactory());
	}
	 ...
	 * @param  
	 */
	public CmdMinDuration() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCmdMinDurationProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.emittercommands.CmdMinDuration".equals(this.getClass().getName()))
		{
	 ...
	 * @param target 
	 * @return 返回EVString类型的发射器最小持续时间的值
	 */
	...
	public CmdMinDuration(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CmdMinDuration(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CmdMinDuration fromBaseObject(BaseObject baseObj)
	{
		...
		CmdMinDuration obj = null;
 		if(baseObj instanceof CmdMinDuration)
		{
			obj = (CmdMinDuration)baseObj;
		} else {
