...
/**
 * 粒子发射器的命令对象获得/设置发射器重复发射间隔的时间参数
 */
public class CmdRepeatDelay extends com.earthview.world.core.ParamCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::EmitterCommands::CCmdRepeatDelay", new CmdRepeatDelayClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::EmitterCommands::JCCmdRepeatDelayProxy", new CmdRepeatDelayClassFactory());
	}
	 ...
	 * @param  
	 */
	public CmdRepeatDelay() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCmdRepeatDelayProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.emittercommands.CmdRepeatDelay".equals(this.getClass().getName()))
		{
	 ...
	 * @param target 
	 * @return 返回EVString类型的发射器重复发射间隔的时间的值
	 */
	...
	public CmdRepeatDelay(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CmdRepeatDelay(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CmdRepeatDelay fromBaseObject(BaseObject baseObj)
	{
		...
		CmdRepeatDelay obj = null;
 		if(baseObj instanceof CmdRepeatDelay)
		{
			obj = (CmdRepeatDelay)baseObj;
		} else {
