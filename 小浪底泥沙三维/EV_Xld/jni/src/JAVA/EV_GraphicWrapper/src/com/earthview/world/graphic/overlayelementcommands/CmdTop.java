...
public class CmdTop extends com.earthview.world.core.ParamCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::OverlayElementCommands::CCmdTop", new CmdTopClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::OverlayElementCommands::JCCmdTopProxy", new CmdTopClassFactory());
	}

	public CmdTop() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCmdTopProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.overlayelementcommands.CmdTop".equals(this.getClass().getName()))
		{
	...
	public CmdTop(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CmdTop(CreatedWhenConstruct cwc, String classNameStr) {
