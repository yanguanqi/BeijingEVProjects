 ...
 */
public class ComponentSelector extends com.earthview.world.graphic.RaySceneQuery {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::CComponentSelector", new ComponentSelectorClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::JCComponentSelectorProxy", new ComponentSelectorClassFactory());
	}

	public ComponentSelector(com.earthview.world.graphic.SceneManager ref_creator) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer ref_creatorPtr = new BasePointer(ref_creator);
		list.add("ref_creator", ref_creatorPtr.get());
		Create("JCComponentSelectorProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.ComponentSelector".equals(this.getClass().getName()))
		{
	...
	public ComponentSelector(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ComponentSelector(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ComponentSelector fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		ComponentSelector obj = null;
 		if(baseObj instanceof ComponentSelector)
		{
			obj = (ComponentSelector)baseObj;
		} else {
			obj = new ComponentSelector(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CComponentSelector");
			obj.increaseCast();
		}
