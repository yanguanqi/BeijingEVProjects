...
public class MatrixSerializer extends com.earthview.world.graphic.AnimationBaseSerializer {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::CMatrixSerializer", new MatrixSerializerClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::JCMatrixSerializerProxy", new MatrixSerializerClassFactory());
	}

	public MatrixSerializer() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCMatrixSerializerProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.MatrixSerializer".equals(this.getClass().getName()))
		{
	...
	public MatrixSerializer(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public MatrixSerializer(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static MatrixSerializer fromBaseObject(BaseObject baseObj)
	{
		...
		MatrixSerializer obj = null;
 		if(baseObj instanceof MatrixSerializer)
		{
			obj = (MatrixSerializer)baseObj;
		} else {
