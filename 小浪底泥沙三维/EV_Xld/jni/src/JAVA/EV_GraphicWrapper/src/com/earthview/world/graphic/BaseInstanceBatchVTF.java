...
public class BaseInstanceBatchVTF extends com.earthview.world.graphic.InstanceBatch {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::CBaseInstanceBatchVTF", new BaseInstanceBatchVTFClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::JCBaseInstanceBatchVTFProxy", new BaseInstanceBatchVTFClassFactory());
	}

	public BaseInstanceBatchVTF(com.earthview.world.graphic.InstanceManager ref_creator, com.earthview.world.graphic.MeshPtr meshReference, com.earthview.world.graphic.MaterialPtr material, long instancesPerBatch, com.earthview.world.graphic.IndexMap ref_indexToBoneMap, String batchName) {
		...
		Create("JCBaseInstanceBatchVTFProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.BaseInstanceBatchVTF".equals(this.getClass().getName()))
		{
	...
	native private void setBoneMatrixLookup_ev_bool_ev_size_t(long pNativeObject, boolean enable, long maxLookupTableInstances);
	public void setBoneMatrixLookup(boolean enable, long maxLookupTableInstances)
	{
		boolean enableParamValue = enable;
		long maxLookupTableInstancesParamValue = maxLookupTableInstances;
		setBoneMatrixLookup_ev_bool_ev_size_t(this.nativeObject.pointer, enableParamValue, maxLookupTableInstancesParamValue);
	}
	native private boolean useBoneMatrixLookup_void(long pNativeObject);
	public boolean useBoneMatrixLookup()
	{
		boolean returnValue = useBoneMatrixLookup_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private void setBoneDualQuaternions_ev_bool(long pNativeObject, boolean enable);
	public void setBoneDualQuaternions(boolean enable)
	{
		boolean enableParamValue = enable;
		setBoneDualQuaternions_ev_bool(this.nativeObject.pointer, enableParamValue);
	}
	native private boolean useBoneDualQuaternions_void(long pNativeObject);
	public boolean useBoneDualQuaternions()
	{
		boolean returnValue = useBoneDualQuaternions_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private void setForceOneWeight_ev_bool(long pNativeObject, boolean enable);
	public void setForceOneWeight(boolean enable)
	{
		boolean enableParamValue = enable;
		setForceOneWeight_ev_bool(this.nativeObject.pointer, enableParamValue);
	}
	native private boolean forceOneWeight_void(long pNativeObject);
	public boolean forceOneWeight()
	{
		boolean returnValue = forceOneWeight_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private void setUseOneWeight_ev_bool(long pNativeObject, boolean enable);
	public void setUseOneWeight(boolean enable)
	{
		boolean enableParamValue = enable;
		setUseOneWeight_ev_bool(this.nativeObject.pointer, enableParamValue);
	}
	native private boolean useOneWeight_void(long pNativeObject);
	public boolean useOneWeight()
	{
		boolean returnValue = useOneWeight_void(this.nativeObject.pointer);
		return returnValue;
	}
	...
	protected  long getMaxLookupTableInstances_void_callback()
	{
		long returnValue = getMaxLookupTableInstances();
		long __returnValue = returnValue;
		return __returnValue;
	}

	native private long getMaxLookupTableInstances_void(long pNativeObject);
	public long getMaxLookupTableInstances()
	{
		long returnValue = getMaxLookupTableInstances_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private long getMaxLookupTableInstances_void_NoVirtual(long pNativeObject);
	protected long getMaxLookupTableInstances_NoVirtual()
	{
		long returnValue = getMaxLookupTableInstances_void_NoVirtual(this.nativeObject.pointer);
		return returnValue;
	}

	public BaseInstanceBatchVTF(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public BaseInstanceBatchVTF(CreatedWhenConstruct cwc, String classNameStr) {
	...
	{
		return super.calculateMaxNumInstances_NoVirtual(baseSubMesh, flags);
	}
	...
	public static BaseInstanceBatchVTF fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		BaseInstanceBatchVTF obj = null;
 		if(baseObj instanceof BaseInstanceBatchVTF)
		{
			obj = (BaseInstanceBatchVTF)baseObj;
		} else {
			obj = new BaseInstanceBatchVTF(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CBaseInstanceBatchVTF");
			obj.increaseCast();
		}
