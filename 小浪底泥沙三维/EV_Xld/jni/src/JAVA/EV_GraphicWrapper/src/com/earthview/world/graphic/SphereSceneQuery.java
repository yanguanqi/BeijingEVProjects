...
public class SphereSceneQuery extends com.earthview.world.graphic.RegionSceneQuery {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::CSphereSceneQuery", new SphereSceneQueryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::JCSphereSceneQueryProxy", new SphereSceneQueryClassFactory());
	}

	public SphereSceneQuery(com.earthview.world.graphic.SceneManager ref_mgr) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer ref_mgrPtr = new BasePointer(ref_mgr);
		list.add("ref_mgr", ref_mgrPtr.get());
		Create("JCSphereSceneQueryProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.SphereSceneQuery".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
		}
	}

	native private void setSphere_CSphere(long pNativeObject, long sphere);
	public void setSphere(com.earthview.world.spatial.math.Sphere sphere)
	{
		long sphereParamValue = sphere.nativeObject.pointer;
		setSphere_CSphere(this.nativeObject.pointer, sphereParamValue);
	}
	native private long getSphere_void(long pNativeObject);
	public com.earthview.world.spatial.math.Sphere getSphere()
	{
		long returnValue = getSphere_void(this.nativeObject.pointer);
	...
	public SphereSceneQuery(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public SphereSceneQuery(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static SphereSceneQuery fromBaseObject(BaseObject baseObj)
	{
		...
		SphereSceneQuery obj = null;
 		if(baseObj instanceof SphereSceneQuery)
		{
			obj = (SphereSceneQuery)baseObj;
		} else {
