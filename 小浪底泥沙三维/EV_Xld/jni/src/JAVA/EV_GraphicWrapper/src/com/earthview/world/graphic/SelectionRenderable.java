...
public class SelectionRenderable extends com.earthview.world.graphic.SimpleRenderable {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::CSelectionRenderable", new SelectionRenderableClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::JCSelectionRenderableProxy", new SelectionRenderableClassFactory());
	}

	public SelectionRenderable() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCSelectionRenderableProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.SelectionRenderable".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
		}
	}

	public SelectionRenderable(String name) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer namePtr = new BasePointer(name);
		list.add("name", namePtr.get());
		Create("JCSelectionRenderableProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.SelectionRenderable".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
	...
	native private void setVertexData_CVertexData_ev_bool(long pNativeObject, long ref_vdata, boolean bCopyData);
	/**
	 * 设置顶点数据
	 * @param ref_vdata 顶点数据
	 * @param bCopyData 是否拷贝数据
	 */
	public void setVertexData(com.earthview.world.graphic.VertexData ref_vdata, boolean bCopyData)
	{
		long ref_vdataParamValue = (ref_vdata == null ? 0L : ref_vdata.nativeObject.pointer);
		boolean bCopyDataParamValue = bCopyData;
		setVertexData_CVertexData_ev_bool(this.nativeObject.pointer, ref_vdataParamValue, bCopyDataParamValue);
	}
	native private void setIndexData_CIndexData_ev_bool(long pNativeObject, long ref_idata, boolean bCopyData);
	/**
	 * 设置索引数据
	 * @param ref_idata 索引数据
	 * @param bCopyData 是否拷贝数据
	 */
	public void setIndexData(com.earthview.world.graphic.IndexData ref_idata, boolean bCopyData)
	{
		long ref_idataParamValue = (ref_idata == null ? 0L : ref_idata.nativeObject.pointer);
		boolean bCopyDataParamValue = bCopyData;
		setIndexData_CIndexData_ev_bool(this.nativeObject.pointer, ref_idataParamValue, bCopyDataParamValue);
	}
	native private void setRenderOperationType_OperationType(long pNativeObject, int type);
	public void setRenderOperationType(com.earthview.world.graphic.RenderOperation.OperationType type)
	{
		int typeParamValue = type.getValue();
		setRenderOperationType_OperationType(this.nativeObject.pointer, typeParamValue);
	}
	native private void setLinkedRenderable_CRenderable(long pNativeObject, long renderbale);
	public void setLinkedRenderable(com.earthview.world.graphic.Renderable renderbale)
	{
		long renderbaleParamValue = (renderbale == null ? 0L : renderbale.nativeObject.pointer);
		setLinkedRenderable_CRenderable(this.nativeObject.pointer, renderbaleParamValue);
	}
	...
	public SelectionRenderable(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public SelectionRenderable(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static SelectionRenderable fromBaseObject(BaseObject baseObj)
	{
		...
		SelectionRenderable obj = null;
 		if(baseObj instanceof SelectionRenderable)
		{
			obj = (SelectionRenderable)baseObj;
		} else {
