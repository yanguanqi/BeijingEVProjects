...
public class CmdVerticalAlign extends com.earthview.world.core.ParamCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::OverlayElementCommands::CCmdVerticalAlign", new CmdVerticalAlignClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::OverlayElementCommands::JCCmdVerticalAlignProxy", new CmdVerticalAlignClassFactory());
	}

	public CmdVerticalAlign() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCmdVerticalAlignProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.overlayelementcommands.CmdVerticalAlign".equals(this.getClass().getName()))
		{
	...
	public CmdVerticalAlign(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CmdVerticalAlign(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CmdVerticalAlign fromBaseObject(BaseObject baseObj)
	{
		...
		CmdVerticalAlign obj = null;
 		if(baseObj instanceof CmdVerticalAlign)
		{
			obj = (CmdVerticalAlign)baseObj;
		} else {
