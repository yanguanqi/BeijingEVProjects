...
/**
 * 粒子发射器的命令对象获得/设置粒子发射方向参数
 */
public class CmdDirection extends com.earthview.world.core.ParamCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::EmitterCommands::CCmdDirection", new CmdDirectionClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::EmitterCommands::JCCmdDirectionProxy", new CmdDirectionClassFactory());
	}
	...
	public CmdDirection() {
		...
		Create("JCCmdDirectionProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.emittercommands.CmdDirection".equals(this.getClass().getName()))
		{
	...
	public CmdDirection(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CmdDirection(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CmdDirection fromBaseObject(BaseObject baseObj)
	{
		...
		CmdDirection obj = null;
 		if(baseObj instanceof CmdDirection)
		{
			obj = (CmdDirection)baseObj;
		} else {
