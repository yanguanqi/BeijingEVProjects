...
/**
 * 粒子发射器的命令对象获得/设置偏离粒子发射方向最大角度参数
 */
public class CmdAngle extends com.earthview.world.core.ParamCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::EmitterCommands::CCmdAngle", new CmdAngleClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::EmitterCommands::JCCmdAngleProxy", new CmdAngleClassFactory());
	}
	...
	public CmdAngle() {
		...
		Create("JCCmdAngleProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.emittercommands.CmdAngle".equals(this.getClass().getName()))
		{
	...
	public CmdAngle(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CmdAngle(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CmdAngle fromBaseObject(BaseObject baseObj)
	{
		...
		CmdAngle obj = null;
 		if(baseObj instanceof CmdAngle)
		{
			obj = (CmdAngle)baseObj;
		} else {
