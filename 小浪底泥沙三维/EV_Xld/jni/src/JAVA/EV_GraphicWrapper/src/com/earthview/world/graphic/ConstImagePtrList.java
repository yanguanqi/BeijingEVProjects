...
public class ConstImagePtrList extends com.earthview.world.core.BaseObject {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::ConstImagePtrList", new ConstImagePtrListClassFactory());
	}

	public ConstImagePtrList() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("ConstImagePtrList", null);
	}
	...
	public ConstImagePtrList(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ConstImagePtrList(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ConstImagePtrList fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		ConstImagePtrList obj = null;
 		if(baseObj instanceof ConstImagePtrList)
		{
			obj = (ConstImagePtrList)baseObj;
		} else {
			obj = new ConstImagePtrList(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "ConstImagePtrList");
			obj.increaseCast();
		}
