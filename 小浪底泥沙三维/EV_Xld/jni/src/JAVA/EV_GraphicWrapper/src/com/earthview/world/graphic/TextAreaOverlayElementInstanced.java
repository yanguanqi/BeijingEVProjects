...
public class TextAreaOverlayElementInstanced extends com.earthview.world.graphic.OverlayElement {
	...
	/**
	 * ¸ù¾İËùÌá¹©µÄ±ä»»À´¶ÔÕâĞ©ÔªËØ½øĞĞ¸üĞÂ
	 * @param  
	 */
	public void _update()
	{
	...
	/**
	 * ÉèÖÃÔªËØµÄÎ»ÖÃºÍ³ß´ç´óĞ¡
	 * @param gmm Ã¶¾Ù£¬±íÊ¾²»Í¬µÄÎ»ÖÃºÍ´óĞ¡
	 */
	...
	/**
	 * æ¸²æŸ“å¼€å§‹æ—¶å‘å¤–é€šçŸ¥çš„äº‹ä»¶
	 * @param sm æ¸²æŸ“åœºæ™¯
	 * @param rsys æ¸²æŸ“ç³»ç»Ÿ
	 * @return å¦‚æœè‡ªåŠ¨æ‰§è¡Œæ¸²æŸ“è¿‡ç¨‹è¿”å›true,æ‰‹åŠ¨æ‰§è¡Œè¿”å›false
	 */
	...
	/**
	 * æ¸²æŸ“å®Œæˆæ—¶å‘å¤–é€šçŸ¥çš„äº‹ä»¶
	 * @param sm æ¸²æŸ“åœºæ™¯
	 * @param rsys æ¸²æŸ“ç³»ç»Ÿ
	 */
	...
	/**
	 * è·å¾—æ¸²æŸ“å¯¹è±¡çš„ä¸–ç•Œå˜æ¢çŸ©é˜µçš„æ•°é‡
	 * @param  
	 */
	...
	/// <summary>
	/// è¿”å›æ¸²æŸ“å®ä½“ç›¸å¯¹è™šæ‹Ÿç›¸æœºçš„è§‚å¯Ÿæ·±åº¦çš„å¹³æ–¹
	/// </summary>
	...
	/**
	 * è·å¾—å…‰ç…§çš„åˆ—è¡¨ï¼ŒæŒ‰ç…§ç›¸å¯¹äºæ¸²æŸ“å®ä½“çš„è¿œè¿‘æ’åˆ—
	 * @param  
	 */
	...
	/**
	 * æ›´æ–°è‡ªå®šä¹‰çš„EarthView::World::Graphic::CGpuProgramParameterså¸¸é‡ï¼Œè¯¥å€¼åªæœ‰ä»æ¸²æŸ“ç³»ç»Ÿä¸­è·å¾—
	 * @param constantEntry CAutoConstantEntryçš„åˆ«å
	 * @param params EarthView::World::Graphic::CGpuProgramParametersçš„æŒ‡é’ˆ
	 */
	...
	/**
	 * è®¾ç½®å¤šè¾¹å½¢æ¸²æŸ“æ–¹å¼æ˜¯å¦å¯é‡å†™
	 * @param override è®¾ç½®å‚æ•°
	 * @return trueå¯ä»¥è¶…è¶Šï¼Œfalseä¸å¯ä»¥
	 */
	...
	/**
	 * è·å–è‡ªå®šä¹‰ç¯å¢ƒå…‰ç³»æ•°æ˜¯å¦å¯ç”¨
	 * @param  
	 */
	...
	/**
	 * è®¾ç½®è‡ªå®šä¹‰ç¯å¢ƒå…‰ç³»æ•°æ˜¯å¦å¯ç”¨
	 * @param  
	 */
