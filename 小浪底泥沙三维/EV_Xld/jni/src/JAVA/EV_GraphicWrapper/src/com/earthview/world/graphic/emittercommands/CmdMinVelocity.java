...
/**
 * 粒子发射器的命令对象获得/设置粒子发射的最小初始速度参数
 */
public class CmdMinVelocity extends com.earthview.world.core.ParamCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::EmitterCommands::CCmdMinVelocity", new CmdMinVelocityClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::EmitterCommands::JCCmdMinVelocityProxy", new CmdMinVelocityClassFactory());
	}
	 ...
	 * @param  
	 */
	public CmdMinVelocity() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCmdMinVelocityProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.emittercommands.CmdMinVelocity".equals(this.getClass().getName()))
		{
	...
	public CmdMinVelocity(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CmdMinVelocity(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CmdMinVelocity fromBaseObject(BaseObject baseObj)
	{
		...
		CmdMinVelocity obj = null;
 		if(baseObj instanceof CmdMinVelocity)
		{
			obj = (CmdMinVelocity)baseObj;
		} else {
