...
/**
 * 粒子发射器的命令对象获得/设置发射粒子最小颜色值参数
 */
public class CmdColourRangeStart extends com.earthview.world.core.ParamCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::EmitterCommands::CCmdColourRangeStart", new CmdColourRangeStartClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::EmitterCommands::JCCmdColourRangeStartProxy", new CmdColourRangeStartClassFactory());
	}
	 ...
	 * @param  
	 */
	public CmdColourRangeStart() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCmdColourRangeStartProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.emittercommands.CmdColourRangeStart".equals(this.getClass().getName()))
		{
	...
	public CmdColourRangeStart(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CmdColourRangeStart(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CmdColourRangeStart fromBaseObject(BaseObject baseObj)
	{
		...
		CmdColourRangeStart obj = null;
 		if(baseObj instanceof CmdColourRangeStart)
		{
			obj = (CmdColourRangeStart)baseObj;
		} else {
