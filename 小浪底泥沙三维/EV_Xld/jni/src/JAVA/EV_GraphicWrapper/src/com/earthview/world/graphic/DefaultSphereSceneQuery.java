...
public class DefaultSphereSceneQuery extends com.earthview.world.graphic.SphereSceneQuery {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Graphic::CDefaultSphereSceneQuery", new DefaultSphereSceneQueryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Graphic::JCDefaultSphereSceneQueryProxy", new DefaultSphereSceneQueryClassFactory());
	}

	public DefaultSphereSceneQuery(com.earthview.world.graphic.SceneManager ref_creator) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer ref_creatorPtr = new BasePointer(ref_creator);
		list.add("ref_creator", ref_creatorPtr.get());
		Create("JCDefaultSphereSceneQueryProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.graphic.DefaultSphereSceneQuery".equals(this.getClass().getName()))
		{
	...
	public DefaultSphereSceneQuery(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public DefaultSphereSceneQuery(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static DefaultSphereSceneQuery fromBaseObject(BaseObject baseObj)
	{
		...
		DefaultSphereSceneQuery obj = null;
 		if(baseObj instanceof DefaultSphereSceneQuery)
		{
			obj = (DefaultSphereSceneQuery)baseObj;
		} else {
