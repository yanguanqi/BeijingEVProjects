...
public class VectorFileDataSource extends com.earthview.world.spatial.geodataset.Ifiledatasource {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::VectorFileParser::CVectorFileDataSource", new VectorFileDataSourceClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::VectorFileParser::JCVectorFileDataSourceProxy", new VectorFileDataSourceClassFactory());
	}
	...
	public VectorFileDataSource(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public VectorFileDataSource(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static VectorFileDataSource fromBaseObject(BaseObject baseObj)
	{
		...
		VectorFileDataSource obj = null;
 		if(baseObj instanceof VectorFileDataSource)
		{
			obj = (VectorFileDataSource)baseObj;
		} else {
