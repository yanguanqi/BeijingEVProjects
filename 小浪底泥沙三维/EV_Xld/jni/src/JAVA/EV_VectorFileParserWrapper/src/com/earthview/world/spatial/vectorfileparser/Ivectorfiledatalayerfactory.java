...
public class Ivectorfiledatalayerfactory extends com.earthview.world.spatial.atlas.Ilayerfactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::VectorFileParser::IVectorFileDataLayerFactory", new IvectorfiledatalayerfactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::VectorFileParser::JIVectorFileDataLayerFactoryProxy", new IvectorfiledatalayerfactoryClassFactory());
	}

	public Ivectorfiledatalayerfactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JIVectorFileDataLayerFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.vectorfileparser.Ivectorfiledatalayerfactory".equals(this.getClass().getName()))
		{
	...
	public Ivectorfiledatalayerfactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Ivectorfiledatalayerfactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Ivectorfiledatalayerfactory fromBaseObject(BaseObject baseObj)
	{
		...
		Ivectorfiledatalayerfactory obj = null;
 		if(baseObj instanceof Ivectorfiledatalayerfactory)
		{
			obj = (Ivectorfiledatalayerfactory)baseObj;
		} else {
