...
public class Ivectorfileannolayer extends com.earthview.world.spatial.atlas.Ivectorlayer {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::VectorFileParser::IVectorFileAnnoLayer", new IvectorfileannolayerClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::VectorFileParser::JIVectorFileAnnoLayerProxy", new IvectorfileannolayerClassFactory());
	}

	public Ivectorfileannolayer() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JIVectorFileAnnoLayerProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.vectorfileparser.Ivectorfileannolayer".equals(this.getClass().getName()))
		{
	...
	public Ivectorfileannolayer(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Ivectorfileannolayer(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Ivectorfileannolayer fromBaseObject(BaseObject baseObj)
	{
		...
		Ivectorfileannolayer obj = null;
 		if(baseObj instanceof Ivectorfileannolayer)
		{
			obj = (Ivectorfileannolayer)baseObj;
		} else {
