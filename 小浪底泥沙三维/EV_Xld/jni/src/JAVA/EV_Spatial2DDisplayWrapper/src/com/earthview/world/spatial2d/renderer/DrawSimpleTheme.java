...
public class DrawSimpleTheme extends com.earthview.world.spatial2d.renderer.DrawTheme {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Renderer::CDrawSimpleTheme", new DrawSimpleThemeClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Renderer::JCDrawSimpleThemeProxy", new DrawSimpleThemeClassFactory());
	}
	 ...
	 * @param  
	 */
	public DrawSimpleTheme() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCDrawSimpleThemeProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.renderer.DrawSimpleTheme".equals(this.getClass().getName()))
		{
	...
	public DrawSimpleTheme(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public DrawSimpleTheme(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static DrawSimpleTheme fromBaseObject(BaseObject baseObj)
	{
		...
		DrawSimpleTheme obj = null;
 		if(baseObj instanceof DrawSimpleTheme)
		{
			obj = (DrawSimpleTheme)baseObj;
		} else {
