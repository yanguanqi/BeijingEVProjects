...
public class DrawRangeTheme extends com.earthview.world.spatial2d.renderer.DrawTheme {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Renderer::CDrawRangeTheme", new DrawRangeThemeClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Renderer::JCDrawRangeThemeProxy", new DrawRangeThemeClassFactory());
	}
	 ...
	 * @param  
	 */
	public DrawRangeTheme() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCDrawRangeThemeProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.renderer.DrawRangeTheme".equals(this.getClass().getName()))
		{
	...
	public DrawRangeTheme(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public DrawRangeTheme(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static DrawRangeTheme fromBaseObject(BaseObject baseObj)
	{
		...
		DrawRangeTheme obj = null;
 		if(baseObj instanceof DrawRangeTheme)
		{
			obj = (DrawRangeTheme)baseObj;
		} else {
