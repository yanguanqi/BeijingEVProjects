 ...
 * 单值专题图渲染类
 */
public class DrawUniqueValueTheme extends com.earthview.world.spatial2d.renderer.DrawTheme {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Renderer::CDrawUniqueValueTheme", new DrawUniqueValueThemeClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Renderer::JCDrawUniqueValueThemeProxy", new DrawUniqueValueThemeClassFactory());
	}
	 ...
	 * @param  
	 */
	public DrawUniqueValueTheme() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCDrawUniqueValueThemeProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.renderer.DrawUniqueValueTheme".equals(this.getClass().getName()))
		{
	...
	public DrawUniqueValueTheme(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public DrawUniqueValueTheme(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static DrawUniqueValueTheme fromBaseObject(BaseObject baseObj)
	{
		...
		DrawUniqueValueTheme obj = null;
 		if(baseObj instanceof DrawUniqueValueTheme)
		{
			obj = (DrawUniqueValueTheme)baseObj;
		} else {
