...
public class Wfsdatalayerfactory extends com.earthview.world.spatial.atlas.Ilayerfactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Atlas::CWFSDataLayerFactory", new WfsdatalayerfactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Atlas::JCWFSDataLayerFactoryProxy", new WfsdatalayerfactoryClassFactory());
	}

	public Wfsdatalayerfactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCWFSDataLayerFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.atlas.Wfsdatalayerfactory".equals(this.getClass().getName()))
		{
	...
	public Wfsdatalayerfactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Wfsdatalayerfactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Wfsdatalayerfactory fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		Wfsdatalayerfactory obj = null;
 		if(baseObj instanceof Wfsdatalayerfactory)
		{
			obj = (Wfsdatalayerfactory)baseObj;
		} else {
			obj = new Wfsdatalayerfactory(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CWFSDataLayerFactory");
			obj.increaseCast();
		}
