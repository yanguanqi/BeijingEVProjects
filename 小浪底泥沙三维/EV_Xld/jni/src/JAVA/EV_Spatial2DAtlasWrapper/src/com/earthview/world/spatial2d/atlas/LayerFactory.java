...
public class LayerFactory extends com.earthview.world.spatial.atlas.Ilayerfactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Atlas::CLayerFactory", new LayerFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Atlas::JCLayerFactoryProxy", new LayerFactoryClassFactory());
	}

	public LayerFactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCLayerFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.atlas.LayerFactory".equals(this.getClass().getName()))
		{
	...
	public LayerFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public LayerFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static LayerFactory fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		LayerFactory obj = null;
 		if(baseObj instanceof LayerFactory)
		{
			obj = (LayerFactory)baseObj;
		} else {
			obj = new LayerFactory(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CLayerFactory");
			obj.increaseCast();
		}
