 ...
 * 图层类
 */
public class DataLayer extends com.earthview.world.spatial.atlas.Ivectorlayer {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Atlas::CDataLayer", new DataLayerClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Atlas::JCDataLayerProxy", new DataLayerClassFactory());
	}
	...
	public DataLayer() {
		...
		Create("JCDataLayerProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.atlas.DataLayer".equals(this.getClass().getName()))
		{
	...
	native private void setDisplayMaxScale_ev_real64(long pNativeObject, double displayMaxScale);
	/**
	 * 设置最大显示比例尺
	 * @param displayMaxScale 最大显示比例尺
	 */
	public void setDisplayMaxScale(double displayMaxScale)
	{
		double displayMaxScaleParamValue = displayMaxScale;
		setDisplayMaxScale_ev_real64(this.nativeObject.pointer, displayMaxScaleParamValue);
	}
	native private void setDisplayMaxScale_ev_real64_NoVirtual(long pNativeObject, double displayMaxScale);
	protected void setDisplayMaxScale_NoVirtual(double displayMaxScale)
	{
		double displayMaxScaleParamValue = displayMaxScale;
		setDisplayMaxScale_ev_real64_NoVirtual(this.nativeObject.pointer, displayMaxScaleParamValue);
	}
	...
	native private void setDisplayMinScale_ev_real64(long pNativeObject, double displayMinScale);
	/**
	 * 设置最小显示比例尺
	 * @param displayMinScale 最小显示比例尺
	 */
	public void setDisplayMinScale(double displayMinScale)
	{
		double displayMinScaleParamValue = displayMinScale;
		setDisplayMinScale_ev_real64(this.nativeObject.pointer, displayMinScaleParamValue);
	}
	native private void setDisplayMinScale_ev_real64_NoVirtual(long pNativeObject, double displayMinScale);
	protected void setDisplayMinScale_NoVirtual(double displayMinScale)
	{
		double displayMinScaleParamValue = displayMinScale;
		setDisplayMinScale_ev_real64_NoVirtual(this.nativeObject.pointer, displayMinScaleParamValue);
	}
	...
	public DataLayer(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public DataLayer(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static DataLayer fromBaseObject(BaseObject baseObj)
	{
		...
		DataLayer obj = null;
 		if(baseObj instanceof DataLayer)
		{
			obj = (DataLayer)baseObj;
		} else {
			obj = new DataLayer(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CDataLayer");
			obj.increaseCast();
		}
