 ...
 */
public class GroupLayerFactory extends com.earthview.world.spatial.atlas.Ilayerfactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Atlas::CGroupLayerFactory", new GroupLayerFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Atlas::JCGroupLayerFactoryProxy", new GroupLayerFactoryClassFactory());
	}

	/**
	 * 构造函数
	 */
	public GroupLayerFactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCGroupLayerFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.atlas.GroupLayerFactory".equals(this.getClass().getName()))
		{
	...
	public GroupLayerFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public GroupLayerFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static GroupLayerFactory fromBaseObject(BaseObject baseObj)
	{
		...
		GroupLayerFactory obj = null;
 		if(baseObj instanceof GroupLayerFactory)
		{
			obj = (GroupLayerFactory)baseObj;
		} else {
