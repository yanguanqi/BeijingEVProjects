...
public class Wfsdatalayer extends com.earthview.world.spatial2d.atlas.DataLayer {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Atlas::CWFSDataLayer", new WfsdatalayerClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Atlas::JCWFSDataLayerProxy", new WfsdatalayerClassFactory());
	}
	...
	public Wfsdatalayer() {
		...
		Create("JCWFSDataLayerProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.atlas.Wfsdatalayer".equals(this.getClass().getName()))
		{
	...
	public Wfsdatalayer(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Wfsdatalayer(CreatedWhenConstruct cwc, String classNameStr) {
	...
	{
		super.setDisplayFilter_NoVirtual(filter);
	}
	/**
	 * 获取图层显示过滤条件
	 * @param  
	...
	{
		return super.getDisplayFilter_NoVirtual();
	}
	/**
	 * 获取与图层所关联的数据集
	 * @param  
	...
	public static Wfsdatalayer fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		Wfsdatalayer obj = null;
 		if(baseObj instanceof Wfsdatalayer)
		{
			obj = (Wfsdatalayer)baseObj;
		} else {
			obj = new Wfsdatalayer(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CWFSDataLayer");
			obj.increaseCast();
		}
