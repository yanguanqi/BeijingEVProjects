...
/**
 * CGroupLayer的类工厂管理CGroupLayer类
 */
public class BaseGroupLayerFactory extends com.earthview.world.spatial.atlas.Ilayerfactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Atlas::CBaseGroupLayerFactory", new BaseGroupLayerFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Atlas::JCBaseGroupLayerFactoryProxy", new BaseGroupLayerFactoryClassFactory());
	}

	/**
	 * 构造函数
	 */
	public BaseGroupLayerFactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCBaseGroupLayerFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.atlas.BaseGroupLayerFactory".equals(this.getClass().getName()))
		{
	...
	public BaseGroupLayerFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public BaseGroupLayerFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static BaseGroupLayerFactory fromBaseObject(BaseObject baseObj)
	{
		...
		BaseGroupLayerFactory obj = null;
 		if(baseObj instanceof BaseGroupLayerFactory)
		{
			obj = (BaseGroupLayerFactory)baseObj;
		} else {
