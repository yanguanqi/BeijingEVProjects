 ...
 */
public class ImageClampSceneLayer extends com.earthview.world.spatial3d.atlas.Iwebclampscenelayer {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::CImageClampSceneLayer", new ImageClampSceneLayerClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::JCImageClampSceneLayerProxy", new ImageClampSceneLayerClassFactory());
	}
	 ...
	 * @param  
	 */
	public ImageClampSceneLayer() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCImageClampSceneLayerProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.atlas.ImageClampSceneLayer".equals(this.getClass().getName()))
		{
	 ...
	 * @param name 图层名称
	 */
	public ImageClampSceneLayer(com.earthview.world.spatial.geodataset.Idataset ref_Dataset) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer ref_DatasetPtr = new BasePointer(ref_Dataset);
		list.add("ref_Dataset", ref_DatasetPtr.get());
		Create("JCImageClampSceneLayerProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.atlas.ImageClampSceneLayer".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
	...
	public ImageClampSceneLayer(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ImageClampSceneLayer(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ImageClampSceneLayer fromBaseObject(BaseObject baseObj)
	{
		...
		ImageClampSceneLayer obj = null;
 		if(baseObj instanceof ImageClampSceneLayer)
		{
			obj = (ImageClampSceneLayer)baseObj;
		} else {
