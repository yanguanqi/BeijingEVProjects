...
/**
 * 非贴地二维矢量数据Scenelayer的类工厂管理非贴地二维矢量数据
 */
public class VectorRelativeWebSceneLayerFactory extends com.earthview.world.spatial.atlas.Ilayerfactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::CVectorRelativeWebSceneLayerFactory", new VectorRelativeWebSceneLayerFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::JCVectorRelativeWebSceneLayerFactoryProxy", new VectorRelativeWebSceneLayerFactoryClassFactory());
	}
	 ...
	 * @param  
	 */
	public VectorRelativeWebSceneLayerFactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCVectorRelativeWebSceneLayerFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.atlas.VectorRelativeWebSceneLayerFactory".equals(this.getClass().getName()))
		{
	...
	native private long createInstance_EVString_IDataset(long pNativeObject, String name, long ref_Dataset);
	/**
	 * 创建一个图层实例
	 ...
	 */
	public com.earthview.world.spatial.atlas.Ilayer createInstance(String name, com.earthview.world.spatial.geodataset.Idataset ref_Dataset)
	{
		String nameParamValue = name;
		long ref_DatasetParamValue = (ref_Dataset == null ? 0L : ref_Dataset.nativeObject.pointer);
		long returnValue = createInstance_EVString_IDataset(this.nativeObject.pointer, nameParamValue, ref_DatasetParamValue);
		if(returnValue == 0L) {
			return null;
		}
		com.earthview.world.spatial.atlas.Ilayer __returnValue = new com.earthview.world.spatial.atlas.Ilayer(CreatedWhenConstruct.CWC_NotToCreate, "ILayer");
	...
	public VectorRelativeWebSceneLayerFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public VectorRelativeWebSceneLayerFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static VectorRelativeWebSceneLayerFactory fromBaseObject(BaseObject baseObj)
	{
		...
		VectorRelativeWebSceneLayerFactory obj = null;
 		if(baseObj instanceof VectorRelativeWebSceneLayerFactory)
		{
			obj = (VectorRelativeWebSceneLayerFactory)baseObj;
		} else {
