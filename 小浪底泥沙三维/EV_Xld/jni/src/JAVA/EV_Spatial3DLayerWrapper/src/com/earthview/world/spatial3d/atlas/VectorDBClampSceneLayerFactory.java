 ...
 * 贴地矢量图层工厂类管理贴地矢量图层
 */
public class VectorDBClampSceneLayerFactory extends com.earthview.world.spatial.atlas.Ilayerfactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayerFactory", new VectorDBClampSceneLayerFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::JCVectorDBClampSceneLayerFactoryProxy", new VectorDBClampSceneLayerFactoryClassFactory());
	}
	 ...
	 * @param  
	 */
	public VectorDBClampSceneLayerFactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCVectorDBClampSceneLayerFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.atlas.VectorDBClampSceneLayerFactory".equals(this.getClass().getName()))
		{
	...
	public VectorDBClampSceneLayerFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public VectorDBClampSceneLayerFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static VectorDBClampSceneLayerFactory fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		VectorDBClampSceneLayerFactory obj = null;
 		if(baseObj instanceof VectorDBClampSceneLayerFactory)
		{
			obj = (VectorDBClampSceneLayerFactory)baseObj;
		} else {
			obj = new VectorDBClampSceneLayerFactory(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CVectorDBClampSceneLayerFactory");
			obj.increaseCast();
		}
