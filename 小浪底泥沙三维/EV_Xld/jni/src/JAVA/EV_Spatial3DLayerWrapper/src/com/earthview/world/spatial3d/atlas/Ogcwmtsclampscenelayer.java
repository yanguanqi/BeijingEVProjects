 ...
 * 网络海图类管理网络海图类
 */
public class Ogcwmtsclampscenelayer extends com.earthview.world.spatial3d.atlas.Iclampscenelayer {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::COGCWMTSClampSceneLayer", new OgcwmtsclampscenelayerClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::JCOGCWMTSClampSceneLayerProxy", new OgcwmtsclampscenelayerClassFactory());
	}
	 ...
	 * @param  
	 */
	public Ogcwmtsclampscenelayer() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCOGCWMTSClampSceneLayerProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.atlas.Ogcwmtsclampscenelayer".equals(this.getClass().getName()))
		{
	 ...
	 * @param  
	 */
	public Ogcwmtsclampscenelayer(com.earthview.world.spatial.geodataset.Idataset ref_Dataset) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer ref_DatasetPtr = new BasePointer(ref_Dataset);
		list.add("ref_Dataset", ref_DatasetPtr.get());
		Create("JCOGCWMTSClampSceneLayerProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.atlas.Ogcwmtsclampscenelayer".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
	...
	public Ogcwmtsclampscenelayer(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Ogcwmtsclampscenelayer(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Ogcwmtsclampscenelayer fromBaseObject(BaseObject baseObj)
	{
		...
		Ogcwmtsclampscenelayer obj = null;
 		if(baseObj instanceof Ogcwmtsclampscenelayer)
		{
			obj = (Ogcwmtsclampscenelayer)baseObj;
		} else {
