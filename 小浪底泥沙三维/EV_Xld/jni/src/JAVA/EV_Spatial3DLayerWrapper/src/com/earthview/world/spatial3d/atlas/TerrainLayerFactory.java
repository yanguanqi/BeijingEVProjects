 ...
 * 地形图层工厂类管理地形图层
 */
public class TerrainLayerFactory extends com.earthview.world.spatial.atlas.Ilayerfactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::CTerrainLayerFactory", new TerrainLayerFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::JCTerrainLayerFactoryProxy", new TerrainLayerFactoryClassFactory());
	}
	 ...
	 * @param  
	 */
	public TerrainLayerFactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCTerrainLayerFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.atlas.TerrainLayerFactory".equals(this.getClass().getName()))
		{
	...
	public TerrainLayerFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public TerrainLayerFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static TerrainLayerFactory fromBaseObject(BaseObject baseObj)
	{
		...
		TerrainLayerFactory obj = null;
 		if(baseObj instanceof TerrainLayerFactory)
		{
			obj = (TerrainLayerFactory)baseObj;
		} else {
