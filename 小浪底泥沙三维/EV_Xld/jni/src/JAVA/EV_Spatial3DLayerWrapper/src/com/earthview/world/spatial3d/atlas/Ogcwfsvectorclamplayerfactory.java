 ...
 */
public class Ogcwfsvectorclamplayerfactory extends com.earthview.world.spatial.atlas.Ilayerfactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::COGCWFSVectorClampLayerFactory", new OgcwfsvectorclamplayerfactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::JCOGCWFSVectorClampLayerFactoryProxy", new OgcwfsvectorclamplayerfactoryClassFactory());
	}
	 ...
	 * @param  
	 */
	public Ogcwfsvectorclamplayerfactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCOGCWFSVectorClampLayerFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.atlas.Ogcwfsvectorclamplayerfactory".equals(this.getClass().getName()))
		{
	...
	public Ogcwfsvectorclamplayerfactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Ogcwfsvectorclamplayerfactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Ogcwfsvectorclamplayerfactory fromBaseObject(BaseObject baseObj)
	{
		...
		Ogcwfsvectorclamplayerfactory obj = null;
 		if(baseObj instanceof Ogcwfsvectorclamplayerfactory)
		{
			obj = (Ogcwfsvectorclamplayerfactory)baseObj;
		} else {
