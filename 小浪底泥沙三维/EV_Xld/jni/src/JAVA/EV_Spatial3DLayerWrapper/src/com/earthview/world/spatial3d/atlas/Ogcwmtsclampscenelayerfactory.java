 ...
 */
public class Ogcwmtsclampscenelayerfactory extends com.earthview.world.spatial.atlas.Ilayerfactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::COGCWMTSClampSceneLayerFactory", new OgcwmtsclampscenelayerfactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::JCOGCWMTSClampSceneLayerFactoryProxy", new OgcwmtsclampscenelayerfactoryClassFactory());
	}
	 ...
	 * @param  
	 */
	public Ogcwmtsclampscenelayerfactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCOGCWMTSClampSceneLayerFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.atlas.Ogcwmtsclampscenelayerfactory".equals(this.getClass().getName()))
		{
	...
	public Ogcwmtsclampscenelayerfactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Ogcwmtsclampscenelayerfactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Ogcwmtsclampscenelayerfactory fromBaseObject(BaseObject baseObj)
	{
		...
		Ogcwmtsclampscenelayerfactory obj = null;
 		if(baseObj instanceof Ogcwmtsclampscenelayerfactory)
		{
			obj = (Ogcwmtsclampscenelayerfactory)baseObj;
		} else {
