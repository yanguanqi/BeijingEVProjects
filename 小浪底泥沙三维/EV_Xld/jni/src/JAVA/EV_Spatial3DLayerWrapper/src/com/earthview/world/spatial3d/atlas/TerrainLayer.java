 ...
 * 地形图层管理地形
 */
public class TerrainLayer extends com.earthview.world.spatial3d.atlas.Iterrainlayer {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::CTerrainLayer", new TerrainLayerClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::JCTerrainLayerProxy", new TerrainLayerClassFactory());
	}
	 ...
	 */
	public TerrainLayer(com.earthview.world.spatial.geodataset.Idataset ref_Dataset) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer ref_DatasetPtr = new BasePointer(ref_Dataset);
		list.add("ref_Dataset", ref_DatasetPtr.get());
		Create("JCTerrainLayerProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.atlas.TerrainLayer".equals(this.getClass().getName()))
		{
	...
	public TerrainLayer(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public TerrainLayer(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static TerrainLayer fromBaseObject(BaseObject baseObj)
	{
		...
		TerrainLayer obj = null;
 		if(baseObj instanceof TerrainLayer)
		{
			obj = (TerrainLayer)baseObj;
		} else {
