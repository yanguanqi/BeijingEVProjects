 ...
 */
public class VectorWebClampSceneLayerFactory extends com.earthview.world.spatial.atlas.Ilayerfactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayerFactory", new VectorWebClampSceneLayerFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::JCVectorWebClampSceneLayerFactoryProxy", new VectorWebClampSceneLayerFactoryClassFactory());
	}
	 ...
	 * @param  
	 */
	public VectorWebClampSceneLayerFactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCVectorWebClampSceneLayerFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.atlas.VectorWebClampSceneLayerFactory".equals(this.getClass().getName()))
		{
	...
	public VectorWebClampSceneLayerFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public VectorWebClampSceneLayerFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static VectorWebClampSceneLayerFactory fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		VectorWebClampSceneLayerFactory obj = null;
 		if(baseObj instanceof VectorWebClampSceneLayerFactory)
		{
			obj = (VectorWebClampSceneLayerFactory)baseObj;
		} else {
			obj = new VectorWebClampSceneLayerFactory(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CVectorWebClampSceneLayerFactory");
			obj.increaseCast();
		}
