 ...
 */
public class Ogcwmsclampscenelayerfactory extends com.earthview.world.spatial.atlas.Ilayerfactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::COGCWMSClampSceneLayerFactory", new OgcwmsclampscenelayerfactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::JCOGCWMSClampSceneLayerFactoryProxy", new OgcwmsclampscenelayerfactoryClassFactory());
	}
	 ...
	 * @param  
	 */
	public Ogcwmsclampscenelayerfactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCOGCWMSClampSceneLayerFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.atlas.Ogcwmsclampscenelayerfactory".equals(this.getClass().getName()))
		{
	...
	public Ogcwmsclampscenelayerfactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Ogcwmsclampscenelayerfactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Ogcwmsclampscenelayerfactory fromBaseObject(BaseObject baseObj)
	{
		...
		Ogcwmsclampscenelayerfactory obj = null;
 		if(baseObj instanceof Ogcwmsclampscenelayerfactory)
		{
			obj = (Ogcwmsclampscenelayerfactory)baseObj;
		} else {
