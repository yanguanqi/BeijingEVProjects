 ...
 */
public class VectorRelativeSceneLayerFactory extends com.earthview.world.spatial.atlas.Ilayerfactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::CVectorRelativeSceneLayerFactory", new VectorRelativeSceneLayerFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::JCVectorRelativeSceneLayerFactoryProxy", new VectorRelativeSceneLayerFactoryClassFactory());
	}
	 ...
	 * @param  
	 */
	public VectorRelativeSceneLayerFactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCVectorRelativeSceneLayerFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.atlas.VectorRelativeSceneLayerFactory".equals(this.getClass().getName()))
		{
	...
	public VectorRelativeSceneLayerFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public VectorRelativeSceneLayerFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static VectorRelativeSceneLayerFactory fromBaseObject(BaseObject baseObj)
	{
		...
		VectorRelativeSceneLayerFactory obj = null;
 		if(baseObj instanceof VectorRelativeSceneLayerFactory)
		{
			obj = (VectorRelativeSceneLayerFactory)baseObj;
		} else {
