 ...
 * 网络海图类管理网络海图类
 */
public class ChartWMTSClampSceneLayer extends com.earthview.world.spatial3d.atlas.Iwebclampscenelayer {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::CChartWMTSClampSceneLayer", new ChartWMTSClampSceneLayerClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::JCChartWMTSClampSceneLayerProxy", new ChartWMTSClampSceneLayerClassFactory());
	}
	 ...
	 * @param  
	 */
	public ChartWMTSClampSceneLayer() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCChartWMTSClampSceneLayerProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.atlas.ChartWMTSClampSceneLayer".equals(this.getClass().getName()))
		{
	 ...
	 * @param  
	 */
	public ChartWMTSClampSceneLayer(com.earthview.world.spatial.geodataset.Idataset ref_Dataset) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer ref_DatasetPtr = new BasePointer(ref_Dataset);
		list.add("ref_Dataset", ref_DatasetPtr.get());
		Create("JCChartWMTSClampSceneLayerProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.atlas.ChartWMTSClampSceneLayer".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
	...
	public ChartWMTSClampSceneLayer(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ChartWMTSClampSceneLayer(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ChartWMTSClampSceneLayer fromBaseObject(BaseObject baseObj)
	{
		...
		ChartWMTSClampSceneLayer obj = null;
 		if(baseObj instanceof ChartWMTSClampSceneLayer)
		{
			obj = (ChartWMTSClampSceneLayer)baseObj;
		} else {
