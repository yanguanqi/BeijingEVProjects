 ...
 * OCG图层类
 */
public class Ogcwmsclampscenelayer extends com.earthview.world.spatial3d.atlas.Iclampscenelayer {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::COGCWMSClampSceneLayer", new OgcwmsclampscenelayerClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::JCOGCWMSClampSceneLayerProxy", new OgcwmsclampscenelayerClassFactory());
	}
	 ...
	 * @param  
	 */
	public Ogcwmsclampscenelayer() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCOGCWMSClampSceneLayerProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.atlas.Ogcwmsclampscenelayer".equals(this.getClass().getName()))
		{
	 ...
	 * @param  
	 */
	public Ogcwmsclampscenelayer(com.earthview.world.spatial.geodataset.Idataset ref_Dataset) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer ref_DatasetPtr = new BasePointer(ref_Dataset);
		list.add("ref_Dataset", ref_DatasetPtr.get());
		Create("JCOGCWMSClampSceneLayerProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.atlas.Ogcwmsclampscenelayer".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
	...
	public Ogcwmsclampscenelayer(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Ogcwmsclampscenelayer(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Ogcwmsclampscenelayer fromBaseObject(BaseObject baseObj)
	{
		...
		Ogcwmsclampscenelayer obj = null;
 		if(baseObj instanceof Ogcwmsclampscenelayer)
		{
			obj = (Ogcwmsclampscenelayer)baseObj;
		} else {
