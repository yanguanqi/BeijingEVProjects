 ...
 */
public class ChartWMTSClampSceneLayerFactory extends com.earthview.world.spatial.atlas.Ilayerfactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::CChartWMTSClampSceneLayerFactory", new ChartWMTSClampSceneLayerFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::JCChartWMTSClampSceneLayerFactoryProxy", new ChartWMTSClampSceneLayerFactoryClassFactory());
	}
	 ...
	 * @param  
	 */
	public ChartWMTSClampSceneLayerFactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCChartWMTSClampSceneLayerFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.atlas.ChartWMTSClampSceneLayerFactory".equals(this.getClass().getName()))
		{
	...
	public ChartWMTSClampSceneLayerFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ChartWMTSClampSceneLayerFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ChartWMTSClampSceneLayerFactory fromBaseObject(BaseObject baseObj)
	{
		...
		ChartWMTSClampSceneLayerFactory obj = null;
 		if(baseObj instanceof ChartWMTSClampSceneLayerFactory)
		{
			obj = (ChartWMTSClampSceneLayerFactory)baseObj;
		} else {
