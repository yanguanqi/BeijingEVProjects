 ...
 */
public class ImageClampSceneLayerFactory extends com.earthview.world.spatial.atlas.Ilayerfactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::CImageClampSceneLayerFactory", new ImageClampSceneLayerFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::JCImageClampSceneLayerFactoryProxy", new ImageClampSceneLayerFactoryClassFactory());
	}
	 ...
	 * @param  
	 */
	public ImageClampSceneLayerFactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCImageClampSceneLayerFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.atlas.ImageClampSceneLayerFactory".equals(this.getClass().getName()))
		{
	...
	public ImageClampSceneLayerFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ImageClampSceneLayerFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ImageClampSceneLayerFactory fromBaseObject(BaseObject baseObj)
	{
		...
		ImageClampSceneLayerFactory obj = null;
 		if(baseObj instanceof ImageClampSceneLayerFactory)
		{
			obj = (ImageClampSceneLayerFactory)baseObj;
		} else {
