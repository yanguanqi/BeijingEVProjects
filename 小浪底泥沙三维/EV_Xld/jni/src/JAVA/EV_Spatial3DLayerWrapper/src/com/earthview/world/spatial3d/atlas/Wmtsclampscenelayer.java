...
/**
 * 贴地层-二维wmt数据，来自wmt服务管理贴地层-二维wmt数据
 */
public class Wmtsclampscenelayer extends com.earthview.world.spatial3d.atlas.Iwebclampscenelayer {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::CWMTSClampSceneLayer", new WmtsclampscenelayerClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::JCWMTSClampSceneLayerProxy", new WmtsclampscenelayerClassFactory());
	}
	 ...
	 * @param  
	 */
	public Wmtsclampscenelayer() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCWMTSClampSceneLayerProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.atlas.Wmtsclampscenelayer".equals(this.getClass().getName()))
		{
	 ...
	 * @param  
	 */
	public Wmtsclampscenelayer(com.earthview.world.spatial.geodataset.Idataset ref_Dataset) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer ref_DatasetPtr = new BasePointer(ref_Dataset);
		list.add("ref_Dataset", ref_DatasetPtr.get());
		Create("JCWMTSClampSceneLayerProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.atlas.Wmtsclampscenelayer".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
	...
	public Wmtsclampscenelayer(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Wmtsclampscenelayer(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Wmtsclampscenelayer fromBaseObject(BaseObject baseObj)
	{
		...
		Wmtsclampscenelayer obj = null;
 		if(baseObj instanceof Wmtsclampscenelayer)
		{
			obj = (Wmtsclampscenelayer)baseObj;
		} else {
