 ...
 */
public class VectorWebClampSceneLayer extends com.earthview.world.spatial3d.atlas.Iwebclampscenelayer {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer", new VectorWebClampSceneLayerClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::JCVectorWebClampSceneLayerProxy", new VectorWebClampSceneLayerClassFactory());
	}
	 ...
	 * @param  
	 */
	public VectorWebClampSceneLayer() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCVectorWebClampSceneLayerProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.atlas.VectorWebClampSceneLayer".equals(this.getClass().getName()))
		{
	 ...
	 * @param  
	 */
	public VectorWebClampSceneLayer(com.earthview.world.spatial.geodataset.Idataset ref_Dataset) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer ref_DatasetPtr = new BasePointer(ref_Dataset);
		list.add("ref_Dataset", ref_DatasetPtr.get());
		Create("JCVectorWebClampSceneLayerProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.atlas.VectorWebClampSceneLayer".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
	...
	protected  double getMaxLabelVisibleDistance_void_callback()
	{
		double returnValue = getMaxLabelVisibleDistance();
	...
	native private double getMaxLabelVisibleDistance_void_NoVirtual(long pNativeObject);
	protected double getMaxLabelVisibleDistance_NoVirtual()
	{
		double returnValue = getMaxLabelVisibleDistance_void_NoVirtual(this.nativeObject.pointer);
		return returnValue;
	}

	protected  void setMaxLabelVisibleDistance_ev_real64_callback(double dis)
	{
		double disParamValue = dis;
		setMaxLabelVisibleDistance(disParamValue);
	}
	...
	native private void setMaxLabelVisibleDistance_ev_real64_NoVirtual(long pNativeObject, double dis);
	protected void setMaxLabelVisibleDistance_NoVirtual(double dis)
	{
		double disParamValue = dis;
		setMaxLabelVisibleDistance_ev_real64_NoVirtual(this.nativeObject.pointer, disParamValue);
	}

	protected  double getMinLabelVisibleDistance_void_callback()
	{
		double returnValue = getMinLabelVisibleDistance();
		double __returnValue = returnValue;
		return __returnValue;
	}
	...
	native private double getMinLabelVisibleDistance_void_NoVirtual(long pNativeObject);
	protected double getMinLabelVisibleDistance_NoVirtual()
	{
		double returnValue = getMinLabelVisibleDistance_void_NoVirtual(this.nativeObject.pointer);
		return returnValue;
	}

	protected  void setMinLabelVisibleDistance_ev_real64_callback(double dis)
	{
		double disParamValue = dis;
		setMinLabelVisibleDistance(disParamValue);
	}
	...
	native private void setMinLabelVisibleDistance_ev_real64_NoVirtual(long pNativeObject, double dis);
	protected void setMinLabelVisibleDistance_NoVirtual(double dis)
	{
		double disParamValue = dis;
		setMinLabelVisibleDistance_ev_real64_NoVirtual(this.nativeObject.pointer, disParamValue);
	}
	...
	native private boolean isImage_void(long pNativeObject);
	/**
	 * 返回是否是影像格式的瓦片
	 * @param  
	 * @return 是否影像格式的瓦片
	...
	{
		boolean returnValue = isImage_void(this.nativeObject.pointer);
		return returnValue;
	}
	...
	public VectorWebClampSceneLayer(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public VectorWebClampSceneLayer(CreatedWhenConstruct cwc, String classNameStr) {
	...
	native protected void register_getMaxLabelVisibleDistance_void(long pNativeObject, String method);
	native protected void register_setMaxLabelVisibleDistance_ev_real64(long pNativeObject, String method);
	native protected void register_getMinLabelVisibleDistance_void(long pNativeObject, String method);
	native protected void register_setMinLabelVisibleDistance_ev_real64(long pNativeObject, String method);
	...
	public void registerCallback(){
		if (!this.nativeObject.equals(InstancePointer.ZERO)){
			this.register_getMaxLabelVisibleDistance_void(this.nativeObject.pointer, "getMaxLabelVisibleDistance_void_callback");
			this.register_setMaxLabelVisibleDistance_ev_real64(this.nativeObject.pointer, "setMaxLabelVisibleDistance_ev_real64_callback");
			this.register_getMinLabelVisibleDistance_void(this.nativeObject.pointer, "getMinLabelVisibleDistance_void_callback");
			this.register_setMinLabelVisibleDistance_ev_real64(this.nativeObject.pointer, "setMinLabelVisibleDistance_ev_real64_callback");
	...
	public static VectorWebClampSceneLayer fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		VectorWebClampSceneLayer obj = null;
 		if(baseObj instanceof VectorWebClampSceneLayer)
		{
			obj = (VectorWebClampSceneLayer)baseObj;
		} else {
			obj = new VectorWebClampSceneLayer(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CVectorWebClampSceneLayer");
			obj.increaseCast();
		}
