...
/**
 * CTerrainGroupLayer的类工厂管理CTerrainGroupLayer类
 */
public class TerrainGroupLayerFactory extends com.earthview.world.spatial.atlas.Ilayerfactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::CTerrainGroupLayerFactory", new TerrainGroupLayerFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::JCTerrainGroupLayerFactoryProxy", new TerrainGroupLayerFactoryClassFactory());
	}
	 ...
	 * @param  
	 */
	public TerrainGroupLayerFactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCTerrainGroupLayerFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.atlas.TerrainGroupLayerFactory".equals(this.getClass().getName()))
		{
	...
	native private static String get_mTerrainGroupLayerFactoryName_void();
	public static String get_mTerrainGroupLayerFactoryName()
	{
		String jniValue = get_mTerrainGroupLayerFactoryName_void();
		
		return jniValue;
	}
	
	public TerrainGroupLayerFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public TerrainGroupLayerFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static TerrainGroupLayerFactory fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		TerrainGroupLayerFactory obj = null;
 		if(baseObj instanceof TerrainGroupLayerFactory)
		{
			obj = (TerrainGroupLayerFactory)baseObj;
		} else {
			obj = new TerrainGroupLayerFactory(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CTerrainGroupLayerFactory");
			obj.increaseCast();
		}
