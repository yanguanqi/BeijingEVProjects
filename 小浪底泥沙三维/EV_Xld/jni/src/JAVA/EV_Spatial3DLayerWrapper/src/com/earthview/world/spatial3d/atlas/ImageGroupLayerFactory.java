...
/**
 * ImageGroupLayer的类工厂管理ImageGroupLayer类
 */
public class ImageGroupLayerFactory extends com.earthview.world.spatial.atlas.Ilayerfactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::CImageGroupLayerFactory", new ImageGroupLayerFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::JCImageGroupLayerFactoryProxy", new ImageGroupLayerFactoryClassFactory());
	}
	 ...
	 * @param  
	 */
	public ImageGroupLayerFactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCImageGroupLayerFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.atlas.ImageGroupLayerFactory".equals(this.getClass().getName()))
		{
	...
	native private static String get_msImageGroupLayerFactoryName_void();
	public static String get_msImageGroupLayerFactoryName()
	{
		String jniValue = get_msImageGroupLayerFactoryName_void();
		
		return jniValue;
	}
	
	public ImageGroupLayerFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ImageGroupLayerFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ImageGroupLayerFactory fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		ImageGroupLayerFactory obj = null;
 		if(baseObj instanceof ImageGroupLayerFactory)
		{
			obj = (ImageGroupLayerFactory)baseObj;
		} else {
			obj = new ImageGroupLayerFactory(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CImageGroupLayerFactory");
			obj.increaseCast();
		}
