 ...
 * 网络海图类管理网络海图类
 */
public class ChartWMSClampSceneLayer extends com.earthview.world.spatial3d.atlas.Iclampscenelayer {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::CChartWMSClampSceneLayer", new ChartWMSClampSceneLayerClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::JCChartWMSClampSceneLayerProxy", new ChartWMSClampSceneLayerClassFactory());
	}
	 ...
	 * @param  
	 */
	public ChartWMSClampSceneLayer() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCChartWMSClampSceneLayerProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.atlas.ChartWMSClampSceneLayer".equals(this.getClass().getName()))
		{
	 ...
	 * @param  
	 */
	public ChartWMSClampSceneLayer(com.earthview.world.spatial.geodataset.Idataset ref_Dataset) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer ref_DatasetPtr = new BasePointer(ref_Dataset);
		list.add("ref_Dataset", ref_DatasetPtr.get());
		Create("JCChartWMSClampSceneLayerProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.atlas.ChartWMSClampSceneLayer".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
	...
	native private void setColorMode_EVString(long pNativeObject, String value);
	/**
	 * 设置颜色模式
	 * @param value 颜色模式
	 */
	public void setColorMode(String value)
	{
		...
		setColorMode_EVString(this.nativeObject.pointer, valueParamValue);
	}
	...
	native private void setDisplayMode_EVString(long pNativeObject, String value);
	/**
	 * 设置显示模式
	 * @param value 显示模式
	 */
	...
	{
		String valueParamValue = value;
		setDisplayMode_EVString(this.nativeObject.pointer, valueParamValue);
	}
	...
	native private void setSymbolMode_EVString(long pNativeObject, String value);
	/**
	 * 设置符号模式
	 * @param value 符号模式
	 */
	...
	{
		String valueParamValue = value;
		setSymbolMode_EVString(this.nativeObject.pointer, valueParamValue);
	}
	...
	native private void setIsobath_EVString(long pNativeObject, String value);
	/**
	 * 设置等深线
	 * @param value 等深线
	 */
	...
	{
		String valueParamValue = value;
		setIsobath_EVString(this.nativeObject.pointer, valueParamValue);
	}
	...
	native private void setAnnotationMode_EVString(long pNativeObject, String value);
	/**
	 * 设置注记样式
	 * @param value 注记样式
	 */
	...
	{
		String valueParamValue = value;
		setAnnotationMode_EVString(this.nativeObject.pointer, valueParamValue);
	}
	native private String getAnnotationMode_void(long pNativeObject);
	/**
	 * 注记样式
	 * @param  
	 * @return 注记样式
	...
	{
		String returnValue = getAnnotationMode_void(this.nativeObject.pointer);
		return returnValue;
	}
	...
	public ChartWMSClampSceneLayer(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ChartWMSClampSceneLayer(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ChartWMSClampSceneLayer fromBaseObject(BaseObject baseObj)
	{
		...
		ChartWMSClampSceneLayer obj = null;
 		if(baseObj instanceof ChartWMSClampSceneLayer)
		{
			obj = (ChartWMSClampSceneLayer)baseObj;
		} else {
