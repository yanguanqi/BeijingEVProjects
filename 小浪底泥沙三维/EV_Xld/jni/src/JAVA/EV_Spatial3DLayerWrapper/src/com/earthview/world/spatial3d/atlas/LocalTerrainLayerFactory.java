 ...
 * 地形图层工厂类管理地形图层
 */
public class LocalTerrainLayerFactory extends com.earthview.world.spatial.atlas.Ilayerfactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::CLocalTerrainLayerFactory", new LocalTerrainLayerFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Atlas::JCLocalTerrainLayerFactoryProxy", new LocalTerrainLayerFactoryClassFactory());
	}
	 ...
	 * @param  
	 */
	public LocalTerrainLayerFactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCLocalTerrainLayerFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.atlas.LocalTerrainLayerFactory".equals(this.getClass().getName()))
		{
	...
	public LocalTerrainLayerFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public LocalTerrainLayerFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static LocalTerrainLayerFactory fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		LocalTerrainLayerFactory obj = null;
 		if(baseObj instanceof LocalTerrainLayerFactory)
		{
			obj = (LocalTerrainLayerFactory)baseObj;
		} else {
			obj = new LocalTerrainLayerFactory(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CLocalTerrainLayerFactory");
			obj.increaseCast();
		}
