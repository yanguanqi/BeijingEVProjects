 ...
 * 图标符号				
 */
public class Icon3DSymbol extends com.earthview.world.spatial.display.Symbol3D {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Display::CIcon3DSymbol", new Icon3DSymbolClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Display::JCIcon3DSymbolProxy", new Icon3DSymbolClassFactory());
	}
	...
	public Icon3DSymbol() {
		...
		Create("JCIcon3DSymbolProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.display.Icon3DSymbol".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
		}
	}

	native private long getIconUri_void(long pNativeObject);
	/**
	 * 获取图标路径
	 * @param  
	 * @return 图标路径
	 */
	public StringPointer getIconUri()
	{
		long returnValue = getIconUri_void(this.nativeObject.pointer);
		StringPointer __returnValue = new StringPointer(new InstancePointer(returnValue));
		return __returnValue;
	}
	native private void setIconUri_EVString(long pNativeObject, String uri);
	/**
	 * 设置图标路径
	 * @param uri 图标路径
	 */
	public void setIconUri(String uri)
	{
		...
		setIconUri_EVString(this.nativeObject.pointer, uriParamValue);
	}
	...
	native private void setIconScale_ev_real32(long pNativeObject, float scale);
	/**
	 * 设置图标大小比例
	 * @param scale 大小比例
	 */
	public void setIconScale(float scale)
	{
		...
		setIconScale_ev_real32(this.nativeObject.pointer, scaleParamValue);
	}
	native private float getHeading_void(long pNativeObject);
	/**
	 * 获取图标角度
	 * @param  
	 * @return 角度
	...
	{
		float returnValue = getHeading_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private void setHeading_ev_real32(long pNativeObject, float angle);
	/**
	 * 设置图标角度
	 * @param angle 角度
	 */
	public void setHeading(float angle)
	{
		...
		setHeading_ev_real32(this.nativeObject.pointer, angleParamValue);
	}
	native private int getAnchorTypeX_void(long pNativeObject);
	/**
	 * 获取图标锚定类型x
	 * @param  
	 * @return 图标锚定类型x
	 */
	public com.earthview.world.spatial.display.EVIconAnchorType getAnchorTypeX()
	{
		int returnValue = getAnchorTypeX_void(this.nativeObject.pointer);
		return com.earthview.world.spatial.display.EVIconAnchorType.toEnum(returnValue);
	}
	native private void setAnchorTypeX_EVIconAnchorType(long pNativeObject, int type);
	/**
	 * 设置图标锚定类型x
	 * @param type 图标锚定类型x
	 */
	public void setAnchorTypeX(com.earthview.world.spatial.display.EVIconAnchorType type)
	{
		int typeParamValue = type.getValue();
		setAnchorTypeX_EVIconAnchorType(this.nativeObject.pointer, typeParamValue);
	}
	native private int getAnchorTypeY_void(long pNativeObject);
	/**
	 * 获取图标锚定类型y
	 * @param  
	 * @return 图标锚定类型y
	 */
	public com.earthview.world.spatial.display.EVIconAnchorType getAnchorTypeY()
	{
		int returnValue = getAnchorTypeY_void(this.nativeObject.pointer);
		return com.earthview.world.spatial.display.EVIconAnchorType.toEnum(returnValue);
	}
	native private void setAnchorTypeY_EVIconAnchorType(long pNativeObject, int type);
	/**
	 * 设置图标锚定类型y
	 * @param type 图标锚定类型y
	 */
	public void setAnchorTypeY(com.earthview.world.spatial.display.EVIconAnchorType type)
	{
		int typeParamValue = type.getValue();
		setAnchorTypeY_EVIconAnchorType(this.nativeObject.pointer, typeParamValue);
	}
	native private float getHotspotX_void(long pNativeObject);
	/**
	 * 获取图标热点x
	 * @param  
	 * @return 图标热点x
	...
	{
		float returnValue = getHotspotX_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private void setHotspotX_ev_real32(long pNativeObject, float x);
	/**
	 * 设置图标热点x
	 * @param x 图标热点x
	 */
	...
	{
		float xParamValue = x;
		setHotspotX_ev_real32(this.nativeObject.pointer, xParamValue);
	}
	native private float getHotspotY_void(long pNativeObject);
	/**
	 * 获取图标热点y
	 * @param  
	 * @return 图标热点y
	...
	{
		float returnValue = getHotspotY_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private void setHotspotY_ev_real32(long pNativeObject, float y);
	/**
	 * 设置图标热点y
	 * @param y 图标热点y
	 */
	...
	{
		float yParamValue = y;
		setHotspotY_ev_real32(this.nativeObject.pointer, yParamValue);
	}
	...
	public Icon3DSymbol(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Icon3DSymbol(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Icon3DSymbol fromBaseObject(BaseObject baseObj)
	{
		...
		Icon3DSymbol obj = null;
 		if(baseObj instanceof Icon3DSymbol)
		{
			obj = (Icon3DSymbol)baseObj;
		} else {
