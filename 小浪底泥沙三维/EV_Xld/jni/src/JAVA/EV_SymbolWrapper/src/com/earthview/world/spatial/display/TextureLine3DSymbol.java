 ...
 * 纹理线扩展符号				
 */
public class TextureLine3DSymbol extends com.earthview.world.spatial.display.SimpleLine3DSymbol {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Display::CTextureLine3DSymbol", new TextureLine3DSymbolClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Display::JCTextureLine3DSymbolProxy", new TextureLine3DSymbolClassFactory());
	}
	 ...
	 * @param  
	 */
	public TextureLine3DSymbol() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCTextureLine3DSymbolProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.display.TextureLine3DSymbol".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
		}
	}

	native private long getTextureInfo_void(long pNativeObject);
	/**
	 * 获取纹理信息
	 * @param  
	 * @return 纹理信息
	 */
	public com.earthview.world.spatial.display.TextureInfo getTextureInfo()
	{
		long returnValue = getTextureInfo_void(this.nativeObject.pointer);
	...
	native private void setTextureInfo_CTextureInfo(long pNativeObject, long ti);
	/**
	 * 设置纹理信息
	 * @param ti 纹理信息
	 */
	public void setTextureInfo(com.earthview.world.spatial.display.TextureInfo ti)
	{
		long tiParamValue = ti.nativeObject.pointer;
		setTextureInfo_CTextureInfo(this.nativeObject.pointer, tiParamValue);
	}
	...
	public TextureLine3DSymbol(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public TextureLine3DSymbol(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static TextureLine3DSymbol fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		TextureLine3DSymbol obj = null;
 		if(baseObj instanceof TextureLine3DSymbol)
		{
			obj = (TextureLine3DSymbol)baseObj;
		} else {
			obj = new TextureLine3DSymbol(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CTextureLine3DSymbol");
			obj.increaseCast();
		}
