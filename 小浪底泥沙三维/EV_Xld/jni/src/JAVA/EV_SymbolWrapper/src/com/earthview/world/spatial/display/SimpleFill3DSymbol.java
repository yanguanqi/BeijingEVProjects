 ...
 * 面扩展符号				
 */
public class SimpleFill3DSymbol extends com.earthview.world.spatial.display.Symbol3D {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Display::CSimpleFill3DSymbol", new SimpleFill3DSymbolClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Display::JCSimpleFill3DSymbolProxy", new SimpleFill3DSymbolClassFactory());
	}
	...
	public SimpleFill3DSymbol() {
		...
		Create("JCSimpleFill3DSymbolProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.display.SimpleFill3DSymbol".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
		}
	}

	native private int getExtensionType_void(long pNativeObject);
	/**
	 * 获取面扩展类型
	 * @param  
	 * @return 面扩展类型
	 */
	public com.earthview.world.spatial.display.EVPolygonExtensionType getExtensionType()
	{
		int returnValue = getExtensionType_void(this.nativeObject.pointer);
		return com.earthview.world.spatial.display.EVPolygonExtensionType.toEnum(returnValue);
	}
	native private void setExtensionType_EVPolygonExtensionType(long pNativeObject, int bExtrude);
	/**
	 * 设置面扩展类型
	 * @param bExtrude 面扩展类型
	 */
	public void setExtensionType(com.earthview.world.spatial.display.EVPolygonExtensionType bExtrude)
	{
		int bExtrudeParamValue = bExtrude.getValue();
		setExtensionType_EVPolygonExtensionType(this.nativeObject.pointer, bExtrudeParamValue);
	}
	native private float getThickness_void(long pNativeObject);
	/**
	 * 获取面扩展厚度
	 * @param  
	 * @return 面扩展厚度
	...
	{
		float returnValue = getThickness_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private void setThickness_ev_real32(long pNativeObject, float thickness);
	/**
	 * 设置面扩展厚度
	 * @param thickness 面扩展厚度
	 */
	public void setThickness(float thickness)
	{
		float thicknessParamValue = thickness;
		setThickness_ev_real32(this.nativeObject.pointer, thicknessParamValue);
	}
	native private long getThicknessField_void(long pNativeObject);
	/**
	 * 获取面扩展厚度对应的字段
	 * @param  
	 * @return 面扩展厚度对应的字段
	 */
	public StringPointer getThicknessField()
	{
		long returnValue = getThicknessField_void(this.nativeObject.pointer);
		StringPointer __returnValue = new StringPointer(new InstancePointer(returnValue));
		return __returnValue;
	}
	native private void setThicknessField_EVString(long pNativeObject, String tf);
	/**
	 * 设置面扩展厚度对应的字段
	 * @param tf 面扩展厚度对应的字段
	 */
	...
	{
		String tfParamValue = tf;
		setThicknessField_EVString(this.nativeObject.pointer, tfParamValue);
	}
	native private long getTopColor_void(long pNativeObject);
	/**
	 * 获取面扩展顶部颜色
	 * @param  
	 * @return 面扩展顶部颜色
	 */
	public com.earthview.world.spatial.display.Icolor getTopColor()
	{
		long returnValue = getTopColor_void(this.nativeObject.pointer);
		if(returnValue == 0L) {
			return null;
		}
	...
	native private void setTopColor_IColor(long pNativeObject, long pColor);
	/**
	 * 设置面扩展顶部颜色
	 * @param pColor 面扩展顶部颜色
	 */
	public void setTopColor(com.earthview.world.spatial.display.Icolor pColor)
	{
		long pColorParamValue = (pColor == null ? 0L : pColor.nativeObject.pointer);
		setTopColor_IColor(this.nativeObject.pointer, pColorParamValue);
	}
	native private long getSideColor_void(long pNativeObject);
	/**
	 * 获取面扩展侧面颜色
	 * @param  
	 * @return 面扩展侧面颜色
	 */
	public com.earthview.world.spatial.display.Icolor getSideColor()
	{
		long returnValue = getSideColor_void(this.nativeObject.pointer);
		if(returnValue == 0L) {
			return null;
		}
		com.earthview.world.spatial.display.Icolor __returnValue = new com.earthview.world.spatial.display.Icolor(CreatedWhenConstruct.CWC_NotToCreate, "IColor");
	...
	native private void setSideColor_IColor(long pNativeObject, long pColor);
	/**
	 * 设置面扩展侧面颜色
	 * @param pColor 面扩展侧面颜色
	 */
	public void setSideColor(com.earthview.world.spatial.display.Icolor pColor)
	{
		long pColorParamValue = (pColor == null ? 0L : pColor.nativeObject.pointer);
		setSideColor_IColor(this.nativeObject.pointer, pColorParamValue);
	}
	...
	native private void setLineColor_IColor(long pNativeObject, long pColor);
	/**
	 * 设置面扩展边框颜色
	 * @param pColor 面扩展边框颜色
	 */
	public void setLineColor(com.earthview.world.spatial.display.Icolor pColor)
	{
		long pColorParamValue = (pColor == null ? 0L : pColor.nativeObject.pointer);
		setLineColor_IColor(this.nativeObject.pointer, pColorParamValue);
	}
	...
	native private long OperatorAssign_CSimpleFill3DSymbol(long pNativeObject, long other);
	/// <summary>
	///  复制操作，复制所有信息，含颜色，法向量
	/// <summary>
	public com.earthview.world.spatial.display.SimpleFill3DSymbol OperatorAssign(com.earthview.world.spatial.display.SimpleFill3DSymbol other)
	{
		long otherParamValue = other.nativeObject.pointer;
		long returnValue = OperatorAssign_CSimpleFill3DSymbol(this.nativeObject.pointer, otherParamValue);
		com.earthview.world.spatial.display.SimpleFill3DSymbol __returnValue = new com.earthview.world.spatial.display.SimpleFill3DSymbol(CreatedWhenConstruct.CWC_NotToCreate, "CSimpleFill3DSymbol");
		__returnValue.setDelegate(true);
		InstancePointer __instancePointer = new InstancePointer(returnValue);
		__returnValue.setInstancePointer(__instancePointer);
		IClassFactory __returnValueClassFactory = GlobalClassFactoryMap.get(__returnValue.getCppInstanceTypeName());
		...
		{
			__returnValue.setDelegate(true);
			__returnValue = (com.earthview.world.spatial.display.SimpleFill3DSymbol)__returnValueClassFactory.create();
			__returnValue.setDelegate(true);
			__returnValue.bindNativeObject(__instancePointer, "CSimpleFill3DSymbol");
		}
		return __returnValue;
	}
	...
	public SimpleFill3DSymbol(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public SimpleFill3DSymbol(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static SimpleFill3DSymbol fromBaseObject(BaseObject baseObj)
	{
		...
		SimpleFill3DSymbol obj = null;
 		if(baseObj instanceof SimpleFill3DSymbol)
		{
			obj = (SimpleFill3DSymbol)baseObj;
		} else {
