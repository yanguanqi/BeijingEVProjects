 ...
 * 模型符号				
 */
public class Model3DSymbol extends com.earthview.world.spatial.display.Symbol3D {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Display::CModel3DSymbol", new Model3DSymbolClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Display::JCModel3DSymbolProxy", new Model3DSymbolClassFactory());
	}
	 ...
	 * @param  
	 */
	public Model3DSymbol() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCModel3DSymbolProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.display.Model3DSymbol".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
		}
	}

	native private long getModelUri_void(long pNativeObject);
	/**
	 * 获取模型路径
	 * @param  
	 * @return 模型路径
	 */
	public StringPointer getModelUri()
	{
		long returnValue = getModelUri_void(this.nativeObject.pointer);
		StringPointer __returnValue = new StringPointer(new InstancePointer(returnValue));
		return __returnValue;
	}
	native private void setModelUri_EVString(long pNativeObject, String uri);
	/**
	 * 设置模型路径
	 * @param uri 模型路径
	 */
	public void setModelUri(String uri)
	{
		...
		setModelUri_EVString(this.nativeObject.pointer, uriParamValue);
	}
	native private float getModelScale_void(long pNativeObject);
	/**
	 * 获取模型大小比例
	 * @param  
	 * @return 大小比例
	...
	{
		float returnValue = getModelScale_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private void setModelScale_ev_real32(long pNativeObject, float scale);
	/**
	 * 设置图标大小比例
	 * @param scale 大小比例
	 */
	public void setModelScale(float scale)
	{
		...
		setModelScale_ev_real32(this.nativeObject.pointer, scaleParamValue);
	}
	...
	public Model3DSymbol(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Model3DSymbol(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Model3DSymbol fromBaseObject(BaseObject baseObj)
	{
		...
		Model3DSymbol obj = null;
 		if(baseObj instanceof Model3DSymbol)
		{
			obj = (Model3DSymbol)baseObj;
		} else {
