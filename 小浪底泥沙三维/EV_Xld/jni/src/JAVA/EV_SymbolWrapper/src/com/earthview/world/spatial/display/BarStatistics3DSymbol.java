 ...
 * 三维柱状统计图符号
 */
public class BarStatistics3DSymbol extends com.earthview.world.spatial.display.Statistics3DSymbol {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Display::CBarStatistics3DSymbol", new BarStatistics3DSymbolClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Display::JCBarStatistics3DSymbolProxy", new BarStatistics3DSymbolClassFactory());
	}
	 ...
	 * @param  
	 */
	public BarStatistics3DSymbol() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCBarStatistics3DSymbolProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.display.BarStatistics3DSymbol".equals(this.getClass().getName()))
		{
	...
	public BarStatistics3DSymbol(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public BarStatistics3DSymbol(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static BarStatistics3DSymbol fromBaseObject(BaseObject baseObj)
	{
		...
		BarStatistics3DSymbol obj = null;
 		if(baseObj instanceof BarStatistics3DSymbol)
		{
			obj = (BarStatistics3DSymbol)baseObj;
		} else {
