...
/**
 * 渐变色填充类提供方法如下：获取与设置颜色色带、旋转角度、颜色个数、填充类型获取符号类型、获取流、获取SLD深度copy风格对象、判断两个Symbol是否属性相同、将Symbol属性写入XML元素从XML元素中恢复Symbol属性、从SLD恢复Symbol属性、从数据流恢复Symbol属性
 */
public class GradientFillSymbol extends com.earthview.world.spatial.display.FillSymbol {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Display::CGradientFillSymbol", new GradientFillSymbolClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Display::JCGradientFillSymbolProxy", new GradientFillSymbolClassFactory());
	}
	...
	public GradientFillSymbol() {
		...
		Create("JCGradientFillSymbolProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.display.GradientFillSymbol".equals(this.getClass().getName()))
		{
	...
	native private void setColorRamp_CColorRamp(long pNativeObject, long colorRamp);
	/**
	 * 设置颜色色带
	 * @param colorRamp 颜色色带
	 */
	public void setColorRamp(com.earthview.world.spatial.display.ColorRamp colorRamp)
	{
		long colorRampParamValue = (colorRamp == null ? 0L : colorRamp.nativeObject.pointer);
		setColorRamp_CColorRamp(this.nativeObject.pointer, colorRampParamValue);
	}
	...
	native private int getGradientCount_void(long pNativeObject);
	/**
	 * 获取颜色个数
	 * @param  
	 * @return 颜色个数
	...
	{
		int returnValue = getGradientCount_void(this.nativeObject.pointer);
		return returnValue;
	}
	native private void setGradientCount_ev_int32(long pNativeObject, int count);
	/**
	 * 设置颜色个数
	 * @param count 颜色个数
	 * @return 颜色个数
	 */
	public void setGradientCount(int count)
	{
		int countParamValue = count;
		setGradientCount_ev_int32(this.nativeObject.pointer, countParamValue);
	}
	native private int getGradientFillStyle_void(long pNativeObject);
	/**
	 * 获取填充类型
	 * @param  
	 * @return 填充类型
	 */
	public com.earthview.world.spatial.display.EVGradientFillStyle getGradientFillStyle()
	{
		int returnValue = getGradientFillStyle_void(this.nativeObject.pointer);
		return com.earthview.world.spatial.display.EVGradientFillStyle.toEnum(returnValue);
	}
	native private void setGradientFillStyle_EVGradientFillStyle(long pNativeObject, int nType);
	/**
	 * 设置填充类型
	 * @param nType 填充类型
	 */
	public void setGradientFillStyle(com.earthview.world.spatial.display.EVGradientFillStyle nType)
	{
		int nTypeParamValue = nType.getValue();
		setGradientFillStyle_EVGradientFillStyle(this.nativeObject.pointer, nTypeParamValue);
	}
	...
	public GradientFillSymbol(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public GradientFillSymbol(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static GradientFillSymbol fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		GradientFillSymbol obj = null;
 		if(baseObj instanceof GradientFillSymbol)
		{
			obj = (GradientFillSymbol)baseObj;
		} else {
			obj = new GradientFillSymbol(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CGradientFillSymbol");
			obj.increaseCast();
		}
