 ...
 * 三维饼状统计图符号
 */
public class PieStatistics3DSymbol extends com.earthview.world.spatial.display.Statistics3DSymbol {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Display::CPieStatistics3DSymbol", new PieStatistics3DSymbolClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Display::JCPieStatistics3DSymbolProxy", new PieStatistics3DSymbolClassFactory());
	}
	 ...
	 * @param  
	 */
	public PieStatistics3DSymbol() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCPieStatistics3DSymbolProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.display.PieStatistics3DSymbol".equals(this.getClass().getName()))
		{
	...
	native private void setStartedDegree_ev_real64(long pNativeObject, double degree);
	/**
	 * 设置起始角度
	 * @param degree 角度值
	 */
	public void setStartedDegree(double degree)
	{
		...
		setStartedDegree_ev_real64(this.nativeObject.pointer, degreeParamValue);
	}
	native private double getStartedDegree_void(long pNativeObject);
	/**
	 * 获取起始角度
	 * @param  
	 * @return 角度值
	...
	{
		double returnValue = getStartedDegree_void(this.nativeObject.pointer);
		return returnValue;
	}
	...
	public PieStatistics3DSymbol(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public PieStatistics3DSymbol(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static PieStatistics3DSymbol fromBaseObject(BaseObject baseObj)
	{
		...
		PieStatistics3DSymbol obj = null;
 		if(baseObj instanceof PieStatistics3DSymbol)
		{
			obj = (PieStatistics3DSymbol)baseObj;
		} else {
