 ...
 * 数据库格式瓦片的路径规则类
 */
public class TileDBPathRule extends com.earthview.world.spatial.TilePathRule {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::CTileDBPathRule", new TileDBPathRuleClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::JCTileDBPathRuleProxy", new TileDBPathRuleClassFactory());
	}
	...
	public TileDBPathRule(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public TileDBPathRule(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static TileDBPathRule fromBaseObject(BaseObject baseObj)
	{
		...
		TileDBPathRule obj = null;
 		if(baseObj instanceof TileDBPathRule)
		{
			obj = (TileDBPathRule)baseObj;
		} else {
