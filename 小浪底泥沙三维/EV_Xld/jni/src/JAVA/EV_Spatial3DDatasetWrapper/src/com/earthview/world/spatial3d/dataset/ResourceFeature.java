...
public class ResourceFeature extends com.earthview.world.spatial.geodataset.Ifeature {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Dataset::CResourceFeature", new ResourceFeatureClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Dataset::JCResourceFeatureProxy", new ResourceFeatureClassFactory());
	}
	...
	public ResourceFeature(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ResourceFeature(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ResourceFeature fromBaseObject(BaseObject baseObj)
	{
		...
		ResourceFeature obj = null;
 		if(baseObj instanceof ResourceFeature)
		{
			obj = (ResourceFeature)baseObj;
		} else {
