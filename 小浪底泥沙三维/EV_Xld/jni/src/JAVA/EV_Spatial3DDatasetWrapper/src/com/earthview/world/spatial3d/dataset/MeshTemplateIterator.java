...
public class MeshTemplateIterator extends com.earthview.world.spatial.geodataset.Ifeatureiterator {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Dataset::CMeshTemplateIterator", new MeshTemplateIteratorClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Dataset::JCMeshTemplateIteratorProxy", new MeshTemplateIteratorClassFactory());
	}
	...
	public MeshTemplateIterator(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public MeshTemplateIterator(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static MeshTemplateIterator fromBaseObject(BaseObject baseObj)
	{
		...
		MeshTemplateIterator obj = null;
 		if(baseObj instanceof MeshTemplateIterator)
		{
			obj = (MeshTemplateIterator)baseObj;
		} else {
