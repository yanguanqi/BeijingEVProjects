...
public class EntityGeometry extends com.earthview.world.spatial.geometry.Igeometry {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Dataset::CEntityGeometry", new EntityGeometryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Dataset::JCEntityGeometryProxy", new EntityGeometryClassFactory());
	}
	...
	public EntityGeometry(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public EntityGeometry(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static EntityGeometry fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		EntityGeometry obj = null;
 		if(baseObj instanceof EntityGeometry)
		{
			obj = (EntityGeometry)baseObj;
		} else {
			obj = new EntityGeometry(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CEntityGeometry");
			obj.increaseCast();
		}
