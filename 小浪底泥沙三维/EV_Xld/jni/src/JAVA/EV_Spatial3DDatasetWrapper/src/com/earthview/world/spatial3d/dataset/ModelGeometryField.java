...
public class ModelGeometryField extends com.earthview.world.spatial.geodataset.Igeometryfield {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Dataset::CModelGeometryField", new ModelGeometryFieldClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Dataset::JCModelGeometryFieldProxy", new ModelGeometryFieldClassFactory());
	}

	public ModelGeometryField(boolean isTempl) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer isTemplPtr = new BasePointer(isTempl);
		list.add("isTempl", isTemplPtr.get());
		Create("JCModelGeometryFieldProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.dataset.ModelGeometryField".equals(this.getClass().getName()))
		{
	...
	public ModelGeometryField(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ModelGeometryField(CreatedWhenConstruct cwc, String classNameStr) {
	...
	{
		super.setGeometryType_NoVirtual(type);
	}
	/**
	 * 获取字段名称
	 * @return 字段名称
	...
	public static ModelGeometryField fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		ModelGeometryField obj = null;
 		if(baseObj instanceof ModelGeometryField)
		{
			obj = (ModelGeometryField)baseObj;
		} else {
			obj = new ModelGeometryField(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CModelGeometryField");
			obj.increaseCast();
		}
