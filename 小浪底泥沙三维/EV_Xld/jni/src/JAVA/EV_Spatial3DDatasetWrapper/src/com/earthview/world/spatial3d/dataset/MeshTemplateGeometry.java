...
public class MeshTemplateGeometry extends com.earthview.world.spatial.geometry.Igeometry {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Dataset::CMeshTemplateGeometry", new MeshTemplateGeometryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Dataset::JCMeshTemplateGeometryProxy", new MeshTemplateGeometryClassFactory());
	}
	...
	public MeshTemplateGeometry(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public MeshTemplateGeometry(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static MeshTemplateGeometry fromBaseObject(BaseObject baseObj)
	{
		...
		MeshTemplateGeometry obj = null;
 		if(baseObj instanceof MeshTemplateGeometry)
		{
			obj = (MeshTemplateGeometry)baseObj;
		} else {
