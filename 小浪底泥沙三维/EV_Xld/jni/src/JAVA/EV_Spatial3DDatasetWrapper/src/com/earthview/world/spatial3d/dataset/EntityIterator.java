...
public class EntityIterator extends com.earthview.world.spatial.geodataset.Ifeatureiterator {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Dataset::CEntityIterator", new EntityIteratorClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Dataset::JCEntityIteratorProxy", new EntityIteratorClassFactory());
	}
	...
	public EntityIterator(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public EntityIterator(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static EntityIterator fromBaseObject(BaseObject baseObj)
	{
		...
		EntityIterator obj = null;
 		if(baseObj instanceof EntityIterator)
		{
			obj = (EntityIterator)baseObj;
		} else {
