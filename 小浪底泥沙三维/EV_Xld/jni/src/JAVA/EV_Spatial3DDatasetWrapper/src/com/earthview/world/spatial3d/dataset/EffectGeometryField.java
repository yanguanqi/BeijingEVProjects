...
public class EffectGeometryField extends com.earthview.world.spatial.geodataset.Igeometryfield {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Dataset::CEffectGeometryField", new EffectGeometryFieldClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Dataset::JCEffectGeometryFieldProxy", new EffectGeometryFieldClassFactory());
	}

	public EffectGeometryField() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCEffectGeometryFieldProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.dataset.EffectGeometryField".equals(this.getClass().getName()))
		{
	...
	public EffectGeometryField(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public EffectGeometryField(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static EffectGeometryField fromBaseObject(BaseObject baseObj)
	{
		...
		EffectGeometryField obj = null;
 		if(baseObj instanceof EffectGeometryField)
		{
			obj = (EffectGeometryField)baseObj;
		} else {
