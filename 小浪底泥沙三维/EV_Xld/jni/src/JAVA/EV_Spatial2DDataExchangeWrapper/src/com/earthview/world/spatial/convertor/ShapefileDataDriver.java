 ...
 * shapefile数据交换驱动
 */
public class ShapefileDataDriver extends com.earthview.world.spatial.convertor.DataDriver {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Convertor::CShapefileDataDriver", new ShapefileDataDriverClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Convertor::JCShapefileDataDriverProxy", new ShapefileDataDriverClassFactory());
	}
	...
	native private int open_IDataSource_EVString_EVDataExchangeOperateMode_CDataExchangeParam_ev_uint32_CDataStream(long pNativeObject, long ref_dataSource, String dataname, int mode, long ref_param, long featurecount, long stream);
	/**
	 * 打开数据驱动
	 ...
	 * @return 操作结果状态
	 */
	public int open(com.earthview.world.spatial.geodataset.Idatasource ref_dataSource, String dataname, com.earthview.world.spatial.convertor.EVDataExchangeOperateMode mode, com.earthview.world.spatial.convertor.DataExchangeParam ref_param, UIntegerPointer featurecount, com.earthview.world.core.DataStream stream)
	{
		...
		long featurecountParamValue = featurecount.nativeObject.pointer;
		long streamParamValue = stream.nativeObject.pointer;
		int returnValue = open_IDataSource_EVString_EVDataExchangeOperateMode_CDataExchangeParam_ev_uint32_CDataStream(this.nativeObject.pointer, ref_dataSourceParamValue, datanameParamValue, modeParamValue, ref_paramParamValue, featurecountParamValue, streamParamValue);
		return returnValue;
	}
	native private int open_IDataSource_EVString_EVDataExchangeOperateMode_CDataExchangeParam_ev_uint32_CDataStream_NoVirtual(long pNativeObject, long ref_dataSource, String dataname, int mode, long ref_param, long featurecount, long stream);
	protected int open_NoVirtual(com.earthview.world.spatial.geodataset.Idatasource ref_dataSource, String dataname, com.earthview.world.spatial.convertor.EVDataExchangeOperateMode mode, com.earthview.world.spatial.convertor.DataExchangeParam ref_param, UIntegerPointer featurecount, com.earthview.world.core.DataStream stream)
	{
		...
		long featurecountParamValue = featurecount.nativeObject.pointer;
		long streamParamValue = stream.nativeObject.pointer;
		int returnValue = open_IDataSource_EVString_EVDataExchangeOperateMode_CDataExchangeParam_ev_uint32_CDataStream_NoVirtual(this.nativeObject.pointer, ref_dataSourceParamValue, datanameParamValue, modeParamValue, ref_paramParamValue, featurecountParamValue, streamParamValue);
		return returnValue;
	}

	public ShapefileDataDriver(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ShapefileDataDriver(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ShapefileDataDriver fromBaseObject(BaseObject baseObj)
	{
		...
		ShapefileDataDriver obj = null;
 		if(baseObj instanceof ShapefileDataDriver)
		{
			obj = (ShapefileDataDriver)baseObj;
		} else {
