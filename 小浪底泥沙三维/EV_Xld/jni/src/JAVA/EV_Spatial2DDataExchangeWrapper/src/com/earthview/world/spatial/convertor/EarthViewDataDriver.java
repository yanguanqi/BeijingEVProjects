...
/**
 * EarthView数据交换驱动导出时到其他数据格式时，字段名为"EVID""Shape""GEOM_LENGTH""GEOM_AREA"不导出；从其他数据格式导入时，上述字段名改为_1，如_1名称已存在，改为_2，依此类推。
 */
public class EarthViewDataDriver extends com.earthview.world.spatial.convertor.DataDriver {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Convertor::CEarthViewDataDriver", new EarthViewDataDriverClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Convertor::JCEarthViewDataDriverProxy", new EarthViewDataDriverClassFactory());
	}
	...
	public EarthViewDataDriver(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public EarthViewDataDriver(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static EarthViewDataDriver fromBaseObject(BaseObject baseObj)
	{
		...
		EarthViewDataDriver obj = null;
 		if(baseObj instanceof EarthViewDataDriver)
		{
			obj = (EarthViewDataDriver)baseObj;
		} else {
