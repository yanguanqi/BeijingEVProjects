 ...
 * 三维海图夜晚颜色模式命令
 */
public class CommandChartNightColor3D extends com.earthview.world.spatial3d.controls.GlobeCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Controls::CCommandChartNightColor3D", new CommandChartNightColor3DClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Controls::JCCommandChartNightColor3DProxy", new CommandChartNightColor3DClassFactory());
	}

	/**
	 * 默认构造函数
	 */
	public CommandChartNightColor3D() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandChartNightColor3DProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.controls.CommandChartNightColor3D".equals(this.getClass().getName()))
		{
	...
	public CommandChartNightColor3D(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandChartNightColor3D(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandChartNightColor3D fromBaseObject(BaseObject baseObj)
	{
		...
		CommandChartNightColor3D obj = null;
 		if(baseObj instanceof CommandChartNightColor3D)
		{
			obj = (CommandChartNightColor3D)baseObj;
		} else {
