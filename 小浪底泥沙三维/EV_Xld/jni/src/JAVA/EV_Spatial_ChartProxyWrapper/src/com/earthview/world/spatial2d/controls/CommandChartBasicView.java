 ...
 * 海图基础显示模式命令
 */
public class CommandChartBasicView extends com.earthview.world.spatial2d.controls.MapCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CCommandChartBasicView", new CommandChartBasicViewClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCCommandChartBasicViewProxy", new CommandChartBasicViewClassFactory());
	}

	/**
	 * 默认构造函数
	 */
	public CommandChartBasicView() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandChartBasicViewProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.CommandChartBasicView".equals(this.getClass().getName()))
		{
	...
	public CommandChartBasicView(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandChartBasicView(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandChartBasicView fromBaseObject(BaseObject baseObj)
	{
		...
		CommandChartBasicView obj = null;
 		if(baseObj instanceof CommandChartBasicView)
		{
			obj = (CommandChartBasicView)baseObj;
		} else {
