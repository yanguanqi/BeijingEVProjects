 ...
 * 海图全部显示模式命令
 */
public class CommandChartOtherView extends com.earthview.world.spatial2d.controls.MapCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CCommandChartOtherView", new CommandChartOtherViewClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCCommandChartOtherViewProxy", new CommandChartOtherViewClassFactory());
	}

	/**
	 * 默认构造函数
	 */
	public CommandChartOtherView() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandChartOtherViewProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.CommandChartOtherView".equals(this.getClass().getName()))
		{
	...
	public CommandChartOtherView(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandChartOtherView(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandChartOtherView fromBaseObject(BaseObject baseObj)
	{
		...
		CommandChartOtherView obj = null;
 		if(baseObj instanceof CommandChartOtherView)
		{
			obj = (CommandChartOtherView)baseObj;
		} else {
