 ...
 * 三维海图符号样式组合框
 */
public class ChartEntryBoxSymbolType3D extends com.earthview.world.spatial.systemui.Ientrybox {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::SystemUI::CChartEntryBoxSymbolType3D", new ChartEntryBoxSymbolType3DClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::SystemUI::JCChartEntryBoxSymbolType3DProxy", new ChartEntryBoxSymbolType3DClassFactory());
	}

	/**
	 * 默认构造函数
	 */
	public ChartEntryBoxSymbolType3D() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCChartEntryBoxSymbolType3DProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.systemui.ChartEntryBoxSymbolType3D".equals(this.getClass().getName()))
		{
	...
	public ChartEntryBoxSymbolType3D(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ChartEntryBoxSymbolType3D(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ChartEntryBoxSymbolType3D fromBaseObject(BaseObject baseObj)
	{
		...
		ChartEntryBoxSymbolType3D obj = null;
 		if(baseObj instanceof ChartEntryBoxSymbolType3D)
		{
			obj = (ChartEntryBoxSymbolType3D)baseObj;
		} else {
