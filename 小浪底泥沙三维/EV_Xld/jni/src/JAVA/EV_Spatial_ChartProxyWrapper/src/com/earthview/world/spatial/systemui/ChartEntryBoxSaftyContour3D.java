 ...
 * 三维海图安全等深线深度组合框
 */
public class ChartEntryBoxSaftyContour3D extends com.earthview.world.spatial.systemui.Ientrybox {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::SystemUI::CChartEntryBoxSaftyContour3D", new ChartEntryBoxSaftyContour3DClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::SystemUI::JCChartEntryBoxSaftyContour3DProxy", new ChartEntryBoxSaftyContour3DClassFactory());
	}

	/**
	 * 默认构造函数
	 */
	public ChartEntryBoxSaftyContour3D() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCChartEntryBoxSaftyContour3DProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.systemui.ChartEntryBoxSaftyContour3D".equals(this.getClass().getName()))
		{
	...
	public ChartEntryBoxSaftyContour3D(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ChartEntryBoxSaftyContour3D(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ChartEntryBoxSaftyContour3D fromBaseObject(BaseObject baseObj)
	{
		...
		ChartEntryBoxSaftyContour3D obj = null;
 		if(baseObj instanceof ChartEntryBoxSaftyContour3D)
		{
			obj = (ChartEntryBoxSaftyContour3D)baseObj;
		} else {
