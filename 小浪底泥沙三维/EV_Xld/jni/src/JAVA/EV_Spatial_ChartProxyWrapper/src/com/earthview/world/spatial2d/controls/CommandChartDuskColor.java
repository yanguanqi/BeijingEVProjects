 ...
 * 海图有雾颜色模式命令
 */
public class CommandChartDuskColor extends com.earthview.world.spatial2d.controls.MapCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CCommandChartDuskColor", new CommandChartDuskColorClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCCommandChartDuskColorProxy", new CommandChartDuskColorClassFactory());
	}

	/**
	 * 默认构造函数
	 */
	public CommandChartDuskColor() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandChartDuskColorProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.CommandChartDuskColor".equals(this.getClass().getName()))
		{
	...
	public CommandChartDuskColor(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandChartDuskColor(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandChartDuskColor fromBaseObject(BaseObject baseObj)
	{
		...
		CommandChartDuskColor obj = null;
 		if(baseObj instanceof CommandChartDuskColor)
		{
			obj = (CommandChartDuskColor)baseObj;
		} else {
