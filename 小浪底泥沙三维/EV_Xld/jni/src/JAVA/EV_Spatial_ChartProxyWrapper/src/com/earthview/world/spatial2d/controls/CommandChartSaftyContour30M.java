 ...
 * 海图30米安全等深线模式命令
 */
public class CommandChartSaftyContour30M extends com.earthview.world.spatial2d.controls.MapCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CCommandChartSaftyContour30M", new CommandChartSaftyContour30MClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCCommandChartSaftyContour30MProxy", new CommandChartSaftyContour30MClassFactory());
	}

	/**
	 * 默认构造函数
	 */
	public CommandChartSaftyContour30M() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandChartSaftyContour30MProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.CommandChartSaftyContour30M".equals(this.getClass().getName()))
		{
	...
	public CommandChartSaftyContour30M(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandChartSaftyContour30M(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandChartSaftyContour30M fromBaseObject(BaseObject baseObj)
	{
		...
		CommandChartSaftyContour30M obj = null;
 		if(baseObj instanceof CommandChartSaftyContour30M)
		{
			obj = (CommandChartSaftyContour30M)baseObj;
		} else {
