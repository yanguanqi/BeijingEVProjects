 ...
 * 海图母语标注模式命令
 */
public class CommandChartChineseLabel extends com.earthview.world.spatial2d.controls.MapCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CCommandChartChineseLabel", new CommandChartChineseLabelClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCCommandChartChineseLabelProxy", new CommandChartChineseLabelClassFactory());
	}

	/**
	 * 默认构造函数
	 */
	public CommandChartChineseLabel() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandChartChineseLabelProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.CommandChartChineseLabel".equals(this.getClass().getName()))
		{
	...
	public CommandChartChineseLabel(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandChartChineseLabel(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandChartChineseLabel fromBaseObject(BaseObject baseObj)
	{
		...
		CommandChartChineseLabel obj = null;
 		if(baseObj instanceof CommandChartChineseLabel)
		{
			obj = (CommandChartChineseLabel)baseObj;
		} else {
