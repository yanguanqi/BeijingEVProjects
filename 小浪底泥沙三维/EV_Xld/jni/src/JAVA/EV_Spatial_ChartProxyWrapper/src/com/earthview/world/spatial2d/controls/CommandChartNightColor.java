 ...
 * 海图夜晚颜色模式命令
 */
public class CommandChartNightColor extends com.earthview.world.spatial2d.controls.MapCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CCommandChartNightColor", new CommandChartNightColorClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCCommandChartNightColorProxy", new CommandChartNightColorClassFactory());
	}

	/**
	 * 默认构造函数
	 */
	public CommandChartNightColor() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandChartNightColorProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.CommandChartNightColor".equals(this.getClass().getName()))
		{
	...
	public CommandChartNightColor(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandChartNightColor(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandChartNightColor fromBaseObject(BaseObject baseObj)
	{
		...
		CommandChartNightColor obj = null;
 		if(baseObj instanceof CommandChartNightColor)
		{
			obj = (CommandChartNightColor)baseObj;
		} else {
