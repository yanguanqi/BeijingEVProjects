 ...
 * 三维海图简单符号模式命令
 */
public class CommandChartSimpleSymbol3D extends com.earthview.world.spatial3d.controls.GlobeCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Controls::CCommandChartSimpleSymbol3D", new CommandChartSimpleSymbol3DClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Controls::JCCommandChartSimpleSymbol3DProxy", new CommandChartSimpleSymbol3DClassFactory());
	}

	/**
	 * 默认构造函数
	 */
	public CommandChartSimpleSymbol3D() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandChartSimpleSymbol3DProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.controls.CommandChartSimpleSymbol3D".equals(this.getClass().getName()))
		{
	...
	public CommandChartSimpleSymbol3D(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandChartSimpleSymbol3D(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandChartSimpleSymbol3D fromBaseObject(BaseObject baseObj)
	{
		...
		CommandChartSimpleSymbol3D obj = null;
 		if(baseObj instanceof CommandChartSimpleSymbol3D)
		{
			obj = (CommandChartSimpleSymbol3D)baseObj;
		} else {
