 ...
 * 海图精确空间关系模式命令
 */
public class CommandChartSpecificRelationship extends com.earthview.world.spatial2d.controls.MapCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CCommandChartSpecificRelationship", new CommandChartSpecificRelationshipClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCCommandChartSpecificRelationshipProxy", new CommandChartSpecificRelationshipClassFactory());
	}

	/**
	 * 默认构造函数
	 */
	public CommandChartSpecificRelationship() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandChartSpecificRelationshipProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.CommandChartSpecificRelationship".equals(this.getClass().getName()))
		{
	...
	public CommandChartSpecificRelationship(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandChartSpecificRelationship(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandChartSpecificRelationship fromBaseObject(BaseObject baseObj)
	{
		...
		CommandChartSpecificRelationship obj = null;
 		if(baseObj instanceof CommandChartSpecificRelationship)
		{
			obj = (CommandChartSpecificRelationship)baseObj;
		} else {
