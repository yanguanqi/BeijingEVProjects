 ...
 * 海图安全等深线深度组合框
 */
public class ChartEntryBoxSaftyContour extends com.earthview.world.spatial.systemui.Ientrybox {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::SystemUI::CChartEntryBoxSaftyContour", new ChartEntryBoxSaftyContourClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::SystemUI::JCChartEntryBoxSaftyContourProxy", new ChartEntryBoxSaftyContourClassFactory());
	}

	/**
	 * 默认构造函数
	 */
	public ChartEntryBoxSaftyContour() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCChartEntryBoxSaftyContourProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.systemui.ChartEntryBoxSaftyContour".equals(this.getClass().getName()))
		{
	...
	public ChartEntryBoxSaftyContour(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ChartEntryBoxSaftyContour(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ChartEntryBoxSaftyContour fromBaseObject(BaseObject baseObj)
	{
		...
		ChartEntryBoxSaftyContour obj = null;
 		if(baseObj instanceof ChartEntryBoxSaftyContour)
		{
			obj = (ChartEntryBoxSaftyContour)baseObj;
		} else {
