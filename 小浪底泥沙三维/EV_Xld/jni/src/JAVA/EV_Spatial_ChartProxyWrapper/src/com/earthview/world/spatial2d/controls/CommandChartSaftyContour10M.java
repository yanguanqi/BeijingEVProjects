 ...
 * 海图10米安全等深线模式命令
 */
public class CommandChartSaftyContour10M extends com.earthview.world.spatial2d.controls.MapCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CCommandChartSaftyContour10M", new CommandChartSaftyContour10MClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCCommandChartSaftyContour10MProxy", new CommandChartSaftyContour10MClassFactory());
	}

	/**
	 * 默认构造函数
	 */
	public CommandChartSaftyContour10M() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandChartSaftyContour10MProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.CommandChartSaftyContour10M".equals(this.getClass().getName()))
		{
	...
	public CommandChartSaftyContour10M(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandChartSaftyContour10M(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandChartSaftyContour10M fromBaseObject(BaseObject baseObj)
	{
		...
		CommandChartSaftyContour10M obj = null;
 		if(baseObj instanceof CommandChartSaftyContour10M)
		{
			obj = (CommandChartSaftyContour10M)baseObj;
		} else {
