 ...
 * 三维海图英语标注模式命令
 */
public class CommandChartEnglishLabel3D extends com.earthview.world.spatial3d.controls.GlobeCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Controls::CCommandChartEnglishLabel3D", new CommandChartEnglishLabel3DClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Controls::JCCommandChartEnglishLabel3DProxy", new CommandChartEnglishLabel3DClassFactory());
	}

	/**
	 * 默认构造函数
	 */
	public CommandChartEnglishLabel3D() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandChartEnglishLabel3DProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.controls.CommandChartEnglishLabel3D".equals(this.getClass().getName()))
		{
	...
	public CommandChartEnglishLabel3D(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandChartEnglishLabel3D(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandChartEnglishLabel3D fromBaseObject(BaseObject baseObj)
	{
		...
		CommandChartEnglishLabel3D obj = null;
 		if(baseObj instanceof CommandChartEnglishLabel3D)
		{
			obj = (CommandChartEnglishLabel3D)baseObj;
		} else {
