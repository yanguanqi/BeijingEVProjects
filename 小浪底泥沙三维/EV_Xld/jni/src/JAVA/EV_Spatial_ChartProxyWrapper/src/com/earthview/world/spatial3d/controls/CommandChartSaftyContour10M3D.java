 ...
 * 三维海图10米安全等深线模式命令
 */
public class CommandChartSaftyContour10M3D extends com.earthview.world.spatial3d.controls.GlobeCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Controls::CCommandChartSaftyContour10M3D", new CommandChartSaftyContour10M3DClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Controls::JCCommandChartSaftyContour10M3DProxy", new CommandChartSaftyContour10M3DClassFactory());
	}

	/**
	 * 默认构造函数
	 */
	public CommandChartSaftyContour10M3D() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandChartSaftyContour10M3DProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.controls.CommandChartSaftyContour10M3D".equals(this.getClass().getName()))
		{
	...
	public CommandChartSaftyContour10M3D(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandChartSaftyContour10M3D(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandChartSaftyContour10M3D fromBaseObject(BaseObject baseObj)
	{
		...
		CommandChartSaftyContour10M3D obj = null;
 		if(baseObj instanceof CommandChartSaftyContour10M3D)
		{
			obj = (CommandChartSaftyContour10M3D)baseObj;
		} else {
