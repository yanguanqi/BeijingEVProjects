 ...
 * 三维海图20米安全等深线模式命令
 */
public class CommandChartSaftyContour20M3D extends com.earthview.world.spatial3d.controls.GlobeCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Controls::CCommandChartSaftyContour20M3D", new CommandChartSaftyContour20M3DClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Controls::JCCommandChartSaftyContour20M3DProxy", new CommandChartSaftyContour20M3DClassFactory());
	}

	/**
	 * 默认构造函数
	 */
	public CommandChartSaftyContour20M3D() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandChartSaftyContour20M3DProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.controls.CommandChartSaftyContour20M3D".equals(this.getClass().getName()))
		{
	...
	public CommandChartSaftyContour20M3D(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandChartSaftyContour20M3D(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandChartSaftyContour20M3D fromBaseObject(BaseObject baseObj)
	{
		...
		CommandChartSaftyContour20M3D obj = null;
 		if(baseObj instanceof CommandChartSaftyContour20M3D)
		{
			obj = (CommandChartSaftyContour20M3D)baseObj;
		} else {
