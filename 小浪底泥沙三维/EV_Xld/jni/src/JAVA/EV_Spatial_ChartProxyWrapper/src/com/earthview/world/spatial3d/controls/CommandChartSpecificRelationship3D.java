 ...
 * 三维海图精确空间关系模式命令
 */
public class CommandChartSpecificRelationship3D extends com.earthview.world.spatial3d.controls.GlobeCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Controls::CCommandChartSpecificRelationship3D", new CommandChartSpecificRelationship3DClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Controls::JCCommandChartSpecificRelationship3DProxy", new CommandChartSpecificRelationship3DClassFactory());
	}

	/**
	 * 默认构造函数
	 */
	public CommandChartSpecificRelationship3D() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandChartSpecificRelationship3DProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.controls.CommandChartSpecificRelationship3D".equals(this.getClass().getName()))
		{
	...
	public CommandChartSpecificRelationship3D(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandChartSpecificRelationship3D(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandChartSpecificRelationship3D fromBaseObject(BaseObject baseObj)
	{
		...
		CommandChartSpecificRelationship3D obj = null;
 		if(baseObj instanceof CommandChartSpecificRelationship3D)
		{
			obj = (CommandChartSpecificRelationship3D)baseObj;
		} else {
