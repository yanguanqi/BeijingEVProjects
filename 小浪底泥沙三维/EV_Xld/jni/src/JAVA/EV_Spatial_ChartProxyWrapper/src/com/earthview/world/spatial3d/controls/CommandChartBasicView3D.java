 ...
 * 三维海图基础显示模式命令
 */
public class CommandChartBasicView3D extends com.earthview.world.spatial3d.controls.GlobeCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Controls::CCommandChartBasicView3D", new CommandChartBasicView3DClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Controls::JCCommandChartBasicView3DProxy", new CommandChartBasicView3DClassFactory());
	}

	/**
	 * 默认构造函数
	 */
	public CommandChartBasicView3D() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandChartBasicView3DProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.controls.CommandChartBasicView3D".equals(this.getClass().getName()))
		{
	...
	public CommandChartBasicView3D(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandChartBasicView3D(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandChartBasicView3D fromBaseObject(BaseObject baseObj)
	{
		...
		CommandChartBasicView3D obj = null;
 		if(baseObj instanceof CommandChartBasicView3D)
		{
			obj = (CommandChartBasicView3D)baseObj;
		} else {
