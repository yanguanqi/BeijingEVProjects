 ...
 * 海图颜色组合框
 */
public class ChartEntryBoxColorMode extends com.earthview.world.spatial.systemui.Ientrybox {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::SystemUI::CChartEntryBoxColorMode", new ChartEntryBoxColorModeClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::SystemUI::JCChartEntryBoxColorModeProxy", new ChartEntryBoxColorModeClassFactory());
	}

	/**
	 * 默认构造函数
	 */
	public ChartEntryBoxColorMode() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCChartEntryBoxColorModeProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.systemui.ChartEntryBoxColorMode".equals(this.getClass().getName()))
		{
	...
	public ChartEntryBoxColorMode(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ChartEntryBoxColorMode(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ChartEntryBoxColorMode fromBaseObject(BaseObject baseObj)
	{
		...
		ChartEntryBoxColorMode obj = null;
 		if(baseObj instanceof ChartEntryBoxColorMode)
		{
			obj = (ChartEntryBoxColorMode)baseObj;
		} else {
