 ...
 * 海图20米安全等深线模式命令
 */
public class CommandChartSaftyContour20M extends com.earthview.world.spatial2d.controls.MapCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CCommandChartSaftyContour20M", new CommandChartSaftyContour20MClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCCommandChartSaftyContour20MProxy", new CommandChartSaftyContour20MClassFactory());
	}

	/**
	 * 默认构造函数
	 */
	public CommandChartSaftyContour20M() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandChartSaftyContour20MProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.CommandChartSaftyContour20M".equals(this.getClass().getName()))
		{
	...
	public CommandChartSaftyContour20M(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandChartSaftyContour20M(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandChartSaftyContour20M fromBaseObject(BaseObject baseObj)
	{
		...
		CommandChartSaftyContour20M obj = null;
 		if(baseObj instanceof CommandChartSaftyContour20M)
		{
			obj = (CommandChartSaftyContour20M)baseObj;
		} else {
