 ...
 * 海图标准显示模式命令
 */
public class CommandChartStandardView extends com.earthview.world.spatial2d.controls.MapCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CCommandChartStandardView", new CommandChartStandardViewClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCCommandChartStandardViewProxy", new CommandChartStandardViewClassFactory());
	}

	/**
	 * 默认构造函数
	 */
	public CommandChartStandardView() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandChartStandardViewProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.CommandChartStandardView".equals(this.getClass().getName()))
		{
	...
	public CommandChartStandardView(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandChartStandardView(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandChartStandardView fromBaseObject(BaseObject baseObj)
	{
		...
		CommandChartStandardView obj = null;
 		if(baseObj instanceof CommandChartStandardView)
		{
			obj = (CommandChartStandardView)baseObj;
		} else {
