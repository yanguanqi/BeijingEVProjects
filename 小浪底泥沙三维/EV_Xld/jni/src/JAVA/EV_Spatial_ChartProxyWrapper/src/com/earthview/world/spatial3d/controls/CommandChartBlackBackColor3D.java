 ...
 * 三维海图傍晚颜色模式命令
 */
public class CommandChartBlackBackColor3D extends com.earthview.world.spatial3d.controls.GlobeCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Controls::CCommandChartBlackBackColor3D", new CommandChartBlackBackColor3DClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Controls::JCCommandChartBlackBackColor3DProxy", new CommandChartBlackBackColor3DClassFactory());
	}

	/**
	 * 默认构造函数
	 */
	public CommandChartBlackBackColor3D() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandChartBlackBackColor3DProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.controls.CommandChartBlackBackColor3D".equals(this.getClass().getName()))
		{
	...
	public CommandChartBlackBackColor3D(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandChartBlackBackColor3D(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandChartBlackBackColor3D fromBaseObject(BaseObject baseObj)
	{
		...
		CommandChartBlackBackColor3D obj = null;
 		if(baseObj instanceof CommandChartBlackBackColor3D)
		{
			obj = (CommandChartBlackBackColor3D)baseObj;
		} else {
