 ...
 * 海图显示类型组合框
 */
public class ChartEntryBoxViewCategory extends com.earthview.world.spatial.systemui.Ientrybox {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::SystemUI::CChartEntryBoxViewCategory", new ChartEntryBoxViewCategoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::SystemUI::JCChartEntryBoxViewCategoryProxy", new ChartEntryBoxViewCategoryClassFactory());
	}

	/**
	 * 默认构造函数
	 */
	public ChartEntryBoxViewCategory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCChartEntryBoxViewCategoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.systemui.ChartEntryBoxViewCategory".equals(this.getClass().getName()))
		{
	...
	public ChartEntryBoxViewCategory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ChartEntryBoxViewCategory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ChartEntryBoxViewCategory fromBaseObject(BaseObject baseObj)
	{
		...
		ChartEntryBoxViewCategory obj = null;
 		if(baseObj instanceof ChartEntryBoxViewCategory)
		{
			obj = (ChartEntryBoxViewCategory)baseObj;
		} else {
