 ...
 */
public class CommandChartBlurRelationship3D extends com.earthview.world.spatial3d.controls.GlobeCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Controls::CCommandChartBlurRelationship3D", new CommandChartBlurRelationship3DClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Controls::JCCommandChartBlurRelationship3DProxy", new CommandChartBlurRelationship3DClassFactory());
	}

	/**
	 * 默认构造函数
	 */
	public CommandChartBlurRelationship3D() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandChartBlurRelationship3DProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.controls.CommandChartBlurRelationship3D".equals(this.getClass().getName()))
		{
	...
	public CommandChartBlurRelationship3D(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandChartBlurRelationship3D(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandChartBlurRelationship3D fromBaseObject(BaseObject baseObj)
	{
		...
		CommandChartBlurRelationship3D obj = null;
 		if(baseObj instanceof CommandChartBlurRelationship3D)
		{
			obj = (CommandChartBlurRelationship3D)baseObj;
		} else {
