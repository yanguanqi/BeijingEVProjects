 ...
 * 海图白天颜色模式命令
 */
public class CommandChartWhiteBackColor extends com.earthview.world.spatial2d.controls.MapCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CCommandChartWhiteBackColor", new CommandChartWhiteBackColorClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCCommandChartWhiteBackColorProxy", new CommandChartWhiteBackColorClassFactory());
	}

	/**
	 * 默认构造函数
	 */
	public CommandChartWhiteBackColor() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandChartWhiteBackColorProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.CommandChartWhiteBackColor".equals(this.getClass().getName()))
		{
	...
	public CommandChartWhiteBackColor(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandChartWhiteBackColor(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandChartWhiteBackColor fromBaseObject(BaseObject baseObj)
	{
		...
		CommandChartWhiteBackColor obj = null;
 		if(baseObj instanceof CommandChartWhiteBackColor)
		{
			obj = (CommandChartWhiteBackColor)baseObj;
		} else {
