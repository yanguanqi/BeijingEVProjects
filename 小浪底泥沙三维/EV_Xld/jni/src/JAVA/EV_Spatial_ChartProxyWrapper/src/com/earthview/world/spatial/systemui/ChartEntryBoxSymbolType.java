 ...
 * 海图符号样式组合框
 */
public class ChartEntryBoxSymbolType extends com.earthview.world.spatial.systemui.Ientrybox {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::SystemUI::CChartEntryBoxSymbolType", new ChartEntryBoxSymbolTypeClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::SystemUI::JCChartEntryBoxSymbolTypeProxy", new ChartEntryBoxSymbolTypeClassFactory());
	}

	/**
	 * 默认构造函数
	 */
	public ChartEntryBoxSymbolType() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCChartEntryBoxSymbolTypeProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.systemui.ChartEntryBoxSymbolType".equals(this.getClass().getName()))
		{
	...
	public ChartEntryBoxSymbolType(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ChartEntryBoxSymbolType(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ChartEntryBoxSymbolType fromBaseObject(BaseObject baseObj)
	{
		...
		ChartEntryBoxSymbolType obj = null;
 		if(baseObj instanceof ChartEntryBoxSymbolType)
		{
			obj = (ChartEntryBoxSymbolType)baseObj;
		} else {
