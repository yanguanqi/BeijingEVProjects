 ...
 * 三维海图白天颜色模式命令
 */
public class CommandChartWhiteBackColor3D extends com.earthview.world.spatial3d.controls.GlobeCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Controls::CCommandChartWhiteBackColor3D", new CommandChartWhiteBackColor3DClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Controls::JCCommandChartWhiteBackColor3DProxy", new CommandChartWhiteBackColor3DClassFactory());
	}

	/**
	 * 默认构造函数
	 */
	public CommandChartWhiteBackColor3D() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandChartWhiteBackColor3DProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.controls.CommandChartWhiteBackColor3D".equals(this.getClass().getName()))
		{
	...
	public CommandChartWhiteBackColor3D(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandChartWhiteBackColor3D(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandChartWhiteBackColor3D fromBaseObject(BaseObject baseObj)
	{
		...
		CommandChartWhiteBackColor3D obj = null;
 		if(baseObj instanceof CommandChartWhiteBackColor3D)
		{
			obj = (CommandChartWhiteBackColor3D)baseObj;
		} else {
