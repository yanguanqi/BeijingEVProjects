 ...
 * 海图传统符号模式命令
 */
public class CommandChartTraditionalSymbol extends com.earthview.world.spatial2d.controls.MapCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CCommandChartTraditionalSymbol", new CommandChartTraditionalSymbolClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCCommandChartTraditionalSymbolProxy", new CommandChartTraditionalSymbolClassFactory());
	}

	/**
	 * 默认构造函数
	 */
	public CommandChartTraditionalSymbol() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandChartTraditionalSymbolProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.CommandChartTraditionalSymbol".equals(this.getClass().getName()))
		{
	...
	public CommandChartTraditionalSymbol(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandChartTraditionalSymbol(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandChartTraditionalSymbol fromBaseObject(BaseObject baseObj)
	{
		...
		CommandChartTraditionalSymbol obj = null;
 		if(baseObj instanceof CommandChartTraditionalSymbol)
		{
			obj = (CommandChartTraditionalSymbol)baseObj;
		} else {
