 ...
 * 三维海图有雾颜色模式命令
 */
public class CommandChartDuskColor3D extends com.earthview.world.spatial3d.controls.GlobeCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Controls::CCommandChartDuskColor3D", new CommandChartDuskColor3DClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Controls::JCCommandChartDuskColor3DProxy", new CommandChartDuskColor3DClassFactory());
	}

	/**
	 * 默认构造函数
	 */
	public CommandChartDuskColor3D() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandChartDuskColor3DProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.controls.CommandChartDuskColor3D".equals(this.getClass().getName()))
		{
	...
	public CommandChartDuskColor3D(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandChartDuskColor3D(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandChartDuskColor3D fromBaseObject(BaseObject baseObj)
	{
		...
		CommandChartDuskColor3D obj = null;
 		if(baseObj instanceof CommandChartDuskColor3D)
		{
			obj = (CommandChartDuskColor3D)baseObj;
		} else {
