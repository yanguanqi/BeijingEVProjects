 ...
 * 三维海图传统符号模式命令
 */
public class CommandChartTraditionalSymbol3D extends com.earthview.world.spatial3d.controls.GlobeCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Controls::CCommandChartTraditionalSymbol3D", new CommandChartTraditionalSymbol3DClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Controls::JCCommandChartTraditionalSymbol3DProxy", new CommandChartTraditionalSymbol3DClassFactory());
	}

	/**
	 * 默认构造函数
	 */
	public CommandChartTraditionalSymbol3D() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandChartTraditionalSymbol3DProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.controls.CommandChartTraditionalSymbol3D".equals(this.getClass().getName()))
		{
	...
	public CommandChartTraditionalSymbol3D(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandChartTraditionalSymbol3D(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandChartTraditionalSymbol3D fromBaseObject(BaseObject baseObj)
	{
		...
		CommandChartTraditionalSymbol3D obj = null;
 		if(baseObj instanceof CommandChartTraditionalSymbol3D)
		{
			obj = (CommandChartTraditionalSymbol3D)baseObj;
		} else {
