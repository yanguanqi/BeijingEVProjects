 ...
 * 三维海图母语标注模式命令
 */
public class CommandChartChineseLabel3D extends com.earthview.world.spatial3d.controls.GlobeCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Controls::CCommandChartChineseLabel3D", new CommandChartChineseLabel3DClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Controls::JCCommandChartChineseLabel3DProxy", new CommandChartChineseLabel3DClassFactory());
	}

	/**
	 * 默认构造函数
	 */
	public CommandChartChineseLabel3D() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandChartChineseLabel3DProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.controls.CommandChartChineseLabel3D".equals(this.getClass().getName()))
		{
	...
	public CommandChartChineseLabel3D(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandChartChineseLabel3D(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandChartChineseLabel3D fromBaseObject(BaseObject baseObj)
	{
		...
		CommandChartChineseLabel3D obj = null;
 		if(baseObj instanceof CommandChartChineseLabel3D)
		{
			obj = (CommandChartChineseLabel3D)baseObj;
		} else {
