 ...
 * 海图晴天颜色模式命令
 */
public class CommandChartBrightColor extends com.earthview.world.spatial2d.controls.MapCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CCommandChartBrightColor", new CommandChartBrightColorClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCCommandChartBrightColorProxy", new CommandChartBrightColorClassFactory());
	}

	/**
	 * 默认构造函数
	 */
	public CommandChartBrightColor() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandChartBrightColorProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.CommandChartBrightColor".equals(this.getClass().getName()))
		{
	...
	public CommandChartBrightColor(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandChartBrightColor(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandChartBrightColor fromBaseObject(BaseObject baseObj)
	{
		...
		CommandChartBrightColor obj = null;
 		if(baseObj instanceof CommandChartBrightColor)
		{
			obj = (CommandChartBrightColor)baseObj;
		} else {
