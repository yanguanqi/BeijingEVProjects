 ...
 * 三维海图5米安全等深线模式命令
 */
public class CommandChartSaftyContour5M3D extends com.earthview.world.spatial3d.controls.GlobeCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Controls::CCommandChartSaftyContour5M3D", new CommandChartSaftyContour5M3DClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Controls::JCCommandChartSaftyContour5M3DProxy", new CommandChartSaftyContour5M3DClassFactory());
	}
	...
	public CommandChartSaftyContour5M3D() {
		...
		Create("JCCommandChartSaftyContour5M3DProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.controls.CommandChartSaftyContour5M3D".equals(this.getClass().getName()))
		{
	...
	public CommandChartSaftyContour5M3D(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandChartSaftyContour5M3D(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandChartSaftyContour5M3D fromBaseObject(BaseObject baseObj)
	{
		...
		CommandChartSaftyContour5M3D obj = null;
 		if(baseObj instanceof CommandChartSaftyContour5M3D)
		{
