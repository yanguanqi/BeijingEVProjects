 ...
 * 三维海图颜色组合框
 */
public class ChartEntryBoxColorMode3D extends com.earthview.world.spatial.systemui.Ientrybox {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::SystemUI::CChartEntryBoxColorMode3D", new ChartEntryBoxColorMode3DClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::SystemUI::JCChartEntryBoxColorMode3DProxy", new ChartEntryBoxColorMode3DClassFactory());
	}

	/**
	 * 默认构造函数
	 */
	public ChartEntryBoxColorMode3D() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCChartEntryBoxColorMode3DProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.systemui.ChartEntryBoxColorMode3D".equals(this.getClass().getName()))
		{
	...
	public ChartEntryBoxColorMode3D(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ChartEntryBoxColorMode3D(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ChartEntryBoxColorMode3D fromBaseObject(BaseObject baseObj)
	{
		...
		ChartEntryBoxColorMode3D obj = null;
 		if(baseObj instanceof ChartEntryBoxColorMode3D)
		{
			obj = (ChartEntryBoxColorMode3D)baseObj;
		} else {
