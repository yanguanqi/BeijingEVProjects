 ...
 * 三维海图标准显示模式命令
 */
public class CommandChartStandardView3D extends com.earthview.world.spatial3d.controls.GlobeCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Controls::CCommandChartStandardView3D", new CommandChartStandardView3DClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Controls::JCCommandChartStandardView3DProxy", new CommandChartStandardView3DClassFactory());
	}

	/**
	 * 默认构造函数
	 */
	public CommandChartStandardView3D() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandChartStandardView3DProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.controls.CommandChartStandardView3D".equals(this.getClass().getName()))
		{
	...
	public CommandChartStandardView3D(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandChartStandardView3D(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandChartStandardView3D fromBaseObject(BaseObject baseObj)
	{
		...
		CommandChartStandardView3D obj = null;
 		if(baseObj instanceof CommandChartStandardView3D)
		{
			obj = (CommandChartStandardView3D)baseObj;
		} else {
