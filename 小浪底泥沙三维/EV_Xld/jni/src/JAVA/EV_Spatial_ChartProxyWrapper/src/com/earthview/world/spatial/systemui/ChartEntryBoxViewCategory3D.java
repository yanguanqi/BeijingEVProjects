 ...
 * 三维海图显示类型组合框
 */
public class ChartEntryBoxViewCategory3D extends com.earthview.world.spatial.systemui.Ientrybox {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::SystemUI::CChartEntryBoxViewCategory3D", new ChartEntryBoxViewCategory3DClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::SystemUI::JCChartEntryBoxViewCategory3DProxy", new ChartEntryBoxViewCategory3DClassFactory());
	}

	/**
	 * 默认构造函数
	 */
	public ChartEntryBoxViewCategory3D() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCChartEntryBoxViewCategory3DProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.systemui.ChartEntryBoxViewCategory3D".equals(this.getClass().getName()))
		{
	...
	public ChartEntryBoxViewCategory3D(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ChartEntryBoxViewCategory3D(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ChartEntryBoxViewCategory3D fromBaseObject(BaseObject baseObj)
	{
		...
		ChartEntryBoxViewCategory3D obj = null;
 		if(baseObj instanceof ChartEntryBoxViewCategory3D)
		{
			obj = (ChartEntryBoxViewCategory3D)baseObj;
		} else {
