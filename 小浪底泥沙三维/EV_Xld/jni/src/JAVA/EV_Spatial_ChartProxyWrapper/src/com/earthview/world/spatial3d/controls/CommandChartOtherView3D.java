 ...
 * 三维海图全部显示模式命令
 */
public class CommandChartOtherView3D extends com.earthview.world.spatial3d.controls.GlobeCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Controls::CCommandChartOtherView3D", new CommandChartOtherView3DClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Controls::JCCommandChartOtherView3DProxy", new CommandChartOtherView3DClassFactory());
	}

	/**
	 * 默认构造函数
	 */
	public CommandChartOtherView3D() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandChartOtherView3DProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.controls.CommandChartOtherView3D".equals(this.getClass().getName()))
		{
	...
	public CommandChartOtherView3D(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandChartOtherView3D(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandChartOtherView3D fromBaseObject(BaseObject baseObj)
	{
		...
		CommandChartOtherView3D obj = null;
 		if(baseObj instanceof CommandChartOtherView3D)
		{
			obj = (CommandChartOtherView3D)baseObj;
		} else {
