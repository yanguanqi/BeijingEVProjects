 ...
 * 三维海图30米安全等深线模式命令
 */
public class CommandChartSaftyContour30M3D extends com.earthview.world.spatial3d.controls.GlobeCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Controls::CCommandChartSaftyContour30M3D", new CommandChartSaftyContour30M3DClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Controls::JCCommandChartSaftyContour30M3DProxy", new CommandChartSaftyContour30M3DClassFactory());
	}

	/**
	 * 默认构造函数
	 */
	public CommandChartSaftyContour30M3D() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandChartSaftyContour30M3DProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.controls.CommandChartSaftyContour30M3D".equals(this.getClass().getName()))
		{
	...
	public CommandChartSaftyContour30M3D(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandChartSaftyContour30M3D(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandChartSaftyContour30M3D fromBaseObject(BaseObject baseObj)
	{
		...
		CommandChartSaftyContour30M3D obj = null;
 		if(baseObj instanceof CommandChartSaftyContour30M3D)
		{
			obj = (CommandChartSaftyContour30M3D)baseObj;
		} else {
