 ...
 * 海图简单符号模式命令
 */
public class CommandChartSimpleSymbol extends com.earthview.world.spatial2d.controls.MapCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CCommandChartSimpleSymbol", new CommandChartSimpleSymbolClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCCommandChartSimpleSymbolProxy", new CommandChartSimpleSymbolClassFactory());
	}

	/**
	 * 默认构造函数
	 */
	public CommandChartSimpleSymbol() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandChartSimpleSymbolProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.CommandChartSimpleSymbol".equals(this.getClass().getName()))
		{
	...
	public CommandChartSimpleSymbol(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandChartSimpleSymbol(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandChartSimpleSymbol fromBaseObject(BaseObject baseObj)
	{
		...
		CommandChartSimpleSymbol obj = null;
 		if(baseObj instanceof CommandChartSimpleSymbol)
		{
			obj = (CommandChartSimpleSymbol)baseObj;
		} else {
