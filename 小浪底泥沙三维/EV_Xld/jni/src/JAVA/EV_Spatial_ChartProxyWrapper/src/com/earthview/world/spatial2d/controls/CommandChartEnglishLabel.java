 ...
 * 海图英语标注模式命令
 */
public class CommandChartEnglishLabel extends com.earthview.world.spatial2d.controls.MapCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CCommandChartEnglishLabel", new CommandChartEnglishLabelClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCCommandChartEnglishLabelProxy", new CommandChartEnglishLabelClassFactory());
	}

	/**
	 * 默认构造函数
	 */
	public CommandChartEnglishLabel() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandChartEnglishLabelProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.CommandChartEnglishLabel".equals(this.getClass().getName()))
		{
	...
	public CommandChartEnglishLabel(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandChartEnglishLabel(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandChartEnglishLabel fromBaseObject(BaseObject baseObj)
	{
		...
		CommandChartEnglishLabel obj = null;
 		if(baseObj instanceof CommandChartEnglishLabel)
		{
			obj = (CommandChartEnglishLabel)baseObj;
		} else {
