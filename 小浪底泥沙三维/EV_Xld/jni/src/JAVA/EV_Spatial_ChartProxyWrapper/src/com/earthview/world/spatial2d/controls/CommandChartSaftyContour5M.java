 ...
 * 海图5米安全等深线模式命令
 */
public class CommandChartSaftyContour5M extends com.earthview.world.spatial2d.controls.MapCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CCommandChartSaftyContour5M", new CommandChartSaftyContour5MClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCCommandChartSaftyContour5MProxy", new CommandChartSaftyContour5MClassFactory());
	}

	/**
	 * 默认构造函数
	 */
	public CommandChartSaftyContour5M() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandChartSaftyContour5MProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.CommandChartSaftyContour5M".equals(this.getClass().getName()))
		{
	...
	public CommandChartSaftyContour5M(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandChartSaftyContour5M(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandChartSaftyContour5M fromBaseObject(BaseObject baseObj)
	{
		...
		CommandChartSaftyContour5M obj = null;
 		if(baseObj instanceof CommandChartSaftyContour5M)
		{
			obj = (CommandChartSaftyContour5M)baseObj;
		} else {
