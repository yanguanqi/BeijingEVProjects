 ...
 * 海图非精确空间关系模式命令，判断包围盒
 */
public class CommandChartBlurRelationship extends com.earthview.world.spatial2d.controls.MapCommand {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::CCommandChartBlurRelationship", new CommandChartBlurRelationshipClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Controls::JCCommandChartBlurRelationshipProxy", new CommandChartBlurRelationshipClassFactory());
	}

	/**
	 * 默认构造函数
	 */
	public CommandChartBlurRelationship() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCCommandChartBlurRelationshipProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.controls.CommandChartBlurRelationship".equals(this.getClass().getName()))
		{
	...
	public CommandChartBlurRelationship(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public CommandChartBlurRelationship(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static CommandChartBlurRelationship fromBaseObject(BaseObject baseObj)
	{
		...
		CommandChartBlurRelationship obj = null;
 		if(baseObj instanceof CommandChartBlurRelationship)
		{
			obj = (CommandChartBlurRelationship)baseObj;
		} else {
