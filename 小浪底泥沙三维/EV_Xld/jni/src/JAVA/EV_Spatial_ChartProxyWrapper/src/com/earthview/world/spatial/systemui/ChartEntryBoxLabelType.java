 ...
 * 海图注记类型组合框
 */
public class ChartEntryBoxLabelType extends com.earthview.world.spatial.systemui.Ientrybox {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::SystemUI::CChartEntryBoxLabelType", new ChartEntryBoxLabelTypeClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::SystemUI::JCChartEntryBoxLabelTypeProxy", new ChartEntryBoxLabelTypeClassFactory());
	}

	/**
	 * 默认构造函数
	 */
	public ChartEntryBoxLabelType() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCChartEntryBoxLabelTypeProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.systemui.ChartEntryBoxLabelType".equals(this.getClass().getName()))
		{
	...
	public ChartEntryBoxLabelType(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ChartEntryBoxLabelType(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ChartEntryBoxLabelType fromBaseObject(BaseObject baseObj)
	{
		...
		ChartEntryBoxLabelType obj = null;
 		if(baseObj instanceof ChartEntryBoxLabelType)
		{
			obj = (ChartEntryBoxLabelType)baseObj;
		} else {
