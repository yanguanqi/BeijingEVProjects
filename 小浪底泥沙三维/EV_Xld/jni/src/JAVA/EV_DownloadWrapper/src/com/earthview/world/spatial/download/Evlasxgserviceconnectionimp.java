...
public class Evlasxgserviceconnectionimp extends com.earthview.world.spatial.download.ConnectionImp {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Download::EVLasXGServiceConnectionImp", new EvlasxgserviceconnectionimpClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Download::JEVLasXGServiceConnectionImpProxy", new EvlasxgserviceconnectionimpClassFactory());
	}

	public Evlasxgserviceconnectionimp() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JEVLasXGServiceConnectionImpProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.download.Evlasxgserviceconnectionimp".equals(this.getClass().getName()))
		{
	...
	protected  int readDem_EVString_EVString_MemoryDataStreamPtr_callback(String servicename, String levelrowcols, long streamPackage)
	{
		String servicenameParamValue = servicename;
		String levelrowcolsParamValue = levelrowcols;
		com.earthview.world.core.MemoryDataStreamPtr streamPackageParamValue = new com.earthview.world.core.MemoryDataStreamPtr(CreatedWhenConstruct.CWC_NotToCreate);
		streamPackageParamValue.setDelegate(true);
		streamPackageParamValue.setInstancePointer(new InstancePointer(streamPackage));
		IClassFactory streamPackageParamValueClassFactory = GlobalClassFactoryMap.get(streamPackageParamValue.getCppInstanceTypeName());
		...
		int returnValue = readDem(servicenameParamValue, levelrowcolsParamValue, streamPackageParamValue);
		int __returnValue = returnValue;
		return __returnValue;
	}

	native private int readDem_EVString_EVString_MemoryDataStreamPtr(long pNativeObject, String servicename, String levelrowcols, long streamPackage);
	/**
	 * 读取DEM信息
	 * @param  
	 * @return 失败返回-1
	 */
	public int readDem(String servicename, String levelrowcols, com.earthview.world.core.MemoryDataStreamPtr streamPackage)
	{
		String servicenameParamValue = servicename;
		String levelrowcolsParamValue = levelrowcols;
		long streamPackageParamValue = streamPackage.nativeObject.pointer;
		int returnValue = readDem_EVString_EVString_MemoryDataStreamPtr(this.nativeObject.pointer, servicenameParamValue, levelrowcolsParamValue, streamPackageParamValue);
		return returnValue;
	}
	native private int readDem_EVString_EVString_MemoryDataStreamPtr_NoVirtual(long pNativeObject, String servicename, String levelrowcols, long streamPackage);
	protected int readDem_NoVirtual(String servicename, String levelrowcols, com.earthview.world.core.MemoryDataStreamPtr streamPackage)
	{
		String servicenameParamValue = servicename;
		String levelrowcolsParamValue = levelrowcols;
		long streamPackageParamValue = streamPackage.nativeObject.pointer;
		int returnValue = readDem_EVString_EVString_MemoryDataStreamPtr_NoVirtual(this.nativeObject.pointer, servicenameParamValue, levelrowcolsParamValue, streamPackageParamValue);
		return returnValue;
	}
	...
	public Evlasxgserviceconnectionimp(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public Evlasxgserviceconnectionimp(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static Evlasxgserviceconnectionimp fromBaseObject(BaseObject baseObj)
	{
		...
		Evlasxgserviceconnectionimp obj = null;
 		if(baseObj instanceof Evlasxgserviceconnectionimp)
		{
			obj = (Evlasxgserviceconnectionimp)baseObj;
		} else {
