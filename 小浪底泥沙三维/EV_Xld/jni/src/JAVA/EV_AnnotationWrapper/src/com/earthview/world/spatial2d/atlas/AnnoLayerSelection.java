 ...
 * 图层选择类
 */
public class AnnoLayerSelection extends com.earthview.world.spatial.atlas.Ilayerselection {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Atlas::CAnnoLayerSelection", new AnnoLayerSelectionClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Atlas::JCAnnoLayerSelectionProxy", new AnnoLayerSelectionClassFactory());
	}
	 ...
	 * @param  
	 */
	public AnnoLayerSelection() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCAnnoLayerSelectionProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.atlas.AnnoLayerSelection".equals(this.getClass().getName()))
		{
	...
	public AnnoLayerSelection(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public AnnoLayerSelection(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static AnnoLayerSelection fromBaseObject(BaseObject baseObj)
	{
		...
		AnnoLayerSelection obj = null;
 		if(baseObj instanceof AnnoLayerSelection)
		{
			obj = (AnnoLayerSelection)baseObj;
		} else {
