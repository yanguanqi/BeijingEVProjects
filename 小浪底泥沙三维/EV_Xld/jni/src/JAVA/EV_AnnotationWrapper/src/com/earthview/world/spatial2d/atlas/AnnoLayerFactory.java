...
public class AnnoLayerFactory extends com.earthview.world.spatial.atlas.Ilayerfactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Atlas::CAnnoLayerFactory", new AnnoLayerFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial2D::Atlas::JCAnnoLayerFactoryProxy", new AnnoLayerFactoryClassFactory());
	}

	public AnnoLayerFactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCAnnoLayerFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial2d.atlas.AnnoLayerFactory".equals(this.getClass().getName()))
		{
	...
	/**
	 * É¾³ýÍ¼²ãÊµÀý
	 * @param layer ´ýÉ¾³ýµÄÍ¼²ã
	 * @return Èç¹ûÉ¾³ý³É¹¦Ôò·µ»Øtrue,·´Ö®Ôò·ñ
	 */
	...
	public AnnoLayerFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public AnnoLayerFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static AnnoLayerFactory fromBaseObject(BaseObject baseObj)
	{
		...
		AnnoLayerFactory obj = null;
 		if(baseObj instanceof AnnoLayerFactory)
		{
			obj = (AnnoLayerFactory)baseObj;
		} else {
