 ...
 */
public class ChartFeatureSelection extends com.earthview.world.spatial.geodataset.Ifeatureselection {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::GeoDataset::CChartFeatureSelection", new ChartFeatureSelectionClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::GeoDataset::JCChartFeatureSelectionProxy", new ChartFeatureSelectionClassFactory());
	}
	 ...
	 * 默认构造函数
	 */
	public ChartFeatureSelection(com.earthview.world.spatial.geodataset.ChartDataset pDataset) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer pDatasetPtr = new BasePointer(pDataset);
		list.add("pDataset", pDatasetPtr.get());
		Create("JCChartFeatureSelectionProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.geodataset.ChartFeatureSelection".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
		}
	}

	public ChartFeatureSelection(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ChartFeatureSelection(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ChartFeatureSelection fromBaseObject(BaseObject baseObj)
	{
		...
		ChartFeatureSelection obj = null;
 		if(baseObj instanceof ChartFeatureSelection)
		{
			obj = (ChartFeatureSelection)baseObj;
		} else {
