 ...
 * 海图图层类工厂
 */
public class ChartLayerFactory extends com.earthview.world.spatial.atlas.Ilayerfactory {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Atlas::CChartLayerFactory", new ChartLayerFactoryClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial::Atlas::JCChartLayerFactoryProxy", new ChartLayerFactoryClassFactory());
	}

	/**
	 * 默认构造函数
	 */
	public ChartLayerFactory() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCChartLayerFactoryProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial.atlas.ChartLayerFactory".equals(this.getClass().getName()))
		{
	...
	/**
	 * 获取工厂类型
	 * @return 海图图层类型：LT_VECTOR_CHARTLAYER
	 */
	...
	public ChartLayerFactory(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public ChartLayerFactory(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static ChartLayerFactory fromBaseObject(BaseObject baseObj)
	{
		...
		ChartLayerFactory obj = null;
 		if(baseObj instanceof ChartLayerFactory)
		{
			obj = (ChartLayerFactory)baseObj;
		} else {
