...
public class PointEditRenderable extends com.earthview.world.graphic.SimpleRenderable {
	
	static {
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Controls::CPointEditRenderable", new PointEditRenderableClassFactory());
		GlobalClassFactoryMap.put("EarthView::World::Spatial3D::Controls::JCPointEditRenderableProxy", new PointEditRenderableClassFactory());
	}
	 ...
	 * @param  
	 */
	public PointEditRenderable() {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		Create("JCPointEditRenderableProxy", null, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.controls.PointEditRenderable".equals(this.getClass().getName()))
		{
	 ...
	 * @param name 名字
	 */
	public PointEditRenderable(String name) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
		NameValuePairList list = new NameValuePairList();
		BasePointer namePtr = new BasePointer(name);
		list.add("name", namePtr.get());
		Create("JCPointEditRenderableProxy", list, true);
		this.registerCallback();
		if (!"com.earthview.world.spatial3d.controls.PointEditRenderable".equals(this.getClass().getName()))
		{
			this.setCustomExtend(true);
	...
	public PointEditRenderable(CreatedWhenConstruct cwc) {
		super(CreatedWhenConstruct.CWC_NotToCreate);
	}
	public PointEditRenderable(CreatedWhenConstruct cwc, String classNameStr) {
	...
	public static PointEditRenderable fromBaseObject(BaseObject baseObj)
	{
		if (baseObj == null || InstancePointer.ZERO.equals(baseObj.nativeObject))
		{
			return null;
		}
		PointEditRenderable obj = null;
 		if(baseObj instanceof PointEditRenderable)
		{
			obj = (PointEditRenderable)baseObj;
		} else {
			obj = new PointEditRenderable(CreatedWhenConstruct.CWC_NotToCreate);
			obj.bindNativeObject(baseObj.nativeObject, "CPointEditRenderable");
			obj.increaseCast();
		}
