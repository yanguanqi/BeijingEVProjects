...
namespace EarthView
{
	namespace World
	{
		namespace Spatial
		{
			namespace Convertor
			{
				class JCFileRasterDriverProxy : public EarthView::World::Spatial::Convertor::CFileRasterDriver
				{
				 private:
				...
				public:
					JCFileRasterDriverProxy(EarthView::World::Core::CNameValuePairList *pList) : CFileRasterDriver(pList)
					{
					}
				...
				public:
					...
					virtual ev_int32 open(EarthView::World::Spatial::GeoDataset::IPropertySet* pPropertySet, EarthView::World::Spatial::Convertor::EVDataExchangeOperateMode mode, const EarthView::World::Spatial::Convertor::CDataExchangeParam* ref_param, ev_uint32& blockcount, EarthView::World::Core::CDataStream& stream)
					{
						if (this->_gRef != NULL && this->m_open_IPropertySet_EVDataExchangeOperateMode_CDataExchangeParam_ev_uint32_CDataStream_callback != "" && this->isCustomExtend())
						{
							...
							jlong blockcount_j = (jlong) &blockcount;
							...
							jint __values1_j = (jint)__env->CallIntMethod(__obj, __method , pPropertySet_j, mode_j, ref_param_j, blockcount_j, stream_j);
							#if EV_PLATFORM == EV_PLATFORM_ANDROID
							if(__jniAttachable)
							{
								EarthView::World::Core::JNILoad::getCachedJVM()->DetachCurrentThread();
					...
					virtual ev_int32 open(EarthView::World::Spatial::GeoDataset::IDataSource* ref_dataSource, const EVString& datasetName, EarthView::World::Spatial::Convertor::EVDataExchangeOperateMode mode, const EarthView::World::Spatial::Convertor::CDataExchangeParam* ref_param, ev_uint32& blockcount, EarthView::World::Core::CDataStream& stream)
					{
						if (this->_gRef != NULL && this->m_open_IDataSource_EVString_EVDataExchangeOperateMode_CDataExchangeParam_ev_uint32_CDataStream_callback != "" && this->isCustomExtend())
						{
							...
							jint __values1_j = (jint)__env->CallIntMethod(__obj, __method , ref_dataSource_j, datasetName_j, mode_j, ref_param_j, blockcount_j, stream_j);
							#if EV_PLATFORM == EV_PLATFORM_ANDROID
							if(__jniAttachable)
							{
								EarthView::World::Core::JNILoad::getCachedJVM()->DetachCurrentThread();
				...
				REGISTER_FACTORY_CLASS(JCFileRasterDriverProxy);
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_convertor_FileRasterDriver_finishWrite_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial::Convertor::CFileRasterDriver *pObjectX = (EarthView::World::Spatial::Convertor::CFileRasterDriver*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCFileRasterDriverProxy))
					{
						pObjectX->EarthView::World::Spatial::Convertor::CFileRasterDriver::finishWrite();
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_convertor_FileRasterDriver_register_1finishWrite_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCFileRasterDriverProxy *pObjectX = (JCFileRasterDriverProxy*) pObjXXXX;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_convertor_FileRasterDriver_finishWrite_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial::Convertor::CFileRasterDriver *pObjectX = (EarthView::World::Spatial::Convertor::CFileRasterDriver*) pObjXXXX;
					pObjectX->EarthView::World::Spatial::Convertor::CFileRasterDriver::finishWrite();
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_convertor_FileRasterDriver_close_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial::Convertor::CFileRasterDriver *pObjectX = (EarthView::World::Spatial::Convertor::CFileRasterDriver*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCFileRasterDriverProxy))
					{
						pObjectX->EarthView::World::Spatial::Convertor::CFileRasterDriver::close();
					}
					else
					{
						pObjectX->close();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_convertor_FileRasterDriver_register_1close_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCFileRasterDriverProxy *pObjectX = (JCFileRasterDriverProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_convertor_FileRasterDriver_close_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial::Convertor::CFileRasterDriver *pObjectX = (EarthView::World::Spatial::Convertor::CFileRasterDriver*) pObjXXXX;
					pObjectX->EarthView::World::Spatial::Convertor::CFileRasterDriver::close();
				}
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial_convertor_FileRasterDriver_open_1IPropertySet_1EVDataExchangeOperateMode_1CDataExchangeParam_1ev_1uint32_1CDataStream(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong pPropertySet_j, jint mode_j, jlong ref_param_j, jlong blockcount_j, jlong stream_j)
				{
					...
					ev_uint32 &blockcount = *(ev_uint32*) blockcount_j;
					EarthView::World::Core::CDataStream &stream = *(EarthView::World::Core::CDataStream*) stream_j;
					EarthView::World::Spatial::Convertor::CFileRasterDriver *pObjectX = (EarthView::World::Spatial::Convertor::CFileRasterDriver*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCFileRasterDriverProxy))
					{
						ev_int32 __values1 = pObjectX->EarthView::World::Spatial::Convertor::CFileRasterDriver::open(pPropertySet, mode, ref_param, blockcount, stream);
						jint __values1_j = (jint)__values1;
						return __values1_j;
					}
					else
					{
						ev_int32 __values1 = pObjectX->open(pPropertySet, mode, ref_param, blockcount, stream);
						jint __values1_j = (jint)__values1;
						return __values1_j;
					}
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_convertor_FileRasterDriver_register_1open_1IPropertySet_1EVDataExchangeOperateMode_1CDataExchangeParam_1ev_1uint32_1CDataStream(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCFileRasterDriverProxy *pObjectX = (JCFileRasterDriverProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial_convertor_FileRasterDriver_open_1IPropertySet_1EVDataExchangeOperateMode_1CDataExchangeParam_1ev_1uint32_1CDataStream_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong pPropertySet_j, jint mode_j, jlong ref_param_j, jlong blockcount_j, jlong stream_j)
				{
					EarthView::World::Spatial::GeoDataset::IPropertySet *pPropertySet = (EarthView::World::Spatial::GeoDataset::IPropertySet*) pPropertySet_j;
					EarthView::World::Spatial::Convertor::EVDataExchangeOperateMode mode = (EarthView::World::Spatial::Convertor::EVDataExchangeOperateMode) mode_j;
					const EarthView::World::Spatial::Convertor::CDataExchangeParam *ref_param = (const EarthView::World::Spatial::Convertor::CDataExchangeParam*) ref_param_j;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial_convertor_FileRasterDriver_open_1IDataSource_1EVString_1EVDataExchangeOperateMode_1CDataExchangeParam_1ev_1uint32_1CDataStream(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong ref_dataSource_j, jstring datasetName_j, jint mode_j, jlong ref_param_j, jlong blockcount_j, jlong stream_j)
				{
					...
					if (typeid(*pObjectX) == typeid(JCFileRasterDriverProxy))
					{
						ev_int32 __values1 = pObjectX->EarthView::World::Spatial::Convertor::CFileRasterDriver::open(ref_dataSource, datasetName, mode, ref_param, blockcount, stream);
						jint __values1_j = (jint)__values1;
						return __values1_j;
					}
					else
					{
						ev_int32 __values1 = pObjectX->open(ref_dataSource, datasetName, mode, ref_param, blockcount, stream);
						jint __values1_j = (jint)__values1;
						return __values1_j;
					}
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_convertor_FileRasterDriver_register_1open_1IDataSource_1EVString_1EVDataExchangeOperateMode_1CDataExchangeParam_1ev_1uint32_1CDataStream(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCFileRasterDriverProxy *pObjectX = (JCFileRasterDriverProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial_convertor_FileRasterDriver_open_1IDataSource_1EVString_1EVDataExchangeOperateMode_1CDataExchangeParam_1ev_1uint32_1CDataStream_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong ref_dataSource_j, jstring datasetName_j, jint mode_j, jlong ref_param_j, jlong blockcount_j, jlong stream_j)
				{
					EarthView::World::Spatial::GeoDataset::IDataSource *ref_dataSource = (EarthView::World::Spatial::GeoDataset::IDataSource*) ref_dataSource_j;
					#if EV_PLATFORM == EV_PLATFORM_ANDROID
					const ev_char* datasetName_ch = (const ev_char*)__env->GetStringUTFChars(datasetName_j,JNI_FALSE);
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial_convertor_FileRasterDriver_read_1ev_1uint32_1CDataStream(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong index_j, jlong stream_j)
				{
					...
					if (typeid(*pObjectX) == typeid(JCFileRasterDriverProxy))
					{
						ev_int32 __values1 = pObjectX->EarthView::World::Spatial::Convertor::CFileRasterDriver::read(index, stream);
						jint __values1_j = (jint)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_convertor_FileRasterDriver_register_1read_1ev_1uint32_1CDataStream(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCFileRasterDriverProxy *pObjectX = (JCFileRasterDriverProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial_convertor_FileRasterDriver_read_1ev_1uint32_1CDataStream_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong index_j, jlong stream_j)
				{
					ev_uint32 index = (ev_uint32) index_j;
					EarthView::World::Core::CDataStream &stream = *(EarthView::World::Core::CDataStream*) stream_j;
					EarthView::World::Spatial::Convertor::CFileRasterDriver *pObjectX = (EarthView::World::Spatial::Convertor::CFileRasterDriver*) pObjXXXX;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial_convertor_FileRasterDriver_write_1ev_1uint32_1CDataStream(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong index_j, jlong stream_j)
				{
					ev_uint32 index = (ev_uint32) index_j;
					EarthView::World::Core::CDataStream &stream = *(EarthView::World::Core::CDataStream*) stream_j;
					EarthView::World::Spatial::Convertor::CFileRasterDriver *pObjectX = (EarthView::World::Spatial::Convertor::CFileRasterDriver*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCFileRasterDriverProxy))
					{
						ev_int32 __values1 = pObjectX->EarthView::World::Spatial::Convertor::CFileRasterDriver::write(index, stream);
						jint __values1_j = (jint)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_convertor_FileRasterDriver_register_1write_1ev_1uint32_1CDataStream(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCFileRasterDriverProxy *pObjectX = (JCFileRasterDriverProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial_convertor_FileRasterDriver_write_1ev_1uint32_1CDataStream_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong index_j, jlong stream_j)
				{
					ev_uint32 index = (ev_uint32) index_j;
					EarthView::World::Core::CDataStream &stream = *(EarthView::World::Core::CDataStream*) stream_j;
					EarthView::World::Spatial::Convertor::CFileRasterDriver *pObjectX = (EarthView::World::Spatial::Convertor::CFileRasterDriver*) pObjXXXX;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_convertor_FileRasterDriver_register_1canRead_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCFileRasterDriverProxy *pObjectX = (JCFileRasterDriverProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_convertor_FileRasterDriver_register_1canWrite_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCFileRasterDriverProxy *pObjectX = (JCFileRasterDriverProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
