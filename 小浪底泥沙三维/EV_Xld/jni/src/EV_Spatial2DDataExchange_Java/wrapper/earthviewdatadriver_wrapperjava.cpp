...
namespace EarthView
{
	namespace World
	{
		namespace Spatial
		{
			namespace Convertor
			{
				class JCEarthViewDataDriverProxy : public EarthView::World::Spatial::Convertor::CEarthViewDataDriver
				{
				 private:
				...
				public:
					JCEarthViewDataDriverProxy(EarthView::World::Core::CNameValuePairList *pList) : CEarthViewDataDriver(pList)
					{
					}
				...
				REGISTER_FACTORY_CLASS(JCEarthViewDataDriverProxy);
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_convertor_EarthViewDataDriver_finishWrite_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial::Convertor::CEarthViewDataDriver *pObjectX = (EarthView::World::Spatial::Convertor::CEarthViewDataDriver*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCEarthViewDataDriverProxy))
					{
						pObjectX->EarthView::World::Spatial::Convertor::CEarthViewDataDriver::finishWrite();
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_convertor_EarthViewDataDriver_register_1finishWrite_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEarthViewDataDriverProxy *pObjectX = (JCEarthViewDataDriverProxy*) pObjXXXX;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_convertor_EarthViewDataDriver_finishWrite_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial::Convertor::CEarthViewDataDriver *pObjectX = (EarthView::World::Spatial::Convertor::CEarthViewDataDriver*) pObjXXXX;
					pObjectX->EarthView::World::Spatial::Convertor::CEarthViewDataDriver::finishWrite();
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_convertor_EarthViewDataDriver_close_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial::Convertor::CEarthViewDataDriver *pObjectX = (EarthView::World::Spatial::Convertor::CEarthViewDataDriver*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCEarthViewDataDriverProxy))
					{
						pObjectX->EarthView::World::Spatial::Convertor::CEarthViewDataDriver::close();
					}
					else
					{
						pObjectX->close();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_convertor_EarthViewDataDriver_register_1close_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEarthViewDataDriverProxy *pObjectX = (JCEarthViewDataDriverProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_convertor_EarthViewDataDriver_close_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial::Convertor::CEarthViewDataDriver *pObjectX = (EarthView::World::Spatial::Convertor::CEarthViewDataDriver*) pObjXXXX;
					pObjectX->EarthView::World::Spatial::Convertor::CEarthViewDataDriver::close();
				}
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial_convertor_EarthViewDataDriver_read_1ev_1uint32_1CDataStream(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong index_j, jlong stream_j)
				{
					...
					if (typeid(*pObjectX) == typeid(JCEarthViewDataDriverProxy))
					{
						ev_int32 __values1 = pObjectX->EarthView::World::Spatial::Convertor::CEarthViewDataDriver::read(index, stream);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_convertor_EarthViewDataDriver_register_1read_1ev_1uint32_1CDataStream(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEarthViewDataDriverProxy *pObjectX = (JCEarthViewDataDriverProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial_convertor_EarthViewDataDriver_read_1ev_1uint32_1CDataStream_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong index_j, jlong stream_j)
				{
					ev_uint32 index = (ev_uint32) index_j;
					EarthView::World::Core::CDataStream &stream = *(EarthView::World::Core::CDataStream*) stream_j;
					EarthView::World::Spatial::Convertor::CEarthViewDataDriver *pObjectX = (EarthView::World::Spatial::Convertor::CEarthViewDataDriver*) pObjXXXX;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial_convertor_EarthViewDataDriver_write_1ev_1uint32_1CDataStream(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong index_j, jlong stream_j)
				{
					ev_uint32 index = (ev_uint32) index_j;
					EarthView::World::Core::CDataStream &stream = *(EarthView::World::Core::CDataStream*) stream_j;
					EarthView::World::Spatial::Convertor::CEarthViewDataDriver *pObjectX = (EarthView::World::Spatial::Convertor::CEarthViewDataDriver*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCEarthViewDataDriverProxy))
					{
						ev_int32 __values1 = pObjectX->EarthView::World::Spatial::Convertor::CEarthViewDataDriver::write(index, stream);
						jint __values1_j = (jint)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_convertor_EarthViewDataDriver_register_1write_1ev_1uint32_1CDataStream(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEarthViewDataDriverProxy *pObjectX = (JCEarthViewDataDriverProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial_convertor_EarthViewDataDriver_write_1ev_1uint32_1CDataStream_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong index_j, jlong stream_j)
				{
					ev_uint32 index = (ev_uint32) index_j;
					EarthView::World::Core::CDataStream &stream = *(EarthView::World::Core::CDataStream*) stream_j;
					EarthView::World::Spatial::Convertor::CEarthViewDataDriver *pObjectX = (EarthView::World::Spatial::Convertor::CEarthViewDataDriver*) pObjXXXX;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial_convertor_EarthViewDataDriver_open_1IPropertySet_1EVDataExchangeOperateMode_1CDataExchangeParam_1ev_1uint32_1CDataStream(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong pPropertySet_j, jint mode_j, jlong ref_param_j, jlong featurecount_j, jlong stream_j)
				{
					...
					if (typeid(*pObjectX) == typeid(JCEarthViewDataDriverProxy))
					{
						ev_int32 __values1 = pObjectX->EarthView::World::Spatial::Convertor::CEarthViewDataDriver::open(pPropertySet, mode, ref_param, featurecount, stream);
						jint __values1_j = (jint)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_convertor_EarthViewDataDriver_register_1open_1IPropertySet_1EVDataExchangeOperateMode_1CDataExchangeParam_1ev_1uint32_1CDataStream(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEarthViewDataDriverProxy *pObjectX = (JCEarthViewDataDriverProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial_convertor_EarthViewDataDriver_open_1IPropertySet_1EVDataExchangeOperateMode_1CDataExchangeParam_1ev_1uint32_1CDataStream_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong pPropertySet_j, jint mode_j, jlong ref_param_j, jlong featurecount_j, jlong stream_j)
				{
					EarthView::World::Spatial::GeoDataset::IPropertySet *pPropertySet = (EarthView::World::Spatial::GeoDataset::IPropertySet*) pPropertySet_j;
					EarthView::World::Spatial::Convertor::EVDataExchangeOperateMode mode = (EarthView::World::Spatial::Convertor::EVDataExchangeOperateMode) mode_j;
					const EarthView::World::Spatial::Convertor::CDataExchangeParam *ref_param = (const EarthView::World::Spatial::Convertor::CDataExchangeParam*) ref_param_j;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial_convertor_EarthViewDataDriver_open_1IDataSource_1EVString_1EVDataExchangeOperateMode_1CDataExchangeParam_1ev_1uint32_1CDataStream(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong ref_dataSource_j, jstring dataname_j, jint mode_j, jlong ref_param_j, jlong featurecount_j, jlong stream_j)
				{
					...
					if (typeid(*pObjectX) == typeid(JCEarthViewDataDriverProxy))
					{
						ev_int32 __values1 = pObjectX->EarthView::World::Spatial::Convertor::CEarthViewDataDriver::open(ref_dataSource, dataname, mode, ref_param, featurecount, stream);
						jint __values1_j = (jint)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_convertor_EarthViewDataDriver_register_1open_1IDataSource_1EVString_1EVDataExchangeOperateMode_1CDataExchangeParam_1ev_1uint32_1CDataStream(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEarthViewDataDriverProxy *pObjectX = (JCEarthViewDataDriverProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial_convertor_EarthViewDataDriver_open_1IDataSource_1EVString_1EVDataExchangeOperateMode_1CDataExchangeParam_1ev_1uint32_1CDataStream_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong ref_dataSource_j, jstring dataname_j, jint mode_j, jlong ref_param_j, jlong featurecount_j, jlong stream_j)
				{
					EarthView::World::Spatial::GeoDataset::IDataSource *ref_dataSource = (EarthView::World::Spatial::GeoDataset::IDataSource*) ref_dataSource_j;
					#if EV_PLATFORM == EV_PLATFORM_ANDROID
					const ev_char* dataname_ch = (const ev_char*)__env->GetStringUTFChars(dataname_j,JNI_FALSE);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_convertor_EarthViewDataDriver_register_1canRead_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEarthViewDataDriverProxy *pObjectX = (JCEarthViewDataDriverProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_convertor_EarthViewDataDriver_register_1canWrite_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEarthViewDataDriverProxy *pObjectX = (JCEarthViewDataDriverProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
