...
namespace EarthView
{
	namespace World
	{
		namespace Spatial
		{
			namespace Geometry
			{
				class JCPointProxy : public EarthView::World::Spatial::Geometry::CPoint
				{
				 private:
				...
				public:
					JCPointProxy(EarthView::World::Core::CNameValuePairList *pList) : CPoint(pList)
					{
					}
				...
				REGISTER_FACTORY_CLASS(JCPointProxy);
				extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_spatial_geometry_Point_getX_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Geometry::CPoint *pObjectX = (EarthView::World::Spatial::Geometry::CPoint*) pObjXXXX;
					ev_real64 __values1 = pObjectX->getX();
					jdouble __values1_j = (jdouble)__values1;
					return __values1_j;
				}
				extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_spatial_geometry_Point_getY_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Geometry::CPoint *pObjectX = (EarthView::World::Spatial::Geometry::CPoint*) pObjXXXX;
				...
				extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_spatial_geometry_Point_getZ_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Geometry::CPoint *pObjectX = (EarthView::World::Spatial::Geometry::CPoint*) pObjXXXX;
				...
				extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_spatial_geometry_Point_getM_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Geometry::CPoint *pObjectX = (EarthView::World::Spatial::Geometry::CPoint*) pObjXXXX;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Point_setX_1ev_1real64(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble value_j)
				{
					ev_real64 value = (ev_real64) value_j;
					EarthView::World::Spatial::Geometry::CPoint *pObjectX = (EarthView::World::Spatial::Geometry::CPoint*) pObjXXXX;
					pObjectX->setX(value);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Point_setY_1ev_1real64(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble value_j)
				{
					ev_real64 value = (ev_real64) value_j;
					EarthView::World::Spatial::Geometry::CPoint *pObjectX = (EarthView::World::Spatial::Geometry::CPoint*) pObjXXXX;
					pObjectX->setY(value);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Point_setZ_1ev_1real64(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble value_j)
				{
					ev_real64 value = (ev_real64) value_j;
					EarthView::World::Spatial::Geometry::CPoint *pObjectX = (EarthView::World::Spatial::Geometry::CPoint*) pObjXXXX;
					pObjectX->setZ(value);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Point_setM_1ev_1real64(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble value_j)
				{
					ev_real64 value = (ev_real64) value_j;
					EarthView::World::Spatial::Geometry::CPoint *pObjectX = (EarthView::World::Spatial::Geometry::CPoint*) pObjXXXX;
					pObjectX->setM(value);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Point_setPoint_1ev_1real64_1ev_1real64(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble x_j, jdouble y_j)
				{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Point_setPoint_1ev_1real64_1ev_1real64_1ev_1real64(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble x_j, jdouble y_j, jdouble z_j)
				{
					ev_real64 x = (ev_real64) x_j;
					ev_real64 y = (ev_real64) y_j;
					ev_real64 z = (ev_real64) z_j;
					EarthView::World::Spatial::Geometry::CPoint *pObjectX = (EarthView::World::Spatial::Geometry::CPoint*) pObjXXXX;
					pObjectX->setPoint(x, y, z);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Point_setPoint_1CCoordinate(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong coord_j)
				{
					const EarthView::World::Spatial::Geometry::CCoordinate &coord = *(EarthView::World::Spatial::Geometry::CCoordinate*) coord_j;
					EarthView::World::Spatial::Geometry::CPoint *pObjectX = (EarthView::World::Spatial::Geometry::CPoint*) pObjXXXX;
					pObjectX->setPoint(coord);
				}
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_geometry_Point_getCoordinate_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Geometry::CPoint *pObjectX = (EarthView::World::Spatial::Geometry::CPoint*) pObjXXXX;
					EarthView::World::Spatial::Geometry::CCoordinate __values1 = pObjectX->getCoordinate();
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_geometry_Point_isValid_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Geometry::CPoint *pObjectX = (EarthView::World::Spatial::Geometry::CPoint*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCPointProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial::Geometry::CPoint::isValid();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Point_register_1isValid_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPointProxy *pObjectX = (JCPointProxy*) pObjXXXX;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_geometry_Point_isValid_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Geometry::CPoint *pObjectX = (EarthView::World::Spatial::Geometry::CPoint*) pObjXXXX;
					ev_bool __values1 = pObjectX->EarthView::World::Spatial::Geometry::CPoint::isValid();
					jboolean __values1_j = (jboolean)__values1;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_geometry_Point_isEmpty_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Geometry::CPoint *pObjectX = (EarthView::World::Spatial::Geometry::CPoint*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCPointProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial::Geometry::CPoint::isEmpty();
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Point_register_1isEmpty_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPointProxy *pObjectX = (JCPointProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_geometry_Point_isEmpty_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Geometry::CPoint *pObjectX = (EarthView::World::Spatial::Geometry::CPoint*) pObjXXXX;
					ev_bool __values1 = pObjectX->EarthView::World::Spatial::Geometry::CPoint::isEmpty();
					jboolean __values1_j = (jboolean)__values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_geometry_Point_getBoundary_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Geometry::CPoint *pObjectX = (EarthView::World::Spatial::Geometry::CPoint*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCPointProxy))
					{
						EarthView::World::Spatial::Geometry::IGeometry* __values1 = pObjectX->EarthView::World::Spatial::Geometry::CPoint::getBoundary();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Point_register_1getBoundary_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPointProxy *pObjectX = (JCPointProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_geometry_Point_getBoundary_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Geometry::CPoint *pObjectX = (EarthView::World::Spatial::Geometry::CPoint*) pObjXXXX;
					EarthView::World::Spatial::Geometry::IGeometry* __values1 = pObjectX->EarthView::World::Spatial::Geometry::CPoint::getBoundary();
					if(__values1 != NULL) {						((EarthView::World::Core::CBaseObject*)__values1)->setExternFree(true);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Point_makeZ_1ev_1real64(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble z_j)
				{
					ev_real64 z = (ev_real64) z_j;
					EarthView::World::Spatial::Geometry::CPoint *pObjectX = (EarthView::World::Spatial::Geometry::CPoint*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCPointProxy))
					{
						pObjectX->EarthView::World::Spatial::Geometry::CPoint::makeZ(z);
					}
					else
					{
						pObjectX->makeZ(z);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Point_register_1makeZ_1ev_1real64(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPointProxy *pObjectX = (JCPointProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Point_makeZ_1ev_1real64_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble z_j)
				{
					ev_real64 z = (ev_real64) z_j;
					EarthView::World::Spatial::Geometry::CPoint *pObjectX = (EarthView::World::Spatial::Geometry::CPoint*) pObjXXXX;
					pObjectX->EarthView::World::Spatial::Geometry::CPoint::makeZ(z);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Point_makeM_1ev_1real64(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble m_j)
				{
					ev_real64 m = (ev_real64) m_j;
					EarthView::World::Spatial::Geometry::CPoint *pObjectX = (EarthView::World::Spatial::Geometry::CPoint*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCPointProxy))
					{
						pObjectX->EarthView::World::Spatial::Geometry::CPoint::makeM(m);
					}
					else
					{
						pObjectX->makeM(m);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Point_register_1makeM_1ev_1real64(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPointProxy *pObjectX = (JCPointProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Point_makeM_1ev_1real64_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble m_j)
				{
					ev_real64 m = (ev_real64) m_j;
					EarthView::World::Spatial::Geometry::CPoint *pObjectX = (EarthView::World::Spatial::Geometry::CPoint*) pObjXXXX;
					pObjectX->EarthView::World::Spatial::Geometry::CPoint::makeM(m);
				}
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_geometry_Point_ev_1clone_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Geometry::CPoint *pObjectX = (EarthView::World::Spatial::Geometry::CPoint*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCPointProxy))
					{
						EarthView::World::Spatial::Geometry::IGeometry* __values1 = pObjectX->EarthView::World::Spatial::Geometry::CPoint::clone();
						if(__values1 != NULL) {							((EarthView::World::Core::CBaseObject*)__values1)->setExternFree(true);
						}						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Point_register_1ev_1clone_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPointProxy *pObjectX = (JCPointProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_geometry_Point_ev_1clone_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Geometry::CPoint *pObjectX = (EarthView::World::Spatial::Geometry::CPoint*) pObjXXXX;
					EarthView::World::Spatial::Geometry::IGeometry* __values1 = pObjectX->EarthView::World::Spatial::Geometry::CPoint::clone();
					if(__values1 != NULL) {						((EarthView::World::Core::CBaseObject*)__values1)->setExternFree(true);
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_geometry_Point_isEquals_1IGeometry_1ev_1real64_1EVDimensionType(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong geom_j, jdouble tolerance_j, jint dimension_j)
				{
					...
					if (typeid(*pObjectX) == typeid(JCPointProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial::Geometry::CPoint::isEquals(geom, tolerance, dimension);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Point_register_1isEquals_1IGeometry_1ev_1real64_1EVDimensionType(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPointProxy *pObjectX = (JCPointProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_geometry_Point_isEquals_1IGeometry_1ev_1real64_1EVDimensionType_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong geom_j, jdouble tolerance_j, jint dimension_j)
				{
					const EarthView::World::Spatial::Geometry::IGeometry *geom = (const EarthView::World::Spatial::Geometry::IGeometry*) geom_j;
					ev_real64 tolerance = (ev_real64) tolerance_j;
					EarthView::World::Spatial::Geometry::EVDimensionType dimension = (EarthView::World::Spatial::Geometry::EVDimensionType) dimension_j;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Point_translate_1ev_1real64_1ev_1real64_1ev_1real64(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble x_j, jdouble y_j, jdouble z_j)
				{
					ev_real64 x = (ev_real64) x_j;
					ev_real64 y = (ev_real64) y_j;
					ev_real64 z = (ev_real64) z_j;
					...
					if (typeid(*pObjectX) == typeid(JCPointProxy))
					{
						pObjectX->EarthView::World::Spatial::Geometry::CPoint::translate(x, y, z);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Point_register_1translate_1ev_1real64_1ev_1real64_1ev_1real64(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPointProxy *pObjectX = (JCPointProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Point_translate_1ev_1real64_1ev_1real64_1ev_1real64_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble x_j, jdouble y_j, jdouble z_j)
				{
					ev_real64 x = (ev_real64) x_j;
					ev_real64 y = (ev_real64) y_j;
					ev_real64 z = (ev_real64) z_j;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Point_rotate_1ev_1real64_1ev_1real64_1ev_1real64_1ev_1real64_1ev_1real64_1ev_1real64(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble xRef_j, jdouble yRef_j, jdouble zRef_j, jdouble xAngle_j, jdouble yAngle_j, jdouble zAngle_j)
				{
					...
					if (typeid(*pObjectX) == typeid(JCPointProxy))
					{
						pObjectX->EarthView::World::Spatial::Geometry::CPoint::rotate(xRef, yRef, zRef, xAngle, yAngle, zAngle);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Point_register_1rotate_1ev_1real64_1ev_1real64_1ev_1real64_1ev_1real64_1ev_1real64_1ev_1real64(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPointProxy *pObjectX = (JCPointProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Point_rotate_1ev_1real64_1ev_1real64_1ev_1real64_1ev_1real64_1ev_1real64_1ev_1real64_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble xRef_j, jdouble yRef_j, jdouble zRef_j, jdouble xAngle_j, jdouble yAngle_j, jdouble zAngle_j)
				{
					ev_real64 xRef = (ev_real64) xRef_j;
					ev_real64 yRef = (ev_real64) yRef_j;
					ev_real64 zRef = (ev_real64) zRef_j;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Point_scale_1ev_1real64_1ev_1real64_1ev_1real64_1ev_1real64_1ev_1real64_1ev_1real64(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble xRef_j, jdouble yRef_j, jdouble zRef_j, jdouble x_j, jdouble y_j, jdouble z_j)
				{
					ev_real64 xRef = (ev_real64) xRef_j;
					ev_real64 yRef = (ev_real64) yRef_j;
					ev_real64 zRef = (ev_real64) zRef_j;
					...
					if (typeid(*pObjectX) == typeid(JCPointProxy))
					{
						pObjectX->EarthView::World::Spatial::Geometry::CPoint::scale(xRef, yRef, zRef, x, y, z);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Point_register_1scale_1ev_1real64_1ev_1real64_1ev_1real64_1ev_1real64_1ev_1real64_1ev_1real64(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPointProxy *pObjectX = (JCPointProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Point_scale_1ev_1real64_1ev_1real64_1ev_1real64_1ev_1real64_1ev_1real64_1ev_1real64_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble xRef_j, jdouble yRef_j, jdouble zRef_j, jdouble x_j, jdouble y_j, jdouble z_j)
				{
					ev_real64 xRef = (ev_real64) xRef_j;
					ev_real64 yRef = (ev_real64) yRef_j;
					ev_real64 zRef = (ev_real64) zRef_j;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Point_projects_1ISpatialReference_1ev_1real64_1ev_1uint32(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong sr_j, jlong sevenParam_j, jlong count_j)
				{
					...
					if (typeid(*pObjectX) == typeid(JCPointProxy))
					{
						pObjectX->EarthView::World::Spatial::Geometry::CPoint::projects(sr, sevenParam, count);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Point_register_1projects_1ISpatialReference_1ev_1real64_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPointProxy *pObjectX = (JCPointProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Point_projects_1ISpatialReference_1ev_1real64_1ev_1uint32_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong sr_j, jlong sevenParam_j, jlong count_j)
				{
					const EarthView::World::Spatial::Geometry::ISpatialReference *sr = (const EarthView::World::Spatial::Geometry::ISpatialReference*) sr_j;
					ev_real64 *sevenParam = (ev_real64*) sevenParam_j;
					ev_uint32 count = (ev_uint32) count_j;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_geometry_Point_mirror_1IGeometry(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong line_j)
				{
					const EarthView::World::Spatial::Geometry::IGeometry *line = (const EarthView::World::Spatial::Geometry::IGeometry*) line_j;
					const 					EarthView::World::Spatial::Geometry::CPoint *pObjectX = (EarthView::World::Spatial::Geometry::CPoint*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCPointProxy))
					{
						EarthView::World::Spatial::Geometry::IGeometry* __values1 = pObjectX->EarthView::World::Spatial::Geometry::CPoint::mirror(line);
						if(__values1 != NULL) {							((EarthView::World::Core::CBaseObject*)__values1)->setExternFree(true);
						}						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Point_register_1mirror_1IGeometry(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPointProxy *pObjectX = (JCPointProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_geometry_Point_mirror_1IGeometry_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong line_j)
				{
					const EarthView::World::Spatial::Geometry::IGeometry *line = (const EarthView::World::Spatial::Geometry::IGeometry*) line_j;
					const 					EarthView::World::Spatial::Geometry::CPoint *pObjectX = (EarthView::World::Spatial::Geometry::CPoint*) pObjXXXX;
					EarthView::World::Spatial::Geometry::IGeometry* __values1 = pObjectX->EarthView::World::Spatial::Geometry::CPoint::mirror(line);
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_geometry_Point_snapToPoint_1IGeometry_1ev_1real64_1EVGeometrySnapType(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong point_j, jdouble tolerance_j, jlong snap_j)
				{
					...
					if (typeid(*pObjectX) == typeid(JCPointProxy))
					{
						EarthView::World::Spatial::Geometry::IGeometry* __values1 = pObjectX->EarthView::World::Spatial::Geometry::CPoint::snapToPoint(point, tolerance, snap);
						if(__values1 != NULL) {							((EarthView::World::Core::CBaseObject*)__values1)->setExternFree(true);
						}						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Point_register_1snapToPoint_1IGeometry_1ev_1real64_1EVGeometrySnapType(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPointProxy *pObjectX = (JCPointProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_geometry_Point_snapToPoint_1IGeometry_1ev_1real64_1EVGeometrySnapType_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong point_j, jdouble tolerance_j, jlong snap_j)
				{
					const EarthView::World::Spatial::Geometry::IGeometry *point = (const EarthView::World::Spatial::Geometry::IGeometry*) point_j;
					ev_real64 tolerance = (ev_real64) tolerance_j;
					EarthView::World::Spatial::Geometry::EVGeometrySnapType &snap = *(EarthView::World::Spatial::Geometry::EVGeometrySnapType*) snap_j;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_geometry_Point_snapToSegment_1IGeometry_1ev_1real64(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong point_j, jdouble tolerance_j)
				{
					const EarthView::World::Spatial::Geometry::IGeometry *point = (const EarthView::World::Spatial::Geometry::IGeometry*) point_j;
					ev_real64 tolerance = (ev_real64) tolerance_j;
					const 					EarthView::World::Spatial::Geometry::CPoint *pObjectX = (EarthView::World::Spatial::Geometry::CPoint*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCPointProxy))
					{
						EarthView::World::Spatial::Geometry::IGeometry* __values1 = pObjectX->EarthView::World::Spatial::Geometry::CPoint::snapToSegment(point, tolerance);
						if(__values1 != NULL) {							((EarthView::World::Core::CBaseObject*)__values1)->setExternFree(true);
						}						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Point_register_1snapToSegment_1IGeometry_1ev_1real64(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPointProxy *pObjectX = (JCPointProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_geometry_Point_snapToSegment_1IGeometry_1ev_1real64_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong point_j, jdouble tolerance_j)
				{
					const EarthView::World::Spatial::Geometry::IGeometry *point = (const EarthView::World::Spatial::Geometry::IGeometry*) point_j;
					ev_real64 tolerance = (ev_real64) tolerance_j;
					const 					EarthView::World::Spatial::Geometry::CPoint *pObjectX = (EarthView::World::Spatial::Geometry::CPoint*) pObjXXXX;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_geometry_Point_movePointTo_1IGeometry_1IGeometry(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong frmPoint_j, jlong cpy_toPoint_j)
				{
					...
					if (typeid(*pObjectX) == typeid(JCPointProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial::Geometry::CPoint::movePointTo(frmPoint, cpy_toPoint);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Point_register_1movePointTo_1IGeometry_1IGeometry(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPointProxy *pObjectX = (JCPointProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_geometry_Point_movePointTo_1IGeometry_1IGeometry_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong frmPoint_j, jlong cpy_toPoint_j)
				{
					const EarthView::World::Spatial::Geometry::IGeometry *frmPoint = (const EarthView::World::Spatial::Geometry::IGeometry*) frmPoint_j;
					const EarthView::World::Spatial::Geometry::IGeometry *cpy_toPoint = (const EarthView::World::Spatial::Geometry::IGeometry*) cpy_toPoint_j;
					EarthView::World::Spatial::Geometry::CPoint *pObjectX = (EarthView::World::Spatial::Geometry::CPoint*) pObjXXXX;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_geometry_Point_addPointTo_1IGeometry(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong cpy_point_j)
				{
					const EarthView::World::Spatial::Geometry::IGeometry *cpy_point = (const EarthView::World::Spatial::Geometry::IGeometry*) cpy_point_j;
					EarthView::World::Spatial::Geometry::CPoint *pObjectX = (EarthView::World::Spatial::Geometry::CPoint*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCPointProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial::Geometry::CPoint::addPointTo(cpy_point);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Point_register_1addPointTo_1IGeometry(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPointProxy *pObjectX = (JCPointProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_geometry_Point_addPointTo_1IGeometry_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong cpy_point_j)
				{
					const EarthView::World::Spatial::Geometry::IGeometry *cpy_point = (const EarthView::World::Spatial::Geometry::IGeometry*) cpy_point_j;
					EarthView::World::Spatial::Geometry::CPoint *pObjectX = (EarthView::World::Spatial::Geometry::CPoint*) pObjXXXX;
					ev_bool __values1 = pObjectX->EarthView::World::Spatial::Geometry::CPoint::addPointTo(cpy_point);
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_geometry_Point_deletePoint_1IGeometry(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong point_j)
				{
					const EarthView::World::Spatial::Geometry::IGeometry *point = (const EarthView::World::Spatial::Geometry::IGeometry*) point_j;
					EarthView::World::Spatial::Geometry::CPoint *pObjectX = (EarthView::World::Spatial::Geometry::CPoint*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCPointProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial::Geometry::CPoint::deletePoint(point);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Point_register_1deletePoint_1IGeometry(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPointProxy *pObjectX = (JCPointProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_geometry_Point_deletePoint_1IGeometry_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong point_j)
				{
					const EarthView::World::Spatial::Geometry::IGeometry *point = (const EarthView::World::Spatial::Geometry::IGeometry*) point_j;
					EarthView::World::Spatial::Geometry::CPoint *pObjectX = (EarthView::World::Spatial::Geometry::CPoint*) pObjXXXX;
					ev_bool __values1 = pObjectX->EarthView::World::Spatial::Geometry::CPoint::deletePoint(point);
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_geometry_Point_clone2_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Geometry::CPoint *pObjectX = (EarthView::World::Spatial::Geometry::CPoint*) pObjXXXX;
					EarthView::World::Spatial::Geometry::CPoint __values1 = pObjectX->clone2();
					EarthView::World::Spatial::Geometry::CPoint *returnvalues = new EarthView::World::Spatial::Geometry::CPoint(__values1);
					((EarthView::World::Core::CBaseObject*)returnvalues)->setExternFree(true);
					jlong __values1_j = (jlong) returnvalues;
					return __values1_j;
				}
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_geometry_Point_OperatorAssign_1CPoint(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jlong obj_j )
				{
					EarthView::World::Spatial::Geometry::CPoint& pObjectX = *(EarthView::World::Spatial::Geometry::CPoint*) pObjXXXX;
					const EarthView::World::Spatial::Geometry::CPoint &obj = *(EarthView::World::Spatial::Geometry::CPoint*) obj_j;
					pObjectX = obj;
					EarthView::World::Spatial::Geometry::CPoint& __values1 = pObjectX;
					jlong __values1_j = (jlong) &__values1;
					return __values1_j;
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Point_register_1isDirty_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPointProxy *pObjectX = (JCPointProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Point_register_1setDirty_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPointProxy *pObjectX = (JCPointProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Point_register_1update_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPointProxy *pObjectX = (JCPointProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Point_register_1resample_1ev_1real64_1EVDimensionType(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPointProxy *pObjectX = (JCPointProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Point_register_1split_1IGeometry(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPointProxy *pObjectX = (JCPointProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Point_register_1clip_1IGeometry(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPointProxy *pObjectX = (JCPointProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Point_register_1smooth_1ev_1real64_1EVDimensionType(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPointProxy *pObjectX = (JCPointProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Point_register_1getEnvelopeRef_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPointProxy *pObjectX = (JCPointProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Point_register_1getSpatialReferenceRef_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPointProxy *pObjectX = (JCPointProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Point_register_1getGeometryType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPointProxy *pObjectX = (JCPointProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Point_register_1getWKBGeometryType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPointProxy *pObjectX = (JCPointProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Point_register_1isSimple_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPointProxy *pObjectX = (JCPointProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Point_register_1simplify_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPointProxy *pObjectX = (JCPointProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Point_register_1setSpatialReferenceRef_1ISpatialReference(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPointProxy *pObjectX = (JCPointProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Point_register_1isContains_1IGeometry_1EVDimensionType(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPointProxy *pObjectX = (JCPointProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Point_register_1isDisjoin_1IGeometry_1EVDimensionType(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPointProxy *pObjectX = (JCPointProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Point_register_1isIntersects_1IGeometry_1EVDimensionType(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPointProxy *pObjectX = (JCPointProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Point_register_1isWithin_1IGeometry_1EVDimensionType(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPointProxy *pObjectX = (JCPointProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Point_register_1isTouches_1IGeometry_1EVDimensionType(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPointProxy *pObjectX = (JCPointProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Point_register_1isCrosses_1IGeometry_1EVDimensionType(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPointProxy *pObjectX = (JCPointProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Point_register_1isRelates_1IGeometry_1EVString_1EVDimensionType(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPointProxy *pObjectX = (JCPointProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Point_register_1buffer_1ev_1real64_1EVDimensionType(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPointProxy *pObjectX = (JCPointProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Point_register_1convexHull_1EVDimensionType(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPointProxy *pObjectX = (JCPointProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Point_register_1difference_1IGeometry_1EVDimensionType(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPointProxy *pObjectX = (JCPointProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Point_register_1distance_1IGeometry_1EVDimensionType(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPointProxy *pObjectX = (JCPointProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Point_register_1intersects_1IGeometry_1EVDimensionType(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPointProxy *pObjectX = (JCPointProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Point_register_1overlaps_1IGeometry_1EVDimensionType(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPointProxy *pObjectX = (JCPointProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Point_register_1symDifference_1IGeometry_1EVDimensionType(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPointProxy *pObjectX = (JCPointProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Point_register_1unions_1IGeometry_1EVDimensionType(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPointProxy *pObjectX = (JCPointProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Point_register_1toWKB_1CDataStream(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPointProxy *pObjectX = (JCPointProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Point_register_1toWKT_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPointProxy *pObjectX = (JCPointProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Point_register_1toStream_1CDataStream(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPointProxy *pObjectX = (JCPointProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Point_register_1getInteriorPoint_1IGeometry(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCPointProxy *pObjectX = (JCPointProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
