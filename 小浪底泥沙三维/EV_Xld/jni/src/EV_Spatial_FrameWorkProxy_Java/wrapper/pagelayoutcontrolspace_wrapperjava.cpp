...
class JCPageLayoutControlSpaceProxy : public CPageLayoutControlSpace
{
 private:
...
public:
	JCPageLayoutControlSpaceProxy(EarthView::World::Core::CNameValuePairList *pList) : CPageLayoutControlSpace(pList)
	{
	}
...
REGISTER_FACTORY_CLASS(JCPageLayoutControlSpaceProxy);
extern "C" JNIEXPORT void JNICALL Java_global_PageLayoutControlSpace_register_1onEvent_1CEvent(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCPageLayoutControlSpaceProxy *pObjectX = (JCPageLayoutControlSpaceProxy*) pObjXXXX;
...
extern "C" JNIEXPORT void JNICALL Java_global_PageLayoutControlSpace_register_1onTimerEvent_1CTimerEvent(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCPageLayoutControlSpaceProxy *pObjectX = (JCPageLayoutControlSpaceProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT void JNICALL Java_global_PageLayoutControlSpace_register_1onCustomEvent_1CEvent(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCPageLayoutControlSpaceProxy *pObjectX = (JCPageLayoutControlSpaceProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
