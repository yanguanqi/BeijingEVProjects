...
namespace EarthView
{
	namespace World
	{
		namespace FrameWorkProxy
		{
			...
			{
				class JCMapSimplePropertyProxy : public EarthView::World::FrameWorkProxy::AtlasManager::CMapSimpleProperty
				{
				 private:
				...
				public:
					JCMapSimplePropertyProxy(EarthView::World::Core::CNameValuePairList *pList) : CMapSimpleProperty(pList)
					{
					}
				...
				REGISTER_FACTORY_CLASS(JCMapSimplePropertyProxy);
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_frameworkproxy_atlasmanager_MapSimpleProperty_getMap_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::FrameWorkProxy::AtlasManager::CMapSimpleProperty *pObjectX = (EarthView::World::FrameWorkProxy::AtlasManager::CMapSimpleProperty*) pObjXXXX;
					const EarthView::World::Spatial::Atlas::IMap* __values1 = pObjectX->getMap();
					jlong __values1_j = (jlong) __values1;
					return __values1_j;
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_frameworkproxy_atlasmanager_MapSimpleProperty_setMap_1IMap(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong ref_map_j)
				{
					EarthView::World::Spatial::Atlas::IMap *ref_map = (EarthView::World::Spatial::Atlas::IMap*) ref_map_j;
					EarthView::World::FrameWorkProxy::AtlasManager::CMapSimpleProperty *pObjectX = (EarthView::World::FrameWorkProxy::AtlasManager::CMapSimpleProperty*) pObjXXXX;
					pObjectX->setMap(ref_map);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_frameworkproxy_atlasmanager_MapSimpleProperty_register_1setParameter_1EVString_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMapSimplePropertyProxy *pObjectX = (JCMapSimplePropertyProxy*) pObjXXXX;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_frameworkproxy_atlasmanager_MapSimpleProperty_register_1setParameter_1EVString_1ev_1bool_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMapSimplePropertyProxy *pObjectX = (JCMapSimplePropertyProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_frameworkproxy_atlasmanager_MapSimpleProperty_register_1setParameterList_1CommonStringPairList(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMapSimplePropertyProxy *pObjectX = (JCMapSimplePropertyProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_frameworkproxy_atlasmanager_MapSimpleProperty_register_1getParameter_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMapSimplePropertyProxy *pObjectX = (JCMapSimplePropertyProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_frameworkproxy_atlasmanager_MapSimpleProperty_register_1copyParametersTo_1CStringInterface(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCMapSimplePropertyProxy *pObjectX = (JCMapSimplePropertyProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
