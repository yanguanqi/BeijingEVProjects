...
class JCMapControlSpaceProxy : public CMapControlSpace
{
 private:
...
public:
	JCMapControlSpaceProxy(EarthView::World::Core::CNameValuePairList *pList) : CMapControlSpace(pList)
	{
	}
...
REGISTER_FACTORY_CLASS(JCMapControlSpaceProxy);
extern "C" JNIEXPORT void JNICALL Java_global_MapControlSpace_register_1onEvent_1CEvent(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCMapControlSpaceProxy *pObjectX = (JCMapControlSpaceProxy*) pObjXXXX;
...
extern "C" JNIEXPORT void JNICALL Java_global_MapControlSpace_register_1onTimerEvent_1CTimerEvent(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCMapControlSpaceProxy *pObjectX = (JCMapControlSpaceProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT void JNICALL Java_global_MapControlSpace_register_1onCustomEvent_1CEvent(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCMapControlSpaceProxy *pObjectX = (JCMapControlSpaceProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
