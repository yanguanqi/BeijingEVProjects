...
namespace EarthView
{
	namespace World
	{
		namespace Spatial3D
		{
			namespace Atlas
			{
				class JCSelectedGeometryStringInterfaceProxy : public EarthView::World::Spatial3D::Atlas::CSelectedGeometryStringInterface
				{
				 private:
				...
				public:
					JCSelectedGeometryStringInterfaceProxy(EarthView::World::Core::CNameValuePairList *pList) : CSelectedGeometryStringInterface(pList)
					{
					}
				...
				REGISTER_FACTORY_CLASS(JCSelectedGeometryStringInterfaceProxy);
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_atlas_SelectedGeometryStringInterface_getLayerName_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::CSelectedGeometryStringInterface *pObjectX = (EarthView::World::Spatial3D::Atlas::CSelectedGeometryStringInterface*) pObjXXXX;
					const EVString& __values1 = pObjectX->getLayerName();
					jlong __values1_j = (jlong) &__values1;
					return __values1_j;
				}
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_atlas_SelectedGeometryStringInterface_getName_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::CSelectedGeometryStringInterface *pObjectX = (EarthView::World::Spatial3D::Atlas::CSelectedGeometryStringInterface*) pObjXXXX;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_atlas_SelectedGeometryStringInterface_updateParams_1CGeoEntity(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong ref_geoent_j)
				{
					EarthView::World::Geometry3D::CGeoEntity *ref_geoent = (EarthView::World::Geometry3D::CGeoEntity*) ref_geoent_j;
					EarthView::World::Spatial3D::Atlas::CSelectedGeometryStringInterface *pObjectX = (EarthView::World::Spatial3D::Atlas::CSelectedGeometryStringInterface*) pObjXXXX;
					ev_bool __values1 = pObjectX->updateParams(ref_geoent);
					jboolean __values1_j = (jboolean)__values1;
					return __values1_j;
				}
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_atlas_SelectedGeometryStringInterface_updateParams_1IGlobeLayer_1ev_1uint32(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong ref_layer_j, jlong id_j)
				{
					...
					EarthView::World::Spatial3D::Atlas::CSelectedGeometryStringInterface *pObjectX = (EarthView::World::Spatial3D::Atlas::CSelectedGeometryStringInterface*) pObjXXXX;
					ev_bool __values1 = pObjectX->updateParams(ref_layer, id);
					jboolean __values1_j = (jboolean)__values1;
					return __values1_j;
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_SelectedGeometryStringInterface_register_1setParameter_1EVString_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCSelectedGeometryStringInterfaceProxy *pObjectX = (JCSelectedGeometryStringInterfaceProxy*) pObjXXXX;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_SelectedGeometryStringInterface_register_1setParameter_1EVString_1ev_1bool_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCSelectedGeometryStringInterfaceProxy *pObjectX = (JCSelectedGeometryStringInterfaceProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_SelectedGeometryStringInterface_register_1setParameterList_1CommonStringPairList(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCSelectedGeometryStringInterfaceProxy *pObjectX = (JCSelectedGeometryStringInterfaceProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_SelectedGeometryStringInterface_register_1getParameter_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCSelectedGeometryStringInterfaceProxy *pObjectX = (JCSelectedGeometryStringInterfaceProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_SelectedGeometryStringInterface_register_1copyParametersTo_1CStringInterface(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCSelectedGeometryStringInterfaceProxy *pObjectX = (JCSelectedGeometryStringInterfaceProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
