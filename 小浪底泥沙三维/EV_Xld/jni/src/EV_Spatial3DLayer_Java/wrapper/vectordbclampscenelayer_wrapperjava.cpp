...
namespace EarthView
{
	namespace World
	{
		namespace Spatial3D
		{
			namespace Atlas
			{
				class JCVectorDBClampSceneLayerProxy : public EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer
				{
				 private:
					EarthView::World::Core::ev_string m_getGeometryType_void_callback;
					EarthView::World::Core::ev_string m_getMaxStaticsThemeVisibleDistance_void_callback;
					EarthView::World::Core::ev_string m_setMaxStaticsThemeVisibleDistance_ev_real64_callback;
				...
				public:
					JCVectorDBClampSceneLayerProxy(EarthView::World::Core::CNameValuePairList *pList) : CVectorDBClampSceneLayer(pList)
					{
					}
				...
				public:
					...
					void register_getMaxStaticsThemeVisibleDistance_void_callback(EarthView::World::Core::ev_string __method)
					{
						this->m_getMaxStaticsThemeVisibleDistance_void_callback = __method;
					}
					void register_setMaxStaticsThemeVisibleDistance_ev_real64_callback(EarthView::World::Core::ev_string __method)
					{
						this->m_setMaxStaticsThemeVisibleDistance_ev_real64_callback = __method;
					}
					...
					virtual void attachLayer(EarthView::World::Spatial::Atlas::ILayer* layer)
					{
						...
						{
							return this->CVectorDBClampSceneLayer::attachLayer(layer);
						}
					}
					virtual EarthView::World::Spatial::Atlas::EVLayerType getType() const
					{
						...
						{
							return this->CVectorDBClampSceneLayer::getType();
						}
					}
					virtual EarthView::World::Spatial::Geometry::EVGeometryType getGeometryType() const
					{
						...
						{
							return this->CVectorDBClampSceneLayer::getGeometryType();
						}
					}
					virtual ev_bool getTile(ev_int32 level, ev_int32 row, ev_int32 col, EarthView::World::Spatial::CTileData& tile)
					{
						...
						{
							return this->CVectorDBClampSceneLayer::getTile(level, row, col, tile);
						}
					}
					virtual ev_bool getTile(Real minX, Real minY, Real maxX, Real maxY, EarthView::World::Spatial::CTileData& tile)
					{
						...
						{
							return this->CVectorDBClampSceneLayer::getTile(minX, minY, maxX, maxY, tile);
						}
					}
					virtual void setVisible(ev_bool visible)
					{
						...
						{
							return this->CVectorDBClampSceneLayer::setVisible(visible);
						}
					}
					virtual EarthView::World::Spatial::GeoDataset::IDataset* getDataset()
					{
						...
						{
							return this->CVectorDBClampSceneLayer::getDataset();
						}
					}
					virtual ev_int32 getMaxVisibleLevel() const
					{
						...
						{
							return this->CVectorDBClampSceneLayer::getMaxVisibleLevel();
						}
					}
					virtual ev_int32 getMinVisibleLevel() const
					{
						...
						{
							return this->CVectorDBClampSceneLayer::getMinVisibleLevel();
						}
					}
					virtual ev_bool setMaxVisibleLevel(ev_int32 maxlevel)
					{
						...
						{
							return this->CVectorDBClampSceneLayer::setMaxVisibleLevel(maxlevel);
						}
					}
					virtual ev_bool setMinVisibleLevel(ev_int32 minlevel)
					{
						...
						{
							return this->CVectorDBClampSceneLayer::setMinVisibleLevel(minlevel);
						}
					}
					virtual EarthView::World::Spatial::Theme::ITheme* getTheme() const
					{
						...
						{
							return this->CVectorDBClampSceneLayer::getTheme();
						}
					}
					virtual void setTheme(const EarthView::World::Spatial::Theme::ITheme* theme)
					{
						...
						{
							return this->CVectorDBClampSceneLayer::setTheme(theme);
						}
					}
					virtual EarthView::World::Core::MemoryDataStreamPtr getThemeStream()
					{
						...
						{
							return this->CVectorDBClampSceneLayer::getThemeStream();
						}
					}
					virtual ev_bool equalThemeStream(EarthView::World::Core::MemoryDataStreamPtr stream)
					{
						...
						{
							return this->CVectorDBClampSceneLayer::equalThemeStream(stream);
						}
					}
					virtual ev_uint8 getTransparentValue() const
					{
						...
						{
							return this->CVectorDBClampSceneLayer::getTransparentValue();
						}
					}
					virtual void setTransparentValue(ev_uint8 transparent)
					{
						...
						{
							return this->CVectorDBClampSceneLayer::setTransparentValue(transparent);
						}
					}
					virtual void setSelectable(ev_bool selectable)
					{
						...
						{
							return this->CVectorDBClampSceneLayer::setSelectable(selectable);
						}
					}
					virtual void select(EarthView::World::Spatial::GeoDataset::IQueryFilter* filter, EarthView::World::Spatial::Atlas::EVSelectionResultType type)
					{
						...
						{
							return this->CVectorDBClampSceneLayer::select(filter, type);
						}
					}
					virtual EarthView::World::Spatial::Atlas::ILayerSelection* getLayerSelection()
					{
						...
						{
							return this->CVectorDBClampSceneLayer::getLayerSelection();
						}
					}
					virtual void clearSelection()
					{
						...
						{
							return this->CVectorDBClampSceneLayer::clearSelection();
						}
					}
					virtual EarthView::World::Spatial::Atlas::ILayer* clone() const
					{
						...
						{
							return this->CVectorDBClampSceneLayer::clone();
						}
					}
					virtual EarthView::World::Core::CXmlElement toXmlElement() const
					{
						...
						{
							return this->CVectorDBClampSceneLayer::toXmlElement();
						}
					}
					virtual void _notifyLayerAdd(EarthView::World::Graphic::CSceneManager* pSceneMgr)
					{
						...
						{
							return this->CVectorDBClampSceneLayer::_notifyLayerAdd(pSceneMgr);
						}
					}
					virtual void _notifyLayerRemoved(EarthView::World::Graphic::CSceneManager* pSceneMgr)
					{
						...
						{
							return this->CVectorDBClampSceneLayer::_notifyLayerRemoved(pSceneMgr);
						}
					}
					virtual void _notifyRefreshed(const EarthView::World::Graphic::CCamera* camera, EarthView::World::Spatial3D::Atlas::LayerRefreshFactor updateType)
					{
						...
						{
							return this->CVectorDBClampSceneLayer::_notifyRefreshed(camera, updateType);
						}
					}
					virtual void _notifyDataChanged(const EVString& strDataSourceName, const EVString& strDatasetName, EarthView::World::Core::CEvent* pEvent)
					{
						...
						{
							return this->CVectorDBClampSceneLayer::_notifyDataChanged(strDataSourceName, strDatasetName, pEvent);
						}
					}
					virtual ev_real64 getMaxStaticsThemeVisibleDistance()
					{
						if (this->_gRef != NULL && this->m_getMaxStaticsThemeVisibleDistance_void_callback != "" && this->isCustomExtend())
						{
							EarthView::World::Core::GlobalReference *__gr = (EarthView::World::Core::GlobalReference *)this->getJavaReference();
							JNIEnv * __env;
							#if EV_PLATFORM == EV_PLATFORM_ANDROID
							...
							jobject __obj = __gr->getJObject();
							jclass __clazz = __gr->getClass();
							jmethodID __method = __gr->getMethod("getMaxStaticsThemeVisibleDistance_void_callback");
						...
						{
							return this->CVectorDBClampSceneLayer::getMaxStaticsThemeVisibleDistance();
						}
					}
					virtual void setMaxStaticsThemeVisibleDistance(ev_real64 dis)
					{
						if (this->_gRef != NULL && this->m_setMaxStaticsThemeVisibleDistance_ev_real64_callback != "" && this->isCustomExtend())
						{
							EarthView::World::Core::GlobalReference *__gr = (EarthView::World::Core::GlobalReference *)this->getJavaReference();
							JNIEnv * __env;
							#if EV_PLATFORM == EV_PLATFORM_ANDROID
							...
							jmethodID __method = __gr->getMethod("setMaxStaticsThemeVisibleDistance_ev_real64_callback");
						...
						{
							return this->CVectorDBClampSceneLayer::setMaxStaticsThemeVisibleDistance(dis);
						}
					}
					virtual void fromXmlElement(EarthView::World::Core::CXmlElement& element)
					{
						...
						{
							return this->CVectorDBClampSceneLayer::fromXmlElement(element);
						}
					}
					virtual const EarthView::World::Spatial::Geometry::IEnvelope* getExtent() const
					{
						...
						{
							return this->CVectorDBClampSceneLayer::getExtent();
						}
					}
					virtual EarthView::World::Spatial::Geometry::ISpatialReference* getSpatialReference() const
					{
						...
						{
							return this->CVectorDBClampSceneLayer::getSpatialReference();
						}
					}
					virtual ev_int32 getMaxLevel() const
					{
						...
						{
							return this->CVectorDBClampSceneLayer::getMaxLevel();
						}
					}
					virtual ev_int32 getMinLevel() const
					{
						...
						{
							return this->CVectorDBClampSceneLayer::getMinLevel();
						}
					}
					virtual ev_real64 getMinX() const
					{
						...
						{
							return this->CVectorDBClampSceneLayer::getMinX();
						}
					}
					virtual ev_real64 getMaxX() const
					{
						...
						{
							return this->CVectorDBClampSceneLayer::getMaxX();
						}
					}
					virtual ev_real64 getMinY() const
					{
						...
						{
							return this->CVectorDBClampSceneLayer::getMinY();
						}
					}
					virtual ev_real64 getMaxY() const
					{
						...
						{
							return this->CVectorDBClampSceneLayer::getMaxY();
						}
					}
					virtual void _notifyTileCreated(ev_uint32 level, ev_uint32 row, ev_uint32 col)
					{
						...
						{
							return this->CVectorDBClampSceneLayer::_notifyTileCreated(level, row, col);
						}
					}
					virtual void _notifyTileDestroyed(ev_uint32 level, ev_uint32 row, ev_uint32 col)
					{
						...
						{
							return this->CVectorDBClampSceneLayer::_notifyTileDestroyed(level, row, col);
						}
					}
					virtual ev_bool levelValid(ev_int32 level) const
					{
						...
						{
							return this->CVectorDBClampSceneLayer::levelValid(level);
						}
					}
					virtual const EarthView::World::Spatial::Geometry::CEnvelope& getGeoExtent() const
					{
						...
						{
							return this->CVectorDBClampSceneLayer::getGeoExtent();
						}
					}
					virtual ev_bool setCurtainExtent(ev_real32 minPX, ev_real32 minPY, ev_real32 maxPX, ev_real32 maxPY)
					{
						...
						{
							return this->CVectorDBClampSceneLayer::setCurtainExtent(minPX, minPY, maxPX, maxPY);
						}
					}
					virtual ev_bool setCurtainAlpha(ev_real32 alpha)
					{
						...
						{
							return this->CVectorDBClampSceneLayer::setCurtainAlpha(alpha);
						}
					}
					virtual ev_bool getCurtainExtent(ev_real32& minPX, ev_real32& minPY, ev_real32& maxPX, ev_real32& maxPY)
					{
						...
						{
							return this->CVectorDBClampSceneLayer::getCurtainExtent(minPX, minPY, maxPX, maxPY);
						}
					}
					virtual ev_bool getCurtainEnabled() const
					{
						...
						{
							return this->CVectorDBClampSceneLayer::getCurtainEnabled();
						}
					}
					virtual ev_bool setCurtainEnabled(ev_bool enabled)
					{
						...
						{
							return this->CVectorDBClampSceneLayer::setCurtainEnabled(enabled);
						}
					}
					virtual ev_bool getCurtainAlpha(ev_real32& alpha)
					{
						...
						{
							return this->CVectorDBClampSceneLayer::getCurtainAlpha(alpha);
						}
					}
					virtual EarthView::World::Spatial3D::Atlas::ClampMode getClampMode() const
					{
						...
						{
							return this->CVectorDBClampSceneLayer::getClampMode();
						}
					}
					virtual void setClampMode(EarthView::World::Spatial3D::Atlas::ClampMode mode)
					{
						...
						{
							return this->CVectorDBClampSceneLayer::setClampMode(mode);
						}
					}
					virtual void detachLayer()
					{
						...
						{
							return this->CVectorDBClampSceneLayer::detachLayer();
						}
					}
					virtual EarthView::World::Spatial::Atlas::ILayer* getLayer() const
					{
						...
						{
							return this->CVectorDBClampSceneLayer::getLayer();
						}
					}
					virtual EVString toXML() const
					{
						...
						{
							return this->CVectorDBClampSceneLayer::toXML();
						}
					}
					virtual EVString getSceneName() const
					{
						...
						{
							return this->CVectorDBClampSceneLayer::getSceneName();
						}
					}
					virtual EVString getName() const
					{
						...
						{
							return this->CVectorDBClampSceneLayer::getName();
						}
					}
					virtual void setName(const EVString& name)
					{
						...
						{
							return this->CVectorDBClampSceneLayer::setName(name);
						}
					}
					virtual EVString getDescription() const
					{
						...
						{
							return this->CVectorDBClampSceneLayer::getDescription();
						}
					}
					virtual void setDescription(const EVString& value)
					{
						...
						{
							return this->CVectorDBClampSceneLayer::setDescription(value);
						}
					}
					virtual ev_bool canEdit() const
					{
						...
						{
							return this->CVectorDBClampSceneLayer::canEdit();
						}
					}
					virtual void setCanEdit(ev_bool can)
					{
						...
						{
							return this->CVectorDBClampSceneLayer::setCanEdit(can);
						}
					}
					virtual ev_bool isEditing() const
					{
						...
						{
							return this->CVectorDBClampSceneLayer::isEditing();
						}
					}
					virtual void setEditing(ev_bool editing)
					{
						...
						{
							return this->CVectorDBClampSceneLayer::setEditing(editing);
						}
					}
					virtual ev_bool isVisible() const
					{
						...
						{
							return this->CVectorDBClampSceneLayer::isVisible();
						}
					}
					virtual ev_bool isValid() const
					{
						...
						{
							return this->CVectorDBClampSceneLayer::isValid();
						}
					}
					virtual ev_bool isSelectable() const
					{
						...
						{
							return this->CVectorDBClampSceneLayer::isSelectable();
						}
					}
					virtual ev_bool getHeightAt(ev_real32 lat, ev_real32 lon, ev_real32 targetSamplesPerDegrees, ev_real32& height)
					{
						...
						{
							return this->CVectorDBClampSceneLayer::getHeightAt(lat, lon, targetSamplesPerDegrees, height);
						}
					}
					virtual EarthView::World::Graphic::CSceneManager* getSceneManager() const
					{
						...
						{
							return this->CVectorDBClampSceneLayer::getSceneManager();
						}
					}
					virtual void toStream(EarthView::World::Core::CDataStream& stream) const
					{
						...
						{
							return this->CVectorDBClampSceneLayer::toStream(stream);
						}
					}
					virtual void fromStream(EarthView::World::Core::CDataStream& stream)
					{
						...
						{
							return this->CVectorDBClampSceneLayer::fromStream(stream);
						}
					}
					virtual EVString getDatasetName()
					{
						...
						{
							return this->CVectorDBClampSceneLayer::getDatasetName();
						}
					}
					virtual EarthView::World::Spatial::GeoDataset::IDataSource* getDataSource()
					{
						...
						{
							return this->CVectorDBClampSceneLayer::getDataSource();
						}
					}
					virtual void setLayerSelection(EarthView::World::Spatial::Atlas::ILayerSelection* selection)
					{
						...
						{
							return this->CVectorDBClampSceneLayer::setLayerSelection(selection);
						}
					}
					virtual ev_bool ignoreScale() const
					{
						...
						{
							return this->CVectorDBClampSceneLayer::ignoreScale();
						}
					}
					virtual void setIgnoreScale(ev_bool bIgnore)
					{
						...
						{
							return this->CVectorDBClampSceneLayer::setIgnoreScale(bIgnore);
						}
					}
					virtual ev_real64 getDisplayMaxScale() const
					{
						...
						{
							return this->CVectorDBClampSceneLayer::getDisplayMaxScale();
						}
					}
					virtual void setDisplayMaxScale(ev_real64 scale)
					{
						...
						{
							return this->CVectorDBClampSceneLayer::setDisplayMaxScale(scale);
						}
					}
					virtual ev_real64 getDisplayMinScale() const
					{
						...
						{
							return this->CVectorDBClampSceneLayer::getDisplayMinScale();
						}
					}
					virtual void setDisplayMinScale(ev_real64 scale)
					{
						...
						{
							return this->CVectorDBClampSceneLayer::setDisplayMinScale(scale);
						}
					}
					virtual void setSpatialReference(EarthView::World::Spatial::Geometry::ISpatialReference* ref_sr)
					{
						...
						{
							return this->CVectorDBClampSceneLayer::setSpatialReference(ref_sr);
						}
					}
					virtual ev_bool draw(EarthView::World::Spatial::Display::ISpatialDisplay* display, EarthView::World::Spatial::Atlas::EVVectorLayerRendererType type)
					{
						...
						{
							return this->CVectorDBClampSceneLayer::draw(display, type);
						}
					}
				};
				REGISTER_FACTORY_CLASS(JCVectorDBClampSceneLayerProxy);
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_attachLayer_1ILayer(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong layer_j)
				{
					EarthView::World::Spatial::Atlas::ILayer *layer = (EarthView::World::Spatial::Atlas::ILayer*) layer_j;
					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorDBClampSceneLayerProxy))
					{
						pObjectX->EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer::attachLayer(layer);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1attachLayer_1ILayer(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_attachLayer_1ILayer_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong layer_j)
				{
					EarthView::World::Spatial::Atlas::ILayer *layer = (EarthView::World::Spatial::Atlas::ILayer*) layer_j;
					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
					pObjectX->EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer::attachLayer(layer);
				}
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_getType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorDBClampSceneLayerProxy))
					{
						EarthView::World::Spatial::Atlas::EVLayerType __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer::getType();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1getType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_getType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
					EarthView::World::Spatial::Atlas::EVLayerType __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer::getType();
					jint __values1_j = (jint) __values1;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_getGeometryType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorDBClampSceneLayerProxy))
					{
						EarthView::World::Spatial::Geometry::EVGeometryType __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer::getGeometryType();
						jint __values1_j = (jint) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1getGeometryType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_getGeometryType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
					EarthView::World::Spatial::Geometry::EVGeometryType __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer::getGeometryType();
					jint __values1_j = (jint) __values1;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_getTile_1ev_1int32_1ev_1int32_1ev_1int32_1CTileData(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint level_j, jint row_j, jint col_j, jlong tile_j)
				{
					...
					if (typeid(*pObjectX) == typeid(JCVectorDBClampSceneLayerProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer::getTile(level, row, col, tile);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1getTile_1ev_1int32_1ev_1int32_1ev_1int32_1CTileData(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_getTile_1ev_1int32_1ev_1int32_1ev_1int32_1CTileData_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint level_j, jint row_j, jint col_j, jlong tile_j)
				{
					ev_int32 level = (ev_int32) level_j;
					ev_int32 row = (ev_int32) row_j;
					ev_int32 col = (ev_int32) col_j;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_getTile_1Real_1Real_1Real_1Real_1CTileData(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble minX_j, jdouble minY_j, jdouble maxX_j, jdouble maxY_j, jlong tile_j)
				{
					...
					if (typeid(*pObjectX) == typeid(JCVectorDBClampSceneLayerProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer::getTile(minX, minY, maxX, maxY, tile);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1getTile_1Real_1Real_1Real_1Real_1CTileData(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_getTile_1Real_1Real_1Real_1Real_1CTileData_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble minX_j, jdouble minY_j, jdouble maxX_j, jdouble maxY_j, jlong tile_j)
				{
					Real minX = (Real) minX_j;
					Real minY = (Real) minY_j;
					Real maxX = (Real) maxX_j;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_setVisible_1ev_1bool(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean visible_j)
				{
					ev_bool visible = (ev_bool) visible_j;
					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorDBClampSceneLayerProxy))
					{
						pObjectX->EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer::setVisible(visible);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1setVisible_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_setVisible_1ev_1bool_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean visible_j)
				{
					ev_bool visible = (ev_bool) visible_j;
					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
					pObjectX->EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer::setVisible(visible);
				}
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_getDataset_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorDBClampSceneLayerProxy))
					{
						EarthView::World::Spatial::GeoDataset::IDataset* __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer::getDataset();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1getDataset_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_getDataset_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
					EarthView::World::Spatial::GeoDataset::IDataset* __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer::getDataset();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_getMaxVisibleLevel_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorDBClampSceneLayerProxy))
					{
						ev_int32 __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer::getMaxVisibleLevel();
						jint __values1_j = (jint)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1getMaxVisibleLevel_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_getMaxVisibleLevel_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
					ev_int32 __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer::getMaxVisibleLevel();
					jint __values1_j = (jint)__values1;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_getMinVisibleLevel_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorDBClampSceneLayerProxy))
					{
						ev_int32 __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer::getMinVisibleLevel();
						jint __values1_j = (jint)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1getMinVisibleLevel_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_getMinVisibleLevel_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
					ev_int32 __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer::getMinVisibleLevel();
					jint __values1_j = (jint)__values1;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_setMaxVisibleLevel_1ev_1int32(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint maxlevel_j)
				{
					ev_int32 maxlevel = (ev_int32) maxlevel_j;
					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorDBClampSceneLayerProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer::setMaxVisibleLevel(maxlevel);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1setMaxVisibleLevel_1ev_1int32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_setMaxVisibleLevel_1ev_1int32_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint maxlevel_j)
				{
					ev_int32 maxlevel = (ev_int32) maxlevel_j;
					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
					ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer::setMaxVisibleLevel(maxlevel);
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_setMinVisibleLevel_1ev_1int32(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint minlevel_j)
				{
					ev_int32 minlevel = (ev_int32) minlevel_j;
					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorDBClampSceneLayerProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer::setMinVisibleLevel(minlevel);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1setMinVisibleLevel_1ev_1int32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_setMinVisibleLevel_1ev_1int32_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint minlevel_j)
				{
					ev_int32 minlevel = (ev_int32) minlevel_j;
					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
					ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer::setMinVisibleLevel(minlevel);
				...
				extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_getMaxLabelVisibleDistance_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
					ev_real64 __values1 = pObjectX->getMaxLabelVisibleDistance();
					jdouble __values1_j = (jdouble)__values1;
					return __values1_j;
				}
				extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_getSuggestMaxLabelVisibleDistance_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
					ev_real64 __values1 = pObjectX->getSuggestMaxLabelVisibleDistance();
					jdouble __values1_j = (jdouble)__values1;
					return __values1_j;
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_setMaxLabelVisibleDistance_1ev_1real64(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble dis_j)
				{
					ev_real64 dis = (ev_real64) dis_j;
					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
					pObjectX->setMaxLabelVisibleDistance(dis);
				}
				extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_getMinLabelVisibleDistance_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
					ev_real64 __values1 = pObjectX->getMinLabelVisibleDistance();
					jdouble __values1_j = (jdouble)__values1;
					return __values1_j;
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_setMinLabelVisibleDistance_1ev_1real64(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble dis_j)
				{
					ev_real64 dis = (ev_real64) dis_j;
					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
					pObjectX->setMinLabelVisibleDistance(dis);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_setLabelProjOffsetMaxAngle_1Real(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble angle_j)
				{
					Real angle = (Real) angle_j;
					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
					pObjectX->setLabelProjOffsetMaxAngle(angle);
				}
				extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_getLabelProjOffsetMaxAngle_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_getLabelVisible_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
					ev_bool __values1 = pObjectX->getLabelVisible();
					jboolean __values1_j = (jboolean)__values1;
					return __values1_j;
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_setLabelVisible_1ev_1bool(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean vis_j)
				{
					ev_bool vis = (ev_bool) vis_j;
					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
					pObjectX->setLabelVisible(vis);
				}
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_getTheme_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorDBClampSceneLayerProxy))
					{
						EarthView::World::Spatial::Theme::ITheme* __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer::getTheme();
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1getTheme_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_getTheme_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
					EarthView::World::Spatial::Theme::ITheme* __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer::getTheme();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_setTheme_1ITheme(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong theme_j)
				{
					const EarthView::World::Spatial::Theme::ITheme *theme = (const EarthView::World::Spatial::Theme::ITheme*) theme_j;
					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorDBClampSceneLayerProxy))
					{
						pObjectX->EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer::setTheme(theme);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1setTheme_1ITheme(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_setTheme_1ITheme_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong theme_j)
				{
					const EarthView::World::Spatial::Theme::ITheme *theme = (const EarthView::World::Spatial::Theme::ITheme*) theme_j;
					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
					pObjectX->EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer::setTheme(theme);
				}
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_getThemeStream_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorDBClampSceneLayerProxy))
					{
						EarthView::World::Core::MemoryDataStreamPtr __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer::getThemeStream();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1getThemeStream_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_getThemeStream_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
					EarthView::World::Core::MemoryDataStreamPtr __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer::getThemeStream();
					EarthView::World::Core::MemoryDataStreamPtr *returnvalues = new EarthView::World::Core::MemoryDataStreamPtr(__values1);
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_equalThemeStream_1MemoryDataStreamPtr(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong stream_j)
				{
					EarthView::World::Core::MemoryDataStreamPtr stream = *(EarthView::World::Core::MemoryDataStreamPtr*) stream_j;
					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorDBClampSceneLayerProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer::equalThemeStream(stream);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1equalThemeStream_1MemoryDataStreamPtr(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_equalThemeStream_1MemoryDataStreamPtr_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong stream_j)
				{
					EarthView::World::Core::MemoryDataStreamPtr stream = *(EarthView::World::Core::MemoryDataStreamPtr*) stream_j;
					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
					ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer::equalThemeStream(stream);
				...
				extern "C" JNIEXPORT jshort JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_getTransparentValue_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorDBClampSceneLayerProxy))
					{
						ev_uint8 __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer::getTransparentValue();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1getTransparentValue_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jshort JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_getTransparentValue_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
					ev_uint8 __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer::getTransparentValue();
					jshort __values1_j = (jshort) __values1;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_setTransparentValue_1ev_1uint8(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jshort transparent_j)
				{
					ev_uint8 transparent = (ev_uint8) transparent_j;
					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorDBClampSceneLayerProxy))
					{
						pObjectX->EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer::setTransparentValue(transparent);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1setTransparentValue_1ev_1uint8(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_setTransparentValue_1ev_1uint8_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jshort transparent_j)
				{
					ev_uint8 transparent = (ev_uint8) transparent_j;
					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
					pObjectX->EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer::setTransparentValue(transparent);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_setSelectable_1ev_1bool(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean selectable_j)
				{
					ev_bool selectable = (ev_bool) selectable_j;
					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorDBClampSceneLayerProxy))
					{
						pObjectX->EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer::setSelectable(selectable);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1setSelectable_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_setSelectable_1ev_1bool_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean selectable_j)
				{
					ev_bool selectable = (ev_bool) selectable_j;
					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
					pObjectX->EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer::setSelectable(selectable);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_select_1IQueryFilter_1EVSelectionResultType(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong filter_j, jint type_j)
				{
					...
					if (typeid(*pObjectX) == typeid(JCVectorDBClampSceneLayerProxy))
					{
						pObjectX->EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer::select(filter, type);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1select_1IQueryFilter_1EVSelectionResultType(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_select_1IQueryFilter_1EVSelectionResultType_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong filter_j, jint type_j)
				{
					EarthView::World::Spatial::GeoDataset::IQueryFilter *filter = (EarthView::World::Spatial::GeoDataset::IQueryFilter*) filter_j;
					EarthView::World::Spatial::Atlas::EVSelectionResultType type = (EarthView::World::Spatial::Atlas::EVSelectionResultType) type_j;
					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_getLayerSelection_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorDBClampSceneLayerProxy))
					{
						EarthView::World::Spatial::Atlas::ILayerSelection* __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer::getLayerSelection();
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1getLayerSelection_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_getLayerSelection_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
					EarthView::World::Spatial::Atlas::ILayerSelection* __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer::getLayerSelection();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_clearSelection_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorDBClampSceneLayerProxy))
					{
						pObjectX->EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer::clearSelection();
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1clearSelection_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_clearSelection_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
					pObjectX->EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer::clearSelection();
				}
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_getFeatureSelection_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
					EarthView::World::Spatial::GeoDataset::IFeatureSelection* __values1 = pObjectX->getFeatureSelection();
					jlong __values1_j = (jlong) __values1;
					return __values1_j;
				}
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_getSelectionSymbol_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_setSelectionSymbol_1ISymbol(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong symbol_j)
				{
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_ev_1clone_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorDBClampSceneLayerProxy))
					{
						EarthView::World::Spatial::Atlas::ILayer* __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer::clone();
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1ev_1clone_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_ev_1clone_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
					EarthView::World::Spatial::Atlas::ILayer* __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer::clone();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_toXmlElement_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorDBClampSceneLayerProxy))
					{
						EarthView::World::Core::CXmlElement __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer::toXmlElement();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1toXmlElement_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_toXmlElement_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
					EarthView::World::Core::CXmlElement __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer::toXmlElement();
					EarthView::World::Core::CXmlElement *returnvalues = new EarthView::World::Core::CXmlElement(__values1);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer__1notifyLayerAdd_1CSceneManager(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong pSceneMgr_j)
				{
					EarthView::World::Graphic::CSceneManager *pSceneMgr = (EarthView::World::Graphic::CSceneManager*) pSceneMgr_j;
					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorDBClampSceneLayerProxy))
					{
						pObjectX->EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer::_notifyLayerAdd(pSceneMgr);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1_1notifyLayerAdd_1CSceneManager(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer__1notifyLayerAdd_1CSceneManager_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong pSceneMgr_j)
				{
					EarthView::World::Graphic::CSceneManager *pSceneMgr = (EarthView::World::Graphic::CSceneManager*) pSceneMgr_j;
					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
					pObjectX->EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer::_notifyLayerAdd(pSceneMgr);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer__1notifyLayerRemoved_1CSceneManager(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong pSceneMgr_j)
				{
					EarthView::World::Graphic::CSceneManager *pSceneMgr = (EarthView::World::Graphic::CSceneManager*) pSceneMgr_j;
					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorDBClampSceneLayerProxy))
					{
						pObjectX->EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer::_notifyLayerRemoved(pSceneMgr);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1_1notifyLayerRemoved_1CSceneManager(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer__1notifyLayerRemoved_1CSceneManager_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong pSceneMgr_j)
				{
					EarthView::World::Graphic::CSceneManager *pSceneMgr = (EarthView::World::Graphic::CSceneManager*) pSceneMgr_j;
					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
					pObjectX->EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer::_notifyLayerRemoved(pSceneMgr);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer__1notifyRefreshed_1CCamera_1LayerRefreshFactor(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong camera_j, jint updateType_j)
				{
					...
					if (typeid(*pObjectX) == typeid(JCVectorDBClampSceneLayerProxy))
					{
						pObjectX->EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer::_notifyRefreshed(camera, updateType);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1_1notifyRefreshed_1CCamera_1LayerRefreshFactor(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer__1notifyRefreshed_1CCamera_1LayerRefreshFactor_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong camera_j, jint updateType_j)
				{
					const EarthView::World::Graphic::CCamera *camera = (const EarthView::World::Graphic::CCamera*) camera_j;
					EarthView::World::Spatial3D::Atlas::LayerRefreshFactor updateType = (EarthView::World::Spatial3D::Atlas::LayerRefreshFactor) updateType_j;
					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer__1notifyDataChanged_1EVString_1EVString_1CEvent(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring strDataSourceName_j, jstring strDatasetName_j, jlong pEvent_j)
				{
					#if EV_PLATFORM == EV_PLATFORM_ANDROID
					...
					if (typeid(*pObjectX) == typeid(JCVectorDBClampSceneLayerProxy))
					{
						pObjectX->EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer::_notifyDataChanged(strDataSourceName, strDatasetName, pEvent);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1_1notifyDataChanged_1EVString_1EVString_1CEvent(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer__1notifyDataChanged_1EVString_1EVString_1CEvent_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring strDataSourceName_j, jstring strDatasetName_j, jlong pEvent_j)
				{
					#if EV_PLATFORM == EV_PLATFORM_ANDROID
					const ev_char* strDataSourceName_ch = (const ev_char*)__env->GetStringUTFChars(strDataSourceName_j,JNI_FALSE);
					const EVString strDataSourceName = strDataSourceName_ch;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_updateTextStyle_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
					pObjectX->updateTextStyle();
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_updateStaticsThemeLabel_1ev_1bool_1ev_1bool(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean updateTextStyle_j, jboolean reCreate_j)
				{
					ev_bool updateTextStyle = (ev_bool) updateTextStyle_j;
					ev_bool reCreate = (ev_bool) reCreate_j;
					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
					pObjectX->updateStaticsThemeLabel(updateTextStyle, reCreate);
				}
				extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_getMaxStaticsThemeVisibleDistance_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorDBClampSceneLayerProxy))
					{
						ev_real64 __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer::getMaxStaticsThemeVisibleDistance();
						jdouble __values1_j = (jdouble)__values1;
						return __values1_j;
					}
					else
					{
						ev_real64 __values1 = pObjectX->getMaxStaticsThemeVisibleDistance();
						jdouble __values1_j = (jdouble)__values1;
						return __values1_j;
					}
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1getMaxStaticsThemeVisibleDistance_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
					__env->ReleaseStringUTFChars(__method, pMethod);
					pObjectX->register_getMaxStaticsThemeVisibleDistance_void_callback(sMethod);
					if (pObjectX->getJavaReference() != NULL && sMethod != "")
					{
						EarthView::World::Core::GlobalReference *__gr = (EarthView::World::Core::GlobalReference *)pObjectX->getJavaReference();
						jobject __obj1 = __gr->getJObject();
						jclass __clazz1 = __env->GetObjectClass(__obj1);
						jmethodID __method = __env->GetMethodID(__clazz1,"getMaxStaticsThemeVisibleDistance_void_callback", "()D");
						__gr->setMethod(sMethod, __method);
					}
				}
				extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_getMaxStaticsThemeVisibleDistance_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
					ev_real64 __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer::getMaxStaticsThemeVisibleDistance();
					jdouble __values1_j = (jdouble)__values1;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_setMaxStaticsThemeVisibleDistance_1ev_1real64(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble dis_j)
				{
					ev_real64 dis = (ev_real64) dis_j;
					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorDBClampSceneLayerProxy))
					{
						pObjectX->EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer::setMaxStaticsThemeVisibleDistance(dis);
					}
					else
					{
						pObjectX->setMaxStaticsThemeVisibleDistance(dis);
					}
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1setMaxStaticsThemeVisibleDistance_1ev_1real64(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
					__env->ReleaseStringUTFChars(__method, pMethod);
					pObjectX->register_setMaxStaticsThemeVisibleDistance_ev_real64_callback(sMethod);
					if (pObjectX->getJavaReference() != NULL && sMethod != "")
					{
						EarthView::World::Core::GlobalReference *__gr = (EarthView::World::Core::GlobalReference *)pObjectX->getJavaReference();
						jobject __obj1 = __gr->getJObject();
						jclass __clazz1 = __env->GetObjectClass(__obj1);
						jmethodID __method = __env->GetMethodID(__clazz1,"setMaxStaticsThemeVisibleDistance_ev_real64_callback", "(D)V");
						__gr->setMethod(sMethod, __method);
					}
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_setMaxStaticsThemeVisibleDistance_1ev_1real64_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble dis_j)
				{
					ev_real64 dis = (ev_real64) dis_j;
					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
					pObjectX->EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer::setMaxStaticsThemeVisibleDistance(dis);
				}
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_getLabelProperty_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
					EarthView::World::Spatial::Display::ILabelProperty* __values1 = pObjectX->getLabelProperty();
					jlong __values1_j = (jlong) __values1;
					return __values1_j;
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_setLabelProperty_1ILabelProperty(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong labelproperty_j)
				{
					const EarthView::World::Spatial::Display::ILabelProperty *labelproperty = (const EarthView::World::Spatial::Display::ILabelProperty*) labelproperty_j;
					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
					pObjectX->setLabelProperty(labelproperty);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_fromXmlElement_1CXmlElement(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong element_j)
				{
					EarthView::World::Core::CXmlElement &element = *(EarthView::World::Core::CXmlElement*) element_j;
					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorDBClampSceneLayerProxy))
					{
						pObjectX->EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer::fromXmlElement(element);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1fromXmlElement_1CXmlElement(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_fromXmlElement_1CXmlElement_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong element_j)
				{
					EarthView::World::Core::CXmlElement &element = *(EarthView::World::Core::CXmlElement*) element_j;
					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
					pObjectX->EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer::fromXmlElement(element);
				}
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_setDisplayFilter_1ev_1bool_1IntVector(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean visible_j, jlong ids_j)
				{
					ev_bool visible = (ev_bool) visible_j;
					EarthView::World::Core::IntVector ids = *(EarthView::World::Core::IntVector*) ids_j;
					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
					ev_bool __values1 = pObjectX->setDisplayFilter(visible, ids);
					jboolean __values1_j = (jboolean)__values1;
					return __values1_j;
				}
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_getDisplayFilter_1ev_1bool_1IntVector(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong visible_j, jlong ids_j)
				{
					ev_bool &visible = *(ev_bool*) visible_j;
					EarthView::World::Core::IntVector &ids = *(EarthView::World::Core::IntVector*) ids_j;
					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
					ev_bool __values1 = pObjectX->getDisplayFilter(visible, ids);
					jboolean __values1_j = (jboolean)__values1;
					return __values1_j;
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_setDisplayFilter_1EVString(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring filter_j)
				{
					#if EV_PLATFORM == EV_PLATFORM_ANDROID
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_getDisplayFilter_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_updateStringInterface_1ev_1uint32(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong id_j)
				{
					ev_uint32 id = (ev_uint32) id_j;
					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
					EarthView::World::Spatial3D::Atlas::CSelectedGeometryStringInterface* __values1 = pObjectX->updateStringInterface(id);
					jlong __values1_j = (jlong) __values1;
					return __values1_j;
				}
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_getExtent_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorDBClampSceneLayerProxy))
					{
						const EarthView::World::Spatial::Geometry::IEnvelope* __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer::getExtent();
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1getExtent_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_getExtent_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
					const EarthView::World::Spatial::Geometry::IEnvelope* __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer::getExtent();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_getSpatialReference_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorDBClampSceneLayerProxy))
					{
						EarthView::World::Spatial::Geometry::ISpatialReference* __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer::getSpatialReference();
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1getSpatialReference_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_getSpatialReference_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer*) pObjXXXX;
					EarthView::World::Spatial::Geometry::ISpatialReference* __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayer::getSpatialReference();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1getTile_1CTileInfo_1CTileData(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1getMaxLevel_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1getMinLevel_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1_1notifyTileCreated_1ev_1uint32_1ev_1uint32_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1_1notifyTileDestroyed_1ev_1uint32_1ev_1uint32_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1levelValid_1ev_1int32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1getGeoExtent_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1setCurtainExtent_1ev_1real32_1ev_1real32_1ev_1real32_1ev_1real32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1setCurtainAlpha_1ev_1real32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1getCurtainExtent_1ev_1real32_1ev_1real32_1ev_1real32_1ev_1real32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1getCurtainEnabled_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1setCurtainEnabled_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1getCurtainAlpha_1ev_1real32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1getClampMode_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1setClampMode_1ClampMode(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1detachLayer_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1getLayer_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1getSceneName_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1getMinX_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1getMaxX_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1getMinY_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1getMaxY_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1getHeightAt_1ev_1real32_1ev_1real32_1ev_1real32_1ev_1real32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1_1notifyRefreshed_1CCamera(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1getSceneManager_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1getDatasetName_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1getDataSource_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1setLayerSelection_1ILayerSelection(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1getName_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1setName_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1getDescription_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1setDescription_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1canEdit_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1setCanEdit_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1isEditing_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1setEditing_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1isVisible_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1isValid_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1isSelectable_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1ignoreScale_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1setIgnoreScale_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1getDisplayMaxScale_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1setDisplayMaxScale_1ev_1real64(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1getDisplayMinScale_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1setDisplayMinScale_1ev_1real64(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1setSpatialReference_1ISpatialReference(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1draw_1ISpatialDisplay_1EVVectorLayerRendererType(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1toStream_1CDataStream(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1toXML_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayer_register_1fromStream_1CDataStream(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerProxy *pObjectX = (JCVectorDBClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				class JCVectorDBClampSceneLayerFactoryProxy : public EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayerFactory
				{
				 private:
					EarthView::World::Core::ev_string m_getType_void_callback;
				...
				public:
					JCVectorDBClampSceneLayerFactoryProxy(EarthView::World::Core::CNameValuePairList *pList) : CVectorDBClampSceneLayerFactory(pList)
					{
					}
					ev_void unRegisterJavaReference()
					{
				...
				public:
					...
					virtual EarthView::World::Spatial::Atlas::EVLayerType getType() const
					{
						...
						{
							return this->CVectorDBClampSceneLayerFactory::getType();
						}
					}
					virtual EarthView::World::Spatial::Atlas::ILayer* createInstance(EarthView::World::Core::CXmlElement& element)
					{
						...
						{
							return this->CVectorDBClampSceneLayerFactory::createInstance(element);
						}
					}
					virtual EarthView::World::Spatial::Atlas::ILayer* createInstance()
					{
						...
						{
							return this->CVectorDBClampSceneLayerFactory::createInstance();
						}
					}
					virtual ev_bool destroyInstance(EarthView::World::Spatial::Atlas::ILayer* layer)
					{
						...
						{
							return this->CVectorDBClampSceneLayerFactory::destroyInstance(layer);
						}
					}
				};
				REGISTER_FACTORY_CLASS(JCVectorDBClampSceneLayerFactoryProxy);
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayerFactory_getType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayerFactory *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayerFactory*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorDBClampSceneLayerFactoryProxy))
					{
						EarthView::World::Spatial::Atlas::EVLayerType __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayerFactory::getType();
						jint __values1_j = (jint) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayerFactory_register_1getType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerFactoryProxy *pObjectX = (JCVectorDBClampSceneLayerFactoryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
					__env->ReleaseStringUTFChars(__method, pMethod);
					pObjectX->register_getType_void_callback(sMethod);
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayerFactory_getType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayerFactory *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayerFactory*) pObjXXXX;
					EarthView::World::Spatial::Atlas::EVLayerType __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayerFactory::getType();
					jint __values1_j = (jint) __values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayerFactory_createInstance_1CXmlElement(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong element_j)
				{
					EarthView::World::Core::CXmlElement &element = *(EarthView::World::Core::CXmlElement*) element_j;
					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayerFactory *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayerFactory*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorDBClampSceneLayerFactoryProxy))
					{
						EarthView::World::Spatial::Atlas::ILayer* __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayerFactory::createInstance(element);
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayerFactory_register_1createInstance_1CXmlElement(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerFactoryProxy *pObjectX = (JCVectorDBClampSceneLayerFactoryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayerFactory_createInstance_1CXmlElement_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong element_j)
				{
					EarthView::World::Core::CXmlElement &element = *(EarthView::World::Core::CXmlElement*) element_j;
					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayerFactory *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayerFactory*) pObjXXXX;
					EarthView::World::Spatial::Atlas::ILayer* __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayerFactory::createInstance(element);
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayerFactory_createInstance_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayerFactory *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayerFactory*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorDBClampSceneLayerFactoryProxy))
					{
						EarthView::World::Spatial::Atlas::ILayer* __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayerFactory::createInstance();
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayerFactory_register_1createInstance_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerFactoryProxy *pObjectX = (JCVectorDBClampSceneLayerFactoryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayerFactory_createInstance_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayerFactory *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayerFactory*) pObjXXXX;
					EarthView::World::Spatial::Atlas::ILayer* __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayerFactory::createInstance();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayerFactory_destroyInstance_1ILayer(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong layer_j)
				{
					EarthView::World::Spatial::Atlas::ILayer *layer = (EarthView::World::Spatial::Atlas::ILayer*) layer_j;
					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayerFactory *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayerFactory*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorDBClampSceneLayerFactoryProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayerFactory::destroyInstance(layer);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayerFactory_register_1destroyInstance_1ILayer(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerFactoryProxy *pObjectX = (JCVectorDBClampSceneLayerFactoryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayerFactory_destroyInstance_1ILayer_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong layer_j)
				{
					EarthView::World::Spatial::Atlas::ILayer *layer = (EarthView::World::Spatial::Atlas::ILayer*) layer_j;
					EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayerFactory *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayerFactory*) pObjXXXX;
					ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayerFactory::destroyInstance(layer);
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayerFactory_get_1msSceneLayerFactoryName_1void(JNIEnv *__env, jclass __clazz)
				{
					EarthView::World::Core::ev_wstring __values1_ch = EarthView::World::Spatial3D::Atlas::CVectorDBClampSceneLayerFactory::msSceneLayerFactoryName;
					jstring __values1_j = __env->NewString((const jchar*)__values1_ch.getString(), __values1_ch.size());
					return __values1_j;
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorDBClampSceneLayerFactory_register_1createInstance_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorDBClampSceneLayerFactoryProxy *pObjectX = (JCVectorDBClampSceneLayerFactoryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
