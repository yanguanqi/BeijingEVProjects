...
namespace EarthView
{
	namespace World
	{
		namespace Spatial3D
		{
			namespace Atlas
			{
				class JCOGCWFSVectorRelativeSceneLayerProxy : public EarthView::World::Spatial3D::Atlas::COGCWFSVectorRelativeSceneLayer
				{
				 private:
					EarthView::World::Core::ev_string m_setLabelVisibleDistance_ev_real64_callback;
					EarthView::World::Core::ev_string m_getVisibleDistinction_void_callback;
					EarthView::World::Core::ev_string m_setVisibleDistinction_ev_real32_callback;
					EarthView::World::Core::ev_string m_getVisibleOctreeDistance_void_callback;
					EarthView::World::Core::ev_string m_setVisibleOctreeDistance_ev_real32_callback;
				...
				public:
					JCOGCWFSVectorRelativeSceneLayerProxy(EarthView::World::Core::CNameValuePairList *pList) : COGCWFSVectorRelativeSceneLayer(pList)
					{
					}
				...
				public:
					...
					void register_getVisibleDistinction_void_callback(EarthView::World::Core::ev_string __method)
					{
						this->m_getVisibleDistinction_void_callback = __method;
					}
					void register_setVisibleDistinction_ev_real32_callback(EarthView::World::Core::ev_string __method)
					{
						this->m_setVisibleDistinction_ev_real32_callback = __method;
					}
					void register_getVisibleOctreeDistance_void_callback(EarthView::World::Core::ev_string __method)
					{
						this->m_getVisibleOctreeDistance_void_callback = __method;
					}
					void register_setVisibleOctreeDistance_ev_real32_callback(EarthView::World::Core::ev_string __method)
					{
						this->m_setVisibleOctreeDistance_ev_real32_callback = __method;
					}
					...
					{
						if (this->_gRef != NULL && this->m_getVisibleDistinction_void_callback != "" && this->isCustomExtend())
						{
							EarthView::World::Core::GlobalReference *__gr = (EarthView::World::Core::GlobalReference *)this->getJavaReference();
							JNIEnv * __env;
							#if EV_PLATFORM == EV_PLATFORM_ANDROID
							...
							jobject __obj = __gr->getJObject();
							jclass __clazz = __gr->getClass();
							jmethodID __method = __gr->getMethod("getVisibleDistinction_void_callback");
					...
					virtual void setVisibleDistinction(ev_real32 dis)
					{
						if (this->_gRef != NULL && this->m_setVisibleDistinction_ev_real32_callback != "" && this->isCustomExtend())
						{
							EarthView::World::Core::GlobalReference *__gr = (EarthView::World::Core::GlobalReference *)this->getJavaReference();
							JNIEnv * __env;
							#if EV_PLATFORM == EV_PLATFORM_ANDROID
							...
							jobject __obj = __gr->getJObject();
							jclass __clazz = __gr->getClass();
							jfloat dis_j = (jfloat) dis;
							jmethodID __method = __gr->getMethod("setVisibleDistinction_ev_real32_callback");
							__env->CallVoidMethod(__obj, __method , dis_j);
							#if EV_PLATFORM == EV_PLATFORM_ANDROID
							if(__jniAttachable)
							{
					...
					{
						if (this->_gRef != NULL && this->m_getVisibleOctreeDistance_void_callback != "" && this->isCustomExtend())
						{
							EarthView::World::Core::GlobalReference *__gr = (EarthView::World::Core::GlobalReference *)this->getJavaReference();
							JNIEnv * __env;
							#if EV_PLATFORM == EV_PLATFORM_ANDROID
							...
							jobject __obj = __gr->getJObject();
							jclass __clazz = __gr->getClass();
							jmethodID __method = __gr->getMethod("getVisibleOctreeDistance_void_callback");
							jfloat __values1_j = (jfloat)__env->CallFloatMethod(__obj, __method );
							#if EV_PLATFORM == EV_PLATFORM_ANDROID
							if(__jniAttachable)
							{
					...
					virtual void setVisibleOctreeDistance(ev_real32 dis)
					{
						if (this->_gRef != NULL && this->m_setVisibleOctreeDistance_ev_real32_callback != "" && this->isCustomExtend())
						{
							EarthView::World::Core::GlobalReference *__gr = (EarthView::World::Core::GlobalReference *)this->getJavaReference();
							JNIEnv * __env;
							#if EV_PLATFORM == EV_PLATFORM_ANDROID
							...
							jclass __clazz = __gr->getClass();
							jfloat dis_j = (jfloat) dis;
							jmethodID __method = __gr->getMethod("setVisibleOctreeDistance_ev_real32_callback");
							__env->CallVoidMethod(__obj, __method , dis_j);
							#if EV_PLATFORM == EV_PLATFORM_ANDROID
							if(__jniAttachable)
							{
				...
				REGISTER_FACTORY_CLASS(JCOGCWFSVectorRelativeSceneLayerProxy);
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_toXmlElement_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::COGCWFSVectorRelativeSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::COGCWFSVectorRelativeSceneLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCOGCWFSVectorRelativeSceneLayerProxy))
					{
						EarthView::World::Core::CXmlElement __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::COGCWFSVectorRelativeSceneLayer::toXmlElement();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_register_1toXmlElement_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCOGCWFSVectorRelativeSceneLayerProxy *pObjectX = (JCOGCWFSVectorRelativeSceneLayerProxy*) pObjXXXX;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_toXmlElement_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::COGCWFSVectorRelativeSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::COGCWFSVectorRelativeSceneLayer*) pObjXXXX;
					EarthView::World::Core::CXmlElement __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::COGCWFSVectorRelativeSceneLayer::toXmlElement();
					EarthView::World::Core::CXmlElement *returnvalues = new EarthView::World::Core::CXmlElement(__values1);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_fromXmlElement_1CXmlElement(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong element_j)
				{
					EarthView::World::Core::CXmlElement &element = *(EarthView::World::Core::CXmlElement*) element_j;
					EarthView::World::Spatial3D::Atlas::COGCWFSVectorRelativeSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::COGCWFSVectorRelativeSceneLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCOGCWFSVectorRelativeSceneLayerProxy))
					{
						pObjectX->EarthView::World::Spatial3D::Atlas::COGCWFSVectorRelativeSceneLayer::fromXmlElement(element);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_register_1fromXmlElement_1CXmlElement(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCOGCWFSVectorRelativeSceneLayerProxy *pObjectX = (JCOGCWFSVectorRelativeSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_fromXmlElement_1CXmlElement_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong element_j)
				{
					EarthView::World::Core::CXmlElement &element = *(EarthView::World::Core::CXmlElement*) element_j;
					EarthView::World::Spatial3D::Atlas::COGCWFSVectorRelativeSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::COGCWFSVectorRelativeSceneLayer*) pObjXXXX;
					pObjectX->EarthView::World::Spatial3D::Atlas::COGCWFSVectorRelativeSceneLayer::fromXmlElement(element);
				}
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_ev_1clone_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::COGCWFSVectorRelativeSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::COGCWFSVectorRelativeSceneLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCOGCWFSVectorRelativeSceneLayerProxy))
					{
						EarthView::World::Spatial::Atlas::ILayer* __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::COGCWFSVectorRelativeSceneLayer::clone();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_register_1ev_1clone_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCOGCWFSVectorRelativeSceneLayerProxy *pObjectX = (JCOGCWFSVectorRelativeSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_ev_1clone_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::COGCWFSVectorRelativeSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::COGCWFSVectorRelativeSceneLayer*) pObjXXXX;
					EarthView::World::Spatial::Atlas::ILayer* __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::COGCWFSVectorRelativeSceneLayer::clone();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_getType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::COGCWFSVectorRelativeSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::COGCWFSVectorRelativeSceneLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCOGCWFSVectorRelativeSceneLayerProxy))
					{
						EarthView::World::Spatial::Atlas::EVLayerType __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::COGCWFSVectorRelativeSceneLayer::getType();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_register_1getType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCOGCWFSVectorRelativeSceneLayerProxy *pObjectX = (JCOGCWFSVectorRelativeSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_getType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::COGCWFSVectorRelativeSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::COGCWFSVectorRelativeSceneLayer*) pObjXXXX;
					EarthView::World::Spatial::Atlas::EVLayerType __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::COGCWFSVectorRelativeSceneLayer::getType();
					jint __values1_j = (jint) __values1;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_setWFSDataset_1IDataset(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong ds_j)
				{
					EarthView::World::Spatial::GeoDataset::IDataset *ds = (EarthView::World::Spatial::GeoDataset::IDataset*) ds_j;
					EarthView::World::Spatial3D::Atlas::COGCWFSVectorRelativeSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::COGCWFSVectorRelativeSceneLayer*) pObjXXXX;
					pObjectX->setWFSDataset(ds);
				}
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_getDataset_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::Atlas::COGCWFSVectorRelativeSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::COGCWFSVectorRelativeSceneLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCOGCWFSVectorRelativeSceneLayerProxy))
					{
						EarthView::World::Spatial::GeoDataset::IDataset* __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::COGCWFSVectorRelativeSceneLayer::getDataset();
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_register_1getDataset_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCOGCWFSVectorRelativeSceneLayerProxy *pObjectX = (JCOGCWFSVectorRelativeSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_getDataset_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::Atlas::COGCWFSVectorRelativeSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::COGCWFSVectorRelativeSceneLayer*) pObjXXXX;
					EarthView::World::Spatial::GeoDataset::IDataset* __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::COGCWFSVectorRelativeSceneLayer::getDataset();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_getWFSDataset_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::COGCWFSVectorRelativeSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::COGCWFSVectorRelativeSceneLayer*) pObjXXXX;
					EarthView::World::Spatial::GeoDataset::IDataset* __values1 = pObjectX->getWFSDataset();
					jlong __values1_j = (jlong) __values1;
					return __values1_j;
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_register_1setLabelVisibleDistance_1ev_1real64(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCOGCWFSVectorRelativeSceneLayerProxy *pObjectX = (JCOGCWFSVectorRelativeSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_register_1getVisibleDistinction_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCOGCWFSVectorRelativeSceneLayerProxy *pObjectX = (JCOGCWFSVectorRelativeSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
					__env->ReleaseStringUTFChars(__method, pMethod);
					pObjectX->register_getVisibleDistinction_void_callback(sMethod);
					if (pObjectX->getJavaReference() != NULL && sMethod != "")
					{
						EarthView::World::Core::GlobalReference *__gr = (EarthView::World::Core::GlobalReference *)pObjectX->getJavaReference();
						jobject __obj1 = __gr->getJObject();
						jclass __clazz1 = __env->GetObjectClass(__obj1);
						jmethodID __method = __env->GetMethodID(__clazz1,"getVisibleDistinction_void_callback", "()F");
						__gr->setMethod(sMethod, __method);
					}
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_register_1setVisibleDistinction_1ev_1real32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCOGCWFSVectorRelativeSceneLayerProxy *pObjectX = (JCOGCWFSVectorRelativeSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
					__env->ReleaseStringUTFChars(__method, pMethod);
					pObjectX->register_setVisibleDistinction_ev_real32_callback(sMethod);
					if (pObjectX->getJavaReference() != NULL && sMethod != "")
					{
						EarthView::World::Core::GlobalReference *__gr = (EarthView::World::Core::GlobalReference *)pObjectX->getJavaReference();
						jobject __obj1 = __gr->getJObject();
						jclass __clazz1 = __env->GetObjectClass(__obj1);
						jmethodID __method = __env->GetMethodID(__clazz1,"setVisibleDistinction_ev_real32_callback", "(F)V");
						__gr->setMethod(sMethod, __method);
					}
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_register_1getVisibleOctreeDistance_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCOGCWFSVectorRelativeSceneLayerProxy *pObjectX = (JCOGCWFSVectorRelativeSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
					__env->ReleaseStringUTFChars(__method, pMethod);
					pObjectX->register_getVisibleOctreeDistance_void_callback(sMethod);
					if (pObjectX->getJavaReference() != NULL && sMethod != "")
					{
						EarthView::World::Core::GlobalReference *__gr = (EarthView::World::Core::GlobalReference *)pObjectX->getJavaReference();
						jobject __obj1 = __gr->getJObject();
						jclass __clazz1 = __env->GetObjectClass(__obj1);
						jmethodID __method = __env->GetMethodID(__clazz1,"getVisibleOctreeDistance_void_callback", "()F");
						__gr->setMethod(sMethod, __method);
					}
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_register_1setVisibleOctreeDistance_1ev_1real32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCOGCWFSVectorRelativeSceneLayerProxy *pObjectX = (JCOGCWFSVectorRelativeSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
					__env->ReleaseStringUTFChars(__method, pMethod);
					pObjectX->register_setVisibleOctreeDistance_ev_real32_callback(sMethod);
					if (pObjectX->getJavaReference() != NULL && sMethod != "")
					{
						EarthView::World::Core::GlobalReference *__gr = (EarthView::World::Core::GlobalReference *)pObjectX->getJavaReference();
						jobject __obj1 = __gr->getJObject();
						jclass __clazz1 = __env->GetObjectClass(__obj1);
						jmethodID __method = __env->GetMethodID(__clazz1,"setVisibleOctreeDistance_ev_real32_callback", "(F)V");
						__gr->setMethod(sMethod, __method);
					}
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_register_1setLabelProjOffsetMaxAngle_1Real(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCOGCWFSVectorRelativeSceneLayerProxy *pObjectX = (JCOGCWFSVectorRelativeSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_register_1getLabelProjOffsetMaxAngle_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCOGCWFSVectorRelativeSceneLayerProxy *pObjectX = (JCOGCWFSVectorRelativeSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_register_1getGeometryType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCOGCWFSVectorRelativeSceneLayerProxy *pObjectX = (JCOGCWFSVectorRelativeSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_register_1deleteSpatialIndex_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCOGCWFSVectorRelativeSceneLayerProxy *pObjectX = (JCOGCWFSVectorRelativeSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_register_1rebulidSpatialIndex_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCOGCWFSVectorRelativeSceneLayerProxy *pObjectX = (JCOGCWFSVectorRelativeSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_register_1attachLayer_1ILayer(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCOGCWFSVectorRelativeSceneLayerProxy *pObjectX = (JCOGCWFSVectorRelativeSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_register_1detachLayer_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCOGCWFSVectorRelativeSceneLayerProxy *pObjectX = (JCOGCWFSVectorRelativeSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_register_1getLayer_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCOGCWFSVectorRelativeSceneLayerProxy *pObjectX = (JCOGCWFSVectorRelativeSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_register_1getTheme_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCOGCWFSVectorRelativeSceneLayerProxy *pObjectX = (JCOGCWFSVectorRelativeSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_register_1setTheme_1ITheme(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCOGCWFSVectorRelativeSceneLayerProxy *pObjectX = (JCOGCWFSVectorRelativeSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_register_1getSceneName_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCOGCWFSVectorRelativeSceneLayerProxy *pObjectX = (JCOGCWFSVectorRelativeSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_register_1getMinX_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCOGCWFSVectorRelativeSceneLayerProxy *pObjectX = (JCOGCWFSVectorRelativeSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_register_1getMaxX_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCOGCWFSVectorRelativeSceneLayerProxy *pObjectX = (JCOGCWFSVectorRelativeSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_register_1getMinY_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCOGCWFSVectorRelativeSceneLayerProxy *pObjectX = (JCOGCWFSVectorRelativeSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_register_1getMaxY_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCOGCWFSVectorRelativeSceneLayerProxy *pObjectX = (JCOGCWFSVectorRelativeSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_register_1getHeightAt_1ev_1real32_1ev_1real32_1ev_1real32_1ev_1real32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCOGCWFSVectorRelativeSceneLayerProxy *pObjectX = (JCOGCWFSVectorRelativeSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_register_1_1notifyLayerAdd_1CSceneManager(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCOGCWFSVectorRelativeSceneLayerProxy *pObjectX = (JCOGCWFSVectorRelativeSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_register_1_1notifyLayerRemoved_1CSceneManager(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCOGCWFSVectorRelativeSceneLayerProxy *pObjectX = (JCOGCWFSVectorRelativeSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_register_1_1notifyRefreshed_1CCamera_1LayerRefreshFactor(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCOGCWFSVectorRelativeSceneLayerProxy *pObjectX = (JCOGCWFSVectorRelativeSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_register_1_1notifyRefreshed_1CCamera(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCOGCWFSVectorRelativeSceneLayerProxy *pObjectX = (JCOGCWFSVectorRelativeSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_register_1_1notifyDataChanged_1EVString_1EVString_1CEvent(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCOGCWFSVectorRelativeSceneLayerProxy *pObjectX = (JCOGCWFSVectorRelativeSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_register_1getSceneManager_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCOGCWFSVectorRelativeSceneLayerProxy *pObjectX = (JCOGCWFSVectorRelativeSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_register_1getDatasetName_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCOGCWFSVectorRelativeSceneLayerProxy *pObjectX = (JCOGCWFSVectorRelativeSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_register_1getDataSource_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCOGCWFSVectorRelativeSceneLayerProxy *pObjectX = (JCOGCWFSVectorRelativeSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_register_1select_1IQueryFilter_1EVSelectionResultType(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCOGCWFSVectorRelativeSceneLayerProxy *pObjectX = (JCOGCWFSVectorRelativeSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_register_1clearSelection_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCOGCWFSVectorRelativeSceneLayerProxy *pObjectX = (JCOGCWFSVectorRelativeSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_register_1setLayerSelection_1ILayerSelection(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCOGCWFSVectorRelativeSceneLayerProxy *pObjectX = (JCOGCWFSVectorRelativeSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_register_1getLayerSelection_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCOGCWFSVectorRelativeSceneLayerProxy *pObjectX = (JCOGCWFSVectorRelativeSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_register_1getName_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCOGCWFSVectorRelativeSceneLayerProxy *pObjectX = (JCOGCWFSVectorRelativeSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_register_1setName_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCOGCWFSVectorRelativeSceneLayerProxy *pObjectX = (JCOGCWFSVectorRelativeSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_register_1getDescription_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCOGCWFSVectorRelativeSceneLayerProxy *pObjectX = (JCOGCWFSVectorRelativeSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_register_1setDescription_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCOGCWFSVectorRelativeSceneLayerProxy *pObjectX = (JCOGCWFSVectorRelativeSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_register_1canEdit_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCOGCWFSVectorRelativeSceneLayerProxy *pObjectX = (JCOGCWFSVectorRelativeSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_register_1setCanEdit_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCOGCWFSVectorRelativeSceneLayerProxy *pObjectX = (JCOGCWFSVectorRelativeSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_register_1isEditing_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCOGCWFSVectorRelativeSceneLayerProxy *pObjectX = (JCOGCWFSVectorRelativeSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_register_1setEditing_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCOGCWFSVectorRelativeSceneLayerProxy *pObjectX = (JCOGCWFSVectorRelativeSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_register_1isVisible_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCOGCWFSVectorRelativeSceneLayerProxy *pObjectX = (JCOGCWFSVectorRelativeSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_register_1setVisible_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCOGCWFSVectorRelativeSceneLayerProxy *pObjectX = (JCOGCWFSVectorRelativeSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_register_1isValid_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCOGCWFSVectorRelativeSceneLayerProxy *pObjectX = (JCOGCWFSVectorRelativeSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_register_1isSelectable_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCOGCWFSVectorRelativeSceneLayerProxy *pObjectX = (JCOGCWFSVectorRelativeSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_register_1setSelectable_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCOGCWFSVectorRelativeSceneLayerProxy *pObjectX = (JCOGCWFSVectorRelativeSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_register_1ignoreScale_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCOGCWFSVectorRelativeSceneLayerProxy *pObjectX = (JCOGCWFSVectorRelativeSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_register_1setIgnoreScale_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCOGCWFSVectorRelativeSceneLayerProxy *pObjectX = (JCOGCWFSVectorRelativeSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_register_1getDisplayMaxScale_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCOGCWFSVectorRelativeSceneLayerProxy *pObjectX = (JCOGCWFSVectorRelativeSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_register_1setDisplayMaxScale_1ev_1real64(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCOGCWFSVectorRelativeSceneLayerProxy *pObjectX = (JCOGCWFSVectorRelativeSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_register_1getDisplayMinScale_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCOGCWFSVectorRelativeSceneLayerProxy *pObjectX = (JCOGCWFSVectorRelativeSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_register_1setDisplayMinScale_1ev_1real64(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCOGCWFSVectorRelativeSceneLayerProxy *pObjectX = (JCOGCWFSVectorRelativeSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_register_1getSpatialReference_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCOGCWFSVectorRelativeSceneLayerProxy *pObjectX = (JCOGCWFSVectorRelativeSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_register_1setSpatialReference_1ISpatialReference(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCOGCWFSVectorRelativeSceneLayerProxy *pObjectX = (JCOGCWFSVectorRelativeSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_register_1setTransparentValue_1ev_1uint8(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCOGCWFSVectorRelativeSceneLayerProxy *pObjectX = (JCOGCWFSVectorRelativeSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_register_1getTransparentValue_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCOGCWFSVectorRelativeSceneLayerProxy *pObjectX = (JCOGCWFSVectorRelativeSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_register_1getExtent_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCOGCWFSVectorRelativeSceneLayerProxy *pObjectX = (JCOGCWFSVectorRelativeSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_register_1draw_1ISpatialDisplay_1EVVectorLayerRendererType(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCOGCWFSVectorRelativeSceneLayerProxy *pObjectX = (JCOGCWFSVectorRelativeSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_register_1toStream_1CDataStream(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCOGCWFSVectorRelativeSceneLayerProxy *pObjectX = (JCOGCWFSVectorRelativeSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_register_1toXML_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCOGCWFSVectorRelativeSceneLayerProxy *pObjectX = (JCOGCWFSVectorRelativeSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayer_register_1fromStream_1CDataStream(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCOGCWFSVectorRelativeSceneLayerProxy *pObjectX = (JCOGCWFSVectorRelativeSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				class JCOGCWFSVectorRelativeSceneLayerFactoryProxy : public EarthView::World::Spatial3D::Atlas::COGCWFSVectorRelativeSceneLayerFactory
				{
				 private:
					EarthView::World::Core::ev_string m_getType_void_callback;
				...
				public:
					JCOGCWFSVectorRelativeSceneLayerFactoryProxy(EarthView::World::Core::CNameValuePairList *pList) : COGCWFSVectorRelativeSceneLayerFactory(pList)
					{
					}
					ev_void unRegisterJavaReference()
					{
				...
				REGISTER_FACTORY_CLASS(JCOGCWFSVectorRelativeSceneLayerFactoryProxy);
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayerfactory_getType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::COGCWFSVectorRelativeSceneLayerFactory *pObjectX = (EarthView::World::Spatial3D::Atlas::COGCWFSVectorRelativeSceneLayerFactory*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCOGCWFSVectorRelativeSceneLayerFactoryProxy))
					{
						EarthView::World::Spatial::Atlas::EVLayerType __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::COGCWFSVectorRelativeSceneLayerFactory::getType();
						jint __values1_j = (jint) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayerfactory_register_1getType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCOGCWFSVectorRelativeSceneLayerFactoryProxy *pObjectX = (JCOGCWFSVectorRelativeSceneLayerFactoryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
					__env->ReleaseStringUTFChars(__method, pMethod);
					pObjectX->register_getType_void_callback(sMethod);
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayerfactory_getType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::COGCWFSVectorRelativeSceneLayerFactory *pObjectX = (EarthView::World::Spatial3D::Atlas::COGCWFSVectorRelativeSceneLayerFactory*) pObjXXXX;
					EarthView::World::Spatial::Atlas::EVLayerType __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::COGCWFSVectorRelativeSceneLayerFactory::getType();
					jint __values1_j = (jint) __values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayerfactory_createInstance_1CXmlElement(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong element_j)
				{
					EarthView::World::Core::CXmlElement &element = *(EarthView::World::Core::CXmlElement*) element_j;
					EarthView::World::Spatial3D::Atlas::COGCWFSVectorRelativeSceneLayerFactory *pObjectX = (EarthView::World::Spatial3D::Atlas::COGCWFSVectorRelativeSceneLayerFactory*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCOGCWFSVectorRelativeSceneLayerFactoryProxy))
					{
						EarthView::World::Spatial::Atlas::ILayer* __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::COGCWFSVectorRelativeSceneLayerFactory::createInstance(element);
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayerfactory_register_1createInstance_1CXmlElement(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCOGCWFSVectorRelativeSceneLayerFactoryProxy *pObjectX = (JCOGCWFSVectorRelativeSceneLayerFactoryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayerfactory_createInstance_1CXmlElement_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong element_j)
				{
					EarthView::World::Core::CXmlElement &element = *(EarthView::World::Core::CXmlElement*) element_j;
					EarthView::World::Spatial3D::Atlas::COGCWFSVectorRelativeSceneLayerFactory *pObjectX = (EarthView::World::Spatial3D::Atlas::COGCWFSVectorRelativeSceneLayerFactory*) pObjXXXX;
					EarthView::World::Spatial::Atlas::ILayer* __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::COGCWFSVectorRelativeSceneLayerFactory::createInstance(element);
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayerfactory_createInstance_1IDataset(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong ref_Dataset_j)
				{
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayerfactory_destroyInstance_1ILayer(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong layer_j)
				{
					EarthView::World::Spatial::Atlas::ILayer *layer = (EarthView::World::Spatial::Atlas::ILayer*) layer_j;
					EarthView::World::Spatial3D::Atlas::COGCWFSVectorRelativeSceneLayerFactory *pObjectX = (EarthView::World::Spatial3D::Atlas::COGCWFSVectorRelativeSceneLayerFactory*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCOGCWFSVectorRelativeSceneLayerFactoryProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::COGCWFSVectorRelativeSceneLayerFactory::destroyInstance(layer);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayerfactory_register_1destroyInstance_1ILayer(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCOGCWFSVectorRelativeSceneLayerFactoryProxy *pObjectX = (JCOGCWFSVectorRelativeSceneLayerFactoryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayerfactory_destroyInstance_1ILayer_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong layer_j)
				{
					EarthView::World::Spatial::Atlas::ILayer *layer = (EarthView::World::Spatial::Atlas::ILayer*) layer_j;
					EarthView::World::Spatial3D::Atlas::COGCWFSVectorRelativeSceneLayerFactory *pObjectX = (EarthView::World::Spatial3D::Atlas::COGCWFSVectorRelativeSceneLayerFactory*) pObjXXXX;
					ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::COGCWFSVectorRelativeSceneLayerFactory::destroyInstance(layer);
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayerfactory_get_1msSceneLayerFactoryName_1void(JNIEnv *__env, jclass __clazz)
				{
					EarthView::World::Core::ev_wstring __values1_ch = EarthView::World::Spatial3D::Atlas::COGCWFSVectorRelativeSceneLayerFactory::msSceneLayerFactoryName;
					jstring __values1_j = __env->NewString((const jchar*)__values1_ch.getString(), __values1_ch.size());
					return __values1_j;
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayerfactory_register_1createInstance_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCOGCWFSVectorRelativeSceneLayerFactoryProxy *pObjectX = (JCOGCWFSVectorRelativeSceneLayerFactoryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Ogcwfsvectorrelativescenelayerfactory_register_1createInstance_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCOGCWFSVectorRelativeSceneLayerFactoryProxy *pObjectX = (JCOGCWFSVectorRelativeSceneLayerFactoryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
