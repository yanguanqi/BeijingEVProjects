...
namespace EarthView
{
	namespace World
	{
		namespace Spatial3D
		{
			namespace Atlas
			{
				class JCVectorWebClampSceneLayerProxy : public EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer
				{
				 private:
					EarthView::World::Core::ev_string m_getMaxLabelVisibleDistance_void_callback;
					EarthView::World::Core::ev_string m_setMaxLabelVisibleDistance_ev_real64_callback;
					EarthView::World::Core::ev_string m_getMinLabelVisibleDistance_void_callback;
					EarthView::World::Core::ev_string m_setMinLabelVisibleDistance_ev_real64_callback;
					...
					EarthView::World::Core::ev_string m_getTileWidth_void_callback;
					EarthView::World::Core::ev_string m_getTileHeight_void_callback;
				...
				public:
					JCVectorWebClampSceneLayerProxy(EarthView::World::Core::CNameValuePairList *pList) : CVectorWebClampSceneLayer(pList)
					{
					}
				...
				public:
					void register_getMaxLabelVisibleDistance_void_callback(EarthView::World::Core::ev_string __method)
					{
						this->m_getMaxLabelVisibleDistance_void_callback = __method;
					}
					void register_setMaxLabelVisibleDistance_ev_real64_callback(EarthView::World::Core::ev_string __method)
					{
						this->m_setMaxLabelVisibleDistance_ev_real64_callback = __method;
					}
					void register_getMinLabelVisibleDistance_void_callback(EarthView::World::Core::ev_string __method)
					{
						this->m_getMinLabelVisibleDistance_void_callback = __method;
					}
					void register_setMinLabelVisibleDistance_ev_real64_callback(EarthView::World::Core::ev_string __method)
					{
						this->m_setMinLabelVisibleDistance_ev_real64_callback = __method;
					}
					...
					void register_getTileWidth_void_callback(EarthView::World::Core::ev_string __method)
					{
						this->m_getTileWidth_void_callback = __method;
					}
					void register_getTileHeight_void_callback(EarthView::World::Core::ev_string __method)
					{
						this->m_getTileHeight_void_callback = __method;
					}
					...
					{
						if (this->_gRef != NULL && this->m_getMaxLabelVisibleDistance_void_callback != "" && this->isCustomExtend())
						{
							EarthView::World::Core::GlobalReference *__gr = (EarthView::World::Core::GlobalReference *)this->getJavaReference();
							JNIEnv * __env;
							#if EV_PLATFORM == EV_PLATFORM_ANDROID
							...
							jobject __obj = __gr->getJObject();
							jclass __clazz = __gr->getClass();
							jmethodID __method = __gr->getMethod("getMaxLabelVisibleDistance_void_callback");
					...
					virtual void setMaxLabelVisibleDistance(ev_real64 dis)
					{
						if (this->_gRef != NULL && this->m_setMaxLabelVisibleDistance_ev_real64_callback != "" && this->isCustomExtend())
						{
							EarthView::World::Core::GlobalReference *__gr = (EarthView::World::Core::GlobalReference *)this->getJavaReference();
							JNIEnv * __env;
							#if EV_PLATFORM == EV_PLATFORM_ANDROID
							...
							jmethodID __method = __gr->getMethod("setMaxLabelVisibleDistance_ev_real64_callback");
					...
					{
						if (this->_gRef != NULL && this->m_getMinLabelVisibleDistance_void_callback != "" && this->isCustomExtend())
						{
							EarthView::World::Core::GlobalReference *__gr = (EarthView::World::Core::GlobalReference *)this->getJavaReference();
							JNIEnv * __env;
							#if EV_PLATFORM == EV_PLATFORM_ANDROID
							...
							jobject __obj = __gr->getJObject();
							jclass __clazz = __gr->getClass();
							jmethodID __method = __gr->getMethod("getMinLabelVisibleDistance_void_callback");
							jdouble __values1_j = (jdouble)__env->CallDoubleMethod(__obj, __method );
							#if EV_PLATFORM == EV_PLATFORM_ANDROID
							if(__jniAttachable)
							{
					...
					virtual void setMinLabelVisibleDistance(ev_real64 dis)
					{
						if (this->_gRef != NULL && this->m_setMinLabelVisibleDistance_ev_real64_callback != "" && this->isCustomExtend())
						{
							EarthView::World::Core::GlobalReference *__gr = (EarthView::World::Core::GlobalReference *)this->getJavaReference();
							JNIEnv * __env;
							#if EV_PLATFORM == EV_PLATFORM_ANDROID
							...
							jclass __clazz = __gr->getClass();
							jdouble dis_j = (jdouble) dis;
							jmethodID __method = __gr->getMethod("setMinLabelVisibleDistance_ev_real64_callback");
							__env->CallVoidMethod(__obj, __method , dis_j);
							#if EV_PLATFORM == EV_PLATFORM_ANDROID
							if(__jniAttachable)
							{
					...
					{
						if (this->_gRef != NULL && this->m_getTileWidth_void_callback != "" && this->isCustomExtend())
						{
							EarthView::World::Core::GlobalReference *__gr = (EarthView::World::Core::GlobalReference *)this->getJavaReference();
							JNIEnv * __env;
							#if EV_PLATFORM == EV_PLATFORM_ANDROID
							...
							jobject __obj = __gr->getJObject();
							jclass __clazz = __gr->getClass();
							jmethodID __method = __gr->getMethod("getTileWidth_void_callback");
							jlong __values1_j = (jlong)__env->CallLongMethod(__obj, __method );
							#if EV_PLATFORM == EV_PLATFORM_ANDROID
							if(__jniAttachable)
							{
					...
					{
						if (this->_gRef != NULL && this->m_getTileHeight_void_callback != "" && this->isCustomExtend())
						{
							EarthView::World::Core::GlobalReference *__gr = (EarthView::World::Core::GlobalReference *)this->getJavaReference();
							JNIEnv * __env;
							#if EV_PLATFORM == EV_PLATFORM_ANDROID
							...
							jobject __obj = __gr->getJObject();
							jclass __clazz = __gr->getClass();
							jmethodID __method = __gr->getMethod("getTileHeight_void_callback");
							jlong __values1_j = (jlong)__env->CallLongMethod(__obj, __method );
							#if EV_PLATFORM == EV_PLATFORM_ANDROID
							if(__jniAttachable)
							{
				...
				REGISTER_FACTORY_CLASS(JCVectorWebClampSceneLayerProxy);
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_getTile_1ev_1int32_1ev_1int32_1ev_1int32_1CTileData(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint level_j, jint row_j, jint col_j, jlong tile_j)
				{
					...
					EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorWebClampSceneLayerProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer::getTile(level, row, col, tile);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1getTile_1ev_1int32_1ev_1int32_1ev_1int32_1CTileData(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_getTile_1ev_1int32_1ev_1int32_1ev_1int32_1CTileData_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint level_j, jint row_j, jint col_j, jlong tile_j)
				{
					ev_int32 level = (ev_int32) level_j;
					ev_int32 row = (ev_int32) row_j;
					ev_int32 col = (ev_int32) col_j;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer__1notifyTileCreated_1ev_1uint32_1ev_1uint32_1ev_1uint32(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong level_j, jlong row_j, jlong col_j)
				{
					...
					if (typeid(*pObjectX) == typeid(JCVectorWebClampSceneLayerProxy))
					{
						pObjectX->EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer::_notifyTileCreated(level, row, col);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1_1notifyTileCreated_1ev_1uint32_1ev_1uint32_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer__1notifyTileCreated_1ev_1uint32_1ev_1uint32_1ev_1uint32_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong level_j, jlong row_j, jlong col_j)
				{
					ev_uint32 level = (ev_uint32) level_j;
					ev_uint32 row = (ev_uint32) row_j;
					ev_uint32 col = (ev_uint32) col_j;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer__1notifyTileDestroyed_1ev_1uint32_1ev_1uint32_1ev_1uint32(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong level_j, jlong row_j, jlong col_j)
				{
					ev_uint32 level = (ev_uint32) level_j;
					ev_uint32 row = (ev_uint32) row_j;
					ev_uint32 col = (ev_uint32) col_j;
					...
					if (typeid(*pObjectX) == typeid(JCVectorWebClampSceneLayerProxy))
					{
						pObjectX->EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer::_notifyTileDestroyed(level, row, col);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1_1notifyTileDestroyed_1ev_1uint32_1ev_1uint32_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer__1notifyTileDestroyed_1ev_1uint32_1ev_1uint32_1ev_1uint32_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong level_j, jlong row_j, jlong col_j)
				{
					ev_uint32 level = (ev_uint32) level_j;
					ev_uint32 row = (ev_uint32) row_j;
					ev_uint32 col = (ev_uint32) col_j;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_getType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorWebClampSceneLayerProxy))
					{
						EarthView::World::Spatial::Atlas::EVLayerType __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer::getType();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1getType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_getType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer*) pObjXXXX;
					EarthView::World::Spatial::Atlas::EVLayerType __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer::getType();
					jint __values1_j = (jint) __values1;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_setVisible_1ev_1bool(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean visible_j)
				{
					ev_bool visible = (ev_bool) visible_j;
					EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorWebClampSceneLayerProxy))
					{
						pObjectX->EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer::setVisible(visible);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1setVisible_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_setVisible_1ev_1bool_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean visible_j)
				{
					ev_bool visible = (ev_bool) visible_j;
					EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer*) pObjXXXX;
					pObjectX->EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer::setVisible(visible);
				}
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_getGeometryType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer*) pObjXXXX;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_ev_1clone_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorWebClampSceneLayerProxy))
					{
						EarthView::World::Spatial::Atlas::ILayer* __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer::clone();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1ev_1clone_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_ev_1clone_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer*) pObjXXXX;
					EarthView::World::Spatial::Atlas::ILayer* __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer::clone();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_getTheme_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorWebClampSceneLayerProxy))
					{
						EarthView::World::Spatial::Theme::ITheme* __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer::getTheme();
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1getTheme_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_getTheme_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer*) pObjXXXX;
					EarthView::World::Spatial::Theme::ITheme* __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer::getTheme();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_setTheme_1ITheme(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong theme_j)
				{
					const EarthView::World::Spatial::Theme::ITheme *theme = (const EarthView::World::Spatial::Theme::ITheme*) theme_j;
					EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorWebClampSceneLayerProxy))
					{
						pObjectX->EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer::setTheme(theme);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1setTheme_1ITheme(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_setTheme_1ITheme_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong theme_j)
				{
					const EarthView::World::Spatial::Theme::ITheme *theme = (const EarthView::World::Spatial::Theme::ITheme*) theme_j;
					EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer*) pObjXXXX;
					pObjectX->EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer::setTheme(theme);
				}
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_getThemeStream_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorWebClampSceneLayerProxy))
					{
						EarthView::World::Core::MemoryDataStreamPtr __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer::getThemeStream();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1getThemeStream_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_getThemeStream_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer*) pObjXXXX;
					EarthView::World::Core::MemoryDataStreamPtr __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer::getThemeStream();
					EarthView::World::Core::MemoryDataStreamPtr *returnvalues = new EarthView::World::Core::MemoryDataStreamPtr(__values1);
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_equalThemeStream_1MemoryDataStreamPtr(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong stream_j)
				{
					EarthView::World::Core::MemoryDataStreamPtr stream = *(EarthView::World::Core::MemoryDataStreamPtr*) stream_j;
					EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorWebClampSceneLayerProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer::equalThemeStream(stream);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1equalThemeStream_1MemoryDataStreamPtr(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_equalThemeStream_1MemoryDataStreamPtr_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong stream_j)
				{
					EarthView::World::Core::MemoryDataStreamPtr stream = *(EarthView::World::Core::MemoryDataStreamPtr*) stream_j;
					EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer*) pObjXXXX;
					ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer::equalThemeStream(stream);
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_getLabelProperty_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer*) pObjXXXX;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_setLabelProperty_1ILabelProperty(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong labelproperty_j)
				{
				...
				extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_getMaxLabelVisibleDistance_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorWebClampSceneLayerProxy))
					{
						ev_real64 __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer::getMaxLabelVisibleDistance();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1getMaxLabelVisibleDistance_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
					__env->ReleaseStringUTFChars(__method, pMethod);
					pObjectX->register_getMaxLabelVisibleDistance_void_callback(sMethod);
					if (pObjectX->getJavaReference() != NULL && sMethod != "")
					{
						EarthView::World::Core::GlobalReference *__gr = (EarthView::World::Core::GlobalReference *)pObjectX->getJavaReference();
						jobject __obj1 = __gr->getJObject();
						jclass __clazz1 = __env->GetObjectClass(__obj1);
						jmethodID __method = __env->GetMethodID(__clazz1,"getMaxLabelVisibleDistance_void_callback", "()D");
						__gr->setMethod(sMethod, __method);
					}
				}
				extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_getMaxLabelVisibleDistance_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer*) pObjXXXX;
					ev_real64 __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer::getMaxLabelVisibleDistance();
					jdouble __values1_j = (jdouble)__values1;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_setMaxLabelVisibleDistance_1ev_1real64(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble dis_j)
				{
					ev_real64 dis = (ev_real64) dis_j;
					EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorWebClampSceneLayerProxy))
					{
						pObjectX->EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer::setMaxLabelVisibleDistance(dis);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1setMaxLabelVisibleDistance_1ev_1real64(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
					__env->ReleaseStringUTFChars(__method, pMethod);
					pObjectX->register_setMaxLabelVisibleDistance_ev_real64_callback(sMethod);
					if (pObjectX->getJavaReference() != NULL && sMethod != "")
					{
						EarthView::World::Core::GlobalReference *__gr = (EarthView::World::Core::GlobalReference *)pObjectX->getJavaReference();
						jobject __obj1 = __gr->getJObject();
						jclass __clazz1 = __env->GetObjectClass(__obj1);
						jmethodID __method = __env->GetMethodID(__clazz1,"setMaxLabelVisibleDistance_ev_real64_callback", "(D)V");
						__gr->setMethod(sMethod, __method);
					}
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_setMaxLabelVisibleDistance_1ev_1real64_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble dis_j)
				{
					ev_real64 dis = (ev_real64) dis_j;
					EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer*) pObjXXXX;
					pObjectX->EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer::setMaxLabelVisibleDistance(dis);
				}
				extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_getMinLabelVisibleDistance_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorWebClampSceneLayerProxy))
					{
						ev_real64 __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer::getMinLabelVisibleDistance();
						jdouble __values1_j = (jdouble)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1getMinLabelVisibleDistance_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
					__env->ReleaseStringUTFChars(__method, pMethod);
					pObjectX->register_getMinLabelVisibleDistance_void_callback(sMethod);
					if (pObjectX->getJavaReference() != NULL && sMethod != "")
					{
						EarthView::World::Core::GlobalReference *__gr = (EarthView::World::Core::GlobalReference *)pObjectX->getJavaReference();
						jobject __obj1 = __gr->getJObject();
						jclass __clazz1 = __env->GetObjectClass(__obj1);
						jmethodID __method = __env->GetMethodID(__clazz1,"getMinLabelVisibleDistance_void_callback", "()D");
						__gr->setMethod(sMethod, __method);
					}
				}
				extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_getMinLabelVisibleDistance_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer*) pObjXXXX;
					ev_real64 __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer::getMinLabelVisibleDistance();
					jdouble __values1_j = (jdouble)__values1;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_setMinLabelVisibleDistance_1ev_1real64(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble dis_j)
				{
					ev_real64 dis = (ev_real64) dis_j;
					EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorWebClampSceneLayerProxy))
					{
						pObjectX->EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer::setMinLabelVisibleDistance(dis);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1setMinLabelVisibleDistance_1ev_1real64(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
					__env->ReleaseStringUTFChars(__method, pMethod);
					pObjectX->register_setMinLabelVisibleDistance_ev_real64_callback(sMethod);
					if (pObjectX->getJavaReference() != NULL && sMethod != "")
					{
						EarthView::World::Core::GlobalReference *__gr = (EarthView::World::Core::GlobalReference *)pObjectX->getJavaReference();
						jobject __obj1 = __gr->getJObject();
						jclass __clazz1 = __env->GetObjectClass(__obj1);
						jmethodID __method = __env->GetMethodID(__clazz1,"setMinLabelVisibleDistance_ev_real64_callback", "(D)V");
						__gr->setMethod(sMethod, __method);
					}
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_setMinLabelVisibleDistance_1ev_1real64_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble dis_j)
				{
					ev_real64 dis = (ev_real64) dis_j;
					EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer*) pObjXXXX;
					pObjectX->EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer::setMinLabelVisibleDistance(dis);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_setLabelProjOffsetMaxAngle_1Real(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble angle_j)
				{
					Real angle = (Real) angle_j;
					EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorWebClampSceneLayerProxy))
					{
						pObjectX->EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer::setLabelProjOffsetMaxAngle(angle);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1setLabelProjOffsetMaxAngle_1Real(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_setLabelProjOffsetMaxAngle_1Real_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble angle_j)
				{
					Real angle = (Real) angle_j;
					EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer*) pObjXXXX;
					pObjectX->EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer::setLabelProjOffsetMaxAngle(angle);
				}
				extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_getLabelProjOffsetMaxAngle_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorWebClampSceneLayerProxy))
					{
						Real __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer::getLabelProjOffsetMaxAngle();
						jdouble __values1_j = (jdouble)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1getLabelProjOffsetMaxAngle_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_getLabelProjOffsetMaxAngle_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer*) pObjXXXX;
					Real __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer::getLabelProjOffsetMaxAngle();
					jdouble __values1_j = (jdouble)__values1;
				...
				extern "C" JNIEXPORT jshort JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_getTransparentValue_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorWebClampSceneLayerProxy))
					{
						ev_uint8 __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer::getTransparentValue();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1getTransparentValue_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jshort JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_getTransparentValue_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer*) pObjXXXX;
					ev_uint8 __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer::getTransparentValue();
					jshort __values1_j = (jshort) __values1;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_setTransparentValue_1ev_1uint8(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jshort transparent_j)
				{
					ev_uint8 transparent = (ev_uint8) transparent_j;
					EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorWebClampSceneLayerProxy))
					{
						pObjectX->EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer::setTransparentValue(transparent);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1setTransparentValue_1ev_1uint8(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_setTransparentValue_1ev_1uint8_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jshort transparent_j)
				{
					ev_uint8 transparent = (ev_uint8) transparent_j;
					EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer*) pObjXXXX;
					pObjectX->EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer::setTransparentValue(transparent);
				}
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_isImage_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer*) pObjXXXX;
					ev_bool __values1 = pObjectX->isImage();
					jboolean __values1_j = (jboolean)__values1;
					return __values1_j;
				}
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_levelValid_1ev_1int32(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint level_j)
				{
					ev_int32 level = (ev_int32) level_j;
					const 					EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorWebClampSceneLayerProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer::levelValid(level);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1levelValid_1ev_1int32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_levelValid_1ev_1int32_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint level_j)
				{
					ev_int32 level = (ev_int32) level_j;
					const 					EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer*) pObjXXXX;
					ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer::levelValid(level);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_fromXmlElement_1CXmlElement(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong element_j)
				{
					EarthView::World::Core::CXmlElement &element = *(EarthView::World::Core::CXmlElement*) element_j;
					EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorWebClampSceneLayerProxy))
					{
						pObjectX->EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer::fromXmlElement(element);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1fromXmlElement_1CXmlElement(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_fromXmlElement_1CXmlElement_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong element_j)
				{
					EarthView::World::Core::CXmlElement &element = *(EarthView::World::Core::CXmlElement*) element_j;
					EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer*) pObjXXXX;
					pObjectX->EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer::fromXmlElement(element);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer__1notifyLayerAdd_1CSceneManager(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong pSceneMgr_j)
				{
					EarthView::World::Graphic::CSceneManager *pSceneMgr = (EarthView::World::Graphic::CSceneManager*) pSceneMgr_j;
					EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorWebClampSceneLayerProxy))
					{
						pObjectX->EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer::_notifyLayerAdd(pSceneMgr);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1_1notifyLayerAdd_1CSceneManager(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer__1notifyLayerAdd_1CSceneManager_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong pSceneMgr_j)
				{
					EarthView::World::Graphic::CSceneManager *pSceneMgr = (EarthView::World::Graphic::CSceneManager*) pSceneMgr_j;
					EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer*) pObjXXXX;
					pObjectX->EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer::_notifyLayerAdd(pSceneMgr);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer__1notifyLayerRemoved_1CSceneManager(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong pSceneMgr_j)
				{
					EarthView::World::Graphic::CSceneManager *pSceneMgr = (EarthView::World::Graphic::CSceneManager*) pSceneMgr_j;
					EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorWebClampSceneLayerProxy))
					{
						pObjectX->EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer::_notifyLayerRemoved(pSceneMgr);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1_1notifyLayerRemoved_1CSceneManager(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer__1notifyLayerRemoved_1CSceneManager_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong pSceneMgr_j)
				{
					EarthView::World::Graphic::CSceneManager *pSceneMgr = (EarthView::World::Graphic::CSceneManager*) pSceneMgr_j;
					EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer*) pObjXXXX;
					pObjectX->EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer::_notifyLayerRemoved(pSceneMgr);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer__1notifyRefreshed_1CCamera_1LayerRefreshFactor(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong camera_j, jint updateType_j)
				{
					...
					if (typeid(*pObjectX) == typeid(JCVectorWebClampSceneLayerProxy))
					{
						pObjectX->EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer::_notifyRefreshed(camera, updateType);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1_1notifyRefreshed_1CCamera_1LayerRefreshFactor(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer__1notifyRefreshed_1CCamera_1LayerRefreshFactor_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong camera_j, jint updateType_j)
				{
					const EarthView::World::Graphic::CCamera *camera = (const EarthView::World::Graphic::CCamera*) camera_j;
					EarthView::World::Spatial3D::Atlas::LayerRefreshFactor updateType = (EarthView::World::Spatial3D::Atlas::LayerRefreshFactor) updateType_j;
					EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer*) pObjXXXX;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_updateTextStyle_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer*) pObjXXXX;
					pObjectX->updateTextStyle();
				}
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_toXmlElement_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorWebClampSceneLayerProxy))
					{
						EarthView::World::Core::CXmlElement __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer::toXmlElement();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1toXmlElement_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_toXmlElement_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer*) pObjXXXX;
					EarthView::World::Core::CXmlElement __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayer::toXmlElement();
					EarthView::World::Core::CXmlElement *returnvalues = new EarthView::World::Core::CXmlElement(__values1);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1getSrs_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1getDataTime_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1getUpdateTime_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1getFileFormat_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1getLayerDataType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1getMaxScale_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1getMinScale_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1getTileWidth_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
					__env->ReleaseStringUTFChars(__method, pMethod);
					pObjectX->register_getTileWidth_void_callback(sMethod);
					if (pObjectX->getJavaReference() != NULL && sMethod != "")
					{
						EarthView::World::Core::GlobalReference *__gr = (EarthView::World::Core::GlobalReference *)pObjectX->getJavaReference();
						jobject __obj1 = __gr->getJObject();
						jclass __clazz1 = __env->GetObjectClass(__obj1);
						jmethodID __method = __env->GetMethodID(__clazz1,"getTileWidth_void_callback", "()J");
						__gr->setMethod(sMethod, __method);
					}
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1getTileHeight_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
					__env->ReleaseStringUTFChars(__method, pMethod);
					pObjectX->register_getTileHeight_void_callback(sMethod);
					if (pObjectX->getJavaReference() != NULL && sMethod != "")
					{
						EarthView::World::Core::GlobalReference *__gr = (EarthView::World::Core::GlobalReference *)pObjectX->getJavaReference();
						jobject __obj1 = __gr->getJObject();
						jclass __clazz1 = __env->GetObjectClass(__obj1);
						jmethodID __method = __env->GetMethodID(__clazz1,"getTileHeight_void_callback", "()J");
						__gr->setMethod(sMethod, __method);
					}
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1getAttributesCount_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1getAttribute_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1getTile_1CTileInfo_1CTileData(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1getTile_1Real_1Real_1Real_1Real_1CTileData(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1getMaxLevel_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1getMinLevel_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1getMaxVisibleLevel_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1getMinVisibleLevel_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1setMaxVisibleLevel_1ev_1int32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1setMinVisibleLevel_1ev_1int32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1getGeoExtent_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1setCurtainExtent_1ev_1real32_1ev_1real32_1ev_1real32_1ev_1real32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1setCurtainAlpha_1ev_1real32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1getCurtainExtent_1ev_1real32_1ev_1real32_1ev_1real32_1ev_1real32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1getCurtainEnabled_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1setCurtainEnabled_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1getCurtainAlpha_1ev_1real32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1getClampMode_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1setClampMode_1ClampMode(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1attachLayer_1ILayer(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1detachLayer_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1getLayer_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1getSceneName_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1getMinX_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1getMaxX_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1getMinY_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1getMaxY_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1getHeightAt_1ev_1real32_1ev_1real32_1ev_1real32_1ev_1real32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1_1notifyRefreshed_1CCamera(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1_1notifyDataChanged_1EVString_1EVString_1CEvent(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1getSceneManager_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1getDataset_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1getDatasetName_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1getDataSource_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1select_1IQueryFilter_1EVSelectionResultType(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1clearSelection_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1setLayerSelection_1ILayerSelection(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1getLayerSelection_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1getName_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1setName_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1getDescription_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1setDescription_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1canEdit_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1setCanEdit_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1isEditing_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1setEditing_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1isVisible_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1isValid_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1isSelectable_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1setSelectable_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1ignoreScale_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1setIgnoreScale_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1getDisplayMaxScale_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1setDisplayMaxScale_1ev_1real64(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1getDisplayMinScale_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1setDisplayMinScale_1ev_1real64(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1getSpatialReference_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1setSpatialReference_1ISpatialReference(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1getExtent_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1draw_1ISpatialDisplay_1EVVectorLayerRendererType(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1toStream_1CDataStream(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1toXML_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayer_register_1fromStream_1CDataStream(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerProxy *pObjectX = (JCVectorWebClampSceneLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				class JCVectorWebClampSceneLayerFactoryProxy : public EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayerFactory
				{
				 private:
					EarthView::World::Core::ev_string m_getType_void_callback;
				...
				public:
					JCVectorWebClampSceneLayerFactoryProxy(EarthView::World::Core::CNameValuePairList *pList) : CVectorWebClampSceneLayerFactory(pList)
					{
					}
					ev_void unRegisterJavaReference()
					{
				...
				REGISTER_FACTORY_CLASS(JCVectorWebClampSceneLayerFactoryProxy);
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayerFactory_getType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayerFactory *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayerFactory*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorWebClampSceneLayerFactoryProxy))
					{
						EarthView::World::Spatial::Atlas::EVLayerType __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayerFactory::getType();
						jint __values1_j = (jint) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayerFactory_register_1getType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerFactoryProxy *pObjectX = (JCVectorWebClampSceneLayerFactoryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
					__env->ReleaseStringUTFChars(__method, pMethod);
					pObjectX->register_getType_void_callback(sMethod);
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayerFactory_getType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayerFactory *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayerFactory*) pObjXXXX;
					EarthView::World::Spatial::Atlas::EVLayerType __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayerFactory::getType();
					jint __values1_j = (jint) __values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayerFactory_createInstance_1CXmlElement(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong element_j)
				{
					EarthView::World::Core::CXmlElement &element = *(EarthView::World::Core::CXmlElement*) element_j;
					EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayerFactory *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayerFactory*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorWebClampSceneLayerFactoryProxy))
					{
						EarthView::World::Spatial::Atlas::ILayer* __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayerFactory::createInstance(element);
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayerFactory_register_1createInstance_1CXmlElement(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerFactoryProxy *pObjectX = (JCVectorWebClampSceneLayerFactoryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayerFactory_createInstance_1CXmlElement_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong element_j)
				{
					EarthView::World::Core::CXmlElement &element = *(EarthView::World::Core::CXmlElement*) element_j;
					EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayerFactory *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayerFactory*) pObjXXXX;
					EarthView::World::Spatial::Atlas::ILayer* __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayerFactory::createInstance(element);
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayerFactory_createInstance_1IDataset(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong ref_Dataset_j)
				{
					EarthView::World::Spatial::GeoDataset::IDataset *ref_Dataset = (EarthView::World::Spatial::GeoDataset::IDataset*) ref_Dataset_j;
					EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayerFactory *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayerFactory*) pObjXXXX;
					EarthView::World::Spatial::Atlas::ILayer* __values1 = pObjectX->createInstance(ref_Dataset);
					jlong __values1_j = (jlong) __values1;
					return __values1_j;
				}
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayerFactory_destroyInstance_1ILayer(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong layer_j)
				{
					EarthView::World::Spatial::Atlas::ILayer *layer = (EarthView::World::Spatial::Atlas::ILayer*) layer_j;
					EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayerFactory *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayerFactory*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorWebClampSceneLayerFactoryProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayerFactory::destroyInstance(layer);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayerFactory_register_1destroyInstance_1ILayer(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerFactoryProxy *pObjectX = (JCVectorWebClampSceneLayerFactoryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayerFactory_destroyInstance_1ILayer_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong layer_j)
				{
					EarthView::World::Spatial::Atlas::ILayer *layer = (EarthView::World::Spatial::Atlas::ILayer*) layer_j;
					EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayerFactory *pObjectX = (EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayerFactory*) pObjXXXX;
					ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayerFactory::destroyInstance(layer);
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayerFactory_get_1msSceneLayerFactoryName_1void(JNIEnv *__env, jclass __clazz)
				{
					EarthView::World::Core::ev_wstring __values1_ch = EarthView::World::Spatial3D::Atlas::CVectorWebClampSceneLayerFactory::msSceneLayerFactoryName;
					jstring __values1_j = __env->NewString((const jchar*)__values1_ch.getString(), __values1_ch.size());
					return __values1_j;
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayerFactory_register_1createInstance_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerFactoryProxy *pObjectX = (JCVectorWebClampSceneLayerFactoryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_VectorWebClampSceneLayerFactory_register_1createInstance_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorWebClampSceneLayerFactoryProxy *pObjectX = (JCVectorWebClampSceneLayerFactoryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
