...
namespace EarthView
{
	namespace World
	{
		namespace Spatial3D
		{
			...
			namespace SystemUI
			{
				class JCTileAltitudeListenerProxy : public EarthView::World::Spatial3D::SystemUI::CTileAltitudeListener
				{
				 private:
					EarthView::World::Core::ev_string m_onOperateStart_CTileAltitudeTool_callback;
					EarthView::World::Core::ev_string m_onOperateEnd_CTileAltitudeTool_callback;
				public:
					JCTileAltitudeListenerProxy(EarthView::World::Core::CNameValuePairList *pList) : CTileAltitudeListener(pList)
					{
					}
				...
				public:
					void register_onOperateStart_CTileAltitudeTool_callback(EarthView::World::Core::ev_string __method)
					{
						this->m_onOperateStart_CTileAltitudeTool_callback = __method;
					}
					void register_onOperateEnd_CTileAltitudeTool_callback(EarthView::World::Core::ev_string __method)
					{
						this->m_onOperateEnd_CTileAltitudeTool_callback = __method;
					}
					virtual void onOperateStart(EarthView::World::Spatial3D::SystemUI::CTileAltitudeTool* tool)
					{
						if (this->_gRef != NULL && this->m_onOperateStart_CTileAltitudeTool_callback != "" && this->isCustomExtend())
						{
							EarthView::World::Core::GlobalReference *__gr = (EarthView::World::Core::GlobalReference *)this->getJavaReference();
							JNIEnv * __env;
							...
							jmethodID __method = __gr->getMethod("onOperateStart_CTileAltitudeTool_callback");
					...
					virtual void onOperateEnd(EarthView::World::Spatial3D::SystemUI::CTileAltitudeTool* tool)
					{
						if (this->_gRef != NULL && this->m_onOperateEnd_CTileAltitudeTool_callback != "" && this->isCustomExtend())
						{
							EarthView::World::Core::GlobalReference *__gr = (EarthView::World::Core::GlobalReference *)this->getJavaReference();
							JNIEnv * __env;
							#if EV_PLATFORM == EV_PLATFORM_ANDROID
							...
							jclass __clazz = __gr->getClass();
							jlong tool_j = (jlong) tool;
							jmethodID __method = __gr->getMethod("onOperateEnd_CTileAltitudeTool_callback");
							__env->CallVoidMethod(__obj, __method , tool_j);
							#if EV_PLATFORM == EV_PLATFORM_ANDROID
							if(__jniAttachable)
							{
				...
				REGISTER_FACTORY_CLASS(JCTileAltitudeListenerProxy);
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_systemui_TileAltitudeListener_onOperateStart_1CTileAltitudeTool(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong tool_j)
				{
					EarthView::World::Spatial3D::SystemUI::CTileAltitudeTool *tool = (EarthView::World::Spatial3D::SystemUI::CTileAltitudeTool*) tool_j;
					EarthView::World::Spatial3D::SystemUI::CTileAltitudeListener *pObjectX = (EarthView::World::Spatial3D::SystemUI::CTileAltitudeListener*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCTileAltitudeListenerProxy))
					{
						pObjectX->EarthView::World::Spatial3D::SystemUI::CTileAltitudeListener::onOperateStart(tool);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_systemui_TileAltitudeListener_register_1onOperateStart_1CTileAltitudeTool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCTileAltitudeListenerProxy *pObjectX = (JCTileAltitudeListenerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
					__env->ReleaseStringUTFChars(__method, pMethod);
					pObjectX->register_onOperateStart_CTileAltitudeTool_callback(sMethod);
					if (pObjectX->getJavaReference() != NULL && sMethod != "")
					{
						EarthView::World::Core::GlobalReference *__gr = (EarthView::World::Core::GlobalReference *)pObjectX->getJavaReference();
						jobject __obj1 = __gr->getJObject();
						jclass __clazz1 = __env->GetObjectClass(__obj1);
						jmethodID __method = __env->GetMethodID(__clazz1,"onOperateStart_CTileAltitudeTool_callback", "(J)V");
						__gr->setMethod(sMethod, __method);
					}
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_systemui_TileAltitudeListener_onOperateStart_1CTileAltitudeTool_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong tool_j)
				{
					EarthView::World::Spatial3D::SystemUI::CTileAltitudeTool *tool = (EarthView::World::Spatial3D::SystemUI::CTileAltitudeTool*) tool_j;
					EarthView::World::Spatial3D::SystemUI::CTileAltitudeListener *pObjectX = (EarthView::World::Spatial3D::SystemUI::CTileAltitudeListener*) pObjXXXX;
					pObjectX->EarthView::World::Spatial3D::SystemUI::CTileAltitudeListener::onOperateStart(tool);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_systemui_TileAltitudeListener_onOperateEnd_1CTileAltitudeTool(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong tool_j)
				{
					EarthView::World::Spatial3D::SystemUI::CTileAltitudeTool *tool = (EarthView::World::Spatial3D::SystemUI::CTileAltitudeTool*) tool_j;
					EarthView::World::Spatial3D::SystemUI::CTileAltitudeListener *pObjectX = (EarthView::World::Spatial3D::SystemUI::CTileAltitudeListener*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCTileAltitudeListenerProxy))
					{
						pObjectX->EarthView::World::Spatial3D::SystemUI::CTileAltitudeListener::onOperateEnd(tool);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_systemui_TileAltitudeListener_register_1onOperateEnd_1CTileAltitudeTool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCTileAltitudeListenerProxy *pObjectX = (JCTileAltitudeListenerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
					__env->ReleaseStringUTFChars(__method, pMethod);
					pObjectX->register_onOperateEnd_CTileAltitudeTool_callback(sMethod);
					if (pObjectX->getJavaReference() != NULL && sMethod != "")
					{
						EarthView::World::Core::GlobalReference *__gr = (EarthView::World::Core::GlobalReference *)pObjectX->getJavaReference();
						jobject __obj1 = __gr->getJObject();
						jclass __clazz1 = __env->GetObjectClass(__obj1);
						jmethodID __method = __env->GetMethodID(__clazz1,"onOperateEnd_CTileAltitudeTool_callback", "(J)V");
						__gr->setMethod(sMethod, __method);
					}
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_systemui_TileAltitudeListener_onOperateEnd_1CTileAltitudeTool_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong tool_j)
				{
					EarthView::World::Spatial3D::SystemUI::CTileAltitudeTool *tool = (EarthView::World::Spatial3D::SystemUI::CTileAltitudeTool*) tool_j;
					EarthView::World::Spatial3D::SystemUI::CTileAltitudeListener *pObjectX = (EarthView::World::Spatial3D::SystemUI::CTileAltitudeListener*) pObjXXXX;
					pObjectX->EarthView::World::Spatial3D::SystemUI::CTileAltitudeListener::onOperateEnd(tool);
				}
				class JCTileAltitudeToolProxy : public EarthView::World::Spatial3D::SystemUI::CTileAltitudeTool
				{
				 private:
				...
				public:
					JCTileAltitudeToolProxy(EarthView::World::Core::CNameValuePairList *pList) : CTileAltitudeTool(pList)
					{
					}
					ev_void unRegisterJavaReference()
					{
				...
				REGISTER_FACTORY_CLASS(JCTileAltitudeToolProxy);
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_systemui_TileAltitudeTool_getType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::SystemUI::CTileAltitudeTool *pObjectX = (EarthView::World::Spatial3D::SystemUI::CTileAltitudeTool*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCTileAltitudeToolProxy))
					{
						ev_uint32 __values1 = pObjectX->EarthView::World::Spatial3D::SystemUI::CTileAltitudeTool::getType();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_systemui_TileAltitudeTool_register_1getType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCTileAltitudeToolProxy *pObjectX = (JCTileAltitudeToolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
					__env->ReleaseStringUTFChars(__method, pMethod);
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_systemui_TileAltitudeTool_getType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::SystemUI::CTileAltitudeTool *pObjectX = (EarthView::World::Spatial3D::SystemUI::CTileAltitudeTool*) pObjXXXX;
					ev_uint32 __values1 = pObjectX->EarthView::World::Spatial3D::SystemUI::CTileAltitudeTool::getType();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_systemui_TileAltitudeTool_onDoubleClick_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint button_j, jint shift_j, jint x_j, jint y_j)
				{
					ev_int32 button = (ev_int32) button_j;
					ev_int32 shift = (ev_int32) shift_j;
					ev_int32 x = (ev_int32) x_j;
					ev_int32 y = (ev_int32) y_j;
					EarthView::World::Spatial3D::SystemUI::CTileAltitudeTool *pObjectX = (EarthView::World::Spatial3D::SystemUI::CTileAltitudeTool*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCTileAltitudeToolProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::SystemUI::CTileAltitudeTool::onDoubleClick(button, shift, x, y);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_systemui_TileAltitudeTool_register_1onDoubleClick_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCTileAltitudeToolProxy *pObjectX = (JCTileAltitudeToolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_systemui_TileAltitudeTool_onDoubleClick_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint button_j, jint shift_j, jint x_j, jint y_j)
				{
					ev_int32 button = (ev_int32) button_j;
					ev_int32 shift = (ev_int32) shift_j;
					ev_int32 x = (ev_int32) x_j;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_systemui_TileAltitudeTool_onMouseDown_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint button_j, jint shift_j, jint x_j, jint y_j)
				{
					ev_int32 button = (ev_int32) button_j;
					ev_int32 shift = (ev_int32) shift_j;
					ev_int32 x = (ev_int32) x_j;
					...
					if (typeid(*pObjectX) == typeid(JCTileAltitudeToolProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::SystemUI::CTileAltitudeTool::onMouseDown(button, shift, x, y);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_systemui_TileAltitudeTool_register_1onMouseDown_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCTileAltitudeToolProxy *pObjectX = (JCTileAltitudeToolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_systemui_TileAltitudeTool_onMouseDown_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint button_j, jint shift_j, jint x_j, jint y_j)
				{
					ev_int32 button = (ev_int32) button_j;
					ev_int32 shift = (ev_int32) shift_j;
					ev_int32 x = (ev_int32) x_j;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_systemui_TileAltitudeTool_onMouseUp_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint button_j, jint shift_j, jint x_j, jint y_j)
				{
					ev_int32 button = (ev_int32) button_j;
					ev_int32 shift = (ev_int32) shift_j;
					ev_int32 x = (ev_int32) x_j;
					...
					if (typeid(*pObjectX) == typeid(JCTileAltitudeToolProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::SystemUI::CTileAltitudeTool::onMouseUp(button, shift, x, y);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_systemui_TileAltitudeTool_register_1onMouseUp_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCTileAltitudeToolProxy *pObjectX = (JCTileAltitudeToolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_systemui_TileAltitudeTool_onMouseUp_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint button_j, jint shift_j, jint x_j, jint y_j)
				{
					ev_int32 button = (ev_int32) button_j;
					ev_int32 shift = (ev_int32) shift_j;
					ev_int32 x = (ev_int32) x_j;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_systemui_TileAltitudeTool_onMouseMove_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint button_j, jint shift_j, jint x_j, jint y_j)
				{
					ev_int32 button = (ev_int32) button_j;
					ev_int32 shift = (ev_int32) shift_j;
					ev_int32 x = (ev_int32) x_j;
					...
					if (typeid(*pObjectX) == typeid(JCTileAltitudeToolProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::SystemUI::CTileAltitudeTool::onMouseMove(button, shift, x, y);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_systemui_TileAltitudeTool_register_1onMouseMove_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCTileAltitudeToolProxy *pObjectX = (JCTileAltitudeToolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_systemui_TileAltitudeTool_onMouseMove_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint button_j, jint shift_j, jint x_j, jint y_j)
				{
					ev_int32 button = (ev_int32) button_j;
					ev_int32 shift = (ev_int32) shift_j;
					ev_int32 x = (ev_int32) x_j;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_systemui_TileAltitudeTool_run_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::SystemUI::CTileAltitudeTool *pObjectX = (EarthView::World::Spatial3D::SystemUI::CTileAltitudeTool*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCTileAltitudeToolProxy))
					{
						pObjectX->EarthView::World::Spatial3D::SystemUI::CTileAltitudeTool::run();
					}
					else
					{
						pObjectX->run();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_systemui_TileAltitudeTool_register_1run_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCTileAltitudeToolProxy *pObjectX = (JCTileAltitudeToolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_systemui_TileAltitudeTool_run_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::SystemUI::CTileAltitudeTool *pObjectX = (EarthView::World::Spatial3D::SystemUI::CTileAltitudeTool*) pObjXXXX;
					pObjectX->EarthView::World::Spatial3D::SystemUI::CTileAltitudeTool::run();
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_systemui_TileAltitudeTool_reset_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::SystemUI::CTileAltitudeTool *pObjectX = (EarthView::World::Spatial3D::SystemUI::CTileAltitudeTool*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCTileAltitudeToolProxy))
					{
						pObjectX->EarthView::World::Spatial3D::SystemUI::CTileAltitudeTool::reset();
					}
					else
					{
						pObjectX->reset();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_systemui_TileAltitudeTool_register_1reset_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCTileAltitudeToolProxy *pObjectX = (JCTileAltitudeToolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_systemui_TileAltitudeTool_reset_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::SystemUI::CTileAltitudeTool *pObjectX = (EarthView::World::Spatial3D::SystemUI::CTileAltitudeTool*) pObjXXXX;
					pObjectX->EarthView::World::Spatial3D::SystemUI::CTileAltitudeTool::reset();
				}
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_systemui_TileAltitudeTool_getPoylgon_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::SystemUI::CTileAltitudeTool *pObjectX = (EarthView::World::Spatial3D::SystemUI::CTileAltitudeTool*) pObjXXXX;
					const EarthView::World::Spatial::Geometry::CPolygon* __values1 = pObjectX->getPoylgon();
					jlong __values1_j = (jlong) __values1;
					return __values1_j;
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_systemui_TileAltitudeTool_setTerrainRangeMode_1TerrainRangeMode(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint m_j)
				{
					EarthView::World::Spatial3D::TerrainRangeMode m = (EarthView::World::Spatial3D::TerrainRangeMode) m_j;
					EarthView::World::Spatial3D::SystemUI::CTileAltitudeTool *pObjectX = (EarthView::World::Spatial3D::SystemUI::CTileAltitudeTool*) pObjXXXX;
					pObjectX->setTerrainRangeMode(m);
				}
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_systemui_TileAltitudeTool_getTileAltitudeListener_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::SystemUI::CTileAltitudeTool *pObjectX = (EarthView::World::Spatial3D::SystemUI::CTileAltitudeTool*) pObjXXXX;
					const EarthView::World::Spatial3D::SystemUI::CTileAltitudeListener* __values1 = pObjectX->getTileAltitudeListener();
					jlong __values1_j = (jlong) __values1;
					return __values1_j;
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_systemui_TileAltitudeTool_setTileAltitudeListener_1CTileAltitudeListener(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong ref_listener_j)
				{
					EarthView::World::Spatial3D::SystemUI::CTileAltitudeListener *ref_listener = (EarthView::World::Spatial3D::SystemUI::CTileAltitudeListener*) ref_listener_j;
					EarthView::World::Spatial3D::SystemUI::CTileAltitudeTool *pObjectX = (EarthView::World::Spatial3D::SystemUI::CTileAltitudeTool*) pObjXXXX;
					pObjectX->setTileAltitudeListener(ref_listener);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_systemui_TileAltitudeTool_register_1activate_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCTileAltitudeToolProxy *pObjectX = (JCTileAltitudeToolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_systemui_TileAltitudeTool_register_1deactivate_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCTileAltitudeToolProxy *pObjectX = (JCTileAltitudeToolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_systemui_TileAltitudeTool_register_1getCursor_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCTileAltitudeToolProxy *pObjectX = (JCTileAltitudeToolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_systemui_TileAltitudeTool_register_1onContextMenu_1ev_1int32_1ev_1int32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCTileAltitudeToolProxy *pObjectX = (JCTileAltitudeToolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_systemui_TileAltitudeTool_register_1onDoubleClick_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCTileAltitudeToolProxy *pObjectX = (JCTileAltitudeToolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_systemui_TileAltitudeTool_register_1onKeyDown_1ev_1int32_1ev_1int32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCTileAltitudeToolProxy *pObjectX = (JCTileAltitudeToolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_systemui_TileAltitudeTool_register_1onKeyUp_1ev_1int32_1ev_1int32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCTileAltitudeToolProxy *pObjectX = (JCTileAltitudeToolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_systemui_TileAltitudeTool_register_1onMouseWheel_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCTileAltitudeToolProxy *pObjectX = (JCTileAltitudeToolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_systemui_TileAltitudeTool_register_1onTouchDown_1MotionEvent(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCTileAltitudeToolProxy *pObjectX = (JCTileAltitudeToolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_systemui_TileAltitudeTool_register_1onTouchUp_1MotionEvent(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCTileAltitudeToolProxy *pObjectX = (JCTileAltitudeToolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_systemui_TileAltitudeTool_register_1onTouchMove_1MotionEvent(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCTileAltitudeToolProxy *pObjectX = (JCTileAltitudeToolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_systemui_TileAltitudeTool_register_1getToolBarType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCTileAltitudeToolProxy *pObjectX = (JCTileAltitudeToolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_systemui_TileAltitudeTool_register_1getName_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCTileAltitudeToolProxy *pObjectX = (JCTileAltitudeToolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_systemui_TileAltitudeTool_register_1getCategory_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCTileAltitudeToolProxy *pObjectX = (JCTileAltitudeToolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_systemui_TileAltitudeTool_register_1getToolTip_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCTileAltitudeToolProxy *pObjectX = (JCTileAltitudeToolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_systemui_TileAltitudeTool_register_1getIcon_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCTileAltitudeToolProxy *pObjectX = (JCTileAltitudeToolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_systemui_TileAltitudeTool_register_1isCheckable_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCTileAltitudeToolProxy *pObjectX = (JCTileAltitudeToolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_systemui_TileAltitudeTool_register_1onClicked_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCTileAltitudeToolProxy *pObjectX = (JCTileAltitudeToolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_systemui_TileAltitudeTool_register_1getChecked_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCTileAltitudeToolProxy *pObjectX = (JCTileAltitudeToolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_systemui_TileAltitudeTool_register_1setChecked_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCTileAltitudeToolProxy *pObjectX = (JCTileAltitudeToolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_systemui_TileAltitudeTool_register_1getEnabled_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCTileAltitudeToolProxy *pObjectX = (JCTileAltitudeToolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_systemui_TileAltitudeTool_register_1setEnabled_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCTileAltitudeToolProxy *pObjectX = (JCTileAltitudeToolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_systemui_TileAltitudeTool_register_1create_1ISpatialControl(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCTileAltitudeToolProxy *pObjectX = (JCTileAltitudeToolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_systemui_TileAltitudeTool_register_1update_1CEvent(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCTileAltitudeToolProxy *pObjectX = (JCTileAltitudeToolProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
