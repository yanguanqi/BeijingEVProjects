...
class JCEditingLayerSetProxy : public CEditingLayerSet
{
 private:
...
public:
	JCEditingLayerSetProxy(EarthView::World::Core::CNameValuePairList *pList) : CEditingLayerSet(pList)
	{
	}
...
protected:
	C_DISABLE_COPY(JCEditingLayerSetProxy)
public:
...
REGISTER_FACTORY_CLASS(JCEditingLayerSetProxy);
extern "C" JNIEXPORT jlong JNICALL Java_global_EditingLayerSet_getToolBarType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CEditingLayerSet *pObjectX = (CEditingLayerSet*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCEditingLayerSetProxy))
	{
		ev_uint32 __values1 = pObjectX->CEditingLayerSet::getToolBarType();
...
extern "C" JNIEXPORT void JNICALL Java_global_EditingLayerSet_register_1getToolBarType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCEditingLayerSetProxy *pObjectX = (JCEditingLayerSetProxy*) pObjXXXX;
...
extern "C" JNIEXPORT jlong JNICALL Java_global_EditingLayerSet_getToolBarType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CEditingLayerSet *pObjectX = (CEditingLayerSet*) pObjXXXX;
	ev_uint32 __values1 = pObjectX->CEditingLayerSet::getToolBarType();
	jlong __values1_j = (jlong) __values1;
...
extern "C" JNIEXPORT jlong JNICALL Java_global_EditingLayerSet_getType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CEditingLayerSet *pObjectX = (CEditingLayerSet*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCEditingLayerSetProxy))
	{
		ev_uint32 __values1 = pObjectX->CEditingLayerSet::getType();
		jlong __values1_j = (jlong) __values1;
		return __values1_j;
	}
	else
...
extern "C" JNIEXPORT void JNICALL Java_global_EditingLayerSet_register_1getType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCEditingLayerSetProxy *pObjectX = (JCEditingLayerSetProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jlong JNICALL Java_global_EditingLayerSet_getType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CEditingLayerSet *pObjectX = (CEditingLayerSet*) pObjXXXX;
	ev_uint32 __values1 = pObjectX->CEditingLayerSet::getType();
	jlong __values1_j = (jlong) __values1;
...
extern "C" JNIEXPORT jstring JNICALL Java_global_EditingLayerSet_getName_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CEditingLayerSet *pObjectX = (CEditingLayerSet*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCEditingLayerSetProxy))
	{
		EVString __values1 = pObjectX->CEditingLayerSet::getName();
...
extern "C" JNIEXPORT void JNICALL Java_global_EditingLayerSet_register_1getName_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCEditingLayerSetProxy *pObjectX = (JCEditingLayerSetProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jstring JNICALL Java_global_EditingLayerSet_getName_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CEditingLayerSet *pObjectX = (CEditingLayerSet*) pObjXXXX;
	EVString __values1 = pObjectX->CEditingLayerSet::getName();
	EarthView::World::Core::ev_wstring valuesw1 = __values1;
...
extern "C" JNIEXPORT jstring JNICALL Java_global_EditingLayerSet_getCategory_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CEditingLayerSet *pObjectX = (CEditingLayerSet*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCEditingLayerSetProxy))
	{
		EVString __values1 = pObjectX->CEditingLayerSet::getCategory();
		EarthView::World::Core::ev_wstring valuesw1 = __values1;
		jstring __values1_j = __env->NewString((const jchar*)valuesw1.getString(), valuesw1.size());
		return __values1_j;
	}
...
extern "C" JNIEXPORT void JNICALL Java_global_EditingLayerSet_register_1getCategory_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCEditingLayerSetProxy *pObjectX = (JCEditingLayerSetProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jstring JNICALL Java_global_EditingLayerSet_getCategory_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CEditingLayerSet *pObjectX = (CEditingLayerSet*) pObjXXXX;
	EVString __values1 = pObjectX->CEditingLayerSet::getCategory();
	EarthView::World::Core::ev_wstring valuesw1 = __values1;
...
extern "C" JNIEXPORT jstring JNICALL Java_global_EditingLayerSet_getToolTip_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CEditingLayerSet *pObjectX = (CEditingLayerSet*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCEditingLayerSetProxy))
	{
		EVString __values1 = pObjectX->CEditingLayerSet::getToolTip();
		EarthView::World::Core::ev_wstring valuesw1 = __values1;
		jstring __values1_j = __env->NewString((const jchar*)valuesw1.getString(), valuesw1.size());
		return __values1_j;
	}
...
extern "C" JNIEXPORT void JNICALL Java_global_EditingLayerSet_register_1getToolTip_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCEditingLayerSetProxy *pObjectX = (JCEditingLayerSetProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jstring JNICALL Java_global_EditingLayerSet_getToolTip_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CEditingLayerSet *pObjectX = (CEditingLayerSet*) pObjXXXX;
	EVString __values1 = pObjectX->CEditingLayerSet::getToolTip();
	EarthView::World::Core::ev_wstring valuesw1 = __values1;
...
extern "C" JNIEXPORT jlong JNICALL Java_global_EditingLayerSet_getIcon_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CEditingLayerSet *pObjectX = (CEditingLayerSet*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCEditingLayerSetProxy))
	{
		EarthView::World::Display::IBitmap* __values1 = pObjectX->CEditingLayerSet::getIcon();
		jlong __values1_j = (jlong) __values1;
		return __values1_j;
	}
	else
...
extern "C" JNIEXPORT void JNICALL Java_global_EditingLayerSet_register_1getIcon_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCEditingLayerSetProxy *pObjectX = (JCEditingLayerSetProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jlong JNICALL Java_global_EditingLayerSet_getIcon_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CEditingLayerSet *pObjectX = (CEditingLayerSet*) pObjXXXX;
	EarthView::World::Display::IBitmap* __values1 = pObjectX->CEditingLayerSet::getIcon();
	jlong __values1_j = (jlong) __values1;
...
extern "C" JNIEXPORT jboolean JNICALL Java_global_EditingLayerSet_isCheckable_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CEditingLayerSet *pObjectX = (CEditingLayerSet*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCEditingLayerSetProxy))
	{
		ev_bool __values1 = pObjectX->CEditingLayerSet::isCheckable();
...
extern "C" JNIEXPORT void JNICALL Java_global_EditingLayerSet_register_1isCheckable_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCEditingLayerSetProxy *pObjectX = (JCEditingLayerSetProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jboolean JNICALL Java_global_EditingLayerSet_isCheckable_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CEditingLayerSet *pObjectX = (CEditingLayerSet*) pObjXXXX;
	ev_bool __values1 = pObjectX->CEditingLayerSet::isCheckable();
	jboolean __values1_j = (jboolean)__values1;
...
extern "C" JNIEXPORT void JNICALL Java_global_EditingLayerSet_onClicked_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	CEditingLayerSet *pObjectX = (CEditingLayerSet*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCEditingLayerSetProxy))
	{
		pObjectX->CEditingLayerSet::onClicked();
	}
	else
	{
		pObjectX->onClicked();
...
extern "C" JNIEXPORT void JNICALL Java_global_EditingLayerSet_register_1onClicked_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCEditingLayerSetProxy *pObjectX = (JCEditingLayerSetProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT void JNICALL Java_global_EditingLayerSet_onClicked_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	CEditingLayerSet *pObjectX = (CEditingLayerSet*) pObjXXXX;
	pObjectX->CEditingLayerSet::onClicked();
}
extern "C" JNIEXPORT jboolean JNICALL Java_global_EditingLayerSet_getChecked_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CEditingLayerSet *pObjectX = (CEditingLayerSet*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCEditingLayerSetProxy))
	{
		ev_bool __values1 = pObjectX->CEditingLayerSet::getChecked();
		jboolean __values1_j = (jboolean)__values1;
		return __values1_j;
	}
	else
...
extern "C" JNIEXPORT void JNICALL Java_global_EditingLayerSet_register_1getChecked_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCEditingLayerSetProxy *pObjectX = (JCEditingLayerSetProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jboolean JNICALL Java_global_EditingLayerSet_getChecked_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CEditingLayerSet *pObjectX = (CEditingLayerSet*) pObjXXXX;
	ev_bool __values1 = pObjectX->CEditingLayerSet::getChecked();
	jboolean __values1_j = (jboolean)__values1;
...
extern "C" JNIEXPORT void JNICALL Java_global_EditingLayerSet_setChecked_1ev_1bool(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean checked_j)
{
	ev_bool checked = (ev_bool) checked_j;
	CEditingLayerSet *pObjectX = (CEditingLayerSet*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCEditingLayerSetProxy))
	{
		pObjectX->CEditingLayerSet::setChecked(checked);
	}
	else
	{
...
extern "C" JNIEXPORT void JNICALL Java_global_EditingLayerSet_register_1setChecked_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCEditingLayerSetProxy *pObjectX = (JCEditingLayerSetProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT void JNICALL Java_global_EditingLayerSet_setChecked_1ev_1bool_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean checked_j)
{
	ev_bool checked = (ev_bool) checked_j;
	CEditingLayerSet *pObjectX = (CEditingLayerSet*) pObjXXXX;
	pObjectX->CEditingLayerSet::setChecked(checked);
}
extern "C" JNIEXPORT jboolean JNICALL Java_global_EditingLayerSet_getEnabled_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CEditingLayerSet *pObjectX = (CEditingLayerSet*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCEditingLayerSetProxy))
	{
		ev_bool __values1 = pObjectX->CEditingLayerSet::getEnabled();
		jboolean __values1_j = (jboolean)__values1;
		return __values1_j;
	}
	else
...
extern "C" JNIEXPORT void JNICALL Java_global_EditingLayerSet_register_1getEnabled_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCEditingLayerSetProxy *pObjectX = (JCEditingLayerSetProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jboolean JNICALL Java_global_EditingLayerSet_getEnabled_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CEditingLayerSet *pObjectX = (CEditingLayerSet*) pObjXXXX;
	ev_bool __values1 = pObjectX->CEditingLayerSet::getEnabled();
	jboolean __values1_j = (jboolean)__values1;
...
extern "C" JNIEXPORT void JNICALL Java_global_EditingLayerSet_setEnabled_1ev_1bool(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean enabled_j)
{
	ev_bool enabled = (ev_bool) enabled_j;
	CEditingLayerSet *pObjectX = (CEditingLayerSet*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCEditingLayerSetProxy))
	{
		pObjectX->CEditingLayerSet::setEnabled(enabled);
	}
	else
	{
...
extern "C" JNIEXPORT void JNICALL Java_global_EditingLayerSet_register_1setEnabled_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCEditingLayerSetProxy *pObjectX = (JCEditingLayerSetProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT void JNICALL Java_global_EditingLayerSet_setEnabled_1ev_1bool_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean enabled_j)
{
	ev_bool enabled = (ev_bool) enabled_j;
	CEditingLayerSet *pObjectX = (CEditingLayerSet*) pObjXXXX;
	pObjectX->CEditingLayerSet::setEnabled(enabled);
}
extern "C" JNIEXPORT void JNICALL Java_global_EditingLayerSet_create_1ISpatialControl(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong ref_ctrl_j)
{
	EarthView::World::Spatial::Atlas::ISpatialControl *ref_ctrl = (EarthView::World::Spatial::Atlas::ISpatialControl*) ref_ctrl_j;
	CEditingLayerSet *pObjectX = (CEditingLayerSet*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCEditingLayerSetProxy))
	{
		pObjectX->CEditingLayerSet::create(ref_ctrl);
	}
	else
	{
...
extern "C" JNIEXPORT void JNICALL Java_global_EditingLayerSet_register_1create_1ISpatialControl(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCEditingLayerSetProxy *pObjectX = (JCEditingLayerSetProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT void JNICALL Java_global_EditingLayerSet_create_1ISpatialControl_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong ref_ctrl_j)
{
	EarthView::World::Spatial::Atlas::ISpatialControl *ref_ctrl = (EarthView::World::Spatial::Atlas::ISpatialControl*) ref_ctrl_j;
	CEditingLayerSet *pObjectX = (CEditingLayerSet*) pObjXXXX;
	pObjectX->CEditingLayerSet::create(ref_ctrl);
}
extern "C" JNIEXPORT jboolean JNICALL Java_global_EditingLayerSet_update_1CEvent(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong e_j)
{
	EarthView::World::Core::CEvent *e = (EarthView::World::Core::CEvent*) e_j;
	CEditingLayerSet *pObjectX = (CEditingLayerSet*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCEditingLayerSetProxy))
	{
		ev_bool __values1 = pObjectX->CEditingLayerSet::update(e);
		jboolean __values1_j = (jboolean)__values1;
		return __values1_j;
	}
	else
...
extern "C" JNIEXPORT void JNICALL Java_global_EditingLayerSet_register_1update_1CEvent(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCEditingLayerSetProxy *pObjectX = (JCEditingLayerSetProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jboolean JNICALL Java_global_EditingLayerSet_update_1CEvent_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong e_j)
{
	EarthView::World::Core::CEvent *e = (EarthView::World::Core::CEvent*) e_j;
	CEditingLayerSet *pObjectX = (CEditingLayerSet*) pObjXXXX;
	ev_bool __values1 = pObjectX->CEditingLayerSet::update(e);
...
extern "C" JNIEXPORT jlong JNICALL Java_global_EditingLayerSet_getEntryCount_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CEditingLayerSet *pObjectX = (CEditingLayerSet*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCEditingLayerSetProxy))
	{
		ev_uint32 __values1 = pObjectX->CEditingLayerSet::getEntryCount();
		jlong __values1_j = (jlong) __values1;
		return __values1_j;
	}
	else
...
extern "C" JNIEXPORT void JNICALL Java_global_EditingLayerSet_register_1getEntryCount_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCEditingLayerSetProxy *pObjectX = (JCEditingLayerSetProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jlong JNICALL Java_global_EditingLayerSet_getEntryCount_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CEditingLayerSet *pObjectX = (CEditingLayerSet*) pObjXXXX;
	ev_uint32 __values1 = pObjectX->CEditingLayerSet::getEntryCount();
	jlong __values1_j = (jlong) __values1;
...
extern "C" JNIEXPORT jstring JNICALL Java_global_EditingLayerSet_getEntry_1ev_1uint32(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong index_j)
{
	ev_uint32 index = (ev_uint32) index_j;
	const 	CEditingLayerSet *pObjectX = (CEditingLayerSet*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCEditingLayerSetProxy))
	{
		EVString __values1 = pObjectX->CEditingLayerSet::getEntry(index);
		EarthView::World::Core::ev_wstring valuesw1 = __values1;
		jstring __values1_j = __env->NewString((const jchar*)valuesw1.getString(), valuesw1.size());
		return __values1_j;
	}
...
extern "C" JNIEXPORT void JNICALL Java_global_EditingLayerSet_register_1getEntry_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCEditingLayerSetProxy *pObjectX = (JCEditingLayerSetProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jstring JNICALL Java_global_EditingLayerSet_getEntry_1ev_1uint32_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong index_j)
{
	ev_uint32 index = (ev_uint32) index_j;
	const 	CEditingLayerSet *pObjectX = (CEditingLayerSet*) pObjXXXX;
	EVString __values1 = pObjectX->CEditingLayerSet::getEntry(index);
...
extern "C" JNIEXPORT jint JNICALL Java_global_EditingLayerSet_getCurrentIndex_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CEditingLayerSet *pObjectX = (CEditingLayerSet*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCEditingLayerSetProxy))
	{
		ev_int32 __values1 = pObjectX->CEditingLayerSet::getCurrentIndex();
...
extern "C" JNIEXPORT void JNICALL Java_global_EditingLayerSet_register_1getCurrentIndex_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCEditingLayerSetProxy *pObjectX = (JCEditingLayerSetProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jint JNICALL Java_global_EditingLayerSet_getCurrentIndex_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CEditingLayerSet *pObjectX = (CEditingLayerSet*) pObjXXXX;
	ev_int32 __values1 = pObjectX->CEditingLayerSet::getCurrentIndex();
	jint __values1_j = (jint)__values1;
...
extern "C" JNIEXPORT void JNICALL Java_global_EditingLayerSet_currentIndexChanged_1ev_1uint32(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong index_j)
{
	ev_uint32 index = (ev_uint32) index_j;
	CEditingLayerSet *pObjectX = (CEditingLayerSet*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCEditingLayerSetProxy))
	{
		pObjectX->CEditingLayerSet::currentIndexChanged(index);
	}
	else
	{
...
extern "C" JNIEXPORT void JNICALL Java_global_EditingLayerSet_register_1currentIndexChanged_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCEditingLayerSetProxy *pObjectX = (JCEditingLayerSetProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT void JNICALL Java_global_EditingLayerSet_currentIndexChanged_1ev_1uint32_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong index_j)
{
	ev_uint32 index = (ev_uint32) index_j;
	CEditingLayerSet *pObjectX = (CEditingLayerSet*) pObjXXXX;
	pObjectX->CEditingLayerSet::currentIndexChanged(index);
}
extern "C" JNIEXPORT jlong JNICALL Java_global_EditingLayerSet_getLayer_1ev_1uint32(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong index_j)
{
	ev_uint32 index = (ev_uint32) index_j;
	const 	CEditingLayerSet *pObjectX = (CEditingLayerSet*) pObjXXXX;
...
extern "C" JNIEXPORT void JNICALL Java_global_EditingLayerSet_register_1getWidth_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCEditingLayerSetProxy *pObjectX = (JCEditingLayerSetProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
