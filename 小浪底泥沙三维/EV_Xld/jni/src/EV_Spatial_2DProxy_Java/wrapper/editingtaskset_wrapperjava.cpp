...
class JCEditingTaskSetProxy : public CEditingTaskSet
{
 private:
...
public:
	JCEditingTaskSetProxy(EarthView::World::Core::CNameValuePairList *pList) : CEditingTaskSet(pList)
	{
	}
...
protected:
	C_DISABLE_COPY(JCEditingTaskSetProxy)
public:
...
REGISTER_FACTORY_CLASS(JCEditingTaskSetProxy);
extern "C" JNIEXPORT jlong JNICALL Java_global_EditingTaskSet_getToolBarType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CEditingTaskSet *pObjectX = (CEditingTaskSet*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCEditingTaskSetProxy))
	{
		ev_uint32 __values1 = pObjectX->CEditingTaskSet::getToolBarType();
...
extern "C" JNIEXPORT void JNICALL Java_global_EditingTaskSet_register_1getToolBarType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCEditingTaskSetProxy *pObjectX = (JCEditingTaskSetProxy*) pObjXXXX;
...
extern "C" JNIEXPORT jlong JNICALL Java_global_EditingTaskSet_getToolBarType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CEditingTaskSet *pObjectX = (CEditingTaskSet*) pObjXXXX;
	ev_uint32 __values1 = pObjectX->CEditingTaskSet::getToolBarType();
	jlong __values1_j = (jlong) __values1;
...
extern "C" JNIEXPORT jlong JNICALL Java_global_EditingTaskSet_getType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CEditingTaskSet *pObjectX = (CEditingTaskSet*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCEditingTaskSetProxy))
	{
		ev_uint32 __values1 = pObjectX->CEditingTaskSet::getType();
		jlong __values1_j = (jlong) __values1;
		return __values1_j;
	}
	else
...
extern "C" JNIEXPORT void JNICALL Java_global_EditingTaskSet_register_1getType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCEditingTaskSetProxy *pObjectX = (JCEditingTaskSetProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jlong JNICALL Java_global_EditingTaskSet_getType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CEditingTaskSet *pObjectX = (CEditingTaskSet*) pObjXXXX;
	ev_uint32 __values1 = pObjectX->CEditingTaskSet::getType();
	jlong __values1_j = (jlong) __values1;
...
extern "C" JNIEXPORT jstring JNICALL Java_global_EditingTaskSet_getName_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CEditingTaskSet *pObjectX = (CEditingTaskSet*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCEditingTaskSetProxy))
	{
		EVString __values1 = pObjectX->CEditingTaskSet::getName();
...
extern "C" JNIEXPORT void JNICALL Java_global_EditingTaskSet_register_1getName_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCEditingTaskSetProxy *pObjectX = (JCEditingTaskSetProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jstring JNICALL Java_global_EditingTaskSet_getName_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CEditingTaskSet *pObjectX = (CEditingTaskSet*) pObjXXXX;
	EVString __values1 = pObjectX->CEditingTaskSet::getName();
	EarthView::World::Core::ev_wstring valuesw1 = __values1;
...
extern "C" JNIEXPORT jstring JNICALL Java_global_EditingTaskSet_getCategory_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CEditingTaskSet *pObjectX = (CEditingTaskSet*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCEditingTaskSetProxy))
	{
		EVString __values1 = pObjectX->CEditingTaskSet::getCategory();
		EarthView::World::Core::ev_wstring valuesw1 = __values1;
		jstring __values1_j = __env->NewString((const jchar*)valuesw1.getString(), valuesw1.size());
		return __values1_j;
	}
...
extern "C" JNIEXPORT void JNICALL Java_global_EditingTaskSet_register_1getCategory_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCEditingTaskSetProxy *pObjectX = (JCEditingTaskSetProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jstring JNICALL Java_global_EditingTaskSet_getCategory_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CEditingTaskSet *pObjectX = (CEditingTaskSet*) pObjXXXX;
	EVString __values1 = pObjectX->CEditingTaskSet::getCategory();
	EarthView::World::Core::ev_wstring valuesw1 = __values1;
...
extern "C" JNIEXPORT jstring JNICALL Java_global_EditingTaskSet_getToolTip_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CEditingTaskSet *pObjectX = (CEditingTaskSet*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCEditingTaskSetProxy))
	{
		EVString __values1 = pObjectX->CEditingTaskSet::getToolTip();
		EarthView::World::Core::ev_wstring valuesw1 = __values1;
		jstring __values1_j = __env->NewString((const jchar*)valuesw1.getString(), valuesw1.size());
		return __values1_j;
	}
...
extern "C" JNIEXPORT void JNICALL Java_global_EditingTaskSet_register_1getToolTip_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCEditingTaskSetProxy *pObjectX = (JCEditingTaskSetProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jstring JNICALL Java_global_EditingTaskSet_getToolTip_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CEditingTaskSet *pObjectX = (CEditingTaskSet*) pObjXXXX;
	EVString __values1 = pObjectX->CEditingTaskSet::getToolTip();
	EarthView::World::Core::ev_wstring valuesw1 = __values1;
...
extern "C" JNIEXPORT jlong JNICALL Java_global_EditingTaskSet_getIcon_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CEditingTaskSet *pObjectX = (CEditingTaskSet*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCEditingTaskSetProxy))
	{
		EarthView::World::Display::IBitmap* __values1 = pObjectX->CEditingTaskSet::getIcon();
		jlong __values1_j = (jlong) __values1;
		return __values1_j;
	}
	else
...
extern "C" JNIEXPORT void JNICALL Java_global_EditingTaskSet_register_1getIcon_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCEditingTaskSetProxy *pObjectX = (JCEditingTaskSetProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jlong JNICALL Java_global_EditingTaskSet_getIcon_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CEditingTaskSet *pObjectX = (CEditingTaskSet*) pObjXXXX;
	EarthView::World::Display::IBitmap* __values1 = pObjectX->CEditingTaskSet::getIcon();
	jlong __values1_j = (jlong) __values1;
...
extern "C" JNIEXPORT jboolean JNICALL Java_global_EditingTaskSet_isCheckable_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CEditingTaskSet *pObjectX = (CEditingTaskSet*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCEditingTaskSetProxy))
	{
		ev_bool __values1 = pObjectX->CEditingTaskSet::isCheckable();
...
extern "C" JNIEXPORT void JNICALL Java_global_EditingTaskSet_register_1isCheckable_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCEditingTaskSetProxy *pObjectX = (JCEditingTaskSetProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jboolean JNICALL Java_global_EditingTaskSet_isCheckable_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CEditingTaskSet *pObjectX = (CEditingTaskSet*) pObjXXXX;
	ev_bool __values1 = pObjectX->CEditingTaskSet::isCheckable();
	jboolean __values1_j = (jboolean)__values1;
...
extern "C" JNIEXPORT void JNICALL Java_global_EditingTaskSet_onClicked_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	CEditingTaskSet *pObjectX = (CEditingTaskSet*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCEditingTaskSetProxy))
	{
		pObjectX->CEditingTaskSet::onClicked();
	}
	else
	{
		pObjectX->onClicked();
...
extern "C" JNIEXPORT void JNICALL Java_global_EditingTaskSet_register_1onClicked_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCEditingTaskSetProxy *pObjectX = (JCEditingTaskSetProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT void JNICALL Java_global_EditingTaskSet_onClicked_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	CEditingTaskSet *pObjectX = (CEditingTaskSet*) pObjXXXX;
	pObjectX->CEditingTaskSet::onClicked();
}
extern "C" JNIEXPORT jboolean JNICALL Java_global_EditingTaskSet_getChecked_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CEditingTaskSet *pObjectX = (CEditingTaskSet*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCEditingTaskSetProxy))
	{
		ev_bool __values1 = pObjectX->CEditingTaskSet::getChecked();
		jboolean __values1_j = (jboolean)__values1;
		return __values1_j;
	}
	else
...
extern "C" JNIEXPORT void JNICALL Java_global_EditingTaskSet_register_1getChecked_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCEditingTaskSetProxy *pObjectX = (JCEditingTaskSetProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jboolean JNICALL Java_global_EditingTaskSet_getChecked_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CEditingTaskSet *pObjectX = (CEditingTaskSet*) pObjXXXX;
	ev_bool __values1 = pObjectX->CEditingTaskSet::getChecked();
	jboolean __values1_j = (jboolean)__values1;
...
extern "C" JNIEXPORT void JNICALL Java_global_EditingTaskSet_setChecked_1ev_1bool(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean checked_j)
{
	ev_bool checked = (ev_bool) checked_j;
	CEditingTaskSet *pObjectX = (CEditingTaskSet*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCEditingTaskSetProxy))
	{
		pObjectX->CEditingTaskSet::setChecked(checked);
	}
	else
	{
...
extern "C" JNIEXPORT void JNICALL Java_global_EditingTaskSet_register_1setChecked_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCEditingTaskSetProxy *pObjectX = (JCEditingTaskSetProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT void JNICALL Java_global_EditingTaskSet_setChecked_1ev_1bool_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean checked_j)
{
	ev_bool checked = (ev_bool) checked_j;
	CEditingTaskSet *pObjectX = (CEditingTaskSet*) pObjXXXX;
	pObjectX->CEditingTaskSet::setChecked(checked);
}
extern "C" JNIEXPORT jboolean JNICALL Java_global_EditingTaskSet_getEnabled_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CEditingTaskSet *pObjectX = (CEditingTaskSet*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCEditingTaskSetProxy))
	{
		ev_bool __values1 = pObjectX->CEditingTaskSet::getEnabled();
		jboolean __values1_j = (jboolean)__values1;
		return __values1_j;
	}
	else
...
extern "C" JNIEXPORT void JNICALL Java_global_EditingTaskSet_register_1getEnabled_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCEditingTaskSetProxy *pObjectX = (JCEditingTaskSetProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jboolean JNICALL Java_global_EditingTaskSet_getEnabled_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CEditingTaskSet *pObjectX = (CEditingTaskSet*) pObjXXXX;
	ev_bool __values1 = pObjectX->CEditingTaskSet::getEnabled();
	jboolean __values1_j = (jboolean)__values1;
...
extern "C" JNIEXPORT void JNICALL Java_global_EditingTaskSet_setEnabled_1ev_1bool(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean enabled_j)
{
	ev_bool enabled = (ev_bool) enabled_j;
	CEditingTaskSet *pObjectX = (CEditingTaskSet*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCEditingTaskSetProxy))
	{
		pObjectX->CEditingTaskSet::setEnabled(enabled);
	}
	else
	{
...
extern "C" JNIEXPORT void JNICALL Java_global_EditingTaskSet_register_1setEnabled_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCEditingTaskSetProxy *pObjectX = (JCEditingTaskSetProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT void JNICALL Java_global_EditingTaskSet_setEnabled_1ev_1bool_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean enabled_j)
{
	ev_bool enabled = (ev_bool) enabled_j;
	CEditingTaskSet *pObjectX = (CEditingTaskSet*) pObjXXXX;
	pObjectX->CEditingTaskSet::setEnabled(enabled);
}
extern "C" JNIEXPORT void JNICALL Java_global_EditingTaskSet_create_1ISpatialControl(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong ref_ctrl_j)
{
	EarthView::World::Spatial::Atlas::ISpatialControl *ref_ctrl = (EarthView::World::Spatial::Atlas::ISpatialControl*) ref_ctrl_j;
	CEditingTaskSet *pObjectX = (CEditingTaskSet*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCEditingTaskSetProxy))
	{
		pObjectX->CEditingTaskSet::create(ref_ctrl);
	}
	else
	{
...
extern "C" JNIEXPORT void JNICALL Java_global_EditingTaskSet_register_1create_1ISpatialControl(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCEditingTaskSetProxy *pObjectX = (JCEditingTaskSetProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT void JNICALL Java_global_EditingTaskSet_create_1ISpatialControl_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong ref_ctrl_j)
{
	EarthView::World::Spatial::Atlas::ISpatialControl *ref_ctrl = (EarthView::World::Spatial::Atlas::ISpatialControl*) ref_ctrl_j;
	CEditingTaskSet *pObjectX = (CEditingTaskSet*) pObjXXXX;
	pObjectX->CEditingTaskSet::create(ref_ctrl);
}
extern "C" JNIEXPORT jboolean JNICALL Java_global_EditingTaskSet_update_1CEvent(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong e_j)
{
	EarthView::World::Core::CEvent *e = (EarthView::World::Core::CEvent*) e_j;
	CEditingTaskSet *pObjectX = (CEditingTaskSet*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCEditingTaskSetProxy))
	{
		ev_bool __values1 = pObjectX->CEditingTaskSet::update(e);
		jboolean __values1_j = (jboolean)__values1;
		return __values1_j;
	}
	else
...
extern "C" JNIEXPORT void JNICALL Java_global_EditingTaskSet_register_1update_1CEvent(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCEditingTaskSetProxy *pObjectX = (JCEditingTaskSetProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jboolean JNICALL Java_global_EditingTaskSet_update_1CEvent_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong e_j)
{
	EarthView::World::Core::CEvent *e = (EarthView::World::Core::CEvent*) e_j;
	CEditingTaskSet *pObjectX = (CEditingTaskSet*) pObjXXXX;
	ev_bool __values1 = pObjectX->CEditingTaskSet::update(e);
...
extern "C" JNIEXPORT jlong JNICALL Java_global_EditingTaskSet_getEntryCount_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CEditingTaskSet *pObjectX = (CEditingTaskSet*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCEditingTaskSetProxy))
	{
		ev_uint32 __values1 = pObjectX->CEditingTaskSet::getEntryCount();
		jlong __values1_j = (jlong) __values1;
		return __values1_j;
	}
	else
...
extern "C" JNIEXPORT void JNICALL Java_global_EditingTaskSet_register_1getEntryCount_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCEditingTaskSetProxy *pObjectX = (JCEditingTaskSetProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jlong JNICALL Java_global_EditingTaskSet_getEntryCount_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CEditingTaskSet *pObjectX = (CEditingTaskSet*) pObjXXXX;
	ev_uint32 __values1 = pObjectX->CEditingTaskSet::getEntryCount();
	jlong __values1_j = (jlong) __values1;
...
extern "C" JNIEXPORT jstring JNICALL Java_global_EditingTaskSet_getEntry_1ev_1uint32(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong index_j)
{
	ev_uint32 index = (ev_uint32) index_j;
	const 	CEditingTaskSet *pObjectX = (CEditingTaskSet*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCEditingTaskSetProxy))
	{
		EVString __values1 = pObjectX->CEditingTaskSet::getEntry(index);
		EarthView::World::Core::ev_wstring valuesw1 = __values1;
		jstring __values1_j = __env->NewString((const jchar*)valuesw1.getString(), valuesw1.size());
		return __values1_j;
	}
...
extern "C" JNIEXPORT void JNICALL Java_global_EditingTaskSet_register_1getEntry_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCEditingTaskSetProxy *pObjectX = (JCEditingTaskSetProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jstring JNICALL Java_global_EditingTaskSet_getEntry_1ev_1uint32_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong index_j)
{
	ev_uint32 index = (ev_uint32) index_j;
	const 	CEditingTaskSet *pObjectX = (CEditingTaskSet*) pObjXXXX;
	EVString __values1 = pObjectX->CEditingTaskSet::getEntry(index);
...
extern "C" JNIEXPORT jint JNICALL Java_global_EditingTaskSet_getCurrentIndex_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CEditingTaskSet *pObjectX = (CEditingTaskSet*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCEditingTaskSetProxy))
	{
		ev_int32 __values1 = pObjectX->CEditingTaskSet::getCurrentIndex();
...
extern "C" JNIEXPORT void JNICALL Java_global_EditingTaskSet_register_1getCurrentIndex_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCEditingTaskSetProxy *pObjectX = (JCEditingTaskSetProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jint JNICALL Java_global_EditingTaskSet_getCurrentIndex_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CEditingTaskSet *pObjectX = (CEditingTaskSet*) pObjXXXX;
	ev_int32 __values1 = pObjectX->CEditingTaskSet::getCurrentIndex();
	jint __values1_j = (jint)__values1;
...
extern "C" JNIEXPORT void JNICALL Java_global_EditingTaskSet_currentIndexChanged_1ev_1uint32(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong index_j)
{
	ev_uint32 index = (ev_uint32) index_j;
	CEditingTaskSet *pObjectX = (CEditingTaskSet*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCEditingTaskSetProxy))
	{
		pObjectX->CEditingTaskSet::currentIndexChanged(index);
	}
	else
	{
...
extern "C" JNIEXPORT void JNICALL Java_global_EditingTaskSet_register_1currentIndexChanged_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCEditingTaskSetProxy *pObjectX = (JCEditingTaskSetProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT void JNICALL Java_global_EditingTaskSet_currentIndexChanged_1ev_1uint32_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong index_j)
{
	ev_uint32 index = (ev_uint32) index_j;
	CEditingTaskSet *pObjectX = (CEditingTaskSet*) pObjXXXX;
	pObjectX->CEditingTaskSet::currentIndexChanged(index);
}
extern "C" JNIEXPORT void JNICALL Java_global_EditingTaskSet_register_1getWidth_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCEditingTaskSetProxy *pObjectX = (JCEditingTaskSetProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
