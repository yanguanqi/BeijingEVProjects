...
#include <typeinfo>
class JCNAToolBarriarProxy : public CNAToolBarriar
{
 private:
...
public:
	JCNAToolBarriarProxy(EarthView::World::Core::CNameValuePairList *pList) : CNAToolBarriar(pList)
	{
	}
...
protected:
	C_DISABLE_COPY(JCNAToolBarriarProxy)
public:
...
REGISTER_FACTORY_CLASS(JCNAToolBarriarProxy);
extern "C" JNIEXPORT jlong JNICALL Java_global_Natoolbarriar_getToolBarType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNAToolBarriar *pObjectX = (CNAToolBarriar*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCNAToolBarriarProxy))
	{
		ev_uint32 __values1 = pObjectX->CNAToolBarriar::getToolBarType();
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolbarriar_register_1getToolBarType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNAToolBarriarProxy *pObjectX = (JCNAToolBarriarProxy*) pObjXXXX;
...
extern "C" JNIEXPORT jlong JNICALL Java_global_Natoolbarriar_getToolBarType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNAToolBarriar *pObjectX = (CNAToolBarriar*) pObjXXXX;
	ev_uint32 __values1 = pObjectX->CNAToolBarriar::getToolBarType();
	jlong __values1_j = (jlong) __values1;
...
extern "C" JNIEXPORT jlong JNICALL Java_global_Natoolbarriar_getType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNAToolBarriar *pObjectX = (CNAToolBarriar*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCNAToolBarriarProxy))
	{
		ev_uint32 __values1 = pObjectX->CNAToolBarriar::getType();
		jlong __values1_j = (jlong) __values1;
		return __values1_j;
	}
	else
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolbarriar_register_1getType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNAToolBarriarProxy *pObjectX = (JCNAToolBarriarProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jlong JNICALL Java_global_Natoolbarriar_getType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNAToolBarriar *pObjectX = (CNAToolBarriar*) pObjXXXX;
	ev_uint32 __values1 = pObjectX->CNAToolBarriar::getType();
	jlong __values1_j = (jlong) __values1;
...
extern "C" JNIEXPORT jstring JNICALL Java_global_Natoolbarriar_getName_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNAToolBarriar *pObjectX = (CNAToolBarriar*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCNAToolBarriarProxy))
	{
		EVString __values1 = pObjectX->CNAToolBarriar::getName();
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolbarriar_register_1getName_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNAToolBarriarProxy *pObjectX = (JCNAToolBarriarProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jstring JNICALL Java_global_Natoolbarriar_getName_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNAToolBarriar *pObjectX = (CNAToolBarriar*) pObjXXXX;
	EVString __values1 = pObjectX->CNAToolBarriar::getName();
	EarthView::World::Core::ev_wstring valuesw1 = __values1;
...
extern "C" JNIEXPORT jstring JNICALL Java_global_Natoolbarriar_getCategory_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNAToolBarriar *pObjectX = (CNAToolBarriar*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCNAToolBarriarProxy))
	{
		EVString __values1 = pObjectX->CNAToolBarriar::getCategory();
		EarthView::World::Core::ev_wstring valuesw1 = __values1;
		jstring __values1_j = __env->NewString((const jchar*)valuesw1.getString(), valuesw1.size());
		return __values1_j;
	}
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolbarriar_register_1getCategory_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNAToolBarriarProxy *pObjectX = (JCNAToolBarriarProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jstring JNICALL Java_global_Natoolbarriar_getCategory_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNAToolBarriar *pObjectX = (CNAToolBarriar*) pObjXXXX;
	EVString __values1 = pObjectX->CNAToolBarriar::getCategory();
	EarthView::World::Core::ev_wstring valuesw1 = __values1;
...
extern "C" JNIEXPORT jstring JNICALL Java_global_Natoolbarriar_getToolTip_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNAToolBarriar *pObjectX = (CNAToolBarriar*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCNAToolBarriarProxy))
	{
		EVString __values1 = pObjectX->CNAToolBarriar::getToolTip();
		EarthView::World::Core::ev_wstring valuesw1 = __values1;
		jstring __values1_j = __env->NewString((const jchar*)valuesw1.getString(), valuesw1.size());
		return __values1_j;
	}
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolbarriar_register_1getToolTip_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNAToolBarriarProxy *pObjectX = (JCNAToolBarriarProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jstring JNICALL Java_global_Natoolbarriar_getToolTip_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNAToolBarriar *pObjectX = (CNAToolBarriar*) pObjXXXX;
	EVString __values1 = pObjectX->CNAToolBarriar::getToolTip();
	EarthView::World::Core::ev_wstring valuesw1 = __values1;
...
extern "C" JNIEXPORT jlong JNICALL Java_global_Natoolbarriar_getIcon_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNAToolBarriar *pObjectX = (CNAToolBarriar*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCNAToolBarriarProxy))
	{
		EarthView::World::Display::IBitmap* __values1 = pObjectX->CNAToolBarriar::getIcon();
		jlong __values1_j = (jlong) __values1;
		return __values1_j;
	}
	else
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolbarriar_register_1getIcon_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNAToolBarriarProxy *pObjectX = (JCNAToolBarriarProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jlong JNICALL Java_global_Natoolbarriar_getIcon_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNAToolBarriar *pObjectX = (CNAToolBarriar*) pObjXXXX;
	EarthView::World::Display::IBitmap* __values1 = pObjectX->CNAToolBarriar::getIcon();
	jlong __values1_j = (jlong) __values1;
...
extern "C" JNIEXPORT jboolean JNICALL Java_global_Natoolbarriar_isCheckable_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNAToolBarriar *pObjectX = (CNAToolBarriar*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCNAToolBarriarProxy))
	{
		ev_bool __values1 = pObjectX->CNAToolBarriar::isCheckable();
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolbarriar_register_1isCheckable_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNAToolBarriarProxy *pObjectX = (JCNAToolBarriarProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jboolean JNICALL Java_global_Natoolbarriar_isCheckable_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNAToolBarriar *pObjectX = (CNAToolBarriar*) pObjXXXX;
	ev_bool __values1 = pObjectX->CNAToolBarriar::isCheckable();
	jboolean __values1_j = (jboolean)__values1;
...
extern "C" JNIEXPORT jint JNICALL Java_global_Natoolbarriar_getCursor_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	CNAToolBarriar *pObjectX = (CNAToolBarriar*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCNAToolBarriarProxy))
	{
		ev_int32 __values1 = pObjectX->CNAToolBarriar::getCursor();
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolbarriar_register_1getCursor_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNAToolBarriarProxy *pObjectX = (JCNAToolBarriarProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jint JNICALL Java_global_Natoolbarriar_getCursor_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	CNAToolBarriar *pObjectX = (CNAToolBarriar*) pObjXXXX;
	ev_int32 __values1 = pObjectX->CNAToolBarriar::getCursor();
	jint __values1_j = (jint)__values1;
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolbarriar_activate_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	CNAToolBarriar *pObjectX = (CNAToolBarriar*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCNAToolBarriarProxy))
	{
		pObjectX->CNAToolBarriar::activate();
	}
	else
	{
		pObjectX->activate();
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolbarriar_register_1activate_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNAToolBarriarProxy *pObjectX = (JCNAToolBarriarProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolbarriar_activate_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	CNAToolBarriar *pObjectX = (CNAToolBarriar*) pObjXXXX;
	pObjectX->CNAToolBarriar::activate();
}
extern "C" JNIEXPORT void JNICALL Java_global_Natoolbarriar_deactivate_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	CNAToolBarriar *pObjectX = (CNAToolBarriar*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCNAToolBarriarProxy))
	{
		pObjectX->CNAToolBarriar::deactivate();
	}
	else
	{
		pObjectX->deactivate();
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolbarriar_register_1deactivate_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNAToolBarriarProxy *pObjectX = (JCNAToolBarriarProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolbarriar_deactivate_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	CNAToolBarriar *pObjectX = (CNAToolBarriar*) pObjXXXX;
	pObjectX->CNAToolBarriar::deactivate();
}
extern "C" JNIEXPORT void JNICALL Java_global_Natoolbarriar_onClicked_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	CNAToolBarriar *pObjectX = (CNAToolBarriar*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCNAToolBarriarProxy))
	{
		pObjectX->CNAToolBarriar::onClicked();
	}
	else
	{
		pObjectX->onClicked();
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolbarriar_register_1onClicked_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNAToolBarriarProxy *pObjectX = (JCNAToolBarriarProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolbarriar_onClicked_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	CNAToolBarriar *pObjectX = (CNAToolBarriar*) pObjXXXX;
	pObjectX->CNAToolBarriar::onClicked();
}
extern "C" JNIEXPORT jboolean JNICALL Java_global_Natoolbarriar_getChecked_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNAToolBarriar *pObjectX = (CNAToolBarriar*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCNAToolBarriarProxy))
	{
		ev_bool __values1 = pObjectX->CNAToolBarriar::getChecked();
		jboolean __values1_j = (jboolean)__values1;
		return __values1_j;
	}
	else
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolbarriar_register_1getChecked_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNAToolBarriarProxy *pObjectX = (JCNAToolBarriarProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jboolean JNICALL Java_global_Natoolbarriar_getChecked_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNAToolBarriar *pObjectX = (CNAToolBarriar*) pObjXXXX;
	ev_bool __values1 = pObjectX->CNAToolBarriar::getChecked();
	jboolean __values1_j = (jboolean)__values1;
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolbarriar_setChecked_1ev_1bool(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean checked_j)
{
	ev_bool checked = (ev_bool) checked_j;
	CNAToolBarriar *pObjectX = (CNAToolBarriar*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCNAToolBarriarProxy))
	{
		pObjectX->CNAToolBarriar::setChecked(checked);
	}
	else
	{
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolbarriar_register_1setChecked_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNAToolBarriarProxy *pObjectX = (JCNAToolBarriarProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolbarriar_setChecked_1ev_1bool_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean checked_j)
{
	ev_bool checked = (ev_bool) checked_j;
	CNAToolBarriar *pObjectX = (CNAToolBarriar*) pObjXXXX;
	pObjectX->CNAToolBarriar::setChecked(checked);
}
extern "C" JNIEXPORT jboolean JNICALL Java_global_Natoolbarriar_getEnabled_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNAToolBarriar *pObjectX = (CNAToolBarriar*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCNAToolBarriarProxy))
	{
		ev_bool __values1 = pObjectX->CNAToolBarriar::getEnabled();
		jboolean __values1_j = (jboolean)__values1;
		return __values1_j;
	}
	else
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolbarriar_register_1getEnabled_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNAToolBarriarProxy *pObjectX = (JCNAToolBarriarProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jboolean JNICALL Java_global_Natoolbarriar_getEnabled_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNAToolBarriar *pObjectX = (CNAToolBarriar*) pObjXXXX;
	ev_bool __values1 = pObjectX->CNAToolBarriar::getEnabled();
	jboolean __values1_j = (jboolean)__values1;
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolbarriar_setEnabled_1ev_1bool(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean enabled_j)
{
	ev_bool enabled = (ev_bool) enabled_j;
	CNAToolBarriar *pObjectX = (CNAToolBarriar*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCNAToolBarriarProxy))
	{
		pObjectX->CNAToolBarriar::setEnabled(enabled);
	}
	else
	{
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolbarriar_register_1setEnabled_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNAToolBarriarProxy *pObjectX = (JCNAToolBarriarProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolbarriar_setEnabled_1ev_1bool_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean enabled_j)
{
	ev_bool enabled = (ev_bool) enabled_j;
	CNAToolBarriar *pObjectX = (CNAToolBarriar*) pObjXXXX;
	pObjectX->CNAToolBarriar::setEnabled(enabled);
}
extern "C" JNIEXPORT jboolean JNICALL Java_global_Natoolbarriar_onKeyDown_1ev_1int32_1ev_1int32(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint keyCode_j, jint shift_j)
{
	...
	if (typeid(*pObjectX) == typeid(JCNAToolBarriarProxy))
	{
		ev_bool __values1 = pObjectX->CNAToolBarriar::onKeyDown(keyCode, shift);
		jboolean __values1_j = (jboolean)__values1;
		return __values1_j;
	}
	else
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolbarriar_register_1onKeyDown_1ev_1int32_1ev_1int32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNAToolBarriarProxy *pObjectX = (JCNAToolBarriarProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jboolean JNICALL Java_global_Natoolbarriar_onKeyDown_1ev_1int32_1ev_1int32_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint keyCode_j, jint shift_j)
{
	ev_int32 keyCode = (ev_int32) keyCode_j;
	ev_int32 shift = (ev_int32) shift_j;
	CNAToolBarriar *pObjectX = (CNAToolBarriar*) pObjXXXX;
...
extern "C" JNIEXPORT jboolean JNICALL Java_global_Natoolbarriar_onMouseDown_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint button_j, jint shift_j, jint x_j, jint y_j)
{
	...
	if (typeid(*pObjectX) == typeid(JCNAToolBarriarProxy))
	{
		ev_bool __values1 = pObjectX->CNAToolBarriar::onMouseDown(button, shift, x, y);
		jboolean __values1_j = (jboolean)__values1;
		return __values1_j;
	}
	else
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolbarriar_register_1onMouseDown_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNAToolBarriarProxy *pObjectX = (JCNAToolBarriarProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jboolean JNICALL Java_global_Natoolbarriar_onMouseDown_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint button_j, jint shift_j, jint x_j, jint y_j)
{
	ev_int32 button = (ev_int32) button_j;
	ev_int32 shift = (ev_int32) shift_j;
	ev_int32 x = (ev_int32) x_j;
...
extern "C" JNIEXPORT jboolean JNICALL Java_global_Natoolbarriar_update_1CEvent(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong e_j)
{
	EarthView::World::Core::CEvent *e = (EarthView::World::Core::CEvent*) e_j;
	CNAToolBarriar *pObjectX = (CNAToolBarriar*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCNAToolBarriarProxy))
	{
		ev_bool __values1 = pObjectX->CNAToolBarriar::update(e);
		jboolean __values1_j = (jboolean)__values1;
		return __values1_j;
	}
	else
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolbarriar_register_1update_1CEvent(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNAToolBarriarProxy *pObjectX = (JCNAToolBarriarProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jboolean JNICALL Java_global_Natoolbarriar_update_1CEvent_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong e_j)
{
	EarthView::World::Core::CEvent *e = (EarthView::World::Core::CEvent*) e_j;
	CNAToolBarriar *pObjectX = (CNAToolBarriar*) pObjXXXX;
	ev_bool __values1 = pObjectX->CNAToolBarriar::update(e);
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolbarriar_register_1onContextMenu_1ev_1int32_1ev_1int32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNAToolBarriarProxy *pObjectX = (JCNAToolBarriarProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolbarriar_register_1onDoubleClick_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNAToolBarriarProxy *pObjectX = (JCNAToolBarriarProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolbarriar_register_1onDoubleClick_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNAToolBarriarProxy *pObjectX = (JCNAToolBarriarProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolbarriar_register_1onKeyUp_1ev_1int32_1ev_1int32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNAToolBarriarProxy *pObjectX = (JCNAToolBarriarProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolbarriar_register_1onMouseMove_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNAToolBarriarProxy *pObjectX = (JCNAToolBarriarProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolbarriar_register_1onMouseUp_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNAToolBarriarProxy *pObjectX = (JCNAToolBarriarProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolbarriar_register_1onMouseWheel_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNAToolBarriarProxy *pObjectX = (JCNAToolBarriarProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolbarriar_register_1onTouchDown_1MotionEvent(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNAToolBarriarProxy *pObjectX = (JCNAToolBarriarProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolbarriar_register_1onTouchUp_1MotionEvent(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNAToolBarriarProxy *pObjectX = (JCNAToolBarriarProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolbarriar_register_1onTouchMove_1MotionEvent(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNAToolBarriarProxy *pObjectX = (JCNAToolBarriarProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolbarriar_register_1create_1ISpatialControl(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNAToolBarriarProxy *pObjectX = (JCNAToolBarriarProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
