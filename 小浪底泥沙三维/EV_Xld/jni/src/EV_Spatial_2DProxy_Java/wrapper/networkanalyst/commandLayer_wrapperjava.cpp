...
#include <typeinfo>
class JCNACmdLayerProxy : public CNACmdLayer
{
 private:
...
public:
	JCNACmdLayerProxy(EarthView::World::Core::CNameValuePairList *pList) : CNACmdLayer(pList)
	{
	}
...
protected:
	C_DISABLE_COPY(JCNACmdLayerProxy)
public:
...
REGISTER_FACTORY_CLASS(JCNACmdLayerProxy);
extern "C" JNIEXPORT jint JNICALL Java_global_Nacmdlayer_getCurrentIndex_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNACmdLayer *pObjectX = (CNACmdLayer*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCNACmdLayerProxy))
	{
		ev_int32 __values1 = pObjectX->CNACmdLayer::getCurrentIndex();
...
extern "C" JNIEXPORT void JNICALL Java_global_Nacmdlayer_register_1getCurrentIndex_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNACmdLayerProxy *pObjectX = (JCNACmdLayerProxy*) pObjXXXX;
...
extern "C" JNIEXPORT jint JNICALL Java_global_Nacmdlayer_getCurrentIndex_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNACmdLayer *pObjectX = (CNACmdLayer*) pObjXXXX;
	ev_int32 __values1 = pObjectX->CNACmdLayer::getCurrentIndex();
	jint __values1_j = (jint)__values1;
...
extern "C" JNIEXPORT jlong JNICALL Java_global_Nacmdlayer_getEntryCount_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNACmdLayer *pObjectX = (CNACmdLayer*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCNACmdLayerProxy))
	{
		ev_uint32 __values1 = pObjectX->CNACmdLayer::getEntryCount();
...
extern "C" JNIEXPORT void JNICALL Java_global_Nacmdlayer_register_1getEntryCount_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNACmdLayerProxy *pObjectX = (JCNACmdLayerProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jlong JNICALL Java_global_Nacmdlayer_getEntryCount_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNACmdLayer *pObjectX = (CNACmdLayer*) pObjXXXX;
	ev_uint32 __values1 = pObjectX->CNACmdLayer::getEntryCount();
	jlong __values1_j = (jlong) __values1;
...
extern "C" JNIEXPORT jstring JNICALL Java_global_Nacmdlayer_getEntry_1ev_1uint32(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong index_j)
{
	ev_uint32 index = (ev_uint32) index_j;
	const 	CNACmdLayer *pObjectX = (CNACmdLayer*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCNACmdLayerProxy))
	{
		EVString __values1 = pObjectX->CNACmdLayer::getEntry(index);
...
extern "C" JNIEXPORT void JNICALL Java_global_Nacmdlayer_register_1getEntry_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNACmdLayerProxy *pObjectX = (JCNACmdLayerProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jstring JNICALL Java_global_Nacmdlayer_getEntry_1ev_1uint32_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong index_j)
{
	ev_uint32 index = (ev_uint32) index_j;
	const 	CNACmdLayer *pObjectX = (CNACmdLayer*) pObjXXXX;
	EVString __values1 = pObjectX->CNACmdLayer::getEntry(index);
...
extern "C" JNIEXPORT void JNICALL Java_global_Nacmdlayer_currentIndexChanged_1ev_1uint32(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong index_j)
{
	ev_uint32 index = (ev_uint32) index_j;
	CNACmdLayer *pObjectX = (CNACmdLayer*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCNACmdLayerProxy))
	{
		pObjectX->CNACmdLayer::currentIndexChanged(index);
	}
	else
	{
...
extern "C" JNIEXPORT void JNICALL Java_global_Nacmdlayer_register_1currentIndexChanged_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNACmdLayerProxy *pObjectX = (JCNACmdLayerProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT void JNICALL Java_global_Nacmdlayer_currentIndexChanged_1ev_1uint32_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong index_j)
{
	ev_uint32 index = (ev_uint32) index_j;
	CNACmdLayer *pObjectX = (CNACmdLayer*) pObjXXXX;
	pObjectX->CNACmdLayer::currentIndexChanged(index);
}
extern "C" JNIEXPORT jlong JNICALL Java_global_Nacmdlayer_getToolBarType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNACmdLayer *pObjectX = (CNACmdLayer*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCNACmdLayerProxy))
	{
		ev_uint32 __values1 = pObjectX->CNACmdLayer::getToolBarType();
		jlong __values1_j = (jlong) __values1;
		return __values1_j;
	}
	else
...
extern "C" JNIEXPORT void JNICALL Java_global_Nacmdlayer_register_1getToolBarType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNACmdLayerProxy *pObjectX = (JCNACmdLayerProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jlong JNICALL Java_global_Nacmdlayer_getToolBarType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNACmdLayer *pObjectX = (CNACmdLayer*) pObjXXXX;
	ev_uint32 __values1 = pObjectX->CNACmdLayer::getToolBarType();
	jlong __values1_j = (jlong) __values1;
...
extern "C" JNIEXPORT jlong JNICALL Java_global_Nacmdlayer_getType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNACmdLayer *pObjectX = (CNACmdLayer*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCNACmdLayerProxy))
	{
		ev_uint32 __values1 = pObjectX->CNACmdLayer::getType();
		jlong __values1_j = (jlong) __values1;
		return __values1_j;
	}
	else
...
extern "C" JNIEXPORT void JNICALL Java_global_Nacmdlayer_register_1getType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNACmdLayerProxy *pObjectX = (JCNACmdLayerProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jlong JNICALL Java_global_Nacmdlayer_getType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNACmdLayer *pObjectX = (CNACmdLayer*) pObjXXXX;
	ev_uint32 __values1 = pObjectX->CNACmdLayer::getType();
	jlong __values1_j = (jlong) __values1;
...
extern "C" JNIEXPORT jstring JNICALL Java_global_Nacmdlayer_getName_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNACmdLayer *pObjectX = (CNACmdLayer*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCNACmdLayerProxy))
	{
		EVString __values1 = pObjectX->CNACmdLayer::getName();
		EarthView::World::Core::ev_wstring valuesw1 = __values1;
		jstring __values1_j = __env->NewString((const jchar*)valuesw1.getString(), valuesw1.size());
		return __values1_j;
	}
...
extern "C" JNIEXPORT void JNICALL Java_global_Nacmdlayer_register_1getName_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNACmdLayerProxy *pObjectX = (JCNACmdLayerProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jstring JNICALL Java_global_Nacmdlayer_getName_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNACmdLayer *pObjectX = (CNACmdLayer*) pObjXXXX;
	EVString __values1 = pObjectX->CNACmdLayer::getName();
	EarthView::World::Core::ev_wstring valuesw1 = __values1;
...
extern "C" JNIEXPORT jstring JNICALL Java_global_Nacmdlayer_getCategory_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNACmdLayer *pObjectX = (CNACmdLayer*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCNACmdLayerProxy))
	{
		EVString __values1 = pObjectX->CNACmdLayer::getCategory();
		EarthView::World::Core::ev_wstring valuesw1 = __values1;
		jstring __values1_j = __env->NewString((const jchar*)valuesw1.getString(), valuesw1.size());
		return __values1_j;
	}
...
extern "C" JNIEXPORT void JNICALL Java_global_Nacmdlayer_register_1getCategory_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNACmdLayerProxy *pObjectX = (JCNACmdLayerProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jstring JNICALL Java_global_Nacmdlayer_getCategory_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNACmdLayer *pObjectX = (CNACmdLayer*) pObjXXXX;
	EVString __values1 = pObjectX->CNACmdLayer::getCategory();
	EarthView::World::Core::ev_wstring valuesw1 = __values1;
...
extern "C" JNIEXPORT jstring JNICALL Java_global_Nacmdlayer_getToolTip_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNACmdLayer *pObjectX = (CNACmdLayer*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCNACmdLayerProxy))
	{
		EVString __values1 = pObjectX->CNACmdLayer::getToolTip();
		EarthView::World::Core::ev_wstring valuesw1 = __values1;
		jstring __values1_j = __env->NewString((const jchar*)valuesw1.getString(), valuesw1.size());
		return __values1_j;
	}
...
extern "C" JNIEXPORT void JNICALL Java_global_Nacmdlayer_register_1getToolTip_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNACmdLayerProxy *pObjectX = (JCNACmdLayerProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jstring JNICALL Java_global_Nacmdlayer_getToolTip_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNACmdLayer *pObjectX = (CNACmdLayer*) pObjXXXX;
	EVString __values1 = pObjectX->CNACmdLayer::getToolTip();
	EarthView::World::Core::ev_wstring valuesw1 = __values1;
...
extern "C" JNIEXPORT jlong JNICALL Java_global_Nacmdlayer_getIcon_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNACmdLayer *pObjectX = (CNACmdLayer*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCNACmdLayerProxy))
	{
		EarthView::World::Display::IBitmap* __values1 = pObjectX->CNACmdLayer::getIcon();
		jlong __values1_j = (jlong) __values1;
		return __values1_j;
	}
	else
...
extern "C" JNIEXPORT void JNICALL Java_global_Nacmdlayer_register_1getIcon_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNACmdLayerProxy *pObjectX = (JCNACmdLayerProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jlong JNICALL Java_global_Nacmdlayer_getIcon_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNACmdLayer *pObjectX = (CNACmdLayer*) pObjXXXX;
	EarthView::World::Display::IBitmap* __values1 = pObjectX->CNACmdLayer::getIcon();
	jlong __values1_j = (jlong) __values1;
...
extern "C" JNIEXPORT jboolean JNICALL Java_global_Nacmdlayer_isCheckable_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNACmdLayer *pObjectX = (CNACmdLayer*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCNACmdLayerProxy))
	{
		ev_bool __values1 = pObjectX->CNACmdLayer::isCheckable();
...
extern "C" JNIEXPORT void JNICALL Java_global_Nacmdlayer_register_1isCheckable_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNACmdLayerProxy *pObjectX = (JCNACmdLayerProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jboolean JNICALL Java_global_Nacmdlayer_isCheckable_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNACmdLayer *pObjectX = (CNACmdLayer*) pObjXXXX;
	ev_bool __values1 = pObjectX->CNACmdLayer::isCheckable();
	jboolean __values1_j = (jboolean)__values1;
...
extern "C" JNIEXPORT void JNICALL Java_global_Nacmdlayer_onClicked_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	CNACmdLayer *pObjectX = (CNACmdLayer*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCNACmdLayerProxy))
	{
		pObjectX->CNACmdLayer::onClicked();
	}
	else
	{
		pObjectX->onClicked();
...
extern "C" JNIEXPORT void JNICALL Java_global_Nacmdlayer_register_1onClicked_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNACmdLayerProxy *pObjectX = (JCNACmdLayerProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT void JNICALL Java_global_Nacmdlayer_onClicked_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	CNACmdLayer *pObjectX = (CNACmdLayer*) pObjXXXX;
	pObjectX->CNACmdLayer::onClicked();
}
extern "C" JNIEXPORT jboolean JNICALL Java_global_Nacmdlayer_getChecked_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNACmdLayer *pObjectX = (CNACmdLayer*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCNACmdLayerProxy))
	{
		ev_bool __values1 = pObjectX->CNACmdLayer::getChecked();
		jboolean __values1_j = (jboolean)__values1;
		return __values1_j;
	}
	else
...
extern "C" JNIEXPORT void JNICALL Java_global_Nacmdlayer_register_1getChecked_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNACmdLayerProxy *pObjectX = (JCNACmdLayerProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jboolean JNICALL Java_global_Nacmdlayer_getChecked_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNACmdLayer *pObjectX = (CNACmdLayer*) pObjXXXX;
	ev_bool __values1 = pObjectX->CNACmdLayer::getChecked();
	jboolean __values1_j = (jboolean)__values1;
...
extern "C" JNIEXPORT void JNICALL Java_global_Nacmdlayer_setChecked_1ev_1bool(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean checked_j)
{
	ev_bool checked = (ev_bool) checked_j;
	CNACmdLayer *pObjectX = (CNACmdLayer*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCNACmdLayerProxy))
	{
		pObjectX->CNACmdLayer::setChecked(checked);
	}
	else
	{
...
extern "C" JNIEXPORT void JNICALL Java_global_Nacmdlayer_register_1setChecked_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNACmdLayerProxy *pObjectX = (JCNACmdLayerProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT void JNICALL Java_global_Nacmdlayer_setChecked_1ev_1bool_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean checked_j)
{
	ev_bool checked = (ev_bool) checked_j;
	CNACmdLayer *pObjectX = (CNACmdLayer*) pObjXXXX;
	pObjectX->CNACmdLayer::setChecked(checked);
}
extern "C" JNIEXPORT jboolean JNICALL Java_global_Nacmdlayer_getEnabled_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNACmdLayer *pObjectX = (CNACmdLayer*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCNACmdLayerProxy))
	{
		ev_bool __values1 = pObjectX->CNACmdLayer::getEnabled();
		jboolean __values1_j = (jboolean)__values1;
		return __values1_j;
	}
	else
...
extern "C" JNIEXPORT void JNICALL Java_global_Nacmdlayer_register_1getEnabled_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNACmdLayerProxy *pObjectX = (JCNACmdLayerProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jboolean JNICALL Java_global_Nacmdlayer_getEnabled_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNACmdLayer *pObjectX = (CNACmdLayer*) pObjXXXX;
	ev_bool __values1 = pObjectX->CNACmdLayer::getEnabled();
	jboolean __values1_j = (jboolean)__values1;
...
extern "C" JNIEXPORT void JNICALL Java_global_Nacmdlayer_setEnabled_1ev_1bool(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean enabled_j)
{
	ev_bool enabled = (ev_bool) enabled_j;
	CNACmdLayer *pObjectX = (CNACmdLayer*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCNACmdLayerProxy))
	{
		pObjectX->CNACmdLayer::setEnabled(enabled);
	}
	else
	{
...
extern "C" JNIEXPORT void JNICALL Java_global_Nacmdlayer_register_1setEnabled_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNACmdLayerProxy *pObjectX = (JCNACmdLayerProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT void JNICALL Java_global_Nacmdlayer_setEnabled_1ev_1bool_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean enabled_j)
{
	ev_bool enabled = (ev_bool) enabled_j;
	CNACmdLayer *pObjectX = (CNACmdLayer*) pObjXXXX;
	pObjectX->CNACmdLayer::setEnabled(enabled);
}
extern "C" JNIEXPORT void JNICALL Java_global_Nacmdlayer_create_1ISpatialControl(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong ctrl_j)
{
	EarthView::World::Spatial::Atlas::ISpatialControl *ctrl = (EarthView::World::Spatial::Atlas::ISpatialControl*) ctrl_j;
	CNACmdLayer *pObjectX = (CNACmdLayer*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCNACmdLayerProxy))
	{
		pObjectX->CNACmdLayer::create(ctrl);
	}
	else
	{
...
extern "C" JNIEXPORT void JNICALL Java_global_Nacmdlayer_register_1create_1ISpatialControl(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNACmdLayerProxy *pObjectX = (JCNACmdLayerProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT void JNICALL Java_global_Nacmdlayer_create_1ISpatialControl_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong ctrl_j)
{
	EarthView::World::Spatial::Atlas::ISpatialControl *ctrl = (EarthView::World::Spatial::Atlas::ISpatialControl*) ctrl_j;
	CNACmdLayer *pObjectX = (CNACmdLayer*) pObjXXXX;
	pObjectX->CNACmdLayer::create(ctrl);
}
extern "C" JNIEXPORT jboolean JNICALL Java_global_Nacmdlayer_update_1CEvent(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong e_j)
{
	EarthView::World::Core::CEvent *e = (EarthView::World::Core::CEvent*) e_j;
	CNACmdLayer *pObjectX = (CNACmdLayer*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCNACmdLayerProxy))
	{
		ev_bool __values1 = pObjectX->CNACmdLayer::update(e);
		jboolean __values1_j = (jboolean)__values1;
		return __values1_j;
	}
	else
...
extern "C" JNIEXPORT void JNICALL Java_global_Nacmdlayer_register_1update_1CEvent(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNACmdLayerProxy *pObjectX = (JCNACmdLayerProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jboolean JNICALL Java_global_Nacmdlayer_update_1CEvent_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong e_j)
{
	EarthView::World::Core::CEvent *e = (EarthView::World::Core::CEvent*) e_j;
	CNACmdLayer *pObjectX = (CNACmdLayer*) pObjXXXX;
	ev_bool __values1 = pObjectX->CNACmdLayer::update(e);
...
extern "C" JNIEXPORT void JNICALL Java_global_Nacmdlayer_register_1getWidth_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNACmdLayerProxy *pObjectX = (JCNACmdLayerProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
