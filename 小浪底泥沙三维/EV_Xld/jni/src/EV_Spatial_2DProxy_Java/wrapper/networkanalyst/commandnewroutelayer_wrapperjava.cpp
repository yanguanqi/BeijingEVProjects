...
#include <typeinfo>
class JCNACmdNewRouteLayerProxy : public CNACmdNewRouteLayer
{
 private:
...
public:
	JCNACmdNewRouteLayerProxy(EarthView::World::Core::CNameValuePairList *pList) : CNACmdNewRouteLayer(pList)
	{
	}
...
protected:
	C_DISABLE_COPY(JCNACmdNewRouteLayerProxy)
public:
...
REGISTER_FACTORY_CLASS(JCNACmdNewRouteLayerProxy);
extern "C" JNIEXPORT jlong JNICALL Java_global_Nacmdnewroutelayer_getToolBarType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNACmdNewRouteLayer *pObjectX = (CNACmdNewRouteLayer*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCNACmdNewRouteLayerProxy))
	{
		ev_uint32 __values1 = pObjectX->CNACmdNewRouteLayer::getToolBarType();
...
extern "C" JNIEXPORT void JNICALL Java_global_Nacmdnewroutelayer_register_1getToolBarType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNACmdNewRouteLayerProxy *pObjectX = (JCNACmdNewRouteLayerProxy*) pObjXXXX;
...
extern "C" JNIEXPORT jlong JNICALL Java_global_Nacmdnewroutelayer_getToolBarType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNACmdNewRouteLayer *pObjectX = (CNACmdNewRouteLayer*) pObjXXXX;
	ev_uint32 __values1 = pObjectX->CNACmdNewRouteLayer::getToolBarType();
	jlong __values1_j = (jlong) __values1;
...
extern "C" JNIEXPORT jlong JNICALL Java_global_Nacmdnewroutelayer_getType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNACmdNewRouteLayer *pObjectX = (CNACmdNewRouteLayer*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCNACmdNewRouteLayerProxy))
	{
		ev_uint32 __values1 = pObjectX->CNACmdNewRouteLayer::getType();
		jlong __values1_j = (jlong) __values1;
		return __values1_j;
	}
	else
...
extern "C" JNIEXPORT void JNICALL Java_global_Nacmdnewroutelayer_register_1getType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNACmdNewRouteLayerProxy *pObjectX = (JCNACmdNewRouteLayerProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jlong JNICALL Java_global_Nacmdnewroutelayer_getType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNACmdNewRouteLayer *pObjectX = (CNACmdNewRouteLayer*) pObjXXXX;
	ev_uint32 __values1 = pObjectX->CNACmdNewRouteLayer::getType();
	jlong __values1_j = (jlong) __values1;
...
extern "C" JNIEXPORT jstring JNICALL Java_global_Nacmdnewroutelayer_getName_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNACmdNewRouteLayer *pObjectX = (CNACmdNewRouteLayer*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCNACmdNewRouteLayerProxy))
	{
		EVString __values1 = pObjectX->CNACmdNewRouteLayer::getName();
...
extern "C" JNIEXPORT void JNICALL Java_global_Nacmdnewroutelayer_register_1getName_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNACmdNewRouteLayerProxy *pObjectX = (JCNACmdNewRouteLayerProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jstring JNICALL Java_global_Nacmdnewroutelayer_getName_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNACmdNewRouteLayer *pObjectX = (CNACmdNewRouteLayer*) pObjXXXX;
	EVString __values1 = pObjectX->CNACmdNewRouteLayer::getName();
	EarthView::World::Core::ev_wstring valuesw1 = __values1;
...
extern "C" JNIEXPORT jstring JNICALL Java_global_Nacmdnewroutelayer_getCategory_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNACmdNewRouteLayer *pObjectX = (CNACmdNewRouteLayer*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCNACmdNewRouteLayerProxy))
	{
		EVString __values1 = pObjectX->CNACmdNewRouteLayer::getCategory();
		EarthView::World::Core::ev_wstring valuesw1 = __values1;
		jstring __values1_j = __env->NewString((const jchar*)valuesw1.getString(), valuesw1.size());
		return __values1_j;
	}
...
extern "C" JNIEXPORT void JNICALL Java_global_Nacmdnewroutelayer_register_1getCategory_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNACmdNewRouteLayerProxy *pObjectX = (JCNACmdNewRouteLayerProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jstring JNICALL Java_global_Nacmdnewroutelayer_getCategory_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNACmdNewRouteLayer *pObjectX = (CNACmdNewRouteLayer*) pObjXXXX;
	EVString __values1 = pObjectX->CNACmdNewRouteLayer::getCategory();
	EarthView::World::Core::ev_wstring valuesw1 = __values1;
...
extern "C" JNIEXPORT jstring JNICALL Java_global_Nacmdnewroutelayer_getToolTip_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNACmdNewRouteLayer *pObjectX = (CNACmdNewRouteLayer*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCNACmdNewRouteLayerProxy))
	{
		EVString __values1 = pObjectX->CNACmdNewRouteLayer::getToolTip();
		EarthView::World::Core::ev_wstring valuesw1 = __values1;
		jstring __values1_j = __env->NewString((const jchar*)valuesw1.getString(), valuesw1.size());
		return __values1_j;
	}
...
extern "C" JNIEXPORT void JNICALL Java_global_Nacmdnewroutelayer_register_1getToolTip_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNACmdNewRouteLayerProxy *pObjectX = (JCNACmdNewRouteLayerProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jstring JNICALL Java_global_Nacmdnewroutelayer_getToolTip_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNACmdNewRouteLayer *pObjectX = (CNACmdNewRouteLayer*) pObjXXXX;
	EVString __values1 = pObjectX->CNACmdNewRouteLayer::getToolTip();
	EarthView::World::Core::ev_wstring valuesw1 = __values1;
...
extern "C" JNIEXPORT jlong JNICALL Java_global_Nacmdnewroutelayer_getIcon_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNACmdNewRouteLayer *pObjectX = (CNACmdNewRouteLayer*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCNACmdNewRouteLayerProxy))
	{
		EarthView::World::Display::IBitmap* __values1 = pObjectX->CNACmdNewRouteLayer::getIcon();
		jlong __values1_j = (jlong) __values1;
		return __values1_j;
	}
	else
...
extern "C" JNIEXPORT void JNICALL Java_global_Nacmdnewroutelayer_register_1getIcon_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNACmdNewRouteLayerProxy *pObjectX = (JCNACmdNewRouteLayerProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jlong JNICALL Java_global_Nacmdnewroutelayer_getIcon_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNACmdNewRouteLayer *pObjectX = (CNACmdNewRouteLayer*) pObjXXXX;
	EarthView::World::Display::IBitmap* __values1 = pObjectX->CNACmdNewRouteLayer::getIcon();
	jlong __values1_j = (jlong) __values1;
...
extern "C" JNIEXPORT jboolean JNICALL Java_global_Nacmdnewroutelayer_isCheckable_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNACmdNewRouteLayer *pObjectX = (CNACmdNewRouteLayer*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCNACmdNewRouteLayerProxy))
	{
		ev_bool __values1 = pObjectX->CNACmdNewRouteLayer::isCheckable();
...
extern "C" JNIEXPORT void JNICALL Java_global_Nacmdnewroutelayer_register_1isCheckable_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNACmdNewRouteLayerProxy *pObjectX = (JCNACmdNewRouteLayerProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jboolean JNICALL Java_global_Nacmdnewroutelayer_isCheckable_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNACmdNewRouteLayer *pObjectX = (CNACmdNewRouteLayer*) pObjXXXX;
	ev_bool __values1 = pObjectX->CNACmdNewRouteLayer::isCheckable();
	jboolean __values1_j = (jboolean)__values1;
...
extern "C" JNIEXPORT void JNICALL Java_global_Nacmdnewroutelayer_onClicked_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	CNACmdNewRouteLayer *pObjectX = (CNACmdNewRouteLayer*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCNACmdNewRouteLayerProxy))
	{
		pObjectX->CNACmdNewRouteLayer::onClicked();
	}
	else
	{
		pObjectX->onClicked();
...
extern "C" JNIEXPORT void JNICALL Java_global_Nacmdnewroutelayer_register_1onClicked_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNACmdNewRouteLayerProxy *pObjectX = (JCNACmdNewRouteLayerProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT void JNICALL Java_global_Nacmdnewroutelayer_onClicked_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	CNACmdNewRouteLayer *pObjectX = (CNACmdNewRouteLayer*) pObjXXXX;
	pObjectX->CNACmdNewRouteLayer::onClicked();
}
extern "C" JNIEXPORT jboolean JNICALL Java_global_Nacmdnewroutelayer_getChecked_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNACmdNewRouteLayer *pObjectX = (CNACmdNewRouteLayer*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCNACmdNewRouteLayerProxy))
	{
		ev_bool __values1 = pObjectX->CNACmdNewRouteLayer::getChecked();
		jboolean __values1_j = (jboolean)__values1;
		return __values1_j;
	}
	else
...
extern "C" JNIEXPORT void JNICALL Java_global_Nacmdnewroutelayer_register_1getChecked_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNACmdNewRouteLayerProxy *pObjectX = (JCNACmdNewRouteLayerProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jboolean JNICALL Java_global_Nacmdnewroutelayer_getChecked_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNACmdNewRouteLayer *pObjectX = (CNACmdNewRouteLayer*) pObjXXXX;
	ev_bool __values1 = pObjectX->CNACmdNewRouteLayer::getChecked();
	jboolean __values1_j = (jboolean)__values1;
...
extern "C" JNIEXPORT void JNICALL Java_global_Nacmdnewroutelayer_setChecked_1ev_1bool(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean checked_j)
{
	ev_bool checked = (ev_bool) checked_j;
	CNACmdNewRouteLayer *pObjectX = (CNACmdNewRouteLayer*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCNACmdNewRouteLayerProxy))
	{
		pObjectX->CNACmdNewRouteLayer::setChecked(checked);
	}
	else
	{
...
extern "C" JNIEXPORT void JNICALL Java_global_Nacmdnewroutelayer_register_1setChecked_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNACmdNewRouteLayerProxy *pObjectX = (JCNACmdNewRouteLayerProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT void JNICALL Java_global_Nacmdnewroutelayer_setChecked_1ev_1bool_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean checked_j)
{
	ev_bool checked = (ev_bool) checked_j;
	CNACmdNewRouteLayer *pObjectX = (CNACmdNewRouteLayer*) pObjXXXX;
	pObjectX->CNACmdNewRouteLayer::setChecked(checked);
}
extern "C" JNIEXPORT jboolean JNICALL Java_global_Nacmdnewroutelayer_getEnabled_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNACmdNewRouteLayer *pObjectX = (CNACmdNewRouteLayer*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCNACmdNewRouteLayerProxy))
	{
		ev_bool __values1 = pObjectX->CNACmdNewRouteLayer::getEnabled();
		jboolean __values1_j = (jboolean)__values1;
		return __values1_j;
	}
	else
...
extern "C" JNIEXPORT void JNICALL Java_global_Nacmdnewroutelayer_register_1getEnabled_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNACmdNewRouteLayerProxy *pObjectX = (JCNACmdNewRouteLayerProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jboolean JNICALL Java_global_Nacmdnewroutelayer_getEnabled_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNACmdNewRouteLayer *pObjectX = (CNACmdNewRouteLayer*) pObjXXXX;
	ev_bool __values1 = pObjectX->CNACmdNewRouteLayer::getEnabled();
	jboolean __values1_j = (jboolean)__values1;
...
extern "C" JNIEXPORT void JNICALL Java_global_Nacmdnewroutelayer_setEnabled_1ev_1bool(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean enabled_j)
{
	ev_bool enabled = (ev_bool) enabled_j;
	CNACmdNewRouteLayer *pObjectX = (CNACmdNewRouteLayer*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCNACmdNewRouteLayerProxy))
	{
		pObjectX->CNACmdNewRouteLayer::setEnabled(enabled);
	}
	else
	{
...
extern "C" JNIEXPORT void JNICALL Java_global_Nacmdnewroutelayer_register_1setEnabled_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNACmdNewRouteLayerProxy *pObjectX = (JCNACmdNewRouteLayerProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT void JNICALL Java_global_Nacmdnewroutelayer_setEnabled_1ev_1bool_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean enabled_j)
{
	ev_bool enabled = (ev_bool) enabled_j;
	CNACmdNewRouteLayer *pObjectX = (CNACmdNewRouteLayer*) pObjXXXX;
	pObjectX->CNACmdNewRouteLayer::setEnabled(enabled);
}
extern "C" JNIEXPORT void JNICALL Java_global_Nacmdnewroutelayer_create_1ISpatialControl(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong ctrl_j)
{
	EarthView::World::Spatial::Atlas::ISpatialControl *ctrl = (EarthView::World::Spatial::Atlas::ISpatialControl*) ctrl_j;
	CNACmdNewRouteLayer *pObjectX = (CNACmdNewRouteLayer*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCNACmdNewRouteLayerProxy))
	{
		pObjectX->CNACmdNewRouteLayer::create(ctrl);
	}
	else
	{
...
extern "C" JNIEXPORT void JNICALL Java_global_Nacmdnewroutelayer_register_1create_1ISpatialControl(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNACmdNewRouteLayerProxy *pObjectX = (JCNACmdNewRouteLayerProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT void JNICALL Java_global_Nacmdnewroutelayer_create_1ISpatialControl_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong ctrl_j)
{
	EarthView::World::Spatial::Atlas::ISpatialControl *ctrl = (EarthView::World::Spatial::Atlas::ISpatialControl*) ctrl_j;
	CNACmdNewRouteLayer *pObjectX = (CNACmdNewRouteLayer*) pObjXXXX;
	pObjectX->CNACmdNewRouteLayer::create(ctrl);
}
extern "C" JNIEXPORT jboolean JNICALL Java_global_Nacmdnewroutelayer_update_1CEvent(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong e_j)
{
	EarthView::World::Core::CEvent *e = (EarthView::World::Core::CEvent*) e_j;
	CNACmdNewRouteLayer *pObjectX = (CNACmdNewRouteLayer*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCNACmdNewRouteLayerProxy))
	{
		ev_bool __values1 = pObjectX->CNACmdNewRouteLayer::update(e);
		jboolean __values1_j = (jboolean)__values1;
		return __values1_j;
	}
	else
...
extern "C" JNIEXPORT void JNICALL Java_global_Nacmdnewroutelayer_register_1update_1CEvent(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNACmdNewRouteLayerProxy *pObjectX = (JCNACmdNewRouteLayerProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jboolean JNICALL Java_global_Nacmdnewroutelayer_update_1CEvent_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong e_j)
{
	EarthView::World::Core::CEvent *e = (EarthView::World::Core::CEvent*) e_j;
	CNACmdNewRouteLayer *pObjectX = (CNACmdNewRouteLayer*) pObjXXXX;
	ev_bool __values1 = pObjectX->CNACmdNewRouteLayer::update(e);
