...
#include <typeinfo>
class JCNAToolStopProxy : public CNAToolStop
{
 private:
...
public:
	JCNAToolStopProxy(EarthView::World::Core::CNameValuePairList *pList) : CNAToolStop(pList)
	{
	}
...
protected:
	C_DISABLE_COPY(JCNAToolStopProxy)
public:
...
REGISTER_FACTORY_CLASS(JCNAToolStopProxy);
extern "C" JNIEXPORT jlong JNICALL Java_global_Natoolstop_getToolBarType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNAToolStop *pObjectX = (CNAToolStop*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCNAToolStopProxy))
	{
		ev_uint32 __values1 = pObjectX->CNAToolStop::getToolBarType();
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolstop_register_1getToolBarType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNAToolStopProxy *pObjectX = (JCNAToolStopProxy*) pObjXXXX;
...
extern "C" JNIEXPORT jlong JNICALL Java_global_Natoolstop_getToolBarType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNAToolStop *pObjectX = (CNAToolStop*) pObjXXXX;
	ev_uint32 __values1 = pObjectX->CNAToolStop::getToolBarType();
	jlong __values1_j = (jlong) __values1;
...
extern "C" JNIEXPORT jlong JNICALL Java_global_Natoolstop_getType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNAToolStop *pObjectX = (CNAToolStop*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCNAToolStopProxy))
	{
		ev_uint32 __values1 = pObjectX->CNAToolStop::getType();
		jlong __values1_j = (jlong) __values1;
		return __values1_j;
	}
	else
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolstop_register_1getType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNAToolStopProxy *pObjectX = (JCNAToolStopProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jlong JNICALL Java_global_Natoolstop_getType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNAToolStop *pObjectX = (CNAToolStop*) pObjXXXX;
	ev_uint32 __values1 = pObjectX->CNAToolStop::getType();
	jlong __values1_j = (jlong) __values1;
...
extern "C" JNIEXPORT jstring JNICALL Java_global_Natoolstop_getName_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNAToolStop *pObjectX = (CNAToolStop*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCNAToolStopProxy))
	{
		EVString __values1 = pObjectX->CNAToolStop::getName();
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolstop_register_1getName_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNAToolStopProxy *pObjectX = (JCNAToolStopProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jstring JNICALL Java_global_Natoolstop_getName_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNAToolStop *pObjectX = (CNAToolStop*) pObjXXXX;
	EVString __values1 = pObjectX->CNAToolStop::getName();
	EarthView::World::Core::ev_wstring valuesw1 = __values1;
...
extern "C" JNIEXPORT jstring JNICALL Java_global_Natoolstop_getCategory_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNAToolStop *pObjectX = (CNAToolStop*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCNAToolStopProxy))
	{
		EVString __values1 = pObjectX->CNAToolStop::getCategory();
		EarthView::World::Core::ev_wstring valuesw1 = __values1;
		jstring __values1_j = __env->NewString((const jchar*)valuesw1.getString(), valuesw1.size());
		return __values1_j;
	}
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolstop_register_1getCategory_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNAToolStopProxy *pObjectX = (JCNAToolStopProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jstring JNICALL Java_global_Natoolstop_getCategory_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNAToolStop *pObjectX = (CNAToolStop*) pObjXXXX;
	EVString __values1 = pObjectX->CNAToolStop::getCategory();
	EarthView::World::Core::ev_wstring valuesw1 = __values1;
...
extern "C" JNIEXPORT jstring JNICALL Java_global_Natoolstop_getToolTip_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNAToolStop *pObjectX = (CNAToolStop*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCNAToolStopProxy))
	{
		EVString __values1 = pObjectX->CNAToolStop::getToolTip();
		EarthView::World::Core::ev_wstring valuesw1 = __values1;
		jstring __values1_j = __env->NewString((const jchar*)valuesw1.getString(), valuesw1.size());
		return __values1_j;
	}
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolstop_register_1getToolTip_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNAToolStopProxy *pObjectX = (JCNAToolStopProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jstring JNICALL Java_global_Natoolstop_getToolTip_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNAToolStop *pObjectX = (CNAToolStop*) pObjXXXX;
	EVString __values1 = pObjectX->CNAToolStop::getToolTip();
	EarthView::World::Core::ev_wstring valuesw1 = __values1;
...
extern "C" JNIEXPORT jboolean JNICALL Java_global_Natoolstop_isCheckable_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNAToolStop *pObjectX = (CNAToolStop*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCNAToolStopProxy))
	{
		ev_bool __values1 = pObjectX->CNAToolStop::isCheckable();
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolstop_register_1isCheckable_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNAToolStopProxy *pObjectX = (JCNAToolStopProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jboolean JNICALL Java_global_Natoolstop_isCheckable_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNAToolStop *pObjectX = (CNAToolStop*) pObjXXXX;
	ev_bool __values1 = pObjectX->CNAToolStop::isCheckable();
	jboolean __values1_j = (jboolean)__values1;
...
extern "C" JNIEXPORT jlong JNICALL Java_global_Natoolstop_getIcon_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNAToolStop *pObjectX = (CNAToolStop*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCNAToolStopProxy))
	{
		EarthView::World::Display::IBitmap* __values1 = pObjectX->CNAToolStop::getIcon();
		jlong __values1_j = (jlong) __values1;
		return __values1_j;
	}
	else
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolstop_register_1getIcon_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNAToolStopProxy *pObjectX = (JCNAToolStopProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jlong JNICALL Java_global_Natoolstop_getIcon_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNAToolStop *pObjectX = (CNAToolStop*) pObjXXXX;
	EarthView::World::Display::IBitmap* __values1 = pObjectX->CNAToolStop::getIcon();
	jlong __values1_j = (jlong) __values1;
...
extern "C" JNIEXPORT jint JNICALL Java_global_Natoolstop_getCursor_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	CNAToolStop *pObjectX = (CNAToolStop*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCNAToolStopProxy))
	{
		ev_int32 __values1 = pObjectX->CNAToolStop::getCursor();
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolstop_register_1getCursor_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNAToolStopProxy *pObjectX = (JCNAToolStopProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jint JNICALL Java_global_Natoolstop_getCursor_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	CNAToolStop *pObjectX = (CNAToolStop*) pObjXXXX;
	ev_int32 __values1 = pObjectX->CNAToolStop::getCursor();
	jint __values1_j = (jint)__values1;
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolstop_activate_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	CNAToolStop *pObjectX = (CNAToolStop*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCNAToolStopProxy))
	{
		pObjectX->CNAToolStop::activate();
	}
	else
	{
		pObjectX->activate();
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolstop_register_1activate_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNAToolStopProxy *pObjectX = (JCNAToolStopProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolstop_activate_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	CNAToolStop *pObjectX = (CNAToolStop*) pObjXXXX;
	pObjectX->CNAToolStop::activate();
}
extern "C" JNIEXPORT void JNICALL Java_global_Natoolstop_deactivate_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	CNAToolStop *pObjectX = (CNAToolStop*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCNAToolStopProxy))
	{
		pObjectX->CNAToolStop::deactivate();
	}
	else
	{
		pObjectX->deactivate();
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolstop_register_1deactivate_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNAToolStopProxy *pObjectX = (JCNAToolStopProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolstop_deactivate_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	CNAToolStop *pObjectX = (CNAToolStop*) pObjXXXX;
	pObjectX->CNAToolStop::deactivate();
}
extern "C" JNIEXPORT void JNICALL Java_global_Natoolstop_onClicked_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	CNAToolStop *pObjectX = (CNAToolStop*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCNAToolStopProxy))
	{
		pObjectX->CNAToolStop::onClicked();
	}
	else
	{
		pObjectX->onClicked();
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolstop_register_1onClicked_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNAToolStopProxy *pObjectX = (JCNAToolStopProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolstop_onClicked_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	CNAToolStop *pObjectX = (CNAToolStop*) pObjXXXX;
	pObjectX->CNAToolStop::onClicked();
}
extern "C" JNIEXPORT jboolean JNICALL Java_global_Natoolstop_getChecked_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNAToolStop *pObjectX = (CNAToolStop*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCNAToolStopProxy))
	{
		ev_bool __values1 = pObjectX->CNAToolStop::getChecked();
		jboolean __values1_j = (jboolean)__values1;
		return __values1_j;
	}
	else
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolstop_register_1getChecked_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNAToolStopProxy *pObjectX = (JCNAToolStopProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jboolean JNICALL Java_global_Natoolstop_getChecked_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNAToolStop *pObjectX = (CNAToolStop*) pObjXXXX;
	ev_bool __values1 = pObjectX->CNAToolStop::getChecked();
	jboolean __values1_j = (jboolean)__values1;
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolstop_setChecked_1ev_1bool(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean checked_j)
{
	ev_bool checked = (ev_bool) checked_j;
	CNAToolStop *pObjectX = (CNAToolStop*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCNAToolStopProxy))
	{
		pObjectX->CNAToolStop::setChecked(checked);
	}
	else
	{
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolstop_register_1setChecked_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNAToolStopProxy *pObjectX = (JCNAToolStopProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolstop_setChecked_1ev_1bool_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean checked_j)
{
	ev_bool checked = (ev_bool) checked_j;
	CNAToolStop *pObjectX = (CNAToolStop*) pObjXXXX;
	pObjectX->CNAToolStop::setChecked(checked);
}
extern "C" JNIEXPORT jboolean JNICALL Java_global_Natoolstop_getEnabled_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNAToolStop *pObjectX = (CNAToolStop*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCNAToolStopProxy))
	{
		ev_bool __values1 = pObjectX->CNAToolStop::getEnabled();
		jboolean __values1_j = (jboolean)__values1;
		return __values1_j;
	}
	else
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolstop_register_1getEnabled_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNAToolStopProxy *pObjectX = (JCNAToolStopProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jboolean JNICALL Java_global_Natoolstop_getEnabled_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CNAToolStop *pObjectX = (CNAToolStop*) pObjXXXX;
	ev_bool __values1 = pObjectX->CNAToolStop::getEnabled();
	jboolean __values1_j = (jboolean)__values1;
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolstop_setEnabled_1ev_1bool(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean enabled_j)
{
	ev_bool enabled = (ev_bool) enabled_j;
	CNAToolStop *pObjectX = (CNAToolStop*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCNAToolStopProxy))
	{
		pObjectX->CNAToolStop::setEnabled(enabled);
	}
	else
	{
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolstop_register_1setEnabled_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNAToolStopProxy *pObjectX = (JCNAToolStopProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolstop_setEnabled_1ev_1bool_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean enabled_j)
{
	ev_bool enabled = (ev_bool) enabled_j;
	CNAToolStop *pObjectX = (CNAToolStop*) pObjXXXX;
	pObjectX->CNAToolStop::setEnabled(enabled);
}
extern "C" JNIEXPORT jboolean JNICALL Java_global_Natoolstop_onKeyDown_1ev_1int32_1ev_1int32(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint keyCode_j, jint shift_j)
{
	...
	if (typeid(*pObjectX) == typeid(JCNAToolStopProxy))
	{
		ev_bool __values1 = pObjectX->CNAToolStop::onKeyDown(keyCode, shift);
		jboolean __values1_j = (jboolean)__values1;
		return __values1_j;
	}
	else
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolstop_register_1onKeyDown_1ev_1int32_1ev_1int32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNAToolStopProxy *pObjectX = (JCNAToolStopProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jboolean JNICALL Java_global_Natoolstop_onKeyDown_1ev_1int32_1ev_1int32_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint keyCode_j, jint shift_j)
{
	ev_int32 keyCode = (ev_int32) keyCode_j;
	ev_int32 shift = (ev_int32) shift_j;
	CNAToolStop *pObjectX = (CNAToolStop*) pObjXXXX;
...
extern "C" JNIEXPORT jboolean JNICALL Java_global_Natoolstop_onMouseDown_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint button_j, jint shift_j, jint x_j, jint y_j)
{
	...
	if (typeid(*pObjectX) == typeid(JCNAToolStopProxy))
	{
		ev_bool __values1 = pObjectX->CNAToolStop::onMouseDown(button, shift, x, y);
		jboolean __values1_j = (jboolean)__values1;
		return __values1_j;
	}
	else
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolstop_register_1onMouseDown_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNAToolStopProxy *pObjectX = (JCNAToolStopProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jboolean JNICALL Java_global_Natoolstop_onMouseDown_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint button_j, jint shift_j, jint x_j, jint y_j)
{
	ev_int32 button = (ev_int32) button_j;
	ev_int32 shift = (ev_int32) shift_j;
	ev_int32 x = (ev_int32) x_j;
...
extern "C" JNIEXPORT jboolean JNICALL Java_global_Natoolstop_update_1CEvent(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong e_j)
{
	EarthView::World::Core::CEvent *e = (EarthView::World::Core::CEvent*) e_j;
	CNAToolStop *pObjectX = (CNAToolStop*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCNAToolStopProxy))
	{
		ev_bool __values1 = pObjectX->CNAToolStop::update(e);
		jboolean __values1_j = (jboolean)__values1;
		return __values1_j;
	}
	else
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolstop_register_1update_1CEvent(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNAToolStopProxy *pObjectX = (JCNAToolStopProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jboolean JNICALL Java_global_Natoolstop_update_1CEvent_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong e_j)
{
	EarthView::World::Core::CEvent *e = (EarthView::World::Core::CEvent*) e_j;
	CNAToolStop *pObjectX = (CNAToolStop*) pObjXXXX;
	ev_bool __values1 = pObjectX->CNAToolStop::update(e);
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolstop_register_1onContextMenu_1ev_1int32_1ev_1int32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNAToolStopProxy *pObjectX = (JCNAToolStopProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolstop_register_1onDoubleClick_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNAToolStopProxy *pObjectX = (JCNAToolStopProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolstop_register_1onDoubleClick_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNAToolStopProxy *pObjectX = (JCNAToolStopProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolstop_register_1onKeyUp_1ev_1int32_1ev_1int32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNAToolStopProxy *pObjectX = (JCNAToolStopProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolstop_register_1onMouseMove_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNAToolStopProxy *pObjectX = (JCNAToolStopProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolstop_register_1onMouseUp_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNAToolStopProxy *pObjectX = (JCNAToolStopProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolstop_register_1onMouseWheel_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNAToolStopProxy *pObjectX = (JCNAToolStopProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolstop_register_1onTouchDown_1MotionEvent(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNAToolStopProxy *pObjectX = (JCNAToolStopProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolstop_register_1onTouchUp_1MotionEvent(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNAToolStopProxy *pObjectX = (JCNAToolStopProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolstop_register_1onTouchMove_1MotionEvent(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNAToolStopProxy *pObjectX = (JCNAToolStopProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT void JNICALL Java_global_Natoolstop_register_1create_1ISpatialControl(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCNAToolStopProxy *pObjectX = (JCNAToolStopProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
