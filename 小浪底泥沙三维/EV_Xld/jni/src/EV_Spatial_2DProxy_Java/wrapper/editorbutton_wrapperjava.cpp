...
class JCEditorButtonProxy : public CEditorButton
{
 private:
...
public:
	JCEditorButtonProxy(EarthView::World::Core::CNameValuePairList *pList) : CEditorButton(pList)
	{
	}
...
protected:
	C_DISABLE_COPY(JCEditorButtonProxy)
public:
...
REGISTER_FACTORY_CLASS(JCEditorButtonProxy);
extern "C" JNIEXPORT jlong JNICALL Java_global_EditorButton_getToolBarType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CEditorButton *pObjectX = (CEditorButton*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCEditorButtonProxy))
	{
		ev_uint32 __values1 = pObjectX->CEditorButton::getToolBarType();
...
extern "C" JNIEXPORT void JNICALL Java_global_EditorButton_register_1getToolBarType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCEditorButtonProxy *pObjectX = (JCEditorButtonProxy*) pObjXXXX;
...
extern "C" JNIEXPORT jlong JNICALL Java_global_EditorButton_getToolBarType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CEditorButton *pObjectX = (CEditorButton*) pObjXXXX;
	ev_uint32 __values1 = pObjectX->CEditorButton::getToolBarType();
	jlong __values1_j = (jlong) __values1;
...
extern "C" JNIEXPORT jlong JNICALL Java_global_EditorButton_getType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CEditorButton *pObjectX = (CEditorButton*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCEditorButtonProxy))
	{
		ev_uint32 __values1 = pObjectX->CEditorButton::getType();
		jlong __values1_j = (jlong) __values1;
		return __values1_j;
	}
	else
...
extern "C" JNIEXPORT void JNICALL Java_global_EditorButton_register_1getType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCEditorButtonProxy *pObjectX = (JCEditorButtonProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jlong JNICALL Java_global_EditorButton_getType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CEditorButton *pObjectX = (CEditorButton*) pObjXXXX;
	ev_uint32 __values1 = pObjectX->CEditorButton::getType();
	jlong __values1_j = (jlong) __values1;
...
extern "C" JNIEXPORT jstring JNICALL Java_global_EditorButton_getName_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CEditorButton *pObjectX = (CEditorButton*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCEditorButtonProxy))
	{
		EVString __values1 = pObjectX->CEditorButton::getName();
...
extern "C" JNIEXPORT void JNICALL Java_global_EditorButton_register_1getName_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCEditorButtonProxy *pObjectX = (JCEditorButtonProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jstring JNICALL Java_global_EditorButton_getName_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CEditorButton *pObjectX = (CEditorButton*) pObjXXXX;
	EVString __values1 = pObjectX->CEditorButton::getName();
	EarthView::World::Core::ev_wstring valuesw1 = __values1;
...
extern "C" JNIEXPORT jstring JNICALL Java_global_EditorButton_getCategory_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CEditorButton *pObjectX = (CEditorButton*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCEditorButtonProxy))
	{
		EVString __values1 = pObjectX->CEditorButton::getCategory();
		EarthView::World::Core::ev_wstring valuesw1 = __values1;
		jstring __values1_j = __env->NewString((const jchar*)valuesw1.getString(), valuesw1.size());
		return __values1_j;
	}
...
extern "C" JNIEXPORT void JNICALL Java_global_EditorButton_register_1getCategory_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCEditorButtonProxy *pObjectX = (JCEditorButtonProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jstring JNICALL Java_global_EditorButton_getCategory_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CEditorButton *pObjectX = (CEditorButton*) pObjXXXX;
	EVString __values1 = pObjectX->CEditorButton::getCategory();
	EarthView::World::Core::ev_wstring valuesw1 = __values1;
...
extern "C" JNIEXPORT jstring JNICALL Java_global_EditorButton_getToolTip_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CEditorButton *pObjectX = (CEditorButton*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCEditorButtonProxy))
	{
		EVString __values1 = pObjectX->CEditorButton::getToolTip();
		EarthView::World::Core::ev_wstring valuesw1 = __values1;
		jstring __values1_j = __env->NewString((const jchar*)valuesw1.getString(), valuesw1.size());
		return __values1_j;
	}
...
extern "C" JNIEXPORT void JNICALL Java_global_EditorButton_register_1getToolTip_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCEditorButtonProxy *pObjectX = (JCEditorButtonProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jstring JNICALL Java_global_EditorButton_getToolTip_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CEditorButton *pObjectX = (CEditorButton*) pObjXXXX;
	EVString __values1 = pObjectX->CEditorButton::getToolTip();
	EarthView::World::Core::ev_wstring valuesw1 = __values1;
...
extern "C" JNIEXPORT jlong JNICALL Java_global_EditorButton_getIcon_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CEditorButton *pObjectX = (CEditorButton*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCEditorButtonProxy))
	{
		EarthView::World::Display::IBitmap* __values1 = pObjectX->CEditorButton::getIcon();
		jlong __values1_j = (jlong) __values1;
		return __values1_j;
	}
	else
...
extern "C" JNIEXPORT void JNICALL Java_global_EditorButton_register_1getIcon_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCEditorButtonProxy *pObjectX = (JCEditorButtonProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jlong JNICALL Java_global_EditorButton_getIcon_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CEditorButton *pObjectX = (CEditorButton*) pObjXXXX;
	EarthView::World::Display::IBitmap* __values1 = pObjectX->CEditorButton::getIcon();
	jlong __values1_j = (jlong) __values1;
...
extern "C" JNIEXPORT jboolean JNICALL Java_global_EditorButton_isCheckable_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CEditorButton *pObjectX = (CEditorButton*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCEditorButtonProxy))
	{
		ev_bool __values1 = pObjectX->CEditorButton::isCheckable();
...
extern "C" JNIEXPORT void JNICALL Java_global_EditorButton_register_1isCheckable_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCEditorButtonProxy *pObjectX = (JCEditorButtonProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jboolean JNICALL Java_global_EditorButton_isCheckable_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CEditorButton *pObjectX = (CEditorButton*) pObjXXXX;
	ev_bool __values1 = pObjectX->CEditorButton::isCheckable();
	jboolean __values1_j = (jboolean)__values1;
...
extern "C" JNIEXPORT void JNICALL Java_global_EditorButton_onClicked_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	CEditorButton *pObjectX = (CEditorButton*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCEditorButtonProxy))
	{
		pObjectX->CEditorButton::onClicked();
	}
	else
	{
		pObjectX->onClicked();
...
extern "C" JNIEXPORT void JNICALL Java_global_EditorButton_register_1onClicked_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCEditorButtonProxy *pObjectX = (JCEditorButtonProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT void JNICALL Java_global_EditorButton_onClicked_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	CEditorButton *pObjectX = (CEditorButton*) pObjXXXX;
	pObjectX->CEditorButton::onClicked();
}
extern "C" JNIEXPORT jboolean JNICALL Java_global_EditorButton_getChecked_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CEditorButton *pObjectX = (CEditorButton*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCEditorButtonProxy))
	{
		ev_bool __values1 = pObjectX->CEditorButton::getChecked();
		jboolean __values1_j = (jboolean)__values1;
		return __values1_j;
	}
	else
...
extern "C" JNIEXPORT void JNICALL Java_global_EditorButton_register_1getChecked_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCEditorButtonProxy *pObjectX = (JCEditorButtonProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jboolean JNICALL Java_global_EditorButton_getChecked_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CEditorButton *pObjectX = (CEditorButton*) pObjXXXX;
	ev_bool __values1 = pObjectX->CEditorButton::getChecked();
	jboolean __values1_j = (jboolean)__values1;
...
extern "C" JNIEXPORT void JNICALL Java_global_EditorButton_setChecked_1ev_1bool(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean checked_j)
{
	ev_bool checked = (ev_bool) checked_j;
	CEditorButton *pObjectX = (CEditorButton*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCEditorButtonProxy))
	{
		pObjectX->CEditorButton::setChecked(checked);
	}
	else
	{
...
extern "C" JNIEXPORT void JNICALL Java_global_EditorButton_register_1setChecked_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCEditorButtonProxy *pObjectX = (JCEditorButtonProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT void JNICALL Java_global_EditorButton_setChecked_1ev_1bool_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean checked_j)
{
	ev_bool checked = (ev_bool) checked_j;
	CEditorButton *pObjectX = (CEditorButton*) pObjXXXX;
	pObjectX->CEditorButton::setChecked(checked);
}
extern "C" JNIEXPORT jboolean JNICALL Java_global_EditorButton_getEnabled_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CEditorButton *pObjectX = (CEditorButton*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCEditorButtonProxy))
	{
		ev_bool __values1 = pObjectX->CEditorButton::getEnabled();
		jboolean __values1_j = (jboolean)__values1;
		return __values1_j;
	}
	else
...
extern "C" JNIEXPORT void JNICALL Java_global_EditorButton_register_1getEnabled_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCEditorButtonProxy *pObjectX = (JCEditorButtonProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jboolean JNICALL Java_global_EditorButton_getEnabled_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CEditorButton *pObjectX = (CEditorButton*) pObjXXXX;
	ev_bool __values1 = pObjectX->CEditorButton::getEnabled();
	jboolean __values1_j = (jboolean)__values1;
...
extern "C" JNIEXPORT void JNICALL Java_global_EditorButton_setEnabled_1ev_1bool(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean enabled_j)
{
	ev_bool enabled = (ev_bool) enabled_j;
	CEditorButton *pObjectX = (CEditorButton*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCEditorButtonProxy))
	{
		pObjectX->CEditorButton::setEnabled(enabled);
	}
	else
	{
...
extern "C" JNIEXPORT void JNICALL Java_global_EditorButton_register_1setEnabled_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCEditorButtonProxy *pObjectX = (JCEditorButtonProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT void JNICALL Java_global_EditorButton_setEnabled_1ev_1bool_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean enabled_j)
{
	ev_bool enabled = (ev_bool) enabled_j;
	CEditorButton *pObjectX = (CEditorButton*) pObjXXXX;
	pObjectX->CEditorButton::setEnabled(enabled);
}
extern "C" JNIEXPORT void JNICALL Java_global_EditorButton_create_1ISpatialControl(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong ref_ctrl_j)
{
	EarthView::World::Spatial::Atlas::ISpatialControl *ref_ctrl = (EarthView::World::Spatial::Atlas::ISpatialControl*) ref_ctrl_j;
	CEditorButton *pObjectX = (CEditorButton*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCEditorButtonProxy))
	{
		pObjectX->CEditorButton::create(ref_ctrl);
	}
	else
	{
...
extern "C" JNIEXPORT void JNICALL Java_global_EditorButton_register_1create_1ISpatialControl(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCEditorButtonProxy *pObjectX = (JCEditorButtonProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT void JNICALL Java_global_EditorButton_create_1ISpatialControl_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong ref_ctrl_j)
{
	EarthView::World::Spatial::Atlas::ISpatialControl *ref_ctrl = (EarthView::World::Spatial::Atlas::ISpatialControl*) ref_ctrl_j;
	CEditorButton *pObjectX = (CEditorButton*) pObjXXXX;
	pObjectX->CEditorButton::create(ref_ctrl);
}
extern "C" JNIEXPORT jboolean JNICALL Java_global_EditorButton_update_1CEvent(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong e_j)
{
	EarthView::World::Core::CEvent *e = (EarthView::World::Core::CEvent*) e_j;
	CEditorButton *pObjectX = (CEditorButton*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCEditorButtonProxy))
	{
		ev_bool __values1 = pObjectX->CEditorButton::update(e);
		jboolean __values1_j = (jboolean)__values1;
		return __values1_j;
	}
	else
...
extern "C" JNIEXPORT void JNICALL Java_global_EditorButton_register_1update_1CEvent(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCEditorButtonProxy *pObjectX = (JCEditorButtonProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jboolean JNICALL Java_global_EditorButton_update_1CEvent_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong e_j)
{
	EarthView::World::Core::CEvent *e = (EarthView::World::Core::CEvent*) e_j;
	CEditorButton *pObjectX = (CEditorButton*) pObjXXXX;
	ev_bool __values1 = pObjectX->CEditorButton::update(e);
...
extern "C" JNIEXPORT void JNICALL Java_global_EditorButton_addCommand_1ICommand(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong ref_cmd_j)
{
	EarthView::World::Spatial::SystemUI::ICommand *ref_cmd = (EarthView::World::Spatial::SystemUI::ICommand*) ref_cmd_j;
	CEditorButton *pObjectX = (CEditorButton*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCEditorButtonProxy))
	{
		pObjectX->CEditorButton::addCommand(ref_cmd);
	}
	else
	{
...
extern "C" JNIEXPORT void JNICALL Java_global_EditorButton_register_1addCommand_1ICommand(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCEditorButtonProxy *pObjectX = (JCEditorButtonProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT void JNICALL Java_global_EditorButton_addCommand_1ICommand_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong ref_cmd_j)
{
	EarthView::World::Spatial::SystemUI::ICommand *ref_cmd = (EarthView::World::Spatial::SystemUI::ICommand*) ref_cmd_j;
	CEditorButton *pObjectX = (CEditorButton*) pObjXXXX;
	pObjectX->CEditorButton::addCommand(ref_cmd);
}
extern "C" JNIEXPORT jlong JNICALL Java_global_EditorButton_getCount_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CEditorButton *pObjectX = (CEditorButton*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCEditorButtonProxy))
	{
		ev_uint32 __values1 = pObjectX->CEditorButton::getCount();
		jlong __values1_j = (jlong) __values1;
		return __values1_j;
	}
	else
...
extern "C" JNIEXPORT void JNICALL Java_global_EditorButton_register_1getCount_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCEditorButtonProxy *pObjectX = (JCEditorButtonProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jlong JNICALL Java_global_EditorButton_getCount_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
{
	const 	CEditorButton *pObjectX = (CEditorButton*) pObjXXXX;
	ev_uint32 __values1 = pObjectX->CEditorButton::getCount();
	jlong __values1_j = (jlong) __values1;
...
extern "C" JNIEXPORT jlong JNICALL Java_global_EditorButton_getCommand_1ev_1uint32(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong index_j)
{
	ev_uint32 index = (ev_uint32) index_j;
	const 	CEditorButton *pObjectX = (CEditorButton*) pObjXXXX;
	if (typeid(*pObjectX) == typeid(JCEditorButtonProxy))
	{
		EarthView::World::Spatial::SystemUI::ICommand* __values1 = pObjectX->CEditorButton::getCommand(index);
		jlong __values1_j = (jlong) __values1;
		return __values1_j;
	}
	else
...
extern "C" JNIEXPORT void JNICALL Java_global_EditorButton_register_1getCommand_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
{
	JCEditorButtonProxy *pObjectX = (JCEditorButtonProxy*) pObjXXXX;
	const char *pMethod = __env->GetStringUTFChars(__method, NULL);
	EarthView::World::Core::ev_string sMethod = pMethod;
...
extern "C" JNIEXPORT jlong JNICALL Java_global_EditorButton_getCommand_1ev_1uint32_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong index_j)
{
	ev_uint32 index = (ev_uint32) index_j;
	const 	CEditorButton *pObjectX = (CEditorButton*) pObjXXXX;
	EarthView::World::Spatial::SystemUI::ICommand* __values1 = pObjectX->CEditorButton::getCommand(index);
