...
namespace EarthView
{
	namespace World
	{
		namespace Spatial
		{
			namespace Accessor
			{
				class JIDBAccessorProxy : public EarthView::World::Spatial::Accessor::IDBAccessor
				{
				 private:
				...
				public:
					JIDBAccessorProxy(EarthView::World::Core::CNameValuePairList *pList) : IDBAccessor(pList)
					{
					}
				...
				REGISTER_FACTORY_CLASS(JIDBAccessorProxy);
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_accessor_Idbaccessor_register_1getType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIDBAccessorProxy *pObjectX = (JIDBAccessorProxy*) pObjXXXX;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_accessor_Idbaccessor_register_1open_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIDBAccessorProxy *pObjectX = (JIDBAccessorProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_accessor_Idbaccessor_register_1close_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIDBAccessorProxy *pObjectX = (JIDBAccessorProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
