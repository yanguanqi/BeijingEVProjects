...
namespace EarthView
{
	namespace World
	{
		namespace Spatial
		{
			namespace Geometry
			{
				extern "C" JNIEXPORT jintArray JNICALL Java_com_earthview_world_spatial_geometry_EVGeometryTypeHelper_getEnumValues (JNIEnv *__env, jclass __clazz)
				{
					jint enum_values[] = {
						GT_UNKNOWN,
						GT_POINT,
				...
				extern "C" JNIEXPORT jintArray JNICALL Java_com_earthview_world_spatial_geometry_EVWKBGeometryTypeHelper_getEnumValues (JNIEnv *__env, jclass __clazz)
				{
					jint enum_values[] = {
						WKBGT_Unknown,
						WKBGT_Point,
						...
						WKBGT_Polygon,
						WKBGT_MultiPoint,
						WKBGT_MultiLineString,
						WKBGT_MultiPolygon,
						WKBGT_GeometryCollection,
						WKBGT_PointZ,
						WKBGT_LineStringZ,
						WKBGT_PolygonZ,
						WKBGT_MultiPointZ,
						WKBGT_MultiLineStringZ,
						WKBGT_MultiPolygonZ,
						WKBGT_GeometryCollectionZ,
						WKBGT_PointM,
						WKBGT_LineStringM,
						WKBGT_PolygonM,
						WKBGT_MultiPointM,
						WKBGT_MultiLineStringM,
						WKBGT_MultiPolygonM,
						WKBGT_GeometryCollectionM,
						WKBGT_PointZM,
						WKBGT_LineStringZM,
						WKBGT_PolygonZM,
						WKBGT_MultiPointZM,
						WKBGT_MultiLineStringZM,
						WKBGT_MultiPolygonZM,
						WKBGT_GeometryCollectionZM
					};
					jintArray array = __env->NewIntArray(29);
					__env->SetIntArrayRegion(array, 0, 29, enum_values);
					return array;
				}
				class JIGeometryProxy : public EarthView::World::Spatial::Geometry::IGeometry
				{
				 private:
				...
				public:
					JIGeometryProxy(EarthView::World::Core::CNameValuePairList *pList) : IGeometry(pList)
					{
					}
				...
				REGISTER_FACTORY_CLASS(JIGeometryProxy);
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_getEnvelopeRef_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Geometry::IGeometry *pObjectX = (EarthView::World::Spatial::Geometry::IGeometry*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIGeometryProxy))
					{
						const EarthView::World::Spatial::Geometry::IEnvelope* __values1 = pObjectX->EarthView::World::Spatial::Geometry::IGeometry::getEnvelopeRef();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_register_1getEnvelopeRef_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGeometryProxy *pObjectX = (JIGeometryProxy*) pObjXXXX;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_getEnvelopeRef_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Geometry::IGeometry *pObjectX = (EarthView::World::Spatial::Geometry::IGeometry*) pObjXXXX;
					const EarthView::World::Spatial::Geometry::IEnvelope* __values1 = pObjectX->EarthView::World::Spatial::Geometry::IGeometry::getEnvelopeRef();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_getSpatialReferenceRef_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Geometry::IGeometry *pObjectX = (EarthView::World::Spatial::Geometry::IGeometry*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIGeometryProxy))
					{
						const EarthView::World::Spatial::Geometry::ISpatialReference* __values1 = pObjectX->EarthView::World::Spatial::Geometry::IGeometry::getSpatialReferenceRef();
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_register_1getSpatialReferenceRef_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGeometryProxy *pObjectX = (JIGeometryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_getSpatialReferenceRef_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Geometry::IGeometry *pObjectX = (EarthView::World::Spatial::Geometry::IGeometry*) pObjXXXX;
					const EarthView::World::Spatial::Geometry::ISpatialReference* __values1 = pObjectX->EarthView::World::Spatial::Geometry::IGeometry::getSpatialReferenceRef();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_getGeometryType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Geometry::IGeometry *pObjectX = (EarthView::World::Spatial::Geometry::IGeometry*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIGeometryProxy))
					{
						EarthView::World::Spatial::Geometry::EVGeometryType __values1 = pObjectX->EarthView::World::Spatial::Geometry::IGeometry::getGeometryType();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_register_1getGeometryType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGeometryProxy *pObjectX = (JIGeometryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_getGeometryType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Geometry::IGeometry *pObjectX = (EarthView::World::Spatial::Geometry::IGeometry*) pObjXXXX;
					EarthView::World::Spatial::Geometry::EVGeometryType __values1 = pObjectX->EarthView::World::Spatial::Geometry::IGeometry::getGeometryType();
					jint __values1_j = (jint) __values1;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_getWKBGeometryType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Geometry::IGeometry *pObjectX = (EarthView::World::Spatial::Geometry::IGeometry*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIGeometryProxy))
					{
						EarthView::World::Spatial::Geometry::EVWKBGeometryType __values1 = pObjectX->EarthView::World::Spatial::Geometry::IGeometry::getWKBGeometryType();
						jint __values1_j = (jint) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_register_1getWKBGeometryType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGeometryProxy *pObjectX = (JIGeometryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_getWKBGeometryType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Geometry::IGeometry *pObjectX = (EarthView::World::Spatial::Geometry::IGeometry*) pObjXXXX;
					EarthView::World::Spatial::Geometry::EVWKBGeometryType __values1 = pObjectX->EarthView::World::Spatial::Geometry::IGeometry::getWKBGeometryType();
					jint __values1_j = (jint) __values1;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_isValid_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Geometry::IGeometry *pObjectX = (EarthView::World::Spatial::Geometry::IGeometry*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIGeometryProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial::Geometry::IGeometry::isValid();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_register_1isValid_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGeometryProxy *pObjectX = (JIGeometryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_isValid_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Geometry::IGeometry *pObjectX = (EarthView::World::Spatial::Geometry::IGeometry*) pObjXXXX;
					ev_bool __values1 = pObjectX->EarthView::World::Spatial::Geometry::IGeometry::isValid();
					jboolean __values1_j = (jboolean)__values1;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_isEmpty_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Geometry::IGeometry *pObjectX = (EarthView::World::Spatial::Geometry::IGeometry*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIGeometryProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial::Geometry::IGeometry::isEmpty();
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_register_1isEmpty_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGeometryProxy *pObjectX = (JIGeometryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_isEmpty_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Geometry::IGeometry *pObjectX = (EarthView::World::Spatial::Geometry::IGeometry*) pObjXXXX;
					ev_bool __values1 = pObjectX->EarthView::World::Spatial::Geometry::IGeometry::isEmpty();
					jboolean __values1_j = (jboolean)__values1;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_isSimple_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Geometry::IGeometry *pObjectX = (EarthView::World::Spatial::Geometry::IGeometry*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIGeometryProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial::Geometry::IGeometry::isSimple();
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_register_1isSimple_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGeometryProxy *pObjectX = (JIGeometryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_isSimple_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Geometry::IGeometry *pObjectX = (EarthView::World::Spatial::Geometry::IGeometry*) pObjXXXX;
					ev_bool __values1 = pObjectX->EarthView::World::Spatial::Geometry::IGeometry::isSimple();
					jboolean __values1_j = (jboolean)__values1;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_simplify_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial::Geometry::IGeometry *pObjectX = (EarthView::World::Spatial::Geometry::IGeometry*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIGeometryProxy))
					{
						pObjectX->EarthView::World::Spatial::Geometry::IGeometry::simplify();
					}
					else
					{
						pObjectX->simplify();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_register_1simplify_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGeometryProxy *pObjectX = (JIGeometryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_simplify_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial::Geometry::IGeometry *pObjectX = (EarthView::World::Spatial::Geometry::IGeometry*) pObjXXXX;
					pObjectX->EarthView::World::Spatial::Geometry::IGeometry::simplify();
				}
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_getBoundary_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Geometry::IGeometry *pObjectX = (EarthView::World::Spatial::Geometry::IGeometry*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIGeometryProxy))
					{
						EarthView::World::Spatial::Geometry::IGeometry* __values1 = pObjectX->EarthView::World::Spatial::Geometry::IGeometry::getBoundary();
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_register_1getBoundary_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGeometryProxy *pObjectX = (JIGeometryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_getBoundary_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Geometry::IGeometry *pObjectX = (EarthView::World::Spatial::Geometry::IGeometry*) pObjXXXX;
					EarthView::World::Spatial::Geometry::IGeometry* __values1 = pObjectX->EarthView::World::Spatial::Geometry::IGeometry::getBoundary();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_makeZ_1ev_1real64(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble z_j)
				{
					ev_real64 z = (ev_real64) z_j;
					EarthView::World::Spatial::Geometry::IGeometry *pObjectX = (EarthView::World::Spatial::Geometry::IGeometry*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIGeometryProxy))
					{
						pObjectX->EarthView::World::Spatial::Geometry::IGeometry::makeZ(z);
					}
					else
					{
						pObjectX->makeZ(z);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_register_1makeZ_1ev_1real64(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGeometryProxy *pObjectX = (JIGeometryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_makeZ_1ev_1real64_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble z_j)
				{
					ev_real64 z = (ev_real64) z_j;
					EarthView::World::Spatial::Geometry::IGeometry *pObjectX = (EarthView::World::Spatial::Geometry::IGeometry*) pObjXXXX;
					pObjectX->EarthView::World::Spatial::Geometry::IGeometry::makeZ(z);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_makeM_1ev_1real64(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble m_j)
				{
					ev_real64 m = (ev_real64) m_j;
					EarthView::World::Spatial::Geometry::IGeometry *pObjectX = (EarthView::World::Spatial::Geometry::IGeometry*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIGeometryProxy))
					{
						pObjectX->EarthView::World::Spatial::Geometry::IGeometry::makeM(m);
					}
					else
					{
						pObjectX->makeM(m);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_register_1makeM_1ev_1real64(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGeometryProxy *pObjectX = (JIGeometryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_makeM_1ev_1real64_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble m_j)
				{
					ev_real64 m = (ev_real64) m_j;
					EarthView::World::Spatial::Geometry::IGeometry *pObjectX = (EarthView::World::Spatial::Geometry::IGeometry*) pObjXXXX;
					pObjectX->EarthView::World::Spatial::Geometry::IGeometry::makeM(m);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_setSpatialReferenceRef_1ISpatialReference(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong ref_sr_j)
				{
					...
					if (typeid(*pObjectX) == typeid(JIGeometryProxy))
					{
						pObjectX->EarthView::World::Spatial::Geometry::IGeometry::setSpatialReferenceRef(ref_sr);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_register_1setSpatialReferenceRef_1ISpatialReference(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGeometryProxy *pObjectX = (JIGeometryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_setSpatialReferenceRef_1ISpatialReference_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong ref_sr_j)
				{
					const EarthView::World::Spatial::Geometry::ISpatialReference *ref_sr = (const EarthView::World::Spatial::Geometry::ISpatialReference*) ref_sr_j;
					EarthView::World::Spatial::Geometry::IGeometry *pObjectX = (EarthView::World::Spatial::Geometry::IGeometry*) pObjXXXX;
					pObjectX->EarthView::World::Spatial::Geometry::IGeometry::setSpatialReferenceRef(ref_sr);
				}
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_ev_1clone_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Geometry::IGeometry *pObjectX = (EarthView::World::Spatial::Geometry::IGeometry*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIGeometryProxy))
					{
						EarthView::World::Spatial::Geometry::IGeometry* __values1 = pObjectX->EarthView::World::Spatial::Geometry::IGeometry::clone();
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_register_1ev_1clone_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGeometryProxy *pObjectX = (JIGeometryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_ev_1clone_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Geometry::IGeometry *pObjectX = (EarthView::World::Spatial::Geometry::IGeometry*) pObjXXXX;
					EarthView::World::Spatial::Geometry::IGeometry* __values1 = pObjectX->EarthView::World::Spatial::Geometry::IGeometry::clone();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_isContains_1IGeometry_1EVDimensionType(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong geom_j, jint dimension_j)
				{
					...
					if (typeid(*pObjectX) == typeid(JIGeometryProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial::Geometry::IGeometry::isContains(geom, dimension);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_register_1isContains_1IGeometry_1EVDimensionType(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGeometryProxy *pObjectX = (JIGeometryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_isContains_1IGeometry_1EVDimensionType_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong geom_j, jint dimension_j)
				{
					const EarthView::World::Spatial::Geometry::IGeometry *geom = (const EarthView::World::Spatial::Geometry::IGeometry*) geom_j;
					EarthView::World::Spatial::Geometry::EVDimensionType dimension = (EarthView::World::Spatial::Geometry::EVDimensionType) dimension_j;
					const 					EarthView::World::Spatial::Geometry::IGeometry *pObjectX = (EarthView::World::Spatial::Geometry::IGeometry*) pObjXXXX;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_isEquals_1IGeometry_1ev_1real64_1EVDimensionType(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong geom_j, jdouble tolerance_j, jint dimension_j)
				{
					const EarthView::World::Spatial::Geometry::IGeometry *geom = (const EarthView::World::Spatial::Geometry::IGeometry*) geom_j;
					...
					if (typeid(*pObjectX) == typeid(JIGeometryProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial::Geometry::IGeometry::isEquals(geom, tolerance, dimension);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_register_1isEquals_1IGeometry_1ev_1real64_1EVDimensionType(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGeometryProxy *pObjectX = (JIGeometryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_isEquals_1IGeometry_1ev_1real64_1EVDimensionType_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong geom_j, jdouble tolerance_j, jint dimension_j)
				{
					const EarthView::World::Spatial::Geometry::IGeometry *geom = (const EarthView::World::Spatial::Geometry::IGeometry*) geom_j;
					ev_real64 tolerance = (ev_real64) tolerance_j;
					EarthView::World::Spatial::Geometry::EVDimensionType dimension = (EarthView::World::Spatial::Geometry::EVDimensionType) dimension_j;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_isDisjoin_1IGeometry_1EVDimensionType(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong geom_j, jint dimension_j)
				{
					const EarthView::World::Spatial::Geometry::IGeometry *geom = (const EarthView::World::Spatial::Geometry::IGeometry*) geom_j;
					EarthView::World::Spatial::Geometry::EVDimensionType dimension = (EarthView::World::Spatial::Geometry::EVDimensionType) dimension_j;
					const 					EarthView::World::Spatial::Geometry::IGeometry *pObjectX = (EarthView::World::Spatial::Geometry::IGeometry*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIGeometryProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial::Geometry::IGeometry::isDisjoin(geom, dimension);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_register_1isDisjoin_1IGeometry_1EVDimensionType(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGeometryProxy *pObjectX = (JIGeometryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_isDisjoin_1IGeometry_1EVDimensionType_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong geom_j, jint dimension_j)
				{
					const EarthView::World::Spatial::Geometry::IGeometry *geom = (const EarthView::World::Spatial::Geometry::IGeometry*) geom_j;
					EarthView::World::Spatial::Geometry::EVDimensionType dimension = (EarthView::World::Spatial::Geometry::EVDimensionType) dimension_j;
					const 					EarthView::World::Spatial::Geometry::IGeometry *pObjectX = (EarthView::World::Spatial::Geometry::IGeometry*) pObjXXXX;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_isIntersects_1IGeometry_1EVDimensionType(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong geom_j, jint dimension_j)
				{
					const EarthView::World::Spatial::Geometry::IGeometry *geom = (const EarthView::World::Spatial::Geometry::IGeometry*) geom_j;
					EarthView::World::Spatial::Geometry::EVDimensionType dimension = (EarthView::World::Spatial::Geometry::EVDimensionType) dimension_j;
					const 					EarthView::World::Spatial::Geometry::IGeometry *pObjectX = (EarthView::World::Spatial::Geometry::IGeometry*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIGeometryProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial::Geometry::IGeometry::isIntersects(geom, dimension);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_register_1isIntersects_1IGeometry_1EVDimensionType(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGeometryProxy *pObjectX = (JIGeometryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_isIntersects_1IGeometry_1EVDimensionType_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong geom_j, jint dimension_j)
				{
					const EarthView::World::Spatial::Geometry::IGeometry *geom = (const EarthView::World::Spatial::Geometry::IGeometry*) geom_j;
					EarthView::World::Spatial::Geometry::EVDimensionType dimension = (EarthView::World::Spatial::Geometry::EVDimensionType) dimension_j;
					const 					EarthView::World::Spatial::Geometry::IGeometry *pObjectX = (EarthView::World::Spatial::Geometry::IGeometry*) pObjXXXX;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_isWithin_1IGeometry_1EVDimensionType(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong geom_j, jint dimension_j)
				{
					const EarthView::World::Spatial::Geometry::IGeometry *geom = (const EarthView::World::Spatial::Geometry::IGeometry*) geom_j;
					EarthView::World::Spatial::Geometry::EVDimensionType dimension = (EarthView::World::Spatial::Geometry::EVDimensionType) dimension_j;
					const 					EarthView::World::Spatial::Geometry::IGeometry *pObjectX = (EarthView::World::Spatial::Geometry::IGeometry*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIGeometryProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial::Geometry::IGeometry::isWithin(geom, dimension);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_register_1isWithin_1IGeometry_1EVDimensionType(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGeometryProxy *pObjectX = (JIGeometryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_isWithin_1IGeometry_1EVDimensionType_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong geom_j, jint dimension_j)
				{
					const EarthView::World::Spatial::Geometry::IGeometry *geom = (const EarthView::World::Spatial::Geometry::IGeometry*) geom_j;
					EarthView::World::Spatial::Geometry::EVDimensionType dimension = (EarthView::World::Spatial::Geometry::EVDimensionType) dimension_j;
					const 					EarthView::World::Spatial::Geometry::IGeometry *pObjectX = (EarthView::World::Spatial::Geometry::IGeometry*) pObjXXXX;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_isTouches_1IGeometry_1EVDimensionType(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong geom_j, jint dimension_j)
				{
					const EarthView::World::Spatial::Geometry::IGeometry *geom = (const EarthView::World::Spatial::Geometry::IGeometry*) geom_j;
					EarthView::World::Spatial::Geometry::EVDimensionType dimension = (EarthView::World::Spatial::Geometry::EVDimensionType) dimension_j;
					const 					EarthView::World::Spatial::Geometry::IGeometry *pObjectX = (EarthView::World::Spatial::Geometry::IGeometry*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIGeometryProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial::Geometry::IGeometry::isTouches(geom, dimension);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_register_1isTouches_1IGeometry_1EVDimensionType(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGeometryProxy *pObjectX = (JIGeometryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_isTouches_1IGeometry_1EVDimensionType_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong geom_j, jint dimension_j)
				{
					const EarthView::World::Spatial::Geometry::IGeometry *geom = (const EarthView::World::Spatial::Geometry::IGeometry*) geom_j;
					EarthView::World::Spatial::Geometry::EVDimensionType dimension = (EarthView::World::Spatial::Geometry::EVDimensionType) dimension_j;
					const 					EarthView::World::Spatial::Geometry::IGeometry *pObjectX = (EarthView::World::Spatial::Geometry::IGeometry*) pObjXXXX;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_isCrosses_1IGeometry_1EVDimensionType(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong geom_j, jint dimension_j)
				{
					const EarthView::World::Spatial::Geometry::IGeometry *geom = (const EarthView::World::Spatial::Geometry::IGeometry*) geom_j;
					EarthView::World::Spatial::Geometry::EVDimensionType dimension = (EarthView::World::Spatial::Geometry::EVDimensionType) dimension_j;
					const 					EarthView::World::Spatial::Geometry::IGeometry *pObjectX = (EarthView::World::Spatial::Geometry::IGeometry*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIGeometryProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial::Geometry::IGeometry::isCrosses(geom, dimension);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_register_1isCrosses_1IGeometry_1EVDimensionType(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGeometryProxy *pObjectX = (JIGeometryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_isCrosses_1IGeometry_1EVDimensionType_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong geom_j, jint dimension_j)
				{
					const EarthView::World::Spatial::Geometry::IGeometry *geom = (const EarthView::World::Spatial::Geometry::IGeometry*) geom_j;
					EarthView::World::Spatial::Geometry::EVDimensionType dimension = (EarthView::World::Spatial::Geometry::EVDimensionType) dimension_j;
					const 					EarthView::World::Spatial::Geometry::IGeometry *pObjectX = (EarthView::World::Spatial::Geometry::IGeometry*) pObjXXXX;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_isRelates_1IGeometry_1EVString_1EVDimensionType(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong geom_j, jstring relateMatrix_j, jint dimension_j)
				{
					const EarthView::World::Spatial::Geometry::IGeometry *geom = (const EarthView::World::Spatial::Geometry::IGeometry*) geom_j;
					#if EV_PLATFORM == EV_PLATFORM_ANDROID
					...
					if (typeid(*pObjectX) == typeid(JIGeometryProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial::Geometry::IGeometry::isRelates(geom, relateMatrix, dimension);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_register_1isRelates_1IGeometry_1EVString_1EVDimensionType(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGeometryProxy *pObjectX = (JIGeometryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_isRelates_1IGeometry_1EVString_1EVDimensionType_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong geom_j, jstring relateMatrix_j, jint dimension_j)
				{
					const EarthView::World::Spatial::Geometry::IGeometry *geom = (const EarthView::World::Spatial::Geometry::IGeometry*) geom_j;
					#if EV_PLATFORM == EV_PLATFORM_ANDROID
					const ev_char* relateMatrix_ch = (const ev_char*)__env->GetStringUTFChars(relateMatrix_j,JNI_FALSE);
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_buffer_1ev_1real64_1EVDimensionType(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble tolerance_j, jint dimension_j)
				{
					ev_real64 tolerance = (ev_real64) tolerance_j;
					EarthView::World::Spatial::Geometry::EVDimensionType dimension = (EarthView::World::Spatial::Geometry::EVDimensionType) dimension_j;
					const 					EarthView::World::Spatial::Geometry::IGeometry *pObjectX = (EarthView::World::Spatial::Geometry::IGeometry*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIGeometryProxy))
					{
						EarthView::World::Spatial::Geometry::IGeometry* __values1 = pObjectX->EarthView::World::Spatial::Geometry::IGeometry::buffer(tolerance, dimension);
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_register_1buffer_1ev_1real64_1EVDimensionType(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGeometryProxy *pObjectX = (JIGeometryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_buffer_1ev_1real64_1EVDimensionType_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble tolerance_j, jint dimension_j)
				{
					ev_real64 tolerance = (ev_real64) tolerance_j;
					EarthView::World::Spatial::Geometry::EVDimensionType dimension = (EarthView::World::Spatial::Geometry::EVDimensionType) dimension_j;
					const 					EarthView::World::Spatial::Geometry::IGeometry *pObjectX = (EarthView::World::Spatial::Geometry::IGeometry*) pObjXXXX;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_convexHull_1EVDimensionType(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint dimension_j)
				{
					EarthView::World::Spatial::Geometry::EVDimensionType dimension = (EarthView::World::Spatial::Geometry::EVDimensionType) dimension_j;
					const 					EarthView::World::Spatial::Geometry::IGeometry *pObjectX = (EarthView::World::Spatial::Geometry::IGeometry*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIGeometryProxy))
					{
						EarthView::World::Spatial::Geometry::IGeometry* __values1 = pObjectX->EarthView::World::Spatial::Geometry::IGeometry::convexHull(dimension);
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_register_1convexHull_1EVDimensionType(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGeometryProxy *pObjectX = (JIGeometryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_convexHull_1EVDimensionType_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint dimension_j)
				{
					EarthView::World::Spatial::Geometry::EVDimensionType dimension = (EarthView::World::Spatial::Geometry::EVDimensionType) dimension_j;
					const 					EarthView::World::Spatial::Geometry::IGeometry *pObjectX = (EarthView::World::Spatial::Geometry::IGeometry*) pObjXXXX;
					EarthView::World::Spatial::Geometry::IGeometry* __values1 = pObjectX->EarthView::World::Spatial::Geometry::IGeometry::convexHull(dimension);
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_difference_1IGeometry_1EVDimensionType(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong geom_j, jint dimension_j)
				{
					const EarthView::World::Spatial::Geometry::IGeometry *geom = (const EarthView::World::Spatial::Geometry::IGeometry*) geom_j;
					EarthView::World::Spatial::Geometry::EVDimensionType dimension = (EarthView::World::Spatial::Geometry::EVDimensionType) dimension_j;
					const 					EarthView::World::Spatial::Geometry::IGeometry *pObjectX = (EarthView::World::Spatial::Geometry::IGeometry*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIGeometryProxy))
					{
						EarthView::World::Spatial::Geometry::IGeometry* __values1 = pObjectX->EarthView::World::Spatial::Geometry::IGeometry::difference(geom, dimension);
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_register_1difference_1IGeometry_1EVDimensionType(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGeometryProxy *pObjectX = (JIGeometryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_difference_1IGeometry_1EVDimensionType_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong geom_j, jint dimension_j)
				{
					const EarthView::World::Spatial::Geometry::IGeometry *geom = (const EarthView::World::Spatial::Geometry::IGeometry*) geom_j;
					EarthView::World::Spatial::Geometry::EVDimensionType dimension = (EarthView::World::Spatial::Geometry::EVDimensionType) dimension_j;
					const 					EarthView::World::Spatial::Geometry::IGeometry *pObjectX = (EarthView::World::Spatial::Geometry::IGeometry*) pObjXXXX;
				...
				extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_distance_1IGeometry_1EVDimensionType(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong geom_j, jint dimension_j)
				{
					const EarthView::World::Spatial::Geometry::IGeometry *geom = (const EarthView::World::Spatial::Geometry::IGeometry*) geom_j;
					EarthView::World::Spatial::Geometry::EVDimensionType dimension = (EarthView::World::Spatial::Geometry::EVDimensionType) dimension_j;
					const 					EarthView::World::Spatial::Geometry::IGeometry *pObjectX = (EarthView::World::Spatial::Geometry::IGeometry*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIGeometryProxy))
					{
						ev_real64 __values1 = pObjectX->EarthView::World::Spatial::Geometry::IGeometry::distance(geom, dimension);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_register_1distance_1IGeometry_1EVDimensionType(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGeometryProxy *pObjectX = (JIGeometryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_distance_1IGeometry_1EVDimensionType_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong geom_j, jint dimension_j)
				{
					const EarthView::World::Spatial::Geometry::IGeometry *geom = (const EarthView::World::Spatial::Geometry::IGeometry*) geom_j;
					EarthView::World::Spatial::Geometry::EVDimensionType dimension = (EarthView::World::Spatial::Geometry::EVDimensionType) dimension_j;
					const 					EarthView::World::Spatial::Geometry::IGeometry *pObjectX = (EarthView::World::Spatial::Geometry::IGeometry*) pObjXXXX;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_intersects_1IGeometry_1EVDimensionType(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong geom_j, jint dimension_j)
				{
					const EarthView::World::Spatial::Geometry::IGeometry *geom = (const EarthView::World::Spatial::Geometry::IGeometry*) geom_j;
					EarthView::World::Spatial::Geometry::EVDimensionType dimension = (EarthView::World::Spatial::Geometry::EVDimensionType) dimension_j;
					const 					EarthView::World::Spatial::Geometry::IGeometry *pObjectX = (EarthView::World::Spatial::Geometry::IGeometry*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIGeometryProxy))
					{
						EarthView::World::Spatial::Geometry::IGeometry* __values1 = pObjectX->EarthView::World::Spatial::Geometry::IGeometry::intersects(geom, dimension);
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_register_1intersects_1IGeometry_1EVDimensionType(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGeometryProxy *pObjectX = (JIGeometryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_intersects_1IGeometry_1EVDimensionType_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong geom_j, jint dimension_j)
				{
					const EarthView::World::Spatial::Geometry::IGeometry *geom = (const EarthView::World::Spatial::Geometry::IGeometry*) geom_j;
					EarthView::World::Spatial::Geometry::EVDimensionType dimension = (EarthView::World::Spatial::Geometry::EVDimensionType) dimension_j;
					const 					EarthView::World::Spatial::Geometry::IGeometry *pObjectX = (EarthView::World::Spatial::Geometry::IGeometry*) pObjXXXX;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_overlaps_1IGeometry_1EVDimensionType(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong geom_j, jint dimension_j)
				{
					const EarthView::World::Spatial::Geometry::IGeometry *geom = (const EarthView::World::Spatial::Geometry::IGeometry*) geom_j;
					EarthView::World::Spatial::Geometry::EVDimensionType dimension = (EarthView::World::Spatial::Geometry::EVDimensionType) dimension_j;
					const 					EarthView::World::Spatial::Geometry::IGeometry *pObjectX = (EarthView::World::Spatial::Geometry::IGeometry*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIGeometryProxy))
					{
						EarthView::World::Spatial::Geometry::IGeometry* __values1 = pObjectX->EarthView::World::Spatial::Geometry::IGeometry::overlaps(geom, dimension);
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_register_1overlaps_1IGeometry_1EVDimensionType(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGeometryProxy *pObjectX = (JIGeometryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_overlaps_1IGeometry_1EVDimensionType_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong geom_j, jint dimension_j)
				{
					const EarthView::World::Spatial::Geometry::IGeometry *geom = (const EarthView::World::Spatial::Geometry::IGeometry*) geom_j;
					EarthView::World::Spatial::Geometry::EVDimensionType dimension = (EarthView::World::Spatial::Geometry::EVDimensionType) dimension_j;
					const 					EarthView::World::Spatial::Geometry::IGeometry *pObjectX = (EarthView::World::Spatial::Geometry::IGeometry*) pObjXXXX;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_symDifference_1IGeometry_1EVDimensionType(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong geom_j, jint dimension_j)
				{
					const EarthView::World::Spatial::Geometry::IGeometry *geom = (const EarthView::World::Spatial::Geometry::IGeometry*) geom_j;
					EarthView::World::Spatial::Geometry::EVDimensionType dimension = (EarthView::World::Spatial::Geometry::EVDimensionType) dimension_j;
					const 					EarthView::World::Spatial::Geometry::IGeometry *pObjectX = (EarthView::World::Spatial::Geometry::IGeometry*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIGeometryProxy))
					{
						EarthView::World::Spatial::Geometry::IGeometry* __values1 = pObjectX->EarthView::World::Spatial::Geometry::IGeometry::symDifference(geom, dimension);
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_register_1symDifference_1IGeometry_1EVDimensionType(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGeometryProxy *pObjectX = (JIGeometryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_symDifference_1IGeometry_1EVDimensionType_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong geom_j, jint dimension_j)
				{
					const EarthView::World::Spatial::Geometry::IGeometry *geom = (const EarthView::World::Spatial::Geometry::IGeometry*) geom_j;
					EarthView::World::Spatial::Geometry::EVDimensionType dimension = (EarthView::World::Spatial::Geometry::EVDimensionType) dimension_j;
					const 					EarthView::World::Spatial::Geometry::IGeometry *pObjectX = (EarthView::World::Spatial::Geometry::IGeometry*) pObjXXXX;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_unions_1IGeometry_1EVDimensionType(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong geom_j, jint dimension_j)
				{
					const EarthView::World::Spatial::Geometry::IGeometry *geom = (const EarthView::World::Spatial::Geometry::IGeometry*) geom_j;
					EarthView::World::Spatial::Geometry::EVDimensionType dimension = (EarthView::World::Spatial::Geometry::EVDimensionType) dimension_j;
					const 					EarthView::World::Spatial::Geometry::IGeometry *pObjectX = (EarthView::World::Spatial::Geometry::IGeometry*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIGeometryProxy))
					{
						EarthView::World::Spatial::Geometry::IGeometry* __values1 = pObjectX->EarthView::World::Spatial::Geometry::IGeometry::unions(geom, dimension);
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_register_1unions_1IGeometry_1EVDimensionType(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGeometryProxy *pObjectX = (JIGeometryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_unions_1IGeometry_1EVDimensionType_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong geom_j, jint dimension_j)
				{
					const EarthView::World::Spatial::Geometry::IGeometry *geom = (const EarthView::World::Spatial::Geometry::IGeometry*) geom_j;
					EarthView::World::Spatial::Geometry::EVDimensionType dimension = (EarthView::World::Spatial::Geometry::EVDimensionType) dimension_j;
					const 					EarthView::World::Spatial::Geometry::IGeometry *pObjectX = (EarthView::World::Spatial::Geometry::IGeometry*) pObjXXXX;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_toWKB_1CDataStream(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong stream_j)
				{
					EarthView::World::Core::CDataStream &stream = *(EarthView::World::Core::CDataStream*) stream_j;
					const 					EarthView::World::Spatial::Geometry::IGeometry *pObjectX = (EarthView::World::Spatial::Geometry::IGeometry*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIGeometryProxy))
					{
						pObjectX->EarthView::World::Spatial::Geometry::IGeometry::toWKB(stream);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_register_1toWKB_1CDataStream(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGeometryProxy *pObjectX = (JIGeometryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_toWKB_1CDataStream_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong stream_j)
				{
					EarthView::World::Core::CDataStream &stream = *(EarthView::World::Core::CDataStream*) stream_j;
					const 					EarthView::World::Spatial::Geometry::IGeometry *pObjectX = (EarthView::World::Spatial::Geometry::IGeometry*) pObjXXXX;
					pObjectX->EarthView::World::Spatial::Geometry::IGeometry::toWKB(stream);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_toWKT_1EVString(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong wkt_j)
				{
					EVString &wkt = *(EVString*) wkt_j;
					const 					EarthView::World::Spatial::Geometry::IGeometry *pObjectX = (EarthView::World::Spatial::Geometry::IGeometry*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIGeometryProxy))
					{
						pObjectX->EarthView::World::Spatial::Geometry::IGeometry::toWKT(wkt);
					}
					else
					{
						pObjectX->toWKT(wkt);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_register_1toWKT_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGeometryProxy *pObjectX = (JIGeometryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_toWKT_1EVString_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong wkt_j)
				{
					EVString &wkt = *(EVString*) wkt_j;
					const 					EarthView::World::Spatial::Geometry::IGeometry *pObjectX = (EarthView::World::Spatial::Geometry::IGeometry*) pObjXXXX;
					pObjectX->EarthView::World::Spatial::Geometry::IGeometry::toWKT(wkt);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_toStream_1CDataStream(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong stream_j)
				{
					EarthView::World::Core::CDataStream &stream = *(EarthView::World::Core::CDataStream*) stream_j;
					const 					EarthView::World::Spatial::Geometry::IGeometry *pObjectX = (EarthView::World::Spatial::Geometry::IGeometry*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIGeometryProxy))
					{
						pObjectX->EarthView::World::Spatial::Geometry::IGeometry::toStream(stream);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_register_1toStream_1CDataStream(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGeometryProxy *pObjectX = (JIGeometryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_toStream_1CDataStream_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong stream_j)
				{
					EarthView::World::Core::CDataStream &stream = *(EarthView::World::Core::CDataStream*) stream_j;
					const 					EarthView::World::Spatial::Geometry::IGeometry *pObjectX = (EarthView::World::Spatial::Geometry::IGeometry*) pObjXXXX;
					pObjectX->EarthView::World::Spatial::Geometry::IGeometry::toStream(stream);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_translate_1ev_1real64_1ev_1real64_1ev_1real64(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble x_j, jdouble y_j, jdouble z_j)
				{
					...
					if (typeid(*pObjectX) == typeid(JIGeometryProxy))
					{
						pObjectX->EarthView::World::Spatial::Geometry::IGeometry::translate(x, y, z);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_register_1translate_1ev_1real64_1ev_1real64_1ev_1real64(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGeometryProxy *pObjectX = (JIGeometryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_translate_1ev_1real64_1ev_1real64_1ev_1real64_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble x_j, jdouble y_j, jdouble z_j)
				{
					ev_real64 x = (ev_real64) x_j;
					ev_real64 y = (ev_real64) y_j;
					ev_real64 z = (ev_real64) z_j;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_rotate_1ev_1real64_1ev_1real64_1ev_1real64_1ev_1real64_1ev_1real64_1ev_1real64(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble xRef_j, jdouble yRef_j, jdouble zRef_j, jdouble xAngle_j, jdouble yAngle_j, jdouble zAngle_j)
				{
					...
					if (typeid(*pObjectX) == typeid(JIGeometryProxy))
					{
						pObjectX->EarthView::World::Spatial::Geometry::IGeometry::rotate(xRef, yRef, zRef, xAngle, yAngle, zAngle);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_register_1rotate_1ev_1real64_1ev_1real64_1ev_1real64_1ev_1real64_1ev_1real64_1ev_1real64(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGeometryProxy *pObjectX = (JIGeometryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_rotate_1ev_1real64_1ev_1real64_1ev_1real64_1ev_1real64_1ev_1real64_1ev_1real64_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble xRef_j, jdouble yRef_j, jdouble zRef_j, jdouble xAngle_j, jdouble yAngle_j, jdouble zAngle_j)
				{
					ev_real64 xRef = (ev_real64) xRef_j;
					ev_real64 yRef = (ev_real64) yRef_j;
					ev_real64 zRef = (ev_real64) zRef_j;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_scale_1ev_1real64_1ev_1real64_1ev_1real64_1ev_1real64_1ev_1real64_1ev_1real64(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble xRef_j, jdouble yRef_j, jdouble zRef_j, jdouble x_j, jdouble y_j, jdouble z_j)
				{
					ev_real64 xRef = (ev_real64) xRef_j;
					ev_real64 yRef = (ev_real64) yRef_j;
					ev_real64 zRef = (ev_real64) zRef_j;
					...
					if (typeid(*pObjectX) == typeid(JIGeometryProxy))
					{
						pObjectX->EarthView::World::Spatial::Geometry::IGeometry::scale(xRef, yRef, zRef, x, y, z);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_register_1scale_1ev_1real64_1ev_1real64_1ev_1real64_1ev_1real64_1ev_1real64_1ev_1real64(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGeometryProxy *pObjectX = (JIGeometryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_scale_1ev_1real64_1ev_1real64_1ev_1real64_1ev_1real64_1ev_1real64_1ev_1real64_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble xRef_j, jdouble yRef_j, jdouble zRef_j, jdouble x_j, jdouble y_j, jdouble z_j)
				{
					ev_real64 xRef = (ev_real64) xRef_j;
					ev_real64 yRef = (ev_real64) yRef_j;
					ev_real64 zRef = (ev_real64) zRef_j;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_projects_1ISpatialReference_1ev_1real64_1ev_1uint32(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong sr_j, jlong sevenParam_j, jlong count_j)
				{
					...
					if (typeid(*pObjectX) == typeid(JIGeometryProxy))
					{
						pObjectX->EarthView::World::Spatial::Geometry::IGeometry::projects(sr, sevenParam, count);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_register_1projects_1ISpatialReference_1ev_1real64_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGeometryProxy *pObjectX = (JIGeometryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_projects_1ISpatialReference_1ev_1real64_1ev_1uint32_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong sr_j, jlong sevenParam_j, jlong count_j)
				{
					const EarthView::World::Spatial::Geometry::ISpatialReference *sr = (const EarthView::World::Spatial::Geometry::ISpatialReference*) sr_j;
					ev_real64 *sevenParam = (ev_real64*) sevenParam_j;
					ev_uint32 count = (ev_uint32) count_j;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_getInteriorPoint_1IGeometry(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong point_j)
				{
					EarthView::World::Spatial::Geometry::IGeometry *point = (EarthView::World::Spatial::Geometry::IGeometry*) point_j;
					const 					EarthView::World::Spatial::Geometry::IGeometry *pObjectX = (EarthView::World::Spatial::Geometry::IGeometry*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIGeometryProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial::Geometry::IGeometry::getInteriorPoint(point);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_register_1getInteriorPoint_1IGeometry(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGeometryProxy *pObjectX = (JIGeometryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_geometry_Igeometry_getInteriorPoint_1IGeometry_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong point_j)
				{
					EarthView::World::Spatial::Geometry::IGeometry *point = (EarthView::World::Spatial::Geometry::IGeometry*) point_j;
					const 					EarthView::World::Spatial::Geometry::IGeometry *pObjectX = (EarthView::World::Spatial::Geometry::IGeometry*) pObjXXXX;
					ev_bool __values1 = pObjectX->EarthView::World::Spatial::Geometry::IGeometry::getInteriorPoint(point);
