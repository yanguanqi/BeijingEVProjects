...
namespace EarthView
{
	namespace World
	{
		namespace Spatial
		{
			namespace Accessor
			{
				class JIWebAccessorProxy : public EarthView::World::Spatial::Accessor::IWebAccessor
				{
				 private:
				...
				public:
					JIWebAccessorProxy(EarthView::World::Core::CNameValuePairList *pList) : IWebAccessor(pList)
					{
					}
				...
				REGISTER_FACTORY_CLASS(JIWebAccessorProxy);
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_accessor_Iwebaccessor_register_1getType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIWebAccessorProxy *pObjectX = (JIWebAccessorProxy*) pObjXXXX;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_accessor_Iwebaccessor_register_1open_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIWebAccessorProxy *pObjectX = (JIWebAccessorProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_accessor_Iwebaccessor_register_1close_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIWebAccessorProxy *pObjectX = (JIWebAccessorProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
