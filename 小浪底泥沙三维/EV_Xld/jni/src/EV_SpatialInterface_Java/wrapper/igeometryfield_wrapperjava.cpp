...
namespace EarthView
{
	namespace World
	{
		namespace Spatial
		{
			...
			{
				class JIGeometryFieldProxy : public EarthView::World::Spatial::GeoDataset::IGeometryField
				{
				 private:
				...
				public:
					JIGeometryFieldProxy(EarthView::World::Core::CNameValuePairList *pList) : IGeometryField(pList)
					{
					}
				...
				REGISTER_FACTORY_CLASS(JIGeometryFieldProxy);
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial_geodataset_Igeometryfield_getGeometryType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::GeoDataset::IGeometryField *pObjectX = (EarthView::World::Spatial::GeoDataset::IGeometryField*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIGeometryFieldProxy))
					{
						EarthView::World::Spatial::Geometry::EVGeometryType __values1 = pObjectX->EarthView::World::Spatial::GeoDataset::IGeometryField::getGeometryType();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geodataset_Igeometryfield_register_1getGeometryType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGeometryFieldProxy *pObjectX = (JIGeometryFieldProxy*) pObjXXXX;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial_geodataset_Igeometryfield_getGeometryType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::GeoDataset::IGeometryField *pObjectX = (EarthView::World::Spatial::GeoDataset::IGeometryField*) pObjXXXX;
					EarthView::World::Spatial::Geometry::EVGeometryType __values1 = pObjectX->EarthView::World::Spatial::GeoDataset::IGeometryField::getGeometryType();
					jint __values1_j = (jint) __values1;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geodataset_Igeometryfield_setGeometryType_1EVGeometryType(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint type_j)
				{
					EarthView::World::Spatial::Geometry::EVGeometryType type = (EarthView::World::Spatial::Geometry::EVGeometryType) type_j;
					EarthView::World::Spatial::GeoDataset::IGeometryField *pObjectX = (EarthView::World::Spatial::GeoDataset::IGeometryField*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIGeometryFieldProxy))
					{
						pObjectX->EarthView::World::Spatial::GeoDataset::IGeometryField::setGeometryType(type);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geodataset_Igeometryfield_register_1setGeometryType_1EVGeometryType(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGeometryFieldProxy *pObjectX = (JIGeometryFieldProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geodataset_Igeometryfield_setGeometryType_1EVGeometryType_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint type_j)
				{
					EarthView::World::Spatial::Geometry::EVGeometryType type = (EarthView::World::Spatial::Geometry::EVGeometryType) type_j;
					EarthView::World::Spatial::GeoDataset::IGeometryField *pObjectX = (EarthView::World::Spatial::GeoDataset::IGeometryField*) pObjXXXX;
					pObjectX->EarthView::World::Spatial::GeoDataset::IGeometryField::setGeometryType(type);
				}
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_geodataset_Igeometryfield_getSpatialReference_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::GeoDataset::IGeometryField *pObjectX = (EarthView::World::Spatial::GeoDataset::IGeometryField*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIGeometryFieldProxy))
					{
						const EarthView::World::Spatial::Geometry::ISpatialReference* __values1 = pObjectX->EarthView::World::Spatial::GeoDataset::IGeometryField::getSpatialReference();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geodataset_Igeometryfield_register_1getSpatialReference_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGeometryFieldProxy *pObjectX = (JIGeometryFieldProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_geodataset_Igeometryfield_getSpatialReference_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::GeoDataset::IGeometryField *pObjectX = (EarthView::World::Spatial::GeoDataset::IGeometryField*) pObjXXXX;
					const EarthView::World::Spatial::Geometry::ISpatialReference* __values1 = pObjectX->EarthView::World::Spatial::GeoDataset::IGeometryField::getSpatialReference();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geodataset_Igeometryfield_setSpatialReference_1ISpatialReference(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong ref_sr_j)
				{
					...
					if (typeid(*pObjectX) == typeid(JIGeometryFieldProxy))
					{
						pObjectX->EarthView::World::Spatial::GeoDataset::IGeometryField::setSpatialReference(ref_sr);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geodataset_Igeometryfield_register_1setSpatialReference_1ISpatialReference(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGeometryFieldProxy *pObjectX = (JIGeometryFieldProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geodataset_Igeometryfield_setSpatialReference_1ISpatialReference_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong ref_sr_j)
				{
					const EarthView::World::Spatial::Geometry::ISpatialReference *ref_sr = (const EarthView::World::Spatial::Geometry::ISpatialReference*) ref_sr_j;
					EarthView::World::Spatial::GeoDataset::IGeometryField *pObjectX = (EarthView::World::Spatial::GeoDataset::IGeometryField*) pObjXXXX;
					pObjectX->EarthView::World::Spatial::GeoDataset::IGeometryField::setSpatialReference(ref_sr);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geodataset_Igeometryfield_register_1getName_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGeometryFieldProxy *pObjectX = (JIGeometryFieldProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geodataset_Igeometryfield_register_1getAliasName_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGeometryFieldProxy *pObjectX = (JIGeometryFieldProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geodataset_Igeometryfield_register_1getFieldType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGeometryFieldProxy *pObjectX = (JIGeometryFieldProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geodataset_Igeometryfield_register_1getSize_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGeometryFieldProxy *pObjectX = (JIGeometryFieldProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geodataset_Igeometryfield_register_1getPrecision_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGeometryFieldProxy *pObjectX = (JIGeometryFieldProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geodataset_Igeometryfield_register_1getDescription_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGeometryFieldProxy *pObjectX = (JIGeometryFieldProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geodataset_Igeometryfield_register_1isRequest_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGeometryFieldProxy *pObjectX = (JIGeometryFieldProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geodataset_Igeometryfield_register_1canEdit_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGeometryFieldProxy *pObjectX = (JIGeometryFieldProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geodataset_Igeometryfield_register_1canDelete_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGeometryFieldProxy *pObjectX = (JIGeometryFieldProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geodataset_Igeometryfield_register_1canNull_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGeometryFieldProxy *pObjectX = (JIGeometryFieldProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geodataset_Igeometryfield_register_1setAliasName_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGeometryFieldProxy *pObjectX = (JIGeometryFieldProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geodataset_Igeometryfield_register_1setSize_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGeometryFieldProxy *pObjectX = (JIGeometryFieldProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geodataset_Igeometryfield_register_1setPrecision_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGeometryFieldProxy *pObjectX = (JIGeometryFieldProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geodataset_Igeometryfield_register_1setDescription_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGeometryFieldProxy *pObjectX = (JIGeometryFieldProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geodataset_Igeometryfield_register_1getDefaultValue_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGeometryFieldProxy *pObjectX = (JIGeometryFieldProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geodataset_Igeometryfield_register_1setDefaultValue_1CVariant(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGeometryFieldProxy *pObjectX = (JIGeometryFieldProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_geodataset_Igeometryfield_register_1ev_1clone_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGeometryFieldProxy *pObjectX = (JIGeometryFieldProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
