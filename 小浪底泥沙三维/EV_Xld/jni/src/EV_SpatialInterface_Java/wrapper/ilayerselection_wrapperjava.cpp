...
namespace EarthView
{
	namespace World
	{
		namespace Spatial
		{
			namespace Atlas
			{
				class JILayerSelectionProxy : public EarthView::World::Spatial::Atlas::ILayerSelection
				{
				 private:
				...
				public:
					JILayerSelectionProxy(EarthView::World::Core::CNameValuePairList *pList) : ILayerSelection(pList)
					{
					}
				...
				protected:
					C_DISABLE_COPY(JILayerSelectionProxy)
				public:
				...
				REGISTER_FACTORY_CLASS(JILayerSelectionProxy);
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_atlas_Ilayerselection_getSelection_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Atlas::ILayerSelection *pObjectX = (EarthView::World::Spatial::Atlas::ILayerSelection*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JILayerSelectionProxy))
					{
						EarthView::World::Spatial::GeoDataset::IFeatureSelection* __values1 = pObjectX->EarthView::World::Spatial::Atlas::ILayerSelection::getSelection();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_Ilayerselection_register_1getSelection_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JILayerSelectionProxy *pObjectX = (JILayerSelectionProxy*) pObjXXXX;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_atlas_Ilayerselection_getSelection_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Atlas::ILayerSelection *pObjectX = (EarthView::World::Spatial::Atlas::ILayerSelection*) pObjXXXX;
					EarthView::World::Spatial::GeoDataset::IFeatureSelection* __values1 = pObjectX->EarthView::World::Spatial::Atlas::ILayerSelection::getSelection();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_atlas_Ilayerselection_getSelectionSymbol_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Atlas::ILayerSelection *pObjectX = (EarthView::World::Spatial::Atlas::ILayerSelection*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JILayerSelectionProxy))
					{
						EarthView::World::Spatial::Display::ISymbol* __values1 = pObjectX->EarthView::World::Spatial::Atlas::ILayerSelection::getSelectionSymbol();
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_Ilayerselection_register_1getSelectionSymbol_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JILayerSelectionProxy *pObjectX = (JILayerSelectionProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_atlas_Ilayerselection_getSelectionSymbol_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Atlas::ILayerSelection *pObjectX = (EarthView::World::Spatial::Atlas::ILayerSelection*) pObjXXXX;
					EarthView::World::Spatial::Display::ISymbol* __values1 = pObjectX->EarthView::World::Spatial::Atlas::ILayerSelection::getSelectionSymbol();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_Ilayerselection_setSelectionSymbol_1ISymbol(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong symbol_j)
				{
					const EarthView::World::Spatial::Display::ISymbol *symbol = (const EarthView::World::Spatial::Display::ISymbol*) symbol_j;
					EarthView::World::Spatial::Atlas::ILayerSelection *pObjectX = (EarthView::World::Spatial::Atlas::ILayerSelection*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JILayerSelectionProxy))
					{
						pObjectX->EarthView::World::Spatial::Atlas::ILayerSelection::setSelectionSymbol(symbol);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_Ilayerselection_register_1setSelectionSymbol_1ISymbol(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JILayerSelectionProxy *pObjectX = (JILayerSelectionProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_Ilayerselection_setSelectionSymbol_1ISymbol_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong symbol_j)
				{
					const EarthView::World::Spatial::Display::ISymbol *symbol = (const EarthView::World::Spatial::Display::ISymbol*) symbol_j;
					EarthView::World::Spatial::Atlas::ILayerSelection *pObjectX = (EarthView::World::Spatial::Atlas::ILayerSelection*) pObjXXXX;
					pObjectX->EarthView::World::Spatial::Atlas::ILayerSelection::setSelectionSymbol(symbol);
