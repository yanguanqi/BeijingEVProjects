...
namespace EarthView
{
	namespace World
	{
		namespace Spatial
		{
			namespace Accessor
			{
				class JIFileAccessorProxy : public EarthView::World::Spatial::Accessor::IFileAccessor
				{
				 private:
				...
				public:
					JIFileAccessorProxy(EarthView::World::Core::CNameValuePairList *pList) : IFileAccessor(pList)
					{
					}
				...
				REGISTER_FACTORY_CLASS(JIFileAccessorProxy);
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_accessor_Ifileaccessor_register_1getType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIFileAccessorProxy *pObjectX = (JIFileAccessorProxy*) pObjXXXX;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_accessor_Ifileaccessor_register_1open_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIFileAccessorProxy *pObjectX = (JIFileAccessorProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_accessor_Ifileaccessor_register_1close_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIFileAccessorProxy *pObjectX = (JIFileAccessorProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
