...
namespace EarthView
{
	namespace World
	{
		namespace Spatial
		{
			namespace Atlas
			{
				class JIRasterLayerProxy : public EarthView::World::Spatial::Atlas::IRasterLayer
				{
				 private:
				...
				public:
					JIRasterLayerProxy(EarthView::World::Core::CNameValuePairList *pList) : IRasterLayer(pList)
					{
					}
				...
				REGISTER_FACTORY_CLASS(JIRasterLayerProxy);
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_setDataset_1IDataset(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong ref_pDataset_j)
				{
					EarthView::World::Spatial::GeoDataset::IDataset *ref_pDataset = (EarthView::World::Spatial::GeoDataset::IDataset*) ref_pDataset_j;
					EarthView::World::Spatial::Atlas::IRasterLayer *pObjectX = (EarthView::World::Spatial::Atlas::IRasterLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIRasterLayerProxy))
					{
						pObjectX->EarthView::World::Spatial::Atlas::IRasterLayer::setDataset(ref_pDataset);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_register_1setDataset_1IDataset(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIRasterLayerProxy *pObjectX = (JIRasterLayerProxy*) pObjXXXX;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_setDataset_1IDataset_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong ref_pDataset_j)
				{
					EarthView::World::Spatial::GeoDataset::IDataset *ref_pDataset = (EarthView::World::Spatial::GeoDataset::IDataset*) ref_pDataset_j;
					EarthView::World::Spatial::Atlas::IRasterLayer *pObjectX = (EarthView::World::Spatial::Atlas::IRasterLayer*) pObjXXXX;
					pObjectX->EarthView::World::Spatial::Atlas::IRasterLayer::setDataset(ref_pDataset);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_setRenderer_1IRasterRenderer(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong pRenderer_j)
				{
					EarthView::World::Spatial2D::Raster::IRasterRenderer *pRenderer = (EarthView::World::Spatial2D::Raster::IRasterRenderer*) pRenderer_j;
					EarthView::World::Spatial::Atlas::IRasterLayer *pObjectX = (EarthView::World::Spatial::Atlas::IRasterLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIRasterLayerProxy))
					{
						pObjectX->EarthView::World::Spatial::Atlas::IRasterLayer::setRenderer(pRenderer);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_register_1setRenderer_1IRasterRenderer(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIRasterLayerProxy *pObjectX = (JIRasterLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_setRenderer_1IRasterRenderer_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong pRenderer_j)
				{
					EarthView::World::Spatial2D::Raster::IRasterRenderer *pRenderer = (EarthView::World::Spatial2D::Raster::IRasterRenderer*) pRenderer_j;
					EarthView::World::Spatial::Atlas::IRasterLayer *pObjectX = (EarthView::World::Spatial::Atlas::IRasterLayer*) pObjXXXX;
					pObjectX->EarthView::World::Spatial::Atlas::IRasterLayer::setRenderer(pRenderer);
				}
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_getRenderer_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Atlas::IRasterLayer *pObjectX = (EarthView::World::Spatial::Atlas::IRasterLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIRasterLayerProxy))
					{
						const EarthView::World::Spatial2D::Raster::IRasterRenderer* __values1 = pObjectX->EarthView::World::Spatial::Atlas::IRasterLayer::getRenderer();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_register_1getRenderer_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIRasterLayerProxy *pObjectX = (JIRasterLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_getRenderer_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Atlas::IRasterLayer *pObjectX = (EarthView::World::Spatial::Atlas::IRasterLayer*) pObjXXXX;
					const EarthView::World::Spatial2D::Raster::IRasterRenderer* __values1 = pObjectX->EarthView::World::Spatial::Atlas::IRasterLayer::getRenderer();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_getLayerID_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial::Atlas::IRasterLayer *pObjectX = (EarthView::World::Spatial::Atlas::IRasterLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIRasterLayerProxy))
					{
						ev_int32 __values1 = pObjectX->EarthView::World::Spatial::Atlas::IRasterLayer::getLayerID();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_register_1getLayerID_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIRasterLayerProxy *pObjectX = (JIRasterLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_getLayerID_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial::Atlas::IRasterLayer *pObjectX = (EarthView::World::Spatial::Atlas::IRasterLayer*) pObjXXXX;
					ev_int32 __values1 = pObjectX->EarthView::World::Spatial::Atlas::IRasterLayer::getLayerID();
					jint __values1_j = (jint)__values1;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_setLayerID_1ev_1int32(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint iID_j)
				{
					ev_int32 iID = (ev_int32) iID_j;
					EarthView::World::Spatial::Atlas::IRasterLayer *pObjectX = (EarthView::World::Spatial::Atlas::IRasterLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIRasterLayerProxy))
					{
						pObjectX->EarthView::World::Spatial::Atlas::IRasterLayer::setLayerID(iID);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_register_1setLayerID_1ev_1int32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIRasterLayerProxy *pObjectX = (JIRasterLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_setLayerID_1ev_1int32_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint iID_j)
				{
					ev_int32 iID = (ev_int32) iID_j;
					EarthView::World::Spatial::Atlas::IRasterLayer *pObjectX = (EarthView::World::Spatial::Atlas::IRasterLayer*) pObjXXXX;
					pObjectX->EarthView::World::Spatial::Atlas::IRasterLayer::setLayerID(iID);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_assignRChannel_1ev_1int32(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint iBand_j)
				{
					ev_int32 iBand = (ev_int32) iBand_j;
					EarthView::World::Spatial::Atlas::IRasterLayer *pObjectX = (EarthView::World::Spatial::Atlas::IRasterLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIRasterLayerProxy))
					{
						pObjectX->EarthView::World::Spatial::Atlas::IRasterLayer::assignRChannel(iBand);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_register_1assignRChannel_1ev_1int32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIRasterLayerProxy *pObjectX = (JIRasterLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_assignRChannel_1ev_1int32_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint iBand_j)
				{
					ev_int32 iBand = (ev_int32) iBand_j;
					EarthView::World::Spatial::Atlas::IRasterLayer *pObjectX = (EarthView::World::Spatial::Atlas::IRasterLayer*) pObjXXXX;
					pObjectX->EarthView::World::Spatial::Atlas::IRasterLayer::assignRChannel(iBand);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_assignGChannel_1ev_1int32(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint iBand_j)
				{
					ev_int32 iBand = (ev_int32) iBand_j;
					EarthView::World::Spatial::Atlas::IRasterLayer *pObjectX = (EarthView::World::Spatial::Atlas::IRasterLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIRasterLayerProxy))
					{
						pObjectX->EarthView::World::Spatial::Atlas::IRasterLayer::assignGChannel(iBand);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_register_1assignGChannel_1ev_1int32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIRasterLayerProxy *pObjectX = (JIRasterLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_assignGChannel_1ev_1int32_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint iBand_j)
				{
					ev_int32 iBand = (ev_int32) iBand_j;
					EarthView::World::Spatial::Atlas::IRasterLayer *pObjectX = (EarthView::World::Spatial::Atlas::IRasterLayer*) pObjXXXX;
					pObjectX->EarthView::World::Spatial::Atlas::IRasterLayer::assignGChannel(iBand);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_assignBChannel_1ev_1int32(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint iBand_j)
				{
					ev_int32 iBand = (ev_int32) iBand_j;
					EarthView::World::Spatial::Atlas::IRasterLayer *pObjectX = (EarthView::World::Spatial::Atlas::IRasterLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIRasterLayerProxy))
					{
						pObjectX->EarthView::World::Spatial::Atlas::IRasterLayer::assignBChannel(iBand);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_register_1assignBChannel_1ev_1int32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIRasterLayerProxy *pObjectX = (JIRasterLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_assignBChannel_1ev_1int32_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint iBand_j)
				{
					ev_int32 iBand = (ev_int32) iBand_j;
					EarthView::World::Spatial::Atlas::IRasterLayer *pObjectX = (EarthView::World::Spatial::Atlas::IRasterLayer*) pObjXXXX;
					pObjectX->EarthView::World::Spatial::Atlas::IRasterLayer::assignBChannel(iBand);
				}
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_getRedIndex_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Atlas::IRasterLayer *pObjectX = (EarthView::World::Spatial::Atlas::IRasterLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIRasterLayerProxy))
					{
						ev_int32 __values1 = pObjectX->EarthView::World::Spatial::Atlas::IRasterLayer::getRedIndex();
						jint __values1_j = (jint)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_register_1getRedIndex_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIRasterLayerProxy *pObjectX = (JIRasterLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_getRedIndex_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Atlas::IRasterLayer *pObjectX = (EarthView::World::Spatial::Atlas::IRasterLayer*) pObjXXXX;
					ev_int32 __values1 = pObjectX->EarthView::World::Spatial::Atlas::IRasterLayer::getRedIndex();
					jint __values1_j = (jint)__values1;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_getGreenIndex_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Atlas::IRasterLayer *pObjectX = (EarthView::World::Spatial::Atlas::IRasterLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIRasterLayerProxy))
					{
						ev_int32 __values1 = pObjectX->EarthView::World::Spatial::Atlas::IRasterLayer::getGreenIndex();
						jint __values1_j = (jint)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_register_1getGreenIndex_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIRasterLayerProxy *pObjectX = (JIRasterLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_getGreenIndex_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Atlas::IRasterLayer *pObjectX = (EarthView::World::Spatial::Atlas::IRasterLayer*) pObjXXXX;
					ev_int32 __values1 = pObjectX->EarthView::World::Spatial::Atlas::IRasterLayer::getGreenIndex();
					jint __values1_j = (jint)__values1;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_getBlueIndex_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Atlas::IRasterLayer *pObjectX = (EarthView::World::Spatial::Atlas::IRasterLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIRasterLayerProxy))
					{
						ev_int32 __values1 = pObjectX->EarthView::World::Spatial::Atlas::IRasterLayer::getBlueIndex();
						jint __values1_j = (jint)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_register_1getBlueIndex_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIRasterLayerProxy *pObjectX = (JIRasterLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_getBlueIndex_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Atlas::IRasterLayer *pObjectX = (EarthView::World::Spatial::Atlas::IRasterLayer*) pObjXXXX;
					ev_int32 __values1 = pObjectX->EarthView::World::Spatial::Atlas::IRasterLayer::getBlueIndex();
					jint __values1_j = (jint)__values1;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_getPixelValue_1ev_1real64_1ev_1real64_1ev_1real64_1ev_1real64_1ev_1real64(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble dfX_j, jdouble dfY_j, jlong dfRValue_j, jlong dfGValue_j, jlong dfBValue_j)
				{
					ev_real64 dfX = (ev_real64) dfX_j;
					ev_real64 dfY = (ev_real64) dfY_j;
					ev_real64 &dfRValue = *(ev_real64*) dfRValue_j;
					ev_real64 &dfGValue = *(ev_real64*) dfGValue_j;
					ev_real64 &dfBValue = *(ev_real64*) dfBValue_j;
					const 					EarthView::World::Spatial::Atlas::IRasterLayer *pObjectX = (EarthView::World::Spatial::Atlas::IRasterLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIRasterLayerProxy))
					{
						pObjectX->EarthView::World::Spatial::Atlas::IRasterLayer::getPixelValue(dfX, dfY, dfRValue, dfGValue, dfBValue);
					}
					else
					{
						pObjectX->getPixelValue(dfX, dfY, dfRValue, dfGValue, dfBValue);
					}
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_register_1getPixelValue_1ev_1real64_1ev_1real64_1ev_1real64_1ev_1real64_1ev_1real64(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIRasterLayerProxy *pObjectX = (JIRasterLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_getPixelValue_1ev_1real64_1ev_1real64_1ev_1real64_1ev_1real64_1ev_1real64_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble dfX_j, jdouble dfY_j, jlong dfRValue_j, jlong dfGValue_j, jlong dfBValue_j)
				{
					ev_real64 dfX = (ev_real64) dfX_j;
					ev_real64 dfY = (ev_real64) dfY_j;
					ev_real64 &dfRValue = *(ev_real64*) dfRValue_j;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_register_1getType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIRasterLayerProxy *pObjectX = (JIRasterLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_register_1getDataset_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIRasterLayerProxy *pObjectX = (JIRasterLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_register_1getDatasetName_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIRasterLayerProxy *pObjectX = (JIRasterLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_register_1getDataSource_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIRasterLayerProxy *pObjectX = (JIRasterLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_register_1select_1IQueryFilter_1EVSelectionResultType(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIRasterLayerProxy *pObjectX = (JIRasterLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_register_1clearSelection_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIRasterLayerProxy *pObjectX = (JIRasterLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_register_1setLayerSelection_1ILayerSelection(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIRasterLayerProxy *pObjectX = (JIRasterLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_register_1getLayerSelection_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIRasterLayerProxy *pObjectX = (JIRasterLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_register_1getName_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIRasterLayerProxy *pObjectX = (JIRasterLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_register_1setName_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIRasterLayerProxy *pObjectX = (JIRasterLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_register_1getDescription_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIRasterLayerProxy *pObjectX = (JIRasterLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_register_1setDescription_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIRasterLayerProxy *pObjectX = (JIRasterLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_register_1canEdit_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIRasterLayerProxy *pObjectX = (JIRasterLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_register_1setCanEdit_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIRasterLayerProxy *pObjectX = (JIRasterLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_register_1isEditing_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIRasterLayerProxy *pObjectX = (JIRasterLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_register_1setEditing_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIRasterLayerProxy *pObjectX = (JIRasterLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_register_1isVisible_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIRasterLayerProxy *pObjectX = (JIRasterLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_register_1setVisible_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIRasterLayerProxy *pObjectX = (JIRasterLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_register_1isValid_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIRasterLayerProxy *pObjectX = (JIRasterLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_register_1isSelectable_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIRasterLayerProxy *pObjectX = (JIRasterLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_register_1setSelectable_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIRasterLayerProxy *pObjectX = (JIRasterLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_register_1ignoreScale_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIRasterLayerProxy *pObjectX = (JIRasterLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_register_1setIgnoreScale_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIRasterLayerProxy *pObjectX = (JIRasterLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_register_1getDisplayMaxScale_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIRasterLayerProxy *pObjectX = (JIRasterLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_register_1setDisplayMaxScale_1ev_1real64(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIRasterLayerProxy *pObjectX = (JIRasterLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_register_1getDisplayMinScale_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIRasterLayerProxy *pObjectX = (JIRasterLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_register_1setDisplayMinScale_1ev_1real64(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIRasterLayerProxy *pObjectX = (JIRasterLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_register_1getSpatialReference_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIRasterLayerProxy *pObjectX = (JIRasterLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_register_1setSpatialReference_1ISpatialReference(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIRasterLayerProxy *pObjectX = (JIRasterLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_register_1setTransparentValue_1ev_1uint8(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIRasterLayerProxy *pObjectX = (JIRasterLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_register_1getTransparentValue_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIRasterLayerProxy *pObjectX = (JIRasterLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_register_1getExtent_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIRasterLayerProxy *pObjectX = (JIRasterLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_register_1draw_1ISpatialDisplay_1EVVectorLayerRendererType(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIRasterLayerProxy *pObjectX = (JIRasterLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_register_1ev_1clone_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIRasterLayerProxy *pObjectX = (JIRasterLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_register_1toStream_1CDataStream(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIRasterLayerProxy *pObjectX = (JIRasterLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_register_1toXML_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIRasterLayerProxy *pObjectX = (JIRasterLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_register_1fromXmlElement_1CXmlElement(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIRasterLayerProxy *pObjectX = (JIRasterLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_register_1toXmlElement_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIRasterLayerProxy *pObjectX = (JIRasterLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_Irasterlayer_register_1fromStream_1CDataStream(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIRasterLayerProxy *pObjectX = (JIRasterLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
