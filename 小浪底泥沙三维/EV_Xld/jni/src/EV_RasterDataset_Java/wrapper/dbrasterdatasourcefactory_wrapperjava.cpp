...
namespace EarthView
{
	namespace World
	{
		namespace Spatial2D
		{
			namespace Raster
			{
				class JCDBRasterDataSourceFactoryProxy : public EarthView::World::Spatial2D::Raster::CDBRasterDataSourceFactory
				{
				 private:
				...
				public:
					JCDBRasterDataSourceFactoryProxy(EarthView::World::Core::CNameValuePairList *pList) : CDBRasterDataSourceFactory(pList)
					{
					}
				...
				REGISTER_FACTORY_CLASS(JCDBRasterDataSourceFactoryProxy);
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial2d_raster_Dbrasterdatasourcefactory_getType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Raster::CDBRasterDataSourceFactory *pObjectX = (EarthView::World::Spatial2D::Raster::CDBRasterDataSourceFactory*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCDBRasterDataSourceFactoryProxy))
					{
						ev_int32 __values1 = pObjectX->EarthView::World::Spatial2D::Raster::CDBRasterDataSourceFactory::getType();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_raster_Dbrasterdatasourcefactory_register_1getType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCDBRasterDataSourceFactoryProxy *pObjectX = (JCDBRasterDataSourceFactoryProxy*) pObjXXXX;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial2d_raster_Dbrasterdatasourcefactory_getType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Raster::CDBRasterDataSourceFactory *pObjectX = (EarthView::World::Spatial2D::Raster::CDBRasterDataSourceFactory*) pObjXXXX;
					ev_int32 __values1 = pObjectX->EarthView::World::Spatial2D::Raster::CDBRasterDataSourceFactory::getType();
					jint __values1_j = (jint)__values1;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_raster_Dbrasterdatasourcefactory_destroyDataSource_1IDataSource(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong pDataSource_j)
				{
					EarthView::World::Spatial::GeoDataset::IDataSource *pDataSource = (EarthView::World::Spatial::GeoDataset::IDataSource*) pDataSource_j;
					EarthView::World::Spatial2D::Raster::CDBRasterDataSourceFactory *pObjectX = (EarthView::World::Spatial2D::Raster::CDBRasterDataSourceFactory*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCDBRasterDataSourceFactoryProxy))
					{
						pObjectX->EarthView::World::Spatial2D::Raster::CDBRasterDataSourceFactory::destroyDataSource(pDataSource);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_raster_Dbrasterdatasourcefactory_register_1destroyDataSource_1IDataSource(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCDBRasterDataSourceFactoryProxy *pObjectX = (JCDBRasterDataSourceFactoryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_raster_Dbrasterdatasourcefactory_destroyDataSource_1IDataSource_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong pDataSource_j)
				{
					EarthView::World::Spatial::GeoDataset::IDataSource *pDataSource = (EarthView::World::Spatial::GeoDataset::IDataSource*) pDataSource_j;
					EarthView::World::Spatial2D::Raster::CDBRasterDataSourceFactory *pObjectX = (EarthView::World::Spatial2D::Raster::CDBRasterDataSourceFactory*) pObjXXXX;
					pObjectX->EarthView::World::Spatial2D::Raster::CDBRasterDataSourceFactory::destroyDataSource(pDataSource);
				}
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_raster_Dbrasterdatasourcefactory_createFromXML_1EVString(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring xml_j)
				{
					#if EV_PLATFORM == EV_PLATFORM_ANDROID
					...
					if (typeid(*pObjectX) == typeid(JCDBRasterDataSourceFactoryProxy))
					{
						EarthView::World::Spatial::GeoDataset::IDataSource* __values1 = pObjectX->EarthView::World::Spatial2D::Raster::CDBRasterDataSourceFactory::createFromXML(xml);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_raster_Dbrasterdatasourcefactory_register_1createFromXML_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCDBRasterDataSourceFactoryProxy *pObjectX = (JCDBRasterDataSourceFactoryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_raster_Dbrasterdatasourcefactory_createFromXML_1EVString_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring xml_j)
				{
					#if EV_PLATFORM == EV_PLATFORM_ANDROID
					const ev_char* xml_ch = (const ev_char*)__env->GetStringUTFChars(xml_j,JNI_FALSE);
					const EVString xml = xml_ch;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_raster_Dbrasterdatasourcefactory_openDataSource_1EVString_1EVString(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring path_j, jstring fileName_j)
				{
					#if EV_PLATFORM == EV_PLATFORM_ANDROID
					...
					if (typeid(*pObjectX) == typeid(JCDBRasterDataSourceFactoryProxy))
					{
						EarthView::World::Spatial::GeoDataset::IDataSource* __values1 = pObjectX->EarthView::World::Spatial2D::Raster::CDBRasterDataSourceFactory::openDataSource(path, fileName);
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_raster_Dbrasterdatasourcefactory_register_1openDataSource_1EVString_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCDBRasterDataSourceFactoryProxy *pObjectX = (JCDBRasterDataSourceFactoryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_raster_Dbrasterdatasourcefactory_openDataSource_1EVString_1EVString_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring path_j, jstring fileName_j)
				{
					#if EV_PLATFORM == EV_PLATFORM_ANDROID
					const ev_char* path_ch = (const ev_char*)__env->GetStringUTFChars(path_j,JNI_FALSE);
					const EVString path = path_ch;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_raster_Dbrasterdatasourcefactory_openDataSource_1IPropertySet(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong connection_j)
				{
					EarthView::World::Spatial::GeoDataset::IPropertySet *connection = (EarthView::World::Spatial::GeoDataset::IPropertySet*) connection_j;
					EarthView::World::Spatial2D::Raster::CDBRasterDataSourceFactory *pObjectX = (EarthView::World::Spatial2D::Raster::CDBRasterDataSourceFactory*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCDBRasterDataSourceFactoryProxy))
					{
						EarthView::World::Spatial::GeoDataset::IDataSource* __values1 = pObjectX->EarthView::World::Spatial2D::Raster::CDBRasterDataSourceFactory::openDataSource(connection);
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_raster_Dbrasterdatasourcefactory_register_1openDataSource_1IPropertySet(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCDBRasterDataSourceFactoryProxy *pObjectX = (JCDBRasterDataSourceFactoryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_raster_Dbrasterdatasourcefactory_openDataSource_1IPropertySet_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong connection_j)
				{
					EarthView::World::Spatial::GeoDataset::IPropertySet *connection = (EarthView::World::Spatial::GeoDataset::IPropertySet*) connection_j;
					EarthView::World::Spatial2D::Raster::CDBRasterDataSourceFactory *pObjectX = (EarthView::World::Spatial2D::Raster::CDBRasterDataSourceFactory*) pObjXXXX;
					EarthView::World::Spatial::GeoDataset::IDataSource* __values1 = pObjectX->EarthView::World::Spatial2D::Raster::CDBRasterDataSourceFactory::openDataSource(connection);
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_raster_Dbrasterdatasourcefactory_createDataSource_1EVString_1EVString(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring path_j, jstring fileName_j)
				{
					#if EV_PLATFORM == EV_PLATFORM_ANDROID
					const ev_char* path_ch = (const ev_char*)__env->GetStringUTFChars(path_j,JNI_FALSE);
					const EVString path = path_ch;
					...
					if (typeid(*pObjectX) == typeid(JCDBRasterDataSourceFactoryProxy))
					{
						EarthView::World::Spatial::GeoDataset::IDataSource* __values1 = pObjectX->EarthView::World::Spatial2D::Raster::CDBRasterDataSourceFactory::createDataSource(path, fileName);
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_raster_Dbrasterdatasourcefactory_register_1createDataSource_1EVString_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCDBRasterDataSourceFactoryProxy *pObjectX = (JCDBRasterDataSourceFactoryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_raster_Dbrasterdatasourcefactory_createDataSource_1EVString_1EVString_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring path_j, jstring fileName_j)
				{
					#if EV_PLATFORM == EV_PLATFORM_ANDROID
					const ev_char* path_ch = (const ev_char*)__env->GetStringUTFChars(path_j,JNI_FALSE);
					const EVString path = path_ch;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_raster_Dbrasterdatasourcefactory_createDataSource_1IPropertySet(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong connection_j)
				{
					EarthView::World::Spatial::GeoDataset::IPropertySet *connection = (EarthView::World::Spatial::GeoDataset::IPropertySet*) connection_j;
					EarthView::World::Spatial2D::Raster::CDBRasterDataSourceFactory *pObjectX = (EarthView::World::Spatial2D::Raster::CDBRasterDataSourceFactory*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCDBRasterDataSourceFactoryProxy))
					{
						EarthView::World::Spatial::GeoDataset::IDataSource* __values1 = pObjectX->EarthView::World::Spatial2D::Raster::CDBRasterDataSourceFactory::createDataSource(connection);
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_raster_Dbrasterdatasourcefactory_register_1createDataSource_1IPropertySet(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCDBRasterDataSourceFactoryProxy *pObjectX = (JCDBRasterDataSourceFactoryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_raster_Dbrasterdatasourcefactory_createDataSource_1IPropertySet_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong connection_j)
				{
					EarthView::World::Spatial::GeoDataset::IPropertySet *connection = (EarthView::World::Spatial::GeoDataset::IPropertySet*) connection_j;
					EarthView::World::Spatial2D::Raster::CDBRasterDataSourceFactory *pObjectX = (EarthView::World::Spatial2D::Raster::CDBRasterDataSourceFactory*) pObjXXXX;
					EarthView::World::Spatial::GeoDataset::IDataSource* __values1 = pObjectX->EarthView::World::Spatial2D::Raster::CDBRasterDataSourceFactory::createDataSource(connection);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_raster_Dbrasterdatasourcefactory_register_1existDataSource_1IDataSource(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCDBRasterDataSourceFactoryProxy *pObjectX = (JCDBRasterDataSourceFactoryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
