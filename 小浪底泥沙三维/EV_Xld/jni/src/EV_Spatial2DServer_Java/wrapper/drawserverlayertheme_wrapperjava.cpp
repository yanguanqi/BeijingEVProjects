...
namespace EarthView
{
	namespace World
	{
		namespace Spatial
		{
			namespace Display
			{
				class JCDrawServerLayerThemeProxy : public EarthView::World::Spatial::Display::CDrawServerLayerTheme
				{
				 private:
				...
				public:
					JCDrawServerLayerThemeProxy(EarthView::World::Core::CNameValuePairList *pList) : CDrawServerLayerTheme(pList)
					{
					}
				...
				REGISTER_FACTORY_CLASS(JCDrawServerLayerThemeProxy);
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_DrawServerLayerTheme_startDraw_1ISpatialDisplay_1ev_1uint8_1ITheme_1ev_1int32(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong ref_display_j, jshort transparent_j, jlong ref_pTheme_j, jint mode_j)
				{
					...
					EarthView::World::Spatial::Theme::ITheme *ref_pTheme = (EarthView::World::Spatial::Theme::ITheme*) ref_pTheme_j;
					ev_int32 mode = (ev_int32) mode_j;
					EarthView::World::Spatial::Display::CDrawServerLayerTheme *pObjectX = (EarthView::World::Spatial::Display::CDrawServerLayerTheme*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCDrawServerLayerThemeProxy))
					{
						pObjectX->EarthView::World::Spatial::Display::CDrawServerLayerTheme::startDraw(ref_display, transparent, ref_pTheme, mode);
					}
					else
					{
						pObjectX->startDraw(ref_display, transparent, ref_pTheme, mode);
					}
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_DrawServerLayerTheme_register_1startDraw_1ISpatialDisplay_1ev_1uint8_1ITheme_1ev_1int32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCDrawServerLayerThemeProxy *pObjectX = (JCDrawServerLayerThemeProxy*) pObjXXXX;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_DrawServerLayerTheme_startDraw_1ISpatialDisplay_1ev_1uint8_1ITheme_1ev_1int32_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong ref_display_j, jshort transparent_j, jlong ref_pTheme_j, jint mode_j)
				{
					EarthView::World::Spatial::Display::ISpatialDisplay *ref_display = (EarthView::World::Spatial::Display::ISpatialDisplay*) ref_display_j;
					ev_uint8 transparent = (ev_uint8) transparent_j;
					EarthView::World::Spatial::Theme::ITheme *ref_pTheme = (EarthView::World::Spatial::Theme::ITheme*) ref_pTheme_j;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_DrawServerLayerTheme_endDraw_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial::Display::CDrawServerLayerTheme *pObjectX = (EarthView::World::Spatial::Display::CDrawServerLayerTheme*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCDrawServerLayerThemeProxy))
					{
						pObjectX->EarthView::World::Spatial::Display::CDrawServerLayerTheme::endDraw();
					}
					else
					{
						pObjectX->endDraw();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_DrawServerLayerTheme_register_1endDraw_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCDrawServerLayerThemeProxy *pObjectX = (JCDrawServerLayerThemeProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_DrawServerLayerTheme_endDraw_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial::Display::CDrawServerLayerTheme *pObjectX = (EarthView::World::Spatial::Display::CDrawServerLayerTheme*) pObjXXXX;
					pObjectX->EarthView::World::Spatial::Display::CDrawServerLayerTheme::endDraw();
				}
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_display_DrawServerLayerTheme_draw_1IDataset(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong pDataset_j)
				{
					EarthView::World::Spatial::GeoDataset::IDataset *pDataset = (EarthView::World::Spatial::GeoDataset::IDataset*) pDataset_j;
					EarthView::World::Spatial::Display::CDrawServerLayerTheme *pObjectX = (EarthView::World::Spatial::Display::CDrawServerLayerTheme*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCDrawServerLayerThemeProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial::Display::CDrawServerLayerTheme::draw(pDataset);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_DrawServerLayerTheme_register_1draw_1IDataset(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCDrawServerLayerThemeProxy *pObjectX = (JCDrawServerLayerThemeProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_display_DrawServerLayerTheme_draw_1IDataset_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong pDataset_j)
				{
					EarthView::World::Spatial::GeoDataset::IDataset *pDataset = (EarthView::World::Spatial::GeoDataset::IDataset*) pDataset_j;
					EarthView::World::Spatial::Display::CDrawServerLayerTheme *pObjectX = (EarthView::World::Spatial::Display::CDrawServerLayerTheme*) pObjXXXX;
					ev_bool __values1 = pObjectX->EarthView::World::Spatial::Display::CDrawServerLayerTheme::draw(pDataset);
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_display_DrawServerLayerTheme_draw_1EVString_1EVString_1IEnvelope_1ISpatialReference(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring datasetName_j, jstring datasourceName_j, jlong pEnv_j, jlong pSRS_j)
				{
					#if EV_PLATFORM == EV_PLATFORM_ANDROID
					...
					if (typeid(*pObjectX) == typeid(JCDrawServerLayerThemeProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial::Display::CDrawServerLayerTheme::draw(datasetName, datasourceName, pEnv, pSRS);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_DrawServerLayerTheme_register_1draw_1EVString_1EVString_1IEnvelope_1ISpatialReference(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCDrawServerLayerThemeProxy *pObjectX = (JCDrawServerLayerThemeProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_display_DrawServerLayerTheme_draw_1EVString_1EVString_1IEnvelope_1ISpatialReference_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring datasetName_j, jstring datasourceName_j, jlong pEnv_j, jlong pSRS_j)
				{
					#if EV_PLATFORM == EV_PLATFORM_ANDROID
					const ev_char* datasetName_ch = (const ev_char*)__env->GetStringUTFChars(datasetName_j,JNI_FALSE);
					EVString datasetName = datasetName_ch;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_DrawServerLayerTheme_drawTile_1RequestPara(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong req_j)
				{
					EarthView::World::Core::CWorkQueue::RequestPara *req = (EarthView::World::Core::CWorkQueue::RequestPara*) req_j;
					EarthView::World::Spatial::Display::CDrawServerLayerTheme *pObjectX = (EarthView::World::Spatial::Display::CDrawServerLayerTheme*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCDrawServerLayerThemeProxy))
					{
						pObjectX->EarthView::World::Spatial::Display::CDrawServerLayerTheme::drawTile(req);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_DrawServerLayerTheme_register_1drawTile_1RequestPara(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCDrawServerLayerThemeProxy *pObjectX = (JCDrawServerLayerThemeProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_DrawServerLayerTheme_drawTile_1RequestPara_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong req_j)
				{
					EarthView::World::Core::CWorkQueue::RequestPara *req = (EarthView::World::Core::CWorkQueue::RequestPara*) req_j;
					EarthView::World::Spatial::Display::CDrawServerLayerTheme *pObjectX = (EarthView::World::Spatial::Display::CDrawServerLayerTheme*) pObjXXXX;
					pObjectX->EarthView::World::Spatial::Display::CDrawServerLayerTheme::drawTile(req);
