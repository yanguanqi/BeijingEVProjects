...
namespace EarthView
{
	namespace World
	{
		namespace Spatial2D
		{
			namespace Atlas
			{
				class JCEVServerLayerExProxy : public EarthView::World::Spatial2D::Atlas::CEVServerLayerEx
				{
				 private:
				...
				public:
					JCEVServerLayerExProxy(EarthView::World::Core::CNameValuePairList *pList) : CEVServerLayerEx(pList)
					{
					}
				...
				public:
					...
					virtual void setDataset(EarthView::World::Spatial::GeoDataset::IDataset* dataset)
					{
						if (this->_gRef != NULL && this->m_setDataset_IDataset_callback != "" && this->isCustomExtend())
						{
							...
							__env->CallVoidMethod(__obj, __method , dataset_j);
							#if EV_PLATFORM == EV_PLATFORM_ANDROID
							if(__jniAttachable)
							{
								EarthView::World::Core::JNILoad::getCachedJVM()->DetachCurrentThread();
				...
				REGISTER_FACTORY_CLASS(JCEVServerLayerExProxy);
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerex_getType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Atlas::CEVServerLayerEx *pObjectX = (EarthView::World::Spatial2D::Atlas::CEVServerLayerEx*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCEVServerLayerExProxy))
					{
						EarthView::World::Spatial::Atlas::EVLayerType __values1 = pObjectX->EarthView::World::Spatial2D::Atlas::CEVServerLayerEx::getType();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerex_register_1getType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEVServerLayerExProxy *pObjectX = (JCEVServerLayerExProxy*) pObjXXXX;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerex_getType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Atlas::CEVServerLayerEx *pObjectX = (EarthView::World::Spatial2D::Atlas::CEVServerLayerEx*) pObjXXXX;
					EarthView::World::Spatial::Atlas::EVLayerType __values1 = pObjectX->EarthView::World::Spatial2D::Atlas::CEVServerLayerEx::getType();
					jint __values1_j = (jint) __values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerex_getDataset_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Atlas::CEVServerLayerEx *pObjectX = (EarthView::World::Spatial2D::Atlas::CEVServerLayerEx*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCEVServerLayerExProxy))
					{
						EarthView::World::Spatial::GeoDataset::IDataset* __values1 = pObjectX->EarthView::World::Spatial2D::Atlas::CEVServerLayerEx::getDataset();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerex_register_1getDataset_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEVServerLayerExProxy *pObjectX = (JCEVServerLayerExProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerex_getDataset_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Atlas::CEVServerLayerEx *pObjectX = (EarthView::World::Spatial2D::Atlas::CEVServerLayerEx*) pObjXXXX;
					EarthView::World::Spatial::GeoDataset::IDataset* __values1 = pObjectX->EarthView::World::Spatial2D::Atlas::CEVServerLayerEx::getDataset();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerex_setDataset_1IDataset(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong dataset_j)
				{
					EarthView::World::Spatial::GeoDataset::IDataset *dataset = (EarthView::World::Spatial::GeoDataset::IDataset*) dataset_j;
					EarthView::World::Spatial2D::Atlas::CEVServerLayerEx *pObjectX = (EarthView::World::Spatial2D::Atlas::CEVServerLayerEx*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCEVServerLayerExProxy))
					{
						pObjectX->EarthView::World::Spatial2D::Atlas::CEVServerLayerEx::setDataset(dataset);
					}
					else
					{
						pObjectX->setDataset(dataset);
					}
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerex_register_1setDataset_1IDataset(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEVServerLayerExProxy *pObjectX = (JCEVServerLayerExProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerex_setDataset_1IDataset_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong dataset_j)
				{
					EarthView::World::Spatial::GeoDataset::IDataset *dataset = (EarthView::World::Spatial::GeoDataset::IDataset*) dataset_j;
					EarthView::World::Spatial2D::Atlas::CEVServerLayerEx *pObjectX = (EarthView::World::Spatial2D::Atlas::CEVServerLayerEx*) pObjXXXX;
					pObjectX->EarthView::World::Spatial2D::Atlas::CEVServerLayerEx::setDataset(dataset);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerex_setTransparentValue_1ev_1uint8(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jshort transparent_j)
				{
					ev_uint8 transparent = (ev_uint8) transparent_j;
					EarthView::World::Spatial2D::Atlas::CEVServerLayerEx *pObjectX = (EarthView::World::Spatial2D::Atlas::CEVServerLayerEx*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCEVServerLayerExProxy))
					{
						pObjectX->EarthView::World::Spatial2D::Atlas::CEVServerLayerEx::setTransparentValue(transparent);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerex_register_1setTransparentValue_1ev_1uint8(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEVServerLayerExProxy *pObjectX = (JCEVServerLayerExProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerex_setTransparentValue_1ev_1uint8_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jshort transparent_j)
				{
					ev_uint8 transparent = (ev_uint8) transparent_j;
					EarthView::World::Spatial2D::Atlas::CEVServerLayerEx *pObjectX = (EarthView::World::Spatial2D::Atlas::CEVServerLayerEx*) pObjXXXX;
					pObjectX->EarthView::World::Spatial2D::Atlas::CEVServerLayerEx::setTransparentValue(transparent);
				}
				extern "C" JNIEXPORT jshort JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerex_getTransparentValue_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Atlas::CEVServerLayerEx *pObjectX = (EarthView::World::Spatial2D::Atlas::CEVServerLayerEx*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCEVServerLayerExProxy))
					{
						ev_uint8 __values1 = pObjectX->EarthView::World::Spatial2D::Atlas::CEVServerLayerEx::getTransparentValue();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerex_register_1getTransparentValue_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEVServerLayerExProxy *pObjectX = (JCEVServerLayerExProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jshort JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerex_getTransparentValue_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Atlas::CEVServerLayerEx *pObjectX = (EarthView::World::Spatial2D::Atlas::CEVServerLayerEx*) pObjXXXX;
					ev_uint8 __values1 = pObjectX->EarthView::World::Spatial2D::Atlas::CEVServerLayerEx::getTransparentValue();
					jshort __values1_j = (jshort) __values1;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerex_draw_1ISpatialDisplay_1EVVectorLayerRendererType(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong display_j, jint type_j)
				{
					...
					if (typeid(*pObjectX) == typeid(JCEVServerLayerExProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial2D::Atlas::CEVServerLayerEx::draw(display, type);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerex_register_1draw_1ISpatialDisplay_1EVVectorLayerRendererType(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEVServerLayerExProxy *pObjectX = (JCEVServerLayerExProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerex_draw_1ISpatialDisplay_1EVVectorLayerRendererType_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong display_j, jint type_j)
				{
					EarthView::World::Spatial::Display::ISpatialDisplay *display = (EarthView::World::Spatial::Display::ISpatialDisplay*) display_j;
					EarthView::World::Spatial::Atlas::EVVectorLayerRendererType type = (EarthView::World::Spatial::Atlas::EVVectorLayerRendererType) type_j;
					EarthView::World::Spatial2D::Atlas::CEVServerLayerEx *pObjectX = (EarthView::World::Spatial2D::Atlas::CEVServerLayerEx*) pObjXXXX;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerex_getExtent_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Atlas::CEVServerLayerEx *pObjectX = (EarthView::World::Spatial2D::Atlas::CEVServerLayerEx*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCEVServerLayerExProxy))
					{
						const EarthView::World::Spatial::Geometry::IEnvelope* __values1 = pObjectX->EarthView::World::Spatial2D::Atlas::CEVServerLayerEx::getExtent();
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerex_register_1getExtent_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEVServerLayerExProxy *pObjectX = (JCEVServerLayerExProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerex_getExtent_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Atlas::CEVServerLayerEx *pObjectX = (EarthView::World::Spatial2D::Atlas::CEVServerLayerEx*) pObjXXXX;
					const EarthView::World::Spatial::Geometry::IEnvelope* __values1 = pObjectX->EarthView::World::Spatial2D::Atlas::CEVServerLayerEx::getExtent();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerex_getSpatialReference_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Atlas::CEVServerLayerEx *pObjectX = (EarthView::World::Spatial2D::Atlas::CEVServerLayerEx*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCEVServerLayerExProxy))
					{
						EarthView::World::Spatial::Geometry::ISpatialReference* __values1 = pObjectX->EarthView::World::Spatial2D::Atlas::CEVServerLayerEx::getSpatialReference();
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerex_register_1getSpatialReference_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEVServerLayerExProxy *pObjectX = (JCEVServerLayerExProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerex_getSpatialReference_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Atlas::CEVServerLayerEx *pObjectX = (EarthView::World::Spatial2D::Atlas::CEVServerLayerEx*) pObjXXXX;
					EarthView::World::Spatial::Geometry::ISpatialReference* __values1 = pObjectX->EarthView::World::Spatial2D::Atlas::CEVServerLayerEx::getSpatialReference();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerex_setSpatialReference_1ISpatialReference(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong ref_sr_j)
				{
					EarthView::World::Spatial::Geometry::ISpatialReference *ref_sr = (EarthView::World::Spatial::Geometry::ISpatialReference*) ref_sr_j;
					EarthView::World::Spatial2D::Atlas::CEVServerLayerEx *pObjectX = (EarthView::World::Spatial2D::Atlas::CEVServerLayerEx*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCEVServerLayerExProxy))
					{
						pObjectX->EarthView::World::Spatial2D::Atlas::CEVServerLayerEx::setSpatialReference(ref_sr);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerex_register_1setSpatialReference_1ISpatialReference(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEVServerLayerExProxy *pObjectX = (JCEVServerLayerExProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerex_setSpatialReference_1ISpatialReference_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong ref_sr_j)
				{
					EarthView::World::Spatial::Geometry::ISpatialReference *ref_sr = (EarthView::World::Spatial::Geometry::ISpatialReference*) ref_sr_j;
					EarthView::World::Spatial2D::Atlas::CEVServerLayerEx *pObjectX = (EarthView::World::Spatial2D::Atlas::CEVServerLayerEx*) pObjXXXX;
					pObjectX->EarthView::World::Spatial2D::Atlas::CEVServerLayerEx::setSpatialReference(ref_sr);
				}
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerex_getTheme_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Atlas::CEVServerLayerEx *pObjectX = (EarthView::World::Spatial2D::Atlas::CEVServerLayerEx*) pObjXXXX;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerex_setTheme_1ITheme(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong theme_j)
				{
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerex_ev_1clone_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Atlas::CEVServerLayerEx *pObjectX = (EarthView::World::Spatial2D::Atlas::CEVServerLayerEx*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCEVServerLayerExProxy))
					{
						EarthView::World::Spatial::Atlas::ILayer* __values1 = pObjectX->EarthView::World::Spatial2D::Atlas::CEVServerLayerEx::clone();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerex_register_1ev_1clone_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEVServerLayerExProxy *pObjectX = (JCEVServerLayerExProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerex_ev_1clone_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Atlas::CEVServerLayerEx *pObjectX = (EarthView::World::Spatial2D::Atlas::CEVServerLayerEx*) pObjXXXX;
					EarthView::World::Spatial::Atlas::ILayer* __values1 = pObjectX->EarthView::World::Spatial2D::Atlas::CEVServerLayerEx::clone();
					if(__values1 != NULL) {						((EarthView::World::Core::CBaseObject*)__values1)->setExternFree(true);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerex_fromXmlElement_1CXmlElement(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong element_j)
				{
					EarthView::World::Core::CXmlElement &element = *(EarthView::World::Core::CXmlElement*) element_j;
					EarthView::World::Spatial2D::Atlas::CEVServerLayerEx *pObjectX = (EarthView::World::Spatial2D::Atlas::CEVServerLayerEx*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCEVServerLayerExProxy))
					{
						pObjectX->EarthView::World::Spatial2D::Atlas::CEVServerLayerEx::fromXmlElement(element);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerex_register_1fromXmlElement_1CXmlElement(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEVServerLayerExProxy *pObjectX = (JCEVServerLayerExProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerex_fromXmlElement_1CXmlElement_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong element_j)
				{
					EarthView::World::Core::CXmlElement &element = *(EarthView::World::Core::CXmlElement*) element_j;
					EarthView::World::Spatial2D::Atlas::CEVServerLayerEx *pObjectX = (EarthView::World::Spatial2D::Atlas::CEVServerLayerEx*) pObjXXXX;
					pObjectX->EarthView::World::Spatial2D::Atlas::CEVServerLayerEx::fromXmlElement(element);
				}
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerex_toXmlElement_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Atlas::CEVServerLayerEx *pObjectX = (EarthView::World::Spatial2D::Atlas::CEVServerLayerEx*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCEVServerLayerExProxy))
					{
						EarthView::World::Core::CXmlElement __values1 = pObjectX->EarthView::World::Spatial2D::Atlas::CEVServerLayerEx::toXmlElement();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerex_register_1toXmlElement_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEVServerLayerExProxy *pObjectX = (JCEVServerLayerExProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerex_toXmlElement_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Atlas::CEVServerLayerEx *pObjectX = (EarthView::World::Spatial2D::Atlas::CEVServerLayerEx*) pObjXXXX;
					EarthView::World::Core::CXmlElement __values1 = pObjectX->EarthView::World::Spatial2D::Atlas::CEVServerLayerEx::toXmlElement();
					EarthView::World::Core::CXmlElement *returnvalues = new EarthView::World::Core::CXmlElement(__values1);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerex_register_1isSelected_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEVServerLayerExProxy *pObjectX = (JCEVServerLayerExProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerex_register_1setSelected_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEVServerLayerExProxy *pObjectX = (JCEVServerLayerExProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerex_register_1getDatasetName_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEVServerLayerExProxy *pObjectX = (JCEVServerLayerExProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerex_register_1getDataSource_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEVServerLayerExProxy *pObjectX = (JCEVServerLayerExProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerex_register_1select_1IQueryFilter_1EVSelectionResultType(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEVServerLayerExProxy *pObjectX = (JCEVServerLayerExProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerex_register_1clearSelection_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEVServerLayerExProxy *pObjectX = (JCEVServerLayerExProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerex_register_1setLayerSelection_1ILayerSelection(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEVServerLayerExProxy *pObjectX = (JCEVServerLayerExProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerex_register_1getLayerSelection_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEVServerLayerExProxy *pObjectX = (JCEVServerLayerExProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerex_register_1getName_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEVServerLayerExProxy *pObjectX = (JCEVServerLayerExProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerex_register_1setName_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEVServerLayerExProxy *pObjectX = (JCEVServerLayerExProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerex_register_1getDescription_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEVServerLayerExProxy *pObjectX = (JCEVServerLayerExProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerex_register_1setDescription_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEVServerLayerExProxy *pObjectX = (JCEVServerLayerExProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerex_register_1canEdit_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEVServerLayerExProxy *pObjectX = (JCEVServerLayerExProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerex_register_1setCanEdit_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEVServerLayerExProxy *pObjectX = (JCEVServerLayerExProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerex_register_1isEditing_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEVServerLayerExProxy *pObjectX = (JCEVServerLayerExProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerex_register_1setEditing_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEVServerLayerExProxy *pObjectX = (JCEVServerLayerExProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerex_register_1isVisible_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEVServerLayerExProxy *pObjectX = (JCEVServerLayerExProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerex_register_1setVisible_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEVServerLayerExProxy *pObjectX = (JCEVServerLayerExProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerex_register_1isValid_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEVServerLayerExProxy *pObjectX = (JCEVServerLayerExProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerex_register_1isSelectable_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEVServerLayerExProxy *pObjectX = (JCEVServerLayerExProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerex_register_1setSelectable_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEVServerLayerExProxy *pObjectX = (JCEVServerLayerExProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerex_register_1ignoreScale_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEVServerLayerExProxy *pObjectX = (JCEVServerLayerExProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerex_register_1setIgnoreScale_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEVServerLayerExProxy *pObjectX = (JCEVServerLayerExProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerex_register_1getDisplayMaxScale_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEVServerLayerExProxy *pObjectX = (JCEVServerLayerExProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerex_register_1setDisplayMaxScale_1ev_1real64(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEVServerLayerExProxy *pObjectX = (JCEVServerLayerExProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerex_register_1getDisplayMinScale_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEVServerLayerExProxy *pObjectX = (JCEVServerLayerExProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerex_register_1setDisplayMinScale_1ev_1real64(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEVServerLayerExProxy *pObjectX = (JCEVServerLayerExProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerex_register_1toStream_1CDataStream(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEVServerLayerExProxy *pObjectX = (JCEVServerLayerExProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerex_register_1toXML_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEVServerLayerExProxy *pObjectX = (JCEVServerLayerExProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerex_register_1fromStream_1CDataStream(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEVServerLayerExProxy *pObjectX = (JCEVServerLayerExProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				class JCEVServerLayerExFactoryProxy : public EarthView::World::Spatial2D::Atlas::CEVServerLayerExFactory
				{
				 private:
					EarthView::World::Core::ev_string m_getType_void_callback;
				...
				public:
					JCEVServerLayerExFactoryProxy(EarthView::World::Core::CNameValuePairList *pList) : CEVServerLayerExFactory(pList)
					{
					}
					ev_void unRegisterJavaReference()
					{
				...
				REGISTER_FACTORY_CLASS(JCEVServerLayerExFactoryProxy);
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerexfactory_getType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Atlas::CEVServerLayerExFactory *pObjectX = (EarthView::World::Spatial2D::Atlas::CEVServerLayerExFactory*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCEVServerLayerExFactoryProxy))
					{
						EarthView::World::Spatial::Atlas::EVLayerType __values1 = pObjectX->EarthView::World::Spatial2D::Atlas::CEVServerLayerExFactory::getType();
						jint __values1_j = (jint) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerexfactory_register_1getType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEVServerLayerExFactoryProxy *pObjectX = (JCEVServerLayerExFactoryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
					__env->ReleaseStringUTFChars(__method, pMethod);
					pObjectX->register_getType_void_callback(sMethod);
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerexfactory_getType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Atlas::CEVServerLayerExFactory *pObjectX = (EarthView::World::Spatial2D::Atlas::CEVServerLayerExFactory*) pObjXXXX;
					EarthView::World::Spatial::Atlas::EVLayerType __values1 = pObjectX->EarthView::World::Spatial2D::Atlas::CEVServerLayerExFactory::getType();
					jint __values1_j = (jint) __values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerexfactory_createInstance_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial2D::Atlas::CEVServerLayerExFactory *pObjectX = (EarthView::World::Spatial2D::Atlas::CEVServerLayerExFactory*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCEVServerLayerExFactoryProxy))
					{
						EarthView::World::Spatial::Atlas::ILayer* __values1 = pObjectX->EarthView::World::Spatial2D::Atlas::CEVServerLayerExFactory::createInstance();
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerexfactory_register_1createInstance_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEVServerLayerExFactoryProxy *pObjectX = (JCEVServerLayerExFactoryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerexfactory_createInstance_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial2D::Atlas::CEVServerLayerExFactory *pObjectX = (EarthView::World::Spatial2D::Atlas::CEVServerLayerExFactory*) pObjXXXX;
					EarthView::World::Spatial::Atlas::ILayer* __values1 = pObjectX->EarthView::World::Spatial2D::Atlas::CEVServerLayerExFactory::createInstance();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerexfactory_createInstance_1CXmlElement(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong element_j)
				{
					EarthView::World::Core::CXmlElement &element = *(EarthView::World::Core::CXmlElement*) element_j;
					EarthView::World::Spatial2D::Atlas::CEVServerLayerExFactory *pObjectX = (EarthView::World::Spatial2D::Atlas::CEVServerLayerExFactory*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCEVServerLayerExFactoryProxy))
					{
						EarthView::World::Spatial::Atlas::ILayer* __values1 = pObjectX->EarthView::World::Spatial2D::Atlas::CEVServerLayerExFactory::createInstance(element);
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerexfactory_register_1createInstance_1CXmlElement(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEVServerLayerExFactoryProxy *pObjectX = (JCEVServerLayerExFactoryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerexfactory_createInstance_1CXmlElement_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong element_j)
				{
					EarthView::World::Core::CXmlElement &element = *(EarthView::World::Core::CXmlElement*) element_j;
					EarthView::World::Spatial2D::Atlas::CEVServerLayerExFactory *pObjectX = (EarthView::World::Spatial2D::Atlas::CEVServerLayerExFactory*) pObjXXXX;
					EarthView::World::Spatial::Atlas::ILayer* __values1 = pObjectX->EarthView::World::Spatial2D::Atlas::CEVServerLayerExFactory::createInstance(element);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerexfactory_register_1createInstance_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEVServerLayerExFactoryProxy *pObjectX = (JCEVServerLayerExFactoryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_atlas_Evserverlayerexfactory_register_1destroyInstance_1ILayer(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEVServerLayerExFactoryProxy *pObjectX = (JCEVServerLayerExFactoryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
