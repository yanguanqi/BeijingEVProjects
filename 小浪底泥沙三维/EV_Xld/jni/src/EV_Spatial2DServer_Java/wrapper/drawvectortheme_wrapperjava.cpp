...
namespace EarthView
{
	namespace World
	{
		namespace Spatial
		{
			namespace Display
			{
				class JCDrawVectorThemeProxy : public EarthView::World::Spatial::Display::CDrawVectorTheme
				{
				 private:
				...
				public:
					JCDrawVectorThemeProxy(EarthView::World::Core::CNameValuePairList *pList) : CDrawVectorTheme(pList)
					{
					}
				...
				REGISTER_FACTORY_CLASS(JCDrawVectorThemeProxy);
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_display_DrawVectorTheme_draw_1IDataset(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong pDataset_j)
				{
					EarthView::World::Spatial::GeoDataset::IDataset *pDataset = (EarthView::World::Spatial::GeoDataset::IDataset*) pDataset_j;
					EarthView::World::Spatial::Display::CDrawVectorTheme *pObjectX = (EarthView::World::Spatial::Display::CDrawVectorTheme*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCDrawVectorThemeProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial::Display::CDrawVectorTheme::draw(pDataset);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_DrawVectorTheme_register_1draw_1IDataset(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCDrawVectorThemeProxy *pObjectX = (JCDrawVectorThemeProxy*) pObjXXXX;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_display_DrawVectorTheme_draw_1IDataset_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong pDataset_j)
				{
					EarthView::World::Spatial::GeoDataset::IDataset *pDataset = (EarthView::World::Spatial::GeoDataset::IDataset*) pDataset_j;
					EarthView::World::Spatial::Display::CDrawVectorTheme *pObjectX = (EarthView::World::Spatial::Display::CDrawVectorTheme*) pObjXXXX;
					ev_bool __values1 = pObjectX->EarthView::World::Spatial::Display::CDrawVectorTheme::draw(pDataset);
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_display_DrawVectorTheme_draw_1EVString_1EVString_1IEnvelope_1ISpatialReference(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring datasetName_j, jstring datasourceName_j, jlong pEnv_j, jlong pSRS_j)
				{
					#if EV_PLATFORM == EV_PLATFORM_ANDROID
					...
					if (typeid(*pObjectX) == typeid(JCDrawVectorThemeProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial::Display::CDrawVectorTheme::draw(datasetName, datasourceName, pEnv, pSRS);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_DrawVectorTheme_register_1draw_1EVString_1EVString_1IEnvelope_1ISpatialReference(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCDrawVectorThemeProxy *pObjectX = (JCDrawVectorThemeProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_display_DrawVectorTheme_draw_1EVString_1EVString_1IEnvelope_1ISpatialReference_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring datasetName_j, jstring datasourceName_j, jlong pEnv_j, jlong pSRS_j)
				{
					#if EV_PLATFORM == EV_PLATFORM_ANDROID
					const ev_char* datasetName_ch = (const ev_char*)__env->GetStringUTFChars(datasetName_j,JNI_FALSE);
					EVString datasetName = datasetName_ch;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_DrawVectorTheme_drawTile_1RequestPara(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong req_j)
				{
					EarthView::World::Core::CWorkQueue::RequestPara *req = (EarthView::World::Core::CWorkQueue::RequestPara*) req_j;
					EarthView::World::Spatial::Display::CDrawVectorTheme *pObjectX = (EarthView::World::Spatial::Display::CDrawVectorTheme*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCDrawVectorThemeProxy))
					{
						pObjectX->EarthView::World::Spatial::Display::CDrawVectorTheme::drawTile(req);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_DrawVectorTheme_register_1drawTile_1RequestPara(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCDrawVectorThemeProxy *pObjectX = (JCDrawVectorThemeProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_DrawVectorTheme_drawTile_1RequestPara_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong req_j)
				{
					EarthView::World::Core::CWorkQueue::RequestPara *req = (EarthView::World::Core::CWorkQueue::RequestPara*) req_j;
					EarthView::World::Spatial::Display::CDrawVectorTheme *pObjectX = (EarthView::World::Spatial::Display::CDrawVectorTheme*) pObjXXXX;
					pObjectX->EarthView::World::Spatial::Display::CDrawVectorTheme::drawTile(req);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_DrawVectorTheme_register_1startDraw_1ISpatialDisplay_1ev_1uint8_1ITheme_1ev_1int32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCDrawVectorThemeProxy *pObjectX = (JCDrawVectorThemeProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_display_DrawVectorTheme_register_1endDraw_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCDrawVectorThemeProxy *pObjectX = (JCDrawVectorThemeProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
