...
namespace EarthView
{
	namespace World
	{
		namespace Layout
		{
			namespace Controls
			{
				class JCCommandInsertScaleBarProxy : public EarthView::World::Layout::Controls::CCommandInsertScaleBar
				{
				 private:
				...
				public:
					JCCommandInsertScaleBarProxy(EarthView::World::Core::CNameValuePairList *pList) : CCommandInsertScaleBar(pList)
					{
					}
				...
				protected:
					C_DISABLE_COPY(JCCommandInsertScaleBarProxy)
				public:
				...
				REGISTER_FACTORY_CLASS(JCCommandInsertScaleBarProxy);
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_layout_controls_CommandInsertScaleBar_getToolBarType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CCommandInsertScaleBar *pObjectX = (EarthView::World::Layout::Controls::CCommandInsertScaleBar*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCCommandInsertScaleBarProxy))
					{
						ev_uint32 __values1 = pObjectX->EarthView::World::Layout::Controls::CCommandInsertScaleBar::getToolBarType();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_CommandInsertScaleBar_register_1getToolBarType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandInsertScaleBarProxy *pObjectX = (JCCommandInsertScaleBarProxy*) pObjXXXX;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_layout_controls_CommandInsertScaleBar_getToolBarType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CCommandInsertScaleBar *pObjectX = (EarthView::World::Layout::Controls::CCommandInsertScaleBar*) pObjXXXX;
					ev_uint32 __values1 = pObjectX->EarthView::World::Layout::Controls::CCommandInsertScaleBar::getToolBarType();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_layout_controls_CommandInsertScaleBar_getType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CCommandInsertScaleBar *pObjectX = (EarthView::World::Layout::Controls::CCommandInsertScaleBar*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCCommandInsertScaleBarProxy))
					{
						ev_uint32 __values1 = pObjectX->EarthView::World::Layout::Controls::CCommandInsertScaleBar::getType();
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_CommandInsertScaleBar_register_1getType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandInsertScaleBarProxy *pObjectX = (JCCommandInsertScaleBarProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_layout_controls_CommandInsertScaleBar_getType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CCommandInsertScaleBar *pObjectX = (EarthView::World::Layout::Controls::CCommandInsertScaleBar*) pObjXXXX;
					ev_uint32 __values1 = pObjectX->EarthView::World::Layout::Controls::CCommandInsertScaleBar::getType();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_layout_controls_CommandInsertScaleBar_getName_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CCommandInsertScaleBar *pObjectX = (EarthView::World::Layout::Controls::CCommandInsertScaleBar*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCCommandInsertScaleBarProxy))
					{
						EVString __values1 = pObjectX->EarthView::World::Layout::Controls::CCommandInsertScaleBar::getName();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_CommandInsertScaleBar_register_1getName_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandInsertScaleBarProxy *pObjectX = (JCCommandInsertScaleBarProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_layout_controls_CommandInsertScaleBar_getName_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CCommandInsertScaleBar *pObjectX = (EarthView::World::Layout::Controls::CCommandInsertScaleBar*) pObjXXXX;
					EVString __values1 = pObjectX->EarthView::World::Layout::Controls::CCommandInsertScaleBar::getName();
					EarthView::World::Core::ev_wstring valuesw1 = __values1;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_layout_controls_CommandInsertScaleBar_getCategory_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CCommandInsertScaleBar *pObjectX = (EarthView::World::Layout::Controls::CCommandInsertScaleBar*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCCommandInsertScaleBarProxy))
					{
						EVString __values1 = pObjectX->EarthView::World::Layout::Controls::CCommandInsertScaleBar::getCategory();
						EarthView::World::Core::ev_wstring valuesw1 = __values1;
						jstring __values1_j = __env->NewString((const jchar*)valuesw1.getString(), valuesw1.size());
						return __values1_j;
					}
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_CommandInsertScaleBar_register_1getCategory_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandInsertScaleBarProxy *pObjectX = (JCCommandInsertScaleBarProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_layout_controls_CommandInsertScaleBar_getCategory_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CCommandInsertScaleBar *pObjectX = (EarthView::World::Layout::Controls::CCommandInsertScaleBar*) pObjXXXX;
					EVString __values1 = pObjectX->EarthView::World::Layout::Controls::CCommandInsertScaleBar::getCategory();
					EarthView::World::Core::ev_wstring valuesw1 = __values1;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_layout_controls_CommandInsertScaleBar_getToolTip_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CCommandInsertScaleBar *pObjectX = (EarthView::World::Layout::Controls::CCommandInsertScaleBar*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCCommandInsertScaleBarProxy))
					{
						EVString __values1 = pObjectX->EarthView::World::Layout::Controls::CCommandInsertScaleBar::getToolTip();
						EarthView::World::Core::ev_wstring valuesw1 = __values1;
						jstring __values1_j = __env->NewString((const jchar*)valuesw1.getString(), valuesw1.size());
						return __values1_j;
					}
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_CommandInsertScaleBar_register_1getToolTip_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandInsertScaleBarProxy *pObjectX = (JCCommandInsertScaleBarProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_layout_controls_CommandInsertScaleBar_getToolTip_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CCommandInsertScaleBar *pObjectX = (EarthView::World::Layout::Controls::CCommandInsertScaleBar*) pObjXXXX;
					EVString __values1 = pObjectX->EarthView::World::Layout::Controls::CCommandInsertScaleBar::getToolTip();
					EarthView::World::Core::ev_wstring valuesw1 = __values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_layout_controls_CommandInsertScaleBar_getIcon_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CCommandInsertScaleBar *pObjectX = (EarthView::World::Layout::Controls::CCommandInsertScaleBar*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCCommandInsertScaleBarProxy))
					{
						EarthView::World::Display::IBitmap* __values1 = pObjectX->EarthView::World::Layout::Controls::CCommandInsertScaleBar::getIcon();
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_CommandInsertScaleBar_register_1getIcon_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandInsertScaleBarProxy *pObjectX = (JCCommandInsertScaleBarProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_layout_controls_CommandInsertScaleBar_getIcon_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CCommandInsertScaleBar *pObjectX = (EarthView::World::Layout::Controls::CCommandInsertScaleBar*) pObjXXXX;
					EarthView::World::Display::IBitmap* __values1 = pObjectX->EarthView::World::Layout::Controls::CCommandInsertScaleBar::getIcon();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_layout_controls_CommandInsertScaleBar_isCheckable_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CCommandInsertScaleBar *pObjectX = (EarthView::World::Layout::Controls::CCommandInsertScaleBar*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCCommandInsertScaleBarProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Layout::Controls::CCommandInsertScaleBar::isCheckable();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_CommandInsertScaleBar_register_1isCheckable_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandInsertScaleBarProxy *pObjectX = (JCCommandInsertScaleBarProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_layout_controls_CommandInsertScaleBar_isCheckable_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CCommandInsertScaleBar *pObjectX = (EarthView::World::Layout::Controls::CCommandInsertScaleBar*) pObjXXXX;
					ev_bool __values1 = pObjectX->EarthView::World::Layout::Controls::CCommandInsertScaleBar::isCheckable();
					jboolean __values1_j = (jboolean)__values1;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_layout_controls_CommandInsertScaleBar_update_1CEvent(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong e_j)
				{
					EarthView::World::Core::CEvent *e = (EarthView::World::Core::CEvent*) e_j;
					EarthView::World::Layout::Controls::CCommandInsertScaleBar *pObjectX = (EarthView::World::Layout::Controls::CCommandInsertScaleBar*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCCommandInsertScaleBarProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Layout::Controls::CCommandInsertScaleBar::update(e);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_CommandInsertScaleBar_register_1update_1CEvent(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandInsertScaleBarProxy *pObjectX = (JCCommandInsertScaleBarProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_layout_controls_CommandInsertScaleBar_update_1CEvent_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong e_j)
				{
					EarthView::World::Core::CEvent *e = (EarthView::World::Core::CEvent*) e_j;
					EarthView::World::Layout::Controls::CCommandInsertScaleBar *pObjectX = (EarthView::World::Layout::Controls::CCommandInsertScaleBar*) pObjXXXX;
					ev_bool __values1 = pObjectX->EarthView::World::Layout::Controls::CCommandInsertScaleBar::update(e);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_CommandInsertScaleBar_register_1onClicked_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandInsertScaleBarProxy *pObjectX = (JCCommandInsertScaleBarProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_CommandInsertScaleBar_register_1getChecked_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandInsertScaleBarProxy *pObjectX = (JCCommandInsertScaleBarProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_CommandInsertScaleBar_register_1setChecked_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandInsertScaleBarProxy *pObjectX = (JCCommandInsertScaleBarProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_CommandInsertScaleBar_register_1getEnabled_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandInsertScaleBarProxy *pObjectX = (JCCommandInsertScaleBarProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_CommandInsertScaleBar_register_1setEnabled_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandInsertScaleBarProxy *pObjectX = (JCCommandInsertScaleBarProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_CommandInsertScaleBar_register_1create_1ISpatialControl(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandInsertScaleBarProxy *pObjectX = (JCCommandInsertScaleBarProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
