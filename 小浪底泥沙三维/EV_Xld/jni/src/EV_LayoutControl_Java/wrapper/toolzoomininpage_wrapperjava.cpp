...
namespace EarthView
{
	namespace World
	{
		namespace Layout
		{
			namespace Controls
			{
				class JCToolZoomInInPageProxy : public EarthView::World::Layout::Controls::CToolZoomInInPage
				{
				 private:
				...
				public:
					JCToolZoomInInPageProxy(EarthView::World::Core::CNameValuePairList *pList) : CToolZoomInInPage(pList)
					{
					}
				...
				protected:
					C_DISABLE_COPY(JCToolZoomInInPageProxy)
				public:
				...
				REGISTER_FACTORY_CLASS(JCToolZoomInInPageProxy);
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_layout_controls_ToolZoomInInPage_getToolBarType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CToolZoomInInPage *pObjectX = (EarthView::World::Layout::Controls::CToolZoomInInPage*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCToolZoomInInPageProxy))
					{
						ev_uint32 __values1 = pObjectX->EarthView::World::Layout::Controls::CToolZoomInInPage::getToolBarType();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolZoomInInPage_register_1getToolBarType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolZoomInInPageProxy *pObjectX = (JCToolZoomInInPageProxy*) pObjXXXX;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_layout_controls_ToolZoomInInPage_getToolBarType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CToolZoomInInPage *pObjectX = (EarthView::World::Layout::Controls::CToolZoomInInPage*) pObjXXXX;
					ev_uint32 __values1 = pObjectX->EarthView::World::Layout::Controls::CToolZoomInInPage::getToolBarType();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_layout_controls_ToolZoomInInPage_getType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CToolZoomInInPage *pObjectX = (EarthView::World::Layout::Controls::CToolZoomInInPage*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCToolZoomInInPageProxy))
					{
						ev_uint32 __values1 = pObjectX->EarthView::World::Layout::Controls::CToolZoomInInPage::getType();
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolZoomInInPage_register_1getType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolZoomInInPageProxy *pObjectX = (JCToolZoomInInPageProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_layout_controls_ToolZoomInInPage_getType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CToolZoomInInPage *pObjectX = (EarthView::World::Layout::Controls::CToolZoomInInPage*) pObjXXXX;
					ev_uint32 __values1 = pObjectX->EarthView::World::Layout::Controls::CToolZoomInInPage::getType();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_layout_controls_ToolZoomInInPage_getName_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CToolZoomInInPage *pObjectX = (EarthView::World::Layout::Controls::CToolZoomInInPage*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCToolZoomInInPageProxy))
					{
						EVString __values1 = pObjectX->EarthView::World::Layout::Controls::CToolZoomInInPage::getName();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolZoomInInPage_register_1getName_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolZoomInInPageProxy *pObjectX = (JCToolZoomInInPageProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_layout_controls_ToolZoomInInPage_getName_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CToolZoomInInPage *pObjectX = (EarthView::World::Layout::Controls::CToolZoomInInPage*) pObjXXXX;
					EVString __values1 = pObjectX->EarthView::World::Layout::Controls::CToolZoomInInPage::getName();
					EarthView::World::Core::ev_wstring valuesw1 = __values1;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_layout_controls_ToolZoomInInPage_getCategory_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CToolZoomInInPage *pObjectX = (EarthView::World::Layout::Controls::CToolZoomInInPage*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCToolZoomInInPageProxy))
					{
						EVString __values1 = pObjectX->EarthView::World::Layout::Controls::CToolZoomInInPage::getCategory();
						EarthView::World::Core::ev_wstring valuesw1 = __values1;
						jstring __values1_j = __env->NewString((const jchar*)valuesw1.getString(), valuesw1.size());
						return __values1_j;
					}
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolZoomInInPage_register_1getCategory_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolZoomInInPageProxy *pObjectX = (JCToolZoomInInPageProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_layout_controls_ToolZoomInInPage_getCategory_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CToolZoomInInPage *pObjectX = (EarthView::World::Layout::Controls::CToolZoomInInPage*) pObjXXXX;
					EVString __values1 = pObjectX->EarthView::World::Layout::Controls::CToolZoomInInPage::getCategory();
					EarthView::World::Core::ev_wstring valuesw1 = __values1;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_layout_controls_ToolZoomInInPage_getToolTip_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CToolZoomInInPage *pObjectX = (EarthView::World::Layout::Controls::CToolZoomInInPage*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCToolZoomInInPageProxy))
					{
						EVString __values1 = pObjectX->EarthView::World::Layout::Controls::CToolZoomInInPage::getToolTip();
						EarthView::World::Core::ev_wstring valuesw1 = __values1;
						jstring __values1_j = __env->NewString((const jchar*)valuesw1.getString(), valuesw1.size());
						return __values1_j;
					}
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolZoomInInPage_register_1getToolTip_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolZoomInInPageProxy *pObjectX = (JCToolZoomInInPageProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_layout_controls_ToolZoomInInPage_getToolTip_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CToolZoomInInPage *pObjectX = (EarthView::World::Layout::Controls::CToolZoomInInPage*) pObjXXXX;
					EVString __values1 = pObjectX->EarthView::World::Layout::Controls::CToolZoomInInPage::getToolTip();
					EarthView::World::Core::ev_wstring valuesw1 = __values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_layout_controls_ToolZoomInInPage_getIcon_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CToolZoomInInPage *pObjectX = (EarthView::World::Layout::Controls::CToolZoomInInPage*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCToolZoomInInPageProxy))
					{
						EarthView::World::Display::IBitmap* __values1 = pObjectX->EarthView::World::Layout::Controls::CToolZoomInInPage::getIcon();
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolZoomInInPage_register_1getIcon_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolZoomInInPageProxy *pObjectX = (JCToolZoomInInPageProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_layout_controls_ToolZoomInInPage_getIcon_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CToolZoomInInPage *pObjectX = (EarthView::World::Layout::Controls::CToolZoomInInPage*) pObjXXXX;
					EarthView::World::Display::IBitmap* __values1 = pObjectX->EarthView::World::Layout::Controls::CToolZoomInInPage::getIcon();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_layout_controls_ToolZoomInInPage_isCheckable_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CToolZoomInInPage *pObjectX = (EarthView::World::Layout::Controls::CToolZoomInInPage*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCToolZoomInInPageProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Layout::Controls::CToolZoomInInPage::isCheckable();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolZoomInInPage_register_1isCheckable_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolZoomInInPageProxy *pObjectX = (JCToolZoomInInPageProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_layout_controls_ToolZoomInInPage_isCheckable_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CToolZoomInInPage *pObjectX = (EarthView::World::Layout::Controls::CToolZoomInInPage*) pObjXXXX;
					ev_bool __values1 = pObjectX->EarthView::World::Layout::Controls::CToolZoomInInPage::isCheckable();
					jboolean __values1_j = (jboolean)__values1;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolZoomInInPage_onClicked_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Layout::Controls::CToolZoomInInPage *pObjectX = (EarthView::World::Layout::Controls::CToolZoomInInPage*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCToolZoomInInPageProxy))
					{
						pObjectX->EarthView::World::Layout::Controls::CToolZoomInInPage::onClicked();
					}
					else
					{
						pObjectX->onClicked();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolZoomInInPage_register_1onClicked_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolZoomInInPageProxy *pObjectX = (JCToolZoomInInPageProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolZoomInInPage_onClicked_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Layout::Controls::CToolZoomInInPage *pObjectX = (EarthView::World::Layout::Controls::CToolZoomInInPage*) pObjXXXX;
					pObjectX->EarthView::World::Layout::Controls::CToolZoomInInPage::onClicked();
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolZoomInInPage_activate_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Layout::Controls::CToolZoomInInPage *pObjectX = (EarthView::World::Layout::Controls::CToolZoomInInPage*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCToolZoomInInPageProxy))
					{
						pObjectX->EarthView::World::Layout::Controls::CToolZoomInInPage::activate();
					}
					else
					{
						pObjectX->activate();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolZoomInInPage_register_1activate_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolZoomInInPageProxy *pObjectX = (JCToolZoomInInPageProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolZoomInInPage_activate_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Layout::Controls::CToolZoomInInPage *pObjectX = (EarthView::World::Layout::Controls::CToolZoomInInPage*) pObjXXXX;
					pObjectX->EarthView::World::Layout::Controls::CToolZoomInInPage::activate();
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolZoomInInPage_deactivate_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Layout::Controls::CToolZoomInInPage *pObjectX = (EarthView::World::Layout::Controls::CToolZoomInInPage*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCToolZoomInInPageProxy))
					{
						pObjectX->EarthView::World::Layout::Controls::CToolZoomInInPage::deactivate();
					}
					else
					{
						pObjectX->deactivate();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolZoomInInPage_register_1deactivate_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolZoomInInPageProxy *pObjectX = (JCToolZoomInInPageProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolZoomInInPage_deactivate_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Layout::Controls::CToolZoomInInPage *pObjectX = (EarthView::World::Layout::Controls::CToolZoomInInPage*) pObjXXXX;
					pObjectX->EarthView::World::Layout::Controls::CToolZoomInInPage::deactivate();
				}
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_layout_controls_ToolZoomInInPage_getCursor_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Layout::Controls::CToolZoomInInPage *pObjectX = (EarthView::World::Layout::Controls::CToolZoomInInPage*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCToolZoomInInPageProxy))
					{
						ev_int32 __values1 = pObjectX->EarthView::World::Layout::Controls::CToolZoomInInPage::getCursor();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolZoomInInPage_register_1getCursor_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolZoomInInPageProxy *pObjectX = (JCToolZoomInInPageProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_layout_controls_ToolZoomInInPage_getCursor_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Layout::Controls::CToolZoomInInPage *pObjectX = (EarthView::World::Layout::Controls::CToolZoomInInPage*) pObjXXXX;
					ev_int32 __values1 = pObjectX->EarthView::World::Layout::Controls::CToolZoomInInPage::getCursor();
					jint __values1_j = (jint)__values1;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_layout_controls_ToolZoomInInPage_onContextMenu_1ev_1int32_1ev_1int32(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint x_j, jint y_j)
				{
					...
					if (typeid(*pObjectX) == typeid(JCToolZoomInInPageProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Layout::Controls::CToolZoomInInPage::onContextMenu(x, y);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolZoomInInPage_register_1onContextMenu_1ev_1int32_1ev_1int32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolZoomInInPageProxy *pObjectX = (JCToolZoomInInPageProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_layout_controls_ToolZoomInInPage_onContextMenu_1ev_1int32_1ev_1int32_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint x_j, jint y_j)
				{
					ev_int32 x = (ev_int32) x_j;
					ev_int32 y = (ev_int32) y_j;
					EarthView::World::Layout::Controls::CToolZoomInInPage *pObjectX = (EarthView::World::Layout::Controls::CToolZoomInInPage*) pObjXXXX;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_layout_controls_ToolZoomInInPage_onMouseDown_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint button_j, jint shift_j, jint x_j, jint y_j)
				{
					...
					if (typeid(*pObjectX) == typeid(JCToolZoomInInPageProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Layout::Controls::CToolZoomInInPage::onMouseDown(button, shift, x, y);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolZoomInInPage_register_1onMouseDown_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolZoomInInPageProxy *pObjectX = (JCToolZoomInInPageProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_layout_controls_ToolZoomInInPage_onMouseDown_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint button_j, jint shift_j, jint x_j, jint y_j)
				{
					ev_int32 button = (ev_int32) button_j;
					ev_int32 shift = (ev_int32) shift_j;
					ev_int32 x = (ev_int32) x_j;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_layout_controls_ToolZoomInInPage_onMouseMove_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint button_j, jint shift_j, jint x_j, jint y_j)
				{
					ev_int32 button = (ev_int32) button_j;
					ev_int32 shift = (ev_int32) shift_j;
					ev_int32 x = (ev_int32) x_j;
					...
					if (typeid(*pObjectX) == typeid(JCToolZoomInInPageProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Layout::Controls::CToolZoomInInPage::onMouseMove(button, shift, x, y);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolZoomInInPage_register_1onMouseMove_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolZoomInInPageProxy *pObjectX = (JCToolZoomInInPageProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_layout_controls_ToolZoomInInPage_onMouseMove_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint button_j, jint shift_j, jint x_j, jint y_j)
				{
					ev_int32 button = (ev_int32) button_j;
					ev_int32 shift = (ev_int32) shift_j;
					ev_int32 x = (ev_int32) x_j;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_layout_controls_ToolZoomInInPage_onMouseUp_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint button_j, jint shift_j, jint x_j, jint y_j)
				{
					ev_int32 button = (ev_int32) button_j;
					ev_int32 shift = (ev_int32) shift_j;
					ev_int32 x = (ev_int32) x_j;
					...
					if (typeid(*pObjectX) == typeid(JCToolZoomInInPageProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Layout::Controls::CToolZoomInInPage::onMouseUp(button, shift, x, y);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolZoomInInPage_register_1onMouseUp_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolZoomInInPageProxy *pObjectX = (JCToolZoomInInPageProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_layout_controls_ToolZoomInInPage_onMouseUp_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint button_j, jint shift_j, jint x_j, jint y_j)
				{
					ev_int32 button = (ev_int32) button_j;
					ev_int32 shift = (ev_int32) shift_j;
					ev_int32 x = (ev_int32) x_j;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_layout_controls_ToolZoomInInPage_update_1CEvent(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong e_j)
				{
					EarthView::World::Core::CEvent *e = (EarthView::World::Core::CEvent*) e_j;
					EarthView::World::Layout::Controls::CToolZoomInInPage *pObjectX = (EarthView::World::Layout::Controls::CToolZoomInInPage*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCToolZoomInInPageProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Layout::Controls::CToolZoomInInPage::update(e);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolZoomInInPage_register_1update_1CEvent(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolZoomInInPageProxy *pObjectX = (JCToolZoomInInPageProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_layout_controls_ToolZoomInInPage_update_1CEvent_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong e_j)
				{
					EarthView::World::Core::CEvent *e = (EarthView::World::Core::CEvent*) e_j;
					EarthView::World::Layout::Controls::CToolZoomInInPage *pObjectX = (EarthView::World::Layout::Controls::CToolZoomInInPage*) pObjXXXX;
					ev_bool __values1 = pObjectX->EarthView::World::Layout::Controls::CToolZoomInInPage::update(e);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolZoomInInPage_register_1onDoubleClick_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolZoomInInPageProxy *pObjectX = (JCToolZoomInInPageProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolZoomInInPage_register_1onDoubleClick_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolZoomInInPageProxy *pObjectX = (JCToolZoomInInPageProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolZoomInInPage_register_1onKeyDown_1ev_1int32_1ev_1int32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolZoomInInPageProxy *pObjectX = (JCToolZoomInInPageProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolZoomInInPage_register_1onKeyUp_1ev_1int32_1ev_1int32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolZoomInInPageProxy *pObjectX = (JCToolZoomInInPageProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolZoomInInPage_register_1onMouseWheel_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolZoomInInPageProxy *pObjectX = (JCToolZoomInInPageProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolZoomInInPage_register_1onTouchDown_1MotionEvent(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolZoomInInPageProxy *pObjectX = (JCToolZoomInInPageProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolZoomInInPage_register_1onTouchUp_1MotionEvent(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolZoomInInPageProxy *pObjectX = (JCToolZoomInInPageProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolZoomInInPage_register_1onTouchMove_1MotionEvent(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolZoomInInPageProxy *pObjectX = (JCToolZoomInInPageProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolZoomInInPage_register_1getChecked_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolZoomInInPageProxy *pObjectX = (JCToolZoomInInPageProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolZoomInInPage_register_1setChecked_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolZoomInInPageProxy *pObjectX = (JCToolZoomInInPageProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolZoomInInPage_register_1getEnabled_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolZoomInInPageProxy *pObjectX = (JCToolZoomInInPageProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolZoomInInPage_register_1setEnabled_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolZoomInInPageProxy *pObjectX = (JCToolZoomInInPageProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolZoomInInPage_register_1create_1ISpatialControl(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolZoomInInPageProxy *pObjectX = (JCToolZoomInInPageProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
