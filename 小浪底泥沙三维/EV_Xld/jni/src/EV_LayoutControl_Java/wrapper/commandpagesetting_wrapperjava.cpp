...
namespace EarthView
{
	namespace World
	{
		namespace Layout
		{
			namespace Controls
			{
				class JCCommandPageSettingProxy : public EarthView::World::Layout::Controls::CCommandPageSetting
				{
				 private:
				...
				public:
					JCCommandPageSettingProxy(EarthView::World::Core::CNameValuePairList *pList) : CCommandPageSetting(pList)
					{
					}
				...
				protected:
					C_DISABLE_COPY(JCCommandPageSettingProxy)
				public:
				...
				REGISTER_FACTORY_CLASS(JCCommandPageSettingProxy);
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_layout_controls_CommandPageSetting_getToolBarType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CCommandPageSetting *pObjectX = (EarthView::World::Layout::Controls::CCommandPageSetting*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCCommandPageSettingProxy))
					{
						ev_uint32 __values1 = pObjectX->EarthView::World::Layout::Controls::CCommandPageSetting::getToolBarType();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_CommandPageSetting_register_1getToolBarType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandPageSettingProxy *pObjectX = (JCCommandPageSettingProxy*) pObjXXXX;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_layout_controls_CommandPageSetting_getToolBarType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CCommandPageSetting *pObjectX = (EarthView::World::Layout::Controls::CCommandPageSetting*) pObjXXXX;
					ev_uint32 __values1 = pObjectX->EarthView::World::Layout::Controls::CCommandPageSetting::getToolBarType();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_layout_controls_CommandPageSetting_getType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CCommandPageSetting *pObjectX = (EarthView::World::Layout::Controls::CCommandPageSetting*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCCommandPageSettingProxy))
					{
						ev_uint32 __values1 = pObjectX->EarthView::World::Layout::Controls::CCommandPageSetting::getType();
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_CommandPageSetting_register_1getType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandPageSettingProxy *pObjectX = (JCCommandPageSettingProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_layout_controls_CommandPageSetting_getType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CCommandPageSetting *pObjectX = (EarthView::World::Layout::Controls::CCommandPageSetting*) pObjXXXX;
					ev_uint32 __values1 = pObjectX->EarthView::World::Layout::Controls::CCommandPageSetting::getType();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_layout_controls_CommandPageSetting_getName_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CCommandPageSetting *pObjectX = (EarthView::World::Layout::Controls::CCommandPageSetting*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCCommandPageSettingProxy))
					{
						EVString __values1 = pObjectX->EarthView::World::Layout::Controls::CCommandPageSetting::getName();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_CommandPageSetting_register_1getName_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandPageSettingProxy *pObjectX = (JCCommandPageSettingProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_layout_controls_CommandPageSetting_getName_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CCommandPageSetting *pObjectX = (EarthView::World::Layout::Controls::CCommandPageSetting*) pObjXXXX;
					EVString __values1 = pObjectX->EarthView::World::Layout::Controls::CCommandPageSetting::getName();
					EarthView::World::Core::ev_wstring valuesw1 = __values1;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_layout_controls_CommandPageSetting_getCategory_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CCommandPageSetting *pObjectX = (EarthView::World::Layout::Controls::CCommandPageSetting*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCCommandPageSettingProxy))
					{
						EVString __values1 = pObjectX->EarthView::World::Layout::Controls::CCommandPageSetting::getCategory();
						EarthView::World::Core::ev_wstring valuesw1 = __values1;
						jstring __values1_j = __env->NewString((const jchar*)valuesw1.getString(), valuesw1.size());
						return __values1_j;
					}
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_CommandPageSetting_register_1getCategory_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandPageSettingProxy *pObjectX = (JCCommandPageSettingProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_layout_controls_CommandPageSetting_getCategory_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CCommandPageSetting *pObjectX = (EarthView::World::Layout::Controls::CCommandPageSetting*) pObjXXXX;
					EVString __values1 = pObjectX->EarthView::World::Layout::Controls::CCommandPageSetting::getCategory();
					EarthView::World::Core::ev_wstring valuesw1 = __values1;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_layout_controls_CommandPageSetting_getToolTip_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CCommandPageSetting *pObjectX = (EarthView::World::Layout::Controls::CCommandPageSetting*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCCommandPageSettingProxy))
					{
						EVString __values1 = pObjectX->EarthView::World::Layout::Controls::CCommandPageSetting::getToolTip();
						EarthView::World::Core::ev_wstring valuesw1 = __values1;
						jstring __values1_j = __env->NewString((const jchar*)valuesw1.getString(), valuesw1.size());
						return __values1_j;
					}
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_CommandPageSetting_register_1getToolTip_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandPageSettingProxy *pObjectX = (JCCommandPageSettingProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_layout_controls_CommandPageSetting_getToolTip_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CCommandPageSetting *pObjectX = (EarthView::World::Layout::Controls::CCommandPageSetting*) pObjXXXX;
					EVString __values1 = pObjectX->EarthView::World::Layout::Controls::CCommandPageSetting::getToolTip();
					EarthView::World::Core::ev_wstring valuesw1 = __values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_layout_controls_CommandPageSetting_getIcon_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CCommandPageSetting *pObjectX = (EarthView::World::Layout::Controls::CCommandPageSetting*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCCommandPageSettingProxy))
					{
						EarthView::World::Display::IBitmap* __values1 = pObjectX->EarthView::World::Layout::Controls::CCommandPageSetting::getIcon();
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_CommandPageSetting_register_1getIcon_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandPageSettingProxy *pObjectX = (JCCommandPageSettingProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_layout_controls_CommandPageSetting_getIcon_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CCommandPageSetting *pObjectX = (EarthView::World::Layout::Controls::CCommandPageSetting*) pObjXXXX;
					EarthView::World::Display::IBitmap* __values1 = pObjectX->EarthView::World::Layout::Controls::CCommandPageSetting::getIcon();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_layout_controls_CommandPageSetting_isCheckable_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CCommandPageSetting *pObjectX = (EarthView::World::Layout::Controls::CCommandPageSetting*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCCommandPageSettingProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Layout::Controls::CCommandPageSetting::isCheckable();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_CommandPageSetting_register_1isCheckable_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandPageSettingProxy *pObjectX = (JCCommandPageSettingProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_layout_controls_CommandPageSetting_isCheckable_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CCommandPageSetting *pObjectX = (EarthView::World::Layout::Controls::CCommandPageSetting*) pObjXXXX;
					ev_bool __values1 = pObjectX->EarthView::World::Layout::Controls::CCommandPageSetting::isCheckable();
					jboolean __values1_j = (jboolean)__values1;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_CommandPageSetting_onClicked_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Layout::Controls::CCommandPageSetting *pObjectX = (EarthView::World::Layout::Controls::CCommandPageSetting*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCCommandPageSettingProxy))
					{
						pObjectX->EarthView::World::Layout::Controls::CCommandPageSetting::onClicked();
					}
					else
					{
						pObjectX->onClicked();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_CommandPageSetting_register_1onClicked_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandPageSettingProxy *pObjectX = (JCCommandPageSettingProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_CommandPageSetting_onClicked_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Layout::Controls::CCommandPageSetting *pObjectX = (EarthView::World::Layout::Controls::CCommandPageSetting*) pObjXXXX;
					pObjectX->EarthView::World::Layout::Controls::CCommandPageSetting::onClicked();
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_CommandPageSetting_register_1getChecked_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandPageSettingProxy *pObjectX = (JCCommandPageSettingProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_CommandPageSetting_register_1setChecked_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandPageSettingProxy *pObjectX = (JCCommandPageSettingProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_CommandPageSetting_register_1getEnabled_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandPageSettingProxy *pObjectX = (JCCommandPageSettingProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_CommandPageSetting_register_1setEnabled_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandPageSettingProxy *pObjectX = (JCCommandPageSettingProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_CommandPageSetting_register_1create_1ISpatialControl(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandPageSettingProxy *pObjectX = (JCCommandPageSettingProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_CommandPageSetting_register_1update_1CEvent(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandPageSettingProxy *pObjectX = (JCCommandPageSettingProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
