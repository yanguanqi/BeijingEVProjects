...
namespace EarthView
{
	namespace World
	{
		namespace Layout
		{
			namespace Controls
			{
				class JCToolPageZoomOutProxy : public EarthView::World::Layout::Controls::CToolPageZoomOut
				{
				 private:
				...
				public:
					JCToolPageZoomOutProxy(EarthView::World::Core::CNameValuePairList *pList) : CToolPageZoomOut(pList)
					{
					}
				...
				protected:
					C_DISABLE_COPY(JCToolPageZoomOutProxy)
				public:
				...
				REGISTER_FACTORY_CLASS(JCToolPageZoomOutProxy);
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomOut_getToolBarType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CToolPageZoomOut *pObjectX = (EarthView::World::Layout::Controls::CToolPageZoomOut*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCToolPageZoomOutProxy))
					{
						ev_uint32 __values1 = pObjectX->EarthView::World::Layout::Controls::CToolPageZoomOut::getToolBarType();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomOut_register_1getToolBarType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolPageZoomOutProxy *pObjectX = (JCToolPageZoomOutProxy*) pObjXXXX;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomOut_getToolBarType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CToolPageZoomOut *pObjectX = (EarthView::World::Layout::Controls::CToolPageZoomOut*) pObjXXXX;
					ev_uint32 __values1 = pObjectX->EarthView::World::Layout::Controls::CToolPageZoomOut::getToolBarType();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomOut_getType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CToolPageZoomOut *pObjectX = (EarthView::World::Layout::Controls::CToolPageZoomOut*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCToolPageZoomOutProxy))
					{
						ev_uint32 __values1 = pObjectX->EarthView::World::Layout::Controls::CToolPageZoomOut::getType();
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomOut_register_1getType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolPageZoomOutProxy *pObjectX = (JCToolPageZoomOutProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomOut_getType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CToolPageZoomOut *pObjectX = (EarthView::World::Layout::Controls::CToolPageZoomOut*) pObjXXXX;
					ev_uint32 __values1 = pObjectX->EarthView::World::Layout::Controls::CToolPageZoomOut::getType();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomOut_getName_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CToolPageZoomOut *pObjectX = (EarthView::World::Layout::Controls::CToolPageZoomOut*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCToolPageZoomOutProxy))
					{
						EVString __values1 = pObjectX->EarthView::World::Layout::Controls::CToolPageZoomOut::getName();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomOut_register_1getName_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolPageZoomOutProxy *pObjectX = (JCToolPageZoomOutProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomOut_getName_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CToolPageZoomOut *pObjectX = (EarthView::World::Layout::Controls::CToolPageZoomOut*) pObjXXXX;
					EVString __values1 = pObjectX->EarthView::World::Layout::Controls::CToolPageZoomOut::getName();
					EarthView::World::Core::ev_wstring valuesw1 = __values1;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomOut_getCategory_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CToolPageZoomOut *pObjectX = (EarthView::World::Layout::Controls::CToolPageZoomOut*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCToolPageZoomOutProxy))
					{
						EVString __values1 = pObjectX->EarthView::World::Layout::Controls::CToolPageZoomOut::getCategory();
						EarthView::World::Core::ev_wstring valuesw1 = __values1;
						jstring __values1_j = __env->NewString((const jchar*)valuesw1.getString(), valuesw1.size());
						return __values1_j;
					}
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomOut_register_1getCategory_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolPageZoomOutProxy *pObjectX = (JCToolPageZoomOutProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomOut_getCategory_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CToolPageZoomOut *pObjectX = (EarthView::World::Layout::Controls::CToolPageZoomOut*) pObjXXXX;
					EVString __values1 = pObjectX->EarthView::World::Layout::Controls::CToolPageZoomOut::getCategory();
					EarthView::World::Core::ev_wstring valuesw1 = __values1;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomOut_getToolTip_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CToolPageZoomOut *pObjectX = (EarthView::World::Layout::Controls::CToolPageZoomOut*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCToolPageZoomOutProxy))
					{
						EVString __values1 = pObjectX->EarthView::World::Layout::Controls::CToolPageZoomOut::getToolTip();
						EarthView::World::Core::ev_wstring valuesw1 = __values1;
						jstring __values1_j = __env->NewString((const jchar*)valuesw1.getString(), valuesw1.size());
						return __values1_j;
					}
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomOut_register_1getToolTip_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolPageZoomOutProxy *pObjectX = (JCToolPageZoomOutProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomOut_getToolTip_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CToolPageZoomOut *pObjectX = (EarthView::World::Layout::Controls::CToolPageZoomOut*) pObjXXXX;
					EVString __values1 = pObjectX->EarthView::World::Layout::Controls::CToolPageZoomOut::getToolTip();
					EarthView::World::Core::ev_wstring valuesw1 = __values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomOut_getIcon_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CToolPageZoomOut *pObjectX = (EarthView::World::Layout::Controls::CToolPageZoomOut*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCToolPageZoomOutProxy))
					{
						EarthView::World::Display::IBitmap* __values1 = pObjectX->EarthView::World::Layout::Controls::CToolPageZoomOut::getIcon();
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomOut_register_1getIcon_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolPageZoomOutProxy *pObjectX = (JCToolPageZoomOutProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomOut_getIcon_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CToolPageZoomOut *pObjectX = (EarthView::World::Layout::Controls::CToolPageZoomOut*) pObjXXXX;
					EarthView::World::Display::IBitmap* __values1 = pObjectX->EarthView::World::Layout::Controls::CToolPageZoomOut::getIcon();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomOut_isCheckable_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CToolPageZoomOut *pObjectX = (EarthView::World::Layout::Controls::CToolPageZoomOut*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCToolPageZoomOutProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Layout::Controls::CToolPageZoomOut::isCheckable();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomOut_register_1isCheckable_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolPageZoomOutProxy *pObjectX = (JCToolPageZoomOutProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomOut_isCheckable_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CToolPageZoomOut *pObjectX = (EarthView::World::Layout::Controls::CToolPageZoomOut*) pObjXXXX;
					ev_bool __values1 = pObjectX->EarthView::World::Layout::Controls::CToolPageZoomOut::isCheckable();
					jboolean __values1_j = (jboolean)__values1;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomOut_activate_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Layout::Controls::CToolPageZoomOut *pObjectX = (EarthView::World::Layout::Controls::CToolPageZoomOut*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCToolPageZoomOutProxy))
					{
						pObjectX->EarthView::World::Layout::Controls::CToolPageZoomOut::activate();
					}
					else
					{
						pObjectX->activate();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomOut_register_1activate_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolPageZoomOutProxy *pObjectX = (JCToolPageZoomOutProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomOut_activate_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Layout::Controls::CToolPageZoomOut *pObjectX = (EarthView::World::Layout::Controls::CToolPageZoomOut*) pObjXXXX;
					pObjectX->EarthView::World::Layout::Controls::CToolPageZoomOut::activate();
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomOut_deactivate_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Layout::Controls::CToolPageZoomOut *pObjectX = (EarthView::World::Layout::Controls::CToolPageZoomOut*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCToolPageZoomOutProxy))
					{
						pObjectX->EarthView::World::Layout::Controls::CToolPageZoomOut::deactivate();
					}
					else
					{
						pObjectX->deactivate();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomOut_register_1deactivate_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolPageZoomOutProxy *pObjectX = (JCToolPageZoomOutProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomOut_deactivate_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Layout::Controls::CToolPageZoomOut *pObjectX = (EarthView::World::Layout::Controls::CToolPageZoomOut*) pObjXXXX;
					pObjectX->EarthView::World::Layout::Controls::CToolPageZoomOut::deactivate();
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomOut_onClicked_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Layout::Controls::CToolPageZoomOut *pObjectX = (EarthView::World::Layout::Controls::CToolPageZoomOut*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCToolPageZoomOutProxy))
					{
						pObjectX->EarthView::World::Layout::Controls::CToolPageZoomOut::onClicked();
					}
					else
					{
						pObjectX->onClicked();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomOut_register_1onClicked_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolPageZoomOutProxy *pObjectX = (JCToolPageZoomOutProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomOut_onClicked_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Layout::Controls::CToolPageZoomOut *pObjectX = (EarthView::World::Layout::Controls::CToolPageZoomOut*) pObjXXXX;
					pObjectX->EarthView::World::Layout::Controls::CToolPageZoomOut::onClicked();
				}
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomOut_getCursor_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Layout::Controls::CToolPageZoomOut *pObjectX = (EarthView::World::Layout::Controls::CToolPageZoomOut*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCToolPageZoomOutProxy))
					{
						ev_int32 __values1 = pObjectX->EarthView::World::Layout::Controls::CToolPageZoomOut::getCursor();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomOut_register_1getCursor_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolPageZoomOutProxy *pObjectX = (JCToolPageZoomOutProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomOut_getCursor_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Layout::Controls::CToolPageZoomOut *pObjectX = (EarthView::World::Layout::Controls::CToolPageZoomOut*) pObjXXXX;
					ev_int32 __values1 = pObjectX->EarthView::World::Layout::Controls::CToolPageZoomOut::getCursor();
					jint __values1_j = (jint)__values1;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomOut_onContextMenu_1ev_1int32_1ev_1int32(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint x_j, jint y_j)
				{
					...
					if (typeid(*pObjectX) == typeid(JCToolPageZoomOutProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Layout::Controls::CToolPageZoomOut::onContextMenu(x, y);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomOut_register_1onContextMenu_1ev_1int32_1ev_1int32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolPageZoomOutProxy *pObjectX = (JCToolPageZoomOutProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomOut_onContextMenu_1ev_1int32_1ev_1int32_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint x_j, jint y_j)
				{
					ev_int32 x = (ev_int32) x_j;
					ev_int32 y = (ev_int32) y_j;
					EarthView::World::Layout::Controls::CToolPageZoomOut *pObjectX = (EarthView::World::Layout::Controls::CToolPageZoomOut*) pObjXXXX;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomOut_onMouseDown_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint button_j, jint shift_j, jint x_j, jint y_j)
				{
					...
					if (typeid(*pObjectX) == typeid(JCToolPageZoomOutProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Layout::Controls::CToolPageZoomOut::onMouseDown(button, shift, x, y);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomOut_register_1onMouseDown_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolPageZoomOutProxy *pObjectX = (JCToolPageZoomOutProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomOut_onMouseDown_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint button_j, jint shift_j, jint x_j, jint y_j)
				{
					ev_int32 button = (ev_int32) button_j;
					ev_int32 shift = (ev_int32) shift_j;
					ev_int32 x = (ev_int32) x_j;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomOut_onMouseMove_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint button_j, jint shift_j, jint x_j, jint y_j)
				{
					ev_int32 button = (ev_int32) button_j;
					ev_int32 shift = (ev_int32) shift_j;
					ev_int32 x = (ev_int32) x_j;
					...
					if (typeid(*pObjectX) == typeid(JCToolPageZoomOutProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Layout::Controls::CToolPageZoomOut::onMouseMove(button, shift, x, y);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomOut_register_1onMouseMove_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolPageZoomOutProxy *pObjectX = (JCToolPageZoomOutProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomOut_onMouseMove_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint button_j, jint shift_j, jint x_j, jint y_j)
				{
					ev_int32 button = (ev_int32) button_j;
					ev_int32 shift = (ev_int32) shift_j;
					ev_int32 x = (ev_int32) x_j;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomOut_onMouseUp_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint button_j, jint shift_j, jint x_j, jint y_j)
				{
					ev_int32 button = (ev_int32) button_j;
					ev_int32 shift = (ev_int32) shift_j;
					ev_int32 x = (ev_int32) x_j;
					...
					if (typeid(*pObjectX) == typeid(JCToolPageZoomOutProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Layout::Controls::CToolPageZoomOut::onMouseUp(button, shift, x, y);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomOut_register_1onMouseUp_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolPageZoomOutProxy *pObjectX = (JCToolPageZoomOutProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomOut_onMouseUp_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint button_j, jint shift_j, jint x_j, jint y_j)
				{
					ev_int32 button = (ev_int32) button_j;
					ev_int32 shift = (ev_int32) shift_j;
					ev_int32 x = (ev_int32) x_j;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomOut_update_1CEvent(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong e_j)
				{
					EarthView::World::Core::CEvent *e = (EarthView::World::Core::CEvent*) e_j;
					EarthView::World::Layout::Controls::CToolPageZoomOut *pObjectX = (EarthView::World::Layout::Controls::CToolPageZoomOut*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCToolPageZoomOutProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Layout::Controls::CToolPageZoomOut::update(e);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomOut_register_1update_1CEvent(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolPageZoomOutProxy *pObjectX = (JCToolPageZoomOutProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomOut_update_1CEvent_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong e_j)
				{
					EarthView::World::Core::CEvent *e = (EarthView::World::Core::CEvent*) e_j;
					EarthView::World::Layout::Controls::CToolPageZoomOut *pObjectX = (EarthView::World::Layout::Controls::CToolPageZoomOut*) pObjXXXX;
					ev_bool __values1 = pObjectX->EarthView::World::Layout::Controls::CToolPageZoomOut::update(e);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomOut_register_1onDoubleClick_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolPageZoomOutProxy *pObjectX = (JCToolPageZoomOutProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomOut_register_1onDoubleClick_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolPageZoomOutProxy *pObjectX = (JCToolPageZoomOutProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomOut_register_1onKeyDown_1ev_1int32_1ev_1int32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolPageZoomOutProxy *pObjectX = (JCToolPageZoomOutProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomOut_register_1onKeyUp_1ev_1int32_1ev_1int32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolPageZoomOutProxy *pObjectX = (JCToolPageZoomOutProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomOut_register_1onMouseWheel_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolPageZoomOutProxy *pObjectX = (JCToolPageZoomOutProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomOut_register_1onTouchDown_1MotionEvent(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolPageZoomOutProxy *pObjectX = (JCToolPageZoomOutProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomOut_register_1onTouchUp_1MotionEvent(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolPageZoomOutProxy *pObjectX = (JCToolPageZoomOutProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomOut_register_1onTouchMove_1MotionEvent(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolPageZoomOutProxy *pObjectX = (JCToolPageZoomOutProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomOut_register_1getChecked_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolPageZoomOutProxy *pObjectX = (JCToolPageZoomOutProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomOut_register_1setChecked_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolPageZoomOutProxy *pObjectX = (JCToolPageZoomOutProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomOut_register_1getEnabled_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolPageZoomOutProxy *pObjectX = (JCToolPageZoomOutProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomOut_register_1setEnabled_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolPageZoomOutProxy *pObjectX = (JCToolPageZoomOutProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomOut_register_1create_1ISpatialControl(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolPageZoomOutProxy *pObjectX = (JCToolPageZoomOutProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
