...
namespace EarthView
{
	namespace World
	{
		namespace Layout
		{
			namespace Controls
			{
				class JCCommandPageNormalProxy : public EarthView::World::Layout::Controls::CCommandPageNormal
				{
				 private:
				...
				public:
					JCCommandPageNormalProxy(EarthView::World::Core::CNameValuePairList *pList) : CCommandPageNormal(pList)
					{
					}
				...
				protected:
					C_DISABLE_COPY(JCCommandPageNormalProxy)
				public:
				...
				REGISTER_FACTORY_CLASS(JCCommandPageNormalProxy);
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_layout_controls_CommandPageNormal_getToolBarType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CCommandPageNormal *pObjectX = (EarthView::World::Layout::Controls::CCommandPageNormal*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCCommandPageNormalProxy))
					{
						ev_uint32 __values1 = pObjectX->EarthView::World::Layout::Controls::CCommandPageNormal::getToolBarType();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_CommandPageNormal_register_1getToolBarType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandPageNormalProxy *pObjectX = (JCCommandPageNormalProxy*) pObjXXXX;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_layout_controls_CommandPageNormal_getToolBarType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CCommandPageNormal *pObjectX = (EarthView::World::Layout::Controls::CCommandPageNormal*) pObjXXXX;
					ev_uint32 __values1 = pObjectX->EarthView::World::Layout::Controls::CCommandPageNormal::getToolBarType();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_layout_controls_CommandPageNormal_getType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CCommandPageNormal *pObjectX = (EarthView::World::Layout::Controls::CCommandPageNormal*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCCommandPageNormalProxy))
					{
						ev_uint32 __values1 = pObjectX->EarthView::World::Layout::Controls::CCommandPageNormal::getType();
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_CommandPageNormal_register_1getType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandPageNormalProxy *pObjectX = (JCCommandPageNormalProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_layout_controls_CommandPageNormal_getType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CCommandPageNormal *pObjectX = (EarthView::World::Layout::Controls::CCommandPageNormal*) pObjXXXX;
					ev_uint32 __values1 = pObjectX->EarthView::World::Layout::Controls::CCommandPageNormal::getType();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_layout_controls_CommandPageNormal_getName_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CCommandPageNormal *pObjectX = (EarthView::World::Layout::Controls::CCommandPageNormal*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCCommandPageNormalProxy))
					{
						EVString __values1 = pObjectX->EarthView::World::Layout::Controls::CCommandPageNormal::getName();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_CommandPageNormal_register_1getName_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandPageNormalProxy *pObjectX = (JCCommandPageNormalProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_layout_controls_CommandPageNormal_getName_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CCommandPageNormal *pObjectX = (EarthView::World::Layout::Controls::CCommandPageNormal*) pObjXXXX;
					EVString __values1 = pObjectX->EarthView::World::Layout::Controls::CCommandPageNormal::getName();
					EarthView::World::Core::ev_wstring valuesw1 = __values1;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_layout_controls_CommandPageNormal_getCategory_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CCommandPageNormal *pObjectX = (EarthView::World::Layout::Controls::CCommandPageNormal*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCCommandPageNormalProxy))
					{
						EVString __values1 = pObjectX->EarthView::World::Layout::Controls::CCommandPageNormal::getCategory();
						EarthView::World::Core::ev_wstring valuesw1 = __values1;
						jstring __values1_j = __env->NewString((const jchar*)valuesw1.getString(), valuesw1.size());
						return __values1_j;
					}
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_CommandPageNormal_register_1getCategory_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandPageNormalProxy *pObjectX = (JCCommandPageNormalProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_layout_controls_CommandPageNormal_getCategory_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CCommandPageNormal *pObjectX = (EarthView::World::Layout::Controls::CCommandPageNormal*) pObjXXXX;
					EVString __values1 = pObjectX->EarthView::World::Layout::Controls::CCommandPageNormal::getCategory();
					EarthView::World::Core::ev_wstring valuesw1 = __values1;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_layout_controls_CommandPageNormal_getToolTip_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CCommandPageNormal *pObjectX = (EarthView::World::Layout::Controls::CCommandPageNormal*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCCommandPageNormalProxy))
					{
						EVString __values1 = pObjectX->EarthView::World::Layout::Controls::CCommandPageNormal::getToolTip();
						EarthView::World::Core::ev_wstring valuesw1 = __values1;
						jstring __values1_j = __env->NewString((const jchar*)valuesw1.getString(), valuesw1.size());
						return __values1_j;
					}
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_CommandPageNormal_register_1getToolTip_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandPageNormalProxy *pObjectX = (JCCommandPageNormalProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_layout_controls_CommandPageNormal_getToolTip_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CCommandPageNormal *pObjectX = (EarthView::World::Layout::Controls::CCommandPageNormal*) pObjXXXX;
					EVString __values1 = pObjectX->EarthView::World::Layout::Controls::CCommandPageNormal::getToolTip();
					EarthView::World::Core::ev_wstring valuesw1 = __values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_layout_controls_CommandPageNormal_getIcon_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CCommandPageNormal *pObjectX = (EarthView::World::Layout::Controls::CCommandPageNormal*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCCommandPageNormalProxy))
					{
						EarthView::World::Display::IBitmap* __values1 = pObjectX->EarthView::World::Layout::Controls::CCommandPageNormal::getIcon();
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_CommandPageNormal_register_1getIcon_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandPageNormalProxy *pObjectX = (JCCommandPageNormalProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_layout_controls_CommandPageNormal_getIcon_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CCommandPageNormal *pObjectX = (EarthView::World::Layout::Controls::CCommandPageNormal*) pObjXXXX;
					EarthView::World::Display::IBitmap* __values1 = pObjectX->EarthView::World::Layout::Controls::CCommandPageNormal::getIcon();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_layout_controls_CommandPageNormal_isCheckable_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CCommandPageNormal *pObjectX = (EarthView::World::Layout::Controls::CCommandPageNormal*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCCommandPageNormalProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Layout::Controls::CCommandPageNormal::isCheckable();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_CommandPageNormal_register_1isCheckable_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandPageNormalProxy *pObjectX = (JCCommandPageNormalProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_layout_controls_CommandPageNormal_isCheckable_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CCommandPageNormal *pObjectX = (EarthView::World::Layout::Controls::CCommandPageNormal*) pObjXXXX;
					ev_bool __values1 = pObjectX->EarthView::World::Layout::Controls::CCommandPageNormal::isCheckable();
					jboolean __values1_j = (jboolean)__values1;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_CommandPageNormal_onClicked_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Layout::Controls::CCommandPageNormal *pObjectX = (EarthView::World::Layout::Controls::CCommandPageNormal*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCCommandPageNormalProxy))
					{
						pObjectX->EarthView::World::Layout::Controls::CCommandPageNormal::onClicked();
					}
					else
					{
						pObjectX->onClicked();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_CommandPageNormal_register_1onClicked_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandPageNormalProxy *pObjectX = (JCCommandPageNormalProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_CommandPageNormal_onClicked_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Layout::Controls::CCommandPageNormal *pObjectX = (EarthView::World::Layout::Controls::CCommandPageNormal*) pObjXXXX;
					pObjectX->EarthView::World::Layout::Controls::CCommandPageNormal::onClicked();
				}
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_layout_controls_CommandPageNormal_update_1CEvent(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong e_j)
				{
					EarthView::World::Core::CEvent *e = (EarthView::World::Core::CEvent*) e_j;
					EarthView::World::Layout::Controls::CCommandPageNormal *pObjectX = (EarthView::World::Layout::Controls::CCommandPageNormal*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCCommandPageNormalProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Layout::Controls::CCommandPageNormal::update(e);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_CommandPageNormal_register_1update_1CEvent(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandPageNormalProxy *pObjectX = (JCCommandPageNormalProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_layout_controls_CommandPageNormal_update_1CEvent_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong e_j)
				{
					EarthView::World::Core::CEvent *e = (EarthView::World::Core::CEvent*) e_j;
					EarthView::World::Layout::Controls::CCommandPageNormal *pObjectX = (EarthView::World::Layout::Controls::CCommandPageNormal*) pObjXXXX;
					ev_bool __values1 = pObjectX->EarthView::World::Layout::Controls::CCommandPageNormal::update(e);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_CommandPageNormal_register_1getChecked_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandPageNormalProxy *pObjectX = (JCCommandPageNormalProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_CommandPageNormal_register_1setChecked_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandPageNormalProxy *pObjectX = (JCCommandPageNormalProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_CommandPageNormal_register_1getEnabled_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandPageNormalProxy *pObjectX = (JCCommandPageNormalProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_CommandPageNormal_register_1setEnabled_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandPageNormalProxy *pObjectX = (JCCommandPageNormalProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_CommandPageNormal_register_1create_1ISpatialControl(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandPageNormalProxy *pObjectX = (JCCommandPageNormalProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
