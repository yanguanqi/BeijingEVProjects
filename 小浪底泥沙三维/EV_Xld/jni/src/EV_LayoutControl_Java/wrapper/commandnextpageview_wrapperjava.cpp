...
namespace EarthView
{
	namespace World
	{
		namespace Layout
		{
			namespace Controls
			{
				class JCCommandNextPageViewProxy : public EarthView::World::Layout::Controls::CCommandNextPageView
				{
				 private:
				...
				public:
					JCCommandNextPageViewProxy(EarthView::World::Core::CNameValuePairList *pList) : CCommandNextPageView(pList)
					{
					}
				...
				protected:
					C_DISABLE_COPY(JCCommandNextPageViewProxy)
				public:
				...
				REGISTER_FACTORY_CLASS(JCCommandNextPageViewProxy);
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_layout_controls_CommandNextPageView_getToolBarType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CCommandNextPageView *pObjectX = (EarthView::World::Layout::Controls::CCommandNextPageView*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCCommandNextPageViewProxy))
					{
						ev_uint32 __values1 = pObjectX->EarthView::World::Layout::Controls::CCommandNextPageView::getToolBarType();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_CommandNextPageView_register_1getToolBarType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandNextPageViewProxy *pObjectX = (JCCommandNextPageViewProxy*) pObjXXXX;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_layout_controls_CommandNextPageView_getToolBarType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CCommandNextPageView *pObjectX = (EarthView::World::Layout::Controls::CCommandNextPageView*) pObjXXXX;
					ev_uint32 __values1 = pObjectX->EarthView::World::Layout::Controls::CCommandNextPageView::getToolBarType();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_layout_controls_CommandNextPageView_getType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CCommandNextPageView *pObjectX = (EarthView::World::Layout::Controls::CCommandNextPageView*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCCommandNextPageViewProxy))
					{
						ev_uint32 __values1 = pObjectX->EarthView::World::Layout::Controls::CCommandNextPageView::getType();
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_CommandNextPageView_register_1getType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandNextPageViewProxy *pObjectX = (JCCommandNextPageViewProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_layout_controls_CommandNextPageView_getType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CCommandNextPageView *pObjectX = (EarthView::World::Layout::Controls::CCommandNextPageView*) pObjXXXX;
					ev_uint32 __values1 = pObjectX->EarthView::World::Layout::Controls::CCommandNextPageView::getType();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_layout_controls_CommandNextPageView_getName_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CCommandNextPageView *pObjectX = (EarthView::World::Layout::Controls::CCommandNextPageView*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCCommandNextPageViewProxy))
					{
						EVString __values1 = pObjectX->EarthView::World::Layout::Controls::CCommandNextPageView::getName();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_CommandNextPageView_register_1getName_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandNextPageViewProxy *pObjectX = (JCCommandNextPageViewProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_layout_controls_CommandNextPageView_getName_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CCommandNextPageView *pObjectX = (EarthView::World::Layout::Controls::CCommandNextPageView*) pObjXXXX;
					EVString __values1 = pObjectX->EarthView::World::Layout::Controls::CCommandNextPageView::getName();
					EarthView::World::Core::ev_wstring valuesw1 = __values1;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_layout_controls_CommandNextPageView_getCategory_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CCommandNextPageView *pObjectX = (EarthView::World::Layout::Controls::CCommandNextPageView*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCCommandNextPageViewProxy))
					{
						EVString __values1 = pObjectX->EarthView::World::Layout::Controls::CCommandNextPageView::getCategory();
						EarthView::World::Core::ev_wstring valuesw1 = __values1;
						jstring __values1_j = __env->NewString((const jchar*)valuesw1.getString(), valuesw1.size());
						return __values1_j;
					}
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_CommandNextPageView_register_1getCategory_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandNextPageViewProxy *pObjectX = (JCCommandNextPageViewProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_layout_controls_CommandNextPageView_getCategory_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CCommandNextPageView *pObjectX = (EarthView::World::Layout::Controls::CCommandNextPageView*) pObjXXXX;
					EVString __values1 = pObjectX->EarthView::World::Layout::Controls::CCommandNextPageView::getCategory();
					EarthView::World::Core::ev_wstring valuesw1 = __values1;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_layout_controls_CommandNextPageView_getToolTip_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CCommandNextPageView *pObjectX = (EarthView::World::Layout::Controls::CCommandNextPageView*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCCommandNextPageViewProxy))
					{
						EVString __values1 = pObjectX->EarthView::World::Layout::Controls::CCommandNextPageView::getToolTip();
						EarthView::World::Core::ev_wstring valuesw1 = __values1;
						jstring __values1_j = __env->NewString((const jchar*)valuesw1.getString(), valuesw1.size());
						return __values1_j;
					}
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_CommandNextPageView_register_1getToolTip_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandNextPageViewProxy *pObjectX = (JCCommandNextPageViewProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_layout_controls_CommandNextPageView_getToolTip_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CCommandNextPageView *pObjectX = (EarthView::World::Layout::Controls::CCommandNextPageView*) pObjXXXX;
					EVString __values1 = pObjectX->EarthView::World::Layout::Controls::CCommandNextPageView::getToolTip();
					EarthView::World::Core::ev_wstring valuesw1 = __values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_layout_controls_CommandNextPageView_getIcon_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CCommandNextPageView *pObjectX = (EarthView::World::Layout::Controls::CCommandNextPageView*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCCommandNextPageViewProxy))
					{
						EarthView::World::Display::IBitmap* __values1 = pObjectX->EarthView::World::Layout::Controls::CCommandNextPageView::getIcon();
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_CommandNextPageView_register_1getIcon_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandNextPageViewProxy *pObjectX = (JCCommandNextPageViewProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_layout_controls_CommandNextPageView_getIcon_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CCommandNextPageView *pObjectX = (EarthView::World::Layout::Controls::CCommandNextPageView*) pObjXXXX;
					EarthView::World::Display::IBitmap* __values1 = pObjectX->EarthView::World::Layout::Controls::CCommandNextPageView::getIcon();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_layout_controls_CommandNextPageView_isCheckable_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CCommandNextPageView *pObjectX = (EarthView::World::Layout::Controls::CCommandNextPageView*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCCommandNextPageViewProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Layout::Controls::CCommandNextPageView::isCheckable();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_CommandNextPageView_register_1isCheckable_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandNextPageViewProxy *pObjectX = (JCCommandNextPageViewProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_layout_controls_CommandNextPageView_isCheckable_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CCommandNextPageView *pObjectX = (EarthView::World::Layout::Controls::CCommandNextPageView*) pObjXXXX;
					ev_bool __values1 = pObjectX->EarthView::World::Layout::Controls::CCommandNextPageView::isCheckable();
					jboolean __values1_j = (jboolean)__values1;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_CommandNextPageView_onClicked_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Layout::Controls::CCommandNextPageView *pObjectX = (EarthView::World::Layout::Controls::CCommandNextPageView*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCCommandNextPageViewProxy))
					{
						pObjectX->EarthView::World::Layout::Controls::CCommandNextPageView::onClicked();
					}
					else
					{
						pObjectX->onClicked();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_CommandNextPageView_register_1onClicked_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandNextPageViewProxy *pObjectX = (JCCommandNextPageViewProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_CommandNextPageView_onClicked_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Layout::Controls::CCommandNextPageView *pObjectX = (EarthView::World::Layout::Controls::CCommandNextPageView*) pObjXXXX;
					pObjectX->EarthView::World::Layout::Controls::CCommandNextPageView::onClicked();
				}
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_layout_controls_CommandNextPageView_update_1CEvent(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong e_j)
				{
					EarthView::World::Core::CEvent *e = (EarthView::World::Core::CEvent*) e_j;
					EarthView::World::Layout::Controls::CCommandNextPageView *pObjectX = (EarthView::World::Layout::Controls::CCommandNextPageView*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCCommandNextPageViewProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Layout::Controls::CCommandNextPageView::update(e);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_CommandNextPageView_register_1update_1CEvent(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandNextPageViewProxy *pObjectX = (JCCommandNextPageViewProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_layout_controls_CommandNextPageView_update_1CEvent_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong e_j)
				{
					EarthView::World::Core::CEvent *e = (EarthView::World::Core::CEvent*) e_j;
					EarthView::World::Layout::Controls::CCommandNextPageView *pObjectX = (EarthView::World::Layout::Controls::CCommandNextPageView*) pObjXXXX;
					ev_bool __values1 = pObjectX->EarthView::World::Layout::Controls::CCommandNextPageView::update(e);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_CommandNextPageView_register_1getChecked_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandNextPageViewProxy *pObjectX = (JCCommandNextPageViewProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_CommandNextPageView_register_1setChecked_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandNextPageViewProxy *pObjectX = (JCCommandNextPageViewProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_CommandNextPageView_register_1getEnabled_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandNextPageViewProxy *pObjectX = (JCCommandNextPageViewProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_CommandNextPageView_register_1setEnabled_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandNextPageViewProxy *pObjectX = (JCCommandNextPageViewProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_CommandNextPageView_register_1create_1ISpatialControl(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandNextPageViewProxy *pObjectX = (JCCommandNextPageViewProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
