...
namespace EarthView
{
	namespace World
	{
		namespace Layout
		{
			namespace Controls
			{
				class JCToolPageZoomInProxy : public EarthView::World::Layout::Controls::CToolPageZoomIn
				{
				 private:
				...
				public:
					JCToolPageZoomInProxy(EarthView::World::Core::CNameValuePairList *pList) : CToolPageZoomIn(pList)
					{
					}
				...
				protected:
					C_DISABLE_COPY(JCToolPageZoomInProxy)
				public:
				...
				REGISTER_FACTORY_CLASS(JCToolPageZoomInProxy);
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomIn_getToolBarType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CToolPageZoomIn *pObjectX = (EarthView::World::Layout::Controls::CToolPageZoomIn*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCToolPageZoomInProxy))
					{
						ev_uint32 __values1 = pObjectX->EarthView::World::Layout::Controls::CToolPageZoomIn::getToolBarType();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomIn_register_1getToolBarType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolPageZoomInProxy *pObjectX = (JCToolPageZoomInProxy*) pObjXXXX;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomIn_getToolBarType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CToolPageZoomIn *pObjectX = (EarthView::World::Layout::Controls::CToolPageZoomIn*) pObjXXXX;
					ev_uint32 __values1 = pObjectX->EarthView::World::Layout::Controls::CToolPageZoomIn::getToolBarType();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomIn_getType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CToolPageZoomIn *pObjectX = (EarthView::World::Layout::Controls::CToolPageZoomIn*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCToolPageZoomInProxy))
					{
						ev_uint32 __values1 = pObjectX->EarthView::World::Layout::Controls::CToolPageZoomIn::getType();
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomIn_register_1getType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolPageZoomInProxy *pObjectX = (JCToolPageZoomInProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomIn_getType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CToolPageZoomIn *pObjectX = (EarthView::World::Layout::Controls::CToolPageZoomIn*) pObjXXXX;
					ev_uint32 __values1 = pObjectX->EarthView::World::Layout::Controls::CToolPageZoomIn::getType();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomIn_getName_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CToolPageZoomIn *pObjectX = (EarthView::World::Layout::Controls::CToolPageZoomIn*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCToolPageZoomInProxy))
					{
						EVString __values1 = pObjectX->EarthView::World::Layout::Controls::CToolPageZoomIn::getName();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomIn_register_1getName_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolPageZoomInProxy *pObjectX = (JCToolPageZoomInProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomIn_getName_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CToolPageZoomIn *pObjectX = (EarthView::World::Layout::Controls::CToolPageZoomIn*) pObjXXXX;
					EVString __values1 = pObjectX->EarthView::World::Layout::Controls::CToolPageZoomIn::getName();
					EarthView::World::Core::ev_wstring valuesw1 = __values1;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomIn_getCategory_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CToolPageZoomIn *pObjectX = (EarthView::World::Layout::Controls::CToolPageZoomIn*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCToolPageZoomInProxy))
					{
						EVString __values1 = pObjectX->EarthView::World::Layout::Controls::CToolPageZoomIn::getCategory();
						EarthView::World::Core::ev_wstring valuesw1 = __values1;
						jstring __values1_j = __env->NewString((const jchar*)valuesw1.getString(), valuesw1.size());
						return __values1_j;
					}
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomIn_register_1getCategory_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolPageZoomInProxy *pObjectX = (JCToolPageZoomInProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomIn_getCategory_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CToolPageZoomIn *pObjectX = (EarthView::World::Layout::Controls::CToolPageZoomIn*) pObjXXXX;
					EVString __values1 = pObjectX->EarthView::World::Layout::Controls::CToolPageZoomIn::getCategory();
					EarthView::World::Core::ev_wstring valuesw1 = __values1;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomIn_getToolTip_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CToolPageZoomIn *pObjectX = (EarthView::World::Layout::Controls::CToolPageZoomIn*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCToolPageZoomInProxy))
					{
						EVString __values1 = pObjectX->EarthView::World::Layout::Controls::CToolPageZoomIn::getToolTip();
						EarthView::World::Core::ev_wstring valuesw1 = __values1;
						jstring __values1_j = __env->NewString((const jchar*)valuesw1.getString(), valuesw1.size());
						return __values1_j;
					}
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomIn_register_1getToolTip_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolPageZoomInProxy *pObjectX = (JCToolPageZoomInProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomIn_getToolTip_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CToolPageZoomIn *pObjectX = (EarthView::World::Layout::Controls::CToolPageZoomIn*) pObjXXXX;
					EVString __values1 = pObjectX->EarthView::World::Layout::Controls::CToolPageZoomIn::getToolTip();
					EarthView::World::Core::ev_wstring valuesw1 = __values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomIn_getIcon_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CToolPageZoomIn *pObjectX = (EarthView::World::Layout::Controls::CToolPageZoomIn*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCToolPageZoomInProxy))
					{
						EarthView::World::Display::IBitmap* __values1 = pObjectX->EarthView::World::Layout::Controls::CToolPageZoomIn::getIcon();
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomIn_register_1getIcon_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolPageZoomInProxy *pObjectX = (JCToolPageZoomInProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomIn_getIcon_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CToolPageZoomIn *pObjectX = (EarthView::World::Layout::Controls::CToolPageZoomIn*) pObjXXXX;
					EarthView::World::Display::IBitmap* __values1 = pObjectX->EarthView::World::Layout::Controls::CToolPageZoomIn::getIcon();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomIn_isCheckable_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CToolPageZoomIn *pObjectX = (EarthView::World::Layout::Controls::CToolPageZoomIn*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCToolPageZoomInProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Layout::Controls::CToolPageZoomIn::isCheckable();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomIn_register_1isCheckable_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolPageZoomInProxy *pObjectX = (JCToolPageZoomInProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomIn_isCheckable_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Layout::Controls::CToolPageZoomIn *pObjectX = (EarthView::World::Layout::Controls::CToolPageZoomIn*) pObjXXXX;
					ev_bool __values1 = pObjectX->EarthView::World::Layout::Controls::CToolPageZoomIn::isCheckable();
					jboolean __values1_j = (jboolean)__values1;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomIn_activate_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Layout::Controls::CToolPageZoomIn *pObjectX = (EarthView::World::Layout::Controls::CToolPageZoomIn*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCToolPageZoomInProxy))
					{
						pObjectX->EarthView::World::Layout::Controls::CToolPageZoomIn::activate();
					}
					else
					{
						pObjectX->activate();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomIn_register_1activate_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolPageZoomInProxy *pObjectX = (JCToolPageZoomInProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomIn_activate_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Layout::Controls::CToolPageZoomIn *pObjectX = (EarthView::World::Layout::Controls::CToolPageZoomIn*) pObjXXXX;
					pObjectX->EarthView::World::Layout::Controls::CToolPageZoomIn::activate();
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomIn_deactivate_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Layout::Controls::CToolPageZoomIn *pObjectX = (EarthView::World::Layout::Controls::CToolPageZoomIn*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCToolPageZoomInProxy))
					{
						pObjectX->EarthView::World::Layout::Controls::CToolPageZoomIn::deactivate();
					}
					else
					{
						pObjectX->deactivate();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomIn_register_1deactivate_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolPageZoomInProxy *pObjectX = (JCToolPageZoomInProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomIn_deactivate_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Layout::Controls::CToolPageZoomIn *pObjectX = (EarthView::World::Layout::Controls::CToolPageZoomIn*) pObjXXXX;
					pObjectX->EarthView::World::Layout::Controls::CToolPageZoomIn::deactivate();
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomIn_onClicked_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Layout::Controls::CToolPageZoomIn *pObjectX = (EarthView::World::Layout::Controls::CToolPageZoomIn*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCToolPageZoomInProxy))
					{
						pObjectX->EarthView::World::Layout::Controls::CToolPageZoomIn::onClicked();
					}
					else
					{
						pObjectX->onClicked();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomIn_register_1onClicked_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolPageZoomInProxy *pObjectX = (JCToolPageZoomInProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomIn_onClicked_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Layout::Controls::CToolPageZoomIn *pObjectX = (EarthView::World::Layout::Controls::CToolPageZoomIn*) pObjXXXX;
					pObjectX->EarthView::World::Layout::Controls::CToolPageZoomIn::onClicked();
				}
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomIn_getCursor_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Layout::Controls::CToolPageZoomIn *pObjectX = (EarthView::World::Layout::Controls::CToolPageZoomIn*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCToolPageZoomInProxy))
					{
						ev_int32 __values1 = pObjectX->EarthView::World::Layout::Controls::CToolPageZoomIn::getCursor();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomIn_register_1getCursor_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolPageZoomInProxy *pObjectX = (JCToolPageZoomInProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomIn_getCursor_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Layout::Controls::CToolPageZoomIn *pObjectX = (EarthView::World::Layout::Controls::CToolPageZoomIn*) pObjXXXX;
					ev_int32 __values1 = pObjectX->EarthView::World::Layout::Controls::CToolPageZoomIn::getCursor();
					jint __values1_j = (jint)__values1;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomIn_onContextMenu_1ev_1int32_1ev_1int32(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint x_j, jint y_j)
				{
					...
					if (typeid(*pObjectX) == typeid(JCToolPageZoomInProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Layout::Controls::CToolPageZoomIn::onContextMenu(x, y);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomIn_register_1onContextMenu_1ev_1int32_1ev_1int32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolPageZoomInProxy *pObjectX = (JCToolPageZoomInProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomIn_onContextMenu_1ev_1int32_1ev_1int32_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint x_j, jint y_j)
				{
					ev_int32 x = (ev_int32) x_j;
					ev_int32 y = (ev_int32) y_j;
					EarthView::World::Layout::Controls::CToolPageZoomIn *pObjectX = (EarthView::World::Layout::Controls::CToolPageZoomIn*) pObjXXXX;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomIn_onMouseDown_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint button_j, jint shift_j, jint x_j, jint y_j)
				{
					...
					if (typeid(*pObjectX) == typeid(JCToolPageZoomInProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Layout::Controls::CToolPageZoomIn::onMouseDown(button, shift, x, y);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomIn_register_1onMouseDown_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolPageZoomInProxy *pObjectX = (JCToolPageZoomInProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomIn_onMouseDown_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint button_j, jint shift_j, jint x_j, jint y_j)
				{
					ev_int32 button = (ev_int32) button_j;
					ev_int32 shift = (ev_int32) shift_j;
					ev_int32 x = (ev_int32) x_j;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomIn_onMouseMove_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint button_j, jint shift_j, jint x_j, jint y_j)
				{
					ev_int32 button = (ev_int32) button_j;
					ev_int32 shift = (ev_int32) shift_j;
					ev_int32 x = (ev_int32) x_j;
					...
					if (typeid(*pObjectX) == typeid(JCToolPageZoomInProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Layout::Controls::CToolPageZoomIn::onMouseMove(button, shift, x, y);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomIn_register_1onMouseMove_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolPageZoomInProxy *pObjectX = (JCToolPageZoomInProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomIn_onMouseMove_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint button_j, jint shift_j, jint x_j, jint y_j)
				{
					ev_int32 button = (ev_int32) button_j;
					ev_int32 shift = (ev_int32) shift_j;
					ev_int32 x = (ev_int32) x_j;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomIn_onMouseUp_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint button_j, jint shift_j, jint x_j, jint y_j)
				{
					ev_int32 button = (ev_int32) button_j;
					ev_int32 shift = (ev_int32) shift_j;
					ev_int32 x = (ev_int32) x_j;
					...
					if (typeid(*pObjectX) == typeid(JCToolPageZoomInProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Layout::Controls::CToolPageZoomIn::onMouseUp(button, shift, x, y);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomIn_register_1onMouseUp_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolPageZoomInProxy *pObjectX = (JCToolPageZoomInProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomIn_onMouseUp_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint button_j, jint shift_j, jint x_j, jint y_j)
				{
					ev_int32 button = (ev_int32) button_j;
					ev_int32 shift = (ev_int32) shift_j;
					ev_int32 x = (ev_int32) x_j;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomIn_update_1CEvent(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong e_j)
				{
					EarthView::World::Core::CEvent *e = (EarthView::World::Core::CEvent*) e_j;
					EarthView::World::Layout::Controls::CToolPageZoomIn *pObjectX = (EarthView::World::Layout::Controls::CToolPageZoomIn*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCToolPageZoomInProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Layout::Controls::CToolPageZoomIn::update(e);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomIn_register_1update_1CEvent(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolPageZoomInProxy *pObjectX = (JCToolPageZoomInProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomIn_update_1CEvent_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong e_j)
				{
					EarthView::World::Core::CEvent *e = (EarthView::World::Core::CEvent*) e_j;
					EarthView::World::Layout::Controls::CToolPageZoomIn *pObjectX = (EarthView::World::Layout::Controls::CToolPageZoomIn*) pObjXXXX;
					ev_bool __values1 = pObjectX->EarthView::World::Layout::Controls::CToolPageZoomIn::update(e);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomIn_register_1onDoubleClick_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolPageZoomInProxy *pObjectX = (JCToolPageZoomInProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomIn_register_1onDoubleClick_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolPageZoomInProxy *pObjectX = (JCToolPageZoomInProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomIn_register_1onKeyDown_1ev_1int32_1ev_1int32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolPageZoomInProxy *pObjectX = (JCToolPageZoomInProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomIn_register_1onKeyUp_1ev_1int32_1ev_1int32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolPageZoomInProxy *pObjectX = (JCToolPageZoomInProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomIn_register_1onMouseWheel_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolPageZoomInProxy *pObjectX = (JCToolPageZoomInProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomIn_register_1onTouchDown_1MotionEvent(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolPageZoomInProxy *pObjectX = (JCToolPageZoomInProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomIn_register_1onTouchUp_1MotionEvent(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolPageZoomInProxy *pObjectX = (JCToolPageZoomInProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomIn_register_1onTouchMove_1MotionEvent(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolPageZoomInProxy *pObjectX = (JCToolPageZoomInProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomIn_register_1getChecked_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolPageZoomInProxy *pObjectX = (JCToolPageZoomInProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomIn_register_1setChecked_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolPageZoomInProxy *pObjectX = (JCToolPageZoomInProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomIn_register_1getEnabled_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolPageZoomInProxy *pObjectX = (JCToolPageZoomInProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomIn_register_1setEnabled_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolPageZoomInProxy *pObjectX = (JCToolPageZoomInProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_layout_controls_ToolPageZoomIn_register_1create_1ISpatialControl(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCToolPageZoomInProxy *pObjectX = (JCToolPageZoomInProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
