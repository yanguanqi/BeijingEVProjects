...
namespace EarthView
{
	namespace World
	{
		namespace Spatial2D
		{
			namespace Controls
			{
				class JCCommandChartDuskColorProxy : public EarthView::World::Spatial2D::Controls::CCommandChartDuskColor
				{
				 private:
				...
				public:
					JCCommandChartDuskColorProxy(EarthView::World::Core::CNameValuePairList *pList) : CCommandChartDuskColor(pList)
					{
					}
				...
				protected:
					C_DISABLE_COPY(JCCommandChartDuskColorProxy)
				public:
				...
				REGISTER_FACTORY_CLASS(JCCommandChartDuskColorProxy);
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_controls_CommandChartDuskColor_getToolBarType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CCommandChartDuskColor *pObjectX = (EarthView::World::Spatial2D::Controls::CCommandChartDuskColor*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCCommandChartDuskColorProxy))
					{
						ev_uint32 __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CCommandChartDuskColor::getToolBarType();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_CommandChartDuskColor_register_1getToolBarType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandChartDuskColorProxy *pObjectX = (JCCommandChartDuskColorProxy*) pObjXXXX;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_controls_CommandChartDuskColor_getToolBarType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CCommandChartDuskColor *pObjectX = (EarthView::World::Spatial2D::Controls::CCommandChartDuskColor*) pObjXXXX;
					ev_uint32 __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CCommandChartDuskColor::getToolBarType();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_controls_CommandChartDuskColor_getType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CCommandChartDuskColor *pObjectX = (EarthView::World::Spatial2D::Controls::CCommandChartDuskColor*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCCommandChartDuskColorProxy))
					{
						ev_uint32 __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CCommandChartDuskColor::getType();
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_CommandChartDuskColor_register_1getType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandChartDuskColorProxy *pObjectX = (JCCommandChartDuskColorProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_controls_CommandChartDuskColor_getType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CCommandChartDuskColor *pObjectX = (EarthView::World::Spatial2D::Controls::CCommandChartDuskColor*) pObjXXXX;
					ev_uint32 __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CCommandChartDuskColor::getType();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial2d_controls_CommandChartDuskColor_getName_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CCommandChartDuskColor *pObjectX = (EarthView::World::Spatial2D::Controls::CCommandChartDuskColor*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCCommandChartDuskColorProxy))
					{
						EVString __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CCommandChartDuskColor::getName();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_CommandChartDuskColor_register_1getName_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandChartDuskColorProxy *pObjectX = (JCCommandChartDuskColorProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial2d_controls_CommandChartDuskColor_getName_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CCommandChartDuskColor *pObjectX = (EarthView::World::Spatial2D::Controls::CCommandChartDuskColor*) pObjXXXX;
					EVString __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CCommandChartDuskColor::getName();
					EarthView::World::Core::ev_wstring valuesw1 = __values1;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial2d_controls_CommandChartDuskColor_getCategory_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CCommandChartDuskColor *pObjectX = (EarthView::World::Spatial2D::Controls::CCommandChartDuskColor*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCCommandChartDuskColorProxy))
					{
						EVString __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CCommandChartDuskColor::getCategory();
						EarthView::World::Core::ev_wstring valuesw1 = __values1;
						jstring __values1_j = __env->NewString((const jchar*)valuesw1.getString(), valuesw1.size());
						return __values1_j;
					}
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_CommandChartDuskColor_register_1getCategory_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandChartDuskColorProxy *pObjectX = (JCCommandChartDuskColorProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial2d_controls_CommandChartDuskColor_getCategory_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CCommandChartDuskColor *pObjectX = (EarthView::World::Spatial2D::Controls::CCommandChartDuskColor*) pObjXXXX;
					EVString __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CCommandChartDuskColor::getCategory();
					EarthView::World::Core::ev_wstring valuesw1 = __values1;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial2d_controls_CommandChartDuskColor_getToolTip_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CCommandChartDuskColor *pObjectX = (EarthView::World::Spatial2D::Controls::CCommandChartDuskColor*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCCommandChartDuskColorProxy))
					{
						EVString __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CCommandChartDuskColor::getToolTip();
						EarthView::World::Core::ev_wstring valuesw1 = __values1;
						jstring __values1_j = __env->NewString((const jchar*)valuesw1.getString(), valuesw1.size());
						return __values1_j;
					}
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_CommandChartDuskColor_register_1getToolTip_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandChartDuskColorProxy *pObjectX = (JCCommandChartDuskColorProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial2d_controls_CommandChartDuskColor_getToolTip_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CCommandChartDuskColor *pObjectX = (EarthView::World::Spatial2D::Controls::CCommandChartDuskColor*) pObjXXXX;
					EVString __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CCommandChartDuskColor::getToolTip();
					EarthView::World::Core::ev_wstring valuesw1 = __values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_controls_CommandChartDuskColor_getIcon_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CCommandChartDuskColor *pObjectX = (EarthView::World::Spatial2D::Controls::CCommandChartDuskColor*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCCommandChartDuskColorProxy))
					{
						EarthView::World::Display::IBitmap* __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CCommandChartDuskColor::getIcon();
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_CommandChartDuskColor_register_1getIcon_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandChartDuskColorProxy *pObjectX = (JCCommandChartDuskColorProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_controls_CommandChartDuskColor_getIcon_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CCommandChartDuskColor *pObjectX = (EarthView::World::Spatial2D::Controls::CCommandChartDuskColor*) pObjXXXX;
					EarthView::World::Display::IBitmap* __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CCommandChartDuskColor::getIcon();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial2d_controls_CommandChartDuskColor_isCheckable_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CCommandChartDuskColor *pObjectX = (EarthView::World::Spatial2D::Controls::CCommandChartDuskColor*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCCommandChartDuskColorProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CCommandChartDuskColor::isCheckable();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_CommandChartDuskColor_register_1isCheckable_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandChartDuskColorProxy *pObjectX = (JCCommandChartDuskColorProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial2d_controls_CommandChartDuskColor_isCheckable_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CCommandChartDuskColor *pObjectX = (EarthView::World::Spatial2D::Controls::CCommandChartDuskColor*) pObjXXXX;
					ev_bool __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CCommandChartDuskColor::isCheckable();
					jboolean __values1_j = (jboolean)__values1;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_CommandChartDuskColor_onClicked_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial2D::Controls::CCommandChartDuskColor *pObjectX = (EarthView::World::Spatial2D::Controls::CCommandChartDuskColor*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCCommandChartDuskColorProxy))
					{
						pObjectX->EarthView::World::Spatial2D::Controls::CCommandChartDuskColor::onClicked();
					}
					else
					{
						pObjectX->onClicked();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_CommandChartDuskColor_register_1onClicked_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandChartDuskColorProxy *pObjectX = (JCCommandChartDuskColorProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_CommandChartDuskColor_onClicked_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial2D::Controls::CCommandChartDuskColor *pObjectX = (EarthView::World::Spatial2D::Controls::CCommandChartDuskColor*) pObjXXXX;
					pObjectX->EarthView::World::Spatial2D::Controls::CCommandChartDuskColor::onClicked();
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_CommandChartDuskColor_register_1getChecked_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandChartDuskColorProxy *pObjectX = (JCCommandChartDuskColorProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_CommandChartDuskColor_register_1setChecked_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandChartDuskColorProxy *pObjectX = (JCCommandChartDuskColorProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_CommandChartDuskColor_register_1getEnabled_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandChartDuskColorProxy *pObjectX = (JCCommandChartDuskColorProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_CommandChartDuskColor_register_1setEnabled_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandChartDuskColorProxy *pObjectX = (JCCommandChartDuskColorProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_CommandChartDuskColor_register_1create_1ISpatialControl(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandChartDuskColorProxy *pObjectX = (JCCommandChartDuskColorProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_CommandChartDuskColor_register_1update_1CEvent(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandChartDuskColorProxy *pObjectX = (JCCommandChartDuskColorProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
