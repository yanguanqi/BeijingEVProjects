...
namespace EarthView
{
	namespace World
	{
		namespace Spatial3D
		{
			namespace Atlas
			{
				class JCLayerSelection3DProxy : public EarthView::World::Spatial3D::Atlas::CLayerSelection3D
				{
				 private:
				...
				public:
					JCLayerSelection3DProxy(EarthView::World::Core::CNameValuePairList *pList) : CLayerSelection3D(pList)
					{
					}
				...
				protected:
					C_DISABLE_COPY(JCLayerSelection3DProxy)
				public:
				...
				REGISTER_FACTORY_CLASS(JCLayerSelection3DProxy);
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_atlas_LayerSelection3D_getSelection_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::CLayerSelection3D *pObjectX = (EarthView::World::Spatial3D::Atlas::CLayerSelection3D*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCLayerSelection3DProxy))
					{
						EarthView::World::Spatial::GeoDataset::IFeatureSelection* __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CLayerSelection3D::getSelection();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_LayerSelection3D_register_1getSelection_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCLayerSelection3DProxy *pObjectX = (JCLayerSelection3DProxy*) pObjXXXX;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_atlas_LayerSelection3D_getSelection_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::CLayerSelection3D *pObjectX = (EarthView::World::Spatial3D::Atlas::CLayerSelection3D*) pObjXXXX;
					EarthView::World::Spatial::GeoDataset::IFeatureSelection* __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::CLayerSelection3D::getSelection();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_LayerSelection3D_setSelection_1IFeatureSelection(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong selection_j)
				{
					EarthView::World::Spatial::GeoDataset::IFeatureSelection *selection = (EarthView::World::Spatial::GeoDataset::IFeatureSelection*) selection_j;
					EarthView::World::Spatial3D::Atlas::CLayerSelection3D *pObjectX = (EarthView::World::Spatial3D::Atlas::CLayerSelection3D*) pObjXXXX;
					pObjectX->setSelection(selection);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_LayerSelection3D_register_1getSelectionSymbol_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCLayerSelection3DProxy *pObjectX = (JCLayerSelection3DProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_LayerSelection3D_register_1setSelectionSymbol_1ISymbol(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCLayerSelection3DProxy *pObjectX = (JCLayerSelection3DProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
