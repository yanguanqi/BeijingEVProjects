...
namespace EarthView
{
	namespace World
	{
		namespace Spatial3D
		{
			namespace Atlas
			{
				extern "C" JNIEXPORT jintArray JNICALL Java_com_earthview_world_spatial3d_atlas_LAYERSRSHelper_getEnumValues (JNIEnv *__env, jclass __clazz)
				{
					jint enum_values[] = {
						LAYERSRS_Unknown,
						LAYERSRS_WGS_1984,
				...
				extern "C" JNIEXPORT jintArray JNICALL Java_com_earthview_world_spatial3d_atlas_LayerRefreshFactorHelper_getEnumValues (JNIEnv *__env, jclass __clazz)
				{
					jint enum_values[] = {
						LRF_General,
						LRF_VisibleChanged,
				...
				class JIGlobeLayerProxy : public EarthView::World::Spatial3D::Atlas::IGlobeLayer
				{
				 private:
				...
				public:
					JIGlobeLayerProxy(EarthView::World::Core::CNameValuePairList *pList) : IGlobeLayer(pList)
					{
					}
				...
				REGISTER_FACTORY_CLASS(JIGlobeLayerProxy);
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_getSceneName_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::IGlobeLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::IGlobeLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIGlobeLayerProxy))
					{
						EVString __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::IGlobeLayer::getSceneName();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_register_1getSceneName_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGlobeLayerProxy *pObjectX = (JIGlobeLayerProxy*) pObjXXXX;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_getSceneName_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::IGlobeLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::IGlobeLayer*) pObjXXXX;
					EVString __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::IGlobeLayer::getSceneName();
					EarthView::World::Core::ev_wstring valuesw1 = __values1;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_getName_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::IGlobeLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::IGlobeLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIGlobeLayerProxy))
					{
						EVString __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::IGlobeLayer::getName();
						EarthView::World::Core::ev_wstring valuesw1 = __values1;
						jstring __values1_j = __env->NewString((const jchar*)valuesw1.getString(), valuesw1.size());
						return __values1_j;
					}
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_register_1getName_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGlobeLayerProxy *pObjectX = (JIGlobeLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_getName_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::IGlobeLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::IGlobeLayer*) pObjXXXX;
					EVString __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::IGlobeLayer::getName();
					EarthView::World::Core::ev_wstring valuesw1 = __values1;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_setName_1EVString(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring name_j)
				{
					#if EV_PLATFORM == EV_PLATFORM_ANDROID
					...
					#endif
					EarthView::World::Spatial3D::Atlas::IGlobeLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::IGlobeLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIGlobeLayerProxy))
					{
						pObjectX->EarthView::World::Spatial3D::Atlas::IGlobeLayer::setName(name);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_register_1setName_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGlobeLayerProxy *pObjectX = (JIGlobeLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_setName_1EVString_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring name_j)
				{
					#if EV_PLATFORM == EV_PLATFORM_ANDROID
					const ev_char* name_ch = (const ev_char*)__env->GetStringUTFChars(name_j,JNI_FALSE);
					const EVString name = name_ch;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_getType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::IGlobeLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::IGlobeLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIGlobeLayerProxy))
					{
						EarthView::World::Spatial::Atlas::EVLayerType __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::IGlobeLayer::getType();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_register_1getType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGlobeLayerProxy *pObjectX = (JIGlobeLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_getType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::IGlobeLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::IGlobeLayer*) pObjXXXX;
					EarthView::World::Spatial::Atlas::EVLayerType __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::IGlobeLayer::getType();
					jint __values1_j = (jint) __values1;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_getDescription_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::IGlobeLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::IGlobeLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIGlobeLayerProxy))
					{
						EVString __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::IGlobeLayer::getDescription();
						EarthView::World::Core::ev_wstring valuesw1 = __values1;
						jstring __values1_j = __env->NewString((const jchar*)valuesw1.getString(), valuesw1.size());
						return __values1_j;
					}
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_register_1getDescription_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGlobeLayerProxy *pObjectX = (JIGlobeLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_getDescription_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::IGlobeLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::IGlobeLayer*) pObjXXXX;
					EVString __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::IGlobeLayer::getDescription();
					EarthView::World::Core::ev_wstring valuesw1 = __values1;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_setDescription_1EVString(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring value_j)
				{
					#if EV_PLATFORM == EV_PLATFORM_ANDROID
					...
					if (typeid(*pObjectX) == typeid(JIGlobeLayerProxy))
					{
						pObjectX->EarthView::World::Spatial3D::Atlas::IGlobeLayer::setDescription(value);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_register_1setDescription_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGlobeLayerProxy *pObjectX = (JIGlobeLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_setDescription_1EVString_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring value_j)
				{
					#if EV_PLATFORM == EV_PLATFORM_ANDROID
					const ev_char* value_ch = (const ev_char*)__env->GetStringUTFChars(value_j,JNI_FALSE);
					const EVString value = value_ch;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_canEdit_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::IGlobeLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::IGlobeLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIGlobeLayerProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::IGlobeLayer::canEdit();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_register_1canEdit_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGlobeLayerProxy *pObjectX = (JIGlobeLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_canEdit_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::IGlobeLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::IGlobeLayer*) pObjXXXX;
					ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::IGlobeLayer::canEdit();
					jboolean __values1_j = (jboolean)__values1;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_setCanEdit_1ev_1bool(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean can_j)
				{
					ev_bool can = (ev_bool) can_j;
					EarthView::World::Spatial3D::Atlas::IGlobeLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::IGlobeLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIGlobeLayerProxy))
					{
						pObjectX->EarthView::World::Spatial3D::Atlas::IGlobeLayer::setCanEdit(can);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_register_1setCanEdit_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGlobeLayerProxy *pObjectX = (JIGlobeLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_setCanEdit_1ev_1bool_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean can_j)
				{
					ev_bool can = (ev_bool) can_j;
					EarthView::World::Spatial3D::Atlas::IGlobeLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::IGlobeLayer*) pObjXXXX;
					pObjectX->EarthView::World::Spatial3D::Atlas::IGlobeLayer::setCanEdit(can);
				}
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_isEditing_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::IGlobeLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::IGlobeLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIGlobeLayerProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::IGlobeLayer::isEditing();
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_register_1isEditing_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGlobeLayerProxy *pObjectX = (JIGlobeLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_isEditing_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::IGlobeLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::IGlobeLayer*) pObjXXXX;
					ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::IGlobeLayer::isEditing();
					jboolean __values1_j = (jboolean)__values1;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_setEditing_1ev_1bool(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean editing_j)
				{
					ev_bool editing = (ev_bool) editing_j;
					EarthView::World::Spatial3D::Atlas::IGlobeLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::IGlobeLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIGlobeLayerProxy))
					{
						pObjectX->EarthView::World::Spatial3D::Atlas::IGlobeLayer::setEditing(editing);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_register_1setEditing_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGlobeLayerProxy *pObjectX = (JIGlobeLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_setEditing_1ev_1bool_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean editing_j)
				{
					ev_bool editing = (ev_bool) editing_j;
					EarthView::World::Spatial3D::Atlas::IGlobeLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::IGlobeLayer*) pObjXXXX;
					pObjectX->EarthView::World::Spatial3D::Atlas::IGlobeLayer::setEditing(editing);
				}
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_isVisible_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::IGlobeLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::IGlobeLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIGlobeLayerProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::IGlobeLayer::isVisible();
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_register_1isVisible_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGlobeLayerProxy *pObjectX = (JIGlobeLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_isVisible_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::IGlobeLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::IGlobeLayer*) pObjXXXX;
					ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::IGlobeLayer::isVisible();
					jboolean __values1_j = (jboolean)__values1;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_setVisible_1ev_1bool(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean visible_j)
				{
					ev_bool visible = (ev_bool) visible_j;
					EarthView::World::Spatial3D::Atlas::IGlobeLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::IGlobeLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIGlobeLayerProxy))
					{
						pObjectX->EarthView::World::Spatial3D::Atlas::IGlobeLayer::setVisible(visible);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_register_1setVisible_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGlobeLayerProxy *pObjectX = (JIGlobeLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_setVisible_1ev_1bool_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean visible_j)
				{
					ev_bool visible = (ev_bool) visible_j;
					EarthView::World::Spatial3D::Atlas::IGlobeLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::IGlobeLayer*) pObjXXXX;
					pObjectX->EarthView::World::Spatial3D::Atlas::IGlobeLayer::setVisible(visible);
				}
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_isValid_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::IGlobeLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::IGlobeLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIGlobeLayerProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::IGlobeLayer::isValid();
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_register_1isValid_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGlobeLayerProxy *pObjectX = (JIGlobeLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_isValid_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::IGlobeLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::IGlobeLayer*) pObjXXXX;
					ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::IGlobeLayer::isValid();
					jboolean __values1_j = (jboolean)__values1;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_isSelectable_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::IGlobeLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::IGlobeLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIGlobeLayerProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::IGlobeLayer::isSelectable();
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_register_1isSelectable_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGlobeLayerProxy *pObjectX = (JIGlobeLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_isSelectable_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::IGlobeLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::IGlobeLayer*) pObjXXXX;
					ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::IGlobeLayer::isSelectable();
					jboolean __values1_j = (jboolean)__values1;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_setSelectable_1ev_1bool(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean selectable_j)
				{
					ev_bool selectable = (ev_bool) selectable_j;
					EarthView::World::Spatial3D::Atlas::IGlobeLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::IGlobeLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIGlobeLayerProxy))
					{
						pObjectX->EarthView::World::Spatial3D::Atlas::IGlobeLayer::setSelectable(selectable);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_register_1setSelectable_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGlobeLayerProxy *pObjectX = (JIGlobeLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_setSelectable_1ev_1bool_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean selectable_j)
				{
					ev_bool selectable = (ev_bool) selectable_j;
					EarthView::World::Spatial3D::Atlas::IGlobeLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::IGlobeLayer*) pObjXXXX;
					pObjectX->EarthView::World::Spatial3D::Atlas::IGlobeLayer::setSelectable(selectable);
				}
				extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_getMinX_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::IGlobeLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::IGlobeLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIGlobeLayerProxy))
					{
						ev_real64 __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::IGlobeLayer::getMinX();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_register_1getMinX_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGlobeLayerProxy *pObjectX = (JIGlobeLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_getMinX_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::IGlobeLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::IGlobeLayer*) pObjXXXX;
					ev_real64 __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::IGlobeLayer::getMinX();
					jdouble __values1_j = (jdouble)__values1;
				...
				extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_getMaxX_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::IGlobeLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::IGlobeLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIGlobeLayerProxy))
					{
						ev_real64 __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::IGlobeLayer::getMaxX();
						jdouble __values1_j = (jdouble)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_register_1getMaxX_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGlobeLayerProxy *pObjectX = (JIGlobeLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_getMaxX_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::IGlobeLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::IGlobeLayer*) pObjXXXX;
					ev_real64 __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::IGlobeLayer::getMaxX();
					jdouble __values1_j = (jdouble)__values1;
				...
				extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_getMinY_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::IGlobeLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::IGlobeLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIGlobeLayerProxy))
					{
						ev_real64 __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::IGlobeLayer::getMinY();
						jdouble __values1_j = (jdouble)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_register_1getMinY_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGlobeLayerProxy *pObjectX = (JIGlobeLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_getMinY_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::IGlobeLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::IGlobeLayer*) pObjXXXX;
					ev_real64 __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::IGlobeLayer::getMinY();
					jdouble __values1_j = (jdouble)__values1;
				...
				extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_getMaxY_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::IGlobeLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::IGlobeLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIGlobeLayerProxy))
					{
						ev_real64 __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::IGlobeLayer::getMaxY();
						jdouble __values1_j = (jdouble)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_register_1getMaxY_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGlobeLayerProxy *pObjectX = (JIGlobeLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_getMaxY_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::IGlobeLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::IGlobeLayer*) pObjXXXX;
					ev_real64 __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::IGlobeLayer::getMaxY();
					jdouble __values1_j = (jdouble)__values1;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_getHeightAt_1ev_1real32_1ev_1real32_1ev_1real32_1ev_1real32(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jfloat lat_j, jfloat lon_j, jfloat targetSamplesPerDegrees_j, jlong height_j)
				{
					...
					if (typeid(*pObjectX) == typeid(JIGlobeLayerProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::IGlobeLayer::getHeightAt(lat, lon, targetSamplesPerDegrees, height);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_register_1getHeightAt_1ev_1real32_1ev_1real32_1ev_1real32_1ev_1real32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGlobeLayerProxy *pObjectX = (JIGlobeLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_getHeightAt_1ev_1real32_1ev_1real32_1ev_1real32_1ev_1real32_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jfloat lat_j, jfloat lon_j, jfloat targetSamplesPerDegrees_j, jlong height_j)
				{
					ev_real32 lat = (ev_real32) lat_j;
					ev_real32 lon = (ev_real32) lon_j;
					ev_real32 targetSamplesPerDegrees = (ev_real32) targetSamplesPerDegrees_j;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer__1notifyLayerAdd_1CSceneManager(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong pSceneMgr_j)
				{
					EarthView::World::Graphic::CSceneManager *pSceneMgr = (EarthView::World::Graphic::CSceneManager*) pSceneMgr_j;
					EarthView::World::Spatial3D::Atlas::IGlobeLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::IGlobeLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIGlobeLayerProxy))
					{
						pObjectX->EarthView::World::Spatial3D::Atlas::IGlobeLayer::_notifyLayerAdd(pSceneMgr);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_register_1_1notifyLayerAdd_1CSceneManager(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGlobeLayerProxy *pObjectX = (JIGlobeLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer__1notifyLayerAdd_1CSceneManager_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong pSceneMgr_j)
				{
					EarthView::World::Graphic::CSceneManager *pSceneMgr = (EarthView::World::Graphic::CSceneManager*) pSceneMgr_j;
					EarthView::World::Spatial3D::Atlas::IGlobeLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::IGlobeLayer*) pObjXXXX;
					pObjectX->EarthView::World::Spatial3D::Atlas::IGlobeLayer::_notifyLayerAdd(pSceneMgr);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer__1notifyLayerRemoved_1CSceneManager(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong pSceneMgr_j)
				{
					EarthView::World::Graphic::CSceneManager *pSceneMgr = (EarthView::World::Graphic::CSceneManager*) pSceneMgr_j;
					EarthView::World::Spatial3D::Atlas::IGlobeLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::IGlobeLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIGlobeLayerProxy))
					{
						pObjectX->EarthView::World::Spatial3D::Atlas::IGlobeLayer::_notifyLayerRemoved(pSceneMgr);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_register_1_1notifyLayerRemoved_1CSceneManager(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGlobeLayerProxy *pObjectX = (JIGlobeLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer__1notifyLayerRemoved_1CSceneManager_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong pSceneMgr_j)
				{
					EarthView::World::Graphic::CSceneManager *pSceneMgr = (EarthView::World::Graphic::CSceneManager*) pSceneMgr_j;
					EarthView::World::Spatial3D::Atlas::IGlobeLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::IGlobeLayer*) pObjXXXX;
					pObjectX->EarthView::World::Spatial3D::Atlas::IGlobeLayer::_notifyLayerRemoved(pSceneMgr);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer__1notifyRefreshed_1CCamera_1LayerRefreshFactor(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong camera_j, jint updateType_j)
				{
					...
					if (typeid(*pObjectX) == typeid(JIGlobeLayerProxy))
					{
						pObjectX->EarthView::World::Spatial3D::Atlas::IGlobeLayer::_notifyRefreshed(camera, updateType);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_register_1_1notifyRefreshed_1CCamera_1LayerRefreshFactor(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGlobeLayerProxy *pObjectX = (JIGlobeLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer__1notifyRefreshed_1CCamera_1LayerRefreshFactor_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong camera_j, jint updateType_j)
				{
					const EarthView::World::Graphic::CCamera *camera = (const EarthView::World::Graphic::CCamera*) camera_j;
					EarthView::World::Spatial3D::Atlas::LayerRefreshFactor updateType = (EarthView::World::Spatial3D::Atlas::LayerRefreshFactor) updateType_j;
					EarthView::World::Spatial3D::Atlas::IGlobeLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::IGlobeLayer*) pObjXXXX;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer__1notifyRefreshed_1CCamera(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong camera_j)
				{
					const EarthView::World::Graphic::CCamera *camera = (const EarthView::World::Graphic::CCamera*) camera_j;
					EarthView::World::Spatial3D::Atlas::IGlobeLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::IGlobeLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIGlobeLayerProxy))
					{
						pObjectX->EarthView::World::Spatial3D::Atlas::IGlobeLayer::_notifyRefreshed(camera);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_register_1_1notifyRefreshed_1CCamera(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGlobeLayerProxy *pObjectX = (JIGlobeLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer__1notifyRefreshed_1CCamera_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong camera_j)
				{
					const EarthView::World::Graphic::CCamera *camera = (const EarthView::World::Graphic::CCamera*) camera_j;
					EarthView::World::Spatial3D::Atlas::IGlobeLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::IGlobeLayer*) pObjXXXX;
					pObjectX->EarthView::World::Spatial3D::Atlas::IGlobeLayer::_notifyRefreshed(camera);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer__1notifyDataChanged_1EVString_1EVString_1CEvent(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring strDataSourceName_j, jstring strDatasetName_j, jlong pEvent_j)
				{
					#if EV_PLATFORM == EV_PLATFORM_ANDROID
					...
					if (typeid(*pObjectX) == typeid(JIGlobeLayerProxy))
					{
						pObjectX->EarthView::World::Spatial3D::Atlas::IGlobeLayer::_notifyDataChanged(strDataSourceName, strDatasetName, pEvent);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_register_1_1notifyDataChanged_1EVString_1EVString_1CEvent(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGlobeLayerProxy *pObjectX = (JIGlobeLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer__1notifyDataChanged_1EVString_1EVString_1CEvent_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring strDataSourceName_j, jstring strDatasetName_j, jlong pEvent_j)
				{
					#if EV_PLATFORM == EV_PLATFORM_ANDROID
					const ev_char* strDataSourceName_ch = (const ev_char*)__env->GetStringUTFChars(strDataSourceName_j,JNI_FALSE);
					const EVString strDataSourceName = strDataSourceName_ch;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_getSceneManager_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::IGlobeLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::IGlobeLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIGlobeLayerProxy))
					{
						EarthView::World::Graphic::CSceneManager* __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::IGlobeLayer::getSceneManager();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_register_1getSceneManager_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGlobeLayerProxy *pObjectX = (JIGlobeLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_getSceneManager_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::IGlobeLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::IGlobeLayer*) pObjXXXX;
					EarthView::World::Graphic::CSceneManager* __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::IGlobeLayer::getSceneManager();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_fromXmlElement_1CXmlElement(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong element_j)
				{
					EarthView::World::Core::CXmlElement &element = *(EarthView::World::Core::CXmlElement*) element_j;
					EarthView::World::Spatial3D::Atlas::IGlobeLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::IGlobeLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIGlobeLayerProxy))
					{
						pObjectX->EarthView::World::Spatial3D::Atlas::IGlobeLayer::fromXmlElement(element);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_register_1fromXmlElement_1CXmlElement(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGlobeLayerProxy *pObjectX = (JIGlobeLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_fromXmlElement_1CXmlElement_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong element_j)
				{
					EarthView::World::Core::CXmlElement &element = *(EarthView::World::Core::CXmlElement*) element_j;
					EarthView::World::Spatial3D::Atlas::IGlobeLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::IGlobeLayer*) pObjXXXX;
					pObjectX->EarthView::World::Spatial3D::Atlas::IGlobeLayer::fromXmlElement(element);
				}
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_toXmlElement_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::IGlobeLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::IGlobeLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIGlobeLayerProxy))
					{
						EarthView::World::Core::CXmlElement __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::IGlobeLayer::toXmlElement();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_register_1toXmlElement_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGlobeLayerProxy *pObjectX = (JIGlobeLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_toXmlElement_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::IGlobeLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::IGlobeLayer*) pObjXXXX;
					EarthView::World::Core::CXmlElement __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::IGlobeLayer::toXmlElement();
					EarthView::World::Core::CXmlElement *returnvalues = new EarthView::World::Core::CXmlElement(__values1);
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_toXML_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::IGlobeLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::IGlobeLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIGlobeLayerProxy))
					{
						EVString __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::IGlobeLayer::toXML();
						EarthView::World::Core::ev_wstring valuesw1 = __values1;
						jstring __values1_j = __env->NewString((const jchar*)valuesw1.getString(), valuesw1.size());
						return __values1_j;
					}
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_register_1toXML_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGlobeLayerProxy *pObjectX = (JIGlobeLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_toXML_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Atlas::IGlobeLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::IGlobeLayer*) pObjXXXX;
					EVString __values1 = pObjectX->EarthView::World::Spatial3D::Atlas::IGlobeLayer::toXML();
					EarthView::World::Core::ev_wstring valuesw1 = __values1;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_toStream_1CDataStream(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong stream_j)
				{
					EarthView::World::Core::CDataStream &stream = *(EarthView::World::Core::CDataStream*) stream_j;
					const 					EarthView::World::Spatial3D::Atlas::IGlobeLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::IGlobeLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIGlobeLayerProxy))
					{
						pObjectX->EarthView::World::Spatial3D::Atlas::IGlobeLayer::toStream(stream);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_register_1toStream_1CDataStream(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGlobeLayerProxy *pObjectX = (JIGlobeLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_toStream_1CDataStream_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong stream_j)
				{
					EarthView::World::Core::CDataStream &stream = *(EarthView::World::Core::CDataStream*) stream_j;
					const 					EarthView::World::Spatial3D::Atlas::IGlobeLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::IGlobeLayer*) pObjXXXX;
					pObjectX->EarthView::World::Spatial3D::Atlas::IGlobeLayer::toStream(stream);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_fromStream_1CDataStream(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong stream_j)
				{
					EarthView::World::Core::CDataStream &stream = *(EarthView::World::Core::CDataStream*) stream_j;
					EarthView::World::Spatial3D::Atlas::IGlobeLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::IGlobeLayer*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIGlobeLayerProxy))
					{
						pObjectX->EarthView::World::Spatial3D::Atlas::IGlobeLayer::fromStream(stream);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_register_1fromStream_1CDataStream(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGlobeLayerProxy *pObjectX = (JIGlobeLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_fromStream_1CDataStream_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong stream_j)
				{
					EarthView::World::Core::CDataStream &stream = *(EarthView::World::Core::CDataStream*) stream_j;
					EarthView::World::Spatial3D::Atlas::IGlobeLayer *pObjectX = (EarthView::World::Spatial3D::Atlas::IGlobeLayer*) pObjXXXX;
					pObjectX->EarthView::World::Spatial3D::Atlas::IGlobeLayer::fromStream(stream);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_register_1getDataset_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGlobeLayerProxy *pObjectX = (JIGlobeLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_register_1getDatasetName_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGlobeLayerProxy *pObjectX = (JIGlobeLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_register_1getDataSource_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGlobeLayerProxy *pObjectX = (JIGlobeLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_register_1select_1IQueryFilter_1EVSelectionResultType(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGlobeLayerProxy *pObjectX = (JIGlobeLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_register_1clearSelection_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGlobeLayerProxy *pObjectX = (JIGlobeLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_register_1setLayerSelection_1ILayerSelection(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGlobeLayerProxy *pObjectX = (JIGlobeLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_register_1getLayerSelection_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGlobeLayerProxy *pObjectX = (JIGlobeLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_register_1ignoreScale_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGlobeLayerProxy *pObjectX = (JIGlobeLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_register_1setIgnoreScale_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGlobeLayerProxy *pObjectX = (JIGlobeLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_register_1getDisplayMaxScale_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGlobeLayerProxy *pObjectX = (JIGlobeLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_register_1setDisplayMaxScale_1ev_1real64(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGlobeLayerProxy *pObjectX = (JIGlobeLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_register_1getDisplayMinScale_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGlobeLayerProxy *pObjectX = (JIGlobeLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_register_1setDisplayMinScale_1ev_1real64(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGlobeLayerProxy *pObjectX = (JIGlobeLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_register_1getSpatialReference_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGlobeLayerProxy *pObjectX = (JIGlobeLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_register_1setSpatialReference_1ISpatialReference(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGlobeLayerProxy *pObjectX = (JIGlobeLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_register_1setTransparentValue_1ev_1uint8(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGlobeLayerProxy *pObjectX = (JIGlobeLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_register_1getTransparentValue_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGlobeLayerProxy *pObjectX = (JIGlobeLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_register_1getExtent_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGlobeLayerProxy *pObjectX = (JIGlobeLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_register_1draw_1ISpatialDisplay_1EVVectorLayerRendererType(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGlobeLayerProxy *pObjectX = (JIGlobeLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_atlas_Iglobelayer_register_1ev_1clone_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIGlobeLayerProxy *pObjectX = (JIGlobeLayerProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
