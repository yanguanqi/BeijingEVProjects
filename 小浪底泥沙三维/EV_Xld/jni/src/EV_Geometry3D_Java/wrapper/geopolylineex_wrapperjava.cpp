...
namespace EarthView
{
	namespace World
	{
		...
		{
			class JCGeoPolylineExProxy : public EarthView::World::Geometry3D::CGeoPolylineEx
			{
			 private:
			...
			public:
				JCGeoPolylineExProxy(EarthView::World::Core::CNameValuePairList *pList) : CGeoPolylineEx(pList)
				{
				}
			...
			REGISTER_FACTORY_CLASS(JCGeoPolylineExProxy);
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_GeoPolylineEx_build_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Geometry3D::CGeoPolylineEx *pObjectX = (EarthView::World::Geometry3D::CGeoPolylineEx*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCGeoPolylineExProxy))
				{
					pObjectX->EarthView::World::Geometry3D::CGeoPolylineEx::build();
				}
				else
				{
					pObjectX->build();
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_GeoPolylineEx_register_1build_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCGeoPolylineExProxy *pObjectX = (JCGeoPolylineExProxy*) pObjXXXX;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_GeoPolylineEx_build_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Geometry3D::CGeoPolylineEx *pObjectX = (EarthView::World::Geometry3D::CGeoPolylineEx*) pObjXXXX;
				pObjectX->EarthView::World::Geometry3D::CGeoPolylineEx::build();
			}
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_geometry3d_GeoPolylineEx_appendGeoObject_1CGeoObject(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong ref_geoObject_j)
			{
				EarthView::World::Spatial::CGeoObject *ref_geoObject = (EarthView::World::Spatial::CGeoObject*) ref_geoObject_j;
				EarthView::World::Geometry3D::CGeoPolylineEx *pObjectX = (EarthView::World::Geometry3D::CGeoPolylineEx*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCGeoPolylineExProxy))
				{
					ev_bool __values1 = pObjectX->EarthView::World::Geometry3D::CGeoPolylineEx::appendGeoObject(ref_geoObject);
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_GeoPolylineEx_register_1appendGeoObject_1CGeoObject(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCGeoPolylineExProxy *pObjectX = (JCGeoPolylineExProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_geometry3d_GeoPolylineEx_appendGeoObject_1CGeoObject_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong ref_geoObject_j)
			{
				EarthView::World::Spatial::CGeoObject *ref_geoObject = (EarthView::World::Spatial::CGeoObject*) ref_geoObject_j;
				EarthView::World::Geometry3D::CGeoPolylineEx *pObjectX = (EarthView::World::Geometry3D::CGeoPolylineEx*) pObjXXXX;
				ev_bool __values1 = pObjectX->EarthView::World::Geometry3D::CGeoPolylineEx::appendGeoObject(ref_geoObject);
			...
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_geometry3d_GeoPolylineEx_removeGeoObject_1CGeoObject(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong geoObject_j)
			{
				EarthView::World::Spatial::CGeoObject *geoObject = (EarthView::World::Spatial::CGeoObject*) geoObject_j;
				EarthView::World::Geometry3D::CGeoPolylineEx *pObjectX = (EarthView::World::Geometry3D::CGeoPolylineEx*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCGeoPolylineExProxy))
				{
					ev_bool __values1 = pObjectX->EarthView::World::Geometry3D::CGeoPolylineEx::removeGeoObject(geoObject);
					jboolean __values1_j = (jboolean)__values1;
					return __values1_j;
				}
				else
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_GeoPolylineEx_register_1removeGeoObject_1CGeoObject(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCGeoPolylineExProxy *pObjectX = (JCGeoPolylineExProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_geometry3d_GeoPolylineEx_removeGeoObject_1CGeoObject_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong geoObject_j)
			{
				EarthView::World::Spatial::CGeoObject *geoObject = (EarthView::World::Spatial::CGeoObject*) geoObject_j;
				EarthView::World::Geometry3D::CGeoPolylineEx *pObjectX = (EarthView::World::Geometry3D::CGeoPolylineEx*) pObjXXXX;
				ev_bool __values1 = pObjectX->EarthView::World::Geometry3D::CGeoPolylineEx::removeGeoObject(geoObject);
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_GeoPolylineEx_removeAllGeoObjects_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Geometry3D::CGeoPolylineEx *pObjectX = (EarthView::World::Geometry3D::CGeoPolylineEx*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCGeoPolylineExProxy))
				{
					pObjectX->EarthView::World::Geometry3D::CGeoPolylineEx::removeAllGeoObjects();
				}
				else
				{
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_GeoPolylineEx_register_1removeAllGeoObjects_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCGeoPolylineExProxy *pObjectX = (JCGeoPolylineExProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_GeoPolylineEx_removeAllGeoObjects_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Geometry3D::CGeoPolylineEx *pObjectX = (EarthView::World::Geometry3D::CGeoPolylineEx*) pObjXXXX;
				pObjectX->EarthView::World::Geometry3D::CGeoPolylineEx::removeAllGeoObjects();
			}
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_geometry3d_GeoPolylineEx_getGeoObject_1ev_1uint32(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong index_j)
			{
				ev_uint32 index = (ev_uint32) index_j;
				const 				EarthView::World::Geometry3D::CGeoPolylineEx *pObjectX = (EarthView::World::Geometry3D::CGeoPolylineEx*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCGeoPolylineExProxy))
				{
					EarthView::World::Spatial::CGeoObject* __values1 = pObjectX->EarthView::World::Geometry3D::CGeoPolylineEx::getGeoObject(index);
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_GeoPolylineEx_register_1getGeoObject_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCGeoPolylineExProxy *pObjectX = (JCGeoPolylineExProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_geometry3d_GeoPolylineEx_getGeoObject_1ev_1uint32_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong index_j)
			{
				ev_uint32 index = (ev_uint32) index_j;
				const 				EarthView::World::Geometry3D::CGeoPolylineEx *pObjectX = (EarthView::World::Geometry3D::CGeoPolylineEx*) pObjXXXX;
				EarthView::World::Spatial::CGeoObject* __values1 = pObjectX->EarthView::World::Geometry3D::CGeoPolylineEx::getGeoObject(index);
			...
			extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_geometry3d_GeoPolylineEx_getGeoObjectCount_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Geometry3D::CGeoPolylineEx *pObjectX = (EarthView::World::Geometry3D::CGeoPolylineEx*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCGeoPolylineExProxy))
				{
					ev_uint64 __values1 = pObjectX->EarthView::World::Geometry3D::CGeoPolylineEx::getGeoObjectCount();
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_GeoPolylineEx_register_1getGeoObjectCount_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCGeoPolylineExProxy *pObjectX = (JCGeoPolylineExProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_geometry3d_GeoPolylineEx_getGeoObjectCount_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Geometry3D::CGeoPolylineEx *pObjectX = (EarthView::World::Geometry3D::CGeoPolylineEx*) pObjXXXX;
				ev_uint64 __values1 = pObjectX->EarthView::World::Geometry3D::CGeoPolylineEx::getGeoObjectCount();
				EarthView::World::Core::ev_string __values1_ch;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_GeoPolylineEx_render_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Geometry3D::CGeoPolylineEx *pObjectX = (EarthView::World::Geometry3D::CGeoPolylineEx*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCGeoPolylineExProxy))
				{
					pObjectX->EarthView::World::Geometry3D::CGeoPolylineEx::render();
				}
				else
				{
					pObjectX->render();
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_GeoPolylineEx_register_1render_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCGeoPolylineExProxy *pObjectX = (JCGeoPolylineExProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_GeoPolylineEx_render_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Geometry3D::CGeoPolylineEx *pObjectX = (EarthView::World::Geometry3D::CGeoPolylineEx*) pObjXXXX;
				pObjectX->EarthView::World::Geometry3D::CGeoPolylineEx::render();
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_GeoPolylineEx_derender_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Geometry3D::CGeoPolylineEx *pObjectX = (EarthView::World::Geometry3D::CGeoPolylineEx*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCGeoPolylineExProxy))
				{
					pObjectX->EarthView::World::Geometry3D::CGeoPolylineEx::derender();
				}
				else
				{
					pObjectX->derender();
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_GeoPolylineEx_register_1derender_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCGeoPolylineExProxy *pObjectX = (JCGeoPolylineExProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_GeoPolylineEx_derender_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Geometry3D::CGeoPolylineEx *pObjectX = (EarthView::World::Geometry3D::CGeoPolylineEx*) pObjXXXX;
				pObjectX->EarthView::World::Geometry3D::CGeoPolylineEx::derender();
			}
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_geometry3d_GeoPolylineEx_isRendering_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Geometry3D::CGeoPolylineEx *pObjectX = (EarthView::World::Geometry3D::CGeoPolylineEx*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCGeoPolylineExProxy))
				{
					ev_bool __values1 = pObjectX->EarthView::World::Geometry3D::CGeoPolylineEx::isRendering();
					jboolean __values1_j = (jboolean)__values1;
					return __values1_j;
				}
				else
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_GeoPolylineEx_register_1isRendering_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCGeoPolylineExProxy *pObjectX = (JCGeoPolylineExProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_geometry3d_GeoPolylineEx_isRendering_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Geometry3D::CGeoPolylineEx *pObjectX = (EarthView::World::Geometry3D::CGeoPolylineEx*) pObjXXXX;
				ev_bool __values1 = pObjectX->EarthView::World::Geometry3D::CGeoPolylineEx::isRendering();
				jboolean __values1_j = (jboolean)__values1;
			...
			extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_geometry3d_GeoPolylineEx_getClampMode_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Geometry3D::CGeoPolylineEx *pObjectX = (EarthView::World::Geometry3D::CGeoPolylineEx*) pObjXXXX;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_GeoPolylineEx_setClampMode_1ClampMode(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint mode_j)
			{
