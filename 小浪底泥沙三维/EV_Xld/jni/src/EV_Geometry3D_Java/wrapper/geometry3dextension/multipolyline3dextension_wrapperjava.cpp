...
namespace EarthView
{
	namespace World
	{
		...
		{
			class JCMultiPolyline3DExtensionProxy : public EarthView::World::Geometry3D::CMultiPolyline3DExtension
			{
			 private:
			...
			public:
				JCMultiPolyline3DExtensionProxy(EarthView::World::Core::CNameValuePairList *pList) : CMultiPolyline3DExtension(pList)
				{
				}
			...
			public:
				...
				virtual void build()
				{
					...
					{
						return this->CMultiPolyline3DExtension::build();
					}
				}
				virtual void build(EarthView::World::Geometry3D::CSubMeshDataVector& subMeshData)
				{
					...
					{
						return this->CMultiPolyline3DExtension::build(subMeshData);
					}
				}
				virtual void render()
				{
					...
					{
						return this->CMultiPolyline3DExtension::render();
					}
				}
				virtual void derender()
				{
					...
					{
						return this->CMultiPolyline3DExtension::derender();
					}
				}
				virtual ev_bool attachToNode(EarthView::World::Graphic::CNode* n)
				{
					...
					{
						return this->CMultiPolyline3DExtension::attachToNode(n);
					}
				}
				virtual EarthView::World::Graphic::CNode* detachFromNode()
				{
					...
					{
						return this->CMultiPolyline3DExtension::detachFromNode();
					}
				}
				virtual ev_bool attachToScene()
				{
					...
					{
						return this->CMultiPolyline3DExtension::attachToScene();
					}
				}
				virtual ev_bool detachFromScene()
				{
					...
					{
						return this->CMultiPolyline3DExtension::detachFromScene();
					}
				}
				virtual void setUserData(EarthView::World::Spatial3D::CFeatureUserData& userData)
				{
					...
					{
						return this->CMultiPolyline3DExtension::setUserData(userData);
					}
				}
				virtual void updateLabel(ev_bool resetTextStyle, ev_bool derenderTxt, ev_bool reCreate, ev_bool attachLabel, EarthView::World::Graphic::CCamera* pCamera)
				{
					...
					{
						return this->CMultiPolyline3DExtension::updateLabel(resetTextStyle, derenderTxt, reCreate, attachLabel, pCamera);
					}
				}
				virtual void updateByCamera(EarthView::World::Graphic::CCamera* pCamera)
				{
					...
					{
						return this->CMultiPolyline3DExtension::updateByCamera(pCamera);
					}
				}
				virtual void setLabelVisibleDistance(ev_real64 dis)
				{
					...
					{
						return this->CMultiPolyline3DExtension::setLabelVisibleDistance(dis);
					}
				}
				virtual void setLabelProjOffsetMaxAngle(Real angle)
				{
					...
					{
						return this->CMultiPolyline3DExtension::setLabelProjOffsetMaxAngle(angle);
					}
				}
				virtual void setLabelProjOffsetEnable(ev_bool useProjOffset)
				{
					...
					{
						return this->CMultiPolyline3DExtension::setLabelProjOffsetEnable(useProjOffset);
					}
				}
				virtual void setLabelProjOffset(Real offset)
				{
					...
					{
						return this->CMultiPolyline3DExtension::setLabelProjOffset(offset);
					}
				}
				virtual ev_bool updateMaterial()
				{
					...
					{
						return this->CMultiPolyline3DExtension::updateMaterial();
					}
				}
				virtual EarthView::World::Graphic::CMeshPtr getMesh()
				{
					...
					{
						return this->CMultiPolyline3DExtension::getMesh();
					}
				}
				virtual ev_bool setVisibilityFilter(ev_bool visible, const EarthView::World::Core::IntVector& ids)
				{
					...
					{
						return this->CMultiPolyline3DExtension::setVisibilityFilter(visible, ids);
					}
				}
				virtual ev_bool isLoaded()
				{
					...
					{
						return this->CMultiPolyline3DExtension::isLoaded();
					}
				}
				virtual ev_bool isAttached()
				{
					...
					{
						return this->CMultiPolyline3DExtension::isAttached();
					}
				}
				virtual ev_bool load()
				{
					...
					{
						return this->CMultiPolyline3DExtension::load();
					}
				}
				virtual ev_bool unload()
				{
					...
					{
						return this->CMultiPolyline3DExtension::unload();
					}
				}
				virtual ev_bool appendGeoObject(EarthView::World::Spatial::CGeoObject* ref_geoObject)
				{
					...
					{
						return this->CMultiPolyline3DExtension::appendGeoObject(ref_geoObject);
					}
				}
				virtual ev_bool removeGeoObject(EarthView::World::Spatial::CGeoObject* geoObject)
				{
					...
					{
						return this->CMultiPolyline3DExtension::removeGeoObject(geoObject);
					}
				}
				virtual void removeAllGeoObjects()
				{
					...
					{
						return this->CMultiPolyline3DExtension::removeAllGeoObjects();
					}
				}
				virtual EarthView::World::Spatial::CGeoObject* getGeoObject(ev_uint32 index) const
				{
					...
					{
						return this->CMultiPolyline3DExtension::getGeoObject(index);
					}
				}
				virtual ev_uint64 getGeoObjectCount() const
				{
					...
					{
						return this->CMultiPolyline3DExtension::getGeoObjectCount();
					}
				}
				virtual ev_bool getDrawWireBoundingBox() const
				{
					...
					{
						return this->CMultiPolyline3DExtension::getDrawWireBoundingBox();
					}
				}
				virtual void setDrawWireBoundingBox(ev_bool isdraw)
				{
					...
					{
						return this->CMultiPolyline3DExtension::setDrawWireBoundingBox(isdraw);
					}
				}
				virtual ev_bool isRendering() const
				{
					...
					{
						return this->CMultiPolyline3DExtension::isRendering();
					}
				}
				virtual void setVisible(ev_bool visible)
				{
					...
					{
						return this->CMultiPolyline3DExtension::setVisible(visible);
					}
				}
				virtual void setDenseInterpolation(ev_bool dense)
				{
					...
					{
						return this->CMultiPolyline3DExtension::setDenseInterpolation(dense);
					}
				}
				virtual void setSelectable(ev_bool selectable)
				{
					...
					{
						return this->CMultiPolyline3DExtension::setSelectable(selectable);
					}
				}
				virtual ev_real64 getLabelVisibleDistance()
				{
					...
					{
						return this->CMultiPolyline3DExtension::getLabelVisibleDistance();
					}
				}
				virtual Real getLabelProjOffsetMaxAngle() const
				{
					...
					{
						return this->CMultiPolyline3DExtension::getLabelProjOffsetMaxAngle();
					}
				}
				virtual ev_bool getLabelProjOffsetEnable() const
				{
					...
					{
						return this->CMultiPolyline3DExtension::getLabelProjOffsetEnable();
					}
				}
				virtual Real getLabelProjOffset() const
				{
					...
					{
						return this->CMultiPolyline3DExtension::getLabelProjOffset();
					}
				}
				virtual ev_bool setObjectVisibility(ev_bool visible, EarthView::World::Spatial::CGeoObject* ref_geoObject)
				{
					...
					{
						return this->CMultiPolyline3DExtension::setObjectVisibility(visible, ref_geoObject);
					}
				}
				virtual EarthView::World::Graphic::CNode* getNode()
				{
					...
					{
						return this->CMultiPolyline3DExtension::getNode();
					}
				}
				virtual ev_bool getSelectable()
				{
					...
					{
						return this->CMultiPolyline3DExtension::getSelectable();
					}
				}
				virtual ev_bool update()
				{
					...
					{
						return this->CMultiPolyline3DExtension::update();
					}
				}
				virtual EarthView::World::Spatial3D::Atlas::IGlobeLayer* getLayer()
				{
					...
					{
						return this->CMultiPolyline3DExtension::getLayer();
					}
				}
				virtual EarthView::World::Spatial::GeoDataset::IDataset* getDataset()
				{
					...
					{
						return this->CMultiPolyline3DExtension::getDataset();
					}
				}
				virtual ev_uint32 getID()
				{
					...
					{
						return this->CMultiPolyline3DExtension::getID();
					}
				}
				virtual EVString getName()
				{
					...
					{
						return this->CMultiPolyline3DExtension::getName();
					}
				}
				virtual void setMatrix(const EarthView::World::Spatial::Math::CMatrix4& m)
				{
					...
					{
						return this->CMultiPolyline3DExtension::setMatrix(m);
					}
				}
				virtual EarthView::World::Spatial::Math::CMatrix4 getMatrix()
				{
					...
					{
						return this->CMultiPolyline3DExtension::getMatrix();
					}
				}
				virtual void setPosition(ev_real64 latitude, ev_real64 longitude, ev_real64 altitude, const EarthView::World::Spatial::Math::CVector3& scale, const EarthView::World::Spatial::Math::CQuaternion& qua)
				{
					...
					{
						return this->CMultiPolyline3DExtension::setPosition(latitude, longitude, altitude, scale, qua);
					}
				}
				virtual void getPosition(ev_real64& latitude, ev_real64& longitude, ev_real64& altitude, EarthView::World::Spatial::Math::CVector3& scale, EarthView::World::Spatial::Math::CQuaternion& qua)
				{
					...
					{
						return this->CMultiPolyline3DExtension::getPosition(latitude, longitude, altitude, scale, qua);
					}
				}
			};
			REGISTER_FACTORY_CLASS(JCMultiPolyline3DExtensionProxy);
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_build_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Geometry3D::CMultiPolyline3DExtension *pObjectX = (EarthView::World::Geometry3D::CMultiPolyline3DExtension*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCMultiPolyline3DExtensionProxy))
				{
					pObjectX->EarthView::World::Geometry3D::CMultiPolyline3DExtension::build();
				}
				else
				{
					pObjectX->build();
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_register_1build_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMultiPolyline3DExtensionProxy *pObjectX = (JCMultiPolyline3DExtensionProxy*) pObjXXXX;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_build_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Geometry3D::CMultiPolyline3DExtension *pObjectX = (EarthView::World::Geometry3D::CMultiPolyline3DExtension*) pObjXXXX;
				pObjectX->EarthView::World::Geometry3D::CMultiPolyline3DExtension::build();
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_build_1CSubMeshDataVector(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong subMeshData_j)
			{
				EarthView::World::Geometry3D::CSubMeshDataVector &subMeshData = *(EarthView::World::Geometry3D::CSubMeshDataVector*) subMeshData_j;
				EarthView::World::Geometry3D::CMultiPolyline3DExtension *pObjectX = (EarthView::World::Geometry3D::CMultiPolyline3DExtension*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCMultiPolyline3DExtensionProxy))
				{
					pObjectX->EarthView::World::Geometry3D::CMultiPolyline3DExtension::build(subMeshData);
				}
				else
				{
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_register_1build_1CSubMeshDataVector(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMultiPolyline3DExtensionProxy *pObjectX = (JCMultiPolyline3DExtensionProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_build_1CSubMeshDataVector_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong subMeshData_j)
			{
				EarthView::World::Geometry3D::CSubMeshDataVector &subMeshData = *(EarthView::World::Geometry3D::CSubMeshDataVector*) subMeshData_j;
				EarthView::World::Geometry3D::CMultiPolyline3DExtension *pObjectX = (EarthView::World::Geometry3D::CMultiPolyline3DExtension*) pObjXXXX;
				pObjectX->EarthView::World::Geometry3D::CMultiPolyline3DExtension::build(subMeshData);
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_render_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Geometry3D::CMultiPolyline3DExtension *pObjectX = (EarthView::World::Geometry3D::CMultiPolyline3DExtension*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCMultiPolyline3DExtensionProxy))
				{
					pObjectX->EarthView::World::Geometry3D::CMultiPolyline3DExtension::render();
				}
				else
				{
					pObjectX->render();
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_register_1render_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMultiPolyline3DExtensionProxy *pObjectX = (JCMultiPolyline3DExtensionProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_render_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Geometry3D::CMultiPolyline3DExtension *pObjectX = (EarthView::World::Geometry3D::CMultiPolyline3DExtension*) pObjXXXX;
				pObjectX->EarthView::World::Geometry3D::CMultiPolyline3DExtension::render();
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_derender_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Geometry3D::CMultiPolyline3DExtension *pObjectX = (EarthView::World::Geometry3D::CMultiPolyline3DExtension*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCMultiPolyline3DExtensionProxy))
				{
					pObjectX->EarthView::World::Geometry3D::CMultiPolyline3DExtension::derender();
				}
				else
				{
					pObjectX->derender();
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_register_1derender_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMultiPolyline3DExtensionProxy *pObjectX = (JCMultiPolyline3DExtensionProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_derender_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Geometry3D::CMultiPolyline3DExtension *pObjectX = (EarthView::World::Geometry3D::CMultiPolyline3DExtension*) pObjXXXX;
				pObjectX->EarthView::World::Geometry3D::CMultiPolyline3DExtension::derender();
			}
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_attachToNode_1CNode(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong n_j)
			{
				EarthView::World::Graphic::CNode *n = (EarthView::World::Graphic::CNode*) n_j;
				EarthView::World::Geometry3D::CMultiPolyline3DExtension *pObjectX = (EarthView::World::Geometry3D::CMultiPolyline3DExtension*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCMultiPolyline3DExtensionProxy))
				{
					ev_bool __values1 = pObjectX->EarthView::World::Geometry3D::CMultiPolyline3DExtension::attachToNode(n);
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_register_1attachToNode_1CNode(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMultiPolyline3DExtensionProxy *pObjectX = (JCMultiPolyline3DExtensionProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_attachToNode_1CNode_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong n_j)
			{
				EarthView::World::Graphic::CNode *n = (EarthView::World::Graphic::CNode*) n_j;
				EarthView::World::Geometry3D::CMultiPolyline3DExtension *pObjectX = (EarthView::World::Geometry3D::CMultiPolyline3DExtension*) pObjXXXX;
				ev_bool __values1 = pObjectX->EarthView::World::Geometry3D::CMultiPolyline3DExtension::attachToNode(n);
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_detachFromNode_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Geometry3D::CMultiPolyline3DExtension *pObjectX = (EarthView::World::Geometry3D::CMultiPolyline3DExtension*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCMultiPolyline3DExtensionProxy))
				{
					EarthView::World::Graphic::CNode* __values1 = pObjectX->EarthView::World::Geometry3D::CMultiPolyline3DExtension::detachFromNode();
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_register_1detachFromNode_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMultiPolyline3DExtensionProxy *pObjectX = (JCMultiPolyline3DExtensionProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_detachFromNode_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Geometry3D::CMultiPolyline3DExtension *pObjectX = (EarthView::World::Geometry3D::CMultiPolyline3DExtension*) pObjXXXX;
				EarthView::World::Graphic::CNode* __values1 = pObjectX->EarthView::World::Geometry3D::CMultiPolyline3DExtension::detachFromNode();
				jlong __values1_j = (jlong) __values1;
			...
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_attachToScene_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Geometry3D::CMultiPolyline3DExtension *pObjectX = (EarthView::World::Geometry3D::CMultiPolyline3DExtension*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCMultiPolyline3DExtensionProxy))
				{
					ev_bool __values1 = pObjectX->EarthView::World::Geometry3D::CMultiPolyline3DExtension::attachToScene();
					jboolean __values1_j = (jboolean)__values1;
					return __values1_j;
				}
				else
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_register_1attachToScene_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMultiPolyline3DExtensionProxy *pObjectX = (JCMultiPolyline3DExtensionProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_attachToScene_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Geometry3D::CMultiPolyline3DExtension *pObjectX = (EarthView::World::Geometry3D::CMultiPolyline3DExtension*) pObjXXXX;
				ev_bool __values1 = pObjectX->EarthView::World::Geometry3D::CMultiPolyline3DExtension::attachToScene();
				jboolean __values1_j = (jboolean)__values1;
			...
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_detachFromScene_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Geometry3D::CMultiPolyline3DExtension *pObjectX = (EarthView::World::Geometry3D::CMultiPolyline3DExtension*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCMultiPolyline3DExtensionProxy))
				{
					ev_bool __values1 = pObjectX->EarthView::World::Geometry3D::CMultiPolyline3DExtension::detachFromScene();
					jboolean __values1_j = (jboolean)__values1;
					return __values1_j;
				}
				else
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_register_1detachFromScene_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMultiPolyline3DExtensionProxy *pObjectX = (JCMultiPolyline3DExtensionProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_detachFromScene_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Geometry3D::CMultiPolyline3DExtension *pObjectX = (EarthView::World::Geometry3D::CMultiPolyline3DExtension*) pObjXXXX;
				ev_bool __values1 = pObjectX->EarthView::World::Geometry3D::CMultiPolyline3DExtension::detachFromScene();
				jboolean __values1_j = (jboolean)__values1;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_setUserData_1CFeatureUserData(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong userData_j)
			{
				EarthView::World::Spatial3D::CFeatureUserData &userData = *(EarthView::World::Spatial3D::CFeatureUserData*) userData_j;
				EarthView::World::Geometry3D::CMultiPolyline3DExtension *pObjectX = (EarthView::World::Geometry3D::CMultiPolyline3DExtension*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCMultiPolyline3DExtensionProxy))
				{
					pObjectX->EarthView::World::Geometry3D::CMultiPolyline3DExtension::setUserData(userData);
				}
				else
				{
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_register_1setUserData_1CFeatureUserData(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMultiPolyline3DExtensionProxy *pObjectX = (JCMultiPolyline3DExtensionProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_setUserData_1CFeatureUserData_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong userData_j)
			{
				EarthView::World::Spatial3D::CFeatureUserData &userData = *(EarthView::World::Spatial3D::CFeatureUserData*) userData_j;
				EarthView::World::Geometry3D::CMultiPolyline3DExtension *pObjectX = (EarthView::World::Geometry3D::CMultiPolyline3DExtension*) pObjXXXX;
				pObjectX->EarthView::World::Geometry3D::CMultiPolyline3DExtension::setUserData(userData);
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_updateLabel_1ev_1bool_1ev_1bool_1ev_1bool_1ev_1bool_1CCamera(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean resetTextStyle_j, jboolean derenderTxt_j, jboolean reCreate_j, jboolean attachLabel_j, jlong pCamera_j)
			{
				...
				if (typeid(*pObjectX) == typeid(JCMultiPolyline3DExtensionProxy))
				{
					pObjectX->EarthView::World::Geometry3D::CMultiPolyline3DExtension::updateLabel(resetTextStyle, derenderTxt, reCreate, attachLabel, pCamera);
				}
				else
				{
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_register_1updateLabel_1ev_1bool_1ev_1bool_1ev_1bool_1ev_1bool_1CCamera(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMultiPolyline3DExtensionProxy *pObjectX = (JCMultiPolyline3DExtensionProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_updateLabel_1ev_1bool_1ev_1bool_1ev_1bool_1ev_1bool_1CCamera_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean resetTextStyle_j, jboolean derenderTxt_j, jboolean reCreate_j, jboolean attachLabel_j, jlong pCamera_j)
			{
				ev_bool resetTextStyle = (ev_bool) resetTextStyle_j;
				ev_bool derenderTxt = (ev_bool) derenderTxt_j;
				ev_bool reCreate = (ev_bool) reCreate_j;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_updateByCamera_1CCamera(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong pCamera_j)
			{
				EarthView::World::Graphic::CCamera *pCamera = (EarthView::World::Graphic::CCamera*) pCamera_j;
				EarthView::World::Geometry3D::CMultiPolyline3DExtension *pObjectX = (EarthView::World::Geometry3D::CMultiPolyline3DExtension*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCMultiPolyline3DExtensionProxy))
				{
					pObjectX->EarthView::World::Geometry3D::CMultiPolyline3DExtension::updateByCamera(pCamera);
				}
				else
				{
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_register_1updateByCamera_1CCamera(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMultiPolyline3DExtensionProxy *pObjectX = (JCMultiPolyline3DExtensionProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_updateByCamera_1CCamera_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong pCamera_j)
			{
				EarthView::World::Graphic::CCamera *pCamera = (EarthView::World::Graphic::CCamera*) pCamera_j;
				EarthView::World::Geometry3D::CMultiPolyline3DExtension *pObjectX = (EarthView::World::Geometry3D::CMultiPolyline3DExtension*) pObjXXXX;
				pObjectX->EarthView::World::Geometry3D::CMultiPolyline3DExtension::updateByCamera(pCamera);
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_setLabelVisibleDistance_1ev_1real64(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble dis_j)
			{
				ev_real64 dis = (ev_real64) dis_j;
				EarthView::World::Geometry3D::CMultiPolyline3DExtension *pObjectX = (EarthView::World::Geometry3D::CMultiPolyline3DExtension*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCMultiPolyline3DExtensionProxy))
				{
					pObjectX->EarthView::World::Geometry3D::CMultiPolyline3DExtension::setLabelVisibleDistance(dis);
				}
				else
				{
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_register_1setLabelVisibleDistance_1ev_1real64(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMultiPolyline3DExtensionProxy *pObjectX = (JCMultiPolyline3DExtensionProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_setLabelVisibleDistance_1ev_1real64_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble dis_j)
			{
				ev_real64 dis = (ev_real64) dis_j;
				EarthView::World::Geometry3D::CMultiPolyline3DExtension *pObjectX = (EarthView::World::Geometry3D::CMultiPolyline3DExtension*) pObjXXXX;
				pObjectX->EarthView::World::Geometry3D::CMultiPolyline3DExtension::setLabelVisibleDistance(dis);
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_setLabelProjOffsetMaxAngle_1Real(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble angle_j)
			{
				Real angle = (Real) angle_j;
				EarthView::World::Geometry3D::CMultiPolyline3DExtension *pObjectX = (EarthView::World::Geometry3D::CMultiPolyline3DExtension*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCMultiPolyline3DExtensionProxy))
				{
					pObjectX->EarthView::World::Geometry3D::CMultiPolyline3DExtension::setLabelProjOffsetMaxAngle(angle);
				}
				else
				{
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_register_1setLabelProjOffsetMaxAngle_1Real(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMultiPolyline3DExtensionProxy *pObjectX = (JCMultiPolyline3DExtensionProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_setLabelProjOffsetMaxAngle_1Real_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble angle_j)
			{
				Real angle = (Real) angle_j;
				EarthView::World::Geometry3D::CMultiPolyline3DExtension *pObjectX = (EarthView::World::Geometry3D::CMultiPolyline3DExtension*) pObjXXXX;
				pObjectX->EarthView::World::Geometry3D::CMultiPolyline3DExtension::setLabelProjOffsetMaxAngle(angle);
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_setLabelProjOffsetEnable_1ev_1bool(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean useProjOffset_j)
			{
				ev_bool useProjOffset = (ev_bool) useProjOffset_j;
				EarthView::World::Geometry3D::CMultiPolyline3DExtension *pObjectX = (EarthView::World::Geometry3D::CMultiPolyline3DExtension*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCMultiPolyline3DExtensionProxy))
				{
					pObjectX->EarthView::World::Geometry3D::CMultiPolyline3DExtension::setLabelProjOffsetEnable(useProjOffset);
				}
				else
				{
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_register_1setLabelProjOffsetEnable_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMultiPolyline3DExtensionProxy *pObjectX = (JCMultiPolyline3DExtensionProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_setLabelProjOffsetEnable_1ev_1bool_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean useProjOffset_j)
			{
				ev_bool useProjOffset = (ev_bool) useProjOffset_j;
				EarthView::World::Geometry3D::CMultiPolyline3DExtension *pObjectX = (EarthView::World::Geometry3D::CMultiPolyline3DExtension*) pObjXXXX;
				pObjectX->EarthView::World::Geometry3D::CMultiPolyline3DExtension::setLabelProjOffsetEnable(useProjOffset);
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_setLabelProjOffset_1Real(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble offset_j)
			{
				Real offset = (Real) offset_j;
				EarthView::World::Geometry3D::CMultiPolyline3DExtension *pObjectX = (EarthView::World::Geometry3D::CMultiPolyline3DExtension*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCMultiPolyline3DExtensionProxy))
				{
					pObjectX->EarthView::World::Geometry3D::CMultiPolyline3DExtension::setLabelProjOffset(offset);
				}
				else
				{
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_register_1setLabelProjOffset_1Real(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMultiPolyline3DExtensionProxy *pObjectX = (JCMultiPolyline3DExtensionProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_setLabelProjOffset_1Real_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble offset_j)
			{
				Real offset = (Real) offset_j;
				EarthView::World::Geometry3D::CMultiPolyline3DExtension *pObjectX = (EarthView::World::Geometry3D::CMultiPolyline3DExtension*) pObjXXXX;
				pObjectX->EarthView::World::Geometry3D::CMultiPolyline3DExtension::setLabelProjOffset(offset);
			}
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_updateMaterial_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Geometry3D::CMultiPolyline3DExtension *pObjectX = (EarthView::World::Geometry3D::CMultiPolyline3DExtension*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCMultiPolyline3DExtensionProxy))
				{
					ev_bool __values1 = pObjectX->EarthView::World::Geometry3D::CMultiPolyline3DExtension::updateMaterial();
					jboolean __values1_j = (jboolean)__values1;
					return __values1_j;
				}
				else
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_register_1updateMaterial_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMultiPolyline3DExtensionProxy *pObjectX = (JCMultiPolyline3DExtensionProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_updateMaterial_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Geometry3D::CMultiPolyline3DExtension *pObjectX = (EarthView::World::Geometry3D::CMultiPolyline3DExtension*) pObjXXXX;
				ev_bool __values1 = pObjectX->EarthView::World::Geometry3D::CMultiPolyline3DExtension::updateMaterial();
				jboolean __values1_j = (jboolean)__values1;
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_getMesh_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Geometry3D::CMultiPolyline3DExtension *pObjectX = (EarthView::World::Geometry3D::CMultiPolyline3DExtension*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCMultiPolyline3DExtensionProxy))
				{
					EarthView::World::Graphic::CMeshPtr __values1 = pObjectX->EarthView::World::Geometry3D::CMultiPolyline3DExtension::getMesh();
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_register_1getMesh_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMultiPolyline3DExtensionProxy *pObjectX = (JCMultiPolyline3DExtensionProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_getMesh_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Geometry3D::CMultiPolyline3DExtension *pObjectX = (EarthView::World::Geometry3D::CMultiPolyline3DExtension*) pObjXXXX;
				EarthView::World::Graphic::CMeshPtr __values1 = pObjectX->EarthView::World::Geometry3D::CMultiPolyline3DExtension::getMesh();
				EarthView::World::Graphic::CMeshPtr *returnvalues = new EarthView::World::Graphic::CMeshPtr(__values1);
			...
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_setVisibilityFilter_1ev_1bool_1IntVector(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean visible_j, jlong ids_j)
			{
				...
				if (typeid(*pObjectX) == typeid(JCMultiPolyline3DExtensionProxy))
				{
					ev_bool __values1 = pObjectX->EarthView::World::Geometry3D::CMultiPolyline3DExtension::setVisibilityFilter(visible, ids);
					jboolean __values1_j = (jboolean)__values1;
					return __values1_j;
				}
				else
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_register_1setVisibilityFilter_1ev_1bool_1IntVector(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMultiPolyline3DExtensionProxy *pObjectX = (JCMultiPolyline3DExtensionProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_setVisibilityFilter_1ev_1bool_1IntVector_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean visible_j, jlong ids_j)
			{
				ev_bool visible = (ev_bool) visible_j;
				const EarthView::World::Core::IntVector &ids = *(EarthView::World::Core::IntVector*) ids_j;
				EarthView::World::Geometry3D::CMultiPolyline3DExtension *pObjectX = (EarthView::World::Geometry3D::CMultiPolyline3DExtension*) pObjXXXX;
			...
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_isLoaded_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Geometry3D::CMultiPolyline3DExtension *pObjectX = (EarthView::World::Geometry3D::CMultiPolyline3DExtension*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCMultiPolyline3DExtensionProxy))
				{
					ev_bool __values1 = pObjectX->EarthView::World::Geometry3D::CMultiPolyline3DExtension::isLoaded();
					jboolean __values1_j = (jboolean)__values1;
					return __values1_j;
				}
				else
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_register_1isLoaded_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMultiPolyline3DExtensionProxy *pObjectX = (JCMultiPolyline3DExtensionProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_isLoaded_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Geometry3D::CMultiPolyline3DExtension *pObjectX = (EarthView::World::Geometry3D::CMultiPolyline3DExtension*) pObjXXXX;
				ev_bool __values1 = pObjectX->EarthView::World::Geometry3D::CMultiPolyline3DExtension::isLoaded();
				jboolean __values1_j = (jboolean)__values1;
			...
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_isAttached_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Geometry3D::CMultiPolyline3DExtension *pObjectX = (EarthView::World::Geometry3D::CMultiPolyline3DExtension*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCMultiPolyline3DExtensionProxy))
				{
					ev_bool __values1 = pObjectX->EarthView::World::Geometry3D::CMultiPolyline3DExtension::isAttached();
					jboolean __values1_j = (jboolean)__values1;
					return __values1_j;
				}
				else
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_register_1isAttached_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMultiPolyline3DExtensionProxy *pObjectX = (JCMultiPolyline3DExtensionProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_isAttached_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Geometry3D::CMultiPolyline3DExtension *pObjectX = (EarthView::World::Geometry3D::CMultiPolyline3DExtension*) pObjXXXX;
				ev_bool __values1 = pObjectX->EarthView::World::Geometry3D::CMultiPolyline3DExtension::isAttached();
				jboolean __values1_j = (jboolean)__values1;
			...
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_load_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Geometry3D::CMultiPolyline3DExtension *pObjectX = (EarthView::World::Geometry3D::CMultiPolyline3DExtension*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCMultiPolyline3DExtensionProxy))
				{
					ev_bool __values1 = pObjectX->EarthView::World::Geometry3D::CMultiPolyline3DExtension::load();
					jboolean __values1_j = (jboolean)__values1;
					return __values1_j;
				}
				else
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_register_1load_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMultiPolyline3DExtensionProxy *pObjectX = (JCMultiPolyline3DExtensionProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_load_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Geometry3D::CMultiPolyline3DExtension *pObjectX = (EarthView::World::Geometry3D::CMultiPolyline3DExtension*) pObjXXXX;
				ev_bool __values1 = pObjectX->EarthView::World::Geometry3D::CMultiPolyline3DExtension::load();
				jboolean __values1_j = (jboolean)__values1;
			...
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_unload_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Geometry3D::CMultiPolyline3DExtension *pObjectX = (EarthView::World::Geometry3D::CMultiPolyline3DExtension*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCMultiPolyline3DExtensionProxy))
				{
					ev_bool __values1 = pObjectX->EarthView::World::Geometry3D::CMultiPolyline3DExtension::unload();
					jboolean __values1_j = (jboolean)__values1;
					return __values1_j;
				}
				else
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_register_1unload_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMultiPolyline3DExtensionProxy *pObjectX = (JCMultiPolyline3DExtensionProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_unload_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Geometry3D::CMultiPolyline3DExtension *pObjectX = (EarthView::World::Geometry3D::CMultiPolyline3DExtension*) pObjXXXX;
				ev_bool __values1 = pObjectX->EarthView::World::Geometry3D::CMultiPolyline3DExtension::unload();
				jboolean __values1_j = (jboolean)__values1;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_setNeedCalLabelPosition_1ev_1bool(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean value_j)
			{
				ev_bool value = (ev_bool) value_j;
				EarthView::World::Geometry3D::CMultiPolyline3DExtension *pObjectX = (EarthView::World::Geometry3D::CMultiPolyline3DExtension*) pObjXXXX;
				pObjectX->setNeedCalLabelPosition(value);
			}
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_getLabelAndStatisticsPositionStream_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Geometry3D::CMultiPolyline3DExtension *pObjectX = (EarthView::World::Geometry3D::CMultiPolyline3DExtension*) pObjXXXX;
			...
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_setLabelAndStatisticsPositionStream_1MemoryDataStreamPtr(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong labelPositions_j)
			{
			...
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_setRoadTransparent_1Real(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble transperent_j)
			{
				Real transperent = (Real) transperent_j;
				EarthView::World::Geometry3D::CMultiPolyline3DExtension *pObjectX = (EarthView::World::Geometry3D::CMultiPolyline3DExtension*) pObjXXXX;
				ev_bool __values1 = pObjectX->setRoadTransparent(transperent);
				jboolean __values1_j = (jboolean)__values1;
				return __values1_j;
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_register_1appendGeoObject_1CGeoObject(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMultiPolyline3DExtensionProxy *pObjectX = (JCMultiPolyline3DExtensionProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_register_1removeGeoObject_1CGeoObject(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMultiPolyline3DExtensionProxy *pObjectX = (JCMultiPolyline3DExtensionProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_register_1removeAllGeoObjects_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMultiPolyline3DExtensionProxy *pObjectX = (JCMultiPolyline3DExtensionProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_register_1getGeoObject_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMultiPolyline3DExtensionProxy *pObjectX = (JCMultiPolyline3DExtensionProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_register_1getGeoObjectCount_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMultiPolyline3DExtensionProxy *pObjectX = (JCMultiPolyline3DExtensionProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_register_1getDrawWireBoundingBox_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMultiPolyline3DExtensionProxy *pObjectX = (JCMultiPolyline3DExtensionProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_register_1setDrawWireBoundingBox_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMultiPolyline3DExtensionProxy *pObjectX = (JCMultiPolyline3DExtensionProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_register_1isRendering_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMultiPolyline3DExtensionProxy *pObjectX = (JCMultiPolyline3DExtensionProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_register_1setVisible_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMultiPolyline3DExtensionProxy *pObjectX = (JCMultiPolyline3DExtensionProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_register_1setDenseInterpolation_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMultiPolyline3DExtensionProxy *pObjectX = (JCMultiPolyline3DExtensionProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_register_1getLabelVisibleDistance_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMultiPolyline3DExtensionProxy *pObjectX = (JCMultiPolyline3DExtensionProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_register_1getLabelProjOffsetMaxAngle_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMultiPolyline3DExtensionProxy *pObjectX = (JCMultiPolyline3DExtensionProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_register_1getLabelProjOffsetEnable_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMultiPolyline3DExtensionProxy *pObjectX = (JCMultiPolyline3DExtensionProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_register_1getLabelProjOffset_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMultiPolyline3DExtensionProxy *pObjectX = (JCMultiPolyline3DExtensionProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_register_1setObjectVisibility_1ev_1bool_1CGeoObject(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMultiPolyline3DExtensionProxy *pObjectX = (JCMultiPolyline3DExtensionProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_register_1getNode_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMultiPolyline3DExtensionProxy *pObjectX = (JCMultiPolyline3DExtensionProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_register_1setSelectable_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMultiPolyline3DExtensionProxy *pObjectX = (JCMultiPolyline3DExtensionProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_register_1getSelectable_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMultiPolyline3DExtensionProxy *pObjectX = (JCMultiPolyline3DExtensionProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_register_1update_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMultiPolyline3DExtensionProxy *pObjectX = (JCMultiPolyline3DExtensionProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_register_1getLayer_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMultiPolyline3DExtensionProxy *pObjectX = (JCMultiPolyline3DExtensionProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_register_1getDataset_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMultiPolyline3DExtensionProxy *pObjectX = (JCMultiPolyline3DExtensionProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_register_1getID_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMultiPolyline3DExtensionProxy *pObjectX = (JCMultiPolyline3DExtensionProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_register_1getName_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMultiPolyline3DExtensionProxy *pObjectX = (JCMultiPolyline3DExtensionProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_register_1setMatrix_1CMatrix4(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMultiPolyline3DExtensionProxy *pObjectX = (JCMultiPolyline3DExtensionProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_register_1getMatrix_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMultiPolyline3DExtensionProxy *pObjectX = (JCMultiPolyline3DExtensionProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_register_1setPosition_1ev_1real64_1ev_1real64_1ev_1real64_1CVector3_1CQuaternion(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMultiPolyline3DExtensionProxy *pObjectX = (JCMultiPolyline3DExtensionProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtension_register_1getPosition_1ev_1real64_1ev_1real64_1ev_1real64_1CVector3_1CQuaternion(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMultiPolyline3DExtensionProxy *pObjectX = (JCMultiPolyline3DExtensionProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			class JCMultiPolyline3DExtensionFactoryProxy : public EarthView::World::Geometry3D::CMultiPolyline3DExtensionFactory
			{
			 private:
			...
			public:
				JCMultiPolyline3DExtensionFactoryProxy(EarthView::World::Core::CNameValuePairList *pList) : CMultiPolyline3DExtensionFactory(pList)
				{
				}
				ev_void unRegisterJavaReference()
				{
			...
			public:
				...
				virtual ev_uint16 getFactoryType()
				{
					...
					{
						return this->CMultiPolyline3DExtensionFactory::getFactoryType();
					}
				}
				virtual EarthView::World::Geometry3D::VisibleObjects createRenderable(EarthView::World::Spatial::Kml::CGeoObjectExtension* geoObj, EarthView::World::Graphic::CSceneManager* scenemanager)
				{
					...
					{
						return this->CMultiPolyline3DExtensionFactory::createRenderable(geoObj, scenemanager);
					}
				}
				virtual void destoryRenderable(EarthView::World::Geometry3D::CVisibleObject* visitObj)
				{
					...
					{
						return this->CMultiPolyline3DExtensionFactory::destoryRenderable(visitObj);
					}
				}
				virtual ev_bool appendGeoObject(EarthView::World::Geometry3D::CVisibleObject* visibleObj, EarthView::World::Spatial::CGeoObject* ref_geoObject)
				{
					...
					{
						return this->CMultiPolyline3DExtensionFactory::appendGeoObject(visibleObj, ref_geoObject);
					}
				}
				virtual ev_bool removeGeoObject(EarthView::World::Geometry3D::CVisibleObject* visibleObj, EarthView::World::Spatial::CGeoObject* geoObject)
				{
					...
					{
						return this->CMultiPolyline3DExtensionFactory::removeGeoObject(visibleObj, geoObject);
					}
				}
				virtual void removeAllGeoObjects(EarthView::World::Geometry3D::CVisibleObject* visibleObj)
				{
					...
					{
						return this->CMultiPolyline3DExtensionFactory::removeAllGeoObjects(visibleObj);
					}
				}
				virtual EarthView::World::Spatial::CGeoObject* getGeoObject(EarthView::World::Geometry3D::CVisibleObject* visibleObj, ev_uint32 index) const
				{
					...
					{
						return this->CMultiPolyline3DExtensionFactory::getGeoObject(visibleObj, index);
					}
				}
				virtual ev_uint64 getGeoObjectCount(EarthView::World::Geometry3D::CVisibleObject* visibleObj) const
				{
					...
					{
						return this->CMultiPolyline3DExtensionFactory::getGeoObjectCount(visibleObj);
					}
				}
			};
			REGISTER_FACTORY_CLASS(JCMultiPolyline3DExtensionFactoryProxy);
			extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtensionFactory_getFactoryType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Geometry3D::CMultiPolyline3DExtensionFactory *pObjectX = (EarthView::World::Geometry3D::CMultiPolyline3DExtensionFactory*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCMultiPolyline3DExtensionFactoryProxy))
				{
					ev_uint16 __values1 = pObjectX->EarthView::World::Geometry3D::CMultiPolyline3DExtensionFactory::getFactoryType();
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtensionFactory_register_1getFactoryType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMultiPolyline3DExtensionFactoryProxy *pObjectX = (JCMultiPolyline3DExtensionFactoryProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
				__env->ReleaseStringUTFChars(__method, pMethod);
			...
			extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtensionFactory_getFactoryType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Geometry3D::CMultiPolyline3DExtensionFactory *pObjectX = (EarthView::World::Geometry3D::CMultiPolyline3DExtensionFactory*) pObjXXXX;
				ev_uint16 __values1 = pObjectX->EarthView::World::Geometry3D::CMultiPolyline3DExtensionFactory::getFactoryType();
				jint __values1_j = (jint) __values1;
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtensionFactory_createRenderable_1CGeoObjectExtension_1CSceneManager(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong geoObj_j, jlong scenemanager_j)
			{
				...
				if (typeid(*pObjectX) == typeid(JCMultiPolyline3DExtensionFactoryProxy))
				{
					EarthView::World::Geometry3D::VisibleObjects __values1 = pObjectX->EarthView::World::Geometry3D::CMultiPolyline3DExtensionFactory::createRenderable(geoObj, scenemanager);
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtensionFactory_register_1createRenderable_1CGeoObjectExtension_1CSceneManager(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMultiPolyline3DExtensionFactoryProxy *pObjectX = (JCMultiPolyline3DExtensionFactoryProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtensionFactory_createRenderable_1CGeoObjectExtension_1CSceneManager_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong geoObj_j, jlong scenemanager_j)
			{
				EarthView::World::Spatial::Kml::CGeoObjectExtension *geoObj = (EarthView::World::Spatial::Kml::CGeoObjectExtension*) geoObj_j;
				EarthView::World::Graphic::CSceneManager *scenemanager = (EarthView::World::Graphic::CSceneManager*) scenemanager_j;
				EarthView::World::Geometry3D::CMultiPolyline3DExtensionFactory *pObjectX = (EarthView::World::Geometry3D::CMultiPolyline3DExtensionFactory*) pObjXXXX;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtensionFactory_destoryRenderable_1CVisibleObject(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong visitObj_j)
			{
				EarthView::World::Geometry3D::CVisibleObject *visitObj = (EarthView::World::Geometry3D::CVisibleObject*) visitObj_j;
				EarthView::World::Geometry3D::CMultiPolyline3DExtensionFactory *pObjectX = (EarthView::World::Geometry3D::CMultiPolyline3DExtensionFactory*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCMultiPolyline3DExtensionFactoryProxy))
				{
					pObjectX->EarthView::World::Geometry3D::CMultiPolyline3DExtensionFactory::destoryRenderable(visitObj);
				}
				else
				{
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtensionFactory_register_1destoryRenderable_1CVisibleObject(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMultiPolyline3DExtensionFactoryProxy *pObjectX = (JCMultiPolyline3DExtensionFactoryProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtensionFactory_destoryRenderable_1CVisibleObject_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong visitObj_j)
			{
				EarthView::World::Geometry3D::CVisibleObject *visitObj = (EarthView::World::Geometry3D::CVisibleObject*) visitObj_j;
				EarthView::World::Geometry3D::CMultiPolyline3DExtensionFactory *pObjectX = (EarthView::World::Geometry3D::CMultiPolyline3DExtensionFactory*) pObjXXXX;
				pObjectX->EarthView::World::Geometry3D::CMultiPolyline3DExtensionFactory::destoryRenderable(visitObj);
			}
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtensionFactory_appendGeoObject_1CVisibleObject_1CGeoObject(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong visibleObj_j, jlong ref_geoObject_j)
			{
				...
				if (typeid(*pObjectX) == typeid(JCMultiPolyline3DExtensionFactoryProxy))
				{
					ev_bool __values1 = pObjectX->EarthView::World::Geometry3D::CMultiPolyline3DExtensionFactory::appendGeoObject(visibleObj, ref_geoObject);
					jboolean __values1_j = (jboolean)__values1;
					return __values1_j;
				}
				else
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtensionFactory_register_1appendGeoObject_1CVisibleObject_1CGeoObject(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMultiPolyline3DExtensionFactoryProxy *pObjectX = (JCMultiPolyline3DExtensionFactoryProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtensionFactory_appendGeoObject_1CVisibleObject_1CGeoObject_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong visibleObj_j, jlong ref_geoObject_j)
			{
				EarthView::World::Geometry3D::CVisibleObject *visibleObj = (EarthView::World::Geometry3D::CVisibleObject*) visibleObj_j;
				EarthView::World::Spatial::CGeoObject *ref_geoObject = (EarthView::World::Spatial::CGeoObject*) ref_geoObject_j;
				EarthView::World::Geometry3D::CMultiPolyline3DExtensionFactory *pObjectX = (EarthView::World::Geometry3D::CMultiPolyline3DExtensionFactory*) pObjXXXX;
			...
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtensionFactory_removeGeoObject_1CVisibleObject_1CGeoObject(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong visibleObj_j, jlong geoObject_j)
			{
				EarthView::World::Geometry3D::CVisibleObject *visibleObj = (EarthView::World::Geometry3D::CVisibleObject*) visibleObj_j;
				...
				if (typeid(*pObjectX) == typeid(JCMultiPolyline3DExtensionFactoryProxy))
				{
					ev_bool __values1 = pObjectX->EarthView::World::Geometry3D::CMultiPolyline3DExtensionFactory::removeGeoObject(visibleObj, geoObject);
					jboolean __values1_j = (jboolean)__values1;
					return __values1_j;
				}
				else
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtensionFactory_register_1removeGeoObject_1CVisibleObject_1CGeoObject(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMultiPolyline3DExtensionFactoryProxy *pObjectX = (JCMultiPolyline3DExtensionFactoryProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtensionFactory_removeGeoObject_1CVisibleObject_1CGeoObject_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong visibleObj_j, jlong geoObject_j)
			{
				EarthView::World::Geometry3D::CVisibleObject *visibleObj = (EarthView::World::Geometry3D::CVisibleObject*) visibleObj_j;
				EarthView::World::Spatial::CGeoObject *geoObject = (EarthView::World::Spatial::CGeoObject*) geoObject_j;
				EarthView::World::Geometry3D::CMultiPolyline3DExtensionFactory *pObjectX = (EarthView::World::Geometry3D::CMultiPolyline3DExtensionFactory*) pObjXXXX;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtensionFactory_removeAllGeoObjects_1CVisibleObject(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong visibleObj_j)
			{
				EarthView::World::Geometry3D::CVisibleObject *visibleObj = (EarthView::World::Geometry3D::CVisibleObject*) visibleObj_j;
				EarthView::World::Geometry3D::CMultiPolyline3DExtensionFactory *pObjectX = (EarthView::World::Geometry3D::CMultiPolyline3DExtensionFactory*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCMultiPolyline3DExtensionFactoryProxy))
				{
					pObjectX->EarthView::World::Geometry3D::CMultiPolyline3DExtensionFactory::removeAllGeoObjects(visibleObj);
				}
				else
				{
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtensionFactory_register_1removeAllGeoObjects_1CVisibleObject(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMultiPolyline3DExtensionFactoryProxy *pObjectX = (JCMultiPolyline3DExtensionFactoryProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtensionFactory_removeAllGeoObjects_1CVisibleObject_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong visibleObj_j)
			{
				EarthView::World::Geometry3D::CVisibleObject *visibleObj = (EarthView::World::Geometry3D::CVisibleObject*) visibleObj_j;
				EarthView::World::Geometry3D::CMultiPolyline3DExtensionFactory *pObjectX = (EarthView::World::Geometry3D::CMultiPolyline3DExtensionFactory*) pObjXXXX;
				pObjectX->EarthView::World::Geometry3D::CMultiPolyline3DExtensionFactory::removeAllGeoObjects(visibleObj);
			}
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtensionFactory_getGeoObject_1CVisibleObject_1ev_1uint32(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong visibleObj_j, jlong index_j)
			{
				EarthView::World::Geometry3D::CVisibleObject *visibleObj = (EarthView::World::Geometry3D::CVisibleObject*) visibleObj_j;
				ev_uint32 index = (ev_uint32) index_j;
				const 				EarthView::World::Geometry3D::CMultiPolyline3DExtensionFactory *pObjectX = (EarthView::World::Geometry3D::CMultiPolyline3DExtensionFactory*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCMultiPolyline3DExtensionFactoryProxy))
				{
					EarthView::World::Spatial::CGeoObject* __values1 = pObjectX->EarthView::World::Geometry3D::CMultiPolyline3DExtensionFactory::getGeoObject(visibleObj, index);
					jlong __values1_j = (jlong) __values1;
					return __values1_j;
				}
				else
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtensionFactory_register_1getGeoObject_1CVisibleObject_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMultiPolyline3DExtensionFactoryProxy *pObjectX = (JCMultiPolyline3DExtensionFactoryProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtensionFactory_getGeoObject_1CVisibleObject_1ev_1uint32_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong visibleObj_j, jlong index_j)
			{
				EarthView::World::Geometry3D::CVisibleObject *visibleObj = (EarthView::World::Geometry3D::CVisibleObject*) visibleObj_j;
				ev_uint32 index = (ev_uint32) index_j;
				const 				EarthView::World::Geometry3D::CMultiPolyline3DExtensionFactory *pObjectX = (EarthView::World::Geometry3D::CMultiPolyline3DExtensionFactory*) pObjXXXX;
			...
			extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtensionFactory_getGeoObjectCount_1CVisibleObject(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong visibleObj_j)
			{
				EarthView::World::Geometry3D::CVisibleObject *visibleObj = (EarthView::World::Geometry3D::CVisibleObject*) visibleObj_j;
				const 				EarthView::World::Geometry3D::CMultiPolyline3DExtensionFactory *pObjectX = (EarthView::World::Geometry3D::CMultiPolyline3DExtensionFactory*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCMultiPolyline3DExtensionFactoryProxy))
				{
					ev_uint64 __values1 = pObjectX->EarthView::World::Geometry3D::CMultiPolyline3DExtensionFactory::getGeoObjectCount(visibleObj);
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtensionFactory_register_1getGeoObjectCount_1CVisibleObject(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCMultiPolyline3DExtensionFactoryProxy *pObjectX = (JCMultiPolyline3DExtensionFactoryProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_geometry3d_MultiPolyline3DExtensionFactory_getGeoObjectCount_1CVisibleObject_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong visibleObj_j)
			{
				EarthView::World::Geometry3D::CVisibleObject *visibleObj = (EarthView::World::Geometry3D::CVisibleObject*) visibleObj_j;
				const 				EarthView::World::Geometry3D::CMultiPolyline3DExtensionFactory *pObjectX = (EarthView::World::Geometry3D::CMultiPolyline3DExtensionFactory*) pObjXXXX;
				ev_uint64 __values1 = pObjectX->EarthView::World::Geometry3D::CMultiPolyline3DExtensionFactory::getGeoObjectCount(visibleObj);
