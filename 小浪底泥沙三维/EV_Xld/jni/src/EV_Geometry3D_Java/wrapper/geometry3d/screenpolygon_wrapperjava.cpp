...
namespace EarthView
{
	namespace World
	{
		...
		{
			class JCScreenPolygonProxy : public EarthView::World::Geometry3D::CScreenPolygon
			{
			 private:
			...
			public:
				JCScreenPolygonProxy(EarthView::World::Core::CNameValuePairList *pList) : CScreenPolygon(pList)
				{
				}
			...
			REGISTER_FACTORY_CLASS(JCScreenPolygonProxy);
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_ScreenPolygon_begin_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Geometry3D::CScreenPolygon *pObjectX = (EarthView::World::Geometry3D::CScreenPolygon*) pObjXXXX;
				pObjectX->begin();
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_ScreenPolygon_appendPolygon_1CPolygon_1CColourValue(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong polygon_j, jlong color_j)
			{
				const EarthView::World::Spatial::Geometry::CPolygon &polygon = *(EarthView::World::Spatial::Geometry::CPolygon*) polygon_j;
				const EarthView::World::Graphic::CColourValue &color = *(EarthView::World::Graphic::CColourValue*) color_j;
				EarthView::World::Geometry3D::CScreenPolygon *pObjectX = (EarthView::World::Geometry3D::CScreenPolygon*) pObjXXXX;
				pObjectX->appendPolygon(polygon, color);
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_ScreenPolygon_appendPolygon_1CPolygon(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong polygon_j)
			{
				const EarthView::World::Spatial::Geometry::CPolygon &polygon = *(EarthView::World::Spatial::Geometry::CPolygon*) polygon_j;
				EarthView::World::Geometry3D::CScreenPolygon *pObjectX = (EarthView::World::Geometry3D::CScreenPolygon*) pObjXXXX;
				pObjectX->appendPolygon(polygon);
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_ScreenPolygon_end_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Geometry3D::CScreenPolygon *pObjectX = (EarthView::World::Geometry3D::CScreenPolygon*) pObjXXXX;
				pObjectX->end();
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_ScreenPolygon_register_1render_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCScreenPolygonProxy *pObjectX = (JCScreenPolygonProxy*) pObjXXXX;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_ScreenPolygon_register_1derender_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCScreenPolygonProxy *pObjectX = (JCScreenPolygonProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_ScreenPolygon_register_1setVisible_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCScreenPolygonProxy *pObjectX = (JCScreenPolygonProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_ScreenPolygon_register_1getVisible_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCScreenPolygonProxy *pObjectX = (JCScreenPolygonProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_ScreenPolygon_register_1setRenderQueueGroup_1ev_1uint8(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCScreenPolygonProxy *pObjectX = (JCScreenPolygonProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_ScreenPolygon_register_1setRenderQueueGroupAndPriority_1ev_1uint8_1ev_1uint16(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCScreenPolygonProxy *pObjectX = (JCScreenPolygonProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_ScreenPolygon_register_1getRenderQueueGroup_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCScreenPolygonProxy *pObjectX = (JCScreenPolygonProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_ScreenPolygon_register_1getMaterial_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCScreenPolygonProxy *pObjectX = (JCScreenPolygonProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_ScreenPolygon_register_1flash_1CColourValue_1ev_1uint32_1ev_1uint32_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCScreenPolygonProxy *pObjectX = (JCScreenPolygonProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_ScreenPolygon_register_1endFlash_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCScreenPolygonProxy *pObjectX = (JCScreenPolygonProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
