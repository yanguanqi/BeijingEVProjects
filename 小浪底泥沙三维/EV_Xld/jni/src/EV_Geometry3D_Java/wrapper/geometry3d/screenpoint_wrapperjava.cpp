...
namespace EarthView
{
	namespace World
	{
		...
		{
			extern "C" JNIEXPORT jintArray JNICALL Java_com_earthview_world_geometry3d_ScreenPointTypeHelper_getEnumValues (JNIEnv *__env, jclass __clazz)
			{
				jint enum_values[] = {
					SPT_Circle,
					SPT_Quad
			...
			class JCScreenPointProxy : public EarthView::World::Geometry3D::CScreenPoint
			{
			 private:
			...
			public:
				JCScreenPointProxy(EarthView::World::Core::CNameValuePairList *pList) : CScreenPoint(pList)
				{
				}
			...
			REGISTER_FACTORY_CLASS(JCScreenPointProxy);
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_ScreenPoint_begin_1CColourValue_1Real(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong color_j, jdouble size_j)
			{
				const EarthView::World::Graphic::CColourValue &color = *(EarthView::World::Graphic::CColourValue*) color_j;
				Real size = (Real) size_j;
				EarthView::World::Geometry3D::CScreenPoint *pObjectX = (EarthView::World::Geometry3D::CScreenPoint*) pObjXXXX;
				pObjectX->begin(color, size);
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_ScreenPoint_begin_1CColourValue(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong color_j)
			{
				const EarthView::World::Graphic::CColourValue &color = *(EarthView::World::Graphic::CColourValue*) color_j;
				EarthView::World::Geometry3D::CScreenPoint *pObjectX = (EarthView::World::Geometry3D::CScreenPoint*) pObjXXXX;
				pObjectX->begin(color);
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_ScreenPoint_begin_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Geometry3D::CScreenPoint *pObjectX = (EarthView::World::Geometry3D::CScreenPoint*) pObjXXXX;
				pObjectX->begin();
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_ScreenPoint_appendPoint_1CVector2_1CColourValue_1Real(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong position_j, jlong color_j, jdouble size_j)
			{
				const EarthView::World::Spatial::Math::CVector2 &position = *(EarthView::World::Spatial::Math::CVector2*) position_j;
				const EarthView::World::Graphic::CColourValue &color = *(EarthView::World::Graphic::CColourValue*) color_j;
				Real size = (Real) size_j;
				EarthView::World::Geometry3D::CScreenPoint *pObjectX = (EarthView::World::Geometry3D::CScreenPoint*) pObjXXXX;
				pObjectX->appendPoint(position, color, size);
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_ScreenPoint_appendPoint_1CVector2_1CColourValue(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong position_j, jlong color_j)
			{
				const EarthView::World::Spatial::Math::CVector2 &position = *(EarthView::World::Spatial::Math::CVector2*) position_j;
				const EarthView::World::Graphic::CColourValue &color = *(EarthView::World::Graphic::CColourValue*) color_j;
				EarthView::World::Geometry3D::CScreenPoint *pObjectX = (EarthView::World::Geometry3D::CScreenPoint*) pObjXXXX;
				pObjectX->appendPoint(position, color);
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_ScreenPoint_appendPoint_1CVector2(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong position_j)
			{
				const EarthView::World::Spatial::Math::CVector2 &position = *(EarthView::World::Spatial::Math::CVector2*) position_j;
				EarthView::World::Geometry3D::CScreenPoint *pObjectX = (EarthView::World::Geometry3D::CScreenPoint*) pObjXXXX;
				pObjectX->appendPoint(position);
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_ScreenPoint_end_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Geometry3D::CScreenPoint *pObjectX = (EarthView::World::Geometry3D::CScreenPoint*) pObjXXXX;
				pObjectX->end();
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_ScreenPoint_register_1render_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCScreenPointProxy *pObjectX = (JCScreenPointProxy*) pObjXXXX;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_ScreenPoint_register_1derender_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCScreenPointProxy *pObjectX = (JCScreenPointProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_ScreenPoint_register_1setVisible_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCScreenPointProxy *pObjectX = (JCScreenPointProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_ScreenPoint_register_1getVisible_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCScreenPointProxy *pObjectX = (JCScreenPointProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_ScreenPoint_register_1setRenderQueueGroup_1ev_1uint8(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCScreenPointProxy *pObjectX = (JCScreenPointProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_ScreenPoint_register_1setRenderQueueGroupAndPriority_1ev_1uint8_1ev_1uint16(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCScreenPointProxy *pObjectX = (JCScreenPointProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_ScreenPoint_register_1getRenderQueueGroup_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCScreenPointProxy *pObjectX = (JCScreenPointProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_ScreenPoint_register_1getMaterial_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCScreenPointProxy *pObjectX = (JCScreenPointProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_ScreenPoint_register_1flash_1CColourValue_1ev_1uint32_1ev_1uint32_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCScreenPointProxy *pObjectX = (JCScreenPointProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_ScreenPoint_register_1endFlash_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCScreenPointProxy *pObjectX = (JCScreenPointProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
