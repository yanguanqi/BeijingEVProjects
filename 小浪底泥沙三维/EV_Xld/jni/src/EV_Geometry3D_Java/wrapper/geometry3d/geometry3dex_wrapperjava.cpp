...
namespace EarthView
{
	namespace World
	{
		namespace Geometry3D
		{
			class JCGeometry3DExProxy : public EarthView::World::Geometry3D::CGeometry3DEx
			{
			 private:
			...
			public:
				JCGeometry3DExProxy(EarthView::World::Core::CNameValuePairList *pList) : CGeometry3DEx(pList)
				{
				}
			...
			REGISTER_FACTORY_CLASS(JCGeometry3DExProxy);
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_geometry3d_Geometry3DEx_getNode_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Geometry3D::CGeometry3DEx *pObjectX = (EarthView::World::Geometry3D::CGeometry3DEx*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCGeometry3DExProxy))
				{
					EarthView::World::Graphic::CNode* __values1 = pObjectX->EarthView::World::Geometry3D::CGeometry3DEx::getNode();
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_Geometry3DEx_register_1getNode_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCGeometry3DExProxy *pObjectX = (JCGeometry3DExProxy*) pObjXXXX;
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_geometry3d_Geometry3DEx_getNode_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Geometry3D::CGeometry3DEx *pObjectX = (EarthView::World::Geometry3D::CGeometry3DEx*) pObjXXXX;
				EarthView::World::Graphic::CNode* __values1 = pObjectX->EarthView::World::Geometry3D::CGeometry3DEx::getNode();
				jlong __values1_j = (jlong) __values1;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_Geometry3DEx_setSelectable_1ev_1bool(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean selectable_j)
			{
				ev_bool selectable = (ev_bool) selectable_j;
				EarthView::World::Geometry3D::CGeometry3DEx *pObjectX = (EarthView::World::Geometry3D::CGeometry3DEx*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCGeometry3DExProxy))
				{
					pObjectX->EarthView::World::Geometry3D::CGeometry3DEx::setSelectable(selectable);
				}
				else
				{
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_Geometry3DEx_register_1setSelectable_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCGeometry3DExProxy *pObjectX = (JCGeometry3DExProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_Geometry3DEx_setSelectable_1ev_1bool_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean selectable_j)
			{
				ev_bool selectable = (ev_bool) selectable_j;
				EarthView::World::Geometry3D::CGeometry3DEx *pObjectX = (EarthView::World::Geometry3D::CGeometry3DEx*) pObjXXXX;
				pObjectX->EarthView::World::Geometry3D::CGeometry3DEx::setSelectable(selectable);
			}
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_geometry3d_Geometry3DEx_update_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Geometry3D::CGeometry3DEx *pObjectX = (EarthView::World::Geometry3D::CGeometry3DEx*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCGeometry3DExProxy))
				{
					ev_bool __values1 = pObjectX->EarthView::World::Geometry3D::CGeometry3DEx::update();
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_Geometry3DEx_register_1update_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCGeometry3DExProxy *pObjectX = (JCGeometry3DExProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_geometry3d_Geometry3DEx_update_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Geometry3D::CGeometry3DEx *pObjectX = (EarthView::World::Geometry3D::CGeometry3DEx*) pObjXXXX;
				ev_bool __values1 = pObjectX->EarthView::World::Geometry3D::CGeometry3DEx::update();
				jboolean __values1_j = (jboolean)__values1;
			...
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_geometry3d_Geometry3DEx_isLoaded_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Geometry3D::CGeometry3DEx *pObjectX = (EarthView::World::Geometry3D::CGeometry3DEx*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCGeometry3DExProxy))
				{
					ev_bool __values1 = pObjectX->EarthView::World::Geometry3D::CGeometry3DEx::isLoaded();
					jboolean __values1_j = (jboolean)__values1;
					return __values1_j;
				}
				else
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_Geometry3DEx_register_1isLoaded_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCGeometry3DExProxy *pObjectX = (JCGeometry3DExProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_geometry3d_Geometry3DEx_isLoaded_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Geometry3D::CGeometry3DEx *pObjectX = (EarthView::World::Geometry3D::CGeometry3DEx*) pObjXXXX;
				ev_bool __values1 = pObjectX->EarthView::World::Geometry3D::CGeometry3DEx::isLoaded();
				jboolean __values1_j = (jboolean)__values1;
			...
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_geometry3d_Geometry3DEx_isAttached_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Geometry3D::CGeometry3DEx *pObjectX = (EarthView::World::Geometry3D::CGeometry3DEx*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCGeometry3DExProxy))
				{
					ev_bool __values1 = pObjectX->EarthView::World::Geometry3D::CGeometry3DEx::isAttached();
					jboolean __values1_j = (jboolean)__values1;
					return __values1_j;
				}
				else
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_Geometry3DEx_register_1isAttached_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCGeometry3DExProxy *pObjectX = (JCGeometry3DExProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_geometry3d_Geometry3DEx_isAttached_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Geometry3D::CGeometry3DEx *pObjectX = (EarthView::World::Geometry3D::CGeometry3DEx*) pObjXXXX;
				ev_bool __values1 = pObjectX->EarthView::World::Geometry3D::CGeometry3DEx::isAttached();
				jboolean __values1_j = (jboolean)__values1;
			...
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_geometry3d_Geometry3DEx_load_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Geometry3D::CGeometry3DEx *pObjectX = (EarthView::World::Geometry3D::CGeometry3DEx*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCGeometry3DExProxy))
				{
					ev_bool __values1 = pObjectX->EarthView::World::Geometry3D::CGeometry3DEx::load();
					jboolean __values1_j = (jboolean)__values1;
					return __values1_j;
				}
				else
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_Geometry3DEx_register_1load_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCGeometry3DExProxy *pObjectX = (JCGeometry3DExProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_geometry3d_Geometry3DEx_load_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Geometry3D::CGeometry3DEx *pObjectX = (EarthView::World::Geometry3D::CGeometry3DEx*) pObjXXXX;
				ev_bool __values1 = pObjectX->EarthView::World::Geometry3D::CGeometry3DEx::load();
				jboolean __values1_j = (jboolean)__values1;
			...
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_geometry3d_Geometry3DEx_unload_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Geometry3D::CGeometry3DEx *pObjectX = (EarthView::World::Geometry3D::CGeometry3DEx*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCGeometry3DExProxy))
				{
					ev_bool __values1 = pObjectX->EarthView::World::Geometry3D::CGeometry3DEx::unload();
					jboolean __values1_j = (jboolean)__values1;
					return __values1_j;
				}
				else
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_Geometry3DEx_register_1unload_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCGeometry3DExProxy *pObjectX = (JCGeometry3DExProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_geometry3d_Geometry3DEx_unload_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Geometry3D::CGeometry3DEx *pObjectX = (EarthView::World::Geometry3D::CGeometry3DEx*) pObjXXXX;
				ev_bool __values1 = pObjectX->EarthView::World::Geometry3D::CGeometry3DEx::unload();
				jboolean __values1_j = (jboolean)__values1;
			...
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_geometry3d_Geometry3DEx_attachToNode_1CNode(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong n_j)
			{
				EarthView::World::Graphic::CNode *n = (EarthView::World::Graphic::CNode*) n_j;
				EarthView::World::Geometry3D::CGeometry3DEx *pObjectX = (EarthView::World::Geometry3D::CGeometry3DEx*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCGeometry3DExProxy))
				{
					ev_bool __values1 = pObjectX->EarthView::World::Geometry3D::CGeometry3DEx::attachToNode(n);
					jboolean __values1_j = (jboolean)__values1;
					return __values1_j;
				}
				else
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_Geometry3DEx_register_1attachToNode_1CNode(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCGeometry3DExProxy *pObjectX = (JCGeometry3DExProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_geometry3d_Geometry3DEx_attachToNode_1CNode_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong n_j)
			{
				EarthView::World::Graphic::CNode *n = (EarthView::World::Graphic::CNode*) n_j;
				EarthView::World::Geometry3D::CGeometry3DEx *pObjectX = (EarthView::World::Geometry3D::CGeometry3DEx*) pObjXXXX;
				ev_bool __values1 = pObjectX->EarthView::World::Geometry3D::CGeometry3DEx::attachToNode(n);
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_geometry3d_Geometry3DEx_detachFromNode_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Geometry3D::CGeometry3DEx *pObjectX = (EarthView::World::Geometry3D::CGeometry3DEx*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCGeometry3DExProxy))
				{
					EarthView::World::Graphic::CNode* __values1 = pObjectX->EarthView::World::Geometry3D::CGeometry3DEx::detachFromNode();
					jlong __values1_j = (jlong) __values1;
					return __values1_j;
				}
				else
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_Geometry3DEx_register_1detachFromNode_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCGeometry3DExProxy *pObjectX = (JCGeometry3DExProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_geometry3d_Geometry3DEx_detachFromNode_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Geometry3D::CGeometry3DEx *pObjectX = (EarthView::World::Geometry3D::CGeometry3DEx*) pObjXXXX;
				EarthView::World::Graphic::CNode* __values1 = pObjectX->EarthView::World::Geometry3D::CGeometry3DEx::detachFromNode();
				jlong __values1_j = (jlong) __values1;
			...
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_geometry3d_Geometry3DEx_attachToScene_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Geometry3D::CGeometry3DEx *pObjectX = (EarthView::World::Geometry3D::CGeometry3DEx*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCGeometry3DExProxy))
				{
					ev_bool __values1 = pObjectX->EarthView::World::Geometry3D::CGeometry3DEx::attachToScene();
					jboolean __values1_j = (jboolean)__values1;
					return __values1_j;
				}
				else
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_Geometry3DEx_register_1attachToScene_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCGeometry3DExProxy *pObjectX = (JCGeometry3DExProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_geometry3d_Geometry3DEx_attachToScene_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Geometry3D::CGeometry3DEx *pObjectX = (EarthView::World::Geometry3D::CGeometry3DEx*) pObjXXXX;
				ev_bool __values1 = pObjectX->EarthView::World::Geometry3D::CGeometry3DEx::attachToScene();
				jboolean __values1_j = (jboolean)__values1;
			...
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_geometry3d_Geometry3DEx_detachFromScene_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Geometry3D::CGeometry3DEx *pObjectX = (EarthView::World::Geometry3D::CGeometry3DEx*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCGeometry3DExProxy))
				{
					ev_bool __values1 = pObjectX->EarthView::World::Geometry3D::CGeometry3DEx::detachFromScene();
					jboolean __values1_j = (jboolean)__values1;
					return __values1_j;
				}
				else
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_Geometry3DEx_register_1detachFromScene_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCGeometry3DExProxy *pObjectX = (JCGeometry3DExProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_geometry3d_Geometry3DEx_detachFromScene_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Geometry3D::CGeometry3DEx *pObjectX = (EarthView::World::Geometry3D::CGeometry3DEx*) pObjXXXX;
				ev_bool __values1 = pObjectX->EarthView::World::Geometry3D::CGeometry3DEx::detachFromScene();
				jboolean __values1_j = (jboolean)__values1;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_Geometry3DEx_startEdit_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Geometry3D::CGeometry3DEx *pObjectX = (EarthView::World::Geometry3D::CGeometry3DEx*) pObjXXXX;
				pObjectX->startEdit();
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_Geometry3DEx_endEdit_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Geometry3D::CGeometry3DEx *pObjectX = (EarthView::World::Geometry3D::CGeometry3DEx*) pObjXXXX;
				pObjectX->endEdit();
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_Geometry3DEx_refreshPosition_1CVector3_1CVector3_1CQuaternion(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong pos_j, jlong scale_j, jlong qua_j)
			{
				...
				EarthView::World::Geometry3D::CGeometry3DEx *pObjectX = (EarthView::World::Geometry3D::CGeometry3DEx*) pObjXXXX;
				pObjectX->refreshPosition(pos, scale, qua);
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_Geometry3DEx_setVisible_1ev_1bool(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean b_j)
			{
				ev_bool b = (ev_bool) b_j;
				EarthView::World::Geometry3D::CGeometry3DEx *pObjectX = (EarthView::World::Geometry3D::CGeometry3DEx*) pObjXXXX;
				pObjectX->setVisible(b);
			}
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_geometry3d_Geometry3DEx_getVisible_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Geometry3D::CGeometry3DEx *pObjectX = (EarthView::World::Geometry3D::CGeometry3DEx*) pObjXXXX;
				ev_bool __values1 = pObjectX->getVisible();
				jboolean __values1_j = (jboolean)__values1;
				return __values1_j;
			}
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_geometry3d_Geometry3DEx_getMaxnum_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Geometry3D::CGeometry3DEx *pObjectX = (EarthView::World::Geometry3D::CGeometry3DEx*) pObjXXXX;
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_geometry3d_Geometry3DEx_getMinnum_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Geometry3D::CGeometry3DEx *pObjectX = (EarthView::World::Geometry3D::CGeometry3DEx*) pObjXXXX;
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_geometry3d_Geometry3DEx_getVectorMovableObj_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Geometry3D::CGeometry3DEx *pObjectX = (EarthView::World::Geometry3D::CGeometry3DEx*) pObjXXXX;
				EarthView::World::Graphic::CMovableObject* __values1 = pObjectX->getVectorMovableObj();
				jlong __values1_j = (jlong) __values1;
				return __values1_j;
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_Geometry3DEx_updateLocation_1CGeoObjectExtension(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong geoObj_j)
			{
				EarthView::World::Spatial::Kml::CGeoObjectExtension *geoObj = (EarthView::World::Spatial::Kml::CGeoObjectExtension*) geoObj_j;
				EarthView::World::Geometry3D::CGeometry3DEx *pObjectX = (EarthView::World::Geometry3D::CGeometry3DEx*) pObjXXXX;
				pObjectX->updateLocation(geoObj);
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_Geometry3DEx_refreshPosition_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Geometry3D::CGeometry3DEx *pObjectX = (EarthView::World::Geometry3D::CGeometry3DEx*) pObjXXXX;
				pObjectX->refreshPosition();
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_Geometry3DEx_refreshMaterialRef_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Geometry3D::CGeometry3DEx *pObjectX = (EarthView::World::Geometry3D::CGeometry3DEx*) pObjXXXX;
				pObjectX->refreshMaterialRef();
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_Geometry3DEx_setUserData_1CFeatureUserData(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong userData_j)
			{
				EarthView::World::Spatial3D::CFeatureUserData &userData = *(EarthView::World::Spatial3D::CFeatureUserData*) userData_j;
				EarthView::World::Geometry3D::CGeometry3DEx *pObjectX = (EarthView::World::Geometry3D::CGeometry3DEx*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCGeometry3DExProxy))
				{
					pObjectX->EarthView::World::Geometry3D::CGeometry3DEx::setUserData(userData);
				}
				else
				{
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_Geometry3DEx_register_1setUserData_1CFeatureUserData(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCGeometry3DExProxy *pObjectX = (JCGeometry3DExProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_Geometry3DEx_setUserData_1CFeatureUserData_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong userData_j)
			{
				EarthView::World::Spatial3D::CFeatureUserData &userData = *(EarthView::World::Spatial3D::CFeatureUserData*) userData_j;
				EarthView::World::Geometry3D::CGeometry3DEx *pObjectX = (EarthView::World::Geometry3D::CGeometry3DEx*) pObjXXXX;
				pObjectX->EarthView::World::Geometry3D::CGeometry3DEx::setUserData(userData);
			}
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_geometry3d_Geometry3DEx_getUserData_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Geometry3D::CGeometry3DEx *pObjectX = (EarthView::World::Geometry3D::CGeometry3DEx*) pObjXXXX;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_Geometry3DEx_register_1getSelectable_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCGeometry3DExProxy *pObjectX = (JCGeometry3DExProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_Geometry3DEx_register_1getLayer_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCGeometry3DExProxy *pObjectX = (JCGeometry3DExProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_Geometry3DEx_register_1getDataset_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCGeometry3DExProxy *pObjectX = (JCGeometry3DExProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_Geometry3DEx_register_1getID_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCGeometry3DExProxy *pObjectX = (JCGeometry3DExProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_Geometry3DEx_register_1getName_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCGeometry3DExProxy *pObjectX = (JCGeometry3DExProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_Geometry3DEx_register_1setMatrix_1CMatrix4(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCGeometry3DExProxy *pObjectX = (JCGeometry3DExProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_Geometry3DEx_register_1getMatrix_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCGeometry3DExProxy *pObjectX = (JCGeometry3DExProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_Geometry3DEx_register_1setPosition_1ev_1real64_1ev_1real64_1ev_1real64_1CVector3_1CQuaternion(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCGeometry3DExProxy *pObjectX = (JCGeometry3DExProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_Geometry3DEx_register_1getPosition_1ev_1real64_1ev_1real64_1ev_1real64_1CVector3_1CQuaternion(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCGeometry3DExProxy *pObjectX = (JCGeometry3DExProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			class JCGeometry3DExFactoryProxy : public EarthView::World::Geometry3D::CGeometry3DExFactory
			{
			 private:
			...
			public:
				JCGeometry3DExFactoryProxy(EarthView::World::Core::CNameValuePairList *pList) : CGeometry3DExFactory(pList)
				{
				}
				ev_void unRegisterJavaReference()
				{
			...
			REGISTER_FACTORY_CLASS(JCGeometry3DExFactoryProxy);
			extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_geometry3d_Geometry3DExFactory_getFactoryType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Geometry3D::CGeometry3DExFactory *pObjectX = (EarthView::World::Geometry3D::CGeometry3DExFactory*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCGeometry3DExFactoryProxy))
				{
					ev_uint16 __values1 = pObjectX->EarthView::World::Geometry3D::CGeometry3DExFactory::getFactoryType();
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_Geometry3DExFactory_register_1getFactoryType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCGeometry3DExFactoryProxy *pObjectX = (JCGeometry3DExFactoryProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
				__env->ReleaseStringUTFChars(__method, pMethod);
			...
			extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_geometry3d_Geometry3DExFactory_getFactoryType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				EarthView::World::Geometry3D::CGeometry3DExFactory *pObjectX = (EarthView::World::Geometry3D::CGeometry3DExFactory*) pObjXXXX;
				ev_uint16 __values1 = pObjectX->EarthView::World::Geometry3D::CGeometry3DExFactory::getFactoryType();
				jint __values1_j = (jint) __values1;
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_geometry3d_Geometry3DExFactory_createRenderable_1CGeoObjectExtension_1CSceneManager(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong geoObj_j, jlong scenemanager_j)
			{
				EarthView::World::Spatial::Kml::CGeoObjectExtension *geoObj = (EarthView::World::Spatial::Kml::CGeoObjectExtension*) geoObj_j;
				...
				if (typeid(*pObjectX) == typeid(JCGeometry3DExFactoryProxy))
				{
					EarthView::World::Geometry3D::VisibleObjects __values1 = pObjectX->EarthView::World::Geometry3D::CGeometry3DExFactory::createRenderable(geoObj, scenemanager);
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_Geometry3DExFactory_register_1createRenderable_1CGeoObjectExtension_1CSceneManager(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCGeometry3DExFactoryProxy *pObjectX = (JCGeometry3DExFactoryProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_geometry3d_Geometry3DExFactory_createRenderable_1CGeoObjectExtension_1CSceneManager_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong geoObj_j, jlong scenemanager_j)
			{
				EarthView::World::Spatial::Kml::CGeoObjectExtension *geoObj = (EarthView::World::Spatial::Kml::CGeoObjectExtension*) geoObj_j;
				EarthView::World::Graphic::CSceneManager *scenemanager = (EarthView::World::Graphic::CSceneManager*) scenemanager_j;
				EarthView::World::Geometry3D::CGeometry3DExFactory *pObjectX = (EarthView::World::Geometry3D::CGeometry3DExFactory*) pObjXXXX;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_Geometry3DExFactory_destoryRenderable_1CVisibleObject(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong visitObj_j)
			{
				EarthView::World::Geometry3D::CVisibleObject *visitObj = (EarthView::World::Geometry3D::CVisibleObject*) visitObj_j;
				EarthView::World::Geometry3D::CGeometry3DExFactory *pObjectX = (EarthView::World::Geometry3D::CGeometry3DExFactory*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCGeometry3DExFactoryProxy))
				{
					pObjectX->EarthView::World::Geometry3D::CGeometry3DExFactory::destoryRenderable(visitObj);
				}
				else
				{
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_Geometry3DExFactory_register_1destoryRenderable_1CVisibleObject(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCGeometry3DExFactoryProxy *pObjectX = (JCGeometry3DExFactoryProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_Geometry3DExFactory_destoryRenderable_1CVisibleObject_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong visitObj_j)
			{
				EarthView::World::Geometry3D::CVisibleObject *visitObj = (EarthView::World::Geometry3D::CVisibleObject*) visitObj_j;
				EarthView::World::Geometry3D::CGeometry3DExFactory *pObjectX = (EarthView::World::Geometry3D::CGeometry3DExFactory*) pObjXXXX;
				pObjectX->EarthView::World::Geometry3D::CGeometry3DExFactory::destoryRenderable(visitObj);
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_Geometry3DExFactory_register_1appendGeoObject_1CVisibleObject_1CGeoObject(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCGeometry3DExFactoryProxy *pObjectX = (JCGeometry3DExFactoryProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_Geometry3DExFactory_register_1removeGeoObject_1CVisibleObject_1CGeoObject(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCGeometry3DExFactoryProxy *pObjectX = (JCGeometry3DExFactoryProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_Geometry3DExFactory_register_1removeAllGeoObjects_1CVisibleObject(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCGeometry3DExFactoryProxy *pObjectX = (JCGeometry3DExFactoryProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_Geometry3DExFactory_register_1getGeoObject_1CVisibleObject_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCGeometry3DExFactoryProxy *pObjectX = (JCGeometry3DExFactoryProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_geometry3d_Geometry3DExFactory_register_1getGeoObjectCount_1CVisibleObject(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCGeometry3DExFactoryProxy *pObjectX = (JCGeometry3DExFactoryProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
