...
namespace EarthView
{
	namespace World
	{
		namespace Spatial3D
		{
			extern "C" JNIEXPORT jintArray JNICALL Java_com_earthview_world_spatial3d_ImageTypeHelper_getEnumValues (JNIEnv *__env, jclass __clazz)
			{
				jint enum_values[] = {
					LocalDem,
					CacheDem
			...
			class JCLocalDemDataSourceProxy : public EarthView::World::Spatial3D::CLocalDemDataSource
			{
			 private:
			...
			public:
				JCLocalDemDataSourceProxy(EarthView::World::Core::CNameValuePairList *pList) : CLocalDemDataSource(pList)
				{
				}
			...
			REGISTER_FACTORY_CLASS(JCLocalDemDataSourceProxy);
			extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial3d_LocalDemDataSource_getName_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Spatial3D::CLocalDemDataSource *pObjectX = (EarthView::World::Spatial3D::CLocalDemDataSource*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCLocalDemDataSourceProxy))
				{
					EVString __values1 = pObjectX->EarthView::World::Spatial3D::CLocalDemDataSource::getName();
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_LocalDemDataSource_register_1getName_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLocalDemDataSourceProxy *pObjectX = (JCLocalDemDataSourceProxy*) pObjXXXX;
			...
			extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial3d_LocalDemDataSource_getName_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Spatial3D::CLocalDemDataSource *pObjectX = (EarthView::World::Spatial3D::CLocalDemDataSource*) pObjXXXX;
				EVString __values1 = pObjectX->EarthView::World::Spatial3D::CLocalDemDataSource::getName();
				EarthView::World::Core::ev_wstring valuesw1 = __values1;
			...
			extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial3d_LocalDemDataSource_getType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Spatial3D::CLocalDemDataSource *pObjectX = (EarthView::World::Spatial3D::CLocalDemDataSource*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCLocalDemDataSourceProxy))
				{
					ev_int32 __values1 = pObjectX->EarthView::World::Spatial3D::CLocalDemDataSource::getType();
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_LocalDemDataSource_register_1getType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLocalDemDataSourceProxy *pObjectX = (JCLocalDemDataSourceProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial3d_LocalDemDataSource_getType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Spatial3D::CLocalDemDataSource *pObjectX = (EarthView::World::Spatial3D::CLocalDemDataSource*) pObjXXXX;
				ev_int32 __values1 = pObjectX->EarthView::World::Spatial3D::CLocalDemDataSource::getType();
				jint __values1_j = (jint)__values1;
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_LocalDemDataSource_getPropertySet_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Spatial3D::CLocalDemDataSource *pObjectX = (EarthView::World::Spatial3D::CLocalDemDataSource*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCLocalDemDataSourceProxy))
				{
					EarthView::World::Spatial::GeoDataset::IPropertySet* __values1 = pObjectX->EarthView::World::Spatial3D::CLocalDemDataSource::getPropertySet();
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_LocalDemDataSource_register_1getPropertySet_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLocalDemDataSourceProxy *pObjectX = (JCLocalDemDataSourceProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_LocalDemDataSource_getPropertySet_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Spatial3D::CLocalDemDataSource *pObjectX = (EarthView::World::Spatial3D::CLocalDemDataSource*) pObjXXXX;
				EarthView::World::Spatial::GeoDataset::IPropertySet* __values1 = pObjectX->EarthView::World::Spatial3D::CLocalDemDataSource::getPropertySet();
				jlong __values1_j = (jlong) __values1;
			...
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_LocalDemDataSource_isValid_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Spatial3D::CLocalDemDataSource *pObjectX = (EarthView::World::Spatial3D::CLocalDemDataSource*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCLocalDemDataSourceProxy))
				{
					ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::CLocalDemDataSource::isValid();
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_LocalDemDataSource_register_1isValid_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLocalDemDataSourceProxy *pObjectX = (JCLocalDemDataSourceProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_LocalDemDataSource_isValid_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Spatial3D::CLocalDemDataSource *pObjectX = (EarthView::World::Spatial3D::CLocalDemDataSource*) pObjXXXX;
				ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::CLocalDemDataSource::isValid();
				jboolean __values1_j = (jboolean)__values1;
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_LocalDemDataSource_getDatasetInfo_1EVString(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring name_j)
			{
				#if EV_PLATFORM == EV_PLATFORM_ANDROID
				...
				#endif
				EarthView::World::Spatial3D::CLocalDemDataSource *pObjectX = (EarthView::World::Spatial3D::CLocalDemDataSource*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCLocalDemDataSourceProxy))
				{
					EarthView::World::Spatial::GeoDataset::IDataMetaInfo* __values1 = pObjectX->EarthView::World::Spatial3D::CLocalDemDataSource::getDatasetInfo(name);
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_LocalDemDataSource_register_1getDatasetInfo_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLocalDemDataSourceProxy *pObjectX = (JCLocalDemDataSourceProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_LocalDemDataSource_getDatasetInfo_1EVString_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring name_j)
			{
				#if EV_PLATFORM == EV_PLATFORM_ANDROID
				const ev_char* name_ch = (const ev_char*)__env->GetStringUTFChars(name_j,JNI_FALSE);
				const EVString name = name_ch;
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_LocalDemDataSource_getDatasetInfos_1EVDatasetType(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint type_j)
			{
				EarthView::World::Spatial::GeoDataset::EVDatasetType type = (EarthView::World::Spatial::GeoDataset::EVDatasetType) type_j;
				EarthView::World::Spatial3D::CLocalDemDataSource *pObjectX = (EarthView::World::Spatial3D::CLocalDemDataSource*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCLocalDemDataSourceProxy))
				{
					EarthView::World::Spatial::GeoDataset::IDataMetaInfos* __values1 = pObjectX->EarthView::World::Spatial3D::CLocalDemDataSource::getDatasetInfos(type);
					if(__values1 != NULL) {						((EarthView::World::Core::CBaseObject*)__values1)->setExternFree(true);
					}					jlong __values1_j = (jlong) __values1;
					return __values1_j;
				}
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_LocalDemDataSource_register_1getDatasetInfos_1EVDatasetType(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLocalDemDataSourceProxy *pObjectX = (JCLocalDemDataSourceProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_LocalDemDataSource_getDatasetInfos_1EVDatasetType_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint type_j)
			{
				EarthView::World::Spatial::GeoDataset::EVDatasetType type = (EarthView::World::Spatial::GeoDataset::EVDatasetType) type_j;
				EarthView::World::Spatial3D::CLocalDemDataSource *pObjectX = (EarthView::World::Spatial3D::CLocalDemDataSource*) pObjXXXX;
				EarthView::World::Spatial::GeoDataset::IDataMetaInfos* __values1 = pObjectX->EarthView::World::Spatial3D::CLocalDemDataSource::getDatasetInfos(type);
			...
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_LocalDemDataSource_createDataset_1EVString_1EVString_1IFields(JNIEnv *__env , jclass __clazz, jstring name_j, jstring dstFolder_j, jlong attrFields_j)
			{
				#if EV_PLATFORM == EV_PLATFORM_ANDROID
				const ev_char* name_ch = (const ev_char*)__env->GetStringUTFChars(name_j,JNI_FALSE);
				const EVString name = name_ch;
				...
				ev_bool __values1 = EarthView::World::Spatial3D::CLocalDemDataSource::createDataset(name, dstFolder, attrFields);
				jboolean __values1_j = (jboolean)__values1;
				return __values1_j;
			}
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_LocalDemDataSource_openDataset_1EVString(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring name_j)
			{
				#if EV_PLATFORM == EV_PLATFORM_ANDROID
				const ev_char* name_ch = (const ev_char*)__env->GetStringUTFChars(name_j,JNI_FALSE);
				const EVString name = name_ch;
				...
				if (typeid(*pObjectX) == typeid(JCLocalDemDataSourceProxy))
				{
					EarthView::World::Spatial::GeoDataset::IDataset* __values1 = pObjectX->EarthView::World::Spatial3D::CLocalDemDataSource::openDataset(name);
					jlong __values1_j = (jlong) __values1;
					return __values1_j;
				}
				else
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_LocalDemDataSource_register_1openDataset_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLocalDemDataSourceProxy *pObjectX = (JCLocalDemDataSourceProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_LocalDemDataSource_openDataset_1EVString_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring name_j)
			{
				#if EV_PLATFORM == EV_PLATFORM_ANDROID
				const ev_char* name_ch = (const ev_char*)__env->GetStringUTFChars(name_j,JNI_FALSE);
				const EVString name = name_ch;
			...
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_LocalDemDataSource_closeDataset_1IDataset(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong dataset_j)
			{
				EarthView::World::Spatial::GeoDataset::IDataset *dataset = (EarthView::World::Spatial::GeoDataset::IDataset*) dataset_j;
				EarthView::World::Spatial3D::CLocalDemDataSource *pObjectX = (EarthView::World::Spatial3D::CLocalDemDataSource*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCLocalDemDataSourceProxy))
				{
					ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::CLocalDemDataSource::closeDataset(dataset);
					jboolean __values1_j = (jboolean)__values1;
					return __values1_j;
				}
				else
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_LocalDemDataSource_register_1closeDataset_1IDataset(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLocalDemDataSourceProxy *pObjectX = (JCLocalDemDataSourceProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_LocalDemDataSource_closeDataset_1IDataset_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong dataset_j)
			{
				EarthView::World::Spatial::GeoDataset::IDataset *dataset = (EarthView::World::Spatial::GeoDataset::IDataset*) dataset_j;
				EarthView::World::Spatial3D::CLocalDemDataSource *pObjectX = (EarthView::World::Spatial3D::CLocalDemDataSource*) pObjXXXX;
				ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::CLocalDemDataSource::closeDataset(dataset);
			...
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_LocalDemDataSource_deleteDataset_1EVString(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring name_j)
			{
				#if EV_PLATFORM == EV_PLATFORM_ANDROID
				const ev_char* name_ch = (const ev_char*)__env->GetStringUTFChars(name_j,JNI_FALSE);
				const EVString name = name_ch;
				...
				if (typeid(*pObjectX) == typeid(JCLocalDemDataSourceProxy))
				{
					ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::CLocalDemDataSource::deleteDataset(name);
					jboolean __values1_j = (jboolean)__values1;
					return __values1_j;
				}
				else
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_LocalDemDataSource_register_1deleteDataset_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLocalDemDataSourceProxy *pObjectX = (JCLocalDemDataSourceProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_LocalDemDataSource_deleteDataset_1EVString_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring name_j)
			{
				#if EV_PLATFORM == EV_PLATFORM_ANDROID
				const ev_char* name_ch = (const ev_char*)__env->GetStringUTFChars(name_j,JNI_FALSE);
				const EVString name = name_ch;
			...
			extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial3d_LocalDemDataSource_toXML_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Spatial3D::CLocalDemDataSource *pObjectX = (EarthView::World::Spatial3D::CLocalDemDataSource*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCLocalDemDataSourceProxy))
				{
					EVString __values1 = pObjectX->EarthView::World::Spatial3D::CLocalDemDataSource::toXML();
					EarthView::World::Core::ev_wstring valuesw1 = __values1;
					jstring __values1_j = __env->NewString((const jchar*)valuesw1.getString(), valuesw1.size());
					return __values1_j;
				}
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_LocalDemDataSource_register_1toXML_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLocalDemDataSourceProxy *pObjectX = (JCLocalDemDataSourceProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial3d_LocalDemDataSource_toXML_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Spatial3D::CLocalDemDataSource *pObjectX = (EarthView::World::Spatial3D::CLocalDemDataSource*) pObjXXXX;
				EVString __values1 = pObjectX->EarthView::World::Spatial3D::CLocalDemDataSource::toXML();
				EarthView::World::Core::ev_wstring valuesw1 = __values1;
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_LocalDemDataSource_ev_1clone_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Spatial3D::CLocalDemDataSource *pObjectX = (EarthView::World::Spatial3D::CLocalDemDataSource*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCLocalDemDataSourceProxy))
				{
					EarthView::World::Spatial::GeoDataset::IDataSource* __values1 = pObjectX->EarthView::World::Spatial3D::CLocalDemDataSource::clone();
					jlong __values1_j = (jlong) __values1;
					return __values1_j;
				}
				else
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_LocalDemDataSource_register_1ev_1clone_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLocalDemDataSourceProxy *pObjectX = (JCLocalDemDataSourceProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_LocalDemDataSource_ev_1clone_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Spatial3D::CLocalDemDataSource *pObjectX = (EarthView::World::Spatial3D::CLocalDemDataSource*) pObjXXXX;
				EarthView::World::Spatial::GeoDataset::IDataSource* __values1 = pObjectX->EarthView::World::Spatial3D::CLocalDemDataSource::clone();
				jlong __values1_j = (jlong) __values1;
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_LocalDemDataSource_getDataset_1EVString(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring name_j)
			{
				#if EV_PLATFORM == EV_PLATFORM_ANDROID
				const ev_char* name_ch = (const ev_char*)__env->GetStringUTFChars(name_j,JNI_FALSE);
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_LocalDemDataSource_register_1createFeatureClass_1EVString_1IGeometryField_1IFields(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLocalDemDataSourceProxy *pObjectX = (JCLocalDemDataSourceProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
