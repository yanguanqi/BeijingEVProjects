...
namespace EarthView
{
	namespace World
	{
		namespace Spatial3D
		{
			...
			{
				class JCSmart3DDatasetProxy : public EarthView::World::Spatial3D::ModelManager::CSmart3DDataset
				{
				 private:
					EarthView::World::Core::ev_string m_readDem_ev_uint32_ev_uint32_ev_uint32_MemoryDataStreamPtr_callback;
					EarthView::World::Core::ev_string m_readDemMetaDataInfo_OBQDemMetaInfo_callback;
				...
				public:
					JCSmart3DDatasetProxy(EarthView::World::Core::CNameValuePairList *pList) : CSmart3DDataset(pList)
					{
					}
				...
				public:
					void register_readDem_ev_uint32_ev_uint32_ev_uint32_MemoryDataStreamPtr_callback(EarthView::World::Core::ev_string __method)
					{
						this->m_readDem_ev_uint32_ev_uint32_ev_uint32_MemoryDataStreamPtr_callback = __method;
					}
					void register_readDemMetaDataInfo_OBQDemMetaInfo_callback(EarthView::World::Core::ev_string __method)
					{
						this->m_readDemMetaDataInfo_OBQDemMetaInfo_callback = __method;
					}
					...
					virtual ev_int32 readDem(ev_uint32 level, ev_uint32 row, ev_uint32 col, EarthView::World::Core::MemoryDataStreamPtr& bilStream)
					{
						if (this->_gRef != NULL && this->m_readDem_ev_uint32_ev_uint32_ev_uint32_MemoryDataStreamPtr_callback != "" && this->isCustomExtend())
						{
							EarthView::World::Core::GlobalReference *__gr = (EarthView::World::Core::GlobalReference *)this->getJavaReference();
							JNIEnv * __env;
							#if EV_PLATFORM == EV_PLATFORM_ANDROID
							...
							jlong bilStream_j = (jlong) &bilStream;
							jmethodID __method = __gr->getMethod("readDem_ev_uint32_ev_uint32_ev_uint32_MemoryDataStreamPtr_callback");
							jint __values1_j = (jint)__env->CallIntMethod(__obj, __method , level_j, row_j, col_j, bilStream_j);
							#if EV_PLATFORM == EV_PLATFORM_ANDROID
							if(__jniAttachable)
							{
								EarthView::World::Core::JNILoad::getCachedJVM()->DetachCurrentThread();
					...
					virtual ev_bool readDemMetaDataInfo(EarthView::World::Spatial3D::ModelManager::OBQDemMetaInfo& info)
					{
						if (this->_gRef != NULL && this->m_readDemMetaDataInfo_OBQDemMetaInfo_callback != "" && this->isCustomExtend())
						{
							EarthView::World::Core::GlobalReference *__gr = (EarthView::World::Core::GlobalReference *)this->getJavaReference();
							JNIEnv * __env;
							#if EV_PLATFORM == EV_PLATFORM_ANDROID
							...
							jmethodID __method = __gr->getMethod("readDemMetaDataInfo_OBQDemMetaInfo_callback");
				...
				REGISTER_FACTORY_CLASS(JCSmart3DDatasetProxy);
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial3d_modelmanager_Smart3DDataset_getType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::ModelManager::CSmart3DDataset *pObjectX = (EarthView::World::Spatial3D::ModelManager::CSmart3DDataset*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCSmart3DDatasetProxy))
					{
						EarthView::World::Spatial::GeoDataset::EVDatasetType __values1 = pObjectX->EarthView::World::Spatial3D::ModelManager::CSmart3DDataset::getType();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_modelmanager_Smart3DDataset_register_1getType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCSmart3DDatasetProxy *pObjectX = (JCSmart3DDatasetProxy*) pObjXXXX;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial3d_modelmanager_Smart3DDataset_getType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::ModelManager::CSmart3DDataset *pObjectX = (EarthView::World::Spatial3D::ModelManager::CSmart3DDataset*) pObjXXXX;
					EarthView::World::Spatial::GeoDataset::EVDatasetType __values1 = pObjectX->EarthView::World::Spatial3D::ModelManager::CSmart3DDataset::getType();
					jint __values1_j = (jint) __values1;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial3d_modelmanager_Smart3DDataset_readInitData_1OBQInitData(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong initData_j)
				{
					...
					EarthView::World::Spatial3D::ModelManager::CSmart3DDataset *pObjectX = (EarthView::World::Spatial3D::ModelManager::CSmart3DDataset*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCSmart3DDatasetProxy))
					{
						ev_int32 __values1 = pObjectX->EarthView::World::Spatial3D::ModelManager::CSmart3DDataset::readInitData(initData);
						jint __values1_j = (jint)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_modelmanager_Smart3DDataset_register_1readInitData_1OBQInitData(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCSmart3DDatasetProxy *pObjectX = (JCSmart3DDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial3d_modelmanager_Smart3DDataset_readInitData_1OBQInitData_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong initData_j)
				{
					EarthView::World::Spatial3D::ModelManager::OBQInitData &initData = *(EarthView::World::Spatial3D::ModelManager::OBQInitData*) initData_j;
					EarthView::World::Spatial3D::ModelManager::CSmart3DDataset *pObjectX = (EarthView::World::Spatial3D::ModelManager::CSmart3DDataset*) pObjXXXX;
					ev_int32 __values1 = pObjectX->EarthView::World::Spatial3D::ModelManager::CSmart3DDataset::readInitData(initData);
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial3d_modelmanager_Smart3DDataset_readTileData_1EVString_1EVString_1ev_1uint32_1MeshStream_1LodIndexVector(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring filename_j, jstring tileName_j, jlong lodID_j, jlong meshStream_j, jlong childIndexVec_j)
				{
					#if EV_PLATFORM == EV_PLATFORM_ANDROID
					...
					if (typeid(*pObjectX) == typeid(JCSmart3DDatasetProxy))
					{
						ev_int32 __values1 = pObjectX->EarthView::World::Spatial3D::ModelManager::CSmart3DDataset::readTileData(filename, tileName, lodID, meshStream, childIndexVec);
						jint __values1_j = (jint)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_modelmanager_Smart3DDataset_register_1readTileData_1EVString_1EVString_1ev_1uint32_1MeshStream_1LodIndexVector(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCSmart3DDatasetProxy *pObjectX = (JCSmart3DDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial3d_modelmanager_Smart3DDataset_readTileData_1EVString_1EVString_1ev_1uint32_1MeshStream_1LodIndexVector_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring filename_j, jstring tileName_j, jlong lodID_j, jlong meshStream_j, jlong childIndexVec_j)
				{
					#if EV_PLATFORM == EV_PLATFORM_ANDROID
					const ev_char* filename_ch = (const ev_char*)__env->GetStringUTFChars(filename_j,JNI_FALSE);
					const EVString filename = filename_ch;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial3d_modelmanager_Smart3DDataset_readTileMeshData_1EVString_1EVString_1MemoryDataStreamPtr(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring filename_j, jstring tileName_j, jlong meshStream_j)
				{
					#if EV_PLATFORM == EV_PLATFORM_ANDROID
					const ev_char* filename_ch = (const ev_char*)__env->GetStringUTFChars(filename_j,JNI_FALSE);
					const EVString filename = filename_ch;
					...
					if (typeid(*pObjectX) == typeid(JCSmart3DDatasetProxy))
					{
						ev_int32 __values1 = pObjectX->EarthView::World::Spatial3D::ModelManager::CSmart3DDataset::readTileMeshData(filename, tileName, meshStream);
						jint __values1_j = (jint)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_modelmanager_Smart3DDataset_register_1readTileMeshData_1EVString_1EVString_1MemoryDataStreamPtr(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCSmart3DDatasetProxy *pObjectX = (JCSmart3DDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial3d_modelmanager_Smart3DDataset_readTileMeshData_1EVString_1EVString_1MemoryDataStreamPtr_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring filename_j, jstring tileName_j, jlong meshStream_j)
				{
					#if EV_PLATFORM == EV_PLATFORM_ANDROID
					const ev_char* filename_ch = (const ev_char*)__env->GetStringUTFChars(filename_j,JNI_FALSE);
					const EVString filename = filename_ch;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial3d_modelmanager_Smart3DDataset_readDem_1ev_1uint32_1ev_1uint32_1ev_1uint32_1MemoryDataStreamPtr(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong level_j, jlong row_j, jlong col_j, jlong bilStream_j)
				{
					...
					if (typeid(*pObjectX) == typeid(JCSmart3DDatasetProxy))
					{
						ev_int32 __values1 = pObjectX->EarthView::World::Spatial3D::ModelManager::CSmart3DDataset::readDem(level, row, col, bilStream);
						jint __values1_j = (jint)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_modelmanager_Smart3DDataset_register_1readDem_1ev_1uint32_1ev_1uint32_1ev_1uint32_1MemoryDataStreamPtr(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCSmart3DDatasetProxy *pObjectX = (JCSmart3DDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
					__env->ReleaseStringUTFChars(__method, pMethod);
					pObjectX->register_readDem_ev_uint32_ev_uint32_ev_uint32_MemoryDataStreamPtr_callback(sMethod);
					if (pObjectX->getJavaReference() != NULL && sMethod != "")
					{
						EarthView::World::Core::GlobalReference *__gr = (EarthView::World::Core::GlobalReference *)pObjectX->getJavaReference();
						jobject __obj1 = __gr->getJObject();
						jclass __clazz1 = __env->GetObjectClass(__obj1);
						jmethodID __method = __env->GetMethodID(__clazz1,"readDem_ev_uint32_ev_uint32_ev_uint32_MemoryDataStreamPtr_callback", "(JJJJ)I");
						__gr->setMethod(sMethod, __method);
					}
				}
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial3d_modelmanager_Smart3DDataset_readDem_1ev_1uint32_1ev_1uint32_1ev_1uint32_1MemoryDataStreamPtr_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong level_j, jlong row_j, jlong col_j, jlong bilStream_j)
				{
					ev_uint32 level = (ev_uint32) level_j;
					ev_uint32 row = (ev_uint32) row_j;
					ev_uint32 col = (ev_uint32) col_j;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_modelmanager_Smart3DDataset_readDemMetaDataInfo_1OBQDemMetaInfo(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong info_j)
				{
					EarthView::World::Spatial3D::ModelManager::OBQDemMetaInfo &info = *(EarthView::World::Spatial3D::ModelManager::OBQDemMetaInfo*) info_j;
					EarthView::World::Spatial3D::ModelManager::CSmart3DDataset *pObjectX = (EarthView::World::Spatial3D::ModelManager::CSmart3DDataset*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCSmart3DDatasetProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::ModelManager::CSmart3DDataset::readDemMetaDataInfo(info);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_modelmanager_Smart3DDataset_register_1readDemMetaDataInfo_1OBQDemMetaInfo(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCSmart3DDatasetProxy *pObjectX = (JCSmart3DDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
					__env->ReleaseStringUTFChars(__method, pMethod);
					pObjectX->register_readDemMetaDataInfo_OBQDemMetaInfo_callback(sMethod);
					if (pObjectX->getJavaReference() != NULL && sMethod != "")
					{
						EarthView::World::Core::GlobalReference *__gr = (EarthView::World::Core::GlobalReference *)pObjectX->getJavaReference();
						jobject __obj1 = __gr->getJObject();
						jclass __clazz1 = __env->GetObjectClass(__obj1);
						jmethodID __method = __env->GetMethodID(__clazz1,"readDemMetaDataInfo_OBQDemMetaInfo_callback", "(J)Z");
						__gr->setMethod(sMethod, __method);
					}
				}
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_modelmanager_Smart3DDataset_readDemMetaDataInfo_1OBQDemMetaInfo_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong info_j)
				{
					EarthView::World::Spatial3D::ModelManager::OBQDemMetaInfo &info = *(EarthView::World::Spatial3D::ModelManager::OBQDemMetaInfo*) info_j;
					EarthView::World::Spatial3D::ModelManager::CSmart3DDataset *pObjectX = (EarthView::World::Spatial3D::ModelManager::CSmart3DDataset*) pObjXXXX;
					ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::ModelManager::CSmart3DDataset::readDemMetaDataInfo(info);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_modelmanager_Smart3DDataset_register_1readMetaDataInfo_1OBQMetaInfo(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCSmart3DDatasetProxy *pObjectX = (JCSmart3DDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_modelmanager_Smart3DDataset_register_1updateMetaDataInfo_1ev_1real64(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCSmart3DDatasetProxy *pObjectX = (JCSmart3DDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_modelmanager_Smart3DDataset_register_1updateMetaDataInfo_1OBQMetaInfo(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCSmart3DDatasetProxy *pObjectX = (JCSmart3DDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_modelmanager_Smart3DDataset_register_1getName_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCSmart3DDatasetProxy *pObjectX = (JCSmart3DDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_modelmanager_Smart3DDataset_register_1getDataVersion_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCSmart3DDatasetProxy *pObjectX = (JCSmart3DDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_modelmanager_Smart3DDataset_register_1getDescription_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCSmart3DDatasetProxy *pObjectX = (JCSmart3DDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_modelmanager_Smart3DDataset_register_1getUpdateTime_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCSmart3DDatasetProxy *pObjectX = (JCSmart3DDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_modelmanager_Smart3DDataset_register_1hasSubDataset_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCSmart3DDatasetProxy *pObjectX = (JCSmart3DDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_modelmanager_Smart3DDataset_register_1getDataSourceRef_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCSmart3DDatasetProxy *pObjectX = (JCSmart3DDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_modelmanager_Smart3DDataset_register_1canEdit_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCSmart3DDatasetProxy *pObjectX = (JCSmart3DDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_modelmanager_Smart3DDataset_register_1isEditing_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCSmart3DDatasetProxy *pObjectX = (JCSmart3DDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_modelmanager_Smart3DDataset_register_1startEditing_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCSmart3DDatasetProxy *pObjectX = (JCSmart3DDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_modelmanager_Smart3DDataset_register_1stopEditing_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCSmart3DDatasetProxy *pObjectX = (JCSmart3DDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_modelmanager_Smart3DDataset_register_1isBeginEditingOperation_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCSmart3DDatasetProxy *pObjectX = (JCSmart3DDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_modelmanager_Smart3DDataset_register_1beginEditingOperation_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCSmart3DDatasetProxy *pObjectX = (JCSmart3DDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_modelmanager_Smart3DDataset_register_1endEditingOperation_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCSmart3DDatasetProxy *pObjectX = (JCSmart3DDatasetProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
