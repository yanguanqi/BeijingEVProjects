...
namespace EarthView
{
	namespace World
	{
		namespace Spatial3D
		{
			...
			{
				class JCEffectUserDataProxy : public EarthView::World::Spatial3D::EffectManager::CEffectUserData
				{
				 private:
					EarthView::World::Core::ev_string m_ev_clone_void_callback;
				public:
					JCEffectUserDataProxy(EarthView::World::Core::CNameValuePairList *pList) : CEffectUserData(pList)
					{
					}
				...
				REGISTER_FACTORY_CLASS(JCEffectUserDataProxy);
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_effectmanager_EffectUserData_ev_1clone_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::EffectManager::CEffectUserData *pObjectX = (EarthView::World::Spatial3D::EffectManager::CEffectUserData*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCEffectUserDataProxy))
					{
						EarthView::World::Graphic::CMovableObject::CUserData* __values1 = pObjectX->EarthView::World::Spatial3D::EffectManager::CEffectUserData::clone();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_EffectUserData_register_1ev_1clone_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectUserDataProxy *pObjectX = (JCEffectUserDataProxy*) pObjXXXX;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_effectmanager_EffectUserData_ev_1clone_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::EffectManager::CEffectUserData *pObjectX = (EarthView::World::Spatial3D::EffectManager::CEffectUserData*) pObjXXXX;
					EarthView::World::Graphic::CMovableObject::CUserData* __values1 = pObjectX->EarthView::World::Spatial3D::EffectManager::CEffectUserData::clone();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_effectmanager_EffectUserData_get_1VisibleObject_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::EffectManager::CEffectUserData *pObjectX = (EarthView::World::Spatial3D::EffectManager::CEffectUserData*)pObjXXXX;
					jlong __values1_j = (jlong)(pObjectX->VisibleObject);
					return __values1_j;
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_EffectUserData_set_1VisibleObject_1CVisibleObject(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jlong __values1_j)
				{
					EarthView::World::Spatial3D::EffectManager::CEffectUserData *pObjectX = (EarthView::World::Spatial3D::EffectManager::CEffectUserData*)pObjXXXX;
					pObjectX->VisibleObject = (EarthView::World::Geometry3D::CVisibleObject*) __values1_j;
				}
				class JCEffectProxy : public EarthView::World::Spatial3D::EffectManager::CEffect
				{
				 private:
				...
				public:
					JCEffectProxy(EarthView::World::Core::CNameValuePairList *pList) : CEffect(pList)
					{
					}
					ev_void unRegisterJavaReference()
					{
				...
				public:
					...
					virtual ev_bool selectBy(const EarthView::World::Spatial::Math::CAxisAlignedBox& aabb, ev_bool renderSelected, EarthView::World::Core::IntVector& indexVec)
					{
						if (this->_gRef != NULL && this->m_selectBy_CAxisAlignedBox_ev_bool_IntVector_callback != "" && this->isCustomExtend())
						{
							...
							jboolean renderSelected_j = (jboolean) renderSelected;
							jlong indexVec_j = (jlong) &indexVec;
							jmethodID __method = __gr->getMethod("selectBy_CAxisAlignedBox_ev_bool_IntVector_callback");
							jboolean __values1_j = (jboolean)__env->CallBooleanMethod(__obj, __method , aabb_j, renderSelected_j, indexVec_j);
							#if EV_PLATFORM == EV_PLATFORM_ANDROID
							if(__jniAttachable)
							{
								EarthView::World::Core::JNILoad::getCachedJVM()->DetachCurrentThread();
					...
					virtual ev_bool selectBy(const EarthView::World::Spatial::Math::CSphere& sphere, ev_bool renderSelected, EarthView::World::Core::IntVector& indexVec)
					{
						if (this->_gRef != NULL && this->m_selectBy_CSphere_ev_bool_IntVector_callback != "" && this->isCustomExtend())
						{
							...
							jboolean __values1_j = (jboolean)__env->CallBooleanMethod(__obj, __method , sphere_j, renderSelected_j, indexVec_j);
							#if EV_PLATFORM == EV_PLATFORM_ANDROID
							if(__jniAttachable)
							{
								EarthView::World::Core::JNILoad::getCachedJVM()->DetachCurrentThread();
					...
					virtual void _notifyAttached(EarthView::World::Graphic::CNode* parent)
					{
						if (this->_gRef != NULL && this->m__notifyAttached_CNode_callback != "" && this->isCustomExtend())
						{
							...
							__env->CallVoidMethod(__obj, __method , parent_j);
							#if EV_PLATFORM == EV_PLATFORM_ANDROID
							if(__jniAttachable)
							{
								EarthView::World::Core::JNILoad::getCachedJVM()->DetachCurrentThread();
				...
				REGISTER_FACTORY_CLASS(JCEffectProxy);
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_setRenderingMaxDistance_1Real(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble dist_j)
				{
					Real dist = (Real) dist_j;
					EarthView::World::Spatial3D::EffectManager::CEffect *pObjectX = (EarthView::World::Spatial3D::EffectManager::CEffect*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCEffectProxy))
					{
						pObjectX->EarthView::World::Spatial3D::EffectManager::CEffect::setRenderingMaxDistance(dist);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1setRenderingMaxDistance_1Real(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
					__env->ReleaseStringUTFChars(__method, pMethod);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_setRenderingMaxDistance_1Real_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble dist_j)
				{
					Real dist = (Real) dist_j;
					EarthView::World::Spatial3D::EffectManager::CEffect *pObjectX = (EarthView::World::Spatial3D::EffectManager::CEffect*) pObjXXXX;
					pObjectX->EarthView::World::Spatial3D::EffectManager::CEffect::setRenderingMaxDistance(dist);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_setRenderingMinDistance_1Real(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble dist_j)
				{
					Real dist = (Real) dist_j;
					EarthView::World::Spatial3D::EffectManager::CEffect *pObjectX = (EarthView::World::Spatial3D::EffectManager::CEffect*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCEffectProxy))
					{
						pObjectX->EarthView::World::Spatial3D::EffectManager::CEffect::setRenderingMinDistance(dist);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1setRenderingMinDistance_1Real(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_setRenderingMinDistance_1Real_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble dist_j)
				{
					Real dist = (Real) dist_j;
					EarthView::World::Spatial3D::EffectManager::CEffect *pObjectX = (EarthView::World::Spatial3D::EffectManager::CEffect*) pObjXXXX;
					pObjectX->EarthView::World::Spatial3D::EffectManager::CEffect::setRenderingMinDistance(dist);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_setVisible_1ev_1bool(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean visible_j)
				{
					ev_bool visible = (ev_bool) visible_j;
					EarthView::World::Spatial3D::EffectManager::CEffect *pObjectX = (EarthView::World::Spatial3D::EffectManager::CEffect*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCEffectProxy))
					{
						pObjectX->EarthView::World::Spatial3D::EffectManager::CEffect::setVisible(visible);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1setVisible_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_setVisible_1ev_1bool_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean visible_j)
				{
					ev_bool visible = (ev_bool) visible_j;
					EarthView::World::Spatial3D::EffectManager::CEffect *pObjectX = (EarthView::World::Spatial3D::EffectManager::CEffect*) pObjXXXX;
					pObjectX->EarthView::World::Spatial3D::EffectManager::CEffect::setVisible(visible);
				}
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_getAliasName_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::EffectManager::CEffect *pObjectX = (EarthView::World::Spatial3D::EffectManager::CEffect*) pObjXXXX;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_getBindedID_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::EffectManager::CEffect *pObjectX = (EarthView::World::Spatial3D::EffectManager::CEffect*) pObjXXXX;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_setBindedID_1ev_1uint32(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong id_j)
				{
					ev_uint32 id = (ev_uint32) id_j;
					EarthView::World::Spatial3D::EffectManager::CEffect *pObjectX = (EarthView::World::Spatial3D::EffectManager::CEffect*) pObjXXXX;
					pObjectX->setBindedID(id);
				}
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_getMovableNum_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::EffectManager::CEffect *pObjectX = (EarthView::World::Spatial3D::EffectManager::CEffect*) pObjXXXX;
					ev_uint32 __values1 = pObjectX->getMovableNum();
					jlong __values1_j = (jlong) __values1;
					return __values1_j;
				}
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_getMovableByIndex_1ev_1uint32(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong index_j)
				{
					ev_uint32 index = (ev_uint32) index_j;
					EarthView::World::Spatial3D::EffectManager::CEffect *pObjectX = (EarthView::World::Spatial3D::EffectManager::CEffect*) pObjXXXX;
					EarthView::World::Graphic::CMovableObject* __values1 = pObjectX->getMovableByIndex(index);
					jlong __values1_j = (jlong) __values1;
					return __values1_j;
				}
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_getEffectInfoNum_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::EffectManager::CEffect *pObjectX = (EarthView::World::Spatial3D::EffectManager::CEffect*) pObjXXXX;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_getEffectInfoByIndex_1ev_1uint32(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong index_j)
				{
					ev_uint32 index = (ev_uint32) index_j;
					EarthView::World::Spatial3D::EffectManager::CEffect *pObjectX = (EarthView::World::Spatial3D::EffectManager::CEffect*) pObjXXXX;
					EarthView::World::Spatial3D::Dataset::CEffectInfo __values1 = pObjectX->getEffectInfoByIndex(index);
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_getEffectID_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::EffectManager::CEffect *pObjectX = (EarthView::World::Spatial3D::EffectManager::CEffect*) pObjXXXX;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_getBoundingBox_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::EffectManager::CEffect *pObjectX = (EarthView::World::Spatial3D::EffectManager::CEffect*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCEffectProxy))
					{
						const EarthView::World::Spatial::Math::CAxisAlignedBox& __values1 = pObjectX->EarthView::World::Spatial3D::EffectManager::CEffect::getBoundingBox();
						jlong __values1_j = (jlong) &__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1getBoundingBox_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_getBoundingBox_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::EffectManager::CEffect *pObjectX = (EarthView::World::Spatial3D::EffectManager::CEffect*) pObjXXXX;
					const EarthView::World::Spatial::Math::CAxisAlignedBox& __values1 = pObjectX->EarthView::World::Spatial3D::EffectManager::CEffect::getBoundingBox();
					jlong __values1_j = (jlong) &__values1;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_getType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::EffectManager::CEffect *pObjectX = (EarthView::World::Spatial3D::EffectManager::CEffect*) pObjXXXX;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_setSelectionColour_1CColourValue(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong colour_j)
				{
					const EarthView::World::Graphic::CColourValue &colour = *(EarthView::World::Graphic::CColourValue*) colour_j;
					EarthView::World::Spatial3D::EffectManager::CEffect *pObjectX = (EarthView::World::Spatial3D::EffectManager::CEffect*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCEffectProxy))
					{
						pObjectX->EarthView::World::Spatial3D::EffectManager::CEffect::setSelectionColour(colour);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1setSelectionColour_1CColourValue(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_setSelectionColour_1CColourValue_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong colour_j)
				{
					const EarthView::World::Graphic::CColourValue &colour = *(EarthView::World::Graphic::CColourValue*) colour_j;
					EarthView::World::Spatial3D::EffectManager::CEffect *pObjectX = (EarthView::World::Spatial3D::EffectManager::CEffect*) pObjXXXX;
					pObjectX->EarthView::World::Spatial3D::EffectManager::CEffect::setSelectionColour(colour);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_renderSelection_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::EffectManager::CEffect *pObjectX = (EarthView::World::Spatial3D::EffectManager::CEffect*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCEffectProxy))
					{
						pObjectX->EarthView::World::Spatial3D::EffectManager::CEffect::renderSelection();
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1renderSelection_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_renderSelection_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::EffectManager::CEffect *pObjectX = (EarthView::World::Spatial3D::EffectManager::CEffect*) pObjXXXX;
					pObjectX->EarthView::World::Spatial3D::EffectManager::CEffect::renderSelection();
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_clearSelection_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::EffectManager::CEffect *pObjectX = (EarthView::World::Spatial3D::EffectManager::CEffect*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCEffectProxy))
					{
						pObjectX->EarthView::World::Spatial3D::EffectManager::CEffect::clearSelection();
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1clearSelection_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_clearSelection_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::EffectManager::CEffect *pObjectX = (EarthView::World::Spatial3D::EffectManager::CEffect*) pObjXXXX;
					pObjectX->EarthView::World::Spatial3D::EffectManager::CEffect::clearSelection();
				}
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_setSelected_1IntVector(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong objIndics_j)
				{
					const EarthView::World::Core::IntVector &objIndics = *(EarthView::World::Core::IntVector*) objIndics_j;
					EarthView::World::Spatial3D::EffectManager::CEffect *pObjectX = (EarthView::World::Spatial3D::EffectManager::CEffect*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCEffectProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::EffectManager::CEffect::setSelected(objIndics);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1setSelected_1IntVector(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_setSelected_1IntVector_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong objIndics_j)
				{
					const EarthView::World::Core::IntVector &objIndics = *(EarthView::World::Core::IntVector*) objIndics_j;
					EarthView::World::Spatial3D::EffectManager::CEffect *pObjectX = (EarthView::World::Spatial3D::EffectManager::CEffect*) pObjXXXX;
					ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::EffectManager::CEffect::setSelected(objIndics);
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_getSelected_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::EffectManager::CEffect *pObjectX = (EarthView::World::Spatial3D::EffectManager::CEffect*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCEffectProxy))
					{
						EarthView::World::Core::IntVector __values1 = pObjectX->EarthView::World::Spatial3D::EffectManager::CEffect::getSelected();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1getSelected_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_getSelected_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::EffectManager::CEffect *pObjectX = (EarthView::World::Spatial3D::EffectManager::CEffect*) pObjXXXX;
					EarthView::World::Core::IntVector __values1 = pObjectX->EarthView::World::Spatial3D::EffectManager::CEffect::getSelected();
					EarthView::World::Core::IntVector *returnvalues = new EarthView::World::Core::IntVector(__values1);
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_startEditing_1ev_1uint32(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong objectIndex_j)
				{
					ev_uint32 objectIndex = (ev_uint32) objectIndex_j;
					EarthView::World::Spatial3D::EffectManager::CEffect *pObjectX = (EarthView::World::Spatial3D::EffectManager::CEffect*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCEffectProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::EffectManager::CEffect::startEditing(objectIndex);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1startEditing_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_startEditing_1ev_1uint32_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong objectIndex_j)
				{
					ev_uint32 objectIndex = (ev_uint32) objectIndex_j;
					EarthView::World::Spatial3D::EffectManager::CEffect *pObjectX = (EarthView::World::Spatial3D::EffectManager::CEffect*) pObjXXXX;
					ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::EffectManager::CEffect::startEditing(objectIndex);
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_getTypeFlags_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::EffectManager::CEffect *pObjectX = (EarthView::World::Spatial3D::EffectManager::CEffect*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCEffectProxy))
					{
						ev_uint32 __values1 = pObjectX->EarthView::World::Spatial3D::EffectManager::CEffect::getTypeFlags();
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1getTypeFlags_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_getTypeFlags_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::EffectManager::CEffect *pObjectX = (EarthView::World::Spatial3D::EffectManager::CEffect*) pObjXXXX;
					ev_uint32 __values1 = pObjectX->EarthView::World::Spatial3D::EffectManager::CEffect::getTypeFlags();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_getSelectedObjectWorldMatrix_1ev_1uint32_1CMatrix4(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong objectIndex_j, jlong matrix_j)
				{
					ev_uint32 objectIndex = (ev_uint32) objectIndex_j;
					...
					if (typeid(*pObjectX) == typeid(JCEffectProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::EffectManager::CEffect::getSelectedObjectWorldMatrix(objectIndex, matrix);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1getSelectedObjectWorldMatrix_1ev_1uint32_1CMatrix4(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_getSelectedObjectWorldMatrix_1ev_1uint32_1CMatrix4_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong objectIndex_j, jlong matrix_j)
				{
					ev_uint32 objectIndex = (ev_uint32) objectIndex_j;
					EarthView::World::Spatial::Math::CMatrix4 &matrix = *(EarthView::World::Spatial::Math::CMatrix4*) matrix_j;
					EarthView::World::Spatial3D::EffectManager::CEffect *pObjectX = (EarthView::World::Spatial3D::EffectManager::CEffect*) pObjXXXX;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_setSelectedObjectWorldMatrix_1ev_1uint32_1CMatrix4(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong objectIndex_j, jlong matrix_j)
				{
					ev_uint32 objectIndex = (ev_uint32) objectIndex_j;
					...
					if (typeid(*pObjectX) == typeid(JCEffectProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::EffectManager::CEffect::setSelectedObjectWorldMatrix(objectIndex, matrix);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1setSelectedObjectWorldMatrix_1ev_1uint32_1CMatrix4(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_setSelectedObjectWorldMatrix_1ev_1uint32_1CMatrix4_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong objectIndex_j, jlong matrix_j)
				{
					ev_uint32 objectIndex = (ev_uint32) objectIndex_j;
					const EarthView::World::Spatial::Math::CMatrix4 &matrix = *(EarthView::World::Spatial::Math::CMatrix4*) matrix_j;
					EarthView::World::Spatial3D::EffectManager::CEffect *pObjectX = (EarthView::World::Spatial3D::EffectManager::CEffect*) pObjXXXX;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_endEditing_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::EffectManager::CEffect *pObjectX = (EarthView::World::Spatial3D::EffectManager::CEffect*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCEffectProxy))
					{
						pObjectX->EarthView::World::Spatial3D::EffectManager::CEffect::endEditing();
					}
					else
					{
						pObjectX->endEditing();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1endEditing_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_endEditing_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::EffectManager::CEffect *pObjectX = (EarthView::World::Spatial3D::EffectManager::CEffect*) pObjXXXX;
					pObjectX->EarthView::World::Spatial3D::EffectManager::CEffect::endEditing();
				}
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_getEditBoundingBox_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::EffectManager::CEffect *pObjectX = (EarthView::World::Spatial3D::EffectManager::CEffect*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCEffectProxy))
					{
						EarthView::World::Graphic::CEditBoundingBox* __values1 = pObjectX->EarthView::World::Spatial3D::EffectManager::CEffect::getEditBoundingBox();
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1getEditBoundingBox_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_getEditBoundingBox_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::EffectManager::CEffect *pObjectX = (EarthView::World::Spatial3D::EffectManager::CEffect*) pObjXXXX;
					EarthView::World::Graphic::CEditBoundingBox* __values1 = pObjectX->EarthView::World::Spatial3D::EffectManager::CEffect::getEditBoundingBox();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_selectBy_1CRay_1CViewport_1ev_1bool_1ev_1int32_1CVector3(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong ray_j, jlong viewport_j, jboolean prepareToRenderSelection_j, jlong objIndex_j, jlong point_j)
				{
					...
					if (typeid(*pObjectX) == typeid(JCEffectProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::EffectManager::CEffect::selectBy(ray, viewport, prepareToRenderSelection, objIndex, point);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1selectBy_1CRay_1CViewport_1ev_1bool_1ev_1int32_1CVector3(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_selectBy_1CRay_1CViewport_1ev_1bool_1ev_1int32_1CVector3_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong ray_j, jlong viewport_j, jboolean prepareToRenderSelection_j, jlong objIndex_j, jlong point_j)
				{
					const EarthView::World::Spatial::Math::CRay &ray = *(EarthView::World::Spatial::Math::CRay*) ray_j;
					const EarthView::World::Graphic::CViewport *viewport = (const EarthView::World::Graphic::CViewport*) viewport_j;
					ev_bool prepareToRenderSelection = (ev_bool) prepareToRenderSelection_j;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_selectBy_1CAxisAlignedBox_1ev_1bool_1IntVector(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong aabb_j, jboolean renderSelected_j, jlong indexVec_j)
				{
					const EarthView::World::Spatial::Math::CAxisAlignedBox &aabb = *(EarthView::World::Spatial::Math::CAxisAlignedBox*) aabb_j;
					ev_bool renderSelected = (ev_bool) renderSelected_j;
					EarthView::World::Core::IntVector &indexVec = *(EarthView::World::Core::IntVector*) indexVec_j;
					EarthView::World::Spatial3D::EffectManager::CEffect *pObjectX = (EarthView::World::Spatial3D::EffectManager::CEffect*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCEffectProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::EffectManager::CEffect::selectBy(aabb, renderSelected, indexVec);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
					{
						ev_bool __values1 = pObjectX->selectBy(aabb, renderSelected, indexVec);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1selectBy_1CAxisAlignedBox_1ev_1bool_1IntVector(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_selectBy_1CAxisAlignedBox_1ev_1bool_1IntVector_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong aabb_j, jboolean renderSelected_j, jlong indexVec_j)
				{
					const EarthView::World::Spatial::Math::CAxisAlignedBox &aabb = *(EarthView::World::Spatial::Math::CAxisAlignedBox*) aabb_j;
					ev_bool renderSelected = (ev_bool) renderSelected_j;
					EarthView::World::Core::IntVector &indexVec = *(EarthView::World::Core::IntVector*) indexVec_j;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_selectBy_1CSphere_1ev_1bool_1IntVector(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong sphere_j, jboolean renderSelected_j, jlong indexVec_j)
				{
					...
					if (typeid(*pObjectX) == typeid(JCEffectProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::EffectManager::CEffect::selectBy(sphere, renderSelected, indexVec);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
					{
						ev_bool __values1 = pObjectX->selectBy(sphere, renderSelected, indexVec);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1selectBy_1CSphere_1ev_1bool_1IntVector(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_selectBy_1CSphere_1ev_1bool_1IntVector_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong sphere_j, jboolean renderSelected_j, jlong indexVec_j)
				{
					const EarthView::World::Spatial::Math::CSphere &sphere = *(EarthView::World::Spatial::Math::CSphere*) sphere_j;
					ev_bool renderSelected = (ev_bool) renderSelected_j;
					EarthView::World::Core::IntVector &indexVec = *(EarthView::World::Core::IntVector*) indexVec_j;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_getMovableType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::EffectManager::CEffect *pObjectX = (EarthView::World::Spatial3D::EffectManager::CEffect*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCEffectProxy))
					{
						EVString __values1 = pObjectX->EarthView::World::Spatial3D::EffectManager::CEffect::getMovableType();
						EarthView::World::Core::ev_wstring valuesw1 = __values1;
						jstring __values1_j = __env->NewString((const jchar*)valuesw1.getString(), valuesw1.size());
						return __values1_j;
					}
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1getMovableType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_getMovableType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::EffectManager::CEffect *pObjectX = (EarthView::World::Spatial3D::EffectManager::CEffect*) pObjXXXX;
					EVString __values1 = pObjectX->EarthView::World::Spatial3D::EffectManager::CEffect::getMovableType();
					EarthView::World::Core::ev_wstring valuesw1 = __values1;
				...
				extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_getBoundingRadius_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::EffectManager::CEffect *pObjectX = (EarthView::World::Spatial3D::EffectManager::CEffect*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCEffectProxy))
					{
						Real __values1 = pObjectX->EarthView::World::Spatial3D::EffectManager::CEffect::getBoundingRadius();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1getBoundingRadius_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_getBoundingRadius_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::EffectManager::CEffect *pObjectX = (EarthView::World::Spatial3D::EffectManager::CEffect*) pObjXXXX;
					Real __values1 = pObjectX->EarthView::World::Spatial3D::EffectManager::CEffect::getBoundingRadius();
					jdouble __values1_j = (jdouble)__values1;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect__1updateRenderQueue_1CRenderQueue(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong queue_j)
				{
					EarthView::World::Graphic::CRenderQueue *queue = (EarthView::World::Graphic::CRenderQueue*) queue_j;
					EarthView::World::Spatial3D::EffectManager::CEffect *pObjectX = (EarthView::World::Spatial3D::EffectManager::CEffect*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCEffectProxy))
					{
						pObjectX->EarthView::World::Spatial3D::EffectManager::CEffect::_updateRenderQueue(queue);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1_1updateRenderQueue_1CRenderQueue(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect__1updateRenderQueue_1CRenderQueue_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong queue_j)
				{
					EarthView::World::Graphic::CRenderQueue *queue = (EarthView::World::Graphic::CRenderQueue*) queue_j;
					EarthView::World::Spatial3D::EffectManager::CEffect *pObjectX = (EarthView::World::Spatial3D::EffectManager::CEffect*) pObjXXXX;
					pObjectX->EarthView::World::Spatial3D::EffectManager::CEffect::_updateRenderQueue(queue);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_visitRenderables_1CVisitor_1ev_1bool(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong visitor_j, jboolean debugRenderables_j)
				{
					...
					if (typeid(*pObjectX) == typeid(JCEffectProxy))
					{
						pObjectX->EarthView::World::Spatial3D::EffectManager::CEffect::visitRenderables(visitor, debugRenderables);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1visitRenderables_1CVisitor_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_visitRenderables_1CVisitor_1ev_1bool_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong visitor_j, jboolean debugRenderables_j)
				{
					EarthView::World::Graphic::CRenderable::CVisitor *visitor = (EarthView::World::Graphic::CRenderable::CVisitor*) visitor_j;
					ev_bool debugRenderables = (ev_bool) debugRenderables_j;
					EarthView::World::Spatial3D::EffectManager::CEffect *pObjectX = (EarthView::World::Spatial3D::EffectManager::CEffect*) pObjXXXX;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_visitRenderables_1CVisitor(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong visitor_j)
				{
					EarthView::World::Graphic::CRenderable::CVisitor *visitor = (EarthView::World::Graphic::CRenderable::CVisitor*) visitor_j;
					EarthView::World::Spatial3D::EffectManager::CEffect *pObjectX = (EarthView::World::Spatial3D::EffectManager::CEffect*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCEffectProxy))
					{
						pObjectX->EarthView::World::Spatial3D::EffectManager::CEffect::visitRenderables(visitor);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1visitRenderables_1CVisitor(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_visitRenderables_1CVisitor_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong visitor_j)
				{
					EarthView::World::Graphic::CRenderable::CVisitor *visitor = (EarthView::World::Graphic::CRenderable::CVisitor*) visitor_j;
					EarthView::World::Spatial3D::EffectManager::CEffect *pObjectX = (EarthView::World::Spatial3D::EffectManager::CEffect*) pObjXXXX;
					pObjectX->EarthView::World::Spatial3D::EffectManager::CEffect::visitRenderables(visitor);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect__1notifyCurrentCamera_1CCamera(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong cam_j)
				{
					EarthView::World::Graphic::CCamera *cam = (EarthView::World::Graphic::CCamera*) cam_j;
					EarthView::World::Spatial3D::EffectManager::CEffect *pObjectX = (EarthView::World::Spatial3D::EffectManager::CEffect*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCEffectProxy))
					{
						pObjectX->EarthView::World::Spatial3D::EffectManager::CEffect::_notifyCurrentCamera(cam);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1_1notifyCurrentCamera_1CCamera(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect__1notifyCurrentCamera_1CCamera_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong cam_j)
				{
					EarthView::World::Graphic::CCamera *cam = (EarthView::World::Graphic::CCamera*) cam_j;
					EarthView::World::Spatial3D::EffectManager::CEffect *pObjectX = (EarthView::World::Spatial3D::EffectManager::CEffect*) pObjXXXX;
					pObjectX->EarthView::World::Spatial3D::EffectManager::CEffect::_notifyCurrentCamera(cam);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect__1notifyAttached_1CNode_1ev_1bool(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong parent_j, jboolean isTagPoint_j)
				{
					...
					if (typeid(*pObjectX) == typeid(JCEffectProxy))
					{
						pObjectX->EarthView::World::Spatial3D::EffectManager::CEffect::_notifyAttached(parent, isTagPoint);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1_1notifyAttached_1CNode_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect__1notifyAttached_1CNode_1ev_1bool_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong parent_j, jboolean isTagPoint_j)
				{
					EarthView::World::Graphic::CNode *parent = (EarthView::World::Graphic::CNode*) parent_j;
					ev_bool isTagPoint = (ev_bool) isTagPoint_j;
					EarthView::World::Spatial3D::EffectManager::CEffect *pObjectX = (EarthView::World::Spatial3D::EffectManager::CEffect*) pObjXXXX;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect__1notifyAttached_1CNode(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong parent_j)
				{
					EarthView::World::Graphic::CNode *parent = (EarthView::World::Graphic::CNode*) parent_j;
					EarthView::World::Spatial3D::EffectManager::CEffect *pObjectX = (EarthView::World::Spatial3D::EffectManager::CEffect*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCEffectProxy))
					{
						pObjectX->EarthView::World::Spatial3D::EffectManager::CEffect::_notifyAttached(parent);
					}
					else
					{
						pObjectX->_notifyAttached(parent);
					}
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1_1notifyAttached_1CNode(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect__1notifyAttached_1CNode_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong parent_j)
				{
					EarthView::World::Graphic::CNode *parent = (EarthView::World::Graphic::CNode*) parent_j;
					EarthView::World::Spatial3D::EffectManager::CEffect *pObjectX = (EarthView::World::Spatial3D::EffectManager::CEffect*) pObjXXXX;
					pObjectX->EarthView::World::Spatial3D::EffectManager::CEffect::_notifyAttached(parent);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1getAnimableObjectPtr_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1getRenderQueueId_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1_1notifyCreator_1CMovableObjectFactory(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1_1getCreator_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1_1notifyManager_1CSceneManager(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1_1getManager_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1getName_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1getParentNode_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1getParentSceneNode_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1isParentTagPoint_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1isAttached_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1detachFromParent_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1isInScene_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1_1notifyMoved_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1_1notifyLightsQueried_1LightList(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1setLightQueriedListener_1CLightQueriedListener(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1getLightQueriedListener_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1getLightListUpdated_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1setLightListUpdated_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1getWorldBoundingSphere_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1getWorldBoundingSphere_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1getVisible_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1isVisible_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1getRenderingMaxDistance_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1getRenderingMinDistance_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1setRenderingMinPixelSize_1Real(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1getRenderingMinPixelSize_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1selectComponentBy_1CRay_1CViewport_1ev_1bool_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32_1CVector3(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1setRenderQueueGroup_1ev_1uint8(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1setRenderQueueGroupAndPriority_1ev_1uint8_1ev_1uint16(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1getRenderQueueGroup_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1_1getParentNodeFullTransform_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1setQueryFlags_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1addQueryFlags_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1removeQueryFlags_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1getQueryFlags_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1setVisibilityFlags_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1addVisibilityFlags_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1removeVisibilityFlags_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1getVisibilityFlags_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1addListener_1CMovableObjectListener(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1removeListener_1CMovableObjectListener(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1existListener_1CMovableObjectListener(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1getListenerCount_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1getListener_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1queryLights_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1getLightMask_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1setLightMask_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1_1getLightList_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1setCastShadows_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1getReceivesShadows_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1setDebugDisplayEnabled_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1isDebugDisplayEnabled_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1getCastShadows_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1getEdgeList_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1hasEdgeList_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1getWorldBoundingBox_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1getWorldBoundingBox_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1getLightCapBounds_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1getDarkCapBounds_1CLight_1Real(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1getShadowVolumeRenderableIterator_1ShadowTechnique_1CLight_1CHardwareIndexBufferSharedPtr_1ev_1bool_1Real_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1getShadowVolumeRenderableIterator_1ShadowTechnique_1CLight_1CHardwareIndexBufferSharedPtr_1ev_1bool_1Real(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1getPointExtrusionDistance_1CLight(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1updateEdgeListLightFacing_1CEdgeData_1CVector4(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1generateShadowVolume_1CEdgeData_1CHardwareIndexBufferSharedPtr_1CLight_1ShadowRenderableList_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_effectmanager_Effect_register_1extrudeBounds_1CAxisAlignedBox_1CVector4_1Real(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEffectProxy *pObjectX = (JCEffectProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
