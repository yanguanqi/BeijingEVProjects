...
namespace EarthView
{
	namespace World
	{
		namespace Spatial3D
		{
			class JCLocalImageDataSourceFactoryProxy : public EarthView::World::Spatial3D::CLocalImageDataSourceFactory
			{
			 private:
			...
			public:
				JCLocalImageDataSourceFactoryProxy(EarthView::World::Core::CNameValuePairList *pList) : CLocalImageDataSourceFactory(pList)
				{
				}
			...
			REGISTER_FACTORY_CLASS(JCLocalImageDataSourceFactoryProxy);
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_LocalImageDataSourceFactory_getSingletonPtr_1void(JNIEnv *__env , jclass __clazz)
			{
				EarthView::World::Spatial3D::CLocalImageDataSourceFactory* __values1 = EarthView::World::Spatial3D::CLocalImageDataSourceFactory::getSingletonPtr();
				jlong __values1_j = (jlong) __values1;
				return __values1_j;
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_LocalImageDataSourceFactory_closeDataSource_1IDataSource(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong ds_j)
			{
				EarthView::World::Spatial::GeoDataset::IDataSource *ds = (EarthView::World::Spatial::GeoDataset::IDataSource*) ds_j;
				EarthView::World::Spatial3D::CLocalImageDataSourceFactory *pObjectX = (EarthView::World::Spatial3D::CLocalImageDataSourceFactory*) pObjXXXX;
				pObjectX->closeDataSource(ds);
			}
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_LocalImageDataSourceFactory_openDataSource_1EVString_1EVString(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring path_j, jstring fileName_j)
			{
				#if EV_PLATFORM == EV_PLATFORM_ANDROID
				...
				#endif
				EarthView::World::Spatial3D::CLocalImageDataSourceFactory *pObjectX = (EarthView::World::Spatial3D::CLocalImageDataSourceFactory*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCLocalImageDataSourceFactoryProxy))
				{
					EarthView::World::Spatial::GeoDataset::IDataSource* __values1 = pObjectX->EarthView::World::Spatial3D::CLocalImageDataSourceFactory::openDataSource(path, fileName);
					jlong __values1_j = (jlong) __values1;
					return __values1_j;
				}
				else
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_LocalImageDataSourceFactory_register_1openDataSource_1EVString_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLocalImageDataSourceFactoryProxy *pObjectX = (JCLocalImageDataSourceFactoryProxy*) pObjXXXX;
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_LocalImageDataSourceFactory_openDataSource_1EVString_1EVString_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring path_j, jstring fileName_j)
			{
				#if EV_PLATFORM == EV_PLATFORM_ANDROID
				const ev_char* path_ch = (const ev_char*)__env->GetStringUTFChars(path_j,JNI_FALSE);
				const EVString path = path_ch;
			...
			extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial3d_LocalImageDataSourceFactory_getType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Spatial3D::CLocalImageDataSourceFactory *pObjectX = (EarthView::World::Spatial3D::CLocalImageDataSourceFactory*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCLocalImageDataSourceFactoryProxy))
				{
					ev_int32 __values1 = pObjectX->EarthView::World::Spatial3D::CLocalImageDataSourceFactory::getType();
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_LocalImageDataSourceFactory_register_1getType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLocalImageDataSourceFactoryProxy *pObjectX = (JCLocalImageDataSourceFactoryProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial3d_LocalImageDataSourceFactory_getType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
			{
				const 				EarthView::World::Spatial3D::CLocalImageDataSourceFactory *pObjectX = (EarthView::World::Spatial3D::CLocalImageDataSourceFactory*) pObjXXXX;
				ev_int32 __values1 = pObjectX->EarthView::World::Spatial3D::CLocalImageDataSourceFactory::getType();
				jint __values1_j = (jint)__values1;
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_LocalImageDataSourceFactory_createFromXML_1EVString(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring xml_j)
			{
				#if EV_PLATFORM == EV_PLATFORM_ANDROID
				...
				if (typeid(*pObjectX) == typeid(JCLocalImageDataSourceFactoryProxy))
				{
					EarthView::World::Spatial::GeoDataset::IDataSource* __values1 = pObjectX->EarthView::World::Spatial3D::CLocalImageDataSourceFactory::createFromXML(xml);
					jlong __values1_j = (jlong) __values1;
					return __values1_j;
				}
				else
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_LocalImageDataSourceFactory_register_1createFromXML_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLocalImageDataSourceFactoryProxy *pObjectX = (JCLocalImageDataSourceFactoryProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_LocalImageDataSourceFactory_createFromXML_1EVString_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring xml_j)
			{
				#if EV_PLATFORM == EV_PLATFORM_ANDROID
				const ev_char* xml_ch = (const ev_char*)__env->GetStringUTFChars(xml_j,JNI_FALSE);
				const EVString xml = xml_ch;
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_LocalImageDataSourceFactory_openDataSource_1IPropertySet(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong connection_j)
			{
				EarthView::World::Spatial::GeoDataset::IPropertySet *connection = (EarthView::World::Spatial::GeoDataset::IPropertySet*) connection_j;
				EarthView::World::Spatial3D::CLocalImageDataSourceFactory *pObjectX = (EarthView::World::Spatial3D::CLocalImageDataSourceFactory*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCLocalImageDataSourceFactoryProxy))
				{
					EarthView::World::Spatial::GeoDataset::IDataSource* __values1 = pObjectX->EarthView::World::Spatial3D::CLocalImageDataSourceFactory::openDataSource(connection);
					jlong __values1_j = (jlong) __values1;
					return __values1_j;
				}
				else
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_LocalImageDataSourceFactory_register_1openDataSource_1IPropertySet(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLocalImageDataSourceFactoryProxy *pObjectX = (JCLocalImageDataSourceFactoryProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_LocalImageDataSourceFactory_openDataSource_1IPropertySet_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong connection_j)
			{
				EarthView::World::Spatial::GeoDataset::IPropertySet *connection = (EarthView::World::Spatial::GeoDataset::IPropertySet*) connection_j;
				EarthView::World::Spatial3D::CLocalImageDataSourceFactory *pObjectX = (EarthView::World::Spatial3D::CLocalImageDataSourceFactory*) pObjXXXX;
				EarthView::World::Spatial::GeoDataset::IDataSource* __values1 = pObjectX->EarthView::World::Spatial3D::CLocalImageDataSourceFactory::openDataSource(connection);
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_LocalImageDataSourceFactory_destroyDataSource_1IDataSource(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong pDataSource_j)
			{
				EarthView::World::Spatial::GeoDataset::IDataSource *pDataSource = (EarthView::World::Spatial::GeoDataset::IDataSource*) pDataSource_j;
				EarthView::World::Spatial3D::CLocalImageDataSourceFactory *pObjectX = (EarthView::World::Spatial3D::CLocalImageDataSourceFactory*) pObjXXXX;
				if (typeid(*pObjectX) == typeid(JCLocalImageDataSourceFactoryProxy))
				{
					pObjectX->EarthView::World::Spatial3D::CLocalImageDataSourceFactory::destroyDataSource(pDataSource);
				}
				else
				{
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_LocalImageDataSourceFactory_register_1destroyDataSource_1IDataSource(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLocalImageDataSourceFactoryProxy *pObjectX = (JCLocalImageDataSourceFactoryProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_LocalImageDataSourceFactory_destroyDataSource_1IDataSource_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong pDataSource_j)
			{
				EarthView::World::Spatial::GeoDataset::IDataSource *pDataSource = (EarthView::World::Spatial::GeoDataset::IDataSource*) pDataSource_j;
				EarthView::World::Spatial3D::CLocalImageDataSourceFactory *pObjectX = (EarthView::World::Spatial3D::CLocalImageDataSourceFactory*) pObjXXXX;
				pObjectX->EarthView::World::Spatial3D::CLocalImageDataSourceFactory::destroyDataSource(pDataSource);
			}
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_LocalImageDataSourceFactory_register_1createDataSource_1EVString_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLocalImageDataSourceFactoryProxy *pObjectX = (JCLocalImageDataSourceFactoryProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_LocalImageDataSourceFactory_register_1createDataSource_1IPropertySet(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLocalImageDataSourceFactoryProxy *pObjectX = (JCLocalImageDataSourceFactoryProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
			...
			extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_LocalImageDataSourceFactory_register_1existDataSource_1IDataSource(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
			{
				JCLocalImageDataSourceFactoryProxy *pObjectX = (JCLocalImageDataSourceFactoryProxy*) pObjXXXX;
				const char *pMethod = __env->GetStringUTFChars(__method, NULL);
				EarthView::World::Core::ev_string sMethod = pMethod;
