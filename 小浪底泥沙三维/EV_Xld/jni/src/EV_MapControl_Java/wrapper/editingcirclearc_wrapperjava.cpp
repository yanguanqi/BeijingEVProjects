...
namespace EarthView
{
	namespace World
	{
		namespace Spatial2D
		{
			namespace Controls
			{
				class JCEditingCircleArcProxy : public EarthView::World::Spatial2D::Controls::CEditingCircleArc
				{
				 private:
				...
				public:
					JCEditingCircleArcProxy(EarthView::World::Core::CNameValuePairList *pList) : CEditingCircleArc(pList)
					{
					}
				...
				REGISTER_FACTORY_CLASS(JCEditingCircleArcProxy);
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_controls_EditingCircleArc_newObject_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CEditingCircleArc *pObjectX = (EarthView::World::Spatial2D::Controls::CEditingCircleArc*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCEditingCircleArcProxy))
					{
						EarthView::World::Spatial2D::Controls::CEditingObject* __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CEditingCircleArc::newObject();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_EditingCircleArc_register_1newObject_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEditingCircleArcProxy *pObjectX = (JCEditingCircleArcProxy*) pObjXXXX;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_controls_EditingCircleArc_newObject_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CEditingCircleArc *pObjectX = (EarthView::World::Spatial2D::Controls::CEditingCircleArc*) pObjXXXX;
					EarthView::World::Spatial2D::Controls::CEditingObject* __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CEditingCircleArc::newObject();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial2d_controls_EditingCircleArc_getName_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CEditingCircleArc *pObjectX = (EarthView::World::Spatial2D::Controls::CEditingCircleArc*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCEditingCircleArcProxy))
					{
						EVString __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CEditingCircleArc::getName();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_EditingCircleArc_register_1getName_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEditingCircleArcProxy *pObjectX = (JCEditingCircleArcProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial2d_controls_EditingCircleArc_getName_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CEditingCircleArc *pObjectX = (EarthView::World::Spatial2D::Controls::CEditingCircleArc*) pObjXXXX;
					EVString __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CEditingCircleArc::getName();
					EarthView::World::Core::ev_wstring valuesw1 = __values1;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial2d_controls_EditingCircleArc_getType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CEditingCircleArc *pObjectX = (EarthView::World::Spatial2D::Controls::CEditingCircleArc*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCEditingCircleArcProxy))
					{
						EarthView::World::Spatial2D::Controls::EditingObjectType __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CEditingCircleArc::getType();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_EditingCircleArc_register_1getType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEditingCircleArcProxy *pObjectX = (JCEditingCircleArcProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial2d_controls_EditingCircleArc_getType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CEditingCircleArc *pObjectX = (EarthView::World::Spatial2D::Controls::CEditingCircleArc*) pObjXXXX;
					EarthView::World::Spatial2D::Controls::EditingObjectType __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CEditingCircleArc::getType();
					jint __values1_j = (jint) __values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_controls_EditingCircleArc_makeSample_1CPoint_1CPoint(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong from_j, jlong to_j)
				{
					...
					if (typeid(*pObjectX) == typeid(JCEditingCircleArcProxy))
					{
						EarthView::World::Spatial::Geometry::IGeometry* __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CEditingCircleArc::makeSample(from, to);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_EditingCircleArc_register_1makeSample_1CPoint_1CPoint(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEditingCircleArcProxy *pObjectX = (JCEditingCircleArcProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_controls_EditingCircleArc_makeSample_1CPoint_1CPoint_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong from_j, jlong to_j)
				{
					const EarthView::World::Spatial::Geometry::CPoint &from = *(EarthView::World::Spatial::Geometry::CPoint*) from_j;
					const EarthView::World::Spatial::Geometry::CPoint &to = *(EarthView::World::Spatial::Geometry::CPoint*) to_j;
					const 					EarthView::World::Spatial2D::Controls::CEditingCircleArc *pObjectX = (EarthView::World::Spatial2D::Controls::CEditingCircleArc*) pObjXXXX;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial2d_controls_EditingCircleArc_isFine_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CEditingCircleArc *pObjectX = (EarthView::World::Spatial2D::Controls::CEditingCircleArc*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCEditingCircleArcProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CEditingCircleArc::isFine();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_EditingCircleArc_register_1isFine_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEditingCircleArcProxy *pObjectX = (JCEditingCircleArcProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial2d_controls_EditingCircleArc_isFine_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CEditingCircleArc *pObjectX = (EarthView::World::Spatial2D::Controls::CEditingCircleArc*) pObjXXXX;
					ev_bool __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CEditingCircleArc::isFine();
					jboolean __values1_j = (jboolean)__values1;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial2d_controls_EditingCircleArc_isExcellent_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CEditingCircleArc *pObjectX = (EarthView::World::Spatial2D::Controls::CEditingCircleArc*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCEditingCircleArcProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CEditingCircleArc::isExcellent();
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_EditingCircleArc_register_1isExcellent_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEditingCircleArcProxy *pObjectX = (JCEditingCircleArcProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial2d_controls_EditingCircleArc_isExcellent_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CEditingCircleArc *pObjectX = (EarthView::World::Spatial2D::Controls::CEditingCircleArc*) pObjXXXX;
					ev_bool __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CEditingCircleArc::isExcellent();
					jboolean __values1_j = (jboolean)__values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_controls_EditingCircleArc_getCenterPoint_1ev_1bool(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong ok_j)
				{
					ev_bool &ok = *(ev_bool*) ok_j;
					const 					EarthView::World::Spatial2D::Controls::CEditingCircleArc *pObjectX = (EarthView::World::Spatial2D::Controls::CEditingCircleArc*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCEditingCircleArcProxy))
					{
						EarthView::World::Spatial::Geometry::CPoint __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CEditingCircleArc::getCenterPoint(ok);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_EditingCircleArc_register_1getCenterPoint_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEditingCircleArcProxy *pObjectX = (JCEditingCircleArcProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_controls_EditingCircleArc_getCenterPoint_1ev_1bool_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong ok_j)
				{
					ev_bool &ok = *(ev_bool*) ok_j;
					const 					EarthView::World::Spatial2D::Controls::CEditingCircleArc *pObjectX = (EarthView::World::Spatial2D::Controls::CEditingCircleArc*) pObjXXXX;
					EarthView::World::Spatial::Geometry::CPoint __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CEditingCircleArc::getCenterPoint(ok);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_EditingCircleArc_setCenterPoint_1CPoint(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong point_j)
				{
					EarthView::World::Spatial::Geometry::CPoint &point = *(EarthView::World::Spatial::Geometry::CPoint*) point_j;
					EarthView::World::Spatial2D::Controls::CEditingCircleArc *pObjectX = (EarthView::World::Spatial2D::Controls::CEditingCircleArc*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCEditingCircleArcProxy))
					{
						pObjectX->EarthView::World::Spatial2D::Controls::CEditingCircleArc::setCenterPoint(point);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_EditingCircleArc_register_1setCenterPoint_1CPoint(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEditingCircleArcProxy *pObjectX = (JCEditingCircleArcProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_EditingCircleArc_setCenterPoint_1CPoint_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong point_j)
				{
					EarthView::World::Spatial::Geometry::CPoint &point = *(EarthView::World::Spatial::Geometry::CPoint*) point_j;
					EarthView::World::Spatial2D::Controls::CEditingCircleArc *pObjectX = (EarthView::World::Spatial2D::Controls::CEditingCircleArc*) pObjXXXX;
					pObjectX->EarthView::World::Spatial2D::Controls::CEditingCircleArc::setCenterPoint(point);
				}
				extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_spatial2d_controls_EditingCircleArc_getCentralAngle_1ev_1bool(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong ok_j)
				{
					ev_bool &ok = *(ev_bool*) ok_j;
					const 					EarthView::World::Spatial2D::Controls::CEditingCircleArc *pObjectX = (EarthView::World::Spatial2D::Controls::CEditingCircleArc*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCEditingCircleArcProxy))
					{
						ev_real64 __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CEditingCircleArc::getCentralAngle(ok);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_EditingCircleArc_register_1getCentralAngle_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEditingCircleArcProxy *pObjectX = (JCEditingCircleArcProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_spatial2d_controls_EditingCircleArc_getCentralAngle_1ev_1bool_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong ok_j)
				{
					ev_bool &ok = *(ev_bool*) ok_j;
					const 					EarthView::World::Spatial2D::Controls::CEditingCircleArc *pObjectX = (EarthView::World::Spatial2D::Controls::CEditingCircleArc*) pObjXXXX;
					ev_real64 __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CEditingCircleArc::getCentralAngle(ok);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_EditingCircleArc_setCentralAngle_1ev_1real64(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble angle_j)
				{
					ev_real64 angle = (ev_real64) angle_j;
					EarthView::World::Spatial2D::Controls::CEditingCircleArc *pObjectX = (EarthView::World::Spatial2D::Controls::CEditingCircleArc*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCEditingCircleArcProxy))
					{
						pObjectX->EarthView::World::Spatial2D::Controls::CEditingCircleArc::setCentralAngle(angle);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_EditingCircleArc_register_1setCentralAngle_1ev_1real64(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEditingCircleArcProxy *pObjectX = (JCEditingCircleArcProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_EditingCircleArc_setCentralAngle_1ev_1real64_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble angle_j)
				{
					ev_real64 angle = (ev_real64) angle_j;
					EarthView::World::Spatial2D::Controls::CEditingCircleArc *pObjectX = (EarthView::World::Spatial2D::Controls::CEditingCircleArc*) pObjXXXX;
					pObjectX->EarthView::World::Spatial2D::Controls::CEditingCircleArc::setCentralAngle(angle);
				}
				extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_spatial2d_controls_EditingCircleArc_getStartAngle_1ev_1bool(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong ok_j)
				{
					ev_bool &ok = *(ev_bool*) ok_j;
					const 					EarthView::World::Spatial2D::Controls::CEditingCircleArc *pObjectX = (EarthView::World::Spatial2D::Controls::CEditingCircleArc*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCEditingCircleArcProxy))
					{
						ev_real64 __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CEditingCircleArc::getStartAngle(ok);
						jdouble __values1_j = (jdouble)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_EditingCircleArc_register_1getStartAngle_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEditingCircleArcProxy *pObjectX = (JCEditingCircleArcProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_spatial2d_controls_EditingCircleArc_getStartAngle_1ev_1bool_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong ok_j)
				{
					ev_bool &ok = *(ev_bool*) ok_j;
					const 					EarthView::World::Spatial2D::Controls::CEditingCircleArc *pObjectX = (EarthView::World::Spatial2D::Controls::CEditingCircleArc*) pObjXXXX;
					ev_real64 __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CEditingCircleArc::getStartAngle(ok);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_EditingCircleArc_setStartAngle_1ev_1real64(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble angle_j)
				{
					ev_real64 angle = (ev_real64) angle_j;
					EarthView::World::Spatial2D::Controls::CEditingCircleArc *pObjectX = (EarthView::World::Spatial2D::Controls::CEditingCircleArc*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCEditingCircleArcProxy))
					{
						pObjectX->EarthView::World::Spatial2D::Controls::CEditingCircleArc::setStartAngle(angle);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_EditingCircleArc_register_1setStartAngle_1ev_1real64(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEditingCircleArcProxy *pObjectX = (JCEditingCircleArcProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_EditingCircleArc_setStartAngle_1ev_1real64_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble angle_j)
				{
					ev_real64 angle = (ev_real64) angle_j;
					EarthView::World::Spatial2D::Controls::CEditingCircleArc *pObjectX = (EarthView::World::Spatial2D::Controls::CEditingCircleArc*) pObjXXXX;
					pObjectX->EarthView::World::Spatial2D::Controls::CEditingCircleArc::setStartAngle(angle);
				}
				extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_spatial2d_controls_EditingCircleArc_getRadius_1ev_1bool(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong ok_j)
				{
					ev_bool &ok = *(ev_bool*) ok_j;
					const 					EarthView::World::Spatial2D::Controls::CEditingCircleArc *pObjectX = (EarthView::World::Spatial2D::Controls::CEditingCircleArc*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCEditingCircleArcProxy))
					{
						ev_real64 __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CEditingCircleArc::getRadius(ok);
						jdouble __values1_j = (jdouble)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_EditingCircleArc_register_1getRadius_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEditingCircleArcProxy *pObjectX = (JCEditingCircleArcProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_spatial2d_controls_EditingCircleArc_getRadius_1ev_1bool_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong ok_j)
				{
					ev_bool &ok = *(ev_bool*) ok_j;
					const 					EarthView::World::Spatial2D::Controls::CEditingCircleArc *pObjectX = (EarthView::World::Spatial2D::Controls::CEditingCircleArc*) pObjXXXX;
					ev_real64 __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CEditingCircleArc::getRadius(ok);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_EditingCircleArc_setRadius_1ev_1real64(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble radius_j)
				{
					ev_real64 radius = (ev_real64) radius_j;
					EarthView::World::Spatial2D::Controls::CEditingCircleArc *pObjectX = (EarthView::World::Spatial2D::Controls::CEditingCircleArc*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCEditingCircleArcProxy))
					{
						pObjectX->EarthView::World::Spatial2D::Controls::CEditingCircleArc::setRadius(radius);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_EditingCircleArc_register_1setRadius_1ev_1real64(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEditingCircleArcProxy *pObjectX = (JCEditingCircleArcProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_EditingCircleArc_setRadius_1ev_1real64_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble radius_j)
				{
					ev_real64 radius = (ev_real64) radius_j;
					EarthView::World::Spatial2D::Controls::CEditingCircleArc *pObjectX = (EarthView::World::Spatial2D::Controls::CEditingCircleArc*) pObjXXXX;
					pObjectX->EarthView::World::Spatial2D::Controls::CEditingCircleArc::setRadius(radius);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_EditingCircleArc_register_1getGeometry_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEditingCircleArcProxy *pObjectX = (JCEditingCircleArcProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_EditingCircleArc_register_1getPointCount_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEditingCircleArcProxy *pObjectX = (JCEditingCircleArcProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_EditingCircleArc_register_1getPoint_1ev_1int32_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEditingCircleArcProxy *pObjectX = (JCEditingCircleArcProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_EditingCircleArc_register_1indexForPoint_1CPoint(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEditingCircleArcProxy *pObjectX = (JCEditingCircleArcProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_EditingCircleArc_register_1getFirstPoint_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEditingCircleArcProxy *pObjectX = (JCEditingCircleArcProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_EditingCircleArc_register_1getLastPoint_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEditingCircleArcProxy *pObjectX = (JCEditingCircleArcProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_EditingCircleArc_register_1getRotateAngle_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEditingCircleArcProxy *pObjectX = (JCEditingCircleArcProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
