...
namespace EarthView
{
	namespace World
	{
		namespace Spatial2D
		{
			namespace Controls
			{
				class JCCommandSplitPartProxy : public EarthView::World::Spatial2D::Controls::CCommandSplitPart
				{
				 private:
				...
				public:
					JCCommandSplitPartProxy(EarthView::World::Core::CNameValuePairList *pList) : CCommandSplitPart(pList)
					{
					}
				...
				protected:
					C_DISABLE_COPY(JCCommandSplitPartProxy)
				public:
				...
				REGISTER_FACTORY_CLASS(JCCommandSplitPartProxy);
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_controls_CommandSplitPart_getToolBarType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CCommandSplitPart *pObjectX = (EarthView::World::Spatial2D::Controls::CCommandSplitPart*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCCommandSplitPartProxy))
					{
						ev_uint32 __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CCommandSplitPart::getToolBarType();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_CommandSplitPart_register_1getToolBarType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandSplitPartProxy *pObjectX = (JCCommandSplitPartProxy*) pObjXXXX;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_controls_CommandSplitPart_getToolBarType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CCommandSplitPart *pObjectX = (EarthView::World::Spatial2D::Controls::CCommandSplitPart*) pObjXXXX;
					ev_uint32 __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CCommandSplitPart::getToolBarType();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_controls_CommandSplitPart_getType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CCommandSplitPart *pObjectX = (EarthView::World::Spatial2D::Controls::CCommandSplitPart*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCCommandSplitPartProxy))
					{
						ev_uint32 __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CCommandSplitPart::getType();
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_CommandSplitPart_register_1getType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandSplitPartProxy *pObjectX = (JCCommandSplitPartProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_controls_CommandSplitPart_getType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CCommandSplitPart *pObjectX = (EarthView::World::Spatial2D::Controls::CCommandSplitPart*) pObjXXXX;
					ev_uint32 __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CCommandSplitPart::getType();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial2d_controls_CommandSplitPart_getName_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CCommandSplitPart *pObjectX = (EarthView::World::Spatial2D::Controls::CCommandSplitPart*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCCommandSplitPartProxy))
					{
						EVString __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CCommandSplitPart::getName();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_CommandSplitPart_register_1getName_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandSplitPartProxy *pObjectX = (JCCommandSplitPartProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial2d_controls_CommandSplitPart_getName_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CCommandSplitPart *pObjectX = (EarthView::World::Spatial2D::Controls::CCommandSplitPart*) pObjXXXX;
					EVString __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CCommandSplitPart::getName();
					EarthView::World::Core::ev_wstring valuesw1 = __values1;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial2d_controls_CommandSplitPart_getCategory_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CCommandSplitPart *pObjectX = (EarthView::World::Spatial2D::Controls::CCommandSplitPart*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCCommandSplitPartProxy))
					{
						EVString __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CCommandSplitPart::getCategory();
						EarthView::World::Core::ev_wstring valuesw1 = __values1;
						jstring __values1_j = __env->NewString((const jchar*)valuesw1.getString(), valuesw1.size());
						return __values1_j;
					}
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_CommandSplitPart_register_1getCategory_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandSplitPartProxy *pObjectX = (JCCommandSplitPartProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial2d_controls_CommandSplitPart_getCategory_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CCommandSplitPart *pObjectX = (EarthView::World::Spatial2D::Controls::CCommandSplitPart*) pObjXXXX;
					EVString __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CCommandSplitPart::getCategory();
					EarthView::World::Core::ev_wstring valuesw1 = __values1;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial2d_controls_CommandSplitPart_getToolTip_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CCommandSplitPart *pObjectX = (EarthView::World::Spatial2D::Controls::CCommandSplitPart*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCCommandSplitPartProxy))
					{
						EVString __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CCommandSplitPart::getToolTip();
						EarthView::World::Core::ev_wstring valuesw1 = __values1;
						jstring __values1_j = __env->NewString((const jchar*)valuesw1.getString(), valuesw1.size());
						return __values1_j;
					}
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_CommandSplitPart_register_1getToolTip_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandSplitPartProxy *pObjectX = (JCCommandSplitPartProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial2d_controls_CommandSplitPart_getToolTip_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CCommandSplitPart *pObjectX = (EarthView::World::Spatial2D::Controls::CCommandSplitPart*) pObjXXXX;
					EVString __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CCommandSplitPart::getToolTip();
					EarthView::World::Core::ev_wstring valuesw1 = __values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_controls_CommandSplitPart_getIcon_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CCommandSplitPart *pObjectX = (EarthView::World::Spatial2D::Controls::CCommandSplitPart*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCCommandSplitPartProxy))
					{
						EarthView::World::Display::IBitmap* __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CCommandSplitPart::getIcon();
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_CommandSplitPart_register_1getIcon_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandSplitPartProxy *pObjectX = (JCCommandSplitPartProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_controls_CommandSplitPart_getIcon_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CCommandSplitPart *pObjectX = (EarthView::World::Spatial2D::Controls::CCommandSplitPart*) pObjXXXX;
					EarthView::World::Display::IBitmap* __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CCommandSplitPart::getIcon();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial2d_controls_CommandSplitPart_isCheckable_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CCommandSplitPart *pObjectX = (EarthView::World::Spatial2D::Controls::CCommandSplitPart*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCCommandSplitPartProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CCommandSplitPart::isCheckable();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_CommandSplitPart_register_1isCheckable_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandSplitPartProxy *pObjectX = (JCCommandSplitPartProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial2d_controls_CommandSplitPart_isCheckable_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CCommandSplitPart *pObjectX = (EarthView::World::Spatial2D::Controls::CCommandSplitPart*) pObjXXXX;
					ev_bool __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CCommandSplitPart::isCheckable();
					jboolean __values1_j = (jboolean)__values1;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_CommandSplitPart_onClicked_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial2D::Controls::CCommandSplitPart *pObjectX = (EarthView::World::Spatial2D::Controls::CCommandSplitPart*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCCommandSplitPartProxy))
					{
						pObjectX->EarthView::World::Spatial2D::Controls::CCommandSplitPart::onClicked();
					}
					else
					{
						pObjectX->onClicked();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_CommandSplitPart_register_1onClicked_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandSplitPartProxy *pObjectX = (JCCommandSplitPartProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_CommandSplitPart_onClicked_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial2D::Controls::CCommandSplitPart *pObjectX = (EarthView::World::Spatial2D::Controls::CCommandSplitPart*) pObjXXXX;
					pObjectX->EarthView::World::Spatial2D::Controls::CCommandSplitPart::onClicked();
				}
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial2d_controls_CommandSplitPart_update_1CEvent(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong e_j)
				{
					EarthView::World::Core::CEvent *e = (EarthView::World::Core::CEvent*) e_j;
					EarthView::World::Spatial2D::Controls::CCommandSplitPart *pObjectX = (EarthView::World::Spatial2D::Controls::CCommandSplitPart*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCCommandSplitPartProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CCommandSplitPart::update(e);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_CommandSplitPart_register_1update_1CEvent(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandSplitPartProxy *pObjectX = (JCCommandSplitPartProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial2d_controls_CommandSplitPart_update_1CEvent_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong e_j)
				{
					EarthView::World::Core::CEvent *e = (EarthView::World::Core::CEvent*) e_j;
					EarthView::World::Spatial2D::Controls::CCommandSplitPart *pObjectX = (EarthView::World::Spatial2D::Controls::CCommandSplitPart*) pObjXXXX;
					ev_bool __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CCommandSplitPart::update(e);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_CommandSplitPart_register_1getChecked_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandSplitPartProxy *pObjectX = (JCCommandSplitPartProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_CommandSplitPart_register_1setChecked_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandSplitPartProxy *pObjectX = (JCCommandSplitPartProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_CommandSplitPart_register_1getEnabled_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandSplitPartProxy *pObjectX = (JCCommandSplitPartProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_CommandSplitPart_register_1setEnabled_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandSplitPartProxy *pObjectX = (JCCommandSplitPartProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_CommandSplitPart_register_1create_1ISpatialControl(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandSplitPartProxy *pObjectX = (JCCommandSplitPartProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
