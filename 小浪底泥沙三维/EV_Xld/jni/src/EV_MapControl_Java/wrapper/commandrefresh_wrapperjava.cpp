...
namespace EarthView
{
	namespace World
	{
		namespace Spatial2D
		{
			namespace Controls
			{
				class JCCommandRefreshProxy : public EarthView::World::Spatial2D::Controls::CCommandRefresh
				{
				 private:
				...
				public:
					JCCommandRefreshProxy(EarthView::World::Core::CNameValuePairList *pList) : CCommandRefresh(pList)
					{
					}
				...
				protected:
					C_DISABLE_COPY(JCCommandRefreshProxy)
				public:
				...
				REGISTER_FACTORY_CLASS(JCCommandRefreshProxy);
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_controls_CommandRefresh_getToolBarType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CCommandRefresh *pObjectX = (EarthView::World::Spatial2D::Controls::CCommandRefresh*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCCommandRefreshProxy))
					{
						ev_uint32 __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CCommandRefresh::getToolBarType();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_CommandRefresh_register_1getToolBarType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandRefreshProxy *pObjectX = (JCCommandRefreshProxy*) pObjXXXX;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_controls_CommandRefresh_getToolBarType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CCommandRefresh *pObjectX = (EarthView::World::Spatial2D::Controls::CCommandRefresh*) pObjXXXX;
					ev_uint32 __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CCommandRefresh::getToolBarType();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_controls_CommandRefresh_getType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CCommandRefresh *pObjectX = (EarthView::World::Spatial2D::Controls::CCommandRefresh*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCCommandRefreshProxy))
					{
						ev_uint32 __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CCommandRefresh::getType();
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_CommandRefresh_register_1getType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandRefreshProxy *pObjectX = (JCCommandRefreshProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_controls_CommandRefresh_getType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CCommandRefresh *pObjectX = (EarthView::World::Spatial2D::Controls::CCommandRefresh*) pObjXXXX;
					ev_uint32 __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CCommandRefresh::getType();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial2d_controls_CommandRefresh_getName_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CCommandRefresh *pObjectX = (EarthView::World::Spatial2D::Controls::CCommandRefresh*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCCommandRefreshProxy))
					{
						EVString __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CCommandRefresh::getName();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_CommandRefresh_register_1getName_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandRefreshProxy *pObjectX = (JCCommandRefreshProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial2d_controls_CommandRefresh_getName_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CCommandRefresh *pObjectX = (EarthView::World::Spatial2D::Controls::CCommandRefresh*) pObjXXXX;
					EVString __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CCommandRefresh::getName();
					EarthView::World::Core::ev_wstring valuesw1 = __values1;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial2d_controls_CommandRefresh_getCategory_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CCommandRefresh *pObjectX = (EarthView::World::Spatial2D::Controls::CCommandRefresh*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCCommandRefreshProxy))
					{
						EVString __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CCommandRefresh::getCategory();
						EarthView::World::Core::ev_wstring valuesw1 = __values1;
						jstring __values1_j = __env->NewString((const jchar*)valuesw1.getString(), valuesw1.size());
						return __values1_j;
					}
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_CommandRefresh_register_1getCategory_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandRefreshProxy *pObjectX = (JCCommandRefreshProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial2d_controls_CommandRefresh_getCategory_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CCommandRefresh *pObjectX = (EarthView::World::Spatial2D::Controls::CCommandRefresh*) pObjXXXX;
					EVString __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CCommandRefresh::getCategory();
					EarthView::World::Core::ev_wstring valuesw1 = __values1;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial2d_controls_CommandRefresh_getToolTip_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CCommandRefresh *pObjectX = (EarthView::World::Spatial2D::Controls::CCommandRefresh*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCCommandRefreshProxy))
					{
						EVString __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CCommandRefresh::getToolTip();
						EarthView::World::Core::ev_wstring valuesw1 = __values1;
						jstring __values1_j = __env->NewString((const jchar*)valuesw1.getString(), valuesw1.size());
						return __values1_j;
					}
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_CommandRefresh_register_1getToolTip_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandRefreshProxy *pObjectX = (JCCommandRefreshProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial2d_controls_CommandRefresh_getToolTip_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CCommandRefresh *pObjectX = (EarthView::World::Spatial2D::Controls::CCommandRefresh*) pObjXXXX;
					EVString __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CCommandRefresh::getToolTip();
					EarthView::World::Core::ev_wstring valuesw1 = __values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_controls_CommandRefresh_getIcon_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CCommandRefresh *pObjectX = (EarthView::World::Spatial2D::Controls::CCommandRefresh*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCCommandRefreshProxy))
					{
						EarthView::World::Display::IBitmap* __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CCommandRefresh::getIcon();
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_CommandRefresh_register_1getIcon_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandRefreshProxy *pObjectX = (JCCommandRefreshProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_controls_CommandRefresh_getIcon_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CCommandRefresh *pObjectX = (EarthView::World::Spatial2D::Controls::CCommandRefresh*) pObjXXXX;
					EarthView::World::Display::IBitmap* __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CCommandRefresh::getIcon();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial2d_controls_CommandRefresh_isCheckable_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CCommandRefresh *pObjectX = (EarthView::World::Spatial2D::Controls::CCommandRefresh*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCCommandRefreshProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CCommandRefresh::isCheckable();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_CommandRefresh_register_1isCheckable_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandRefreshProxy *pObjectX = (JCCommandRefreshProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial2d_controls_CommandRefresh_isCheckable_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CCommandRefresh *pObjectX = (EarthView::World::Spatial2D::Controls::CCommandRefresh*) pObjXXXX;
					ev_bool __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CCommandRefresh::isCheckable();
					jboolean __values1_j = (jboolean)__values1;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_CommandRefresh_onClicked_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial2D::Controls::CCommandRefresh *pObjectX = (EarthView::World::Spatial2D::Controls::CCommandRefresh*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCCommandRefreshProxy))
					{
						pObjectX->EarthView::World::Spatial2D::Controls::CCommandRefresh::onClicked();
					}
					else
					{
						pObjectX->onClicked();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_CommandRefresh_register_1onClicked_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandRefreshProxy *pObjectX = (JCCommandRefreshProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_CommandRefresh_onClicked_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial2D::Controls::CCommandRefresh *pObjectX = (EarthView::World::Spatial2D::Controls::CCommandRefresh*) pObjXXXX;
					pObjectX->EarthView::World::Spatial2D::Controls::CCommandRefresh::onClicked();
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_CommandRefresh_register_1getChecked_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandRefreshProxy *pObjectX = (JCCommandRefreshProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_CommandRefresh_register_1setChecked_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandRefreshProxy *pObjectX = (JCCommandRefreshProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_CommandRefresh_register_1getEnabled_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandRefreshProxy *pObjectX = (JCCommandRefreshProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_CommandRefresh_register_1setEnabled_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandRefreshProxy *pObjectX = (JCCommandRefreshProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_CommandRefresh_register_1create_1ISpatialControl(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandRefreshProxy *pObjectX = (JCCommandRefreshProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_CommandRefresh_register_1update_1CEvent(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCCommandRefreshProxy *pObjectX = (JCCommandRefreshProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
