...
namespace EarthView
{
	namespace World
	{
		namespace Spatial2D
		{
			namespace Controls
			{
				class JCEditingPolygonProxy : public EarthView::World::Spatial2D::Controls::CEditingPolygon
				{
				 private:
				...
				public:
					JCEditingPolygonProxy(EarthView::World::Core::CNameValuePairList *pList) : CEditingPolygon(pList)
					{
					}
				...
				REGISTER_FACTORY_CLASS(JCEditingPolygonProxy);
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial2d_controls_EditingPolygon_getType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CEditingPolygon *pObjectX = (EarthView::World::Spatial2D::Controls::CEditingPolygon*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCEditingPolygonProxy))
					{
						EarthView::World::Spatial::Geometry::EVGeometryType __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CEditingPolygon::getType();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_EditingPolygon_register_1getType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEditingPolygonProxy *pObjectX = (JCEditingPolygonProxy*) pObjXXXX;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial2d_controls_EditingPolygon_getType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CEditingPolygon *pObjectX = (EarthView::World::Spatial2D::Controls::CEditingPolygon*) pObjXXXX;
					EarthView::World::Spatial::Geometry::EVGeometryType __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CEditingPolygon::getType();
					jint __values1_j = (jint) __values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_controls_EditingPolygon_getGeometry_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CEditingPolygon *pObjectX = (EarthView::World::Spatial2D::Controls::CEditingPolygon*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCEditingPolygonProxy))
					{
						const EarthView::World::Spatial::Geometry::IGeometry* __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CEditingPolygon::getGeometry();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_EditingPolygon_register_1getGeometry_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEditingPolygonProxy *pObjectX = (JCEditingPolygonProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_controls_EditingPolygon_getGeometry_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CEditingPolygon *pObjectX = (EarthView::World::Spatial2D::Controls::CEditingPolygon*) pObjXXXX;
					const EarthView::World::Spatial::Geometry::IGeometry* __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CEditingPolygon::getGeometry();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_EditingPolygon_finishPart_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial2D::Controls::CEditingPolygon *pObjectX = (EarthView::World::Spatial2D::Controls::CEditingPolygon*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCEditingPolygonProxy))
					{
						pObjectX->EarthView::World::Spatial2D::Controls::CEditingPolygon::finishPart();
					}
					else
					{
						pObjectX->finishPart();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_EditingPolygon_register_1finishPart_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEditingPolygonProxy *pObjectX = (JCEditingPolygonProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_EditingPolygon_finishPart_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial2D::Controls::CEditingPolygon *pObjectX = (EarthView::World::Spatial2D::Controls::CEditingPolygon*) pObjXXXX;
					pObjectX->EarthView::World::Spatial2D::Controls::CEditingPolygon::finishPart();
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_EditingPolygon_addPoint_1CPoint(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong pnt_j)
				{
					EarthView::World::Spatial::Geometry::CPoint &pnt = *(EarthView::World::Spatial::Geometry::CPoint*) pnt_j;
					EarthView::World::Spatial2D::Controls::CEditingPolygon *pObjectX = (EarthView::World::Spatial2D::Controls::CEditingPolygon*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCEditingPolygonProxy))
					{
						pObjectX->EarthView::World::Spatial2D::Controls::CEditingPolygon::addPoint(pnt);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_EditingPolygon_register_1addPoint_1CPoint(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEditingPolygonProxy *pObjectX = (JCEditingPolygonProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_EditingPolygon_addPoint_1CPoint_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong pnt_j)
				{
					EarthView::World::Spatial::Geometry::CPoint &pnt = *(EarthView::World::Spatial::Geometry::CPoint*) pnt_j;
					EarthView::World::Spatial2D::Controls::CEditingPolygon *pObjectX = (EarthView::World::Spatial2D::Controls::CEditingPolygon*) pObjXXXX;
					pObjectX->EarthView::World::Spatial2D::Controls::CEditingPolygon::addPoint(pnt);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_EditingPolygon_register_1translate_1ev_1real64_1ev_1real64(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEditingPolygonProxy *pObjectX = (JCEditingPolygonProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_EditingPolygon_register_1rotate_1ev_1real64_1ev_1real64_1ev_1real64(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEditingPolygonProxy *pObjectX = (JCEditingPolygonProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
