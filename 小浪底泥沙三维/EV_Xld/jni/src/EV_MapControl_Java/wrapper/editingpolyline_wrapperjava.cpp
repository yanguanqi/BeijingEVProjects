...
namespace EarthView
{
	namespace World
	{
		namespace Spatial2D
		{
			namespace Controls
			{
				class JCEditingPolylineProxy : public EarthView::World::Spatial2D::Controls::CEditingPolyline
				{
				 private:
				...
				public:
					JCEditingPolylineProxy(EarthView::World::Core::CNameValuePairList *pList) : CEditingPolyline(pList)
					{
					}
				...
				REGISTER_FACTORY_CLASS(JCEditingPolylineProxy);
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial2d_controls_EditingPolyline_getType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CEditingPolyline *pObjectX = (EarthView::World::Spatial2D::Controls::CEditingPolyline*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCEditingPolylineProxy))
					{
						EarthView::World::Spatial::Geometry::EVGeometryType __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CEditingPolyline::getType();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_EditingPolyline_register_1getType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEditingPolylineProxy *pObjectX = (JCEditingPolylineProxy*) pObjXXXX;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial2d_controls_EditingPolyline_getType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CEditingPolyline *pObjectX = (EarthView::World::Spatial2D::Controls::CEditingPolyline*) pObjXXXX;
					EarthView::World::Spatial::Geometry::EVGeometryType __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CEditingPolyline::getType();
					jint __values1_j = (jint) __values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_controls_EditingPolyline_getGeometry_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CEditingPolyline *pObjectX = (EarthView::World::Spatial2D::Controls::CEditingPolyline*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCEditingPolylineProxy))
					{
						const EarthView::World::Spatial::Geometry::IGeometry* __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CEditingPolyline::getGeometry();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_EditingPolyline_register_1getGeometry_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEditingPolylineProxy *pObjectX = (JCEditingPolylineProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_controls_EditingPolyline_getGeometry_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CEditingPolyline *pObjectX = (EarthView::World::Spatial2D::Controls::CEditingPolyline*) pObjXXXX;
					const EarthView::World::Spatial::Geometry::IGeometry* __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CEditingPolyline::getGeometry();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_EditingPolyline_finishPart_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial2D::Controls::CEditingPolyline *pObjectX = (EarthView::World::Spatial2D::Controls::CEditingPolyline*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCEditingPolylineProxy))
					{
						pObjectX->EarthView::World::Spatial2D::Controls::CEditingPolyline::finishPart();
					}
					else
					{
						pObjectX->finishPart();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_EditingPolyline_register_1finishPart_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEditingPolylineProxy *pObjectX = (JCEditingPolylineProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_EditingPolyline_finishPart_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial2D::Controls::CEditingPolyline *pObjectX = (EarthView::World::Spatial2D::Controls::CEditingPolyline*) pObjXXXX;
					pObjectX->EarthView::World::Spatial2D::Controls::CEditingPolyline::finishPart();
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_EditingPolyline_addPoint_1CPoint(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong pnt_j)
				{
					EarthView::World::Spatial::Geometry::CPoint &pnt = *(EarthView::World::Spatial::Geometry::CPoint*) pnt_j;
					EarthView::World::Spatial2D::Controls::CEditingPolyline *pObjectX = (EarthView::World::Spatial2D::Controls::CEditingPolyline*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCEditingPolylineProxy))
					{
						pObjectX->EarthView::World::Spatial2D::Controls::CEditingPolyline::addPoint(pnt);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_EditingPolyline_register_1addPoint_1CPoint(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEditingPolylineProxy *pObjectX = (JCEditingPolylineProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_EditingPolyline_addPoint_1CPoint_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong pnt_j)
				{
					EarthView::World::Spatial::Geometry::CPoint &pnt = *(EarthView::World::Spatial::Geometry::CPoint*) pnt_j;
					EarthView::World::Spatial2D::Controls::CEditingPolyline *pObjectX = (EarthView::World::Spatial2D::Controls::CEditingPolyline*) pObjXXXX;
					pObjectX->EarthView::World::Spatial2D::Controls::CEditingPolyline::addPoint(pnt);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_EditingPolyline_register_1translate_1ev_1real64_1ev_1real64(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEditingPolylineProxy *pObjectX = (JCEditingPolylineProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_EditingPolyline_register_1rotate_1ev_1real64_1ev_1real64_1ev_1real64(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCEditingPolylineProxy *pObjectX = (JCEditingPolylineProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
