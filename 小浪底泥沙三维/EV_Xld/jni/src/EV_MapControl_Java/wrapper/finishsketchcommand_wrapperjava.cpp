...
namespace EarthView
{
	namespace World
	{
		namespace Spatial2D
		{
			namespace Controls
			{
				class JCFinishSketchCommandProxy : public EarthView::World::Spatial2D::Controls::CFinishSketchCommand
				{
				 private:
				...
				public:
					JCFinishSketchCommandProxy(EarthView::World::Core::CNameValuePairList *pList) : CFinishSketchCommand(pList)
					{
					}
				...
				protected:
					C_DISABLE_COPY(JCFinishSketchCommandProxy)
				public:
				...
				REGISTER_FACTORY_CLASS(JCFinishSketchCommandProxy);
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_controls_FinishSketchCommand_getToolBarType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CFinishSketchCommand *pObjectX = (EarthView::World::Spatial2D::Controls::CFinishSketchCommand*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCFinishSketchCommandProxy))
					{
						ev_uint32 __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CFinishSketchCommand::getToolBarType();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_FinishSketchCommand_register_1getToolBarType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCFinishSketchCommandProxy *pObjectX = (JCFinishSketchCommandProxy*) pObjXXXX;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_controls_FinishSketchCommand_getToolBarType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CFinishSketchCommand *pObjectX = (EarthView::World::Spatial2D::Controls::CFinishSketchCommand*) pObjXXXX;
					ev_uint32 __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CFinishSketchCommand::getToolBarType();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_controls_FinishSketchCommand_getType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CFinishSketchCommand *pObjectX = (EarthView::World::Spatial2D::Controls::CFinishSketchCommand*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCFinishSketchCommandProxy))
					{
						ev_uint32 __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CFinishSketchCommand::getType();
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_FinishSketchCommand_register_1getType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCFinishSketchCommandProxy *pObjectX = (JCFinishSketchCommandProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_controls_FinishSketchCommand_getType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CFinishSketchCommand *pObjectX = (EarthView::World::Spatial2D::Controls::CFinishSketchCommand*) pObjXXXX;
					ev_uint32 __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CFinishSketchCommand::getType();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial2d_controls_FinishSketchCommand_getName_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CFinishSketchCommand *pObjectX = (EarthView::World::Spatial2D::Controls::CFinishSketchCommand*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCFinishSketchCommandProxy))
					{
						EVString __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CFinishSketchCommand::getName();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_FinishSketchCommand_register_1getName_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCFinishSketchCommandProxy *pObjectX = (JCFinishSketchCommandProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial2d_controls_FinishSketchCommand_getName_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CFinishSketchCommand *pObjectX = (EarthView::World::Spatial2D::Controls::CFinishSketchCommand*) pObjXXXX;
					EVString __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CFinishSketchCommand::getName();
					EarthView::World::Core::ev_wstring valuesw1 = __values1;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial2d_controls_FinishSketchCommand_getCategory_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CFinishSketchCommand *pObjectX = (EarthView::World::Spatial2D::Controls::CFinishSketchCommand*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCFinishSketchCommandProxy))
					{
						EVString __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CFinishSketchCommand::getCategory();
						EarthView::World::Core::ev_wstring valuesw1 = __values1;
						jstring __values1_j = __env->NewString((const jchar*)valuesw1.getString(), valuesw1.size());
						return __values1_j;
					}
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_FinishSketchCommand_register_1getCategory_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCFinishSketchCommandProxy *pObjectX = (JCFinishSketchCommandProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial2d_controls_FinishSketchCommand_getCategory_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CFinishSketchCommand *pObjectX = (EarthView::World::Spatial2D::Controls::CFinishSketchCommand*) pObjXXXX;
					EVString __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CFinishSketchCommand::getCategory();
					EarthView::World::Core::ev_wstring valuesw1 = __values1;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial2d_controls_FinishSketchCommand_getToolTip_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CFinishSketchCommand *pObjectX = (EarthView::World::Spatial2D::Controls::CFinishSketchCommand*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCFinishSketchCommandProxy))
					{
						EVString __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CFinishSketchCommand::getToolTip();
						EarthView::World::Core::ev_wstring valuesw1 = __values1;
						jstring __values1_j = __env->NewString((const jchar*)valuesw1.getString(), valuesw1.size());
						return __values1_j;
					}
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_FinishSketchCommand_register_1getToolTip_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCFinishSketchCommandProxy *pObjectX = (JCFinishSketchCommandProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial2d_controls_FinishSketchCommand_getToolTip_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CFinishSketchCommand *pObjectX = (EarthView::World::Spatial2D::Controls::CFinishSketchCommand*) pObjXXXX;
					EVString __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CFinishSketchCommand::getToolTip();
					EarthView::World::Core::ev_wstring valuesw1 = __values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_controls_FinishSketchCommand_getIcon_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CFinishSketchCommand *pObjectX = (EarthView::World::Spatial2D::Controls::CFinishSketchCommand*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCFinishSketchCommandProxy))
					{
						EarthView::World::Display::IBitmap* __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CFinishSketchCommand::getIcon();
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_FinishSketchCommand_register_1getIcon_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCFinishSketchCommandProxy *pObjectX = (JCFinishSketchCommandProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_controls_FinishSketchCommand_getIcon_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CFinishSketchCommand *pObjectX = (EarthView::World::Spatial2D::Controls::CFinishSketchCommand*) pObjXXXX;
					EarthView::World::Display::IBitmap* __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CFinishSketchCommand::getIcon();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial2d_controls_FinishSketchCommand_isCheckable_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CFinishSketchCommand *pObjectX = (EarthView::World::Spatial2D::Controls::CFinishSketchCommand*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCFinishSketchCommandProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CFinishSketchCommand::isCheckable();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_FinishSketchCommand_register_1isCheckable_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCFinishSketchCommandProxy *pObjectX = (JCFinishSketchCommandProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial2d_controls_FinishSketchCommand_isCheckable_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CFinishSketchCommand *pObjectX = (EarthView::World::Spatial2D::Controls::CFinishSketchCommand*) pObjXXXX;
					ev_bool __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CFinishSketchCommand::isCheckable();
					jboolean __values1_j = (jboolean)__values1;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_FinishSketchCommand_onClicked_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial2D::Controls::CFinishSketchCommand *pObjectX = (EarthView::World::Spatial2D::Controls::CFinishSketchCommand*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCFinishSketchCommandProxy))
					{
						pObjectX->EarthView::World::Spatial2D::Controls::CFinishSketchCommand::onClicked();
					}
					else
					{
						pObjectX->onClicked();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_FinishSketchCommand_register_1onClicked_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCFinishSketchCommandProxy *pObjectX = (JCFinishSketchCommandProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_FinishSketchCommand_onClicked_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial2D::Controls::CFinishSketchCommand *pObjectX = (EarthView::World::Spatial2D::Controls::CFinishSketchCommand*) pObjXXXX;
					pObjectX->EarthView::World::Spatial2D::Controls::CFinishSketchCommand::onClicked();
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_FinishSketchCommand_register_1getChecked_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCFinishSketchCommandProxy *pObjectX = (JCFinishSketchCommandProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_FinishSketchCommand_register_1setChecked_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCFinishSketchCommandProxy *pObjectX = (JCFinishSketchCommandProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_FinishSketchCommand_register_1getEnabled_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCFinishSketchCommandProxy *pObjectX = (JCFinishSketchCommandProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_FinishSketchCommand_register_1setEnabled_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCFinishSketchCommandProxy *pObjectX = (JCFinishSketchCommandProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_FinishSketchCommand_register_1create_1ISpatialControl(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCFinishSketchCommandProxy *pObjectX = (JCFinishSketchCommandProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_FinishSketchCommand_register_1update_1CEvent(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCFinishSketchCommandProxy *pObjectX = (JCFinishSketchCommandProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
