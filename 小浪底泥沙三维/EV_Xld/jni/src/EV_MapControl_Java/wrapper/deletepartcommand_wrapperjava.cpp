...
namespace EarthView
{
	namespace World
	{
		namespace Spatial2D
		{
			namespace Controls
			{
				class JCDeletePartCommandProxy : public EarthView::World::Spatial2D::Controls::CDeletePartCommand
				{
				 private:
				...
				public:
					JCDeletePartCommandProxy(EarthView::World::Core::CNameValuePairList *pList) : CDeletePartCommand(pList)
					{
					}
				...
				protected:
					C_DISABLE_COPY(JCDeletePartCommandProxy)
				public:
				...
				REGISTER_FACTORY_CLASS(JCDeletePartCommandProxy);
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_controls_DeletePartCommand_getToolBarType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CDeletePartCommand *pObjectX = (EarthView::World::Spatial2D::Controls::CDeletePartCommand*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCDeletePartCommandProxy))
					{
						ev_uint32 __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CDeletePartCommand::getToolBarType();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_DeletePartCommand_register_1getToolBarType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCDeletePartCommandProxy *pObjectX = (JCDeletePartCommandProxy*) pObjXXXX;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_controls_DeletePartCommand_getToolBarType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CDeletePartCommand *pObjectX = (EarthView::World::Spatial2D::Controls::CDeletePartCommand*) pObjXXXX;
					ev_uint32 __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CDeletePartCommand::getToolBarType();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_controls_DeletePartCommand_getType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CDeletePartCommand *pObjectX = (EarthView::World::Spatial2D::Controls::CDeletePartCommand*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCDeletePartCommandProxy))
					{
						ev_uint32 __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CDeletePartCommand::getType();
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_DeletePartCommand_register_1getType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCDeletePartCommandProxy *pObjectX = (JCDeletePartCommandProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_controls_DeletePartCommand_getType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CDeletePartCommand *pObjectX = (EarthView::World::Spatial2D::Controls::CDeletePartCommand*) pObjXXXX;
					ev_uint32 __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CDeletePartCommand::getType();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial2d_controls_DeletePartCommand_getName_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CDeletePartCommand *pObjectX = (EarthView::World::Spatial2D::Controls::CDeletePartCommand*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCDeletePartCommandProxy))
					{
						EVString __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CDeletePartCommand::getName();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_DeletePartCommand_register_1getName_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCDeletePartCommandProxy *pObjectX = (JCDeletePartCommandProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial2d_controls_DeletePartCommand_getName_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CDeletePartCommand *pObjectX = (EarthView::World::Spatial2D::Controls::CDeletePartCommand*) pObjXXXX;
					EVString __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CDeletePartCommand::getName();
					EarthView::World::Core::ev_wstring valuesw1 = __values1;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial2d_controls_DeletePartCommand_getCategory_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CDeletePartCommand *pObjectX = (EarthView::World::Spatial2D::Controls::CDeletePartCommand*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCDeletePartCommandProxy))
					{
						EVString __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CDeletePartCommand::getCategory();
						EarthView::World::Core::ev_wstring valuesw1 = __values1;
						jstring __values1_j = __env->NewString((const jchar*)valuesw1.getString(), valuesw1.size());
						return __values1_j;
					}
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_DeletePartCommand_register_1getCategory_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCDeletePartCommandProxy *pObjectX = (JCDeletePartCommandProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial2d_controls_DeletePartCommand_getCategory_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CDeletePartCommand *pObjectX = (EarthView::World::Spatial2D::Controls::CDeletePartCommand*) pObjXXXX;
					EVString __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CDeletePartCommand::getCategory();
					EarthView::World::Core::ev_wstring valuesw1 = __values1;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial2d_controls_DeletePartCommand_getToolTip_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CDeletePartCommand *pObjectX = (EarthView::World::Spatial2D::Controls::CDeletePartCommand*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCDeletePartCommandProxy))
					{
						EVString __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CDeletePartCommand::getToolTip();
						EarthView::World::Core::ev_wstring valuesw1 = __values1;
						jstring __values1_j = __env->NewString((const jchar*)valuesw1.getString(), valuesw1.size());
						return __values1_j;
					}
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_DeletePartCommand_register_1getToolTip_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCDeletePartCommandProxy *pObjectX = (JCDeletePartCommandProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial2d_controls_DeletePartCommand_getToolTip_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CDeletePartCommand *pObjectX = (EarthView::World::Spatial2D::Controls::CDeletePartCommand*) pObjXXXX;
					EVString __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CDeletePartCommand::getToolTip();
					EarthView::World::Core::ev_wstring valuesw1 = __values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_controls_DeletePartCommand_getIcon_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CDeletePartCommand *pObjectX = (EarthView::World::Spatial2D::Controls::CDeletePartCommand*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCDeletePartCommandProxy))
					{
						EarthView::World::Display::IBitmap* __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CDeletePartCommand::getIcon();
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_DeletePartCommand_register_1getIcon_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCDeletePartCommandProxy *pObjectX = (JCDeletePartCommandProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_controls_DeletePartCommand_getIcon_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CDeletePartCommand *pObjectX = (EarthView::World::Spatial2D::Controls::CDeletePartCommand*) pObjXXXX;
					EarthView::World::Display::IBitmap* __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CDeletePartCommand::getIcon();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial2d_controls_DeletePartCommand_isCheckable_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CDeletePartCommand *pObjectX = (EarthView::World::Spatial2D::Controls::CDeletePartCommand*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCDeletePartCommandProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CDeletePartCommand::isCheckable();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_DeletePartCommand_register_1isCheckable_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCDeletePartCommandProxy *pObjectX = (JCDeletePartCommandProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial2d_controls_DeletePartCommand_isCheckable_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CDeletePartCommand *pObjectX = (EarthView::World::Spatial2D::Controls::CDeletePartCommand*) pObjXXXX;
					ev_bool __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CDeletePartCommand::isCheckable();
					jboolean __values1_j = (jboolean)__values1;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_DeletePartCommand_onClicked_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial2D::Controls::CDeletePartCommand *pObjectX = (EarthView::World::Spatial2D::Controls::CDeletePartCommand*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCDeletePartCommandProxy))
					{
						pObjectX->EarthView::World::Spatial2D::Controls::CDeletePartCommand::onClicked();
					}
					else
					{
						pObjectX->onClicked();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_DeletePartCommand_register_1onClicked_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCDeletePartCommandProxy *pObjectX = (JCDeletePartCommandProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_DeletePartCommand_onClicked_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial2D::Controls::CDeletePartCommand *pObjectX = (EarthView::World::Spatial2D::Controls::CDeletePartCommand*) pObjXXXX;
					pObjectX->EarthView::World::Spatial2D::Controls::CDeletePartCommand::onClicked();
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_DeletePartCommand_register_1getChecked_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCDeletePartCommandProxy *pObjectX = (JCDeletePartCommandProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_DeletePartCommand_register_1setChecked_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCDeletePartCommandProxy *pObjectX = (JCDeletePartCommandProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_DeletePartCommand_register_1getEnabled_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCDeletePartCommandProxy *pObjectX = (JCDeletePartCommandProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_DeletePartCommand_register_1setEnabled_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCDeletePartCommandProxy *pObjectX = (JCDeletePartCommandProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_DeletePartCommand_register_1create_1ISpatialControl(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCDeletePartCommandProxy *pObjectX = (JCDeletePartCommandProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_DeletePartCommand_register_1update_1CEvent(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCDeletePartCommandProxy *pObjectX = (JCDeletePartCommandProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
