...
namespace EarthView
{
	namespace World
	{
		namespace Spatial2D
		{
			namespace Controls
			{
				class JCTrackingGeometryItemProxy : public EarthView::World::Spatial2D::Controls::CTrackingGeometryItem
				{
				 private:
				...
				public:
					JCTrackingGeometryItemProxy(EarthView::World::Core::CNameValuePairList *pList) : CTrackingGeometryItem(pList)
					{
					}
				...
				REGISTER_FACTORY_CLASS(JCTrackingGeometryItemProxy);
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_controls_TrackingGeometryItem_boundingRect_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CTrackingGeometryItem *pObjectX = (EarthView::World::Spatial2D::Controls::CTrackingGeometryItem*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCTrackingGeometryItemProxy))
					{
						EarthView::World::Spatial::Display::CSpatialRect __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CTrackingGeometryItem::boundingRect();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_TrackingGeometryItem_register_1boundingRect_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCTrackingGeometryItemProxy *pObjectX = (JCTrackingGeometryItemProxy*) pObjXXXX;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_controls_TrackingGeometryItem_boundingRect_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CTrackingGeometryItem *pObjectX = (EarthView::World::Spatial2D::Controls::CTrackingGeometryItem*) pObjXXXX;
					EarthView::World::Spatial::Display::CSpatialRect __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CTrackingGeometryItem::boundingRect();
					EarthView::World::Spatial::Display::CSpatialRect *returnvalues = new EarthView::World::Spatial::Display::CSpatialRect(__values1);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_TrackingGeometryItem_paint_1ISpatialDisplay_1EVTrackingItemState_1CSpatialRect(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong display_j, jint state_j, jlong rect_j)
				{
					...
					EarthView::World::Spatial2D::Controls::CTrackingGeometryItem *pObjectX = (EarthView::World::Spatial2D::Controls::CTrackingGeometryItem*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCTrackingGeometryItemProxy))
					{
						pObjectX->EarthView::World::Spatial2D::Controls::CTrackingGeometryItem::paint(display, state, rect);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_TrackingGeometryItem_register_1paint_1ISpatialDisplay_1EVTrackingItemState_1CSpatialRect(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCTrackingGeometryItemProxy *pObjectX = (JCTrackingGeometryItemProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_TrackingGeometryItem_paint_1ISpatialDisplay_1EVTrackingItemState_1CSpatialRect_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong display_j, jint state_j, jlong rect_j)
				{
					EarthView::World::Spatial::Display::ISpatialDisplay *display = (EarthView::World::Spatial::Display::ISpatialDisplay*) display_j;
					const EarthView::World::Spatial2D::Controls::EVTrackingItemState state = (const EarthView::World::Spatial2D::Controls::EVTrackingItemState) state_j;
					const EarthView::World::Spatial::Display::CSpatialRect &rect = *(EarthView::World::Spatial::Display::CSpatialRect*) rect_j;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial2d_controls_TrackingGeometryItem_isContains_1ev_1real64_1ev_1real64(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble x_j, jdouble y_j)
				{
					...
					if (typeid(*pObjectX) == typeid(JCTrackingGeometryItemProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CTrackingGeometryItem::isContains(x, y);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_TrackingGeometryItem_register_1isContains_1ev_1real64_1ev_1real64(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCTrackingGeometryItemProxy *pObjectX = (JCTrackingGeometryItemProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial2d_controls_TrackingGeometryItem_isContains_1ev_1real64_1ev_1real64_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jdouble x_j, jdouble y_j)
				{
					ev_real64 x = (ev_real64) x_j;
					ev_real64 y = (ev_real64) y_j;
					const 					EarthView::World::Spatial2D::Controls::CTrackingGeometryItem *pObjectX = (EarthView::World::Spatial2D::Controls::CTrackingGeometryItem*) pObjXXXX;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial2d_controls_TrackingGeometryItem_type_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CTrackingGeometryItem *pObjectX = (EarthView::World::Spatial2D::Controls::CTrackingGeometryItem*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCTrackingGeometryItemProxy))
					{
						ev_int32 __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CTrackingGeometryItem::type();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_TrackingGeometryItem_register_1type_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCTrackingGeometryItemProxy *pObjectX = (JCTrackingGeometryItemProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial2d_controls_TrackingGeometryItem_type_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CTrackingGeometryItem *pObjectX = (EarthView::World::Spatial2D::Controls::CTrackingGeometryItem*) pObjXXXX;
					ev_int32 __values1 = pObjectX->EarthView::World::Spatial2D::Controls::CTrackingGeometryItem::type();
					jint __values1_j = (jint)__values1;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_TrackingGeometryItem_setGeometry_1IGeometry(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong geo_j)
				{
					const EarthView::World::Spatial::Geometry::IGeometry *geo = (const EarthView::World::Spatial::Geometry::IGeometry*) geo_j;
					EarthView::World::Spatial2D::Controls::CTrackingGeometryItem *pObjectX = (EarthView::World::Spatial2D::Controls::CTrackingGeometryItem*) pObjXXXX;
					pObjectX->setGeometry(geo);
				}
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_controls_TrackingGeometryItem_getGeometry_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CTrackingGeometryItem *pObjectX = (EarthView::World::Spatial2D::Controls::CTrackingGeometryItem*) pObjXXXX;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_TrackingGeometryItem_setSymbol_1ISymbol(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong symbol_j)
				{
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_controls_TrackingGeometryItem_getSymbol_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial2D::Controls::CTrackingGeometryItem *pObjectX = (EarthView::World::Spatial2D::Controls::CTrackingGeometryItem*) pObjXXXX;
