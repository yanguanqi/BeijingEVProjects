	...
	namespace World
	{
		namespace Spatial2D
		{
			namespace Controls
			{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_EagleEyeControl_addMapControl_1CMapControl(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong pControl_j)
				{
					EarthView::World::Spatial2D::Controls::CMapControl *pControl = (EarthView::World::Spatial2D::Controls::CMapControl*) pControl_j;
					...
					pObjectX->addMapControl(pControl);
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial2d_controls_EagleEyeControl_removeMapControl_1CMapControl(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong pControl_j)
				{
					EarthView::World::Spatial2D::Controls::CMapControl *pControl = (EarthView::World::Spatial2D::Controls::CMapControl*) pControl_j;
					EarthView::World::Spatial2D::Controls::CEagleEyeControl *pObjectX = (EarthView::World::Spatial2D::Controls::CEagleEyeControl*) pObjXXXX;
					pObjectX->removeMapControl(pControl);
				}
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial2d_controls_EagleEyeControl_getMapControl_1ev_1int32(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint nIndex_j)
				{
					ev_int32 nIndex = (ev_int32) nIndex_j;
					EarthView::World::Spatial2D::Controls::CEagleEyeControl *pObjectX = (EarthView::World::Spatial2D::Controls::CEagleEyeControl*) pObjXXXX;
					EarthView::World::Spatial2D::Controls::CMapControl* __values1 = pObjectX->getMapControl(nIndex);
					jlong __values1_j = (jlong) __values1;
					return __values1_j;
				}
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial2d_controls_EagleEyeControl_isExist_1CMapControl(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong pControl_j)
				{
					EarthView::World::Spatial2D::Controls::CMapControl *pControl = (EarthView::World::Spatial2D::Controls::CMapControl*) pControl_j;
					EarthView::World::Spatial2D::Controls::CEagleEyeControl *pObjectX = (EarthView::World::Spatial2D::Controls::CEagleEyeControl*) pObjXXXX;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial2d_controls_EagleEyeControl_setActiveControl_1CMapControl(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong pControl_j)
				{
					EarthView::World::Spatial2D::Controls::CMapControl *pControl = (EarthView::World::Spatial2D::Controls::CMapControl*) pControl_j;
					EarthView::World::Spatial2D::Controls::CEagleEyeControl *pObjectX = (EarthView::World::Spatial2D::Controls::CEagleEyeControl*) pObjXXXX;
					ev_bool __values1 = pObjectX->setActiveControl(pControl);
					jboolean __values1_j = (jboolean)__values1;
					return __values1_j;
				}
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial2d_controls_EagleEyeControl_getMapControlCount_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial2D::Controls::CEagleEyeControl *pObjectX = (EarthView::World::Spatial2D::Controls::CEagleEyeControl*) pObjXXXX;
