...
namespace EarthView
{
	namespace World
	{
		namespace Spatial3D
		{
			namespace Analysis
			{
				class JCAnalysis3DMeasureAzimuthProxy : public EarthView::World::Spatial3D::Analysis::CAnalysis3DMeasureAzimuth
				{
				 private:
				...
				public:
					JCAnalysis3DMeasureAzimuthProxy(EarthView::World::Core::CNameValuePairList *pList) : CAnalysis3DMeasureAzimuth(pList)
					{
					}
				...
				REGISTER_FACTORY_CLASS(JCAnalysis3DMeasureAzimuthProxy);
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DMeasureAzimuth_deactivate_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::Analysis::CAnalysis3DMeasureAzimuth *pObjectX = (EarthView::World::Spatial3D::Analysis::CAnalysis3DMeasureAzimuth*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCAnalysis3DMeasureAzimuthProxy))
					{
						pObjectX->EarthView::World::Spatial3D::Analysis::CAnalysis3DMeasureAzimuth::deactivate();
					}
					else
					{
						pObjectX->deactivate();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DMeasureAzimuth_register_1deactivate_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCAnalysis3DMeasureAzimuthProxy *pObjectX = (JCAnalysis3DMeasureAzimuthProxy*) pObjXXXX;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DMeasureAzimuth_deactivate_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::Analysis::CAnalysis3DMeasureAzimuth *pObjectX = (EarthView::World::Spatial3D::Analysis::CAnalysis3DMeasureAzimuth*) pObjXXXX;
					pObjectX->EarthView::World::Spatial3D::Analysis::CAnalysis3DMeasureAzimuth::deactivate();
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DMeasureAzimuth_reset_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::Analysis::CAnalysis3DMeasureAzimuth *pObjectX = (EarthView::World::Spatial3D::Analysis::CAnalysis3DMeasureAzimuth*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCAnalysis3DMeasureAzimuthProxy))
					{
						pObjectX->EarthView::World::Spatial3D::Analysis::CAnalysis3DMeasureAzimuth::reset();
					}
					else
					{
						pObjectX->reset();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DMeasureAzimuth_register_1reset_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCAnalysis3DMeasureAzimuthProxy *pObjectX = (JCAnalysis3DMeasureAzimuthProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DMeasureAzimuth_reset_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::Analysis::CAnalysis3DMeasureAzimuth *pObjectX = (EarthView::World::Spatial3D::Analysis::CAnalysis3DMeasureAzimuth*) pObjXXXX;
					pObjectX->EarthView::World::Spatial3D::Analysis::CAnalysis3DMeasureAzimuth::reset();
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DMeasureAzimuth_initialize_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::Analysis::CAnalysis3DMeasureAzimuth *pObjectX = (EarthView::World::Spatial3D::Analysis::CAnalysis3DMeasureAzimuth*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCAnalysis3DMeasureAzimuthProxy))
					{
						pObjectX->EarthView::World::Spatial3D::Analysis::CAnalysis3DMeasureAzimuth::initialize();
					}
					else
					{
						pObjectX->initialize();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DMeasureAzimuth_register_1initialize_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCAnalysis3DMeasureAzimuthProxy *pObjectX = (JCAnalysis3DMeasureAzimuthProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DMeasureAzimuth_initialize_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::Analysis::CAnalysis3DMeasureAzimuth *pObjectX = (EarthView::World::Spatial3D::Analysis::CAnalysis3DMeasureAzimuth*) pObjXXXX;
					pObjectX->EarthView::World::Spatial3D::Analysis::CAnalysis3DMeasureAzimuth::initialize();
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DMeasureAzimuth_renderAnalysis3D_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::Analysis::CAnalysis3DMeasureAzimuth *pObjectX = (EarthView::World::Spatial3D::Analysis::CAnalysis3DMeasureAzimuth*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCAnalysis3DMeasureAzimuthProxy))
					{
						pObjectX->EarthView::World::Spatial3D::Analysis::CAnalysis3DMeasureAzimuth::renderAnalysis3D();
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DMeasureAzimuth_register_1renderAnalysis3D_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCAnalysis3DMeasureAzimuthProxy *pObjectX = (JCAnalysis3DMeasureAzimuthProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DMeasureAzimuth_renderAnalysis3D_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::Analysis::CAnalysis3DMeasureAzimuth *pObjectX = (EarthView::World::Spatial3D::Analysis::CAnalysis3DMeasureAzimuth*) pObjXXXX;
					pObjectX->EarthView::World::Spatial3D::Analysis::CAnalysis3DMeasureAzimuth::renderAnalysis3D();
				}
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DMeasureAzimuth_getClockwise_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::Analysis::CAnalysis3DMeasureAzimuth *pObjectX = (EarthView::World::Spatial3D::Analysis::CAnalysis3DMeasureAzimuth*) pObjXXXX;
					ev_bool __values1 = pObjectX->getClockwise();
					jboolean __values1_j = (jboolean)__values1;
					return __values1_j;
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DMeasureAzimuth_setClockwise_1ev_1bool(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jboolean clockwise_j)
				{
					ev_bool clockwise = (ev_bool) clockwise_j;
					EarthView::World::Spatial3D::Analysis::CAnalysis3DMeasureAzimuth *pObjectX = (EarthView::World::Spatial3D::Analysis::CAnalysis3DMeasureAzimuth*) pObjXXXX;
					pObjectX->setClockwise(clockwise);
				}
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DMeasureAzimuth_getOriginPoint_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::Analysis::CAnalysis3DMeasureAzimuth *pObjectX = (EarthView::World::Spatial3D::Analysis::CAnalysis3DMeasureAzimuth*) pObjXXXX;
					EarthView::World::Spatial::Math::CVector3 __values1 = pObjectX->getOriginPoint();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DMeasureAzimuth_setOriginPoint_1CVector3(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong value_j)
				{
					EarthView::World::Spatial::Math::CVector3 &value = *(EarthView::World::Spatial::Math::CVector3*) value_j;
					EarthView::World::Spatial3D::Analysis::CAnalysis3DMeasureAzimuth *pObjectX = (EarthView::World::Spatial3D::Analysis::CAnalysis3DMeasureAzimuth*) pObjXXXX;
					pObjectX->setOriginPoint(value);
				}
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DMeasureAzimuth_getTerminalPoint_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::Analysis::CAnalysis3DMeasureAzimuth *pObjectX = (EarthView::World::Spatial3D::Analysis::CAnalysis3DMeasureAzimuth*) pObjXXXX;
					EarthView::World::Spatial::Math::CVector3 __values1 = pObjectX->getTerminalPoint();
					EarthView::World::Spatial::Math::CVector3 *returnvalues = new EarthView::World::Spatial::Math::CVector3(__values1);
					((EarthView::World::Core::CBaseObject*)returnvalues)->setExternFree(true);
					jlong __values1_j = (jlong) returnvalues;
					return __values1_j;
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DMeasureAzimuth_setTerminalPoint_1CVector3(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong value_j)
				{
					EarthView::World::Spatial::Math::CVector3 &value = *(EarthView::World::Spatial::Math::CVector3*) value_j;
					EarthView::World::Spatial3D::Analysis::CAnalysis3DMeasureAzimuth *pObjectX = (EarthView::World::Spatial3D::Analysis::CAnalysis3DMeasureAzimuth*) pObjXXXX;
					pObjectX->setTerminalPoint(value);
				}
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DMeasureAzimuth_getNorthPoleLineColor_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Analysis::CAnalysis3DMeasureAzimuth *pObjectX = (EarthView::World::Spatial3D::Analysis::CAnalysis3DMeasureAzimuth*) pObjXXXX;
					const EarthView::World::Graphic::CColourValue& __values1 = pObjectX->getNorthPoleLineColor();
					jlong __values1_j = (jlong) &__values1;
					return __values1_j;
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DMeasureAzimuth_setNorthPoleLineColor_1CColourValue(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong value_j)
				{
					const EarthView::World::Graphic::CColourValue &value = *(EarthView::World::Graphic::CColourValue*) value_j;
					EarthView::World::Spatial3D::Analysis::CAnalysis3DMeasureAzimuth *pObjectX = (EarthView::World::Spatial3D::Analysis::CAnalysis3DMeasureAzimuth*) pObjXXXX;
					pObjectX->setNorthPoleLineColor(value);
				}
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DMeasureAzimuth_getTargetLineColor_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Analysis::CAnalysis3DMeasureAzimuth *pObjectX = (EarthView::World::Spatial3D::Analysis::CAnalysis3DMeasureAzimuth*) pObjXXXX;
					const EarthView::World::Graphic::CColourValue& __values1 = pObjectX->getTargetLineColor();
					jlong __values1_j = (jlong) &__values1;
					return __values1_j;
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DMeasureAzimuth_setTargetLineColor_1CColourValue(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong value_j)
				{
					const EarthView::World::Graphic::CColourValue &value = *(EarthView::World::Graphic::CColourValue*) value_j;
					EarthView::World::Spatial3D::Analysis::CAnalysis3DMeasureAzimuth *pObjectX = (EarthView::World::Spatial3D::Analysis::CAnalysis3DMeasureAzimuth*) pObjXXXX;
					pObjectX->setTargetLineColor(value);
				}
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DMeasureAzimuth_getAngleArcLineColor_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial3D::Analysis::CAnalysis3DMeasureAzimuth *pObjectX = (EarthView::World::Spatial3D::Analysis::CAnalysis3DMeasureAzimuth*) pObjXXXX;
					const EarthView::World::Graphic::CColourValue& __values1 = pObjectX->getAngleArcLineColor();
					jlong __values1_j = (jlong) &__values1;
					return __values1_j;
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DMeasureAzimuth_setAngleArcLineColor_1CColourValue(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong value_j)
				{
					const EarthView::World::Graphic::CColourValue &value = *(EarthView::World::Graphic::CColourValue*) value_j;
					EarthView::World::Spatial3D::Analysis::CAnalysis3DMeasureAzimuth *pObjectX = (EarthView::World::Spatial3D::Analysis::CAnalysis3DMeasureAzimuth*) pObjXXXX;
					pObjectX->setAngleArcLineColor(value);
				}
				extern "C" JNIEXPORT jdouble JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DMeasureAzimuth_getAzimuthDegree_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::Analysis::CAnalysis3DMeasureAzimuth *pObjectX = (EarthView::World::Spatial3D::Analysis::CAnalysis3DMeasureAzimuth*) pObjXXXX;
					ev_real64 __values1 = pObjectX->getAzimuthDegree();
					jdouble __values1_j = (jdouble)__values1;
					return __values1_j;
				}
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DMeasureAzimuth_onMouseUp_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint button_j, jint shift_j, jint x_j, jint y_j)
				{
					...
					if (typeid(*pObjectX) == typeid(JCAnalysis3DMeasureAzimuthProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::Analysis::CAnalysis3DMeasureAzimuth::onMouseUp(button, shift, x, y);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DMeasureAzimuth_register_1onMouseUp_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCAnalysis3DMeasureAzimuthProxy *pObjectX = (JCAnalysis3DMeasureAzimuthProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DMeasureAzimuth_onMouseUp_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint button_j, jint shift_j, jint x_j, jint y_j)
				{
					ev_int32 button = (ev_int32) button_j;
					ev_int32 shift = (ev_int32) shift_j;
					ev_int32 x = (ev_int32) x_j;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DMeasureAzimuth_onMouseMove_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint button_j, jint shift_j, jint x_j, jint y_j)
				{
					ev_int32 button = (ev_int32) button_j;
					ev_int32 shift = (ev_int32) shift_j;
					ev_int32 x = (ev_int32) x_j;
					...
					if (typeid(*pObjectX) == typeid(JCAnalysis3DMeasureAzimuthProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::Analysis::CAnalysis3DMeasureAzimuth::onMouseMove(button, shift, x, y);
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DMeasureAzimuth_register_1onMouseMove_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCAnalysis3DMeasureAzimuthProxy *pObjectX = (JCAnalysis3DMeasureAzimuthProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DMeasureAzimuth_onMouseMove_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jint button_j, jint shift_j, jint x_j, jint y_j)
				{
					ev_int32 button = (ev_int32) button_j;
					ev_int32 shift = (ev_int32) shift_j;
					ev_int32 x = (ev_int32) x_j;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DMeasureAzimuth_onDoubleClick_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::Analysis::CAnalysis3DMeasureAzimuth *pObjectX = (EarthView::World::Spatial3D::Analysis::CAnalysis3DMeasureAzimuth*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCAnalysis3DMeasureAzimuthProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::Analysis::CAnalysis3DMeasureAzimuth::onDoubleClick();
						jboolean __values1_j = (jboolean)__values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DMeasureAzimuth_register_1onDoubleClick_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCAnalysis3DMeasureAzimuthProxy *pObjectX = (JCAnalysis3DMeasureAzimuthProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DMeasureAzimuth_onDoubleClick_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::Analysis::CAnalysis3DMeasureAzimuth *pObjectX = (EarthView::World::Spatial3D::Analysis::CAnalysis3DMeasureAzimuth*) pObjXXXX;
					ev_bool __values1 = pObjectX->EarthView::World::Spatial3D::Analysis::CAnalysis3DMeasureAzimuth::onDoubleClick();
					jboolean __values1_j = (jboolean)__values1;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DMeasureAzimuth_register_1getMath3D_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCAnalysis3DMeasureAzimuthProxy *pObjectX = (JCAnalysis3DMeasureAzimuthProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DMeasureAzimuth_register_1setVisible_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCAnalysis3DMeasureAzimuthProxy *pObjectX = (JCAnalysis3DMeasureAzimuthProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DMeasureAzimuth_register_1getMousePickState_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCAnalysis3DMeasureAzimuthProxy *pObjectX = (JCAnalysis3DMeasureAzimuthProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DMeasureAzimuth_register_1setMousePickState_1MousePickState(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCAnalysis3DMeasureAzimuthProxy *pObjectX = (JCAnalysis3DMeasureAzimuthProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DMeasureAzimuth_register_1getIsAnalysisInServer_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCAnalysis3DMeasureAzimuthProxy *pObjectX = (JCAnalysis3DMeasureAzimuthProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DMeasureAzimuth_register_1setIsAnalysisInServer_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCAnalysis3DMeasureAzimuthProxy *pObjectX = (JCAnalysis3DMeasureAzimuthProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DMeasureAzimuth_register_1getAltitude3DListener_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCAnalysis3DMeasureAzimuthProxy *pObjectX = (JCAnalysis3DMeasureAzimuthProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DMeasureAzimuth_register_1setAltitude3DListener_1CAltitudeListener(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCAnalysis3DMeasureAzimuthProxy *pObjectX = (JCAnalysis3DMeasureAzimuthProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DMeasureAzimuth_register_1getAnalysis3DListener_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCAnalysis3DMeasureAzimuthProxy *pObjectX = (JCAnalysis3DMeasureAzimuthProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DMeasureAzimuth_register_1setAnalysis3DListener_1CAnalysis3DListener(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCAnalysis3DMeasureAzimuthProxy *pObjectX = (JCAnalysis3DMeasureAzimuthProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DMeasureAzimuth_register_1activate_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCAnalysis3DMeasureAzimuthProxy *pObjectX = (JCAnalysis3DMeasureAzimuthProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DMeasureAzimuth_register_1getCursor_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCAnalysis3DMeasureAzimuthProxy *pObjectX = (JCAnalysis3DMeasureAzimuthProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DMeasureAzimuth_register_1onContextMenu_1ev_1int32_1ev_1int32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCAnalysis3DMeasureAzimuthProxy *pObjectX = (JCAnalysis3DMeasureAzimuthProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DMeasureAzimuth_register_1onDoubleClick_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCAnalysis3DMeasureAzimuthProxy *pObjectX = (JCAnalysis3DMeasureAzimuthProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DMeasureAzimuth_register_1onKeyDown_1ev_1int32_1ev_1int32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCAnalysis3DMeasureAzimuthProxy *pObjectX = (JCAnalysis3DMeasureAzimuthProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DMeasureAzimuth_register_1onKeyUp_1ev_1int32_1ev_1int32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCAnalysis3DMeasureAzimuthProxy *pObjectX = (JCAnalysis3DMeasureAzimuthProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DMeasureAzimuth_register_1onMouseDown_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCAnalysis3DMeasureAzimuthProxy *pObjectX = (JCAnalysis3DMeasureAzimuthProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DMeasureAzimuth_register_1onMouseWheel_1ev_1int32_1ev_1int32_1ev_1int32_1ev_1int32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCAnalysis3DMeasureAzimuthProxy *pObjectX = (JCAnalysis3DMeasureAzimuthProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DMeasureAzimuth_register_1onTouchDown_1MotionEvent(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCAnalysis3DMeasureAzimuthProxy *pObjectX = (JCAnalysis3DMeasureAzimuthProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DMeasureAzimuth_register_1onTouchUp_1MotionEvent(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCAnalysis3DMeasureAzimuthProxy *pObjectX = (JCAnalysis3DMeasureAzimuthProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DMeasureAzimuth_register_1onTouchMove_1MotionEvent(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCAnalysis3DMeasureAzimuthProxy *pObjectX = (JCAnalysis3DMeasureAzimuthProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DMeasureAzimuth_register_1getToolBarType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCAnalysis3DMeasureAzimuthProxy *pObjectX = (JCAnalysis3DMeasureAzimuthProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DMeasureAzimuth_register_1getType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCAnalysis3DMeasureAzimuthProxy *pObjectX = (JCAnalysis3DMeasureAzimuthProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DMeasureAzimuth_register_1getName_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCAnalysis3DMeasureAzimuthProxy *pObjectX = (JCAnalysis3DMeasureAzimuthProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DMeasureAzimuth_register_1getCategory_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCAnalysis3DMeasureAzimuthProxy *pObjectX = (JCAnalysis3DMeasureAzimuthProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DMeasureAzimuth_register_1getToolTip_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCAnalysis3DMeasureAzimuthProxy *pObjectX = (JCAnalysis3DMeasureAzimuthProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DMeasureAzimuth_register_1getIcon_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCAnalysis3DMeasureAzimuthProxy *pObjectX = (JCAnalysis3DMeasureAzimuthProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DMeasureAzimuth_register_1isCheckable_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCAnalysis3DMeasureAzimuthProxy *pObjectX = (JCAnalysis3DMeasureAzimuthProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DMeasureAzimuth_register_1onClicked_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCAnalysis3DMeasureAzimuthProxy *pObjectX = (JCAnalysis3DMeasureAzimuthProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DMeasureAzimuth_register_1getChecked_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCAnalysis3DMeasureAzimuthProxy *pObjectX = (JCAnalysis3DMeasureAzimuthProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DMeasureAzimuth_register_1setChecked_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCAnalysis3DMeasureAzimuthProxy *pObjectX = (JCAnalysis3DMeasureAzimuthProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DMeasureAzimuth_register_1getEnabled_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCAnalysis3DMeasureAzimuthProxy *pObjectX = (JCAnalysis3DMeasureAzimuthProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DMeasureAzimuth_register_1setEnabled_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCAnalysis3DMeasureAzimuthProxy *pObjectX = (JCAnalysis3DMeasureAzimuthProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DMeasureAzimuth_register_1create_1ISpatialControl(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCAnalysis3DMeasureAzimuthProxy *pObjectX = (JCAnalysis3DMeasureAzimuthProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DMeasureAzimuth_register_1update_1CEvent(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCAnalysis3DMeasureAzimuthProxy *pObjectX = (JCAnalysis3DMeasureAzimuthProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
