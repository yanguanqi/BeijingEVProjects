...
namespace EarthView
{
	namespace World
	{
		namespace Spatial3D
		{
			namespace Analysis
			{
				class JCAnalysis3DVolumeParamProxy : public EarthView::World::Spatial3D::Analysis::CAnalysis3DVolumeParam
				{
				 private:
				...
				public:
					JCAnalysis3DVolumeParamProxy(EarthView::World::Core::CNameValuePairList *pList) : CAnalysis3DVolumeParam(pList)
					{
					}
				...
				REGISTER_FACTORY_CLASS(JCAnalysis3DVolumeParamProxy);
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DVolumeParam_setSelectedPoint_1CVector3(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong cen_j)
				{
					EarthView::World::Spatial::Math::CVector3 &cen = *(EarthView::World::Spatial::Math::CVector3*) cen_j;
					EarthView::World::Spatial3D::Analysis::CAnalysis3DVolumeParam *pObjectX = (EarthView::World::Spatial3D::Analysis::CAnalysis3DVolumeParam*) pObjXXXX;
					pObjectX->setSelectedPoint(cen);
				}
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DVolumeParam_getSelectedPoint_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::Analysis::CAnalysis3DVolumeParam *pObjectX = (EarthView::World::Spatial3D::Analysis::CAnalysis3DVolumeParam*) pObjXXXX;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DVolumeParam_register_1setParameter_1EVString_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCAnalysis3DVolumeParamProxy *pObjectX = (JCAnalysis3DVolumeParamProxy*) pObjXXXX;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DVolumeParam_register_1setParameter_1EVString_1ev_1bool_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCAnalysis3DVolumeParamProxy *pObjectX = (JCAnalysis3DVolumeParamProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DVolumeParam_register_1setParameterList_1CommonStringPairList(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCAnalysis3DVolumeParamProxy *pObjectX = (JCAnalysis3DVolumeParamProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DVolumeParam_register_1getParameter_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCAnalysis3DVolumeParamProxy *pObjectX = (JCAnalysis3DVolumeParamProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DVolumeParam_register_1copyParametersTo_1CStringInterface(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCAnalysis3DVolumeParamProxy *pObjectX = (JCAnalysis3DVolumeParamProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
