...
namespace EarthView
{
	namespace World
	{
		namespace Spatial3D
		{
			namespace Analysis
			{
				class JCAnalysis3DRegionFloodParamProxy : public EarthView::World::Spatial3D::Analysis::CAnalysis3DRegionFloodParam
				{
				 private:
				...
				public:
					JCAnalysis3DRegionFloodParamProxy(EarthView::World::Core::CNameValuePairList *pList) : CAnalysis3DRegionFloodParam(pList)
					{
					}
				...
				REGISTER_FACTORY_CLASS(JCAnalysis3DRegionFloodParamProxy);
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DRegionFloodParam_setCenter_1CVector3(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong cen_j)
				{
					EarthView::World::Spatial::Math::CVector3 &cen = *(EarthView::World::Spatial::Math::CVector3*) cen_j;
					EarthView::World::Spatial3D::Analysis::CAnalysis3DRegionFloodParam *pObjectX = (EarthView::World::Spatial3D::Analysis::CAnalysis3DRegionFloodParam*) pObjXXXX;
					pObjectX->setCenter(cen);
				}
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DRegionFloodParam_getCenter_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial3D::Analysis::CAnalysis3DRegionFloodParam *pObjectX = (EarthView::World::Spatial3D::Analysis::CAnalysis3DRegionFloodParam*) pObjXXXX;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DRegionFloodParam_register_1setParameter_1EVString_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCAnalysis3DRegionFloodParamProxy *pObjectX = (JCAnalysis3DRegionFloodParamProxy*) pObjXXXX;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DRegionFloodParam_register_1setParameter_1EVString_1ev_1bool_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCAnalysis3DRegionFloodParamProxy *pObjectX = (JCAnalysis3DRegionFloodParamProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DRegionFloodParam_register_1setParameterList_1CommonStringPairList(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCAnalysis3DRegionFloodParamProxy *pObjectX = (JCAnalysis3DRegionFloodParamProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DRegionFloodParam_register_1getParameter_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCAnalysis3DRegionFloodParamProxy *pObjectX = (JCAnalysis3DRegionFloodParamProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial3d_analysis_Analysis3DRegionFloodParam_register_1copyParametersTo_1CStringInterface(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCAnalysis3DRegionFloodParamProxy *pObjectX = (JCAnalysis3DRegionFloodParamProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
