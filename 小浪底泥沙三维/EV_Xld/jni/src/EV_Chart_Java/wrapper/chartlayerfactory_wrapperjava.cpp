...
namespace EarthView
{
	namespace World
	{
		namespace Spatial
		{
			namespace Atlas
			{
				class JCChartLayerFactoryProxy : public EarthView::World::Spatial::Atlas::CChartLayerFactory
				{
				 private:
				...
				public:
					JCChartLayerFactoryProxy(EarthView::World::Core::CNameValuePairList *pList) : CChartLayerFactory(pList)
					{
					}
				...
				REGISTER_FACTORY_CLASS(JCChartLayerFactoryProxy);
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial_atlas_ChartLayerFactory_getType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Atlas::CChartLayerFactory *pObjectX = (EarthView::World::Spatial::Atlas::CChartLayerFactory*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCChartLayerFactoryProxy))
					{
						EarthView::World::Spatial::Atlas::EVLayerType __values1 = pObjectX->EarthView::World::Spatial::Atlas::CChartLayerFactory::getType();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_ChartLayerFactory_register_1getType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCChartLayerFactoryProxy *pObjectX = (JCChartLayerFactoryProxy*) pObjXXXX;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial_atlas_ChartLayerFactory_getType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::Atlas::CChartLayerFactory *pObjectX = (EarthView::World::Spatial::Atlas::CChartLayerFactory*) pObjXXXX;
					EarthView::World::Spatial::Atlas::EVLayerType __values1 = pObjectX->EarthView::World::Spatial::Atlas::CChartLayerFactory::getType();
					jint __values1_j = (jint) __values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_atlas_ChartLayerFactory_createInstance_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial::Atlas::CChartLayerFactory *pObjectX = (EarthView::World::Spatial::Atlas::CChartLayerFactory*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCChartLayerFactoryProxy))
					{
						EarthView::World::Spatial::Atlas::ILayer* __values1 = pObjectX->EarthView::World::Spatial::Atlas::CChartLayerFactory::createInstance();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_ChartLayerFactory_register_1createInstance_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCChartLayerFactoryProxy *pObjectX = (JCChartLayerFactoryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_atlas_ChartLayerFactory_createInstance_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					EarthView::World::Spatial::Atlas::CChartLayerFactory *pObjectX = (EarthView::World::Spatial::Atlas::CChartLayerFactory*) pObjXXXX;
					EarthView::World::Spatial::Atlas::ILayer* __values1 = pObjectX->EarthView::World::Spatial::Atlas::CChartLayerFactory::createInstance();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_atlas_ChartLayerFactory_createInstance_1EVString(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring strXml_j)
				{
					#if EV_PLATFORM == EV_PLATFORM_ANDROID
					...
					if (typeid(*pObjectX) == typeid(JCChartLayerFactoryProxy))
					{
						EarthView::World::Spatial::Atlas::ILayer* __values1 = pObjectX->EarthView::World::Spatial::Atlas::CChartLayerFactory::createInstance(strXml);
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_ChartLayerFactory_register_1createInstance_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCChartLayerFactoryProxy *pObjectX = (JCChartLayerFactoryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_atlas_ChartLayerFactory_createInstance_1EVString_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring strXml_j)
				{
					#if EV_PLATFORM == EV_PLATFORM_ANDROID
					const ev_char* strXml_ch = (const ev_char*)__env->GetStringUTFChars(strXml_j,JNI_FALSE);
					const EVString strXml = strXml_ch;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_atlas_ChartLayerFactory_createInstance_1CXmlElement(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong element_j)
				{
					EarthView::World::Core::CXmlElement &element = *(EarthView::World::Core::CXmlElement*) element_j;
					EarthView::World::Spatial::Atlas::CChartLayerFactory *pObjectX = (EarthView::World::Spatial::Atlas::CChartLayerFactory*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCChartLayerFactoryProxy))
					{
						EarthView::World::Spatial::Atlas::ILayer* __values1 = pObjectX->EarthView::World::Spatial::Atlas::CChartLayerFactory::createInstance(element);
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_ChartLayerFactory_register_1createInstance_1CXmlElement(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCChartLayerFactoryProxy *pObjectX = (JCChartLayerFactoryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_atlas_ChartLayerFactory_createInstance_1CXmlElement_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong element_j)
				{
					EarthView::World::Core::CXmlElement &element = *(EarthView::World::Core::CXmlElement*) element_j;
					EarthView::World::Spatial::Atlas::CChartLayerFactory *pObjectX = (EarthView::World::Spatial::Atlas::CChartLayerFactory*) pObjXXXX;
					EarthView::World::Spatial::Atlas::ILayer* __values1 = pObjectX->EarthView::World::Spatial::Atlas::CChartLayerFactory::createInstance(element);
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_atlas_ChartLayerFactory_destroyInstance_1ILayer(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong layer_j)
				{
					EarthView::World::Spatial::Atlas::ILayer *layer = (EarthView::World::Spatial::Atlas::ILayer*) layer_j;
					EarthView::World::Spatial::Atlas::CChartLayerFactory *pObjectX = (EarthView::World::Spatial::Atlas::CChartLayerFactory*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCChartLayerFactoryProxy))
					{
						ev_bool __values1 = pObjectX->EarthView::World::Spatial::Atlas::CChartLayerFactory::destroyInstance(layer);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_atlas_ChartLayerFactory_register_1destroyInstance_1ILayer(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCChartLayerFactoryProxy *pObjectX = (JCChartLayerFactoryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jboolean JNICALL Java_com_earthview_world_spatial_atlas_ChartLayerFactory_destroyInstance_1ILayer_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong layer_j)
				{
					EarthView::World::Spatial::Atlas::ILayer *layer = (EarthView::World::Spatial::Atlas::ILayer*) layer_j;
					EarthView::World::Spatial::Atlas::CChartLayerFactory *pObjectX = (EarthView::World::Spatial::Atlas::CChartLayerFactory*) pObjXXXX;
					ev_bool __values1 = pObjectX->EarthView::World::Spatial::Atlas::CChartLayerFactory::destroyInstance(layer);
