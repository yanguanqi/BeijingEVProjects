...
namespace EarthView
{
	namespace World
	{
		namespace Spatial
		{
			namespace SystemUI
			{
				class JIEntryBoxProxy : public EarthView::World::Spatial::SystemUI::IEntryBox
				{
				 private:
				...
				public:
					JIEntryBoxProxy(EarthView::World::Core::CNameValuePairList *pList) : IEntryBox(pList)
					{
					}
				...
				protected:
					C_DISABLE_COPY(JIEntryBoxProxy)
				public:
				...
				REGISTER_FACTORY_CLASS(JIEntryBoxProxy);
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_systemui_Ientrybox_getWidth_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::SystemUI::IEntryBox *pObjectX = (EarthView::World::Spatial::SystemUI::IEntryBox*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIEntryBoxProxy))
					{
						ev_uint32 __values1 = pObjectX->EarthView::World::Spatial::SystemUI::IEntryBox::getWidth();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_systemui_Ientrybox_register_1getWidth_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIEntryBoxProxy *pObjectX = (JIEntryBoxProxy*) pObjXXXX;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_systemui_Ientrybox_getWidth_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::SystemUI::IEntryBox *pObjectX = (EarthView::World::Spatial::SystemUI::IEntryBox*) pObjXXXX;
					ev_uint32 __values1 = pObjectX->EarthView::World::Spatial::SystemUI::IEntryBox::getWidth();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_systemui_Ientrybox_getEntryCount_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::SystemUI::IEntryBox *pObjectX = (EarthView::World::Spatial::SystemUI::IEntryBox*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIEntryBoxProxy))
					{
						ev_uint32 __values1 = pObjectX->EarthView::World::Spatial::SystemUI::IEntryBox::getEntryCount();
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_systemui_Ientrybox_register_1getEntryCount_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIEntryBoxProxy *pObjectX = (JIEntryBoxProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_systemui_Ientrybox_getEntryCount_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::SystemUI::IEntryBox *pObjectX = (EarthView::World::Spatial::SystemUI::IEntryBox*) pObjXXXX;
					ev_uint32 __values1 = pObjectX->EarthView::World::Spatial::SystemUI::IEntryBox::getEntryCount();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial_systemui_Ientrybox_getEntry_1ev_1uint32(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong index_j)
				{
					ev_uint32 index = (ev_uint32) index_j;
					const 					EarthView::World::Spatial::SystemUI::IEntryBox *pObjectX = (EarthView::World::Spatial::SystemUI::IEntryBox*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIEntryBoxProxy))
					{
						EVString __values1 = pObjectX->EarthView::World::Spatial::SystemUI::IEntryBox::getEntry(index);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_systemui_Ientrybox_register_1getEntry_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIEntryBoxProxy *pObjectX = (JIEntryBoxProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jstring JNICALL Java_com_earthview_world_spatial_systemui_Ientrybox_getEntry_1ev_1uint32_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong index_j)
				{
					ev_uint32 index = (ev_uint32) index_j;
					const 					EarthView::World::Spatial::SystemUI::IEntryBox *pObjectX = (EarthView::World::Spatial::SystemUI::IEntryBox*) pObjXXXX;
					EVString __values1 = pObjectX->EarthView::World::Spatial::SystemUI::IEntryBox::getEntry(index);
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial_systemui_Ientrybox_getCurrentIndex_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::SystemUI::IEntryBox *pObjectX = (EarthView::World::Spatial::SystemUI::IEntryBox*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIEntryBoxProxy))
					{
						ev_int32 __values1 = pObjectX->EarthView::World::Spatial::SystemUI::IEntryBox::getCurrentIndex();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_systemui_Ientrybox_register_1getCurrentIndex_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIEntryBoxProxy *pObjectX = (JIEntryBoxProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial_systemui_Ientrybox_getCurrentIndex_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::SystemUI::IEntryBox *pObjectX = (EarthView::World::Spatial::SystemUI::IEntryBox*) pObjXXXX;
					ev_int32 __values1 = pObjectX->EarthView::World::Spatial::SystemUI::IEntryBox::getCurrentIndex();
					jint __values1_j = (jint)__values1;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_systemui_Ientrybox_currentIndexChanged_1ev_1uint32(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong index_j)
				{
					ev_uint32 index = (ev_uint32) index_j;
					EarthView::World::Spatial::SystemUI::IEntryBox *pObjectX = (EarthView::World::Spatial::SystemUI::IEntryBox*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIEntryBoxProxy))
					{
						pObjectX->EarthView::World::Spatial::SystemUI::IEntryBox::currentIndexChanged(index);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_systemui_Ientrybox_register_1currentIndexChanged_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIEntryBoxProxy *pObjectX = (JIEntryBoxProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_systemui_Ientrybox_currentIndexChanged_1ev_1uint32_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong index_j)
				{
					ev_uint32 index = (ev_uint32) index_j;
					EarthView::World::Spatial::SystemUI::IEntryBox *pObjectX = (EarthView::World::Spatial::SystemUI::IEntryBox*) pObjXXXX;
					pObjectX->EarthView::World::Spatial::SystemUI::IEntryBox::currentIndexChanged(index);
				}
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_systemui_Ientrybox_getType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::SystemUI::IEntryBox *pObjectX = (EarthView::World::Spatial::SystemUI::IEntryBox*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIEntryBoxProxy))
					{
						ev_uint32 __values1 = pObjectX->EarthView::World::Spatial::SystemUI::IEntryBox::getType();
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_systemui_Ientrybox_register_1getType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIEntryBoxProxy *pObjectX = (JIEntryBoxProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_systemui_Ientrybox_getType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::SystemUI::IEntryBox *pObjectX = (EarthView::World::Spatial::SystemUI::IEntryBox*) pObjXXXX;
					ev_uint32 __values1 = pObjectX->EarthView::World::Spatial::SystemUI::IEntryBox::getType();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_systemui_Ientrybox_register_1getToolBarType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIEntryBoxProxy *pObjectX = (JIEntryBoxProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_systemui_Ientrybox_register_1getName_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIEntryBoxProxy *pObjectX = (JIEntryBoxProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_systemui_Ientrybox_register_1getCategory_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIEntryBoxProxy *pObjectX = (JIEntryBoxProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_systemui_Ientrybox_register_1getToolTip_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIEntryBoxProxy *pObjectX = (JIEntryBoxProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_systemui_Ientrybox_register_1getIcon_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIEntryBoxProxy *pObjectX = (JIEntryBoxProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_systemui_Ientrybox_register_1isCheckable_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIEntryBoxProxy *pObjectX = (JIEntryBoxProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_systemui_Ientrybox_register_1onClicked_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIEntryBoxProxy *pObjectX = (JIEntryBoxProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_systemui_Ientrybox_register_1getChecked_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIEntryBoxProxy *pObjectX = (JIEntryBoxProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_systemui_Ientrybox_register_1setChecked_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIEntryBoxProxy *pObjectX = (JIEntryBoxProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_systemui_Ientrybox_register_1getEnabled_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIEntryBoxProxy *pObjectX = (JIEntryBoxProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_systemui_Ientrybox_register_1setEnabled_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIEntryBoxProxy *pObjectX = (JIEntryBoxProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_systemui_Ientrybox_register_1create_1ISpatialControl(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIEntryBoxProxy *pObjectX = (JIEntryBoxProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_systemui_Ientrybox_register_1update_1CEvent(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIEntryBoxProxy *pObjectX = (JIEntryBoxProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
