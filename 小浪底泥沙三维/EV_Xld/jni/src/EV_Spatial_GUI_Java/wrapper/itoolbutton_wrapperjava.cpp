...
namespace EarthView
{
	namespace World
	{
		namespace Spatial
		{
			namespace SystemUI
			{
				class JIToolButtonProxy : public EarthView::World::Spatial::SystemUI::IToolButton
				{
				 private:
				...
				public:
					JIToolButtonProxy(EarthView::World::Core::CNameValuePairList *pList) : IToolButton(pList)
					{
					}
				...
				protected:
					C_DISABLE_COPY(JIToolButtonProxy)
				public:
				...
				REGISTER_FACTORY_CLASS(JIToolButtonProxy);
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_systemui_Itoolbutton_addCommand_1ICommand(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong ref_cmd_j)
				{
					EarthView::World::Spatial::SystemUI::ICommand *ref_cmd = (EarthView::World::Spatial::SystemUI::ICommand*) ref_cmd_j;
					EarthView::World::Spatial::SystemUI::IToolButton *pObjectX = (EarthView::World::Spatial::SystemUI::IToolButton*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIToolButtonProxy))
					{
						pObjectX->EarthView::World::Spatial::SystemUI::IToolButton::addCommand(ref_cmd);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_systemui_Itoolbutton_register_1addCommand_1ICommand(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIToolButtonProxy *pObjectX = (JIToolButtonProxy*) pObjXXXX;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_systemui_Itoolbutton_addCommand_1ICommand_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong ref_cmd_j)
				{
					EarthView::World::Spatial::SystemUI::ICommand *ref_cmd = (EarthView::World::Spatial::SystemUI::ICommand*) ref_cmd_j;
					EarthView::World::Spatial::SystemUI::IToolButton *pObjectX = (EarthView::World::Spatial::SystemUI::IToolButton*) pObjXXXX;
					pObjectX->EarthView::World::Spatial::SystemUI::IToolButton::addCommand(ref_cmd);
				}
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_systemui_Itoolbutton_getCount_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::SystemUI::IToolButton *pObjectX = (EarthView::World::Spatial::SystemUI::IToolButton*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIToolButtonProxy))
					{
						ev_uint32 __values1 = pObjectX->EarthView::World::Spatial::SystemUI::IToolButton::getCount();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_systemui_Itoolbutton_register_1getCount_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIToolButtonProxy *pObjectX = (JIToolButtonProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_systemui_Itoolbutton_getCount_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::SystemUI::IToolButton *pObjectX = (EarthView::World::Spatial::SystemUI::IToolButton*) pObjXXXX;
					ev_uint32 __values1 = pObjectX->EarthView::World::Spatial::SystemUI::IToolButton::getCount();
					jlong __values1_j = (jlong) __values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_systemui_Itoolbutton_getCommand_1ev_1uint32(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong index_j)
				{
					ev_uint32 index = (ev_uint32) index_j;
					const 					EarthView::World::Spatial::SystemUI::IToolButton *pObjectX = (EarthView::World::Spatial::SystemUI::IToolButton*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIToolButtonProxy))
					{
						EarthView::World::Spatial::SystemUI::ICommand* __values1 = pObjectX->EarthView::World::Spatial::SystemUI::IToolButton::getCommand(index);
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_systemui_Itoolbutton_register_1getCommand_1ev_1uint32(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIToolButtonProxy *pObjectX = (JIToolButtonProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_systemui_Itoolbutton_getCommand_1ev_1uint32_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong index_j)
				{
					ev_uint32 index = (ev_uint32) index_j;
					const 					EarthView::World::Spatial::SystemUI::IToolButton *pObjectX = (EarthView::World::Spatial::SystemUI::IToolButton*) pObjXXXX;
					EarthView::World::Spatial::SystemUI::ICommand* __values1 = pObjectX->EarthView::World::Spatial::SystemUI::IToolButton::getCommand(index);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_systemui_Itoolbutton_register_1getToolBarType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIToolButtonProxy *pObjectX = (JIToolButtonProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_systemui_Itoolbutton_register_1getType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIToolButtonProxy *pObjectX = (JIToolButtonProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_systemui_Itoolbutton_register_1getName_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIToolButtonProxy *pObjectX = (JIToolButtonProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_systemui_Itoolbutton_register_1getCategory_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIToolButtonProxy *pObjectX = (JIToolButtonProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_systemui_Itoolbutton_register_1getToolTip_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIToolButtonProxy *pObjectX = (JIToolButtonProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_systemui_Itoolbutton_register_1getIcon_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIToolButtonProxy *pObjectX = (JIToolButtonProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_systemui_Itoolbutton_register_1isCheckable_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIToolButtonProxy *pObjectX = (JIToolButtonProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_systemui_Itoolbutton_register_1onClicked_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIToolButtonProxy *pObjectX = (JIToolButtonProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_systemui_Itoolbutton_register_1getChecked_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIToolButtonProxy *pObjectX = (JIToolButtonProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_systemui_Itoolbutton_register_1setChecked_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIToolButtonProxy *pObjectX = (JIToolButtonProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_systemui_Itoolbutton_register_1getEnabled_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIToolButtonProxy *pObjectX = (JIToolButtonProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_systemui_Itoolbutton_register_1setEnabled_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIToolButtonProxy *pObjectX = (JIToolButtonProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_systemui_Itoolbutton_register_1create_1ISpatialControl(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIToolButtonProxy *pObjectX = (JIToolButtonProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_systemui_Itoolbutton_register_1update_1CEvent(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIToolButtonProxy *pObjectX = (JIToolButtonProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
