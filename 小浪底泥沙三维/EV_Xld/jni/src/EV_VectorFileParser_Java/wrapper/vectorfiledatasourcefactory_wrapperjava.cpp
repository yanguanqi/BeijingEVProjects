...
namespace EarthView
{
	namespace World
	{
		namespace Spatial
		{
			...
			{
				class JCVectorFileDataSourceFactoryProxy : public EarthView::World::Spatial::VectorFileParser::CVectorFileDataSourceFactory
				{
				 private:
				...
				public:
					JCVectorFileDataSourceFactoryProxy(EarthView::World::Core::CNameValuePairList *pList) : CVectorFileDataSourceFactory(pList)
					{
					}
				...
				REGISTER_FACTORY_CLASS(JCVectorFileDataSourceFactoryProxy);
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial_vectorfileparser_VectorFileDataSourceFactory_getType_1void(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::VectorFileParser::CVectorFileDataSourceFactory *pObjectX = (EarthView::World::Spatial::VectorFileParser::CVectorFileDataSourceFactory*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorFileDataSourceFactoryProxy))
					{
						ev_int32 __values1 = pObjectX->EarthView::World::Spatial::VectorFileParser::CVectorFileDataSourceFactory::getType();
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_vectorfileparser_VectorFileDataSourceFactory_register_1getType_1void(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorFileDataSourceFactoryProxy *pObjectX = (JCVectorFileDataSourceFactoryProxy*) pObjXXXX;
				...
				extern "C" JNIEXPORT jint JNICALL Java_com_earthview_world_spatial_vectorfileparser_VectorFileDataSourceFactory_getType_1void_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX)
				{
					const 					EarthView::World::Spatial::VectorFileParser::CVectorFileDataSourceFactory *pObjectX = (EarthView::World::Spatial::VectorFileParser::CVectorFileDataSourceFactory*) pObjXXXX;
					ev_int32 __values1 = pObjectX->EarthView::World::Spatial::VectorFileParser::CVectorFileDataSourceFactory::getType();
					jint __values1_j = (jint)__values1;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_vectorfileparser_VectorFileDataSourceFactory_createFromXML_1EVString(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring xml_j)
				{
					#if EV_PLATFORM == EV_PLATFORM_ANDROID
					...
					#endif
					EarthView::World::Spatial::VectorFileParser::CVectorFileDataSourceFactory *pObjectX = (EarthView::World::Spatial::VectorFileParser::CVectorFileDataSourceFactory*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorFileDataSourceFactoryProxy))
					{
						EarthView::World::Spatial::GeoDataset::IDataSource* __values1 = pObjectX->EarthView::World::Spatial::VectorFileParser::CVectorFileDataSourceFactory::createFromXML(xml);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_vectorfileparser_VectorFileDataSourceFactory_register_1createFromXML_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorFileDataSourceFactoryProxy *pObjectX = (JCVectorFileDataSourceFactoryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_vectorfileparser_VectorFileDataSourceFactory_createFromXML_1EVString_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring xml_j)
				{
					#if EV_PLATFORM == EV_PLATFORM_ANDROID
					const ev_char* xml_ch = (const ev_char*)__env->GetStringUTFChars(xml_j,JNI_FALSE);
					const EVString xml = xml_ch;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_vectorfileparser_VectorFileDataSourceFactory_openDataSource_1EVString_1EVString(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring path_j, jstring fileName_j)
				{
					#if EV_PLATFORM == EV_PLATFORM_ANDROID
					...
					if (typeid(*pObjectX) == typeid(JCVectorFileDataSourceFactoryProxy))
					{
						EarthView::World::Spatial::GeoDataset::IDataSource* __values1 = pObjectX->EarthView::World::Spatial::VectorFileParser::CVectorFileDataSourceFactory::openDataSource(path, fileName);
						jlong __values1_j = (jlong) __values1;
						return __values1_j;
					}
					else
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_vectorfileparser_VectorFileDataSourceFactory_register_1openDataSource_1EVString_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorFileDataSourceFactoryProxy *pObjectX = (JCVectorFileDataSourceFactoryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_vectorfileparser_VectorFileDataSourceFactory_openDataSource_1EVString_1EVString_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring path_j, jstring fileName_j)
				{
					#if EV_PLATFORM == EV_PLATFORM_ANDROID
					const ev_char* path_ch = (const ev_char*)__env->GetStringUTFChars(path_j,JNI_FALSE);
					const EVString path = path_ch;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_vectorfileparser_VectorFileDataSourceFactory_closeDataSource_1IDataSource(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong pDataSource_j)
				{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_vectorfileparser_VectorFileDataSourceFactory_destroyDataSource_1IDataSource(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong pDataSource_j)
				{
					EarthView::World::Spatial::GeoDataset::IDataSource *pDataSource = (EarthView::World::Spatial::GeoDataset::IDataSource*) pDataSource_j;
					EarthView::World::Spatial::VectorFileParser::CVectorFileDataSourceFactory *pObjectX = (EarthView::World::Spatial::VectorFileParser::CVectorFileDataSourceFactory*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JCVectorFileDataSourceFactoryProxy))
					{
						pObjectX->EarthView::World::Spatial::VectorFileParser::CVectorFileDataSourceFactory::destroyDataSource(pDataSource);
					}
					else
					{
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_vectorfileparser_VectorFileDataSourceFactory_register_1destroyDataSource_1IDataSource(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorFileDataSourceFactoryProxy *pObjectX = (JCVectorFileDataSourceFactoryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_vectorfileparser_VectorFileDataSourceFactory_destroyDataSource_1IDataSource_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jlong pDataSource_j)
				{
					EarthView::World::Spatial::GeoDataset::IDataSource *pDataSource = (EarthView::World::Spatial::GeoDataset::IDataSource*) pDataSource_j;
					EarthView::World::Spatial::VectorFileParser::CVectorFileDataSourceFactory *pObjectX = (EarthView::World::Spatial::VectorFileParser::CVectorFileDataSourceFactory*) pObjXXXX;
					pObjectX->EarthView::World::Spatial::VectorFileParser::CVectorFileDataSourceFactory::destroyDataSource(pDataSource);
				}
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_vectorfileparser_VectorFileDataSourceFactory_getSingletonPtr_1void(JNIEnv *__env , jclass __clazz)
				{
					EarthView::World::Spatial::VectorFileParser::CVectorFileDataSourceFactory* __values1 = EarthView::World::Spatial::VectorFileParser::CVectorFileDataSourceFactory::getSingletonPtr();
					jlong __values1_j = (jlong) __values1;
					return __values1_j;
				}
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_vectorfileparser_VectorFileDataSourceFactory_register_1openDataSource_1IPropertySet(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorFileDataSourceFactoryProxy *pObjectX = (JCVectorFileDataSourceFactoryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_vectorfileparser_VectorFileDataSourceFactory_register_1createDataSource_1EVString_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorFileDataSourceFactoryProxy *pObjectX = (JCVectorFileDataSourceFactoryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_vectorfileparser_VectorFileDataSourceFactory_register_1createDataSource_1IPropertySet(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorFileDataSourceFactoryProxy *pObjectX = (JCVectorFileDataSourceFactoryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_vectorfileparser_VectorFileDataSourceFactory_register_1existDataSource_1IDataSource(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JCVectorFileDataSourceFactoryProxy *pObjectX = (JCVectorFileDataSourceFactoryProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
