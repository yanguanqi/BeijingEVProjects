...
namespace EarthView
{
	namespace World
	{
		namespace Spatial
		{
			...
			{
				class JIVectorFileTableProxyProxy : public EarthView::World::Spatial::VectorFileParser::IVectorFileTableProxy
				{
				 private:
				...
				public:
					JIVectorFileTableProxyProxy(EarthView::World::Core::CNameValuePairList *pList) : IVectorFileTableProxy(pList)
					{
					}
				...
				REGISTER_FACTORY_CLASS(JIVectorFileTableProxyProxy);
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_vectorfileparser_Ivectorfiletableproxy_max_1EVString(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring expression_j)
				{
					#if EV_PLATFORM == EV_PLATFORM_ANDROID
					...
					#endif
					EarthView::World::Spatial::VectorFileParser::IVectorFileTableProxy *pObjectX = (EarthView::World::Spatial::VectorFileParser::IVectorFileTableProxy*) pObjXXXX;
					if (typeid(*pObjectX) == typeid(JIVectorFileTableProxyProxy))
					{
						EarthView::World::Core::CVariant __values1 = pObjectX->EarthView::World::Spatial::VectorFileParser::IVectorFileTableProxy::max(expression);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_vectorfileparser_Ivectorfiletableproxy_register_1max_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIVectorFileTableProxyProxy *pObjectX = (JIVectorFileTableProxyProxy*) pObjXXXX;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_vectorfileparser_Ivectorfiletableproxy_max_1EVString_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring expression_j)
				{
					#if EV_PLATFORM == EV_PLATFORM_ANDROID
					const ev_char* expression_ch = (const ev_char*)__env->GetStringUTFChars(expression_j,JNI_FALSE);
					const EVString expression = expression_ch;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_vectorfileparser_Ivectorfiletableproxy_min_1EVString(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring expression_j)
				{
					#if EV_PLATFORM == EV_PLATFORM_ANDROID
					const ev_char* expression_ch = (const ev_char*)__env->GetStringUTFChars(expression_j,JNI_FALSE);
					const EVString expression = expression_ch;
					...
					if (typeid(*pObjectX) == typeid(JIVectorFileTableProxyProxy))
					{
						EarthView::World::Core::CVariant __values1 = pObjectX->EarthView::World::Spatial::VectorFileParser::IVectorFileTableProxy::min(expression);
						EarthView::World::Core::CVariant *returnvalues = new EarthView::World::Core::CVariant(__values1);
						((EarthView::World::Core::CBaseObject*)returnvalues)->setExternFree(true);
						jlong __values1_j = (jlong) returnvalues;
						return __values1_j;
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_vectorfileparser_Ivectorfiletableproxy_register_1min_1EVString(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIVectorFileTableProxyProxy *pObjectX = (JIVectorFileTableProxyProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_vectorfileparser_Ivectorfiletableproxy_min_1EVString_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring expression_j)
				{
					#if EV_PLATFORM == EV_PLATFORM_ANDROID
					const ev_char* expression_ch = (const ev_char*)__env->GetStringUTFChars(expression_j,JNI_FALSE);
					const EVString expression = expression_ch;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_vectorfileparser_Ivectorfiletableproxy_column_1EVString_1ev_1bool(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring fieldName_j, jboolean isUnique_j)
				{
					#if EV_PLATFORM == EV_PLATFORM_ANDROID
					...
					if (typeid(*pObjectX) == typeid(JIVectorFileTableProxyProxy))
					{
						EarthView::World::Core::CVariantArray __values1 = pObjectX->EarthView::World::Spatial::VectorFileParser::IVectorFileTableProxy::column(fieldName, isUnique);
				...
				extern "C" JNIEXPORT void JNICALL Java_com_earthview_world_spatial_vectorfileparser_Ivectorfiletableproxy_register_1column_1EVString_1ev_1bool(JNIEnv *__env, jobject __thiz, jlong pObjXXXX, jstring __method)
				{
					JIVectorFileTableProxyProxy *pObjectX = (JIVectorFileTableProxyProxy*) pObjXXXX;
					const char *pMethod = __env->GetStringUTFChars(__method, NULL);
					EarthView::World::Core::ev_string sMethod = pMethod;
				...
				extern "C" JNIEXPORT jlong JNICALL Java_com_earthview_world_spatial_vectorfileparser_Ivectorfiletableproxy_column_1EVString_1ev_1bool_1NoVirtual(JNIEnv *__env , jobject __thiz, jlong pObjXXXX, jstring fieldName_j, jboolean isUnique_j)
				{
					#if EV_PLATFORM == EV_PLATFORM_ANDROID
					const ev_char* fieldName_ch = (const ev_char*)__env->GetStringUTFChars(fieldName_j,JNI_FALSE);
					const EVString fieldName = fieldName_ch;
